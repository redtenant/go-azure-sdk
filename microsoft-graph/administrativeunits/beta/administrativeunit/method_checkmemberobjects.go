...
func (c AdministrativeUnitClient) CheckMemberObjects(ctx context.Context, id beta.AdministrativeUnitId, input CheckMemberObjectsRequest, options CheckMemberObjectsOperationOptions) (result CheckMemberObjectsOperationResponse, err error) {
...
func (c AdministrativeUnitClient) CheckMemberObjectsComplete(ctx context.Context, id beta.AdministrativeUnitId, input CheckMemberObjectsRequest, options CheckMemberObjectsOperationOptions) (result CheckMemberObjectsCompleteResult, err error) {
	items := make([]string, 0)
