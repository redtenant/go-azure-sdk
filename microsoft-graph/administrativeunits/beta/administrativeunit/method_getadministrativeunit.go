...
// object. Since the administrativeUnit resource supports extensions, you can also use the GET operation to get custom
// properties and extension data in an administrativeUnit instance.
func (c AdministrativeUnitClient) GetAdministrativeUnit(ctx context.Context, id beta.AdministrativeUnitId, options GetAdministrativeUnitOperationOptions) (result GetAdministrativeUnitOperationResponse, err error) {
