...
func (c AdministrativeUnitClient) GetMemberObjects(ctx context.Context, id beta.AdministrativeUnitId, input GetMemberObjectsRequest, options GetMemberObjectsOperationOptions) (result GetMemberObjectsOperationResponse, err error) {
...
func (c AdministrativeUnitClient) GetMemberObjectsComplete(ctx context.Context, id beta.AdministrativeUnitId, input GetMemberObjectsRequest, options GetMemberObjectsOperationOptions) (result GetMemberObjectsCompleteResult, err error) {
	items := make([]string, 0)
