...
type CreateExtensionOperationResponse struct {
...
// CreateExtension - Create new navigation property to extensions for administrativeUnits
func (c ExtensionClient) CreateExtension(ctx context.Context, id beta.AdministrativeUnitId, input beta.Extension, options CreateExtensionOperationOptions) (result CreateExtensionOperationResponse, err error) {
