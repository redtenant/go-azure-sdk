...
func (c ExtensionClient) GetExtensionsCount(ctx context.Context, id beta.AdministrativeUnitId, options GetExtensionsCountOperationOptions) (result GetExtensionsCountOperationResponse, err error) {
