...
// ListExtensions - Get extensions from administrativeUnits. The collection of open extensions defined for this
// administrative unit. Nullable.
func (c ExtensionClient) ListExtensions(ctx context.Context, id beta.AdministrativeUnitId, options ListExtensionsOperationOptions) (result ListExtensionsOperationResponse, err error) {
...
func (c ExtensionClient) ListExtensionsComplete(ctx context.Context, id beta.AdministrativeUnitId, options ListExtensionsOperationOptions) (ListExtensionsCompleteResult, error) {
...
func (c ExtensionClient) ListExtensionsCompleteMatchingPredicate(ctx context.Context, id beta.AdministrativeUnitId, options ListExtensionsOperationOptions, predicate ExtensionOperationPredicate) (result ListExtensionsCompleteResult, err error) {
