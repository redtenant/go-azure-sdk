...
// UpdateExtension - Update the navigation property extensions in administrativeUnits
func (c ExtensionClient) UpdateExtension(ctx context.Context, id beta.AdministrativeUnitIdExtensionId, input beta.Extension, options UpdateExtensionOperationOptions) (result UpdateExtensionOperationResponse, err error) {
