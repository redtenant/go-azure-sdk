...
type DeleteScopedRoleMemberOperationResponse struct {
	HttpResponse *http.Response
	OData        *odata.OData
}

type DeleteScopedRoleMemberOperationOptions struct {
	IfMatch   *string
...
func DefaultDeleteScopedRoleMemberOperationOptions() DeleteScopedRoleMemberOperationOptions {
	return DeleteScopedRoleMemberOperationOptions{}
}
...
// DeleteScopedRoleMember - Remove a scopedRoleMember. Remove a Microsoft Entra role assignment with administrative unit
// scope.
