...
type GetScopedRoleMembersCountOperationResponse struct {
	HttpResponse *http.Response
	OData        *odata.OData
	Model        *[]byte
}

type GetScopedRoleMembersCountOperationOptions struct {
	Filter    *string
...
func DefaultGetScopedRoleMembersCountOperationOptions() GetScopedRoleMembersCountOperationOptions {
	return GetScopedRoleMembersCountOperationOptions{}
}
