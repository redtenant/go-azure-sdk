...
func (c AppManagementPolicyClient) AddAppManagementPolicyRef(ctx context.Context, id beta.ApplicationId, input beta.ReferenceCreate, options AddAppManagementPolicyRefOperationOptions) (result AddAppManagementPolicyRefOperationResponse, err error) {
