...
func (c AppManagementPolicyClient) GetAppManagementPoliciesCount(ctx context.Context, id beta.ApplicationId, options GetAppManagementPoliciesCountOperationOptions) (result GetAppManagementPoliciesCountOperationResponse, err error) {
