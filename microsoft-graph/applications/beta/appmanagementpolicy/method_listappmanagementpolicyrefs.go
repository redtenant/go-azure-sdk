...
// this application.
func (c AppManagementPolicyClient) ListAppManagementPolicyRefs(ctx context.Context, id beta.ApplicationId, options ListAppManagementPolicyRefsOperationOptions) (result ListAppManagementPolicyRefsOperationResponse, err error) {
...
func (c AppManagementPolicyClient) ListAppManagementPolicyRefsComplete(ctx context.Context, id beta.ApplicationId, options ListAppManagementPolicyRefsOperationOptions) (ListAppManagementPolicyRefsCompleteResult, error) {
...
func (c AppManagementPolicyClient) ListAppManagementPolicyRefsCompleteMatchingPredicate(ctx context.Context, id beta.ApplicationId, options ListAppManagementPolicyRefsOperationOptions, predicate DirectoryObjectOperationPredicate) (result ListAppManagementPolicyRefsCompleteResult, err error) {
