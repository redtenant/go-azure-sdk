...
// Read-only.
func (c CreatedOnBehalfOfClient) GetCreatedOnBehalfOf(ctx context.Context, id beta.ApplicationId, options GetCreatedOnBehalfOfOperationOptions) (result GetCreatedOnBehalfOfOperationResponse, err error) {
