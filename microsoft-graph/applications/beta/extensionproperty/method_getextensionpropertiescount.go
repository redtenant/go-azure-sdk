...
func (c ExtensionPropertyClient) GetExtensionPropertiesCount(ctx context.Context, id beta.ApplicationId, options GetExtensionPropertiesCountOperationOptions) (result GetExtensionPropertiesCountOperationResponse, err error) {
