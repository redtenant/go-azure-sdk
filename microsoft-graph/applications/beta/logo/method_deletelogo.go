...
type DeleteLogoOperationResponse struct {
...
func DefaultDeleteLogoOperationOptions() DeleteLogoOperationOptions {
	return DeleteLogoOperationOptions{}
}
...
func (c LogoClient) DeleteLogo(ctx context.Context, id beta.ApplicationId, options DeleteLogoOperationOptions) (result DeleteLogoOperationResponse, err error) {
