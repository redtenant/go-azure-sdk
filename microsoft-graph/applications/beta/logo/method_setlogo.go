...
func (c LogoClient) SetLogo(ctx context.Context, id beta.ApplicationId, input []byte, options SetLogoOperationOptions) (result SetLogoOperationResponse, err error) {
