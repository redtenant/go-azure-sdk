...
// AddOwnerRef - Add owner. Use this API to add an owner to an application by posting to the owners collection.
func (c OwnerClient) AddOwnerRef(ctx context.Context, id beta.ApplicationId, input beta.ReferenceCreate, options AddOwnerRefOperationOptions) (result AddOwnerRefOperationResponse, err error) {
