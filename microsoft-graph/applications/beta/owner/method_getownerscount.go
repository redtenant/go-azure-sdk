...
func (c OwnerClient) GetOwnersCount(ctx context.Context, id beta.ApplicationId, options GetOwnersCountOperationOptions) (result GetOwnersCountOperationResponse, err error) {
