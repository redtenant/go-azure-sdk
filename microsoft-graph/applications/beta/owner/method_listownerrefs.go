...
func (c OwnerClient) ListOwnerRefs(ctx context.Context, id beta.ApplicationId, options ListOwnerRefsOperationOptions) (result ListOwnerRefsOperationResponse, err error) {
...
func (c OwnerClient) ListOwnerRefsComplete(ctx context.Context, id beta.ApplicationId, options ListOwnerRefsOperationOptions) (ListOwnerRefsCompleteResult, error) {
...
func (c OwnerClient) ListOwnerRefsCompleteMatchingPredicate(ctx context.Context, id beta.ApplicationId, options ListOwnerRefsOperationOptions, predicate DirectoryObjectOperationPredicate) (result ListOwnerRefsCompleteResult, err error) {
