...
func (c OwnerClient) ListOwners(ctx context.Context, id beta.ApplicationId, options ListOwnersOperationOptions) (result ListOwnersOperationResponse, err error) {
...
func (c OwnerClient) ListOwnersComplete(ctx context.Context, id beta.ApplicationId, options ListOwnersOperationOptions) (ListOwnersCompleteResult, error) {
...
func (c OwnerClient) ListOwnersCompleteMatchingPredicate(ctx context.Context, id beta.ApplicationId, options ListOwnersOperationOptions, predicate DirectoryObjectOperationPredicate) (result ListOwnersCompleteResult, err error) {
