...
// RemoveOwnerRef - Remove owner. Remove an owner from an application. As a recommended best practice, apps should have
// at least two owners.
func (c OwnerClient) RemoveOwnerRef(ctx context.Context, id beta.ApplicationIdOwnerId, options RemoveOwnerRefOperationOptions) (result RemoveOwnerRefOperationResponse, err error) {
