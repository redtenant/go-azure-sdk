...
// RemoveOwnerRefs - Remove owner. Remove an owner from an application. As a recommended best practice, apps should have
// at least two owners.
func (c OwnerClient) RemoveOwnerRefs(ctx context.Context, id beta.ApplicationId, options RemoveOwnerRefsOperationOptions) (result RemoveOwnerRefsOperationResponse, err error) {
