...
func (c SynchronizationClient) AcquireSynchronizationAccessToken(ctx context.Context, id beta.ApplicationId, input AcquireSynchronizationAccessTokenRequest, options AcquireSynchronizationAccessTokenOperationOptions) (result AcquireSynchronizationAccessTokenOperationResponse, err error) {
