...
func (c SynchronizationClient) DeleteSynchronization(ctx context.Context, id beta.ApplicationId, options DeleteSynchronizationOperationOptions) (result DeleteSynchronizationOperationResponse, err error) {
