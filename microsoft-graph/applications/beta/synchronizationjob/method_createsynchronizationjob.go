...
func (c SynchronizationJobClient) CreateSynchronizationJob(ctx context.Context, id beta.ApplicationId, input beta.SynchronizationJob, options CreateSynchronizationJobOperationOptions) (result CreateSynchronizationJobOperationResponse, err error) {
