...
func (c SynchronizationJobClient) DeleteSynchronizationJob(ctx context.Context, id beta.ApplicationIdSynchronizationJobId, options DeleteSynchronizationJobOperationOptions) (result DeleteSynchronizationJobOperationResponse, err error) {
