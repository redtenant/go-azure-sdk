...
func (c SynchronizationJobClient) GetSynchronizationJobsCount(ctx context.Context, id beta.ApplicationId, options GetSynchronizationJobsCountOperationOptions) (result GetSynchronizationJobsCountOperationResponse, err error) {
