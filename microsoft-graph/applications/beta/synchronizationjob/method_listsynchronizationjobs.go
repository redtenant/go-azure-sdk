...
type ListSynchronizationJobsOperationResponse struct {
	...
	OData        *odata.OData
	Model        *[]beta.SynchronizationJob
}

type ListSynchronizationJobsCompleteResult struct {
	LatestHttpResponse *http.Response
	Items              []beta.SynchronizationJob
}
...
// ListSynchronizationJobs - Get jobs from applications. Performs synchronization by periodically running in the
// background, polling for changes in one directory, and pushing them to another directory.
func (c SynchronizationJobClient) ListSynchronizationJobs(ctx context.Context, id beta.ApplicationId, options ListSynchronizationJobsOperationOptions) (result ListSynchronizationJobsOperationResponse, err error) {
	...
	var values struct {
		Values *[]beta.SynchronizationJob `json:"value"`
	}
...
func (c SynchronizationJobClient) ListSynchronizationJobsComplete(ctx context.Context, id beta.ApplicationId, options ListSynchronizationJobsOperationOptions) (ListSynchronizationJobsCompleteResult, error) {
...
func (c SynchronizationJobClient) ListSynchronizationJobsCompleteMatchingPredicate(ctx context.Context, id beta.ApplicationId, options ListSynchronizationJobsOperationOptions, predicate SynchronizationJobOperationPredicate) (result ListSynchronizationJobsCompleteResult, err error) {
	items := make([]beta.SynchronizationJob, 0)
