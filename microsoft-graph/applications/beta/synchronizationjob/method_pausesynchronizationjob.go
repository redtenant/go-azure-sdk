...
func (c SynchronizationJobClient) PauseSynchronizationJob(ctx context.Context, id beta.ApplicationIdSynchronizationJobId, options PauseSynchronizationJobOperationOptions) (result PauseSynchronizationJobOperationResponse, err error) {
