...
func (c SynchronizationJobClient) StartSynchronizationJob(ctx context.Context, id beta.ApplicationIdSynchronizationJobId, options StartSynchronizationJobOperationOptions) (result StartSynchronizationJobOperationResponse, err error) {
