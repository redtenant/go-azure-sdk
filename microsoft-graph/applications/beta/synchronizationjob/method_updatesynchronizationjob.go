...
func (c SynchronizationJobClient) UpdateSynchronizationJob(ctx context.Context, id beta.ApplicationIdSynchronizationJobId, input beta.SynchronizationJob, options UpdateSynchronizationJobOperationOptions) (result UpdateSynchronizationJobOperationResponse, err error) {
