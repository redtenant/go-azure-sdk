...
func (c SynchronizationJobBulkUploadClient) DeleteSynchronizationJobBulkUpload(ctx context.Context, id beta.ApplicationIdSynchronizationJobId, options DeleteSynchronizationJobBulkUploadOperationOptions) (result DeleteSynchronizationJobBulkUploadOperationResponse, err error) {
