...
// GetSynchronizationJobBulkUpload - Get bulkUpload from applications. The bulk upload operation for the job.
func (c SynchronizationJobBulkUploadClient) GetSynchronizationJobBulkUpload(ctx context.Context, id beta.ApplicationIdSynchronizationJobId, options GetSynchronizationJobBulkUploadOperationOptions) (result GetSynchronizationJobBulkUploadOperationResponse, err error) {
