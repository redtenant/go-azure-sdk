...
func (c SynchronizationJobBulkUploadClient) GetSynchronizationJobBulkUploadValue(ctx context.Context, id beta.ApplicationIdSynchronizationJobId, options GetSynchronizationJobBulkUploadValueOperationOptions) (result GetSynchronizationJobBulkUploadValueOperationResponse, err error) {
