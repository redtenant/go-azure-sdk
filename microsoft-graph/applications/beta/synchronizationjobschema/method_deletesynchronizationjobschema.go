...
func (c SynchronizationJobSchemaClient) DeleteSynchronizationJobSchema(ctx context.Context, id beta.ApplicationIdSynchronizationJobId, options DeleteSynchronizationJobSchemaOperationOptions) (result DeleteSynchronizationJobSchemaOperationResponse, err error) {
