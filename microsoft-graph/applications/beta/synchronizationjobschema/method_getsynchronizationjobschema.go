...
func (c SynchronizationJobSchemaClient) GetSynchronizationJobSchema(ctx context.Context, id beta.ApplicationIdSynchronizationJobId, options GetSynchronizationJobSchemaOperationOptions) (result GetSynchronizationJobSchemaOperationResponse, err error) {
