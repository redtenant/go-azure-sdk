...
func (c SynchronizationJobSchemaClient) UpdateSynchronizationJobSchema(ctx context.Context, id beta.ApplicationIdSynchronizationJobId, input beta.SynchronizationSchema, options UpdateSynchronizationJobSchemaOperationOptions) (result UpdateSynchronizationJobSchemaOperationResponse, err error) {
