...
// CreateSynchronizationJobSchemaDirectory - Create new navigation property to directories for applications
func (c SynchronizationJobSchemaDirectoryClient) CreateSynchronizationJobSchemaDirectory(ctx context.Context, id beta.ApplicationIdSynchronizationJobId, input beta.DirectoryDefinition, options CreateSynchronizationJobSchemaDirectoryOperationOptions) (result CreateSynchronizationJobSchemaDirectoryOperationResponse, err error) {
