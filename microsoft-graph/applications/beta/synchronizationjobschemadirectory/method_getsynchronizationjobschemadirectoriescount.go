...
func (c SynchronizationJobSchemaDirectoryClient) GetSynchronizationJobSchemaDirectoriesCount(ctx context.Context, id beta.ApplicationIdSynchronizationJobId, options GetSynchronizationJobSchemaDirectoriesCountOperationOptions) (result GetSynchronizationJobSchemaDirectoriesCountOperationResponse, err error) {
