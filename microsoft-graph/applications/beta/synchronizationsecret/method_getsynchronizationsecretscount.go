...
func (c SynchronizationSecretClient) GetSynchronizationSecretsCount(ctx context.Context, id beta.ApplicationId, options GetSynchronizationSecretsCountOperationOptions) (result GetSynchronizationSecretsCountOperationResponse, err error) {
