...
func (c SynchronizationTemplateClient) UpdateSynchronizationTemplate(ctx context.Context, id beta.ApplicationIdSynchronizationTemplateId, input beta.SynchronizationTemplate, options UpdateSynchronizationTemplateOperationOptions) (result UpdateSynchronizationTemplateOperationResponse, err error) {
