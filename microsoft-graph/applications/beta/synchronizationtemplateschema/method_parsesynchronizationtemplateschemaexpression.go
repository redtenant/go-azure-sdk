...
func (c SynchronizationTemplateSchemaClient) ParseSynchronizationTemplateSchemaExpression(ctx context.Context, id beta.ApplicationIdSynchronizationTemplateId, input ParseSynchronizationTemplateSchemaExpressionRequest, options ParseSynchronizationTemplateSchemaExpressionOperationOptions) (result ParseSynchronizationTemplateSchemaExpressionOperationResponse, err error) {
