...
func (c SynchronizationTemplateSchemaClient) UpdateSynchronizationTemplateSchema(ctx context.Context, id beta.ApplicationIdSynchronizationTemplateId, input beta.SynchronizationSchema, options UpdateSynchronizationTemplateSchemaOperationOptions) (result UpdateSynchronizationTemplateSchemaOperationResponse, err error) {
