...
func (c SynchronizationTemplateSchemaDirectoryClient) CreateSynchronizationTemplateSchemaDirectory(ctx context.Context, id beta.ApplicationIdSynchronizationTemplateId, input beta.DirectoryDefinition, options CreateSynchronizationTemplateSchemaDirectoryOperationOptions) (result CreateSynchronizationTemplateSchemaDirectoryOperationResponse, err error) {
