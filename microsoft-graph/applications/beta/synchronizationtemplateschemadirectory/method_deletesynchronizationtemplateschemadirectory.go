...
func (c SynchronizationTemplateSchemaDirectoryClient) DeleteSynchronizationTemplateSchemaDirectory(ctx context.Context, id beta.ApplicationIdSynchronizationTemplateIdSchemaDirectoryId, options DeleteSynchronizationTemplateSchemaDirectoryOperationOptions) (result DeleteSynchronizationTemplateSchemaDirectoryOperationResponse, err error) {
