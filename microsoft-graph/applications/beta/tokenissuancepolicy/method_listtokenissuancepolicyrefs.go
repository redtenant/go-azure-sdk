...
func (c TokenIssuancePolicyClient) ListTokenIssuancePolicyRefs(ctx context.Context, id beta.ApplicationId, options ListTokenIssuancePolicyRefsOperationOptions) (result ListTokenIssuancePolicyRefsOperationResponse, err error) {
...
func (c TokenIssuancePolicyClient) ListTokenIssuancePolicyRefsComplete(ctx context.Context, id beta.ApplicationId, options ListTokenIssuancePolicyRefsOperationOptions) (ListTokenIssuancePolicyRefsCompleteResult, error) {
...
func (c TokenIssuancePolicyClient) ListTokenIssuancePolicyRefsCompleteMatchingPredicate(ctx context.Context, id beta.ApplicationId, options ListTokenIssuancePolicyRefsOperationOptions, predicate DirectoryObjectOperationPredicate) (result ListTokenIssuancePolicyRefsCompleteResult, err error) {
