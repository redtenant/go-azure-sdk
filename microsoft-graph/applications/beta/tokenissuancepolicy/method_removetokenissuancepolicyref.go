...
func (c TokenIssuancePolicyClient) RemoveTokenIssuancePolicyRef(ctx context.Context, id beta.ApplicationIdTokenIssuancePolicyId, options RemoveTokenIssuancePolicyRefOperationOptions) (result RemoveTokenIssuancePolicyRefOperationResponse, err error) {
