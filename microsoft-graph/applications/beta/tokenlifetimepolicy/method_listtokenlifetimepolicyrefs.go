...
// ListTokenLifetimePolicyRefs - List assigned tokenLifetimePolicy. List the tokenLifetimePolicy objects that are
// assigned to an application or servicePrincipal. Only one object is returned in the collection because only one
