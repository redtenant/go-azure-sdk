...
// existing valid certificates (no certificates have been added yet, or all certificates have expired), won’t be able
// to use this service action. You can use the Update application operation to perform an update instead.
func (c ApplicationClient) AddKey(ctx context.Context, id stable.ApplicationId, input AddKeyRequest, options AddKeyOperationOptions) (result AddKeyOperationResponse, err error) {
