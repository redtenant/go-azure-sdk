...
func (c ApplicationClient) CheckMemberGroups(ctx context.Context, id stable.ApplicationId, input CheckMemberGroupsRequest, options CheckMemberGroupsOperationOptions) (result CheckMemberGroupsOperationResponse, err error) {
...
func (c ApplicationClient) CheckMemberGroupsComplete(ctx context.Context, id stable.ApplicationId, input CheckMemberGroupsRequest, options CheckMemberGroupsOperationOptions) (result CheckMemberGroupsCompleteResult, err error) {
	items := make([]string, 0)
