...
func (c ApplicationClient) CheckMemberObjects(ctx context.Context, id stable.ApplicationId, input CheckMemberObjectsRequest, options CheckMemberObjectsOperationOptions) (result CheckMemberObjectsOperationResponse, err error) {
...
func (c ApplicationClient) CheckMemberObjectsComplete(ctx context.Context, id stable.ApplicationId, input CheckMemberObjectsRequest, options CheckMemberObjectsOperationOptions) (result CheckMemberObjectsCompleteResult, err error) {
	items := make([]string, 0)
