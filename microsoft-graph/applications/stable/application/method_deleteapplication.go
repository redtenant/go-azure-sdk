...
// DeleteApplication - Delete application. Delete an application object. When deleted, apps are moved to a temporary
// container and can be restored within 30 days. After that time, they are permanently deleted.
func (c ApplicationClient) DeleteApplication(ctx context.Context, id stable.ApplicationId, options DeleteApplicationOperationOptions) (result DeleteApplicationOperationResponse, err error) {
