...
func (c ApplicationClient) GetApplication(ctx context.Context, id stable.ApplicationId, options GetApplicationOperationOptions) (result GetApplicationOperationResponse, err error) {
