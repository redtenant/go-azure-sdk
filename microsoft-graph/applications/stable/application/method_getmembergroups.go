...
func (c ApplicationClient) GetMemberGroups(ctx context.Context, id stable.ApplicationId, input GetMemberGroupsRequest, options GetMemberGroupsOperationOptions) (result GetMemberGroupsOperationResponse, err error) {
...
func (c ApplicationClient) GetMemberGroupsComplete(ctx context.Context, id stable.ApplicationId, input GetMemberGroupsRequest, options GetMemberGroupsOperationOptions) (result GetMemberGroupsCompleteResult, err error) {
	items := make([]string, 0)
