...
// RemovePassword - Invoke action removePassword. Remove a password from an application.
func (c ApplicationClient) RemovePassword(ctx context.Context, id stable.ApplicationId, input RemovePasswordRequest, options RemovePasswordOperationOptions) (result RemovePasswordOperationResponse, err error) {
