...
func (c ApplicationClient) UnsetVerifiedPublisher(ctx context.Context, id stable.ApplicationId, options UnsetVerifiedPublisherOperationOptions) (result UnsetVerifiedPublisherOperationResponse, err error) {
