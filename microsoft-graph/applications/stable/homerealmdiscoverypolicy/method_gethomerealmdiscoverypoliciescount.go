...
func (c HomeRealmDiscoveryPolicyClient) GetHomeRealmDiscoveryPoliciesCount(ctx context.Context, id stable.ApplicationId, options GetHomeRealmDiscoveryPoliciesCountOperationOptions) (result GetHomeRealmDiscoveryPoliciesCountOperationResponse, err error) {
