...
func (c HomeRealmDiscoveryPolicyClient) GetHomeRealmDiscoveryPolicy(ctx context.Context, id stable.ApplicationIdHomeRealmDiscoveryPolicyId, options GetHomeRealmDiscoveryPolicyOperationOptions) (result GetHomeRealmDiscoveryPolicyOperationResponse, err error) {
