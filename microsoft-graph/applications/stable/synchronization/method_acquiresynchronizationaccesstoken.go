...
func (c SynchronizationClient) AcquireSynchronizationAccessToken(ctx context.Context, id stable.ApplicationId, input AcquireSynchronizationAccessTokenRequest, options AcquireSynchronizationAccessTokenOperationOptions) (result AcquireSynchronizationAccessTokenOperationResponse, err error) {
