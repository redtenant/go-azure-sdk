...
// DeleteSynchronization - Delete navigation property synchronization for applications
func (c SynchronizationClient) DeleteSynchronization(ctx context.Context, id stable.ApplicationId, options DeleteSynchronizationOperationOptions) (result DeleteSynchronizationOperationResponse, err error) {
