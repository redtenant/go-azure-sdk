...
func (c SynchronizationClient) GetSynchronization(ctx context.Context, id stable.ApplicationId, options GetSynchronizationOperationOptions) (result GetSynchronizationOperationResponse, err error) {
	...
	var model stable.Synchronization
	result.Model = &model
