...
// DeleteSynchronizationJobBulkUpload - Delete navigation property bulkUpload for applications
func (c SynchronizationJobBulkUploadClient) DeleteSynchronizationJobBulkUpload(ctx context.Context, id stable.ApplicationIdSynchronizationJobId, options DeleteSynchronizationJobBulkUploadOperationOptions) (result DeleteSynchronizationJobBulkUploadOperationResponse, err error) {
