...
func (c SynchronizationJobBulkUploadClient) GetSynchronizationJobBulkUpload(ctx context.Context, id stable.ApplicationIdSynchronizationJobId, options GetSynchronizationJobBulkUploadOperationOptions) (result GetSynchronizationJobBulkUploadOperationResponse, err error) {
