...
type GetSynchronizationJobBulkUploadValueOperationResponse struct {
...
// GetSynchronizationJobBulkUploadValue - Get media content for the navigation property bulkUpload from applications.
// The bulk upload operation for the job.
func (c SynchronizationJobBulkUploadClient) GetSynchronizationJobBulkUploadValue(ctx context.Context, id stable.ApplicationIdSynchronizationJobId, options GetSynchronizationJobBulkUploadValueOperationOptions) (result GetSynchronizationJobBulkUploadValueOperationResponse, err error) {
