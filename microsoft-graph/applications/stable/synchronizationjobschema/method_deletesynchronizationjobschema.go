...
func (c SynchronizationJobSchemaClient) DeleteSynchronizationJobSchema(ctx context.Context, id stable.ApplicationIdSynchronizationJobId, options DeleteSynchronizationJobSchemaOperationOptions) (result DeleteSynchronizationJobSchemaOperationResponse, err error) {
