...
func (c SynchronizationJobSchemaClient) GetSynchronizationJobSchema(ctx context.Context, id stable.ApplicationIdSynchronizationJobId, options GetSynchronizationJobSchemaOperationOptions) (result GetSynchronizationJobSchemaOperationResponse, err error) {
