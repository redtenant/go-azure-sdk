...
func (c SynchronizationJobSchemaDirectoryClient) GetSynchronizationJobSchemaDirectoriesCount(ctx context.Context, id stable.ApplicationIdSynchronizationJobId, options GetSynchronizationJobSchemaDirectoriesCountOperationOptions) (result GetSynchronizationJobSchemaDirectoriesCountOperationResponse, err error) {
