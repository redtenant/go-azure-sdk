...
func (c SynchronizationJobSchemaDirectoryClient) GetSynchronizationJobSchemaDirectory(ctx context.Context, id stable.ApplicationIdSynchronizationJobIdSchemaDirectoryId, options GetSynchronizationJobSchemaDirectoryOperationOptions) (result GetSynchronizationJobSchemaDirectoryOperationResponse, err error) {
