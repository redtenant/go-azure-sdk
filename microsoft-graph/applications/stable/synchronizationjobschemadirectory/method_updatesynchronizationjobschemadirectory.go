...
func (c SynchronizationJobSchemaDirectoryClient) UpdateSynchronizationJobSchemaDirectory(ctx context.Context, id stable.ApplicationIdSynchronizationJobIdSchemaDirectoryId, input stable.DirectoryDefinition, options UpdateSynchronizationJobSchemaDirectoryOperationOptions) (result UpdateSynchronizationJobSchemaDirectoryOperationResponse, err error) {
