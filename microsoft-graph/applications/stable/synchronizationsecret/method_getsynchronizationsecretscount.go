...
func (c SynchronizationSecretClient) GetSynchronizationSecretsCount(ctx context.Context, id stable.ApplicationId, options GetSynchronizationSecretsCountOperationOptions) (result GetSynchronizationSecretsCountOperationResponse, err error) {
