...
func (c SynchronizationSecretClient) ListSynchronizationSecrets(ctx context.Context, id stable.ApplicationId, options ListSynchronizationSecretsOperationOptions) (result ListSynchronizationSecretsOperationResponse, err error) {
...
func (c SynchronizationSecretClient) ListSynchronizationSecretsComplete(ctx context.Context, id stable.ApplicationId, options ListSynchronizationSecretsOperationOptions) (ListSynchronizationSecretsCompleteResult, error) {
...
func (c SynchronizationSecretClient) ListSynchronizationSecretsCompleteMatchingPredicate(ctx context.Context, id stable.ApplicationId, options ListSynchronizationSecretsOperationOptions, predicate SynchronizationSecretKeyStringValuePairOperationPredicate) (result ListSynchronizationSecretsCompleteResult, err error) {
