...
func (c SynchronizationSecretClient) SetSynchronizationSecret(ctx context.Context, id stable.ApplicationId, input SetSynchronizationSecretRequest, options SetSynchronizationSecretOperationOptions) (result SetSynchronizationSecretOperationResponse, err error) {
