...
func (c SynchronizationTemplateClient) GetSynchronizationTemplatesCount(ctx context.Context, id stable.ApplicationId, options GetSynchronizationTemplatesCountOperationOptions) (result GetSynchronizationTemplatesCountOperationResponse, err error) {
