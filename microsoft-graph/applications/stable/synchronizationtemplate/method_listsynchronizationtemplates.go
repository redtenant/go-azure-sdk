...
type ListSynchronizationTemplatesCompleteResult struct {
	...
	Items              []stable.SynchronizationTemplate
}
...
// ListSynchronizationTemplates - Get templates from applications. Preconfigured synchronization settings for a
// particular application.
func (c SynchronizationTemplateClient) ListSynchronizationTemplates(ctx context.Context, id stable.ApplicationId, options ListSynchronizationTemplatesOperationOptions) (result ListSynchronizationTemplatesOperationResponse, err error) {
	...
	var values struct {
		Values *[]stable.SynchronizationTemplate `json:"value"`
	}
...
func (c SynchronizationTemplateClient) ListSynchronizationTemplatesComplete(ctx context.Context, id stable.ApplicationId, options ListSynchronizationTemplatesOperationOptions) (ListSynchronizationTemplatesCompleteResult, error) {
...
func (c SynchronizationTemplateClient) ListSynchronizationTemplatesCompleteMatchingPredicate(ctx context.Context, id stable.ApplicationId, options ListSynchronizationTemplatesOperationOptions, predicate SynchronizationTemplateOperationPredicate) (result ListSynchronizationTemplatesCompleteResult, err error) {
	items := make([]stable.SynchronizationTemplate, 0)
