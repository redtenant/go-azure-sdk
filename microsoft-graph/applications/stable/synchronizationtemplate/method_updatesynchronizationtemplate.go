...
// UpdateSynchronizationTemplate - Update synchronizationTemplate. Update (override) the synchronization template
// associated with a given application.
func (c SynchronizationTemplateClient) UpdateSynchronizationTemplate(ctx context.Context, id stable.ApplicationIdSynchronizationTemplateId, input stable.SynchronizationTemplate, options UpdateSynchronizationTemplateOperationOptions) (result UpdateSynchronizationTemplateOperationResponse, err error) {
