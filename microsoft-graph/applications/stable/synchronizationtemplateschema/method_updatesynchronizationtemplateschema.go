...
// UpdateSynchronizationTemplateSchema - Update the navigation property schema in applications
func (c SynchronizationTemplateSchemaClient) UpdateSynchronizationTemplateSchema(ctx context.Context, id stable.ApplicationIdSynchronizationTemplateId, input stable.SynchronizationSchema, options UpdateSynchronizationTemplateSchemaOperationOptions) (result UpdateSynchronizationTemplateSchemaOperationResponse, err error) {
