...
type GetApplicationTemplateOperationResponse struct {
	...
	OData        *odata.OData
	Model        *beta.ApplicationTemplate
}
...
func (c ApplicationTemplateClient) GetApplicationTemplate(ctx context.Context, id beta.ApplicationTemplateId, options GetApplicationTemplateOperationOptions) (result GetApplicationTemplateOperationResponse, err error) {
	...
	var model beta.ApplicationTemplate
	result.Model = &model
