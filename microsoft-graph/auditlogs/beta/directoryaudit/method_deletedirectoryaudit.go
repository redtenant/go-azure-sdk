...
func (c DirectoryAuditClient) DeleteDirectoryAudit(ctx context.Context, id beta.AuditLogDirectoryAuditId, options DeleteDirectoryAuditOperationOptions) (result DeleteDirectoryAuditOperationResponse, err error) {
