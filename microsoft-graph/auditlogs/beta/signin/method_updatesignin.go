...
func (c SignInClient) UpdateSignIn(ctx context.Context, id beta.AuditLogSignInId, input beta.SignIn, options UpdateSignInOperationOptions) (result UpdateSignInOperationResponse, err error) {
