...
// GetProvisioning - Get provisioning from auditLogs
func (c ProvisioningClient) GetProvisioning(ctx context.Context, id stable.AuditLogProvisioningId, options GetProvisioningOperationOptions) (result GetProvisioningOperationResponse, err error) {
	...
	var model stable.ProvisioningObjectSummary
	result.Model = &model
