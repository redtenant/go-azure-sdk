...
type CreateSignInOperationResponse struct {
...
func (c SignInClient) CreateSignIn(ctx context.Context, input stable.SignIn, options CreateSignInOperationOptions) (result CreateSignInOperationResponse, err error) {
