...
func TestNewIdentityB2cUserFlowIdLanguageID(t *testing.T) {
	id := NewIdentityB2cUserFlowIdLanguageID("b2cIdentityUserFlowId", "userFlowLanguageConfigurationId")
...
func TestFormatIdentityB2cUserFlowIdLanguageID(t *testing.T) {
	actual := NewIdentityB2cUserFlowIdLanguageID("b2cIdentityUserFlowId", "userFlowLanguageConfigurationId").ID()
	expected := "/identity/b2cUserFlows/b2cIdentityUserFlowId/languages/userFlowLanguageConfigurationId"
	if actual != expected {
		t.Fatalf("Expected the Formatted ID to be %q but got %q", expected, actual)
	}
}

func TestParseIdentityB2cUserFlowIdLanguageID(t *testing.T) {
	testData := []struct {
		Input    string
		Error    bool
		Expected *IdentityB2cUserFlowIdLanguageId
	}{
		{
			// Incomplete URI
			Input: "",
		...
		},
		{
			...
			Input: "/identity/b2cUserFlows/b2cIdentityUserFlowId/languages/userFlowLanguageConfigurationId/extra",
			Error: true,
		},
	}
	for _, v := range testData {
		...
		actual, err := ParseIdentityB2cUserFlowIdLanguageID(v.Input)
		if err != nil {
			if v.Error {
				continue
			}
...
func TestParseIdentityB2cUserFlowIdLanguageIDInsensitively(t *testing.T) {
	testData := []struct {
		Input    string
		Error    bool
		Expected *IdentityB2cUserFlowIdLanguageId
	...
	for _, v := range testData {
		...
		actual, err := ParseIdentityB2cUserFlowIdLanguageIDInsensitively(v.Input)
		if err != nil {
			if v.Error {
				continue
			}
...
func TestSegmentsForIdentityB2cUserFlowIdLanguageId(t *testing.T) {
	segments := IdentityB2cUserFlowIdLanguageId{}.Segments()
	if len(segments) == 0 {
		t.Fatalf("IdentityB2cUserFlowIdLanguageId has no segments")
	}
