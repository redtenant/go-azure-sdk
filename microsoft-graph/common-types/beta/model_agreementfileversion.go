...
var _ AgreementFileProperties = AgreementFileVersion{}
...
func (s AgreementFileVersion) AgreementFileProperties() BaseAgreementFilePropertiesImpl {
...
func (s AgreementFileVersion) Entity() BaseEntityImpl {
...
var _ json.Marshaler = AgreementFileVersion{}

func (s AgreementFileVersion) MarshalJSON() ([]byte, error) {
	type wrapper AgreementFileVersion
	wrapped := wrapper(s)
	encoded, err := json.Marshal(wrapped)
	if err != nil {
		return nil, fmt.Errorf("marshaling AgreementFileVersion: %+v", err)
	}

	var decoded map[string]interface{}
	if err = json.Unmarshal(encoded, &decoded); err != nil {
		return nil, fmt.Errorf("unmarshaling AgreementFileVersion: %+v", err)
	}

	if !s.OmitDiscriminatedValue {
		decoded["@odata.type"] = "#microsoft.graph.agreementFileVersion"
	}

	encoded, err = json.Marshal(decoded)
	if err != nil {
		return nil, fmt.Errorf("re-marshaling AgreementFileVersion: %+v", err)
	}
