...
var _ AndroidDeviceOwnerWiFiConfiguration = AndroidDeviceOwnerEnterpriseWiFiConfiguration{}
...
type AndroidDeviceOwnerEnterpriseWiFiConfiguration struct {
	...
	// Fields inherited from AndroidDeviceOwnerWiFiConfiguration
...
func (s AndroidDeviceOwnerEnterpriseWiFiConfiguration) AndroidDeviceOwnerWiFiConfiguration() BaseAndroidDeviceOwnerWiFiConfigurationImpl {
	return BaseAndroidDeviceOwnerWiFiConfigurationImpl{
		ConnectAutomatically:           s.ConnectAutomatically,
		ConnectWhenNetworkNameIsHidden: s.ConnectWhenNetworkNameIsHidden,
		MacAddressRandomizationMode:    s.MacAddressRandomizationMode,
...
func (s AndroidDeviceOwnerEnterpriseWiFiConfiguration) DeviceConfiguration() BaseDeviceConfigurationImpl {
...
func (s AndroidDeviceOwnerEnterpriseWiFiConfiguration) Entity() BaseEntityImpl {
...
var _ json.Marshaler = AndroidDeviceOwnerEnterpriseWiFiConfiguration{}

func (s AndroidDeviceOwnerEnterpriseWiFiConfiguration) MarshalJSON() ([]byte, error) {
	type wrapper AndroidDeviceOwnerEnterpriseWiFiConfiguration
	wrapped := wrapper(s)
	encoded, err := json.Marshal(wrapped)
	if err != nil {
		return nil, fmt.Errorf("marshaling AndroidDeviceOwnerEnterpriseWiFiConfiguration: %+v", err)
	}

	var decoded map[string]interface{}
	if err = json.Unmarshal(encoded, &decoded); err != nil {
		return nil, fmt.Errorf("unmarshaling AndroidDeviceOwnerEnterpriseWiFiConfiguration: %+v", err)
	}

	if !s.OmitDiscriminatedValue {
		decoded["@odata.type"] = "#microsoft.graph.androidDeviceOwnerEnterpriseWiFiConfiguration"
	}

	encoded, err = json.Marshal(decoded)
	if err != nil {
		return nil, fmt.Errorf("re-marshaling AndroidDeviceOwnerEnterpriseWiFiConfiguration: %+v", err)
	}

	return encoded, nil
}

var _ json.Unmarshaler = &AndroidDeviceOwnerEnterpriseWiFiConfiguration{}

func (s *AndroidDeviceOwnerEnterpriseWiFiConfiguration) UnmarshalJSON(bytes []byte) error {
	var decoded struct {
		AuthenticationMethod                        *WiFiAuthenticationMethod                    `json:"authenticationMethod,omitempty"`
		DerivedCredentialSettings                   *DeviceManagementDerivedCredentialSettings   `json:"derivedCredentialSettings,omitempty"`
		EapType                                     *AndroidEapType                              `json:"eapType,omitempty"`
	...
	s.MacAddressRandomizationMode = decoded.MacAddressRandomizationMode
	...
	if err := json.Unmarshal(bytes, &temp); err != nil {
		return fmt.Errorf("unmarshaling AndroidDeviceOwnerEnterpriseWiFiConfiguration into map[string]json.RawMessage: %+v", err)
	}
	...
	if v, ok := temp["identityCertificateForClientAuthentication"]; ok {
		...
		if err != nil {
			return fmt.Errorf("unmarshaling field 'IdentityCertificateForClientAuthentication' for 'AndroidDeviceOwnerEnterpriseWiFiConfiguration': %+v", err)
		}
