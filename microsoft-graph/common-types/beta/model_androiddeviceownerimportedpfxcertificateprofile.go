...
var _ AndroidDeviceOwnerCertificateProfileBase = AndroidDeviceOwnerImportedPFXCertificateProfile{}
...
type AndroidDeviceOwnerImportedPFXCertificateProfile struct {
	...
	// Fields inherited from AndroidDeviceOwnerCertificateProfileBase
...
func (s AndroidDeviceOwnerImportedPFXCertificateProfile) AndroidDeviceOwnerCertificateProfileBase() BaseAndroidDeviceOwnerCertificateProfileBaseImpl {
	return BaseAndroidDeviceOwnerCertificateProfileBaseImpl{
...
func (s AndroidDeviceOwnerImportedPFXCertificateProfile) DeviceConfiguration() BaseDeviceConfigurationImpl {
...
func (s AndroidDeviceOwnerImportedPFXCertificateProfile) Entity() BaseEntityImpl {
...
var _ json.Marshaler = AndroidDeviceOwnerImportedPFXCertificateProfile{}

func (s AndroidDeviceOwnerImportedPFXCertificateProfile) MarshalJSON() ([]byte, error) {
	type wrapper AndroidDeviceOwnerImportedPFXCertificateProfile
	wrapped := wrapper(s)
	encoded, err := json.Marshal(wrapped)
	if err != nil {
		return nil, fmt.Errorf("marshaling AndroidDeviceOwnerImportedPFXCertificateProfile: %+v", err)
	}

	var decoded map[string]interface{}
	if err = json.Unmarshal(encoded, &decoded); err != nil {
		return nil, fmt.Errorf("unmarshaling AndroidDeviceOwnerImportedPFXCertificateProfile: %+v", err)
	}

	if !s.OmitDiscriminatedValue {
		decoded["@odata.type"] = "#microsoft.graph.androidDeviceOwnerImportedPFXCertificateProfile"
	}

	encoded, err = json.Marshal(decoded)
	if err != nil {
		return nil, fmt.Errorf("re-marshaling AndroidDeviceOwnerImportedPFXCertificateProfile: %+v", err)
	}
