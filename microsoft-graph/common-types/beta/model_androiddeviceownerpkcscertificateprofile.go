...
var _ AndroidDeviceOwnerCertificateProfileBase = AndroidDeviceOwnerPkcsCertificateProfile{}
...
func (s AndroidDeviceOwnerPkcsCertificateProfile) AndroidDeviceOwnerCertificateProfileBase() BaseAndroidDeviceOwnerCertificateProfileBaseImpl {
...
func (s AndroidDeviceOwnerPkcsCertificateProfile) DeviceConfiguration() BaseDeviceConfigurationImpl {
...
func (s AndroidDeviceOwnerPkcsCertificateProfile) Entity() BaseEntityImpl {
...
var _ json.Marshaler = AndroidDeviceOwnerPkcsCertificateProfile{}

func (s AndroidDeviceOwnerPkcsCertificateProfile) MarshalJSON() ([]byte, error) {
	type wrapper AndroidDeviceOwnerPkcsCertificateProfile
	wrapped := wrapper(s)
	encoded, err := json.Marshal(wrapped)
	if err != nil {
		return nil, fmt.Errorf("marshaling AndroidDeviceOwnerPkcsCertificateProfile: %+v", err)
	}

	var decoded map[string]interface{}
	if err = json.Unmarshal(encoded, &decoded); err != nil {
		return nil, fmt.Errorf("unmarshaling AndroidDeviceOwnerPkcsCertificateProfile: %+v", err)
	}

	if !s.OmitDiscriminatedValue {
		decoded["@odata.type"] = "#microsoft.graph.androidDeviceOwnerPkcsCertificateProfile"
	}

	encoded, err = json.Marshal(decoded)
	if err != nil {
		return nil, fmt.Errorf("re-marshaling AndroidDeviceOwnerPkcsCertificateProfile: %+v", err)
	}
