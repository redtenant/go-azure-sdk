...
var _ AndroidDeviceOwnerCertificateProfileBase = AndroidDeviceOwnerScepCertificateProfile{}
...
func (s AndroidDeviceOwnerScepCertificateProfile) AndroidDeviceOwnerCertificateProfileBase() BaseAndroidDeviceOwnerCertificateProfileBaseImpl {
...
func (s AndroidDeviceOwnerScepCertificateProfile) DeviceConfiguration() BaseDeviceConfigurationImpl {
...
func (s AndroidDeviceOwnerScepCertificateProfile) Entity() BaseEntityImpl {
...
var _ json.Marshaler = AndroidDeviceOwnerScepCertificateProfile{}

func (s AndroidDeviceOwnerScepCertificateProfile) MarshalJSON() ([]byte, error) {
	type wrapper AndroidDeviceOwnerScepCertificateProfile
	wrapped := wrapper(s)
	encoded, err := json.Marshal(wrapped)
	if err != nil {
		return nil, fmt.Errorf("marshaling AndroidDeviceOwnerScepCertificateProfile: %+v", err)
	}

	var decoded map[string]interface{}
	if err = json.Unmarshal(encoded, &decoded); err != nil {
		return nil, fmt.Errorf("unmarshaling AndroidDeviceOwnerScepCertificateProfile: %+v", err)
	}

	if !s.OmitDiscriminatedValue {
		decoded["@odata.type"] = "#microsoft.graph.androidDeviceOwnerScepCertificateProfile"
	}

	encoded, err = json.Marshal(decoded)
	if err != nil {
		return nil, fmt.Errorf("re-marshaling AndroidDeviceOwnerScepCertificateProfile: %+v", err)
	}
