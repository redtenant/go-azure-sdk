...
var _ DeviceCompliancePolicy = AndroidForWorkCompliancePolicy{}
...
func (s AndroidForWorkCompliancePolicy) DeviceCompliancePolicy() BaseDeviceCompliancePolicyImpl {
...
func (s AndroidForWorkCompliancePolicy) Entity() BaseEntityImpl {
...
var _ json.Marshaler = AndroidForWorkCompliancePolicy{}

func (s AndroidForWorkCompliancePolicy) MarshalJSON() ([]byte, error) {
	type wrapper AndroidForWorkCompliancePolicy
	wrapped := wrapper(s)
	encoded, err := json.Marshal(wrapped)
	if err != nil {
		return nil, fmt.Errorf("marshaling AndroidForWorkCompliancePolicy: %+v", err)
	}

	var decoded map[string]interface{}
	if err = json.Unmarshal(encoded, &decoded); err != nil {
		return nil, fmt.Errorf("unmarshaling AndroidForWorkCompliancePolicy: %+v", err)
	}

	if !s.OmitDiscriminatedValue {
		decoded["@odata.type"] = "#microsoft.graph.androidForWorkCompliancePolicy"
	}

	encoded, err = json.Marshal(decoded)
	if err != nil {
		return nil, fmt.Errorf("re-marshaling AndroidForWorkCompliancePolicy: %+v", err)
	}
