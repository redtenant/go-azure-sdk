...
var _ AndroidForWorkWiFiConfiguration = AndroidForWorkEnterpriseWiFiConfiguration{}
...
type AndroidForWorkEnterpriseWiFiConfiguration struct {
	...
	// Fields inherited from AndroidForWorkWiFiConfiguration
...
func (s AndroidForWorkEnterpriseWiFiConfiguration) AndroidForWorkWiFiConfiguration() BaseAndroidForWorkWiFiConfigurationImpl {
	return BaseAndroidForWorkWiFiConfigurationImpl{
...
func (s AndroidForWorkEnterpriseWiFiConfiguration) DeviceConfiguration() BaseDeviceConfigurationImpl {
...
func (s AndroidForWorkEnterpriseWiFiConfiguration) Entity() BaseEntityImpl {
...
var _ json.Marshaler = AndroidForWorkEnterpriseWiFiConfiguration{}

func (s AndroidForWorkEnterpriseWiFiConfiguration) MarshalJSON() ([]byte, error) {
	type wrapper AndroidForWorkEnterpriseWiFiConfiguration
	wrapped := wrapper(s)
	encoded, err := json.Marshal(wrapped)
	if err != nil {
		return nil, fmt.Errorf("marshaling AndroidForWorkEnterpriseWiFiConfiguration: %+v", err)
	}

	var decoded map[string]interface{}
	if err = json.Unmarshal(encoded, &decoded); err != nil {
		return nil, fmt.Errorf("unmarshaling AndroidForWorkEnterpriseWiFiConfiguration: %+v", err)
	}

	if !s.OmitDiscriminatedValue {
		decoded["@odata.type"] = "#microsoft.graph.androidForWorkEnterpriseWiFiConfiguration"
	}

	encoded, err = json.Marshal(decoded)
	if err != nil {
		return nil, fmt.Errorf("re-marshaling AndroidForWorkEnterpriseWiFiConfiguration: %+v", err)
	}

	return encoded, nil
}

var _ json.Unmarshaler = &AndroidForWorkEnterpriseWiFiConfiguration{}

func (s *AndroidForWorkEnterpriseWiFiConfiguration) UnmarshalJSON(bytes []byte) error {
	var decoded struct {
		AuthenticationMethod                        *WiFiAuthenticationMethod                    `json:"authenticationMethod,omitempty"`
		EapType                                     *AndroidEapType                              `json:"eapType,omitempty"`
		InnerAuthenticationProtocolForEapTtls       *NonEapAuthenticationMethodForEapTtlsType    `json:"innerAuthenticationProtocolForEapTtls,omitempty"`
	...
	if err := json.Unmarshal(bytes, &temp); err != nil {
		return fmt.Errorf("unmarshaling AndroidForWorkEnterpriseWiFiConfiguration into map[string]json.RawMessage: %+v", err)
	}
	...
	if v, ok := temp["identityCertificateForClientAuthentication"]; ok {
		...
		if err != nil {
			return fmt.Errorf("unmarshaling field 'IdentityCertificateForClientAuthentication' for 'AndroidForWorkEnterpriseWiFiConfiguration': %+v", err)
		}
