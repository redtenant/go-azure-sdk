...
var _ AndroidForWorkEasEmailProfileBase = AndroidForWorkGmailEasConfiguration{}
...
func (s AndroidForWorkGmailEasConfiguration) AndroidForWorkEasEmailProfileBase() BaseAndroidForWorkEasEmailProfileBaseImpl {
...
func (s AndroidForWorkGmailEasConfiguration) DeviceConfiguration() BaseDeviceConfigurationImpl {
...
func (s AndroidForWorkGmailEasConfiguration) Entity() BaseEntityImpl {
...
var _ json.Marshaler = AndroidForWorkGmailEasConfiguration{}

func (s AndroidForWorkGmailEasConfiguration) MarshalJSON() ([]byte, error) {
	type wrapper AndroidForWorkGmailEasConfiguration
	wrapped := wrapper(s)
	encoded, err := json.Marshal(wrapped)
	if err != nil {
		return nil, fmt.Errorf("marshaling AndroidForWorkGmailEasConfiguration: %+v", err)
	}

	var decoded map[string]interface{}
	if err = json.Unmarshal(encoded, &decoded); err != nil {
		return nil, fmt.Errorf("unmarshaling AndroidForWorkGmailEasConfiguration: %+v", err)
	}

	if !s.OmitDiscriminatedValue {
		decoded["@odata.type"] = "#microsoft.graph.androidForWorkGmailEasConfiguration"
	}

	encoded, err = json.Marshal(decoded)
	if err != nil {
		return nil, fmt.Errorf("re-marshaling AndroidForWorkGmailEasConfiguration: %+v", err)
	}
...
func (s *AndroidForWorkGmailEasConfiguration) UnmarshalJSON(bytes []byte) error {
	...
	if err := json.Unmarshal(bytes, &temp); err != nil {
		return fmt.Errorf("unmarshaling AndroidForWorkGmailEasConfiguration into map[string]json.RawMessage: %+v", err)
	}

	if v, ok := temp["identityCertificate"]; ok {
		impl, err := UnmarshalAndroidForWorkCertificateProfileBaseImplementation(v)
		if err != nil {
			return fmt.Errorf("unmarshaling field 'IdentityCertificate' for 'AndroidForWorkGmailEasConfiguration': %+v", err)
		}
