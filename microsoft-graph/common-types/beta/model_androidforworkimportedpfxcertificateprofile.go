...
var _ AndroidCertificateProfileBase = AndroidForWorkImportedPFXCertificateProfile{}
...
func (s AndroidForWorkImportedPFXCertificateProfile) AndroidCertificateProfileBase() BaseAndroidCertificateProfileBaseImpl {
...
func (s AndroidForWorkImportedPFXCertificateProfile) DeviceConfiguration() BaseDeviceConfigurationImpl {
...
func (s AndroidForWorkImportedPFXCertificateProfile) Entity() BaseEntityImpl {
...
var _ json.Marshaler = AndroidForWorkImportedPFXCertificateProfile{}

func (s AndroidForWorkImportedPFXCertificateProfile) MarshalJSON() ([]byte, error) {
	type wrapper AndroidForWorkImportedPFXCertificateProfile
	wrapped := wrapper(s)
	encoded, err := json.Marshal(wrapped)
	if err != nil {
		return nil, fmt.Errorf("marshaling AndroidForWorkImportedPFXCertificateProfile: %+v", err)
	}

	var decoded map[string]interface{}
	if err = json.Unmarshal(encoded, &decoded); err != nil {
		return nil, fmt.Errorf("unmarshaling AndroidForWorkImportedPFXCertificateProfile: %+v", err)
	}

	if !s.OmitDiscriminatedValue {
		decoded["@odata.type"] = "#microsoft.graph.androidForWorkImportedPFXCertificateProfile"
	}

	encoded, err = json.Marshal(decoded)
	if err != nil {
		return nil, fmt.Errorf("re-marshaling AndroidForWorkImportedPFXCertificateProfile: %+v", err)
	}
