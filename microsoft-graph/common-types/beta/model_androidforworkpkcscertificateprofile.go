...
var _ AndroidForWorkCertificateProfileBase = AndroidForWorkPkcsCertificateProfile{}
...
func (s AndroidForWorkPkcsCertificateProfile) AndroidForWorkCertificateProfileBase() BaseAndroidForWorkCertificateProfileBaseImpl {
...
func (s AndroidForWorkPkcsCertificateProfile) DeviceConfiguration() BaseDeviceConfigurationImpl {
...
func (s AndroidForWorkPkcsCertificateProfile) Entity() BaseEntityImpl {
...
var _ json.Marshaler = AndroidForWorkPkcsCertificateProfile{}

func (s AndroidForWorkPkcsCertificateProfile) MarshalJSON() ([]byte, error) {
	type wrapper AndroidForWorkPkcsCertificateProfile
	wrapped := wrapper(s)
	encoded, err := json.Marshal(wrapped)
	if err != nil {
		return nil, fmt.Errorf("marshaling AndroidForWorkPkcsCertificateProfile: %+v", err)
	}

	var decoded map[string]interface{}
	if err = json.Unmarshal(encoded, &decoded); err != nil {
		return nil, fmt.Errorf("unmarshaling AndroidForWorkPkcsCertificateProfile: %+v", err)
	}

	if !s.OmitDiscriminatedValue {
		decoded["@odata.type"] = "#microsoft.graph.androidForWorkPkcsCertificateProfile"
	}

	encoded, err = json.Marshal(decoded)
	if err != nil {
		return nil, fmt.Errorf("re-marshaling AndroidForWorkPkcsCertificateProfile: %+v", err)
	}
