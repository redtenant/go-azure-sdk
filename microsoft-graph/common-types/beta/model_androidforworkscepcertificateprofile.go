...
var _ AndroidForWorkCertificateProfileBase = AndroidForWorkScepCertificateProfile{}
...
type AndroidForWorkScepCertificateProfile struct {
	...
	// Fields inherited from AndroidForWorkCertificateProfileBase
...
func (s AndroidForWorkScepCertificateProfile) AndroidForWorkCertificateProfileBase() BaseAndroidForWorkCertificateProfileBaseImpl {
	return BaseAndroidForWorkCertificateProfileBaseImpl{
...
func (s AndroidForWorkScepCertificateProfile) DeviceConfiguration() BaseDeviceConfigurationImpl {
...
func (s AndroidForWorkScepCertificateProfile) Entity() BaseEntityImpl {
...
var _ json.Marshaler = AndroidForWorkScepCertificateProfile{}

func (s AndroidForWorkScepCertificateProfile) MarshalJSON() ([]byte, error) {
	type wrapper AndroidForWorkScepCertificateProfile
	wrapped := wrapper(s)
	encoded, err := json.Marshal(wrapped)
	if err != nil {
		return nil, fmt.Errorf("marshaling AndroidForWorkScepCertificateProfile: %+v", err)
	}

	var decoded map[string]interface{}
	if err = json.Unmarshal(encoded, &decoded); err != nil {
		return nil, fmt.Errorf("unmarshaling AndroidForWorkScepCertificateProfile: %+v", err)
	}

	if !s.OmitDiscriminatedValue {
		decoded["@odata.type"] = "#microsoft.graph.androidForWorkScepCertificateProfile"
	}

	encoded, err = json.Marshal(decoded)
	if err != nil {
		return nil, fmt.Errorf("re-marshaling AndroidForWorkScepCertificateProfile: %+v", err)
	}
