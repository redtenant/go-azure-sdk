...
var _ AndroidCertificateProfileBase = AndroidImportedPFXCertificateProfile{}
...
func (s AndroidImportedPFXCertificateProfile) AndroidCertificateProfileBase() BaseAndroidCertificateProfileBaseImpl {
...
func (s AndroidImportedPFXCertificateProfile) DeviceConfiguration() BaseDeviceConfigurationImpl {
...
func (s AndroidImportedPFXCertificateProfile) Entity() BaseEntityImpl {
...
var _ json.Marshaler = AndroidImportedPFXCertificateProfile{}

func (s AndroidImportedPFXCertificateProfile) MarshalJSON() ([]byte, error) {
	type wrapper AndroidImportedPFXCertificateProfile
	wrapped := wrapper(s)
	encoded, err := json.Marshal(wrapped)
	if err != nil {
		return nil, fmt.Errorf("marshaling AndroidImportedPFXCertificateProfile: %+v", err)
	}

	var decoded map[string]interface{}
	if err = json.Unmarshal(encoded, &decoded); err != nil {
		return nil, fmt.Errorf("unmarshaling AndroidImportedPFXCertificateProfile: %+v", err)
	}

	if !s.OmitDiscriminatedValue {
		decoded["@odata.type"] = "#microsoft.graph.androidImportedPFXCertificateProfile"
	}

	encoded, err = json.Marshal(decoded)
	if err != nil {
		return nil, fmt.Errorf("re-marshaling AndroidImportedPFXCertificateProfile: %+v", err)
	}
