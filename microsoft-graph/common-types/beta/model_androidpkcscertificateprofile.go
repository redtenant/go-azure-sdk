...
var _ AndroidCertificateProfileBase = AndroidPkcsCertificateProfile{}
...
func (s AndroidPkcsCertificateProfile) AndroidCertificateProfileBase() BaseAndroidCertificateProfileBaseImpl {
...
func (s AndroidPkcsCertificateProfile) DeviceConfiguration() BaseDeviceConfigurationImpl {
...
func (s AndroidPkcsCertificateProfile) Entity() BaseEntityImpl {
...
var _ json.Marshaler = AndroidPkcsCertificateProfile{}

func (s AndroidPkcsCertificateProfile) MarshalJSON() ([]byte, error) {
	type wrapper AndroidPkcsCertificateProfile
	wrapped := wrapper(s)
	encoded, err := json.Marshal(wrapped)
	if err != nil {
		return nil, fmt.Errorf("marshaling AndroidPkcsCertificateProfile: %+v", err)
	}

	var decoded map[string]interface{}
	if err = json.Unmarshal(encoded, &decoded); err != nil {
		return nil, fmt.Errorf("unmarshaling AndroidPkcsCertificateProfile: %+v", err)
	}

	if !s.OmitDiscriminatedValue {
		decoded["@odata.type"] = "#microsoft.graph.androidPkcsCertificateProfile"
	}

	encoded, err = json.Marshal(decoded)
	if err != nil {
		return nil, fmt.Errorf("re-marshaling AndroidPkcsCertificateProfile: %+v", err)
	}
