...
var _ AndroidWorkProfileWiFiConfiguration = AndroidWorkProfileEnterpriseWiFiConfiguration{}
...
func (s AndroidWorkProfileEnterpriseWiFiConfiguration) AndroidWorkProfileWiFiConfiguration() BaseAndroidWorkProfileWiFiConfigurationImpl {
	return BaseAndroidWorkProfileWiFiConfigurationImpl{
...
func (s AndroidWorkProfileEnterpriseWiFiConfiguration) DeviceConfiguration() BaseDeviceConfigurationImpl {
...
func (s AndroidWorkProfileEnterpriseWiFiConfiguration) Entity() BaseEntityImpl {
...
var _ json.Marshaler = AndroidWorkProfileEnterpriseWiFiConfiguration{}

func (s AndroidWorkProfileEnterpriseWiFiConfiguration) MarshalJSON() ([]byte, error) {
	type wrapper AndroidWorkProfileEnterpriseWiFiConfiguration
	wrapped := wrapper(s)
	encoded, err := json.Marshal(wrapped)
	if err != nil {
		return nil, fmt.Errorf("marshaling AndroidWorkProfileEnterpriseWiFiConfiguration: %+v", err)
	}

	var decoded map[string]interface{}
	if err = json.Unmarshal(encoded, &decoded); err != nil {
		return nil, fmt.Errorf("unmarshaling AndroidWorkProfileEnterpriseWiFiConfiguration: %+v", err)
	}

	if !s.OmitDiscriminatedValue {
		decoded["@odata.type"] = "#microsoft.graph.androidWorkProfileEnterpriseWiFiConfiguration"
	}

	encoded, err = json.Marshal(decoded)
	if err != nil {
		return nil, fmt.Errorf("re-marshaling AndroidWorkProfileEnterpriseWiFiConfiguration: %+v", err)
	}

	return encoded, nil
}

var _ json.Unmarshaler = &AndroidWorkProfileEnterpriseWiFiConfiguration{}

func (s *AndroidWorkProfileEnterpriseWiFiConfiguration) UnmarshalJSON(bytes []byte) error {
	var decoded struct {
		AuthenticationMethod                        *WiFiAuthenticationMethod                    `json:"authenticationMethod,omitempty"`
		EapType                                     *AndroidEapType                              `json:"eapType,omitempty"`
		InnerAuthenticationProtocolForEapTtls       *NonEapAuthenticationMethodForEapTtlsType    `json:"innerAuthenticationProtocolForEapTtls,omitempty"`
	...
	if err := json.Unmarshal(bytes, &temp); err != nil {
		return fmt.Errorf("unmarshaling AndroidWorkProfileEnterpriseWiFiConfiguration into map[string]json.RawMessage: %+v", err)
	}
	...
	if v, ok := temp["identityCertificateForClientAuthentication"]; ok {
		...
		if err != nil {
			return fmt.Errorf("unmarshaling field 'IdentityCertificateForClientAuthentication' for 'AndroidWorkProfileEnterpriseWiFiConfiguration': %+v", err)
		}
