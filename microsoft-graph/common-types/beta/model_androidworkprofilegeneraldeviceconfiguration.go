...
var _ DeviceConfiguration = AndroidWorkProfileGeneralDeviceConfiguration{}
...
func (s AndroidWorkProfileGeneralDeviceConfiguration) DeviceConfiguration() BaseDeviceConfigurationImpl {
...
func (s AndroidWorkProfileGeneralDeviceConfiguration) Entity() BaseEntityImpl {
...
var _ json.Marshaler = AndroidWorkProfileGeneralDeviceConfiguration{}

func (s AndroidWorkProfileGeneralDeviceConfiguration) MarshalJSON() ([]byte, error) {
	type wrapper AndroidWorkProfileGeneralDeviceConfiguration
	wrapped := wrapper(s)
	encoded, err := json.Marshal(wrapped)
	if err != nil {
		return nil, fmt.Errorf("marshaling AndroidWorkProfileGeneralDeviceConfiguration: %+v", err)
	}

	var decoded map[string]interface{}
	if err = json.Unmarshal(encoded, &decoded); err != nil {
		return nil, fmt.Errorf("unmarshaling AndroidWorkProfileGeneralDeviceConfiguration: %+v", err)
	}

	if !s.OmitDiscriminatedValue {
		decoded["@odata.type"] = "#microsoft.graph.androidWorkProfileGeneralDeviceConfiguration"
	}

	encoded, err = json.Marshal(decoded)
	if err != nil {
		return nil, fmt.Errorf("re-marshaling AndroidWorkProfileGeneralDeviceConfiguration: %+v", err)
	}
