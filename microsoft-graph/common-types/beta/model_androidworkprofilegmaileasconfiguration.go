...
var _ AndroidWorkProfileEasEmailProfileBase = AndroidWorkProfileGmailEasConfiguration{}
...
func (s AndroidWorkProfileGmailEasConfiguration) AndroidWorkProfileEasEmailProfileBase() BaseAndroidWorkProfileEasEmailProfileBaseImpl {
...
func (s AndroidWorkProfileGmailEasConfiguration) DeviceConfiguration() BaseDeviceConfigurationImpl {
...
func (s AndroidWorkProfileGmailEasConfiguration) Entity() BaseEntityImpl {
...
var _ json.Marshaler = AndroidWorkProfileGmailEasConfiguration{}

func (s AndroidWorkProfileGmailEasConfiguration) MarshalJSON() ([]byte, error) {
	type wrapper AndroidWorkProfileGmailEasConfiguration
	wrapped := wrapper(s)
	encoded, err := json.Marshal(wrapped)
	if err != nil {
		return nil, fmt.Errorf("marshaling AndroidWorkProfileGmailEasConfiguration: %+v", err)
	}

	var decoded map[string]interface{}
	if err = json.Unmarshal(encoded, &decoded); err != nil {
		return nil, fmt.Errorf("unmarshaling AndroidWorkProfileGmailEasConfiguration: %+v", err)
	}

	if !s.OmitDiscriminatedValue {
		decoded["@odata.type"] = "#microsoft.graph.androidWorkProfileGmailEasConfiguration"
	}

	encoded, err = json.Marshal(decoded)
	if err != nil {
		return nil, fmt.Errorf("re-marshaling AndroidWorkProfileGmailEasConfiguration: %+v", err)
	}

	return encoded, nil
}

var _ json.Unmarshaler = &AndroidWorkProfileGmailEasConfiguration{}

func (s *AndroidWorkProfileGmailEasConfiguration) UnmarshalJSON(bytes []byte) error {
	var decoded struct {
		AuthenticationMethod                        *EasAuthenticationMethod                     `json:"authenticationMethod,omitempty"`
		DurationOfEmailToSync                       *EmailSyncDuration                           `json:"durationOfEmailToSync,omitempty"`
		EmailAddressSource                          *UserEmailSource                             `json:"emailAddressSource,omitempty"`
	...
	if err := json.Unmarshal(bytes, &temp); err != nil {
		return fmt.Errorf("unmarshaling AndroidWorkProfileGmailEasConfiguration into map[string]json.RawMessage: %+v", err)
	}

	if v, ok := temp["identityCertificate"]; ok {
		impl, err := UnmarshalAndroidWorkProfileCertificateProfileBaseImplementation(v)
		if err != nil {
			return fmt.Errorf("unmarshaling field 'IdentityCertificate' for 'AndroidWorkProfileGmailEasConfiguration': %+v", err)
		}
