...
var _ AndroidWorkProfileCertificateProfileBase = AndroidWorkProfilePkcsCertificateProfile{}
...
type AndroidWorkProfilePkcsCertificateProfile struct {
	...
	// Fields inherited from AndroidWorkProfileCertificateProfileBase
...
func (s AndroidWorkProfilePkcsCertificateProfile) AndroidWorkProfileCertificateProfileBase() BaseAndroidWorkProfileCertificateProfileBaseImpl {
	return BaseAndroidWorkProfileCertificateProfileBaseImpl{
...
func (s AndroidWorkProfilePkcsCertificateProfile) DeviceConfiguration() BaseDeviceConfigurationImpl {
...
func (s AndroidWorkProfilePkcsCertificateProfile) Entity() BaseEntityImpl {
...
var _ json.Marshaler = AndroidWorkProfilePkcsCertificateProfile{}

func (s AndroidWorkProfilePkcsCertificateProfile) MarshalJSON() ([]byte, error) {
	type wrapper AndroidWorkProfilePkcsCertificateProfile
	wrapped := wrapper(s)
	encoded, err := json.Marshal(wrapped)
	if err != nil {
		return nil, fmt.Errorf("marshaling AndroidWorkProfilePkcsCertificateProfile: %+v", err)
	}

	var decoded map[string]interface{}
	if err = json.Unmarshal(encoded, &decoded); err != nil {
		return nil, fmt.Errorf("unmarshaling AndroidWorkProfilePkcsCertificateProfile: %+v", err)
	}

	if !s.OmitDiscriminatedValue {
		decoded["@odata.type"] = "#microsoft.graph.androidWorkProfilePkcsCertificateProfile"
	}

	encoded, err = json.Marshal(decoded)
	if err != nil {
		return nil, fmt.Errorf("re-marshaling AndroidWorkProfilePkcsCertificateProfile: %+v", err)
	}
