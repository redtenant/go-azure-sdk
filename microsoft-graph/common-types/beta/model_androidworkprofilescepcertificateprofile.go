...
var _ AndroidWorkProfileCertificateProfileBase = AndroidWorkProfileScepCertificateProfile{}
...
func (s AndroidWorkProfileScepCertificateProfile) AndroidWorkProfileCertificateProfileBase() BaseAndroidWorkProfileCertificateProfileBaseImpl {
...
func (s AndroidWorkProfileScepCertificateProfile) DeviceConfiguration() BaseDeviceConfigurationImpl {
...
func (s AndroidWorkProfileScepCertificateProfile) Entity() BaseEntityImpl {
...
var _ json.Marshaler = AndroidWorkProfileScepCertificateProfile{}

func (s AndroidWorkProfileScepCertificateProfile) MarshalJSON() ([]byte, error) {
	type wrapper AndroidWorkProfileScepCertificateProfile
	wrapped := wrapper(s)
	encoded, err := json.Marshal(wrapped)
	if err != nil {
		return nil, fmt.Errorf("marshaling AndroidWorkProfileScepCertificateProfile: %+v", err)
	}

	var decoded map[string]interface{}
	if err = json.Unmarshal(encoded, &decoded); err != nil {
		return nil, fmt.Errorf("unmarshaling AndroidWorkProfileScepCertificateProfile: %+v", err)
	}

	if !s.OmitDiscriminatedValue {
		decoded["@odata.type"] = "#microsoft.graph.androidWorkProfileScepCertificateProfile"
	}

	encoded, err = json.Marshal(decoded)
	if err != nil {
		return nil, fmt.Errorf("re-marshaling AndroidWorkProfileScepCertificateProfile: %+v", err)
	}
