...
var _ DeviceConfiguration = AndroidWorkProfileVpnConfiguration{}
...
func (s AndroidWorkProfileVpnConfiguration) DeviceConfiguration() BaseDeviceConfigurationImpl {
...
func (s AndroidWorkProfileVpnConfiguration) Entity() BaseEntityImpl {
...
var _ json.Marshaler = AndroidWorkProfileVpnConfiguration{}

func (s AndroidWorkProfileVpnConfiguration) MarshalJSON() ([]byte, error) {
	type wrapper AndroidWorkProfileVpnConfiguration
	wrapped := wrapper(s)
	encoded, err := json.Marshal(wrapped)
	if err != nil {
		return nil, fmt.Errorf("marshaling AndroidWorkProfileVpnConfiguration: %+v", err)
	}

	var decoded map[string]interface{}
	if err = json.Unmarshal(encoded, &decoded); err != nil {
		return nil, fmt.Errorf("unmarshaling AndroidWorkProfileVpnConfiguration: %+v", err)
	}

	if !s.OmitDiscriminatedValue {
		decoded["@odata.type"] = "#microsoft.graph.androidWorkProfileVpnConfiguration"
	}

	encoded, err = json.Marshal(decoded)
	if err != nil {
		return nil, fmt.Errorf("re-marshaling AndroidWorkProfileVpnConfiguration: %+v", err)
	}

	return encoded, nil
}

var _ json.Unmarshaler = &AndroidWorkProfileVpnConfiguration{}

func (s *AndroidWorkProfileVpnConfiguration) UnmarshalJSON(bytes []byte) error {
	var decoded struct {
		AlwaysOn                                    nullable.Type[bool]                          `json:"alwaysOn,omitempty"`
		AlwaysOnLockdown                            nullable.Type[bool]                          `json:"alwaysOnLockdown,omitempty"`
		AuthenticationMethod                        *VpnAuthenticationMethod                     `json:"authenticationMethod,omitempty"`
	...
	if err := json.Unmarshal(bytes, &temp); err != nil {
		return fmt.Errorf("unmarshaling AndroidWorkProfileVpnConfiguration into map[string]json.RawMessage: %+v", err)
	}

	if v, ok := temp["identityCertificate"]; ok {
		impl, err := UnmarshalAndroidWorkProfileCertificateProfileBaseImplementation(v)
		if err != nil {
			return fmt.Errorf("unmarshaling field 'IdentityCertificate' for 'AndroidWorkProfileVpnConfiguration': %+v", err)
		}
	...
	if v, ok := temp["proxyServer"]; ok {
		...
		if err != nil {
			return fmt.Errorf("unmarshaling field 'ProxyServer' for 'AndroidWorkProfileVpnConfiguration': %+v", err)
		}
		s.ProxyServer = impl
	}
	...
	if v, ok := temp["targetedMobileApps"]; ok {
		...
		for i, val := range listTemp {
			...
			if err != nil {
				return fmt.Errorf("unmarshaling index %d field 'TargetedMobileApps' for 'AndroidWorkProfileVpnConfiguration': %+v", i, err)
			}
