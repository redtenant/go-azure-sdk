...
var _ AospDeviceOwnerCertificateProfileBase = AospDeviceOwnerScepCertificateProfile{}
...
func (s AospDeviceOwnerScepCertificateProfile) AospDeviceOwnerCertificateProfileBase() BaseAospDeviceOwnerCertificateProfileBaseImpl {
...
func (s AospDeviceOwnerScepCertificateProfile) DeviceConfiguration() BaseDeviceConfigurationImpl {
...
func (s AospDeviceOwnerScepCertificateProfile) Entity() BaseEntityImpl {
...
var _ json.Marshaler = AospDeviceOwnerScepCertificateProfile{}

func (s AospDeviceOwnerScepCertificateProfile) MarshalJSON() ([]byte, error) {
	type wrapper AospDeviceOwnerScepCertificateProfile
	wrapped := wrapper(s)
	encoded, err := json.Marshal(wrapped)
	if err != nil {
		return nil, fmt.Errorf("marshaling AospDeviceOwnerScepCertificateProfile: %+v", err)
	}

	var decoded map[string]interface{}
	if err = json.Unmarshal(encoded, &decoded); err != nil {
		return nil, fmt.Errorf("unmarshaling AospDeviceOwnerScepCertificateProfile: %+v", err)
	}

	if !s.OmitDiscriminatedValue {
		decoded["@odata.type"] = "#microsoft.graph.aospDeviceOwnerScepCertificateProfile"
	}

	encoded, err = json.Marshal(decoded)
	if err != nil {
		return nil, fmt.Errorf("re-marshaling AospDeviceOwnerScepCertificateProfile: %+v", err)
	}
