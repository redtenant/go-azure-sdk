...
func (s AwsLambda) AwsIdentity() BaseAwsIdentityImpl {
...
func (s AwsLambda) AuthorizationSystemIdentity() BaseAuthorizationSystemIdentityImpl {
...
func (s AwsLambda) Entity() BaseEntityImpl {
...
var _ json.Marshaler = AwsLambda{}

func (s AwsLambda) MarshalJSON() ([]byte, error) {
	type wrapper AwsLambda
	wrapped := wrapper(s)
	encoded, err := json.Marshal(wrapped)
	if err != nil {
		return nil, fmt.Errorf("marshaling AwsLambda: %+v", err)
	}

	var decoded map[string]interface{}
	if err = json.Unmarshal(encoded, &decoded); err != nil {
		return nil, fmt.Errorf("unmarshaling AwsLambda: %+v", err)
	}

	if !s.OmitDiscriminatedValue {
		decoded["@odata.type"] = "#microsoft.graph.awsLambda"
	}

	encoded, err = json.Marshal(decoded)
	if err != nil {
		return nil, fmt.Errorf("re-marshaling AwsLambda: %+v", err)
	}
...
func (s *AwsLambda) UnmarshalJSON(bytes []byte) error {
	...
	if err := json.Unmarshal(bytes, &temp); err != nil {
		return fmt.Errorf("unmarshaling AwsLambda into map[string]json.RawMessage: %+v", err)
	}

	if v, ok := temp["authorizationSystem"]; ok {
		impl, err := UnmarshalAuthorizationSystemImplementation(v)
		if err != nil {
			return fmt.Errorf("unmarshaling field 'AuthorizationSystem' for 'AwsLambda': %+v", err)
		}
	...
	if v, ok := temp["source"]; ok {
		...
		if err != nil {
			return fmt.Errorf("unmarshaling field 'Source' for 'AwsLambda': %+v", err)
		}
		s.Source = impl
	}
