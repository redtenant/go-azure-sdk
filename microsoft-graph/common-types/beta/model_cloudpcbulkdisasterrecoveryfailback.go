...
var _ CloudPCBulkAction = CloudPCBulkDisasterRecoveryFailback{}
...
func (s CloudPCBulkDisasterRecoveryFailback) CloudPCBulkAction() BaseCloudPCBulkActionImpl {
...
func (s CloudPCBulkDisasterRecoveryFailback) Entity() BaseEntityImpl {
...
var _ json.Marshaler = CloudPCBulkDisasterRecoveryFailback{}

func (s CloudPCBulkDisasterRecoveryFailback) MarshalJSON() ([]byte, error) {
	type wrapper CloudPCBulkDisasterRecoveryFailback
	wrapped := wrapper(s)
	encoded, err := json.Marshal(wrapped)
	if err != nil {
		return nil, fmt.Errorf("marshaling CloudPCBulkDisasterRecoveryFailback: %+v", err)
	}

	var decoded map[string]interface{}
	if err = json.Unmarshal(encoded, &decoded); err != nil {
		return nil, fmt.Errorf("unmarshaling CloudPCBulkDisasterRecoveryFailback: %+v", err)
	}

	if !s.OmitDiscriminatedValue {
		decoded["@odata.type"] = "#microsoft.graph.cloudPcBulkDisasterRecoveryFailback"
	}

	encoded, err = json.Marshal(decoded)
	if err != nil {
		return nil, fmt.Errorf("re-marshaling CloudPCBulkDisasterRecoveryFailback: %+v", err)
	}
