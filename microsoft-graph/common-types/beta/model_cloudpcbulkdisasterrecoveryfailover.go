...
var _ CloudPCBulkAction = CloudPCBulkDisasterRecoveryFailover{}
...
func (s CloudPCBulkDisasterRecoveryFailover) CloudPCBulkAction() BaseCloudPCBulkActionImpl {
...
func (s CloudPCBulkDisasterRecoveryFailover) Entity() BaseEntityImpl {
...
var _ json.Marshaler = CloudPCBulkDisasterRecoveryFailover{}

func (s CloudPCBulkDisasterRecoveryFailover) MarshalJSON() ([]byte, error) {
	type wrapper CloudPCBulkDisasterRecoveryFailover
	wrapped := wrapper(s)
	encoded, err := json.Marshal(wrapped)
	if err != nil {
		return nil, fmt.Errorf("marshaling CloudPCBulkDisasterRecoveryFailover: %+v", err)
	}

	var decoded map[string]interface{}
	if err = json.Unmarshal(encoded, &decoded); err != nil {
		return nil, fmt.Errorf("unmarshaling CloudPCBulkDisasterRecoveryFailover: %+v", err)
	}

	if !s.OmitDiscriminatedValue {
		decoded["@odata.type"] = "#microsoft.graph.cloudPcBulkDisasterRecoveryFailover"
	}

	encoded, err = json.Marshal(decoded)
	if err != nil {
		return nil, fmt.Errorf("re-marshaling CloudPCBulkDisasterRecoveryFailover: %+v", err)
	}
