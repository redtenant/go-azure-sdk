...
var _ CloudPCBulkAction = CloudPCBulkModifyDiskEncryptionType{}

type CloudPCBulkModifyDiskEncryptionType struct {
	DiskEncryptionType *CloudPCDiskEncryptionType `json:"diskEncryptionType,omitempty"`
...
func (s CloudPCBulkModifyDiskEncryptionType) CloudPCBulkAction() BaseCloudPCBulkActionImpl {
...
func (s CloudPCBulkModifyDiskEncryptionType) Entity() BaseEntityImpl {
...
var _ json.Marshaler = CloudPCBulkModifyDiskEncryptionType{}

func (s CloudPCBulkModifyDiskEncryptionType) MarshalJSON() ([]byte, error) {
	type wrapper CloudPCBulkModifyDiskEncryptionType
	wrapped := wrapper(s)
	encoded, err := json.Marshal(wrapped)
	if err != nil {
		return nil, fmt.Errorf("marshaling CloudPCBulkModifyDiskEncryptionType: %+v", err)
	}

	var decoded map[string]interface{}
	if err = json.Unmarshal(encoded, &decoded); err != nil {
		return nil, fmt.Errorf("unmarshaling CloudPCBulkModifyDiskEncryptionType: %+v", err)
	}

	if !s.OmitDiscriminatedValue {
		decoded["@odata.type"] = "#microsoft.graph.cloudPcBulkModifyDiskEncryptionType"
	}

	encoded, err = json.Marshal(decoded)
	if err != nil {
		return nil, fmt.Errorf("re-marshaling CloudPCBulkModifyDiskEncryptionType: %+v", err)
	}
