...
var _ CloudPCBulkAction = CloudPCBulkPowerOff{}
...
func (s CloudPCBulkPowerOff) CloudPCBulkAction() BaseCloudPCBulkActionImpl {
...
func (s CloudPCBulkPowerOff) Entity() BaseEntityImpl {
...
var _ json.Marshaler = CloudPCBulkPowerOff{}

func (s CloudPCBulkPowerOff) MarshalJSON() ([]byte, error) {
	type wrapper CloudPCBulkPowerOff
	wrapped := wrapper(s)
	encoded, err := json.Marshal(wrapped)
	if err != nil {
		return nil, fmt.Errorf("marshaling CloudPCBulkPowerOff: %+v", err)
	}

	var decoded map[string]interface{}
	if err = json.Unmarshal(encoded, &decoded); err != nil {
		return nil, fmt.Errorf("unmarshaling CloudPCBulkPowerOff: %+v", err)
	}

	if !s.OmitDiscriminatedValue {
		decoded["@odata.type"] = "#microsoft.graph.cloudPcBulkPowerOff"
	}

	encoded, err = json.Marshal(decoded)
	if err != nil {
		return nil, fmt.Errorf("re-marshaling CloudPCBulkPowerOff: %+v", err)
	}
