...
var _ CloudPCBulkAction = CloudPCBulkPowerOn{}
...
func (s CloudPCBulkPowerOn) CloudPCBulkAction() BaseCloudPCBulkActionImpl {
...
func (s CloudPCBulkPowerOn) Entity() BaseEntityImpl {
...
var _ json.Marshaler = CloudPCBulkPowerOn{}

func (s CloudPCBulkPowerOn) MarshalJSON() ([]byte, error) {
	type wrapper CloudPCBulkPowerOn
	wrapped := wrapper(s)
	encoded, err := json.Marshal(wrapped)
	if err != nil {
		return nil, fmt.Errorf("marshaling CloudPCBulkPowerOn: %+v", err)
	}

	var decoded map[string]interface{}
	if err = json.Unmarshal(encoded, &decoded); err != nil {
		return nil, fmt.Errorf("unmarshaling CloudPCBulkPowerOn: %+v", err)
	}

	if !s.OmitDiscriminatedValue {
		decoded["@odata.type"] = "#microsoft.graph.cloudPcBulkPowerOn"
	}

	encoded, err = json.Marshal(decoded)
	if err != nil {
		return nil, fmt.Errorf("re-marshaling CloudPCBulkPowerOn: %+v", err)
	}
