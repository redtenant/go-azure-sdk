...
var _ CloudPCBulkAction = CloudPCBulkReprovision{}
...
func (s CloudPCBulkReprovision) CloudPCBulkAction() BaseCloudPCBulkActionImpl {
...
func (s CloudPCBulkReprovision) Entity() BaseEntityImpl {
...
var _ json.Marshaler = CloudPCBulkReprovision{}

func (s CloudPCBulkReprovision) MarshalJSON() ([]byte, error) {
	type wrapper CloudPCBulkReprovision
	wrapped := wrapper(s)
	encoded, err := json.Marshal(wrapped)
	if err != nil {
		return nil, fmt.Errorf("marshaling CloudPCBulkReprovision: %+v", err)
	}

	var decoded map[string]interface{}
	if err = json.Unmarshal(encoded, &decoded); err != nil {
		return nil, fmt.Errorf("unmarshaling CloudPCBulkReprovision: %+v", err)
	}

	if !s.OmitDiscriminatedValue {
		decoded["@odata.type"] = "#microsoft.graph.cloudPcBulkReprovision"
	}

	encoded, err = json.Marshal(decoded)
	if err != nil {
		return nil, fmt.Errorf("re-marshaling CloudPCBulkReprovision: %+v", err)
	}
