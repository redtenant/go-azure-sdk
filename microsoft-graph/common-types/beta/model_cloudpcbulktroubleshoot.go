...
var _ CloudPCBulkAction = CloudPCBulkTroubleshoot{}
...
func (s CloudPCBulkTroubleshoot) CloudPCBulkAction() BaseCloudPCBulkActionImpl {
...
func (s CloudPCBulkTroubleshoot) Entity() BaseEntityImpl {
...
var _ json.Marshaler = CloudPCBulkTroubleshoot{}

func (s CloudPCBulkTroubleshoot) MarshalJSON() ([]byte, error) {
	type wrapper CloudPCBulkTroubleshoot
	wrapped := wrapper(s)
	encoded, err := json.Marshal(wrapped)
	if err != nil {
		return nil, fmt.Errorf("marshaling CloudPCBulkTroubleshoot: %+v", err)
	}

	var decoded map[string]interface{}
	if err = json.Unmarshal(encoded, &decoded); err != nil {
		return nil, fmt.Errorf("unmarshaling CloudPCBulkTroubleshoot: %+v", err)
	}

	if !s.OmitDiscriminatedValue {
		decoded["@odata.type"] = "#microsoft.graph.cloudPcBulkTroubleshoot"
	}

	encoded, err = json.Marshal(decoded)
	if err != nil {
		return nil, fmt.Errorf("re-marshaling CloudPCBulkTroubleshoot: %+v", err)
	}
