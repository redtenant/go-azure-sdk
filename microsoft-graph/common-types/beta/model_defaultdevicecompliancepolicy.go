...
var _ DeviceCompliancePolicy = DefaultDeviceCompliancePolicy{}
...
func (s DefaultDeviceCompliancePolicy) DeviceCompliancePolicy() BaseDeviceCompliancePolicyImpl {
...
func (s DefaultDeviceCompliancePolicy) Entity() BaseEntityImpl {
...
var _ json.Marshaler = DefaultDeviceCompliancePolicy{}

func (s DefaultDeviceCompliancePolicy) MarshalJSON() ([]byte, error) {
	type wrapper DefaultDeviceCompliancePolicy
	wrapped := wrapper(s)
	encoded, err := json.Marshal(wrapped)
	if err != nil {
		return nil, fmt.Errorf("marshaling DefaultDeviceCompliancePolicy: %+v", err)
	}

	var decoded map[string]interface{}
	if err = json.Unmarshal(encoded, &decoded); err != nil {
		return nil, fmt.Errorf("unmarshaling DefaultDeviceCompliancePolicy: %+v", err)
	}

	if !s.OmitDiscriminatedValue {
		decoded["@odata.type"] = "#microsoft.graph.defaultDeviceCompliancePolicy"
	}

	encoded, err = json.Marshal(decoded)
	if err != nil {
		return nil, fmt.Errorf("re-marshaling DefaultDeviceCompliancePolicy: %+v", err)
	}
