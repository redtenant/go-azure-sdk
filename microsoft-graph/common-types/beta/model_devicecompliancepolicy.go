...
func UnmarshalDeviceCompliancePolicyImplementation(input []byte) (DeviceCompliancePolicy, error) {
	...
	if strings.EqualFold(value, "#microsoft.graph.androidDeviceOwnerCompliancePolicy") {
		var out AndroidDeviceOwnerCompliancePolicy
		if err := json.Unmarshal(input, &out); err != nil {
			return nil, fmt.Errorf("unmarshaling into AndroidDeviceOwnerCompliancePolicy: %+v", err)
		}
		return out, nil
	}

	if strings.EqualFold(value, "#microsoft.graph.androidForWorkCompliancePolicy") {
		var out AndroidForWorkCompliancePolicy
		if err := json.Unmarshal(input, &out); err != nil {
			return nil, fmt.Errorf("unmarshaling into AndroidForWorkCompliancePolicy: %+v", err)
		}
		return out, nil
	}
	...
	if strings.EqualFold(value, "#microsoft.graph.aospDeviceOwnerCompliancePolicy") {
		var out AospDeviceOwnerCompliancePolicy
		if err := json.Unmarshal(input, &out); err != nil {
			return nil, fmt.Errorf("unmarshaling into AospDeviceOwnerCompliancePolicy: %+v", err)
		}
		return out, nil
	}

	if strings.EqualFold(value, "#microsoft.graph.defaultDeviceCompliancePolicy") {
		var out DefaultDeviceCompliancePolicy
		if err := json.Unmarshal(input, &out); err != nil {
			return nil, fmt.Errorf("unmarshaling into DefaultDeviceCompliancePolicy: %+v", err)
		}
		return out, nil
	}
