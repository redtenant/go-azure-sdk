...
var _ DeviceManagementSettingDefinition = DeviceManagementAbstractComplexSettingDefinition{}
...
func (s DeviceManagementAbstractComplexSettingDefinition) DeviceManagementSettingDefinition() BaseDeviceManagementSettingDefinitionImpl {
...
func (s DeviceManagementAbstractComplexSettingDefinition) Entity() BaseEntityImpl {
...
var _ json.Marshaler = DeviceManagementAbstractComplexSettingDefinition{}

func (s DeviceManagementAbstractComplexSettingDefinition) MarshalJSON() ([]byte, error) {
	type wrapper DeviceManagementAbstractComplexSettingDefinition
	wrapped := wrapper(s)
	encoded, err := json.Marshal(wrapped)
	if err != nil {
		return nil, fmt.Errorf("marshaling DeviceManagementAbstractComplexSettingDefinition: %+v", err)
	}

	var decoded map[string]interface{}
	if err = json.Unmarshal(encoded, &decoded); err != nil {
		return nil, fmt.Errorf("unmarshaling DeviceManagementAbstractComplexSettingDefinition: %+v", err)
	}

	if !s.OmitDiscriminatedValue {
		decoded["@odata.type"] = "#microsoft.graph.deviceManagementAbstractComplexSettingDefinition"
	}

	encoded, err = json.Marshal(decoded)
	if err != nil {
		return nil, fmt.Errorf("re-marshaling DeviceManagementAbstractComplexSettingDefinition: %+v", err)
	}
...
func (s *DeviceManagementAbstractComplexSettingDefinition) UnmarshalJSON(bytes []byte) error {
	...
	if err := json.Unmarshal(bytes, &temp); err != nil {
		return fmt.Errorf("unmarshaling DeviceManagementAbstractComplexSettingDefinition into map[string]json.RawMessage: %+v", err)
	}
	...
	if v, ok := temp["constraints"]; ok {
		...
		for i, val := range listTemp {
			...
			if err != nil {
				return fmt.Errorf("unmarshaling index %d field 'Constraints' for 'DeviceManagementAbstractComplexSettingDefinition': %+v", i, err)
			}
