...
var _ ProtectionUnitBase = DriveProtectionUnit{}
...
func (s DriveProtectionUnit) ProtectionUnitBase() BaseProtectionUnitBaseImpl {
...
func (s DriveProtectionUnit) Entity() BaseEntityImpl {
...
var _ json.Marshaler = DriveProtectionUnit{}

func (s DriveProtectionUnit) MarshalJSON() ([]byte, error) {
	type wrapper DriveProtectionUnit
	wrapped := wrapper(s)
	encoded, err := json.Marshal(wrapped)
	if err != nil {
		return nil, fmt.Errorf("marshaling DriveProtectionUnit: %+v", err)
	}

	var decoded map[string]interface{}
	if err = json.Unmarshal(encoded, &decoded); err != nil {
		return nil, fmt.Errorf("unmarshaling DriveProtectionUnit: %+v", err)
	}
	...
	if !s.OmitDiscriminatedValue {
		decoded["@odata.type"] = "#microsoft.graph.driveProtectionUnit"
	}

	encoded, err = json.Marshal(decoded)
	if err != nil {
		return nil, fmt.Errorf("re-marshaling DriveProtectionUnit: %+v", err)
	}
...
func (s *DriveProtectionUnit) UnmarshalJSON(bytes []byte) error {
	...
	if err := json.Unmarshal(bytes, &temp); err != nil {
		return fmt.Errorf("unmarshaling DriveProtectionUnit into map[string]json.RawMessage: %+v", err)
	}

	if v, ok := temp["createdBy"]; ok {
		impl, err := UnmarshalIdentitySetImplementation(v)
		if err != nil {
			return fmt.Errorf("unmarshaling field 'CreatedBy' for 'DriveProtectionUnit': %+v", err)
		}
		s.CreatedBy = impl
	}
	...
	if v, ok := temp["lastModifiedBy"]; ok {
		impl, err := UnmarshalIdentitySetImplementation(v)
		if err != nil {
			return fmt.Errorf("unmarshaling field 'LastModifiedBy' for 'DriveProtectionUnit': %+v", err)
		}
