...
var _ EdiscoveryCaseOperation = EdiscoveryAddToReviewSetOperation{}
...
func (s EdiscoveryAddToReviewSetOperation) EdiscoveryCaseOperation() BaseEdiscoveryCaseOperationImpl {
...
func (s EdiscoveryAddToReviewSetOperation) Entity() BaseEntityImpl {
...
var _ json.Marshaler = EdiscoveryAddToReviewSetOperation{}

func (s EdiscoveryAddToReviewSetOperation) MarshalJSON() ([]byte, error) {
	type wrapper EdiscoveryAddToReviewSetOperation
	wrapped := wrapper(s)
	encoded, err := json.Marshal(wrapped)
	if err != nil {
		return nil, fmt.Errorf("marshaling EdiscoveryAddToReviewSetOperation: %+v", err)
	}

	var decoded map[string]interface{}
	if err = json.Unmarshal(encoded, &decoded); err != nil {
		return nil, fmt.Errorf("unmarshaling EdiscoveryAddToReviewSetOperation: %+v", err)
	}

	if !s.OmitDiscriminatedValue {
		decoded["@odata.type"] = "#microsoft.graph.ediscovery.addToReviewSetOperation"
	}

	encoded, err = json.Marshal(decoded)
	if err != nil {
		return nil, fmt.Errorf("re-marshaling EdiscoveryAddToReviewSetOperation: %+v", err)
	}
...
func (s *EdiscoveryAddToReviewSetOperation) UnmarshalJSON(bytes []byte) error {
	...
	if err := json.Unmarshal(bytes, &temp); err != nil {
		return fmt.Errorf("unmarshaling EdiscoveryAddToReviewSetOperation into map[string]json.RawMessage: %+v", err)
	}

	if v, ok := temp["createdBy"]; ok {
		impl, err := UnmarshalIdentitySetImplementation(v)
		if err != nil {
			return fmt.Errorf("unmarshaling field 'CreatedBy' for 'EdiscoveryAddToReviewSetOperation': %+v", err)
		}
		s.CreatedBy = impl
	}
