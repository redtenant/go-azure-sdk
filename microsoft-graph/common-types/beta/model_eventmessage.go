...
var _ EventMessage = BaseEventMessageImpl{}

type BaseEventMessageImpl struct {
...
func (s BaseEventMessageImpl) EventMessage() BaseEventMessageImpl {
	return s
}

func (s BaseEventMessageImpl) Message() BaseMessageImpl {
...
func (s BaseEventMessageImpl) OutlookItem() BaseOutlookItemImpl {
...
func (s BaseEventMessageImpl) Entity() BaseEntityImpl {
...
func (s RawEventMessageImpl) Message() BaseMessageImpl {
	return s.eventMessage.Message()
}

func (s RawEventMessageImpl) OutlookItem() BaseOutlookItemImpl {
	return s.eventMessage.OutlookItem()
}

func (s RawEventMessageImpl) Entity() BaseEntityImpl {
	return s.eventMessage.Entity()
}

var _ json.Marshaler = BaseEventMessageImpl{}

func (s BaseEventMessageImpl) MarshalJSON() ([]byte, error) {
	type wrapper BaseEventMessageImpl
	wrapped := wrapper(s)
	encoded, err := json.Marshal(wrapped)
	if err != nil {
		return nil, fmt.Errorf("marshaling BaseEventMessageImpl: %+v", err)
	}

	var decoded map[string]interface{}
	if err = json.Unmarshal(encoded, &decoded); err != nil {
		return nil, fmt.Errorf("unmarshaling BaseEventMessageImpl: %+v", err)
	}

	delete(decoded, "event")

	if !s.OmitDiscriminatedValue {
		decoded["@odata.type"] = "#microsoft.graph.eventMessage"
	}

	encoded, err = json.Marshal(decoded)
	if err != nil {
		return nil, fmt.Errorf("re-marshaling BaseEventMessageImpl: %+v", err)
	}

	return encoded, nil
}

var _ json.Unmarshaler = &BaseEventMessageImpl{}

func (s *BaseEventMessageImpl) UnmarshalJSON(bytes []byte) error {
	var decoded struct {
		EndDateTime                   *DateTimeTimeZone                    `json:"endDateTime,omitempty"`
		Event                         *Event                               `json:"event,omitempty"`
		IsAllDay                      nullable.Type[bool]                  `json:"isAllDay,omitempty"`
	...
	if err := json.Unmarshal(bytes, &temp); err != nil {
		return fmt.Errorf("unmarshaling BaseEventMessageImpl into map[string]json.RawMessage: %+v", err)
	}
	...
	if v, ok := temp["attachments"]; ok {
		...
		for i, val := range listTemp {
			...
			if err != nil {
				return fmt.Errorf("unmarshaling index %d field 'Attachments' for 'BaseEventMessageImpl': %+v", i, err)
			}
	...
	if v, ok := temp["bccRecipients"]; ok {
		...
		for i, val := range listTemp {
			...
			if err != nil {
				return fmt.Errorf("unmarshaling index %d field 'BccRecipients' for 'BaseEventMessageImpl': %+v", i, err)
			}
			output = append(output, impl)
		}
	...
	if v, ok := temp["ccRecipients"]; ok {
		...
		for i, val := range listTemp {
			impl, err := UnmarshalRecipientImplementation(val)
			if err != nil {
				return fmt.Errorf("unmarshaling index %d field 'CcRecipients' for 'BaseEventMessageImpl': %+v", i, err)
			}
			output = append(output, impl)
		}
	...
	if v, ok := temp["extensions"]; ok {
		...
		for i, val := range listTemp {
			...
			if err != nil {
				return fmt.Errorf("unmarshaling index %d field 'Extensions' for 'BaseEventMessageImpl': %+v", i, err)
			}
			output = append(output, impl)
		}
		s.Extensions = &output
	...
	if v, ok := temp["from"]; ok {
		...
		if err != nil {
			return fmt.Errorf("unmarshaling field 'From' for 'BaseEventMessageImpl': %+v", err)
		}
		s.From = impl
	}
	...
	if v, ok := temp["location"]; ok {
		...
		if err != nil {
			return fmt.Errorf("unmarshaling field 'Location' for 'BaseEventMessageImpl': %+v", err)
		}
		s.Location = impl
	}
	...
	if v, ok := temp["replyTo"]; ok {
		...
		for i, val := range listTemp {
			impl, err := UnmarshalRecipientImplementation(val)
			if err != nil {
				return fmt.Errorf("unmarshaling index %d field 'ReplyTo' for 'BaseEventMessageImpl': %+v", i, err)
			}
			output = append(output, impl)
		}
		s.ReplyTo = &output
	...
	if v, ok := temp["sender"]; ok {
		impl, err := UnmarshalRecipientImplementation(v)
		if err != nil {
			return fmt.Errorf("unmarshaling field 'Sender' for 'BaseEventMessageImpl': %+v", err)
		}
		s.Sender = impl
	}
	...
	if v, ok := temp["toRecipients"]; ok {
		...
		for i, val := range listTemp {
			impl, err := UnmarshalRecipientImplementation(val)
			if err != nil {
				return fmt.Errorf("unmarshaling index %d field 'ToRecipients' for 'BaseEventMessageImpl': %+v", i, err)
			}
			output = append(output, impl)
		}
...
func UnmarshalEventMessageImplementation(input []byte) (EventMessage, error) {
	if input == nil {
		return nil, nil
	}
	...
	if err := json.Unmarshal(input, &temp); err != nil {
		return nil, fmt.Errorf("unmarshaling EventMessage into map[string]interface: %+v", err)
	}
	...
	if strings.EqualFold(value, "#microsoft.graph.eventMessageRequest") {
		var out EventMessageRequest
		if err := json.Unmarshal(input, &out); err != nil {
			return nil, fmt.Errorf("unmarshaling into EventMessageRequest: %+v", err)
		}
		return out, nil
	}

	if strings.EqualFold(value, "#microsoft.graph.eventMessageResponse") {
		var out EventMessageResponse
		if err := json.Unmarshal(input, &out); err != nil {
			return nil, fmt.Errorf("unmarshaling into EventMessageResponse: %+v", err)
		}
		return out, nil
	}

	var parent BaseEventMessageImpl
	if err := json.Unmarshal(input, &parent); err != nil {
		return nil, fmt.Errorf("unmarshaling into BaseEventMessageImpl: %+v", err)
	}

	return RawEventMessageImpl{
		eventMessage: parent,
		Type:         value,
		Values:       temp,
	}, nil
