...
var _ UnifiedRoleManagementAlertConfiguration = InvalidLicenseAlertConfiguration{}
...
func (s InvalidLicenseAlertConfiguration) UnifiedRoleManagementAlertConfiguration() BaseUnifiedRoleManagementAlertConfigurationImpl {
...
func (s InvalidLicenseAlertConfiguration) Entity() BaseEntityImpl {
...
var _ json.Marshaler = InvalidLicenseAlertConfiguration{}

func (s InvalidLicenseAlertConfiguration) MarshalJSON() ([]byte, error) {
	type wrapper InvalidLicenseAlertConfiguration
	wrapped := wrapper(s)
	encoded, err := json.Marshal(wrapped)
	if err != nil {
		return nil, fmt.Errorf("marshaling InvalidLicenseAlertConfiguration: %+v", err)
	}

	var decoded map[string]interface{}
	if err = json.Unmarshal(encoded, &decoded); err != nil {
		return nil, fmt.Errorf("unmarshaling InvalidLicenseAlertConfiguration: %+v", err)
	}

	if !s.OmitDiscriminatedValue {
		decoded["@odata.type"] = "#microsoft.graph.invalidLicenseAlertConfiguration"
	}

	encoded, err = json.Marshal(decoded)
	if err != nil {
		return nil, fmt.Errorf("re-marshaling InvalidLicenseAlertConfiguration: %+v", err)
	}
