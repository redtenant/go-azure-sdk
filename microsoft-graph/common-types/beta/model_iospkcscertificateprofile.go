...
var _ IosCertificateProfileBase = IosPkcsCertificateProfile{}
...
func (s IosPkcsCertificateProfile) IosCertificateProfileBase() BaseIosCertificateProfileBaseImpl {
...
func (s IosPkcsCertificateProfile) IosCertificateProfile() BaseIosCertificateProfileImpl {
...
func (s IosPkcsCertificateProfile) DeviceConfiguration() BaseDeviceConfigurationImpl {
...
func (s IosPkcsCertificateProfile) Entity() BaseEntityImpl {
...
var _ json.Marshaler = IosPkcsCertificateProfile{}

func (s IosPkcsCertificateProfile) MarshalJSON() ([]byte, error) {
	type wrapper IosPkcsCertificateProfile
	wrapped := wrapper(s)
	encoded, err := json.Marshal(wrapped)
	if err != nil {
		return nil, fmt.Errorf("marshaling IosPkcsCertificateProfile: %+v", err)
	}

	var decoded map[string]interface{}
	if err = json.Unmarshal(encoded, &decoded); err != nil {
		return nil, fmt.Errorf("unmarshaling IosPkcsCertificateProfile: %+v", err)
	}

	if !s.OmitDiscriminatedValue {
		decoded["@odata.type"] = "#microsoft.graph.iosPkcsCertificateProfile"
	}

	encoded, err = json.Marshal(decoded)
	if err != nil {
		return nil, fmt.Errorf("re-marshaling IosPkcsCertificateProfile: %+v", err)
	}
