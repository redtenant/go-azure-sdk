...
type IosUpdateConfiguration struct {
	...
	// If update schedule type is set to use time window scheduling, custom time windows when updates will be scheduled.
	// This collection can contain a maximum of 20 elements.
	...
	DesiredOsVersion nullable.Type[string] `json:"desiredOsVersion,omitempty"`

	// Days before software updates are visible to iOS devices ranging from 0 to 90 inclusive
	EnforcedSoftwareUpdateDelayInDays nullable.Type[int64] `json:"enforcedSoftwareUpdateDelayInDays,omitempty"`
