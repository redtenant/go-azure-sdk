...
var _ ManagedApp = ManagedIOSStoreApp{}
...
func (s ManagedIOSStoreApp) ManagedApp() BaseManagedAppImpl {
...
func (s ManagedIOSStoreApp) MobileApp() BaseMobileAppImpl {
...
func (s ManagedIOSStoreApp) Entity() BaseEntityImpl {
...
var _ json.Marshaler = ManagedIOSStoreApp{}

func (s ManagedIOSStoreApp) MarshalJSON() ([]byte, error) {
	type wrapper ManagedIOSStoreApp
	wrapped := wrapper(s)
	encoded, err := json.Marshal(wrapped)
	if err != nil {
		return nil, fmt.Errorf("marshaling ManagedIOSStoreApp: %+v", err)
	}

	var decoded map[string]interface{}
	if err = json.Unmarshal(encoded, &decoded); err != nil {
		return nil, fmt.Errorf("unmarshaling ManagedIOSStoreApp: %+v", err)
	}

	if !s.OmitDiscriminatedValue {
		decoded["@odata.type"] = "#microsoft.graph.managedIOSStoreApp"
	}

	encoded, err = json.Marshal(decoded)
	if err != nil {
		return nil, fmt.Errorf("re-marshaling ManagedIOSStoreApp: %+v", err)
	}

	return encoded, nil
}

var _ json.Unmarshaler = &ManagedIOSStoreApp{}

func (s *ManagedIOSStoreApp) UnmarshalJSON(bytes []byte) error {
	var decoded struct {
		AppStoreUrl                     *string                    `json:"appStoreUrl,omitempty"`
		ApplicableDeviceType            *IosDeviceType             `json:"applicableDeviceType,omitempty"`
		BundleId                        nullable.Type[string]      `json:"bundleId,omitempty"`
	...
	s.ApplicableDeviceType = decoded.ApplicableDeviceType
	...
	if err := json.Unmarshal(bytes, &temp); err != nil {
		return fmt.Errorf("unmarshaling ManagedIOSStoreApp into map[string]json.RawMessage: %+v", err)
	}
	...
	if v, ok := temp["relationships"]; ok {
		...
		for i, val := range listTemp {
			...
			if err != nil {
				return fmt.Errorf("unmarshaling index %d field 'Relationships' for 'ManagedIOSStoreApp': %+v", i, err)
			}
