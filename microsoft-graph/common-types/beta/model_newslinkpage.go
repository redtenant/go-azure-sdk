...
func (s NewsLinkPage) BaseSitePage() BaseBaseSitePageImpl {
...
func (s NewsLinkPage) BaseItem() BaseBaseItemImpl {
...
func (s NewsLinkPage) Entity() BaseEntityImpl {
...
var _ json.Marshaler = NewsLinkPage{}

func (s NewsLinkPage) MarshalJSON() ([]byte, error) {
	type wrapper NewsLinkPage
	wrapped := wrapper(s)
	encoded, err := json.Marshal(wrapped)
	if err != nil {
		return nil, fmt.Errorf("marshaling NewsLinkPage: %+v", err)
	}
	...
	if err != nil {
		return nil, fmt.Errorf("re-marshaling NewsLinkPage: %+v", err)
	}
...
func (s *NewsLinkPage) UnmarshalJSON(bytes []byte) error {
	...
	if err := json.Unmarshal(bytes, &temp); err != nil {
		return fmt.Errorf("unmarshaling NewsLinkPage into map[string]json.RawMessage: %+v", err)
	}

	if v, ok := temp["createdBy"]; ok {
		impl, err := UnmarshalIdentitySetImplementation(v)
		if err != nil {
			return fmt.Errorf("unmarshaling field 'CreatedBy' for 'NewsLinkPage': %+v", err)
		}
		s.CreatedBy = &impl
	}
	...
	if v, ok := temp["lastModifiedBy"]; ok {
		impl, err := UnmarshalIdentitySetImplementation(v)
		if err != nil {
			return fmt.Errorf("unmarshaling field 'LastModifiedBy' for 'NewsLinkPage': %+v", err)
		}
