...
var _ CustomAuthenticationExtension = OnAttributeCollectionStartCustomExtension{}
...
func (s OnAttributeCollectionStartCustomExtension) CustomCalloutExtension() BaseCustomCalloutExtensionImpl {
...
func (s OnAttributeCollectionStartCustomExtension) Entity() BaseEntityImpl {
...
var _ json.Marshaler = OnAttributeCollectionStartCustomExtension{}

func (s OnAttributeCollectionStartCustomExtension) MarshalJSON() ([]byte, error) {
	type wrapper OnAttributeCollectionStartCustomExtension
	wrapped := wrapper(s)
	encoded, err := json.Marshal(wrapped)
	if err != nil {
		return nil, fmt.Errorf("marshaling OnAttributeCollectionStartCustomExtension: %+v", err)
	}

	var decoded map[string]interface{}
	if err = json.Unmarshal(encoded, &decoded); err != nil {
		return nil, fmt.Errorf("unmarshaling OnAttributeCollectionStartCustomExtension: %+v", err)
	}

	if !s.OmitDiscriminatedValue {
		decoded["@odata.type"] = "#microsoft.graph.onAttributeCollectionStartCustomExtension"
	}

	encoded, err = json.Marshal(decoded)
	if err != nil {
		return nil, fmt.Errorf("re-marshaling OnAttributeCollectionStartCustomExtension: %+v", err)
	}

	return encoded, nil
}

var _ json.Unmarshaler = &OnAttributeCollectionStartCustomExtension{}

func (s *OnAttributeCollectionStartCustomExtension) UnmarshalJSON(bytes []byte) error {
	var decoded struct {
		ClientConfiguration *CustomExtensionClientConfiguration `json:"clientConfiguration,omitempty"`
		Description         nullable.Type[string]               `json:"description,omitempty"`
		DisplayName         nullable.Type[string]               `json:"displayName,omitempty"`
	...
	if err := json.Unmarshal(bytes, &temp); err != nil {
		return fmt.Errorf("unmarshaling OnAttributeCollectionStartCustomExtension into map[string]json.RawMessage: %+v", err)
	}
	...
	if v, ok := temp["endpointConfiguration"]; ok {
		...
		if err != nil {
			return fmt.Errorf("unmarshaling field 'EndpointConfiguration' for 'OnAttributeCollectionStartCustomExtension': %+v", err)
		}
