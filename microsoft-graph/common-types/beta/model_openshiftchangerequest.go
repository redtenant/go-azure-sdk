...
var _ ScheduleChangeRequest = OpenShiftChangeRequest{}
...
func (s OpenShiftChangeRequest) ScheduleChangeRequest() BaseScheduleChangeRequestImpl {
...
func (s OpenShiftChangeRequest) ChangeTrackedEntity() BaseChangeTrackedEntityImpl {
...
func (s OpenShiftChangeRequest) Entity() BaseEntityImpl {
...
var _ json.Marshaler = OpenShiftChangeRequest{}

func (s OpenShiftChangeRequest) MarshalJSON() ([]byte, error) {
	type wrapper OpenShiftChangeRequest
	wrapped := wrapper(s)
	encoded, err := json.Marshal(wrapped)
	if err != nil {
		return nil, fmt.Errorf("marshaling OpenShiftChangeRequest: %+v", err)
	}

	var decoded map[string]interface{}
	if err = json.Unmarshal(encoded, &decoded); err != nil {
		return nil, fmt.Errorf("unmarshaling OpenShiftChangeRequest: %+v", err)
	}

	if !s.OmitDiscriminatedValue {
		decoded["@odata.type"] = "#microsoft.graph.openShiftChangeRequest"
	}

	encoded, err = json.Marshal(decoded)
	if err != nil {
		return nil, fmt.Errorf("re-marshaling OpenShiftChangeRequest: %+v", err)
	}
...
func (s *OpenShiftChangeRequest) UnmarshalJSON(bytes []byte) error {
	...
	if err := json.Unmarshal(bytes, &temp); err != nil {
		return fmt.Errorf("unmarshaling OpenShiftChangeRequest into map[string]json.RawMessage: %+v", err)
	}

	if v, ok := temp["createdBy"]; ok {
		impl, err := UnmarshalIdentitySetImplementation(v)
		if err != nil {
			return fmt.Errorf("unmarshaling field 'CreatedBy' for 'OpenShiftChangeRequest': %+v", err)
		}
		s.CreatedBy = impl
	}
	...
	if v, ok := temp["lastModifiedBy"]; ok {
		impl, err := UnmarshalIdentitySetImplementation(v)
		if err != nil {
			return fmt.Errorf("unmarshaling field 'LastModifiedBy' for 'OpenShiftChangeRequest': %+v", err)
		}
