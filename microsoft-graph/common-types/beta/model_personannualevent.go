...
var _ ItemFacet = PersonAnnualEvent{}
...
func (s PersonAnnualEvent) ItemFacet() BaseItemFacetImpl {
...
func (s PersonAnnualEvent) Entity() BaseEntityImpl {
...
var _ json.Marshaler = PersonAnnualEvent{}

func (s PersonAnnualEvent) MarshalJSON() ([]byte, error) {
	type wrapper PersonAnnualEvent
	wrapped := wrapper(s)
	encoded, err := json.Marshal(wrapped)
	if err != nil {
		return nil, fmt.Errorf("marshaling PersonAnnualEvent: %+v", err)
	}

	var decoded map[string]interface{}
	if err = json.Unmarshal(encoded, &decoded); err != nil {
		return nil, fmt.Errorf("unmarshaling PersonAnnualEvent: %+v", err)
	}

	if !s.OmitDiscriminatedValue {
		decoded["@odata.type"] = "#microsoft.graph.personAnnualEvent"
	}

	encoded, err = json.Marshal(decoded)
	if err != nil {
		return nil, fmt.Errorf("re-marshaling PersonAnnualEvent: %+v", err)
	}
...
func (s *PersonAnnualEvent) UnmarshalJSON(bytes []byte) error {
	...
	if err := json.Unmarshal(bytes, &temp); err != nil {
		return fmt.Errorf("unmarshaling PersonAnnualEvent into map[string]json.RawMessage: %+v", err)
	}

	if v, ok := temp["createdBy"]; ok {
		impl, err := UnmarshalIdentitySetImplementation(v)
		if err != nil {
			return fmt.Errorf("unmarshaling field 'CreatedBy' for 'PersonAnnualEvent': %+v", err)
		}
		s.CreatedBy = impl
	}
	...
	if v, ok := temp["lastModifiedBy"]; ok {
		impl, err := UnmarshalIdentitySetImplementation(v)
		if err != nil {
			return fmt.Errorf("unmarshaling field 'LastModifiedBy' for 'PersonAnnualEvent': %+v", err)
		}
