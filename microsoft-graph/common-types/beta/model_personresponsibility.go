...
var _ ItemFacet = PersonResponsibility{}
...
func (s PersonResponsibility) ItemFacet() BaseItemFacetImpl {
...
func (s PersonResponsibility) Entity() BaseEntityImpl {
...
var _ json.Marshaler = PersonResponsibility{}

func (s PersonResponsibility) MarshalJSON() ([]byte, error) {
	type wrapper PersonResponsibility
	wrapped := wrapper(s)
	encoded, err := json.Marshal(wrapped)
	if err != nil {
		return nil, fmt.Errorf("marshaling PersonResponsibility: %+v", err)
	}

	var decoded map[string]interface{}
	if err = json.Unmarshal(encoded, &decoded); err != nil {
		return nil, fmt.Errorf("unmarshaling PersonResponsibility: %+v", err)
	}

	if !s.OmitDiscriminatedValue {
		decoded["@odata.type"] = "#microsoft.graph.personResponsibility"
	}

	encoded, err = json.Marshal(decoded)
	if err != nil {
		return nil, fmt.Errorf("re-marshaling PersonResponsibility: %+v", err)
	}

	return encoded, nil
}

var _ json.Unmarshaler = &PersonResponsibility{}

func (s *PersonResponsibility) UnmarshalJSON(bytes []byte) error {
	var decoded struct {
		CollaborationTags    *[]string                  `json:"collaborationTags,omitempty"`
		Description          nullable.Type[string]      `json:"description,omitempty"`
		DisplayName          *string                    `json:"displayName,omitempty"`
	...
	if err := json.Unmarshal(bytes, &temp); err != nil {
		return fmt.Errorf("unmarshaling PersonResponsibility into map[string]json.RawMessage: %+v", err)
	}

	if v, ok := temp["createdBy"]; ok {
		impl, err := UnmarshalIdentitySetImplementation(v)
		if err != nil {
			return fmt.Errorf("unmarshaling field 'CreatedBy' for 'PersonResponsibility': %+v", err)
		}
		s.CreatedBy = impl
	}
	...
	if v, ok := temp["lastModifiedBy"]; ok {
		impl, err := UnmarshalIdentitySetImplementation(v)
		if err != nil {
			return fmt.Errorf("unmarshaling field 'LastModifiedBy' for 'PersonResponsibility': %+v", err)
		}
