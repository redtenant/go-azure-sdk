...
var _ SecurityFileThreatSubmission = SecurityFileContentThreatSubmission{}
...
func (s SecurityFileContentThreatSubmission) SecurityFileThreatSubmission() BaseSecurityFileThreatSubmissionImpl {
...
func (s SecurityFileContentThreatSubmission) SecurityThreatSubmission() BaseSecurityThreatSubmissionImpl {
...
func (s SecurityFileContentThreatSubmission) Entity() BaseEntityImpl {
...
var _ json.Marshaler = SecurityFileContentThreatSubmission{}

func (s SecurityFileContentThreatSubmission) MarshalJSON() ([]byte, error) {
	type wrapper SecurityFileContentThreatSubmission
	wrapped := wrapper(s)
	encoded, err := json.Marshal(wrapped)
	if err != nil {
		return nil, fmt.Errorf("marshaling SecurityFileContentThreatSubmission: %+v", err)
	}

	var decoded map[string]interface{}
	if err = json.Unmarshal(encoded, &decoded); err != nil {
		return nil, fmt.Errorf("unmarshaling SecurityFileContentThreatSubmission: %+v", err)
	}

	if !s.OmitDiscriminatedValue {
		decoded["@odata.type"] = "#microsoft.graph.security.fileContentThreatSubmission"
	}

	encoded, err = json.Marshal(decoded)
	if err != nil {
		return nil, fmt.Errorf("re-marshaling SecurityFileContentThreatSubmission: %+v", err)
	}
