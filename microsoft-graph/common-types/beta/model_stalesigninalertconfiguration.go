...
var _ UnifiedRoleManagementAlertConfiguration = StaleSignInAlertConfiguration{}
...
func (s StaleSignInAlertConfiguration) UnifiedRoleManagementAlertConfiguration() BaseUnifiedRoleManagementAlertConfigurationImpl {
...
func (s StaleSignInAlertConfiguration) Entity() BaseEntityImpl {
...
var _ json.Marshaler = StaleSignInAlertConfiguration{}

func (s StaleSignInAlertConfiguration) MarshalJSON() ([]byte, error) {
	type wrapper StaleSignInAlertConfiguration
	wrapped := wrapper(s)
	encoded, err := json.Marshal(wrapped)
	if err != nil {
		return nil, fmt.Errorf("marshaling StaleSignInAlertConfiguration: %+v", err)
	}

	var decoded map[string]interface{}
	if err = json.Unmarshal(encoded, &decoded); err != nil {
		return nil, fmt.Errorf("unmarshaling StaleSignInAlertConfiguration: %+v", err)
	}

	if !s.OmitDiscriminatedValue {
		decoded["@odata.type"] = "#microsoft.graph.staleSignInAlertConfiguration"
	}

	encoded, err = json.Marshal(decoded)
	if err != nil {
		return nil, fmt.Errorf("re-marshaling StaleSignInAlertConfiguration: %+v", err)
	}
