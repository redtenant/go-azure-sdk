...
var _ WindowsCertificateProfileBase = Windows10ImportedPFXCertificateProfile{}
...
func (s Windows10ImportedPFXCertificateProfile) WindowsCertificateProfileBase() BaseWindowsCertificateProfileBaseImpl {
...
func (s Windows10ImportedPFXCertificateProfile) DeviceConfiguration() BaseDeviceConfigurationImpl {
...
func (s Windows10ImportedPFXCertificateProfile) Entity() BaseEntityImpl {
...
var _ json.Marshaler = Windows10ImportedPFXCertificateProfile{}

func (s Windows10ImportedPFXCertificateProfile) MarshalJSON() ([]byte, error) {
	type wrapper Windows10ImportedPFXCertificateProfile
	wrapped := wrapper(s)
	encoded, err := json.Marshal(wrapped)
	if err != nil {
		return nil, fmt.Errorf("marshaling Windows10ImportedPFXCertificateProfile: %+v", err)
	}

	var decoded map[string]interface{}
	if err = json.Unmarshal(encoded, &decoded); err != nil {
		return nil, fmt.Errorf("unmarshaling Windows10ImportedPFXCertificateProfile: %+v", err)
	}

	if !s.OmitDiscriminatedValue {
		decoded["@odata.type"] = "#microsoft.graph.windows10ImportedPFXCertificateProfile"
	}

	encoded, err = json.Marshal(decoded)
	if err != nil {
		return nil, fmt.Errorf("re-marshaling Windows10ImportedPFXCertificateProfile: %+v", err)
	}
