...
var _ Windows10CertificateProfileBase = Windows10PkcsCertificateProfile{}
...
func (s Windows10PkcsCertificateProfile) Windows10CertificateProfileBase() BaseWindows10CertificateProfileBaseImpl {
	return BaseWindows10CertificateProfileBaseImpl{
...
func (s Windows10PkcsCertificateProfile) WindowsCertificateProfileBase() BaseWindowsCertificateProfileBaseImpl {
...
func (s Windows10PkcsCertificateProfile) DeviceConfiguration() BaseDeviceConfigurationImpl {
...
func (s Windows10PkcsCertificateProfile) Entity() BaseEntityImpl {
...
var _ json.Marshaler = Windows10PkcsCertificateProfile{}

func (s Windows10PkcsCertificateProfile) MarshalJSON() ([]byte, error) {
	type wrapper Windows10PkcsCertificateProfile
	wrapped := wrapper(s)
	encoded, err := json.Marshal(wrapped)
	if err != nil {
		return nil, fmt.Errorf("marshaling Windows10PkcsCertificateProfile: %+v", err)
	}

	var decoded map[string]interface{}
	if err = json.Unmarshal(encoded, &decoded); err != nil {
		return nil, fmt.Errorf("unmarshaling Windows10PkcsCertificateProfile: %+v", err)
	}

	if !s.OmitDiscriminatedValue {
		decoded["@odata.type"] = "#microsoft.graph.windows10PkcsCertificateProfile"
	}

	encoded, err = json.Marshal(decoded)
	if err != nil {
		return nil, fmt.Errorf("re-marshaling Windows10PkcsCertificateProfile: %+v", err)
	}
