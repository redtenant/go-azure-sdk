...
var _ DeviceConfiguration = WindowsDomainJoinConfiguration{}
...
type WindowsDomainJoinConfiguration struct {
	...
	// Organizational unit (OU) where the computer account will be created. If this parameter is NULL, the well known
...
func (s WindowsDomainJoinConfiguration) DeviceConfiguration() BaseDeviceConfigurationImpl {
...
func (s WindowsDomainJoinConfiguration) Entity() BaseEntityImpl {
...
var _ json.Marshaler = WindowsDomainJoinConfiguration{}

func (s WindowsDomainJoinConfiguration) MarshalJSON() ([]byte, error) {
	type wrapper WindowsDomainJoinConfiguration
	wrapped := wrapper(s)
	encoded, err := json.Marshal(wrapped)
	if err != nil {
		return nil, fmt.Errorf("marshaling WindowsDomainJoinConfiguration: %+v", err)
	}

	var decoded map[string]interface{}
	if err = json.Unmarshal(encoded, &decoded); err != nil {
		return nil, fmt.Errorf("unmarshaling WindowsDomainJoinConfiguration: %+v", err)
	}

	if !s.OmitDiscriminatedValue {
		decoded["@odata.type"] = "#microsoft.graph.windowsDomainJoinConfiguration"
	}

	encoded, err = json.Marshal(decoded)
	if err != nil {
		return nil, fmt.Errorf("re-marshaling WindowsDomainJoinConfiguration: %+v", err)
	}
...
func (s *WindowsDomainJoinConfiguration) UnmarshalJSON(bytes []byte) error {
	...
	if err := json.Unmarshal(bytes, &temp); err != nil {
		return fmt.Errorf("unmarshaling WindowsDomainJoinConfiguration into map[string]json.RawMessage: %+v", err)
	}

	if v, ok := temp["networkAccessConfigurations"]; ok {
		var listTemp []json.RawMessage
		if err := json.Unmarshal(v, &listTemp); err != nil {
			return fmt.Errorf("unmarshaling NetworkAccessConfigurations into list []json.RawMessage: %+v", err)
		}
		...
		for i, val := range listTemp {
			...
			if err != nil {
				return fmt.Errorf("unmarshaling index %d field 'NetworkAccessConfigurations' for 'WindowsDomainJoinConfiguration': %+v", i, err)
			}
