...
var _ ManagedDevice = WindowsManagedDevice{}

type WindowsManagedDevice struct {

	// Fields inherited from ManagedDevice
...
func (s WindowsManagedDevice) ManagedDevice() BaseManagedDeviceImpl {
	return BaseManagedDeviceImpl{
		AadRegistered:                               s.AadRegistered,
		ActivationLockBypassCode:                    s.ActivationLockBypassCode,
		AndroidSecurityPatchLevel:                   s.AndroidSecurityPatchLevel,
		AssignmentFilterEvaluationStatusDetails:     s.AssignmentFilterEvaluationStatusDetails,
		AutopilotEnrolled:                           s.AutopilotEnrolled,
		AzureADDeviceId:                             s.AzureADDeviceId,
		AzureADRegistered:                           s.AzureADRegistered,
		AzureActiveDirectoryDeviceId:                s.AzureActiveDirectoryDeviceId,
		BootstrapTokenEscrowed:                      s.BootstrapTokenEscrowed,
		ChassisType:                                 s.ChassisType,
		ChromeOSDeviceInfo:                          s.ChromeOSDeviceInfo,
		CloudPCRemoteActionResults:                  s.CloudPCRemoteActionResults,
		ComplianceGracePeriodExpirationDateTime:     s.ComplianceGracePeriodExpirationDateTime,
		ComplianceState:                             s.ComplianceState,
		ConfigurationManagerClientEnabledFeatures:   s.ConfigurationManagerClientEnabledFeatures,
		ConfigurationManagerClientHealthState:       s.ConfigurationManagerClientHealthState,
		ConfigurationManagerClientInformation:       s.ConfigurationManagerClientInformation,
		DetectedApps:                                s.DetectedApps,
		DeviceActionResults:                         s.DeviceActionResults,
		DeviceCategory:                              s.DeviceCategory,
		DeviceCategoryDisplayName:                   s.DeviceCategoryDisplayName,
		DeviceCompliancePolicyStates:                s.DeviceCompliancePolicyStates,
		DeviceConfigurationStates:                   s.DeviceConfigurationStates,
		DeviceEnrollmentType:                        s.DeviceEnrollmentType,
		DeviceFirmwareConfigurationInterfaceManaged: s.DeviceFirmwareConfigurationInterfaceManaged,
		DeviceHealthAttestationState:                s.DeviceHealthAttestationState,
		DeviceHealthScriptStates:                    s.DeviceHealthScriptStates,
		DeviceName:                                  s.DeviceName,
		DeviceRegistrationState:                     s.DeviceRegistrationState,
		DeviceType:                                  s.DeviceType,
		EasActivated:                                s.EasActivated,
		EasActivationDateTime:                       s.EasActivationDateTime,
		EasDeviceId:                                 s.EasDeviceId,
		EmailAddress:                                s.EmailAddress,
		EnrolledByUserPrincipalName:                 s.EnrolledByUserPrincipalName,
		EnrolledDateTime:                            s.EnrolledDateTime,
		EnrollmentProfileName:                       s.EnrollmentProfileName,
		EthernetMacAddress:                          s.EthernetMacAddress,
		ExchangeAccessState:                         s.ExchangeAccessState,
		ExchangeAccessStateReason:                   s.ExchangeAccessStateReason,
		ExchangeLastSuccessfulSyncDateTime:          s.ExchangeLastSuccessfulSyncDateTime,
		FreeStorageSpaceInBytes:                     s.FreeStorageSpaceInBytes,
		HardwareInformation:                         s.HardwareInformation,
		Iccid:                                       s.Iccid,
		Imei:                                        s.Imei,
		...
		LogCollectionRequests:                       s.LogCollectionRequests,
		LostModeState:                               s.LostModeState,
		ManagedDeviceMobileAppConfigurationStates:   s.ManagedDeviceMobileAppConfigurationStates,
		ManagedDeviceName:                           s.ManagedDeviceName,
		ManagedDeviceOwnerType:                      s.ManagedDeviceOwnerType,
		ManagementAgent:                             s.ManagementAgent,
		ManagementCertificateExpirationDate:         s.ManagementCertificateExpirationDate,
		ManagementFeatures:                          s.ManagementFeatures,
		ManagementState:                             s.ManagementState,
		...
		PartnerReportedThreatState:                  s.PartnerReportedThreatState,
		PhoneNumber:                                 s.PhoneNumber,
		PhysicalMemoryInBytes:                       s.PhysicalMemoryInBytes,
		PreferMdmOverGroupPolicyAppliedDateTime:     s.PreferMdmOverGroupPolicyAppliedDateTime,
		ProcessorArchitecture:                       s.ProcessorArchitecture,
		RemoteAssistanceSessionErrorDetails:         s.RemoteAssistanceSessionErrorDetails,
		RemoteAssistanceSessionUrl:                  s.RemoteAssistanceSessionUrl,
		RequireUserEnrollmentApproval:               s.RequireUserEnrollmentApproval,
		RetireAfterDateTime:                         s.RetireAfterDateTime,
		RoleScopeTagIds:                             s.RoleScopeTagIds,
		SecurityBaselineStates:                      s.SecurityBaselineStates,
		SecurityPatchLevel:                          s.SecurityPatchLevel,
		SerialNumber:                                s.SerialNumber,
		SkuFamily:                                   s.SkuFamily,
		SkuNumber:                                   s.SkuNumber,
		SpecificationVersion:                        s.SpecificationVersion,
		SubscriberCarrier:                           s.SubscriberCarrier,
		TotalStorageSpaceInBytes:                    s.TotalStorageSpaceInBytes,
		Udid:                                        s.Udid,
		UserDisplayName:                             s.UserDisplayName,
		UserId:                                      s.UserId,
		UserPrincipalName:                           s.UserPrincipalName,
		Users:                                       s.Users,
		UsersLoggedOn:                               s.UsersLoggedOn,
		WiFiMacAddress:                              s.WiFiMacAddress,
		WindowsActiveMalwareCount:                   s.WindowsActiveMalwareCount,
		WindowsProtectionState:                      s.WindowsProtectionState,
		WindowsRemediatedMalwareCount:               s.WindowsRemediatedMalwareCount,
		Id:                                          s.Id,
		ODataId:                                     s.ODataId,
...
func (s WindowsManagedDevice) Entity() BaseEntityImpl {
...
var _ json.Marshaler = WindowsManagedDevice{}

func (s WindowsManagedDevice) MarshalJSON() ([]byte, error) {
	type wrapper WindowsManagedDevice
	wrapped := wrapper(s)
	encoded, err := json.Marshal(wrapped)
	if err != nil {
		return nil, fmt.Errorf("marshaling WindowsManagedDevice: %+v", err)
	}

	var decoded map[string]interface{}
	if err = json.Unmarshal(encoded, &decoded); err != nil {
		return nil, fmt.Errorf("unmarshaling WindowsManagedDevice: %+v", err)
	}

	if !s.OmitDiscriminatedValue {
		decoded["@odata.type"] = "#microsoft.graph.windowsManagedDevice"
	}

	encoded, err = json.Marshal(decoded)
	if err != nil {
		return nil, fmt.Errorf("re-marshaling WindowsManagedDevice: %+v", err)
	}
...
func (s *WindowsManagedDevice) UnmarshalJSON(bytes []byte) error {
	...
	if err := json.Unmarshal(bytes, &temp); err != nil {
		return fmt.Errorf("unmarshaling WindowsManagedDevice into map[string]json.RawMessage: %+v", err)
	}
	...
	if v, ok := temp["deviceActionResults"]; ok {
		...
		for i, val := range listTemp {
			...
			if err != nil {
				return fmt.Errorf("unmarshaling index %d field 'DeviceActionResults' for 'WindowsManagedDevice': %+v", i, err)
			}
