...
var _ WindowsPhone81AppX = WindowsPhone81AppXBundle{}
...
type WindowsPhone81AppXBundle struct {
	...
	// Fields inherited from WindowsPhone81AppX
...
func (s WindowsPhone81AppXBundle) WindowsPhone81AppX() BaseWindowsPhone81AppXImpl {
	return BaseWindowsPhone81AppXImpl{
		ApplicableArchitectures:         s.ApplicableArchitectures,
		IdentityName:                    s.IdentityName,
		IdentityPublisherHash:           s.IdentityPublisherHash,
		IdentityResourceIdentifier:      s.IdentityResourceIdentifier,
		IdentityVersion:                 s.IdentityVersion,
		MinimumSupportedOperatingSystem: s.MinimumSupportedOperatingSystem,
		PhoneProductIdentifier:          s.PhoneProductIdentifier,
		PhonePublisherId:                s.PhonePublisherId,
...
func (s WindowsPhone81AppXBundle) MobileLobApp() BaseMobileLobAppImpl {
...
func (s WindowsPhone81AppXBundle) MobileApp() BaseMobileAppImpl {
...
func (s WindowsPhone81AppXBundle) Entity() BaseEntityImpl {
...
var _ json.Marshaler = WindowsPhone81AppXBundle{}

func (s WindowsPhone81AppXBundle) MarshalJSON() ([]byte, error) {
	type wrapper WindowsPhone81AppXBundle
	wrapped := wrapper(s)
	encoded, err := json.Marshal(wrapped)
	if err != nil {
		return nil, fmt.Errorf("marshaling WindowsPhone81AppXBundle: %+v", err)
	}

	var decoded map[string]interface{}
	if err = json.Unmarshal(encoded, &decoded); err != nil {
		return nil, fmt.Errorf("unmarshaling WindowsPhone81AppXBundle: %+v", err)
	}

	if !s.OmitDiscriminatedValue {
		decoded["@odata.type"] = "#microsoft.graph.windowsPhone81AppXBundle"
	}

	encoded, err = json.Marshal(decoded)
	if err != nil {
		return nil, fmt.Errorf("re-marshaling WindowsPhone81AppXBundle: %+v", err)
	}

	return encoded, nil
}

var _ json.Unmarshaler = &WindowsPhone81AppXBundle{}

func (s *WindowsPhone81AppXBundle) UnmarshalJSON(bytes []byte) error {
	var decoded struct {
		AppXPackageInformationList      *[]WindowsPackageInformation   `json:"appXPackageInformationList,omitempty"`
		ApplicableArchitectures         *WindowsArchitecture           `json:"applicableArchitectures,omitempty"`
		IdentityName                    nullable.Type[string]          `json:"identityName,omitempty"`
	...
	s.AppXPackageInformationList = decoded.AppXPackageInformationList
	...
	if err := json.Unmarshal(bytes, &temp); err != nil {
		return fmt.Errorf("unmarshaling WindowsPhone81AppXBundle into map[string]json.RawMessage: %+v", err)
	}
	...
	if v, ok := temp["relationships"]; ok {
		...
		for i, val := range listTemp {
			...
			if err != nil {
				return fmt.Errorf("unmarshaling index %d field 'Relationships' for 'WindowsPhone81AppXBundle': %+v", i, err)
			}
