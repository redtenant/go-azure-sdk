...
var _ WindowsCertificateProfileBase = WindowsPhone81ImportedPFXCertificateProfile{}
...
func (s WindowsPhone81ImportedPFXCertificateProfile) WindowsCertificateProfileBase() BaseWindowsCertificateProfileBaseImpl {
...
func (s WindowsPhone81ImportedPFXCertificateProfile) DeviceConfiguration() BaseDeviceConfigurationImpl {
...
func (s WindowsPhone81ImportedPFXCertificateProfile) Entity() BaseEntityImpl {
...
var _ json.Marshaler = WindowsPhone81ImportedPFXCertificateProfile{}

func (s WindowsPhone81ImportedPFXCertificateProfile) MarshalJSON() ([]byte, error) {
	type wrapper WindowsPhone81ImportedPFXCertificateProfile
	wrapped := wrapper(s)
	encoded, err := json.Marshal(wrapped)
	if err != nil {
		return nil, fmt.Errorf("marshaling WindowsPhone81ImportedPFXCertificateProfile: %+v", err)
	}

	var decoded map[string]interface{}
	if err = json.Unmarshal(encoded, &decoded); err != nil {
		return nil, fmt.Errorf("unmarshaling WindowsPhone81ImportedPFXCertificateProfile: %+v", err)
	}

	if !s.OmitDiscriminatedValue {
		decoded["@odata.type"] = "#microsoft.graph.windowsPhone81ImportedPFXCertificateProfile"
	}

	encoded, err = json.Marshal(decoded)
	if err != nil {
		return nil, fmt.Errorf("re-marshaling WindowsPhone81ImportedPFXCertificateProfile: %+v", err)
	}
