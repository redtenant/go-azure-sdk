...
var _ EventMessage = EventMessageResponse{}
...
type EventMessageResponse struct {
	...
	// Specifies the type of response to a meeting request. Possible values are: tentativelyAccepted, accepted, declined.
	// For the eventMessageResponse type, none, organizer, and notResponded are not supported. Read-only. Not filterable.
...
func (s EventMessageResponse) EventMessage() BaseEventMessageImpl {
...
func (s EventMessageResponse) Message() BaseMessageImpl {
...
func (s EventMessageResponse) OutlookItem() BaseOutlookItemImpl {
...
func (s EventMessageResponse) Entity() BaseEntityImpl {
...
var _ json.Marshaler = EventMessageResponse{}

func (s EventMessageResponse) MarshalJSON() ([]byte, error) {
	type wrapper EventMessageResponse
	wrapped := wrapper(s)
	encoded, err := json.Marshal(wrapped)
	if err != nil {
		return nil, fmt.Errorf("marshaling EventMessageResponse: %+v", err)
	}

	var decoded map[string]interface{}
	if err = json.Unmarshal(encoded, &decoded); err != nil {
		return nil, fmt.Errorf("unmarshaling EventMessageResponse: %+v", err)
	}

	delete(decoded, "proposedNewTime")
	delete(decoded, "responseType")

	if !s.OmitDiscriminatedValue {
		decoded["@odata.type"] = "#microsoft.graph.eventMessageResponse"
	}

	encoded, err = json.Marshal(decoded)
	if err != nil {
		return nil, fmt.Errorf("re-marshaling EventMessageResponse: %+v", err)
	}

	return encoded, nil
}

var _ json.Unmarshaler = &EventMessageResponse{}

func (s *EventMessageResponse) UnmarshalJSON(bytes []byte) error {
	var decoded struct {
		ProposedNewTime               *TimeSlot                            `json:"proposedNewTime,omitempty"`
		ResponseType                  *ResponseType                        `json:"responseType,omitempty"`
		EndDateTime                   *DateTimeTimeZone                    `json:"endDateTime,omitempty"`
	...
	if err := json.Unmarshal(bytes, &temp); err != nil {
		return fmt.Errorf("unmarshaling EventMessageResponse into map[string]json.RawMessage: %+v", err)
	}
	...
	if v, ok := temp["attachments"]; ok {
		...
		for i, val := range listTemp {
			...
			if err != nil {
				return fmt.Errorf("unmarshaling index %d field 'Attachments' for 'EventMessageResponse': %+v", i, err)
			}
	...
	if v, ok := temp["bccRecipients"]; ok {
		...
		for i, val := range listTemp {
			...
			if err != nil {
				return fmt.Errorf("unmarshaling index %d field 'BccRecipients' for 'EventMessageResponse': %+v", i, err)
			}
			output = append(output, impl)
		}
	...
	if v, ok := temp["ccRecipients"]; ok {
		...
		for i, val := range listTemp {
			impl, err := UnmarshalRecipientImplementation(val)
			if err != nil {
				return fmt.Errorf("unmarshaling index %d field 'CcRecipients' for 'EventMessageResponse': %+v", i, err)
			}
			output = append(output, impl)
		}
	...
	if v, ok := temp["extensions"]; ok {
		...
		for i, val := range listTemp {
			...
			if err != nil {
				return fmt.Errorf("unmarshaling index %d field 'Extensions' for 'EventMessageResponse': %+v", i, err)
			}
			output = append(output, impl)
		}
		s.Extensions = &output
	...
	if v, ok := temp["from"]; ok {
		...
		if err != nil {
			return fmt.Errorf("unmarshaling field 'From' for 'EventMessageResponse': %+v", err)
		}
		s.From = impl
	}
	...
	if v, ok := temp["location"]; ok {
		...
		if err != nil {
			return fmt.Errorf("unmarshaling field 'Location' for 'EventMessageResponse': %+v", err)
		}
		s.Location = impl
	}
	...
	if v, ok := temp["replyTo"]; ok {
		...
		for i, val := range listTemp {
			impl, err := UnmarshalRecipientImplementation(val)
			if err != nil {
				return fmt.Errorf("unmarshaling index %d field 'ReplyTo' for 'EventMessageResponse': %+v", i, err)
			}
			output = append(output, impl)
		}
		s.ReplyTo = &output
	...
	if v, ok := temp["sender"]; ok {
		impl, err := UnmarshalRecipientImplementation(v)
		if err != nil {
			return fmt.Errorf("unmarshaling field 'Sender' for 'EventMessageResponse': %+v", err)
		}
		s.Sender = impl
	}
	...
	if v, ok := temp["toRecipients"]; ok {
		...
		for i, val := range listTemp {
			impl, err := UnmarshalRecipientImplementation(val)
			if err != nil {
				return fmt.Errorf("unmarshaling index %d field 'ToRecipients' for 'EventMessageResponse': %+v", i, err)
			}
			output = append(output, impl)
		}
