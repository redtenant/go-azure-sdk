...
var _ OrganizationalBrandingProperties = OrganizationalBrandingLocalization{}
...
func (s OrganizationalBrandingLocalization) OrganizationalBrandingProperties() BaseOrganizationalBrandingPropertiesImpl {
...
func (s OrganizationalBrandingLocalization) Entity() BaseEntityImpl {
...
var _ json.Marshaler = OrganizationalBrandingLocalization{}

func (s OrganizationalBrandingLocalization) MarshalJSON() ([]byte, error) {
	type wrapper OrganizationalBrandingLocalization
	wrapped := wrapper(s)
	encoded, err := json.Marshal(wrapped)
	if err != nil {
		return nil, fmt.Errorf("marshaling OrganizationalBrandingLocalization: %+v", err)
	}

	var decoded map[string]interface{}
	if err = json.Unmarshal(encoded, &decoded); err != nil {
		return nil, fmt.Errorf("unmarshaling OrganizationalBrandingLocalization: %+v", err)
	}

	if !s.OmitDiscriminatedValue {
		decoded["@odata.type"] = "#microsoft.graph.organizationalBrandingLocalization"
	}

	encoded, err = json.Marshal(decoded)
	if err != nil {
		return nil, fmt.Errorf("re-marshaling OrganizationalBrandingLocalization: %+v", err)
	}
