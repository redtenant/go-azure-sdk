...
type PhoneAuthenticationMethod struct {
	...
	// {number}x{extension}, with extension optional. For example, +1 5555551234 or +1 5555551234x123 are valid. Numbers are
	// rejected when creating or updating if they don't match the required format.
