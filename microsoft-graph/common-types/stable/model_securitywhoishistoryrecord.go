...
var _ SecurityWhoisBaseRecord = SecurityWhoisHistoryRecord{}

type SecurityWhoisHistoryRecord struct {
...
func (s SecurityWhoisHistoryRecord) SecurityWhoisBaseRecord() BaseSecurityWhoisBaseRecordImpl {
...
func (s SecurityWhoisHistoryRecord) Entity() BaseEntityImpl {
...
var _ json.Marshaler = SecurityWhoisHistoryRecord{}

func (s SecurityWhoisHistoryRecord) MarshalJSON() ([]byte, error) {
	type wrapper SecurityWhoisHistoryRecord
	wrapped := wrapper(s)
	encoded, err := json.Marshal(wrapped)
	if err != nil {
		return nil, fmt.Errorf("marshaling SecurityWhoisHistoryRecord: %+v", err)
	}

	var decoded map[string]interface{}
	if err = json.Unmarshal(encoded, &decoded); err != nil {
		return nil, fmt.Errorf("unmarshaling SecurityWhoisHistoryRecord: %+v", err)
	}

	if !s.OmitDiscriminatedValue {
		decoded["@odata.type"] = "#microsoft.graph.security.whoisHistoryRecord"
	}

	encoded, err = json.Marshal(decoded)
	if err != nil {
		return nil, fmt.Errorf("re-marshaling SecurityWhoisHistoryRecord: %+v", err)
	}
...
func (s *SecurityWhoisHistoryRecord) UnmarshalJSON(bytes []byte) error {
	...
	if err := json.Unmarshal(bytes, &temp); err != nil {
		return fmt.Errorf("unmarshaling SecurityWhoisHistoryRecord into map[string]json.RawMessage: %+v", err)
	}

	if v, ok := temp["host"]; ok {
		impl, err := UnmarshalSecurityHostImplementation(v)
		if err != nil {
			return fmt.Errorf("unmarshaling field 'Host' for 'SecurityWhoisHistoryRecord': %+v", err)
		}
		s.Host = &impl
	}
