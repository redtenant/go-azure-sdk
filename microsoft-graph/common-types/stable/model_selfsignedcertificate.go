...
type SelfSignedCertificate struct {
	...
	// 8601 format and is always in UTC time. For example, midnight UTC on January 1, 2014 is 2014-01-01T00:00:00Z.
	...
	// using ISO 8601 format and is always in UTC time. For example, midnight UTC on January 1, 2014 is
