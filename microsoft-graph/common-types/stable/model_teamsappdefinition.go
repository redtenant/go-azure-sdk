...
type TeamsAppDefinition struct {
	...
	// Teams app has been approved by the admin and the app is published. rejected—The admin rejected the request to
	// publish the specific version of the Teams app.
