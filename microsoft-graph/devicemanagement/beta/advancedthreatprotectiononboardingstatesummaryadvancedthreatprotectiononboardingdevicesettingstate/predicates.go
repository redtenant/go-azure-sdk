...
func (p AdvancedThreatProtectionOnboardingDeviceSettingStateOperationPredicate) Matches(input beta.AdvancedThreatProtectionOnboardingDeviceSettingState) bool {
