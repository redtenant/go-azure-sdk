...
func (c AuditEventClient) DeleteAuditEvent(ctx context.Context, id beta.DeviceManagementAuditEventId, options DeleteAuditEventOperationOptions) (result DeleteAuditEventOperationResponse, err error) {
