...
func (c AuditEventClient) GetAuditEvent(ctx context.Context, id beta.DeviceManagementAuditEventId, options GetAuditEventOperationOptions) (result GetAuditEventOperationResponse, err error) {
