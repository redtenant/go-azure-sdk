...
func DefaultListComanagedDevicesOperationOptions() ListComanagedDevicesOperationOptions {
	return ListComanagedDevicesOperationOptions{}
}

func (o ListComanagedDevicesOperationOptions) ToHeaders() *client.Headers {
	out := client.Headers{}

	return &out
}

func (o ListComanagedDevicesOperationOptions) ToOData() *odata.Query {
	out := odata.Query{}
	if o.Count != nil {
		out.Count = *o.Count
	}
...
func (o ListComanagedDevicesOperationOptions) ToQuery() *client.QueryParams {
...
func (c ComanagedDeviceClient) ListComanagedDevices(ctx context.Context, options ListComanagedDevicesOperationOptions) (result ListComanagedDevicesOperationResponse, err error) {
...
func (c ComanagedDeviceClient) ListComanagedDevicesComplete(ctx context.Context, options ListComanagedDevicesOperationOptions) (ListComanagedDevicesCompleteResult, error) {
	return c.ListComanagedDevicesCompleteMatchingPredicate(ctx, options, ManagedDeviceOperationPredicate{})
}
...
func (c ComanagedDeviceClient) ListComanagedDevicesCompleteMatchingPredicate(ctx context.Context, options ListComanagedDevicesOperationOptions, predicate ManagedDeviceOperationPredicate) (result ListComanagedDevicesCompleteResult, err error) {
	...
	resp, err := c.ListComanagedDevices(ctx, options)
	if err != nil {
