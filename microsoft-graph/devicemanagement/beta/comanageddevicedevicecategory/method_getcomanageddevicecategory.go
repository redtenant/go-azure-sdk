...
type GetComanagedDeviceCategoryOperationResponse struct {
	HttpResponse *http.Response
	OData        *odata.OData
	Model        *beta.DeviceCategory
}

type GetComanagedDeviceCategoryOperationOptions struct {
	Expand    *odata.Expand
...
func DefaultGetComanagedDeviceCategoryOperationOptions() GetComanagedDeviceCategoryOperationOptions {
	return GetComanagedDeviceCategoryOperationOptions{}
}
