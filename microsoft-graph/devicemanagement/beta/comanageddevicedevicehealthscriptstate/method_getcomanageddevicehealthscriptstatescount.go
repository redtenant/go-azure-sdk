...
type GetComanagedDeviceHealthScriptStatesCountOperationResponse struct {
	HttpResponse *http.Response
	OData        *odata.OData
	Model        *[]byte
}

type GetComanagedDeviceHealthScriptStatesCountOperationOptions struct {
	Filter    *string
...
func DefaultGetComanagedDeviceHealthScriptStatesCountOperationOptions() GetComanagedDeviceHealthScriptStatesCountOperationOptions {
	return GetComanagedDeviceHealthScriptStatesCountOperationOptions{}
}
