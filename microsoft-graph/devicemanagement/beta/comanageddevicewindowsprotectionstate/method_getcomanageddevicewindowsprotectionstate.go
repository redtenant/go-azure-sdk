...
type GetComanagedDeviceWindowsProtectionStateOperationResponse struct {
	HttpResponse *http.Response
	OData        *odata.OData
	Model        *beta.WindowsProtectionState
}

type GetComanagedDeviceWindowsProtectionStateOperationOptions struct {
	Expand    *odata.Expand
...
func DefaultGetComanagedDeviceWindowsProtectionStateOperationOptions() GetComanagedDeviceWindowsProtectionStateOperationOptions {
	return GetComanagedDeviceWindowsProtectionStateOperationOptions{}
}
...
// GetComanagedDeviceWindowsProtectionState - Get windowsProtectionState from deviceManagement. The device protection
