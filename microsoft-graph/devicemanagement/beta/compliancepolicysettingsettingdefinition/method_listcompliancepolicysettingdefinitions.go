...
func (c CompliancePolicySettingSettingDefinitionClient) ListCompliancePolicySettingDefinitions(ctx context.Context, id beta.DeviceManagementCompliancePolicyIdSettingId, options ListCompliancePolicySettingDefinitionsOperationOptions) (result ListCompliancePolicySettingDefinitionsOperationResponse, err error) {
...
func (c CompliancePolicySettingSettingDefinitionClient) ListCompliancePolicySettingDefinitionsComplete(ctx context.Context, id beta.DeviceManagementCompliancePolicyIdSettingId, options ListCompliancePolicySettingDefinitionsOperationOptions) (ListCompliancePolicySettingDefinitionsCompleteResult, error) {
