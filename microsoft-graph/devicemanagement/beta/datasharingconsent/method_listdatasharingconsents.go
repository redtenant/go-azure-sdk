...
type ListDataSharingConsentsOperationResponse struct {
	HttpResponse *http.Response
	OData        *odata.OData
	Model        *[]beta.DataSharingConsent
}

type ListDataSharingConsentsCompleteResult struct {
	LatestHttpResponse *http.Response
	Items              []beta.DataSharingConsent
}

type ListDataSharingConsentsOperationOptions struct {
	Count     *bool
	Expand    *odata.Expand
	Filter    *string
...
func DefaultListDataSharingConsentsOperationOptions() ListDataSharingConsentsOperationOptions {
	return ListDataSharingConsentsOperationOptions{}
}
...
type ListDataSharingConsentsCustomPager struct {
...
func (c DataSharingConsentClient) ListDataSharingConsents(ctx context.Context, options ListDataSharingConsentsOperationOptions) (result ListDataSharingConsentsOperationResponse, err error) {
	opts := client.RequestOptions{
		...
		Pager:         &ListDataSharingConsentsCustomPager{},
	...
	var values struct {
		Values *[]beta.DataSharingConsent `json:"value"`
	}
...
func (c DataSharingConsentClient) ListDataSharingConsentsComplete(ctx context.Context, options ListDataSharingConsentsOperationOptions) (ListDataSharingConsentsCompleteResult, error) {
	return c.ListDataSharingConsentsCompleteMatchingPredicate(ctx, options, DataSharingConsentOperationPredicate{})
}
...
func (c DataSharingConsentClient) ListDataSharingConsentsCompleteMatchingPredicate(ctx context.Context, options ListDataSharingConsentsOperationOptions, predicate DataSharingConsentOperationPredicate) (result ListDataSharingConsentsCompleteResult, err error) {
	items := make([]beta.DataSharingConsent, 0)

	resp, err := c.ListDataSharingConsents(ctx, options)
	if err != nil {
	...
	result = ListDataSharingConsentsCompleteResult{
