...
func (c DetectedAppManagedDeviceClient) GetDetectedAppManagedDevice(ctx context.Context, id beta.DeviceManagementDetectedAppIdManagedDeviceId, options GetDetectedAppManagedDeviceOperationOptions) (result GetDetectedAppManagedDeviceOperationResponse, err error) {
