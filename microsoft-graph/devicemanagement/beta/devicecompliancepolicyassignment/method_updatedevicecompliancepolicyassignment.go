...
type UpdateDeviceCompliancePolicyAssignmentOperationResponse struct {
...
// UpdateDeviceCompliancePolicyAssignment - Update the navigation property assignments in deviceManagement
func (c DeviceCompliancePolicyAssignmentClient) UpdateDeviceCompliancePolicyAssignment(ctx context.Context, id beta.DeviceManagementDeviceCompliancePolicyIdAssignmentId, input beta.DeviceCompliancePolicyAssignment, options UpdateDeviceCompliancePolicyAssignmentOperationOptions) (result UpdateDeviceCompliancePolicyAssignmentOperationResponse, err error) {
