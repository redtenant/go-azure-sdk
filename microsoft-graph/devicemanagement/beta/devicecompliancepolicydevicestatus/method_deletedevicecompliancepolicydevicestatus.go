...
// DeleteDeviceCompliancePolicyDeviceStatus - Delete navigation property deviceStatuses for deviceManagement
func (c DeviceCompliancePolicyDeviceStatusClient) DeleteDeviceCompliancePolicyDeviceStatus(ctx context.Context, id beta.DeviceManagementDeviceCompliancePolicyIdDeviceStatusId, options DeleteDeviceCompliancePolicyDeviceStatusOperationOptions) (result DeleteDeviceCompliancePolicyDeviceStatusOperationResponse, err error) {
