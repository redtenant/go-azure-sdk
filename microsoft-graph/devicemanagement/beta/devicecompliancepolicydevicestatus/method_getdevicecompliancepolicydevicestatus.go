...
// GetDeviceCompliancePolicyDeviceStatus - Get deviceStatuses from deviceManagement. List of
// DeviceComplianceDeviceStatus.
func (c DeviceCompliancePolicyDeviceStatusClient) GetDeviceCompliancePolicyDeviceStatus(ctx context.Context, id beta.DeviceManagementDeviceCompliancePolicyIdDeviceStatusId, options GetDeviceCompliancePolicyDeviceStatusOperationOptions) (result GetDeviceCompliancePolicyDeviceStatusOperationResponse, err error) {
