...
type ListDeviceCompliancePolicyDeviceStatusesCompleteResult struct {
	...
	Items              []beta.DeviceComplianceDeviceStatus
}
...
// ListDeviceCompliancePolicyDeviceStatuses - Get deviceStatuses from deviceManagement. List of
// DeviceComplianceDeviceStatus.
func (c DeviceCompliancePolicyDeviceStatusClient) ListDeviceCompliancePolicyDeviceStatuses(ctx context.Context, id beta.DeviceManagementDeviceCompliancePolicyId, options ListDeviceCompliancePolicyDeviceStatusesOperationOptions) (result ListDeviceCompliancePolicyDeviceStatusesOperationResponse, err error) {
	...
	var values struct {
		Values *[]beta.DeviceComplianceDeviceStatus `json:"value"`
	}
...
func (c DeviceCompliancePolicyDeviceStatusClient) ListDeviceCompliancePolicyDeviceStatusesComplete(ctx context.Context, id beta.DeviceManagementDeviceCompliancePolicyId, options ListDeviceCompliancePolicyDeviceStatusesOperationOptions) (ListDeviceCompliancePolicyDeviceStatusesCompleteResult, error) {
