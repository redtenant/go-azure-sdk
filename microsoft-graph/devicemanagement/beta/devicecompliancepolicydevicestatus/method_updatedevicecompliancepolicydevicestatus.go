...
type UpdateDeviceCompliancePolicyDeviceStatusOperationResponse struct {
...
// UpdateDeviceCompliancePolicyDeviceStatus - Update the navigation property deviceStatuses in deviceManagement
func (c DeviceCompliancePolicyDeviceStatusClient) UpdateDeviceCompliancePolicyDeviceStatus(ctx context.Context, id beta.DeviceManagementDeviceCompliancePolicyIdDeviceStatusId, input beta.DeviceComplianceDeviceStatus, options UpdateDeviceCompliancePolicyDeviceStatusOperationOptions) (result UpdateDeviceCompliancePolicyDeviceStatusOperationResponse, err error) {
