...
type ListDeviceCompliancePolicyScheduledActionsForRulesCompleteResult struct {
	...
	Items              []beta.DeviceComplianceScheduledActionForRule
}
...
func (c DeviceCompliancePolicyScheduledActionsForRuleClient) ListDeviceCompliancePolicyScheduledActionsForRules(ctx context.Context, id beta.DeviceManagementDeviceCompliancePolicyId, options ListDeviceCompliancePolicyScheduledActionsForRulesOperationOptions) (result ListDeviceCompliancePolicyScheduledActionsForRulesOperationResponse, err error) {
	...
	var values struct {
		Values *[]beta.DeviceComplianceScheduledActionForRule `json:"value"`
	}
...
func (c DeviceCompliancePolicyScheduledActionsForRuleClient) ListDeviceCompliancePolicyScheduledActionsForRulesCompleteMatchingPredicate(ctx context.Context, id beta.DeviceManagementDeviceCompliancePolicyId, options ListDeviceCompliancePolicyScheduledActionsForRulesOperationOptions, predicate DeviceComplianceScheduledActionForRuleOperationPredicate) (result ListDeviceCompliancePolicyScheduledActionsForRulesCompleteResult, err error) {
	items := make([]beta.DeviceComplianceScheduledActionForRule, 0)
