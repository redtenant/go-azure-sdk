...
// GetDeviceCompliancePolicyScheduledActionsForRuleConfiguration - Get scheduledActionConfigurations from
...
func (c DeviceCompliancePolicyScheduledActionsForRuleScheduledActionConfigurationClient) GetDeviceCompliancePolicyScheduledActionsForRuleConfiguration(ctx context.Context, id beta.DeviceManagementDeviceCompliancePolicyIdScheduledActionsForRuleIdScheduledActionConfigurationId, options GetDeviceCompliancePolicyScheduledActionsForRuleConfigurationOperationOptions) (result GetDeviceCompliancePolicyScheduledActionsForRuleConfigurationOperationResponse, err error) {
