...
// ListDeviceCompliancePolicyScheduledActionsForRuleConfigurations - Get scheduledActionConfigurations from
// deviceManagement. The list of scheduled action configurations for this compliance policy. Compliance policy must have
// one and only one block scheduled action.
func (c DeviceCompliancePolicyScheduledActionsForRuleScheduledActionConfigurationClient) ListDeviceCompliancePolicyScheduledActionsForRuleConfigurations(ctx context.Context, id beta.DeviceManagementDeviceCompliancePolicyIdScheduledActionsForRuleId, options ListDeviceCompliancePolicyScheduledActionsForRuleConfigurationsOperationOptions) (result ListDeviceCompliancePolicyScheduledActionsForRuleConfigurationsOperationResponse, err error) {
...
func (c DeviceCompliancePolicyScheduledActionsForRuleScheduledActionConfigurationClient) ListDeviceCompliancePolicyScheduledActionsForRuleConfigurationsComplete(ctx context.Context, id beta.DeviceManagementDeviceCompliancePolicyIdScheduledActionsForRuleId, options ListDeviceCompliancePolicyScheduledActionsForRuleConfigurationsOperationOptions) (ListDeviceCompliancePolicyScheduledActionsForRuleConfigurationsCompleteResult, error) {
