...
type UpdateDeviceCompliancePolicySettingStateSummaryOperationResponse struct {
...
// UpdateDeviceCompliancePolicySettingStateSummary - Update the navigation property
// deviceCompliancePolicySettingStateSummaries in deviceManagement
func (c DeviceCompliancePolicySettingStateSummaryClient) UpdateDeviceCompliancePolicySettingStateSummary(ctx context.Context, id beta.DeviceManagementDeviceCompliancePolicySettingStateSummaryId, input beta.DeviceCompliancePolicySettingStateSummary, options UpdateDeviceCompliancePolicySettingStateSummaryOperationOptions) (result UpdateDeviceCompliancePolicySettingStateSummaryOperationResponse, err error) {
