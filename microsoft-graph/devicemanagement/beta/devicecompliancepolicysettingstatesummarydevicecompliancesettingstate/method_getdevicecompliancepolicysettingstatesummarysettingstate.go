...
// GetDeviceCompliancePolicySettingStateSummarySettingState - Get deviceComplianceSettingStates from deviceManagement
func (c DeviceCompliancePolicySettingStateSummaryDeviceComplianceSettingStateClient) GetDeviceCompliancePolicySettingStateSummarySettingState(ctx context.Context, id beta.DeviceManagementDeviceCompliancePolicySettingStateSummaryIdDeviceComplianceSettingStateId, options GetDeviceCompliancePolicySettingStateSummarySettingStateOperationOptions) (result GetDeviceCompliancePolicySettingStateSummarySettingStateOperationResponse, err error) {
	...
	var model beta.DeviceComplianceSettingState
	result.Model = &model
