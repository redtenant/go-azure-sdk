...
func (c DeviceConfigurationClient) AssignDeviceConfigurations(ctx context.Context, id beta.DeviceManagementDeviceConfigurationId, input AssignDeviceConfigurationsRequest, options AssignDeviceConfigurationsOperationOptions) (result AssignDeviceConfigurationsOperationResponse, err error) {
...
func (c DeviceConfigurationClient) AssignDeviceConfigurationsComplete(ctx context.Context, id beta.DeviceManagementDeviceConfigurationId, input AssignDeviceConfigurationsRequest, options AssignDeviceConfigurationsOperationOptions) (AssignDeviceConfigurationsCompleteResult, error) {
...
func (c DeviceConfigurationClient) AssignDeviceConfigurationsCompleteMatchingPredicate(ctx context.Context, id beta.DeviceManagementDeviceConfigurationId, input AssignDeviceConfigurationsRequest, options AssignDeviceConfigurationsOperationOptions, predicate DeviceConfigurationAssignmentOperationPredicate) (result AssignDeviceConfigurationsCompleteResult, err error) {
