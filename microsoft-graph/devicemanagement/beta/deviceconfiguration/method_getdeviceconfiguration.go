...
func (c DeviceConfigurationClient) GetDeviceConfiguration(ctx context.Context, id beta.DeviceManagementDeviceConfigurationId, options GetDeviceConfigurationOperationOptions) (result GetDeviceConfigurationOperationResponse, err error) {
