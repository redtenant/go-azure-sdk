...
// ListDeviceConfigurationDeviceSettingStateSummaries - Get deviceSettingStateSummaries from deviceManagement. Device
// Configuration Setting State Device Summary
func (c DeviceConfigurationDeviceSettingStateSummaryClient) ListDeviceConfigurationDeviceSettingStateSummaries(ctx context.Context, id beta.DeviceManagementDeviceConfigurationId, options ListDeviceConfigurationDeviceSettingStateSummariesOperationOptions) (result ListDeviceConfigurationDeviceSettingStateSummariesOperationResponse, err error) {
