...
type ListDeviceConfigurationDeviceStatusesCompleteResult struct {
	...
	Items              []beta.DeviceConfigurationDeviceStatus
}
...
// ListDeviceConfigurationDeviceStatuses - Get deviceStatuses from deviceManagement. Device configuration installation
// status by device.
func (c DeviceConfigurationDeviceStatusClient) ListDeviceConfigurationDeviceStatuses(ctx context.Context, id beta.DeviceManagementDeviceConfigurationId, options ListDeviceConfigurationDeviceStatusesOperationOptions) (result ListDeviceConfigurationDeviceStatusesOperationResponse, err error) {
	...
	var values struct {
		Values *[]beta.DeviceConfigurationDeviceStatus `json:"value"`
	}
...
func (c DeviceConfigurationDeviceStatusClient) ListDeviceConfigurationDeviceStatusesComplete(ctx context.Context, id beta.DeviceManagementDeviceConfigurationId, options ListDeviceConfigurationDeviceStatusesOperationOptions) (ListDeviceConfigurationDeviceStatusesCompleteResult, error) {
...
func (c DeviceConfigurationDeviceStatusClient) ListDeviceConfigurationDeviceStatusesCompleteMatchingPredicate(ctx context.Context, id beta.DeviceManagementDeviceConfigurationId, options ListDeviceConfigurationDeviceStatusesOperationOptions, predicate DeviceConfigurationDeviceStatusOperationPredicate) (result ListDeviceConfigurationDeviceStatusesCompleteResult, err error) {
	items := make([]beta.DeviceConfigurationDeviceStatus, 0)
