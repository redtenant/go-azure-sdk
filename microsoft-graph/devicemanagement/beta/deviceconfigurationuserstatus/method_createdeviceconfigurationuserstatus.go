...
// CreateDeviceConfigurationUserStatus - Create new navigation property to userStatuses for deviceManagement
func (c DeviceConfigurationUserStatusClient) CreateDeviceConfigurationUserStatus(ctx context.Context, id beta.DeviceManagementDeviceConfigurationId, input beta.DeviceConfigurationUserStatus, options CreateDeviceConfigurationUserStatusOperationOptions) (result CreateDeviceConfigurationUserStatusOperationResponse, err error) {
