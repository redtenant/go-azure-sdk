...
// DeleteDeviceConfigurationUserStatus - Delete navigation property userStatuses for deviceManagement
func (c DeviceConfigurationUserStatusClient) DeleteDeviceConfigurationUserStatus(ctx context.Context, id beta.DeviceManagementDeviceConfigurationIdUserStatusId, options DeleteDeviceConfigurationUserStatusOperationOptions) (result DeleteDeviceConfigurationUserStatusOperationResponse, err error) {
