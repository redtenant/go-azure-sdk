...
type UpdateDeviceConfigurationUserStatusOperationResponse struct {
...
// UpdateDeviceConfigurationUserStatus - Update the navigation property userStatuses in deviceManagement
func (c DeviceConfigurationUserStatusClient) UpdateDeviceConfigurationUserStatus(ctx context.Context, id beta.DeviceManagementDeviceConfigurationIdUserStatusId, input beta.DeviceConfigurationUserStatus, options UpdateDeviceConfigurationUserStatusOperationOptions) (result UpdateDeviceConfigurationUserStatusOperationResponse, err error) {
