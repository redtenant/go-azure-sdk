...
type GetDeviceCustomAttributeShellScriptDeviceRunStateManagedDeviceOperationResponse struct {
	HttpResponse *http.Response
	OData        *odata.OData
	Model        beta.ManagedDevice
}

type GetDeviceCustomAttributeShellScriptDeviceRunStateManagedDeviceOperationOptions struct {
	Expand    *odata.Expand
...
func DefaultGetDeviceCustomAttributeShellScriptDeviceRunStateManagedDeviceOperationOptions() GetDeviceCustomAttributeShellScriptDeviceRunStateManagedDeviceOperationOptions {
	return GetDeviceCustomAttributeShellScriptDeviceRunStateManagedDeviceOperationOptions{}
}
...
// GetDeviceCustomAttributeShellScriptDeviceRunStateManagedDevice - Get managedDevice from deviceManagement. The managed
