...
type GetDeviceCustomAttributeShellScriptRunSummaryOperationOptions struct {
	Expand    *odata.Expand
...
func DefaultGetDeviceCustomAttributeShellScriptRunSummaryOperationOptions() GetDeviceCustomAttributeShellScriptRunSummaryOperationOptions {
	return GetDeviceCustomAttributeShellScriptRunSummaryOperationOptions{}
}
...
// GetDeviceCustomAttributeShellScriptRunSummary - Get runSummary from deviceManagement. Run summary for device
// management script.
