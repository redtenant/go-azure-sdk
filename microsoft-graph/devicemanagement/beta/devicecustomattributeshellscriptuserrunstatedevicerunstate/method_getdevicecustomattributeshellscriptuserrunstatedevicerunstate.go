...
func DefaultGetDeviceCustomAttributeShellScriptUserRunStateDeviceRunStateOperationOptions() GetDeviceCustomAttributeShellScriptUserRunStateDeviceRunStateOperationOptions {
	return GetDeviceCustomAttributeShellScriptUserRunStateDeviceRunStateOperationOptions{}
}
...
// GetDeviceCustomAttributeShellScriptUserRunStateDeviceRunState - Get deviceRunStates from deviceManagement. List of
