...
// DeleteDeviceEnrollmentConfiguration - Delete navigation property deviceEnrollmentConfigurations for deviceManagement
func (c DeviceEnrollmentConfigurationClient) DeleteDeviceEnrollmentConfiguration(ctx context.Context, id beta.DeviceManagementDeviceEnrollmentConfigurationId, options DeleteDeviceEnrollmentConfigurationOperationOptions) (result DeleteDeviceEnrollmentConfigurationOperationResponse, err error) {
