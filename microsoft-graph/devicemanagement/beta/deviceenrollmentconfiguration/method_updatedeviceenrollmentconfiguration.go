...
// UpdateDeviceEnrollmentConfiguration - Update the navigation property deviceEnrollmentConfigurations in
// deviceManagement
func (c DeviceEnrollmentConfigurationClient) UpdateDeviceEnrollmentConfiguration(ctx context.Context, id beta.DeviceManagementDeviceEnrollmentConfigurationId, input beta.DeviceEnrollmentConfiguration, options UpdateDeviceEnrollmentConfigurationOperationOptions) (result UpdateDeviceEnrollmentConfigurationOperationResponse, err error) {
