...
// ListDeviceEnrollmentConfigurationAssignments - Get assignments from deviceManagement. The list of group assignments
// for the device configuration profile
func (c DeviceEnrollmentConfigurationAssignmentClient) ListDeviceEnrollmentConfigurationAssignments(ctx context.Context, id beta.DeviceManagementDeviceEnrollmentConfigurationId, options ListDeviceEnrollmentConfigurationAssignmentsOperationOptions) (result ListDeviceEnrollmentConfigurationAssignmentsOperationResponse, err error) {
...
func (c DeviceEnrollmentConfigurationAssignmentClient) ListDeviceEnrollmentConfigurationAssignmentsComplete(ctx context.Context, id beta.DeviceManagementDeviceEnrollmentConfigurationId, options ListDeviceEnrollmentConfigurationAssignmentsOperationOptions) (ListDeviceEnrollmentConfigurationAssignmentsCompleteResult, error) {
...
func (c DeviceEnrollmentConfigurationAssignmentClient) ListDeviceEnrollmentConfigurationAssignmentsCompleteMatchingPredicate(ctx context.Context, id beta.DeviceManagementDeviceEnrollmentConfigurationId, options ListDeviceEnrollmentConfigurationAssignmentsOperationOptions, predicate EnrollmentConfigurationAssignmentOperationPredicate) (result ListDeviceEnrollmentConfigurationAssignmentsCompleteResult, err error) {
