...
type GetDeviceHealthScriptDeviceRunStateManagedDeviceOperationResponse struct {
...
func DefaultGetDeviceHealthScriptDeviceRunStateManagedDeviceOperationOptions() GetDeviceHealthScriptDeviceRunStateManagedDeviceOperationOptions {
	return GetDeviceHealthScriptDeviceRunStateManagedDeviceOperationOptions{}
}
...
// GetDeviceHealthScriptDeviceRunStateManagedDevice - Get managedDevice from deviceManagement. The managed device on
// which the device health script executed
