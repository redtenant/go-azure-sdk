...
func (c DeviceManagementPartnerClient) CreateDeviceManagementPartnerTerminate(ctx context.Context, id beta.DeviceManagementDeviceManagementPartnerId, options CreateDeviceManagementPartnerTerminateOperationOptions) (result CreateDeviceManagementPartnerTerminateOperationResponse, err error) {
