...
func (c DeviceManagementPartnerClient) DeleteDeviceManagementPartner(ctx context.Context, id beta.DeviceManagementDeviceManagementPartnerId, options DeleteDeviceManagementPartnerOperationOptions) (result DeleteDeviceManagementPartnerOperationResponse, err error) {
