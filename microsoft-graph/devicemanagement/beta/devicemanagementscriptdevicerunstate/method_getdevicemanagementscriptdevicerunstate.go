...
func DefaultGetDeviceManagementScriptDeviceRunStateOperationOptions() GetDeviceManagementScriptDeviceRunStateOperationOptions {
	return GetDeviceManagementScriptDeviceRunStateOperationOptions{}
}
...
// GetDeviceManagementScriptDeviceRunState - Get deviceRunStates from deviceManagement. List of run states for this
