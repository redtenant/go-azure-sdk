...
type GetDeviceManagementScriptDeviceRunStateManagedDeviceOperationResponse struct {
	HttpResponse *http.Response
	OData        *odata.OData
	Model        beta.ManagedDevice
}

type GetDeviceManagementScriptDeviceRunStateManagedDeviceOperationOptions struct {
	Expand    *odata.Expand
...
func DefaultGetDeviceManagementScriptDeviceRunStateManagedDeviceOperationOptions() GetDeviceManagementScriptDeviceRunStateManagedDeviceOperationOptions {
	return GetDeviceManagementScriptDeviceRunStateManagedDeviceOperationOptions{}
}
...
// GetDeviceManagementScriptDeviceRunStateManagedDevice - Get managedDevice from deviceManagement. The managed devices
// that executes the device management script.
