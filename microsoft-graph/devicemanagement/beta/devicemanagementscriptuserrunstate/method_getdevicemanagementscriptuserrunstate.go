...
func DefaultGetDeviceManagementScriptUserRunStateOperationOptions() GetDeviceManagementScriptUserRunStateOperationOptions {
	return GetDeviceManagementScriptUserRunStateOperationOptions{}
}
...
// GetDeviceManagementScriptUserRunState - Get userRunStates from deviceManagement. List of run states for this script
// across all users.
