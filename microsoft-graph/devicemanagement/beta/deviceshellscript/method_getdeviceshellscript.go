...
func DefaultGetDeviceShellScriptOperationOptions() GetDeviceShellScriptOperationOptions {
	return GetDeviceShellScriptOperationOptions{}
}
...
// GetDeviceShellScript - Get deviceShellScripts from deviceManagement. The list of device shell scripts associated with
// the tenant.
