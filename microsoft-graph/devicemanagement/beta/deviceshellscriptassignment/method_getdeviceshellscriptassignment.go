...
func DefaultGetDeviceShellScriptAssignmentOperationOptions() GetDeviceShellScriptAssignmentOperationOptions {
	return GetDeviceShellScriptAssignmentOperationOptions{}
}
...
// GetDeviceShellScriptAssignment - Get assignments from deviceManagement. The list of group assignments for the device
// management script.
