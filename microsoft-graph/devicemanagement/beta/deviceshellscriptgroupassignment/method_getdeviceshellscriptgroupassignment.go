...
func DefaultGetDeviceShellScriptGroupAssignmentOperationOptions() GetDeviceShellScriptGroupAssignmentOperationOptions {
	return GetDeviceShellScriptGroupAssignmentOperationOptions{}
}
...
// GetDeviceShellScriptGroupAssignment - Get groupAssignments from deviceManagement. The list of group assignments for
