...
// GetGroupPolicyDefinitionFile - Get groupPolicyDefinitionFiles from deviceManagement. The available group policy
// definition files for this account.
func (c GroupPolicyDefinitionFileClient) GetGroupPolicyDefinitionFile(ctx context.Context, id beta.DeviceManagementGroupPolicyDefinitionFileId, options GetGroupPolicyDefinitionFileOperationOptions) (result GetGroupPolicyDefinitionFileOperationResponse, err error) {
