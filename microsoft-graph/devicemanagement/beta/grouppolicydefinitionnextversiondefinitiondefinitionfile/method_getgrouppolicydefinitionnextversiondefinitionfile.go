...
func (c GroupPolicyDefinitionNextVersionDefinitionDefinitionFileClient) GetGroupPolicyDefinitionNextVersionDefinitionFile(ctx context.Context, id beta.DeviceManagementGroupPolicyDefinitionId, options GetGroupPolicyDefinitionNextVersionDefinitionFileOperationOptions) (result GetGroupPolicyDefinitionNextVersionDefinitionFileOperationResponse, err error) {
