...
// DeleteImportedWindowsAutopilotDeviceIdentity - Delete navigation property importedWindowsAutopilotDeviceIdentities
// for deviceManagement
func (c ImportedWindowsAutopilotDeviceIdentityClient) DeleteImportedWindowsAutopilotDeviceIdentity(ctx context.Context, id beta.DeviceManagementImportedWindowsAutopilotDeviceIdentityId, options DeleteImportedWindowsAutopilotDeviceIdentityOperationOptions) (result DeleteImportedWindowsAutopilotDeviceIdentityOperationResponse, err error) {
