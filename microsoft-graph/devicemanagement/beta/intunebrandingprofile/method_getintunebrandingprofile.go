...
func DefaultGetIntuneBrandingProfileOperationOptions() GetIntuneBrandingProfileOperationOptions {
	return GetIntuneBrandingProfileOperationOptions{}
}
...
// GetIntuneBrandingProfile - Get intuneBrandingProfiles from deviceManagement. Intune branding profiles targeted to AAD
// groups
