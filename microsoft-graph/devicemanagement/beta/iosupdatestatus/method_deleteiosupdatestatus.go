...
// DeleteIosUpdateStatus - Delete navigation property iosUpdateStatuses for deviceManagement
func (c IosUpdateStatusClient) DeleteIosUpdateStatus(ctx context.Context, id beta.DeviceManagementIosUpdateStatusId, options DeleteIosUpdateStatusOperationOptions) (result DeleteIosUpdateStatusOperationResponse, err error) {
