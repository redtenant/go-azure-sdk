...
func (c ManagedDeviceClient) ChangeManagedDeviceAssignments(ctx context.Context, id beta.DeviceManagementManagedDeviceId, input ChangeManagedDeviceAssignmentsRequest, options ChangeManagedDeviceAssignmentsOperationOptions) (result ChangeManagedDeviceAssignmentsOperationResponse, err error) {
