...
func (c ManagedDeviceClient) CleanManagedDeviceWindowsDevice(ctx context.Context, id beta.DeviceManagementManagedDeviceId, input CleanManagedDeviceWindowsDeviceRequest, options CleanManagedDeviceWindowsDeviceOperationOptions) (result CleanManagedDeviceWindowsDeviceOperationResponse, err error) {
