...
func (c ManagedDeviceClient) CreateManagedDeviceActivateDeviceEsim(ctx context.Context, id beta.DeviceManagementManagedDeviceId, input CreateManagedDeviceActivateDeviceEsimRequest, options CreateManagedDeviceActivateDeviceEsimOperationOptions) (result CreateManagedDeviceActivateDeviceEsimOperationResponse, err error) {
