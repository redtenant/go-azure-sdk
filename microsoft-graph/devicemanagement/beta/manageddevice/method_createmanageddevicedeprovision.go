...
func DefaultCreateManagedDeviceDeprovisionOperationOptions() CreateManagedDeviceDeprovisionOperationOptions {
	return CreateManagedDeviceDeprovisionOperationOptions{}
}
...
func (c ManagedDeviceClient) CreateManagedDeviceDeprovision(ctx context.Context, id beta.DeviceManagementManagedDeviceId, input CreateManagedDeviceDeprovisionRequest, options CreateManagedDeviceDeprovisionOperationOptions) (result CreateManagedDeviceDeprovisionOperationResponse, err error) {
