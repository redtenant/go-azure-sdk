...
func (c ManagedDeviceClient) CreateManagedDeviceLogCollectionRequest(ctx context.Context, id beta.DeviceManagementManagedDeviceId, input CreateManagedDeviceLogCollectionRequestRequest, options CreateManagedDeviceLogCollectionRequestOperationOptions) (result CreateManagedDeviceLogCollectionRequestOperationResponse, err error) {
