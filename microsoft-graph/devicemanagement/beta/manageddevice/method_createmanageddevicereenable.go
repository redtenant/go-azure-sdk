...
func DefaultCreateManagedDeviceReenableOperationOptions() CreateManagedDeviceReenableOperationOptions {
	return CreateManagedDeviceReenableOperationOptions{}
}
...
func (c ManagedDeviceClient) CreateManagedDeviceReenable(ctx context.Context, id beta.DeviceManagementManagedDeviceId, options CreateManagedDeviceReenableOperationOptions) (result CreateManagedDeviceReenableOperationResponse, err error) {
