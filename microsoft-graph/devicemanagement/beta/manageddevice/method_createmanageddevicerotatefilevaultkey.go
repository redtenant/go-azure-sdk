...
func DefaultCreateManagedDeviceRotateFileVaultKeyOperationOptions() CreateManagedDeviceRotateFileVaultKeyOperationOptions {
	return CreateManagedDeviceRotateFileVaultKeyOperationOptions{}
}
...
func (c ManagedDeviceClient) CreateManagedDeviceRotateFileVaultKey(ctx context.Context, id beta.DeviceManagementManagedDeviceId, options CreateManagedDeviceRotateFileVaultKeyOperationOptions) (result CreateManagedDeviceRotateFileVaultKeyOperationResponse, err error) {
