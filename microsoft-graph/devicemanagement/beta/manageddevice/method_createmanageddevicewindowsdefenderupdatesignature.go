...
func (c ManagedDeviceClient) CreateManagedDeviceWindowsDefenderUpdateSignature(ctx context.Context, id beta.DeviceManagementManagedDeviceId, options CreateManagedDeviceWindowsDefenderUpdateSignatureOperationOptions) (result CreateManagedDeviceWindowsDefenderUpdateSignatureOperationResponse, err error) {
