...
// DeleteManagedDevice - Delete navigation property managedDevices for deviceManagement
func (c ManagedDeviceClient) DeleteManagedDevice(ctx context.Context, id beta.DeviceManagementManagedDeviceId, options DeleteManagedDeviceOperationOptions) (result DeleteManagedDeviceOperationResponse, err error) {
