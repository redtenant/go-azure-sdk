...
func (c ManagedDeviceClient) EnableManagedDeviceLostMode(ctx context.Context, id beta.DeviceManagementManagedDeviceId, input EnableManagedDeviceLostModeRequest, options EnableManagedDeviceLostModeOperationOptions) (result EnableManagedDeviceLostModeOperationResponse, err error) {
