...
func (c ManagedDeviceClient) GetManagedDevicesCount(ctx context.Context, options GetManagedDevicesCountOperationOptions) (result GetManagedDevicesCountOperationResponse, err error) {
