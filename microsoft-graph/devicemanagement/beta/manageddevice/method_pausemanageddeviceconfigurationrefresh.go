...
func (c ManagedDeviceClient) PauseManagedDeviceConfigurationRefresh(ctx context.Context, id beta.DeviceManagementManagedDeviceId, input PauseManagedDeviceConfigurationRefreshRequest, options PauseManagedDeviceConfigurationRefreshOperationOptions) (result PauseManagedDeviceConfigurationRefreshOperationResponse, err error) {
