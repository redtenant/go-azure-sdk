...
func (c ManagedDeviceClient) RebootManagedDeviceNow(ctx context.Context, id beta.DeviceManagementManagedDeviceId, options RebootManagedDeviceNowOperationOptions) (result RebootManagedDeviceNowOperationResponse, err error) {
