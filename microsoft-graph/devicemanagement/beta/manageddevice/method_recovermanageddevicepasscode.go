...
func (c ManagedDeviceClient) RecoverManagedDevicePasscode(ctx context.Context, id beta.DeviceManagementManagedDeviceId, options RecoverManagedDevicePasscodeOperationOptions) (result RecoverManagedDevicePasscodeOperationResponse, err error) {
