...
func (c ManagedDeviceClient) RemoteLockManagedDevice(ctx context.Context, id beta.DeviceManagementManagedDeviceId, options RemoteLockManagedDeviceOperationOptions) (result RemoteLockManagedDeviceOperationResponse, err error) {
