...
func (c ManagedDeviceClient) RequestManagedDeviceRemoteAssistance(ctx context.Context, id beta.DeviceManagementManagedDeviceId, options RequestManagedDeviceRemoteAssistanceOperationOptions) (result RequestManagedDeviceRemoteAssistanceOperationResponse, err error) {
