...
func (c ManagedDeviceClient) ResetManagedDevicePasscode(ctx context.Context, id beta.DeviceManagementManagedDeviceId, options ResetManagedDevicePasscodeOperationOptions) (result ResetManagedDevicePasscodeOperationResponse, err error) {
