...
func (c ManagedDeviceClient) RestoreManagedDeviceCloudPC(ctx context.Context, id beta.DeviceManagementManagedDeviceId, input RestoreManagedDeviceCloudPCRequest, options RestoreManagedDeviceCloudPCOperationOptions) (result RestoreManagedDeviceCloudPCOperationResponse, err error) {
