...
// device
func (c ManagedDeviceClient) RevokeManagedDeviceAppleVppLicenses(ctx context.Context, id beta.DeviceManagementManagedDeviceId, options RevokeManagedDeviceAppleVppLicensesOperationOptions) (result RevokeManagedDeviceAppleVppLicensesOperationResponse, err error) {
