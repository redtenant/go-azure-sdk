...
func (c ManagedDeviceClient) SetManagedDeviceName(ctx context.Context, id beta.DeviceManagementManagedDeviceId, input SetManagedDeviceNameRequest, options SetManagedDeviceNameOperationOptions) (result SetManagedDeviceNameOperationResponse, err error) {
