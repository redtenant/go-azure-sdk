...
func (c ManagedDeviceClient) ShutDownManagedDevice(ctx context.Context, id beta.DeviceManagementManagedDeviceId, options ShutDownManagedDeviceOperationOptions) (result ShutDownManagedDeviceOperationResponse, err error) {
