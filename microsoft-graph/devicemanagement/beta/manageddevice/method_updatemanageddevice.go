...
func (c ManagedDeviceClient) UpdateManagedDevice(ctx context.Context, id beta.DeviceManagementManagedDeviceId, input beta.ManagedDevice, options UpdateManagedDeviceOperationOptions) (result UpdateManagedDeviceOperationResponse, err error) {
