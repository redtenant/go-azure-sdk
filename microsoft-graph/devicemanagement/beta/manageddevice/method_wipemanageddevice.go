...
func (c ManagedDeviceClient) WipeManagedDevice(ctx context.Context, id beta.DeviceManagementManagedDeviceId, input WipeManagedDeviceRequest, options WipeManagedDeviceOperationOptions) (result WipeManagedDeviceOperationResponse, err error) {
