...
func (c ManagedDeviceAssignmentFilterEvaluationStatusDetailClient) CreateManagedDeviceAssignmentFilterEvaluationStatusDetail(ctx context.Context, id beta.DeviceManagementManagedDeviceId, input beta.AssignmentFilterEvaluationStatusDetails, options CreateManagedDeviceAssignmentFilterEvaluationStatusDetailOperationOptions) (result CreateManagedDeviceAssignmentFilterEvaluationStatusDetailOperationResponse, err error) {
