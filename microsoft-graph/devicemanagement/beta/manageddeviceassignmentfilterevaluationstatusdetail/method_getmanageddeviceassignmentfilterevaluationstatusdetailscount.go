...
func (c ManagedDeviceAssignmentFilterEvaluationStatusDetailClient) GetManagedDeviceAssignmentFilterEvaluationStatusDetailsCount(ctx context.Context, id beta.DeviceManagementManagedDeviceId, options GetManagedDeviceAssignmentFilterEvaluationStatusDetailsCountOperationOptions) (result GetManagedDeviceAssignmentFilterEvaluationStatusDetailsCountOperationResponse, err error) {
