...
func (c ManagedDeviceDetectedAppClient) GetManagedDeviceDetectedAppsCount(ctx context.Context, id beta.DeviceManagementManagedDeviceId, options GetManagedDeviceDetectedAppsCountOperationOptions) (result GetManagedDeviceDetectedAppsCountOperationResponse, err error) {
