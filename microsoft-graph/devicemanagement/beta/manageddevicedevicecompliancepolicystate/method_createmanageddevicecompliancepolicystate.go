...
// deviceManagement
func (c ManagedDeviceDeviceCompliancePolicyStateClient) CreateManagedDeviceCompliancePolicyState(ctx context.Context, id beta.DeviceManagementManagedDeviceId, input beta.DeviceCompliancePolicyState, options CreateManagedDeviceCompliancePolicyStateOperationOptions) (result CreateManagedDeviceCompliancePolicyStateOperationResponse, err error) {
