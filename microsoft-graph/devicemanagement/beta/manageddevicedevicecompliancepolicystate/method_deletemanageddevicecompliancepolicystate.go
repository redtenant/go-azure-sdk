...
// deviceManagement
func (c ManagedDeviceDeviceCompliancePolicyStateClient) DeleteManagedDeviceCompliancePolicyState(ctx context.Context, id beta.DeviceManagementManagedDeviceIdDeviceCompliancePolicyStateId, options DeleteManagedDeviceCompliancePolicyStateOperationOptions) (result DeleteManagedDeviceCompliancePolicyStateOperationResponse, err error) {
