...
func (c ManagedDeviceDeviceCompliancePolicyStateClient) GetManagedDeviceCompliancePolicyState(ctx context.Context, id beta.DeviceManagementManagedDeviceIdDeviceCompliancePolicyStateId, options GetManagedDeviceCompliancePolicyStateOperationOptions) (result GetManagedDeviceCompliancePolicyStateOperationResponse, err error) {
