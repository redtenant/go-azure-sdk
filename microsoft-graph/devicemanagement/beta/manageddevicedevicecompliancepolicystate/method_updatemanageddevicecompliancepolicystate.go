...
// UpdateManagedDeviceCompliancePolicyState - Update the navigation property deviceCompliancePolicyStates in
// deviceManagement
func (c ManagedDeviceDeviceCompliancePolicyStateClient) UpdateManagedDeviceCompliancePolicyState(ctx context.Context, id beta.DeviceManagementManagedDeviceIdDeviceCompliancePolicyStateId, input beta.DeviceCompliancePolicyState, options UpdateManagedDeviceCompliancePolicyStateOperationOptions) (result UpdateManagedDeviceCompliancePolicyStateOperationResponse, err error) {
