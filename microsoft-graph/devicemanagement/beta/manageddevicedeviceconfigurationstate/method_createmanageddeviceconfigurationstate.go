...
// deviceManagement
func (c ManagedDeviceDeviceConfigurationStateClient) CreateManagedDeviceConfigurationState(ctx context.Context, id beta.DeviceManagementManagedDeviceId, input beta.DeviceConfigurationState, options CreateManagedDeviceConfigurationStateOperationOptions) (result CreateManagedDeviceConfigurationStateOperationResponse, err error) {
