...
func (c ManagedDeviceDeviceConfigurationStateClient) DeleteManagedDeviceConfigurationState(ctx context.Context, id beta.DeviceManagementManagedDeviceIdDeviceConfigurationStateId, options DeleteManagedDeviceConfigurationStateOperationOptions) (result DeleteManagedDeviceConfigurationStateOperationResponse, err error) {
