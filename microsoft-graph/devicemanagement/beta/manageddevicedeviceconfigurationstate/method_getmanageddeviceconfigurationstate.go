...
// GetManagedDeviceConfigurationState - Get deviceConfigurationStates from deviceManagement. Device configuration states
// for this device.
func (c ManagedDeviceDeviceConfigurationStateClient) GetManagedDeviceConfigurationState(ctx context.Context, id beta.DeviceManagementManagedDeviceIdDeviceConfigurationStateId, options GetManagedDeviceConfigurationStateOperationOptions) (result GetManagedDeviceConfigurationStateOperationResponse, err error) {
