...
func (c ManagedDeviceDeviceConfigurationStateClient) UpdateManagedDeviceConfigurationState(ctx context.Context, id beta.DeviceManagementManagedDeviceIdDeviceConfigurationStateId, input beta.DeviceConfigurationState, options UpdateManagedDeviceConfigurationStateOperationOptions) (result UpdateManagedDeviceConfigurationStateOperationResponse, err error) {
