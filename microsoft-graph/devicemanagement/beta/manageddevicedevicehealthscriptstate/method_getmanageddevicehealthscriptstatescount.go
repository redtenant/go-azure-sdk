...
func (c ManagedDeviceDeviceHealthScriptStateClient) GetManagedDeviceHealthScriptStatesCount(ctx context.Context, id beta.DeviceManagementManagedDeviceId, options GetManagedDeviceHealthScriptStatesCountOperationOptions) (result GetManagedDeviceHealthScriptStatesCountOperationResponse, err error) {
