...
// ListManagedDeviceHealthScriptStates - Get deviceHealthScriptStates from deviceManagement. Results of device health
// scripts that ran for this device. Default is empty list. This property is read-only.
func (c ManagedDeviceDeviceHealthScriptStateClient) ListManagedDeviceHealthScriptStates(ctx context.Context, id beta.DeviceManagementManagedDeviceId, options ListManagedDeviceHealthScriptStatesOperationOptions) (result ListManagedDeviceHealthScriptStatesOperationResponse, err error) {
...
func (c ManagedDeviceDeviceHealthScriptStateClient) ListManagedDeviceHealthScriptStatesComplete(ctx context.Context, id beta.DeviceManagementManagedDeviceId, options ListManagedDeviceHealthScriptStatesOperationOptions) (ListManagedDeviceHealthScriptStatesCompleteResult, error) {
...
func (c ManagedDeviceDeviceHealthScriptStateClient) ListManagedDeviceHealthScriptStatesCompleteMatchingPredicate(ctx context.Context, id beta.DeviceManagementManagedDeviceId, options ListManagedDeviceHealthScriptStatesOperationOptions, predicate DeviceHealthScriptPolicyStateOperationPredicate) (result ListManagedDeviceHealthScriptStatesCompleteResult, err error) {
