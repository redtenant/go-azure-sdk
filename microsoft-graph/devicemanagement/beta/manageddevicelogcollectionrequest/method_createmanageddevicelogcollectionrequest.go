...
// deviceManagement
func (c ManagedDeviceLogCollectionRequestClient) CreateManagedDeviceLogCollectionRequest(ctx context.Context, id beta.DeviceManagementManagedDeviceId, input beta.DeviceLogCollectionResponse, options CreateManagedDeviceLogCollectionRequestOperationOptions) (result CreateManagedDeviceLogCollectionRequestOperationResponse, err error) {
