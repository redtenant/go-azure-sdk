...
func (c ManagedDeviceLogCollectionRequestClient) CreateManagedDeviceLogCollectionRequestDownloadUrl(ctx context.Context, id beta.DeviceManagementManagedDeviceIdLogCollectionRequestId, options CreateManagedDeviceLogCollectionRequestDownloadUrlOperationOptions) (result CreateManagedDeviceLogCollectionRequestDownloadUrlOperationResponse, err error) {
