...
func (c ManagedDeviceLogCollectionRequestClient) DeleteManagedDeviceLogCollectionRequest(ctx context.Context, id beta.DeviceManagementManagedDeviceIdLogCollectionRequestId, options DeleteManagedDeviceLogCollectionRequestOperationOptions) (result DeleteManagedDeviceLogCollectionRequestOperationResponse, err error) {
