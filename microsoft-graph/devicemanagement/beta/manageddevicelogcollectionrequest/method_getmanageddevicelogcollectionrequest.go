...
// requests
func (c ManagedDeviceLogCollectionRequestClient) GetManagedDeviceLogCollectionRequest(ctx context.Context, id beta.DeviceManagementManagedDeviceIdLogCollectionRequestId, options GetManagedDeviceLogCollectionRequestOperationOptions) (result GetManagedDeviceLogCollectionRequestOperationResponse, err error) {
