...
func (c ManagedDeviceLogCollectionRequestClient) GetManagedDeviceLogCollectionRequestsCount(ctx context.Context, id beta.DeviceManagementManagedDeviceId, options GetManagedDeviceLogCollectionRequestsCountOperationOptions) (result GetManagedDeviceLogCollectionRequestsCountOperationResponse, err error) {
