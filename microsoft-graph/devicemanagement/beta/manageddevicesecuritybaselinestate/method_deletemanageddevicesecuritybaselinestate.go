...
// DeleteManagedDeviceSecurityBaselineState - Delete navigation property securityBaselineStates for deviceManagement
func (c ManagedDeviceSecurityBaselineStateClient) DeleteManagedDeviceSecurityBaselineState(ctx context.Context, id beta.DeviceManagementManagedDeviceIdSecurityBaselineStateId, options DeleteManagedDeviceSecurityBaselineStateOperationOptions) (result DeleteManagedDeviceSecurityBaselineStateOperationResponse, err error) {
