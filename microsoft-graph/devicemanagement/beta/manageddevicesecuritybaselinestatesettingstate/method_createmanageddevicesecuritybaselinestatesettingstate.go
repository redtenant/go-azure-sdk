...
// CreateManagedDeviceSecurityBaselineStateSettingState - Create new navigation property to settingStates for
// deviceManagement
func (c ManagedDeviceSecurityBaselineStateSettingStateClient) CreateManagedDeviceSecurityBaselineStateSettingState(ctx context.Context, id beta.DeviceManagementManagedDeviceIdSecurityBaselineStateId, input beta.SecurityBaselineSettingState, options CreateManagedDeviceSecurityBaselineStateSettingStateOperationOptions) (result CreateManagedDeviceSecurityBaselineStateSettingStateOperationResponse, err error) {
