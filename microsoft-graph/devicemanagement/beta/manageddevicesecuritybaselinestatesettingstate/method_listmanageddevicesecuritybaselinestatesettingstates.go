...
// ListManagedDeviceSecurityBaselineStateSettingStates - Get settingStates from deviceManagement. The security baseline
// state for different settings for a device
func (c ManagedDeviceSecurityBaselineStateSettingStateClient) ListManagedDeviceSecurityBaselineStateSettingStates(ctx context.Context, id beta.DeviceManagementManagedDeviceIdSecurityBaselineStateId, options ListManagedDeviceSecurityBaselineStateSettingStatesOperationOptions) (result ListManagedDeviceSecurityBaselineStateSettingStatesOperationResponse, err error) {
...
func (c ManagedDeviceSecurityBaselineStateSettingStateClient) ListManagedDeviceSecurityBaselineStateSettingStatesComplete(ctx context.Context, id beta.DeviceManagementManagedDeviceIdSecurityBaselineStateId, options ListManagedDeviceSecurityBaselineStateSettingStatesOperationOptions) (ListManagedDeviceSecurityBaselineStateSettingStatesCompleteResult, error) {
...
func (c ManagedDeviceSecurityBaselineStateSettingStateClient) ListManagedDeviceSecurityBaselineStateSettingStatesCompleteMatchingPredicate(ctx context.Context, id beta.DeviceManagementManagedDeviceIdSecurityBaselineStateId, options ListManagedDeviceSecurityBaselineStateSettingStatesOperationOptions, predicate SecurityBaselineSettingStateOperationPredicate) (result ListManagedDeviceSecurityBaselineStateSettingStatesCompleteResult, err error) {
