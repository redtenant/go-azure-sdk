...
// UpdateManagedDeviceSecurityBaselineStateSettingState - Update the navigation property settingStates in
// deviceManagement
func (c ManagedDeviceSecurityBaselineStateSettingStateClient) UpdateManagedDeviceSecurityBaselineStateSettingState(ctx context.Context, id beta.DeviceManagementManagedDeviceIdSecurityBaselineStateIdSettingStateId, input beta.SecurityBaselineSettingState, options UpdateManagedDeviceSecurityBaselineStateSettingStateOperationOptions) (result UpdateManagedDeviceSecurityBaselineStateSettingStateOperationResponse, err error) {
