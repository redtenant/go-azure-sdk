...
func (c ManagedDeviceUserClient) ListManagedDeviceUsers(ctx context.Context, id beta.DeviceManagementManagedDeviceId, options ListManagedDeviceUsersOperationOptions) (result ListManagedDeviceUsersOperationResponse, err error) {
...
func (c ManagedDeviceUserClient) ListManagedDeviceUsersComplete(ctx context.Context, id beta.DeviceManagementManagedDeviceId, options ListManagedDeviceUsersOperationOptions) (ListManagedDeviceUsersCompleteResult, error) {
...
func (c ManagedDeviceUserClient) ListManagedDeviceUsersCompleteMatchingPredicate(ctx context.Context, id beta.DeviceManagementManagedDeviceId, options ListManagedDeviceUsersOperationOptions, predicate UserOperationPredicate) (result ListManagedDeviceUsersCompleteResult, err error) {
