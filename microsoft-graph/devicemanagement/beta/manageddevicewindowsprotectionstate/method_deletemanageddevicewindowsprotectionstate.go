...
func (c ManagedDeviceWindowsProtectionStateClient) DeleteManagedDeviceWindowsProtectionState(ctx context.Context, id beta.DeviceManagementManagedDeviceId, options DeleteManagedDeviceWindowsProtectionStateOperationOptions) (result DeleteManagedDeviceWindowsProtectionStateOperationResponse, err error) {
