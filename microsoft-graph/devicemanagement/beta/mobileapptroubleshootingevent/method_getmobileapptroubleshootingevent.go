...
// GetMobileAppTroubleshootingEvent - Get mobileAppTroubleshootingEvents from deviceManagement. The collection property
// of MobileAppTroubleshootingEvent.
func (c MobileAppTroubleshootingEventClient) GetMobileAppTroubleshootingEvent(ctx context.Context, id beta.DeviceManagementMobileAppTroubleshootingEventId, options GetMobileAppTroubleshootingEventOperationOptions) (result GetMobileAppTroubleshootingEventOperationResponse, err error) {
