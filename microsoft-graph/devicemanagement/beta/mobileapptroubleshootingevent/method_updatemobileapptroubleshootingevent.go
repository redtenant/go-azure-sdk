...
// UpdateMobileAppTroubleshootingEvent - Update the navigation property mobileAppTroubleshootingEvents in
// deviceManagement
func (c MobileAppTroubleshootingEventClient) UpdateMobileAppTroubleshootingEvent(ctx context.Context, id beta.DeviceManagementMobileAppTroubleshootingEventId, input beta.MobileAppTroubleshootingEvent, options UpdateMobileAppTroubleshootingEventOperationOptions) (result UpdateMobileAppTroubleshootingEventOperationResponse, err error) {
