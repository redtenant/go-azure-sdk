...
// appLogCollectionRequests for deviceManagement
func (c MobileAppTroubleshootingEventAppLogCollectionRequestClient) CreateMobileAppTroubleshootingEventAppLogCollectionRequest(ctx context.Context, id beta.DeviceManagementMobileAppTroubleshootingEventId, input beta.AppLogCollectionRequest, options CreateMobileAppTroubleshootingEventAppLogCollectionRequestOperationOptions) (result CreateMobileAppTroubleshootingEventAppLogCollectionRequestOperationResponse, err error) {
