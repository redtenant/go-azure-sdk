...
func (c MobileAppTroubleshootingEventAppLogCollectionRequestClient) CreateMobileAppTroubleshootingEventAppLogCollectionRequestDownloadUrl(ctx context.Context, id beta.DeviceManagementMobileAppTroubleshootingEventIdAppLogCollectionRequestId, options CreateMobileAppTroubleshootingEventAppLogCollectionRequestDownloadUrlOperationOptions) (result CreateMobileAppTroubleshootingEventAppLogCollectionRequestDownloadUrlOperationResponse, err error) {
