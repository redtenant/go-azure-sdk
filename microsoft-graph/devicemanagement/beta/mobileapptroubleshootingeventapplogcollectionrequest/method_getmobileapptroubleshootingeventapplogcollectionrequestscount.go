...
func (c MobileAppTroubleshootingEventAppLogCollectionRequestClient) GetMobileAppTroubleshootingEventAppLogCollectionRequestsCount(ctx context.Context, id beta.DeviceManagementMobileAppTroubleshootingEventId, options GetMobileAppTroubleshootingEventAppLogCollectionRequestsCountOperationOptions) (result GetMobileAppTroubleshootingEventAppLogCollectionRequestsCountOperationResponse, err error) {
