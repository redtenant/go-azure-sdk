...
// UpdateMobileAppTroubleshootingEventAppLogCollectionRequest - Update the navigation property appLogCollectionRequests
// in deviceManagement
func (c MobileAppTroubleshootingEventAppLogCollectionRequestClient) UpdateMobileAppTroubleshootingEventAppLogCollectionRequest(ctx context.Context, id beta.DeviceManagementMobileAppTroubleshootingEventIdAppLogCollectionRequestId, input beta.AppLogCollectionRequest, options UpdateMobileAppTroubleshootingEventAppLogCollectionRequestOperationOptions) (result UpdateMobileAppTroubleshootingEventAppLogCollectionRequestOperationResponse, err error) {
