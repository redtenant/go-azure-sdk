...
// DeleteMobileThreatDefenseConnector - Delete navigation property mobileThreatDefenseConnectors for deviceManagement
func (c MobileThreatDefenseConnectorClient) DeleteMobileThreatDefenseConnector(ctx context.Context, id beta.DeviceManagementMobileThreatDefenseConnectorId, options DeleteMobileThreatDefenseConnectorOperationOptions) (result DeleteMobileThreatDefenseConnectorOperationResponse, err error) {
