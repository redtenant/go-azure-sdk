...
type SendNotificationMessageTemplateTestMessageOperationResponse struct {
...
func (c NotificationMessageTemplateClient) SendNotificationMessageTemplateTestMessage(ctx context.Context, id beta.DeviceManagementNotificationMessageTemplateId, options SendNotificationMessageTemplateTestMessageOperationOptions) (result SendNotificationMessageTemplateTestMessageOperationResponse, err error) {
