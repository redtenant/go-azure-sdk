...
// GetNotificationMessageTemplateLocalizedNotificationMessage - Get localizedNotificationMessages from deviceManagement.
// The list of localized messages for this Notification Message Template.
func (c NotificationMessageTemplateLocalizedNotificationMessageClient) GetNotificationMessageTemplateLocalizedNotificationMessage(ctx context.Context, id beta.DeviceManagementNotificationMessageTemplateIdLocalizedNotificationMessageId, options GetNotificationMessageTemplateLocalizedNotificationMessageOperationOptions) (result GetNotificationMessageTemplateLocalizedNotificationMessageOperationResponse, err error) {
