...
// DeleteRemoteAssistancePartner - Delete navigation property remoteAssistancePartners for deviceManagement
func (c RemoteAssistancePartnerClient) DeleteRemoteAssistancePartner(ctx context.Context, id beta.DeviceManagementRemoteAssistancePartnerId, options DeleteRemoteAssistancePartnerOperationOptions) (result DeleteRemoteAssistancePartnerOperationResponse, err error) {
