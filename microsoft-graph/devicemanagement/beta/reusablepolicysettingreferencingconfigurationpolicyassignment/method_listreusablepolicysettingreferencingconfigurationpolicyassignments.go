...
type ListReusablePolicySettingReferencingConfigurationPolicyAssignmentsOperationOptions struct {
	Count     *bool
	Expand    *odata.Expand
	Filter    *string
...
func DefaultListReusablePolicySettingReferencingConfigurationPolicyAssignmentsOperationOptions() ListReusablePolicySettingReferencingConfigurationPolicyAssignmentsOperationOptions {
	return ListReusablePolicySettingReferencingConfigurationPolicyAssignmentsOperationOptions{}
}

func (o ListReusablePolicySettingReferencingConfigurationPolicyAssignmentsOperationOptions) ToHeaders() *client.Headers {
	out := client.Headers{}

	return &out
}

func (o ListReusablePolicySettingReferencingConfigurationPolicyAssignmentsOperationOptions) ToOData() *odata.Query {
	out := odata.Query{}
	if o.Count != nil {
		out.Count = *o.Count
	}
...
func (o ListReusablePolicySettingReferencingConfigurationPolicyAssignmentsOperationOptions) ToQuery() *client.QueryParams {
...
// ListReusablePolicySettingReferencingConfigurationPolicyAssignments - Get assignments from deviceManagement. Policy
// assignments
func (c ReusablePolicySettingReferencingConfigurationPolicyAssignmentClient) ListReusablePolicySettingReferencingConfigurationPolicyAssignments(ctx context.Context, id beta.DeviceManagementReusablePolicySettingIdReferencingConfigurationPolicyId, options ListReusablePolicySettingReferencingConfigurationPolicyAssignmentsOperationOptions) (result ListReusablePolicySettingReferencingConfigurationPolicyAssignmentsOperationResponse, err error) {
...
func (c ReusablePolicySettingReferencingConfigurationPolicyAssignmentClient) ListReusablePolicySettingReferencingConfigurationPolicyAssignmentsComplete(ctx context.Context, id beta.DeviceManagementReusablePolicySettingIdReferencingConfigurationPolicyId, options ListReusablePolicySettingReferencingConfigurationPolicyAssignmentsOperationOptions) (ListReusablePolicySettingReferencingConfigurationPolicyAssignmentsCompleteResult, error) {
	return c.ListReusablePolicySettingReferencingConfigurationPolicyAssignmentsCompleteMatchingPredicate(ctx, id, options, DeviceManagementConfigurationPolicyAssignmentOperationPredicate{})
}
...
func (c ReusablePolicySettingReferencingConfigurationPolicyAssignmentClient) ListReusablePolicySettingReferencingConfigurationPolicyAssignmentsCompleteMatchingPredicate(ctx context.Context, id beta.DeviceManagementReusablePolicySettingIdReferencingConfigurationPolicyId, options ListReusablePolicySettingReferencingConfigurationPolicyAssignmentsOperationOptions, predicate DeviceManagementConfigurationPolicyAssignmentOperationPredicate) (result ListReusablePolicySettingReferencingConfigurationPolicyAssignmentsCompleteResult, err error) {
	items := make([]beta.DeviceManagementConfigurationPolicyAssignment, 0)

	resp, err := c.ListReusablePolicySettingReferencingConfigurationPolicyAssignments(ctx, id, options)
	if err != nil {
