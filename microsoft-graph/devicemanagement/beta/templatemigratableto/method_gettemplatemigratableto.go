...
func DefaultGetTemplateMigratableToOperationOptions() GetTemplateMigratableToOperationOptions {
	return GetTemplateMigratableToOperationOptions{}
}
...
// GetTemplateMigratableTo - Get migratableTo from deviceManagement. Collection of templates this template can migrate
// to
