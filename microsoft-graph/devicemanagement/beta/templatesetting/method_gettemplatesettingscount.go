...
type GetTemplateSettingsCountOperationResponse struct {
...
func DefaultGetTemplateSettingsCountOperationOptions() GetTemplateSettingsCountOperationOptions {
	return GetTemplateSettingsCountOperationOptions{}
}

func (o GetTemplateSettingsCountOperationOptions) ToHeaders() *client.Headers {
	out := client.Headers{}

	return &out
}

func (o GetTemplateSettingsCountOperationOptions) ToOData() *odata.Query {
	out := odata.Query{}
	if o.Filter != nil {
		out.Filter = *o.Filter
	}
...
func (o GetTemplateSettingsCountOperationOptions) ToQuery() *client.QueryParams {
