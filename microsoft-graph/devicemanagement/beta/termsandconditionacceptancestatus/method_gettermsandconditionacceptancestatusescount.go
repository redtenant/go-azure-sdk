...
func (c TermsAndConditionAcceptanceStatusClient) GetTermsAndConditionAcceptanceStatusesCount(ctx context.Context, id beta.DeviceManagementTermsAndConditionId, options GetTermsAndConditionAcceptanceStatusesCountOperationOptions) (result GetTermsAndConditionAcceptanceStatusesCountOperationResponse, err error) {
