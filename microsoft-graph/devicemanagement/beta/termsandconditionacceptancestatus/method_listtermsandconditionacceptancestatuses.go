...
type ListTermsAndConditionAcceptanceStatusesCompleteResult struct {
	...
	Items              []beta.TermsAndConditionsAcceptanceStatus
}
...
// ListTermsAndConditionAcceptanceStatuses - Get acceptanceStatuses from deviceManagement. The list of acceptance
// statuses for this T&C policy.
func (c TermsAndConditionAcceptanceStatusClient) ListTermsAndConditionAcceptanceStatuses(ctx context.Context, id beta.DeviceManagementTermsAndConditionId, options ListTermsAndConditionAcceptanceStatusesOperationOptions) (result ListTermsAndConditionAcceptanceStatusesOperationResponse, err error) {
	...
	var values struct {
		Values *[]beta.TermsAndConditionsAcceptanceStatus `json:"value"`
	}
...
func (c TermsAndConditionAcceptanceStatusClient) ListTermsAndConditionAcceptanceStatusesComplete(ctx context.Context, id beta.DeviceManagementTermsAndConditionId, options ListTermsAndConditionAcceptanceStatusesOperationOptions) (ListTermsAndConditionAcceptanceStatusesCompleteResult, error) {
...
func (c TermsAndConditionAcceptanceStatusClient) ListTermsAndConditionAcceptanceStatusesCompleteMatchingPredicate(ctx context.Context, id beta.DeviceManagementTermsAndConditionId, options ListTermsAndConditionAcceptanceStatusesOperationOptions, predicate TermsAndConditionsAcceptanceStatusOperationPredicate) (result ListTermsAndConditionAcceptanceStatusesCompleteResult, err error) {
	items := make([]beta.TermsAndConditionsAcceptanceStatus, 0)
