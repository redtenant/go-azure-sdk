...
type UpdateUserExperienceAnalyticsAppHealthApplicationPerformanceOperationResponse struct {
...
func (c UserExperienceAnalyticsAppHealthApplicationPerformanceClient) UpdateUserExperienceAnalyticsAppHealthApplicationPerformance(ctx context.Context, id beta.DeviceManagementUserExperienceAnalyticsAppHealthApplicationPerformanceId, input beta.UserExperienceAnalyticsAppHealthApplicationPerformance, options UpdateUserExperienceAnalyticsAppHealthApplicationPerformanceOperationOptions) (result UpdateUserExperienceAnalyticsAppHealthApplicationPerformanceOperationResponse, err error) {
