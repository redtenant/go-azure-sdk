...
// Model Performance
func (c UserExperienceAnalyticsAppHealthDeviceModelPerformanceClient) GetUserExperienceAnalyticsAppHealthDeviceModelPerformance(ctx context.Context, id beta.DeviceManagementUserExperienceAnalyticsAppHealthDeviceModelPerformanceId, options GetUserExperienceAnalyticsAppHealthDeviceModelPerformanceOperationOptions) (result GetUserExperienceAnalyticsAppHealthDeviceModelPerformanceOperationResponse, err error) {
