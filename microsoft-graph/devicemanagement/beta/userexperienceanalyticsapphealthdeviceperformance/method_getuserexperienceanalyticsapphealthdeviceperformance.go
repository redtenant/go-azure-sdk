...
func (c UserExperienceAnalyticsAppHealthDevicePerformanceClient) GetUserExperienceAnalyticsAppHealthDevicePerformance(ctx context.Context, id beta.DeviceManagementUserExperienceAnalyticsAppHealthDevicePerformanceId, options GetUserExperienceAnalyticsAppHealthDevicePerformanceOperationOptions) (result GetUserExperienceAnalyticsAppHealthDevicePerformanceOperationResponse, err error) {
