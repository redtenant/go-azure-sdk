...
func (c UserExperienceAnalyticsBaselineDeviceBootPerformanceMetricClient) GetUserExperienceAnalyticsBaselineDeviceBootPerformanceMetric(ctx context.Context, id beta.DeviceManagementUserExperienceAnalyticsBaselineId, options GetUserExperienceAnalyticsBaselineDeviceBootPerformanceMetricOperationOptions) (result GetUserExperienceAnalyticsBaselineDeviceBootPerformanceMetricOperationResponse, err error) {
