...
func (c UserExperienceAnalyticsCategoryMetricValueClient) DeleteUserExperienceAnalyticsCategoryMetricValue(ctx context.Context, id beta.DeviceManagementUserExperienceAnalyticsCategoryIdMetricValueId, options DeleteUserExperienceAnalyticsCategoryMetricValueOperationOptions) (result DeleteUserExperienceAnalyticsCategoryMetricValueOperationResponse, err error) {
