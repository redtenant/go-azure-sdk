...
func (c UserExperienceAnalyticsCategoryMetricValueClient) ListUserExperienceAnalyticsCategoryMetricValues(ctx context.Context, id beta.DeviceManagementUserExperienceAnalyticsCategoryId, options ListUserExperienceAnalyticsCategoryMetricValuesOperationOptions) (result ListUserExperienceAnalyticsCategoryMetricValuesOperationResponse, err error) {
...
func (c UserExperienceAnalyticsCategoryMetricValueClient) ListUserExperienceAnalyticsCategoryMetricValuesComplete(ctx context.Context, id beta.DeviceManagementUserExperienceAnalyticsCategoryId, options ListUserExperienceAnalyticsCategoryMetricValuesOperationOptions) (ListUserExperienceAnalyticsCategoryMetricValuesCompleteResult, error) {
...
func (c UserExperienceAnalyticsCategoryMetricValueClient) ListUserExperienceAnalyticsCategoryMetricValuesCompleteMatchingPredicate(ctx context.Context, id beta.DeviceManagementUserExperienceAnalyticsCategoryId, options ListUserExperienceAnalyticsCategoryMetricValuesOperationOptions, predicate UserExperienceAnalyticsMetricOperationPredicate) (result ListUserExperienceAnalyticsCategoryMetricValuesCompleteResult, err error) {
