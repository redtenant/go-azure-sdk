...
func (c UserExperienceAnalyticsDevicePerformanceClient) DeleteUserExperienceAnalyticsDevicePerformance(ctx context.Context, id beta.DeviceManagementUserExperienceAnalyticsDevicePerformanceId, options DeleteUserExperienceAnalyticsDevicePerformanceOperationOptions) (result DeleteUserExperienceAnalyticsDevicePerformanceOperationResponse, err error) {
