...
func DefaultGetUserExperienceAnalyticsDevicePerformanceOperationOptions() GetUserExperienceAnalyticsDevicePerformanceOperationOptions {
	return GetUserExperienceAnalyticsDevicePerformanceOperationOptions{}
}
...
// GetUserExperienceAnalyticsDevicePerformance - Get userExperienceAnalyticsDevicePerformance from deviceManagement.
// User experience analytics device performance
func (c UserExperienceAnalyticsDevicePerformanceClient) GetUserExperienceAnalyticsDevicePerformance(ctx context.Context, id beta.DeviceManagementUserExperienceAnalyticsDevicePerformanceId, options GetUserExperienceAnalyticsDevicePerformanceOperationOptions) (result GetUserExperienceAnalyticsDevicePerformanceOperationResponse, err error) {
