...
func DefaultUpdateUserExperienceAnalyticsDevicePerformanceOperationOptions() UpdateUserExperienceAnalyticsDevicePerformanceOperationOptions {
	return UpdateUserExperienceAnalyticsDevicePerformanceOperationOptions{}
}
...
// UpdateUserExperienceAnalyticsDevicePerformance - Update the navigation property
// userExperienceAnalyticsDevicePerformance in deviceManagement
func (c UserExperienceAnalyticsDevicePerformanceClient) UpdateUserExperienceAnalyticsDevicePerformance(ctx context.Context, id beta.DeviceManagementUserExperienceAnalyticsDevicePerformanceId, input beta.UserExperienceAnalyticsDevicePerformance, options UpdateUserExperienceAnalyticsDevicePerformanceOperationOptions) (result UpdateUserExperienceAnalyticsDevicePerformanceOperationResponse, err error) {
