...
func DefaultGetUserExperienceAnalyticsDeviceScoreOperationOptions() GetUserExperienceAnalyticsDeviceScoreOperationOptions {
	return GetUserExperienceAnalyticsDeviceScoreOperationOptions{}
}
...
// GetUserExperienceAnalyticsDeviceScore - Get userExperienceAnalyticsDeviceScores from deviceManagement. User
// experience analytics device scores
func (c UserExperienceAnalyticsDeviceScoreClient) GetUserExperienceAnalyticsDeviceScore(ctx context.Context, id beta.DeviceManagementUserExperienceAnalyticsDeviceScoreId, options GetUserExperienceAnalyticsDeviceScoreOperationOptions) (result GetUserExperienceAnalyticsDeviceScoreOperationResponse, err error) {
