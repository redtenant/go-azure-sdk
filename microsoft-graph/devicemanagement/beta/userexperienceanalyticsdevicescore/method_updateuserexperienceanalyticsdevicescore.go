...
// deviceManagement
func (c UserExperienceAnalyticsDeviceScoreClient) UpdateUserExperienceAnalyticsDeviceScore(ctx context.Context, id beta.DeviceManagementUserExperienceAnalyticsDeviceScoreId, input beta.UserExperienceAnalyticsDeviceScores, options UpdateUserExperienceAnalyticsDeviceScoreOperationOptions) (result UpdateUserExperienceAnalyticsDeviceScoreOperationResponse, err error) {
