...
func (c UserExperienceAnalyticsDeviceStartupHistoryClient) GetUserExperienceAnalyticsDeviceStartupHistory(ctx context.Context, id beta.DeviceManagementUserExperienceAnalyticsDeviceStartupHistoryId, options GetUserExperienceAnalyticsDeviceStartupHistoryOperationOptions) (result GetUserExperienceAnalyticsDeviceStartupHistoryOperationResponse, err error) {
	...
	var model beta.UserExperienceAnalyticsDeviceStartupHistory
	result.Model = &model
