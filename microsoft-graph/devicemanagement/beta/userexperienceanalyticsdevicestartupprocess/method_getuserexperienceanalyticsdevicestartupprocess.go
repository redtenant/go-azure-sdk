...
func (c UserExperienceAnalyticsDeviceStartupProcessClient) GetUserExperienceAnalyticsDeviceStartupProcess(ctx context.Context, id beta.DeviceManagementUserExperienceAnalyticsDeviceStartupProcessId, options GetUserExperienceAnalyticsDeviceStartupProcessOperationOptions) (result GetUserExperienceAnalyticsDeviceStartupProcessOperationResponse, err error) {
