...
// deviceManagement
func (c UserExperienceAnalyticsModelScoreClient) CreateUserExperienceAnalyticsModelScore(ctx context.Context, input beta.UserExperienceAnalyticsModelScores, options CreateUserExperienceAnalyticsModelScoreOperationOptions) (result CreateUserExperienceAnalyticsModelScoreOperationResponse, err error) {
