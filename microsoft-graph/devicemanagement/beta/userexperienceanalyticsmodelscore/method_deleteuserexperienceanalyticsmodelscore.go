...
// deviceManagement
func (c UserExperienceAnalyticsModelScoreClient) DeleteUserExperienceAnalyticsModelScore(ctx context.Context, id beta.DeviceManagementUserExperienceAnalyticsModelScoreId, options DeleteUserExperienceAnalyticsModelScoreOperationOptions) (result DeleteUserExperienceAnalyticsModelScoreOperationResponse, err error) {
