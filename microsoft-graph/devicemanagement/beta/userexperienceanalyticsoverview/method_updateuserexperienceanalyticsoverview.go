...
type UpdateUserExperienceAnalyticsOverviewOperationResponse struct {
...
// deviceManagement
func (c UserExperienceAnalyticsOverviewClient) UpdateUserExperienceAnalyticsOverview(ctx context.Context, input beta.UserExperienceAnalyticsOverview, options UpdateUserExperienceAnalyticsOverviewOperationOptions) (result UpdateUserExperienceAnalyticsOverviewOperationResponse, err error) {
