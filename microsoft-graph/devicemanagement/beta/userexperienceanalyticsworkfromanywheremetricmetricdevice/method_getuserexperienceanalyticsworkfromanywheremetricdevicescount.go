...
func (c UserExperienceAnalyticsWorkFromAnywhereMetricMetricDeviceClient) GetUserExperienceAnalyticsWorkFromAnywhereMetricDevicesCount(ctx context.Context, id beta.DeviceManagementUserExperienceAnalyticsWorkFromAnywhereMetricId, options GetUserExperienceAnalyticsWorkFromAnywhereMetricDevicesCountOperationOptions) (result GetUserExperienceAnalyticsWorkFromAnywhereMetricDevicesCountOperationResponse, err error) {
