...
// deviceManagement
func (c UserExperienceAnalyticsWorkFromAnywhereMetricMetricDeviceClient) UpdateUserExperienceAnalyticsWorkFromAnywhereMetricDevice(ctx context.Context, id beta.DeviceManagementUserExperienceAnalyticsWorkFromAnywhereMetricIdMetricDeviceId, input beta.UserExperienceAnalyticsWorkFromAnywhereDevice, options UpdateUserExperienceAnalyticsWorkFromAnywhereMetricDeviceOperationOptions) (result UpdateUserExperienceAnalyticsWorkFromAnywhereMetricDeviceOperationResponse, err error) {
