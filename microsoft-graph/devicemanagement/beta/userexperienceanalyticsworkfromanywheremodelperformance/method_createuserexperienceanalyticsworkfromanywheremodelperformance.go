...
type CreateUserExperienceAnalyticsWorkFromAnywhereModelPerformanceOperationResponse struct {
...
func (c UserExperienceAnalyticsWorkFromAnywhereModelPerformanceClient) CreateUserExperienceAnalyticsWorkFromAnywhereModelPerformance(ctx context.Context, input beta.UserExperienceAnalyticsWorkFromAnywhereModelPerformance, options CreateUserExperienceAnalyticsWorkFromAnywhereModelPerformanceOperationOptions) (result CreateUserExperienceAnalyticsWorkFromAnywhereModelPerformanceOperationResponse, err error) {
