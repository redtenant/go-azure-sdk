...
func (c VirtualEndpointCloudPCClient) CreateVirtualEndpointCloudPC(ctx context.Context, input beta.CloudPC, options CreateVirtualEndpointCloudPCOperationOptions) (result CreateVirtualEndpointCloudPCOperationResponse, err error) {
