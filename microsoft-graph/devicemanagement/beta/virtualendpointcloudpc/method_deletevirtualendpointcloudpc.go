...
func (c VirtualEndpointCloudPCClient) DeleteVirtualEndpointCloudPC(ctx context.Context, id beta.DeviceManagementVirtualEndpointCloudPCId, options DeleteVirtualEndpointCloudPCOperationOptions) (result DeleteVirtualEndpointCloudPCOperationResponse, err error) {
