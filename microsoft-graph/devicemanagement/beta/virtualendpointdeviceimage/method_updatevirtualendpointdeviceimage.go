...
type UpdateVirtualEndpointDeviceImageOperationResponse struct {
...
func (c VirtualEndpointDeviceImageClient) UpdateVirtualEndpointDeviceImage(ctx context.Context, id beta.DeviceManagementVirtualEndpointDeviceImageId, input beta.CloudPCDeviceImage, options UpdateVirtualEndpointDeviceImageOperationOptions) (result UpdateVirtualEndpointDeviceImageOperationResponse, err error) {
