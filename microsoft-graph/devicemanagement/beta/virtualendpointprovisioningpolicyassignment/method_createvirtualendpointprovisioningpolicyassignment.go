...
// deviceManagement
func (c VirtualEndpointProvisioningPolicyAssignmentClient) CreateVirtualEndpointProvisioningPolicyAssignment(ctx context.Context, id beta.DeviceManagementVirtualEndpointProvisioningPolicyId, input beta.CloudPCProvisioningPolicyAssignment, options CreateVirtualEndpointProvisioningPolicyAssignmentOperationOptions) (result CreateVirtualEndpointProvisioningPolicyAssignmentOperationResponse, err error) {
