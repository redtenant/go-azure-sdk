...
func (c VirtualEndpointProvisioningPolicyAssignmentClient) GetVirtualEndpointProvisioningPolicyAssignmentsCount(ctx context.Context, id beta.DeviceManagementVirtualEndpointProvisioningPolicyId, options GetVirtualEndpointProvisioningPolicyAssignmentsCountOperationOptions) (result GetVirtualEndpointProvisioningPolicyAssignmentsCountOperationResponse, err error) {
