...
type GetVirtualEndpointSnapshotOperationResponse struct {
	HttpResponse *http.Response
	OData        *odata.OData
	Model        *beta.CloudPCSnapshot
}

type GetVirtualEndpointSnapshotOperationOptions struct {
	Expand    *odata.Expand
...
func DefaultGetVirtualEndpointSnapshotOperationOptions() GetVirtualEndpointSnapshotOperationOptions {
	return GetVirtualEndpointSnapshotOperationOptions{}
}
