...
func (c VirtualEndpointUserSettingClient) CreateVirtualEndpointUserSetting(ctx context.Context, input beta.CloudPCUserSetting, options CreateVirtualEndpointUserSettingOperationOptions) (result CreateVirtualEndpointUserSettingOperationResponse, err error) {
