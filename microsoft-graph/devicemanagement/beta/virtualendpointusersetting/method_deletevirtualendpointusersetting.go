...
func (c VirtualEndpointUserSettingClient) DeleteVirtualEndpointUserSetting(ctx context.Context, id beta.DeviceManagementVirtualEndpointUserSettingId, options DeleteVirtualEndpointUserSettingOperationOptions) (result DeleteVirtualEndpointUserSettingOperationResponse, err error) {
