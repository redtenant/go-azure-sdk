...
func (c VirtualEndpointUserSettingAssignmentClient) ListVirtualEndpointUserSettingAssignmentsComplete(ctx context.Context, id beta.DeviceManagementVirtualEndpointUserSettingId, options ListVirtualEndpointUserSettingAssignmentsOperationOptions) (ListVirtualEndpointUserSettingAssignmentsCompleteResult, error) {
...
func (c VirtualEndpointUserSettingAssignmentClient) ListVirtualEndpointUserSettingAssignmentsCompleteMatchingPredicate(ctx context.Context, id beta.DeviceManagementVirtualEndpointUserSettingId, options ListVirtualEndpointUserSettingAssignmentsOperationOptions, predicate CloudPCUserSettingAssignmentOperationPredicate) (result ListVirtualEndpointUserSettingAssignmentsCompleteResult, err error) {
