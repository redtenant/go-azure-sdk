...
// DeleteWindowsAutopilotDeviceIdentity - Delete navigation property windowsAutopilotDeviceIdentities for
// deviceManagement
func (c WindowsAutopilotDeviceIdentityClient) DeleteWindowsAutopilotDeviceIdentity(ctx context.Context, id beta.DeviceManagementWindowsAutopilotDeviceIdentityId, options DeleteWindowsAutopilotDeviceIdentityOperationOptions) (result DeleteWindowsAutopilotDeviceIdentityOperationResponse, err error) {
