...
// GetWindowsAutopilotDeviceIdentity - Get windowsAutopilotDeviceIdentities from deviceManagement. The Windows autopilot
// device identities contained collection.
func (c WindowsAutopilotDeviceIdentityClient) GetWindowsAutopilotDeviceIdentity(ctx context.Context, id beta.DeviceManagementWindowsAutopilotDeviceIdentityId, options GetWindowsAutopilotDeviceIdentityOperationOptions) (result GetWindowsAutopilotDeviceIdentityOperationResponse, err error) {
