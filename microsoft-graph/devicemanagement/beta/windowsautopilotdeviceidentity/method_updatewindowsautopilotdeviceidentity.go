...
// deviceManagement
func (c WindowsAutopilotDeviceIdentityClient) UpdateWindowsAutopilotDeviceIdentity(ctx context.Context, id beta.DeviceManagementWindowsAutopilotDeviceIdentityId, input beta.WindowsAutopilotDeviceIdentity, options UpdateWindowsAutopilotDeviceIdentityOperationOptions) (result UpdateWindowsAutopilotDeviceIdentityOperationResponse, err error) {
