...
// Autopilot devices.
func (c WindowsAutopilotDeviceIdentityClient) UpdateWindowsAutopilotDeviceIdentityDeviceProperties(ctx context.Context, id beta.DeviceManagementWindowsAutopilotDeviceIdentityId, input UpdateWindowsAutopilotDeviceIdentityDevicePropertiesRequest, options UpdateWindowsAutopilotDeviceIdentityDevicePropertiesOperationOptions) (result UpdateWindowsAutopilotDeviceIdentityDevicePropertiesOperationResponse, err error) {
