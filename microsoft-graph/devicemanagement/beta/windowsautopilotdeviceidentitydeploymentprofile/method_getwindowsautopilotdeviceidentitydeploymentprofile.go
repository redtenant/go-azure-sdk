...
type GetWindowsAutopilotDeviceIdentityDeploymentProfileOperationResponse struct {
...
func DefaultGetWindowsAutopilotDeviceIdentityDeploymentProfileOperationOptions() GetWindowsAutopilotDeviceIdentityDeploymentProfileOperationOptions {
	return GetWindowsAutopilotDeviceIdentityDeploymentProfileOperationOptions{}
}
...
// GetWindowsAutopilotDeviceIdentityDeploymentProfile - Get deploymentProfile from deviceManagement. Deployment profile
// currently assigned to the Windows autopilot device.
