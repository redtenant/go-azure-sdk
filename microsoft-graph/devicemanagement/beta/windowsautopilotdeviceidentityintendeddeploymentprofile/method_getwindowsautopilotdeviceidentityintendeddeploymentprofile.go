...
type GetWindowsAutopilotDeviceIdentityIntendedDeploymentProfileOperationResponse struct {
	HttpResponse *http.Response
	OData        *odata.OData
	Model        beta.WindowsAutopilotDeploymentProfile
}

type GetWindowsAutopilotDeviceIdentityIntendedDeploymentProfileOperationOptions struct {
	Expand    *odata.Expand
...
func DefaultGetWindowsAutopilotDeviceIdentityIntendedDeploymentProfileOperationOptions() GetWindowsAutopilotDeviceIdentityIntendedDeploymentProfileOperationOptions {
	return GetWindowsAutopilotDeviceIdentityIntendedDeploymentProfileOperationOptions{}
}
...
// GetWindowsAutopilotDeviceIdentityIntendedDeploymentProfile - Get intendedDeploymentProfile from deviceManagement.
