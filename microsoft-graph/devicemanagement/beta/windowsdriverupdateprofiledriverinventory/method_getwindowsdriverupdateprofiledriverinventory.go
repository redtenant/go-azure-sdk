...
type GetWindowsDriverUpdateProfileDriverInventoryOperationResponse struct {
	HttpResponse *http.Response
	OData        *odata.OData
	Model        *beta.WindowsDriverUpdateInventory
}

type GetWindowsDriverUpdateProfileDriverInventoryOperationOptions struct {
	Expand    *odata.Expand
...
func DefaultGetWindowsDriverUpdateProfileDriverInventoryOperationOptions() GetWindowsDriverUpdateProfileDriverInventoryOperationOptions {
	return GetWindowsDriverUpdateProfileDriverInventoryOperationOptions{}
}
...
// GetWindowsDriverUpdateProfileDriverInventory - Get driverInventories from deviceManagement. Driver inventories for
// this profile.
func (c WindowsDriverUpdateProfileDriverInventoryClient) GetWindowsDriverUpdateProfileDriverInventory(ctx context.Context, id beta.DeviceManagementWindowsDriverUpdateProfileIdDriverInventoryId, options GetWindowsDriverUpdateProfileDriverInventoryOperationOptions) (result GetWindowsDriverUpdateProfileDriverInventoryOperationResponse, err error) {
	...
	var model beta.WindowsDriverUpdateInventory
	result.Model = &model
