...
type GetWindowsFeatureUpdateProfileAssignmentOperationResponse struct {
	HttpResponse *http.Response
	OData        *odata.OData
	Model        *beta.WindowsFeatureUpdateProfileAssignment
}

type GetWindowsFeatureUpdateProfileAssignmentOperationOptions struct {
	Expand    *odata.Expand
...
func DefaultGetWindowsFeatureUpdateProfileAssignmentOperationOptions() GetWindowsFeatureUpdateProfileAssignmentOperationOptions {
	return GetWindowsFeatureUpdateProfileAssignmentOperationOptions{}
}
...
// GetWindowsFeatureUpdateProfileAssignment - Get assignments from deviceManagement. The list of group assignments of
// the profile.
