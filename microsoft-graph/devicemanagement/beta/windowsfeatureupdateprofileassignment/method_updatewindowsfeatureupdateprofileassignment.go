...
type UpdateWindowsFeatureUpdateProfileAssignmentOperationResponse struct {
	HttpResponse *http.Response
	OData        *odata.OData
}

type UpdateWindowsFeatureUpdateProfileAssignmentOperationOptions struct {
...
func DefaultUpdateWindowsFeatureUpdateProfileAssignmentOperationOptions() UpdateWindowsFeatureUpdateProfileAssignmentOperationOptions {
	return UpdateWindowsFeatureUpdateProfileAssignmentOperationOptions{}
}
