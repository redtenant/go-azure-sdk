...
// DeleteWindowsInformationProtectionAppLearningSummary - Delete navigation property
// windowsInformationProtectionAppLearningSummaries for deviceManagement
func (c WindowsInformationProtectionAppLearningSummaryClient) DeleteWindowsInformationProtectionAppLearningSummary(ctx context.Context, id beta.DeviceManagementWindowsInformationProtectionAppLearningSummaryId, options DeleteWindowsInformationProtectionAppLearningSummaryOperationOptions) (result DeleteWindowsInformationProtectionAppLearningSummaryOperationResponse, err error) {
