...
// DeleteWindowsInformationProtectionNetworkLearningSummary - Delete navigation property
// windowsInformationProtectionNetworkLearningSummaries for deviceManagement
func (c WindowsInformationProtectionNetworkLearningSummaryClient) DeleteWindowsInformationProtectionNetworkLearningSummary(ctx context.Context, id beta.DeviceManagementWindowsInformationProtectionNetworkLearningSummaryId, options DeleteWindowsInformationProtectionNetworkLearningSummaryOperationOptions) (result DeleteWindowsInformationProtectionNetworkLearningSummaryOperationResponse, err error) {
