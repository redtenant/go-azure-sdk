...
// UpdateApplePushNotificationCertificate - Update applePushNotificationCertificate. Update the properties of a
// applePushNotificationCertificate object.
func (c ApplePushNotificationCertificateClient) UpdateApplePushNotificationCertificate(ctx context.Context, input stable.ApplePushNotificationCertificate, options UpdateApplePushNotificationCertificateOperationOptions) (result UpdateApplePushNotificationCertificateOperationResponse, err error) {
