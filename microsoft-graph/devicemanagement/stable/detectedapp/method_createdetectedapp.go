...
type CreateDetectedAppOperationResponse struct {
...
// CreateDetectedApp - Create detectedApp. Create a new detectedApp object.
func (c DetectedAppClient) CreateDetectedApp(ctx context.Context, input stable.DetectedApp, options CreateDetectedAppOperationOptions) (result CreateDetectedAppOperationResponse, err error) {
