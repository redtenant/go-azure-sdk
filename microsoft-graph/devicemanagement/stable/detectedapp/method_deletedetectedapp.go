...
// DeleteDetectedApp - Delete detectedApp. Deletes a detectedApp.
func (c DetectedAppClient) DeleteDetectedApp(ctx context.Context, id stable.DeviceManagementDetectedAppId, options DeleteDetectedAppOperationOptions) (result DeleteDetectedAppOperationResponse, err error) {
