...
func DefaultDeleteDeviceCategoryOperationOptions() DeleteDeviceCategoryOperationOptions {
	return DeleteDeviceCategoryOperationOptions{}
}
...
// DeleteDeviceCategory - Delete deviceCategory. Deletes a deviceCategory.
func (c DeviceCategoryClient) DeleteDeviceCategory(ctx context.Context, id stable.DeviceManagementDeviceCategoryId, options DeleteDeviceCategoryOperationOptions) (result DeleteDeviceCategoryOperationResponse, err error) {
