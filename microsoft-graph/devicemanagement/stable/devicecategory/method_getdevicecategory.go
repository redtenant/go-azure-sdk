...
// GetDeviceCategory - Get deviceCategory. Read properties and relationships of the deviceCategory object.
func (c DeviceCategoryClient) GetDeviceCategory(ctx context.Context, id stable.DeviceManagementDeviceCategoryId, options GetDeviceCategoryOperationOptions) (result GetDeviceCategoryOperationResponse, err error) {
