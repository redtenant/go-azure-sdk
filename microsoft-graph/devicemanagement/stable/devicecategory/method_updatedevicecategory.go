...
// UpdateDeviceCategory - Update deviceCategory. Update the properties of a deviceCategory object.
func (c DeviceCategoryClient) UpdateDeviceCategory(ctx context.Context, id stable.DeviceManagementDeviceCategoryId, input stable.DeviceCategory, options UpdateDeviceCategoryOperationOptions) (result UpdateDeviceCategoryOperationResponse, err error) {
