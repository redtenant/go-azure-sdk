...
func (c DeviceCompliancePolicyClient) AssignDeviceCompliancePolicies(ctx context.Context, id stable.DeviceManagementDeviceCompliancePolicyId, input AssignDeviceCompliancePoliciesRequest, options AssignDeviceCompliancePoliciesOperationOptions) (result AssignDeviceCompliancePoliciesOperationResponse, err error) {
...
func (c DeviceCompliancePolicyClient) AssignDeviceCompliancePoliciesComplete(ctx context.Context, id stable.DeviceManagementDeviceCompliancePolicyId, input AssignDeviceCompliancePoliciesRequest, options AssignDeviceCompliancePoliciesOperationOptions) (AssignDeviceCompliancePoliciesCompleteResult, error) {
