...
// GetDeviceCompliancePolicyAssignment - Get deviceCompliancePolicyAssignment. Read properties and relationships of the
// deviceCompliancePolicyAssignment object.
func (c DeviceCompliancePolicyAssignmentClient) GetDeviceCompliancePolicyAssignment(ctx context.Context, id stable.DeviceManagementDeviceCompliancePolicyIdAssignmentId, options GetDeviceCompliancePolicyAssignmentOperationOptions) (result GetDeviceCompliancePolicyAssignmentOperationResponse, err error) {
