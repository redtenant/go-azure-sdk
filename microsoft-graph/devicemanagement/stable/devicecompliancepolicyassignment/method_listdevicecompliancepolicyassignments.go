...
// ListDeviceCompliancePolicyAssignments - List deviceCompliancePolicyAssignments. List properties and relationships of
// the deviceCompliancePolicyAssignment objects.
func (c DeviceCompliancePolicyAssignmentClient) ListDeviceCompliancePolicyAssignments(ctx context.Context, id stable.DeviceManagementDeviceCompliancePolicyId, options ListDeviceCompliancePolicyAssignmentsOperationOptions) (result ListDeviceCompliancePolicyAssignmentsOperationResponse, err error) {
	...
	var values struct {
		Values *[]stable.DeviceCompliancePolicyAssignment `json:"value"`
	}
...
func (c DeviceCompliancePolicyAssignmentClient) ListDeviceCompliancePolicyAssignmentsComplete(ctx context.Context, id stable.DeviceManagementDeviceCompliancePolicyId, options ListDeviceCompliancePolicyAssignmentsOperationOptions) (ListDeviceCompliancePolicyAssignmentsCompleteResult, error) {
...
func (c DeviceCompliancePolicyAssignmentClient) ListDeviceCompliancePolicyAssignmentsCompleteMatchingPredicate(ctx context.Context, id stable.DeviceManagementDeviceCompliancePolicyId, options ListDeviceCompliancePolicyAssignmentsOperationOptions, predicate DeviceCompliancePolicyAssignmentOperationPredicate) (result ListDeviceCompliancePolicyAssignmentsCompleteResult, err error) {
	items := make([]stable.DeviceCompliancePolicyAssignment, 0)
