...
func (c DeviceCompliancePolicyScheduledActionsForRuleClient) GetDeviceCompliancePolicyScheduledActionsForRuleCount(ctx context.Context, id stable.DeviceManagementDeviceCompliancePolicyId, options GetDeviceCompliancePolicyScheduledActionsForRuleCountOperationOptions) (result GetDeviceCompliancePolicyScheduledActionsForRuleCountOperationResponse, err error) {
