...
// DeleteDeviceCompliancePolicyScheduledActionsForRuleConfiguration - Delete deviceComplianceActionItem. Deletes a
// deviceComplianceActionItem.
func (c DeviceCompliancePolicyScheduledActionsForRuleScheduledActionConfigurationClient) DeleteDeviceCompliancePolicyScheduledActionsForRuleConfiguration(ctx context.Context, id stable.DeviceManagementDeviceCompliancePolicyIdScheduledActionsForRuleIdScheduledActionConfigurationId, options DeleteDeviceCompliancePolicyScheduledActionsForRuleConfigurationOperationOptions) (result DeleteDeviceCompliancePolicyScheduledActionsForRuleConfigurationOperationResponse, err error) {
