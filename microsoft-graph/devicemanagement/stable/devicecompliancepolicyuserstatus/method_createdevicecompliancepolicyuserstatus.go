...
// CreateDeviceCompliancePolicyUserStatus - Create deviceComplianceUserStatus. Create a new deviceComplianceUserStatus
// object.
func (c DeviceCompliancePolicyUserStatusClient) CreateDeviceCompliancePolicyUserStatus(ctx context.Context, id stable.DeviceManagementDeviceCompliancePolicyId, input stable.DeviceComplianceUserStatus, options CreateDeviceCompliancePolicyUserStatusOperationOptions) (result CreateDeviceCompliancePolicyUserStatusOperationResponse, err error) {
