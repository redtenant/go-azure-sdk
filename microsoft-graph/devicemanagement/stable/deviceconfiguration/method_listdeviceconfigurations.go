...
func DefaultListDeviceConfigurationsOperationOptions() ListDeviceConfigurationsOperationOptions {
	return ListDeviceConfigurationsOperationOptions{}
}

func (o ListDeviceConfigurationsOperationOptions) ToHeaders() *client.Headers {
	out := client.Headers{}

	return &out
}

func (o ListDeviceConfigurationsOperationOptions) ToOData() *odata.Query {
	out := odata.Query{}
	if o.Count != nil {
		out.Count = *o.Count
	}
...
func (o ListDeviceConfigurationsOperationOptions) ToQuery() *client.QueryParams {
...
func (c DeviceConfigurationClient) ListDeviceConfigurations(ctx context.Context, options ListDeviceConfigurationsOperationOptions) (result ListDeviceConfigurationsOperationResponse, err error) {
	...
	temp := make([]stable.DeviceConfiguration, 0)
	if values.Values != nil {
		for i, v := range *values.Values {
			val, err := stable.UnmarshalDeviceConfigurationImplementation(v)
			if err != nil {
				err = fmt.Errorf("unmarshalling item %d for stable.DeviceConfiguration (%q): %+v", i, v, err)
				return result, err
			}
...
func (c DeviceConfigurationClient) ListDeviceConfigurationsComplete(ctx context.Context, options ListDeviceConfigurationsOperationOptions) (ListDeviceConfigurationsCompleteResult, error) {
	return c.ListDeviceConfigurationsCompleteMatchingPredicate(ctx, options, DeviceConfigurationOperationPredicate{})
}
...
func (c DeviceConfigurationClient) ListDeviceConfigurationsCompleteMatchingPredicate(ctx context.Context, options ListDeviceConfigurationsOperationOptions, predicate DeviceConfigurationOperationPredicate) (result ListDeviceConfigurationsCompleteResult, err error) {
	items := make([]stable.DeviceConfiguration, 0)

	resp, err := c.ListDeviceConfigurations(ctx, options)
	if err != nil {
