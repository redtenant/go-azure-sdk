...
// GetDeviceConfigurationAssignment - Get deviceConfigurationAssignment. Read properties and relationships of the
// deviceConfigurationAssignment object.
func (c DeviceConfigurationAssignmentClient) GetDeviceConfigurationAssignment(ctx context.Context, id stable.DeviceManagementDeviceConfigurationIdAssignmentId, options GetDeviceConfigurationAssignmentOperationOptions) (result GetDeviceConfigurationAssignmentOperationResponse, err error) {
