...
// UpdateDeviceConfigurationDeviceStateSummary - Update deviceConfigurationDeviceStateSummary. Update the properties of
// a deviceConfigurationDeviceStateSummary object.
func (c DeviceConfigurationDeviceStateSummaryClient) UpdateDeviceConfigurationDeviceStateSummary(ctx context.Context, input stable.DeviceConfigurationDeviceStateSummary, options UpdateDeviceConfigurationDeviceStateSummaryOperationOptions) (result UpdateDeviceConfigurationDeviceStateSummaryOperationResponse, err error) {
