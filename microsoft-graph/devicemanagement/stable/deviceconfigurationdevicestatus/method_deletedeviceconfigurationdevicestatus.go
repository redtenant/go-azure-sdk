...
// DeleteDeviceConfigurationDeviceStatus - Delete deviceConfigurationDeviceStatus. Deletes a
// deviceConfigurationDeviceStatus.
func (c DeviceConfigurationDeviceStatusClient) DeleteDeviceConfigurationDeviceStatus(ctx context.Context, id stable.DeviceManagementDeviceConfigurationIdDeviceStatusId, options DeleteDeviceConfigurationDeviceStatusOperationOptions) (result DeleteDeviceConfigurationDeviceStatusOperationResponse, err error) {
