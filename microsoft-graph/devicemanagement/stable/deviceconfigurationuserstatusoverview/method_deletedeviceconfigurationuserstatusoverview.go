...
func (c DeviceConfigurationUserStatusOverviewClient) DeleteDeviceConfigurationUserStatusOverview(ctx context.Context, id stable.DeviceManagementDeviceConfigurationId, options DeleteDeviceConfigurationUserStatusOverviewOperationOptions) (result DeleteDeviceConfigurationUserStatusOverviewOperationResponse, err error) {
