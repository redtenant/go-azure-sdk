...
// GetDeviceEnrollmentConfigurationAssignment - Get enrollmentConfigurationAssignment. Read properties and relationships
// of the enrollmentConfigurationAssignment object.
func (c DeviceEnrollmentConfigurationAssignmentClient) GetDeviceEnrollmentConfigurationAssignment(ctx context.Context, id stable.DeviceManagementDeviceEnrollmentConfigurationIdAssignmentId, options GetDeviceEnrollmentConfigurationAssignmentOperationOptions) (result GetDeviceEnrollmentConfigurationAssignmentOperationResponse, err error) {
