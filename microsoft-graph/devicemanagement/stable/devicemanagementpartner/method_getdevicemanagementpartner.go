...
// GetDeviceManagementPartner - Get deviceManagementPartner. Read properties and relationships of the
// deviceManagementPartner object.
func (c DeviceManagementPartnerClient) GetDeviceManagementPartner(ctx context.Context, id stable.DeviceManagementDeviceManagementPartnerId, options GetDeviceManagementPartnerOperationOptions) (result GetDeviceManagementPartnerOperationResponse, err error) {
