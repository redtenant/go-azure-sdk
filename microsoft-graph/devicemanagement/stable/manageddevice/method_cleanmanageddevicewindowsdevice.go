...
func (c ManagedDeviceClient) CleanManagedDeviceWindowsDevice(ctx context.Context, id stable.DeviceManagementManagedDeviceId, input CleanManagedDeviceWindowsDeviceRequest, options CleanManagedDeviceWindowsDeviceOperationOptions) (result CleanManagedDeviceWindowsDeviceOperationResponse, err error) {
