...
func (c ManagedDeviceClient) CreateManagedDeviceWindowsDefenderScan(ctx context.Context, id stable.DeviceManagementManagedDeviceId, input CreateManagedDeviceWindowsDefenderScanRequest, options CreateManagedDeviceWindowsDefenderScanOperationOptions) (result CreateManagedDeviceWindowsDefenderScanOperationResponse, err error) {
