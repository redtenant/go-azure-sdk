...
// DeleteManagedDevice - Delete managedDevice. Deletes a managedDevice.
func (c ManagedDeviceClient) DeleteManagedDevice(ctx context.Context, id stable.DeviceManagementManagedDeviceId, options DeleteManagedDeviceOperationOptions) (result DeleteManagedDeviceOperationResponse, err error) {
