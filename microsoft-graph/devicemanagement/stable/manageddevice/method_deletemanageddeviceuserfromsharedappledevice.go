...
// Apple device
func (c ManagedDeviceClient) DeleteManagedDeviceUserFromSharedAppleDevice(ctx context.Context, id stable.DeviceManagementManagedDeviceId, input DeleteManagedDeviceUserFromSharedAppleDeviceRequest, options DeleteManagedDeviceUserFromSharedAppleDeviceOperationOptions) (result DeleteManagedDeviceUserFromSharedAppleDeviceOperationResponse, err error) {
