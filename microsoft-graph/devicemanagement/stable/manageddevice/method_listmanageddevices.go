...
// ListManagedDevices - Get managedDevices from deviceManagement. The list of managed devices.
func (c ManagedDeviceClient) ListManagedDevices(ctx context.Context, options ListManagedDevicesOperationOptions) (result ListManagedDevicesOperationResponse, err error) {
...
func (c ManagedDeviceClient) ListManagedDevicesComplete(ctx context.Context, options ListManagedDevicesOperationOptions) (ListManagedDevicesCompleteResult, error) {
	return c.ListManagedDevicesCompleteMatchingPredicate(ctx, options, ManagedDeviceOperationPredicate{})
}
...
func (c ManagedDeviceClient) ListManagedDevicesCompleteMatchingPredicate(ctx context.Context, options ListManagedDevicesOperationOptions, predicate ManagedDeviceOperationPredicate) (result ListManagedDevicesCompleteResult, err error) {
	...
	resp, err := c.ListManagedDevices(ctx, options)
	if err != nil {
