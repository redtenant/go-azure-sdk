...
func (c ManagedDeviceClient) LocateManagedDeviceDevice(ctx context.Context, id stable.DeviceManagementManagedDeviceId, options LocateManagedDeviceDeviceOperationOptions) (result LocateManagedDeviceDeviceOperationResponse, err error) {
