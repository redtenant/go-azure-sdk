...
// device active user
func (c ManagedDeviceClient) LogoutManagedDeviceSharedAppleDeviceActiveUser(ctx context.Context, id stable.DeviceManagementManagedDeviceId, options LogoutManagedDeviceSharedAppleDeviceActiveUserOperationOptions) (result LogoutManagedDeviceSharedAppleDeviceActiveUserOperationResponse, err error) {
