...
func (c ManagedDeviceClient) RebootManagedDeviceNow(ctx context.Context, id stable.DeviceManagementManagedDeviceId, options RebootManagedDeviceNowOperationOptions) (result RebootManagedDeviceNowOperationResponse, err error) {
