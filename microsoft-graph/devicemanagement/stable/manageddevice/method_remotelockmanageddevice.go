...
func (c ManagedDeviceClient) RemoteLockManagedDevice(ctx context.Context, id stable.DeviceManagementManagedDeviceId, options RemoteLockManagedDeviceOperationOptions) (result RemoteLockManagedDeviceOperationResponse, err error) {
