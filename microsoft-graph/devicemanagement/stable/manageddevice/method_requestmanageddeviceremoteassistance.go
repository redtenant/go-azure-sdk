...
func (c ManagedDeviceClient) RequestManagedDeviceRemoteAssistance(ctx context.Context, id stable.DeviceManagementManagedDeviceId, options RequestManagedDeviceRemoteAssistanceOperationOptions) (result RequestManagedDeviceRemoteAssistanceOperationResponse, err error) {
