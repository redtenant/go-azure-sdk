...
func (c ManagedDeviceClient) ResetManagedDevicePasscode(ctx context.Context, id stable.DeviceManagementManagedDeviceId, options ResetManagedDevicePasscodeOperationOptions) (result ResetManagedDevicePasscodeOperationResponse, err error) {
