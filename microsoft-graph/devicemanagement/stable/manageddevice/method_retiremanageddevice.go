...
func (c ManagedDeviceClient) RetireManagedDevice(ctx context.Context, id stable.DeviceManagementManagedDeviceId, options RetireManagedDeviceOperationOptions) (result RetireManagedDeviceOperationResponse, err error) {
