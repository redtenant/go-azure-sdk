...
// UpdateManagedDevice - Update the navigation property managedDevices in deviceManagement
func (c ManagedDeviceClient) UpdateManagedDevice(ctx context.Context, id stable.DeviceManagementManagedDeviceId, input stable.ManagedDevice, options UpdateManagedDeviceOperationOptions) (result UpdateManagedDeviceOperationResponse, err error) {
