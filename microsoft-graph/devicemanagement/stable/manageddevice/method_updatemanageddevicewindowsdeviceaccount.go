...
func (c ManagedDeviceClient) UpdateManagedDeviceWindowsDeviceAccount(ctx context.Context, id stable.DeviceManagementManagedDeviceId, input UpdateManagedDeviceWindowsDeviceAccountRequest, options UpdateManagedDeviceWindowsDeviceAccountOperationOptions) (result UpdateManagedDeviceWindowsDeviceAccountOperationResponse, err error) {
