...
func (c ManagedDeviceClient) WipeManagedDevice(ctx context.Context, id stable.DeviceManagementManagedDeviceId, input WipeManagedDeviceRequest, options WipeManagedDeviceOperationOptions) (result WipeManagedDeviceOperationResponse, err error) {
