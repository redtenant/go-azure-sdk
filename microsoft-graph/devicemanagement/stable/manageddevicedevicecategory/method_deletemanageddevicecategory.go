...
func (c ManagedDeviceDeviceCategoryClient) DeleteManagedDeviceCategory(ctx context.Context, id stable.DeviceManagementManagedDeviceId, options DeleteManagedDeviceCategoryOperationOptions) (result DeleteManagedDeviceCategoryOperationResponse, err error) {
