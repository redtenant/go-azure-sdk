...
func (c ManagedDeviceDeviceCategoryClient) GetManagedDeviceCategory(ctx context.Context, id stable.DeviceManagementManagedDeviceId, options GetManagedDeviceCategoryOperationOptions) (result GetManagedDeviceCategoryOperationResponse, err error) {
