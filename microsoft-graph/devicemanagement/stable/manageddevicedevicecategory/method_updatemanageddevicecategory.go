...
func (c ManagedDeviceDeviceCategoryClient) UpdateManagedDeviceCategory(ctx context.Context, id stable.DeviceManagementManagedDeviceId, input stable.DeviceCategory, options UpdateManagedDeviceCategoryOperationOptions) (result UpdateManagedDeviceCategoryOperationResponse, err error) {
