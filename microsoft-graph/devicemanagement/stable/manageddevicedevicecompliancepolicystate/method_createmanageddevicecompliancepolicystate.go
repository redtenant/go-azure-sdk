...
// deviceManagement
func (c ManagedDeviceDeviceCompliancePolicyStateClient) CreateManagedDeviceCompliancePolicyState(ctx context.Context, id stable.DeviceManagementManagedDeviceId, input stable.DeviceCompliancePolicyState, options CreateManagedDeviceCompliancePolicyStateOperationOptions) (result CreateManagedDeviceCompliancePolicyStateOperationResponse, err error) {
