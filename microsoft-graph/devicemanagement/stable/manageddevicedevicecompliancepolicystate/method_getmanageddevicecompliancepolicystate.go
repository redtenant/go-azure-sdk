...
// GetManagedDeviceCompliancePolicyState - Get deviceCompliancePolicyStates from deviceManagement. Device compliance
// policy states for this device.
func (c ManagedDeviceDeviceCompliancePolicyStateClient) GetManagedDeviceCompliancePolicyState(ctx context.Context, id stable.DeviceManagementManagedDeviceIdDeviceCompliancePolicyStateId, options GetManagedDeviceCompliancePolicyStateOperationOptions) (result GetManagedDeviceCompliancePolicyStateOperationResponse, err error) {
