...
func (c ManagedDeviceDeviceConfigurationStateClient) DeleteManagedDeviceConfigurationState(ctx context.Context, id stable.DeviceManagementManagedDeviceIdDeviceConfigurationStateId, options DeleteManagedDeviceConfigurationStateOperationOptions) (result DeleteManagedDeviceConfigurationStateOperationResponse, err error) {
