...
// for this device.
func (c ManagedDeviceDeviceConfigurationStateClient) GetManagedDeviceConfigurationState(ctx context.Context, id stable.DeviceManagementManagedDeviceIdDeviceConfigurationStateId, options GetManagedDeviceConfigurationStateOperationOptions) (result GetManagedDeviceConfigurationStateOperationResponse, err error) {
