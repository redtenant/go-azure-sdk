...
// ListManagedDeviceConfigurationStates - Get deviceConfigurationStates from deviceManagement. Device configuration
// states for this device.
func (c ManagedDeviceDeviceConfigurationStateClient) ListManagedDeviceConfigurationStates(ctx context.Context, id stable.DeviceManagementManagedDeviceId, options ListManagedDeviceConfigurationStatesOperationOptions) (result ListManagedDeviceConfigurationStatesOperationResponse, err error) {
	...
	var values struct {
		Values *[]stable.DeviceConfigurationState `json:"value"`
	}
...
func (c ManagedDeviceDeviceConfigurationStateClient) ListManagedDeviceConfigurationStatesComplete(ctx context.Context, id stable.DeviceManagementManagedDeviceId, options ListManagedDeviceConfigurationStatesOperationOptions) (ListManagedDeviceConfigurationStatesCompleteResult, error) {
...
func (c ManagedDeviceDeviceConfigurationStateClient) ListManagedDeviceConfigurationStatesCompleteMatchingPredicate(ctx context.Context, id stable.DeviceManagementManagedDeviceId, options ListManagedDeviceConfigurationStatesOperationOptions, predicate DeviceConfigurationStateOperationPredicate) (result ListManagedDeviceConfigurationStatesCompleteResult, err error) {
	items := make([]stable.DeviceConfigurationState, 0)
