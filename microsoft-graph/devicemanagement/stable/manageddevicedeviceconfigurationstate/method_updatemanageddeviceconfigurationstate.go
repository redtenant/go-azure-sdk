...
func (c ManagedDeviceDeviceConfigurationStateClient) UpdateManagedDeviceConfigurationState(ctx context.Context, id stable.DeviceManagementManagedDeviceIdDeviceConfigurationStateId, input stable.DeviceConfigurationState, options UpdateManagedDeviceConfigurationStateOperationOptions) (result UpdateManagedDeviceConfigurationStateOperationResponse, err error) {
