...
// GetManagedDeviceLogCollectionRequest - Get logCollectionRequests from deviceManagement. List of log collection
// requests
func (c ManagedDeviceLogCollectionRequestClient) GetManagedDeviceLogCollectionRequest(ctx context.Context, id stable.DeviceManagementManagedDeviceIdLogCollectionRequestId, options GetManagedDeviceLogCollectionRequestOperationOptions) (result GetManagedDeviceLogCollectionRequestOperationResponse, err error) {
