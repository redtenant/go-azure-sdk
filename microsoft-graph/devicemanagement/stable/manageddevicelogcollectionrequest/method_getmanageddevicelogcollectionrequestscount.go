...
func DefaultGetManagedDeviceLogCollectionRequestsCountOperationOptions() GetManagedDeviceLogCollectionRequestsCountOperationOptions {
	return GetManagedDeviceLogCollectionRequestsCountOperationOptions{}
}
...
func (c ManagedDeviceLogCollectionRequestClient) GetManagedDeviceLogCollectionRequestsCount(ctx context.Context, id stable.DeviceManagementManagedDeviceId, options GetManagedDeviceLogCollectionRequestsCountOperationOptions) (result GetManagedDeviceLogCollectionRequestsCountOperationResponse, err error) {
