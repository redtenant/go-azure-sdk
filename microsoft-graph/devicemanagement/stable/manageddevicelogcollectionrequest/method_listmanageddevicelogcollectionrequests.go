...
// ListManagedDeviceLogCollectionRequests - Get logCollectionRequests from deviceManagement. List of log collection
// requests
func (c ManagedDeviceLogCollectionRequestClient) ListManagedDeviceLogCollectionRequests(ctx context.Context, id stable.DeviceManagementManagedDeviceId, options ListManagedDeviceLogCollectionRequestsOperationOptions) (result ListManagedDeviceLogCollectionRequestsOperationResponse, err error) {
...
func (c ManagedDeviceLogCollectionRequestClient) ListManagedDeviceLogCollectionRequestsComplete(ctx context.Context, id stable.DeviceManagementManagedDeviceId, options ListManagedDeviceLogCollectionRequestsOperationOptions) (ListManagedDeviceLogCollectionRequestsCompleteResult, error) {
...
func (c ManagedDeviceLogCollectionRequestClient) ListManagedDeviceLogCollectionRequestsCompleteMatchingPredicate(ctx context.Context, id stable.DeviceManagementManagedDeviceId, options ListManagedDeviceLogCollectionRequestsOperationOptions, predicate DeviceLogCollectionResponseOperationPredicate) (result ListManagedDeviceLogCollectionRequestsCompleteResult, err error) {
