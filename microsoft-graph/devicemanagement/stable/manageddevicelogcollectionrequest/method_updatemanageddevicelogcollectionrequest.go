...
// UpdateManagedDeviceLogCollectionRequest - Update the navigation property logCollectionRequests in deviceManagement
func (c ManagedDeviceLogCollectionRequestClient) UpdateManagedDeviceLogCollectionRequest(ctx context.Context, id stable.DeviceManagementManagedDeviceIdLogCollectionRequestId, input stable.DeviceLogCollectionResponse, options UpdateManagedDeviceLogCollectionRequestOperationOptions) (result UpdateManagedDeviceLogCollectionRequestOperationResponse, err error) {
