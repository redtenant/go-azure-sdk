...
// CreateMobileAppTroubleshootingEventAppLogCollectionRequest - Create appLogCollectionRequest. Create a new
// appLogCollectionRequest object.
func (c MobileAppTroubleshootingEventAppLogCollectionRequestClient) CreateMobileAppTroubleshootingEventAppLogCollectionRequest(ctx context.Context, id stable.DeviceManagementMobileAppTroubleshootingEventId, input stable.AppLogCollectionRequest, options CreateMobileAppTroubleshootingEventAppLogCollectionRequestOperationOptions) (result CreateMobileAppTroubleshootingEventAppLogCollectionRequestOperationResponse, err error) {
	...
	var model stable.AppLogCollectionRequest
	result.Model = &model
