...
// GetMobileAppTroubleshootingEventAppLogCollectionRequest - Get appLogCollectionRequest. Read properties and
// relationships of the appLogCollectionRequest object.
func (c MobileAppTroubleshootingEventAppLogCollectionRequestClient) GetMobileAppTroubleshootingEventAppLogCollectionRequest(ctx context.Context, id stable.DeviceManagementMobileAppTroubleshootingEventIdAppLogCollectionRequestId, options GetMobileAppTroubleshootingEventAppLogCollectionRequestOperationOptions) (result GetMobileAppTroubleshootingEventAppLogCollectionRequestOperationResponse, err error) {
