...
// ListMobileAppTroubleshootingEventAppLogCollectionRequests - List appLogCollectionRequests. List properties and
// relationships of the appLogCollectionRequest objects.
func (c MobileAppTroubleshootingEventAppLogCollectionRequestClient) ListMobileAppTroubleshootingEventAppLogCollectionRequests(ctx context.Context, id stable.DeviceManagementMobileAppTroubleshootingEventId, options ListMobileAppTroubleshootingEventAppLogCollectionRequestsOperationOptions) (result ListMobileAppTroubleshootingEventAppLogCollectionRequestsOperationResponse, err error) {
	...
	var values struct {
		Values *[]stable.AppLogCollectionRequest `json:"value"`
	}
...
func (c MobileAppTroubleshootingEventAppLogCollectionRequestClient) ListMobileAppTroubleshootingEventAppLogCollectionRequestsComplete(ctx context.Context, id stable.DeviceManagementMobileAppTroubleshootingEventId, options ListMobileAppTroubleshootingEventAppLogCollectionRequestsOperationOptions) (ListMobileAppTroubleshootingEventAppLogCollectionRequestsCompleteResult, error) {
...
func (c MobileAppTroubleshootingEventAppLogCollectionRequestClient) ListMobileAppTroubleshootingEventAppLogCollectionRequestsCompleteMatchingPredicate(ctx context.Context, id stable.DeviceManagementMobileAppTroubleshootingEventId, options ListMobileAppTroubleshootingEventAppLogCollectionRequestsOperationOptions, predicate AppLogCollectionRequestOperationPredicate) (result ListMobileAppTroubleshootingEventAppLogCollectionRequestsCompleteResult, err error) {
	items := make([]stable.AppLogCollectionRequest, 0)
