...
func DefaultDeleteReportOperationOptions() DeleteReportOperationOptions {
	return DeleteReportOperationOptions{}
}

func (o DeleteReportOperationOptions) ToHeaders() *client.Headers {
	out := client.Headers{}
	if o.IfMatch != nil {
...
func (o DeleteReportOperationOptions) ToQuery() *client.QueryParams {
...
func (c ReportClient) DeleteReport(ctx context.Context, options DeleteReportOperationOptions) (result DeleteReportOperationResponse, err error) {
