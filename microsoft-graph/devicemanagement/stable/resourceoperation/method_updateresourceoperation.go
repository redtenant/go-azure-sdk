...
type UpdateResourceOperationOperationResponse struct {
...
// UpdateResourceOperation - Update resourceOperation. Update the properties of a resourceOperation object.
func (c ResourceOperationClient) UpdateResourceOperation(ctx context.Context, id stable.DeviceManagementResourceOperationId, input stable.ResourceOperation, options UpdateResourceOperationOperationOptions) (result UpdateResourceOperationOperationResponse, err error) {
