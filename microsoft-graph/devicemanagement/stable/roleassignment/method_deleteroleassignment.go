...
func DefaultDeleteRoleAssignmentOperationOptions() DeleteRoleAssignmentOperationOptions {
	return DeleteRoleAssignmentOperationOptions{}
}
...
// DeleteRoleAssignment - Delete deviceAndAppManagementRoleAssignment. Deletes a deviceAndAppManagementRoleAssignment.
func (c RoleAssignmentClient) DeleteRoleAssignment(ctx context.Context, id stable.DeviceManagementRoleAssignmentId, options DeleteRoleAssignmentOperationOptions) (result DeleteRoleAssignmentOperationResponse, err error) {
