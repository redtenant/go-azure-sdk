...
func DefaultGetRoleAssignmentOperationOptions() GetRoleAssignmentOperationOptions {
	return GetRoleAssignmentOperationOptions{}
}
...
// GetRoleAssignment - Get deviceAndAppManagementRoleAssignment. Read properties and relationships of the
// deviceAndAppManagementRoleAssignment object.
func (c RoleAssignmentClient) GetRoleAssignment(ctx context.Context, id stable.DeviceManagementRoleAssignmentId, options GetRoleAssignmentOperationOptions) (result GetRoleAssignmentOperationResponse, err error) {
