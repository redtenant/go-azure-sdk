...
// GetTermsAndCondition - Get termsAndConditions. Read properties and relationships of the termsAndConditions object.
func (c TermsAndConditionClient) GetTermsAndCondition(ctx context.Context, id stable.DeviceManagementTermsAndConditionId, options GetTermsAndConditionOperationOptions) (result GetTermsAndConditionOperationResponse, err error) {
