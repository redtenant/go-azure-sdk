...
func (c TermsAndConditionAcceptanceStatusClient) CreateTermsAndConditionAcceptanceStatus(ctx context.Context, id stable.DeviceManagementTermsAndConditionId, input stable.TermsAndConditionsAcceptanceStatus, options CreateTermsAndConditionAcceptanceStatusOperationOptions) (result CreateTermsAndConditionAcceptanceStatusOperationResponse, err error) {
