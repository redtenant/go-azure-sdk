...
// GetTermsAndConditionAssignment - Get termsAndConditionsAssignment. Read properties and relationships of the
// termsAndConditionsAssignment object.
func (c TermsAndConditionAssignmentClient) GetTermsAndConditionAssignment(ctx context.Context, id stable.DeviceManagementTermsAndConditionIdAssignmentId, options GetTermsAndConditionAssignmentOperationOptions) (result GetTermsAndConditionAssignmentOperationResponse, err error) {
