...
// UpdateTermsAndConditionAssignment - Update termsAndConditionsAssignment. Update the properties of a
// termsAndConditionsAssignment object.
func (c TermsAndConditionAssignmentClient) UpdateTermsAndConditionAssignment(ctx context.Context, id stable.DeviceManagementTermsAndConditionIdAssignmentId, input stable.TermsAndConditionsAssignment, options UpdateTermsAndConditionAssignmentOperationOptions) (result UpdateTermsAndConditionAssignmentOperationResponse, err error) {
