...
func DefaultDeleteTroubleshootingEventOperationOptions() DeleteTroubleshootingEventOperationOptions {
	return DeleteTroubleshootingEventOperationOptions{}
}
...
func (c TroubleshootingEventClient) DeleteTroubleshootingEvent(ctx context.Context, id stable.DeviceManagementTroubleshootingEventId, options DeleteTroubleshootingEventOperationOptions) (result DeleteTroubleshootingEventOperationResponse, err error) {
