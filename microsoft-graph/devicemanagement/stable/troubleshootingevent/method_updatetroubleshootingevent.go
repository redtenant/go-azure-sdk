...
func (c TroubleshootingEventClient) UpdateTroubleshootingEvent(ctx context.Context, id stable.DeviceManagementTroubleshootingEventId, input stable.DeviceManagementTroubleshootingEvent, options UpdateTroubleshootingEventOperationOptions) (result UpdateTroubleshootingEventOperationResponse, err error) {
