...
func (p UserExperienceAnalyticsAppHealthApplicationPerformanceOperationPredicate) Matches(input stable.UserExperienceAnalyticsAppHealthApplicationPerformance) bool {
