...
func (p UserExperienceAnalyticsAppHealthAppPerformanceByAppVersionDetailsOperationPredicate) Matches(input stable.UserExperienceAnalyticsAppHealthAppPerformanceByAppVersionDetails) bool {
