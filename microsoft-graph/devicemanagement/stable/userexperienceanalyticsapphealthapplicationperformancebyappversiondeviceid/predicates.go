...
func (p UserExperienceAnalyticsAppHealthAppPerformanceByAppVersionDeviceIdOperationPredicate) Matches(input stable.UserExperienceAnalyticsAppHealthAppPerformanceByAppVersionDeviceId) bool {
