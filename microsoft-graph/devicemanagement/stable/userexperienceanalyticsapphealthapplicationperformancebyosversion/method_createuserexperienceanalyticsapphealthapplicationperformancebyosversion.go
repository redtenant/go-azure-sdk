...
func (c UserExperienceAnalyticsAppHealthApplicationPerformanceByOSVersionClient) CreateUserExperienceAnalyticsAppHealthApplicationPerformanceByOSVersion(ctx context.Context, input stable.UserExperienceAnalyticsAppHealthAppPerformanceByOSVersion, options CreateUserExperienceAnalyticsAppHealthApplicationPerformanceByOSVersionOperationOptions) (result CreateUserExperienceAnalyticsAppHealthApplicationPerformanceByOSVersionOperationResponse, err error) {
