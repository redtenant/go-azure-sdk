...
func (p UserExperienceAnalyticsAppHealthDeviceModelPerformanceOperationPredicate) Matches(input stable.UserExperienceAnalyticsAppHealthDeviceModelPerformance) bool {
