...
func (p UserExperienceAnalyticsAppHealthDevicePerformanceOperationPredicate) Matches(input stable.UserExperienceAnalyticsAppHealthDevicePerformance) bool {
