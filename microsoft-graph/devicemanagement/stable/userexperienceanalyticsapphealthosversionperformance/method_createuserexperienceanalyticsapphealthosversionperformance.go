...
func (c UserExperienceAnalyticsAppHealthOSVersionPerformanceClient) CreateUserExperienceAnalyticsAppHealthOSVersionPerformance(ctx context.Context, input stable.UserExperienceAnalyticsAppHealthOSVersionPerformance, options CreateUserExperienceAnalyticsAppHealthOSVersionPerformanceOperationOptions) (result CreateUserExperienceAnalyticsAppHealthOSVersionPerformanceOperationResponse, err error) {
