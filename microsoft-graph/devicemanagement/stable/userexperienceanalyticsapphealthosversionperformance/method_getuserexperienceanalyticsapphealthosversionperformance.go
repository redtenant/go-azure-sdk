...
func (c UserExperienceAnalyticsAppHealthOSVersionPerformanceClient) GetUserExperienceAnalyticsAppHealthOSVersionPerformance(ctx context.Context, id stable.DeviceManagementUserExperienceAnalyticsAppHealthOSVersionPerformanceId, options GetUserExperienceAnalyticsAppHealthOSVersionPerformanceOperationOptions) (result GetUserExperienceAnalyticsAppHealthOSVersionPerformanceOperationResponse, err error) {
	...
	var model stable.UserExperienceAnalyticsAppHealthOSVersionPerformance
	result.Model = &model
