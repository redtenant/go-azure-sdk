...
func (p UserExperienceAnalyticsAppHealthOSVersionPerformanceOperationPredicate) Matches(input stable.UserExperienceAnalyticsAppHealthOSVersionPerformance) bool {
