...
// deviceManagement
func (c UserExperienceAnalyticsBaselineClient) CreateUserExperienceAnalyticsBaseline(ctx context.Context, input stable.UserExperienceAnalyticsBaseline, options CreateUserExperienceAnalyticsBaselineOperationOptions) (result CreateUserExperienceAnalyticsBaselineOperationResponse, err error) {
