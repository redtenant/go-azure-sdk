...
// deviceManagement
func (c UserExperienceAnalyticsCategoryClient) CreateUserExperienceAnalyticsCategory(ctx context.Context, input stable.UserExperienceAnalyticsCategory, options CreateUserExperienceAnalyticsCategoryOperationOptions) (result CreateUserExperienceAnalyticsCategoryOperationResponse, err error) {
