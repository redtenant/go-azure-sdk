...
func (c UserExperienceAnalyticsCategoryClient) GetUserExperienceAnalyticsCategory(ctx context.Context, id stable.DeviceManagementUserExperienceAnalyticsCategoryId, options GetUserExperienceAnalyticsCategoryOperationOptions) (result GetUserExperienceAnalyticsCategoryOperationResponse, err error) {
