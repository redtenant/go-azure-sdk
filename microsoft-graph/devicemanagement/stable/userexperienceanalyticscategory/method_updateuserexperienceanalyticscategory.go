...
type UpdateUserExperienceAnalyticsCategoryOperationResponse struct {
...
// deviceManagement
func (c UserExperienceAnalyticsCategoryClient) UpdateUserExperienceAnalyticsCategory(ctx context.Context, id stable.DeviceManagementUserExperienceAnalyticsCategoryId, input stable.UserExperienceAnalyticsCategory, options UpdateUserExperienceAnalyticsCategoryOperationOptions) (result UpdateUserExperienceAnalyticsCategoryOperationResponse, err error) {
