...
func (c UserExperienceAnalyticsDeviceStartupProcessClient) DeleteUserExperienceAnalyticsDeviceStartupProcess(ctx context.Context, id stable.DeviceManagementUserExperienceAnalyticsDeviceStartupProcessId, options DeleteUserExperienceAnalyticsDeviceStartupProcessOperationOptions) (result DeleteUserExperienceAnalyticsDeviceStartupProcessOperationResponse, err error) {
