...
func (p UserExperienceAnalyticsDeviceStartupProcessPerformanceOperationPredicate) Matches(input stable.UserExperienceAnalyticsDeviceStartupProcessPerformance) bool {
