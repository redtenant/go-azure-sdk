...
type CreateUserExperienceAnalyticsWorkFromAnywhereMetricOperationResponse struct {
...
func (c UserExperienceAnalyticsWorkFromAnywhereMetricClient) CreateUserExperienceAnalyticsWorkFromAnywhereMetric(ctx context.Context, input stable.UserExperienceAnalyticsWorkFromAnywhereMetric, options CreateUserExperienceAnalyticsWorkFromAnywhereMetricOperationOptions) (result CreateUserExperienceAnalyticsWorkFromAnywhereMetricOperationResponse, err error) {
