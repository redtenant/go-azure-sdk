...
func (c VirtualEndpointClient) UpdateVirtualEndpoint(ctx context.Context, input stable.VirtualEndpoint, options UpdateVirtualEndpointOperationOptions) (result UpdateVirtualEndpointOperationResponse, err error) {
