...
type UpdateVirtualEndpointAuditEventOperationResponse struct {
...
func (c VirtualEndpointAuditEventClient) UpdateVirtualEndpointAuditEvent(ctx context.Context, id stable.DeviceManagementVirtualEndpointAuditEventId, input stable.CloudPCAuditEvent, options UpdateVirtualEndpointAuditEventOperationOptions) (result UpdateVirtualEndpointAuditEventOperationResponse, err error) {
