...
// TroubleshootVirtualEndpointCloudPC - Invoke action troubleshoot. Troubleshoot a specific cloudPC object. Use this API
// to check the health status of the Cloud PC and the session host.
