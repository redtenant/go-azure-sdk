...
func (c VirtualEndpointDeviceImageClient) GetVirtualEndpointDeviceImage(ctx context.Context, id stable.DeviceManagementVirtualEndpointDeviceImageId, options GetVirtualEndpointDeviceImageOperationOptions) (result GetVirtualEndpointDeviceImageOperationResponse, err error) {
