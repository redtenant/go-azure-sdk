...
func (c VirtualEndpointGalleryImageClient) CreateVirtualEndpointGalleryImage(ctx context.Context, input stable.CloudPCGalleryImage, options CreateVirtualEndpointGalleryImageOperationOptions) (result CreateVirtualEndpointGalleryImageOperationResponse, err error) {
