...
// removed from the specified Azure resources. You cannot delete an Azure network connection when it's in use, as
// indicated by the inUse property.
func (c VirtualEndpointOnPremisesConnectionClient) DeleteVirtualEndpointOnPremisesConnection(ctx context.Context, id stable.DeviceManagementVirtualEndpointOnPremisesConnectionId, options DeleteVirtualEndpointOnPremisesConnectionOperationOptions) (result DeleteVirtualEndpointOnPremisesConnectionOperationResponse, err error) {
