...
func DefaultDeleteVirtualEndpointProvisioningPolicyOperationOptions() DeleteVirtualEndpointProvisioningPolicyOperationOptions {
	return DeleteVirtualEndpointProvisioningPolicyOperationOptions{}
}
...
// DeleteVirtualEndpointProvisioningPolicy - Delete cloudPcProvisioningPolicy. Delete a cloudPcProvisioningPolicy
// object. You can’t delete a policy that’s in use.
func (c VirtualEndpointProvisioningPolicyClient) DeleteVirtualEndpointProvisioningPolicy(ctx context.Context, id stable.DeviceManagementVirtualEndpointProvisioningPolicyId, options DeleteVirtualEndpointProvisioningPolicyOperationOptions) (result DeleteVirtualEndpointProvisioningPolicyOperationResponse, err error) {
