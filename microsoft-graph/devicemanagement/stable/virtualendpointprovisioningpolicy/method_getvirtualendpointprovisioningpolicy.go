...
func DefaultGetVirtualEndpointProvisioningPolicyOperationOptions() GetVirtualEndpointProvisioningPolicyOperationOptions {
	return GetVirtualEndpointProvisioningPolicyOperationOptions{}
}
...
// GetVirtualEndpointProvisioningPolicy - Get cloudPcProvisioningPolicy. Read the properties and relationships of a
// cloudPcProvisioningPolicy object.
func (c VirtualEndpointProvisioningPolicyClient) GetVirtualEndpointProvisioningPolicy(ctx context.Context, id stable.DeviceManagementVirtualEndpointProvisioningPolicyId, options GetVirtualEndpointProvisioningPolicyOperationOptions) (result GetVirtualEndpointProvisioningPolicyOperationResponse, err error) {
