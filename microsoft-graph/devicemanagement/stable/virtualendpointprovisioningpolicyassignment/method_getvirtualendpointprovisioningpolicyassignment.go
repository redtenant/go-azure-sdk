...
func (c VirtualEndpointProvisioningPolicyAssignmentClient) GetVirtualEndpointProvisioningPolicyAssignment(ctx context.Context, id stable.DeviceManagementVirtualEndpointProvisioningPolicyIdAssignmentId, options GetVirtualEndpointProvisioningPolicyAssignmentOperationOptions) (result GetVirtualEndpointProvisioningPolicyAssignmentOperationResponse, err error) {
