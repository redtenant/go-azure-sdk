...
type ListVirtualEndpointProvisioningPolicyAssignmentsCompleteResult struct {
	...
	Items              []stable.CloudPCProvisioningPolicyAssignment
}
...
func (c VirtualEndpointProvisioningPolicyAssignmentClient) ListVirtualEndpointProvisioningPolicyAssignments(ctx context.Context, id stable.DeviceManagementVirtualEndpointProvisioningPolicyId, options ListVirtualEndpointProvisioningPolicyAssignmentsOperationOptions) (result ListVirtualEndpointProvisioningPolicyAssignmentsOperationResponse, err error) {
	...
	var values struct {
		Values *[]stable.CloudPCProvisioningPolicyAssignment `json:"value"`
	}
...
func (c VirtualEndpointProvisioningPolicyAssignmentClient) ListVirtualEndpointProvisioningPolicyAssignmentsComplete(ctx context.Context, id stable.DeviceManagementVirtualEndpointProvisioningPolicyId, options ListVirtualEndpointProvisioningPolicyAssignmentsOperationOptions) (ListVirtualEndpointProvisioningPolicyAssignmentsCompleteResult, error) {
...
func (c VirtualEndpointProvisioningPolicyAssignmentClient) ListVirtualEndpointProvisioningPolicyAssignmentsCompleteMatchingPredicate(ctx context.Context, id stable.DeviceManagementVirtualEndpointProvisioningPolicyId, options ListVirtualEndpointProvisioningPolicyAssignmentsOperationOptions, predicate CloudPCProvisioningPolicyAssignmentOperationPredicate) (result ListVirtualEndpointProvisioningPolicyAssignmentsCompleteResult, err error) {
	items := make([]stable.CloudPCProvisioningPolicyAssignment, 0)
