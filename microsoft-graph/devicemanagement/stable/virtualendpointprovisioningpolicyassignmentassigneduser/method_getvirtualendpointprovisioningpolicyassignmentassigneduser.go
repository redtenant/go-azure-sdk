...
func (c VirtualEndpointProvisioningPolicyAssignmentAssignedUserClient) GetVirtualEndpointProvisioningPolicyAssignmentAssignedUser(ctx context.Context, id stable.DeviceManagementVirtualEndpointProvisioningPolicyIdAssignmentIdAssignedUserId, options GetVirtualEndpointProvisioningPolicyAssignmentAssignedUserOperationOptions) (result GetVirtualEndpointProvisioningPolicyAssignmentAssignedUserOperationResponse, err error) {
