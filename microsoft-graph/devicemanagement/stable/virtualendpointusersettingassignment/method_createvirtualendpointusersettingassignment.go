...
func (c VirtualEndpointUserSettingAssignmentClient) CreateVirtualEndpointUserSettingAssignment(ctx context.Context, id stable.DeviceManagementVirtualEndpointUserSettingId, input stable.CloudPCUserSettingAssignment, options CreateVirtualEndpointUserSettingAssignmentOperationOptions) (result CreateVirtualEndpointUserSettingAssignmentOperationResponse, err error) {
