...
func (c VirtualEndpointUserSettingAssignmentClient) DeleteVirtualEndpointUserSettingAssignment(ctx context.Context, id stable.DeviceManagementVirtualEndpointUserSettingIdAssignmentId, options DeleteVirtualEndpointUserSettingAssignmentOperationOptions) (result DeleteVirtualEndpointUserSettingAssignmentOperationResponse, err error) {
