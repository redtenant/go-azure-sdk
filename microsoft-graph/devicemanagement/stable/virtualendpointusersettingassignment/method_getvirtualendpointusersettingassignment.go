...
// an example, see Get cloudPcUserSetting.
func (c VirtualEndpointUserSettingAssignmentClient) GetVirtualEndpointUserSettingAssignment(ctx context.Context, id stable.DeviceManagementVirtualEndpointUserSettingIdAssignmentId, options GetVirtualEndpointUserSettingAssignmentOperationOptions) (result GetVirtualEndpointUserSettingAssignmentOperationResponse, err error) {
	...
	var model stable.CloudPCUserSettingAssignment
	result.Model = &model
