...
func (c VirtualEndpointUserSettingAssignmentClient) UpdateVirtualEndpointUserSettingAssignment(ctx context.Context, id stable.DeviceManagementVirtualEndpointUserSettingIdAssignmentId, input stable.CloudPCUserSettingAssignment, options UpdateVirtualEndpointUserSettingAssignmentOperationOptions) (result UpdateVirtualEndpointUserSettingAssignmentOperationResponse, err error) {
