...
// GetWindowsInformationProtectionAppLearningSummary - Get windowsInformationProtectionAppLearningSummary. Read
// properties and relationships of the windowsInformationProtectionAppLearningSummary object.
func (c WindowsInformationProtectionAppLearningSummaryClient) GetWindowsInformationProtectionAppLearningSummary(ctx context.Context, id stable.DeviceManagementWindowsInformationProtectionAppLearningSummaryId, options GetWindowsInformationProtectionAppLearningSummaryOperationOptions) (result GetWindowsInformationProtectionAppLearningSummaryOperationResponse, err error) {
