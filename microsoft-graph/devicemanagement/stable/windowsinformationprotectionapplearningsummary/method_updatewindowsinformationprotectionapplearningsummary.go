...
// UpdateWindowsInformationProtectionAppLearningSummary - Update windowsInformationProtectionAppLearningSummary. Update
// the properties of a windowsInformationProtectionAppLearningSummary object.
func (c WindowsInformationProtectionAppLearningSummaryClient) UpdateWindowsInformationProtectionAppLearningSummary(ctx context.Context, id stable.DeviceManagementWindowsInformationProtectionAppLearningSummaryId, input stable.WindowsInformationProtectionAppLearningSummary, options UpdateWindowsInformationProtectionAppLearningSummaryOperationOptions) (result UpdateWindowsInformationProtectionAppLearningSummaryOperationResponse, err error) {
