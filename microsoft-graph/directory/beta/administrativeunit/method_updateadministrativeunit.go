...
// UpdateAdministrativeUnit - Update the navigation property administrativeUnits in directory
func (c AdministrativeUnitClient) UpdateAdministrativeUnit(ctx context.Context, id beta.DirectoryAdministrativeUnitId, input beta.AdministrativeUnit, options UpdateAdministrativeUnitOperationOptions) (result UpdateAdministrativeUnitOperationResponse, err error) {
