...
func (c AdministrativeUnitExtensionClient) GetAdministrativeUnitExtension(ctx context.Context, id beta.DirectoryAdministrativeUnitIdExtensionId, options GetAdministrativeUnitExtensionOperationOptions) (result GetAdministrativeUnitExtensionOperationResponse, err error) {
