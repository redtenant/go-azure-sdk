...
func (c AdministrativeUnitMemberClient) GetAdministrativeUnitMembersCount(ctx context.Context, id beta.DirectoryAdministrativeUnitId, options GetAdministrativeUnitMembersCountOperationOptions) (result GetAdministrativeUnitMembersCountOperationResponse, err error) {
