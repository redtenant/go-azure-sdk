...
// ListAdministrativeUnitMemberRefs - Get ref of members from directory. Users and groups that are members of this
// administrative unit. Supports $expand.
func (c AdministrativeUnitMemberClient) ListAdministrativeUnitMemberRefs(ctx context.Context, id beta.DirectoryAdministrativeUnitId, options ListAdministrativeUnitMemberRefsOperationOptions) (result ListAdministrativeUnitMemberRefsOperationResponse, err error) {
...
func (c AdministrativeUnitMemberClient) ListAdministrativeUnitMemberRefsComplete(ctx context.Context, id beta.DirectoryAdministrativeUnitId, options ListAdministrativeUnitMemberRefsOperationOptions) (ListAdministrativeUnitMemberRefsCompleteResult, error) {
...
func (c AdministrativeUnitMemberClient) ListAdministrativeUnitMemberRefsCompleteMatchingPredicate(ctx context.Context, id beta.DirectoryAdministrativeUnitId, options ListAdministrativeUnitMemberRefsOperationOptions, predicate DirectoryObjectOperationPredicate) (result ListAdministrativeUnitMemberRefsCompleteResult, err error) {
