...
// DeleteAdministrativeUnitScopedRoleMember - Delete navigation property scopedRoleMembers for directory
func (c AdministrativeUnitScopedRoleMemberClient) DeleteAdministrativeUnitScopedRoleMember(ctx context.Context, id beta.DirectoryAdministrativeUnitIdScopedRoleMemberId, options DeleteAdministrativeUnitScopedRoleMemberOperationOptions) (result DeleteAdministrativeUnitScopedRoleMemberOperationResponse, err error) {
