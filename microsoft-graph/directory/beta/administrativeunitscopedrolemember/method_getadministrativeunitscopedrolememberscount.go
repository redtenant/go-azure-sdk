...
func (c AdministrativeUnitScopedRoleMemberClient) GetAdministrativeUnitScopedRoleMembersCount(ctx context.Context, id beta.DirectoryAdministrativeUnitId, options GetAdministrativeUnitScopedRoleMembersCountOperationOptions) (result GetAdministrativeUnitScopedRoleMembersCountOperationResponse, err error) {
