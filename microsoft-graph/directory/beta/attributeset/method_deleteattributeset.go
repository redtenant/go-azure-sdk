...
func DefaultDeleteAttributeSetOperationOptions() DeleteAttributeSetOperationOptions {
	return DeleteAttributeSetOperationOptions{}
}
...
func (c AttributeSetClient) DeleteAttributeSet(ctx context.Context, id beta.DirectoryAttributeSetId, options DeleteAttributeSetOperationOptions) (result DeleteAttributeSetOperationResponse, err error) {
