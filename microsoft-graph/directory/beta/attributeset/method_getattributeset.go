...
func DefaultGetAttributeSetOperationOptions() GetAttributeSetOperationOptions {
	return GetAttributeSetOperationOptions{}
}
...
func (c AttributeSetClient) GetAttributeSet(ctx context.Context, id beta.DirectoryAttributeSetId, options GetAttributeSetOperationOptions) (result GetAttributeSetOperationResponse, err error) {
