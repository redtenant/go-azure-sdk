...
func (c CustomSecurityAttributeDefinitionClient) DeleteCustomSecurityAttributeDefinition(ctx context.Context, id beta.DirectoryCustomSecurityAttributeDefinitionId, options DeleteCustomSecurityAttributeDefinitionOperationOptions) (result DeleteCustomSecurityAttributeDefinitionOperationResponse, err error) {
