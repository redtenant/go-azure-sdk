...
func (c DirectoryClient) UpdateDirectory(ctx context.Context, input beta.Directory, options UpdateDirectoryOperationOptions) (result UpdateDirectoryOperationResponse, err error) {
