...
func DefaultDeleteFeatureRolloutPolicyOperationOptions() DeleteFeatureRolloutPolicyOperationOptions {
	return DeleteFeatureRolloutPolicyOperationOptions{}
}
...
// DeleteFeatureRolloutPolicy - Delete navigation property featureRolloutPolicies for directory
func (c FeatureRolloutPolicyClient) DeleteFeatureRolloutPolicy(ctx context.Context, id beta.DirectoryFeatureRolloutPolicyId, options DeleteFeatureRolloutPolicyOperationOptions) (result DeleteFeatureRolloutPolicyOperationResponse, err error) {
