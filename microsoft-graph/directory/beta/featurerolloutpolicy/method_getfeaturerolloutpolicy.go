...
// GetFeatureRolloutPolicy - Get featureRolloutPolicies from directory
func (c FeatureRolloutPolicyClient) GetFeatureRolloutPolicy(ctx context.Context, id beta.DirectoryFeatureRolloutPolicyId, options GetFeatureRolloutPolicyOperationOptions) (result GetFeatureRolloutPolicyOperationResponse, err error) {
