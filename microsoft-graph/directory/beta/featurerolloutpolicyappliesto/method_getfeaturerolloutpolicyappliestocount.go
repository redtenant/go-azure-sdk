...
func DefaultGetFeatureRolloutPolicyAppliesToCountOperationOptions() GetFeatureRolloutPolicyAppliesToCountOperationOptions {
	return GetFeatureRolloutPolicyAppliesToCountOperationOptions{}
}
...
func (c FeatureRolloutPolicyAppliesToClient) GetFeatureRolloutPolicyAppliesToCount(ctx context.Context, id beta.DirectoryFeatureRolloutPolicyId, options GetFeatureRolloutPolicyAppliesToCountOperationOptions) (result GetFeatureRolloutPolicyAppliesToCountOperationResponse, err error) {
