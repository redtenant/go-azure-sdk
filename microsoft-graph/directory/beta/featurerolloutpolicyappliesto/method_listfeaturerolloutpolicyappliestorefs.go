...
// ListFeatureRolloutPolicyAppliesToRefs - Get ref of appliesTo from directory. Nullable. Specifies a list of
// directoryObject resources that feature is enabled for.
func (c FeatureRolloutPolicyAppliesToClient) ListFeatureRolloutPolicyAppliesToRefs(ctx context.Context, id beta.DirectoryFeatureRolloutPolicyId, options ListFeatureRolloutPolicyAppliesToRefsOperationOptions) (result ListFeatureRolloutPolicyAppliesToRefsOperationResponse, err error) {
...
func (c FeatureRolloutPolicyAppliesToClient) ListFeatureRolloutPolicyAppliesToRefsComplete(ctx context.Context, id beta.DirectoryFeatureRolloutPolicyId, options ListFeatureRolloutPolicyAppliesToRefsOperationOptions) (ListFeatureRolloutPolicyAppliesToRefsCompleteResult, error) {
...
func (c FeatureRolloutPolicyAppliesToClient) ListFeatureRolloutPolicyAppliesToRefsCompleteMatchingPredicate(ctx context.Context, id beta.DirectoryFeatureRolloutPolicyId, options ListFeatureRolloutPolicyAppliesToRefsOperationOptions, predicate DirectoryObjectOperationPredicate) (result ListFeatureRolloutPolicyAppliesToRefsCompleteResult, err error) {
