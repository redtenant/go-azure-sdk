...
func (c FederationConfigurationClient) CreateFederationConfiguration(ctx context.Context, input beta.IdentityProviderBase, options CreateFederationConfigurationOperationOptions) (result CreateFederationConfigurationOperationResponse, err error) {
