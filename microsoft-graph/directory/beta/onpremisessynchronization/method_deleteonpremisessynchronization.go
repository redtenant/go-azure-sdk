...
func (c OnPremisesSynchronizationClient) DeleteOnPremisesSynchronization(ctx context.Context, id beta.DirectoryOnPremisesSynchronizationId, options DeleteOnPremisesSynchronizationOperationOptions) (result DeleteOnPremisesSynchronizationOperationResponse, err error) {
