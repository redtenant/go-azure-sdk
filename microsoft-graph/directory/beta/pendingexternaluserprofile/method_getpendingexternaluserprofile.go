...
func DefaultGetPendingExternalUserProfileOperationOptions() GetPendingExternalUserProfileOperationOptions {
	return GetPendingExternalUserProfileOperationOptions{}
}
...
// GetPendingExternalUserProfile - Get pendingExternalUserProfile. Retrieve the properties of a specific
