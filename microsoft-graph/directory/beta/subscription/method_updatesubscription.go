...
type UpdateSubscriptionOperationResponse struct {
...
func (c SubscriptionClient) UpdateSubscription(ctx context.Context, id beta.DirectorySubscriptionId, input beta.CompanySubscription, options UpdateSubscriptionOperationOptions) (result UpdateSubscriptionOperationResponse, err error) {
