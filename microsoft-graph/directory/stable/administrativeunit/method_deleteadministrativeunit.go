...
func (c AdministrativeUnitClient) DeleteAdministrativeUnit(ctx context.Context, id stable.DirectoryAdministrativeUnitId, options DeleteAdministrativeUnitOperationOptions) (result DeleteAdministrativeUnitOperationResponse, err error) {
