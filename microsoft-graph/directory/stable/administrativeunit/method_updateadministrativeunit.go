...
func (c AdministrativeUnitClient) UpdateAdministrativeUnit(ctx context.Context, id stable.DirectoryAdministrativeUnitId, input stable.AdministrativeUnit, options UpdateAdministrativeUnitOperationOptions) (result UpdateAdministrativeUnitOperationResponse, err error) {
