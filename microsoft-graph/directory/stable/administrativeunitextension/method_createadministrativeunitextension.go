...
type CreateAdministrativeUnitExtensionOperationResponse struct {
...
func (c AdministrativeUnitExtensionClient) CreateAdministrativeUnitExtension(ctx context.Context, id stable.DirectoryAdministrativeUnitId, input stable.Extension, options CreateAdministrativeUnitExtensionOperationOptions) (result CreateAdministrativeUnitExtensionOperationResponse, err error) {
