...
func (c AdministrativeUnitExtensionClient) ListAdministrativeUnitExtensions(ctx context.Context, id stable.DirectoryAdministrativeUnitId, options ListAdministrativeUnitExtensionsOperationOptions) (result ListAdministrativeUnitExtensionsOperationResponse, err error) {
...
func (c AdministrativeUnitExtensionClient) ListAdministrativeUnitExtensionsComplete(ctx context.Context, id stable.DirectoryAdministrativeUnitId, options ListAdministrativeUnitExtensionsOperationOptions) (ListAdministrativeUnitExtensionsCompleteResult, error) {
...
func (c AdministrativeUnitExtensionClient) ListAdministrativeUnitExtensionsCompleteMatchingPredicate(ctx context.Context, id stable.DirectoryAdministrativeUnitId, options ListAdministrativeUnitExtensionsOperationOptions, predicate ExtensionOperationPredicate) (result ListAdministrativeUnitExtensionsCompleteResult, err error) {
