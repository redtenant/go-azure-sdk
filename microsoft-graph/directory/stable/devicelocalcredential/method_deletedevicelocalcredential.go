...
func (c DeviceLocalCredentialClient) DeleteDeviceLocalCredential(ctx context.Context, id stable.DirectoryDeviceLocalCredentialId, options DeleteDeviceLocalCredentialOperationOptions) (result DeleteDeviceLocalCredentialOperationResponse, err error) {
