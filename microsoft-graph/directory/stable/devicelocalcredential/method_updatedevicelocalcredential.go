...
func (c DeviceLocalCredentialClient) UpdateDeviceLocalCredential(ctx context.Context, id stable.DirectoryDeviceLocalCredentialId, input stable.DeviceLocalCredentialInfo, options UpdateDeviceLocalCredentialOperationOptions) (result UpdateDeviceLocalCredentialOperationResponse, err error) {
