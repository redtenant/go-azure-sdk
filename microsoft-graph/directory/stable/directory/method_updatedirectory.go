...
func (c DirectoryClient) UpdateDirectory(ctx context.Context, input stable.Directory, options UpdateDirectoryOperationOptions) (result UpdateDirectoryOperationResponse, err error) {
