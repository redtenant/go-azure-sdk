...
func (c DirectoryObjectClient) CheckMemberObjects(ctx context.Context, id beta.DirectoryObjectId, input CheckMemberObjectsRequest, options CheckMemberObjectsOperationOptions) (result CheckMemberObjectsOperationResponse, err error) {
...
func (c DirectoryObjectClient) CheckMemberObjectsComplete(ctx context.Context, id beta.DirectoryObjectId, input CheckMemberObjectsRequest, options CheckMemberObjectsOperationOptions) (result CheckMemberObjectsCompleteResult, err error) {
	items := make([]string, 0)
