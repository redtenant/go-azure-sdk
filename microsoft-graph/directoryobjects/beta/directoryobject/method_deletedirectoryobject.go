...
func (c DirectoryObjectClient) DeleteDirectoryObject(ctx context.Context, id beta.DirectoryObjectId, options DeleteDirectoryObjectOperationOptions) (result DeleteDirectoryObjectOperationResponse, err error) {
