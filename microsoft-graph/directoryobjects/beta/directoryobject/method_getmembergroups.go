...
func (c DirectoryObjectClient) GetMemberGroups(ctx context.Context, id beta.DirectoryObjectId, input GetMemberGroupsRequest, options GetMemberGroupsOperationOptions) (result GetMemberGroupsOperationResponse, err error) {
...
func (c DirectoryObjectClient) GetMemberGroupsComplete(ctx context.Context, id beta.DirectoryObjectId, input GetMemberGroupsRequest, options GetMemberGroupsOperationOptions) (result GetMemberGroupsCompleteResult, err error) {
	items := make([]string, 0)
