...
func (c DirectoryObjectClient) GetMemberObjects(ctx context.Context, id beta.DirectoryObjectId, input GetMemberObjectsRequest, options GetMemberObjectsOperationOptions) (result GetMemberObjectsOperationResponse, err error) {
...
func (c DirectoryObjectClient) GetMemberObjectsComplete(ctx context.Context, id beta.DirectoryObjectId, input GetMemberObjectsRequest, options GetMemberObjectsOperationOptions) (result GetMemberObjectsCompleteResult, err error) {
	items := make([]string, 0)
