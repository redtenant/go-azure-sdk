...
func (c DirectoryObjectClient) UpdateDirectoryObject(ctx context.Context, id beta.DirectoryObjectId, input beta.DirectoryObject, options UpdateDirectoryObjectOperationOptions) (result UpdateDirectoryObjectOperationResponse, err error) {
