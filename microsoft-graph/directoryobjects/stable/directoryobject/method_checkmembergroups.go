...
func (c DirectoryObjectClient) CheckMemberGroups(ctx context.Context, id stable.DirectoryObjectId, input CheckMemberGroupsRequest, options CheckMemberGroupsOperationOptions) (result CheckMemberGroupsOperationResponse, err error) {
...
func (c DirectoryObjectClient) CheckMemberGroupsComplete(ctx context.Context, id stable.DirectoryObjectId, input CheckMemberGroupsRequest, options CheckMemberGroupsOperationOptions) (result CheckMemberGroupsCompleteResult, err error) {
	items := make([]string, 0)
