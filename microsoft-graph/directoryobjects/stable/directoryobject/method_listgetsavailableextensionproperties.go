...
func (c DirectoryObjectClient) ListGetsAvailableExtensionProperties(ctx context.Context, input ListGetsAvailableExtensionPropertiesRequest, options ListGetsAvailableExtensionPropertiesOperationOptions) (result ListGetsAvailableExtensionPropertiesOperationResponse, err error) {
...
func (c DirectoryObjectClient) ListGetsAvailableExtensionPropertiesComplete(ctx context.Context, input ListGetsAvailableExtensionPropertiesRequest, options ListGetsAvailableExtensionPropertiesOperationOptions) (ListGetsAvailableExtensionPropertiesCompleteResult, error) {
