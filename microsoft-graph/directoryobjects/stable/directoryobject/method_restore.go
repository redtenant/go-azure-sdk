...
func (c DirectoryObjectClient) Restore(ctx context.Context, id stable.DirectoryObjectId, options RestoreOperationOptions) (result RestoreOperationResponse, err error) {
