...
func (c DirectoryRoleClient) CheckMemberGroups(ctx context.Context, id beta.DirectoryRoleId, input CheckMemberGroupsRequest, options CheckMemberGroupsOperationOptions) (result CheckMemberGroupsOperationResponse, err error) {
...
func (c DirectoryRoleClient) CheckMemberGroupsComplete(ctx context.Context, id beta.DirectoryRoleId, input CheckMemberGroupsRequest, options CheckMemberGroupsOperationOptions) (result CheckMemberGroupsCompleteResult, err error) {
	items := make([]string, 0)
