...
func (c DirectoryRoleClient) CheckMemberObjects(ctx context.Context, id beta.DirectoryRoleId, input CheckMemberObjectsRequest, options CheckMemberObjectsOperationOptions) (result CheckMemberObjectsOperationResponse, err error) {
...
func (c DirectoryRoleClient) CheckMemberObjectsComplete(ctx context.Context, id beta.DirectoryRoleId, input CheckMemberObjectsRequest, options CheckMemberObjectsOperationOptions) (result CheckMemberObjectsCompleteResult, err error) {
	items := make([]string, 0)
