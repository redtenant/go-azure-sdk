...
func (c DirectoryRoleClient) DeleteDirectoryRole(ctx context.Context, id beta.DirectoryRoleId, options DeleteDirectoryRoleOperationOptions) (result DeleteDirectoryRoleOperationResponse, err error) {
