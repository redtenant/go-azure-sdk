...
func (c DirectoryRoleClient) GetMemberGroups(ctx context.Context, id beta.DirectoryRoleId, input GetMemberGroupsRequest, options GetMemberGroupsOperationOptions) (result GetMemberGroupsOperationResponse, err error) {
...
func (c DirectoryRoleClient) GetMemberGroupsComplete(ctx context.Context, id beta.DirectoryRoleId, input GetMemberGroupsRequest, options GetMemberGroupsOperationOptions) (result GetMemberGroupsCompleteResult, err error) {
	items := make([]string, 0)
