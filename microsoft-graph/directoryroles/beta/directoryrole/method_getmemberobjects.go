...
func (c DirectoryRoleClient) GetMemberObjects(ctx context.Context, id beta.DirectoryRoleId, input GetMemberObjectsRequest, options GetMemberObjectsOperationOptions) (result GetMemberObjectsOperationResponse, err error) {
...
func (c DirectoryRoleClient) GetMemberObjectsComplete(ctx context.Context, id beta.DirectoryRoleId, input GetMemberObjectsRequest, options GetMemberObjectsOperationOptions) (result GetMemberObjectsCompleteResult, err error) {
	items := make([]string, 0)
