...
func (c DirectoryRoleClient) Restore(ctx context.Context, id beta.DirectoryRoleId, input RestoreRequest, options RestoreOperationOptions) (result RestoreOperationResponse, err error) {
