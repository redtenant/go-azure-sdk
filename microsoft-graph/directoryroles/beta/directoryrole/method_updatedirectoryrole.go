...
func (c DirectoryRoleClient) UpdateDirectoryRole(ctx context.Context, id beta.DirectoryRoleId, input beta.DirectoryRole, options UpdateDirectoryRoleOperationOptions) (result UpdateDirectoryRoleOperationResponse, err error) {
