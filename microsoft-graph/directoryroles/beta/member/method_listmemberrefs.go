...
// ListMemberRefs - List members. Retrieve a list of the users that are assigned to the directory role. Only users can
// be assigned to a directory role. You can use both the object ID and template ID of the directoryRole with this API.
// The template ID of a built-in role is immutable and can be seen in the role description on the Microsoft Entra admin
// center. For details, see Role template IDs.
