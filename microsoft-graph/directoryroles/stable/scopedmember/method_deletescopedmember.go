...
type DeleteScopedMemberOperationResponse struct {
	HttpResponse *http.Response
	OData        *odata.OData
}

type DeleteScopedMemberOperationOptions struct {
	IfMatch   *string
...
func DefaultDeleteScopedMemberOperationOptions() DeleteScopedMemberOperationOptions {
	return DeleteScopedMemberOperationOptions{}
}
...
func (c ScopedMemberClient) DeleteScopedMember(ctx context.Context, id stable.DirectoryRoleIdScopedMemberId, options DeleteScopedMemberOperationOptions) (result DeleteScopedMemberOperationResponse, err error) {
