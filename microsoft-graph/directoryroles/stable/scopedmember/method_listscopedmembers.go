...
// directory role.
func (c ScopedMemberClient) ListScopedMembers(ctx context.Context, id stable.DirectoryRoleId, options ListScopedMembersOperationOptions) (result ListScopedMembersOperationResponse, err error) {
...
func (c ScopedMemberClient) ListScopedMembersComplete(ctx context.Context, id stable.DirectoryRoleId, options ListScopedMembersOperationOptions) (ListScopedMembersCompleteResult, error) {
...
func (c ScopedMemberClient) ListScopedMembersCompleteMatchingPredicate(ctx context.Context, id stable.DirectoryRoleId, options ListScopedMembersOperationOptions, predicate ScopedRoleMembershipOperationPredicate) (result ListScopedMembersCompleteResult, err error) {
