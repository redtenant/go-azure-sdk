...
func (c DirectoryRoleTemplateClient) DeleteDirectoryRoleTemplate(ctx context.Context, id beta.DirectoryRoleTemplateId, options DeleteDirectoryRoleTemplateOperationOptions) (result DeleteDirectoryRoleTemplateOperationResponse, err error) {
