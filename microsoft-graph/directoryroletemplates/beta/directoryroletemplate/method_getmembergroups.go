...
func (c DirectoryRoleTemplateClient) GetMemberGroups(ctx context.Context, id beta.DirectoryRoleTemplateId, input GetMemberGroupsRequest, options GetMemberGroupsOperationOptions) (result GetMemberGroupsOperationResponse, err error) {
...
func (c DirectoryRoleTemplateClient) GetMemberGroupsComplete(ctx context.Context, id beta.DirectoryRoleTemplateId, input GetMemberGroupsRequest, options GetMemberGroupsOperationOptions) (result GetMemberGroupsCompleteResult, err error) {
	items := make([]string, 0)
