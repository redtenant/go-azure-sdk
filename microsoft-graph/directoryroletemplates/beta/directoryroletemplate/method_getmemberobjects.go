...
func (c DirectoryRoleTemplateClient) GetMemberObjects(ctx context.Context, id beta.DirectoryRoleTemplateId, input GetMemberObjectsRequest, options GetMemberObjectsOperationOptions) (result GetMemberObjectsOperationResponse, err error) {
...
func (c DirectoryRoleTemplateClient) GetMemberObjectsComplete(ctx context.Context, id beta.DirectoryRoleTemplateId, input GetMemberObjectsRequest, options GetMemberObjectsOperationOptions) (result GetMemberObjectsCompleteResult, err error) {
	items := make([]string, 0)
