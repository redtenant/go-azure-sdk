...
func (c DirectoryRoleTemplateClient) Restore(ctx context.Context, id beta.DirectoryRoleTemplateId, input RestoreRequest, options RestoreOperationOptions) (result RestoreOperationResponse, err error) {
