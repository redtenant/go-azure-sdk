...
func (c DirectoryRoleTemplateClient) CheckMemberGroups(ctx context.Context, id stable.DirectoryRoleTemplateId, input CheckMemberGroupsRequest, options CheckMemberGroupsOperationOptions) (result CheckMemberGroupsOperationResponse, err error) {
...
func (c DirectoryRoleTemplateClient) CheckMemberGroupsComplete(ctx context.Context, id stable.DirectoryRoleTemplateId, input CheckMemberGroupsRequest, options CheckMemberGroupsOperationOptions) (result CheckMemberGroupsCompleteResult, err error) {
	items := make([]string, 0)
