...
func (c DirectoryRoleTemplateClient) CheckMemberObjects(ctx context.Context, id stable.DirectoryRoleTemplateId, input CheckMemberObjectsRequest, options CheckMemberObjectsOperationOptions) (result CheckMemberObjectsOperationResponse, err error) {
...
func (c DirectoryRoleTemplateClient) CheckMemberObjectsComplete(ctx context.Context, id stable.DirectoryRoleTemplateId, input CheckMemberObjectsRequest, options CheckMemberObjectsOperationOptions) (result CheckMemberObjectsCompleteResult, err error) {
	items := make([]string, 0)
