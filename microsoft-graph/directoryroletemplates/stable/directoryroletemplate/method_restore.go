...
func (c DirectoryRoleTemplateClient) Restore(ctx context.Context, id stable.DirectoryRoleTemplateId, options RestoreOperationOptions) (result RestoreOperationResponse, err error) {
