...
func (c DomainNameReferenceClient) ListDomainNameReferences(ctx context.Context, id beta.DomainId, options ListDomainNameReferencesOperationOptions) (result ListDomainNameReferencesOperationResponse, err error) {
...
func (c DomainNameReferenceClient) ListDomainNameReferencesComplete(ctx context.Context, id beta.DomainId, options ListDomainNameReferencesOperationOptions) (ListDomainNameReferencesCompleteResult, error) {
