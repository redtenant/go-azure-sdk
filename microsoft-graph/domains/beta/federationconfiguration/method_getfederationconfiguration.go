...
func (c FederationConfigurationClient) GetFederationConfiguration(ctx context.Context, id beta.DomainIdFederationConfigurationId, options GetFederationConfigurationOperationOptions) (result GetFederationConfigurationOperationResponse, err error) {
