...
func (c VerificationDnsRecordClient) CreateVerificationDnsRecord(ctx context.Context, id beta.DomainId, input beta.DomainDnsRecord, options CreateVerificationDnsRecordOperationOptions) (result CreateVerificationDnsRecordOperationResponse, err error) {
