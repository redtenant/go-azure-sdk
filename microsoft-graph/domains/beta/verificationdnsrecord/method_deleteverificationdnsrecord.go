...
func DefaultDeleteVerificationDnsRecordOperationOptions() DeleteVerificationDnsRecordOperationOptions {
	return DeleteVerificationDnsRecordOperationOptions{}
}
...
func (c VerificationDnsRecordClient) DeleteVerificationDnsRecord(ctx context.Context, id beta.DomainIdVerificationDnsRecordId, options DeleteVerificationDnsRecordOperationOptions) (result DeleteVerificationDnsRecordOperationResponse, err error) {
