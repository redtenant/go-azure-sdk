...
func (c VerificationDnsRecordClient) ListVerificationDnsRecords(ctx context.Context, id beta.DomainId, options ListVerificationDnsRecordsOperationOptions) (result ListVerificationDnsRecordsOperationResponse, err error) {
...
func (c VerificationDnsRecordClient) ListVerificationDnsRecordsComplete(ctx context.Context, id beta.DomainId, options ListVerificationDnsRecordsOperationOptions) (ListVerificationDnsRecordsCompleteResult, error) {
...
func (c VerificationDnsRecordClient) ListVerificationDnsRecordsCompleteMatchingPredicate(ctx context.Context, id beta.DomainId, options ListVerificationDnsRecordsOperationOptions, predicate DomainDnsRecordOperationPredicate) (result ListVerificationDnsRecordsCompleteResult, err error) {
