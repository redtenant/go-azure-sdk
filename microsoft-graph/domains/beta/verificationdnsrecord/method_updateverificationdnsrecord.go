...
func (c VerificationDnsRecordClient) UpdateVerificationDnsRecord(ctx context.Context, id beta.DomainIdVerificationDnsRecordId, input beta.DomainDnsRecord, options UpdateVerificationDnsRecordOperationOptions) (result UpdateVerificationDnsRecordOperationResponse, err error) {
