...
func (c ServiceConfigurationRecordClient) DeleteServiceConfigurationRecord(ctx context.Context, id stable.DomainIdServiceConfigurationRecordId, options DeleteServiceConfigurationRecordOperationOptions) (result DeleteServiceConfigurationRecordOperationResponse, err error) {
