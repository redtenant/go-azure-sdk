...
func DefaultGetServiceConfigurationRecordsCountOperationOptions() GetServiceConfigurationRecordsCountOperationOptions {
	return GetServiceConfigurationRecordsCountOperationOptions{}
}
...
func (c ServiceConfigurationRecordClient) GetServiceConfigurationRecordsCount(ctx context.Context, id stable.DomainId, options GetServiceConfigurationRecordsCountOperationOptions) (result GetServiceConfigurationRecordsCountOperationResponse, err error) {
	opts := client.RequestOptions{
		...
		Path:          fmt.Sprintf("%s/serviceConfigurationRecords/$count", id.ID()),
