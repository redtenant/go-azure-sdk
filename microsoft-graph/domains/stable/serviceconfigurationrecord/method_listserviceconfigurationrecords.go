...
func (c ServiceConfigurationRecordClient) ListServiceConfigurationRecords(ctx context.Context, id stable.DomainId, options ListServiceConfigurationRecordsOperationOptions) (result ListServiceConfigurationRecordsOperationResponse, err error) {
...
func (c ServiceConfigurationRecordClient) ListServiceConfigurationRecordsComplete(ctx context.Context, id stable.DomainId, options ListServiceConfigurationRecordsOperationOptions) (ListServiceConfigurationRecordsCompleteResult, error) {
...
func (c ServiceConfigurationRecordClient) ListServiceConfigurationRecordsCompleteMatchingPredicate(ctx context.Context, id stable.DomainId, options ListServiceConfigurationRecordsOperationOptions, predicate DomainDnsRecordOperationPredicate) (result ListServiceConfigurationRecordsCompleteResult, err error) {
