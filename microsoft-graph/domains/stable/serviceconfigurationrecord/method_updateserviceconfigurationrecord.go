...
func (c ServiceConfigurationRecordClient) UpdateServiceConfigurationRecord(ctx context.Context, id stable.DomainIdServiceConfigurationRecordId, input stable.DomainDnsRecord, options UpdateServiceConfigurationRecordOperationOptions) (result UpdateServiceConfigurationRecordOperationResponse, err error) {
