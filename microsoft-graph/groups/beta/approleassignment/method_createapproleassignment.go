...
func (c AppRoleAssignmentClient) CreateAppRoleAssignment(ctx context.Context, id beta.GroupId, input beta.AppRoleAssignment, options CreateAppRoleAssignmentOperationOptions) (result CreateAppRoleAssignmentOperationResponse, err error) {
