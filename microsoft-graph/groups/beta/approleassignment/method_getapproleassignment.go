...
// GetAppRoleAssignment - Get appRoleAssignments from groups. Represents the app roles a group has been granted for an
// application. Supports $expand.
func (c AppRoleAssignmentClient) GetAppRoleAssignment(ctx context.Context, id beta.GroupIdAppRoleAssignmentId, options GetAppRoleAssignmentOperationOptions) (result GetAppRoleAssignmentOperationResponse, err error) {
