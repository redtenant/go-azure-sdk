...
func (c AppRoleAssignmentClient) GetAppRoleAssignmentsCount(ctx context.Context, id beta.GroupId, options GetAppRoleAssignmentsCountOperationOptions) (result GetAppRoleAssignmentsCountOperationResponse, err error) {
