...
func (c AppRoleAssignmentClient) ListAppRoleAssignments(ctx context.Context, id beta.GroupId, options ListAppRoleAssignmentsOperationOptions) (result ListAppRoleAssignmentsOperationResponse, err error) {
...
func (c AppRoleAssignmentClient) ListAppRoleAssignmentsComplete(ctx context.Context, id beta.GroupId, options ListAppRoleAssignmentsOperationOptions) (ListAppRoleAssignmentsCompleteResult, error) {
...
func (c AppRoleAssignmentClient) ListAppRoleAssignmentsCompleteMatchingPredicate(ctx context.Context, id beta.GroupId, options ListAppRoleAssignmentsOperationOptions, predicate AppRoleAssignmentOperationPredicate) (result ListAppRoleAssignmentsCompleteResult, err error) {
