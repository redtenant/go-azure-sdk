...
func (c AppRoleAssignmentClient) UpdateAppRoleAssignment(ctx context.Context, id beta.GroupIdAppRoleAssignmentId, input beta.AppRoleAssignment, options UpdateAppRoleAssignmentOperationOptions) (result UpdateAppRoleAssignmentOperationResponse, err error) {
