...
// shared.
func (c CalendarCalendarPermissionClient) GetCalendarPermission(ctx context.Context, id beta.GroupIdCalendarCalendarPermissionId, options GetCalendarPermissionOperationOptions) (result GetCalendarPermissionOperationResponse, err error) {
