...
// shared.
func (c CalendarCalendarPermissionClient) ListCalendarPermissions(ctx context.Context, id beta.GroupId, options ListCalendarPermissionsOperationOptions) (result ListCalendarPermissionsOperationResponse, err error) {
...
func (c CalendarCalendarPermissionClient) ListCalendarPermissionsComplete(ctx context.Context, id beta.GroupId, options ListCalendarPermissionsOperationOptions) (ListCalendarPermissionsCompleteResult, error) {
...
func (c CalendarCalendarPermissionClient) ListCalendarPermissionsCompleteMatchingPredicate(ctx context.Context, id beta.GroupId, options ListCalendarPermissionsOperationOptions, predicate CalendarPermissionOperationPredicate) (result ListCalendarPermissionsCompleteResult, err error) {
