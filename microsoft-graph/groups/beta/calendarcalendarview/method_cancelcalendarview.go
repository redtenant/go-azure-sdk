...
func (c CalendarCalendarViewClient) CancelCalendarView(ctx context.Context, id beta.GroupIdCalendarCalendarViewId, input CancelCalendarViewRequest, options CancelCalendarViewOperationOptions) (result CancelCalendarViewOperationResponse, err error) {
