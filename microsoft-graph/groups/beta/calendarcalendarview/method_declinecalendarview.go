...
func (c CalendarCalendarViewClient) DeclineCalendarView(ctx context.Context, id beta.GroupIdCalendarCalendarViewId, input DeclineCalendarViewRequest, options DeclineCalendarViewOperationOptions) (result DeclineCalendarViewOperationResponse, err error) {
