...
// Outlook.com account.
func (c CalendarCalendarViewClient) ForwardCalendarView(ctx context.Context, id beta.GroupIdCalendarCalendarViewId, input ForwardCalendarViewRequest, options ForwardCalendarViewOperationOptions) (result ForwardCalendarViewOperationResponse, err error) {
