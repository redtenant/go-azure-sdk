...
func (c CalendarCalendarViewClient) GetCalendarView(ctx context.Context, id beta.GroupIdCalendarCalendarViewId, options GetCalendarViewOperationOptions) (result GetCalendarViewOperationResponse, err error) {
