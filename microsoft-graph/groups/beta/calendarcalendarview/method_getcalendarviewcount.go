...
func (c CalendarCalendarViewClient) GetCalendarViewCount(ctx context.Context, id beta.GroupId, options GetCalendarViewCountOperationOptions) (result GetCalendarViewCountOperationResponse, err error) {
