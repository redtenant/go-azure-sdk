...
func (c CalendarCalendarViewClient) ListCalendarViews(ctx context.Context, id beta.GroupId, options ListCalendarViewsOperationOptions) (result ListCalendarViewsOperationResponse, err error) {
...
func (c CalendarCalendarViewClient) ListCalendarViewsComplete(ctx context.Context, id beta.GroupId, options ListCalendarViewsOperationOptions) (ListCalendarViewsCompleteResult, error) {
