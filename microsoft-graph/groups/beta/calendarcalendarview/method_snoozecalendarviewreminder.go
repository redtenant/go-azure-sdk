...
// a new time.
func (c CalendarCalendarViewClient) SnoozeCalendarViewReminder(ctx context.Context, id beta.GroupIdCalendarCalendarViewId, input SnoozeCalendarViewReminderRequest, options SnoozeCalendarViewReminderOperationOptions) (result SnoozeCalendarViewReminderOperationResponse, err error) {
