...
func (c CalendarCalendarViewClient) TentativelyAcceptCalendarView(ctx context.Context, id beta.GroupIdCalendarCalendarViewId, input TentativelyAcceptCalendarViewRequest, options TentativelyAcceptCalendarViewOperationOptions) (result TentativelyAcceptCalendarViewOperationResponse, err error) {
