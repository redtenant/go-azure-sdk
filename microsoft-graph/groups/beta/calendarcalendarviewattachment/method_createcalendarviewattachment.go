...
func (c CalendarCalendarViewAttachmentClient) CreateCalendarViewAttachment(ctx context.Context, id beta.GroupIdCalendarCalendarViewId, input beta.Attachment, options CreateCalendarViewAttachmentOperationOptions) (result CreateCalendarViewAttachmentOperationResponse, err error) {
