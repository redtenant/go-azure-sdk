...
func DefaultCreateCalendarViewAttachmentsUploadSessionOperationOptions() CreateCalendarViewAttachmentsUploadSessionOperationOptions {
	return CreateCalendarViewAttachmentsUploadSessionOperationOptions{}
}
...
// CreateCalendarViewAttachmentsUploadSession - Invoke action createUploadSession. Create an upload session that allows
...
func (c CalendarCalendarViewAttachmentClient) CreateCalendarViewAttachmentsUploadSession(ctx context.Context, id beta.GroupIdCalendarCalendarViewId, input CreateCalendarViewAttachmentsUploadSessionRequest, options CreateCalendarViewAttachmentsUploadSessionOperationOptions) (result CreateCalendarViewAttachmentsUploadSessionOperationResponse, err error) {
