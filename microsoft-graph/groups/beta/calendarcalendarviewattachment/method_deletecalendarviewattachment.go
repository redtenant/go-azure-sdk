...
func (c CalendarCalendarViewAttachmentClient) DeleteCalendarViewAttachment(ctx context.Context, id beta.GroupIdCalendarCalendarViewIdAttachmentId, options DeleteCalendarViewAttachmentOperationOptions) (result DeleteCalendarViewAttachmentOperationResponse, err error) {
