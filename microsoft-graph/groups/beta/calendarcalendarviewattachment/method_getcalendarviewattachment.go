...
func (c CalendarCalendarViewAttachmentClient) GetCalendarViewAttachment(ctx context.Context, id beta.GroupIdCalendarCalendarViewIdAttachmentId, options GetCalendarViewAttachmentOperationOptions) (result GetCalendarViewAttachmentOperationResponse, err error) {
