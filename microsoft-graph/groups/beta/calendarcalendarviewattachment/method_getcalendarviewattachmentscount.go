...
func (c CalendarCalendarViewAttachmentClient) GetCalendarViewAttachmentsCount(ctx context.Context, id beta.GroupIdCalendarCalendarViewId, options GetCalendarViewAttachmentsCountOperationOptions) (result GetCalendarViewAttachmentsCountOperationResponse, err error) {
