...
func DefaultCancelCalendarViewExceptionOccurrenceOperationOptions() CancelCalendarViewExceptionOccurrenceOperationOptions {
	return CancelCalendarViewExceptionOccurrenceOperationOptions{}
}
...
// CancelCalendarViewExceptionOccurrence - Invoke action cancel. This action allows the organizer of a meeting to send a
