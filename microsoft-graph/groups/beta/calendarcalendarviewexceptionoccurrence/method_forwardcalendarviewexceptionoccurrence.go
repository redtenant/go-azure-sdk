...
func DefaultForwardCalendarViewExceptionOccurrenceOperationOptions() ForwardCalendarViewExceptionOccurrenceOperationOptions {
	return ForwardCalendarViewExceptionOccurrenceOperationOptions{}
}
...
// ForwardCalendarViewExceptionOccurrence - Invoke action forward. This action allows the organizer or attendee of a
...
func (c CalendarCalendarViewExceptionOccurrenceClient) ForwardCalendarViewExceptionOccurrence(ctx context.Context, id beta.GroupIdCalendarCalendarViewIdExceptionOccurrenceId, input ForwardCalendarViewExceptionOccurrenceRequest, options ForwardCalendarViewExceptionOccurrenceOperationOptions) (result ForwardCalendarViewExceptionOccurrenceOperationResponse, err error) {
