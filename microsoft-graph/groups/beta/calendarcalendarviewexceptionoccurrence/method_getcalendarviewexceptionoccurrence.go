...
func (c CalendarCalendarViewExceptionOccurrenceClient) GetCalendarViewExceptionOccurrence(ctx context.Context, id beta.GroupIdCalendarCalendarViewIdExceptionOccurrenceId, options GetCalendarViewExceptionOccurrenceOperationOptions) (result GetCalendarViewExceptionOccurrenceOperationResponse, err error) {
