...
func (c CalendarCalendarViewExceptionOccurrenceClient) GetCalendarViewExceptionOccurrencesCount(ctx context.Context, id beta.GroupIdCalendarCalendarViewId, options GetCalendarViewExceptionOccurrencesCountOperationOptions) (result GetCalendarViewExceptionOccurrencesCountOperationResponse, err error) {
