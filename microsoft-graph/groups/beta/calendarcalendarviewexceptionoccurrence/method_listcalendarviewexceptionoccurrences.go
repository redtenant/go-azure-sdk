...
func DefaultListCalendarViewExceptionOccurrencesOperationOptions() ListCalendarViewExceptionOccurrencesOperationOptions {
	return ListCalendarViewExceptionOccurrencesOperationOptions{}
}
...
func (c CalendarCalendarViewExceptionOccurrenceClient) ListCalendarViewExceptionOccurrences(ctx context.Context, id beta.GroupIdCalendarCalendarViewId, options ListCalendarViewExceptionOccurrencesOperationOptions) (result ListCalendarViewExceptionOccurrencesOperationResponse, err error) {
...
func (c CalendarCalendarViewExceptionOccurrenceClient) ListCalendarViewExceptionOccurrencesComplete(ctx context.Context, id beta.GroupIdCalendarCalendarViewId, options ListCalendarViewExceptionOccurrencesOperationOptions) (ListCalendarViewExceptionOccurrencesCompleteResult, error) {
	return c.ListCalendarViewExceptionOccurrencesCompleteMatchingPredicate(ctx, id, options, EventOperationPredicate{})
}

// ListCalendarViewExceptionOccurrencesCompleteMatchingPredicate retrieves all the results and then applies the predicate
func (c CalendarCalendarViewExceptionOccurrenceClient) ListCalendarViewExceptionOccurrencesCompleteMatchingPredicate(ctx context.Context, id beta.GroupIdCalendarCalendarViewId, options ListCalendarViewExceptionOccurrencesOperationOptions, predicate EventOperationPredicate) (result ListCalendarViewExceptionOccurrencesCompleteResult, err error) {
	items := make([]beta.Event, 0)

	resp, err := c.ListCalendarViewExceptionOccurrences(ctx, id, options)
	if err != nil {
