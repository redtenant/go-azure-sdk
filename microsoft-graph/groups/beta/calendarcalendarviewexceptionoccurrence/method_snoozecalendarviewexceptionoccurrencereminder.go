...
func (c CalendarCalendarViewExceptionOccurrenceClient) SnoozeCalendarViewExceptionOccurrenceReminder(ctx context.Context, id beta.GroupIdCalendarCalendarViewIdExceptionOccurrenceId, input SnoozeCalendarViewExceptionOccurrenceReminderRequest, options SnoozeCalendarViewExceptionOccurrenceReminderOperationOptions) (result SnoozeCalendarViewExceptionOccurrenceReminderOperationResponse, err error) {
