...
func DefaultCreateCalendarViewExceptionOccurrenceAttachmentOperationOptions() CreateCalendarViewExceptionOccurrenceAttachmentOperationOptions {
	return CreateCalendarViewExceptionOccurrenceAttachmentOperationOptions{}
}
...
func (c CalendarCalendarViewExceptionOccurrenceAttachmentClient) CreateCalendarViewExceptionOccurrenceAttachment(ctx context.Context, id beta.GroupIdCalendarCalendarViewIdExceptionOccurrenceId, input beta.Attachment, options CreateCalendarViewExceptionOccurrenceAttachmentOperationOptions) (result CreateCalendarViewExceptionOccurrenceAttachmentOperationResponse, err error) {
