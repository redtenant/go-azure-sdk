...
func DefaultCreateCalendarViewExceptionOccurrenceAttachmentsUploadSessionOperationOptions() CreateCalendarViewExceptionOccurrenceAttachmentsUploadSessionOperationOptions {
	return CreateCalendarViewExceptionOccurrenceAttachmentsUploadSessionOperationOptions{}
}
...
// CreateCalendarViewExceptionOccurrenceAttachmentsUploadSession - Invoke action createUploadSession. Create an upload
...
func (c CalendarCalendarViewExceptionOccurrenceAttachmentClient) CreateCalendarViewExceptionOccurrenceAttachmentsUploadSession(ctx context.Context, id beta.GroupIdCalendarCalendarViewIdExceptionOccurrenceId, input CreateCalendarViewExceptionOccurrenceAttachmentsUploadSessionRequest, options CreateCalendarViewExceptionOccurrenceAttachmentsUploadSessionOperationOptions) (result CreateCalendarViewExceptionOccurrenceAttachmentsUploadSessionOperationResponse, err error) {
