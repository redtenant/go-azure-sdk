...
func DefaultDeleteCalendarViewExceptionOccurrenceAttachmentOperationOptions() DeleteCalendarViewExceptionOccurrenceAttachmentOperationOptions {
	return DeleteCalendarViewExceptionOccurrenceAttachmentOperationOptions{}
}
...
func (c CalendarCalendarViewExceptionOccurrenceAttachmentClient) DeleteCalendarViewExceptionOccurrenceAttachment(ctx context.Context, id beta.GroupIdCalendarCalendarViewIdExceptionOccurrenceIdAttachmentId, options DeleteCalendarViewExceptionOccurrenceAttachmentOperationOptions) (result DeleteCalendarViewExceptionOccurrenceAttachmentOperationResponse, err error) {
