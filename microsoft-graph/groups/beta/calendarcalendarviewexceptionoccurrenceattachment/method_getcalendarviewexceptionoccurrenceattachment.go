...
func DefaultGetCalendarViewExceptionOccurrenceAttachmentOperationOptions() GetCalendarViewExceptionOccurrenceAttachmentOperationOptions {
	return GetCalendarViewExceptionOccurrenceAttachmentOperationOptions{}
}
...
// GetCalendarViewExceptionOccurrenceAttachment - Get attachments from groups. The collection of FileAttachment,
// ItemAttachment, and referenceAttachment attachments for the event. Navigation property. Read-only. Nullable.
func (c CalendarCalendarViewExceptionOccurrenceAttachmentClient) GetCalendarViewExceptionOccurrenceAttachment(ctx context.Context, id beta.GroupIdCalendarCalendarViewIdExceptionOccurrenceIdAttachmentId, options GetCalendarViewExceptionOccurrenceAttachmentOperationOptions) (result GetCalendarViewExceptionOccurrenceAttachmentOperationResponse, err error) {
