...
func (c CalendarCalendarViewExceptionOccurrenceAttachmentClient) GetCalendarViewExceptionOccurrenceAttachmentsCount(ctx context.Context, id beta.GroupIdCalendarCalendarViewIdExceptionOccurrenceId, options GetCalendarViewExceptionOccurrenceAttachmentsCountOperationOptions) (result GetCalendarViewExceptionOccurrenceAttachmentsCountOperationResponse, err error) {
