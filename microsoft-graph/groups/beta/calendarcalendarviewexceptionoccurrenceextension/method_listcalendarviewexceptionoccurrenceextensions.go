...
func (c CalendarCalendarViewExceptionOccurrenceExtensionClient) ListCalendarViewExceptionOccurrenceExtensions(ctx context.Context, id beta.GroupIdCalendarCalendarViewIdExceptionOccurrenceId, options ListCalendarViewExceptionOccurrenceExtensionsOperationOptions) (result ListCalendarViewExceptionOccurrenceExtensionsOperationResponse, err error) {
...
func (c CalendarCalendarViewExceptionOccurrenceExtensionClient) ListCalendarViewExceptionOccurrenceExtensionsComplete(ctx context.Context, id beta.GroupIdCalendarCalendarViewIdExceptionOccurrenceId, options ListCalendarViewExceptionOccurrenceExtensionsOperationOptions) (ListCalendarViewExceptionOccurrenceExtensionsCompleteResult, error) {
