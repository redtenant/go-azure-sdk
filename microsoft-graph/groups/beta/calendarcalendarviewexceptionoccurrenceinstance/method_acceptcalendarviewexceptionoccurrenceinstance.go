...
func (c CalendarCalendarViewExceptionOccurrenceInstanceClient) AcceptCalendarViewExceptionOccurrenceInstance(ctx context.Context, id beta.GroupIdCalendarCalendarViewIdExceptionOccurrenceIdInstanceId, input AcceptCalendarViewExceptionOccurrenceInstanceRequest, options AcceptCalendarViewExceptionOccurrenceInstanceOperationOptions) (result AcceptCalendarViewExceptionOccurrenceInstanceOperationResponse, err error) {
