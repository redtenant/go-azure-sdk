...
func DefaultDeleteCalendarViewExceptionOccurrenceInstanceAttachmentOperationOptions() DeleteCalendarViewExceptionOccurrenceInstanceAttachmentOperationOptions {
	return DeleteCalendarViewExceptionOccurrenceInstanceAttachmentOperationOptions{}
}
...
func (c CalendarCalendarViewExceptionOccurrenceInstanceAttachmentClient) DeleteCalendarViewExceptionOccurrenceInstanceAttachment(ctx context.Context, id beta.GroupIdCalendarCalendarViewIdExceptionOccurrenceIdInstanceIdAttachmentId, options DeleteCalendarViewExceptionOccurrenceInstanceAttachmentOperationOptions) (result DeleteCalendarViewExceptionOccurrenceInstanceAttachmentOperationResponse, err error) {
