...
func (c CalendarCalendarViewExceptionOccurrenceInstanceAttachmentClient) GetCalendarViewExceptionOccurrenceInstanceAttachment(ctx context.Context, id beta.GroupIdCalendarCalendarViewIdExceptionOccurrenceIdInstanceIdAttachmentId, options GetCalendarViewExceptionOccurrenceInstanceAttachmentOperationOptions) (result GetCalendarViewExceptionOccurrenceInstanceAttachmentOperationResponse, err error) {
