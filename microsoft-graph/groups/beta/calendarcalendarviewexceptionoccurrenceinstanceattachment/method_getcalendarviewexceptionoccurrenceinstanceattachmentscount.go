...
func DefaultGetCalendarViewExceptionOccurrenceInstanceAttachmentsCountOperationOptions() GetCalendarViewExceptionOccurrenceInstanceAttachmentsCountOperationOptions {
	return GetCalendarViewExceptionOccurrenceInstanceAttachmentsCountOperationOptions{}
}
...
func (c CalendarCalendarViewExceptionOccurrenceInstanceAttachmentClient) GetCalendarViewExceptionOccurrenceInstanceAttachmentsCount(ctx context.Context, id beta.GroupIdCalendarCalendarViewIdExceptionOccurrenceIdInstanceId, options GetCalendarViewExceptionOccurrenceInstanceAttachmentsCountOperationOptions) (result GetCalendarViewExceptionOccurrenceInstanceAttachmentsCountOperationResponse, err error) {
