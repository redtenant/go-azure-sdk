...
func DefaultListCalendarViewExceptionOccurrenceInstanceAttachmentsOperationOptions() ListCalendarViewExceptionOccurrenceInstanceAttachmentsOperationOptions {
	return ListCalendarViewExceptionOccurrenceInstanceAttachmentsOperationOptions{}
}
...
// ListCalendarViewExceptionOccurrenceInstanceAttachments - Get attachments from groups. The collection of
// FileAttachment, ItemAttachment, and referenceAttachment attachments for the event. Navigation property. Read-only.
// Nullable.
func (c CalendarCalendarViewExceptionOccurrenceInstanceAttachmentClient) ListCalendarViewExceptionOccurrenceInstanceAttachments(ctx context.Context, id beta.GroupIdCalendarCalendarViewIdExceptionOccurrenceIdInstanceId, options ListCalendarViewExceptionOccurrenceInstanceAttachmentsOperationOptions) (result ListCalendarViewExceptionOccurrenceInstanceAttachmentsOperationResponse, err error) {
...
func (c CalendarCalendarViewExceptionOccurrenceInstanceAttachmentClient) ListCalendarViewExceptionOccurrenceInstanceAttachmentsComplete(ctx context.Context, id beta.GroupIdCalendarCalendarViewIdExceptionOccurrenceIdInstanceId, options ListCalendarViewExceptionOccurrenceInstanceAttachmentsOperationOptions) (ListCalendarViewExceptionOccurrenceInstanceAttachmentsCompleteResult, error) {
	return c.ListCalendarViewExceptionOccurrenceInstanceAttachmentsCompleteMatchingPredicate(ctx, id, options, AttachmentOperationPredicate{})
}
...
func (c CalendarCalendarViewExceptionOccurrenceInstanceAttachmentClient) ListCalendarViewExceptionOccurrenceInstanceAttachmentsCompleteMatchingPredicate(ctx context.Context, id beta.GroupIdCalendarCalendarViewIdExceptionOccurrenceIdInstanceId, options ListCalendarViewExceptionOccurrenceInstanceAttachmentsOperationOptions, predicate AttachmentOperationPredicate) (result ListCalendarViewExceptionOccurrenceInstanceAttachmentsCompleteResult, err error) {
	items := make([]beta.Attachment, 0)

	resp, err := c.ListCalendarViewExceptionOccurrenceInstanceAttachments(ctx, id, options)
	if err != nil {
