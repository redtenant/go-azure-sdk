...
func (c CalendarCalendarViewExceptionOccurrenceInstanceExtensionClient) DeleteCalendarViewExceptionOccurrenceInstanceExtension(ctx context.Context, id beta.GroupIdCalendarCalendarViewIdExceptionOccurrenceIdInstanceIdExtensionId, options DeleteCalendarViewExceptionOccurrenceInstanceExtensionOperationOptions) (result DeleteCalendarViewExceptionOccurrenceInstanceExtensionOperationResponse, err error) {
