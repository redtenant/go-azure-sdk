...
func (c CalendarCalendarViewExtensionClient) CreateCalendarViewExtension(ctx context.Context, id beta.GroupIdCalendarCalendarViewId, input beta.Extension, options CreateCalendarViewExtensionOperationOptions) (result CreateCalendarViewExtensionOperationResponse, err error) {
