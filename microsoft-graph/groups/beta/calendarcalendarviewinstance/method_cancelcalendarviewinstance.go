...
func (c CalendarCalendarViewInstanceClient) CancelCalendarViewInstance(ctx context.Context, id beta.GroupIdCalendarCalendarViewIdInstanceId, input CancelCalendarViewInstanceRequest, options CancelCalendarViewInstanceOperationOptions) (result CancelCalendarViewInstanceOperationResponse, err error) {
