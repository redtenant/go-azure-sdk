...
func (c CalendarCalendarViewInstanceClient) DeclineCalendarViewInstance(ctx context.Context, id beta.GroupIdCalendarCalendarViewIdInstanceId, input DeclineCalendarViewInstanceRequest, options DeclineCalendarViewInstanceOperationOptions) (result DeclineCalendarViewInstanceOperationResponse, err error) {
