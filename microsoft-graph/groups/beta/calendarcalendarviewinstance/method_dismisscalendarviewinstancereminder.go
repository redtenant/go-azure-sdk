...
func (c CalendarCalendarViewInstanceClient) DismissCalendarViewInstanceReminder(ctx context.Context, id beta.GroupIdCalendarCalendarViewIdInstanceId, options DismissCalendarViewInstanceReminderOperationOptions) (result DismissCalendarViewInstanceReminderOperationResponse, err error) {
