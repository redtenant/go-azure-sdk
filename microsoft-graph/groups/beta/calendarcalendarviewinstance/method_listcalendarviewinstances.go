...
// ListCalendarViewInstances - Get instances from groups. The occurrences of a recurring series, if the event is a
...
// Read-only. Nullable.
func (c CalendarCalendarViewInstanceClient) ListCalendarViewInstances(ctx context.Context, id beta.GroupIdCalendarCalendarViewId, options ListCalendarViewInstancesOperationOptions) (result ListCalendarViewInstancesOperationResponse, err error) {
...
func (c CalendarCalendarViewInstanceClient) ListCalendarViewInstancesComplete(ctx context.Context, id beta.GroupIdCalendarCalendarViewId, options ListCalendarViewInstancesOperationOptions) (ListCalendarViewInstancesCompleteResult, error) {
...
func (c CalendarCalendarViewInstanceClient) ListCalendarViewInstancesCompleteMatchingPredicate(ctx context.Context, id beta.GroupIdCalendarCalendarViewId, options ListCalendarViewInstancesOperationOptions, predicate EventOperationPredicate) (result ListCalendarViewInstancesCompleteResult, err error) {
