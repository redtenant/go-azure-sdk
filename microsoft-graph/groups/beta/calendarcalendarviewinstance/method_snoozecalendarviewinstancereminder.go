...
func (c CalendarCalendarViewInstanceClient) SnoozeCalendarViewInstanceReminder(ctx context.Context, id beta.GroupIdCalendarCalendarViewIdInstanceId, input SnoozeCalendarViewInstanceReminderRequest, options SnoozeCalendarViewInstanceReminderOperationOptions) (result SnoozeCalendarViewInstanceReminderOperationResponse, err error) {
