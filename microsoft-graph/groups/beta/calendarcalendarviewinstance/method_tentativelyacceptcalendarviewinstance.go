...
func (c CalendarCalendarViewInstanceClient) TentativelyAcceptCalendarViewInstance(ctx context.Context, id beta.GroupIdCalendarCalendarViewIdInstanceId, input TentativelyAcceptCalendarViewInstanceRequest, options TentativelyAcceptCalendarViewInstanceOperationOptions) (result TentativelyAcceptCalendarViewInstanceOperationResponse, err error) {
