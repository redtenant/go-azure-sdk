...
func (c CalendarCalendarViewInstanceAttachmentClient) CreateCalendarViewInstanceAttachment(ctx context.Context, id beta.GroupIdCalendarCalendarViewIdInstanceId, input beta.Attachment, options CreateCalendarViewInstanceAttachmentOperationOptions) (result CreateCalendarViewInstanceAttachmentOperationResponse, err error) {
