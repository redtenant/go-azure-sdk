...
func DefaultCreateCalendarViewInstanceAttachmentsUploadSessionOperationOptions() CreateCalendarViewInstanceAttachmentsUploadSessionOperationOptions {
	return CreateCalendarViewInstanceAttachmentsUploadSessionOperationOptions{}
}
...
// CreateCalendarViewInstanceAttachmentsUploadSession - Invoke action createUploadSession. Create an upload session that
// allows an app to iteratively upload ranges of a file, so as to attach the file to an Outlook item. The item can be a
...
func (c CalendarCalendarViewInstanceAttachmentClient) CreateCalendarViewInstanceAttachmentsUploadSession(ctx context.Context, id beta.GroupIdCalendarCalendarViewIdInstanceId, input CreateCalendarViewInstanceAttachmentsUploadSessionRequest, options CreateCalendarViewInstanceAttachmentsUploadSessionOperationOptions) (result CreateCalendarViewInstanceAttachmentsUploadSessionOperationResponse, err error) {
