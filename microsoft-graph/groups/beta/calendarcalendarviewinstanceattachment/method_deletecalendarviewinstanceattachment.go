...
func DefaultDeleteCalendarViewInstanceAttachmentOperationOptions() DeleteCalendarViewInstanceAttachmentOperationOptions {
	return DeleteCalendarViewInstanceAttachmentOperationOptions{}
}
...
func (c CalendarCalendarViewInstanceAttachmentClient) DeleteCalendarViewInstanceAttachment(ctx context.Context, id beta.GroupIdCalendarCalendarViewIdInstanceIdAttachmentId, options DeleteCalendarViewInstanceAttachmentOperationOptions) (result DeleteCalendarViewInstanceAttachmentOperationResponse, err error) {
