...
func (c CalendarCalendarViewInstanceAttachmentClient) GetCalendarViewInstanceAttachment(ctx context.Context, id beta.GroupIdCalendarCalendarViewIdInstanceIdAttachmentId, options GetCalendarViewInstanceAttachmentOperationOptions) (result GetCalendarViewInstanceAttachmentOperationResponse, err error) {
