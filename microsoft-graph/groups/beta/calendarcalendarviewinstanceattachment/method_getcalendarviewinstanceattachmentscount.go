...
func (c CalendarCalendarViewInstanceAttachmentClient) GetCalendarViewInstanceAttachmentsCount(ctx context.Context, id beta.GroupIdCalendarCalendarViewIdInstanceId, options GetCalendarViewInstanceAttachmentsCountOperationOptions) (result GetCalendarViewInstanceAttachmentsCountOperationResponse, err error) {
