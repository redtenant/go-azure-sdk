...
func (c CalendarCalendarViewInstanceExceptionOccurrenceClient) AcceptCalendarViewInstanceExceptionOccurrence(ctx context.Context, id beta.GroupIdCalendarCalendarViewIdInstanceIdExceptionOccurrenceId, input AcceptCalendarViewInstanceExceptionOccurrenceRequest, options AcceptCalendarViewInstanceExceptionOccurrenceOperationOptions) (result AcceptCalendarViewInstanceExceptionOccurrenceOperationResponse, err error) {
