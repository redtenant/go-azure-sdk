...
func DefaultCancelCalendarViewInstanceExceptionOccurrenceOperationOptions() CancelCalendarViewInstanceExceptionOccurrenceOperationOptions {
	return CancelCalendarViewInstanceExceptionOccurrenceOperationOptions{}
}
...
// CancelCalendarViewInstanceExceptionOccurrence - Invoke action cancel. This action allows the organizer of a meeting
...
// cancellation.
func (c CalendarCalendarViewInstanceExceptionOccurrenceClient) CancelCalendarViewInstanceExceptionOccurrence(ctx context.Context, id beta.GroupIdCalendarCalendarViewIdInstanceIdExceptionOccurrenceId, input CancelCalendarViewInstanceExceptionOccurrenceRequest, options CancelCalendarViewInstanceExceptionOccurrenceOperationOptions) (result CancelCalendarViewInstanceExceptionOccurrenceOperationResponse, err error) {
