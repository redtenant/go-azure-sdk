...
func (c CalendarCalendarViewInstanceExceptionOccurrenceClient) DeclineCalendarViewInstanceExceptionOccurrence(ctx context.Context, id beta.GroupIdCalendarCalendarViewIdInstanceIdExceptionOccurrenceId, input DeclineCalendarViewInstanceExceptionOccurrenceRequest, options DeclineCalendarViewInstanceExceptionOccurrenceOperationOptions) (result DeclineCalendarViewInstanceExceptionOccurrenceOperationResponse, err error) {
