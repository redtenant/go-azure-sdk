...
func DefaultGetCalendarViewInstanceExceptionOccurrenceOperationOptions() GetCalendarViewInstanceExceptionOccurrenceOperationOptions {
	return GetCalendarViewInstanceExceptionOccurrenceOperationOptions{}
}
...
func (c CalendarCalendarViewInstanceExceptionOccurrenceClient) GetCalendarViewInstanceExceptionOccurrence(ctx context.Context, id beta.GroupIdCalendarCalendarViewIdInstanceIdExceptionOccurrenceId, options GetCalendarViewInstanceExceptionOccurrenceOperationOptions) (result GetCalendarViewInstanceExceptionOccurrenceOperationResponse, err error) {
