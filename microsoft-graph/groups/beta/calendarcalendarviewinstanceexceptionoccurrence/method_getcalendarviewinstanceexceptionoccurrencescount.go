...
func DefaultGetCalendarViewInstanceExceptionOccurrencesCountOperationOptions() GetCalendarViewInstanceExceptionOccurrencesCountOperationOptions {
	return GetCalendarViewInstanceExceptionOccurrencesCountOperationOptions{}
}
...
func (c CalendarCalendarViewInstanceExceptionOccurrenceClient) GetCalendarViewInstanceExceptionOccurrencesCount(ctx context.Context, id beta.GroupIdCalendarCalendarViewIdInstanceId, options GetCalendarViewInstanceExceptionOccurrencesCountOperationOptions) (result GetCalendarViewInstanceExceptionOccurrencesCountOperationResponse, err error) {
