...
func DefaultListCalendarViewInstanceExceptionOccurrencesOperationOptions() ListCalendarViewInstanceExceptionOccurrencesOperationOptions {
	return ListCalendarViewInstanceExceptionOccurrencesOperationOptions{}
}
...
func (c CalendarCalendarViewInstanceExceptionOccurrenceClient) ListCalendarViewInstanceExceptionOccurrences(ctx context.Context, id beta.GroupIdCalendarCalendarViewIdInstanceId, options ListCalendarViewInstanceExceptionOccurrencesOperationOptions) (result ListCalendarViewInstanceExceptionOccurrencesOperationResponse, err error) {
...
func (c CalendarCalendarViewInstanceExceptionOccurrenceClient) ListCalendarViewInstanceExceptionOccurrencesComplete(ctx context.Context, id beta.GroupIdCalendarCalendarViewIdInstanceId, options ListCalendarViewInstanceExceptionOccurrencesOperationOptions) (ListCalendarViewInstanceExceptionOccurrencesCompleteResult, error) {
	return c.ListCalendarViewInstanceExceptionOccurrencesCompleteMatchingPredicate(ctx, id, options, EventOperationPredicate{})
}
...
func (c CalendarCalendarViewInstanceExceptionOccurrenceClient) ListCalendarViewInstanceExceptionOccurrencesCompleteMatchingPredicate(ctx context.Context, id beta.GroupIdCalendarCalendarViewIdInstanceId, options ListCalendarViewInstanceExceptionOccurrencesOperationOptions, predicate EventOperationPredicate) (result ListCalendarViewInstanceExceptionOccurrencesCompleteResult, err error) {
	items := make([]beta.Event, 0)

	resp, err := c.ListCalendarViewInstanceExceptionOccurrences(ctx, id, options)
	if err != nil {
