...
func DefaultCreateCalendarViewInstanceExceptionOccurrenceAttachmentsUploadSessionOperationOptions() CreateCalendarViewInstanceExceptionOccurrenceAttachmentsUploadSessionOperationOptions {
	return CreateCalendarViewInstanceExceptionOccurrenceAttachmentsUploadSessionOperationOptions{}
}
...
// CreateCalendarViewInstanceExceptionOccurrenceAttachmentsUploadSession - Invoke action createUploadSession. Create an
...
// MB. To attach a file that's smaller than 3 MB, do a POST operation on the attachments navigation property of the
// Outlook item; see how to do this for a message or for an event. As part of the response, this action returns an
// upload URL that you can use in subsequent sequential PUT queries. Request headers for each PUT operation let you
...
func (c CalendarCalendarViewInstanceExceptionOccurrenceAttachmentClient) CreateCalendarViewInstanceExceptionOccurrenceAttachmentsUploadSession(ctx context.Context, id beta.GroupIdCalendarCalendarViewIdInstanceIdExceptionOccurrenceId, input CreateCalendarViewInstanceExceptionOccurrenceAttachmentsUploadSessionRequest, options CreateCalendarViewInstanceExceptionOccurrenceAttachmentsUploadSessionOperationOptions) (result CreateCalendarViewInstanceExceptionOccurrenceAttachmentsUploadSessionOperationResponse, err error) {
