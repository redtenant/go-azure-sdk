...
func DefaultDeleteCalendarViewInstanceExceptionOccurrenceAttachmentOperationOptions() DeleteCalendarViewInstanceExceptionOccurrenceAttachmentOperationOptions {
	return DeleteCalendarViewInstanceExceptionOccurrenceAttachmentOperationOptions{}
}
...
func (c CalendarCalendarViewInstanceExceptionOccurrenceAttachmentClient) DeleteCalendarViewInstanceExceptionOccurrenceAttachment(ctx context.Context, id beta.GroupIdCalendarCalendarViewIdInstanceIdExceptionOccurrenceIdAttachmentId, options DeleteCalendarViewInstanceExceptionOccurrenceAttachmentOperationOptions) (result DeleteCalendarViewInstanceExceptionOccurrenceAttachmentOperationResponse, err error) {
