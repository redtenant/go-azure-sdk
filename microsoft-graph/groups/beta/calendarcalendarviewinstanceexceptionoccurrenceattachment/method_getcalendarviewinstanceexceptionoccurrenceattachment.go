...
func (c CalendarCalendarViewInstanceExceptionOccurrenceAttachmentClient) GetCalendarViewInstanceExceptionOccurrenceAttachment(ctx context.Context, id beta.GroupIdCalendarCalendarViewIdInstanceIdExceptionOccurrenceIdAttachmentId, options GetCalendarViewInstanceExceptionOccurrenceAttachmentOperationOptions) (result GetCalendarViewInstanceExceptionOccurrenceAttachmentOperationResponse, err error) {
