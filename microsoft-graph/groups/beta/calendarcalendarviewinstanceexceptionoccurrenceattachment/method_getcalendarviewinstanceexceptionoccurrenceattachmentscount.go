...
func (c CalendarCalendarViewInstanceExceptionOccurrenceAttachmentClient) GetCalendarViewInstanceExceptionOccurrenceAttachmentsCount(ctx context.Context, id beta.GroupIdCalendarCalendarViewIdInstanceIdExceptionOccurrenceId, options GetCalendarViewInstanceExceptionOccurrenceAttachmentsCountOperationOptions) (result GetCalendarViewInstanceExceptionOccurrenceAttachmentsCountOperationResponse, err error) {
