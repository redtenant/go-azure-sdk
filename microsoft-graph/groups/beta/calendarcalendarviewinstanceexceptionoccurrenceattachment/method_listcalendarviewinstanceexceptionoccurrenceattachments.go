...
func DefaultListCalendarViewInstanceExceptionOccurrenceAttachmentsOperationOptions() ListCalendarViewInstanceExceptionOccurrenceAttachmentsOperationOptions {
	return ListCalendarViewInstanceExceptionOccurrenceAttachmentsOperationOptions{}
}
...
// ListCalendarViewInstanceExceptionOccurrenceAttachments - Get attachments from groups. The collection of
// FileAttachment, ItemAttachment, and referenceAttachment attachments for the event. Navigation property. Read-only.
// Nullable.
func (c CalendarCalendarViewInstanceExceptionOccurrenceAttachmentClient) ListCalendarViewInstanceExceptionOccurrenceAttachments(ctx context.Context, id beta.GroupIdCalendarCalendarViewIdInstanceIdExceptionOccurrenceId, options ListCalendarViewInstanceExceptionOccurrenceAttachmentsOperationOptions) (result ListCalendarViewInstanceExceptionOccurrenceAttachmentsOperationResponse, err error) {
...
func (c CalendarCalendarViewInstanceExceptionOccurrenceAttachmentClient) ListCalendarViewInstanceExceptionOccurrenceAttachmentsComplete(ctx context.Context, id beta.GroupIdCalendarCalendarViewIdInstanceIdExceptionOccurrenceId, options ListCalendarViewInstanceExceptionOccurrenceAttachmentsOperationOptions) (ListCalendarViewInstanceExceptionOccurrenceAttachmentsCompleteResult, error) {
	return c.ListCalendarViewInstanceExceptionOccurrenceAttachmentsCompleteMatchingPredicate(ctx, id, options, AttachmentOperationPredicate{})
}
...
func (c CalendarCalendarViewInstanceExceptionOccurrenceAttachmentClient) ListCalendarViewInstanceExceptionOccurrenceAttachmentsCompleteMatchingPredicate(ctx context.Context, id beta.GroupIdCalendarCalendarViewIdInstanceIdExceptionOccurrenceId, options ListCalendarViewInstanceExceptionOccurrenceAttachmentsOperationOptions, predicate AttachmentOperationPredicate) (result ListCalendarViewInstanceExceptionOccurrenceAttachmentsCompleteResult, err error) {
	items := make([]beta.Attachment, 0)

	resp, err := c.ListCalendarViewInstanceExceptionOccurrenceAttachments(ctx, id, options)
	if err != nil {
