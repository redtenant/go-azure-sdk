...
func (c CalendarCalendarViewInstanceExceptionOccurrenceExtensionClient) CreateCalendarViewInstanceExceptionOccurrenceExtension(ctx context.Context, id beta.GroupIdCalendarCalendarViewIdInstanceIdExceptionOccurrenceId, input beta.Extension, options CreateCalendarViewInstanceExceptionOccurrenceExtensionOperationOptions) (result CreateCalendarViewInstanceExceptionOccurrenceExtensionOperationResponse, err error) {
