...
func (c CalendarCalendarViewInstanceExtensionClient) CreateCalendarViewInstanceExtension(ctx context.Context, id beta.GroupIdCalendarCalendarViewIdInstanceId, input beta.Extension, options CreateCalendarViewInstanceExtensionOperationOptions) (result CreateCalendarViewInstanceExtensionOperationResponse, err error) {
