...
// event. Nullable.
func (c CalendarCalendarViewInstanceExtensionClient) ListCalendarViewInstanceExtensions(ctx context.Context, id beta.GroupIdCalendarCalendarViewIdInstanceId, options ListCalendarViewInstanceExtensionsOperationOptions) (result ListCalendarViewInstanceExtensionsOperationResponse, err error) {
...
func (c CalendarCalendarViewInstanceExtensionClient) ListCalendarViewInstanceExtensionsComplete(ctx context.Context, id beta.GroupIdCalendarCalendarViewIdInstanceId, options ListCalendarViewInstanceExtensionsOperationOptions) (ListCalendarViewInstanceExtensionsCompleteResult, error) {
...
func (c CalendarCalendarViewInstanceExtensionClient) ListCalendarViewInstanceExtensionsCompleteMatchingPredicate(ctx context.Context, id beta.GroupIdCalendarCalendarViewIdInstanceId, options ListCalendarViewInstanceExtensionsOperationOptions, predicate ExtensionOperationPredicate) (result ListCalendarViewInstanceExtensionsCompleteResult, err error) {
