...
func DefaultGetCalendarEventExceptionOccurrenceAttachmentOperationOptions() GetCalendarEventExceptionOccurrenceAttachmentOperationOptions {
	return GetCalendarEventExceptionOccurrenceAttachmentOperationOptions{}
}
...
// GetCalendarEventExceptionOccurrenceAttachment - Get attachments from groups. The collection of FileAttachment,
