...
func DefaultDeclineCalendarEventExceptionOccurrenceInstanceOperationOptions() DeclineCalendarEventExceptionOccurrenceInstanceOperationOptions {
	return DeclineCalendarEventExceptionOccurrenceInstanceOperationOptions{}
}
...
// DeclineCalendarEventExceptionOccurrenceInstance - Invoke action decline. Decline invitation to the specified event in
