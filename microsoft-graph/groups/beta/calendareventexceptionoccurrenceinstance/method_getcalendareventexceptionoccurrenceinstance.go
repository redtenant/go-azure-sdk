...
func DefaultGetCalendarEventExceptionOccurrenceInstanceOperationOptions() GetCalendarEventExceptionOccurrenceInstanceOperationOptions {
	return GetCalendarEventExceptionOccurrenceInstanceOperationOptions{}
}
...
// GetCalendarEventExceptionOccurrenceInstance - Get instances from groups. The occurrences of a recurring series, if
