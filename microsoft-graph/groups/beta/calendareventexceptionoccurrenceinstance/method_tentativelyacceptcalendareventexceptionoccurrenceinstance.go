...
func DefaultTentativelyAcceptCalendarEventExceptionOccurrenceInstanceOperationOptions() TentativelyAcceptCalendarEventExceptionOccurrenceInstanceOperationOptions {
	return TentativelyAcceptCalendarEventExceptionOccurrenceInstanceOperationOptions{}
}
...
// TentativelyAcceptCalendarEventExceptionOccurrenceInstance - Invoke action tentativelyAccept. Tentatively accept the
