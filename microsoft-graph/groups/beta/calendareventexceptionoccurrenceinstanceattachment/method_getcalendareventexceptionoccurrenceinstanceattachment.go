...
func DefaultGetCalendarEventExceptionOccurrenceInstanceAttachmentOperationOptions() GetCalendarEventExceptionOccurrenceInstanceAttachmentOperationOptions {
	return GetCalendarEventExceptionOccurrenceInstanceAttachmentOperationOptions{}
}
...
// GetCalendarEventExceptionOccurrenceInstanceAttachment - Get attachments from groups. The collection of
