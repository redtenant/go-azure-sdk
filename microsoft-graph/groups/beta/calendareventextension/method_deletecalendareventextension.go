...
func (c CalendarEventExtensionClient) DeleteCalendarEventExtension(ctx context.Context, id beta.GroupIdCalendarEventIdExtensionId, options DeleteCalendarEventExtensionOperationOptions) (result DeleteCalendarEventExtensionOperationResponse, err error) {
