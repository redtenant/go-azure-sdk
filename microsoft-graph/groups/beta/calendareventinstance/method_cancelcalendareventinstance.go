...
func (c CalendarEventInstanceClient) CancelCalendarEventInstance(ctx context.Context, id beta.GroupIdCalendarEventIdInstanceId, input CancelCalendarEventInstanceRequest, options CancelCalendarEventInstanceOperationOptions) (result CancelCalendarEventInstanceOperationResponse, err error) {
