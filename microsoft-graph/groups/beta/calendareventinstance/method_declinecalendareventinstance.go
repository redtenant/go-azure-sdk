...
func (c CalendarEventInstanceClient) DeclineCalendarEventInstance(ctx context.Context, id beta.GroupIdCalendarEventIdInstanceId, input DeclineCalendarEventInstanceRequest, options DeclineCalendarEventInstanceOperationOptions) (result DeclineCalendarEventInstanceOperationResponse, err error) {
