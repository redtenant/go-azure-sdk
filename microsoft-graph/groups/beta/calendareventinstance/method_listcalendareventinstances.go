...
// Read-only. Nullable.
func (c CalendarEventInstanceClient) ListCalendarEventInstances(ctx context.Context, id beta.GroupIdCalendarEventId, options ListCalendarEventInstancesOperationOptions) (result ListCalendarEventInstancesOperationResponse, err error) {
...
func (c CalendarEventInstanceClient) ListCalendarEventInstancesComplete(ctx context.Context, id beta.GroupIdCalendarEventId, options ListCalendarEventInstancesOperationOptions) (ListCalendarEventInstancesCompleteResult, error) {
...
func (c CalendarEventInstanceClient) ListCalendarEventInstancesCompleteMatchingPredicate(ctx context.Context, id beta.GroupIdCalendarEventId, options ListCalendarEventInstancesOperationOptions, predicate EventOperationPredicate) (result ListCalendarEventInstancesCompleteResult, err error) {
