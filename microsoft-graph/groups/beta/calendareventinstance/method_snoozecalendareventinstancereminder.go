...
func (c CalendarEventInstanceClient) SnoozeCalendarEventInstanceReminder(ctx context.Context, id beta.GroupIdCalendarEventIdInstanceId, input SnoozeCalendarEventInstanceReminderRequest, options SnoozeCalendarEventInstanceReminderOperationOptions) (result SnoozeCalendarEventInstanceReminderOperationResponse, err error) {
