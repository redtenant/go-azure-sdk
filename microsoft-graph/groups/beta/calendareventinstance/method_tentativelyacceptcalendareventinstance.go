...
func (c CalendarEventInstanceClient) TentativelyAcceptCalendarEventInstance(ctx context.Context, id beta.GroupIdCalendarEventIdInstanceId, input TentativelyAcceptCalendarEventInstanceRequest, options TentativelyAcceptCalendarEventInstanceOperationOptions) (result TentativelyAcceptCalendarEventInstanceOperationResponse, err error) {
