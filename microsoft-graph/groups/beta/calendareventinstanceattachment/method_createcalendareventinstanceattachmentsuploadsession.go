...
func (c CalendarEventInstanceAttachmentClient) CreateCalendarEventInstanceAttachmentsUploadSession(ctx context.Context, id beta.GroupIdCalendarEventIdInstanceId, input CreateCalendarEventInstanceAttachmentsUploadSessionRequest, options CreateCalendarEventInstanceAttachmentsUploadSessionOperationOptions) (result CreateCalendarEventInstanceAttachmentsUploadSessionOperationResponse, err error) {
