...
func DefaultGetCalendarEventInstanceAttachmentOperationOptions() GetCalendarEventInstanceAttachmentOperationOptions {
	return GetCalendarEventInstanceAttachmentOperationOptions{}
}
...
// GetCalendarEventInstanceAttachment - Get attachments from groups. The collection of FileAttachment, ItemAttachment,
// and referenceAttachment attachments for the event. Navigation property. Read-only. Nullable.
func (c CalendarEventInstanceAttachmentClient) GetCalendarEventInstanceAttachment(ctx context.Context, id beta.GroupIdCalendarEventIdInstanceIdAttachmentId, options GetCalendarEventInstanceAttachmentOperationOptions) (result GetCalendarEventInstanceAttachmentOperationResponse, err error) {
