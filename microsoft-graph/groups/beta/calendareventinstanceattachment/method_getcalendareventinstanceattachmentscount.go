...
func DefaultGetCalendarEventInstanceAttachmentsCountOperationOptions() GetCalendarEventInstanceAttachmentsCountOperationOptions {
	return GetCalendarEventInstanceAttachmentsCountOperationOptions{}
}
...
func (c CalendarEventInstanceAttachmentClient) GetCalendarEventInstanceAttachmentsCount(ctx context.Context, id beta.GroupIdCalendarEventIdInstanceId, options GetCalendarEventInstanceAttachmentsCountOperationOptions) (result GetCalendarEventInstanceAttachmentsCountOperationResponse, err error) {
