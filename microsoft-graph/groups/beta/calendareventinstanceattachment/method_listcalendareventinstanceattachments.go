...
func DefaultListCalendarEventInstanceAttachmentsOperationOptions() ListCalendarEventInstanceAttachmentsOperationOptions {
	return ListCalendarEventInstanceAttachmentsOperationOptions{}
}
...
// ListCalendarEventInstanceAttachments - Get attachments from groups. The collection of FileAttachment, ItemAttachment,
// and referenceAttachment attachments for the event. Navigation property. Read-only. Nullable.
func (c CalendarEventInstanceAttachmentClient) ListCalendarEventInstanceAttachments(ctx context.Context, id beta.GroupIdCalendarEventIdInstanceId, options ListCalendarEventInstanceAttachmentsOperationOptions) (result ListCalendarEventInstanceAttachmentsOperationResponse, err error) {
...
func (c CalendarEventInstanceAttachmentClient) ListCalendarEventInstanceAttachmentsComplete(ctx context.Context, id beta.GroupIdCalendarEventIdInstanceId, options ListCalendarEventInstanceAttachmentsOperationOptions) (ListCalendarEventInstanceAttachmentsCompleteResult, error) {
	return c.ListCalendarEventInstanceAttachmentsCompleteMatchingPredicate(ctx, id, options, AttachmentOperationPredicate{})
}

// ListCalendarEventInstanceAttachmentsCompleteMatchingPredicate retrieves all the results and then applies the predicate
func (c CalendarEventInstanceAttachmentClient) ListCalendarEventInstanceAttachmentsCompleteMatchingPredicate(ctx context.Context, id beta.GroupIdCalendarEventIdInstanceId, options ListCalendarEventInstanceAttachmentsOperationOptions, predicate AttachmentOperationPredicate) (result ListCalendarEventInstanceAttachmentsCompleteResult, err error) {
	items := make([]beta.Attachment, 0)

	resp, err := c.ListCalendarEventInstanceAttachments(ctx, id, options)
	if err != nil {
