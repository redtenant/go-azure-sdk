...
// property. Read-only.
func (c CalendarEventInstanceCalendarClient) GetCalendarEventInstanceCalendar(ctx context.Context, id beta.GroupIdCalendarEventIdInstanceId, options GetCalendarEventInstanceCalendarOperationOptions) (result GetCalendarEventInstanceCalendarOperationResponse, err error) {
