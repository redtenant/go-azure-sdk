...
func DefaultGetCalendarEventInstanceExceptionOccurrenceAttachmentOperationOptions() GetCalendarEventInstanceExceptionOccurrenceAttachmentOperationOptions {
	return GetCalendarEventInstanceExceptionOccurrenceAttachmentOperationOptions{}
}
...
// GetCalendarEventInstanceExceptionOccurrenceAttachment - Get attachments from groups. The collection of
