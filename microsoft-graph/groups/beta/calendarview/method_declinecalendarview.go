...
func (c CalendarViewClient) DeclineCalendarView(ctx context.Context, id beta.GroupIdCalendarViewId, input DeclineCalendarViewRequest, options DeclineCalendarViewOperationOptions) (result DeclineCalendarViewOperationResponse, err error) {
