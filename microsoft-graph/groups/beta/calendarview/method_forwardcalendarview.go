...
// Outlook.com account.
func (c CalendarViewClient) ForwardCalendarView(ctx context.Context, id beta.GroupIdCalendarViewId, input ForwardCalendarViewRequest, options ForwardCalendarViewOperationOptions) (result ForwardCalendarViewOperationResponse, err error) {
