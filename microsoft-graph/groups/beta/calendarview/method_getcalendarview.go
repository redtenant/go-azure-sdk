...
func (c CalendarViewClient) GetCalendarView(ctx context.Context, id beta.GroupIdCalendarViewId, options GetCalendarViewOperationOptions) (result GetCalendarViewOperationResponse, err error) {
