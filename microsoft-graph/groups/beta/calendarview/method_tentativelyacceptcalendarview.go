...
func (c CalendarViewClient) TentativelyAcceptCalendarView(ctx context.Context, id beta.GroupIdCalendarViewId, input TentativelyAcceptCalendarViewRequest, options TentativelyAcceptCalendarViewOperationOptions) (result TentativelyAcceptCalendarViewOperationResponse, err error) {
