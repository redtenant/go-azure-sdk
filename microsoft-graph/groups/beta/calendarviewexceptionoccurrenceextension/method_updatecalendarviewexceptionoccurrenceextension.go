...
type UpdateCalendarViewExceptionOccurrenceExtensionOperationResponse struct {
...
func (c CalendarViewExceptionOccurrenceExtensionClient) UpdateCalendarViewExceptionOccurrenceExtension(ctx context.Context, id beta.GroupIdCalendarViewIdExceptionOccurrenceIdExtensionId, input beta.Extension, options UpdateCalendarViewExceptionOccurrenceExtensionOperationOptions) (result UpdateCalendarViewExceptionOccurrenceExtensionOperationResponse, err error) {
