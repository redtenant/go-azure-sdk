...
func (c CalendarViewExceptionOccurrenceInstanceClient) ListCalendarViewExceptionOccurrenceInstances(ctx context.Context, id beta.GroupIdCalendarViewIdExceptionOccurrenceId, options ListCalendarViewExceptionOccurrenceInstancesOperationOptions) (result ListCalendarViewExceptionOccurrenceInstancesOperationResponse, err error) {
...
func (c CalendarViewExceptionOccurrenceInstanceClient) ListCalendarViewExceptionOccurrenceInstancesComplete(ctx context.Context, id beta.GroupIdCalendarViewIdExceptionOccurrenceId, options ListCalendarViewExceptionOccurrenceInstancesOperationOptions) (ListCalendarViewExceptionOccurrenceInstancesCompleteResult, error) {
...
func (c CalendarViewExceptionOccurrenceInstanceClient) ListCalendarViewExceptionOccurrenceInstancesCompleteMatchingPredicate(ctx context.Context, id beta.GroupIdCalendarViewIdExceptionOccurrenceId, options ListCalendarViewExceptionOccurrenceInstancesOperationOptions, predicate EventOperationPredicate) (result ListCalendarViewExceptionOccurrenceInstancesCompleteResult, err error) {
