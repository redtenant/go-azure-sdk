...
func (c CalendarViewExtensionClient) CreateCalendarViewExtension(ctx context.Context, id beta.GroupIdCalendarViewId, input beta.Extension, options CreateCalendarViewExtensionOperationOptions) (result CreateCalendarViewExtensionOperationResponse, err error) {
