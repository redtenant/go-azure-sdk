...
// Nullable.
func (c CalendarViewExtensionClient) ListCalendarViewExtensions(ctx context.Context, id beta.GroupIdCalendarViewId, options ListCalendarViewExtensionsOperationOptions) (result ListCalendarViewExtensionsOperationResponse, err error) {
...
func (c CalendarViewExtensionClient) ListCalendarViewExtensionsComplete(ctx context.Context, id beta.GroupIdCalendarViewId, options ListCalendarViewExtensionsOperationOptions) (ListCalendarViewExtensionsCompleteResult, error) {
...
func (c CalendarViewExtensionClient) ListCalendarViewExtensionsCompleteMatchingPredicate(ctx context.Context, id beta.GroupIdCalendarViewId, options ListCalendarViewExtensionsOperationOptions, predicate ExtensionOperationPredicate) (result ListCalendarViewExtensionsCompleteResult, err error) {
