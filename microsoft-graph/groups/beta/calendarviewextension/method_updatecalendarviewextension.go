...
func (c CalendarViewExtensionClient) UpdateCalendarViewExtension(ctx context.Context, id beta.GroupIdCalendarViewIdExtensionId, input beta.Extension, options UpdateCalendarViewExtensionOperationOptions) (result UpdateCalendarViewExtensionOperationResponse, err error) {
