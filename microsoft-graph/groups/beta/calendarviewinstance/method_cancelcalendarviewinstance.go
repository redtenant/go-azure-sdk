...
func (c CalendarViewInstanceClient) CancelCalendarViewInstance(ctx context.Context, id beta.GroupIdCalendarViewIdInstanceId, input CancelCalendarViewInstanceRequest, options CancelCalendarViewInstanceOperationOptions) (result CancelCalendarViewInstanceOperationResponse, err error) {
