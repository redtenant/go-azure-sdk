...
func (c CalendarViewInstanceClient) DismissCalendarViewInstanceReminder(ctx context.Context, id beta.GroupIdCalendarViewIdInstanceId, options DismissCalendarViewInstanceReminderOperationOptions) (result DismissCalendarViewInstanceReminderOperationResponse, err error) {
