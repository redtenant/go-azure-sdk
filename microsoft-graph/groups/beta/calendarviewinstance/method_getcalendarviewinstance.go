...
// Nullable.
func (c CalendarViewInstanceClient) GetCalendarViewInstance(ctx context.Context, id beta.GroupIdCalendarViewIdInstanceId, options GetCalendarViewInstanceOperationOptions) (result GetCalendarViewInstanceOperationResponse, err error) {
