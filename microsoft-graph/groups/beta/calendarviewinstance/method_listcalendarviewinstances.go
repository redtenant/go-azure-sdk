...
// Read-only. Nullable.
func (c CalendarViewInstanceClient) ListCalendarViewInstances(ctx context.Context, id beta.GroupIdCalendarViewId, options ListCalendarViewInstancesOperationOptions) (result ListCalendarViewInstancesOperationResponse, err error) {
...
func (c CalendarViewInstanceClient) ListCalendarViewInstancesComplete(ctx context.Context, id beta.GroupIdCalendarViewId, options ListCalendarViewInstancesOperationOptions) (ListCalendarViewInstancesCompleteResult, error) {
...
func (c CalendarViewInstanceClient) ListCalendarViewInstancesCompleteMatchingPredicate(ctx context.Context, id beta.GroupIdCalendarViewId, options ListCalendarViewInstancesOperationOptions, predicate EventOperationPredicate) (result ListCalendarViewInstancesCompleteResult, err error) {
