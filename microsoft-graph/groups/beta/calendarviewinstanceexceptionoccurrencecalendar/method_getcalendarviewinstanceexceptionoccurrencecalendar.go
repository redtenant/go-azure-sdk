...
func (c CalendarViewInstanceExceptionOccurrenceCalendarClient) GetCalendarViewInstanceExceptionOccurrenceCalendar(ctx context.Context, id beta.GroupIdCalendarViewIdInstanceIdExceptionOccurrenceId, options GetCalendarViewInstanceExceptionOccurrenceCalendarOperationOptions) (result GetCalendarViewInstanceExceptionOccurrenceCalendarOperationResponse, err error) {
