...
func (c CalendarViewInstanceExtensionClient) CreateCalendarViewInstanceExtension(ctx context.Context, id beta.GroupIdCalendarViewIdInstanceId, input beta.Extension, options CreateCalendarViewInstanceExtensionOperationOptions) (result CreateCalendarViewInstanceExtensionOperationResponse, err error) {
