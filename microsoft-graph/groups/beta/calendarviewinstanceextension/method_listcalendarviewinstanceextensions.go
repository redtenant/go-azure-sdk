...
// event. Nullable.
func (c CalendarViewInstanceExtensionClient) ListCalendarViewInstanceExtensions(ctx context.Context, id beta.GroupIdCalendarViewIdInstanceId, options ListCalendarViewInstanceExtensionsOperationOptions) (result ListCalendarViewInstanceExtensionsOperationResponse, err error) {
...
func (c CalendarViewInstanceExtensionClient) ListCalendarViewInstanceExtensionsComplete(ctx context.Context, id beta.GroupIdCalendarViewIdInstanceId, options ListCalendarViewInstanceExtensionsOperationOptions) (ListCalendarViewInstanceExtensionsCompleteResult, error) {
...
func (c CalendarViewInstanceExtensionClient) ListCalendarViewInstanceExtensionsCompleteMatchingPredicate(ctx context.Context, id beta.GroupIdCalendarViewIdInstanceId, options ListCalendarViewInstanceExtensionsOperationOptions, predicate ExtensionOperationPredicate) (result ListCalendarViewInstanceExtensionsCompleteResult, err error) {
