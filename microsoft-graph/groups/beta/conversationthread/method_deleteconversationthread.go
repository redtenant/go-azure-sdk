...
func DefaultDeleteConversationThreadOperationOptions() DeleteConversationThreadOperationOptions {
	return DeleteConversationThreadOperationOptions{}
}
...
func (c ConversationThreadClient) DeleteConversationThread(ctx context.Context, id beta.GroupIdConversationIdThreadId, options DeleteConversationThreadOperationOptions) (result DeleteConversationThreadOperationResponse, err error) {
