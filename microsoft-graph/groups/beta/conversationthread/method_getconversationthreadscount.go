...
func DefaultGetConversationThreadsCountOperationOptions() GetConversationThreadsCountOperationOptions {
	return GetConversationThreadsCountOperationOptions{}
}
...
func (c ConversationThreadClient) GetConversationThreadsCount(ctx context.Context, id beta.GroupIdConversationId, options GetConversationThreadsCountOperationOptions) (result GetConversationThreadsCountOperationResponse, err error) {
