...
func DefaultGetConversationThreadPostOperationOptions() GetConversationThreadPostOperationOptions {
	return GetConversationThreadPostOperationOptions{}
}
...
func (c ConversationThreadPostClient) GetConversationThreadPost(ctx context.Context, id beta.GroupIdConversationIdThreadIdPostId, options GetConversationThreadPostOperationOptions) (result GetConversationThreadPostOperationResponse, err error) {
