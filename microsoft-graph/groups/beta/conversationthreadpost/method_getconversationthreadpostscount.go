...
func DefaultGetConversationThreadPostsCountOperationOptions() GetConversationThreadPostsCountOperationOptions {
	return GetConversationThreadPostsCountOperationOptions{}
}
...
func (c ConversationThreadPostClient) GetConversationThreadPostsCount(ctx context.Context, id beta.GroupIdConversationIdThreadId, options GetConversationThreadPostsCountOperationOptions) (result GetConversationThreadPostsCountOperationResponse, err error) {
