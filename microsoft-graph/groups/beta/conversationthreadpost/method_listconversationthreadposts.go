...
func (c ConversationThreadPostClient) ListConversationThreadPosts(ctx context.Context, id beta.GroupIdConversationIdThreadId, options ListConversationThreadPostsOperationOptions) (result ListConversationThreadPostsOperationResponse, err error) {
...
func (c ConversationThreadPostClient) ListConversationThreadPostsComplete(ctx context.Context, id beta.GroupIdConversationIdThreadId, options ListConversationThreadPostsOperationOptions) (ListConversationThreadPostsCompleteResult, error) {
...
func (c ConversationThreadPostClient) ListConversationThreadPostsCompleteMatchingPredicate(ctx context.Context, id beta.GroupIdConversationIdThreadId, options ListConversationThreadPostsOperationOptions, predicate PostOperationPredicate) (result ListConversationThreadPostsCompleteResult, err error) {
