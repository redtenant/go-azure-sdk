...
func (c ConversationThreadPostExtensionClient) GetConversationThreadPostExtension(ctx context.Context, id beta.GroupIdConversationIdThreadIdPostIdExtensionId, options GetConversationThreadPostExtensionOperationOptions) (result GetConversationThreadPostExtensionOperationResponse, err error) {
