...
func (c ConversationThreadPostInReplyToAttachmentClient) CreateConversationThreadPostInReplyToAttachment(ctx context.Context, id beta.GroupIdConversationIdThreadIdPostId, input beta.Attachment, options CreateConversationThreadPostInReplyToAttachmentOperationOptions) (result CreateConversationThreadPostInReplyToAttachmentOperationResponse, err error) {
