...
func (c ConversationThreadPostInReplyToAttachmentClient) CreateConversationThreadPostInReplyToAttachmentsUploadSession(ctx context.Context, id beta.GroupIdConversationIdThreadIdPostId, input CreateConversationThreadPostInReplyToAttachmentsUploadSessionRequest, options CreateConversationThreadPostInReplyToAttachmentsUploadSessionOperationOptions) (result CreateConversationThreadPostInReplyToAttachmentsUploadSessionOperationResponse, err error) {
