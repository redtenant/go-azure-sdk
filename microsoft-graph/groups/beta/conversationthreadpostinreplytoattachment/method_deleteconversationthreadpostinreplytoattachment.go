...
func (c ConversationThreadPostInReplyToAttachmentClient) DeleteConversationThreadPostInReplyToAttachment(ctx context.Context, id beta.GroupIdConversationIdThreadIdPostIdInReplyToAttachmentId, options DeleteConversationThreadPostInReplyToAttachmentOperationOptions) (result DeleteConversationThreadPostInReplyToAttachmentOperationResponse, err error) {
