...
func (c ConversationThreadPostInReplyToExtensionClient) ListConversationThreadPostInReplyToExtensions(ctx context.Context, id beta.GroupIdConversationIdThreadIdPostId, options ListConversationThreadPostInReplyToExtensionsOperationOptions) (result ListConversationThreadPostInReplyToExtensionsOperationResponse, err error) {
...
func (c ConversationThreadPostInReplyToExtensionClient) ListConversationThreadPostInReplyToExtensionsComplete(ctx context.Context, id beta.GroupIdConversationIdThreadIdPostId, options ListConversationThreadPostInReplyToExtensionsOperationOptions) (ListConversationThreadPostInReplyToExtensionsCompleteResult, error) {
