...
func (c DriveClient) DeleteDrive(ctx context.Context, id beta.GroupIdDriveId, options DeleteDriveOperationOptions) (result DeleteDriveOperationResponse, err error) {
