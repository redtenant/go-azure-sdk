...
func (c DriveClient) GetDrivesCount(ctx context.Context, id beta.GroupId, options GetDrivesCountOperationOptions) (result GetDrivesCountOperationResponse, err error) {
