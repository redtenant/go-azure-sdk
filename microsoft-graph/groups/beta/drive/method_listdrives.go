...
func (c DriveClient) ListDrives(ctx context.Context, id beta.GroupId, options ListDrivesOperationOptions) (result ListDrivesOperationResponse, err error) {
...
func (c DriveClient) ListDrivesComplete(ctx context.Context, id beta.GroupId, options ListDrivesOperationOptions) (ListDrivesCompleteResult, error) {
...
func (c DriveClient) ListDrivesCompleteMatchingPredicate(ctx context.Context, id beta.GroupId, options ListDrivesOperationOptions, predicate DriveOperationPredicate) (result ListDrivesCompleteResult, err error) {
