...
func (c DriveClient) UpdateDrive(ctx context.Context, id beta.GroupIdDriveId, input beta.Drive, options UpdateDriveOperationOptions) (result UpdateDriveOperationResponse, err error) {
