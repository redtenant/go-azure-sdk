...
type CreateDriveActivityOperationResponse struct {
...
// CreateDriveActivity - Create new navigation property to activities for groups
func (c DriveActivityClient) CreateDriveActivity(ctx context.Context, id beta.GroupIdDriveId, input beta.ItemActivityOLD, options CreateDriveActivityOperationOptions) (result CreateDriveActivityOperationResponse, err error) {
