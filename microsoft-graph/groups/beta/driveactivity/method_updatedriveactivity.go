...
// UpdateDriveActivity - Update the navigation property activities in groups
func (c DriveActivityClient) UpdateDriveActivity(ctx context.Context, id beta.GroupIdDriveIdActivityId, input beta.ItemActivityOLD, options UpdateDriveActivityOperationOptions) (result UpdateDriveActivityOperationResponse, err error) {
