...
func DefaultDeleteDriveActivityDriveItemContentOperationOptions() DeleteDriveActivityDriveItemContentOperationOptions {
	return DeleteDriveActivityDriveItemContentOperationOptions{}
}
...
// DeleteDriveActivityDriveItemContent - Delete content for the navigation property driveItem in groups. The content
...
func (c DriveActivityDriveItemContentClient) DeleteDriveActivityDriveItemContent(ctx context.Context, id beta.GroupIdDriveIdActivityId, options DeleteDriveActivityDriveItemContentOperationOptions) (result DeleteDriveActivityDriveItemContentOperationResponse, err error) {
