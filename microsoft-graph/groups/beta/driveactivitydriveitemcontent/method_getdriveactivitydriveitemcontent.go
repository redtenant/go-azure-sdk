...
// GetDriveActivityDriveItemContent - Get content for the navigation property driveItem from groups. The content stream,
...
func (c DriveActivityDriveItemContentClient) GetDriveActivityDriveItemContent(ctx context.Context, id beta.GroupIdDriveIdActivityId, options GetDriveActivityDriveItemContentOperationOptions) (result GetDriveActivityDriveItemContentOperationResponse, err error) {
