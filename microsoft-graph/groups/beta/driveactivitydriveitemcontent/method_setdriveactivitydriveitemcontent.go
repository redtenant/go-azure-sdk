...
// SetDriveActivityDriveItemContent - Update content for the navigation property driveItem in groups. The content
...
func (c DriveActivityDriveItemContentClient) SetDriveActivityDriveItemContent(ctx context.Context, id beta.GroupIdDriveIdActivityId, input []byte, options SetDriveActivityDriveItemContentOperationOptions) (result SetDriveActivityDriveItemContentOperationResponse, err error) {
