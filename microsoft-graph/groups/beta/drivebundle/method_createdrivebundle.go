...
func (c DriveBundleClient) CreateDriveBundle(ctx context.Context, id beta.GroupIdDriveId, input beta.DriveItem, options CreateDriveBundleOperationOptions) (result CreateDriveBundleOperationResponse, err error) {
