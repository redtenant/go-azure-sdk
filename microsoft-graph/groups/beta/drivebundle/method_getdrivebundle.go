...
func (c DriveBundleClient) GetDriveBundle(ctx context.Context, id beta.GroupIdDriveIdBundleId, options GetDriveBundleOperationOptions) (result GetDriveBundleOperationResponse, err error) {
