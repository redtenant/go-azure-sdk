...
func (c DriveBundleClient) GetDriveBundlesCount(ctx context.Context, id beta.GroupIdDriveId, options GetDriveBundlesCountOperationOptions) (result GetDriveBundlesCountOperationResponse, err error) {
