...
func (c DriveBundleClient) ListDriveBundles(ctx context.Context, id beta.GroupIdDriveId, options ListDriveBundlesOperationOptions) (result ListDriveBundlesOperationResponse, err error) {
...
func (c DriveBundleClient) ListDriveBundlesComplete(ctx context.Context, id beta.GroupIdDriveId, options ListDriveBundlesOperationOptions) (ListDriveBundlesCompleteResult, error) {
...
func (c DriveBundleClient) ListDriveBundlesCompleteMatchingPredicate(ctx context.Context, id beta.GroupIdDriveId, options ListDriveBundlesOperationOptions, predicate DriveItemOperationPredicate) (result ListDriveBundlesCompleteResult, err error) {
