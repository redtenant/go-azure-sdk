...
// Business.
func (c DriveFollowingClient) GetDriveFollowing(ctx context.Context, id beta.GroupIdDriveIdFollowingId, options GetDriveFollowingOperationOptions) (result GetDriveFollowingOperationResponse, err error) {
