...
func (c DriveFollowingClient) GetDriveFollowingCount(ctx context.Context, id beta.GroupIdDriveId, options GetDriveFollowingCountOperationOptions) (result GetDriveFollowingCountOperationResponse, err error) {
