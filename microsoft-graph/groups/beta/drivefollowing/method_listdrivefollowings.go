...
// ListDriveFollowings - Get following from groups. The list of items the user is following. Only in OneDrive for
// Business.
func (c DriveFollowingClient) ListDriveFollowings(ctx context.Context, id beta.GroupIdDriveId, options ListDriveFollowingsOperationOptions) (result ListDriveFollowingsOperationResponse, err error) {
...
func (c DriveFollowingClient) ListDriveFollowingsComplete(ctx context.Context, id beta.GroupIdDriveId, options ListDriveFollowingsOperationOptions) (ListDriveFollowingsCompleteResult, error) {
...
func (c DriveFollowingClient) ListDriveFollowingsCompleteMatchingPredicate(ctx context.Context, id beta.GroupIdDriveId, options ListDriveFollowingsOperationOptions, predicate DriveItemOperationPredicate) (result ListDriveFollowingsCompleteResult, err error) {
