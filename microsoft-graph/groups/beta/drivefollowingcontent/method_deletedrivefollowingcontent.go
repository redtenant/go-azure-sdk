...
// DeleteDriveFollowingContent - Delete content for the navigation property following in groups. The content stream, if
...
func (c DriveFollowingContentClient) DeleteDriveFollowingContent(ctx context.Context, id beta.GroupIdDriveIdFollowingId, options DeleteDriveFollowingContentOperationOptions) (result DeleteDriveFollowingContentOperationResponse, err error) {
