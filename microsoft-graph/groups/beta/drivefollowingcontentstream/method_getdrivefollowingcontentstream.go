...
// GetDriveFollowingContentStream - Get contentStream for the navigation property following from groups. The content
// stream, if the item represents a file.
func (c DriveFollowingContentStreamClient) GetDriveFollowingContentStream(ctx context.Context, id beta.GroupIdDriveIdFollowingId, options GetDriveFollowingContentStreamOperationOptions) (result GetDriveFollowingContentStreamOperationResponse, err error) {
