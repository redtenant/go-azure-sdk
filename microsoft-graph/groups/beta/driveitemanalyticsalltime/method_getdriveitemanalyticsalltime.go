...
func (c DriveItemAnalyticsAllTimeClient) GetDriveItemAnalyticsAllTime(ctx context.Context, id beta.GroupIdDriveIdItemId, options GetDriveItemAnalyticsAllTimeOperationOptions) (result GetDriveItemAnalyticsAllTimeOperationResponse, err error) {
