...
// UpdateDriveItemAnalyticsItemActivityStatActivity - Update the navigation property activities in groups
func (c DriveItemAnalyticsItemActivityStatActivityClient) UpdateDriveItemAnalyticsItemActivityStatActivity(ctx context.Context, id beta.GroupIdDriveIdItemIdAnalyticsItemActivityStatIdActivityId, input beta.ItemActivity, options UpdateDriveItemAnalyticsItemActivityStatActivityOperationOptions) (result UpdateDriveItemAnalyticsItemActivityStatActivityOperationResponse, err error) {
