...
func (c DriveItemChildClient) CreateDriveItemChild(ctx context.Context, id beta.GroupIdDriveIdItemId, input beta.DriveItem, options CreateDriveItemChildOperationOptions) (result CreateDriveItemChildOperationResponse, err error) {
