...
// GetDriveItemChild - Get children from groups. Collection containing Item objects for the immediate children of Item.
// Only items representing folders have children. Read-only. Nullable.
func (c DriveItemChildClient) GetDriveItemChild(ctx context.Context, id beta.GroupIdDriveIdItemIdChildId, options GetDriveItemChildOperationOptions) (result GetDriveItemChildOperationResponse, err error) {
