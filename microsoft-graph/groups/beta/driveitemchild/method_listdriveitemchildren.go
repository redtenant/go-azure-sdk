...
// ListDriveItemChildren - Get children from groups. Collection containing Item objects for the immediate children of
// Item. Only items representing folders have children. Read-only. Nullable.
func (c DriveItemChildClient) ListDriveItemChildren(ctx context.Context, id beta.GroupIdDriveIdItemId, options ListDriveItemChildrenOperationOptions) (result ListDriveItemChildrenOperationResponse, err error) {
...
func (c DriveItemChildClient) ListDriveItemChildrenComplete(ctx context.Context, id beta.GroupIdDriveIdItemId, options ListDriveItemChildrenOperationOptions) (ListDriveItemChildrenCompleteResult, error) {
...
func (c DriveItemChildClient) ListDriveItemChildrenCompleteMatchingPredicate(ctx context.Context, id beta.GroupIdDriveIdItemId, options ListDriveItemChildrenOperationOptions, predicate DriveItemOperationPredicate) (result ListDriveItemChildrenCompleteResult, err error) {
