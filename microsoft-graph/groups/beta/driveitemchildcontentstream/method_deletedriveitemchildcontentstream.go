...
// DeleteDriveItemChildContentStream - Delete contentStream for the navigation property children in groups. The content
// stream, if the item represents a file.
func (c DriveItemChildContentStreamClient) DeleteDriveItemChildContentStream(ctx context.Context, id beta.GroupIdDriveIdItemIdChildId, options DeleteDriveItemChildContentStreamOperationOptions) (result DeleteDriveItemChildContentStreamOperationResponse, err error) {
