...
// GetDriveItemChildContentStream - Get contentStream for the navigation property children from groups. The content
// stream, if the item represents a file.
func (c DriveItemChildContentStreamClient) GetDriveItemChildContentStream(ctx context.Context, id beta.GroupIdDriveIdItemIdChildId, options GetDriveItemChildContentStreamOperationOptions) (result GetDriveItemChildContentStreamOperationResponse, err error) {
