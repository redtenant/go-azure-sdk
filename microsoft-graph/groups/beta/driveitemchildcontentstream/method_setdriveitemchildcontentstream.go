...
// SetDriveItemChildContentStream - Update contentStream for the navigation property children in groups. The content
// stream, if the item represents a file.
func (c DriveItemChildContentStreamClient) SetDriveItemChildContentStream(ctx context.Context, id beta.GroupIdDriveIdItemIdChildId, input []byte, options SetDriveItemChildContentStreamOperationOptions) (result SetDriveItemChildContentStreamOperationResponse, err error) {
