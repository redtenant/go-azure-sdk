...
func (c DriveItemContentClient) DeleteDriveItemContent(ctx context.Context, id beta.GroupIdDriveIdItemId, options DeleteDriveItemContentOperationOptions) (result DeleteDriveItemContentOperationResponse, err error) {
