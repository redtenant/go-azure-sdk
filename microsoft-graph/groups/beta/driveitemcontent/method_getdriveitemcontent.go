...
func (c DriveItemContentClient) GetDriveItemContent(ctx context.Context, id beta.GroupIdDriveIdItemId, options GetDriveItemContentOperationOptions) (result GetDriveItemContentOperationResponse, err error) {
