...
func (c DriveItemContentClient) SetDriveItemContent(ctx context.Context, id beta.GroupIdDriveIdItemId, input []byte, options SetDriveItemContentOperationOptions) (result SetDriveItemContentOperationResponse, err error) {
