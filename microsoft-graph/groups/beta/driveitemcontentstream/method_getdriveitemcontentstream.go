...
// GetDriveItemContentStream - Get contentStream for the navigation property items from groups. The content stream, if
// the item represents a file.
func (c DriveItemContentStreamClient) GetDriveItemContentStream(ctx context.Context, id beta.GroupIdDriveIdItemId, options GetDriveItemContentStreamOperationOptions) (result GetDriveItemContentStreamOperationResponse, err error) {
