...
func (c DriveItemCreatedByUserMailboxSettingClient) GetDriveItemCreatedByUserMailboxSetting(ctx context.Context, id beta.GroupIdDriveIdItemId, options GetDriveItemCreatedByUserMailboxSettingOperationOptions) (result GetDriveItemCreatedByUserMailboxSettingOperationResponse, err error) {
