...
func (c DriveItemListItemClient) DeleteDriveItemListItem(ctx context.Context, id beta.GroupIdDriveIdItemId, options DeleteDriveItemListItemOperationOptions) (result DeleteDriveItemListItemOperationResponse, err error) {
