...
// Read-only. Nullable.
func (c DriveItemListItemClient) GetDriveItemListItem(ctx context.Context, id beta.GroupIdDriveIdItemId, options GetDriveItemListItemOperationOptions) (result GetDriveItemListItemOperationResponse, err error) {
