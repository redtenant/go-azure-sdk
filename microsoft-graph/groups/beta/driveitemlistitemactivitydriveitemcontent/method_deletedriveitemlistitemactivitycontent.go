...
// DeleteDriveItemListItemActivityContent - Delete content for the navigation property driveItem in groups. The content
...
func (c DriveItemListItemActivityDriveItemContentClient) DeleteDriveItemListItemActivityContent(ctx context.Context, id beta.GroupIdDriveIdItemIdListItemActivityId, options DeleteDriveItemListItemActivityContentOperationOptions) (result DeleteDriveItemListItemActivityContentOperationResponse, err error) {
