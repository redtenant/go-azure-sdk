...
func DefaultGetDriveItemListItemActivityContentOperationOptions() GetDriveItemListItemActivityContentOperationOptions {
	return GetDriveItemListItemActivityContentOperationOptions{}
}
...
// GetDriveItemListItemActivityContent - Get content for the navigation property driveItem from groups. The content
...
func (c DriveItemListItemActivityDriveItemContentClient) GetDriveItemListItemActivityContent(ctx context.Context, id beta.GroupIdDriveIdItemIdListItemActivityId, options GetDriveItemListItemActivityContentOperationOptions) (result GetDriveItemListItemActivityContentOperationResponse, err error) {
