...
// SetDriveItemListItemActivityContent - Update content for the navigation property driveItem in groups. The content
...
func (c DriveItemListItemActivityDriveItemContentClient) SetDriveItemListItemActivityContent(ctx context.Context, id beta.GroupIdDriveIdItemIdListItemActivityId, input []byte, options SetDriveItemListItemActivityContentOperationOptions) (result SetDriveItemListItemActivityContentOperationResponse, err error) {
