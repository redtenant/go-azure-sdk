...
// DeleteDriveItemListItemActivityContentStream - Delete contentStream for the navigation property driveItem in groups.
// The content stream, if the item represents a file.
func (c DriveItemListItemActivityDriveItemContentStreamClient) DeleteDriveItemListItemActivityContentStream(ctx context.Context, id beta.GroupIdDriveIdItemIdListItemActivityId, options DeleteDriveItemListItemActivityContentStreamOperationOptions) (result DeleteDriveItemListItemActivityContentStreamOperationResponse, err error) {
