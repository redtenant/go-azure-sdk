...
// GetDriveItemListItemActivityContentStream - Get contentStream for the navigation property driveItem from groups. The
// content stream, if the item represents a file.
func (c DriveItemListItemActivityDriveItemContentStreamClient) GetDriveItemListItemActivityContentStream(ctx context.Context, id beta.GroupIdDriveIdItemIdListItemActivityId, options GetDriveItemListItemActivityContentStreamOperationOptions) (result GetDriveItemListItemActivityContentStreamOperationResponse, err error) {
