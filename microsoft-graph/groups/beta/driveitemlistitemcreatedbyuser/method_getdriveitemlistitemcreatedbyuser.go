...
// GetDriveItemListItemCreatedByUser - Get createdByUser from groups
func (c DriveItemListItemCreatedByUserClient) GetDriveItemListItemCreatedByUser(ctx context.Context, id beta.GroupIdDriveIdItemId, options GetDriveItemListItemCreatedByUserOperationOptions) (result GetDriveItemListItemCreatedByUserOperationResponse, err error) {
