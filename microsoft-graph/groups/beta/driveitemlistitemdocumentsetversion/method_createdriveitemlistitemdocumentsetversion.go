...
func (c DriveItemListItemDocumentSetVersionClient) CreateDriveItemListItemDocumentSetVersion(ctx context.Context, id beta.GroupIdDriveIdItemId, input beta.DocumentSetVersion, options CreateDriveItemListItemDocumentSetVersionOperationOptions) (result CreateDriveItemListItemDocumentSetVersionOperationResponse, err error) {
