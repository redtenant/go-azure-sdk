...
func (c DriveItemListItemDocumentSetVersionClient) UpdateDriveItemListItemDocumentSetVersion(ctx context.Context, id beta.GroupIdDriveIdItemIdListItemDocumentSetVersionId, input beta.DocumentSetVersion, options UpdateDriveItemListItemDocumentSetVersionOperationOptions) (result UpdateDriveItemListItemDocumentSetVersionOperationResponse, err error) {
