...
func (c DriveItemListItemDriveItemClient) GetDriveItemListItemDriveItem(ctx context.Context, id beta.GroupIdDriveIdItemId, options GetDriveItemListItemDriveItemOperationOptions) (result GetDriveItemListItemDriveItemOperationResponse, err error) {
