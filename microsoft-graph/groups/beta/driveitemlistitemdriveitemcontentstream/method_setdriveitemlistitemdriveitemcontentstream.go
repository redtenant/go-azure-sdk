...
// SetDriveItemListItemDriveItemContentStream - Update contentStream for the navigation property driveItem in groups.
// The content stream, if the item represents a file.
func (c DriveItemListItemDriveItemContentStreamClient) SetDriveItemListItemDriveItemContentStream(ctx context.Context, id beta.GroupIdDriveIdItemId, input []byte, options SetDriveItemListItemDriveItemContentStreamOperationOptions) (result SetDriveItemListItemDriveItemContentStreamOperationResponse, err error) {
