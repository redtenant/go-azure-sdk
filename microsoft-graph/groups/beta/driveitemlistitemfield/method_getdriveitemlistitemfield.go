...
func (c DriveItemListItemFieldClient) GetDriveItemListItemField(ctx context.Context, id beta.GroupIdDriveIdItemId, options GetDriveItemListItemFieldOperationOptions) (result GetDriveItemListItemFieldOperationResponse, err error) {
