...
// GetDriveItemListItemLastModifiedByUser - Get lastModifiedByUser from groups
func (c DriveItemListItemLastModifiedByUserClient) GetDriveItemListItemLastModifiedByUser(ctx context.Context, id beta.GroupIdDriveIdItemId, options GetDriveItemListItemLastModifiedByUserOperationOptions) (result GetDriveItemListItemLastModifiedByUserOperationResponse, err error) {
