...
// on $select.
func (c DriveItemListItemLastModifiedByUserMailboxSettingClient) GetDriveItemListItemLastModifiedByUserMailboxSetting(ctx context.Context, id beta.GroupIdDriveIdItemId, options GetDriveItemListItemLastModifiedByUserMailboxSettingOperationOptions) (result GetDriveItemListItemLastModifiedByUserMailboxSettingOperationResponse, err error) {
