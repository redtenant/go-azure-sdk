...
func (c DriveItemListItemLastModifiedByUserMailboxSettingClient) UpdateDriveItemListItemLastModifiedByUserMailboxSetting(ctx context.Context, id beta.GroupIdDriveIdItemId, input beta.MailboxSettings, options UpdateDriveItemListItemLastModifiedByUserMailboxSettingOperationOptions) (result UpdateDriveItemListItemLastModifiedByUserMailboxSettingOperationResponse, err error) {
