...
func (c DriveItemListItemLastModifiedByUserServiceProvisioningErrorClient) ListDriveItemListItemLastModifiedByUserServiceProvisioningErrors(ctx context.Context, id beta.GroupIdDriveIdItemId, options ListDriveItemListItemLastModifiedByUserServiceProvisioningErrorsOperationOptions) (result ListDriveItemListItemLastModifiedByUserServiceProvisioningErrorsOperationResponse, err error) {
...
func (c DriveItemListItemLastModifiedByUserServiceProvisioningErrorClient) ListDriveItemListItemLastModifiedByUserServiceProvisioningErrorsComplete(ctx context.Context, id beta.GroupIdDriveIdItemId, options ListDriveItemListItemLastModifiedByUserServiceProvisioningErrorsOperationOptions) (ListDriveItemListItemLastModifiedByUserServiceProvisioningErrorsCompleteResult, error) {
...
func (c DriveItemListItemLastModifiedByUserServiceProvisioningErrorClient) ListDriveItemListItemLastModifiedByUserServiceProvisioningErrorsCompleteMatchingPredicate(ctx context.Context, id beta.GroupIdDriveIdItemId, options ListDriveItemListItemLastModifiedByUserServiceProvisioningErrorsOperationOptions, predicate ServiceProvisioningErrorOperationPredicate) (result ListDriveItemListItemLastModifiedByUserServiceProvisioningErrorsCompleteResult, err error) {
