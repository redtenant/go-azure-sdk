...
func (c DriveItemListItemVersionClient) DeleteDriveItemListItemVersion(ctx context.Context, id beta.GroupIdDriveIdItemIdListItemVersionId, options DeleteDriveItemListItemVersionOperationOptions) (result DeleteDriveItemListItemVersionOperationResponse, err error) {
