...
func (c DriveItemListItemVersionClient) GetDriveItemListItemVersion(ctx context.Context, id beta.GroupIdDriveIdItemIdListItemVersionId, options GetDriveItemListItemVersionOperationOptions) (result GetDriveItemListItemVersionOperationResponse, err error) {
