...
func (c DriveItemListItemVersionFieldClient) DeleteDriveItemListItemVersionField(ctx context.Context, id beta.GroupIdDriveIdItemIdListItemVersionId, options DeleteDriveItemListItemVersionFieldOperationOptions) (result DeleteDriveItemListItemVersionFieldOperationResponse, err error) {
