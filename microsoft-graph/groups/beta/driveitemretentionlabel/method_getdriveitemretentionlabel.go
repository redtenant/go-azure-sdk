...
func (c DriveItemRetentionLabelClient) GetDriveItemRetentionLabel(ctx context.Context, id beta.GroupIdDriveIdItemId, options GetDriveItemRetentionLabelOperationOptions) (result GetDriveItemRetentionLabelOperationResponse, err error) {
