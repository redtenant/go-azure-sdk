...
func (c DriveItemRetentionLabelClient) UpdateDriveItemRetentionLabel(ctx context.Context, id beta.GroupIdDriveIdItemId, input beta.ItemRetentionLabel, options UpdateDriveItemRetentionLabelOperationOptions) (result UpdateDriveItemRetentionLabelOperationResponse, err error) {
