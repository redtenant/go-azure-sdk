...
func (c DriveItemSubscriptionClient) CreateDriveItemSubscription(ctx context.Context, id beta.GroupIdDriveIdItemId, input beta.Subscription, options CreateDriveItemSubscriptionOperationOptions) (result CreateDriveItemSubscriptionOperationResponse, err error) {
