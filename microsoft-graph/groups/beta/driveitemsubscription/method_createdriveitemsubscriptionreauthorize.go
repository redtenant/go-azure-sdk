...
func (c DriveItemSubscriptionClient) CreateDriveItemSubscriptionReauthorize(ctx context.Context, id beta.GroupIdDriveIdItemIdSubscriptionId, options CreateDriveItemSubscriptionReauthorizeOperationOptions) (result CreateDriveItemSubscriptionReauthorizeOperationResponse, err error) {
