...
func (c DriveItemSubscriptionClient) DeleteDriveItemSubscription(ctx context.Context, id beta.GroupIdDriveIdItemIdSubscriptionId, options DeleteDriveItemSubscriptionOperationOptions) (result DeleteDriveItemSubscriptionOperationResponse, err error) {
