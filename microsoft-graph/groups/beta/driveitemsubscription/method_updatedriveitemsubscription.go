...
func (c DriveItemSubscriptionClient) UpdateDriveItemSubscription(ctx context.Context, id beta.GroupIdDriveIdItemIdSubscriptionId, input beta.Subscription, options UpdateDriveItemSubscriptionOperationOptions) (result UpdateDriveItemSubscriptionOperationResponse, err error) {
