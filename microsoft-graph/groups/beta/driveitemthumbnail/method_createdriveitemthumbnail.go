...
func (c DriveItemThumbnailClient) CreateDriveItemThumbnail(ctx context.Context, id beta.GroupIdDriveIdItemId, input beta.ThumbnailSet, options CreateDriveItemThumbnailOperationOptions) (result CreateDriveItemThumbnailOperationResponse, err error) {
