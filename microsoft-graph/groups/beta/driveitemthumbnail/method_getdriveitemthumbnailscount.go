...
func (c DriveItemThumbnailClient) GetDriveItemThumbnailsCount(ctx context.Context, id beta.GroupIdDriveIdItemId, options GetDriveItemThumbnailsCountOperationOptions) (result GetDriveItemThumbnailsCountOperationResponse, err error) {
