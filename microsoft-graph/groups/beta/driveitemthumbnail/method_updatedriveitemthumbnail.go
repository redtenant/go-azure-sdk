...
func (c DriveItemThumbnailClient) UpdateDriveItemThumbnail(ctx context.Context, id beta.GroupIdDriveIdItemIdThumbnailId, input beta.ThumbnailSet, options UpdateDriveItemThumbnailOperationOptions) (result UpdateDriveItemThumbnailOperationResponse, err error) {
