...
func (c DriveItemVersionClient) CreateDriveItemVersion(ctx context.Context, id beta.GroupIdDriveIdItemId, input beta.DriveItemVersion, options CreateDriveItemVersionOperationOptions) (result CreateDriveItemVersionOperationResponse, err error) {
