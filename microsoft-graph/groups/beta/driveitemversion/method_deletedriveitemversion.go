...
func (c DriveItemVersionClient) DeleteDriveItemVersion(ctx context.Context, id beta.GroupIdDriveIdItemIdVersionId, options DeleteDriveItemVersionOperationOptions) (result DeleteDriveItemVersionOperationResponse, err error) {
