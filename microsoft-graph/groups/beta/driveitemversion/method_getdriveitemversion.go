...
// GetDriveItemVersion - Get versions from groups. The list of previous versions of the item. For more info, see getting
// previous versions. Read-only. Nullable.
func (c DriveItemVersionClient) GetDriveItemVersion(ctx context.Context, id beta.GroupIdDriveIdItemIdVersionId, options GetDriveItemVersionOperationOptions) (result GetDriveItemVersionOperationResponse, err error) {
