...
func (c DriveItemVersionClient) GetDriveItemVersionsCount(ctx context.Context, id beta.GroupIdDriveIdItemId, options GetDriveItemVersionsCountOperationOptions) (result GetDriveItemVersionsCountOperationResponse, err error) {
