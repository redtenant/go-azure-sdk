...
func (c DriveItemVersionClient) RestoreDriveItemVersionVersion(ctx context.Context, id beta.GroupIdDriveIdItemIdVersionId, options RestoreDriveItemVersionVersionOperationOptions) (result RestoreDriveItemVersionVersionOperationResponse, err error) {
