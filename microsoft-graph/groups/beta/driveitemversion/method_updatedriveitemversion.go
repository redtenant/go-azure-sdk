...
func (c DriveItemVersionClient) UpdateDriveItemVersion(ctx context.Context, id beta.GroupIdDriveIdItemIdVersionId, input beta.DriveItemVersion, options UpdateDriveItemVersionOperationOptions) (result UpdateDriveItemVersionOperationResponse, err error) {
