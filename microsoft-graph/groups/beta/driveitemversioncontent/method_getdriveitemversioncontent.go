...
// GetDriveItemVersionContent - Get content for the navigation property versions from groups
func (c DriveItemVersionContentClient) GetDriveItemVersionContent(ctx context.Context, id beta.GroupIdDriveIdItemIdVersionId, options GetDriveItemVersionContentOperationOptions) (result GetDriveItemVersionContentOperationResponse, err error) {
