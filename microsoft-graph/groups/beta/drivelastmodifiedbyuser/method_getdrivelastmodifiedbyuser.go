...
// GetDriveLastModifiedByUser - Get lastModifiedByUser from groups
func (c DriveLastModifiedByUserClient) GetDriveLastModifiedByUser(ctx context.Context, id beta.GroupIdDriveId, options GetDriveLastModifiedByUserOperationOptions) (result GetDriveLastModifiedByUserOperationResponse, err error) {
