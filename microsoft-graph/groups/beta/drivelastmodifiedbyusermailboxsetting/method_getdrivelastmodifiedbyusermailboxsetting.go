...
func (c DriveLastModifiedByUserMailboxSettingClient) GetDriveLastModifiedByUserMailboxSetting(ctx context.Context, id beta.GroupIdDriveId, options GetDriveLastModifiedByUserMailboxSettingOperationOptions) (result GetDriveLastModifiedByUserMailboxSettingOperationResponse, err error) {
