...
func (c DriveLastModifiedByUserMailboxSettingClient) UpdateDriveLastModifiedByUserMailboxSetting(ctx context.Context, id beta.GroupIdDriveId, input beta.MailboxSettings, options UpdateDriveLastModifiedByUserMailboxSettingOperationOptions) (result UpdateDriveLastModifiedByUserMailboxSettingOperationResponse, err error) {
