...
func (c DriveLastModifiedByUserServiceProvisioningErrorClient) GetDriveLastModifiedByUserServiceProvisioningErrorsCount(ctx context.Context, id beta.GroupIdDriveId, options GetDriveLastModifiedByUserServiceProvisioningErrorsCountOperationOptions) (result GetDriveLastModifiedByUserServiceProvisioningErrorsCountOperationResponse, err error) {
