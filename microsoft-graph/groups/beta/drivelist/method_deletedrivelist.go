...
func (c DriveListClient) DeleteDriveList(ctx context.Context, id beta.GroupIdDriveId, options DeleteDriveListOperationOptions) (result DeleteDriveListOperationResponse, err error) {
