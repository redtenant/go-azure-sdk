...
func (c DriveListClient) UpdateDriveList(ctx context.Context, id beta.GroupIdDriveId, input beta.List, options UpdateDriveListOperationOptions) (result UpdateDriveListOperationResponse, err error) {
