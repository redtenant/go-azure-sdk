...
func (c DriveListColumnClient) CreateDriveListColumn(ctx context.Context, id beta.GroupIdDriveId, input beta.ColumnDefinition, options CreateDriveListColumnOperationOptions) (result CreateDriveListColumnOperationResponse, err error) {
