...
func (c DriveListColumnClient) DeleteDriveListColumn(ctx context.Context, id beta.GroupIdDriveIdListColumnId, options DeleteDriveListColumnOperationOptions) (result DeleteDriveListColumnOperationResponse, err error) {
