...
func (c DriveListColumnClient) GetDriveListColumn(ctx context.Context, id beta.GroupIdDriveIdListColumnId, options GetDriveListColumnOperationOptions) (result GetDriveListColumnOperationResponse, err error) {
