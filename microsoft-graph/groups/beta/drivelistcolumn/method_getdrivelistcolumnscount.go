...
func (c DriveListColumnClient) GetDriveListColumnsCount(ctx context.Context, id beta.GroupIdDriveId, options GetDriveListColumnsCountOperationOptions) (result GetDriveListColumnsCountOperationResponse, err error) {
