...
func (c DriveListColumnClient) ListDriveListColumns(ctx context.Context, id beta.GroupIdDriveId, options ListDriveListColumnsOperationOptions) (result ListDriveListColumnsOperationResponse, err error) {
...
func (c DriveListColumnClient) ListDriveListColumnsComplete(ctx context.Context, id beta.GroupIdDriveId, options ListDriveListColumnsOperationOptions) (ListDriveListColumnsCompleteResult, error) {
...
func (c DriveListColumnClient) ListDriveListColumnsCompleteMatchingPredicate(ctx context.Context, id beta.GroupIdDriveId, options ListDriveListColumnsOperationOptions, predicate ColumnDefinitionOperationPredicate) (result ListDriveListColumnsCompleteResult, err error) {
