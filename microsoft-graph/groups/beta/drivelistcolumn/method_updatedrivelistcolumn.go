...
func (c DriveListColumnClient) UpdateDriveListColumn(ctx context.Context, id beta.GroupIdDriveIdListColumnId, input beta.ColumnDefinition, options UpdateDriveListColumnOperationOptions) (result UpdateDriveListColumnOperationResponse, err error) {
