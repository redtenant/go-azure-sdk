...
func (c DriveListContentTypeClient) AddDriveListContentTypesCopy(ctx context.Context, id beta.GroupIdDriveId, input AddDriveListContentTypesCopyRequest, options AddDriveListContentTypesCopyOperationOptions) (result AddDriveListContentTypesCopyOperationResponse, err error) {
