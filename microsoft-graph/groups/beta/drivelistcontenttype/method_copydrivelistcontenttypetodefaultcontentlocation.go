...
// CopyDriveListContentTypeToDefaultContentLocation - Invoke action copyToDefaultContentLocation
func (c DriveListContentTypeClient) CopyDriveListContentTypeToDefaultContentLocation(ctx context.Context, id beta.GroupIdDriveIdListContentTypeId, input CopyDriveListContentTypeToDefaultContentLocationRequest, options CopyDriveListContentTypeToDefaultContentLocationOperationOptions) (result CopyDriveListContentTypeToDefaultContentLocationOperationResponse, err error) {
