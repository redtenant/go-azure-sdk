...
func (c DriveListContentTypeClient) CreateDriveListContentType(ctx context.Context, id beta.GroupIdDriveId, input beta.ContentType, options CreateDriveListContentTypeOperationOptions) (result CreateDriveListContentTypeOperationResponse, err error) {
