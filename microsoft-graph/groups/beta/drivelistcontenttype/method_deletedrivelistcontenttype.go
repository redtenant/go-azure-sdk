...
func (c DriveListContentTypeClient) DeleteDriveListContentType(ctx context.Context, id beta.GroupIdDriveIdListContentTypeId, options DeleteDriveListContentTypeOperationOptions) (result DeleteDriveListContentTypeOperationResponse, err error) {
