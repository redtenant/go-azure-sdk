...
func (c DriveListContentTypeClient) ListDriveListContentTypes(ctx context.Context, id beta.GroupIdDriveId, options ListDriveListContentTypesOperationOptions) (result ListDriveListContentTypesOperationResponse, err error) {
...
func (c DriveListContentTypeClient) ListDriveListContentTypesComplete(ctx context.Context, id beta.GroupIdDriveId, options ListDriveListContentTypesOperationOptions) (ListDriveListContentTypesCompleteResult, error) {
...
func (c DriveListContentTypeClient) ListDriveListContentTypesCompleteMatchingPredicate(ctx context.Context, id beta.GroupIdDriveId, options ListDriveListContentTypesOperationOptions, predicate ContentTypeOperationPredicate) (result ListDriveListContentTypesCompleteResult, err error) {
