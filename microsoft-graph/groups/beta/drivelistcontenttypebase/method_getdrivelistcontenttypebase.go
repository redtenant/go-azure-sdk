...
func (c DriveListContentTypeBaseClient) GetDriveListContentTypeBase(ctx context.Context, id beta.GroupIdDriveIdListContentTypeId, options GetDriveListContentTypeBaseOperationOptions) (result GetDriveListContentTypeBaseOperationResponse, err error) {
