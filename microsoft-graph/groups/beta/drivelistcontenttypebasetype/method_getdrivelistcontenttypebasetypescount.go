...
func (c DriveListContentTypeBaseTypeClient) GetDriveListContentTypeBaseTypesCount(ctx context.Context, id beta.GroupIdDriveIdListContentTypeId, options GetDriveListContentTypeBaseTypesCountOperationOptions) (result GetDriveListContentTypeBaseTypesCountOperationResponse, err error) {
