...
func (c DriveListContentTypeColumnClient) DeleteDriveListContentTypeColumn(ctx context.Context, id beta.GroupIdDriveIdListContentTypeIdColumnId, options DeleteDriveListContentTypeColumnOperationOptions) (result DeleteDriveListContentTypeColumnOperationResponse, err error) {
