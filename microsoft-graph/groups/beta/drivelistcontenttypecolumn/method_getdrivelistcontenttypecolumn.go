...
func (c DriveListContentTypeColumnClient) GetDriveListContentTypeColumn(ctx context.Context, id beta.GroupIdDriveIdListContentTypeIdColumnId, options GetDriveListContentTypeColumnOperationOptions) (result GetDriveListContentTypeColumnOperationResponse, err error) {
