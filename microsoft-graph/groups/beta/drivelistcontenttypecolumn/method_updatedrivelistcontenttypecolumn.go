...
func (c DriveListContentTypeColumnClient) UpdateDriveListContentTypeColumn(ctx context.Context, id beta.GroupIdDriveIdListContentTypeIdColumnId, input beta.ColumnDefinition, options UpdateDriveListContentTypeColumnOperationOptions) (result UpdateDriveListContentTypeColumnOperationResponse, err error) {
