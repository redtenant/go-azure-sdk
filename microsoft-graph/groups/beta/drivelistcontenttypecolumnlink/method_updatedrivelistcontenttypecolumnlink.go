...
// UpdateDriveListContentTypeColumnLink - Update the navigation property columnLinks in groups
func (c DriveListContentTypeColumnLinkClient) UpdateDriveListContentTypeColumnLink(ctx context.Context, id beta.GroupIdDriveIdListContentTypeIdColumnLinkId, input beta.ColumnLink, options UpdateDriveListContentTypeColumnLinkOperationOptions) (result UpdateDriveListContentTypeColumnLinkOperationResponse, err error) {
