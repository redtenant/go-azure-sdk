...
func (c DriveListContentTypeColumnPositionClient) GetDriveListContentTypeColumnPositionsCount(ctx context.Context, id beta.GroupIdDriveIdListContentTypeId, options GetDriveListContentTypeColumnPositionsCountOperationOptions) (result GetDriveListContentTypeColumnPositionsCountOperationResponse, err error) {
