...
// GetDriveListDrive - Get drive from groups. Allows access to the list as a drive resource with driveItems. Only
// present on document libraries.
func (c DriveListDriveClient) GetDriveListDrive(ctx context.Context, id beta.GroupIdDriveId, options GetDriveListDriveOperationOptions) (result GetDriveListDriveOperationResponse, err error) {
