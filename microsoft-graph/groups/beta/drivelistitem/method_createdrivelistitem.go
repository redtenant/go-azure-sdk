...
func (c DriveListItemClient) CreateDriveListItem(ctx context.Context, id beta.GroupIdDriveId, input beta.ListItem, options CreateDriveListItemOperationOptions) (result CreateDriveListItemOperationResponse, err error) {
