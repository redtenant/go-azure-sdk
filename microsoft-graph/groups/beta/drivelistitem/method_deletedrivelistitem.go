...
func (c DriveListItemClient) DeleteDriveListItem(ctx context.Context, id beta.GroupIdDriveIdListItemId, options DeleteDriveListItemOperationOptions) (result DeleteDriveListItemOperationResponse, err error) {
