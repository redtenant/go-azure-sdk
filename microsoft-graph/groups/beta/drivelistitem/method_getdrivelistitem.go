...
func (c DriveListItemClient) GetDriveListItem(ctx context.Context, id beta.GroupIdDriveIdListItemId, options GetDriveListItemOperationOptions) (result GetDriveListItemOperationResponse, err error) {
