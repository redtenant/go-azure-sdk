...
// ListDriveListItems - Get items from groups. All items contained in the list.
func (c DriveListItemClient) ListDriveListItems(ctx context.Context, id beta.GroupIdDriveId, options ListDriveListItemsOperationOptions) (result ListDriveListItemsOperationResponse, err error) {
	...
	var values struct {
		Values *[]beta.ListItem `json:"value"`
	}
...
func (c DriveListItemClient) ListDriveListItemsComplete(ctx context.Context, id beta.GroupIdDriveId, options ListDriveListItemsOperationOptions) (ListDriveListItemsCompleteResult, error) {
...
func (c DriveListItemClient) ListDriveListItemsCompleteMatchingPredicate(ctx context.Context, id beta.GroupIdDriveId, options ListDriveListItemsOperationOptions, predicate ListItemOperationPredicate) (result ListDriveListItemsCompleteResult, err error) {
	items := make([]beta.ListItem, 0)
