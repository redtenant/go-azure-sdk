...
func (c DriveListItemClient) UpdateDriveListItem(ctx context.Context, id beta.GroupIdDriveIdListItemId, input beta.ListItem, options UpdateDriveListItemOperationOptions) (result UpdateDriveListItemOperationResponse, err error) {
