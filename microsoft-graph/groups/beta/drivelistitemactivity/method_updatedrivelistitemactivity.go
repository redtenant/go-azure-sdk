...
// UpdateDriveListItemActivity - Update the navigation property activities in groups
func (c DriveListItemActivityClient) UpdateDriveListItemActivity(ctx context.Context, id beta.GroupIdDriveIdListItemIdActivityId, input beta.ItemActivityOLD, options UpdateDriveListItemActivityOperationOptions) (result UpdateDriveListItemActivityOperationResponse, err error) {
