...
func DefaultGetDriveListItemActivityDriveItemContentOperationOptions() GetDriveListItemActivityDriveItemContentOperationOptions {
	return GetDriveListItemActivityDriveItemContentOperationOptions{}
}
...
// GetDriveListItemActivityDriveItemContent - Get content for the navigation property driveItem from groups. The content
...
func (c DriveListItemActivityDriveItemContentClient) GetDriveListItemActivityDriveItemContent(ctx context.Context, id beta.GroupIdDriveIdListItemIdActivityId, options GetDriveListItemActivityDriveItemContentOperationOptions) (result GetDriveListItemActivityDriveItemContentOperationResponse, err error) {
