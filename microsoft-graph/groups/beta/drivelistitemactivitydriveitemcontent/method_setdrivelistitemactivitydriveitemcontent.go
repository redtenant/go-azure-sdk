...
// SetDriveListItemActivityDriveItemContent - Update content for the navigation property driveItem in groups. The
...
func (c DriveListItemActivityDriveItemContentClient) SetDriveListItemActivityDriveItemContent(ctx context.Context, id beta.GroupIdDriveIdListItemIdActivityId, input []byte, options SetDriveListItemActivityDriveItemContentOperationOptions) (result SetDriveListItemActivityDriveItemContentOperationResponse, err error) {
