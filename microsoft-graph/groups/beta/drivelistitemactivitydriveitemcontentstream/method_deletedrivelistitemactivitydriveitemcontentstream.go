...
type DeleteDriveListItemActivityDriveItemContentStreamOperationResponse struct {
	HttpResponse *http.Response
	OData        *odata.OData
}

type DeleteDriveListItemActivityDriveItemContentStreamOperationOptions struct {
	IfMatch   *string
...
func DefaultDeleteDriveListItemActivityDriveItemContentStreamOperationOptions() DeleteDriveListItemActivityDriveItemContentStreamOperationOptions {
	return DeleteDriveListItemActivityDriveItemContentStreamOperationOptions{}
}
...
// DeleteDriveListItemActivityDriveItemContentStream - Delete contentStream for the navigation property driveItem in
// groups. The content stream, if the item represents a file.
func (c DriveListItemActivityDriveItemContentStreamClient) DeleteDriveListItemActivityDriveItemContentStream(ctx context.Context, id beta.GroupIdDriveIdListItemIdActivityId, options DeleteDriveListItemActivityDriveItemContentStreamOperationOptions) (result DeleteDriveListItemActivityDriveItemContentStreamOperationResponse, err error) {
