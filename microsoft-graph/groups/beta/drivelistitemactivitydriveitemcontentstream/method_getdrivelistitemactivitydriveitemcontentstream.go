...
type GetDriveListItemActivityDriveItemContentStreamOperationResponse struct {
...
// GetDriveListItemActivityDriveItemContentStream - Get contentStream for the navigation property driveItem from groups.
// The content stream, if the item represents a file.
func (c DriveListItemActivityDriveItemContentStreamClient) GetDriveListItemActivityDriveItemContentStream(ctx context.Context, id beta.GroupIdDriveIdListItemIdActivityId, options GetDriveListItemActivityDriveItemContentStreamOperationOptions) (result GetDriveListItemActivityDriveItemContentStreamOperationResponse, err error) {
