...
// GetDriveListItemActivityListItem - Get listItem from groups
func (c DriveListItemActivityListItemClient) GetDriveListItemActivityListItem(ctx context.Context, id beta.GroupIdDriveIdListItemIdActivityId, options GetDriveListItemActivityListItemOperationOptions) (result GetDriveListItemActivityListItemOperationResponse, err error) {
