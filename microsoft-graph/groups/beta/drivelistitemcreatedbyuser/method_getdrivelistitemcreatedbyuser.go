...
// GetDriveListItemCreatedByUser - Get createdByUser from groups
func (c DriveListItemCreatedByUserClient) GetDriveListItemCreatedByUser(ctx context.Context, id beta.GroupIdDriveIdListItemId, options GetDriveListItemCreatedByUserOperationOptions) (result GetDriveListItemCreatedByUserOperationResponse, err error) {
