...
func (c DriveListItemDocumentSetVersionFieldClient) DeleteDriveListItemDocumentSetVersionField(ctx context.Context, id beta.GroupIdDriveIdListItemIdDocumentSetVersionId, options DeleteDriveListItemDocumentSetVersionFieldOperationOptions) (result DeleteDriveListItemDocumentSetVersionFieldOperationResponse, err error) {
