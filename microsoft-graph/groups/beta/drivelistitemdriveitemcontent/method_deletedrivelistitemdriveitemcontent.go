...
func (c DriveListItemDriveItemContentClient) DeleteDriveListItemDriveItemContent(ctx context.Context, id beta.GroupIdDriveIdListItemId, options DeleteDriveListItemDriveItemContentOperationOptions) (result DeleteDriveListItemDriveItemContentOperationResponse, err error) {
