...
// GetDriveListItemDriveItemContentStream - Get contentStream for the navigation property driveItem from groups. The
// content stream, if the item represents a file.
func (c DriveListItemDriveItemContentStreamClient) GetDriveListItemDriveItemContentStream(ctx context.Context, id beta.GroupIdDriveIdListItemId, options GetDriveListItemDriveItemContentStreamOperationOptions) (result GetDriveListItemDriveItemContentStreamOperationResponse, err error) {
