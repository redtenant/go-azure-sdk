...
// SetDriveListItemDriveItemContentStream - Update contentStream for the navigation property driveItem in groups. The
// content stream, if the item represents a file.
func (c DriveListItemDriveItemContentStreamClient) SetDriveListItemDriveItemContentStream(ctx context.Context, id beta.GroupIdDriveIdListItemId, input []byte, options SetDriveListItemDriveItemContentStreamOperationOptions) (result SetDriveListItemDriveItemContentStreamOperationResponse, err error) {
