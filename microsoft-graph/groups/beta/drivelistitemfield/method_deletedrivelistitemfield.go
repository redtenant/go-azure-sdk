...
func (c DriveListItemFieldClient) DeleteDriveListItemField(ctx context.Context, id beta.GroupIdDriveIdListItemId, options DeleteDriveListItemFieldOperationOptions) (result DeleteDriveListItemFieldOperationResponse, err error) {
