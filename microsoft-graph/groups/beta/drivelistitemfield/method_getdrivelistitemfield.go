...
func (c DriveListItemFieldClient) GetDriveListItemField(ctx context.Context, id beta.GroupIdDriveIdListItemId, options GetDriveListItemFieldOperationOptions) (result GetDriveListItemFieldOperationResponse, err error) {
