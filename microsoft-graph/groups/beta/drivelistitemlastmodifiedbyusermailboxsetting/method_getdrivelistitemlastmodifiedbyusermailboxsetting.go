...
// on $select.
func (c DriveListItemLastModifiedByUserMailboxSettingClient) GetDriveListItemLastModifiedByUserMailboxSetting(ctx context.Context, id beta.GroupIdDriveIdListItemId, options GetDriveListItemLastModifiedByUserMailboxSettingOperationOptions) (result GetDriveListItemLastModifiedByUserMailboxSettingOperationResponse, err error) {
