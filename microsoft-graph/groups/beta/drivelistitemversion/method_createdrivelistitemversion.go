...
func (c DriveListItemVersionClient) CreateDriveListItemVersion(ctx context.Context, id beta.GroupIdDriveIdListItemId, input beta.ListItemVersion, options CreateDriveListItemVersionOperationOptions) (result CreateDriveListItemVersionOperationResponse, err error) {
