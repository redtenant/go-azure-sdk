...
func (c DriveListItemVersionClient) DeleteDriveListItemVersion(ctx context.Context, id beta.GroupIdDriveIdListItemIdVersionId, options DeleteDriveListItemVersionOperationOptions) (result DeleteDriveListItemVersionOperationResponse, err error) {
