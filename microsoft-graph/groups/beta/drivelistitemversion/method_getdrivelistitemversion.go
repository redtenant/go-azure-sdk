...
func (c DriveListItemVersionClient) GetDriveListItemVersion(ctx context.Context, id beta.GroupIdDriveIdListItemIdVersionId, options GetDriveListItemVersionOperationOptions) (result GetDriveListItemVersionOperationResponse, err error) {
