...
func (c DriveListItemVersionClient) GetDriveListItemVersionsCount(ctx context.Context, id beta.GroupIdDriveIdListItemId, options GetDriveListItemVersionsCountOperationOptions) (result GetDriveListItemVersionsCountOperationResponse, err error) {
