...
func (c DriveListItemVersionFieldClient) DeleteDriveListItemVersionField(ctx context.Context, id beta.GroupIdDriveIdListItemIdVersionId, options DeleteDriveListItemVersionFieldOperationOptions) (result DeleteDriveListItemVersionFieldOperationResponse, err error) {
