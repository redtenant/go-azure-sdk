...
// list item.
func (c DriveListItemVersionFieldClient) GetDriveListItemVersionField(ctx context.Context, id beta.GroupIdDriveIdListItemIdVersionId, options GetDriveListItemVersionFieldOperationOptions) (result GetDriveListItemVersionFieldOperationResponse, err error) {
