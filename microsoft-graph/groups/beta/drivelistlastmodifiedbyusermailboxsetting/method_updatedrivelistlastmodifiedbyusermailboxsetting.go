...
func (c DriveListLastModifiedByUserMailboxSettingClient) UpdateDriveListLastModifiedByUserMailboxSetting(ctx context.Context, id beta.GroupIdDriveId, input beta.MailboxSettings, options UpdateDriveListLastModifiedByUserMailboxSettingOperationOptions) (result UpdateDriveListLastModifiedByUserMailboxSettingOperationResponse, err error) {
