...
func (c DriveListSubscriptionClient) DeleteDriveListSubscription(ctx context.Context, id beta.GroupIdDriveIdListSubscriptionId, options DeleteDriveListSubscriptionOperationOptions) (result DeleteDriveListSubscriptionOperationResponse, err error) {
