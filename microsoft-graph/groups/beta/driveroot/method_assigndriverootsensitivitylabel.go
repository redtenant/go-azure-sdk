...
func (c DriveRootClient) AssignDriveRootSensitivityLabel(ctx context.Context, id beta.GroupIdDriveId, input AssignDriveRootSensitivityLabelRequest, options AssignDriveRootSensitivityLabelOperationOptions) (result AssignDriveRootSensitivityLabelOperationResponse, err error) {
