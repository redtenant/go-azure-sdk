...
func (c DriveRootClient) CheckoutDriveRoot(ctx context.Context, id beta.GroupIdDriveId, options CheckoutDriveRootOperationOptions) (result CheckoutDriveRootOperationResponse, err error) {
