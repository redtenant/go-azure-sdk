...
func (c DriveRootClient) CreateDriveRootLink(ctx context.Context, id beta.GroupIdDriveId, input CreateDriveRootLinkRequest, options CreateDriveRootLinkOperationOptions) (result CreateDriveRootLinkOperationResponse, err error) {
