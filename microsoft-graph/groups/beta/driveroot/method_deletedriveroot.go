...
func (c DriveRootClient) DeleteDriveRoot(ctx context.Context, id beta.GroupIdDriveId, options DeleteDriveRootOperationOptions) (result DeleteDriveRootOperationResponse, err error) {
