...
func (c DriveRootClient) GetDriveRoot(ctx context.Context, id beta.GroupIdDriveId, options GetDriveRootOperationOptions) (result GetDriveRootOperationResponse, err error) {
