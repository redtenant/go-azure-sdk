...
func (c DriveRootClient) PreviewDriveRoot(ctx context.Context, id beta.GroupIdDriveId, input PreviewDriveRootRequest, options PreviewDriveRootOperationOptions) (result PreviewDriveRootOperationResponse, err error) {
