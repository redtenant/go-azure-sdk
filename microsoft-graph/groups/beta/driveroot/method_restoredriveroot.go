...
// bin.
func (c DriveRootClient) RestoreDriveRoot(ctx context.Context, id beta.GroupIdDriveId, input RestoreDriveRootRequest, options RestoreDriveRootOperationOptions) (result RestoreDriveRootOperationResponse, err error) {
