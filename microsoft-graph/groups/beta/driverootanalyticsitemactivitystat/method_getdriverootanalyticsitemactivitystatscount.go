...
func (c DriveRootAnalyticsItemActivityStatClient) GetDriveRootAnalyticsItemActivityStatsCount(ctx context.Context, id beta.GroupIdDriveId, options GetDriveRootAnalyticsItemActivityStatsCountOperationOptions) (result GetDriveRootAnalyticsItemActivityStatsCountOperationResponse, err error) {
