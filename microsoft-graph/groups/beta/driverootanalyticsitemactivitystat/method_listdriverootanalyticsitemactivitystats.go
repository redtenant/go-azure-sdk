...
func (c DriveRootAnalyticsItemActivityStatClient) ListDriveRootAnalyticsItemActivityStats(ctx context.Context, id beta.GroupIdDriveId, options ListDriveRootAnalyticsItemActivityStatsOperationOptions) (result ListDriveRootAnalyticsItemActivityStatsOperationResponse, err error) {
...
func (c DriveRootAnalyticsItemActivityStatClient) ListDriveRootAnalyticsItemActivityStatsComplete(ctx context.Context, id beta.GroupIdDriveId, options ListDriveRootAnalyticsItemActivityStatsOperationOptions) (ListDriveRootAnalyticsItemActivityStatsCompleteResult, error) {
