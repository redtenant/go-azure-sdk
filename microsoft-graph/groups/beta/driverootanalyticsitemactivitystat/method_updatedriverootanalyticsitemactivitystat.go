...
func (c DriveRootAnalyticsItemActivityStatClient) UpdateDriveRootAnalyticsItemActivityStat(ctx context.Context, id beta.GroupIdDriveIdRootAnalyticsItemActivityStatId, input beta.ItemActivityStat, options UpdateDriveRootAnalyticsItemActivityStatOperationOptions) (result UpdateDriveRootAnalyticsItemActivityStatOperationResponse, err error) {
