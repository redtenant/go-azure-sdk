...
func (c DriveRootAnalyticsItemActivityStatActivityClient) UpdateDriveRootAnalyticsItemActivityStatActivity(ctx context.Context, id beta.GroupIdDriveIdRootAnalyticsItemActivityStatIdActivityId, input beta.ItemActivity, options UpdateDriveRootAnalyticsItemActivityStatActivityOperationOptions) (result UpdateDriveRootAnalyticsItemActivityStatActivityOperationResponse, err error) {
