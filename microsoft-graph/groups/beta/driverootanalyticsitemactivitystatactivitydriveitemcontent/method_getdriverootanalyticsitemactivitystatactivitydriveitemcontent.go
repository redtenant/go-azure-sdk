...
// from groups. The content stream, if the item represents a file. The content property will have a potentially breaking
...
func (c DriveRootAnalyticsItemActivityStatActivityDriveItemContentClient) GetDriveRootAnalyticsItemActivityStatActivityDriveItemContent(ctx context.Context, id beta.GroupIdDriveIdRootAnalyticsItemActivityStatIdActivityId, options GetDriveRootAnalyticsItemActivityStatActivityDriveItemContentOperationOptions) (result GetDriveRootAnalyticsItemActivityStatActivityDriveItemContentOperationResponse, err error) {
