...
func (c DriveRootChildClient) CreateDriveRootChild(ctx context.Context, id beta.GroupIdDriveId, input beta.DriveItem, options CreateDriveRootChildOperationOptions) (result CreateDriveRootChildOperationResponse, err error) {
