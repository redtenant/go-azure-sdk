...
func (c DriveRootChildClient) GetDriveRootChild(ctx context.Context, id beta.GroupIdDriveIdRootChildId, options GetDriveRootChildOperationOptions) (result GetDriveRootChildOperationResponse, err error) {
