...
func (c DriveRootChildClient) GetDriveRootChildrenCount(ctx context.Context, id beta.GroupIdDriveId, options GetDriveRootChildrenCountOperationOptions) (result GetDriveRootChildrenCountOperationResponse, err error) {
