...
// DeleteDriveRootChildContentStream - Delete contentStream for the navigation property children in groups. The content
// stream, if the item represents a file.
func (c DriveRootChildContentStreamClient) DeleteDriveRootChildContentStream(ctx context.Context, id beta.GroupIdDriveIdRootChildId, options DeleteDriveRootChildContentStreamOperationOptions) (result DeleteDriveRootChildContentStreamOperationResponse, err error) {
