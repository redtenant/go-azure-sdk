...
// SetDriveRootContentStream - Update contentStream for the navigation property root in groups. The content stream, if
// the item represents a file.
func (c DriveRootContentStreamClient) SetDriveRootContentStream(ctx context.Context, id beta.GroupIdDriveId, input []byte, options SetDriveRootContentStreamOperationOptions) (result SetDriveRootContentStreamOperationResponse, err error) {
