...
// GetDriveRootCreatedByUser - Get createdByUser from groups
func (c DriveRootCreatedByUserClient) GetDriveRootCreatedByUser(ctx context.Context, id beta.GroupIdDriveId, options GetDriveRootCreatedByUserOperationOptions) (result GetDriveRootCreatedByUserOperationResponse, err error) {
