...
func (c DriveRootCreatedByUserMailboxSettingClient) GetDriveRootCreatedByUserMailboxSetting(ctx context.Context, id beta.GroupIdDriveId, options GetDriveRootCreatedByUserMailboxSettingOperationOptions) (result GetDriveRootCreatedByUserMailboxSettingOperationResponse, err error) {
