...
type UpdateDriveRootCreatedByUserMailboxSettingOperationResponse struct {
...
func (c DriveRootCreatedByUserMailboxSettingClient) UpdateDriveRootCreatedByUserMailboxSetting(ctx context.Context, id beta.GroupIdDriveId, input beta.MailboxSettings, options UpdateDriveRootCreatedByUserMailboxSettingOperationOptions) (result UpdateDriveRootCreatedByUserMailboxSettingOperationResponse, err error) {
