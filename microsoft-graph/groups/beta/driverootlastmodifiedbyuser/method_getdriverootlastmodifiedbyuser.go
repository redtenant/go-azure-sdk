...
// GetDriveRootLastModifiedByUser - Get lastModifiedByUser from groups
func (c DriveRootLastModifiedByUserClient) GetDriveRootLastModifiedByUser(ctx context.Context, id beta.GroupIdDriveId, options GetDriveRootLastModifiedByUserOperationOptions) (result GetDriveRootLastModifiedByUserOperationResponse, err error) {
