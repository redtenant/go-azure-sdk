...
func (c DriveRootLastModifiedByUserServiceProvisioningErrorClient) ListDriveRootLastModifiedByUserServiceProvisioningErrorsCompleteMatchingPredicate(ctx context.Context, id beta.GroupIdDriveId, options ListDriveRootLastModifiedByUserServiceProvisioningErrorsOperationOptions, predicate ServiceProvisioningErrorOperationPredicate) (result ListDriveRootLastModifiedByUserServiceProvisioningErrorsCompleteResult, err error) {
