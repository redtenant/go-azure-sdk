...
func (c DriveRootListItemClient) CreateDriveRootListItemLink(ctx context.Context, id beta.GroupIdDriveId, input CreateDriveRootListItemLinkRequest, options CreateDriveRootListItemLinkOperationOptions) (result CreateDriveRootListItemLinkOperationResponse, err error) {
