...
// Read-only. Nullable.
func (c DriveRootListItemClient) GetDriveRootListItem(ctx context.Context, id beta.GroupIdDriveId, options GetDriveRootListItemOperationOptions) (result GetDriveRootListItemOperationResponse, err error) {
