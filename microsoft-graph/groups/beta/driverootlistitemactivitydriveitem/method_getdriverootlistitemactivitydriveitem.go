...
// GetDriveRootListItemActivityDriveItem - Get driveItem from groups
func (c DriveRootListItemActivityDriveItemClient) GetDriveRootListItemActivityDriveItem(ctx context.Context, id beta.GroupIdDriveIdRootListItemActivityId, options GetDriveRootListItemActivityDriveItemOperationOptions) (result GetDriveRootListItemActivityDriveItemOperationResponse, err error) {
