...
type DeleteDriveRootListItemActivityDriveItemContentOperationResponse struct {
	HttpResponse *http.Response
	OData        *odata.OData
}

type DeleteDriveRootListItemActivityDriveItemContentOperationOptions struct {
	IfMatch   *string
...
func DefaultDeleteDriveRootListItemActivityDriveItemContentOperationOptions() DeleteDriveRootListItemActivityDriveItemContentOperationOptions {
	return DeleteDriveRootListItemActivityDriveItemContentOperationOptions{}
}
...
// DeleteDriveRootListItemActivityDriveItemContent - Delete content for the navigation property driveItem in groups. The
...
func (c DriveRootListItemActivityDriveItemContentClient) DeleteDriveRootListItemActivityDriveItemContent(ctx context.Context, id beta.GroupIdDriveIdRootListItemActivityId, options DeleteDriveRootListItemActivityDriveItemContentOperationOptions) (result DeleteDriveRootListItemActivityDriveItemContentOperationResponse, err error) {
