...
type GetDriveRootListItemActivityDriveItemContentOperationResponse struct {
	HttpResponse *http.Response
	OData        *odata.OData
	Model        *[]byte
}

type GetDriveRootListItemActivityDriveItemContentOperationOptions struct {
	Format    *odata.Format
...
func DefaultGetDriveRootListItemActivityDriveItemContentOperationOptions() GetDriveRootListItemActivityDriveItemContentOperationOptions {
	return GetDriveRootListItemActivityDriveItemContentOperationOptions{}
}
...
// GetDriveRootListItemActivityDriveItemContent - Get content for the navigation property driveItem from groups. The
...
func (c DriveRootListItemActivityDriveItemContentClient) GetDriveRootListItemActivityDriveItemContent(ctx context.Context, id beta.GroupIdDriveIdRootListItemActivityId, options GetDriveRootListItemActivityDriveItemContentOperationOptions) (result GetDriveRootListItemActivityDriveItemContentOperationResponse, err error) {
