...
func (c DriveRootListItemActivityDriveItemContentStreamClient) DeleteDriveRootListItemActivityDriveItemContentStream(ctx context.Context, id beta.GroupIdDriveIdRootListItemActivityId, options DeleteDriveRootListItemActivityDriveItemContentStreamOperationOptions) (result DeleteDriveRootListItemActivityDriveItemContentStreamOperationResponse, err error) {
