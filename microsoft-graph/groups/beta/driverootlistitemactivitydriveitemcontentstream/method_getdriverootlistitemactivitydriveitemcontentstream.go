...
func (c DriveRootListItemActivityDriveItemContentStreamClient) GetDriveRootListItemActivityDriveItemContentStream(ctx context.Context, id beta.GroupIdDriveIdRootListItemActivityId, options GetDriveRootListItemActivityDriveItemContentStreamOperationOptions) (result GetDriveRootListItemActivityDriveItemContentStreamOperationResponse, err error) {
