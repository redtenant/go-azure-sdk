...
// item.
func (c DriveRootListItemAnalyticsClient) GetDriveRootListItemAnalytic(ctx context.Context, id beta.GroupIdDriveId, options GetDriveRootListItemAnalyticOperationOptions) (result GetDriveRootListItemAnalyticOperationResponse, err error) {
