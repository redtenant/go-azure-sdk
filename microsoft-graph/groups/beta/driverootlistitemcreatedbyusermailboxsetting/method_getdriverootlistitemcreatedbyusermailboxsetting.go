...
// on $select.
func (c DriveRootListItemCreatedByUserMailboxSettingClient) GetDriveRootListItemCreatedByUserMailboxSetting(ctx context.Context, id beta.GroupIdDriveId, options GetDriveRootListItemCreatedByUserMailboxSettingOperationOptions) (result GetDriveRootListItemCreatedByUserMailboxSettingOperationResponse, err error) {
