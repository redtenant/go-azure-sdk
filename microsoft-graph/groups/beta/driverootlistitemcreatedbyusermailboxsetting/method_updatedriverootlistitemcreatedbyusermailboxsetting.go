...
func (c DriveRootListItemCreatedByUserMailboxSettingClient) UpdateDriveRootListItemCreatedByUserMailboxSetting(ctx context.Context, id beta.GroupIdDriveId, input beta.MailboxSettings, options UpdateDriveRootListItemCreatedByUserMailboxSettingOperationOptions) (result UpdateDriveRootListItemCreatedByUserMailboxSettingOperationResponse, err error) {
