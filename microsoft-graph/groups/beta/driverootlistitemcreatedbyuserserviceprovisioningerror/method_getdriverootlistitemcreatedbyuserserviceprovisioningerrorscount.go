...
func (c DriveRootListItemCreatedByUserServiceProvisioningErrorClient) GetDriveRootListItemCreatedByUserServiceProvisioningErrorsCount(ctx context.Context, id beta.GroupIdDriveId, options GetDriveRootListItemCreatedByUserServiceProvisioningErrorsCountOperationOptions) (result GetDriveRootListItemCreatedByUserServiceProvisioningErrorsCountOperationResponse, err error) {
