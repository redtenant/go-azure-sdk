...
func (c DriveRootListItemDocumentSetVersionClient) CreateDriveRootListItemDocumentSetVersion(ctx context.Context, id beta.GroupIdDriveId, input beta.DocumentSetVersion, options CreateDriveRootListItemDocumentSetVersionOperationOptions) (result CreateDriveRootListItemDocumentSetVersionOperationResponse, err error) {
