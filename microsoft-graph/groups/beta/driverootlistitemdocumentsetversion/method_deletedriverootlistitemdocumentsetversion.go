...
func (c DriveRootListItemDocumentSetVersionClient) DeleteDriveRootListItemDocumentSetVersion(ctx context.Context, id beta.GroupIdDriveIdRootListItemDocumentSetVersionId, options DeleteDriveRootListItemDocumentSetVersionOperationOptions) (result DeleteDriveRootListItemDocumentSetVersionOperationResponse, err error) {
