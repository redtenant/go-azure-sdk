...
func (c DriveRootListItemDocumentSetVersionClient) GetDriveRootListItemDocumentSetVersion(ctx context.Context, id beta.GroupIdDriveIdRootListItemDocumentSetVersionId, options GetDriveRootListItemDocumentSetVersionOperationOptions) (result GetDriveRootListItemDocumentSetVersionOperationResponse, err error) {
