...
func (c DriveRootListItemDocumentSetVersionClient) UpdateDriveRootListItemDocumentSetVersion(ctx context.Context, id beta.GroupIdDriveIdRootListItemDocumentSetVersionId, input beta.DocumentSetVersion, options UpdateDriveRootListItemDocumentSetVersionOperationOptions) (result UpdateDriveRootListItemDocumentSetVersionOperationResponse, err error) {
