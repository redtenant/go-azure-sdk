...
func (c DriveRootListItemDocumentSetVersionFieldClient) DeleteDriveRootListItemDocumentSetVersionField(ctx context.Context, id beta.GroupIdDriveIdRootListItemDocumentSetVersionId, options DeleteDriveRootListItemDocumentSetVersionFieldOperationOptions) (result DeleteDriveRootListItemDocumentSetVersionFieldOperationResponse, err error) {
