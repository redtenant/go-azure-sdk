...
func (c DriveRootListItemFieldClient) GetDriveRootListItemField(ctx context.Context, id beta.GroupIdDriveId, options GetDriveRootListItemFieldOperationOptions) (result GetDriveRootListItemFieldOperationResponse, err error) {
