...
// GetDriveRootListItemLastModifiedByUser - Get lastModifiedByUser from groups
func (c DriveRootListItemLastModifiedByUserClient) GetDriveRootListItemLastModifiedByUser(ctx context.Context, id beta.GroupIdDriveId, options GetDriveRootListItemLastModifiedByUserOperationOptions) (result GetDriveRootListItemLastModifiedByUserOperationResponse, err error) {
