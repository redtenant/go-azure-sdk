...
// CreateDriveRootListItemPermission - Create new navigation property to permissions for groups
func (c DriveRootListItemPermissionClient) CreateDriveRootListItemPermission(ctx context.Context, id beta.GroupIdDriveId, input beta.Permission, options CreateDriveRootListItemPermissionOperationOptions) (result CreateDriveRootListItemPermissionOperationResponse, err error) {
