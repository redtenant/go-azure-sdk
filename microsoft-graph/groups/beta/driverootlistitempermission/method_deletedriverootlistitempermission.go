...
func DefaultDeleteDriveRootListItemPermissionOperationOptions() DeleteDriveRootListItemPermissionOperationOptions {
	return DeleteDriveRootListItemPermissionOperationOptions{}
}
...
// DeleteDriveRootListItemPermission - Delete navigation property permissions for groups
func (c DriveRootListItemPermissionClient) DeleteDriveRootListItemPermission(ctx context.Context, id beta.GroupIdDriveIdRootListItemPermissionId, options DeleteDriveRootListItemPermissionOperationOptions) (result DeleteDriveRootListItemPermissionOperationResponse, err error) {
