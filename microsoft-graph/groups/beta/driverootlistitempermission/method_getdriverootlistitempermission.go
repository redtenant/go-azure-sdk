...
// GetDriveRootListItemPermission - Get permissions from groups. The set of permissions for the item. Read-only.
// Nullable.
func (c DriveRootListItemPermissionClient) GetDriveRootListItemPermission(ctx context.Context, id beta.GroupIdDriveIdRootListItemPermissionId, options GetDriveRootListItemPermissionOperationOptions) (result GetDriveRootListItemPermissionOperationResponse, err error) {
