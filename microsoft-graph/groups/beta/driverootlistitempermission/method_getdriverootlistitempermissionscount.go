...
func DefaultGetDriveRootListItemPermissionsCountOperationOptions() GetDriveRootListItemPermissionsCountOperationOptions {
	return GetDriveRootListItemPermissionsCountOperationOptions{}
}
...
func (c DriveRootListItemPermissionClient) GetDriveRootListItemPermissionsCount(ctx context.Context, id beta.GroupIdDriveId, options GetDriveRootListItemPermissionsCountOperationOptions) (result GetDriveRootListItemPermissionsCountOperationResponse, err error) {
	opts := client.RequestOptions{
		...
		Path:          fmt.Sprintf("%s/root/listItem/permissions/$count", id.ID()),
