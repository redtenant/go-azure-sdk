...
func DefaultUpdateDriveRootListItemPermissionOperationOptions() UpdateDriveRootListItemPermissionOperationOptions {
	return UpdateDriveRootListItemPermissionOperationOptions{}
}
...
// UpdateDriveRootListItemPermission - Update the navigation property permissions in groups
func (c DriveRootListItemPermissionClient) UpdateDriveRootListItemPermission(ctx context.Context, id beta.GroupIdDriveIdRootListItemPermissionId, input beta.Permission, options UpdateDriveRootListItemPermissionOperationOptions) (result UpdateDriveRootListItemPermissionOperationResponse, err error) {
