...
func (c DriveRootListItemVersionClient) DeleteDriveRootListItemVersion(ctx context.Context, id beta.GroupIdDriveIdRootListItemVersionId, options DeleteDriveRootListItemVersionOperationOptions) (result DeleteDriveRootListItemVersionOperationResponse, err error) {
