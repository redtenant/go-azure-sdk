...
func (c DriveRootListItemVersionClient) GetDriveRootListItemVersion(ctx context.Context, id beta.GroupIdDriveIdRootListItemVersionId, options GetDriveRootListItemVersionOperationOptions) (result GetDriveRootListItemVersionOperationResponse, err error) {
