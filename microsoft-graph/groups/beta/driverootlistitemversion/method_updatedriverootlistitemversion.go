...
func (c DriveRootListItemVersionClient) UpdateDriveRootListItemVersion(ctx context.Context, id beta.GroupIdDriveIdRootListItemVersionId, input beta.ListItemVersion, options UpdateDriveRootListItemVersionOperationOptions) (result UpdateDriveRootListItemVersionOperationResponse, err error) {
