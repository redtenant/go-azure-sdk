...
// UpdateDriveRootListItemVersionField - Update the navigation property fields in groups
func (c DriveRootListItemVersionFieldClient) UpdateDriveRootListItemVersionField(ctx context.Context, id beta.GroupIdDriveIdRootListItemVersionId, input beta.FieldValueSet, options UpdateDriveRootListItemVersionFieldOperationOptions) (result UpdateDriveRootListItemVersionFieldOperationResponse, err error) {
