...
func (c DriveRootPermissionClient) CreateDriveRootPermission(ctx context.Context, id beta.GroupIdDriveId, input beta.Permission, options CreateDriveRootPermissionOperationOptions) (result CreateDriveRootPermissionOperationResponse, err error) {
