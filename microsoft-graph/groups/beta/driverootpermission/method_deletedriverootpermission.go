...
func (c DriveRootPermissionClient) DeleteDriveRootPermission(ctx context.Context, id beta.GroupIdDriveIdRootPermissionId, options DeleteDriveRootPermissionOperationOptions) (result DeleteDriveRootPermissionOperationResponse, err error) {
