...
func (c DriveRootPermissionClient) GetDriveRootPermission(ctx context.Context, id beta.GroupIdDriveIdRootPermissionId, options GetDriveRootPermissionOperationOptions) (result GetDriveRootPermissionOperationResponse, err error) {
