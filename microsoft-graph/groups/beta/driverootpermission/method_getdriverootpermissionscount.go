...
func (c DriveRootPermissionClient) GetDriveRootPermissionsCount(ctx context.Context, id beta.GroupIdDriveId, options GetDriveRootPermissionsCountOperationOptions) (result GetDriveRootPermissionsCountOperationResponse, err error) {
