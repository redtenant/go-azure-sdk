...
func (c DriveRootPermissionClient) ListDriveRootPermissionGrants(ctx context.Context, id beta.GroupIdDriveIdRootPermissionId, input ListDriveRootPermissionGrantsRequest, options ListDriveRootPermissionGrantsOperationOptions) (result ListDriveRootPermissionGrantsOperationResponse, err error) {
...
func (c DriveRootPermissionClient) ListDriveRootPermissionGrantsComplete(ctx context.Context, id beta.GroupIdDriveIdRootPermissionId, input ListDriveRootPermissionGrantsRequest, options ListDriveRootPermissionGrantsOperationOptions) (ListDriveRootPermissionGrantsCompleteResult, error) {
...
func (c DriveRootPermissionClient) ListDriveRootPermissionGrantsCompleteMatchingPredicate(ctx context.Context, id beta.GroupIdDriveIdRootPermissionId, input ListDriveRootPermissionGrantsRequest, options ListDriveRootPermissionGrantsOperationOptions, predicate PermissionOperationPredicate) (result ListDriveRootPermissionGrantsCompleteResult, err error) {
