...
func (c DriveRootPermissionClient) ListDriveRootPermissions(ctx context.Context, id beta.GroupIdDriveId, options ListDriveRootPermissionsOperationOptions) (result ListDriveRootPermissionsOperationResponse, err error) {
...
func (c DriveRootPermissionClient) ListDriveRootPermissionsComplete(ctx context.Context, id beta.GroupIdDriveId, options ListDriveRootPermissionsOperationOptions) (ListDriveRootPermissionsCompleteResult, error) {
