...
func (c DriveRootPermissionClient) RevokeDriveRootPermissionGrants(ctx context.Context, id beta.GroupIdDriveIdRootPermissionId, input RevokeDriveRootPermissionGrantsRequest, options RevokeDriveRootPermissionGrantsOperationOptions) (result RevokeDriveRootPermissionGrantsOperationResponse, err error) {
