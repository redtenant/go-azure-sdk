...
func (c DriveRootPermissionClient) UpdateDriveRootPermission(ctx context.Context, id beta.GroupIdDriveIdRootPermissionId, input beta.Permission, options UpdateDriveRootPermissionOperationOptions) (result UpdateDriveRootPermissionOperationResponse, err error) {
