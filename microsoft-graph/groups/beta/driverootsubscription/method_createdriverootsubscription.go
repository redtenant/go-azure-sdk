...
func (c DriveRootSubscriptionClient) CreateDriveRootSubscription(ctx context.Context, id beta.GroupIdDriveId, input beta.Subscription, options CreateDriveRootSubscriptionOperationOptions) (result CreateDriveRootSubscriptionOperationResponse, err error) {
