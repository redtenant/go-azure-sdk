...
func (c DriveRootSubscriptionClient) UpdateDriveRootSubscription(ctx context.Context, id beta.GroupIdDriveIdRootSubscriptionId, input beta.Subscription, options UpdateDriveRootSubscriptionOperationOptions) (result UpdateDriveRootSubscriptionOperationResponse, err error) {
