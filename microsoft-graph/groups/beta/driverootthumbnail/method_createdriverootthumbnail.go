...
func (c DriveRootThumbnailClient) CreateDriveRootThumbnail(ctx context.Context, id beta.GroupIdDriveId, input beta.ThumbnailSet, options CreateDriveRootThumbnailOperationOptions) (result CreateDriveRootThumbnailOperationResponse, err error) {
