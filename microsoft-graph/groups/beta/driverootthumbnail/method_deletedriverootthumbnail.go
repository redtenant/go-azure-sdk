...
func (c DriveRootThumbnailClient) DeleteDriveRootThumbnail(ctx context.Context, id beta.GroupIdDriveIdRootThumbnailId, options DeleteDriveRootThumbnailOperationOptions) (result DeleteDriveRootThumbnailOperationResponse, err error) {
