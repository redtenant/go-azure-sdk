...
func (c DriveRootThumbnailClient) GetDriveRootThumbnail(ctx context.Context, id beta.GroupIdDriveIdRootThumbnailId, options GetDriveRootThumbnailOperationOptions) (result GetDriveRootThumbnailOperationResponse, err error) {
