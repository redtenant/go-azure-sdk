...
func (c DriveRootThumbnailClient) GetDriveRootThumbnailsCount(ctx context.Context, id beta.GroupIdDriveId, options GetDriveRootThumbnailsCountOperationOptions) (result GetDriveRootThumbnailsCountOperationResponse, err error) {
