...
func (c DriveRootVersionClient) CreateDriveRootVersion(ctx context.Context, id beta.GroupIdDriveId, input beta.DriveItemVersion, options CreateDriveRootVersionOperationOptions) (result CreateDriveRootVersionOperationResponse, err error) {
