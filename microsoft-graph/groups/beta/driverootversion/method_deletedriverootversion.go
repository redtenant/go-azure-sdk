...
func (c DriveRootVersionClient) DeleteDriveRootVersion(ctx context.Context, id beta.GroupIdDriveIdRootVersionId, options DeleteDriveRootVersionOperationOptions) (result DeleteDriveRootVersionOperationResponse, err error) {
