...
func (c DriveRootVersionClient) GetDriveRootVersionsCount(ctx context.Context, id beta.GroupIdDriveId, options GetDriveRootVersionsCountOperationOptions) (result GetDriveRootVersionsCountOperationResponse, err error) {
