...
func (c DriveRootVersionClient) RestoreDriveRootVersionVersion(ctx context.Context, id beta.GroupIdDriveIdRootVersionId, options RestoreDriveRootVersionVersionOperationOptions) (result RestoreDriveRootVersionVersionOperationResponse, err error) {
