...
// SetDriveRootVersionContent - Update content for the navigation property versions in groups
func (c DriveRootVersionContentClient) SetDriveRootVersionContent(ctx context.Context, id beta.GroupIdDriveIdRootVersionId, input []byte, options SetDriveRootVersionContentOperationOptions) (result SetDriveRootVersionContentOperationResponse, err error) {
