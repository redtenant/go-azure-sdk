...
func (c DriveSpecialClient) GetDriveSpecial(ctx context.Context, id beta.GroupIdDriveIdSpecialId, options GetDriveSpecialOperationOptions) (result GetDriveSpecialOperationResponse, err error) {
