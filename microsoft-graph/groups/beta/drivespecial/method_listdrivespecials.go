...
func (c DriveSpecialClient) ListDriveSpecials(ctx context.Context, id beta.GroupIdDriveId, options ListDriveSpecialsOperationOptions) (result ListDriveSpecialsOperationResponse, err error) {
...
func (c DriveSpecialClient) ListDriveSpecialsComplete(ctx context.Context, id beta.GroupIdDriveId, options ListDriveSpecialsOperationOptions) (ListDriveSpecialsCompleteResult, error) {
...
func (c DriveSpecialClient) ListDriveSpecialsCompleteMatchingPredicate(ctx context.Context, id beta.GroupIdDriveId, options ListDriveSpecialsOperationOptions, predicate DriveItemOperationPredicate) (result ListDriveSpecialsCompleteResult, err error) {
