...
func (c DriveSpecialContentClient) DeleteDriveSpecialContent(ctx context.Context, id beta.GroupIdDriveIdSpecialId, options DeleteDriveSpecialContentOperationOptions) (result DeleteDriveSpecialContentOperationResponse, err error) {
