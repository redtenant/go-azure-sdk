...
func (c DriveSpecialContentClient) GetDriveSpecialContent(ctx context.Context, id beta.GroupIdDriveIdSpecialId, options GetDriveSpecialContentOperationOptions) (result GetDriveSpecialContentOperationResponse, err error) {
