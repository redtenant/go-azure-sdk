...
func (c DriveSpecialContentClient) SetDriveSpecialContent(ctx context.Context, id beta.GroupIdDriveIdSpecialId, input []byte, options SetDriveSpecialContentOperationOptions) (result SetDriveSpecialContentOperationResponse, err error) {
