...
// DeleteDriveSpecialContentStream - Delete contentStream for the navigation property special in groups. The content
// stream, if the item represents a file.
func (c DriveSpecialContentStreamClient) DeleteDriveSpecialContentStream(ctx context.Context, id beta.GroupIdDriveIdSpecialId, options DeleteDriveSpecialContentStreamOperationOptions) (result DeleteDriveSpecialContentStreamOperationResponse, err error) {
