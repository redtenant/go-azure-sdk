...
// GetDriveSpecialContentStream - Get contentStream for the navigation property special from groups. The content stream,
// if the item represents a file.
func (c DriveSpecialContentStreamClient) GetDriveSpecialContentStream(ctx context.Context, id beta.GroupIdDriveIdSpecialId, options GetDriveSpecialContentStreamOperationOptions) (result GetDriveSpecialContentStreamOperationResponse, err error) {
