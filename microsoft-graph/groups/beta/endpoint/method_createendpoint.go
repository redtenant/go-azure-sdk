...
// CreateEndpoint - Create new navigation property to endpoints for groups
func (c EndpointClient) CreateEndpoint(ctx context.Context, id beta.GroupId, input beta.Endpoint, options CreateEndpointOperationOptions) (result CreateEndpointOperationResponse, err error) {
