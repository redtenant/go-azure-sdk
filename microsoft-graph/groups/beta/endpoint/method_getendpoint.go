...
// GetEndpoint - Get endpoint. Retrieve the properties and relationships of a specific endpoint object.
func (c EndpointClient) GetEndpoint(ctx context.Context, id beta.GroupIdEndpointId, options GetEndpointOperationOptions) (result GetEndpointOperationResponse, err error) {
