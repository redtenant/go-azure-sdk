...
func (c EndpointClient) GetEndpointsCount(ctx context.Context, id beta.GroupId, options GetEndpointsCountOperationOptions) (result GetEndpointsCountOperationResponse, err error) {
