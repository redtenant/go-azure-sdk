...
// UpdateEndpoint - Update the navigation property endpoints in groups
func (c EndpointClient) UpdateEndpoint(ctx context.Context, id beta.GroupIdEndpointId, input beta.Endpoint, options UpdateEndpointOperationOptions) (result UpdateEndpointOperationResponse, err error) {
