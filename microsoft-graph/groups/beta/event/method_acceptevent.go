...
func (c EventClient) AcceptEvent(ctx context.Context, id beta.GroupIdEventId, input AcceptEventRequest, options AcceptEventOperationOptions) (result AcceptEventOperationResponse, err error) {
