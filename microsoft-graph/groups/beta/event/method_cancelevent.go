...
func (c EventClient) CancelEvent(ctx context.Context, id beta.GroupIdEventId, input CancelEventRequest, options CancelEventOperationOptions) (result CancelEventOperationResponse, err error) {
