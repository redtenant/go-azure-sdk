...
func (c EventClient) CreateEvent(ctx context.Context, id beta.GroupId, input beta.Event, options CreateEventOperationOptions) (result CreateEventOperationResponse, err error) {
