...
func (c EventClient) DeleteEvent(ctx context.Context, id beta.GroupIdEventId, options DeleteEventOperationOptions) (result DeleteEventOperationResponse, err error) {
