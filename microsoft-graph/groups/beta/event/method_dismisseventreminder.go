...
// user calendar.
func (c EventClient) DismissEventReminder(ctx context.Context, id beta.GroupIdEventId, options DismissEventReminderOperationOptions) (result DismissEventReminderOperationResponse, err error) {
