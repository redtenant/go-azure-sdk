...
func (c EventClient) GetEventsCount(ctx context.Context, id beta.GroupId, options GetEventsCountOperationOptions) (result GetEventsCountOperationResponse, err error) {
