...
func (c EventClient) ListEvents(ctx context.Context, id beta.GroupId, options ListEventsOperationOptions) (result ListEventsOperationResponse, err error) {
...
func (c EventClient) ListEventsComplete(ctx context.Context, id beta.GroupId, options ListEventsOperationOptions) (ListEventsCompleteResult, error) {
...
func (c EventClient) ListEventsCompleteMatchingPredicate(ctx context.Context, id beta.GroupId, options ListEventsOperationOptions, predicate EventOperationPredicate) (result ListEventsCompleteResult, err error) {
