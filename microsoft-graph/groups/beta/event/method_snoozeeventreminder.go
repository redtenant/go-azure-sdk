...
// time.
func (c EventClient) SnoozeEventReminder(ctx context.Context, id beta.GroupIdEventId, input SnoozeEventReminderRequest, options SnoozeEventReminderOperationOptions) (result SnoozeEventReminderOperationResponse, err error) {
