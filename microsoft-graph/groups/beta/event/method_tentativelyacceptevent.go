...
func (c EventClient) TentativelyAcceptEvent(ctx context.Context, id beta.GroupIdEventId, input TentativelyAcceptEventRequest, options TentativelyAcceptEventOperationOptions) (result TentativelyAcceptEventOperationResponse, err error) {
