...
func (c EventAttachmentClient) CreateEventAttachmentsUploadSession(ctx context.Context, id beta.GroupIdEventId, input CreateEventAttachmentsUploadSessionRequest, options CreateEventAttachmentsUploadSessionOperationOptions) (result CreateEventAttachmentsUploadSessionOperationResponse, err error) {
