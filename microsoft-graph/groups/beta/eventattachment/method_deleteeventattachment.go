...
func (c EventAttachmentClient) DeleteEventAttachment(ctx context.Context, id beta.GroupIdEventIdAttachmentId, options DeleteEventAttachmentOperationOptions) (result DeleteEventAttachmentOperationResponse, err error) {
