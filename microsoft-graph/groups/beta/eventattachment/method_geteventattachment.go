...
// GetEventAttachment - Get attachments from groups. The collection of FileAttachment, ItemAttachment, and
// referenceAttachment attachments for the event. Navigation property. Read-only. Nullable.
func (c EventAttachmentClient) GetEventAttachment(ctx context.Context, id beta.GroupIdEventIdAttachmentId, options GetEventAttachmentOperationOptions) (result GetEventAttachmentOperationResponse, err error) {
