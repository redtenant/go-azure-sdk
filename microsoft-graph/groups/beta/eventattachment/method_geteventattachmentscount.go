...
func (c EventAttachmentClient) GetEventAttachmentsCount(ctx context.Context, id beta.GroupIdEventId, options GetEventAttachmentsCountOperationOptions) (result GetEventAttachmentsCountOperationResponse, err error) {
