...
func (c EventAttachmentClient) ListEventAttachments(ctx context.Context, id beta.GroupIdEventId, options ListEventAttachmentsOperationOptions) (result ListEventAttachmentsOperationResponse, err error) {
...
func (c EventAttachmentClient) ListEventAttachmentsComplete(ctx context.Context, id beta.GroupIdEventId, options ListEventAttachmentsOperationOptions) (ListEventAttachmentsCompleteResult, error) {
...
func (c EventAttachmentClient) ListEventAttachmentsCompleteMatchingPredicate(ctx context.Context, id beta.GroupIdEventId, options ListEventAttachmentsOperationOptions, predicate AttachmentOperationPredicate) (result ListEventAttachmentsCompleteResult, err error) {
