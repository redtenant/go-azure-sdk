...
func DefaultCancelEventExceptionOccurrenceOperationOptions() CancelEventExceptionOccurrenceOperationOptions {
	return CancelEventExceptionOccurrenceOperationOptions{}
}
...
// CancelEventExceptionOccurrence - Invoke action cancel. This action allows the organizer of a meeting to send a
...
func (c EventExceptionOccurrenceClient) CancelEventExceptionOccurrence(ctx context.Context, id beta.GroupIdEventIdExceptionOccurrenceId, input CancelEventExceptionOccurrenceRequest, options CancelEventExceptionOccurrenceOperationOptions) (result CancelEventExceptionOccurrenceOperationResponse, err error) {
