...
func (c EventExceptionOccurrenceClient) DeclineEventExceptionOccurrence(ctx context.Context, id beta.GroupIdEventIdExceptionOccurrenceId, input DeclineEventExceptionOccurrenceRequest, options DeclineEventExceptionOccurrenceOperationOptions) (result DeclineEventExceptionOccurrenceOperationResponse, err error) {
