...
func (c EventExceptionOccurrenceClient) ForwardEventExceptionOccurrence(ctx context.Context, id beta.GroupIdEventIdExceptionOccurrenceId, input ForwardEventExceptionOccurrenceRequest, options ForwardEventExceptionOccurrenceOperationOptions) (result ForwardEventExceptionOccurrenceOperationResponse, err error) {
