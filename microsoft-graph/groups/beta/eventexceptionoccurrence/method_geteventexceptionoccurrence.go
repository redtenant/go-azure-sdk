...
func DefaultGetEventExceptionOccurrenceOperationOptions() GetEventExceptionOccurrenceOperationOptions {
	return GetEventExceptionOccurrenceOperationOptions{}
}
...
// GetEventExceptionOccurrence - Get exceptionOccurrences from groups
func (c EventExceptionOccurrenceClient) GetEventExceptionOccurrence(ctx context.Context, id beta.GroupIdEventIdExceptionOccurrenceId, options GetEventExceptionOccurrenceOperationOptions) (result GetEventExceptionOccurrenceOperationResponse, err error) {
