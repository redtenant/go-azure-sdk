...
func DefaultGetEventExceptionOccurrencesCountOperationOptions() GetEventExceptionOccurrencesCountOperationOptions {
	return GetEventExceptionOccurrencesCountOperationOptions{}
}
...
func (c EventExceptionOccurrenceClient) GetEventExceptionOccurrencesCount(ctx context.Context, id beta.GroupIdEventId, options GetEventExceptionOccurrencesCountOperationOptions) (result GetEventExceptionOccurrencesCountOperationResponse, err error) {
