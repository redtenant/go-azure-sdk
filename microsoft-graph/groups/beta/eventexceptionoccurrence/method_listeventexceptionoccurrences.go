...
func DefaultListEventExceptionOccurrencesOperationOptions() ListEventExceptionOccurrencesOperationOptions {
	return ListEventExceptionOccurrencesOperationOptions{}
}
...
// ListEventExceptionOccurrences - Get exceptionOccurrences from groups
func (c EventExceptionOccurrenceClient) ListEventExceptionOccurrences(ctx context.Context, id beta.GroupIdEventId, options ListEventExceptionOccurrencesOperationOptions) (result ListEventExceptionOccurrencesOperationResponse, err error) {
...
func (c EventExceptionOccurrenceClient) ListEventExceptionOccurrencesComplete(ctx context.Context, id beta.GroupIdEventId, options ListEventExceptionOccurrencesOperationOptions) (ListEventExceptionOccurrencesCompleteResult, error) {
	return c.ListEventExceptionOccurrencesCompleteMatchingPredicate(ctx, id, options, EventOperationPredicate{})
}

// ListEventExceptionOccurrencesCompleteMatchingPredicate retrieves all the results and then applies the predicate
func (c EventExceptionOccurrenceClient) ListEventExceptionOccurrencesCompleteMatchingPredicate(ctx context.Context, id beta.GroupIdEventId, options ListEventExceptionOccurrencesOperationOptions, predicate EventOperationPredicate) (result ListEventExceptionOccurrencesCompleteResult, err error) {
	items := make([]beta.Event, 0)

	resp, err := c.ListEventExceptionOccurrences(ctx, id, options)
	if err != nil {
