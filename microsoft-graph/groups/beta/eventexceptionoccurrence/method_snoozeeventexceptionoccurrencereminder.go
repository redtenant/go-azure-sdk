...
func (c EventExceptionOccurrenceClient) SnoozeEventExceptionOccurrenceReminder(ctx context.Context, id beta.GroupIdEventIdExceptionOccurrenceId, input SnoozeEventExceptionOccurrenceReminderRequest, options SnoozeEventExceptionOccurrenceReminderOperationOptions) (result SnoozeEventExceptionOccurrenceReminderOperationResponse, err error) {
