...
func (c EventExceptionOccurrenceInstanceClient) AcceptEventExceptionOccurrenceInstance(ctx context.Context, id beta.GroupIdEventIdExceptionOccurrenceIdInstanceId, input AcceptEventExceptionOccurrenceInstanceRequest, options AcceptEventExceptionOccurrenceInstanceOperationOptions) (result AcceptEventExceptionOccurrenceInstanceOperationResponse, err error) {
