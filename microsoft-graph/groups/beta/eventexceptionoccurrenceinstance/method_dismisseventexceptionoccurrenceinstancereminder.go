...
func (c EventExceptionOccurrenceInstanceClient) DismissEventExceptionOccurrenceInstanceReminder(ctx context.Context, id beta.GroupIdEventIdExceptionOccurrenceIdInstanceId, options DismissEventExceptionOccurrenceInstanceReminderOperationOptions) (result DismissEventExceptionOccurrenceInstanceReminderOperationResponse, err error) {
