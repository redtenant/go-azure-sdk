...
func (c EventExceptionOccurrenceInstanceClient) ForwardEventExceptionOccurrenceInstance(ctx context.Context, id beta.GroupIdEventIdExceptionOccurrenceIdInstanceId, input ForwardEventExceptionOccurrenceInstanceRequest, options ForwardEventExceptionOccurrenceInstanceOperationOptions) (result ForwardEventExceptionOccurrenceInstanceOperationResponse, err error) {
