...
// GetEventExceptionOccurrenceInstance - Get instances from groups. The occurrences of a recurring series, if the event
...
// Read-only. Nullable.
func (c EventExceptionOccurrenceInstanceClient) GetEventExceptionOccurrenceInstance(ctx context.Context, id beta.GroupIdEventIdExceptionOccurrenceIdInstanceId, options GetEventExceptionOccurrenceInstanceOperationOptions) (result GetEventExceptionOccurrenceInstanceOperationResponse, err error) {
