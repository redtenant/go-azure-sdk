...
func (c EventExceptionOccurrenceInstanceClient) SnoozeEventExceptionOccurrenceInstanceReminder(ctx context.Context, id beta.GroupIdEventIdExceptionOccurrenceIdInstanceId, input SnoozeEventExceptionOccurrenceInstanceReminderRequest, options SnoozeEventExceptionOccurrenceInstanceReminderOperationOptions) (result SnoozeEventExceptionOccurrenceInstanceReminderOperationResponse, err error) {
