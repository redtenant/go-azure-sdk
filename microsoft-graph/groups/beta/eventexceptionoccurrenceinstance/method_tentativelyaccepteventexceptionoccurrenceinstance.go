...
func (c EventExceptionOccurrenceInstanceClient) TentativelyAcceptEventExceptionOccurrenceInstance(ctx context.Context, id beta.GroupIdEventIdExceptionOccurrenceIdInstanceId, input TentativelyAcceptEventExceptionOccurrenceInstanceRequest, options TentativelyAcceptEventExceptionOccurrenceInstanceOperationOptions) (result TentativelyAcceptEventExceptionOccurrenceInstanceOperationResponse, err error) {
