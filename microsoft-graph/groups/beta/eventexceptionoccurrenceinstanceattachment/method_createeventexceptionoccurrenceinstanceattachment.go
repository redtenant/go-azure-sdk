...
// CreateEventExceptionOccurrenceInstanceAttachment - Create new navigation property to attachments for groups
func (c EventExceptionOccurrenceInstanceAttachmentClient) CreateEventExceptionOccurrenceInstanceAttachment(ctx context.Context, id beta.GroupIdEventIdExceptionOccurrenceIdInstanceId, input beta.Attachment, options CreateEventExceptionOccurrenceInstanceAttachmentOperationOptions) (result CreateEventExceptionOccurrenceInstanceAttachmentOperationResponse, err error) {
