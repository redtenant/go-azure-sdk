...
func DefaultCreateEventExceptionOccurrenceInstanceAttachmentsUploadSessionOperationOptions() CreateEventExceptionOccurrenceInstanceAttachmentsUploadSessionOperationOptions {
	return CreateEventExceptionOccurrenceInstanceAttachmentsUploadSessionOperationOptions{}
}
...
// CreateEventExceptionOccurrenceInstanceAttachmentsUploadSession - Invoke action createUploadSession. Create an upload
...
func (c EventExceptionOccurrenceInstanceAttachmentClient) CreateEventExceptionOccurrenceInstanceAttachmentsUploadSession(ctx context.Context, id beta.GroupIdEventIdExceptionOccurrenceIdInstanceId, input CreateEventExceptionOccurrenceInstanceAttachmentsUploadSessionRequest, options CreateEventExceptionOccurrenceInstanceAttachmentsUploadSessionOperationOptions) (result CreateEventExceptionOccurrenceInstanceAttachmentsUploadSessionOperationResponse, err error) {
