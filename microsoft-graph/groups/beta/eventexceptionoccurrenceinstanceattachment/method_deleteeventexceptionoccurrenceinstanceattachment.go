...
func DefaultDeleteEventExceptionOccurrenceInstanceAttachmentOperationOptions() DeleteEventExceptionOccurrenceInstanceAttachmentOperationOptions {
	return DeleteEventExceptionOccurrenceInstanceAttachmentOperationOptions{}
}
...
// DeleteEventExceptionOccurrenceInstanceAttachment - Delete navigation property attachments for groups
func (c EventExceptionOccurrenceInstanceAttachmentClient) DeleteEventExceptionOccurrenceInstanceAttachment(ctx context.Context, id beta.GroupIdEventIdExceptionOccurrenceIdInstanceIdAttachmentId, options DeleteEventExceptionOccurrenceInstanceAttachmentOperationOptions) (result DeleteEventExceptionOccurrenceInstanceAttachmentOperationResponse, err error) {
