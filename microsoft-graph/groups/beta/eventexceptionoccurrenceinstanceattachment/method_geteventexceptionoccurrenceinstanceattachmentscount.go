...
func DefaultGetEventExceptionOccurrenceInstanceAttachmentsCountOperationOptions() GetEventExceptionOccurrenceInstanceAttachmentsCountOperationOptions {
	return GetEventExceptionOccurrenceInstanceAttachmentsCountOperationOptions{}
}
...
func (c EventExceptionOccurrenceInstanceAttachmentClient) GetEventExceptionOccurrenceInstanceAttachmentsCount(ctx context.Context, id beta.GroupIdEventIdExceptionOccurrenceIdInstanceId, options GetEventExceptionOccurrenceInstanceAttachmentsCountOperationOptions) (result GetEventExceptionOccurrenceInstanceAttachmentsCountOperationResponse, err error) {
