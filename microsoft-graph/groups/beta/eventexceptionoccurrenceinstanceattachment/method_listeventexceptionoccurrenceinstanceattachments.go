...
// ListEventExceptionOccurrenceInstanceAttachments - Get attachments from groups. The collection of FileAttachment,
// ItemAttachment, and referenceAttachment attachments for the event. Navigation property. Read-only. Nullable.
func (c EventExceptionOccurrenceInstanceAttachmentClient) ListEventExceptionOccurrenceInstanceAttachments(ctx context.Context, id beta.GroupIdEventIdExceptionOccurrenceIdInstanceId, options ListEventExceptionOccurrenceInstanceAttachmentsOperationOptions) (result ListEventExceptionOccurrenceInstanceAttachmentsOperationResponse, err error) {
...
func (c EventExceptionOccurrenceInstanceAttachmentClient) ListEventExceptionOccurrenceInstanceAttachmentsComplete(ctx context.Context, id beta.GroupIdEventIdExceptionOccurrenceIdInstanceId, options ListEventExceptionOccurrenceInstanceAttachmentsOperationOptions) (ListEventExceptionOccurrenceInstanceAttachmentsCompleteResult, error) {
