...
// GetEventExceptionOccurrenceInstanceCalendar - Get calendar from groups. The calendar that contains the event.
// Navigation property. Read-only.
func (c EventExceptionOccurrenceInstanceCalendarClient) GetEventExceptionOccurrenceInstanceCalendar(ctx context.Context, id beta.GroupIdEventIdExceptionOccurrenceIdInstanceId, options GetEventExceptionOccurrenceInstanceCalendarOperationOptions) (result GetEventExceptionOccurrenceInstanceCalendarOperationResponse, err error) {
