...
// CreateEventExceptionOccurrenceInstanceExtension - Create new navigation property to extensions for groups
func (c EventExceptionOccurrenceInstanceExtensionClient) CreateEventExceptionOccurrenceInstanceExtension(ctx context.Context, id beta.GroupIdEventIdExceptionOccurrenceIdInstanceId, input beta.Extension, options CreateEventExceptionOccurrenceInstanceExtensionOperationOptions) (result CreateEventExceptionOccurrenceInstanceExtensionOperationResponse, err error) {
