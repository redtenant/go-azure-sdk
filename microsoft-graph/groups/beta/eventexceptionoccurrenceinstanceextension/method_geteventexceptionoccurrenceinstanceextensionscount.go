...
func (c EventExceptionOccurrenceInstanceExtensionClient) GetEventExceptionOccurrenceInstanceExtensionsCount(ctx context.Context, id beta.GroupIdEventIdExceptionOccurrenceIdInstanceId, options GetEventExceptionOccurrenceInstanceExtensionsCountOperationOptions) (result GetEventExceptionOccurrenceInstanceExtensionsCountOperationResponse, err error) {
