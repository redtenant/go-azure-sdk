...
// ListEventExceptionOccurrenceInstanceExtensions - Get extensions from groups. The collection of open extensions
// defined for the event. Nullable.
func (c EventExceptionOccurrenceInstanceExtensionClient) ListEventExceptionOccurrenceInstanceExtensions(ctx context.Context, id beta.GroupIdEventIdExceptionOccurrenceIdInstanceId, options ListEventExceptionOccurrenceInstanceExtensionsOperationOptions) (result ListEventExceptionOccurrenceInstanceExtensionsOperationResponse, err error) {
...
func (c EventExceptionOccurrenceInstanceExtensionClient) ListEventExceptionOccurrenceInstanceExtensionsComplete(ctx context.Context, id beta.GroupIdEventIdExceptionOccurrenceIdInstanceId, options ListEventExceptionOccurrenceInstanceExtensionsOperationOptions) (ListEventExceptionOccurrenceInstanceExtensionsCompleteResult, error) {
...
func (c EventExceptionOccurrenceInstanceExtensionClient) ListEventExceptionOccurrenceInstanceExtensionsCompleteMatchingPredicate(ctx context.Context, id beta.GroupIdEventIdExceptionOccurrenceIdInstanceId, options ListEventExceptionOccurrenceInstanceExtensionsOperationOptions, predicate ExtensionOperationPredicate) (result ListEventExceptionOccurrenceInstanceExtensionsCompleteResult, err error) {
