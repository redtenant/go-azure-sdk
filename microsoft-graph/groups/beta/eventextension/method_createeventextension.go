...
// CreateEventExtension - Create openTypeExtension. Create an open extension (openTypeExtension object) and add custom
...
func (c EventExtensionClient) CreateEventExtension(ctx context.Context, id beta.GroupIdEventId, input beta.Extension, options CreateEventExtensionOperationOptions) (result CreateEventExtensionOperationResponse, err error) {
