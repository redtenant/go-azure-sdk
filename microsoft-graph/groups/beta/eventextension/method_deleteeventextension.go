...
func (c EventExtensionClient) DeleteEventExtension(ctx context.Context, id beta.GroupIdEventIdExtensionId, options DeleteEventExtensionOperationOptions) (result DeleteEventExtensionOperationResponse, err error) {
