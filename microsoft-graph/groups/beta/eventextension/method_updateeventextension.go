...
func (c EventExtensionClient) UpdateEventExtension(ctx context.Context, id beta.GroupIdEventIdExtensionId, input beta.Extension, options UpdateEventExtensionOperationOptions) (result UpdateEventExtensionOperationResponse, err error) {
