...
func (c EventInstanceAttachmentClient) CreateEventInstanceAttachment(ctx context.Context, id beta.GroupIdEventIdInstanceId, input beta.Attachment, options CreateEventInstanceAttachmentOperationOptions) (result CreateEventInstanceAttachmentOperationResponse, err error) {
