...
func DefaultCreateEventInstanceAttachmentsUploadSessionOperationOptions() CreateEventInstanceAttachmentsUploadSessionOperationOptions {
	return CreateEventInstanceAttachmentsUploadSessionOperationOptions{}
}
...
// CreateEventInstanceAttachmentsUploadSession - Invoke action createUploadSession. Create an upload session that allows
// an app to iteratively upload ranges of a file, so as to attach the file to an Outlook item. The item can be a message
// or event. Use this approach to attach a file if the file size is between 3 MB and 150 MB. To attach a file that's
...
func (c EventInstanceAttachmentClient) CreateEventInstanceAttachmentsUploadSession(ctx context.Context, id beta.GroupIdEventIdInstanceId, input CreateEventInstanceAttachmentsUploadSessionRequest, options CreateEventInstanceAttachmentsUploadSessionOperationOptions) (result CreateEventInstanceAttachmentsUploadSessionOperationResponse, err error) {
