...
func (c EventInstanceAttachmentClient) DeleteEventInstanceAttachment(ctx context.Context, id beta.GroupIdEventIdInstanceIdAttachmentId, options DeleteEventInstanceAttachmentOperationOptions) (result DeleteEventInstanceAttachmentOperationResponse, err error) {
