...
func (c EventInstanceAttachmentClient) GetEventInstanceAttachment(ctx context.Context, id beta.GroupIdEventIdInstanceIdAttachmentId, options GetEventInstanceAttachmentOperationOptions) (result GetEventInstanceAttachmentOperationResponse, err error) {
