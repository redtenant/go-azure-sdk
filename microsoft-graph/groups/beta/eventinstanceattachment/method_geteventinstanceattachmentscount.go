...
func (c EventInstanceAttachmentClient) GetEventInstanceAttachmentsCount(ctx context.Context, id beta.GroupIdEventIdInstanceId, options GetEventInstanceAttachmentsCountOperationOptions) (result GetEventInstanceAttachmentsCountOperationResponse, err error) {
