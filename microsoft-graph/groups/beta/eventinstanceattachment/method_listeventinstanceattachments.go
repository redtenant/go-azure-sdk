...
func (c EventInstanceAttachmentClient) ListEventInstanceAttachments(ctx context.Context, id beta.GroupIdEventIdInstanceId, options ListEventInstanceAttachmentsOperationOptions) (result ListEventInstanceAttachmentsOperationResponse, err error) {
...
func (c EventInstanceAttachmentClient) ListEventInstanceAttachmentsComplete(ctx context.Context, id beta.GroupIdEventIdInstanceId, options ListEventInstanceAttachmentsOperationOptions) (ListEventInstanceAttachmentsCompleteResult, error) {
...
func (c EventInstanceAttachmentClient) ListEventInstanceAttachmentsCompleteMatchingPredicate(ctx context.Context, id beta.GroupIdEventIdInstanceId, options ListEventInstanceAttachmentsOperationOptions, predicate AttachmentOperationPredicate) (result ListEventInstanceAttachmentsCompleteResult, err error) {
