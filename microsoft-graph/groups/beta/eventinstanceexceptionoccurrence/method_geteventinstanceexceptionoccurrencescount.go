...
func (c EventInstanceExceptionOccurrenceClient) GetEventInstanceExceptionOccurrencesCount(ctx context.Context, id beta.GroupIdEventIdInstanceId, options GetEventInstanceExceptionOccurrencesCountOperationOptions) (result GetEventInstanceExceptionOccurrencesCountOperationResponse, err error) {
