...
// ListEventInstanceExceptionOccurrences - Get exceptionOccurrences from groups
func (c EventInstanceExceptionOccurrenceClient) ListEventInstanceExceptionOccurrences(ctx context.Context, id beta.GroupIdEventIdInstanceId, options ListEventInstanceExceptionOccurrencesOperationOptions) (result ListEventInstanceExceptionOccurrencesOperationResponse, err error) {
...
func (c EventInstanceExceptionOccurrenceClient) ListEventInstanceExceptionOccurrencesComplete(ctx context.Context, id beta.GroupIdEventIdInstanceId, options ListEventInstanceExceptionOccurrencesOperationOptions) (ListEventInstanceExceptionOccurrencesCompleteResult, error) {
...
func (c EventInstanceExceptionOccurrenceClient) ListEventInstanceExceptionOccurrencesCompleteMatchingPredicate(ctx context.Context, id beta.GroupIdEventIdInstanceId, options ListEventInstanceExceptionOccurrencesOperationOptions, predicate EventOperationPredicate) (result ListEventInstanceExceptionOccurrencesCompleteResult, err error) {
