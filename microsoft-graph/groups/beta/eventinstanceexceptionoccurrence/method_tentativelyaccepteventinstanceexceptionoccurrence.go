...
func (c EventInstanceExceptionOccurrenceClient) TentativelyAcceptEventInstanceExceptionOccurrence(ctx context.Context, id beta.GroupIdEventIdInstanceIdExceptionOccurrenceId, input TentativelyAcceptEventInstanceExceptionOccurrenceRequest, options TentativelyAcceptEventInstanceExceptionOccurrenceOperationOptions) (result TentativelyAcceptEventInstanceExceptionOccurrenceOperationResponse, err error) {
