...
// CreateEventInstanceExceptionOccurrenceAttachment - Create new navigation property to attachments for groups
func (c EventInstanceExceptionOccurrenceAttachmentClient) CreateEventInstanceExceptionOccurrenceAttachment(ctx context.Context, id beta.GroupIdEventIdInstanceIdExceptionOccurrenceId, input beta.Attachment, options CreateEventInstanceExceptionOccurrenceAttachmentOperationOptions) (result CreateEventInstanceExceptionOccurrenceAttachmentOperationResponse, err error) {
