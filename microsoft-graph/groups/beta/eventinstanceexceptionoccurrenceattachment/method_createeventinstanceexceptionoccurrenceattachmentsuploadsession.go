...
func (c EventInstanceExceptionOccurrenceAttachmentClient) CreateEventInstanceExceptionOccurrenceAttachmentsUploadSession(ctx context.Context, id beta.GroupIdEventIdInstanceIdExceptionOccurrenceId, input CreateEventInstanceExceptionOccurrenceAttachmentsUploadSessionRequest, options CreateEventInstanceExceptionOccurrenceAttachmentsUploadSessionOperationOptions) (result CreateEventInstanceExceptionOccurrenceAttachmentsUploadSessionOperationResponse, err error) {
