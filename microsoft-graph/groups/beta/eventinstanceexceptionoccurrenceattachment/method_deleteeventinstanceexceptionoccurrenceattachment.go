...
func DefaultDeleteEventInstanceExceptionOccurrenceAttachmentOperationOptions() DeleteEventInstanceExceptionOccurrenceAttachmentOperationOptions {
	return DeleteEventInstanceExceptionOccurrenceAttachmentOperationOptions{}
}
...
// DeleteEventInstanceExceptionOccurrenceAttachment - Delete navigation property attachments for groups
func (c EventInstanceExceptionOccurrenceAttachmentClient) DeleteEventInstanceExceptionOccurrenceAttachment(ctx context.Context, id beta.GroupIdEventIdInstanceIdExceptionOccurrenceIdAttachmentId, options DeleteEventInstanceExceptionOccurrenceAttachmentOperationOptions) (result DeleteEventInstanceExceptionOccurrenceAttachmentOperationResponse, err error) {
