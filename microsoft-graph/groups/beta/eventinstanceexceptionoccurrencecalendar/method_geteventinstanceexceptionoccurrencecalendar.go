...
// GetEventInstanceExceptionOccurrenceCalendar - Get calendar from groups. The calendar that contains the event.
// Navigation property. Read-only.
func (c EventInstanceExceptionOccurrenceCalendarClient) GetEventInstanceExceptionOccurrenceCalendar(ctx context.Context, id beta.GroupIdEventIdInstanceIdExceptionOccurrenceId, options GetEventInstanceExceptionOccurrenceCalendarOperationOptions) (result GetEventInstanceExceptionOccurrenceCalendarOperationResponse, err error) {
