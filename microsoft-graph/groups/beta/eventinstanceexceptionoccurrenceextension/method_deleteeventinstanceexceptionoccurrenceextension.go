...
// DeleteEventInstanceExceptionOccurrenceExtension - Delete navigation property extensions for groups
func (c EventInstanceExceptionOccurrenceExtensionClient) DeleteEventInstanceExceptionOccurrenceExtension(ctx context.Context, id beta.GroupIdEventIdInstanceIdExceptionOccurrenceIdExtensionId, options DeleteEventInstanceExceptionOccurrenceExtensionOperationOptions) (result DeleteEventInstanceExceptionOccurrenceExtensionOperationResponse, err error) {
