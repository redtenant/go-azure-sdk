...
func (c EventInstanceExtensionClient) CreateEventInstanceExtension(ctx context.Context, id beta.GroupIdEventIdInstanceId, input beta.Extension, options CreateEventInstanceExtensionOperationOptions) (result CreateEventInstanceExtensionOperationResponse, err error) {
