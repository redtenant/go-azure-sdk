...
func (c EventInstanceExtensionClient) UpdateEventInstanceExtension(ctx context.Context, id beta.GroupIdEventIdInstanceIdExtensionId, input beta.Extension, options UpdateEventInstanceExtensionOperationOptions) (result UpdateEventInstanceExtensionOperationResponse, err error) {
