...
func (c GroupClient) CheckMemberGroups(ctx context.Context, id beta.GroupId, input CheckMemberGroupsRequest, options CheckMemberGroupsOperationOptions) (result CheckMemberGroupsOperationResponse, err error) {
...
func (c GroupClient) CheckMemberGroupsComplete(ctx context.Context, id beta.GroupId, input CheckMemberGroupsRequest, options CheckMemberGroupsOperationOptions) (result CheckMemberGroupsCompleteResult, err error) {
	items := make([]string, 0)
