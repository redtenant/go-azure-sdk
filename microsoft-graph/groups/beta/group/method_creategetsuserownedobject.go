...
func (c GroupClient) CreateGetsUserOwnedObject(ctx context.Context, input CreateGetsUserOwnedObjectRequest, options CreateGetsUserOwnedObjectOperationOptions) (result CreateGetsUserOwnedObjectOperationResponse, err error) {
