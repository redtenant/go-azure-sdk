...
// password-based single sign-on credentials for a given group to a given service principal.
func (c GroupClient) DeletePasswordSingleSignOnCredentials(ctx context.Context, id beta.GroupId, input DeletePasswordSingleSignOnCredentialsRequest, options DeletePasswordSingleSignOnCredentialsOperationOptions) (result DeletePasswordSingleSignOnCredentialsOperationResponse, err error) {
