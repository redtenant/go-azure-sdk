...
func (c GroupClient) Restore(ctx context.Context, id beta.GroupId, input RestoreRequest, options RestoreOperationOptions) (result RestoreOperationResponse, err error) {
