...
func (c GroupClient) RetryServiceProvisioning(ctx context.Context, id beta.GroupId, options RetryServiceProvisioningOperationOptions) (result RetryServiceProvisioningOperationResponse, err error) {
