...
// ListMembers - List group members. Get a list of the group's direct members. A group can have users, contacts,
// devices, service principals, and other groups as members. This operation isn't transitive.
func (c MemberClient) ListMembers(ctx context.Context, id beta.GroupId, options ListMembersOperationOptions) (result ListMembersOperationResponse, err error) {
...
func (c MemberClient) ListMembersComplete(ctx context.Context, id beta.GroupId, options ListMembersOperationOptions) (ListMembersCompleteResult, error) {
...
func (c MemberClient) ListMembersCompleteMatchingPredicate(ctx context.Context, id beta.GroupId, options ListMembersOperationOptions, predicate DirectoryObjectOperationPredicate) (result ListMembersCompleteResult, err error) {
