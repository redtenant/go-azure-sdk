...
// RemoveMemberRefs - Remove member. Remove a member from a group via the members navigation property. You can't remove
// a member from groups with dynamic memberships.
func (c MemberClient) RemoveMemberRefs(ctx context.Context, id beta.GroupId, options RemoveMemberRefsOperationOptions) (result RemoveMemberRefsOperationResponse, err error) {
