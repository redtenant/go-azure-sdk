...
// GetMemberOf - Get memberOf from groups. Groups and administrative units that this group is a member of. HTTP Methods:
// GET (supported for all groups). Read-only. Nullable. Supports $expand.
