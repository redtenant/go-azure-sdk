...
func (c OnenoteNotebookClient) CopyOnenoteNotebookNotebook(ctx context.Context, id beta.GroupIdOnenoteNotebookId, input CopyOnenoteNotebookNotebookRequest, options CopyOnenoteNotebookNotebookOperationOptions) (result CopyOnenoteNotebookNotebookOperationResponse, err error) {
