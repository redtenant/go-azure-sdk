...
func (c OnenoteNotebookClient) CreateOnenoteNotebook(ctx context.Context, id beta.GroupId, input beta.Notebook, options CreateOnenoteNotebookOperationOptions) (result CreateOnenoteNotebookOperationResponse, err error) {
