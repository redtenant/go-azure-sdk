...
func (c OnenoteNotebookClient) DeleteOnenoteNotebook(ctx context.Context, id beta.GroupIdOnenoteNotebookId, options DeleteOnenoteNotebookOperationOptions) (result DeleteOnenoteNotebookOperationResponse, err error) {
