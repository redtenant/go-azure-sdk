...
func (c OnenoteNotebookClient) GetOnenoteNotebook(ctx context.Context, id beta.GroupIdOnenoteNotebookId, options GetOnenoteNotebookOperationOptions) (result GetOnenoteNotebookOperationResponse, err error) {
