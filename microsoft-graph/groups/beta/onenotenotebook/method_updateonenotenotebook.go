...
func (c OnenoteNotebookClient) UpdateOnenoteNotebook(ctx context.Context, id beta.GroupIdOnenoteNotebookId, input beta.Notebook, options UpdateOnenoteNotebookOperationOptions) (result UpdateOnenoteNotebookOperationResponse, err error) {
