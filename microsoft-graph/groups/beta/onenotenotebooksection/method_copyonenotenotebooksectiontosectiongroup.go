...
func DefaultCopyOnenoteNotebookSectionToSectionGroupOperationOptions() CopyOnenoteNotebookSectionToSectionGroupOperationOptions {
	return CopyOnenoteNotebookSectionToSectionGroupOperationOptions{}
}
...
// CopyOnenoteNotebookSectionToSectionGroup - Invoke action copyToSectionGroup. Copies a section to a specific section
// group. For Copy operations, you follow an asynchronous calling pattern: First call the Copy action, and then poll the
// operation endpoint for the result.
func (c OnenoteNotebookSectionClient) CopyOnenoteNotebookSectionToSectionGroup(ctx context.Context, id beta.GroupIdOnenoteNotebookIdSectionId, input CopyOnenoteNotebookSectionToSectionGroupRequest, options CopyOnenoteNotebookSectionToSectionGroupOperationOptions) (result CopyOnenoteNotebookSectionToSectionGroupOperationResponse, err error) {
