...
func (c OnenoteNotebookSectionClient) CreateOnenoteNotebookSection(ctx context.Context, id beta.GroupIdOnenoteNotebookId, input beta.OnenoteSection, options CreateOnenoteNotebookSectionOperationOptions) (result CreateOnenoteNotebookSectionOperationResponse, err error) {
