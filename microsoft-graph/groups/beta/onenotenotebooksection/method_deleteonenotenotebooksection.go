...
func (c OnenoteNotebookSectionClient) DeleteOnenoteNotebookSection(ctx context.Context, id beta.GroupIdOnenoteNotebookIdSectionId, options DeleteOnenoteNotebookSectionOperationOptions) (result DeleteOnenoteNotebookSectionOperationResponse, err error) {
