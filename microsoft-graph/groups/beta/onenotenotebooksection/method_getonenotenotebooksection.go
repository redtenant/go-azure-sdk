...
func (c OnenoteNotebookSectionClient) GetOnenoteNotebookSection(ctx context.Context, id beta.GroupIdOnenoteNotebookIdSectionId, options GetOnenoteNotebookSectionOperationOptions) (result GetOnenoteNotebookSectionOperationResponse, err error) {
