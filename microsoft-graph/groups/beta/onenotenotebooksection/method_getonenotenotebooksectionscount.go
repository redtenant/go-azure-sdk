...
func (c OnenoteNotebookSectionClient) GetOnenoteNotebookSectionsCount(ctx context.Context, id beta.GroupIdOnenoteNotebookId, options GetOnenoteNotebookSectionsCountOperationOptions) (result GetOnenoteNotebookSectionsCountOperationResponse, err error) {
