...
func (c OnenoteNotebookSectionClient) UpdateOnenoteNotebookSection(ctx context.Context, id beta.GroupIdOnenoteNotebookIdSectionId, input beta.OnenoteSection, options UpdateOnenoteNotebookSectionOperationOptions) (result UpdateOnenoteNotebookSectionOperationResponse, err error) {
