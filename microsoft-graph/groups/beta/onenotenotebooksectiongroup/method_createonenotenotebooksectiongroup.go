...
func (c OnenoteNotebookSectionGroupClient) CreateOnenoteNotebookSectionGroup(ctx context.Context, id beta.GroupIdOnenoteNotebookId, input beta.SectionGroup, options CreateOnenoteNotebookSectionGroupOperationOptions) (result CreateOnenoteNotebookSectionGroupOperationResponse, err error) {
