...
func (c OnenoteNotebookSectionGroupClient) DeleteOnenoteNotebookSectionGroup(ctx context.Context, id beta.GroupIdOnenoteNotebookIdSectionGroupId, options DeleteOnenoteNotebookSectionGroupOperationOptions) (result DeleteOnenoteNotebookSectionGroupOperationResponse, err error) {
