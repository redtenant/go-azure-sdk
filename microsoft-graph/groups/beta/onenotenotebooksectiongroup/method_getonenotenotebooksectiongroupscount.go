...
func (c OnenoteNotebookSectionGroupClient) GetOnenoteNotebookSectionGroupsCount(ctx context.Context, id beta.GroupIdOnenoteNotebookId, options GetOnenoteNotebookSectionGroupsCountOperationOptions) (result GetOnenoteNotebookSectionGroupsCountOperationResponse, err error) {
