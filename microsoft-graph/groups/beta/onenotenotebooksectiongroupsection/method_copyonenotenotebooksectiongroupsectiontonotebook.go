...
func (c OnenoteNotebookSectionGroupSectionClient) CopyOnenoteNotebookSectionGroupSectionToNotebook(ctx context.Context, id beta.GroupIdOnenoteNotebookIdSectionGroupIdSectionId, input CopyOnenoteNotebookSectionGroupSectionToNotebookRequest, options CopyOnenoteNotebookSectionGroupSectionToNotebookOperationOptions) (result CopyOnenoteNotebookSectionGroupSectionToNotebookOperationResponse, err error) {
