...
func (c OnenoteNotebookSectionGroupSectionClient) CopyOnenoteNotebookSectionGroupSectionToSectionGroup(ctx context.Context, id beta.GroupIdOnenoteNotebookIdSectionGroupIdSectionId, input CopyOnenoteNotebookSectionGroupSectionToSectionGroupRequest, options CopyOnenoteNotebookSectionGroupSectionToSectionGroupOperationOptions) (result CopyOnenoteNotebookSectionGroupSectionToSectionGroupOperationResponse, err error) {
