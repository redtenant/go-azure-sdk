...
// Nullable.
func (c OnenoteNotebookSectionGroupSectionClient) GetOnenoteNotebookSectionGroupSection(ctx context.Context, id beta.GroupIdOnenoteNotebookIdSectionGroupIdSectionId, options GetOnenoteNotebookSectionGroupSectionOperationOptions) (result GetOnenoteNotebookSectionGroupSectionOperationResponse, err error) {
