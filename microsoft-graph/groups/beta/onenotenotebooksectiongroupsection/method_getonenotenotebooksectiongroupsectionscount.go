...
func (c OnenoteNotebookSectionGroupSectionClient) GetOnenoteNotebookSectionGroupSectionsCount(ctx context.Context, id beta.GroupIdOnenoteNotebookIdSectionGroupId, options GetOnenoteNotebookSectionGroupSectionsCountOperationOptions) (result GetOnenoteNotebookSectionGroupSectionsCountOperationResponse, err error) {
