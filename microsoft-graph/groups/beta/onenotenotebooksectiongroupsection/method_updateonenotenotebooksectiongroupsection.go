...
func (c OnenoteNotebookSectionGroupSectionClient) UpdateOnenoteNotebookSectionGroupSection(ctx context.Context, id beta.GroupIdOnenoteNotebookIdSectionGroupIdSectionId, input beta.OnenoteSection, options UpdateOnenoteNotebookSectionGroupSectionOperationOptions) (result UpdateOnenoteNotebookSectionGroupSectionOperationResponse, err error) {
