...
func (c OnenoteNotebookSectionGroupSectionPageClient) DeleteOnenoteNotebookSectionGroupSectionPage(ctx context.Context, id beta.GroupIdOnenoteNotebookIdSectionGroupIdSectionIdPageId, options DeleteOnenoteNotebookSectionGroupSectionPageOperationOptions) (result DeleteOnenoteNotebookSectionGroupSectionPageOperationResponse, err error) {
