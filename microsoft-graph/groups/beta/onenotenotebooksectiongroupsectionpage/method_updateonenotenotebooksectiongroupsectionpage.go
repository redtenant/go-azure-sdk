...
func (c OnenoteNotebookSectionGroupSectionPageClient) UpdateOnenoteNotebookSectionGroupSectionPage(ctx context.Context, id beta.GroupIdOnenoteNotebookIdSectionGroupIdSectionIdPageId, input beta.OnenotePage, options UpdateOnenoteNotebookSectionGroupSectionPageOperationOptions) (result UpdateOnenoteNotebookSectionGroupSectionPageOperationResponse, err error) {
