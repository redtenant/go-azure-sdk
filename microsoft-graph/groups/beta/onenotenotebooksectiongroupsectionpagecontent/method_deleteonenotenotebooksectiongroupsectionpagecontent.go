...
// page's HTML content.
func (c OnenoteNotebookSectionGroupSectionPageContentClient) DeleteOnenoteNotebookSectionGroupSectionPageContent(ctx context.Context, id beta.GroupIdOnenoteNotebookIdSectionGroupIdSectionIdPageId, options DeleteOnenoteNotebookSectionGroupSectionPageContentOperationOptions) (result DeleteOnenoteNotebookSectionGroupSectionPageContentOperationResponse, err error) {
