...
func (c OnenoteNotebookSectionGroupSectionParentSectionGroupClient) GetOnenoteNotebookSectionGroupSectionParentSectionGroup(ctx context.Context, id beta.GroupIdOnenoteNotebookIdSectionGroupIdSectionId, options GetOnenoteNotebookSectionGroupSectionParentSectionGroupOperationOptions) (result GetOnenoteNotebookSectionGroupSectionParentSectionGroupOperationResponse, err error) {
