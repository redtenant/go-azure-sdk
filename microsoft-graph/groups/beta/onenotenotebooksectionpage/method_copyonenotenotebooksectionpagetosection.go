...
func (c OnenoteNotebookSectionPageClient) CopyOnenoteNotebookSectionPageToSection(ctx context.Context, id beta.GroupIdOnenoteNotebookIdSectionIdPageId, input CopyOnenoteNotebookSectionPageToSectionRequest, options CopyOnenoteNotebookSectionPageToSectionOperationOptions) (result CopyOnenoteNotebookSectionPageToSectionOperationResponse, err error) {
