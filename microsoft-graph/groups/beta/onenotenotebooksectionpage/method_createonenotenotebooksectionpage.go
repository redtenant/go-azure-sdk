...
func (c OnenoteNotebookSectionPageClient) CreateOnenoteNotebookSectionPage(ctx context.Context, id beta.GroupIdOnenoteNotebookIdSectionId, input beta.OnenotePage, options CreateOnenoteNotebookSectionPageOperationOptions) (result CreateOnenoteNotebookSectionPageOperationResponse, err error) {
