...
func (c OnenoteNotebookSectionPageClient) CreateOnenoteNotebookSectionPageOnenotePatchContent(ctx context.Context, id beta.GroupIdOnenoteNotebookIdSectionIdPageId, input CreateOnenoteNotebookSectionPageOnenotePatchContentRequest, options CreateOnenoteNotebookSectionPageOnenotePatchContentOperationOptions) (result CreateOnenoteNotebookSectionPageOnenotePatchContentOperationResponse, err error) {
