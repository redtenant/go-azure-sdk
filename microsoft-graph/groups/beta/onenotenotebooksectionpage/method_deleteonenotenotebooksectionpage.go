...
func (c OnenoteNotebookSectionPageClient) DeleteOnenoteNotebookSectionPage(ctx context.Context, id beta.GroupIdOnenoteNotebookIdSectionIdPageId, options DeleteOnenoteNotebookSectionPageOperationOptions) (result DeleteOnenoteNotebookSectionPageOperationResponse, err error) {
