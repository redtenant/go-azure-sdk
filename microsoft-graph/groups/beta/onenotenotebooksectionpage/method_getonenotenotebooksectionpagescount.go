...
func (c OnenoteNotebookSectionPageClient) GetOnenoteNotebookSectionPagesCount(ctx context.Context, id beta.GroupIdOnenoteNotebookIdSectionId, options GetOnenoteNotebookSectionPagesCountOperationOptions) (result GetOnenoteNotebookSectionPagesCountOperationResponse, err error) {
