...
func (c OnenoteNotebookSectionPageClient) ListOnenoteNotebookSectionPages(ctx context.Context, id beta.GroupIdOnenoteNotebookIdSectionId, options ListOnenoteNotebookSectionPagesOperationOptions) (result ListOnenoteNotebookSectionPagesOperationResponse, err error) {
...
func (c OnenoteNotebookSectionPageClient) ListOnenoteNotebookSectionPagesComplete(ctx context.Context, id beta.GroupIdOnenoteNotebookIdSectionId, options ListOnenoteNotebookSectionPagesOperationOptions) (ListOnenoteNotebookSectionPagesCompleteResult, error) {
