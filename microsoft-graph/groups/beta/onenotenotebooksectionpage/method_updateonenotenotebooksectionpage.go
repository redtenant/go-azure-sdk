...
func (c OnenoteNotebookSectionPageClient) UpdateOnenoteNotebookSectionPage(ctx context.Context, id beta.GroupIdOnenoteNotebookIdSectionIdPageId, input beta.OnenotePage, options UpdateOnenoteNotebookSectionPageOperationOptions) (result UpdateOnenoteNotebookSectionPageOperationResponse, err error) {
