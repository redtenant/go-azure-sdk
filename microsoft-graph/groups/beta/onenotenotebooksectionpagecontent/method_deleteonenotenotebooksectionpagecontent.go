...
// content.
func (c OnenoteNotebookSectionPageContentClient) DeleteOnenoteNotebookSectionPageContent(ctx context.Context, id beta.GroupIdOnenoteNotebookIdSectionIdPageId, options DeleteOnenoteNotebookSectionPageContentOperationOptions) (result DeleteOnenoteNotebookSectionPageContentOperationResponse, err error) {
