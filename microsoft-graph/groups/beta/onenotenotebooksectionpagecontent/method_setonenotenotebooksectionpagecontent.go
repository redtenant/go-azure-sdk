...
// content.
func (c OnenoteNotebookSectionPageContentClient) SetOnenoteNotebookSectionPageContent(ctx context.Context, id beta.GroupIdOnenoteNotebookIdSectionIdPageId, input []byte, options SetOnenoteNotebookSectionPageContentOperationOptions) (result SetOnenoteNotebookSectionPageContentOperationResponse, err error) {
