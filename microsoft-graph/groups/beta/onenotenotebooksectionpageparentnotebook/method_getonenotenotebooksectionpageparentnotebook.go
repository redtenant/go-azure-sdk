...
// GetOnenoteNotebookSectionPageParentNotebook - Get parentNotebook from groups. The notebook that contains the page.
// Read-only.
func (c OnenoteNotebookSectionPageParentNotebookClient) GetOnenoteNotebookSectionPageParentNotebook(ctx context.Context, id beta.GroupIdOnenoteNotebookIdSectionIdPageId, options GetOnenoteNotebookSectionPageParentNotebookOperationOptions) (result GetOnenoteNotebookSectionPageParentNotebookOperationResponse, err error) {
