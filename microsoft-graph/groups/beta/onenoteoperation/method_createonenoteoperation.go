...
func (c OnenoteOperationClient) CreateOnenoteOperation(ctx context.Context, id beta.GroupId, input beta.OnenoteOperation, options CreateOnenoteOperationOperationOptions) (result CreateOnenoteOperationOperationResponse, err error) {
