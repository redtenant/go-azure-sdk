...
func (c OnenoteOperationClient) DeleteOnenoteOperation(ctx context.Context, id beta.GroupIdOnenoteOperationId, options DeleteOnenoteOperationOperationOptions) (result DeleteOnenoteOperationOperationResponse, err error) {
