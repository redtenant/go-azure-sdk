...
func (c OnenoteOperationClient) GetOnenoteOperation(ctx context.Context, id beta.GroupIdOnenoteOperationId, options GetOnenoteOperationOperationOptions) (result GetOnenoteOperationOperationResponse, err error) {
