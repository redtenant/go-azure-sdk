...
func (c OnenoteOperationClient) ListOnenoteOperations(ctx context.Context, id beta.GroupId, options ListOnenoteOperationsOperationOptions) (result ListOnenoteOperationsOperationResponse, err error) {
...
func (c OnenoteOperationClient) ListOnenoteOperationsComplete(ctx context.Context, id beta.GroupId, options ListOnenoteOperationsOperationOptions) (ListOnenoteOperationsCompleteResult, error) {
...
func (c OnenoteOperationClient) ListOnenoteOperationsCompleteMatchingPredicate(ctx context.Context, id beta.GroupId, options ListOnenoteOperationsOperationOptions, predicate OnenoteOperationOperationPredicate) (result ListOnenoteOperationsCompleteResult, err error) {
