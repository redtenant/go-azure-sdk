...
func (c OnenoteOperationClient) UpdateOnenoteOperation(ctx context.Context, id beta.GroupIdOnenoteOperationId, input beta.OnenoteOperation, options UpdateOnenoteOperationOperationOptions) (result UpdateOnenoteOperationOperationResponse, err error) {
