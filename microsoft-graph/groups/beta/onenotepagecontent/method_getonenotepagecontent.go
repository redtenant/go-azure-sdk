...
func (c OnenotePageContentClient) GetOnenotePageContent(ctx context.Context, id beta.GroupIdOnenotePageId, options GetOnenotePageContentOperationOptions) (result GetOnenotePageContentOperationResponse, err error) {
