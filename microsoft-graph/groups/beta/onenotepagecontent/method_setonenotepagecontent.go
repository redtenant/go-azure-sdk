...
func (c OnenotePageContentClient) SetOnenotePageContent(ctx context.Context, id beta.GroupIdOnenotePageId, input []byte, options SetOnenotePageContentOperationOptions) (result SetOnenotePageContentOperationResponse, err error) {
