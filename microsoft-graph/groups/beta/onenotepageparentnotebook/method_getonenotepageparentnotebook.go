...
func (c OnenotePageParentNotebookClient) GetOnenotePageParentNotebook(ctx context.Context, id beta.GroupIdOnenotePageId, options GetOnenotePageParentNotebookOperationOptions) (result GetOnenotePageParentNotebookOperationResponse, err error) {
