...
func (c OnenoteResourceClient) CreateOnenoteResource(ctx context.Context, id beta.GroupId, input beta.OnenoteResource, options CreateOnenoteResourceOperationOptions) (result CreateOnenoteResourceOperationResponse, err error) {
