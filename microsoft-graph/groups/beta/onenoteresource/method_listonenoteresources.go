...
func (c OnenoteResourceClient) ListOnenoteResources(ctx context.Context, id beta.GroupId, options ListOnenoteResourcesOperationOptions) (result ListOnenoteResourcesOperationResponse, err error) {
...
func (c OnenoteResourceClient) ListOnenoteResourcesComplete(ctx context.Context, id beta.GroupId, options ListOnenoteResourcesOperationOptions) (ListOnenoteResourcesCompleteResult, error) {
...
func (c OnenoteResourceClient) ListOnenoteResourcesCompleteMatchingPredicate(ctx context.Context, id beta.GroupId, options ListOnenoteResourcesOperationOptions, predicate OnenoteResourceOperationPredicate) (result ListOnenoteResourcesCompleteResult, err error) {
