...
// GetOnenoteResourceContent - Get content for the navigation property resources from groups. The content of the
// resource.
func (c OnenoteResourceContentClient) GetOnenoteResourceContent(ctx context.Context, id beta.GroupIdOnenoteResourceId, options GetOnenoteResourceContentOperationOptions) (result GetOnenoteResourceContentOperationResponse, err error) {
