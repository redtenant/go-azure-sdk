...
// SetOnenoteResourceContent - Update content for the navigation property resources in groups. The content of the
// resource.
func (c OnenoteResourceContentClient) SetOnenoteResourceContent(ctx context.Context, id beta.GroupIdOnenoteResourceId, input []byte, options SetOnenoteResourceContentOperationOptions) (result SetOnenoteResourceContentOperationResponse, err error) {
