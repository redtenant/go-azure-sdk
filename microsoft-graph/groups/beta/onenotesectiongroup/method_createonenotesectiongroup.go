...
func (c OnenoteSectionGroupClient) CreateOnenoteSectionGroup(ctx context.Context, id beta.GroupId, input beta.SectionGroup, options CreateOnenoteSectionGroupOperationOptions) (result CreateOnenoteSectionGroupOperationResponse, err error) {
