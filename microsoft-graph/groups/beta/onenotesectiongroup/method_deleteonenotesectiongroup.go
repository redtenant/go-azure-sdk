...
func (c OnenoteSectionGroupClient) DeleteOnenoteSectionGroup(ctx context.Context, id beta.GroupIdOnenoteSectionGroupId, options DeleteOnenoteSectionGroupOperationOptions) (result DeleteOnenoteSectionGroupOperationResponse, err error) {
