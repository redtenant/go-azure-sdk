...
func (c OnenoteSectionGroupClient) GetOnenoteSectionGroupsCount(ctx context.Context, id beta.GroupId, options GetOnenoteSectionGroupsCountOperationOptions) (result GetOnenoteSectionGroupsCountOperationResponse, err error) {
