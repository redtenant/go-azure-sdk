...
func (c OnenoteSectionGroupSectionClient) CreateOnenoteSectionGroupSection(ctx context.Context, id beta.GroupIdOnenoteSectionGroupId, input beta.OnenoteSection, options CreateOnenoteSectionGroupSectionOperationOptions) (result CreateOnenoteSectionGroupSectionOperationResponse, err error) {
