...
func (c OnenoteSectionGroupSectionClient) DeleteOnenoteSectionGroupSection(ctx context.Context, id beta.GroupIdOnenoteSectionGroupIdSectionId, options DeleteOnenoteSectionGroupSectionOperationOptions) (result DeleteOnenoteSectionGroupSectionOperationResponse, err error) {
