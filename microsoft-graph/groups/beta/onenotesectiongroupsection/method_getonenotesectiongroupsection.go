...
func (c OnenoteSectionGroupSectionClient) GetOnenoteSectionGroupSection(ctx context.Context, id beta.GroupIdOnenoteSectionGroupIdSectionId, options GetOnenoteSectionGroupSectionOperationOptions) (result GetOnenoteSectionGroupSectionOperationResponse, err error) {
