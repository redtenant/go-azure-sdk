...
func (c OnenoteSectionGroupSectionClient) GetOnenoteSectionGroupSectionsCount(ctx context.Context, id beta.GroupIdOnenoteSectionGroupId, options GetOnenoteSectionGroupSectionsCountOperationOptions) (result GetOnenoteSectionGroupSectionsCountOperationResponse, err error) {
