...
func (c OnenoteSectionGroupSectionClient) ListOnenoteSectionGroupSections(ctx context.Context, id beta.GroupIdOnenoteSectionGroupId, options ListOnenoteSectionGroupSectionsOperationOptions) (result ListOnenoteSectionGroupSectionsOperationResponse, err error) {
...
func (c OnenoteSectionGroupSectionClient) ListOnenoteSectionGroupSectionsComplete(ctx context.Context, id beta.GroupIdOnenoteSectionGroupId, options ListOnenoteSectionGroupSectionsOperationOptions) (ListOnenoteSectionGroupSectionsCompleteResult, error) {
...
func (c OnenoteSectionGroupSectionClient) ListOnenoteSectionGroupSectionsCompleteMatchingPredicate(ctx context.Context, id beta.GroupIdOnenoteSectionGroupId, options ListOnenoteSectionGroupSectionsOperationOptions, predicate OnenoteSectionOperationPredicate) (result ListOnenoteSectionGroupSectionsCompleteResult, err error) {
