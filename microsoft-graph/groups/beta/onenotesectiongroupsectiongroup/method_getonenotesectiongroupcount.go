...
func (c OnenoteSectionGroupSectionGroupClient) GetOnenoteSectionGroupCount(ctx context.Context, id beta.GroupIdOnenoteSectionGroupId, options GetOnenoteSectionGroupCountOperationOptions) (result GetOnenoteSectionGroupCountOperationResponse, err error) {
