...
// ListOnenoteSectionGroupSectionGroups - Get sectionGroups from groups. The section groups in the section. Read-only.
// Nullable.
func (c OnenoteSectionGroupSectionGroupClient) ListOnenoteSectionGroupSectionGroups(ctx context.Context, id beta.GroupIdOnenoteSectionGroupId, options ListOnenoteSectionGroupSectionGroupsOperationOptions) (result ListOnenoteSectionGroupSectionGroupsOperationResponse, err error) {
...
func (c OnenoteSectionGroupSectionGroupClient) ListOnenoteSectionGroupSectionGroupsComplete(ctx context.Context, id beta.GroupIdOnenoteSectionGroupId, options ListOnenoteSectionGroupSectionGroupsOperationOptions) (ListOnenoteSectionGroupSectionGroupsCompleteResult, error) {
...
func (c OnenoteSectionGroupSectionGroupClient) ListOnenoteSectionGroupSectionGroupsCompleteMatchingPredicate(ctx context.Context, id beta.GroupIdOnenoteSectionGroupId, options ListOnenoteSectionGroupSectionGroupsOperationOptions, predicate SectionGroupOperationPredicate) (result ListOnenoteSectionGroupSectionGroupsCompleteResult, err error) {
