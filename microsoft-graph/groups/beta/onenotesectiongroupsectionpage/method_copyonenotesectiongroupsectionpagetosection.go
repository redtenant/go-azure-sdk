...
func (c OnenoteSectionGroupSectionPageClient) CopyOnenoteSectionGroupSectionPageToSection(ctx context.Context, id beta.GroupIdOnenoteSectionGroupIdSectionIdPageId, input CopyOnenoteSectionGroupSectionPageToSectionRequest, options CopyOnenoteSectionGroupSectionPageToSectionOperationOptions) (result CopyOnenoteSectionGroupSectionPageToSectionOperationResponse, err error) {
