...
func (c OnenoteSectionGroupSectionPageClient) DeleteOnenoteSectionGroupSectionPage(ctx context.Context, id beta.GroupIdOnenoteSectionGroupIdSectionIdPageId, options DeleteOnenoteSectionGroupSectionPageOperationOptions) (result DeleteOnenoteSectionGroupSectionPageOperationResponse, err error) {
