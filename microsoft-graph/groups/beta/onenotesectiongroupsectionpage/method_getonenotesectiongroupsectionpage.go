...
// Nullable.
func (c OnenoteSectionGroupSectionPageClient) GetOnenoteSectionGroupSectionPage(ctx context.Context, id beta.GroupIdOnenoteSectionGroupIdSectionIdPageId, options GetOnenoteSectionGroupSectionPageOperationOptions) (result GetOnenoteSectionGroupSectionPageOperationResponse, err error) {
