...
func (c OnenoteSectionGroupSectionPageClient) GetOnenoteSectionGroupSectionPagesCount(ctx context.Context, id beta.GroupIdOnenoteSectionGroupIdSectionId, options GetOnenoteSectionGroupSectionPagesCountOperationOptions) (result GetOnenoteSectionGroupSectionPagesCountOperationResponse, err error) {
