...
// Nullable.
func (c OnenoteSectionGroupSectionPageClient) ListOnenoteSectionGroupSectionPages(ctx context.Context, id beta.GroupIdOnenoteSectionGroupIdSectionId, options ListOnenoteSectionGroupSectionPagesOperationOptions) (result ListOnenoteSectionGroupSectionPagesOperationResponse, err error) {
...
func (c OnenoteSectionGroupSectionPageClient) ListOnenoteSectionGroupSectionPagesComplete(ctx context.Context, id beta.GroupIdOnenoteSectionGroupIdSectionId, options ListOnenoteSectionGroupSectionPagesOperationOptions) (ListOnenoteSectionGroupSectionPagesCompleteResult, error) {
...
func (c OnenoteSectionGroupSectionPageClient) ListOnenoteSectionGroupSectionPagesCompleteMatchingPredicate(ctx context.Context, id beta.GroupIdOnenoteSectionGroupIdSectionId, options ListOnenoteSectionGroupSectionPagesOperationOptions, predicate OnenotePageOperationPredicate) (result ListOnenoteSectionGroupSectionPagesCompleteResult, err error) {
