...
// HTML content.
func (c OnenoteSectionGroupSectionPageContentClient) DeleteOnenoteSectionGroupSectionPageContent(ctx context.Context, id beta.GroupIdOnenoteSectionGroupIdSectionIdPageId, options DeleteOnenoteSectionGroupSectionPageContentOperationOptions) (result DeleteOnenoteSectionGroupSectionPageContentOperationResponse, err error) {
