...
// content.
func (c OnenoteSectionGroupSectionPageContentClient) GetOnenoteSectionGroupSectionPageContent(ctx context.Context, id beta.GroupIdOnenoteSectionGroupIdSectionIdPageId, options GetOnenoteSectionGroupSectionPageContentOperationOptions) (result GetOnenoteSectionGroupSectionPageContentOperationResponse, err error) {
