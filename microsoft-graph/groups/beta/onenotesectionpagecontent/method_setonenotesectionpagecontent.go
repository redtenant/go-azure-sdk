...
func (c OnenoteSectionPageContentClient) SetOnenoteSectionPageContent(ctx context.Context, id beta.GroupIdOnenoteSectionIdPageId, input []byte, options SetOnenoteSectionPageContentOperationOptions) (result SetOnenoteSectionPageContentOperationResponse, err error) {
