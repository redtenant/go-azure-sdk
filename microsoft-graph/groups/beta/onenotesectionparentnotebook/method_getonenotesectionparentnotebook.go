...
func (c OnenoteSectionParentNotebookClient) GetOnenoteSectionParentNotebook(ctx context.Context, id beta.GroupIdOnenoteSectionId, options GetOnenoteSectionParentNotebookOperationOptions) (result GetOnenoteSectionParentNotebookOperationResponse, err error) {
