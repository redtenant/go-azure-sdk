...
// ListOwners - List group owners. Retrieve a list of the group's owners. The owners are a set of users who are allowed
// to modify the group object. Owners are currently not available in Microsoft Graph for groups that were created in
