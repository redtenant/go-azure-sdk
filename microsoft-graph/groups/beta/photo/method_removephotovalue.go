...
func DefaultRemovePhotoValueOperationOptions() RemovePhotoValueOperationOptions {
	return RemovePhotoValueOperationOptions{}
}
...
// RemovePhotoValue - Delete media content for the navigation property photos in groups. The unique identifier for an
// entity. Read-only.
func (c PhotoClient) RemovePhotoValue(ctx context.Context, id beta.GroupIdPhotoId, options RemovePhotoValueOperationOptions) (result RemovePhotoValueOperationResponse, err error) {
