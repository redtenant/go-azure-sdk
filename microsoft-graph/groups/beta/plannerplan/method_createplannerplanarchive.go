...
func (c PlannerPlanClient) CreatePlannerPlanArchive(ctx context.Context, id beta.GroupIdPlannerPlanId, input CreatePlannerPlanArchiveRequest, options CreatePlannerPlanArchiveOperationOptions) (result CreatePlannerPlanArchiveOperationResponse, err error) {
