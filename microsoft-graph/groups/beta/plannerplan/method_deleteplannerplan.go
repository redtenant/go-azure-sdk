...
func (c PlannerPlanClient) DeletePlannerPlan(ctx context.Context, id beta.GroupIdPlannerPlanId, options DeletePlannerPlanOperationOptions) (result DeletePlannerPlanOperationResponse, err error) {
