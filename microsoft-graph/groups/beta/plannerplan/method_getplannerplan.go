...
func (c PlannerPlanClient) GetPlannerPlan(ctx context.Context, id beta.GroupIdPlannerPlanId, options GetPlannerPlanOperationOptions) (result GetPlannerPlanOperationResponse, err error) {
