...
func (c PlannerPlanClient) GetPlannerPlansCount(ctx context.Context, id beta.GroupId, options GetPlannerPlansCountOperationOptions) (result GetPlannerPlansCountOperationResponse, err error) {
