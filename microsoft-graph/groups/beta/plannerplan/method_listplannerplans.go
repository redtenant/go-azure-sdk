...
func (c PlannerPlanClient) ListPlannerPlans(ctx context.Context, id beta.GroupId, options ListPlannerPlansOperationOptions) (result ListPlannerPlansOperationResponse, err error) {
...
func (c PlannerPlanClient) ListPlannerPlansComplete(ctx context.Context, id beta.GroupId, options ListPlannerPlansOperationOptions) (ListPlannerPlansCompleteResult, error) {
...
func (c PlannerPlanClient) ListPlannerPlansCompleteMatchingPredicate(ctx context.Context, id beta.GroupId, options ListPlannerPlansOperationOptions, predicate PlannerPlanOperationPredicate) (result ListPlannerPlansCompleteResult, err error) {
