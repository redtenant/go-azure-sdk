...
func (c PlannerPlanClient) MovePlannerPlanToContainer(ctx context.Context, id beta.GroupIdPlannerPlanId, input MovePlannerPlanToContainerRequest, options MovePlannerPlanToContainerOperationOptions) (result MovePlannerPlanToContainerOperationResponse, err error) {
