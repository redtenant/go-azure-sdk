...
func (c PlannerPlanClient) UpdatePlannerPlan(ctx context.Context, id beta.GroupIdPlannerPlanId, input beta.PlannerPlan, options UpdatePlannerPlanOperationOptions) (result UpdatePlannerPlanOperationResponse, err error) {
