...
func (c PlannerPlanBucketClient) CreatePlannerPlanBucket(ctx context.Context, id beta.GroupIdPlannerPlanId, input beta.PlannerBucket, options CreatePlannerPlanBucketOperationOptions) (result CreatePlannerPlanBucketOperationResponse, err error) {
