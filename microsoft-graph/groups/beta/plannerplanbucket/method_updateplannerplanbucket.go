...
func (c PlannerPlanBucketClient) UpdatePlannerPlanBucket(ctx context.Context, id beta.GroupIdPlannerPlanIdBucketId, input beta.PlannerBucket, options UpdatePlannerPlanBucketOperationOptions) (result UpdatePlannerPlanBucketOperationResponse, err error) {
