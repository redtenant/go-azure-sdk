...
func (c PlannerPlanBucketTaskClient) GetPlannerPlanBucketTask(ctx context.Context, id beta.GroupIdPlannerPlanIdBucketIdTaskId, options GetPlannerPlanBucketTaskOperationOptions) (result GetPlannerPlanBucketTaskOperationResponse, err error) {
