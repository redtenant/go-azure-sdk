...
func (c PlannerPlanBucketTaskClient) UpdatePlannerPlanBucketTask(ctx context.Context, id beta.GroupIdPlannerPlanIdBucketIdTaskId, input beta.PlannerTask, options UpdatePlannerPlanBucketTaskOperationOptions) (result UpdatePlannerPlanBucketTaskOperationResponse, err error) {
