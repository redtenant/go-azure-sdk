...
func (c PlannerPlanBucketTaskAssignedToTaskBoardFormatClient) GetPlannerPlanBucketTaskAssignedToTaskBoardFormat(ctx context.Context, id beta.GroupIdPlannerPlanIdBucketIdTaskId, options GetPlannerPlanBucketTaskAssignedToTaskBoardFormatOperationOptions) (result GetPlannerPlanBucketTaskAssignedToTaskBoardFormatOperationResponse, err error) {
