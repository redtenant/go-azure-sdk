...
// UpdatePlannerPlanBucketTaskBoardFormat - Update the navigation property bucketTaskBoardFormat in groups
func (c PlannerPlanBucketTaskBucketTaskBoardFormatClient) UpdatePlannerPlanBucketTaskBoardFormat(ctx context.Context, id beta.GroupIdPlannerPlanIdBucketIdTaskId, input beta.PlannerBucketTaskBoardTaskFormat, options UpdatePlannerPlanBucketTaskBoardFormatOperationOptions) (result UpdatePlannerPlanBucketTaskBoardFormatOperationResponse, err error) {
