...
func (c PlannerPlanBucketTaskDetailClient) DeletePlannerPlanBucketTaskDetail(ctx context.Context, id beta.GroupIdPlannerPlanIdBucketIdTaskId, options DeletePlannerPlanBucketTaskDetailOperationOptions) (result DeletePlannerPlanBucketTaskDetailOperationResponse, err error) {
