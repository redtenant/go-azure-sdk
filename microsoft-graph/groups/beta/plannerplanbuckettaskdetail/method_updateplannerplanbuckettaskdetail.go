...
func (c PlannerPlanBucketTaskDetailClient) UpdatePlannerPlanBucketTaskDetail(ctx context.Context, id beta.GroupIdPlannerPlanIdBucketIdTaskId, input beta.PlannerTaskDetails, options UpdatePlannerPlanBucketTaskDetailOperationOptions) (result UpdatePlannerPlanBucketTaskDetailOperationResponse, err error) {
