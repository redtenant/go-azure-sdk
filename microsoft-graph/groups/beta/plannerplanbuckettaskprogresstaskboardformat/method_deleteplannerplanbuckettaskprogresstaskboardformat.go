...
func (c PlannerPlanBucketTaskProgressTaskBoardFormatClient) DeletePlannerPlanBucketTaskProgressTaskBoardFormat(ctx context.Context, id beta.GroupIdPlannerPlanIdBucketIdTaskId, options DeletePlannerPlanBucketTaskProgressTaskBoardFormatOperationOptions) (result DeletePlannerPlanBucketTaskProgressTaskBoardFormatOperationResponse, err error) {
