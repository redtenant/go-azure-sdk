...
func (c PlannerPlanBucketTaskProgressTaskBoardFormatClient) GetPlannerPlanBucketTaskProgressTaskBoardFormat(ctx context.Context, id beta.GroupIdPlannerPlanIdBucketIdTaskId, options GetPlannerPlanBucketTaskProgressTaskBoardFormatOperationOptions) (result GetPlannerPlanBucketTaskProgressTaskBoardFormatOperationResponse, err error) {
