...
func (c PlannerPlanBucketTaskProgressTaskBoardFormatClient) UpdatePlannerPlanBucketTaskProgressTaskBoardFormat(ctx context.Context, id beta.GroupIdPlannerPlanIdBucketIdTaskId, input beta.PlannerProgressTaskBoardTaskFormat, options UpdatePlannerPlanBucketTaskProgressTaskBoardFormatOperationOptions) (result UpdatePlannerPlanBucketTaskProgressTaskBoardFormatOperationResponse, err error) {
