...
func (c PlannerPlanDetailClient) UpdatePlannerPlanDetail(ctx context.Context, id beta.GroupIdPlannerPlanId, input beta.PlannerPlanDetails, options UpdatePlannerPlanDetailOperationOptions) (result UpdatePlannerPlanDetailOperationResponse, err error) {
