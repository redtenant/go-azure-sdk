...
func (c PlannerPlanTaskClient) UpdatePlannerPlanTask(ctx context.Context, id beta.GroupIdPlannerPlanIdTaskId, input beta.PlannerTask, options UpdatePlannerPlanTaskOperationOptions) (result UpdatePlannerPlanTaskOperationResponse, err error) {
