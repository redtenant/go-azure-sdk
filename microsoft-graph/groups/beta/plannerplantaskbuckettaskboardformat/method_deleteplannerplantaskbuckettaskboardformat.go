...
func (c PlannerPlanTaskBucketTaskBoardFormatClient) DeletePlannerPlanTaskBucketTaskBoardFormat(ctx context.Context, id beta.GroupIdPlannerPlanIdTaskId, options DeletePlannerPlanTaskBucketTaskBoardFormatOperationOptions) (result DeletePlannerPlanTaskBucketTaskBoardFormatOperationResponse, err error) {
