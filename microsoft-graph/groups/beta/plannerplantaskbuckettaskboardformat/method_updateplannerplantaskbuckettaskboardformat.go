...
type UpdatePlannerPlanTaskBucketTaskBoardFormatOperationResponse struct {
	HttpResponse *http.Response
	OData        *odata.OData
}

type UpdatePlannerPlanTaskBucketTaskBoardFormatOperationOptions struct {
	IfMatch   *string
...
func DefaultUpdatePlannerPlanTaskBucketTaskBoardFormatOperationOptions() UpdatePlannerPlanTaskBucketTaskBoardFormatOperationOptions {
	return UpdatePlannerPlanTaskBucketTaskBoardFormatOperationOptions{}
}
...
// UpdatePlannerPlanTaskBucketTaskBoardFormat - Update the navigation property bucketTaskBoardFormat in groups
func (c PlannerPlanTaskBucketTaskBoardFormatClient) UpdatePlannerPlanTaskBucketTaskBoardFormat(ctx context.Context, id beta.GroupIdPlannerPlanIdTaskId, input beta.PlannerBucketTaskBoardTaskFormat, options UpdatePlannerPlanTaskBucketTaskBoardFormatOperationOptions) (result UpdatePlannerPlanTaskBucketTaskBoardFormatOperationResponse, err error) {
