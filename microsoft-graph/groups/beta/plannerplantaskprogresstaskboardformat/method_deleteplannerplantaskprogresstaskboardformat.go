...
func (c PlannerPlanTaskProgressTaskBoardFormatClient) DeletePlannerPlanTaskProgressTaskBoardFormat(ctx context.Context, id beta.GroupIdPlannerPlanIdTaskId, options DeletePlannerPlanTaskProgressTaskBoardFormatOperationOptions) (result DeletePlannerPlanTaskProgressTaskBoardFormatOperationResponse, err error) {
