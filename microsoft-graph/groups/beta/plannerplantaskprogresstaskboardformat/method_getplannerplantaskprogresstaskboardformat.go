...
func (c PlannerPlanTaskProgressTaskBoardFormatClient) GetPlannerPlanTaskProgressTaskBoardFormat(ctx context.Context, id beta.GroupIdPlannerPlanIdTaskId, options GetPlannerPlanTaskProgressTaskBoardFormatOperationOptions) (result GetPlannerPlanTaskProgressTaskBoardFormatOperationResponse, err error) {
