...
// ListRejectedSenderRefs - List rejectedSenders. Get a list of users or groups that are in the rejected-senders list
// for this group. Users in the rejected senders list can't post to conversations of the group (identified in the GET
