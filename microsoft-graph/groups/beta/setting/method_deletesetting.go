...
func (c SettingClient) DeleteSetting(ctx context.Context, id beta.GroupIdSettingId, options DeleteSettingOperationOptions) (result DeleteSettingOperationResponse, err error) {
