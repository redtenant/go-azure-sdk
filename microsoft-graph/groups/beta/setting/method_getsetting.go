...
// GetSetting - Get settings from groups. Settings that can govern this group's behavior, like whether members can
// invite guest users to the group. Nullable.
func (c SettingClient) GetSetting(ctx context.Context, id beta.GroupIdSettingId, options GetSettingOperationOptions) (result GetSettingOperationResponse, err error) {
