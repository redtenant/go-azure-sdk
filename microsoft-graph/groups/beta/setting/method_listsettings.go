...
// ListSettings - Get settings from groups. Settings that can govern this group's behavior, like whether members can
// invite guest users to the group. Nullable.
func (c SettingClient) ListSettings(ctx context.Context, id beta.GroupId, options ListSettingsOperationOptions) (result ListSettingsOperationResponse, err error) {
...
func (c SettingClient) ListSettingsComplete(ctx context.Context, id beta.GroupId, options ListSettingsOperationOptions) (ListSettingsCompleteResult, error) {
	return c.ListSettingsCompleteMatchingPredicate(ctx, id, options, DirectorySettingOperationPredicate{})
}

// ListSettingsCompleteMatchingPredicate retrieves all the results and then applies the predicate
func (c SettingClient) ListSettingsCompleteMatchingPredicate(ctx context.Context, id beta.GroupId, options ListSettingsOperationOptions, predicate DirectorySettingOperationPredicate) (result ListSettingsCompleteResult, err error) {
