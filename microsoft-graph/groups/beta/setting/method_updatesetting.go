...
// UpdateSetting - Update the navigation property settings in groups
func (c SettingClient) UpdateSetting(ctx context.Context, id beta.GroupIdSettingId, input beta.DirectorySetting, options UpdateSettingOperationOptions) (result UpdateSettingOperationResponse, err error) {
