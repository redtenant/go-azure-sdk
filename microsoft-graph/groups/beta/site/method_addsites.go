...
func (c SiteClient) AddSites(ctx context.Context, id beta.GroupId, input AddSitesRequest, options AddSitesOperationOptions) (result AddSitesOperationResponse, err error) {
...
func (c SiteClient) AddSitesComplete(ctx context.Context, id beta.GroupId, input AddSitesRequest, options AddSitesOperationOptions) (AddSitesCompleteResult, error) {
