...
func DefaultGetSiteOperationOptions() GetSiteOperationOptions {
	return GetSiteOperationOptions{}
}
...
// GetSite - Get sites from groups. The list of SharePoint sites in this group. Access the default site with
// /sites/root.
func (c SiteClient) GetSite(ctx context.Context, id beta.GroupIdSiteId, options GetSiteOperationOptions) (result GetSiteOperationResponse, err error) {
