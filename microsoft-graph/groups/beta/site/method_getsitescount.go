...
func (c SiteClient) GetSitesCount(ctx context.Context, id beta.GroupId, options GetSitesCountOperationOptions) (result GetSitesCountOperationResponse, err error) {
