...
func (c SiteAnalyticsClient) UpdateSiteAnalytic(ctx context.Context, id beta.GroupIdSiteId, input beta.ItemAnalytics, options UpdateSiteAnalyticOperationOptions) (result UpdateSiteAnalyticOperationResponse, err error) {
