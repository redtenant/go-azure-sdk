...
type CreateSiteAnalyticsItemActivityStatOperationResponse struct {
...
func (c SiteAnalyticsItemActivityStatClient) CreateSiteAnalyticsItemActivityStat(ctx context.Context, id beta.GroupIdSiteId, input beta.ItemActivityStat, options CreateSiteAnalyticsItemActivityStatOperationOptions) (result CreateSiteAnalyticsItemActivityStatOperationResponse, err error) {
