...
func (c SiteAnalyticsItemActivityStatClient) UpdateSiteAnalyticsItemActivityStat(ctx context.Context, id beta.GroupIdSiteIdAnalyticsItemActivityStatId, input beta.ItemActivityStat, options UpdateSiteAnalyticsItemActivityStatOperationOptions) (result UpdateSiteAnalyticsItemActivityStatOperationResponse, err error) {
