...
func (c SiteAnalyticsItemActivityStatActivityClient) GetSiteAnalyticsItemActivityStatActivitiesCount(ctx context.Context, id beta.GroupIdSiteIdAnalyticsItemActivityStatId, options GetSiteAnalyticsItemActivityStatActivitiesCountOperationOptions) (result GetSiteAnalyticsItemActivityStatActivitiesCountOperationResponse, err error) {
