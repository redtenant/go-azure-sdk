...
func (c SiteAnalyticsItemActivityStatActivityClient) ListSiteAnalyticsItemActivityStatActivities(ctx context.Context, id beta.GroupIdSiteIdAnalyticsItemActivityStatId, options ListSiteAnalyticsItemActivityStatActivitiesOperationOptions) (result ListSiteAnalyticsItemActivityStatActivitiesOperationResponse, err error) {
...
func (c SiteAnalyticsItemActivityStatActivityClient) ListSiteAnalyticsItemActivityStatActivitiesComplete(ctx context.Context, id beta.GroupIdSiteIdAnalyticsItemActivityStatId, options ListSiteAnalyticsItemActivityStatActivitiesOperationOptions) (ListSiteAnalyticsItemActivityStatActivitiesCompleteResult, error) {
...
func (c SiteAnalyticsItemActivityStatActivityClient) ListSiteAnalyticsItemActivityStatActivitiesCompleteMatchingPredicate(ctx context.Context, id beta.GroupIdSiteIdAnalyticsItemActivityStatId, options ListSiteAnalyticsItemActivityStatActivitiesOperationOptions, predicate ItemActivityOperationPredicate) (result ListSiteAnalyticsItemActivityStatActivitiesCompleteResult, err error) {
