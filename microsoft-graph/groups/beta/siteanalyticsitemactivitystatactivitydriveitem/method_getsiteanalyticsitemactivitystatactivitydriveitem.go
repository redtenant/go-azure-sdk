...
func (c SiteAnalyticsItemActivityStatActivityDriveItemClient) GetSiteAnalyticsItemActivityStatActivityDriveItem(ctx context.Context, id beta.GroupIdSiteIdAnalyticsItemActivityStatIdActivityId, options GetSiteAnalyticsItemActivityStatActivityDriveItemOperationOptions) (result GetSiteAnalyticsItemActivityStatActivityDriveItemOperationResponse, err error) {
