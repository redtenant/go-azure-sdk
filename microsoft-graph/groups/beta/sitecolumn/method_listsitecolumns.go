...
// site.
func (c SiteColumnClient) ListSiteColumns(ctx context.Context, id beta.GroupIdSiteId, options ListSiteColumnsOperationOptions) (result ListSiteColumnsOperationResponse, err error) {
...
func (c SiteColumnClient) ListSiteColumnsComplete(ctx context.Context, id beta.GroupIdSiteId, options ListSiteColumnsOperationOptions) (ListSiteColumnsCompleteResult, error) {
...
func (c SiteColumnClient) ListSiteColumnsCompleteMatchingPredicate(ctx context.Context, id beta.GroupIdSiteId, options ListSiteColumnsOperationOptions, predicate ColumnDefinitionOperationPredicate) (result ListSiteColumnsCompleteResult, err error) {
