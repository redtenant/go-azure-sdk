...
func DefaultListSiteContentModelsOperationOptions() ListSiteContentModelsOperationOptions {
	return ListSiteContentModelsOperationOptions{}
}

func (o ListSiteContentModelsOperationOptions) ToHeaders() *client.Headers {
	out := client.Headers{}

	return &out
}

func (o ListSiteContentModelsOperationOptions) ToOData() *odata.Query {
	out := odata.Query{}
	if o.Count != nil {
		out.Count = *o.Count
	}
...
func (o ListSiteContentModelsOperationOptions) ToQuery() *client.QueryParams {
...
func (c SiteContentModelClient) ListSiteContentModels(ctx context.Context, id beta.GroupIdSiteId, options ListSiteContentModelsOperationOptions) (result ListSiteContentModelsOperationResponse, err error) {
	opts := client.RequestOptions{
		...
		Pager:         &ListSiteContentModelsCustomPager{},
	...
	var values struct {
		Values *[]beta.ContentModel `json:"value"`
	}
...
func (c SiteContentModelClient) ListSiteContentModelsComplete(ctx context.Context, id beta.GroupIdSiteId, options ListSiteContentModelsOperationOptions) (ListSiteContentModelsCompleteResult, error) {
	return c.ListSiteContentModelsCompleteMatchingPredicate(ctx, id, options, ContentModelOperationPredicate{})
}
...
func (c SiteContentModelClient) ListSiteContentModelsCompleteMatchingPredicate(ctx context.Context, id beta.GroupIdSiteId, options ListSiteContentModelsOperationOptions, predicate ContentModelOperationPredicate) (result ListSiteContentModelsCompleteResult, err error) {
	items := make([]beta.ContentModel, 0)

	resp, err := c.ListSiteContentModels(ctx, id, options)
	if err != nil {
	...
	result = ListSiteContentModelsCompleteResult{
