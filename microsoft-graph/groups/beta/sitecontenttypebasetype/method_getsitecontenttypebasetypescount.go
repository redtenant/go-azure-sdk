...
type GetSiteContentTypeBaseTypesCountOperationResponse struct {
...
func DefaultGetSiteContentTypeBaseTypesCountOperationOptions() GetSiteContentTypeBaseTypesCountOperationOptions {
	return GetSiteContentTypeBaseTypesCountOperationOptions{}
}
...
func (c SiteContentTypeBaseTypeClient) GetSiteContentTypeBaseTypesCount(ctx context.Context, id beta.GroupIdSiteIdContentTypeId, options GetSiteContentTypeBaseTypesCountOperationOptions) (result GetSiteContentTypeBaseTypesCountOperationResponse, err error) {
