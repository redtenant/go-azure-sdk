...
func (c SiteContentTypeColumnClient) GetSiteContentTypeColumn(ctx context.Context, id beta.GroupIdSiteIdContentTypeIdColumnId, options GetSiteContentTypeColumnOperationOptions) (result GetSiteContentTypeColumnOperationResponse, err error) {
