...
func (c SiteContentTypeColumnClient) GetSiteContentTypeColumnsCount(ctx context.Context, id beta.GroupIdSiteIdContentTypeId, options GetSiteContentTypeColumnsCountOperationOptions) (result GetSiteContentTypeColumnsCountOperationResponse, err error) {
