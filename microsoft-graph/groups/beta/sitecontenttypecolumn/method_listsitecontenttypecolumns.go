...
func (c SiteContentTypeColumnClient) ListSiteContentTypeColumns(ctx context.Context, id beta.GroupIdSiteIdContentTypeId, options ListSiteContentTypeColumnsOperationOptions) (result ListSiteContentTypeColumnsOperationResponse, err error) {
...
func (c SiteContentTypeColumnClient) ListSiteContentTypeColumnsComplete(ctx context.Context, id beta.GroupIdSiteIdContentTypeId, options ListSiteContentTypeColumnsOperationOptions) (ListSiteContentTypeColumnsCompleteResult, error) {
...
func (c SiteContentTypeColumnClient) ListSiteContentTypeColumnsCompleteMatchingPredicate(ctx context.Context, id beta.GroupIdSiteIdContentTypeId, options ListSiteContentTypeColumnsOperationOptions, predicate ColumnDefinitionOperationPredicate) (result ListSiteContentTypeColumnsCompleteResult, err error) {
