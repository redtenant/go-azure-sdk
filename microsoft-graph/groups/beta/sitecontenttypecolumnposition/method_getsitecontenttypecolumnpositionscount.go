...
func (c SiteContentTypeColumnPositionClient) GetSiteContentTypeColumnPositionsCount(ctx context.Context, id beta.GroupIdSiteIdContentTypeId, options GetSiteContentTypeColumnPositionsCountOperationOptions) (result GetSiteContentTypeColumnPositionsCountOperationResponse, err error) {
