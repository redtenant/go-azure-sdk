...
func (c SiteContentTypeColumnPositionClient) ListSiteContentTypeColumnPositions(ctx context.Context, id beta.GroupIdSiteIdContentTypeId, options ListSiteContentTypeColumnPositionsOperationOptions) (result ListSiteContentTypeColumnPositionsOperationResponse, err error) {
...
func (c SiteContentTypeColumnPositionClient) ListSiteContentTypeColumnPositionsComplete(ctx context.Context, id beta.GroupIdSiteIdContentTypeId, options ListSiteContentTypeColumnPositionsOperationOptions) (ListSiteContentTypeColumnPositionsCompleteResult, error) {
