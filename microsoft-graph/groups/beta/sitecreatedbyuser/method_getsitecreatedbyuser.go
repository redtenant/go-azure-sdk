...
// GetSiteCreatedByUser - Get createdByUser from groups
func (c SiteCreatedByUserClient) GetSiteCreatedByUser(ctx context.Context, id beta.GroupIdSiteId, options GetSiteCreatedByUserOperationOptions) (result GetSiteCreatedByUserOperationResponse, err error) {
