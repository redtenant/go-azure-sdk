...
func (c SiteCreatedByUserMailboxSettingClient) UpdateSiteCreatedByUserMailboxSetting(ctx context.Context, id beta.GroupIdSiteId, input beta.MailboxSettings, options UpdateSiteCreatedByUserMailboxSettingOperationOptions) (result UpdateSiteCreatedByUserMailboxSettingOperationResponse, err error) {
