...
type DeleteSiteDocumentProcessingJobOperationResponse struct {
	HttpResponse *http.Response
	OData        *odata.OData
}

type DeleteSiteDocumentProcessingJobOperationOptions struct {
	IfMatch   *string
...
func DefaultDeleteSiteDocumentProcessingJobOperationOptions() DeleteSiteDocumentProcessingJobOperationOptions {
	return DeleteSiteDocumentProcessingJobOperationOptions{}
}
