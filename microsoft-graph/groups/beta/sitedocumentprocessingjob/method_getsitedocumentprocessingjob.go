...
type GetSiteDocumentProcessingJobOperationResponse struct {
	HttpResponse *http.Response
	OData        *odata.OData
	Model        *beta.DocumentProcessingJob
}

type GetSiteDocumentProcessingJobOperationOptions struct {
	Expand    *odata.Expand
...
func DefaultGetSiteDocumentProcessingJobOperationOptions() GetSiteDocumentProcessingJobOperationOptions {
	return GetSiteDocumentProcessingJobOperationOptions{}
}
...
// GetSiteDocumentProcessingJob - Get documentProcessingJobs from groups. The document processing jobs running on this
// site.
