...
func (c SiteDriveClient) ListSiteDrives(ctx context.Context, id beta.GroupIdSiteId, options ListSiteDrivesOperationOptions) (result ListSiteDrivesOperationResponse, err error) {
...
func (c SiteDriveClient) ListSiteDrivesComplete(ctx context.Context, id beta.GroupIdSiteId, options ListSiteDrivesOperationOptions) (ListSiteDrivesCompleteResult, error) {
...
func (c SiteDriveClient) ListSiteDrivesCompleteMatchingPredicate(ctx context.Context, id beta.GroupIdSiteId, options ListSiteDrivesOperationOptions, predicate DriveOperationPredicate) (result ListSiteDrivesCompleteResult, err error) {
