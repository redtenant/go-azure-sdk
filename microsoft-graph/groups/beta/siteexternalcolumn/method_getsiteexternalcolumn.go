...
// GetSiteExternalColumn - Get externalColumns from groups. The collection of column definitions available in the site
// that is referenced from the sites in the parent hierarchy of the current site.
func (c SiteExternalColumnClient) GetSiteExternalColumn(ctx context.Context, id beta.GroupIdSiteIdExternalColumnId, options GetSiteExternalColumnOperationOptions) (result GetSiteExternalColumnOperationResponse, err error) {
