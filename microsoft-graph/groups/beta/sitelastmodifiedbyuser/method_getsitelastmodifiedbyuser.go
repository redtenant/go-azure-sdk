...
// GetSiteLastModifiedByUser - Get lastModifiedByUser from groups
func (c SiteLastModifiedByUserClient) GetSiteLastModifiedByUser(ctx context.Context, id beta.GroupIdSiteId, options GetSiteLastModifiedByUserOperationOptions) (result GetSiteLastModifiedByUserOperationResponse, err error) {
