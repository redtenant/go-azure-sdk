...
func (c SiteListClient) UpdateSiteList(ctx context.Context, id beta.GroupIdSiteIdListId, input beta.List, options UpdateSiteListOperationOptions) (result UpdateSiteListOperationResponse, err error) {
