...
func (c SiteListColumnClient) GetSiteListColumn(ctx context.Context, id beta.GroupIdSiteIdListIdColumnId, options GetSiteListColumnOperationOptions) (result GetSiteListColumnOperationResponse, err error) {
