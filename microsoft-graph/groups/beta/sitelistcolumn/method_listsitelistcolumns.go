...
func (c SiteListColumnClient) ListSiteListColumns(ctx context.Context, id beta.GroupIdSiteIdListId, options ListSiteListColumnsOperationOptions) (result ListSiteListColumnsOperationResponse, err error) {
...
func (c SiteListColumnClient) ListSiteListColumnsComplete(ctx context.Context, id beta.GroupIdSiteIdListId, options ListSiteListColumnsOperationOptions) (ListSiteListColumnsCompleteResult, error) {
...
func (c SiteListColumnClient) ListSiteListColumnsCompleteMatchingPredicate(ctx context.Context, id beta.GroupIdSiteIdListId, options ListSiteListColumnsOperationOptions, predicate ColumnDefinitionOperationPredicate) (result ListSiteListColumnsCompleteResult, err error) {
