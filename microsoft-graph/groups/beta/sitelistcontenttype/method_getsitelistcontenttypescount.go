...
func (c SiteListContentTypeClient) GetSiteListContentTypesCount(ctx context.Context, id beta.GroupIdSiteIdListId, options GetSiteListContentTypesCountOperationOptions) (result GetSiteListContentTypesCountOperationResponse, err error) {
