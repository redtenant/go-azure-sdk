...
// this content type.
func (c SiteListContentTypeBaseTypeClient) GetSiteListContentTypeBaseType(ctx context.Context, id beta.GroupIdSiteIdListIdContentTypeIdBaseTypeId, options GetSiteListContentTypeBaseTypeOperationOptions) (result GetSiteListContentTypeBaseTypeOperationResponse, err error) {
