...
// this content type.
func (c SiteListContentTypeBaseTypeClient) ListSiteListContentTypeBaseTypes(ctx context.Context, id beta.GroupIdSiteIdListIdContentTypeId, options ListSiteListContentTypeBaseTypesOperationOptions) (result ListSiteListContentTypeBaseTypesOperationResponse, err error) {
...
func (c SiteListContentTypeBaseTypeClient) ListSiteListContentTypeBaseTypesComplete(ctx context.Context, id beta.GroupIdSiteIdListIdContentTypeId, options ListSiteListContentTypeBaseTypesOperationOptions) (ListSiteListContentTypeBaseTypesCompleteResult, error) {
...
func (c SiteListContentTypeBaseTypeClient) ListSiteListContentTypeBaseTypesCompleteMatchingPredicate(ctx context.Context, id beta.GroupIdSiteIdListIdContentTypeId, options ListSiteListContentTypeBaseTypesOperationOptions, predicate ContentTypeOperationPredicate) (result ListSiteListContentTypeBaseTypesCompleteResult, err error) {
