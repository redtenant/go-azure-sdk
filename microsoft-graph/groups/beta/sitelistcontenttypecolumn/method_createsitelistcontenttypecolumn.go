...
func (c SiteListContentTypeColumnClient) CreateSiteListContentTypeColumn(ctx context.Context, id beta.GroupIdSiteIdListIdContentTypeId, input beta.ColumnDefinition, options CreateSiteListContentTypeColumnOperationOptions) (result CreateSiteListContentTypeColumnOperationResponse, err error) {
