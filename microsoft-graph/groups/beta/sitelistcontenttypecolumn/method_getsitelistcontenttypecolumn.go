...
func (c SiteListContentTypeColumnClient) GetSiteListContentTypeColumn(ctx context.Context, id beta.GroupIdSiteIdListIdContentTypeIdColumnId, options GetSiteListContentTypeColumnOperationOptions) (result GetSiteListContentTypeColumnOperationResponse, err error) {
