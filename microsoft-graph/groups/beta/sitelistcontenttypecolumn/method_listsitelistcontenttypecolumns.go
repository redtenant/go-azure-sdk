...
func (c SiteListContentTypeColumnClient) ListSiteListContentTypeColumns(ctx context.Context, id beta.GroupIdSiteIdListIdContentTypeId, options ListSiteListContentTypeColumnsOperationOptions) (result ListSiteListContentTypeColumnsOperationResponse, err error) {
...
func (c SiteListContentTypeColumnClient) ListSiteListContentTypeColumnsComplete(ctx context.Context, id beta.GroupIdSiteIdListIdContentTypeId, options ListSiteListContentTypeColumnsOperationOptions) (ListSiteListContentTypeColumnsCompleteResult, error) {
