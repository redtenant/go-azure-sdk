...
func (c SiteListContentTypeColumnLinkClient) CreateSiteListContentTypeColumnLink(ctx context.Context, id beta.GroupIdSiteIdListIdContentTypeId, input beta.ColumnLink, options CreateSiteListContentTypeColumnLinkOperationOptions) (result CreateSiteListContentTypeColumnLinkOperationResponse, err error) {
