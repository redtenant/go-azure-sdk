...
// content type.
func (c SiteListContentTypeColumnLinkClient) GetSiteListContentTypeColumnLink(ctx context.Context, id beta.GroupIdSiteIdListIdContentTypeIdColumnLinkId, options GetSiteListContentTypeColumnLinkOperationOptions) (result GetSiteListContentTypeColumnLinkOperationResponse, err error) {
