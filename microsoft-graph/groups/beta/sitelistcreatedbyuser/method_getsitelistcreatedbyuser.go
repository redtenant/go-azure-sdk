...
// GetSiteListCreatedByUser - Get createdByUser from groups
func (c SiteListCreatedByUserClient) GetSiteListCreatedByUser(ctx context.Context, id beta.GroupIdSiteIdListId, options GetSiteListCreatedByUserOperationOptions) (result GetSiteListCreatedByUserOperationResponse, err error) {
