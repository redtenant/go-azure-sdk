...
// object.
func (c SiteListCreatedByUserServiceProvisioningErrorClient) ListSiteListCreatedByUserServiceProvisioningErrors(ctx context.Context, id beta.GroupIdSiteIdListId, options ListSiteListCreatedByUserServiceProvisioningErrorsOperationOptions) (result ListSiteListCreatedByUserServiceProvisioningErrorsOperationResponse, err error) {
...
func (c SiteListCreatedByUserServiceProvisioningErrorClient) ListSiteListCreatedByUserServiceProvisioningErrorsComplete(ctx context.Context, id beta.GroupIdSiteIdListId, options ListSiteListCreatedByUserServiceProvisioningErrorsOperationOptions) (ListSiteListCreatedByUserServiceProvisioningErrorsCompleteResult, error) {
...
func (c SiteListCreatedByUserServiceProvisioningErrorClient) ListSiteListCreatedByUserServiceProvisioningErrorsCompleteMatchingPredicate(ctx context.Context, id beta.GroupIdSiteIdListId, options ListSiteListCreatedByUserServiceProvisioningErrorsOperationOptions, predicate ServiceProvisioningErrorOperationPredicate) (result ListSiteListCreatedByUserServiceProvisioningErrorsCompleteResult, err error) {
