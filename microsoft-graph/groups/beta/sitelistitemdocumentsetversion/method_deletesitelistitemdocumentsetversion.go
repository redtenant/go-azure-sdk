...
func (c SiteListItemDocumentSetVersionClient) DeleteSiteListItemDocumentSetVersion(ctx context.Context, id beta.GroupIdSiteIdListIdItemIdDocumentSetVersionId, options DeleteSiteListItemDocumentSetVersionOperationOptions) (result DeleteSiteListItemDocumentSetVersionOperationResponse, err error) {
