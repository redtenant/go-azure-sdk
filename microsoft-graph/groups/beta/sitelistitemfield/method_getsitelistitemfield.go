...
func (c SiteListItemFieldClient) GetSiteListItemField(ctx context.Context, id beta.GroupIdSiteIdListIdItemId, options GetSiteListItemFieldOperationOptions) (result GetSiteListItemFieldOperationResponse, err error) {
