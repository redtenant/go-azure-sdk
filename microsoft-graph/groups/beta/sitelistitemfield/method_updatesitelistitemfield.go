...
func (c SiteListItemFieldClient) UpdateSiteListItemField(ctx context.Context, id beta.GroupIdSiteIdListIdItemId, input beta.FieldValueSet, options UpdateSiteListItemFieldOperationOptions) (result UpdateSiteListItemFieldOperationResponse, err error) {
