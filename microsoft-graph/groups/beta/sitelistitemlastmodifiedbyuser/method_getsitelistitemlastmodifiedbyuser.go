...
// GetSiteListItemLastModifiedByUser - Get lastModifiedByUser from groups
func (c SiteListItemLastModifiedByUserClient) GetSiteListItemLastModifiedByUser(ctx context.Context, id beta.GroupIdSiteIdListIdItemId, options GetSiteListItemLastModifiedByUserOperationOptions) (result GetSiteListItemLastModifiedByUserOperationResponse, err error) {
