...
// on $select.
func (c SiteListItemLastModifiedByUserMailboxSettingClient) GetSiteListItemLastModifiedByUserMailboxSetting(ctx context.Context, id beta.GroupIdSiteIdListIdItemId, options GetSiteListItemLastModifiedByUserMailboxSettingOperationOptions) (result GetSiteListItemLastModifiedByUserMailboxSettingOperationResponse, err error) {
