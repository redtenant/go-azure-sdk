...
// from a user object.
func (c SiteListItemLastModifiedByUserServiceProvisioningErrorClient) ListSiteListItemLastModifiedByUserServiceProvisioningErrors(ctx context.Context, id beta.GroupIdSiteIdListIdItemId, options ListSiteListItemLastModifiedByUserServiceProvisioningErrorsOperationOptions) (result ListSiteListItemLastModifiedByUserServiceProvisioningErrorsOperationResponse, err error) {
...
func (c SiteListItemLastModifiedByUserServiceProvisioningErrorClient) ListSiteListItemLastModifiedByUserServiceProvisioningErrorsComplete(ctx context.Context, id beta.GroupIdSiteIdListIdItemId, options ListSiteListItemLastModifiedByUserServiceProvisioningErrorsOperationOptions) (ListSiteListItemLastModifiedByUserServiceProvisioningErrorsCompleteResult, error) {
