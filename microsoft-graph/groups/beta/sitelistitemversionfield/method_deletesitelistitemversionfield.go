...
func (c SiteListItemVersionFieldClient) DeleteSiteListItemVersionField(ctx context.Context, id beta.GroupIdSiteIdListIdItemIdVersionId, options DeleteSiteListItemVersionFieldOperationOptions) (result DeleteSiteListItemVersionFieldOperationResponse, err error) {
