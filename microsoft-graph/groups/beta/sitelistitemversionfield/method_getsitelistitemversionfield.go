...
// list item.
func (c SiteListItemVersionFieldClient) GetSiteListItemVersionField(ctx context.Context, id beta.GroupIdSiteIdListIdItemIdVersionId, options GetSiteListItemVersionFieldOperationOptions) (result GetSiteListItemVersionFieldOperationResponse, err error) {
