...
func (c SiteListOperationClient) CreateSiteListOperation(ctx context.Context, id beta.GroupIdSiteIdListId, input beta.RichLongRunningOperation, options CreateSiteListOperationOperationOptions) (result CreateSiteListOperationOperationResponse, err error) {
