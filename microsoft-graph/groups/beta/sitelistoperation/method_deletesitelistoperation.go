...
func DefaultDeleteSiteListOperationOperationOptions() DeleteSiteListOperationOperationOptions {
	return DeleteSiteListOperationOperationOptions{}
}
...
func (c SiteListOperationClient) DeleteSiteListOperation(ctx context.Context, id beta.GroupIdSiteIdListIdOperationId, options DeleteSiteListOperationOperationOptions) (result DeleteSiteListOperationOperationResponse, err error) {
