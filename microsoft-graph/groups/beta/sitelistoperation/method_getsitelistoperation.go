...
func DefaultGetSiteListOperationOperationOptions() GetSiteListOperationOperationOptions {
	return GetSiteListOperationOperationOptions{}
}
...
func (c SiteListOperationClient) GetSiteListOperation(ctx context.Context, id beta.GroupIdSiteIdListIdOperationId, options GetSiteListOperationOperationOptions) (result GetSiteListOperationOperationResponse, err error) {
