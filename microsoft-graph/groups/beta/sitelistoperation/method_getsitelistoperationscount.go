...
func DefaultGetSiteListOperationsCountOperationOptions() GetSiteListOperationsCountOperationOptions {
	return GetSiteListOperationsCountOperationOptions{}
}
...
func (c SiteListOperationClient) GetSiteListOperationsCount(ctx context.Context, id beta.GroupIdSiteIdListId, options GetSiteListOperationsCountOperationOptions) (result GetSiteListOperationsCountOperationResponse, err error) {
