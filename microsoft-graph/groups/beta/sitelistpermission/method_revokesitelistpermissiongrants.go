...
func DefaultRevokeSiteListPermissionGrantsOperationOptions() RevokeSiteListPermissionGrantsOperationOptions {
	return RevokeSiteListPermissionGrantsOperationOptions{}
}
...
// RevokeSiteListPermissionGrants - Invoke action revokeGrants. Revoke access to a listItem or driveItem granted via a
