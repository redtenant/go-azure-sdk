...
func (c SiteOnenoteClient) UpdateSiteOnenote(ctx context.Context, id beta.GroupIdSiteId, input beta.Onenote, options UpdateSiteOnenoteOperationOptions) (result UpdateSiteOnenoteOperationResponse, err error) {
