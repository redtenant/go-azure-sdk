...
func DefaultCopySiteOnenoteNotebookSectionToNotebookOperationOptions() CopySiteOnenoteNotebookSectionToNotebookOperationOptions {
	return CopySiteOnenoteNotebookSectionToNotebookOperationOptions{}
}
...
// CopySiteOnenoteNotebookSectionToNotebook - Invoke action copyToNotebook. Copies a section to a specific notebook. For
