...
func (c SiteOnenoteNotebookSectionClient) CreateSiteOnenoteNotebookSection(ctx context.Context, id beta.GroupIdSiteIdOnenoteNotebookId, input beta.OnenoteSection, options CreateSiteOnenoteNotebookSectionOperationOptions) (result CreateSiteOnenoteNotebookSectionOperationResponse, err error) {
