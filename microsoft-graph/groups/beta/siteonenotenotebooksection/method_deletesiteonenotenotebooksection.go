...
func DefaultDeleteSiteOnenoteNotebookSectionOperationOptions() DeleteSiteOnenoteNotebookSectionOperationOptions {
	return DeleteSiteOnenoteNotebookSectionOperationOptions{}
}
...
func (c SiteOnenoteNotebookSectionClient) DeleteSiteOnenoteNotebookSection(ctx context.Context, id beta.GroupIdSiteIdOnenoteNotebookIdSectionId, options DeleteSiteOnenoteNotebookSectionOperationOptions) (result DeleteSiteOnenoteNotebookSectionOperationResponse, err error) {
