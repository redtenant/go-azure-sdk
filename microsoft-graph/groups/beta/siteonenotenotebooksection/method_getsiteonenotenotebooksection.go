...
func DefaultGetSiteOnenoteNotebookSectionOperationOptions() GetSiteOnenoteNotebookSectionOperationOptions {
	return GetSiteOnenoteNotebookSectionOperationOptions{}
}
...
func (c SiteOnenoteNotebookSectionClient) GetSiteOnenoteNotebookSection(ctx context.Context, id beta.GroupIdSiteIdOnenoteNotebookIdSectionId, options GetSiteOnenoteNotebookSectionOperationOptions) (result GetSiteOnenoteNotebookSectionOperationResponse, err error) {
