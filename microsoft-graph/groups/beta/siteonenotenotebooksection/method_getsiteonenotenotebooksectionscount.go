...
func DefaultGetSiteOnenoteNotebookSectionsCountOperationOptions() GetSiteOnenoteNotebookSectionsCountOperationOptions {
	return GetSiteOnenoteNotebookSectionsCountOperationOptions{}
}
...
func (c SiteOnenoteNotebookSectionClient) GetSiteOnenoteNotebookSectionsCount(ctx context.Context, id beta.GroupIdSiteIdOnenoteNotebookId, options GetSiteOnenoteNotebookSectionsCountOperationOptions) (result GetSiteOnenoteNotebookSectionsCountOperationResponse, err error) {
