...
func (c SiteOnenoteNotebookSectionClient) ListSiteOnenoteNotebookSections(ctx context.Context, id beta.GroupIdSiteIdOnenoteNotebookId, options ListSiteOnenoteNotebookSectionsOperationOptions) (result ListSiteOnenoteNotebookSectionsOperationResponse, err error) {
...
func (c SiteOnenoteNotebookSectionClient) ListSiteOnenoteNotebookSectionsComplete(ctx context.Context, id beta.GroupIdSiteIdOnenoteNotebookId, options ListSiteOnenoteNotebookSectionsOperationOptions) (ListSiteOnenoteNotebookSectionsCompleteResult, error) {
...
func (c SiteOnenoteNotebookSectionClient) ListSiteOnenoteNotebookSectionsCompleteMatchingPredicate(ctx context.Context, id beta.GroupIdSiteIdOnenoteNotebookId, options ListSiteOnenoteNotebookSectionsOperationOptions, predicate OnenoteSectionOperationPredicate) (result ListSiteOnenoteNotebookSectionsCompleteResult, err error) {
