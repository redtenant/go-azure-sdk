...
func (c SiteOnenoteNotebookSectionGroupSectionGroupClient) GetSiteOnenoteNotebookSectionGroupCount(ctx context.Context, id beta.GroupIdSiteIdOnenoteNotebookIdSectionGroupId, options GetSiteOnenoteNotebookSectionGroupCountOperationOptions) (result GetSiteOnenoteNotebookSectionGroupCountOperationResponse, err error) {
