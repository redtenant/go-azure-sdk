...
func (c SiteOnenoteNotebookSectionGroupSectionPageClient) UpdateSiteOnenoteNotebookSectionGroupSectionPage(ctx context.Context, id beta.GroupIdSiteIdOnenoteNotebookIdSectionGroupIdSectionIdPageId, input beta.OnenotePage, options UpdateSiteOnenoteNotebookSectionGroupSectionPageOperationOptions) (result UpdateSiteOnenoteNotebookSectionGroupSectionPageOperationResponse, err error) {
