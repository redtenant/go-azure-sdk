...
func (c SiteOnenoteNotebookSectionPageClient) DeleteSiteOnenoteNotebookSectionPage(ctx context.Context, id beta.GroupIdSiteIdOnenoteNotebookIdSectionIdPageId, options DeleteSiteOnenoteNotebookSectionPageOperationOptions) (result DeleteSiteOnenoteNotebookSectionPageOperationResponse, err error) {
