...
func DefaultGetSiteOnenoteNotebookSectionPageOperationOptions() GetSiteOnenoteNotebookSectionPageOperationOptions {
	return GetSiteOnenoteNotebookSectionPageOperationOptions{}
}
...
// GetSiteOnenoteNotebookSectionPage - Get pages from groups. The collection of pages in the section. Read-only.
// Nullable.
func (c SiteOnenoteNotebookSectionPageClient) GetSiteOnenoteNotebookSectionPage(ctx context.Context, id beta.GroupIdSiteIdOnenoteNotebookIdSectionIdPageId, options GetSiteOnenoteNotebookSectionPageOperationOptions) (result GetSiteOnenoteNotebookSectionPageOperationResponse, err error) {
