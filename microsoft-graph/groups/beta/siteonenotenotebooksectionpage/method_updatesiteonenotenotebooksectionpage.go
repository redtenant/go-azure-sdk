...
func DefaultUpdateSiteOnenoteNotebookSectionPageOperationOptions() UpdateSiteOnenoteNotebookSectionPageOperationOptions {
	return UpdateSiteOnenoteNotebookSectionPageOperationOptions{}
}
...
func (c SiteOnenoteNotebookSectionPageClient) UpdateSiteOnenoteNotebookSectionPage(ctx context.Context, id beta.GroupIdSiteIdOnenoteNotebookIdSectionIdPageId, input beta.OnenotePage, options UpdateSiteOnenoteNotebookSectionPageOperationOptions) (result UpdateSiteOnenoteNotebookSectionPageOperationResponse, err error) {
