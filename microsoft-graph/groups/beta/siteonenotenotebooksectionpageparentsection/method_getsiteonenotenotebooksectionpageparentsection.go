package siteonenotenotebooksectionpageparentsection
...
type GetSiteOnenoteNotebookSectionPageParentSectionOperationResponse struct {
	HttpResponse *http.Response
	OData        *odata.OData
	Model        *beta.OnenoteSection
}

type GetSiteOnenoteNotebookSectionPageParentSectionOperationOptions struct {
	Expand    *odata.Expand
...
func DefaultGetSiteOnenoteNotebookSectionPageParentSectionOperationOptions() GetSiteOnenoteNotebookSectionPageParentSectionOperationOptions {
	return GetSiteOnenoteNotebookSectionPageParentSectionOperationOptions{}
}
...
// GetSiteOnenoteNotebookSectionPageParentSection - Get parentSection from groups. The section that contains the page.
// Read-only.
func (c SiteOnenoteNotebookSectionPageParentSectionClient) GetSiteOnenoteNotebookSectionPageParentSection(ctx context.Context, id beta.GroupIdSiteIdOnenoteNotebookIdSectionIdPageId, options GetSiteOnenoteNotebookSectionPageParentSectionOperationOptions) (result GetSiteOnenoteNotebookSectionPageParentSectionOperationResponse, err error) {
