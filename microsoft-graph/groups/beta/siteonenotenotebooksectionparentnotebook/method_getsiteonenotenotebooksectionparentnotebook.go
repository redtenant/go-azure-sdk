...
type GetSiteOnenoteNotebookSectionParentNotebookOperationResponse struct {
	HttpResponse *http.Response
	OData        *odata.OData
	Model        *beta.Notebook
}

type GetSiteOnenoteNotebookSectionParentNotebookOperationOptions struct {
	Expand    *odata.Expand
...
func DefaultGetSiteOnenoteNotebookSectionParentNotebookOperationOptions() GetSiteOnenoteNotebookSectionParentNotebookOperationOptions {
	return GetSiteOnenoteNotebookSectionParentNotebookOperationOptions{}
}
...
// GetSiteOnenoteNotebookSectionParentNotebook - Get parentNotebook from groups. The notebook that contains the section.
// Read-only.
func (c SiteOnenoteNotebookSectionParentNotebookClient) GetSiteOnenoteNotebookSectionParentNotebook(ctx context.Context, id beta.GroupIdSiteIdOnenoteNotebookIdSectionId, options GetSiteOnenoteNotebookSectionParentNotebookOperationOptions) (result GetSiteOnenoteNotebookSectionParentNotebookOperationResponse, err error) {
