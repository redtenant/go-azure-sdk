...
func (c SiteOnenoteOperationClient) CreateSiteOnenoteOperation(ctx context.Context, id beta.GroupIdSiteId, input beta.OnenoteOperation, options CreateSiteOnenoteOperationOperationOptions) (result CreateSiteOnenoteOperationOperationResponse, err error) {
