...
func (c SiteOnenotePageContentClient) SetSiteOnenotePageContent(ctx context.Context, id beta.GroupIdSiteIdOnenotePageId, input []byte, options SetSiteOnenotePageContentOperationOptions) (result SetSiteOnenotePageContentOperationResponse, err error) {
