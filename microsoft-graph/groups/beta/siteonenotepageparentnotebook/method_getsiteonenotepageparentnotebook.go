...
func (c SiteOnenotePageParentNotebookClient) GetSiteOnenotePageParentNotebook(ctx context.Context, id beta.GroupIdSiteIdOnenotePageId, options GetSiteOnenotePageParentNotebookOperationOptions) (result GetSiteOnenotePageParentNotebookOperationResponse, err error) {
