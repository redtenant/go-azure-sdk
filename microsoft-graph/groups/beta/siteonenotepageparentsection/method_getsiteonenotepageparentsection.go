...
type GetSiteOnenotePageParentSectionOperationResponse struct {
	HttpResponse *http.Response
	OData        *odata.OData
	Model        *beta.OnenoteSection
}

type GetSiteOnenotePageParentSectionOperationOptions struct {
	Expand    *odata.Expand
...
func DefaultGetSiteOnenotePageParentSectionOperationOptions() GetSiteOnenotePageParentSectionOperationOptions {
	return GetSiteOnenotePageParentSectionOperationOptions{}
}
...
func (c SiteOnenotePageParentSectionClient) GetSiteOnenotePageParentSection(ctx context.Context, id beta.GroupIdSiteIdOnenotePageId, options GetSiteOnenotePageParentSectionOperationOptions) (result GetSiteOnenotePageParentSectionOperationResponse, err error) {
