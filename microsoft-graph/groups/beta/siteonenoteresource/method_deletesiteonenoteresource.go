...
func (c SiteOnenoteResourceClient) DeleteSiteOnenoteResource(ctx context.Context, id beta.GroupIdSiteIdOnenoteResourceId, options DeleteSiteOnenoteResourceOperationOptions) (result DeleteSiteOnenoteResourceOperationResponse, err error) {
