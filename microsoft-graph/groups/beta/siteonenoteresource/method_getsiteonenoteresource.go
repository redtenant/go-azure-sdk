...
func (c SiteOnenoteResourceClient) GetSiteOnenoteResource(ctx context.Context, id beta.GroupIdSiteIdOnenoteResourceId, options GetSiteOnenoteResourceOperationOptions) (result GetSiteOnenoteResourceOperationResponse, err error) {
