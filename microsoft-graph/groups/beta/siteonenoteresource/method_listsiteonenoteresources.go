...
func (c SiteOnenoteResourceClient) ListSiteOnenoteResources(ctx context.Context, id beta.GroupIdSiteId, options ListSiteOnenoteResourcesOperationOptions) (result ListSiteOnenoteResourcesOperationResponse, err error) {
...
func (c SiteOnenoteResourceClient) ListSiteOnenoteResourcesComplete(ctx context.Context, id beta.GroupIdSiteId, options ListSiteOnenoteResourcesOperationOptions) (ListSiteOnenoteResourcesCompleteResult, error) {
...
func (c SiteOnenoteResourceClient) ListSiteOnenoteResourcesCompleteMatchingPredicate(ctx context.Context, id beta.GroupIdSiteId, options ListSiteOnenoteResourcesOperationOptions, predicate OnenoteResourceOperationPredicate) (result ListSiteOnenoteResourcesCompleteResult, err error) {
