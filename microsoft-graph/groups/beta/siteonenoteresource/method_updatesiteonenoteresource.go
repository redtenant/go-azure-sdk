...
func (c SiteOnenoteResourceClient) UpdateSiteOnenoteResource(ctx context.Context, id beta.GroupIdSiteIdOnenoteResourceId, input beta.OnenoteResource, options UpdateSiteOnenoteResourceOperationOptions) (result UpdateSiteOnenoteResourceOperationResponse, err error) {
