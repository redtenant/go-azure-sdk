...
// DeleteSiteOnenoteResourceContent - Delete content for the navigation property resources in groups. The content of the
// resource.
func (c SiteOnenoteResourceContentClient) DeleteSiteOnenoteResourceContent(ctx context.Context, id beta.GroupIdSiteIdOnenoteResourceId, options DeleteSiteOnenoteResourceContentOperationOptions) (result DeleteSiteOnenoteResourceContentOperationResponse, err error) {
