...
func (c SiteOnenoteSectionGroupSectionGroupClient) GetSiteOnenoteSectionGroupCount(ctx context.Context, id beta.GroupIdSiteIdOnenoteSectionGroupId, options GetSiteOnenoteSectionGroupCountOperationOptions) (result GetSiteOnenoteSectionGroupCountOperationResponse, err error) {
