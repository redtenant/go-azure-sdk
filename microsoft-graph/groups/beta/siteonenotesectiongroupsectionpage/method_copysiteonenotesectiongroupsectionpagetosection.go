...
func DefaultCopySiteOnenoteSectionGroupSectionPageToSectionOperationOptions() CopySiteOnenoteSectionGroupSectionPageToSectionOperationOptions {
	return CopySiteOnenoteSectionGroupSectionPageToSectionOperationOptions{}
}
...
// CopySiteOnenoteSectionGroupSectionPageToSection - Invoke action copyToSection. Copy a page to a specific section. For
...
func (c SiteOnenoteSectionGroupSectionPageClient) CopySiteOnenoteSectionGroupSectionPageToSection(ctx context.Context, id beta.GroupIdSiteIdOnenoteSectionGroupIdSectionIdPageId, input CopySiteOnenoteSectionGroupSectionPageToSectionRequest, options CopySiteOnenoteSectionGroupSectionPageToSectionOperationOptions) (result CopySiteOnenoteSectionGroupSectionPageToSectionOperationResponse, err error) {
