...
func DefaultCreateSiteOnenoteSectionGroupSectionPageOperationOptions() CreateSiteOnenoteSectionGroupSectionPageOperationOptions {
	return CreateSiteOnenoteSectionGroupSectionPageOperationOptions{}
}
...
func (c SiteOnenoteSectionGroupSectionPageClient) CreateSiteOnenoteSectionGroupSectionPage(ctx context.Context, id beta.GroupIdSiteIdOnenoteSectionGroupIdSectionId, input beta.OnenotePage, options CreateSiteOnenoteSectionGroupSectionPageOperationOptions) (result CreateSiteOnenoteSectionGroupSectionPageOperationResponse, err error) {
