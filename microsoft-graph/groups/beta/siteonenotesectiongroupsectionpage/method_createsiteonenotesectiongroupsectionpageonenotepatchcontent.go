...
func DefaultCreateSiteOnenoteSectionGroupSectionPageOnenotePatchContentOperationOptions() CreateSiteOnenoteSectionGroupSectionPageOnenotePatchContentOperationOptions {
	return CreateSiteOnenoteSectionGroupSectionPageOnenotePatchContentOperationOptions{}
}
...
func (c SiteOnenoteSectionGroupSectionPageClient) CreateSiteOnenoteSectionGroupSectionPageOnenotePatchContent(ctx context.Context, id beta.GroupIdSiteIdOnenoteSectionGroupIdSectionIdPageId, input CreateSiteOnenoteSectionGroupSectionPageOnenotePatchContentRequest, options CreateSiteOnenoteSectionGroupSectionPageOnenotePatchContentOperationOptions) (result CreateSiteOnenoteSectionGroupSectionPageOnenotePatchContentOperationResponse, err error) {
