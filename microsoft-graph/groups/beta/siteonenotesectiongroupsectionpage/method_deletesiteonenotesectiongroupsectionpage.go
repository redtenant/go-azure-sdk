...
func DefaultDeleteSiteOnenoteSectionGroupSectionPageOperationOptions() DeleteSiteOnenoteSectionGroupSectionPageOperationOptions {
	return DeleteSiteOnenoteSectionGroupSectionPageOperationOptions{}
}
...
func (c SiteOnenoteSectionGroupSectionPageClient) DeleteSiteOnenoteSectionGroupSectionPage(ctx context.Context, id beta.GroupIdSiteIdOnenoteSectionGroupIdSectionIdPageId, options DeleteSiteOnenoteSectionGroupSectionPageOperationOptions) (result DeleteSiteOnenoteSectionGroupSectionPageOperationResponse, err error) {
