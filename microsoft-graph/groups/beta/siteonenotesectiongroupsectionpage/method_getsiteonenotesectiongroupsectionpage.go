...
func DefaultGetSiteOnenoteSectionGroupSectionPageOperationOptions() GetSiteOnenoteSectionGroupSectionPageOperationOptions {
	return GetSiteOnenoteSectionGroupSectionPageOperationOptions{}
}
...
// GetSiteOnenoteSectionGroupSectionPage - Get pages from groups. The collection of pages in the section. Read-only.
// Nullable.
func (c SiteOnenoteSectionGroupSectionPageClient) GetSiteOnenoteSectionGroupSectionPage(ctx context.Context, id beta.GroupIdSiteIdOnenoteSectionGroupIdSectionIdPageId, options GetSiteOnenoteSectionGroupSectionPageOperationOptions) (result GetSiteOnenoteSectionGroupSectionPageOperationResponse, err error) {
