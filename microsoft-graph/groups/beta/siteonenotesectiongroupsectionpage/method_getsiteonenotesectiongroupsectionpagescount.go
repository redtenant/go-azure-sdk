...
func DefaultGetSiteOnenoteSectionGroupSectionPagesCountOperationOptions() GetSiteOnenoteSectionGroupSectionPagesCountOperationOptions {
	return GetSiteOnenoteSectionGroupSectionPagesCountOperationOptions{}
}
...
func (c SiteOnenoteSectionGroupSectionPageClient) GetSiteOnenoteSectionGroupSectionPagesCount(ctx context.Context, id beta.GroupIdSiteIdOnenoteSectionGroupIdSectionId, options GetSiteOnenoteSectionGroupSectionPagesCountOperationOptions) (result GetSiteOnenoteSectionGroupSectionPagesCountOperationResponse, err error) {
