...
func DefaultUpdateSiteOnenoteSectionGroupSectionPageOperationOptions() UpdateSiteOnenoteSectionGroupSectionPageOperationOptions {
	return UpdateSiteOnenoteSectionGroupSectionPageOperationOptions{}
}
...
func (c SiteOnenoteSectionGroupSectionPageClient) UpdateSiteOnenoteSectionGroupSectionPage(ctx context.Context, id beta.GroupIdSiteIdOnenoteSectionGroupIdSectionIdPageId, input beta.OnenotePage, options UpdateSiteOnenoteSectionGroupSectionPageOperationOptions) (result UpdateSiteOnenoteSectionGroupSectionPageOperationResponse, err error) {
