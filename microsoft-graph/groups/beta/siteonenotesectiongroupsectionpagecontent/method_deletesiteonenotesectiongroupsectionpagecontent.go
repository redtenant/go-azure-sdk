...
// page's HTML content.
func (c SiteOnenoteSectionGroupSectionPageContentClient) DeleteSiteOnenoteSectionGroupSectionPageContent(ctx context.Context, id beta.GroupIdSiteIdOnenoteSectionGroupIdSectionIdPageId, options DeleteSiteOnenoteSectionGroupSectionPageContentOperationOptions) (result DeleteSiteOnenoteSectionGroupSectionPageContentOperationResponse, err error) {
