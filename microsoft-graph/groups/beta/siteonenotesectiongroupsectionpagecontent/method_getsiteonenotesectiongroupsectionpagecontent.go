...
type GetSiteOnenoteSectionGroupSectionPageContentOperationResponse struct {
	HttpResponse *http.Response
	OData        *odata.OData
	Model        *[]byte
}

type GetSiteOnenoteSectionGroupSectionPageContentOperationOptions struct {
...
func DefaultGetSiteOnenoteSectionGroupSectionPageContentOperationOptions() GetSiteOnenoteSectionGroupSectionPageContentOperationOptions {
	return GetSiteOnenoteSectionGroupSectionPageContentOperationOptions{}
}
...
// GetSiteOnenoteSectionGroupSectionPageContent - Get content for the navigation property pages from groups. The page's
// HTML content.
func (c SiteOnenoteSectionGroupSectionPageContentClient) GetSiteOnenoteSectionGroupSectionPageContent(ctx context.Context, id beta.GroupIdSiteIdOnenoteSectionGroupIdSectionIdPageId, options GetSiteOnenoteSectionGroupSectionPageContentOperationOptions) (result GetSiteOnenoteSectionGroupSectionPageContentOperationResponse, err error) {
