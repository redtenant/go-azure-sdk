...
func DefaultCopySiteOnenoteSectionPageToSectionOperationOptions() CopySiteOnenoteSectionPageToSectionOperationOptions {
	return CopySiteOnenoteSectionPageToSectionOperationOptions{}
}
...
// CopySiteOnenoteSectionPageToSection - Invoke action copyToSection. Copy a page to a specific section. For copy
...
func (c SiteOnenoteSectionPageClient) CopySiteOnenoteSectionPageToSection(ctx context.Context, id beta.GroupIdSiteIdOnenoteSectionIdPageId, input CopySiteOnenoteSectionPageToSectionRequest, options CopySiteOnenoteSectionPageToSectionOperationOptions) (result CopySiteOnenoteSectionPageToSectionOperationResponse, err error) {
