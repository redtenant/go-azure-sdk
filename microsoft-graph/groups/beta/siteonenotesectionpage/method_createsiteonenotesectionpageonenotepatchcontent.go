...
func (c SiteOnenoteSectionPageClient) CreateSiteOnenoteSectionPageOnenotePatchContent(ctx context.Context, id beta.GroupIdSiteIdOnenoteSectionIdPageId, input CreateSiteOnenoteSectionPageOnenotePatchContentRequest, options CreateSiteOnenoteSectionPageOnenotePatchContentOperationOptions) (result CreateSiteOnenoteSectionPageOnenotePatchContentOperationResponse, err error) {
