...
func DefaultDeleteSiteOnenoteSectionPageOperationOptions() DeleteSiteOnenoteSectionPageOperationOptions {
	return DeleteSiteOnenoteSectionPageOperationOptions{}
}
...
func (c SiteOnenoteSectionPageClient) DeleteSiteOnenoteSectionPage(ctx context.Context, id beta.GroupIdSiteIdOnenoteSectionIdPageId, options DeleteSiteOnenoteSectionPageOperationOptions) (result DeleteSiteOnenoteSectionPageOperationResponse, err error) {
