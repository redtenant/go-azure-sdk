...
func DefaultGetSiteOnenoteSectionPageOperationOptions() GetSiteOnenoteSectionPageOperationOptions {
	return GetSiteOnenoteSectionPageOperationOptions{}
}
...
func (c SiteOnenoteSectionPageClient) GetSiteOnenoteSectionPage(ctx context.Context, id beta.GroupIdSiteIdOnenoteSectionIdPageId, options GetSiteOnenoteSectionPageOperationOptions) (result GetSiteOnenoteSectionPageOperationResponse, err error) {
