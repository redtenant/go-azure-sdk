...
func (c SiteOnenoteSectionPageClient) GetSiteOnenoteSectionPagesCount(ctx context.Context, id beta.GroupIdSiteIdOnenoteSectionId, options GetSiteOnenoteSectionPagesCountOperationOptions) (result GetSiteOnenoteSectionPagesCountOperationResponse, err error) {
