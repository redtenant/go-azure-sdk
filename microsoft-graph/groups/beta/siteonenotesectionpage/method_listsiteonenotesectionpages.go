...
func (c SiteOnenoteSectionPageClient) ListSiteOnenoteSectionPages(ctx context.Context, id beta.GroupIdSiteIdOnenoteSectionId, options ListSiteOnenoteSectionPagesOperationOptions) (result ListSiteOnenoteSectionPagesOperationResponse, err error) {
...
func (c SiteOnenoteSectionPageClient) ListSiteOnenoteSectionPagesComplete(ctx context.Context, id beta.GroupIdSiteIdOnenoteSectionId, options ListSiteOnenoteSectionPagesOperationOptions) (ListSiteOnenoteSectionPagesCompleteResult, error) {
...
func (c SiteOnenoteSectionPageClient) ListSiteOnenoteSectionPagesCompleteMatchingPredicate(ctx context.Context, id beta.GroupIdSiteIdOnenoteSectionId, options ListSiteOnenoteSectionPagesOperationOptions, predicate OnenotePageOperationPredicate) (result ListSiteOnenoteSectionPagesCompleteResult, err error) {
