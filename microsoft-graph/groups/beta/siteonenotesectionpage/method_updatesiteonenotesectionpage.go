...
func DefaultUpdateSiteOnenoteSectionPageOperationOptions() UpdateSiteOnenoteSectionPageOperationOptions {
	return UpdateSiteOnenoteSectionPageOperationOptions{}
}
...
func (c SiteOnenoteSectionPageClient) UpdateSiteOnenoteSectionPage(ctx context.Context, id beta.GroupIdSiteIdOnenoteSectionIdPageId, input beta.OnenotePage, options UpdateSiteOnenoteSectionPageOperationOptions) (result UpdateSiteOnenoteSectionPageOperationResponse, err error) {
