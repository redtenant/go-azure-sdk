...
// Read-only.
func (c SiteOnenoteSectionPageParentNotebookClient) GetSiteOnenoteSectionPageParentNotebook(ctx context.Context, id beta.GroupIdSiteIdOnenoteSectionIdPageId, options GetSiteOnenoteSectionPageParentNotebookOperationOptions) (result GetSiteOnenoteSectionPageParentNotebookOperationResponse, err error) {
