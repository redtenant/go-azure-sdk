...
func (c SiteOperationClient) DeleteSiteOperation(ctx context.Context, id beta.GroupIdSiteIdOperationId, options DeleteSiteOperationOperationOptions) (result DeleteSiteOperationOperationResponse, err error) {
