...
func (c SiteOperationClient) GetSiteOperationsCount(ctx context.Context, id beta.GroupIdSiteId, options GetSiteOperationsCountOperationOptions) (result GetSiteOperationsCountOperationResponse, err error) {
