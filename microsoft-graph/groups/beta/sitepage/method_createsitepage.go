...
type CreateSitePageOperationResponse struct {
...
func (c SitePageClient) CreateSitePage(ctx context.Context, id beta.GroupIdSiteId, input beta.BaseSitePage, options CreateSitePageOperationOptions) (result CreateSitePageOperationResponse, err error) {
