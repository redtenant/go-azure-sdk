...
func (c SitePageCreatedByUserMailboxSettingClient) GetSitePageCreatedByUserMailboxSetting(ctx context.Context, id beta.GroupIdSiteIdPageId, options GetSitePageCreatedByUserMailboxSettingOperationOptions) (result GetSitePageCreatedByUserMailboxSettingOperationResponse, err error) {
