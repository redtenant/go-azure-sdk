...
func (c SitePageCreatedByUserMailboxSettingClient) UpdateSitePageCreatedByUserMailboxSetting(ctx context.Context, id beta.GroupIdSiteIdPageId, input beta.MailboxSettings, options UpdateSitePageCreatedByUserMailboxSettingOperationOptions) (result UpdateSitePageCreatedByUserMailboxSettingOperationResponse, err error) {
