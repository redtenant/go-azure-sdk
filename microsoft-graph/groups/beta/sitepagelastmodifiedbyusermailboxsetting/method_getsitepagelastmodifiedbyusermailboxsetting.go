...
func (c SitePageLastModifiedByUserMailboxSettingClient) GetSitePageLastModifiedByUserMailboxSetting(ctx context.Context, id beta.GroupIdSiteIdPageId, options GetSitePageLastModifiedByUserMailboxSettingOperationOptions) (result GetSitePageLastModifiedByUserMailboxSettingOperationResponse, err error) {
