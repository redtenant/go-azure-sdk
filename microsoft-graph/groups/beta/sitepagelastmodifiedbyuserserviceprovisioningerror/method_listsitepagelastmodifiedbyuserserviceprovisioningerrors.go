...
func (c SitePageLastModifiedByUserServiceProvisioningErrorClient) ListSitePageLastModifiedByUserServiceProvisioningErrorsCompleteMatchingPredicate(ctx context.Context, id beta.GroupIdSiteIdPageId, options ListSitePageLastModifiedByUserServiceProvisioningErrorsOperationOptions, predicate ServiceProvisioningErrorOperationPredicate) (result ListSitePageLastModifiedByUserServiceProvisioningErrorsCompleteResult, err error) {
