...
func DefaultRevokeSitePermissionGrantsOperationOptions() RevokeSitePermissionGrantsOperationOptions {
	return RevokeSitePermissionGrantsOperationOptions{}
}
...
// RevokeSitePermissionGrants - Invoke action revokeGrants. Revoke access to a listItem or driveItem granted via a
