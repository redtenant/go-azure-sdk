...
func (c SiteSiteClient) ListSiteSites(ctx context.Context, id beta.GroupIdSiteId, options ListSiteSitesOperationOptions) (result ListSiteSitesOperationResponse, err error) {
...
func (c SiteSiteClient) ListSiteSitesComplete(ctx context.Context, id beta.GroupIdSiteId, options ListSiteSitesOperationOptions) (ListSiteSitesCompleteResult, error) {
...
func (c SiteSiteClient) ListSiteSitesCompleteMatchingPredicate(ctx context.Context, id beta.GroupIdSiteId, options ListSiteSitesOperationOptions, predicate SiteOperationPredicate) (result ListSiteSitesCompleteResult, err error) {
