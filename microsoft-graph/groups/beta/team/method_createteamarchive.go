...
func (c TeamClient) CreateTeamArchive(ctx context.Context, id beta.GroupId, input CreateTeamArchiveRequest, options CreateTeamArchiveOperationOptions) (result CreateTeamArchiveOperationResponse, err error) {
