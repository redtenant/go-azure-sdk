...
// response.
func (c TeamClient) CreateTeamCompleteMigration(ctx context.Context, id beta.GroupId, options CreateTeamCompleteMigrationOperationOptions) (result CreateTeamCompleteMigrationOperationResponse, err error) {
