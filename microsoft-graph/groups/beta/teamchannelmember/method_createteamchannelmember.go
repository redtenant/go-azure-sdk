...
func (c TeamChannelMemberClient) CreateTeamChannelMember(ctx context.Context, id beta.GroupIdTeamChannelId, input beta.ConversationMember, options CreateTeamChannelMemberOperationOptions) (result CreateTeamChannelMemberOperationResponse, err error) {
