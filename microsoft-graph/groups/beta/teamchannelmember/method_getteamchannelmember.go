...
func DefaultGetTeamChannelMemberOperationOptions() GetTeamChannelMemberOperationOptions {
	return GetTeamChannelMemberOperationOptions{}
}
...
func (c TeamChannelMemberClient) GetTeamChannelMember(ctx context.Context, id beta.GroupIdTeamChannelIdMemberId, options GetTeamChannelMemberOperationOptions) (result GetTeamChannelMemberOperationResponse, err error) {
