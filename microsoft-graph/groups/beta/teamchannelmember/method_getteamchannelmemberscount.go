...
func DefaultGetTeamChannelMembersCountOperationOptions() GetTeamChannelMembersCountOperationOptions {
	return GetTeamChannelMembersCountOperationOptions{}
}
...
func (c TeamChannelMemberClient) GetTeamChannelMembersCount(ctx context.Context, id beta.GroupIdTeamChannelId, options GetTeamChannelMembersCountOperationOptions) (result GetTeamChannelMembersCountOperationResponse, err error) {
