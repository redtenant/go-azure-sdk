...
func DefaultListTeamChannelMembersOperationOptions() ListTeamChannelMembersOperationOptions {
	return ListTeamChannelMembersOperationOptions{}
}
...
func (c TeamChannelMemberClient) ListTeamChannelMembers(ctx context.Context, id beta.GroupIdTeamChannelId, options ListTeamChannelMembersOperationOptions) (result ListTeamChannelMembersOperationResponse, err error) {
...
func (c TeamChannelMemberClient) ListTeamChannelMembersComplete(ctx context.Context, id beta.GroupIdTeamChannelId, options ListTeamChannelMembersOperationOptions) (ListTeamChannelMembersCompleteResult, error) {
	return c.ListTeamChannelMembersCompleteMatchingPredicate(ctx, id, options, ConversationMemberOperationPredicate{})
}

// ListTeamChannelMembersCompleteMatchingPredicate retrieves all the results and then applies the predicate
func (c TeamChannelMemberClient) ListTeamChannelMembersCompleteMatchingPredicate(ctx context.Context, id beta.GroupIdTeamChannelId, options ListTeamChannelMembersOperationOptions, predicate ConversationMemberOperationPredicate) (result ListTeamChannelMembersCompleteResult, err error) {
	items := make([]beta.ConversationMember, 0)

	resp, err := c.ListTeamChannelMembers(ctx, id, options)
	if err != nil {
