...
func (c TeamChannelMessageClient) CreateTeamChannelMessage(ctx context.Context, id beta.GroupIdTeamChannelId, input beta.ChatMessage, options CreateTeamChannelMessageOperationOptions) (result CreateTeamChannelMessageOperationResponse, err error) {
