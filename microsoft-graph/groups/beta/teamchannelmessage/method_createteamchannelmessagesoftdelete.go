...
func DefaultCreateTeamChannelMessageSoftDeleteOperationOptions() CreateTeamChannelMessageSoftDeleteOperationOptions {
	return CreateTeamChannelMessageSoftDeleteOperationOptions{}
}
...
// CreateTeamChannelMessageSoftDelete - Invoke action softDelete. Delete a single chatMessage or a chat message reply in
// a channel or a chat.
func (c TeamChannelMessageClient) CreateTeamChannelMessageSoftDelete(ctx context.Context, id beta.GroupIdTeamChannelIdMessageId, options CreateTeamChannelMessageSoftDeleteOperationOptions) (result CreateTeamChannelMessageSoftDeleteOperationResponse, err error) {
