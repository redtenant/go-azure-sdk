...
func (c TeamChannelMessageHostedContentClient) GetTeamChannelMessageHostedContentValue(ctx context.Context, id beta.GroupIdTeamChannelIdMessageIdHostedContentId, options GetTeamChannelMessageHostedContentValueOperationOptions) (result GetTeamChannelMessageHostedContentValueOperationResponse, err error) {
