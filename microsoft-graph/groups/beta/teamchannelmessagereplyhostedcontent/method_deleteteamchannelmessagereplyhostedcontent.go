...
func (c TeamChannelMessageReplyHostedContentClient) DeleteTeamChannelMessageReplyHostedContent(ctx context.Context, id beta.GroupIdTeamChannelIdMessageIdReplyIdHostedContentId, options DeleteTeamChannelMessageReplyHostedContentOperationOptions) (result DeleteTeamChannelMessageReplyHostedContentOperationResponse, err error) {
