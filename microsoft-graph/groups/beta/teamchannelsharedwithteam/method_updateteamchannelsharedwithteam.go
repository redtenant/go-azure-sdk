...
func (c TeamChannelSharedWithTeamClient) UpdateTeamChannelSharedWithTeam(ctx context.Context, id beta.GroupIdTeamChannelIdSharedWithTeamId, input beta.SharedWithChannelTeamInfo, options UpdateTeamChannelSharedWithTeamOperationOptions) (result UpdateTeamChannelSharedWithTeamOperationResponse, err error) {
