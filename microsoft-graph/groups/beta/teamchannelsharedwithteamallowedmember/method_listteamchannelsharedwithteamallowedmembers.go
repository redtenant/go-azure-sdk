...
func (c TeamChannelSharedWithTeamAllowedMemberClient) ListTeamChannelSharedWithTeamAllowedMembers(ctx context.Context, id beta.GroupIdTeamChannelIdSharedWithTeamId, options ListTeamChannelSharedWithTeamAllowedMembersOperationOptions) (result ListTeamChannelSharedWithTeamAllowedMembersOperationResponse, err error) {
...
func (c TeamChannelSharedWithTeamAllowedMemberClient) ListTeamChannelSharedWithTeamAllowedMembersComplete(ctx context.Context, id beta.GroupIdTeamChannelIdSharedWithTeamId, options ListTeamChannelSharedWithTeamAllowedMembersOperationOptions) (ListTeamChannelSharedWithTeamAllowedMembersCompleteResult, error) {
...
func (c TeamChannelSharedWithTeamAllowedMemberClient) ListTeamChannelSharedWithTeamAllowedMembersCompleteMatchingPredicate(ctx context.Context, id beta.GroupIdTeamChannelIdSharedWithTeamId, options ListTeamChannelSharedWithTeamAllowedMembersOperationOptions, predicate ConversationMemberOperationPredicate) (result ListTeamChannelSharedWithTeamAllowedMembersCompleteResult, err error) {
