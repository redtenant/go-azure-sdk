...
func (c TeamChannelTabClient) ListTeamChannelTabsComplete(ctx context.Context, id beta.GroupIdTeamChannelId, options ListTeamChannelTabsOperationOptions) (ListTeamChannelTabsCompleteResult, error) {
