...
func (c TeamChannelTabClient) UpdateTeamChannelTab(ctx context.Context, id beta.GroupIdTeamChannelIdTabId, input beta.TeamsTab, options UpdateTeamChannelTabOperationOptions) (result UpdateTeamChannelTabOperationResponse, err error) {
