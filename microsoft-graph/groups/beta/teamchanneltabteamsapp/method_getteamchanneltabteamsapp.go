...
// GetTeamChannelTabTeamsApp - Get teamsApp from groups. The application that is linked to the tab.
func (c TeamChannelTabTeamsAppClient) GetTeamChannelTabTeamsApp(ctx context.Context, id beta.GroupIdTeamChannelIdTabId, options GetTeamChannelTabTeamsAppOperationOptions) (result GetTeamChannelTabTeamsAppOperationResponse, err error) {
