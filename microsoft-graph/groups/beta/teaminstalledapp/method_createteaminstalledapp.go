...
func (c TeamInstalledAppClient) CreateTeamInstalledApp(ctx context.Context, id beta.GroupId, input beta.TeamsAppInstallation, options CreateTeamInstalledAppOperationOptions) (result CreateTeamInstalledAppOperationResponse, err error) {
