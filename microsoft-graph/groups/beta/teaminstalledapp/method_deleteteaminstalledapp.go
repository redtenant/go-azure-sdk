...
func DefaultDeleteTeamInstalledAppOperationOptions() DeleteTeamInstalledAppOperationOptions {
	return DeleteTeamInstalledAppOperationOptions{}
}
...
func (c TeamInstalledAppClient) DeleteTeamInstalledApp(ctx context.Context, id beta.GroupIdTeamInstalledAppId, options DeleteTeamInstalledAppOperationOptions) (result DeleteTeamInstalledAppOperationResponse, err error) {
