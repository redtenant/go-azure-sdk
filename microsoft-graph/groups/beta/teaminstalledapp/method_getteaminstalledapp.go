...
func DefaultGetTeamInstalledAppOperationOptions() GetTeamInstalledAppOperationOptions {
	return GetTeamInstalledAppOperationOptions{}
}
...
func (c TeamInstalledAppClient) GetTeamInstalledApp(ctx context.Context, id beta.GroupIdTeamInstalledAppId, options GetTeamInstalledAppOperationOptions) (result GetTeamInstalledAppOperationResponse, err error) {
