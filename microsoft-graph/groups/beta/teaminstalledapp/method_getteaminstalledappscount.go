...
func DefaultGetTeamInstalledAppsCountOperationOptions() GetTeamInstalledAppsCountOperationOptions {
	return GetTeamInstalledAppsCountOperationOptions{}
}
...
func (c TeamInstalledAppClient) GetTeamInstalledAppsCount(ctx context.Context, id beta.GroupId, options GetTeamInstalledAppsCountOperationOptions) (result GetTeamInstalledAppsCountOperationResponse, err error) {
	opts := client.RequestOptions{
		...
		Path:          fmt.Sprintf("%s/team/installedApps/$count", id.ID()),
