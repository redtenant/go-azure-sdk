...
func DefaultAddTeamMembersOperationOptions() AddTeamMembersOperationOptions {
	return AddTeamMembersOperationOptions{}
}
...
// AddTeamMembers - Invoke action add. Add multiple members in a single request to a team. The response provides details
// about which memberships could and couldn't be created.
func (c TeamMemberClient) AddTeamMembers(ctx context.Context, id beta.GroupId, input AddTeamMembersRequest, options AddTeamMembersOperationOptions) (result AddTeamMembersOperationResponse, err error) {
	opts := client.RequestOptions{
		...
		Pager:         &AddTeamMembersCustomPager{},
		Path:          fmt.Sprintf("%s/team/members/add", id.ID()),
...
func (c TeamMemberClient) AddTeamMembersComplete(ctx context.Context, id beta.GroupId, input AddTeamMembersRequest, options AddTeamMembersOperationOptions) (AddTeamMembersCompleteResult, error) {
	return c.AddTeamMembersCompleteMatchingPredicate(ctx, id, input, options, ActionResultPartOperationPredicate{})
}
...
func (c TeamMemberClient) AddTeamMembersCompleteMatchingPredicate(ctx context.Context, id beta.GroupId, input AddTeamMembersRequest, options AddTeamMembersOperationOptions, predicate ActionResultPartOperationPredicate) (result AddTeamMembersCompleteResult, err error) {
	...
	resp, err := c.AddTeamMembers(ctx, id, input, options)
	if err != nil {
	...
	result = AddTeamMembersCompleteResult{
