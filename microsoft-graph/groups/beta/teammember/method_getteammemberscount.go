...
func (c TeamMemberClient) GetTeamMembersCount(ctx context.Context, id beta.GroupId, options GetTeamMembersCountOperationOptions) (result GetTeamMembersCountOperationResponse, err error) {
