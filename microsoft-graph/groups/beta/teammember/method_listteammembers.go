...
func (c TeamMemberClient) ListTeamMembers(ctx context.Context, id beta.GroupId, options ListTeamMembersOperationOptions) (result ListTeamMembersOperationResponse, err error) {
...
func (c TeamMemberClient) ListTeamMembersComplete(ctx context.Context, id beta.GroupId, options ListTeamMembersOperationOptions) (ListTeamMembersCompleteResult, error) {
