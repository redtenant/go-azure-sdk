...
func DefaultUpdateTeamMemberOperationOptions() UpdateTeamMemberOperationOptions {
	return UpdateTeamMemberOperationOptions{}
}
...
func (c TeamMemberClient) UpdateTeamMember(ctx context.Context, id beta.GroupIdTeamMemberId, input beta.ConversationMember, options UpdateTeamMemberOperationOptions) (result UpdateTeamMemberOperationResponse, err error) {
