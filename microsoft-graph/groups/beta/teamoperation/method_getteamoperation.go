...
func (c TeamOperationClient) GetTeamOperation(ctx context.Context, id beta.GroupIdTeamOperationId, options GetTeamOperationOperationOptions) (result GetTeamOperationOperationResponse, err error) {
