...
func (c TeamOperationClient) UpdateTeamOperation(ctx context.Context, id beta.GroupIdTeamOperationId, input beta.TeamsAsyncOperation, options UpdateTeamOperationOperationOptions) (result UpdateTeamOperationOperationResponse, err error) {
