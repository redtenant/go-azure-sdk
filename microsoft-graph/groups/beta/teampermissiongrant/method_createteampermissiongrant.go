...
type CreateTeamPermissionGrantOperationResponse struct {
	HttpResponse *http.Response
	OData        *odata.OData
	Model        *beta.ResourceSpecificPermissionGrant
}

type CreateTeamPermissionGrantOperationOptions struct {
	Metadata  *odata.Metadata
	RetryFunc client.RequestRetryFunc
}

func DefaultCreateTeamPermissionGrantOperationOptions() CreateTeamPermissionGrantOperationOptions {
	return CreateTeamPermissionGrantOperationOptions{}
}
...
func (c TeamPermissionGrantClient) CreateTeamPermissionGrant(ctx context.Context, id beta.GroupId, input beta.ResourceSpecificPermissionGrant, options CreateTeamPermissionGrantOperationOptions) (result CreateTeamPermissionGrantOperationResponse, err error) {
