...
type DeleteTeamPermissionGrantOperationResponse struct {
	HttpResponse *http.Response
	OData        *odata.OData
}

type DeleteTeamPermissionGrantOperationOptions struct {
	IfMatch   *string
...
func DefaultDeleteTeamPermissionGrantOperationOptions() DeleteTeamPermissionGrantOperationOptions {
	return DeleteTeamPermissionGrantOperationOptions{}
}
...
func (c TeamPermissionGrantClient) DeleteTeamPermissionGrant(ctx context.Context, id beta.GroupIdTeamPermissionGrantId, options DeleteTeamPermissionGrantOperationOptions) (result DeleteTeamPermissionGrantOperationResponse, err error) {
