...
// team.
func (c TeamPermissionGrantClient) GetTeamPermissionGrant(ctx context.Context, id beta.GroupIdTeamPermissionGrantId, options GetTeamPermissionGrantOperationOptions) (result GetTeamPermissionGrantOperationResponse, err error) {
