...
// the team.
func (c TeamPermissionGrantClient) ListTeamPermissionGrants(ctx context.Context, id beta.GroupId, options ListTeamPermissionGrantsOperationOptions) (result ListTeamPermissionGrantsOperationResponse, err error) {
...
func (c TeamPermissionGrantClient) ListTeamPermissionGrantsComplete(ctx context.Context, id beta.GroupId, options ListTeamPermissionGrantsOperationOptions) (ListTeamPermissionGrantsCompleteResult, error) {
...
func (c TeamPermissionGrantClient) ListTeamPermissionGrantsCompleteMatchingPredicate(ctx context.Context, id beta.GroupId, options ListTeamPermissionGrantsOperationOptions, predicate ResourceSpecificPermissionGrantOperationPredicate) (result ListTeamPermissionGrantsCompleteResult, err error) {
