...
func (c TeamPrimaryChannelFilesFolderContentClient) DeleteTeamPrimaryChannelFilesFolderContent(ctx context.Context, id beta.GroupId, options DeleteTeamPrimaryChannelFilesFolderContentOperationOptions) (result DeleteTeamPrimaryChannelFilesFolderContentOperationResponse, err error) {
