...
func (c TeamPrimaryChannelFilesFolderContentClient) GetTeamPrimaryChannelFilesFolderContent(ctx context.Context, id beta.GroupId, options GetTeamPrimaryChannelFilesFolderContentOperationOptions) (result GetTeamPrimaryChannelFilesFolderContentOperationResponse, err error) {
