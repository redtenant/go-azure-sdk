...
func (c TeamPrimaryChannelFilesFolderContentClient) SetTeamPrimaryChannelFilesFolderContent(ctx context.Context, id beta.GroupId, input []byte, options SetTeamPrimaryChannelFilesFolderContentOperationOptions) (result SetTeamPrimaryChannelFilesFolderContentOperationResponse, err error) {
