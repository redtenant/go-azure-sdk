...
// channel.
func (c TeamPrimaryChannelMemberClient) GetTeamPrimaryChannelMember(ctx context.Context, id beta.GroupIdTeamPrimaryChannelMemberId, options GetTeamPrimaryChannelMemberOperationOptions) (result GetTeamPrimaryChannelMemberOperationResponse, err error) {
