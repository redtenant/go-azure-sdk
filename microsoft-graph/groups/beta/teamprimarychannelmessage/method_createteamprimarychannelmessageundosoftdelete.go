...
func (c TeamPrimaryChannelMessageClient) CreateTeamPrimaryChannelMessageUndoSoftDelete(ctx context.Context, id beta.GroupIdTeamPrimaryChannelMessageId, options CreateTeamPrimaryChannelMessageUndoSoftDeleteOperationOptions) (result CreateTeamPrimaryChannelMessageUndoSoftDeleteOperationResponse, err error) {
