...
func (c TeamPrimaryChannelMessageClient) ListTeamPrimaryChannelMessagesComplete(ctx context.Context, id beta.GroupId, options ListTeamPrimaryChannelMessagesOperationOptions) (ListTeamPrimaryChannelMessagesCompleteResult, error) {
...
func (c TeamPrimaryChannelMessageClient) ListTeamPrimaryChannelMessagesCompleteMatchingPredicate(ctx context.Context, id beta.GroupId, options ListTeamPrimaryChannelMessagesOperationOptions, predicate ChatMessageOperationPredicate) (result ListTeamPrimaryChannelMessagesCompleteResult, err error) {
