...
func (c TeamPrimaryChannelMessageReplyClient) CreateTeamPrimaryChannelMessageReply(ctx context.Context, id beta.GroupIdTeamPrimaryChannelMessageId, input beta.ChatMessage, options CreateTeamPrimaryChannelMessageReplyOperationOptions) (result CreateTeamPrimaryChannelMessageReplyOperationResponse, err error) {
