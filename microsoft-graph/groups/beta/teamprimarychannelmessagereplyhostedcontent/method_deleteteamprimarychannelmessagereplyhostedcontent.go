...
func DefaultDeleteTeamPrimaryChannelMessageReplyHostedContentOperationOptions() DeleteTeamPrimaryChannelMessageReplyHostedContentOperationOptions {
	return DeleteTeamPrimaryChannelMessageReplyHostedContentOperationOptions{}
}
...
func (c TeamPrimaryChannelMessageReplyHostedContentClient) DeleteTeamPrimaryChannelMessageReplyHostedContent(ctx context.Context, id beta.GroupIdTeamPrimaryChannelMessageIdReplyIdHostedContentId, options DeleteTeamPrimaryChannelMessageReplyHostedContentOperationOptions) (result DeleteTeamPrimaryChannelMessageReplyHostedContentOperationResponse, err error) {
