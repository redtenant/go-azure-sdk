...
func (c TeamPrimaryChannelSharedWithTeamClient) CreateTeamPrimaryChannelSharedWithTeam(ctx context.Context, id beta.GroupId, input beta.SharedWithChannelTeamInfo, options CreateTeamPrimaryChannelSharedWithTeamOperationOptions) (result CreateTeamPrimaryChannelSharedWithTeamOperationResponse, err error) {
