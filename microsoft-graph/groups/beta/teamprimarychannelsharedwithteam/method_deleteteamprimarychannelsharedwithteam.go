...
func (c TeamPrimaryChannelSharedWithTeamClient) DeleteTeamPrimaryChannelSharedWithTeam(ctx context.Context, id beta.GroupIdTeamPrimaryChannelSharedWithTeamId, options DeleteTeamPrimaryChannelSharedWithTeamOperationOptions) (result DeleteTeamPrimaryChannelSharedWithTeamOperationResponse, err error) {
