...
// shared.
func (c TeamPrimaryChannelSharedWithTeamClient) GetTeamPrimaryChannelSharedWithTeam(ctx context.Context, id beta.GroupIdTeamPrimaryChannelSharedWithTeamId, options GetTeamPrimaryChannelSharedWithTeamOperationOptions) (result GetTeamPrimaryChannelSharedWithTeamOperationResponse, err error) {
