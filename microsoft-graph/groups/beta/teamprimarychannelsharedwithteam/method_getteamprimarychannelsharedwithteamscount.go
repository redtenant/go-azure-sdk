...
func (c TeamPrimaryChannelSharedWithTeamClient) GetTeamPrimaryChannelSharedWithTeamsCount(ctx context.Context, id beta.GroupId, options GetTeamPrimaryChannelSharedWithTeamsCountOperationOptions) (result GetTeamPrimaryChannelSharedWithTeamsCountOperationResponse, err error) {
