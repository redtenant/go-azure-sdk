...
func (c TeamPrimaryChannelSharedWithTeamAllowedMemberClient) ListTeamPrimaryChannelSharedWithTeamAllowedMembers(ctx context.Context, id beta.GroupIdTeamPrimaryChannelSharedWithTeamId, options ListTeamPrimaryChannelSharedWithTeamAllowedMembersOperationOptions) (result ListTeamPrimaryChannelSharedWithTeamAllowedMembersOperationResponse, err error) {
