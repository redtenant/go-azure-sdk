...
func (c TeamPrimaryChannelTabClient) DeleteTeamPrimaryChannelTab(ctx context.Context, id beta.GroupIdTeamPrimaryChannelTabId, options DeleteTeamPrimaryChannelTabOperationOptions) (result DeleteTeamPrimaryChannelTabOperationResponse, err error) {
