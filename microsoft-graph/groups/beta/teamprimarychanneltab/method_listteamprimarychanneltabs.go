...
// property.
func (c TeamPrimaryChannelTabClient) ListTeamPrimaryChannelTabs(ctx context.Context, id beta.GroupId, options ListTeamPrimaryChannelTabsOperationOptions) (result ListTeamPrimaryChannelTabsOperationResponse, err error) {
...
func (c TeamPrimaryChannelTabClient) ListTeamPrimaryChannelTabsComplete(ctx context.Context, id beta.GroupId, options ListTeamPrimaryChannelTabsOperationOptions) (ListTeamPrimaryChannelTabsCompleteResult, error) {
