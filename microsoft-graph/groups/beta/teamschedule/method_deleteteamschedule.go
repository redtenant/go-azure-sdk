...
func DefaultDeleteTeamScheduleOperationOptions() DeleteTeamScheduleOperationOptions {
	return DeleteTeamScheduleOperationOptions{}
}
...
func (c TeamScheduleClient) DeleteTeamSchedule(ctx context.Context, id beta.GroupId, options DeleteTeamScheduleOperationOptions) (result DeleteTeamScheduleOperationResponse, err error) {
