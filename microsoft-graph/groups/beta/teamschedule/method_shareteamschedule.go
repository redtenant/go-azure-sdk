...
// supports a draft version and a shared version of the item. The draft version is viewable only by managers, and the
...
func (c TeamScheduleClient) ShareTeamSchedule(ctx context.Context, id beta.GroupId, input ShareTeamScheduleRequest, options ShareTeamScheduleOperationOptions) (result ShareTeamScheduleOperationResponse, err error) {
