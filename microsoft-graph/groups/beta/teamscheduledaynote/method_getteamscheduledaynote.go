...
func (c TeamScheduleDayNoteClient) GetTeamScheduleDayNote(ctx context.Context, id beta.GroupIdTeamScheduleDayNoteId, options GetTeamScheduleDayNoteOperationOptions) (result GetTeamScheduleDayNoteOperationResponse, err error) {
