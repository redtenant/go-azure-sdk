...
func (c TeamScheduleDayNoteClient) ListTeamScheduleDayNotes(ctx context.Context, id beta.GroupId, options ListTeamScheduleDayNotesOperationOptions) (result ListTeamScheduleDayNotesOperationResponse, err error) {
...
func (c TeamScheduleDayNoteClient) ListTeamScheduleDayNotesComplete(ctx context.Context, id beta.GroupId, options ListTeamScheduleDayNotesOperationOptions) (ListTeamScheduleDayNotesCompleteResult, error) {
...
func (c TeamScheduleDayNoteClient) ListTeamScheduleDayNotesCompleteMatchingPredicate(ctx context.Context, id beta.GroupId, options ListTeamScheduleDayNotesOperationOptions, predicate DayNoteOperationPredicate) (result ListTeamScheduleDayNotesCompleteResult, err error) {
