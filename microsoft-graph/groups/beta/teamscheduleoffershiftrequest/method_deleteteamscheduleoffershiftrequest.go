...
func (c TeamScheduleOfferShiftRequestClient) DeleteTeamScheduleOfferShiftRequest(ctx context.Context, id beta.GroupIdTeamScheduleOfferShiftRequestId, options DeleteTeamScheduleOfferShiftRequestOperationOptions) (result DeleteTeamScheduleOfferShiftRequestOperationResponse, err error) {
