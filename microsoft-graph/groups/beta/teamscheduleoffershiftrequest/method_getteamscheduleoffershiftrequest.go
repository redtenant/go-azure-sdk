...
func (c TeamScheduleOfferShiftRequestClient) GetTeamScheduleOfferShiftRequest(ctx context.Context, id beta.GroupIdTeamScheduleOfferShiftRequestId, options GetTeamScheduleOfferShiftRequestOperationOptions) (result GetTeamScheduleOfferShiftRequestOperationResponse, err error) {
