...
func (c TeamScheduleOfferShiftRequestClient) UpdateTeamScheduleOfferShiftRequest(ctx context.Context, id beta.GroupIdTeamScheduleOfferShiftRequestId, input beta.OfferShiftRequest, options UpdateTeamScheduleOfferShiftRequestOperationOptions) (result UpdateTeamScheduleOfferShiftRequestOperationResponse, err error) {
