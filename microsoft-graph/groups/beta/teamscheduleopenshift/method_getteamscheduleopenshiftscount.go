...
func (c TeamScheduleOpenShiftClient) GetTeamScheduleOpenShiftsCount(ctx context.Context, id beta.GroupId, options GetTeamScheduleOpenShiftsCountOperationOptions) (result GetTeamScheduleOpenShiftsCountOperationResponse, err error) {
