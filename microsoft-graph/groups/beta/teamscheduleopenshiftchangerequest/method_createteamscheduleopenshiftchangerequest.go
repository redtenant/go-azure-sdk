...
func (c TeamScheduleOpenShiftChangeRequestClient) CreateTeamScheduleOpenShiftChangeRequest(ctx context.Context, id beta.GroupId, input beta.OpenShiftChangeRequest, options CreateTeamScheduleOpenShiftChangeRequestOperationOptions) (result CreateTeamScheduleOpenShiftChangeRequestOperationResponse, err error) {
	...
	var model beta.OpenShiftChangeRequest
	result.Model = &model
