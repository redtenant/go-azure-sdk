...
// schedule.
func (c TeamScheduleOpenShiftChangeRequestClient) GetTeamScheduleOpenShiftChangeRequest(ctx context.Context, id beta.GroupIdTeamScheduleOpenShiftChangeRequestId, options GetTeamScheduleOpenShiftChangeRequestOperationOptions) (result GetTeamScheduleOpenShiftChangeRequestOperationResponse, err error) {
