...
func (c TeamScheduleOpenShiftChangeRequestClient) UpdateTeamScheduleOpenShiftChangeRequest(ctx context.Context, id beta.GroupIdTeamScheduleOpenShiftChangeRequestId, input beta.OpenShiftChangeRequest, options UpdateTeamScheduleOpenShiftChangeRequestOperationOptions) (result UpdateTeamScheduleOpenShiftChangeRequestOperationResponse, err error) {
