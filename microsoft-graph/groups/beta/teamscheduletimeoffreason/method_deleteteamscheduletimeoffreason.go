...
type DeleteTeamScheduleTimeOffReasonOperationResponse struct {
	HttpResponse *http.Response
	OData        *odata.OData
}

type DeleteTeamScheduleTimeOffReasonOperationOptions struct {
	IfMatch   *string
...
func DefaultDeleteTeamScheduleTimeOffReasonOperationOptions() DeleteTeamScheduleTimeOffReasonOperationOptions {
	return DeleteTeamScheduleTimeOffReasonOperationOptions{}
}
...
func (c TeamScheduleTimeOffReasonClient) DeleteTeamScheduleTimeOffReason(ctx context.Context, id beta.GroupIdTeamScheduleTimeOffReasonId, options DeleteTeamScheduleTimeOffReasonOperationOptions) (result DeleteTeamScheduleTimeOffReasonOperationResponse, err error) {
