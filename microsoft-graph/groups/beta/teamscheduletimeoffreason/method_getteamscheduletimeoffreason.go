...
type GetTeamScheduleTimeOffReasonOperationResponse struct {
...
func DefaultGetTeamScheduleTimeOffReasonOperationOptions() GetTeamScheduleTimeOffReasonOperationOptions {
	return GetTeamScheduleTimeOffReasonOperationOptions{}
}
...
func (c TeamScheduleTimeOffReasonClient) GetTeamScheduleTimeOffReason(ctx context.Context, id beta.GroupIdTeamScheduleTimeOffReasonId, options GetTeamScheduleTimeOffReasonOperationOptions) (result GetTeamScheduleTimeOffReasonOperationResponse, err error) {
