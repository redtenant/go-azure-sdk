...
type UpdateTeamScheduleTimeOffReasonOperationResponse struct {
...
func (c TeamScheduleTimeOffReasonClient) UpdateTeamScheduleTimeOffReason(ctx context.Context, id beta.GroupIdTeamScheduleTimeOffReasonId, input beta.TimeOffReason, options UpdateTeamScheduleTimeOffReasonOperationOptions) (result UpdateTeamScheduleTimeOffReasonOperationResponse, err error) {
