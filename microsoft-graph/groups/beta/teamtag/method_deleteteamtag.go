...
type DeleteTeamTagOperationResponse struct {
	HttpResponse *http.Response
	OData        *odata.OData
}

type DeleteTeamTagOperationOptions struct {
	IfMatch   *string
...
func DefaultDeleteTeamTagOperationOptions() DeleteTeamTagOperationOptions {
	return DeleteTeamTagOperationOptions{}
}
...
func (c TeamTagClient) DeleteTeamTag(ctx context.Context, id beta.GroupIdTeamTagId, options DeleteTeamTagOperationOptions) (result DeleteTeamTagOperationResponse, err error) {
