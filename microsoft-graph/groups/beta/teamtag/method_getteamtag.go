...
type GetTeamTagOperationResponse struct {
...
func DefaultGetTeamTagOperationOptions() GetTeamTagOperationOptions {
	return GetTeamTagOperationOptions{}
}
...
func (c TeamTagClient) GetTeamTag(ctx context.Context, id beta.GroupIdTeamTagId, options GetTeamTagOperationOptions) (result GetTeamTagOperationResponse, err error) {
