...
func (c TeamTagClient) ListTeamTags(ctx context.Context, id beta.GroupId, options ListTeamTagsOperationOptions) (result ListTeamTagsOperationResponse, err error) {
	...
	var values struct {
		Values *[]beta.TeamworkTag `json:"value"`
	}
...
func (c TeamTagClient) ListTeamTagsComplete(ctx context.Context, id beta.GroupId, options ListTeamTagsOperationOptions) (ListTeamTagsCompleteResult, error) {
...
func (c TeamTagClient) ListTeamTagsCompleteMatchingPredicate(ctx context.Context, id beta.GroupId, options ListTeamTagsOperationOptions, predicate TeamworkTagOperationPredicate) (result ListTeamTagsCompleteResult, err error) {
	items := make([]beta.TeamworkTag, 0)
