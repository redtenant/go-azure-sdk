...
type UpdateTeamTagOperationResponse struct {
...
func (c TeamTagClient) UpdateTeamTag(ctx context.Context, id beta.GroupIdTeamTagId, input beta.TeamworkTag, options UpdateTeamTagOperationOptions) (result UpdateTeamTagOperationResponse, err error) {
