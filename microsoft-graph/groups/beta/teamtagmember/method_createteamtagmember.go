...
func (c TeamTagMemberClient) CreateTeamTagMember(ctx context.Context, id beta.GroupIdTeamTagId, input beta.TeamworkTagMember, options CreateTeamTagMemberOperationOptions) (result CreateTeamTagMemberOperationResponse, err error) {
