...
func (c TeamTemplateClient) GetTeamTemplate(ctx context.Context, id beta.GroupId, options GetTeamTemplateOperationOptions) (result GetTeamTemplateOperationResponse, err error) {
