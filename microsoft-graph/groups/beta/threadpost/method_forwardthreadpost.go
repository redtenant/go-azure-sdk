...
func (c ThreadPostClient) ForwardThreadPost(ctx context.Context, id beta.GroupIdThreadIdPostId, input ForwardThreadPostRequest, options ForwardThreadPostOperationOptions) (result ForwardThreadPostOperationResponse, err error) {
