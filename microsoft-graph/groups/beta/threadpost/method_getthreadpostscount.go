...
func (c ThreadPostClient) GetThreadPostsCount(ctx context.Context, id beta.GroupIdThreadId, options GetThreadPostsCountOperationOptions) (result GetThreadPostsCountOperationResponse, err error) {
