...
func DefaultReplyThreadPostOperationOptions() ReplyThreadPostOperationOptions {
	return ReplyThreadPostOperationOptions{}
}
...
func (c ThreadPostClient) ReplyThreadPost(ctx context.Context, id beta.GroupIdThreadIdPostId, input ReplyThreadPostRequest, options ReplyThreadPostOperationOptions) (result ReplyThreadPostOperationResponse, err error) {
