...
// ListThreadPostInReplyToAttachments - Get attachments from groups. The collection of fileAttachment, itemAttachment,
// and referenceAttachment attachments for the post. Read-only. Nullable. Supports $expand.
