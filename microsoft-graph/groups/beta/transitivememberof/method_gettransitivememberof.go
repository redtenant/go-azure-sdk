...
// GetTransitiveMemberOf - Get transitiveMemberOf from groups. The groups a group is a member of, either directly or
// through nested membership. Nullable.
func (c TransitiveMemberOfClient) GetTransitiveMemberOf(ctx context.Context, id beta.GroupIdTransitiveMemberOfId, options GetTransitiveMemberOfOperationOptions) (result GetTransitiveMemberOfOperationResponse, err error) {
