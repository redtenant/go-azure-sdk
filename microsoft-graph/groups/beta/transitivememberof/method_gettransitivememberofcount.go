...
func (c TransitiveMemberOfClient) GetTransitiveMemberOfCount(ctx context.Context, id beta.GroupId, options GetTransitiveMemberOfCountOperationOptions) (result GetTransitiveMemberOfCountOperationResponse, err error) {
