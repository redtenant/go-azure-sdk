...
func (c TransitiveMemberOfClient) ListTransitiveMemberOfsComplete(ctx context.Context, id beta.GroupId, options ListTransitiveMemberOfsOperationOptions) (ListTransitiveMemberOfsCompleteResult, error) {
