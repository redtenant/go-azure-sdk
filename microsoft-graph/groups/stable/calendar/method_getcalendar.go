...
func DefaultGetCalendarOperationOptions() GetCalendarOperationOptions {
	return GetCalendarOperationOptions{}
}
...
func (c CalendarClient) GetCalendar(ctx context.Context, id stable.GroupId, options GetCalendarOperationOptions) (result GetCalendarOperationResponse, err error) {
