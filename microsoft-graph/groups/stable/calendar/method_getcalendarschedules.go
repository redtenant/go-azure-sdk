...
func (c CalendarClient) GetCalendarSchedules(ctx context.Context, id stable.GroupId, input GetCalendarSchedulesRequest, options GetCalendarSchedulesOperationOptions) (result GetCalendarSchedulesOperationResponse, err error) {
...
func (c CalendarClient) GetCalendarSchedulesComplete(ctx context.Context, id stable.GroupId, input GetCalendarSchedulesRequest, options GetCalendarSchedulesOperationOptions) (GetCalendarSchedulesCompleteResult, error) {
...
func (c CalendarClient) GetCalendarSchedulesCompleteMatchingPredicate(ctx context.Context, id stable.GroupId, input GetCalendarSchedulesRequest, options GetCalendarSchedulesOperationOptions, predicate ScheduleInformationOperationPredicate) (result GetCalendarSchedulesCompleteResult, err error) {
