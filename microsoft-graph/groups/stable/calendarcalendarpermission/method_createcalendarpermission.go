...
func (c CalendarCalendarPermissionClient) CreateCalendarPermission(ctx context.Context, id stable.GroupId, input stable.CalendarPermission, options CreateCalendarPermissionOperationOptions) (result CreateCalendarPermissionOperationResponse, err error) {
