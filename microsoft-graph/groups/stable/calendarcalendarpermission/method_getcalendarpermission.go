...
// GetCalendarPermission - Get calendarPermissions from groups. The permissions of the users with whom the calendar is
// shared.
func (c CalendarCalendarPermissionClient) GetCalendarPermission(ctx context.Context, id stable.GroupIdCalendarCalendarPermissionId, options GetCalendarPermissionOperationOptions) (result GetCalendarPermissionOperationResponse, err error) {
