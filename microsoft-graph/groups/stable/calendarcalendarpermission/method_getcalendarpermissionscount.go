...
func (c CalendarCalendarPermissionClient) GetCalendarPermissionsCount(ctx context.Context, id stable.GroupId, options GetCalendarPermissionsCountOperationOptions) (result GetCalendarPermissionsCountOperationResponse, err error) {
