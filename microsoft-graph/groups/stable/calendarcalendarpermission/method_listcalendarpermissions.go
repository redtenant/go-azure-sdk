...
// ListCalendarPermissions - Get calendarPermissions from groups. The permissions of the users with whom the calendar is
// shared.
func (c CalendarCalendarPermissionClient) ListCalendarPermissions(ctx context.Context, id stable.GroupId, options ListCalendarPermissionsOperationOptions) (result ListCalendarPermissionsOperationResponse, err error) {
...
func (c CalendarCalendarPermissionClient) ListCalendarPermissionsComplete(ctx context.Context, id stable.GroupId, options ListCalendarPermissionsOperationOptions) (ListCalendarPermissionsCompleteResult, error) {
...
func (c CalendarCalendarPermissionClient) ListCalendarPermissionsCompleteMatchingPredicate(ctx context.Context, id stable.GroupId, options ListCalendarPermissionsOperationOptions, predicate CalendarPermissionOperationPredicate) (result ListCalendarPermissionsCompleteResult, err error) {
