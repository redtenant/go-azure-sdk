...
func (c CalendarCalendarViewClient) AcceptCalendarView(ctx context.Context, id stable.GroupIdCalendarCalendarViewId, input AcceptCalendarViewRequest, options AcceptCalendarViewOperationOptions) (result AcceptCalendarViewOperationResponse, err error) {
