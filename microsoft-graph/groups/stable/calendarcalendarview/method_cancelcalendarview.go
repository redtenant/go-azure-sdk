...
func (c CalendarCalendarViewClient) CancelCalendarView(ctx context.Context, id stable.GroupIdCalendarCalendarViewId, input CancelCalendarViewRequest, options CancelCalendarViewOperationOptions) (result CancelCalendarViewOperationResponse, err error) {
