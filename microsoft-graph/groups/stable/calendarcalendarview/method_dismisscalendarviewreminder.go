...
// in a user calendar.
func (c CalendarCalendarViewClient) DismissCalendarViewReminder(ctx context.Context, id stable.GroupIdCalendarCalendarViewId, options DismissCalendarViewReminderOperationOptions) (result DismissCalendarViewReminderOperationResponse, err error) {
