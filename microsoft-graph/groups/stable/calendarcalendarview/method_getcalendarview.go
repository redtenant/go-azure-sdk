...
func (c CalendarCalendarViewClient) GetCalendarView(ctx context.Context, id stable.GroupIdCalendarCalendarViewId, options GetCalendarViewOperationOptions) (result GetCalendarViewOperationResponse, err error) {
