...
func (c CalendarCalendarViewClient) GetCalendarViewCount(ctx context.Context, id stable.GroupId, options GetCalendarViewCountOperationOptions) (result GetCalendarViewCountOperationResponse, err error) {
