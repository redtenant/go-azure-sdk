...
func (c CalendarCalendarViewClient) ListCalendarViews(ctx context.Context, id stable.GroupId, options ListCalendarViewsOperationOptions) (result ListCalendarViewsOperationResponse, err error) {
...
func (c CalendarCalendarViewClient) ListCalendarViewsComplete(ctx context.Context, id stable.GroupId, options ListCalendarViewsOperationOptions) (ListCalendarViewsCompleteResult, error) {
...
func (c CalendarCalendarViewClient) ListCalendarViewsCompleteMatchingPredicate(ctx context.Context, id stable.GroupId, options ListCalendarViewsOperationOptions, predicate EventOperationPredicate) (result ListCalendarViewsCompleteResult, err error) {
