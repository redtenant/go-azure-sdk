...
// a new time.
func (c CalendarCalendarViewClient) SnoozeCalendarViewReminder(ctx context.Context, id stable.GroupIdCalendarCalendarViewId, input SnoozeCalendarViewReminderRequest, options SnoozeCalendarViewReminderOperationOptions) (result SnoozeCalendarViewReminderOperationResponse, err error) {
