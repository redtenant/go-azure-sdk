...
func (c CalendarCalendarViewClient) TentativelyAcceptCalendarView(ctx context.Context, id stable.GroupIdCalendarCalendarViewId, input TentativelyAcceptCalendarViewRequest, options TentativelyAcceptCalendarViewOperationOptions) (result TentativelyAcceptCalendarViewOperationResponse, err error) {
