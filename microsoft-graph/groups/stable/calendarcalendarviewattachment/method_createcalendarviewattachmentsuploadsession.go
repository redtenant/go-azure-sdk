...
func (c CalendarCalendarViewAttachmentClient) CreateCalendarViewAttachmentsUploadSession(ctx context.Context, id stable.GroupIdCalendarCalendarViewId, input CreateCalendarViewAttachmentsUploadSessionRequest, options CreateCalendarViewAttachmentsUploadSessionOperationOptions) (result CreateCalendarViewAttachmentsUploadSessionOperationResponse, err error) {
