...
func DefaultDeleteCalendarViewAttachmentOperationOptions() DeleteCalendarViewAttachmentOperationOptions {
	return DeleteCalendarViewAttachmentOperationOptions{}
}
...
func (c CalendarCalendarViewAttachmentClient) DeleteCalendarViewAttachment(ctx context.Context, id stable.GroupIdCalendarCalendarViewIdAttachmentId, options DeleteCalendarViewAttachmentOperationOptions) (result DeleteCalendarViewAttachmentOperationResponse, err error) {
