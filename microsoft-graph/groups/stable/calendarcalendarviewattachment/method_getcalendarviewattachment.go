...
func DefaultGetCalendarViewAttachmentOperationOptions() GetCalendarViewAttachmentOperationOptions {
	return GetCalendarViewAttachmentOperationOptions{}
}
...
// GetCalendarViewAttachment - Get attachments from groups. The collection of FileAttachment, ItemAttachment, and
// referenceAttachment attachments for the event. Navigation property. Read-only. Nullable.
func (c CalendarCalendarViewAttachmentClient) GetCalendarViewAttachment(ctx context.Context, id stable.GroupIdCalendarCalendarViewIdAttachmentId, options GetCalendarViewAttachmentOperationOptions) (result GetCalendarViewAttachmentOperationResponse, err error) {
