...
func DefaultGetCalendarViewAttachmentsCountOperationOptions() GetCalendarViewAttachmentsCountOperationOptions {
	return GetCalendarViewAttachmentsCountOperationOptions{}
}
...
func (c CalendarCalendarViewAttachmentClient) GetCalendarViewAttachmentsCount(ctx context.Context, id stable.GroupIdCalendarCalendarViewId, options GetCalendarViewAttachmentsCountOperationOptions) (result GetCalendarViewAttachmentsCountOperationResponse, err error) {
