...
func (c CalendarCalendarViewAttachmentClient) ListCalendarViewAttachments(ctx context.Context, id stable.GroupIdCalendarCalendarViewId, options ListCalendarViewAttachmentsOperationOptions) (result ListCalendarViewAttachmentsOperationResponse, err error) {
...
func (c CalendarCalendarViewAttachmentClient) ListCalendarViewAttachmentsComplete(ctx context.Context, id stable.GroupIdCalendarCalendarViewId, options ListCalendarViewAttachmentsOperationOptions) (ListCalendarViewAttachmentsCompleteResult, error) {
