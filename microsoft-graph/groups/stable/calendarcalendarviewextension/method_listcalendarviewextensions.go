...
// Nullable.
func (c CalendarCalendarViewExtensionClient) ListCalendarViewExtensions(ctx context.Context, id stable.GroupIdCalendarCalendarViewId, options ListCalendarViewExtensionsOperationOptions) (result ListCalendarViewExtensionsOperationResponse, err error) {
...
func (c CalendarCalendarViewExtensionClient) ListCalendarViewExtensionsComplete(ctx context.Context, id stable.GroupIdCalendarCalendarViewId, options ListCalendarViewExtensionsOperationOptions) (ListCalendarViewExtensionsCompleteResult, error) {
...
func (c CalendarCalendarViewExtensionClient) ListCalendarViewExtensionsCompleteMatchingPredicate(ctx context.Context, id stable.GroupIdCalendarCalendarViewId, options ListCalendarViewExtensionsOperationOptions, predicate ExtensionOperationPredicate) (result ListCalendarViewExtensionsCompleteResult, err error) {
