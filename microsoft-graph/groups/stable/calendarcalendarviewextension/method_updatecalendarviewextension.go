...
type UpdateCalendarViewExtensionOperationResponse struct {
...
func (c CalendarCalendarViewExtensionClient) UpdateCalendarViewExtension(ctx context.Context, id stable.GroupIdCalendarCalendarViewIdExtensionId, input stable.Extension, options UpdateCalendarViewExtensionOperationOptions) (result UpdateCalendarViewExtensionOperationResponse, err error) {
