...
func (c CalendarCalendarViewInstanceClient) DeclineCalendarViewInstance(ctx context.Context, id stable.GroupIdCalendarCalendarViewIdInstanceId, input DeclineCalendarViewInstanceRequest, options DeclineCalendarViewInstanceOperationOptions) (result DeclineCalendarViewInstanceOperationResponse, err error) {
