...
// Outlook.com account.
func (c CalendarCalendarViewInstanceClient) ForwardCalendarViewInstance(ctx context.Context, id stable.GroupIdCalendarCalendarViewIdInstanceId, input ForwardCalendarViewInstanceRequest, options ForwardCalendarViewInstanceOperationOptions) (result ForwardCalendarViewInstanceOperationResponse, err error) {
