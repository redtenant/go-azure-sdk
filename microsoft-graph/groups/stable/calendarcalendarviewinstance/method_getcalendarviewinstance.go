...
// Nullable.
func (c CalendarCalendarViewInstanceClient) GetCalendarViewInstance(ctx context.Context, id stable.GroupIdCalendarCalendarViewIdInstanceId, options GetCalendarViewInstanceOperationOptions) (result GetCalendarViewInstanceOperationResponse, err error) {
