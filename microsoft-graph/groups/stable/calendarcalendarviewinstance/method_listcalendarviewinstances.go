...
// Read-only. Nullable.
func (c CalendarCalendarViewInstanceClient) ListCalendarViewInstances(ctx context.Context, id stable.GroupIdCalendarCalendarViewId, options ListCalendarViewInstancesOperationOptions) (result ListCalendarViewInstancesOperationResponse, err error) {
...
func (c CalendarCalendarViewInstanceClient) ListCalendarViewInstancesComplete(ctx context.Context, id stable.GroupIdCalendarCalendarViewId, options ListCalendarViewInstancesOperationOptions) (ListCalendarViewInstancesCompleteResult, error) {
...
func (c CalendarCalendarViewInstanceClient) ListCalendarViewInstancesCompleteMatchingPredicate(ctx context.Context, id stable.GroupIdCalendarCalendarViewId, options ListCalendarViewInstancesOperationOptions, predicate EventOperationPredicate) (result ListCalendarViewInstancesCompleteResult, err error) {
