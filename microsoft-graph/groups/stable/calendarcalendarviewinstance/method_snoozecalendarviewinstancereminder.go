...
func (c CalendarCalendarViewInstanceClient) SnoozeCalendarViewInstanceReminder(ctx context.Context, id stable.GroupIdCalendarCalendarViewIdInstanceId, input SnoozeCalendarViewInstanceReminderRequest, options SnoozeCalendarViewInstanceReminderOperationOptions) (result SnoozeCalendarViewInstanceReminderOperationResponse, err error) {
