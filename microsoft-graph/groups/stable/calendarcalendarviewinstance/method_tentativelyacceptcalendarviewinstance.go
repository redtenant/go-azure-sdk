...
func (c CalendarCalendarViewInstanceClient) TentativelyAcceptCalendarViewInstance(ctx context.Context, id stable.GroupIdCalendarCalendarViewIdInstanceId, input TentativelyAcceptCalendarViewInstanceRequest, options TentativelyAcceptCalendarViewInstanceOperationOptions) (result TentativelyAcceptCalendarViewInstanceOperationResponse, err error) {
