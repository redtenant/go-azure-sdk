...
func DefaultCreateCalendarViewInstanceAttachmentOperationOptions() CreateCalendarViewInstanceAttachmentOperationOptions {
	return CreateCalendarViewInstanceAttachmentOperationOptions{}
}
...
func (c CalendarCalendarViewInstanceAttachmentClient) CreateCalendarViewInstanceAttachment(ctx context.Context, id stable.GroupIdCalendarCalendarViewIdInstanceId, input stable.Attachment, options CreateCalendarViewInstanceAttachmentOperationOptions) (result CreateCalendarViewInstanceAttachmentOperationResponse, err error) {
