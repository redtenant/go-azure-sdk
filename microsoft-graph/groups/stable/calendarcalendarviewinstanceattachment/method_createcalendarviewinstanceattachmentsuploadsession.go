...
// allows an app to iteratively upload ranges of a file, so as to attach the file to the specified Outlook item. The
...
func (c CalendarCalendarViewInstanceAttachmentClient) CreateCalendarViewInstanceAttachmentsUploadSession(ctx context.Context, id stable.GroupIdCalendarCalendarViewIdInstanceId, input CreateCalendarViewInstanceAttachmentsUploadSessionRequest, options CreateCalendarViewInstanceAttachmentsUploadSessionOperationOptions) (result CreateCalendarViewInstanceAttachmentsUploadSessionOperationResponse, err error) {
