...
func (c CalendarCalendarViewInstanceAttachmentClient) DeleteCalendarViewInstanceAttachment(ctx context.Context, id stable.GroupIdCalendarCalendarViewIdInstanceIdAttachmentId, options DeleteCalendarViewInstanceAttachmentOperationOptions) (result DeleteCalendarViewInstanceAttachmentOperationResponse, err error) {
