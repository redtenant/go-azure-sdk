...
func DefaultGetCalendarViewInstanceAttachmentOperationOptions() GetCalendarViewInstanceAttachmentOperationOptions {
	return GetCalendarViewInstanceAttachmentOperationOptions{}
}
...
// GetCalendarViewInstanceAttachment - Get attachments from groups. The collection of FileAttachment, ItemAttachment,
// and referenceAttachment attachments for the event. Navigation property. Read-only. Nullable.
func (c CalendarCalendarViewInstanceAttachmentClient) GetCalendarViewInstanceAttachment(ctx context.Context, id stable.GroupIdCalendarCalendarViewIdInstanceIdAttachmentId, options GetCalendarViewInstanceAttachmentOperationOptions) (result GetCalendarViewInstanceAttachmentOperationResponse, err error) {
