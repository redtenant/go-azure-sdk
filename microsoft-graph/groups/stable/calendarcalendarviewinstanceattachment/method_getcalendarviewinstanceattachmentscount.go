...
func DefaultGetCalendarViewInstanceAttachmentsCountOperationOptions() GetCalendarViewInstanceAttachmentsCountOperationOptions {
	return GetCalendarViewInstanceAttachmentsCountOperationOptions{}
}
...
func (c CalendarCalendarViewInstanceAttachmentClient) GetCalendarViewInstanceAttachmentsCount(ctx context.Context, id stable.GroupIdCalendarCalendarViewIdInstanceId, options GetCalendarViewInstanceAttachmentsCountOperationOptions) (result GetCalendarViewInstanceAttachmentsCountOperationResponse, err error) {
