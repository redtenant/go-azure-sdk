...
func DefaultListCalendarViewInstanceAttachmentsOperationOptions() ListCalendarViewInstanceAttachmentsOperationOptions {
	return ListCalendarViewInstanceAttachmentsOperationOptions{}
}
...
// ListCalendarViewInstanceAttachments - Get attachments from groups. The collection of FileAttachment, ItemAttachment,
// and referenceAttachment attachments for the event. Navigation property. Read-only. Nullable.
func (c CalendarCalendarViewInstanceAttachmentClient) ListCalendarViewInstanceAttachments(ctx context.Context, id stable.GroupIdCalendarCalendarViewIdInstanceId, options ListCalendarViewInstanceAttachmentsOperationOptions) (result ListCalendarViewInstanceAttachmentsOperationResponse, err error) {
	opts := client.RequestOptions{
		...
		Pager:         &ListCalendarViewInstanceAttachmentsCustomPager{},
...
func (c CalendarCalendarViewInstanceAttachmentClient) ListCalendarViewInstanceAttachmentsComplete(ctx context.Context, id stable.GroupIdCalendarCalendarViewIdInstanceId, options ListCalendarViewInstanceAttachmentsOperationOptions) (ListCalendarViewInstanceAttachmentsCompleteResult, error) {
	return c.ListCalendarViewInstanceAttachmentsCompleteMatchingPredicate(ctx, id, options, AttachmentOperationPredicate{})
}

// ListCalendarViewInstanceAttachmentsCompleteMatchingPredicate retrieves all the results and then applies the predicate
func (c CalendarCalendarViewInstanceAttachmentClient) ListCalendarViewInstanceAttachmentsCompleteMatchingPredicate(ctx context.Context, id stable.GroupIdCalendarCalendarViewIdInstanceId, options ListCalendarViewInstanceAttachmentsOperationOptions, predicate AttachmentOperationPredicate) (result ListCalendarViewInstanceAttachmentsCompleteResult, err error) {
	items := make([]stable.Attachment, 0)

	resp, err := c.ListCalendarViewInstanceAttachments(ctx, id, options)
	if err != nil {
	...
	result = ListCalendarViewInstanceAttachmentsCompleteResult{
