...
func (c CalendarCalendarViewInstanceExtensionClient) UpdateCalendarViewInstanceExtension(ctx context.Context, id stable.GroupIdCalendarCalendarViewIdInstanceIdExtensionId, input stable.Extension, options UpdateCalendarViewInstanceExtensionOperationOptions) (result UpdateCalendarViewInstanceExtensionOperationResponse, err error) {
