...
func DefaultCancelCalendarEventOperationOptions() CancelCalendarEventOperationOptions {
	return CancelCalendarEventOperationOptions{}
}
...
func (c CalendarEventClient) CancelCalendarEvent(ctx context.Context, id stable.GroupIdCalendarEventId, input CancelCalendarEventRequest, options CancelCalendarEventOperationOptions) (result CancelCalendarEventOperationResponse, err error) {
