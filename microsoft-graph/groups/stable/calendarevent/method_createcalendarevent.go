...
func (c CalendarEventClient) CreateCalendarEvent(ctx context.Context, id stable.GroupId, input stable.Event, options CreateCalendarEventOperationOptions) (result CreateCalendarEventOperationResponse, err error) {
