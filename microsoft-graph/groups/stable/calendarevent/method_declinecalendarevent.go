...
func (c CalendarEventClient) DeclineCalendarEvent(ctx context.Context, id stable.GroupIdCalendarEventId, input DeclineCalendarEventRequest, options DeclineCalendarEventOperationOptions) (result DeclineCalendarEventOperationResponse, err error) {
