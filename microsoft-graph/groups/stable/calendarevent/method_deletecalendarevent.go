...
func DefaultDeleteCalendarEventOperationOptions() DeleteCalendarEventOperationOptions {
	return DeleteCalendarEventOperationOptions{}
}
...
func (c CalendarEventClient) DeleteCalendarEvent(ctx context.Context, id stable.GroupIdCalendarEventId, options DeleteCalendarEventOperationOptions) (result DeleteCalendarEventOperationResponse, err error) {
