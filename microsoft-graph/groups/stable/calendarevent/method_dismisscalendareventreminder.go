...
func DefaultDismissCalendarEventReminderOperationOptions() DismissCalendarEventReminderOperationOptions {
	return DismissCalendarEventReminderOperationOptions{}
}
...
// DismissCalendarEventReminder - Invoke action dismissReminder. Dismiss a reminder that has been triggered for an event
// in a user calendar.
func (c CalendarEventClient) DismissCalendarEventReminder(ctx context.Context, id stable.GroupIdCalendarEventId, options DismissCalendarEventReminderOperationOptions) (result DismissCalendarEventReminderOperationResponse, err error) {
