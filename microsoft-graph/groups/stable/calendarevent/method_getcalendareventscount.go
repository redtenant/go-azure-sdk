...
func DefaultGetCalendarEventsCountOperationOptions() GetCalendarEventsCountOperationOptions {
	return GetCalendarEventsCountOperationOptions{}
}
...
func (c CalendarEventClient) GetCalendarEventsCount(ctx context.Context, id stable.GroupId, options GetCalendarEventsCountOperationOptions) (result GetCalendarEventsCountOperationResponse, err error) {
	opts := client.RequestOptions{
		...
		Path:          fmt.Sprintf("%s/calendar/events/$count", id.ID()),
