...
func (c CalendarEventClient) TentativelyAcceptCalendarEvent(ctx context.Context, id stable.GroupIdCalendarEventId, input TentativelyAcceptCalendarEventRequest, options TentativelyAcceptCalendarEventOperationOptions) (result TentativelyAcceptCalendarEventOperationResponse, err error) {
