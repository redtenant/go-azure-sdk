...
func (c CalendarEventAttachmentClient) CreateCalendarEventAttachment(ctx context.Context, id stable.GroupIdCalendarEventId, input stable.Attachment, options CreateCalendarEventAttachmentOperationOptions) (result CreateCalendarEventAttachmentOperationResponse, err error) {
