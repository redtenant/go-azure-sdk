...
func DefaultCreateCalendarEventAttachmentsUploadSessionOperationOptions() CreateCalendarEventAttachmentsUploadSessionOperationOptions {
	return CreateCalendarEventAttachmentsUploadSessionOperationOptions{}
}
...
// CreateCalendarEventAttachmentsUploadSession - Invoke action createUploadSession. Create an upload session that allows
...
func (c CalendarEventAttachmentClient) CreateCalendarEventAttachmentsUploadSession(ctx context.Context, id stable.GroupIdCalendarEventId, input CreateCalendarEventAttachmentsUploadSessionRequest, options CreateCalendarEventAttachmentsUploadSessionOperationOptions) (result CreateCalendarEventAttachmentsUploadSessionOperationResponse, err error) {
