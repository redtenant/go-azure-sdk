...
func DefaultGetCalendarEventAttachmentOperationOptions() GetCalendarEventAttachmentOperationOptions {
	return GetCalendarEventAttachmentOperationOptions{}
}
...
// GetCalendarEventAttachment - Get attachments from groups. The collection of FileAttachment, ItemAttachment, and
// referenceAttachment attachments for the event. Navigation property. Read-only. Nullable.
func (c CalendarEventAttachmentClient) GetCalendarEventAttachment(ctx context.Context, id stable.GroupIdCalendarEventIdAttachmentId, options GetCalendarEventAttachmentOperationOptions) (result GetCalendarEventAttachmentOperationResponse, err error) {
