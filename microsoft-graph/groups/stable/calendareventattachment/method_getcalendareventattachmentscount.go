...
func DefaultGetCalendarEventAttachmentsCountOperationOptions() GetCalendarEventAttachmentsCountOperationOptions {
	return GetCalendarEventAttachmentsCountOperationOptions{}
}
...
func (c CalendarEventAttachmentClient) GetCalendarEventAttachmentsCount(ctx context.Context, id stable.GroupIdCalendarEventId, options GetCalendarEventAttachmentsCountOperationOptions) (result GetCalendarEventAttachmentsCountOperationResponse, err error) {
