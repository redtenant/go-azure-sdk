...
func (c CalendarEventAttachmentClient) ListCalendarEventAttachments(ctx context.Context, id stable.GroupIdCalendarEventId, options ListCalendarEventAttachmentsOperationOptions) (result ListCalendarEventAttachmentsOperationResponse, err error) {
...
func (c CalendarEventAttachmentClient) ListCalendarEventAttachmentsComplete(ctx context.Context, id stable.GroupIdCalendarEventId, options ListCalendarEventAttachmentsOperationOptions) (ListCalendarEventAttachmentsCompleteResult, error) {
...
func (c CalendarEventAttachmentClient) ListCalendarEventAttachmentsCompleteMatchingPredicate(ctx context.Context, id stable.GroupIdCalendarEventId, options ListCalendarEventAttachmentsOperationOptions, predicate AttachmentOperationPredicate) (result ListCalendarEventAttachmentsCompleteResult, err error) {
