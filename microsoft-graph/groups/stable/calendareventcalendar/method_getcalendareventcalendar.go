...
// GetCalendarEventCalendar - Get calendar from groups. The calendar that contains the event. Navigation property.
// Read-only.
func (c CalendarEventCalendarClient) GetCalendarEventCalendar(ctx context.Context, id stable.GroupIdCalendarEventId, options GetCalendarEventCalendarOperationOptions) (result GetCalendarEventCalendarOperationResponse, err error) {
