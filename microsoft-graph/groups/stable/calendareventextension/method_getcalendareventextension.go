...
// Nullable.
func (c CalendarEventExtensionClient) GetCalendarEventExtension(ctx context.Context, id stable.GroupIdCalendarEventIdExtensionId, options GetCalendarEventExtensionOperationOptions) (result GetCalendarEventExtensionOperationResponse, err error) {
