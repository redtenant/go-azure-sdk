...
// Nullable.
func (c CalendarEventExtensionClient) ListCalendarEventExtensions(ctx context.Context, id stable.GroupIdCalendarEventId, options ListCalendarEventExtensionsOperationOptions) (result ListCalendarEventExtensionsOperationResponse, err error) {
...
func (c CalendarEventExtensionClient) ListCalendarEventExtensionsComplete(ctx context.Context, id stable.GroupIdCalendarEventId, options ListCalendarEventExtensionsOperationOptions) (ListCalendarEventExtensionsCompleteResult, error) {
...
func (c CalendarEventExtensionClient) ListCalendarEventExtensionsCompleteMatchingPredicate(ctx context.Context, id stable.GroupIdCalendarEventId, options ListCalendarEventExtensionsOperationOptions, predicate ExtensionOperationPredicate) (result ListCalendarEventExtensionsCompleteResult, err error) {
