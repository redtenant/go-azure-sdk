...
func DefaultCancelCalendarEventInstanceOperationOptions() CancelCalendarEventInstanceOperationOptions {
	return CancelCalendarEventInstanceOperationOptions{}
}

func (o CancelCalendarEventInstanceOperationOptions) ToHeaders() *client.Headers {
	out := client.Headers{}

	return &out
}

func (o CancelCalendarEventInstanceOperationOptions) ToOData() *odata.Query {
	out := odata.Query{}
	if o.Metadata != nil {
...
func (o CancelCalendarEventInstanceOperationOptions) ToQuery() *client.QueryParams {
	out := client.QueryParams{}

	return &out
}

// CancelCalendarEventInstance - Invoke action cancel. This action allows the organizer of a meeting to send a
...
func (c CalendarEventInstanceClient) CancelCalendarEventInstance(ctx context.Context, id stable.GroupIdCalendarEventIdInstanceId, input CancelCalendarEventInstanceRequest, options CancelCalendarEventInstanceOperationOptions) (result CancelCalendarEventInstanceOperationResponse, err error) {
