...
func (c CalendarEventInstanceClient) DismissCalendarEventInstanceReminder(ctx context.Context, id stable.GroupIdCalendarEventIdInstanceId, options DismissCalendarEventInstanceReminderOperationOptions) (result DismissCalendarEventInstanceReminderOperationResponse, err error) {
