...
func DefaultGetCalendarEventInstanceOperationOptions() GetCalendarEventInstanceOperationOptions {
	return GetCalendarEventInstanceOperationOptions{}
}
...
func (o GetCalendarEventInstanceOperationOptions) ToOData() *odata.Query {
	out := odata.Query{}
	if o.Expand != nil {
		out.Expand = *o.Expand
	}
...
func (o GetCalendarEventInstanceOperationOptions) ToQuery() *client.QueryParams {
...
// GetCalendarEventInstance - Get instances from groups. The occurrences of a recurring series, if the event is a series
...
// Nullable.
func (c CalendarEventInstanceClient) GetCalendarEventInstance(ctx context.Context, id stable.GroupIdCalendarEventIdInstanceId, options GetCalendarEventInstanceOperationOptions) (result GetCalendarEventInstanceOperationResponse, err error) {
