...
func DefaultCreateCalendarEventInstanceAttachmentsUploadSessionOperationOptions() CreateCalendarEventInstanceAttachmentsUploadSessionOperationOptions {
	return CreateCalendarEventInstanceAttachmentsUploadSessionOperationOptions{}
}
...
// CreateCalendarEventInstanceAttachmentsUploadSession - Invoke action createUploadSession. Create an upload session
