...
// GetCalendarEventInstanceCalendar - Get calendar from groups. The calendar that contains the event. Navigation
// property. Read-only.
func (c CalendarEventInstanceCalendarClient) GetCalendarEventInstanceCalendar(ctx context.Context, id stable.GroupIdCalendarEventIdInstanceId, options GetCalendarEventInstanceCalendarOperationOptions) (result GetCalendarEventInstanceCalendarOperationResponse, err error) {
