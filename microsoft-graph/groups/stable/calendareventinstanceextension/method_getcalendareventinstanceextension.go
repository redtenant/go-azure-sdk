...
// event. Nullable.
func (c CalendarEventInstanceExtensionClient) GetCalendarEventInstanceExtension(ctx context.Context, id stable.GroupIdCalendarEventIdInstanceIdExtensionId, options GetCalendarEventInstanceExtensionOperationOptions) (result GetCalendarEventInstanceExtensionOperationResponse, err error) {
