...
func (c CalendarViewAttachmentClient) CreateCalendarViewAttachment(ctx context.Context, id stable.GroupIdCalendarViewId, input stable.Attachment, options CreateCalendarViewAttachmentOperationOptions) (result CreateCalendarViewAttachmentOperationResponse, err error) {
