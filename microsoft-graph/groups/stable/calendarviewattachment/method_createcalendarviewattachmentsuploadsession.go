...
func (c CalendarViewAttachmentClient) CreateCalendarViewAttachmentsUploadSession(ctx context.Context, id stable.GroupIdCalendarViewId, input CreateCalendarViewAttachmentsUploadSessionRequest, options CreateCalendarViewAttachmentsUploadSessionOperationOptions) (result CreateCalendarViewAttachmentsUploadSessionOperationResponse, err error) {
