...
func (c CalendarViewAttachmentClient) DeleteCalendarViewAttachment(ctx context.Context, id stable.GroupIdCalendarViewIdAttachmentId, options DeleteCalendarViewAttachmentOperationOptions) (result DeleteCalendarViewAttachmentOperationResponse, err error) {
