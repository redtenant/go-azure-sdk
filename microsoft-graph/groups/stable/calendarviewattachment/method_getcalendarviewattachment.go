...
func (c CalendarViewAttachmentClient) GetCalendarViewAttachment(ctx context.Context, id stable.GroupIdCalendarViewIdAttachmentId, options GetCalendarViewAttachmentOperationOptions) (result GetCalendarViewAttachmentOperationResponse, err error) {
