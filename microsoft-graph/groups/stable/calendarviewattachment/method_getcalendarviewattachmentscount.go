...
func (c CalendarViewAttachmentClient) GetCalendarViewAttachmentsCount(ctx context.Context, id stable.GroupIdCalendarViewId, options GetCalendarViewAttachmentsCountOperationOptions) (result GetCalendarViewAttachmentsCountOperationResponse, err error) {
