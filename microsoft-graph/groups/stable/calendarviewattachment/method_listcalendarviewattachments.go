...
func (c CalendarViewAttachmentClient) ListCalendarViewAttachments(ctx context.Context, id stable.GroupIdCalendarViewId, options ListCalendarViewAttachmentsOperationOptions) (result ListCalendarViewAttachmentsOperationResponse, err error) {
...
func (c CalendarViewAttachmentClient) ListCalendarViewAttachmentsComplete(ctx context.Context, id stable.GroupIdCalendarViewId, options ListCalendarViewAttachmentsOperationOptions) (ListCalendarViewAttachmentsCompleteResult, error) {
...
func (c CalendarViewAttachmentClient) ListCalendarViewAttachmentsCompleteMatchingPredicate(ctx context.Context, id stable.GroupIdCalendarViewId, options ListCalendarViewAttachmentsOperationOptions, predicate AttachmentOperationPredicate) (result ListCalendarViewAttachmentsCompleteResult, err error) {
