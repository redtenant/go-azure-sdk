...
func (c CalendarViewExtensionClient) UpdateCalendarViewExtension(ctx context.Context, id stable.GroupIdCalendarViewIdExtensionId, input stable.Extension, options UpdateCalendarViewExtensionOperationOptions) (result UpdateCalendarViewExtensionOperationResponse, err error) {
