...
func (c CalendarViewInstanceClient) CancelCalendarViewInstance(ctx context.Context, id stable.GroupIdCalendarViewIdInstanceId, input CancelCalendarViewInstanceRequest, options CancelCalendarViewInstanceOperationOptions) (result CancelCalendarViewInstanceOperationResponse, err error) {
