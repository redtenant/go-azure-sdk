...
func (c CalendarViewInstanceClient) DeclineCalendarViewInstance(ctx context.Context, id stable.GroupIdCalendarViewIdInstanceId, input DeclineCalendarViewInstanceRequest, options DeclineCalendarViewInstanceOperationOptions) (result DeclineCalendarViewInstanceOperationResponse, err error) {
