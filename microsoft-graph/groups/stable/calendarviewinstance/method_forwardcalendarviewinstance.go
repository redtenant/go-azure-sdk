...
// Outlook.com account.
func (c CalendarViewInstanceClient) ForwardCalendarViewInstance(ctx context.Context, id stable.GroupIdCalendarViewIdInstanceId, input ForwardCalendarViewInstanceRequest, options ForwardCalendarViewInstanceOperationOptions) (result ForwardCalendarViewInstanceOperationResponse, err error) {
