...
// Nullable.
func (c CalendarViewInstanceClient) GetCalendarViewInstance(ctx context.Context, id stable.GroupIdCalendarViewIdInstanceId, options GetCalendarViewInstanceOperationOptions) (result GetCalendarViewInstanceOperationResponse, err error) {
