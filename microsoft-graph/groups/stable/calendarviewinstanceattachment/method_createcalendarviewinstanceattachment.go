...
func (c CalendarViewInstanceAttachmentClient) CreateCalendarViewInstanceAttachment(ctx context.Context, id stable.GroupIdCalendarViewIdInstanceId, input stable.Attachment, options CreateCalendarViewInstanceAttachmentOperationOptions) (result CreateCalendarViewInstanceAttachmentOperationResponse, err error) {
