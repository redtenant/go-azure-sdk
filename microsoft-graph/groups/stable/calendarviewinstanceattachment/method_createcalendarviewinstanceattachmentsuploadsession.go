...
func (c CalendarViewInstanceAttachmentClient) CreateCalendarViewInstanceAttachmentsUploadSession(ctx context.Context, id stable.GroupIdCalendarViewIdInstanceId, input CreateCalendarViewInstanceAttachmentsUploadSessionRequest, options CreateCalendarViewInstanceAttachmentsUploadSessionOperationOptions) (result CreateCalendarViewInstanceAttachmentsUploadSessionOperationResponse, err error) {
