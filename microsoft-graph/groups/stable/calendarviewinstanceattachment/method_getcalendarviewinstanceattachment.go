...
func (c CalendarViewInstanceAttachmentClient) GetCalendarViewInstanceAttachment(ctx context.Context, id stable.GroupIdCalendarViewIdInstanceIdAttachmentId, options GetCalendarViewInstanceAttachmentOperationOptions) (result GetCalendarViewInstanceAttachmentOperationResponse, err error) {
