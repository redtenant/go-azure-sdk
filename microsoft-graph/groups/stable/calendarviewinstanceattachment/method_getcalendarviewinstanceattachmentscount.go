...
func (c CalendarViewInstanceAttachmentClient) GetCalendarViewInstanceAttachmentsCount(ctx context.Context, id stable.GroupIdCalendarViewIdInstanceId, options GetCalendarViewInstanceAttachmentsCountOperationOptions) (result GetCalendarViewInstanceAttachmentsCountOperationResponse, err error) {
