...
func (c CalendarViewInstanceAttachmentClient) ListCalendarViewInstanceAttachments(ctx context.Context, id stable.GroupIdCalendarViewIdInstanceId, options ListCalendarViewInstanceAttachmentsOperationOptions) (result ListCalendarViewInstanceAttachmentsOperationResponse, err error) {
...
func (c CalendarViewInstanceAttachmentClient) ListCalendarViewInstanceAttachmentsComplete(ctx context.Context, id stable.GroupIdCalendarViewIdInstanceId, options ListCalendarViewInstanceAttachmentsOperationOptions) (ListCalendarViewInstanceAttachmentsCompleteResult, error) {
...
func (c CalendarViewInstanceAttachmentClient) ListCalendarViewInstanceAttachmentsCompleteMatchingPredicate(ctx context.Context, id stable.GroupIdCalendarViewIdInstanceId, options ListCalendarViewInstanceAttachmentsOperationOptions, predicate AttachmentOperationPredicate) (result ListCalendarViewInstanceAttachmentsCompleteResult, err error) {
