...
func (c CalendarViewInstanceExtensionClient) UpdateCalendarViewInstanceExtension(ctx context.Context, id stable.GroupIdCalendarViewIdInstanceIdExtensionId, input stable.Extension, options UpdateCalendarViewInstanceExtensionOperationOptions) (result UpdateCalendarViewInstanceExtensionOperationResponse, err error) {
