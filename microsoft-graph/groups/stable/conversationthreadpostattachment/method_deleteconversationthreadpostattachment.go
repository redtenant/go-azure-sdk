...
func DefaultDeleteConversationThreadPostAttachmentOperationOptions() DeleteConversationThreadPostAttachmentOperationOptions {
	return DeleteConversationThreadPostAttachmentOperationOptions{}
}
...
func (c ConversationThreadPostAttachmentClient) DeleteConversationThreadPostAttachment(ctx context.Context, id stable.GroupIdConversationIdThreadIdPostIdAttachmentId, options DeleteConversationThreadPostAttachmentOperationOptions) (result DeleteConversationThreadPostAttachmentOperationResponse, err error) {
