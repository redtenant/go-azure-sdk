...
func DefaultGetConversationThreadPostAttachmentOperationOptions() GetConversationThreadPostAttachmentOperationOptions {
	return GetConversationThreadPostAttachmentOperationOptions{}
}
...
// GetConversationThreadPostAttachment - Get attachments from groups. Read-only. Nullable. Supports $expand.
func (c ConversationThreadPostAttachmentClient) GetConversationThreadPostAttachment(ctx context.Context, id stable.GroupIdConversationIdThreadIdPostIdAttachmentId, options GetConversationThreadPostAttachmentOperationOptions) (result GetConversationThreadPostAttachmentOperationResponse, err error) {
