...
func DefaultGetConversationThreadPostAttachmentsCountOperationOptions() GetConversationThreadPostAttachmentsCountOperationOptions {
	return GetConversationThreadPostAttachmentsCountOperationOptions{}
}
...
func (c ConversationThreadPostAttachmentClient) GetConversationThreadPostAttachmentsCount(ctx context.Context, id stable.GroupIdConversationIdThreadIdPostId, options GetConversationThreadPostAttachmentsCountOperationOptions) (result GetConversationThreadPostAttachmentsCountOperationResponse, err error) {
