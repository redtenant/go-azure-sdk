...
// ListConversationThreadPostAttachments - Get attachments from groups. Read-only. Nullable. Supports $expand.
func (c ConversationThreadPostAttachmentClient) ListConversationThreadPostAttachments(ctx context.Context, id stable.GroupIdConversationIdThreadIdPostId, options ListConversationThreadPostAttachmentsOperationOptions) (result ListConversationThreadPostAttachmentsOperationResponse, err error) {
...
func (c ConversationThreadPostAttachmentClient) ListConversationThreadPostAttachmentsComplete(ctx context.Context, id stable.GroupIdConversationIdThreadIdPostId, options ListConversationThreadPostAttachmentsOperationOptions) (ListConversationThreadPostAttachmentsCompleteResult, error) {
