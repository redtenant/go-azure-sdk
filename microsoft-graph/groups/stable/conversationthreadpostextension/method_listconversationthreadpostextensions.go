...
func (c ConversationThreadPostExtensionClient) ListConversationThreadPostExtensions(ctx context.Context, id stable.GroupIdConversationIdThreadIdPostId, options ListConversationThreadPostExtensionsOperationOptions) (result ListConversationThreadPostExtensionsOperationResponse, err error) {
...
func (c ConversationThreadPostExtensionClient) ListConversationThreadPostExtensionsComplete(ctx context.Context, id stable.GroupIdConversationIdThreadIdPostId, options ListConversationThreadPostExtensionsOperationOptions) (ListConversationThreadPostExtensionsCompleteResult, error) {
