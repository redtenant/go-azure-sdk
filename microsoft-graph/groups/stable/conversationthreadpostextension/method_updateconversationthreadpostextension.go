...
type UpdateConversationThreadPostExtensionOperationResponse struct {
...
func (c ConversationThreadPostExtensionClient) UpdateConversationThreadPostExtension(ctx context.Context, id stable.GroupIdConversationIdThreadIdPostIdExtensionId, input stable.Extension, options UpdateConversationThreadPostExtensionOperationOptions) (result UpdateConversationThreadPostExtensionOperationResponse, err error) {
