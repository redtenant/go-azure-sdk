...
func DefaultGetConversationThreadPostInReplyToOperationOptions() GetConversationThreadPostInReplyToOperationOptions {
	return GetConversationThreadPostInReplyToOperationOptions{}
}
...
// GetConversationThreadPostInReplyTo - Get inReplyTo from groups. Read-only. Supports $expand.
func (c ConversationThreadPostInReplyToClient) GetConversationThreadPostInReplyTo(ctx context.Context, id stable.GroupIdConversationIdThreadIdPostId, options GetConversationThreadPostInReplyToOperationOptions) (result GetConversationThreadPostInReplyToOperationResponse, err error) {
	opts := client.RequestOptions{
		...
		Path:          fmt.Sprintf("%s/inReplyTo", id.ID()),
