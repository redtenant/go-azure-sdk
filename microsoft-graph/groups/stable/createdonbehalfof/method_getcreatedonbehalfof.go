...
// This property isn't set if the user is an administrator. Read-only.
func (c CreatedOnBehalfOfClient) GetCreatedOnBehalfOf(ctx context.Context, id stable.GroupId, options GetCreatedOnBehalfOfOperationOptions) (result GetCreatedOnBehalfOfOperationResponse, err error) {
