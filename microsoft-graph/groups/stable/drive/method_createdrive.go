...
// CreateDrive - Create new navigation property to drives for groups
func (c DriveClient) CreateDrive(ctx context.Context, id stable.GroupId, input stable.Drive, options CreateDriveOperationOptions) (result CreateDriveOperationResponse, err error) {
