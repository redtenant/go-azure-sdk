...
// CreateDriveBundle - Create new navigation property to bundles for groups
func (c DriveBundleClient) CreateDriveBundle(ctx context.Context, id stable.GroupIdDriveId, input stable.DriveItem, options CreateDriveBundleOperationOptions) (result CreateDriveBundleOperationResponse, err error) {
