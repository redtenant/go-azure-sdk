...
func DefaultGetDriveBundleOperationOptions() GetDriveBundleOperationOptions {
	return GetDriveBundleOperationOptions{}
}
...
// GetDriveBundle - Get bundles from groups. Collection of bundles (albums and multi-select-shared sets of items). Only
// in personal OneDrive.
func (c DriveBundleClient) GetDriveBundle(ctx context.Context, id stable.GroupIdDriveIdBundleId, options GetDriveBundleOperationOptions) (result GetDriveBundleOperationResponse, err error) {
