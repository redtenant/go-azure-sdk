...
func (c DriveBundleClient) GetDriveBundlesCount(ctx context.Context, id stable.GroupIdDriveId, options GetDriveBundlesCountOperationOptions) (result GetDriveBundlesCountOperationResponse, err error) {
