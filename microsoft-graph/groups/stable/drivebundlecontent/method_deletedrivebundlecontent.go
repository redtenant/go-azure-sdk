...
// DeleteDriveBundleContent - Delete content for the navigation property bundles in groups. The content stream, if the
// item represents a file.
func (c DriveBundleContentClient) DeleteDriveBundleContent(ctx context.Context, id stable.GroupIdDriveIdBundleId, options DeleteDriveBundleContentOperationOptions) (result DeleteDriveBundleContentOperationResponse, err error) {
