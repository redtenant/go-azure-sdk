...
// GetDriveFollowing - Get following from groups. The list of items the user is following. Only in OneDrive for
// Business.
func (c DriveFollowingClient) GetDriveFollowing(ctx context.Context, id stable.GroupIdDriveIdFollowingId, options GetDriveFollowingOperationOptions) (result GetDriveFollowingOperationResponse, err error) {
