...
func (c DriveFollowingClient) GetDriveFollowingCount(ctx context.Context, id stable.GroupIdDriveId, options GetDriveFollowingCountOperationOptions) (result GetDriveFollowingCountOperationResponse, err error) {
