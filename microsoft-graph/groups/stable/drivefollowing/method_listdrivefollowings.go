...
// Business.
func (c DriveFollowingClient) ListDriveFollowings(ctx context.Context, id stable.GroupIdDriveId, options ListDriveFollowingsOperationOptions) (result ListDriveFollowingsOperationResponse, err error) {
...
func (c DriveFollowingClient) ListDriveFollowingsComplete(ctx context.Context, id stable.GroupIdDriveId, options ListDriveFollowingsOperationOptions) (ListDriveFollowingsCompleteResult, error) {
