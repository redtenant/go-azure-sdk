...
func (c DriveItemClient) CreateDriveItem(ctx context.Context, id stable.GroupIdDriveId, input stable.DriveItem, options CreateDriveItemOperationOptions) (result CreateDriveItemOperationResponse, err error) {
