...
func (c DriveItemClient) CreateDriveItemLink(ctx context.Context, id stable.GroupIdDriveIdItemId, input CreateDriveItemLinkRequest, options CreateDriveItemLinkOperationOptions) (result CreateDriveItemLinkOperationResponse, err error) {
