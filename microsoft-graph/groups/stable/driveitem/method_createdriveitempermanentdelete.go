...
func (c DriveItemClient) CreateDriveItemPermanentDelete(ctx context.Context, id stable.GroupIdDriveIdItemId, options CreateDriveItemPermanentDeleteOperationOptions) (result CreateDriveItemPermanentDeleteOperationResponse, err error) {
