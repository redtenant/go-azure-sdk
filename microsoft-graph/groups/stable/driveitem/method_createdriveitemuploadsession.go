...
func (c DriveItemClient) CreateDriveItemUploadSession(ctx context.Context, id stable.GroupIdDriveIdItemId, input CreateDriveItemUploadSessionRequest, options CreateDriveItemUploadSessionOperationOptions) (result CreateDriveItemUploadSessionOperationResponse, err error) {
