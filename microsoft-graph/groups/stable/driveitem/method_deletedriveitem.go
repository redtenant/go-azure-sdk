...
func (c DriveItemClient) DeleteDriveItem(ctx context.Context, id stable.GroupIdDriveIdItemId, options DeleteDriveItemOperationOptions) (result DeleteDriveItemOperationResponse, err error) {
