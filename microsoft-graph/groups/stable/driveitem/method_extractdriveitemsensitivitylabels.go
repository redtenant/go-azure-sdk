...
func (c DriveItemClient) ExtractDriveItemSensitivityLabels(ctx context.Context, id stable.GroupIdDriveIdItemId, options ExtractDriveItemSensitivityLabelsOperationOptions) (result ExtractDriveItemSensitivityLabelsOperationResponse, err error) {
