...
func (c DriveItemClient) GetDriveItemsCount(ctx context.Context, id stable.GroupIdDriveId, options GetDriveItemsCountOperationOptions) (result GetDriveItemsCountOperationResponse, err error) {
