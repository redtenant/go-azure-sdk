...
func (c DriveItemClient) PreviewDriveItem(ctx context.Context, id stable.GroupIdDriveIdItemId, input PreviewDriveItemRequest, options PreviewDriveItemOperationOptions) (result PreviewDriveItemOperationResponse, err error) {
