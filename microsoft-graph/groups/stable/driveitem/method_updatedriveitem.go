...
func (c DriveItemClient) UpdateDriveItem(ctx context.Context, id stable.GroupIdDriveIdItemId, input stable.DriveItem, options UpdateDriveItemOperationOptions) (result UpdateDriveItemOperationResponse, err error) {
