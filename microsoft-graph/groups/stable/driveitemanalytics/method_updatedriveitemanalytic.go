...
func (c DriveItemAnalyticsClient) UpdateDriveItemAnalytic(ctx context.Context, id stable.GroupIdDriveIdItemId, input stable.ItemAnalytics, options UpdateDriveItemAnalyticOperationOptions) (result UpdateDriveItemAnalyticOperationResponse, err error) {
