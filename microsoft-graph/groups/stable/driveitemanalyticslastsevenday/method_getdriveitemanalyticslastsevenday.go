...
func (c DriveItemAnalyticsLastSevenDayClient) GetDriveItemAnalyticsLastSevenDay(ctx context.Context, id stable.GroupIdDriveIdItemId, options GetDriveItemAnalyticsLastSevenDayOperationOptions) (result GetDriveItemAnalyticsLastSevenDayOperationResponse, err error) {
