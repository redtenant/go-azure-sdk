...
// DeleteDriveItemChildContent - Delete content for the navigation property children in groups. The content stream, if
// the item represents a file.
func (c DriveItemChildContentClient) DeleteDriveItemChildContent(ctx context.Context, id stable.GroupIdDriveIdItemIdChildId, options DeleteDriveItemChildContentOperationOptions) (result DeleteDriveItemChildContentOperationResponse, err error) {
