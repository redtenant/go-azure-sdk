...
func DefaultSetDriveItemChildContentOperationOptions() SetDriveItemChildContentOperationOptions {
	return SetDriveItemChildContentOperationOptions{}
}
...
// SetDriveItemChildContent - Update content for the navigation property children in groups. The content stream, if the
// item represents a file.
func (c DriveItemChildContentClient) SetDriveItemChildContent(ctx context.Context, id stable.GroupIdDriveIdItemIdChildId, input []byte, options SetDriveItemChildContentOperationOptions) (result SetDriveItemChildContentOperationResponse, err error) {
