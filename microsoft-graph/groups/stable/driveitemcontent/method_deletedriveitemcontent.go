...
// DeleteDriveItemContent - Delete content for the navigation property items in groups. The content stream, if the item
// represents a file.
func (c DriveItemContentClient) DeleteDriveItemContent(ctx context.Context, id stable.GroupIdDriveIdItemId, options DeleteDriveItemContentOperationOptions) (result DeleteDriveItemContentOperationResponse, err error) {
