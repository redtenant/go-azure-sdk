...
// GetDriveItemContent - Get content for the navigation property items from groups. The content stream, if the item
// represents a file.
func (c DriveItemContentClient) GetDriveItemContent(ctx context.Context, id stable.GroupIdDriveIdItemId, options GetDriveItemContentOperationOptions) (result GetDriveItemContentOperationResponse, err error) {
