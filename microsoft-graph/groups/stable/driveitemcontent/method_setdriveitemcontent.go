...
// SetDriveItemContent - Update content for the navigation property items in groups. The content stream, if the item
// represents a file.
func (c DriveItemContentClient) SetDriveItemContent(ctx context.Context, id stable.GroupIdDriveIdItemId, input []byte, options SetDriveItemContentOperationOptions) (result SetDriveItemContentOperationResponse, err error) {
