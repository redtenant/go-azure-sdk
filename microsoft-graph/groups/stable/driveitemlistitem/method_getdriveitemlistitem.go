...
func DefaultGetDriveItemListItemOperationOptions() GetDriveItemListItemOperationOptions {
	return GetDriveItemListItemOperationOptions{}
}
...
// GetDriveItemListItem - Get listItem from groups. For drives in SharePoint, the associated document library list item.
// Read-only. Nullable.
func (c DriveItemListItemClient) GetDriveItemListItem(ctx context.Context, id stable.GroupIdDriveIdItemId, options GetDriveItemListItemOperationOptions) (result GetDriveItemListItemOperationResponse, err error) {
