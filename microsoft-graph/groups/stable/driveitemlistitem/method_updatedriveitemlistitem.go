...
// UpdateDriveItemListItem - Update the navigation property listItem in groups
func (c DriveItemListItemClient) UpdateDriveItemListItem(ctx context.Context, id stable.GroupIdDriveIdItemId, input stable.ListItem, options UpdateDriveItemListItemOperationOptions) (result UpdateDriveItemListItemOperationResponse, err error) {
