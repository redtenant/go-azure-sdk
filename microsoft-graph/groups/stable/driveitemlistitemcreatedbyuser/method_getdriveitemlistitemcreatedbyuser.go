...
// GetDriveItemListItemCreatedByUser - Get createdByUser from groups. Identity of the user who created the item.
// Read-only.
func (c DriveItemListItemCreatedByUserClient) GetDriveItemListItemCreatedByUser(ctx context.Context, id stable.GroupIdDriveIdItemId, options GetDriveItemListItemCreatedByUserOperationOptions) (result GetDriveItemListItemCreatedByUserOperationResponse, err error) {
