...
func (c DriveItemListItemCreatedByUserMailboxSettingClient) GetDriveItemListItemCreatedByUserMailboxSetting(ctx context.Context, id stable.GroupIdDriveIdItemId, options GetDriveItemListItemCreatedByUserMailboxSettingOperationOptions) (result GetDriveItemListItemCreatedByUserMailboxSettingOperationResponse, err error) {
