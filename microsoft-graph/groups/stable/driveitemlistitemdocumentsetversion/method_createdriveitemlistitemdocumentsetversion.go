...
func (c DriveItemListItemDocumentSetVersionClient) CreateDriveItemListItemDocumentSetVersion(ctx context.Context, id stable.GroupIdDriveIdItemId, input stable.DocumentSetVersion, options CreateDriveItemListItemDocumentSetVersionOperationOptions) (result CreateDriveItemListItemDocumentSetVersionOperationResponse, err error) {
