...
func (c DriveItemListItemDocumentSetVersionClient) RestoreDriveItemListItemDocumentSetVersion(ctx context.Context, id stable.GroupIdDriveIdItemIdListItemDocumentSetVersionId, options RestoreDriveItemListItemDocumentSetVersionOperationOptions) (result RestoreDriveItemListItemDocumentSetVersionOperationResponse, err error) {
