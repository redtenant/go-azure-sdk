...
// UpdateDriveItemListItemDocumentSetVersionField - Update the navigation property fields in groups
func (c DriveItemListItemDocumentSetVersionFieldClient) UpdateDriveItemListItemDocumentSetVersionField(ctx context.Context, id stable.GroupIdDriveIdItemIdListItemDocumentSetVersionId, input stable.FieldValueSet, options UpdateDriveItemListItemDocumentSetVersionFieldOperationOptions) (result UpdateDriveItemListItemDocumentSetVersionFieldOperationResponse, err error) {
