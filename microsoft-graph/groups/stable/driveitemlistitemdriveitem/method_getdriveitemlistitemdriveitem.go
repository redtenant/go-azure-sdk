...
// GetDriveItemListItemDriveItem - Get driveItem from groups. For document libraries, the driveItem relationship exposes
// the listItem as a driveItem
func (c DriveItemListItemDriveItemClient) GetDriveItemListItemDriveItem(ctx context.Context, id stable.GroupIdDriveIdItemId, options GetDriveItemListItemDriveItemOperationOptions) (result GetDriveItemListItemDriveItemOperationResponse, err error) {
