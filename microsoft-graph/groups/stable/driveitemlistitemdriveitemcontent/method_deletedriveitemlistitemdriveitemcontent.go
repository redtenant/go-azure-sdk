...
// DeleteDriveItemListItemDriveItemContent - Delete content for the navigation property driveItem in groups. The content
// stream, if the item represents a file.
func (c DriveItemListItemDriveItemContentClient) DeleteDriveItemListItemDriveItemContent(ctx context.Context, id stable.GroupIdDriveIdItemId, options DeleteDriveItemListItemDriveItemContentOperationOptions) (result DeleteDriveItemListItemDriveItemContentOperationResponse, err error) {
