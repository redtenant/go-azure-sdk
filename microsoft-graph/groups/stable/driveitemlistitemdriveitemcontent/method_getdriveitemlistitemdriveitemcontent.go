...
// GetDriveItemListItemDriveItemContent - Get content for the navigation property driveItem from groups. The content
// stream, if the item represents a file.
func (c DriveItemListItemDriveItemContentClient) GetDriveItemListItemDriveItemContent(ctx context.Context, id stable.GroupIdDriveIdItemId, options GetDriveItemListItemDriveItemContentOperationOptions) (result GetDriveItemListItemDriveItemContentOperationResponse, err error) {
