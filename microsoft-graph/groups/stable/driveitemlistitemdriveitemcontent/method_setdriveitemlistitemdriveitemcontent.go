...
// SetDriveItemListItemDriveItemContent - Update content for the navigation property driveItem in groups. The content
// stream, if the item represents a file.
func (c DriveItemListItemDriveItemContentClient) SetDriveItemListItemDriveItemContent(ctx context.Context, id stable.GroupIdDriveIdItemId, input []byte, options SetDriveItemListItemDriveItemContentOperationOptions) (result SetDriveItemListItemDriveItemContentOperationResponse, err error) {
