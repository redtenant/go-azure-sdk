...
func (c DriveItemListItemFieldClient) DeleteDriveItemListItemField(ctx context.Context, id stable.GroupIdDriveIdItemId, options DeleteDriveItemListItemFieldOperationOptions) (result DeleteDriveItemListItemFieldOperationResponse, err error) {
