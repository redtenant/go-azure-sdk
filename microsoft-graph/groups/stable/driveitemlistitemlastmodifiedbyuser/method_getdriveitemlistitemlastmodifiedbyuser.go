...
// GetDriveItemListItemLastModifiedByUser - Get lastModifiedByUser from groups. Identity of the user who last modified
// the item. Read-only.
func (c DriveItemListItemLastModifiedByUserClient) GetDriveItemListItemLastModifiedByUser(ctx context.Context, id stable.GroupIdDriveIdItemId, options GetDriveItemListItemLastModifiedByUserOperationOptions) (result GetDriveItemListItemLastModifiedByUserOperationResponse, err error) {
