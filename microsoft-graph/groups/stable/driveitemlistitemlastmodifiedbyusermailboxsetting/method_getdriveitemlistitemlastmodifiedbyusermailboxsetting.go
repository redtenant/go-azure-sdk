...
func (c DriveItemListItemLastModifiedByUserMailboxSettingClient) GetDriveItemListItemLastModifiedByUserMailboxSetting(ctx context.Context, id stable.GroupIdDriveIdItemId, options GetDriveItemListItemLastModifiedByUserMailboxSettingOperationOptions) (result GetDriveItemListItemLastModifiedByUserMailboxSettingOperationResponse, err error) {
