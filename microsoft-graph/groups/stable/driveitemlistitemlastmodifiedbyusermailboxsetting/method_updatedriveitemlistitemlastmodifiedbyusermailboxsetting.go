...
type UpdateDriveItemListItemLastModifiedByUserMailboxSettingOperationResponse struct {
...
func (c DriveItemListItemLastModifiedByUserMailboxSettingClient) UpdateDriveItemListItemLastModifiedByUserMailboxSetting(ctx context.Context, id stable.GroupIdDriveIdItemId, input stable.MailboxSettings, options UpdateDriveItemListItemLastModifiedByUserMailboxSettingOperationOptions) (result UpdateDriveItemListItemLastModifiedByUserMailboxSettingOperationResponse, err error) {
