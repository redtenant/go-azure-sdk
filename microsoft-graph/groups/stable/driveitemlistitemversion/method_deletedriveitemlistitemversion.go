...
func DefaultDeleteDriveItemListItemVersionOperationOptions() DeleteDriveItemListItemVersionOperationOptions {
	return DeleteDriveItemListItemVersionOperationOptions{}
}
...
// DeleteDriveItemListItemVersion - Delete navigation property versions for groups
func (c DriveItemListItemVersionClient) DeleteDriveItemListItemVersion(ctx context.Context, id stable.GroupIdDriveIdItemIdListItemVersionId, options DeleteDriveItemListItemVersionOperationOptions) (result DeleteDriveItemListItemVersionOperationResponse, err error) {
