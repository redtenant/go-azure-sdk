...
func DefaultGetDriveItemListItemVersionOperationOptions() GetDriveItemListItemVersionOperationOptions {
	return GetDriveItemListItemVersionOperationOptions{}
}
...
// GetDriveItemListItemVersion - Get versions from groups. The list of previous versions of the list item.
func (c DriveItemListItemVersionClient) GetDriveItemListItemVersion(ctx context.Context, id stable.GroupIdDriveIdItemIdListItemVersionId, options GetDriveItemListItemVersionOperationOptions) (result GetDriveItemListItemVersionOperationResponse, err error) {
