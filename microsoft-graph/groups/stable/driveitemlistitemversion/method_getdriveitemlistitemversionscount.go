...
func (c DriveItemListItemVersionClient) GetDriveItemListItemVersionsCount(ctx context.Context, id stable.GroupIdDriveIdItemId, options GetDriveItemListItemVersionsCountOperationOptions) (result GetDriveItemListItemVersionsCountOperationResponse, err error) {
