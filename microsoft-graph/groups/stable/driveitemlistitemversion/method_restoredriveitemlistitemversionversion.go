...
func (c DriveItemListItemVersionClient) RestoreDriveItemListItemVersionVersion(ctx context.Context, id stable.GroupIdDriveIdItemIdListItemVersionId, options RestoreDriveItemListItemVersionVersionOperationOptions) (result RestoreDriveItemListItemVersionVersionOperationResponse, err error) {
