...
// DeleteDriveItemListItemVersionField - Delete navigation property fields for groups
func (c DriveItemListItemVersionFieldClient) DeleteDriveItemListItemVersionField(ctx context.Context, id stable.GroupIdDriveIdItemIdListItemVersionId, options DeleteDriveItemListItemVersionFieldOperationOptions) (result DeleteDriveItemListItemVersionFieldOperationResponse, err error) {
