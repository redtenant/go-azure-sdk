...
// GetDriveItemListItemVersionField - Get fields from groups. A collection of the fields and values for this version of
// the list item.
func (c DriveItemListItemVersionFieldClient) GetDriveItemListItemVersionField(ctx context.Context, id stable.GroupIdDriveIdItemIdListItemVersionId, options GetDriveItemListItemVersionFieldOperationOptions) (result GetDriveItemListItemVersionFieldOperationResponse, err error) {
