...
func (c DriveItemPermissionClient) DeleteDriveItemPermission(ctx context.Context, id stable.GroupIdDriveIdItemIdPermissionId, options DeleteDriveItemPermissionOperationOptions) (result DeleteDriveItemPermissionOperationResponse, err error) {
