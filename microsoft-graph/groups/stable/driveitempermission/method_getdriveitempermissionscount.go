...
func (c DriveItemPermissionClient) GetDriveItemPermissionsCount(ctx context.Context, id stable.GroupIdDriveIdItemId, options GetDriveItemPermissionsCountOperationOptions) (result GetDriveItemPermissionsCountOperationResponse, err error) {
