...
func (c DriveItemPermissionClient) ListDriveItemPermissionGrants(ctx context.Context, id stable.GroupIdDriveIdItemIdPermissionId, input ListDriveItemPermissionGrantsRequest, options ListDriveItemPermissionGrantsOperationOptions) (result ListDriveItemPermissionGrantsOperationResponse, err error) {
...
func (c DriveItemPermissionClient) ListDriveItemPermissionGrantsComplete(ctx context.Context, id stable.GroupIdDriveIdItemIdPermissionId, input ListDriveItemPermissionGrantsRequest, options ListDriveItemPermissionGrantsOperationOptions) (ListDriveItemPermissionGrantsCompleteResult, error) {
