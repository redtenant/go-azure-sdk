...
func (c DriveItemPermissionClient) ListDriveItemPermissions(ctx context.Context, id stable.GroupIdDriveIdItemId, options ListDriveItemPermissionsOperationOptions) (result ListDriveItemPermissionsOperationResponse, err error) {
...
func (c DriveItemPermissionClient) ListDriveItemPermissionsComplete(ctx context.Context, id stable.GroupIdDriveIdItemId, options ListDriveItemPermissionsOperationOptions) (ListDriveItemPermissionsCompleteResult, error) {
...
func (c DriveItemPermissionClient) ListDriveItemPermissionsCompleteMatchingPredicate(ctx context.Context, id stable.GroupIdDriveIdItemId, options ListDriveItemPermissionsOperationOptions, predicate PermissionOperationPredicate) (result ListDriveItemPermissionsCompleteResult, err error) {
