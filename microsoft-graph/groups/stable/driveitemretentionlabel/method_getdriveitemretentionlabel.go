...
// GetDriveItemRetentionLabel - Get retentionLabel from groups. Information about retention label and settings enforced
// on the driveItem. Read-write.
func (c DriveItemRetentionLabelClient) GetDriveItemRetentionLabel(ctx context.Context, id stable.GroupIdDriveIdItemId, options GetDriveItemRetentionLabelOperationOptions) (result GetDriveItemRetentionLabelOperationResponse, err error) {
