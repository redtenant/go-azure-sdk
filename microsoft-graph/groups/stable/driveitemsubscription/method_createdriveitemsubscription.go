...
// CreateDriveItemSubscription - Create new navigation property to subscriptions for groups
func (c DriveItemSubscriptionClient) CreateDriveItemSubscription(ctx context.Context, id stable.GroupIdDriveIdItemId, input stable.Subscription, options CreateDriveItemSubscriptionOperationOptions) (result CreateDriveItemSubscriptionOperationResponse, err error) {
