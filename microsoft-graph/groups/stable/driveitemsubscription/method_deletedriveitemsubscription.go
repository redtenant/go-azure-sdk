...
// DeleteDriveItemSubscription - Delete navigation property subscriptions for groups
func (c DriveItemSubscriptionClient) DeleteDriveItemSubscription(ctx context.Context, id stable.GroupIdDriveIdItemIdSubscriptionId, options DeleteDriveItemSubscriptionOperationOptions) (result DeleteDriveItemSubscriptionOperationResponse, err error) {
