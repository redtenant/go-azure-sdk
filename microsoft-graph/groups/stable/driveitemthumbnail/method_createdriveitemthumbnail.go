...
// CreateDriveItemThumbnail - Create new navigation property to thumbnails for groups
func (c DriveItemThumbnailClient) CreateDriveItemThumbnail(ctx context.Context, id stable.GroupIdDriveIdItemId, input stable.ThumbnailSet, options CreateDriveItemThumbnailOperationOptions) (result CreateDriveItemThumbnailOperationResponse, err error) {
