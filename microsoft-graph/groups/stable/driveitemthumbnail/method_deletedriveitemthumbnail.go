...
// DeleteDriveItemThumbnail - Delete navigation property thumbnails for groups
func (c DriveItemThumbnailClient) DeleteDriveItemThumbnail(ctx context.Context, id stable.GroupIdDriveIdItemIdThumbnailId, options DeleteDriveItemThumbnailOperationOptions) (result DeleteDriveItemThumbnailOperationResponse, err error) {
