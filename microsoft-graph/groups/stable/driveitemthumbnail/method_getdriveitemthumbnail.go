...
func (c DriveItemThumbnailClient) GetDriveItemThumbnail(ctx context.Context, id stable.GroupIdDriveIdItemIdThumbnailId, options GetDriveItemThumbnailOperationOptions) (result GetDriveItemThumbnailOperationResponse, err error) {
