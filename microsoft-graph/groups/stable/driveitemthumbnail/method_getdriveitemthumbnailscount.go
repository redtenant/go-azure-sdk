...
func (c DriveItemThumbnailClient) GetDriveItemThumbnailsCount(ctx context.Context, id stable.GroupIdDriveIdItemId, options GetDriveItemThumbnailsCountOperationOptions) (result GetDriveItemThumbnailsCountOperationResponse, err error) {
