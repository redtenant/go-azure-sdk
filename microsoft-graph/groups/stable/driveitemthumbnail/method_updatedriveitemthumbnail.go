...
// UpdateDriveItemThumbnail - Update the navigation property thumbnails in groups
func (c DriveItemThumbnailClient) UpdateDriveItemThumbnail(ctx context.Context, id stable.GroupIdDriveIdItemIdThumbnailId, input stable.ThumbnailSet, options UpdateDriveItemThumbnailOperationOptions) (result UpdateDriveItemThumbnailOperationResponse, err error) {
