...
// GetDriveLastModifiedByUser - Get lastModifiedByUser from groups. Identity of the user who last modified the item.
// Read-only.
func (c DriveLastModifiedByUserClient) GetDriveLastModifiedByUser(ctx context.Context, id stable.GroupIdDriveId, options GetDriveLastModifiedByUserOperationOptions) (result GetDriveLastModifiedByUserOperationResponse, err error) {
