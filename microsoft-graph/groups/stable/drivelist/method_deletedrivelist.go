...
func DefaultDeleteDriveListOperationOptions() DeleteDriveListOperationOptions {
	return DeleteDriveListOperationOptions{}
}
...
// DeleteDriveList - Delete navigation property list for groups
func (c DriveListClient) DeleteDriveList(ctx context.Context, id stable.GroupIdDriveId, options DeleteDriveListOperationOptions) (result DeleteDriveListOperationResponse, err error) {
