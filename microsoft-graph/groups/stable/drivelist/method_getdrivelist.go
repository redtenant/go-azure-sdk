...
// Nullable.
func (c DriveListClient) GetDriveList(ctx context.Context, id stable.GroupIdDriveId, options GetDriveListOperationOptions) (result GetDriveListOperationResponse, err error) {
