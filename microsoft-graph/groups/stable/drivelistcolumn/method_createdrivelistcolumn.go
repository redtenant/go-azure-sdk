...
// CreateDriveListColumn - Create new navigation property to columns for groups
func (c DriveListColumnClient) CreateDriveListColumn(ctx context.Context, id stable.GroupIdDriveId, input stable.ColumnDefinition, options CreateDriveListColumnOperationOptions) (result CreateDriveListColumnOperationResponse, err error) {
