...
func DefaultDeleteDriveListColumnOperationOptions() DeleteDriveListColumnOperationOptions {
	return DeleteDriveListColumnOperationOptions{}
}
...
// DeleteDriveListColumn - Delete navigation property columns for groups
func (c DriveListColumnClient) DeleteDriveListColumn(ctx context.Context, id stable.GroupIdDriveIdListColumnId, options DeleteDriveListColumnOperationOptions) (result DeleteDriveListColumnOperationResponse, err error) {
