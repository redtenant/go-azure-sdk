...
// GetDriveListColumn - Get columns from groups. The collection of field definitions for this list.
func (c DriveListColumnClient) GetDriveListColumn(ctx context.Context, id stable.GroupIdDriveIdListColumnId, options GetDriveListColumnOperationOptions) (result GetDriveListColumnOperationResponse, err error) {
