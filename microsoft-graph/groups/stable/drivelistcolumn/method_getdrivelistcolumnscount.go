...
func (c DriveListColumnClient) GetDriveListColumnsCount(ctx context.Context, id stable.GroupIdDriveId, options GetDriveListColumnsCountOperationOptions) (result GetDriveListColumnsCountOperationResponse, err error) {
