...
func (c DriveListContentTypeClient) AddDriveListContentTypesCopyFromHub(ctx context.Context, id stable.GroupIdDriveId, input AddDriveListContentTypesCopyFromHubRequest, options AddDriveListContentTypesCopyFromHubOperationOptions) (result AddDriveListContentTypesCopyFromHubOperationResponse, err error) {
