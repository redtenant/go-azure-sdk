...
// operation.
func (c DriveListContentTypeClient) CopyDriveListContentTypeToDefaultContentLocation(ctx context.Context, id stable.GroupIdDriveIdListContentTypeId, input CopyDriveListContentTypeToDefaultContentLocationRequest, options CopyDriveListContentTypeToDefaultContentLocationOperationOptions) (result CopyDriveListContentTypeToDefaultContentLocationOperationResponse, err error) {
