...
// CreateDriveListContentType - Create new navigation property to contentTypes for groups
func (c DriveListContentTypeClient) CreateDriveListContentType(ctx context.Context, id stable.GroupIdDriveId, input stable.ContentType, options CreateDriveListContentTypeOperationOptions) (result CreateDriveListContentTypeOperationResponse, err error) {
