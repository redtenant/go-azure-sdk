...
func (c DriveListContentTypeClient) CreateDriveListContentTypeAssociateWithHubSite(ctx context.Context, id stable.GroupIdDriveIdListContentTypeId, input CreateDriveListContentTypeAssociateWithHubSiteRequest, options CreateDriveListContentTypeAssociateWithHubSiteOperationOptions) (result CreateDriveListContentTypeAssociateWithHubSiteOperationResponse, err error) {
