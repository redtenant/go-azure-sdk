...
// CreateDriveListContentTypePublish - Invoke action publish. Publishes a contentType present in the content type hub
// site.
func (c DriveListContentTypeClient) CreateDriveListContentTypePublish(ctx context.Context, id stable.GroupIdDriveIdListContentTypeId, options CreateDriveListContentTypePublishOperationOptions) (result CreateDriveListContentTypePublishOperationResponse, err error) {
