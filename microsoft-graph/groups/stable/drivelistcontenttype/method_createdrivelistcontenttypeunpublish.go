...
func (c DriveListContentTypeClient) CreateDriveListContentTypeUnpublish(ctx context.Context, id stable.GroupIdDriveIdListContentTypeId, options CreateDriveListContentTypeUnpublishOperationOptions) (result CreateDriveListContentTypeUnpublishOperationResponse, err error) {
