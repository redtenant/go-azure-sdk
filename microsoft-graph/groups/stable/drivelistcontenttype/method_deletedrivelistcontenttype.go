...
// DeleteDriveListContentType - Delete navigation property contentTypes for groups
func (c DriveListContentTypeClient) DeleteDriveListContentType(ctx context.Context, id stable.GroupIdDriveIdListContentTypeId, options DeleteDriveListContentTypeOperationOptions) (result DeleteDriveListContentTypeOperationResponse, err error) {
