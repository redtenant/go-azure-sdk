...
func (c DriveListContentTypeClient) UpdateDriveListContentType(ctx context.Context, id stable.GroupIdDriveIdListContentTypeId, input stable.ContentType, options UpdateDriveListContentTypeOperationOptions) (result UpdateDriveListContentTypeOperationResponse, err error) {
