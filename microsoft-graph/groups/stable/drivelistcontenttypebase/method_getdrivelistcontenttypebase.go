...
// GetDriveListContentTypeBase - Get base from groups. Parent contentType from which this content type is derived.
func (c DriveListContentTypeBaseClient) GetDriveListContentTypeBase(ctx context.Context, id stable.GroupIdDriveIdListContentTypeId, options GetDriveListContentTypeBaseOperationOptions) (result GetDriveListContentTypeBaseOperationResponse, err error) {
