...
func (c DriveListContentTypeBaseTypeClient) GetDriveListContentTypeBaseTypesCount(ctx context.Context, id stable.GroupIdDriveIdListContentTypeId, options GetDriveListContentTypeBaseTypesCountOperationOptions) (result GetDriveListContentTypeBaseTypesCountOperationResponse, err error) {
