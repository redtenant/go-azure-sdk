...
// ListDriveListContentTypeBaseTypes - Get baseTypes from groups. The collection of content types that are ancestors of
// this content type.
func (c DriveListContentTypeBaseTypeClient) ListDriveListContentTypeBaseTypes(ctx context.Context, id stable.GroupIdDriveIdListContentTypeId, options ListDriveListContentTypeBaseTypesOperationOptions) (result ListDriveListContentTypeBaseTypesOperationResponse, err error) {
...
func (c DriveListContentTypeBaseTypeClient) ListDriveListContentTypeBaseTypesComplete(ctx context.Context, id stable.GroupIdDriveIdListContentTypeId, options ListDriveListContentTypeBaseTypesOperationOptions) (ListDriveListContentTypeBaseTypesCompleteResult, error) {
...
func (c DriveListContentTypeBaseTypeClient) ListDriveListContentTypeBaseTypesCompleteMatchingPredicate(ctx context.Context, id stable.GroupIdDriveIdListContentTypeId, options ListDriveListContentTypeBaseTypesOperationOptions, predicate ContentTypeOperationPredicate) (result ListDriveListContentTypeBaseTypesCompleteResult, err error) {
