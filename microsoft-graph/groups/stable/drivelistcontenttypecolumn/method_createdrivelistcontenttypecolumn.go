...
func (c DriveListContentTypeColumnClient) CreateDriveListContentTypeColumn(ctx context.Context, id stable.GroupIdDriveIdListContentTypeId, input stable.ColumnDefinition, options CreateDriveListContentTypeColumnOperationOptions) (result CreateDriveListContentTypeColumnOperationResponse, err error) {
