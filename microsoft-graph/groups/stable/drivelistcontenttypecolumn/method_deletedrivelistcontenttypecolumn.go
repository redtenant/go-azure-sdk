...
// DeleteDriveListContentTypeColumn - Delete navigation property columns for groups
func (c DriveListContentTypeColumnClient) DeleteDriveListContentTypeColumn(ctx context.Context, id stable.GroupIdDriveIdListContentTypeIdColumnId, options DeleteDriveListContentTypeColumnOperationOptions) (result DeleteDriveListContentTypeColumnOperationResponse, err error) {
