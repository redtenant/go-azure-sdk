...
// GetDriveListContentTypeColumn - Get columns from groups. The collection of column definitions for this content type.
func (c DriveListContentTypeColumnClient) GetDriveListContentTypeColumn(ctx context.Context, id stable.GroupIdDriveIdListContentTypeIdColumnId, options GetDriveListContentTypeColumnOperationOptions) (result GetDriveListContentTypeColumnOperationResponse, err error) {
