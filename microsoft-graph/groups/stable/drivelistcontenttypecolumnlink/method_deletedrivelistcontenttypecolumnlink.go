...
func (c DriveListContentTypeColumnLinkClient) DeleteDriveListContentTypeColumnLink(ctx context.Context, id stable.GroupIdDriveIdListContentTypeIdColumnLinkId, options DeleteDriveListContentTypeColumnLinkOperationOptions) (result DeleteDriveListContentTypeColumnLinkOperationResponse, err error) {
