...
func (c DriveListContentTypeColumnLinkClient) GetDriveListContentTypeColumnLinksCount(ctx context.Context, id stable.GroupIdDriveIdListContentTypeId, options GetDriveListContentTypeColumnLinksCountOperationOptions) (result GetDriveListContentTypeColumnLinksCountOperationResponse, err error) {
