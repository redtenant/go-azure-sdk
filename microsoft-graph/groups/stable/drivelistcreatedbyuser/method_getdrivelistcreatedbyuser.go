...
// GetDriveListCreatedByUser - Get createdByUser from groups. Identity of the user who created the item. Read-only.
func (c DriveListCreatedByUserClient) GetDriveListCreatedByUser(ctx context.Context, id stable.GroupIdDriveId, options GetDriveListCreatedByUserOperationOptions) (result GetDriveListCreatedByUserOperationResponse, err error) {
