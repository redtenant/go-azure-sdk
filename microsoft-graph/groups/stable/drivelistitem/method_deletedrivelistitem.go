...
func DefaultDeleteDriveListItemOperationOptions() DeleteDriveListItemOperationOptions {
	return DeleteDriveListItemOperationOptions{}
}
...
// DeleteDriveListItem - Delete navigation property items for groups
func (c DriveListItemClient) DeleteDriveListItem(ctx context.Context, id stable.GroupIdDriveIdListItemId, options DeleteDriveListItemOperationOptions) (result DeleteDriveListItemOperationResponse, err error) {
