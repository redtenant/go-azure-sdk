...
func DefaultGetDriveListItemOperationOptions() GetDriveListItemOperationOptions {
	return GetDriveListItemOperationOptions{}
}
...
// GetDriveListItem - Get items from groups. All items contained in the list.
func (c DriveListItemClient) GetDriveListItem(ctx context.Context, id stable.GroupIdDriveIdListItemId, options GetDriveListItemOperationOptions) (result GetDriveListItemOperationResponse, err error) {
