...
func (c DriveListItemClient) ListDriveListItems(ctx context.Context, id stable.GroupIdDriveId, options ListDriveListItemsOperationOptions) (result ListDriveListItemsOperationResponse, err error) {
...
func (c DriveListItemClient) ListDriveListItemsComplete(ctx context.Context, id stable.GroupIdDriveId, options ListDriveListItemsOperationOptions) (ListDriveListItemsCompleteResult, error) {
...
func (c DriveListItemClient) ListDriveListItemsCompleteMatchingPredicate(ctx context.Context, id stable.GroupIdDriveId, options ListDriveListItemsOperationOptions, predicate ListItemOperationPredicate) (result ListDriveListItemsCompleteResult, err error) {
