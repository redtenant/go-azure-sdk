...
// UpdateDriveListItem - Update the navigation property items in groups
func (c DriveListItemClient) UpdateDriveListItem(ctx context.Context, id stable.GroupIdDriveIdListItemId, input stable.ListItem, options UpdateDriveListItemOperationOptions) (result UpdateDriveListItemOperationResponse, err error) {
