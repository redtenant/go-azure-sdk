...
// GetDriveListItemCreatedByUser - Get createdByUser from groups. Identity of the user who created the item. Read-only.
func (c DriveListItemCreatedByUserClient) GetDriveListItemCreatedByUser(ctx context.Context, id stable.GroupIdDriveIdListItemId, options GetDriveListItemCreatedByUserOperationOptions) (result GetDriveListItemCreatedByUserOperationResponse, err error) {
