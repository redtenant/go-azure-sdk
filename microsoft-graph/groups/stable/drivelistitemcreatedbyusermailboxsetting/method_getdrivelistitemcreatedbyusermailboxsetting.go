...
func (c DriveListItemCreatedByUserMailboxSettingClient) GetDriveListItemCreatedByUserMailboxSetting(ctx context.Context, id stable.GroupIdDriveIdListItemId, options GetDriveListItemCreatedByUserMailboxSettingOperationOptions) (result GetDriveListItemCreatedByUserMailboxSettingOperationResponse, err error) {
