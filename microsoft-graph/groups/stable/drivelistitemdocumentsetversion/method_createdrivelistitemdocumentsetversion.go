...
func (c DriveListItemDocumentSetVersionClient) CreateDriveListItemDocumentSetVersion(ctx context.Context, id stable.GroupIdDriveIdListItemId, input stable.DocumentSetVersion, options CreateDriveListItemDocumentSetVersionOperationOptions) (result CreateDriveListItemDocumentSetVersionOperationResponse, err error) {
