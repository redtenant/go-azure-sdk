...
func (c DriveListItemDocumentSetVersionClient) DeleteDriveListItemDocumentSetVersion(ctx context.Context, id stable.GroupIdDriveIdListItemIdDocumentSetVersionId, options DeleteDriveListItemDocumentSetVersionOperationOptions) (result DeleteDriveListItemDocumentSetVersionOperationResponse, err error) {
