...
func (c DriveListItemDocumentSetVersionClient) GetDriveListItemDocumentSetVersionsCount(ctx context.Context, id stable.GroupIdDriveIdListItemId, options GetDriveListItemDocumentSetVersionsCountOperationOptions) (result GetDriveListItemDocumentSetVersionsCountOperationResponse, err error) {
