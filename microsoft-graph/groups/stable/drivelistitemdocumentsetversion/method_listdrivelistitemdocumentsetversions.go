...
func DefaultListDriveListItemDocumentSetVersionsOperationOptions() ListDriveListItemDocumentSetVersionsOperationOptions {
	return ListDriveListItemDocumentSetVersionsOperationOptions{}
}
...
// ListDriveListItemDocumentSetVersions - Get documentSetVersions from groups. Version information for a document set
// version created by a user.
func (c DriveListItemDocumentSetVersionClient) ListDriveListItemDocumentSetVersions(ctx context.Context, id stable.GroupIdDriveIdListItemId, options ListDriveListItemDocumentSetVersionsOperationOptions) (result ListDriveListItemDocumentSetVersionsOperationResponse, err error) {
	opts := client.RequestOptions{
		...
		Pager:         &ListDriveListItemDocumentSetVersionsCustomPager{},
...
func (c DriveListItemDocumentSetVersionClient) ListDriveListItemDocumentSetVersionsComplete(ctx context.Context, id stable.GroupIdDriveIdListItemId, options ListDriveListItemDocumentSetVersionsOperationOptions) (ListDriveListItemDocumentSetVersionsCompleteResult, error) {
	return c.ListDriveListItemDocumentSetVersionsCompleteMatchingPredicate(ctx, id, options, DocumentSetVersionOperationPredicate{})
}

// ListDriveListItemDocumentSetVersionsCompleteMatchingPredicate retrieves all the results and then applies the predicate
func (c DriveListItemDocumentSetVersionClient) ListDriveListItemDocumentSetVersionsCompleteMatchingPredicate(ctx context.Context, id stable.GroupIdDriveIdListItemId, options ListDriveListItemDocumentSetVersionsOperationOptions, predicate DocumentSetVersionOperationPredicate) (result ListDriveListItemDocumentSetVersionsCompleteResult, err error) {
	items := make([]stable.DocumentSetVersion, 0)

	resp, err := c.ListDriveListItemDocumentSetVersions(ctx, id, options)
	if err != nil {
	...
	result = ListDriveListItemDocumentSetVersionsCompleteResult{
