...
func (c DriveListItemDocumentSetVersionClient) UpdateDriveListItemDocumentSetVersion(ctx context.Context, id stable.GroupIdDriveIdListItemIdDocumentSetVersionId, input stable.DocumentSetVersion, options UpdateDriveListItemDocumentSetVersionOperationOptions) (result UpdateDriveListItemDocumentSetVersionOperationResponse, err error) {
