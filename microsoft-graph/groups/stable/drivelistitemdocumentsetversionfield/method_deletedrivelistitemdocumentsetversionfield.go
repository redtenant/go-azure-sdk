...
type DeleteDriveListItemDocumentSetVersionFieldOperationResponse struct {
...
func DefaultDeleteDriveListItemDocumentSetVersionFieldOperationOptions() DeleteDriveListItemDocumentSetVersionFieldOperationOptions {
	return DeleteDriveListItemDocumentSetVersionFieldOperationOptions{}
}
...
// DeleteDriveListItemDocumentSetVersionField - Delete navigation property fields for groups
func (c DriveListItemDocumentSetVersionFieldClient) DeleteDriveListItemDocumentSetVersionField(ctx context.Context, id stable.GroupIdDriveIdListItemIdDocumentSetVersionId, options DeleteDriveListItemDocumentSetVersionFieldOperationOptions) (result DeleteDriveListItemDocumentSetVersionFieldOperationResponse, err error) {
