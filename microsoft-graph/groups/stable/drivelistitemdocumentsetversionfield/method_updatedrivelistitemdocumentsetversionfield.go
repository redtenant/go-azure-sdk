...
// UpdateDriveListItemDocumentSetVersionField - Update the navigation property fields in groups
func (c DriveListItemDocumentSetVersionFieldClient) UpdateDriveListItemDocumentSetVersionField(ctx context.Context, id stable.GroupIdDriveIdListItemIdDocumentSetVersionId, input stable.FieldValueSet, options UpdateDriveListItemDocumentSetVersionFieldOperationOptions) (result UpdateDriveListItemDocumentSetVersionFieldOperationResponse, err error) {
