...
func DefaultDeleteDriveListItemDriveItemContentOperationOptions() DeleteDriveListItemDriveItemContentOperationOptions {
	return DeleteDriveListItemDriveItemContentOperationOptions{}
}
...
// DeleteDriveListItemDriveItemContent - Delete content for the navigation property driveItem in groups. The content
// stream, if the item represents a file.
func (c DriveListItemDriveItemContentClient) DeleteDriveListItemDriveItemContent(ctx context.Context, id stable.GroupIdDriveIdListItemId, options DeleteDriveListItemDriveItemContentOperationOptions) (result DeleteDriveListItemDriveItemContentOperationResponse, err error) {
