...
// DeleteDriveListItemField - Delete navigation property fields for groups
func (c DriveListItemFieldClient) DeleteDriveListItemField(ctx context.Context, id stable.GroupIdDriveIdListItemId, options DeleteDriveListItemFieldOperationOptions) (result DeleteDriveListItemFieldOperationResponse, err error) {
