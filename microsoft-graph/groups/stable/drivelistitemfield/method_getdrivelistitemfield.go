...
// GetDriveListItemField - Get fields from groups. The values of the columns set on this list item.
func (c DriveListItemFieldClient) GetDriveListItemField(ctx context.Context, id stable.GroupIdDriveIdListItemId, options GetDriveListItemFieldOperationOptions) (result GetDriveListItemFieldOperationResponse, err error) {
