...
func (c DriveListItemLastModifiedByUserMailboxSettingClient) UpdateDriveListItemLastModifiedByUserMailboxSetting(ctx context.Context, id stable.GroupIdDriveIdListItemId, input stable.MailboxSettings, options UpdateDriveListItemLastModifiedByUserMailboxSettingOperationOptions) (result UpdateDriveListItemLastModifiedByUserMailboxSettingOperationResponse, err error) {
