...
// DeleteDriveListItemVersion - Delete navigation property versions for groups
func (c DriveListItemVersionClient) DeleteDriveListItemVersion(ctx context.Context, id stable.GroupIdDriveIdListItemIdVersionId, options DeleteDriveListItemVersionOperationOptions) (result DeleteDriveListItemVersionOperationResponse, err error) {
