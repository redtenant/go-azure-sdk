...
func DefaultGetDriveListItemVersionOperationOptions() GetDriveListItemVersionOperationOptions {
	return GetDriveListItemVersionOperationOptions{}
}
...
// GetDriveListItemVersion - Get versions from groups. The list of previous versions of the list item.
func (c DriveListItemVersionClient) GetDriveListItemVersion(ctx context.Context, id stable.GroupIdDriveIdListItemIdVersionId, options GetDriveListItemVersionOperationOptions) (result GetDriveListItemVersionOperationResponse, err error) {
