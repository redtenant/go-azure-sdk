...
func DefaultGetDriveListItemVersionsCountOperationOptions() GetDriveListItemVersionsCountOperationOptions {
	return GetDriveListItemVersionsCountOperationOptions{}
}
...
func (c DriveListItemVersionClient) GetDriveListItemVersionsCount(ctx context.Context, id stable.GroupIdDriveIdListItemId, options GetDriveListItemVersionsCountOperationOptions) (result GetDriveListItemVersionsCountOperationResponse, err error) {
