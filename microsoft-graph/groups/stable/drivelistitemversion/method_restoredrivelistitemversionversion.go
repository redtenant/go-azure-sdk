...
// RestoreDriveListItemVersionVersion - Invoke action restoreVersion. Restore a previous version of a ListItem to be the
...
func (c DriveListItemVersionClient) RestoreDriveListItemVersionVersion(ctx context.Context, id stable.GroupIdDriveIdListItemIdVersionId, options RestoreDriveListItemVersionVersionOperationOptions) (result RestoreDriveListItemVersionVersionOperationResponse, err error) {
