...
func DefaultUpdateDriveListItemVersionOperationOptions() UpdateDriveListItemVersionOperationOptions {
	return UpdateDriveListItemVersionOperationOptions{}
}
...
// UpdateDriveListItemVersion - Update the navigation property versions in groups
func (c DriveListItemVersionClient) UpdateDriveListItemVersion(ctx context.Context, id stable.GroupIdDriveIdListItemIdVersionId, input stable.ListItemVersion, options UpdateDriveListItemVersionOperationOptions) (result UpdateDriveListItemVersionOperationResponse, err error) {
