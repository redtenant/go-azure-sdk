...
// DeleteDriveListItemVersionField - Delete navigation property fields for groups
func (c DriveListItemVersionFieldClient) DeleteDriveListItemVersionField(ctx context.Context, id stable.GroupIdDriveIdListItemIdVersionId, options DeleteDriveListItemVersionFieldOperationOptions) (result DeleteDriveListItemVersionFieldOperationResponse, err error) {
