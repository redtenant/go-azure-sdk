...
// GetDriveListItemVersionField - Get fields from groups. A collection of the fields and values for this version of the
// list item.
func (c DriveListItemVersionFieldClient) GetDriveListItemVersionField(ctx context.Context, id stable.GroupIdDriveIdListItemIdVersionId, options GetDriveListItemVersionFieldOperationOptions) (result GetDriveListItemVersionFieldOperationResponse, err error) {
