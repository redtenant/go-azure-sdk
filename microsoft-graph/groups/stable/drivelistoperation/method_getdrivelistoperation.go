...
func (c DriveListOperationClient) GetDriveListOperation(ctx context.Context, id stable.GroupIdDriveIdListOperationId, options GetDriveListOperationOperationOptions) (result GetDriveListOperationOperationResponse, err error) {
