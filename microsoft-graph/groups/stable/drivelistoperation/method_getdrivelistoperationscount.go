...
func (c DriveListOperationClient) GetDriveListOperationsCount(ctx context.Context, id stable.GroupIdDriveId, options GetDriveListOperationsCountOperationOptions) (result GetDriveListOperationsCountOperationResponse, err error) {
