...
func (c DriveListOperationClient) UpdateDriveListOperation(ctx context.Context, id stable.GroupIdDriveIdListOperationId, input stable.RichLongRunningOperation, options UpdateDriveListOperationOperationOptions) (result UpdateDriveListOperationOperationResponse, err error) {
