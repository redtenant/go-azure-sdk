...
func (c DriveListSubscriptionClient) CreateDriveListSubscription(ctx context.Context, id stable.GroupIdDriveId, input stable.Subscription, options CreateDriveListSubscriptionOperationOptions) (result CreateDriveListSubscriptionOperationResponse, err error) {
