...
func (c DriveListSubscriptionClient) CreateDriveListSubscriptionReauthorize(ctx context.Context, id stable.GroupIdDriveIdListSubscriptionId, options CreateDriveListSubscriptionReauthorizeOperationOptions) (result CreateDriveListSubscriptionReauthorizeOperationResponse, err error) {
