...
func (c DriveListSubscriptionClient) GetDriveListSubscription(ctx context.Context, id stable.GroupIdDriveIdListSubscriptionId, options GetDriveListSubscriptionOperationOptions) (result GetDriveListSubscriptionOperationResponse, err error) {
