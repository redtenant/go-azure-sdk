...
func (c DriveRootClient) CheckinDriveRoot(ctx context.Context, id stable.GroupIdDriveId, input CheckinDriveRootRequest, options CheckinDriveRootOperationOptions) (result CheckinDriveRootOperationResponse, err error) {
