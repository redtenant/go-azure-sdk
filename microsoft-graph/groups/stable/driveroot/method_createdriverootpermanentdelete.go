...
func (c DriveRootClient) CreateDriveRootPermanentDelete(ctx context.Context, id stable.GroupIdDriveId, options CreateDriveRootPermanentDeleteOperationOptions) (result CreateDriveRootPermanentDeleteOperationResponse, err error) {
