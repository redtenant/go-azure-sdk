...
func (c DriveRootClient) CreateDriveRootUploadSession(ctx context.Context, id stable.GroupIdDriveId, input CreateDriveRootUploadSessionRequest, options CreateDriveRootUploadSessionOperationOptions) (result CreateDriveRootUploadSessionOperationResponse, err error) {
