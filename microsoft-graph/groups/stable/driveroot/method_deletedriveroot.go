...
func DefaultDeleteDriveRootOperationOptions() DeleteDriveRootOperationOptions {
	return DeleteDriveRootOperationOptions{}
}
...
// DeleteDriveRoot - Delete navigation property root for groups
func (c DriveRootClient) DeleteDriveRoot(ctx context.Context, id stable.GroupIdDriveId, options DeleteDriveRootOperationOptions) (result DeleteDriveRootOperationResponse, err error) {
