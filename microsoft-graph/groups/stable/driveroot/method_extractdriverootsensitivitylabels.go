...
func (c DriveRootClient) ExtractDriveRootSensitivityLabels(ctx context.Context, id stable.GroupIdDriveId, options ExtractDriveRootSensitivityLabelsOperationOptions) (result ExtractDriveRootSensitivityLabelsOperationResponse, err error) {
