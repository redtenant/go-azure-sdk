...
func DefaultGetDriveRootOperationOptions() GetDriveRootOperationOptions {
	return GetDriveRootOperationOptions{}
}
...
// GetDriveRoot - Get root from groups. The root folder of the drive. Read-only.
func (c DriveRootClient) GetDriveRoot(ctx context.Context, id stable.GroupIdDriveId, options GetDriveRootOperationOptions) (result GetDriveRootOperationResponse, err error) {
