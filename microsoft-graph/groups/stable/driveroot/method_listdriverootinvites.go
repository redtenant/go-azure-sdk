...
func (c DriveRootClient) ListDriveRootInvites(ctx context.Context, id stable.GroupIdDriveId, input ListDriveRootInvitesRequest, options ListDriveRootInvitesOperationOptions) (result ListDriveRootInvitesOperationResponse, err error) {
...
func (c DriveRootClient) ListDriveRootInvitesComplete(ctx context.Context, id stable.GroupIdDriveId, input ListDriveRootInvitesRequest, options ListDriveRootInvitesOperationOptions) (ListDriveRootInvitesCompleteResult, error) {
...
func (c DriveRootClient) ListDriveRootInvitesCompleteMatchingPredicate(ctx context.Context, id stable.GroupIdDriveId, input ListDriveRootInvitesRequest, options ListDriveRootInvitesOperationOptions, predicate PermissionOperationPredicate) (result ListDriveRootInvitesCompleteResult, err error) {
