...
func (c DriveRootClient) PreviewDriveRoot(ctx context.Context, id stable.GroupIdDriveId, input PreviewDriveRootRequest, options PreviewDriveRootOperationOptions) (result PreviewDriveRootOperationResponse, err error) {
