...
func (c DriveRootClient) UnfollowDriveRoot(ctx context.Context, id stable.GroupIdDriveId, options UnfollowDriveRootOperationOptions) (result UnfollowDriveRootOperationResponse, err error) {
