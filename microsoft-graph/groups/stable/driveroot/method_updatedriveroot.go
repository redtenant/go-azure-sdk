...
// UpdateDriveRoot - Update the navigation property root in groups
func (c DriveRootClient) UpdateDriveRoot(ctx context.Context, id stable.GroupIdDriveId, input stable.DriveItem, options UpdateDriveRootOperationOptions) (result UpdateDriveRootOperationResponse, err error) {
