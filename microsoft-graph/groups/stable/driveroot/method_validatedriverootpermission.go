...
func DefaultValidateDriveRootPermissionOperationOptions() ValidateDriveRootPermissionOperationOptions {
	return ValidateDriveRootPermissionOperationOptions{}
}
...
func (c DriveRootClient) ValidateDriveRootPermission(ctx context.Context, id stable.GroupIdDriveId, input ValidateDriveRootPermissionRequest, options ValidateDriveRootPermissionOperationOptions) (result ValidateDriveRootPermissionOperationResponse, err error) {
	opts := client.RequestOptions{
		...
		Path:          fmt.Sprintf("%s/root/validatePermission", id.ID()),
