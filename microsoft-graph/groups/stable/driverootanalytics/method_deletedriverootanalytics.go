...
func (c DriveRootAnalyticsClient) DeleteDriveRootAnalytics(ctx context.Context, id stable.GroupIdDriveId, options DeleteDriveRootAnalyticsOperationOptions) (result DeleteDriveRootAnalyticsOperationResponse, err error) {
