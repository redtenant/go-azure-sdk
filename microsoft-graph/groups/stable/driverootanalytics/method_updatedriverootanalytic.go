...
// UpdateDriveRootAnalytic - Update the navigation property analytics in groups
func (c DriveRootAnalyticsClient) UpdateDriveRootAnalytic(ctx context.Context, id stable.GroupIdDriveId, input stable.ItemAnalytics, options UpdateDriveRootAnalyticOperationOptions) (result UpdateDriveRootAnalyticOperationResponse, err error) {
