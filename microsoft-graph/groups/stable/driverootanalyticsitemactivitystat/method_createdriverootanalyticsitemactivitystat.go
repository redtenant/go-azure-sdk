...
func (c DriveRootAnalyticsItemActivityStatClient) CreateDriveRootAnalyticsItemActivityStat(ctx context.Context, id stable.GroupIdDriveId, input stable.ItemActivityStat, options CreateDriveRootAnalyticsItemActivityStatOperationOptions) (result CreateDriveRootAnalyticsItemActivityStatOperationResponse, err error) {
