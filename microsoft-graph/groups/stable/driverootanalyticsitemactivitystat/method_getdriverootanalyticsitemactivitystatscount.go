...
func (c DriveRootAnalyticsItemActivityStatClient) GetDriveRootAnalyticsItemActivityStatsCount(ctx context.Context, id stable.GroupIdDriveId, options GetDriveRootAnalyticsItemActivityStatsCountOperationOptions) (result GetDriveRootAnalyticsItemActivityStatsCountOperationResponse, err error) {
