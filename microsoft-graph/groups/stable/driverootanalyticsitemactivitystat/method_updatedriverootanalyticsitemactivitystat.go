...
// UpdateDriveRootAnalyticsItemActivityStat - Update the navigation property itemActivityStats in groups
func (c DriveRootAnalyticsItemActivityStatClient) UpdateDriveRootAnalyticsItemActivityStat(ctx context.Context, id stable.GroupIdDriveIdRootAnalyticsItemActivityStatId, input stable.ItemActivityStat, options UpdateDriveRootAnalyticsItemActivityStatOperationOptions) (result UpdateDriveRootAnalyticsItemActivityStatOperationResponse, err error) {
