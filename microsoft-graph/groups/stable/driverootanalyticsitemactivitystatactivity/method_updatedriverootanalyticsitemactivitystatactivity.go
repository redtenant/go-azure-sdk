...
// UpdateDriveRootAnalyticsItemActivityStatActivity - Update the navigation property activities in groups
func (c DriveRootAnalyticsItemActivityStatActivityClient) UpdateDriveRootAnalyticsItemActivityStatActivity(ctx context.Context, id stable.GroupIdDriveIdRootAnalyticsItemActivityStatIdActivityId, input stable.ItemActivity, options UpdateDriveRootAnalyticsItemActivityStatActivityOperationOptions) (result UpdateDriveRootAnalyticsItemActivityStatActivityOperationResponse, err error) {
