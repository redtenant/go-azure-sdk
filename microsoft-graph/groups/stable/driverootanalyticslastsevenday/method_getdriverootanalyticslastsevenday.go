...
func (c DriveRootAnalyticsLastSevenDayClient) GetDriveRootAnalyticsLastSevenDay(ctx context.Context, id stable.GroupIdDriveId, options GetDriveRootAnalyticsLastSevenDayOperationOptions) (result GetDriveRootAnalyticsLastSevenDayOperationResponse, err error) {
