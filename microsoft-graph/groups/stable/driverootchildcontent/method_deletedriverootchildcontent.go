...
// DeleteDriveRootChildContent - Delete content for the navigation property children in groups. The content stream, if
// the item represents a file.
func (c DriveRootChildContentClient) DeleteDriveRootChildContent(ctx context.Context, id stable.GroupIdDriveIdRootChildId, options DeleteDriveRootChildContentOperationOptions) (result DeleteDriveRootChildContentOperationResponse, err error) {
