...
func DefaultGetDriveRootChildContentOperationOptions() GetDriveRootChildContentOperationOptions {
	return GetDriveRootChildContentOperationOptions{}
}
...
// GetDriveRootChildContent - Get content for the navigation property children from groups. The content stream, if the
// item represents a file.
func (c DriveRootChildContentClient) GetDriveRootChildContent(ctx context.Context, id stable.GroupIdDriveIdRootChildId, options GetDriveRootChildContentOperationOptions) (result GetDriveRootChildContentOperationResponse, err error) {
