...
// SetDriveRootChildContent - Update content for the navigation property children in groups. The content stream, if the
// item represents a file.
func (c DriveRootChildContentClient) SetDriveRootChildContent(ctx context.Context, id stable.GroupIdDriveIdRootChildId, input []byte, options SetDriveRootChildContentOperationOptions) (result SetDriveRootChildContentOperationResponse, err error) {
