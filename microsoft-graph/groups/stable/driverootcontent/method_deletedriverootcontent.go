...
func DefaultDeleteDriveRootContentOperationOptions() DeleteDriveRootContentOperationOptions {
	return DeleteDriveRootContentOperationOptions{}
}
...
// DeleteDriveRootContent - Delete content for the navigation property root in groups. The content stream, if the item
// represents a file.
func (c DriveRootContentClient) DeleteDriveRootContent(ctx context.Context, id stable.GroupIdDriveId, options DeleteDriveRootContentOperationOptions) (result DeleteDriveRootContentOperationResponse, err error) {
