...
// GetDriveRootContent - Get content for the navigation property root from groups. The content stream, if the item
// represents a file.
func (c DriveRootContentClient) GetDriveRootContent(ctx context.Context, id stable.GroupIdDriveId, options GetDriveRootContentOperationOptions) (result GetDriveRootContentOperationResponse, err error) {
