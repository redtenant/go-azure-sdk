...
// SetDriveRootContent - Update content for the navigation property root in groups. The content stream, if the item
// represents a file.
func (c DriveRootContentClient) SetDriveRootContent(ctx context.Context, id stable.GroupIdDriveId, input []byte, options SetDriveRootContentOperationOptions) (result SetDriveRootContentOperationResponse, err error) {
