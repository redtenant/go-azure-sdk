...
// GetDriveRootCreatedByUser - Get createdByUser from groups. Identity of the user who created the item. Read-only.
func (c DriveRootCreatedByUserClient) GetDriveRootCreatedByUser(ctx context.Context, id stable.GroupIdDriveId, options GetDriveRootCreatedByUserOperationOptions) (result GetDriveRootCreatedByUserOperationResponse, err error) {
