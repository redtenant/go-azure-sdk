...
// GetDriveRootLastModifiedByUser - Get lastModifiedByUser from groups. Identity of the user who last modified the item.
// Read-only.
func (c DriveRootLastModifiedByUserClient) GetDriveRootLastModifiedByUser(ctx context.Context, id stable.GroupIdDriveId, options GetDriveRootLastModifiedByUserOperationOptions) (result GetDriveRootLastModifiedByUserOperationResponse, err error) {
