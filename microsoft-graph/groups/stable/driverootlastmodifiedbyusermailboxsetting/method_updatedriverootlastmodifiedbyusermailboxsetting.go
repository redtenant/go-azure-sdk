...
func (c DriveRootLastModifiedByUserMailboxSettingClient) UpdateDriveRootLastModifiedByUserMailboxSetting(ctx context.Context, id stable.GroupIdDriveId, input stable.MailboxSettings, options UpdateDriveRootLastModifiedByUserMailboxSettingOperationOptions) (result UpdateDriveRootLastModifiedByUserMailboxSettingOperationResponse, err error) {
