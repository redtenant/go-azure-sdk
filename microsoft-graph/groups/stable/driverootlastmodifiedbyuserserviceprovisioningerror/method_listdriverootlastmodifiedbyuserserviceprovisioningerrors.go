...
func (c DriveRootLastModifiedByUserServiceProvisioningErrorClient) ListDriveRootLastModifiedByUserServiceProvisioningErrorsCompleteMatchingPredicate(ctx context.Context, id stable.GroupIdDriveId, options ListDriveRootLastModifiedByUserServiceProvisioningErrorsOperationOptions, predicate ServiceProvisioningErrorOperationPredicate) (result ListDriveRootLastModifiedByUserServiceProvisioningErrorsCompleteResult, err error) {
