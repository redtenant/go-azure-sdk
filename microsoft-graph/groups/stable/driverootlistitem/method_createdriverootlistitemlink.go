...
func (c DriveRootListItemClient) CreateDriveRootListItemLink(ctx context.Context, id stable.GroupIdDriveId, input CreateDriveRootListItemLinkRequest, options CreateDriveRootListItemLinkOperationOptions) (result CreateDriveRootListItemLinkOperationResponse, err error) {
