...
func (c DriveRootListItemClient) DeleteDriveRootListItem(ctx context.Context, id stable.GroupIdDriveId, options DeleteDriveRootListItemOperationOptions) (result DeleteDriveRootListItemOperationResponse, err error) {
