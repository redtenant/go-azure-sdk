...
func DefaultGetDriveRootListItemOperationOptions() GetDriveRootListItemOperationOptions {
	return GetDriveRootListItemOperationOptions{}
}
...
// GetDriveRootListItem - Get listItem from groups. For drives in SharePoint, the associated document library list item.
// Read-only. Nullable.
func (c DriveRootListItemClient) GetDriveRootListItem(ctx context.Context, id stable.GroupIdDriveId, options GetDriveRootListItemOperationOptions) (result GetDriveRootListItemOperationResponse, err error) {
