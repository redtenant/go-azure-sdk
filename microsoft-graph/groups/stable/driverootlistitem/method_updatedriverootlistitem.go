...
// UpdateDriveRootListItem - Update the navigation property listItem in groups
func (c DriveRootListItemClient) UpdateDriveRootListItem(ctx context.Context, id stable.GroupIdDriveId, input stable.ListItem, options UpdateDriveRootListItemOperationOptions) (result UpdateDriveRootListItemOperationResponse, err error) {
