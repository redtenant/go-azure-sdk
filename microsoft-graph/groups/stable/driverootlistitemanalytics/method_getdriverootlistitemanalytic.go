...
// GetDriveRootListItemAnalytic - Get analytics from groups. Analytics about the view activities that took place on this
// item.
func (c DriveRootListItemAnalyticsClient) GetDriveRootListItemAnalytic(ctx context.Context, id stable.GroupIdDriveId, options GetDriveRootListItemAnalyticOperationOptions) (result GetDriveRootListItemAnalyticOperationResponse, err error) {
