...
// GetDriveRootListItemCreatedByUser - Get createdByUser from groups. Identity of the user who created the item.
// Read-only.
func (c DriveRootListItemCreatedByUserClient) GetDriveRootListItemCreatedByUser(ctx context.Context, id stable.GroupIdDriveId, options GetDriveRootListItemCreatedByUserOperationOptions) (result GetDriveRootListItemCreatedByUserOperationResponse, err error) {
