...
func (c DriveRootListItemCreatedByUserMailboxSettingClient) GetDriveRootListItemCreatedByUserMailboxSetting(ctx context.Context, id stable.GroupIdDriveId, options GetDriveRootListItemCreatedByUserMailboxSettingOperationOptions) (result GetDriveRootListItemCreatedByUserMailboxSettingOperationResponse, err error) {
