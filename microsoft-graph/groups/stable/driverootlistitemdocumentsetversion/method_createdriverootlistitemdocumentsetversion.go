...
// CreateDriveRootListItemDocumentSetVersion - Create new navigation property to documentSetVersions for groups
func (c DriveRootListItemDocumentSetVersionClient) CreateDriveRootListItemDocumentSetVersion(ctx context.Context, id stable.GroupIdDriveId, input stable.DocumentSetVersion, options CreateDriveRootListItemDocumentSetVersionOperationOptions) (result CreateDriveRootListItemDocumentSetVersionOperationResponse, err error) {
