...
func DefaultGetDriveRootListItemDocumentSetVersionOperationOptions() GetDriveRootListItemDocumentSetVersionOperationOptions {
	return GetDriveRootListItemDocumentSetVersionOperationOptions{}
}
...
// GetDriveRootListItemDocumentSetVersion - Get documentSetVersions from groups. Version information for a document set
// version created by a user.
func (c DriveRootListItemDocumentSetVersionClient) GetDriveRootListItemDocumentSetVersion(ctx context.Context, id stable.GroupIdDriveIdRootListItemDocumentSetVersionId, options GetDriveRootListItemDocumentSetVersionOperationOptions) (result GetDriveRootListItemDocumentSetVersionOperationResponse, err error) {
