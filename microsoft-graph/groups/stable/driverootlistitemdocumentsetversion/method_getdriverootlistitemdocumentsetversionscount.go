...
func (c DriveRootListItemDocumentSetVersionClient) GetDriveRootListItemDocumentSetVersionsCount(ctx context.Context, id stable.GroupIdDriveId, options GetDriveRootListItemDocumentSetVersionsCountOperationOptions) (result GetDriveRootListItemDocumentSetVersionsCountOperationResponse, err error) {
