...
// UpdateDriveRootListItemDocumentSetVersion - Update the navigation property documentSetVersions in groups
func (c DriveRootListItemDocumentSetVersionClient) UpdateDriveRootListItemDocumentSetVersion(ctx context.Context, id stable.GroupIdDriveIdRootListItemDocumentSetVersionId, input stable.DocumentSetVersion, options UpdateDriveRootListItemDocumentSetVersionOperationOptions) (result UpdateDriveRootListItemDocumentSetVersionOperationResponse, err error) {
