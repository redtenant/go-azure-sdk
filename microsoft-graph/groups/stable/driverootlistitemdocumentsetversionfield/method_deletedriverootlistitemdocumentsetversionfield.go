...
// DeleteDriveRootListItemDocumentSetVersionField - Delete navigation property fields for groups
func (c DriveRootListItemDocumentSetVersionFieldClient) DeleteDriveRootListItemDocumentSetVersionField(ctx context.Context, id stable.GroupIdDriveIdRootListItemDocumentSetVersionId, options DeleteDriveRootListItemDocumentSetVersionFieldOperationOptions) (result DeleteDriveRootListItemDocumentSetVersionFieldOperationResponse, err error) {
