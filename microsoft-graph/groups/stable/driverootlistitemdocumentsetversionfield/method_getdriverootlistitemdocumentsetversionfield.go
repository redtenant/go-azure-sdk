...
// GetDriveRootListItemDocumentSetVersionField - Get fields from groups. A collection of the fields and values for this
// version of the list item.
func (c DriveRootListItemDocumentSetVersionFieldClient) GetDriveRootListItemDocumentSetVersionField(ctx context.Context, id stable.GroupIdDriveIdRootListItemDocumentSetVersionId, options GetDriveRootListItemDocumentSetVersionFieldOperationOptions) (result GetDriveRootListItemDocumentSetVersionFieldOperationResponse, err error) {
