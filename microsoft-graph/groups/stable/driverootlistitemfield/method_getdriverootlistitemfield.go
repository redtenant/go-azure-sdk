...
// GetDriveRootListItemField - Get fields from groups. The values of the columns set on this list item.
func (c DriveRootListItemFieldClient) GetDriveRootListItemField(ctx context.Context, id stable.GroupIdDriveId, options GetDriveRootListItemFieldOperationOptions) (result GetDriveRootListItemFieldOperationResponse, err error) {
