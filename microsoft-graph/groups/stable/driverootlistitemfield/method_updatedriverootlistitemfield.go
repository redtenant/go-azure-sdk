...
// UpdateDriveRootListItemField - Update the navigation property fields in groups
func (c DriveRootListItemFieldClient) UpdateDriveRootListItemField(ctx context.Context, id stable.GroupIdDriveId, input stable.FieldValueSet, options UpdateDriveRootListItemFieldOperationOptions) (result UpdateDriveRootListItemFieldOperationResponse, err error) {
