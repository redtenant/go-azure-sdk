...
func DefaultDeleteDriveRootListItemVersionOperationOptions() DeleteDriveRootListItemVersionOperationOptions {
	return DeleteDriveRootListItemVersionOperationOptions{}
}
...
// DeleteDriveRootListItemVersion - Delete navigation property versions for groups
func (c DriveRootListItemVersionClient) DeleteDriveRootListItemVersion(ctx context.Context, id stable.GroupIdDriveIdRootListItemVersionId, options DeleteDriveRootListItemVersionOperationOptions) (result DeleteDriveRootListItemVersionOperationResponse, err error) {
