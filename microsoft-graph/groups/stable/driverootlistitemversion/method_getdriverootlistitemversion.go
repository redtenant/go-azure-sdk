...
// GetDriveRootListItemVersion - Get versions from groups. The list of previous versions of the list item.
func (c DriveRootListItemVersionClient) GetDriveRootListItemVersion(ctx context.Context, id stable.GroupIdDriveIdRootListItemVersionId, options GetDriveRootListItemVersionOperationOptions) (result GetDriveRootListItemVersionOperationResponse, err error) {
