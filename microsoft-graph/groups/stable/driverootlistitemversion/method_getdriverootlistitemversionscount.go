...
func (c DriveRootListItemVersionClient) GetDriveRootListItemVersionsCount(ctx context.Context, id stable.GroupIdDriveId, options GetDriveRootListItemVersionsCountOperationOptions) (result GetDriveRootListItemVersionsCountOperationResponse, err error) {
