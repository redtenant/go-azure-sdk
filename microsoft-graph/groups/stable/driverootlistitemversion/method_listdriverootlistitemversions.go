...
// ListDriveRootListItemVersions - Get versions from groups. The list of previous versions of the list item.
func (c DriveRootListItemVersionClient) ListDriveRootListItemVersions(ctx context.Context, id stable.GroupIdDriveId, options ListDriveRootListItemVersionsOperationOptions) (result ListDriveRootListItemVersionsOperationResponse, err error) {
...
func (c DriveRootListItemVersionClient) ListDriveRootListItemVersionsComplete(ctx context.Context, id stable.GroupIdDriveId, options ListDriveRootListItemVersionsOperationOptions) (ListDriveRootListItemVersionsCompleteResult, error) {
...
func (c DriveRootListItemVersionClient) ListDriveRootListItemVersionsCompleteMatchingPredicate(ctx context.Context, id stable.GroupIdDriveId, options ListDriveRootListItemVersionsOperationOptions, predicate ListItemVersionOperationPredicate) (result ListDriveRootListItemVersionsCompleteResult, err error) {
