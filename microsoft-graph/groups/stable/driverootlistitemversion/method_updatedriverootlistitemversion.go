...
// UpdateDriveRootListItemVersion - Update the navigation property versions in groups
func (c DriveRootListItemVersionClient) UpdateDriveRootListItemVersion(ctx context.Context, id stable.GroupIdDriveIdRootListItemVersionId, input stable.ListItemVersion, options UpdateDriveRootListItemVersionOperationOptions) (result UpdateDriveRootListItemVersionOperationResponse, err error) {
