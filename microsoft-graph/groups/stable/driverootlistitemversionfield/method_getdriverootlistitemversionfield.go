...
// GetDriveRootListItemVersionField - Get fields from groups. A collection of the fields and values for this version of
// the list item.
func (c DriveRootListItemVersionFieldClient) GetDriveRootListItemVersionField(ctx context.Context, id stable.GroupIdDriveIdRootListItemVersionId, options GetDriveRootListItemVersionFieldOperationOptions) (result GetDriveRootListItemVersionFieldOperationResponse, err error) {
