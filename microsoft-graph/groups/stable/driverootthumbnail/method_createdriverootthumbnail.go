...
// CreateDriveRootThumbnail - Create new navigation property to thumbnails for groups
func (c DriveRootThumbnailClient) CreateDriveRootThumbnail(ctx context.Context, id stable.GroupIdDriveId, input stable.ThumbnailSet, options CreateDriveRootThumbnailOperationOptions) (result CreateDriveRootThumbnailOperationResponse, err error) {
