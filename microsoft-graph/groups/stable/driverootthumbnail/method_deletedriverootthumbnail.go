...
// DeleteDriveRootThumbnail - Delete navigation property thumbnails for groups
func (c DriveRootThumbnailClient) DeleteDriveRootThumbnail(ctx context.Context, id stable.GroupIdDriveIdRootThumbnailId, options DeleteDriveRootThumbnailOperationOptions) (result DeleteDriveRootThumbnailOperationResponse, err error) {
