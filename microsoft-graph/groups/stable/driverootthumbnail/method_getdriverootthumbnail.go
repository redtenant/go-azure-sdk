...
// GetDriveRootThumbnail - Get thumbnails from groups. Collection of thumbnailSet objects associated with the item. For
// more information, see getting thumbnails. Read-only. Nullable.
func (c DriveRootThumbnailClient) GetDriveRootThumbnail(ctx context.Context, id stable.GroupIdDriveIdRootThumbnailId, options GetDriveRootThumbnailOperationOptions) (result GetDriveRootThumbnailOperationResponse, err error) {
