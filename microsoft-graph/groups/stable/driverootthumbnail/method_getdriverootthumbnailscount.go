...
func (c DriveRootThumbnailClient) GetDriveRootThumbnailsCount(ctx context.Context, id stable.GroupIdDriveId, options GetDriveRootThumbnailsCountOperationOptions) (result GetDriveRootThumbnailsCountOperationResponse, err error) {
