...
func (c DriveRootThumbnailClient) UpdateDriveRootThumbnail(ctx context.Context, id stable.GroupIdDriveIdRootThumbnailId, input stable.ThumbnailSet, options UpdateDriveRootThumbnailOperationOptions) (result UpdateDriveRootThumbnailOperationResponse, err error) {
