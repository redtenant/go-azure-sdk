...
// GetDriveRootVersionContent - Get content for the navigation property versions from groups. The content stream for
// this version of the item.
func (c DriveRootVersionContentClient) GetDriveRootVersionContent(ctx context.Context, id stable.GroupIdDriveIdRootVersionId, options GetDriveRootVersionContentOperationOptions) (result GetDriveRootVersionContentOperationResponse, err error) {
