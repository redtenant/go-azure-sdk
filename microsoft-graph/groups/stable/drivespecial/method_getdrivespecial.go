...
// GetDriveSpecial - Get special from groups. Collection of common folders available in OneDrive. Read-only. Nullable.
func (c DriveSpecialClient) GetDriveSpecial(ctx context.Context, id stable.GroupIdDriveIdSpecialId, options GetDriveSpecialOperationOptions) (result GetDriveSpecialOperationResponse, err error) {
