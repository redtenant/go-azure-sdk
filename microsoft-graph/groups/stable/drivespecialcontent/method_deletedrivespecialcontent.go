...
// DeleteDriveSpecialContent - Delete content for the navigation property special in groups. The content stream, if the
// item represents a file.
func (c DriveSpecialContentClient) DeleteDriveSpecialContent(ctx context.Context, id stable.GroupIdDriveIdSpecialId, options DeleteDriveSpecialContentOperationOptions) (result DeleteDriveSpecialContentOperationResponse, err error) {
