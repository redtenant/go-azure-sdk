...
// GetDriveSpecialContent - Get content for the navigation property special from groups. The content stream, if the item
// represents a file.
func (c DriveSpecialContentClient) GetDriveSpecialContent(ctx context.Context, id stable.GroupIdDriveIdSpecialId, options GetDriveSpecialContentOperationOptions) (result GetDriveSpecialContentOperationResponse, err error) {
