...
func (c EventExtensionClient) DeleteEventExtension(ctx context.Context, id stable.GroupIdEventIdExtensionId, options DeleteEventExtensionOperationOptions) (result DeleteEventExtensionOperationResponse, err error) {
