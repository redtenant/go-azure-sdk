...
// ListEventExtensions - Get open extension. Get an open extension (openTypeExtension object) identified by name or
...
func (c EventExtensionClient) ListEventExtensions(ctx context.Context, id stable.GroupIdEventId, options ListEventExtensionsOperationOptions) (result ListEventExtensionsOperationResponse, err error) {
...
func (c EventExtensionClient) ListEventExtensionsComplete(ctx context.Context, id stable.GroupIdEventId, options ListEventExtensionsOperationOptions) (ListEventExtensionsCompleteResult, error) {
...
func (c EventExtensionClient) ListEventExtensionsCompleteMatchingPredicate(ctx context.Context, id stable.GroupIdEventId, options ListEventExtensionsOperationOptions, predicate ExtensionOperationPredicate) (result ListEventExtensionsCompleteResult, err error) {
