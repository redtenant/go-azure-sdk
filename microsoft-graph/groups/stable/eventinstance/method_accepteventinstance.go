...
func (c EventInstanceClient) AcceptEventInstance(ctx context.Context, id stable.GroupIdEventIdInstanceId, input AcceptEventInstanceRequest, options AcceptEventInstanceOperationOptions) (result AcceptEventInstanceOperationResponse, err error) {
