...
func (c EventInstanceClient) CancelEventInstance(ctx context.Context, id stable.GroupIdEventIdInstanceId, input CancelEventInstanceRequest, options CancelEventInstanceOperationOptions) (result CancelEventInstanceOperationResponse, err error) {
