...
func DefaultDeclineEventInstanceOperationOptions() DeclineEventInstanceOperationOptions {
	return DeclineEventInstanceOperationOptions{}
}
...
// DeclineEventInstance - Invoke action decline. Decline invitation to the specified event in a user calendar. If the
...
func (c EventInstanceClient) DeclineEventInstance(ctx context.Context, id stable.GroupIdEventIdInstanceId, input DeclineEventInstanceRequest, options DeclineEventInstanceOperationOptions) (result DeclineEventInstanceOperationResponse, err error) {
