...
// Outlook.com account.
func (c EventInstanceClient) ForwardEventInstance(ctx context.Context, id stable.GroupIdEventIdInstanceId, input ForwardEventInstanceRequest, options ForwardEventInstanceOperationOptions) (result ForwardEventInstanceOperationResponse, err error) {
