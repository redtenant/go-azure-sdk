...
func (c EventInstanceClient) GetEventInstancesCount(ctx context.Context, id stable.GroupIdEventId, options GetEventInstancesCountOperationOptions) (result GetEventInstancesCountOperationResponse, err error) {
