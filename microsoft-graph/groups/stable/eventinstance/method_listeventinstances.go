...
// ListEventInstances - Get instances from groups. The occurrences of a recurring series, if the event is a series
...
// Nullable.
func (c EventInstanceClient) ListEventInstances(ctx context.Context, id stable.GroupIdEventId, options ListEventInstancesOperationOptions) (result ListEventInstancesOperationResponse, err error) {
...
func (c EventInstanceClient) ListEventInstancesComplete(ctx context.Context, id stable.GroupIdEventId, options ListEventInstancesOperationOptions) (ListEventInstancesCompleteResult, error) {
...
func (c EventInstanceClient) ListEventInstancesCompleteMatchingPredicate(ctx context.Context, id stable.GroupIdEventId, options ListEventInstancesOperationOptions, predicate EventOperationPredicate) (result ListEventInstancesCompleteResult, err error) {
