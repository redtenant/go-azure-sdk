...
// a new time.
func (c EventInstanceClient) SnoozeEventInstanceReminder(ctx context.Context, id stable.GroupIdEventIdInstanceId, input SnoozeEventInstanceReminderRequest, options SnoozeEventInstanceReminderOperationOptions) (result SnoozeEventInstanceReminderOperationResponse, err error) {
