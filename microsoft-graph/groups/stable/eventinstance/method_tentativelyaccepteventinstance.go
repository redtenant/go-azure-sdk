...
func (c EventInstanceClient) TentativelyAcceptEventInstance(ctx context.Context, id stable.GroupIdEventIdInstanceId, input TentativelyAcceptEventInstanceRequest, options TentativelyAcceptEventInstanceOperationOptions) (result TentativelyAcceptEventInstanceOperationResponse, err error) {
