...
// CreateEventInstanceAttachment - Create new navigation property to attachments for groups
func (c EventInstanceAttachmentClient) CreateEventInstanceAttachment(ctx context.Context, id stable.GroupIdEventIdInstanceId, input stable.Attachment, options CreateEventInstanceAttachmentOperationOptions) (result CreateEventInstanceAttachmentOperationResponse, err error) {
