...
// an app to iteratively upload ranges of a file, so as to attach the file to the specified Outlook item. The item can
...
func (c EventInstanceAttachmentClient) CreateEventInstanceAttachmentsUploadSession(ctx context.Context, id stable.GroupIdEventIdInstanceId, input CreateEventInstanceAttachmentsUploadSessionRequest, options CreateEventInstanceAttachmentsUploadSessionOperationOptions) (result CreateEventInstanceAttachmentsUploadSessionOperationResponse, err error) {
