...
func DefaultDeleteEventInstanceAttachmentOperationOptions() DeleteEventInstanceAttachmentOperationOptions {
	return DeleteEventInstanceAttachmentOperationOptions{}
}
...
// DeleteEventInstanceAttachment - Delete navigation property attachments for groups
func (c EventInstanceAttachmentClient) DeleteEventInstanceAttachment(ctx context.Context, id stable.GroupIdEventIdInstanceIdAttachmentId, options DeleteEventInstanceAttachmentOperationOptions) (result DeleteEventInstanceAttachmentOperationResponse, err error) {
