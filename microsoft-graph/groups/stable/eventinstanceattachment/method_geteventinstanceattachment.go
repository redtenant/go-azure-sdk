...
// GetEventInstanceAttachment - Get attachments from groups. The collection of FileAttachment, ItemAttachment, and
// referenceAttachment attachments for the event. Navigation property. Read-only. Nullable.
func (c EventInstanceAttachmentClient) GetEventInstanceAttachment(ctx context.Context, id stable.GroupIdEventIdInstanceIdAttachmentId, options GetEventInstanceAttachmentOperationOptions) (result GetEventInstanceAttachmentOperationResponse, err error) {
