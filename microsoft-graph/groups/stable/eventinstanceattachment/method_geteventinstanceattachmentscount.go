...
func DefaultGetEventInstanceAttachmentsCountOperationOptions() GetEventInstanceAttachmentsCountOperationOptions {
	return GetEventInstanceAttachmentsCountOperationOptions{}
}
...
func (c EventInstanceAttachmentClient) GetEventInstanceAttachmentsCount(ctx context.Context, id stable.GroupIdEventIdInstanceId, options GetEventInstanceAttachmentsCountOperationOptions) (result GetEventInstanceAttachmentsCountOperationResponse, err error) {
