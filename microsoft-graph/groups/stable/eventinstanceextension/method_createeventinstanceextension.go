...
// CreateEventInstanceExtension - Create new navigation property to extensions for groups
func (c EventInstanceExtensionClient) CreateEventInstanceExtension(ctx context.Context, id stable.GroupIdEventIdInstanceId, input stable.Extension, options CreateEventInstanceExtensionOperationOptions) (result CreateEventInstanceExtensionOperationResponse, err error) {
