...
func (c EventInstanceExtensionClient) GetEventInstanceExtensionsCount(ctx context.Context, id stable.GroupIdEventIdInstanceId, options GetEventInstanceExtensionsCountOperationOptions) (result GetEventInstanceExtensionsCountOperationResponse, err error) {
