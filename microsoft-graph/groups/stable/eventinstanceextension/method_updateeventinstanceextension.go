...
// UpdateEventInstanceExtension - Update the navigation property extensions in groups
func (c EventInstanceExtensionClient) UpdateEventInstanceExtension(ctx context.Context, id stable.GroupIdEventIdInstanceIdExtensionId, input stable.Extension, options UpdateEventInstanceExtensionOperationOptions) (result UpdateEventInstanceExtensionOperationResponse, err error) {
