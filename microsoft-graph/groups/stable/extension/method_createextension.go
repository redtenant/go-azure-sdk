...
func (c ExtensionClient) CreateExtension(ctx context.Context, id stable.GroupId, input stable.Extension, options CreateExtensionOperationOptions) (result CreateExtensionOperationResponse, err error) {
