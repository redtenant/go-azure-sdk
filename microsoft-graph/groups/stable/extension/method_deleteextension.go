...
func (c ExtensionClient) DeleteExtension(ctx context.Context, id stable.GroupIdExtensionId, options DeleteExtensionOperationOptions) (result DeleteExtensionOperationResponse, err error) {
