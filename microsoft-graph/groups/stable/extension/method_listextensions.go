...
// ListExtensions - Get extensions from groups. The collection of open extensions defined for the group. Read-only.
// Nullable.
func (c ExtensionClient) ListExtensions(ctx context.Context, id stable.GroupId, options ListExtensionsOperationOptions) (result ListExtensionsOperationResponse, err error) {
...
func (c ExtensionClient) ListExtensionsComplete(ctx context.Context, id stable.GroupId, options ListExtensionsOperationOptions) (ListExtensionsCompleteResult, error) {
...
func (c ExtensionClient) ListExtensionsCompleteMatchingPredicate(ctx context.Context, id stable.GroupId, options ListExtensionsOperationOptions, predicate ExtensionOperationPredicate) (result ListExtensionsCompleteResult, err error) {
