...
func (c GroupClient) CheckGrantedPermissionsForApps(ctx context.Context, id stable.GroupId, options CheckGrantedPermissionsForAppsOperationOptions) (result CheckGrantedPermissionsForAppsOperationResponse, err error) {
...
func (c GroupClient) CheckGrantedPermissionsForAppsComplete(ctx context.Context, id stable.GroupId, options CheckGrantedPermissionsForAppsOperationOptions) (CheckGrantedPermissionsForAppsCompleteResult, error) {
...
func (c GroupClient) CheckGrantedPermissionsForAppsCompleteMatchingPredicate(ctx context.Context, id stable.GroupId, options CheckGrantedPermissionsForAppsOperationOptions, predicate ResourceSpecificPermissionGrantOperationPredicate) (result CheckGrantedPermissionsForAppsCompleteResult, err error) {
