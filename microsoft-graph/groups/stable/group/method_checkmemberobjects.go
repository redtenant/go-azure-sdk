...
func (c GroupClient) CheckMemberObjects(ctx context.Context, id stable.GroupId, input CheckMemberObjectsRequest, options CheckMemberObjectsOperationOptions) (result CheckMemberObjectsOperationResponse, err error) {
...
func (c GroupClient) CheckMemberObjectsComplete(ctx context.Context, id stable.GroupId, input CheckMemberObjectsRequest, options CheckMemberObjectsOperationOptions) (result CheckMemberObjectsCompleteResult, err error) {
	items := make([]string, 0)
