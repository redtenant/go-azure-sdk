...
// are an exception and aren't returned in the $select query.
func (c GroupClient) GetGroup(ctx context.Context, id stable.GroupId, options GetGroupOperationOptions) (result GetGroupOperationResponse, err error) {
