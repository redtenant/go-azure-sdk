...
func (c GroupClient) GetMemberGroups(ctx context.Context, id stable.GroupId, input GetMemberGroupsRequest, options GetMemberGroupsOperationOptions) (result GetMemberGroupsOperationResponse, err error) {
...
func (c GroupClient) GetMemberGroupsComplete(ctx context.Context, id stable.GroupId, input GetMemberGroupsRequest, options GetMemberGroupsOperationOptions) (result GetMemberGroupsCompleteResult, err error) {
	items := make([]string, 0)
