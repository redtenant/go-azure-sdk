...
func (c GroupClient) GetMemberObjects(ctx context.Context, id stable.GroupId, input GetMemberObjectsRequest, options GetMemberObjectsOperationOptions) (result GetMemberObjectsOperationResponse, err error) {
...
func (c GroupClient) GetMemberObjectsComplete(ctx context.Context, id stable.GroupId, input GetMemberObjectsRequest, options GetMemberObjectsOperationOptions) (result GetMemberObjectsCompleteResult, err error) {
	items := make([]string, 0)
