...
func (c GroupClient) ListGetsAvailableExtensionProperties(ctx context.Context, input ListGetsAvailableExtensionPropertiesRequest, options ListGetsAvailableExtensionPropertiesOperationOptions) (result ListGetsAvailableExtensionPropertiesOperationResponse, err error) {
...
func (c GroupClient) ListGetsAvailableExtensionPropertiesComplete(ctx context.Context, input ListGetsAvailableExtensionPropertiesRequest, options ListGetsAvailableExtensionPropertiesOperationOptions) (ListGetsAvailableExtensionPropertiesCompleteResult, error) {
