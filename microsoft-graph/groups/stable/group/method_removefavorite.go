...
func (c GroupClient) RemoveFavorite(ctx context.Context, id stable.GroupId, options RemoveFavoriteOperationOptions) (result RemoveFavoriteOperationResponse, err error) {
