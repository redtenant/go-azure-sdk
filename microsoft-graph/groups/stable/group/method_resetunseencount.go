...
func (c GroupClient) ResetUnseenCount(ctx context.Context, id stable.GroupId, options ResetUnseenCountOperationOptions) (result ResetUnseenCountOperationResponse, err error) {
