...
func (c GroupClient) RetryServiceProvisioning(ctx context.Context, id stable.GroupId, options RetryServiceProvisioningOperationOptions) (result RetryServiceProvisioningOperationResponse, err error) {
