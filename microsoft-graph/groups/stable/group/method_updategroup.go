...
func (c GroupClient) UpdateGroup(ctx context.Context, id stable.GroupId, input stable.Group, options UpdateGroupOperationOptions) (result UpdateGroupOperationResponse, err error) {
