...
// ListMemberRefs - List group members. Get a list of the group's direct members. A group can have users, organizational
// contacts, devices, service principals and other groups as members. This operation is not transitive.
