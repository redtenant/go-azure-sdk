...
func (c MembersWithLicenseErrorClient) ListMembersWithLicenseErrors(ctx context.Context, id stable.GroupId, options ListMembersWithLicenseErrorsOperationOptions) (result ListMembersWithLicenseErrorsOperationResponse, err error) {
...
func (c MembersWithLicenseErrorClient) ListMembersWithLicenseErrorsComplete(ctx context.Context, id stable.GroupId, options ListMembersWithLicenseErrorsOperationOptions) (ListMembersWithLicenseErrorsCompleteResult, error) {
...
func (c MembersWithLicenseErrorClient) ListMembersWithLicenseErrorsCompleteMatchingPredicate(ctx context.Context, id stable.GroupId, options ListMembersWithLicenseErrorsOperationOptions, predicate DirectoryObjectOperationPredicate) (result ListMembersWithLicenseErrorsCompleteResult, err error) {
