...
func (c OnenoteClient) DeleteOnenote(ctx context.Context, id stable.GroupId, options DeleteOnenoteOperationOptions) (result DeleteOnenoteOperationResponse, err error) {
