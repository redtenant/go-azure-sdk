...
func (c OnenoteNotebookClient) CreateOnenoteNotebook(ctx context.Context, id stable.GroupId, input stable.Notebook, options CreateOnenoteNotebookOperationOptions) (result CreateOnenoteNotebookOperationResponse, err error) {
