...
func (c OnenoteNotebookClient) DeleteOnenoteNotebook(ctx context.Context, id stable.GroupIdOnenoteNotebookId, options DeleteOnenoteNotebookOperationOptions) (result DeleteOnenoteNotebookOperationResponse, err error) {
