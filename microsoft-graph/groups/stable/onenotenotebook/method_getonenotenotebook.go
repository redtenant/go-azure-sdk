...
func DefaultGetOnenoteNotebookOperationOptions() GetOnenoteNotebookOperationOptions {
	return GetOnenoteNotebookOperationOptions{}
}
...
// GetOnenoteNotebook - Get notebooks from groups. The collection of OneNote notebooks that are owned by the user or
// group. Read-only. Nullable.
func (c OnenoteNotebookClient) GetOnenoteNotebook(ctx context.Context, id stable.GroupIdOnenoteNotebookId, options GetOnenoteNotebookOperationOptions) (result GetOnenoteNotebookOperationResponse, err error) {
