...
func (c OnenoteNotebookClient) GetOnenoteNotebooksCount(ctx context.Context, id stable.GroupId, options GetOnenoteNotebooksCountOperationOptions) (result GetOnenoteNotebooksCountOperationResponse, err error) {
