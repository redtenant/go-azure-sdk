...
func (c OnenoteNotebookClient) UpdateOnenoteNotebook(ctx context.Context, id stable.GroupIdOnenoteNotebookId, input stable.Notebook, options UpdateOnenoteNotebookOperationOptions) (result UpdateOnenoteNotebookOperationResponse, err error) {
