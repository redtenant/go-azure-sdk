...
// CreateOnenoteNotebookSectionGroup - Create new navigation property to sectionGroups for groups
func (c OnenoteNotebookSectionGroupClient) CreateOnenoteNotebookSectionGroup(ctx context.Context, id stable.GroupIdOnenoteNotebookId, input stable.SectionGroup, options CreateOnenoteNotebookSectionGroupOperationOptions) (result CreateOnenoteNotebookSectionGroupOperationResponse, err error) {
