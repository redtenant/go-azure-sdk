...
func DefaultDeleteOnenoteNotebookSectionGroupOperationOptions() DeleteOnenoteNotebookSectionGroupOperationOptions {
	return DeleteOnenoteNotebookSectionGroupOperationOptions{}
}
...
// DeleteOnenoteNotebookSectionGroup - Delete navigation property sectionGroups for groups
func (c OnenoteNotebookSectionGroupClient) DeleteOnenoteNotebookSectionGroup(ctx context.Context, id stable.GroupIdOnenoteNotebookIdSectionGroupId, options DeleteOnenoteNotebookSectionGroupOperationOptions) (result DeleteOnenoteNotebookSectionGroupOperationResponse, err error) {
