...
// GetOnenoteNotebookSectionGroup - Get sectionGroups from groups. The section groups in the notebook. Read-only.
// Nullable.
func (c OnenoteNotebookSectionGroupClient) GetOnenoteNotebookSectionGroup(ctx context.Context, id stable.GroupIdOnenoteNotebookIdSectionGroupId, options GetOnenoteNotebookSectionGroupOperationOptions) (result GetOnenoteNotebookSectionGroupOperationResponse, err error) {
