...
func DefaultGetOnenoteNotebookSectionGroupsCountOperationOptions() GetOnenoteNotebookSectionGroupsCountOperationOptions {
	return GetOnenoteNotebookSectionGroupsCountOperationOptions{}
}
...
func (c OnenoteNotebookSectionGroupClient) GetOnenoteNotebookSectionGroupsCount(ctx context.Context, id stable.GroupIdOnenoteNotebookId, options GetOnenoteNotebookSectionGroupsCountOperationOptions) (result GetOnenoteNotebookSectionGroupsCountOperationResponse, err error) {
