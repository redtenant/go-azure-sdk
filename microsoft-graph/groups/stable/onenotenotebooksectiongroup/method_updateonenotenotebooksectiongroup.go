...
func (c OnenoteNotebookSectionGroupClient) UpdateOnenoteNotebookSectionGroup(ctx context.Context, id stable.GroupIdOnenoteNotebookIdSectionGroupId, input stable.SectionGroup, options UpdateOnenoteNotebookSectionGroupOperationOptions) (result UpdateOnenoteNotebookSectionGroupOperationResponse, err error) {
