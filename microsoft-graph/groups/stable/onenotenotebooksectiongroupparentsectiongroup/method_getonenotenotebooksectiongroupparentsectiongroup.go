...
// GetOnenoteNotebookSectionGroupParentSectionGroup - Get parentSectionGroup from groups. The section group that
// contains the section group. Read-only.
func (c OnenoteNotebookSectionGroupParentSectionGroupClient) GetOnenoteNotebookSectionGroupParentSectionGroup(ctx context.Context, id stable.GroupIdOnenoteNotebookIdSectionGroupId, options GetOnenoteNotebookSectionGroupParentSectionGroupOperationOptions) (result GetOnenoteNotebookSectionGroupParentSectionGroupOperationResponse, err error) {
