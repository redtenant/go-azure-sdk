...
// CopyOnenoteNotebookSectionGroupSectionToSectionGroup - Invoke action copyToSectionGroup. For Copy operations, you
// follow an asynchronous calling pattern: First call the Copy action, and then poll the operation endpoint for the
// result.
func (c OnenoteNotebookSectionGroupSectionClient) CopyOnenoteNotebookSectionGroupSectionToSectionGroup(ctx context.Context, id stable.GroupIdOnenoteNotebookIdSectionGroupIdSectionId, input CopyOnenoteNotebookSectionGroupSectionToSectionGroupRequest, options CopyOnenoteNotebookSectionGroupSectionToSectionGroupOperationOptions) (result CopyOnenoteNotebookSectionGroupSectionToSectionGroupOperationResponse, err error) {
