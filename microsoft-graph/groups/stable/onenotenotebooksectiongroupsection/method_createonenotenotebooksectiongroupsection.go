...
func DefaultCreateOnenoteNotebookSectionGroupSectionOperationOptions() CreateOnenoteNotebookSectionGroupSectionOperationOptions {
	return CreateOnenoteNotebookSectionGroupSectionOperationOptions{}
}
...
// CreateOnenoteNotebookSectionGroupSection - Create new navigation property to sections for groups
func (c OnenoteNotebookSectionGroupSectionClient) CreateOnenoteNotebookSectionGroupSection(ctx context.Context, id stable.GroupIdOnenoteNotebookIdSectionGroupId, input stable.OnenoteSection, options CreateOnenoteNotebookSectionGroupSectionOperationOptions) (result CreateOnenoteNotebookSectionGroupSectionOperationResponse, err error) {
