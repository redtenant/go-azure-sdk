...
func DefaultGetOnenoteNotebookSectionGroupSectionOperationOptions() GetOnenoteNotebookSectionGroupSectionOperationOptions {
	return GetOnenoteNotebookSectionGroupSectionOperationOptions{}
}
...
// GetOnenoteNotebookSectionGroupSection - Get sections from groups. The sections in the section group. Read-only.
// Nullable.
func (c OnenoteNotebookSectionGroupSectionClient) GetOnenoteNotebookSectionGroupSection(ctx context.Context, id stable.GroupIdOnenoteNotebookIdSectionGroupIdSectionId, options GetOnenoteNotebookSectionGroupSectionOperationOptions) (result GetOnenoteNotebookSectionGroupSectionOperationResponse, err error) {
