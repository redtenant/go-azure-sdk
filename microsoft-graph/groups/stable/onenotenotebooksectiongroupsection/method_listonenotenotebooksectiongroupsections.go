...
// ListOnenoteNotebookSectionGroupSections - Get sections from groups. The sections in the section group. Read-only.
// Nullable.
func (c OnenoteNotebookSectionGroupSectionClient) ListOnenoteNotebookSectionGroupSections(ctx context.Context, id stable.GroupIdOnenoteNotebookIdSectionGroupId, options ListOnenoteNotebookSectionGroupSectionsOperationOptions) (result ListOnenoteNotebookSectionGroupSectionsOperationResponse, err error) {
...
func (c OnenoteNotebookSectionGroupSectionClient) ListOnenoteNotebookSectionGroupSectionsComplete(ctx context.Context, id stable.GroupIdOnenoteNotebookIdSectionGroupId, options ListOnenoteNotebookSectionGroupSectionsOperationOptions) (ListOnenoteNotebookSectionGroupSectionsCompleteResult, error) {
