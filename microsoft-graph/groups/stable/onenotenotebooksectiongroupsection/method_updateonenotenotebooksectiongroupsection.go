...
// UpdateOnenoteNotebookSectionGroupSection - Update the navigation property sections in groups
func (c OnenoteNotebookSectionGroupSectionClient) UpdateOnenoteNotebookSectionGroupSection(ctx context.Context, id stable.GroupIdOnenoteNotebookIdSectionGroupIdSectionId, input stable.OnenoteSection, options UpdateOnenoteNotebookSectionGroupSectionOperationOptions) (result UpdateOnenoteNotebookSectionGroupSectionOperationResponse, err error) {
