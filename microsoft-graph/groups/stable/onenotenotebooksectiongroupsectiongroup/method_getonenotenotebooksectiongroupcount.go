...
func (c OnenoteNotebookSectionGroupSectionGroupClient) GetOnenoteNotebookSectionGroupCount(ctx context.Context, id stable.GroupIdOnenoteNotebookIdSectionGroupId, options GetOnenoteNotebookSectionGroupCountOperationOptions) (result GetOnenoteNotebookSectionGroupCountOperationResponse, err error) {
