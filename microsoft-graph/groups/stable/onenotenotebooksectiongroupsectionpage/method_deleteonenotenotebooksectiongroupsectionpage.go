...
// DeleteOnenoteNotebookSectionGroupSectionPage - Delete navigation property pages for groups
func (c OnenoteNotebookSectionGroupSectionPageClient) DeleteOnenoteNotebookSectionGroupSectionPage(ctx context.Context, id stable.GroupIdOnenoteNotebookIdSectionGroupIdSectionIdPageId, options DeleteOnenoteNotebookSectionGroupSectionPageOperationOptions) (result DeleteOnenoteNotebookSectionGroupSectionPageOperationResponse, err error) {
