...
// UpdateOnenoteNotebookSectionGroupSectionPage - Update the navigation property pages in groups
func (c OnenoteNotebookSectionGroupSectionPageClient) UpdateOnenoteNotebookSectionGroupSectionPage(ctx context.Context, id stable.GroupIdOnenoteNotebookIdSectionGroupIdSectionIdPageId, input stable.OnenotePage, options UpdateOnenoteNotebookSectionGroupSectionPageOperationOptions) (result UpdateOnenoteNotebookSectionGroupSectionPageOperationResponse, err error) {
