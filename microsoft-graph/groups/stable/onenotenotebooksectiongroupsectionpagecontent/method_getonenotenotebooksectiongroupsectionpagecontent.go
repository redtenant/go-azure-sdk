...
// GetOnenoteNotebookSectionGroupSectionPageContent - Get content for the navigation property pages from groups. The
// page's HTML content.
func (c OnenoteNotebookSectionGroupSectionPageContentClient) GetOnenoteNotebookSectionGroupSectionPageContent(ctx context.Context, id stable.GroupIdOnenoteNotebookIdSectionGroupIdSectionIdPageId, options GetOnenoteNotebookSectionGroupSectionPageContentOperationOptions) (result GetOnenoteNotebookSectionGroupSectionPageContentOperationResponse, err error) {
