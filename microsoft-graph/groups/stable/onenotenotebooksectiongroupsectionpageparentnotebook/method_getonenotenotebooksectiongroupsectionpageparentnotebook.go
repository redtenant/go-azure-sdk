...
// GetOnenoteNotebookSectionGroupSectionPageParentNotebook - Get parentNotebook from groups. The notebook that contains
// the page. Read-only.
func (c OnenoteNotebookSectionGroupSectionPageParentNotebookClient) GetOnenoteNotebookSectionGroupSectionPageParentNotebook(ctx context.Context, id stable.GroupIdOnenoteNotebookIdSectionGroupIdSectionIdPageId, options GetOnenoteNotebookSectionGroupSectionPageParentNotebookOperationOptions) (result GetOnenoteNotebookSectionGroupSectionPageParentNotebookOperationResponse, err error) {
