...
// DeleteOnenoteNotebookSectionPageContent - Delete content for the navigation property pages in groups. The page's HTML
// content.
func (c OnenoteNotebookSectionPageContentClient) DeleteOnenoteNotebookSectionPageContent(ctx context.Context, id stable.GroupIdOnenoteNotebookIdSectionIdPageId, options DeleteOnenoteNotebookSectionPageContentOperationOptions) (result DeleteOnenoteNotebookSectionPageContentOperationResponse, err error) {
