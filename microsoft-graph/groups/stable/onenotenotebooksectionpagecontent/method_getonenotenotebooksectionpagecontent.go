...
// GetOnenoteNotebookSectionPageContent - Get content for the navigation property pages from groups. The page's HTML
// content.
func (c OnenoteNotebookSectionPageContentClient) GetOnenoteNotebookSectionPageContent(ctx context.Context, id stable.GroupIdOnenoteNotebookIdSectionIdPageId, options GetOnenoteNotebookSectionPageContentOperationOptions) (result GetOnenoteNotebookSectionPageContentOperationResponse, err error) {
