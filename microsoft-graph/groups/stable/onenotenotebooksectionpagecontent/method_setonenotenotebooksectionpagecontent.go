...
// SetOnenoteNotebookSectionPageContent - Update content for the navigation property pages in groups. The page's HTML
// content.
func (c OnenoteNotebookSectionPageContentClient) SetOnenoteNotebookSectionPageContent(ctx context.Context, id stable.GroupIdOnenoteNotebookIdSectionIdPageId, input []byte, options SetOnenoteNotebookSectionPageContentOperationOptions) (result SetOnenoteNotebookSectionPageContentOperationResponse, err error) {
