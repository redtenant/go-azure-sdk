...
// GetOnenoteNotebookSectionPageParentSection - Get parentSection from groups. The section that contains the page.
// Read-only.
func (c OnenoteNotebookSectionPageParentSectionClient) GetOnenoteNotebookSectionPageParentSection(ctx context.Context, id stable.GroupIdOnenoteNotebookIdSectionIdPageId, options GetOnenoteNotebookSectionPageParentSectionOperationOptions) (result GetOnenoteNotebookSectionPageParentSectionOperationResponse, err error) {
