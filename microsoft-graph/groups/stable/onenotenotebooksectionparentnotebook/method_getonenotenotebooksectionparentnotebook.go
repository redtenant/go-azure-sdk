...
// GetOnenoteNotebookSectionParentNotebook - Get parentNotebook from groups. The notebook that contains the section.
// Read-only.
func (c OnenoteNotebookSectionParentNotebookClient) GetOnenoteNotebookSectionParentNotebook(ctx context.Context, id stable.GroupIdOnenoteNotebookIdSectionId, options GetOnenoteNotebookSectionParentNotebookOperationOptions) (result GetOnenoteNotebookSectionParentNotebookOperationResponse, err error) {
