...
// GetOnenoteNotebookSectionParentSectionGroup - Get parentSectionGroup from groups. The section group that contains the
// section. Read-only.
func (c OnenoteNotebookSectionParentSectionGroupClient) GetOnenoteNotebookSectionParentSectionGroup(ctx context.Context, id stable.GroupIdOnenoteNotebookIdSectionId, options GetOnenoteNotebookSectionParentSectionGroupOperationOptions) (result GetOnenoteNotebookSectionParentSectionGroupOperationResponse, err error) {
