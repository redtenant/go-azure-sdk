...
// DeleteOnenoteOperation - Delete navigation property operations for groups
func (c OnenoteOperationClient) DeleteOnenoteOperation(ctx context.Context, id stable.GroupIdOnenoteOperationId, options DeleteOnenoteOperationOperationOptions) (result DeleteOnenoteOperationOperationResponse, err error) {
