...
// GetOnenoteOperation - Get operations from groups. The status of OneNote operations. Getting an operations collection
...
func (c OnenoteOperationClient) GetOnenoteOperation(ctx context.Context, id stable.GroupIdOnenoteOperationId, options GetOnenoteOperationOperationOptions) (result GetOnenoteOperationOperationResponse, err error) {
