...
// UpdateOnenoteOperation - Update the navigation property operations in groups
func (c OnenoteOperationClient) UpdateOnenoteOperation(ctx context.Context, id stable.GroupIdOnenoteOperationId, input stable.OnenoteOperation, options UpdateOnenoteOperationOperationOptions) (result UpdateOnenoteOperationOperationResponse, err error) {
