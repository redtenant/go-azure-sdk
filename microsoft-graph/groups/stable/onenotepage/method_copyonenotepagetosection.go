...
// result.
func (c OnenotePageClient) CopyOnenotePageToSection(ctx context.Context, id stable.GroupIdOnenotePageId, input CopyOnenotePageToSectionRequest, options CopyOnenotePageToSectionOperationOptions) (result CopyOnenotePageToSectionOperationResponse, err error) {
