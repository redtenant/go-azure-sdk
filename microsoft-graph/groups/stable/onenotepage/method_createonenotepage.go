...
func (c OnenotePageClient) CreateOnenotePage(ctx context.Context, id stable.GroupId, input stable.OnenotePage, options CreateOnenotePageOperationOptions) (result CreateOnenotePageOperationResponse, err error) {
