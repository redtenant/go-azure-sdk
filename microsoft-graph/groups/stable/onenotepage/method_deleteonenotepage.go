...
func (c OnenotePageClient) DeleteOnenotePage(ctx context.Context, id stable.GroupIdOnenotePageId, options DeleteOnenotePageOperationOptions) (result DeleteOnenotePageOperationResponse, err error) {
