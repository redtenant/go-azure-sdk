...
// Read-only. Nullable.
func (c OnenotePageClient) GetOnenotePage(ctx context.Context, id stable.GroupIdOnenotePageId, options GetOnenotePageOperationOptions) (result GetOnenotePageOperationResponse, err error) {
