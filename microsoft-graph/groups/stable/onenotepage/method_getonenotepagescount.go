...
func DefaultGetOnenotePagesCountOperationOptions() GetOnenotePagesCountOperationOptions {
	return GetOnenotePagesCountOperationOptions{}
}
...
func (c OnenotePageClient) GetOnenotePagesCount(ctx context.Context, id stable.GroupId, options GetOnenotePagesCountOperationOptions) (result GetOnenotePagesCountOperationResponse, err error) {
