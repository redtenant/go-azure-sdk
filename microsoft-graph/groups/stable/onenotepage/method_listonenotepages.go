...
// ListOnenotePages - Get pages from groups. The pages in all OneNote notebooks that are owned by the user or group.
// Read-only. Nullable.
func (c OnenotePageClient) ListOnenotePages(ctx context.Context, id stable.GroupId, options ListOnenotePagesOperationOptions) (result ListOnenotePagesOperationResponse, err error) {
...
func (c OnenotePageClient) ListOnenotePagesComplete(ctx context.Context, id stable.GroupId, options ListOnenotePagesOperationOptions) (ListOnenotePagesCompleteResult, error) {
...
func (c OnenotePageClient) ListOnenotePagesCompleteMatchingPredicate(ctx context.Context, id stable.GroupId, options ListOnenotePagesOperationOptions, predicate OnenotePageOperationPredicate) (result ListOnenotePagesCompleteResult, err error) {
