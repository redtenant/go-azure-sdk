...
func (c OnenotePageClient) UpdateOnenotePage(ctx context.Context, id stable.GroupIdOnenotePageId, input stable.OnenotePage, options UpdateOnenotePageOperationOptions) (result UpdateOnenotePageOperationResponse, err error) {
