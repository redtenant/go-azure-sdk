...
func (c OnenotePageContentClient) DeleteOnenotePageContent(ctx context.Context, id stable.GroupIdOnenotePageId, options DeleteOnenotePageContentOperationOptions) (result DeleteOnenotePageContentOperationResponse, err error) {
