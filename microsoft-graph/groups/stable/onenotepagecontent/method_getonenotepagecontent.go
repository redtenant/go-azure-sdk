...
// GetOnenotePageContent - Get content for the navigation property pages from groups. The page's HTML content.
func (c OnenotePageContentClient) GetOnenotePageContent(ctx context.Context, id stable.GroupIdOnenotePageId, options GetOnenotePageContentOperationOptions) (result GetOnenotePageContentOperationResponse, err error) {
