...
// SetOnenotePageContent - Update content for the navigation property pages in groups. The page's HTML content.
func (c OnenotePageContentClient) SetOnenotePageContent(ctx context.Context, id stable.GroupIdOnenotePageId, input []byte, options SetOnenotePageContentOperationOptions) (result SetOnenotePageContentOperationResponse, err error) {
