...
// CreateOnenoteResource - Create new navigation property to resources for groups
func (c OnenoteResourceClient) CreateOnenoteResource(ctx context.Context, id stable.GroupId, input stable.OnenoteResource, options CreateOnenoteResourceOperationOptions) (result CreateOnenoteResourceOperationResponse, err error) {
