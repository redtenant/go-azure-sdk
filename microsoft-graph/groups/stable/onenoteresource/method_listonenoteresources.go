...
// ListOnenoteResources - Get resources from groups. The image and other file resources in OneNote pages. Getting a
// resources collection isn't supported, but you can get the binary content of a specific resource. Read-only. Nullable.
func (c OnenoteResourceClient) ListOnenoteResources(ctx context.Context, id stable.GroupId, options ListOnenoteResourcesOperationOptions) (result ListOnenoteResourcesOperationResponse, err error) {
...
func (c OnenoteResourceClient) ListOnenoteResourcesComplete(ctx context.Context, id stable.GroupId, options ListOnenoteResourcesOperationOptions) (ListOnenoteResourcesCompleteResult, error) {
...
func (c OnenoteResourceClient) ListOnenoteResourcesCompleteMatchingPredicate(ctx context.Context, id stable.GroupId, options ListOnenoteResourcesOperationOptions, predicate OnenoteResourceOperationPredicate) (result ListOnenoteResourcesCompleteResult, err error) {
