...
func (c OnenoteResourceClient) UpdateOnenoteResource(ctx context.Context, id stable.GroupIdOnenoteResourceId, input stable.OnenoteResource, options UpdateOnenoteResourceOperationOptions) (result UpdateOnenoteResourceOperationResponse, err error) {
