...
func (c OnenoteSectionClient) CopyOnenoteSectionToNotebook(ctx context.Context, id stable.GroupIdOnenoteSectionId, input CopyOnenoteSectionToNotebookRequest, options CopyOnenoteSectionToNotebookOperationOptions) (result CopyOnenoteSectionToNotebookOperationResponse, err error) {
