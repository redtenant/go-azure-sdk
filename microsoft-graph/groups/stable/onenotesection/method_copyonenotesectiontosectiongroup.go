...
func (c OnenoteSectionClient) CopyOnenoteSectionToSectionGroup(ctx context.Context, id stable.GroupIdOnenoteSectionId, input CopyOnenoteSectionToSectionGroupRequest, options CopyOnenoteSectionToSectionGroupOperationOptions) (result CopyOnenoteSectionToSectionGroupOperationResponse, err error) {
