...
func (c OnenoteSectionClient) CreateOnenoteSection(ctx context.Context, id stable.GroupId, input stable.OnenoteSection, options CreateOnenoteSectionOperationOptions) (result CreateOnenoteSectionOperationResponse, err error) {
