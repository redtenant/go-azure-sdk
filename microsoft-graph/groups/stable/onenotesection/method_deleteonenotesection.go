...
func (c OnenoteSectionClient) DeleteOnenoteSection(ctx context.Context, id stable.GroupIdOnenoteSectionId, options DeleteOnenoteSectionOperationOptions) (result DeleteOnenoteSectionOperationResponse, err error) {
