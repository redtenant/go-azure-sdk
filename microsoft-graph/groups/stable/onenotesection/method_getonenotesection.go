...
func DefaultGetOnenoteSectionOperationOptions() GetOnenoteSectionOperationOptions {
	return GetOnenoteSectionOperationOptions{}
}
...
// GetOnenoteSection - Get sections from groups. The sections in all OneNote notebooks that are owned by the user or
// group. Read-only. Nullable.
func (c OnenoteSectionClient) GetOnenoteSection(ctx context.Context, id stable.GroupIdOnenoteSectionId, options GetOnenoteSectionOperationOptions) (result GetOnenoteSectionOperationResponse, err error) {
