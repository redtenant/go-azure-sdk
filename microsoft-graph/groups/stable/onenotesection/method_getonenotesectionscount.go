...
func (c OnenoteSectionClient) GetOnenoteSectionsCount(ctx context.Context, id stable.GroupId, options GetOnenoteSectionsCountOperationOptions) (result GetOnenoteSectionsCountOperationResponse, err error) {
