...
// ListOnenoteSections - Get sections from groups. The sections in all OneNote notebooks that are owned by the user or
// group. Read-only. Nullable.
func (c OnenoteSectionClient) ListOnenoteSections(ctx context.Context, id stable.GroupId, options ListOnenoteSectionsOperationOptions) (result ListOnenoteSectionsOperationResponse, err error) {
...
func (c OnenoteSectionClient) ListOnenoteSectionsComplete(ctx context.Context, id stable.GroupId, options ListOnenoteSectionsOperationOptions) (ListOnenoteSectionsCompleteResult, error) {
...
func (c OnenoteSectionClient) ListOnenoteSectionsCompleteMatchingPredicate(ctx context.Context, id stable.GroupId, options ListOnenoteSectionsOperationOptions, predicate OnenoteSectionOperationPredicate) (result ListOnenoteSectionsCompleteResult, err error) {
