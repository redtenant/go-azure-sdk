...
func (c OnenoteSectionClient) UpdateOnenoteSection(ctx context.Context, id stable.GroupIdOnenoteSectionId, input stable.OnenoteSection, options UpdateOnenoteSectionOperationOptions) (result UpdateOnenoteSectionOperationResponse, err error) {
