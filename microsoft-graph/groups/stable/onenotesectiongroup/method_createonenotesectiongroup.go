...
// CreateOnenoteSectionGroup - Create new navigation property to sectionGroups for groups
func (c OnenoteSectionGroupClient) CreateOnenoteSectionGroup(ctx context.Context, id stable.GroupId, input stable.SectionGroup, options CreateOnenoteSectionGroupOperationOptions) (result CreateOnenoteSectionGroupOperationResponse, err error) {
