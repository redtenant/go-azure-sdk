...
// DeleteOnenoteSectionGroup - Delete navigation property sectionGroups for groups
func (c OnenoteSectionGroupClient) DeleteOnenoteSectionGroup(ctx context.Context, id stable.GroupIdOnenoteSectionGroupId, options DeleteOnenoteSectionGroupOperationOptions) (result DeleteOnenoteSectionGroupOperationResponse, err error) {
