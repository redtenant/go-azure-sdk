...
// GetOnenoteSectionGroup - Get sectionGroups from groups. The section groups in all OneNote notebooks that are owned by
// the user or group. Read-only. Nullable.
func (c OnenoteSectionGroupClient) GetOnenoteSectionGroup(ctx context.Context, id stable.GroupIdOnenoteSectionGroupId, options GetOnenoteSectionGroupOperationOptions) (result GetOnenoteSectionGroupOperationResponse, err error) {
