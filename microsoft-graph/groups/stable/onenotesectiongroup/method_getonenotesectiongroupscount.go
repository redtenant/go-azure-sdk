...
func (c OnenoteSectionGroupClient) GetOnenoteSectionGroupsCount(ctx context.Context, id stable.GroupId, options GetOnenoteSectionGroupsCountOperationOptions) (result GetOnenoteSectionGroupsCountOperationResponse, err error) {
