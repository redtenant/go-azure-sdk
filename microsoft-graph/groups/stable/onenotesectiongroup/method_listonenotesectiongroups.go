...
func (c OnenoteSectionGroupClient) ListOnenoteSectionGroups(ctx context.Context, id stable.GroupId, options ListOnenoteSectionGroupsOperationOptions) (result ListOnenoteSectionGroupsOperationResponse, err error) {
...
func (c OnenoteSectionGroupClient) ListOnenoteSectionGroupsComplete(ctx context.Context, id stable.GroupId, options ListOnenoteSectionGroupsOperationOptions) (ListOnenoteSectionGroupsCompleteResult, error) {
...
func (c OnenoteSectionGroupClient) ListOnenoteSectionGroupsCompleteMatchingPredicate(ctx context.Context, id stable.GroupId, options ListOnenoteSectionGroupsOperationOptions, predicate SectionGroupOperationPredicate) (result ListOnenoteSectionGroupsCompleteResult, err error) {
