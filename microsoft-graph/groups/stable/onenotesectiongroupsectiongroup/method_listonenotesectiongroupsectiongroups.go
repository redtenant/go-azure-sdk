...
// Nullable.
func (c OnenoteSectionGroupSectionGroupClient) ListOnenoteSectionGroupSectionGroups(ctx context.Context, id stable.GroupIdOnenoteSectionGroupId, options ListOnenoteSectionGroupSectionGroupsOperationOptions) (result ListOnenoteSectionGroupSectionGroupsOperationResponse, err error) {
...
func (c OnenoteSectionGroupSectionGroupClient) ListOnenoteSectionGroupSectionGroupsComplete(ctx context.Context, id stable.GroupIdOnenoteSectionGroupId, options ListOnenoteSectionGroupSectionGroupsOperationOptions) (ListOnenoteSectionGroupSectionGroupsCompleteResult, error) {
