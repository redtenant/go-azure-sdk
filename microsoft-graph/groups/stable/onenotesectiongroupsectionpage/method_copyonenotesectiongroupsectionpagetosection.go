...
func DefaultCopyOnenoteSectionGroupSectionPageToSectionOperationOptions() CopyOnenoteSectionGroupSectionPageToSectionOperationOptions {
	return CopyOnenoteSectionGroupSectionPageToSectionOperationOptions{}
}
...
// CopyOnenoteSectionGroupSectionPageToSection - Invoke action copyToSection. Copy a page to a specific section. For
...
func (c OnenoteSectionGroupSectionPageClient) CopyOnenoteSectionGroupSectionPageToSection(ctx context.Context, id stable.GroupIdOnenoteSectionGroupIdSectionIdPageId, input CopyOnenoteSectionGroupSectionPageToSectionRequest, options CopyOnenoteSectionGroupSectionPageToSectionOperationOptions) (result CopyOnenoteSectionGroupSectionPageToSectionOperationResponse, err error) {
