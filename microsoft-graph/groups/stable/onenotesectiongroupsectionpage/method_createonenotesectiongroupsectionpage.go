...
// CreateOnenoteSectionGroupSectionPage - Create new navigation property to pages for groups
func (c OnenoteSectionGroupSectionPageClient) CreateOnenoteSectionGroupSectionPage(ctx context.Context, id stable.GroupIdOnenoteSectionGroupIdSectionId, input stable.OnenotePage, options CreateOnenoteSectionGroupSectionPageOperationOptions) (result CreateOnenoteSectionGroupSectionPageOperationResponse, err error) {
