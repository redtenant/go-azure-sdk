...
func (c OnenoteSectionGroupSectionPageClient) CreateOnenoteSectionGroupSectionPageOnenotePatchContent(ctx context.Context, id stable.GroupIdOnenoteSectionGroupIdSectionIdPageId, input CreateOnenoteSectionGroupSectionPageOnenotePatchContentRequest, options CreateOnenoteSectionGroupSectionPageOnenotePatchContentOperationOptions) (result CreateOnenoteSectionGroupSectionPageOnenotePatchContentOperationResponse, err error) {
