...
func DefaultDeleteOnenoteSectionGroupSectionPageOperationOptions() DeleteOnenoteSectionGroupSectionPageOperationOptions {
	return DeleteOnenoteSectionGroupSectionPageOperationOptions{}
}
...
// DeleteOnenoteSectionGroupSectionPage - Delete navigation property pages for groups
func (c OnenoteSectionGroupSectionPageClient) DeleteOnenoteSectionGroupSectionPage(ctx context.Context, id stable.GroupIdOnenoteSectionGroupIdSectionIdPageId, options DeleteOnenoteSectionGroupSectionPageOperationOptions) (result DeleteOnenoteSectionGroupSectionPageOperationResponse, err error) {
