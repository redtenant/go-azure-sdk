...
// GetOnenoteSectionGroupSectionPage - Get pages from groups. The collection of pages in the section. Read-only.
// Nullable.
func (c OnenoteSectionGroupSectionPageClient) GetOnenoteSectionGroupSectionPage(ctx context.Context, id stable.GroupIdOnenoteSectionGroupIdSectionIdPageId, options GetOnenoteSectionGroupSectionPageOperationOptions) (result GetOnenoteSectionGroupSectionPageOperationResponse, err error) {
