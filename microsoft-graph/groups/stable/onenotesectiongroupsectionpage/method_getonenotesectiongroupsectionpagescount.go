...
func (c OnenoteSectionGroupSectionPageClient) GetOnenoteSectionGroupSectionPagesCount(ctx context.Context, id stable.GroupIdOnenoteSectionGroupIdSectionId, options GetOnenoteSectionGroupSectionPagesCountOperationOptions) (result GetOnenoteSectionGroupSectionPagesCountOperationResponse, err error) {
