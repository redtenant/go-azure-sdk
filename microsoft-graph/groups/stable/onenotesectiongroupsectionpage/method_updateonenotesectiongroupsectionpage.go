...
// UpdateOnenoteSectionGroupSectionPage - Update the navigation property pages in groups
func (c OnenoteSectionGroupSectionPageClient) UpdateOnenoteSectionGroupSectionPage(ctx context.Context, id stable.GroupIdOnenoteSectionGroupIdSectionIdPageId, input stable.OnenotePage, options UpdateOnenoteSectionGroupSectionPageOperationOptions) (result UpdateOnenoteSectionGroupSectionPageOperationResponse, err error) {
