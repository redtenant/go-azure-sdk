...
// DeleteOnenoteSectionGroupSectionPageContent - Delete content for the navigation property pages in groups. The page's
// HTML content.
func (c OnenoteSectionGroupSectionPageContentClient) DeleteOnenoteSectionGroupSectionPageContent(ctx context.Context, id stable.GroupIdOnenoteSectionGroupIdSectionIdPageId, options DeleteOnenoteSectionGroupSectionPageContentOperationOptions) (result DeleteOnenoteSectionGroupSectionPageContentOperationResponse, err error) {
