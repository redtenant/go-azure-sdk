...
// GetOnenoteSectionGroupSectionPageContent - Get content for the navigation property pages from groups. The page's HTML
// content.
func (c OnenoteSectionGroupSectionPageContentClient) GetOnenoteSectionGroupSectionPageContent(ctx context.Context, id stable.GroupIdOnenoteSectionGroupIdSectionIdPageId, options GetOnenoteSectionGroupSectionPageContentOperationOptions) (result GetOnenoteSectionGroupSectionPageContentOperationResponse, err error) {
