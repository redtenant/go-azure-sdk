...
// GetOnenoteSectionGroupSectionPageParentNotebook - Get parentNotebook from groups. The notebook that contains the
// page. Read-only.
func (c OnenoteSectionGroupSectionPageParentNotebookClient) GetOnenoteSectionGroupSectionPageParentNotebook(ctx context.Context, id stable.GroupIdOnenoteSectionGroupIdSectionIdPageId, options GetOnenoteSectionGroupSectionPageParentNotebookOperationOptions) (result GetOnenoteSectionGroupSectionPageParentNotebookOperationResponse, err error) {
