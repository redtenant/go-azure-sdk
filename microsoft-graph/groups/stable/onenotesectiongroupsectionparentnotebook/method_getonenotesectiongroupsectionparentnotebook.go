...
// GetOnenoteSectionGroupSectionParentNotebook - Get parentNotebook from groups. The notebook that contains the section.
// Read-only.
func (c OnenoteSectionGroupSectionParentNotebookClient) GetOnenoteSectionGroupSectionParentNotebook(ctx context.Context, id stable.GroupIdOnenoteSectionGroupIdSectionId, options GetOnenoteSectionGroupSectionParentNotebookOperationOptions) (result GetOnenoteSectionGroupSectionParentNotebookOperationResponse, err error) {
