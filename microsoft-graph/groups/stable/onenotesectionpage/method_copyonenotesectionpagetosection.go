...
func (c OnenoteSectionPageClient) CopyOnenoteSectionPageToSection(ctx context.Context, id stable.GroupIdOnenoteSectionIdPageId, input CopyOnenoteSectionPageToSectionRequest, options CopyOnenoteSectionPageToSectionOperationOptions) (result CopyOnenoteSectionPageToSectionOperationResponse, err error) {
