...
func (c OnenoteSectionPageClient) DeleteOnenoteSectionPage(ctx context.Context, id stable.GroupIdOnenoteSectionIdPageId, options DeleteOnenoteSectionPageOperationOptions) (result DeleteOnenoteSectionPageOperationResponse, err error) {
