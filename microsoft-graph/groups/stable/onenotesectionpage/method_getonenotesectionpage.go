...
func DefaultGetOnenoteSectionPageOperationOptions() GetOnenoteSectionPageOperationOptions {
	return GetOnenoteSectionPageOperationOptions{}
}
...
func (c OnenoteSectionPageClient) GetOnenoteSectionPage(ctx context.Context, id stable.GroupIdOnenoteSectionIdPageId, options GetOnenoteSectionPageOperationOptions) (result GetOnenoteSectionPageOperationResponse, err error) {
