...
func (c OnenoteSectionPageClient) GetOnenoteSectionPagesCount(ctx context.Context, id stable.GroupIdOnenoteSectionId, options GetOnenoteSectionPagesCountOperationOptions) (result GetOnenoteSectionPagesCountOperationResponse, err error) {
