...
func (c OnenoteSectionPageClient) ListOnenoteSectionPages(ctx context.Context, id stable.GroupIdOnenoteSectionId, options ListOnenoteSectionPagesOperationOptions) (result ListOnenoteSectionPagesOperationResponse, err error) {
...
func (c OnenoteSectionPageClient) ListOnenoteSectionPagesComplete(ctx context.Context, id stable.GroupIdOnenoteSectionId, options ListOnenoteSectionPagesOperationOptions) (ListOnenoteSectionPagesCompleteResult, error) {
...
func (c OnenoteSectionPageClient) ListOnenoteSectionPagesCompleteMatchingPredicate(ctx context.Context, id stable.GroupIdOnenoteSectionId, options ListOnenoteSectionPagesOperationOptions, predicate OnenotePageOperationPredicate) (result ListOnenoteSectionPagesCompleteResult, err error) {
