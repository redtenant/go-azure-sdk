...
func (c OnenoteSectionPageClient) UpdateOnenoteSectionPage(ctx context.Context, id stable.GroupIdOnenoteSectionIdPageId, input stable.OnenotePage, options UpdateOnenoteSectionPageOperationOptions) (result UpdateOnenoteSectionPageOperationResponse, err error) {
