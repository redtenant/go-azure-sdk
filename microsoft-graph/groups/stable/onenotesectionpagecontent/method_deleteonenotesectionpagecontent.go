...
// content.
func (c OnenoteSectionPageContentClient) DeleteOnenoteSectionPageContent(ctx context.Context, id stable.GroupIdOnenoteSectionIdPageId, options DeleteOnenoteSectionPageContentOperationOptions) (result DeleteOnenoteSectionPageContentOperationResponse, err error) {
