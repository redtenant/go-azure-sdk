...
// GetOnenoteSectionPageParentNotebook - Get parentNotebook from groups. The notebook that contains the page. Read-only.
func (c OnenoteSectionPageParentNotebookClient) GetOnenoteSectionPageParentNotebook(ctx context.Context, id stable.GroupIdOnenoteSectionIdPageId, options GetOnenoteSectionPageParentNotebookOperationOptions) (result GetOnenoteSectionPageParentNotebookOperationResponse, err error) {
