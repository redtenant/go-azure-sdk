...
// GetOnenoteSectionPageParentSection - Get parentSection from groups. The section that contains the page. Read-only.
func (c OnenoteSectionPageParentSectionClient) GetOnenoteSectionPageParentSection(ctx context.Context, id stable.GroupIdOnenoteSectionIdPageId, options GetOnenoteSectionPageParentSectionOperationOptions) (result GetOnenoteSectionPageParentSectionOperationResponse, err error) {
