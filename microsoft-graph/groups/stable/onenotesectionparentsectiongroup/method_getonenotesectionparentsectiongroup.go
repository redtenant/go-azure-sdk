...
// GetOnenoteSectionParentSectionGroup - Get parentSectionGroup from groups. The section group that contains the
// section. Read-only.
func (c OnenoteSectionParentSectionGroupClient) GetOnenoteSectionParentSectionGroup(ctx context.Context, id stable.GroupIdOnenoteSectionId, options GetOnenoteSectionParentSectionGroupOperationOptions) (result GetOnenoteSectionParentSectionGroupOperationResponse, err error) {
