...
func (c OwnerClient) GetOwnersCount(ctx context.Context, id stable.GroupId, options GetOwnersCountOperationOptions) (result GetOwnersCountOperationResponse, err error) {
