...
// ListOwnerRefs - List group owners. Retrieve a list of the group's owners. The owners are a set of users or service
...
func (c OwnerClient) ListOwnerRefs(ctx context.Context, id stable.GroupId, options ListOwnerRefsOperationOptions) (result ListOwnerRefsOperationResponse, err error) {
...
func (c OwnerClient) ListOwnerRefsComplete(ctx context.Context, id stable.GroupId, options ListOwnerRefsOperationOptions) (ListOwnerRefsCompleteResult, error) {
...
func (c OwnerClient) ListOwnerRefsCompleteMatchingPredicate(ctx context.Context, id stable.GroupId, options ListOwnerRefsOperationOptions, predicate DirectoryObjectOperationPredicate) (result ListOwnerRefsCompleteResult, err error) {
