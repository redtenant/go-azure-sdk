...
func (c OwnerClient) ListOwnersComplete(ctx context.Context, id stable.GroupId, options ListOwnersOperationOptions) (ListOwnersCompleteResult, error) {
...
func (c OwnerClient) ListOwnersCompleteMatchingPredicate(ctx context.Context, id stable.GroupId, options ListOwnersOperationOptions, predicate DirectoryObjectOperationPredicate) (result ListOwnersCompleteResult, err error) {
