...
// owners navigation property. Once owners are assigned to a group, the last owner (a user object) of the group cannot
// be removed.
func (c OwnerClient) RemoveOwnerRef(ctx context.Context, id stable.GroupIdOwnerId, options RemoveOwnerRefOperationOptions) (result RemoveOwnerRefOperationResponse, err error) {
