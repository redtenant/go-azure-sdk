...
// be removed.
func (c OwnerClient) RemoveOwnerRefs(ctx context.Context, id stable.GroupId, options RemoveOwnerRefsOperationOptions) (result RemoveOwnerRefsOperationResponse, err error) {
