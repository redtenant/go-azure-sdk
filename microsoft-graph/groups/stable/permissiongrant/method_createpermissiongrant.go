...
func (c PermissionGrantClient) CreatePermissionGrant(ctx context.Context, id stable.GroupId, input stable.ResourceSpecificPermissionGrant, options CreatePermissionGrantOperationOptions) (result CreatePermissionGrantOperationResponse, err error) {
