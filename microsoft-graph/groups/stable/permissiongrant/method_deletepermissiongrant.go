...
func (c PermissionGrantClient) DeletePermissionGrant(ctx context.Context, id stable.GroupIdPermissionGrantId, options DeletePermissionGrantOperationOptions) (result DeletePermissionGrantOperationResponse, err error) {
