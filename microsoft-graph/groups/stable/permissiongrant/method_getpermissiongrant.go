...
// GetPermissionGrant - Get permissionGrants from groups
func (c PermissionGrantClient) GetPermissionGrant(ctx context.Context, id stable.GroupIdPermissionGrantId, options GetPermissionGrantOperationOptions) (result GetPermissionGrantOperationResponse, err error) {
