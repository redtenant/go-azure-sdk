...
func DefaultGetPermissionGrantsCountOperationOptions() GetPermissionGrantsCountOperationOptions {
	return GetPermissionGrantsCountOperationOptions{}
}
...
func (c PermissionGrantClient) GetPermissionGrantsCount(ctx context.Context, id stable.GroupId, options GetPermissionGrantsCountOperationOptions) (result GetPermissionGrantsCountOperationResponse, err error) {
