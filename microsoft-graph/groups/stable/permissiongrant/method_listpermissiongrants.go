...
// This list specifies the Microsoft Entra apps that have access to the group, along with the corresponding
// resource-specific access that each app has.
func (c PermissionGrantClient) ListPermissionGrants(ctx context.Context, id stable.GroupId, options ListPermissionGrantsOperationOptions) (result ListPermissionGrantsOperationResponse, err error) {
...
func (c PermissionGrantClient) ListPermissionGrantsComplete(ctx context.Context, id stable.GroupId, options ListPermissionGrantsOperationOptions) (ListPermissionGrantsCompleteResult, error) {
...
func (c PermissionGrantClient) ListPermissionGrantsCompleteMatchingPredicate(ctx context.Context, id stable.GroupId, options ListPermissionGrantsOperationOptions, predicate ResourceSpecificPermissionGrantOperationPredicate) (result ListPermissionGrantsCompleteResult, err error) {
