...
func (c PermissionGrantClient) UpdatePermissionGrant(ctx context.Context, id stable.GroupIdPermissionGrantId, input stable.ResourceSpecificPermissionGrant, options UpdatePermissionGrantOperationOptions) (result UpdatePermissionGrantOperationResponse, err error) {
