...
func (c PlannerClient) DeletePlanner(ctx context.Context, id stable.GroupId, options DeletePlannerOperationOptions) (result DeletePlannerOperationResponse, err error) {
