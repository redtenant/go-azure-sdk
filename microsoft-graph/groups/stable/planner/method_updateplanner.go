...
func (c PlannerClient) UpdatePlanner(ctx context.Context, id stable.GroupId, input stable.PlannerGroup, options UpdatePlannerOperationOptions) (result UpdatePlannerOperationResponse, err error) {
