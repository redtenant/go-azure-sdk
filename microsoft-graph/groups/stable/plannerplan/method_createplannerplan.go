...
func (c PlannerPlanClient) CreatePlannerPlan(ctx context.Context, id stable.GroupId, input stable.PlannerPlan, options CreatePlannerPlanOperationOptions) (result CreatePlannerPlanOperationResponse, err error) {
