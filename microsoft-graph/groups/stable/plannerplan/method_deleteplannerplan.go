...
// DeletePlannerPlan - Delete navigation property plans for groups
func (c PlannerPlanClient) DeletePlannerPlan(ctx context.Context, id stable.GroupIdPlannerPlanId, options DeletePlannerPlanOperationOptions) (result DeletePlannerPlanOperationResponse, err error) {
