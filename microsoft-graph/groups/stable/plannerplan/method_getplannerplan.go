...
// GetPlannerPlan - Get plans from groups. Read-only. Nullable. Returns the plannerPlans owned by the group.
func (c PlannerPlanClient) GetPlannerPlan(ctx context.Context, id stable.GroupIdPlannerPlanId, options GetPlannerPlanOperationOptions) (result GetPlannerPlanOperationResponse, err error) {
