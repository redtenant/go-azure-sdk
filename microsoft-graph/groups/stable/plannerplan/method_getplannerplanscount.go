...
func (c PlannerPlanClient) GetPlannerPlansCount(ctx context.Context, id stable.GroupId, options GetPlannerPlansCountOperationOptions) (result GetPlannerPlansCountOperationResponse, err error) {
