...
// UpdatePlannerPlan - Update the navigation property plans in groups
func (c PlannerPlanClient) UpdatePlannerPlan(ctx context.Context, id stable.GroupIdPlannerPlanId, input stable.PlannerPlan, options UpdatePlannerPlanOperationOptions) (result UpdatePlannerPlanOperationResponse, err error) {
