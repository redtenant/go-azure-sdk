...
func (c PlannerPlanBucketClient) ListPlannerPlanBuckets(ctx context.Context, id stable.GroupIdPlannerPlanId, options ListPlannerPlanBucketsOperationOptions) (result ListPlannerPlanBucketsOperationResponse, err error) {
...
func (c PlannerPlanBucketClient) ListPlannerPlanBucketsComplete(ctx context.Context, id stable.GroupIdPlannerPlanId, options ListPlannerPlanBucketsOperationOptions) (ListPlannerPlanBucketsCompleteResult, error) {
...
func (c PlannerPlanBucketClient) ListPlannerPlanBucketsCompleteMatchingPredicate(ctx context.Context, id stable.GroupIdPlannerPlanId, options ListPlannerPlanBucketsOperationOptions, predicate PlannerBucketOperationPredicate) (result ListPlannerPlanBucketsCompleteResult, err error) {
