...
func (c PlannerPlanBucketClient) UpdatePlannerPlanBucket(ctx context.Context, id stable.GroupIdPlannerPlanIdBucketId, input stable.PlannerBucket, options UpdatePlannerPlanBucketOperationOptions) (result UpdatePlannerPlanBucketOperationResponse, err error) {
