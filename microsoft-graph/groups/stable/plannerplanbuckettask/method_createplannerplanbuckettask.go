...
// CreatePlannerPlanBucketTask - Create new navigation property to tasks for groups
func (c PlannerPlanBucketTaskClient) CreatePlannerPlanBucketTask(ctx context.Context, id stable.GroupIdPlannerPlanIdBucketId, input stable.PlannerTask, options CreatePlannerPlanBucketTaskOperationOptions) (result CreatePlannerPlanBucketTaskOperationResponse, err error) {
