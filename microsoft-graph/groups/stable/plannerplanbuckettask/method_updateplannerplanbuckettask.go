...
// UpdatePlannerPlanBucketTask - Update the navigation property tasks in groups
func (c PlannerPlanBucketTaskClient) UpdatePlannerPlanBucketTask(ctx context.Context, id stable.GroupIdPlannerPlanIdBucketIdTaskId, input stable.PlannerTask, options UpdatePlannerPlanBucketTaskOperationOptions) (result UpdatePlannerPlanBucketTaskOperationResponse, err error) {
