...
// DeletePlannerPlanBucketTaskAssignedToTaskBoardFormat - Delete navigation property assignedToTaskBoardFormat for
// groups
func (c PlannerPlanBucketTaskAssignedToTaskBoardFormatClient) DeletePlannerPlanBucketTaskAssignedToTaskBoardFormat(ctx context.Context, id stable.GroupIdPlannerPlanIdBucketIdTaskId, options DeletePlannerPlanBucketTaskAssignedToTaskBoardFormatOperationOptions) (result DeletePlannerPlanBucketTaskAssignedToTaskBoardFormatOperationResponse, err error) {
