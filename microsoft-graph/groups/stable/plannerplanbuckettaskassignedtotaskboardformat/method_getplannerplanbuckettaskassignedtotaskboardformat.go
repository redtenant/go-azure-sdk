...
// GetPlannerPlanBucketTaskAssignedToTaskBoardFormat - Get assignedToTaskBoardFormat from groups. Read-only. Nullable.
// Used to render the task correctly in the task board view when grouped by assignedTo.
func (c PlannerPlanBucketTaskAssignedToTaskBoardFormatClient) GetPlannerPlanBucketTaskAssignedToTaskBoardFormat(ctx context.Context, id stable.GroupIdPlannerPlanIdBucketIdTaskId, options GetPlannerPlanBucketTaskAssignedToTaskBoardFormatOperationOptions) (result GetPlannerPlanBucketTaskAssignedToTaskBoardFormatOperationResponse, err error) {
