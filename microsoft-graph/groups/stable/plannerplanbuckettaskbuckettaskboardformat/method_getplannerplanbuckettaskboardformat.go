...
// GetPlannerPlanBucketTaskBoardFormat - Get bucketTaskBoardFormat from groups. Read-only. Nullable. Used to render the
// task correctly in the task board view when grouped by bucket.
func (c PlannerPlanBucketTaskBucketTaskBoardFormatClient) GetPlannerPlanBucketTaskBoardFormat(ctx context.Context, id stable.GroupIdPlannerPlanIdBucketIdTaskId, options GetPlannerPlanBucketTaskBoardFormatOperationOptions) (result GetPlannerPlanBucketTaskBoardFormatOperationResponse, err error) {
