...
func (c PlannerPlanBucketTaskBucketTaskBoardFormatClient) UpdatePlannerPlanBucketTaskBoardFormat(ctx context.Context, id stable.GroupIdPlannerPlanIdBucketIdTaskId, input stable.PlannerBucketTaskBoardTaskFormat, options UpdatePlannerPlanBucketTaskBoardFormatOperationOptions) (result UpdatePlannerPlanBucketTaskBoardFormatOperationResponse, err error) {
