...
// DeletePlannerPlanBucketTaskDetail - Delete navigation property details for groups
func (c PlannerPlanBucketTaskDetailClient) DeletePlannerPlanBucketTaskDetail(ctx context.Context, id stable.GroupIdPlannerPlanIdBucketIdTaskId, options DeletePlannerPlanBucketTaskDetailOperationOptions) (result DeletePlannerPlanBucketTaskDetailOperationResponse, err error) {
