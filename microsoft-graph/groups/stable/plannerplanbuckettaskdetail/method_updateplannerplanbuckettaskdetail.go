...
// UpdatePlannerPlanBucketTaskDetail - Update the navigation property details in groups
func (c PlannerPlanBucketTaskDetailClient) UpdatePlannerPlanBucketTaskDetail(ctx context.Context, id stable.GroupIdPlannerPlanIdBucketIdTaskId, input stable.PlannerTaskDetails, options UpdatePlannerPlanBucketTaskDetailOperationOptions) (result UpdatePlannerPlanBucketTaskDetailOperationResponse, err error) {
