...
// DeletePlannerPlanBucketTaskProgressTaskBoardFormat - Delete navigation property progressTaskBoardFormat for groups
func (c PlannerPlanBucketTaskProgressTaskBoardFormatClient) DeletePlannerPlanBucketTaskProgressTaskBoardFormat(ctx context.Context, id stable.GroupIdPlannerPlanIdBucketIdTaskId, options DeletePlannerPlanBucketTaskProgressTaskBoardFormatOperationOptions) (result DeletePlannerPlanBucketTaskProgressTaskBoardFormatOperationResponse, err error) {
