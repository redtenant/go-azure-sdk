...
// GetPlannerPlanBucketTaskProgressTaskBoardFormat - Get progressTaskBoardFormat from groups. Read-only. Nullable. Used
// to render the task correctly in the task board view when grouped by progress.
func (c PlannerPlanBucketTaskProgressTaskBoardFormatClient) GetPlannerPlanBucketTaskProgressTaskBoardFormat(ctx context.Context, id stable.GroupIdPlannerPlanIdBucketIdTaskId, options GetPlannerPlanBucketTaskProgressTaskBoardFormatOperationOptions) (result GetPlannerPlanBucketTaskProgressTaskBoardFormatOperationResponse, err error) {
