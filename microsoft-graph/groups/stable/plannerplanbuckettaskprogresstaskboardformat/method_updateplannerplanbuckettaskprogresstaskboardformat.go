...
// UpdatePlannerPlanBucketTaskProgressTaskBoardFormat - Update the navigation property progressTaskBoardFormat in groups
func (c PlannerPlanBucketTaskProgressTaskBoardFormatClient) UpdatePlannerPlanBucketTaskProgressTaskBoardFormat(ctx context.Context, id stable.GroupIdPlannerPlanIdBucketIdTaskId, input stable.PlannerProgressTaskBoardTaskFormat, options UpdatePlannerPlanBucketTaskProgressTaskBoardFormatOperationOptions) (result UpdatePlannerPlanBucketTaskProgressTaskBoardFormatOperationResponse, err error) {
