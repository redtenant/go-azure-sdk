...
// UpdatePlannerPlanTask - Update the navigation property tasks in groups
func (c PlannerPlanTaskClient) UpdatePlannerPlanTask(ctx context.Context, id stable.GroupIdPlannerPlanIdTaskId, input stable.PlannerTask, options UpdatePlannerPlanTaskOperationOptions) (result UpdatePlannerPlanTaskOperationResponse, err error) {
