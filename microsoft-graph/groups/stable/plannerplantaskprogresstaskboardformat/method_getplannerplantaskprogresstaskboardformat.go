...
// GetPlannerPlanTaskProgressTaskBoardFormat - Get progressTaskBoardFormat from groups. Read-only. Nullable. Used to
// render the task correctly in the task board view when grouped by progress.
func (c PlannerPlanTaskProgressTaskBoardFormatClient) GetPlannerPlanTaskProgressTaskBoardFormat(ctx context.Context, id stable.GroupIdPlannerPlanIdTaskId, options GetPlannerPlanTaskProgressTaskBoardFormatOperationOptions) (result GetPlannerPlanTaskProgressTaskBoardFormatOperationResponse, err error) {
