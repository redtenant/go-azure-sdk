...
func DefaultGetRejectedSendersCountOperationOptions() GetRejectedSendersCountOperationOptions {
	return GetRejectedSendersCountOperationOptions{}
}
...
func (c RejectedSenderClient) GetRejectedSendersCount(ctx context.Context, id stable.GroupId, options GetRejectedSendersCountOperationOptions) (result GetRejectedSendersCountOperationResponse, err error) {
	opts := client.RequestOptions{
		...
		Path:          fmt.Sprintf("%s/rejectedSenders/$count", id.ID()),
