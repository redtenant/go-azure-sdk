...
// ListRejectedSenders - List rejectedSenders. Users in the rejected senders list can't post to conversations of the
...
func (c RejectedSenderClient) ListRejectedSenders(ctx context.Context, id stable.GroupId, options ListRejectedSendersOperationOptions) (result ListRejectedSendersOperationResponse, err error) {
...
func (c RejectedSenderClient) ListRejectedSendersComplete(ctx context.Context, id stable.GroupId, options ListRejectedSendersOperationOptions) (ListRejectedSendersCompleteResult, error) {
...
func (c RejectedSenderClient) ListRejectedSendersCompleteMatchingPredicate(ctx context.Context, id stable.GroupId, options ListRejectedSendersOperationOptions, predicate DirectoryObjectOperationPredicate) (result ListRejectedSendersCompleteResult, err error) {
