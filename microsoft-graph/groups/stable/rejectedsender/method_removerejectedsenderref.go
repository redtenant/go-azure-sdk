...
// RemoveRejectedSenderRef - Remove rejectedSender
func (c RejectedSenderClient) RemoveRejectedSenderRef(ctx context.Context, id stable.GroupIdRejectedSenderId, options RemoveRejectedSenderRefOperationOptions) (result RemoveRejectedSenderRefOperationResponse, err error) {
