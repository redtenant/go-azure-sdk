...
func DefaultRemoveRejectedSenderRefsOperationOptions() RemoveRejectedSenderRefsOperationOptions {
	return RemoveRejectedSenderRefsOperationOptions{}
}
...
// RemoveRejectedSenderRefs - Remove rejectedSender
func (c RejectedSenderClient) RemoveRejectedSenderRefs(ctx context.Context, id stable.GroupId, options RemoveRejectedSenderRefsOperationOptions) (result RemoveRejectedSenderRefsOperationResponse, err error) {
