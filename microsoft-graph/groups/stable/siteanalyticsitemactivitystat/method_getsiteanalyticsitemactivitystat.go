...
func (c SiteAnalyticsItemActivityStatClient) GetSiteAnalyticsItemActivityStat(ctx context.Context, id stable.GroupIdSiteIdAnalyticsItemActivityStatId, options GetSiteAnalyticsItemActivityStatOperationOptions) (result GetSiteAnalyticsItemActivityStatOperationResponse, err error) {
