...
func (c SiteColumnClient) CreateSiteColumn(ctx context.Context, id stable.GroupIdSiteId, input stable.ColumnDefinition, options CreateSiteColumnOperationOptions) (result CreateSiteColumnOperationResponse, err error) {
