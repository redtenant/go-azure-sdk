...
func (c SiteColumnClient) GetSiteColumn(ctx context.Context, id stable.GroupIdSiteIdColumnId, options GetSiteColumnOperationOptions) (result GetSiteColumnOperationResponse, err error) {
