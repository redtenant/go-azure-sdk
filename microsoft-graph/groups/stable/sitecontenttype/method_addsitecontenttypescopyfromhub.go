...
// site or list. For more information, see contentType: getCompatibleHubContentTypes and the blog post Syntex Product
// Updates – August 2021.
func (c SiteContentTypeClient) AddSiteContentTypesCopyFromHub(ctx context.Context, id stable.GroupIdSiteId, input AddSiteContentTypesCopyFromHubRequest, options AddSiteContentTypesCopyFromHubOperationOptions) (result AddSiteContentTypesCopyFromHubOperationResponse, err error) {
