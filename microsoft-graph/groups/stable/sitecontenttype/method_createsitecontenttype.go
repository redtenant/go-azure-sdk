...
func DefaultCreateSiteContentTypeOperationOptions() CreateSiteContentTypeOperationOptions {
	return CreateSiteContentTypeOperationOptions{}
}
...
func (c SiteContentTypeClient) CreateSiteContentType(ctx context.Context, id stable.GroupIdSiteId, input stable.ContentType, options CreateSiteContentTypeOperationOptions) (result CreateSiteContentTypeOperationResponse, err error) {
