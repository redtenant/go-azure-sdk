...
func DefaultGetSiteContentTypeOperationOptions() GetSiteContentTypeOperationOptions {
	return GetSiteContentTypeOperationOptions{}
}
...
func (c SiteContentTypeClient) GetSiteContentType(ctx context.Context, id stable.GroupIdSiteIdContentTypeId, options GetSiteContentTypeOperationOptions) (result GetSiteContentTypeOperationResponse, err error) {
