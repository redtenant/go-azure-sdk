...
func DefaultGetSiteContentTypesCountOperationOptions() GetSiteContentTypesCountOperationOptions {
	return GetSiteContentTypesCountOperationOptions{}
}
...
func (c SiteContentTypeClient) GetSiteContentTypesCount(ctx context.Context, id stable.GroupIdSiteId, options GetSiteContentTypesCountOperationOptions) (result GetSiteContentTypesCountOperationResponse, err error) {
