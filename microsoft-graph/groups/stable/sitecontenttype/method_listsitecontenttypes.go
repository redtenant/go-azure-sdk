...
func (c SiteContentTypeClient) ListSiteContentTypes(ctx context.Context, id stable.GroupIdSiteId, options ListSiteContentTypesOperationOptions) (result ListSiteContentTypesOperationResponse, err error) {
...
func (c SiteContentTypeClient) ListSiteContentTypesComplete(ctx context.Context, id stable.GroupIdSiteId, options ListSiteContentTypesOperationOptions) (ListSiteContentTypesCompleteResult, error) {
...
func (c SiteContentTypeClient) ListSiteContentTypesCompleteMatchingPredicate(ctx context.Context, id stable.GroupIdSiteId, options ListSiteContentTypesOperationOptions, predicate ContentTypeOperationPredicate) (result ListSiteContentTypesCompleteResult, err error) {
