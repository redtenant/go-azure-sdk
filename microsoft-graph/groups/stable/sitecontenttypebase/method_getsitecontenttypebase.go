...
func (c SiteContentTypeBaseClient) GetSiteContentTypeBase(ctx context.Context, id stable.GroupIdSiteIdContentTypeId, options GetSiteContentTypeBaseOperationOptions) (result GetSiteContentTypeBaseOperationResponse, err error) {
