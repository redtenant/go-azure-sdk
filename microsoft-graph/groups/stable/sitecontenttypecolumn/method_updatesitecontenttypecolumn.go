...
func (c SiteContentTypeColumnClient) UpdateSiteContentTypeColumn(ctx context.Context, id stable.GroupIdSiteIdContentTypeIdColumnId, input stable.ColumnDefinition, options UpdateSiteContentTypeColumnOperationOptions) (result UpdateSiteContentTypeColumnOperationResponse, err error) {
