...
func DefaultDeleteSiteContentTypeColumnLinkOperationOptions() DeleteSiteContentTypeColumnLinkOperationOptions {
	return DeleteSiteContentTypeColumnLinkOperationOptions{}
}
...
func (c SiteContentTypeColumnLinkClient) DeleteSiteContentTypeColumnLink(ctx context.Context, id stable.GroupIdSiteIdContentTypeIdColumnLinkId, options DeleteSiteContentTypeColumnLinkOperationOptions) (result DeleteSiteContentTypeColumnLinkOperationResponse, err error) {
