...
func DefaultGetSiteContentTypeColumnLinksCountOperationOptions() GetSiteContentTypeColumnLinksCountOperationOptions {
	return GetSiteContentTypeColumnLinksCountOperationOptions{}
}
...
func (c SiteContentTypeColumnLinkClient) GetSiteContentTypeColumnLinksCount(ctx context.Context, id stable.GroupIdSiteIdContentTypeId, options GetSiteContentTypeColumnLinksCountOperationOptions) (result GetSiteContentTypeColumnLinksCountOperationResponse, err error) {
