...
// ListSiteExternalColumns - Get externalColumns from groups
func (c SiteExternalColumnClient) ListSiteExternalColumns(ctx context.Context, id stable.GroupIdSiteId, options ListSiteExternalColumnsOperationOptions) (result ListSiteExternalColumnsOperationResponse, err error) {
...
func (c SiteExternalColumnClient) ListSiteExternalColumnsComplete(ctx context.Context, id stable.GroupIdSiteId, options ListSiteExternalColumnsOperationOptions) (ListSiteExternalColumnsCompleteResult, error) {
...
func (c SiteExternalColumnClient) ListSiteExternalColumnsCompleteMatchingPredicate(ctx context.Context, id stable.GroupIdSiteId, options ListSiteExternalColumnsOperationOptions, predicate ColumnDefinitionOperationPredicate) (result ListSiteExternalColumnsCompleteResult, err error) {
