...
func (c SiteItemClient) GetSiteItemsCount(ctx context.Context, id stable.GroupIdSiteId, options GetSiteItemsCountOperationOptions) (result GetSiteItemsCountOperationResponse, err error) {
