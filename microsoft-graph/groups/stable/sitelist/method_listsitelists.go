...
func (c SiteListClient) ListSiteLists(ctx context.Context, id stable.GroupIdSiteId, options ListSiteListsOperationOptions) (result ListSiteListsOperationResponse, err error) {
...
func (c SiteListClient) ListSiteListsComplete(ctx context.Context, id stable.GroupIdSiteId, options ListSiteListsOperationOptions) (ListSiteListsCompleteResult, error) {
...
func (c SiteListClient) ListSiteListsCompleteMatchingPredicate(ctx context.Context, id stable.GroupIdSiteId, options ListSiteListsOperationOptions, predicate ListOperationPredicate) (result ListSiteListsCompleteResult, err error) {
	items := make([]stable.List, 0)
