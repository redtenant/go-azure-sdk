...
// AddSiteListContentTypesCopy - Invoke action addCopy. Add a copy of a content type from a site to a list.
func (c SiteListContentTypeClient) AddSiteListContentTypesCopy(ctx context.Context, id stable.GroupIdSiteIdListId, input AddSiteListContentTypesCopyRequest, options AddSiteListContentTypesCopyOperationOptions) (result AddSiteListContentTypesCopyOperationResponse, err error) {
