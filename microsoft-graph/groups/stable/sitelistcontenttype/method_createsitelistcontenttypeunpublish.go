...
type CreateSiteListContentTypeUnpublishOperationResponse struct {
...
// CreateSiteListContentTypeUnpublish - Invoke action unpublish. Unpublish a contentType from a content type hub site.
func (c SiteListContentTypeClient) CreateSiteListContentTypeUnpublish(ctx context.Context, id stable.GroupIdSiteIdListIdContentTypeId, options CreateSiteListContentTypeUnpublishOperationOptions) (result CreateSiteListContentTypeUnpublishOperationResponse, err error) {
