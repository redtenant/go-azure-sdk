...
func (c SiteListContentTypeClient) DeleteSiteListContentType(ctx context.Context, id stable.GroupIdSiteIdListIdContentTypeId, options DeleteSiteListContentTypeOperationOptions) (result DeleteSiteListContentTypeOperationResponse, err error) {
