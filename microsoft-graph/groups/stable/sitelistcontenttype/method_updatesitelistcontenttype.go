...
func (c SiteListContentTypeClient) UpdateSiteListContentType(ctx context.Context, id stable.GroupIdSiteIdListIdContentTypeId, input stable.ContentType, options UpdateSiteListContentTypeOperationOptions) (result UpdateSiteListContentTypeOperationResponse, err error) {
