...
func (c SiteListContentTypeColumnClient) GetSiteListContentTypeColumnsCount(ctx context.Context, id stable.GroupIdSiteIdListIdContentTypeId, options GetSiteListContentTypeColumnsCountOperationOptions) (result GetSiteListContentTypeColumnsCountOperationResponse, err error) {
