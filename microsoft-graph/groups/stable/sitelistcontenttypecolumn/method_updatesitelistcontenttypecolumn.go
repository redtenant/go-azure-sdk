...
func (c SiteListContentTypeColumnClient) UpdateSiteListContentTypeColumn(ctx context.Context, id stable.GroupIdSiteIdListIdContentTypeIdColumnId, input stable.ColumnDefinition, options UpdateSiteListContentTypeColumnOperationOptions) (result UpdateSiteListContentTypeColumnOperationResponse, err error) {
