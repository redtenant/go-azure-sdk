...
func (c SiteListContentTypeColumnLinkClient) DeleteSiteListContentTypeColumnLink(ctx context.Context, id stable.GroupIdSiteIdListIdContentTypeIdColumnLinkId, options DeleteSiteListContentTypeColumnLinkOperationOptions) (result DeleteSiteListContentTypeColumnLinkOperationResponse, err error) {
