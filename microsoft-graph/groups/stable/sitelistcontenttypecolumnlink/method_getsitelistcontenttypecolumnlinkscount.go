...
func (c SiteListContentTypeColumnLinkClient) GetSiteListContentTypeColumnLinksCount(ctx context.Context, id stable.GroupIdSiteIdListIdContentTypeId, options GetSiteListContentTypeColumnLinksCountOperationOptions) (result GetSiteListContentTypeColumnLinksCountOperationResponse, err error) {
