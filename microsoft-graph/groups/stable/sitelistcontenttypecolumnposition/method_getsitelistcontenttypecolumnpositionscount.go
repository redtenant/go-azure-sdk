...
func (c SiteListContentTypeColumnPositionClient) GetSiteListContentTypeColumnPositionsCount(ctx context.Context, id stable.GroupIdSiteIdListIdContentTypeId, options GetSiteListContentTypeColumnPositionsCountOperationOptions) (result GetSiteListContentTypeColumnPositionsCountOperationResponse, err error) {
