...
func DefaultDeleteSiteListItemOperationOptions() DeleteSiteListItemOperationOptions {
	return DeleteSiteListItemOperationOptions{}
}
...
func (c SiteListItemClient) DeleteSiteListItem(ctx context.Context, id stable.GroupIdSiteIdListIdItemId, options DeleteSiteListItemOperationOptions) (result DeleteSiteListItemOperationResponse, err error) {
