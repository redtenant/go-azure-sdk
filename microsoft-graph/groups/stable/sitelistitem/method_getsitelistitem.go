...
func DefaultGetSiteListItemOperationOptions() GetSiteListItemOperationOptions {
	return GetSiteListItemOperationOptions{}
}
...
func (c SiteListItemClient) GetSiteListItem(ctx context.Context, id stable.GroupIdSiteIdListIdItemId, options GetSiteListItemOperationOptions) (result GetSiteListItemOperationResponse, err error) {
