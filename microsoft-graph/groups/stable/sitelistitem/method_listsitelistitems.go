...
func DefaultListSiteListItemsOperationOptions() ListSiteListItemsOperationOptions {
	return ListSiteListItemsOperationOptions{}
}
...
func (c SiteListItemClient) ListSiteListItems(ctx context.Context, id stable.GroupIdSiteIdListId, options ListSiteListItemsOperationOptions) (result ListSiteListItemsOperationResponse, err error) {
	opts := client.RequestOptions{
		...
		Pager:         &ListSiteListItemsCustomPager{},
...
func (c SiteListItemClient) ListSiteListItemsComplete(ctx context.Context, id stable.GroupIdSiteIdListId, options ListSiteListItemsOperationOptions) (ListSiteListItemsCompleteResult, error) {
	return c.ListSiteListItemsCompleteMatchingPredicate(ctx, id, options, ListItemOperationPredicate{})
}
...
func (c SiteListItemClient) ListSiteListItemsCompleteMatchingPredicate(ctx context.Context, id stable.GroupIdSiteIdListId, options ListSiteListItemsOperationOptions, predicate ListItemOperationPredicate) (result ListSiteListItemsCompleteResult, err error) {
	...
	resp, err := c.ListSiteListItems(ctx, id, options)
	if err != nil {
	...
	result = ListSiteListItemsCompleteResult{
