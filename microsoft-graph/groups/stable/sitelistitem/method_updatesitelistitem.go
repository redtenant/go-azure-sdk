...
func (c SiteListItemClient) UpdateSiteListItem(ctx context.Context, id stable.GroupIdSiteIdListIdItemId, input stable.ListItem, options UpdateSiteListItemOperationOptions) (result UpdateSiteListItemOperationResponse, err error) {
