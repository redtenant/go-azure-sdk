...
func (c SiteListItemDocumentSetVersionClient) CreateSiteListItemDocumentSetVersion(ctx context.Context, id stable.GroupIdSiteIdListIdItemId, input stable.DocumentSetVersion, options CreateSiteListItemDocumentSetVersionOperationOptions) (result CreateSiteListItemDocumentSetVersionOperationResponse, err error) {
