...
func (c SiteListItemDocumentSetVersionClient) GetSiteListItemDocumentSetVersion(ctx context.Context, id stable.GroupIdSiteIdListIdItemIdDocumentSetVersionId, options GetSiteListItemDocumentSetVersionOperationOptions) (result GetSiteListItemDocumentSetVersionOperationResponse, err error) {
