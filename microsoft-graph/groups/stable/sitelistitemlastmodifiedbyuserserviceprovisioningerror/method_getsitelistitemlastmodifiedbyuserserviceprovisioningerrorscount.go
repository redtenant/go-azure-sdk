...
func (c SiteListItemLastModifiedByUserServiceProvisioningErrorClient) GetSiteListItemLastModifiedByUserServiceProvisioningErrorsCount(ctx context.Context, id stable.GroupIdSiteIdListIdItemId, options GetSiteListItemLastModifiedByUserServiceProvisioningErrorsCountOperationOptions) (result GetSiteListItemLastModifiedByUserServiceProvisioningErrorsCountOperationResponse, err error) {
