...
type CreateSiteListItemVersionOperationResponse struct {
...
func (c SiteListItemVersionClient) CreateSiteListItemVersion(ctx context.Context, id stable.GroupIdSiteIdListIdItemId, input stable.ListItemVersion, options CreateSiteListItemVersionOperationOptions) (result CreateSiteListItemVersionOperationResponse, err error) {
