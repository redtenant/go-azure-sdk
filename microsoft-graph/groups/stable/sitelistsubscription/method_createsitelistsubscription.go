...
func (c SiteListSubscriptionClient) CreateSiteListSubscription(ctx context.Context, id stable.GroupIdSiteIdListId, input stable.Subscription, options CreateSiteListSubscriptionOperationOptions) (result CreateSiteListSubscriptionOperationResponse, err error) {
