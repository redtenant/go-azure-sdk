...
func (c SiteOnenoteClient) DeleteSiteOnenote(ctx context.Context, id stable.GroupIdSiteId, options DeleteSiteOnenoteOperationOptions) (result DeleteSiteOnenoteOperationResponse, err error) {
