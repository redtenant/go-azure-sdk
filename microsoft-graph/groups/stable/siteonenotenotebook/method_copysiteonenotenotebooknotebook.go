...
// CopySiteOnenoteNotebookNotebook - Invoke action copyNotebook. For Copy operations, you follow an asynchronous calling
// pattern: First call the Copy action, and then poll the operation endpoint for the result.
func (c SiteOnenoteNotebookClient) CopySiteOnenoteNotebookNotebook(ctx context.Context, id stable.GroupIdSiteIdOnenoteNotebookId, input CopySiteOnenoteNotebookNotebookRequest, options CopySiteOnenoteNotebookNotebookOperationOptions) (result CopySiteOnenoteNotebookNotebookOperationResponse, err error) {
