...
func DefaultCreateSiteOnenoteNotebookOperationOptions() CreateSiteOnenoteNotebookOperationOptions {
	return CreateSiteOnenoteNotebookOperationOptions{}
}
...
func (c SiteOnenoteNotebookClient) CreateSiteOnenoteNotebook(ctx context.Context, id stable.GroupIdSiteId, input stable.Notebook, options CreateSiteOnenoteNotebookOperationOptions) (result CreateSiteOnenoteNotebookOperationResponse, err error) {
