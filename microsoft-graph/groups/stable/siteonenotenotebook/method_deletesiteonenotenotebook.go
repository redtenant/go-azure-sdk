...
func DefaultDeleteSiteOnenoteNotebookOperationOptions() DeleteSiteOnenoteNotebookOperationOptions {
	return DeleteSiteOnenoteNotebookOperationOptions{}
}
...
func (c SiteOnenoteNotebookClient) DeleteSiteOnenoteNotebook(ctx context.Context, id stable.GroupIdSiteIdOnenoteNotebookId, options DeleteSiteOnenoteNotebookOperationOptions) (result DeleteSiteOnenoteNotebookOperationResponse, err error) {
