...
func DefaultGetSiteOnenoteNotebookOperationOptions() GetSiteOnenoteNotebookOperationOptions {
	return GetSiteOnenoteNotebookOperationOptions{}
}
...
func (c SiteOnenoteNotebookClient) GetSiteOnenoteNotebook(ctx context.Context, id stable.GroupIdSiteIdOnenoteNotebookId, options GetSiteOnenoteNotebookOperationOptions) (result GetSiteOnenoteNotebookOperationResponse, err error) {
