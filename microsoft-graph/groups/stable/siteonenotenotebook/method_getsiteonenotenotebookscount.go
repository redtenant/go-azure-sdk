...
func (c SiteOnenoteNotebookClient) GetSiteOnenoteNotebooksCount(ctx context.Context, id stable.GroupIdSiteId, options GetSiteOnenoteNotebooksCountOperationOptions) (result GetSiteOnenoteNotebooksCountOperationResponse, err error) {
