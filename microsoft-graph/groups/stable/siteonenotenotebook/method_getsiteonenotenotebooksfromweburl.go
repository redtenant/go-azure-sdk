...
func (c SiteOnenoteNotebookClient) GetSiteOnenoteNotebooksFromWebUrl(ctx context.Context, id stable.GroupIdSiteId, input GetSiteOnenoteNotebooksFromWebUrlRequest, options GetSiteOnenoteNotebooksFromWebUrlOperationOptions) (result GetSiteOnenoteNotebooksFromWebUrlOperationResponse, err error) {
