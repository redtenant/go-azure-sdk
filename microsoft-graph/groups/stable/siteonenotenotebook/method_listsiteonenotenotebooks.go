...
func (c SiteOnenoteNotebookClient) ListSiteOnenoteNotebooks(ctx context.Context, id stable.GroupIdSiteId, options ListSiteOnenoteNotebooksOperationOptions) (result ListSiteOnenoteNotebooksOperationResponse, err error) {
...
func (c SiteOnenoteNotebookClient) ListSiteOnenoteNotebooksComplete(ctx context.Context, id stable.GroupIdSiteId, options ListSiteOnenoteNotebooksOperationOptions) (ListSiteOnenoteNotebooksCompleteResult, error) {
...
func (c SiteOnenoteNotebookClient) ListSiteOnenoteNotebooksCompleteMatchingPredicate(ctx context.Context, id stable.GroupIdSiteId, options ListSiteOnenoteNotebooksOperationOptions, predicate NotebookOperationPredicate) (result ListSiteOnenoteNotebooksCompleteResult, err error) {
