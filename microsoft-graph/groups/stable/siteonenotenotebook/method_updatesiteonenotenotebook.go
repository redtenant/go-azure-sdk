...
func (c SiteOnenoteNotebookClient) UpdateSiteOnenoteNotebook(ctx context.Context, id stable.GroupIdSiteIdOnenoteNotebookId, input stable.Notebook, options UpdateSiteOnenoteNotebookOperationOptions) (result UpdateSiteOnenoteNotebookOperationResponse, err error) {
