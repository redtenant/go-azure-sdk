...
func (c SiteOnenoteNotebookSectionGroupClient) CreateSiteOnenoteNotebookSectionGroup(ctx context.Context, id stable.GroupIdSiteIdOnenoteNotebookId, input stable.SectionGroup, options CreateSiteOnenoteNotebookSectionGroupOperationOptions) (result CreateSiteOnenoteNotebookSectionGroupOperationResponse, err error) {
