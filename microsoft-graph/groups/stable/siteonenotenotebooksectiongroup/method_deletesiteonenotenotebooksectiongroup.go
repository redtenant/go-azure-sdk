...
func DefaultDeleteSiteOnenoteNotebookSectionGroupOperationOptions() DeleteSiteOnenoteNotebookSectionGroupOperationOptions {
	return DeleteSiteOnenoteNotebookSectionGroupOperationOptions{}
}
...
func (c SiteOnenoteNotebookSectionGroupClient) DeleteSiteOnenoteNotebookSectionGroup(ctx context.Context, id stable.GroupIdSiteIdOnenoteNotebookIdSectionGroupId, options DeleteSiteOnenoteNotebookSectionGroupOperationOptions) (result DeleteSiteOnenoteNotebookSectionGroupOperationResponse, err error) {
