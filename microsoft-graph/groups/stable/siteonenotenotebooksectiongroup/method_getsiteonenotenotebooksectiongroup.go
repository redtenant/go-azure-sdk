...
func DefaultGetSiteOnenoteNotebookSectionGroupOperationOptions() GetSiteOnenoteNotebookSectionGroupOperationOptions {
	return GetSiteOnenoteNotebookSectionGroupOperationOptions{}
}
...
// GetSiteOnenoteNotebookSectionGroup - Get sectionGroups from groups. The section groups in the notebook. Read-only.
// Nullable.
func (c SiteOnenoteNotebookSectionGroupClient) GetSiteOnenoteNotebookSectionGroup(ctx context.Context, id stable.GroupIdSiteIdOnenoteNotebookIdSectionGroupId, options GetSiteOnenoteNotebookSectionGroupOperationOptions) (result GetSiteOnenoteNotebookSectionGroupOperationResponse, err error) {
