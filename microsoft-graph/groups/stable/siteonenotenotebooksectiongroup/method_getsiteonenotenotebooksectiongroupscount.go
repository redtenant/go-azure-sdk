...
func DefaultGetSiteOnenoteNotebookSectionGroupsCountOperationOptions() GetSiteOnenoteNotebookSectionGroupsCountOperationOptions {
	return GetSiteOnenoteNotebookSectionGroupsCountOperationOptions{}
}
...
func (c SiteOnenoteNotebookSectionGroupClient) GetSiteOnenoteNotebookSectionGroupsCount(ctx context.Context, id stable.GroupIdSiteIdOnenoteNotebookId, options GetSiteOnenoteNotebookSectionGroupsCountOperationOptions) (result GetSiteOnenoteNotebookSectionGroupsCountOperationResponse, err error) {
