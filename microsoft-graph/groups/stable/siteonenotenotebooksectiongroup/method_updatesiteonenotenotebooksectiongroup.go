...
func DefaultUpdateSiteOnenoteNotebookSectionGroupOperationOptions() UpdateSiteOnenoteNotebookSectionGroupOperationOptions {
	return UpdateSiteOnenoteNotebookSectionGroupOperationOptions{}
}
...
func (c SiteOnenoteNotebookSectionGroupClient) UpdateSiteOnenoteNotebookSectionGroup(ctx context.Context, id stable.GroupIdSiteIdOnenoteNotebookIdSectionGroupId, input stable.SectionGroup, options UpdateSiteOnenoteNotebookSectionGroupOperationOptions) (result UpdateSiteOnenoteNotebookSectionGroupOperationResponse, err error) {
