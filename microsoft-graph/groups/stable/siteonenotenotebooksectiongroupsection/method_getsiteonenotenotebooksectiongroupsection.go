...
func DefaultGetSiteOnenoteNotebookSectionGroupSectionOperationOptions() GetSiteOnenoteNotebookSectionGroupSectionOperationOptions {
	return GetSiteOnenoteNotebookSectionGroupSectionOperationOptions{}
}
...
// GetSiteOnenoteNotebookSectionGroupSection - Get sections from groups. The sections in the section group. Read-only.
// Nullable.
func (c SiteOnenoteNotebookSectionGroupSectionClient) GetSiteOnenoteNotebookSectionGroupSection(ctx context.Context, id stable.GroupIdSiteIdOnenoteNotebookIdSectionGroupIdSectionId, options GetSiteOnenoteNotebookSectionGroupSectionOperationOptions) (result GetSiteOnenoteNotebookSectionGroupSectionOperationResponse, err error) {
