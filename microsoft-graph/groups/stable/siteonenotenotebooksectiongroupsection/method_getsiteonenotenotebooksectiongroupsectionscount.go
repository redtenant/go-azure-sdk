...
func DefaultGetSiteOnenoteNotebookSectionGroupSectionsCountOperationOptions() GetSiteOnenoteNotebookSectionGroupSectionsCountOperationOptions {
	return GetSiteOnenoteNotebookSectionGroupSectionsCountOperationOptions{}
}
...
func (c SiteOnenoteNotebookSectionGroupSectionClient) GetSiteOnenoteNotebookSectionGroupSectionsCount(ctx context.Context, id stable.GroupIdSiteIdOnenoteNotebookIdSectionGroupId, options GetSiteOnenoteNotebookSectionGroupSectionsCountOperationOptions) (result GetSiteOnenoteNotebookSectionGroupSectionsCountOperationResponse, err error) {
