...
// Nullable.
func (c SiteOnenoteNotebookSectionGroupSectionClient) ListSiteOnenoteNotebookSectionGroupSections(ctx context.Context, id stable.GroupIdSiteIdOnenoteNotebookIdSectionGroupId, options ListSiteOnenoteNotebookSectionGroupSectionsOperationOptions) (result ListSiteOnenoteNotebookSectionGroupSectionsOperationResponse, err error) {
...
func (c SiteOnenoteNotebookSectionGroupSectionClient) ListSiteOnenoteNotebookSectionGroupSectionsComplete(ctx context.Context, id stable.GroupIdSiteIdOnenoteNotebookIdSectionGroupId, options ListSiteOnenoteNotebookSectionGroupSectionsOperationOptions) (ListSiteOnenoteNotebookSectionGroupSectionsCompleteResult, error) {
...
func (c SiteOnenoteNotebookSectionGroupSectionClient) ListSiteOnenoteNotebookSectionGroupSectionsCompleteMatchingPredicate(ctx context.Context, id stable.GroupIdSiteIdOnenoteNotebookIdSectionGroupId, options ListSiteOnenoteNotebookSectionGroupSectionsOperationOptions, predicate OnenoteSectionOperationPredicate) (result ListSiteOnenoteNotebookSectionGroupSectionsCompleteResult, err error) {
