...
// Read-only. Nullable.
func (c SiteOnenoteNotebookSectionGroupSectionPageClient) GetSiteOnenoteNotebookSectionGroupSectionPage(ctx context.Context, id stable.GroupIdSiteIdOnenoteNotebookIdSectionGroupIdSectionIdPageId, options GetSiteOnenoteNotebookSectionGroupSectionPageOperationOptions) (result GetSiteOnenoteNotebookSectionGroupSectionPageOperationResponse, err error) {
