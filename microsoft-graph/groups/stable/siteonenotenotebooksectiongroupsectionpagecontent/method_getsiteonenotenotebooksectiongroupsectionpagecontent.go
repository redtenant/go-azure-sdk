...
// page's HTML content.
func (c SiteOnenoteNotebookSectionGroupSectionPageContentClient) GetSiteOnenoteNotebookSectionGroupSectionPageContent(ctx context.Context, id stable.GroupIdSiteIdOnenoteNotebookIdSectionGroupIdSectionIdPageId, options GetSiteOnenoteNotebookSectionGroupSectionPageContentOperationOptions) (result GetSiteOnenoteNotebookSectionGroupSectionPageContentOperationResponse, err error) {
