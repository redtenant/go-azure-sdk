...
func (c SiteOnenoteNotebookSectionGroupSectionPageParentNotebookClient) GetSiteOnenoteNotebookSectionGroupSectionPageParentNotebook(ctx context.Context, id stable.GroupIdSiteIdOnenoteNotebookIdSectionGroupIdSectionIdPageId, options GetSiteOnenoteNotebookSectionGroupSectionPageParentNotebookOperationOptions) (result GetSiteOnenoteNotebookSectionGroupSectionPageParentNotebookOperationResponse, err error) {
