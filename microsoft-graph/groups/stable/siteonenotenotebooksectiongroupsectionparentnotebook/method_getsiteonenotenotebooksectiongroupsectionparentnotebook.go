...
func (c SiteOnenoteNotebookSectionGroupSectionParentNotebookClient) GetSiteOnenoteNotebookSectionGroupSectionParentNotebook(ctx context.Context, id stable.GroupIdSiteIdOnenoteNotebookIdSectionGroupIdSectionId, options GetSiteOnenoteNotebookSectionGroupSectionParentNotebookOperationOptions) (result GetSiteOnenoteNotebookSectionGroupSectionParentNotebookOperationResponse, err error) {
