package siteonenotenotebooksectiongroupsectionparentsectiongroup
...
type GetSiteOnenoteNotebookSectionGroupSectionParentSectionGroupOperationResponse struct {
	HttpResponse *http.Response
	OData        *odata.OData
	Model        *stable.SectionGroup
}

type GetSiteOnenoteNotebookSectionGroupSectionParentSectionGroupOperationOptions struct {
	Expand    *odata.Expand
...
func DefaultGetSiteOnenoteNotebookSectionGroupSectionParentSectionGroupOperationOptions() GetSiteOnenoteNotebookSectionGroupSectionParentSectionGroupOperationOptions {
	return GetSiteOnenoteNotebookSectionGroupSectionParentSectionGroupOperationOptions{}
}
...
// GetSiteOnenoteNotebookSectionGroupSectionParentSectionGroup - Get parentSectionGroup from groups. The section group
// that contains the section. Read-only.
