...
func (c SiteOnenoteOperationClient) GetSiteOnenoteOperation(ctx context.Context, id stable.GroupIdSiteIdOnenoteOperationId, options GetSiteOnenoteOperationOperationOptions) (result GetSiteOnenoteOperationOperationResponse, err error) {
