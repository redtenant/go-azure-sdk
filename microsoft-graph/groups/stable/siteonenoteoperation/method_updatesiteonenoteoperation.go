...
func (c SiteOnenoteOperationClient) UpdateSiteOnenoteOperation(ctx context.Context, id stable.GroupIdSiteIdOnenoteOperationId, input stable.OnenoteOperation, options UpdateSiteOnenoteOperationOperationOptions) (result UpdateSiteOnenoteOperationOperationResponse, err error) {
