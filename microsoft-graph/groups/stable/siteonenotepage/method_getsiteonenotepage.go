...
func DefaultGetSiteOnenotePageOperationOptions() GetSiteOnenotePageOperationOptions {
	return GetSiteOnenotePageOperationOptions{}
}
...
// Read-only. Nullable.
func (c SiteOnenotePageClient) GetSiteOnenotePage(ctx context.Context, id stable.GroupIdSiteIdOnenotePageId, options GetSiteOnenotePageOperationOptions) (result GetSiteOnenotePageOperationResponse, err error) {
