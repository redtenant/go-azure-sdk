...
func DefaultGetSiteOnenotePagesCountOperationOptions() GetSiteOnenotePagesCountOperationOptions {
	return GetSiteOnenotePagesCountOperationOptions{}
}
...
func (c SiteOnenotePageClient) GetSiteOnenotePagesCount(ctx context.Context, id stable.GroupIdSiteId, options GetSiteOnenotePagesCountOperationOptions) (result GetSiteOnenotePagesCountOperationResponse, err error) {
	opts := client.RequestOptions{
		...
		Path:          fmt.Sprintf("%s/onenote/pages/$count", id.ID()),
