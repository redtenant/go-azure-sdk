...
// Read-only. Nullable.
func (c SiteOnenotePageClient) ListSiteOnenotePages(ctx context.Context, id stable.GroupIdSiteId, options ListSiteOnenotePagesOperationOptions) (result ListSiteOnenotePagesOperationResponse, err error) {
...
func (c SiteOnenotePageClient) ListSiteOnenotePagesComplete(ctx context.Context, id stable.GroupIdSiteId, options ListSiteOnenotePagesOperationOptions) (ListSiteOnenotePagesCompleteResult, error) {
...
func (c SiteOnenotePageClient) ListSiteOnenotePagesCompleteMatchingPredicate(ctx context.Context, id stable.GroupIdSiteId, options ListSiteOnenotePagesOperationOptions, predicate OnenotePageOperationPredicate) (result ListSiteOnenotePagesCompleteResult, err error) {
