...
// SetSiteOnenoteResourceContent - Update content for the navigation property resources in groups. The content stream
func (c SiteOnenoteResourceContentClient) SetSiteOnenoteResourceContent(ctx context.Context, id stable.GroupIdSiteIdOnenoteResourceId, input []byte, options SetSiteOnenoteResourceContentOperationOptions) (result SetSiteOnenoteResourceContentOperationResponse, err error) {
