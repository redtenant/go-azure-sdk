...
// CopySiteOnenoteSectionToNotebook - Invoke action copyToNotebook. For Copy operations, you follow an asynchronous
// calling pattern: First call the Copy action, and then poll the operation endpoint for the result.
func (c SiteOnenoteSectionClient) CopySiteOnenoteSectionToNotebook(ctx context.Context, id stable.GroupIdSiteIdOnenoteSectionId, input CopySiteOnenoteSectionToNotebookRequest, options CopySiteOnenoteSectionToNotebookOperationOptions) (result CopySiteOnenoteSectionToNotebookOperationResponse, err error) {
