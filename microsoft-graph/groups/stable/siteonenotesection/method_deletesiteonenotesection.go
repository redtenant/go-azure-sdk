...
func (c SiteOnenoteSectionClient) DeleteSiteOnenoteSection(ctx context.Context, id stable.GroupIdSiteIdOnenoteSectionId, options DeleteSiteOnenoteSectionOperationOptions) (result DeleteSiteOnenoteSectionOperationResponse, err error) {
