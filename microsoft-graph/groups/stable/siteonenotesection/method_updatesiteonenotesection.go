...
func (c SiteOnenoteSectionClient) UpdateSiteOnenoteSection(ctx context.Context, id stable.GroupIdSiteIdOnenoteSectionId, input stable.OnenoteSection, options UpdateSiteOnenoteSectionOperationOptions) (result UpdateSiteOnenoteSectionOperationResponse, err error) {
