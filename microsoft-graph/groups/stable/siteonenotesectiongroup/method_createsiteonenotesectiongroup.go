...
type CreateSiteOnenoteSectionGroupOperationResponse struct {
	HttpResponse *http.Response
	OData        *odata.OData
	Model        *stable.SectionGroup
}

type CreateSiteOnenoteSectionGroupOperationOptions struct {
	Metadata  *odata.Metadata
	RetryFunc client.RequestRetryFunc
}

func DefaultCreateSiteOnenoteSectionGroupOperationOptions() CreateSiteOnenoteSectionGroupOperationOptions {
	return CreateSiteOnenoteSectionGroupOperationOptions{}
}
...
func (c SiteOnenoteSectionGroupClient) CreateSiteOnenoteSectionGroup(ctx context.Context, id stable.GroupIdSiteId, input stable.SectionGroup, options CreateSiteOnenoteSectionGroupOperationOptions) (result CreateSiteOnenoteSectionGroupOperationResponse, err error) {
