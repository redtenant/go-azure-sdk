...
type DeleteSiteOnenoteSectionGroupOperationResponse struct {
	HttpResponse *http.Response
	OData        *odata.OData
}

type DeleteSiteOnenoteSectionGroupOperationOptions struct {
	IfMatch   *string
...
func DefaultDeleteSiteOnenoteSectionGroupOperationOptions() DeleteSiteOnenoteSectionGroupOperationOptions {
	return DeleteSiteOnenoteSectionGroupOperationOptions{}
}
...
func (c SiteOnenoteSectionGroupClient) DeleteSiteOnenoteSectionGroup(ctx context.Context, id stable.GroupIdSiteIdOnenoteSectionGroupId, options DeleteSiteOnenoteSectionGroupOperationOptions) (result DeleteSiteOnenoteSectionGroupOperationResponse, err error) {
