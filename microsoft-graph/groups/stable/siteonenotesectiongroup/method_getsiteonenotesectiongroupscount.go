...
type GetSiteOnenoteSectionGroupsCountOperationResponse struct {
	HttpResponse *http.Response
	OData        *odata.OData
	Model        *[]byte
}

type GetSiteOnenoteSectionGroupsCountOperationOptions struct {
	Filter    *string
...
func DefaultGetSiteOnenoteSectionGroupsCountOperationOptions() GetSiteOnenoteSectionGroupsCountOperationOptions {
	return GetSiteOnenoteSectionGroupsCountOperationOptions{}
}
...
func (c SiteOnenoteSectionGroupClient) GetSiteOnenoteSectionGroupsCount(ctx context.Context, id stable.GroupIdSiteId, options GetSiteOnenoteSectionGroupsCountOperationOptions) (result GetSiteOnenoteSectionGroupsCountOperationResponse, err error) {
