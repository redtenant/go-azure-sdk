...
type UpdateSiteOnenoteSectionGroupOperationResponse struct {
	HttpResponse *http.Response
	OData        *odata.OData
}

type UpdateSiteOnenoteSectionGroupOperationOptions struct {
	Metadata  *odata.Metadata
	RetryFunc client.RequestRetryFunc
}

func DefaultUpdateSiteOnenoteSectionGroupOperationOptions() UpdateSiteOnenoteSectionGroupOperationOptions {
	return UpdateSiteOnenoteSectionGroupOperationOptions{}
}
...
func (c SiteOnenoteSectionGroupClient) UpdateSiteOnenoteSectionGroup(ctx context.Context, id stable.GroupIdSiteIdOnenoteSectionGroupId, input stable.SectionGroup, options UpdateSiteOnenoteSectionGroupOperationOptions) (result UpdateSiteOnenoteSectionGroupOperationResponse, err error) {
