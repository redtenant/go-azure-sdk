...
// group. Read-only.
func (c SiteOnenoteSectionGroupParentNotebookClient) GetSiteOnenoteSectionGroupParentNotebook(ctx context.Context, id stable.GroupIdSiteIdOnenoteSectionGroupId, options GetSiteOnenoteSectionGroupParentNotebookOperationOptions) (result GetSiteOnenoteSectionGroupParentNotebookOperationResponse, err error) {
