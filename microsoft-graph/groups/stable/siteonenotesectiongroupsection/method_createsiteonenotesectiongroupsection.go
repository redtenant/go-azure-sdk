...
func DefaultCreateSiteOnenoteSectionGroupSectionOperationOptions() CreateSiteOnenoteSectionGroupSectionOperationOptions {
	return CreateSiteOnenoteSectionGroupSectionOperationOptions{}
}
...
func (c SiteOnenoteSectionGroupSectionClient) CreateSiteOnenoteSectionGroupSection(ctx context.Context, id stable.GroupIdSiteIdOnenoteSectionGroupId, input stable.OnenoteSection, options CreateSiteOnenoteSectionGroupSectionOperationOptions) (result CreateSiteOnenoteSectionGroupSectionOperationResponse, err error) {
