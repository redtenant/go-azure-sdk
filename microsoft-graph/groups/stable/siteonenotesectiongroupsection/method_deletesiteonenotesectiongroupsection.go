...
func DefaultDeleteSiteOnenoteSectionGroupSectionOperationOptions() DeleteSiteOnenoteSectionGroupSectionOperationOptions {
	return DeleteSiteOnenoteSectionGroupSectionOperationOptions{}
}
...
func (c SiteOnenoteSectionGroupSectionClient) DeleteSiteOnenoteSectionGroupSection(ctx context.Context, id stable.GroupIdSiteIdOnenoteSectionGroupIdSectionId, options DeleteSiteOnenoteSectionGroupSectionOperationOptions) (result DeleteSiteOnenoteSectionGroupSectionOperationResponse, err error) {
