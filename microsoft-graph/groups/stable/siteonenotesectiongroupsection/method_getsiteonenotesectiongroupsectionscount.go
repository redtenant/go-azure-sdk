...
func DefaultGetSiteOnenoteSectionGroupSectionsCountOperationOptions() GetSiteOnenoteSectionGroupSectionsCountOperationOptions {
	return GetSiteOnenoteSectionGroupSectionsCountOperationOptions{}
}
...
func (c SiteOnenoteSectionGroupSectionClient) GetSiteOnenoteSectionGroupSectionsCount(ctx context.Context, id stable.GroupIdSiteIdOnenoteSectionGroupId, options GetSiteOnenoteSectionGroupSectionsCountOperationOptions) (result GetSiteOnenoteSectionGroupSectionsCountOperationResponse, err error) {
