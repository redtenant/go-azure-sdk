...
func (c SiteOnenoteSectionGroupSectionClient) UpdateSiteOnenoteSectionGroupSection(ctx context.Context, id stable.GroupIdSiteIdOnenoteSectionGroupIdSectionId, input stable.OnenoteSection, options UpdateSiteOnenoteSectionGroupSectionOperationOptions) (result UpdateSiteOnenoteSectionGroupSectionOperationResponse, err error) {
