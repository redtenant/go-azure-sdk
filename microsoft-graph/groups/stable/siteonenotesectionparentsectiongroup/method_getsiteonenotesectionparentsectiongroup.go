...
// section. Read-only.
func (c SiteOnenoteSectionParentSectionGroupClient) GetSiteOnenoteSectionParentSectionGroup(ctx context.Context, id stable.GroupIdSiteIdOnenoteSectionId, options GetSiteOnenoteSectionParentSectionGroupOperationOptions) (result GetSiteOnenoteSectionParentSectionGroupOperationResponse, err error) {
