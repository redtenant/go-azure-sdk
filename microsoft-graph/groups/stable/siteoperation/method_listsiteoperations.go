...
// ListSiteOperations - Get operations from groups. The collection of long-running operations on the site.
func (c SiteOperationClient) ListSiteOperations(ctx context.Context, id stable.GroupIdSiteId, options ListSiteOperationsOperationOptions) (result ListSiteOperationsOperationResponse, err error) {
...
func (c SiteOperationClient) ListSiteOperationsComplete(ctx context.Context, id stable.GroupIdSiteId, options ListSiteOperationsOperationOptions) (ListSiteOperationsCompleteResult, error) {
...
func (c SiteOperationClient) ListSiteOperationsCompleteMatchingPredicate(ctx context.Context, id stable.GroupIdSiteId, options ListSiteOperationsOperationOptions, predicate RichLongRunningOperationOperationPredicate) (result ListSiteOperationsCompleteResult, err error) {
