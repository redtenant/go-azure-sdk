...
type UpdateSitePageOperationResponse struct {
...
func (c SitePageClient) UpdateSitePage(ctx context.Context, id stable.GroupIdSiteIdPageId, input stable.BaseSitePage, options UpdateSitePageOperationOptions) (result UpdateSitePageOperationResponse, err error) {
