...
func (c SitePageCreatedByUserMailboxSettingClient) GetSitePageCreatedByUserMailboxSetting(ctx context.Context, id stable.GroupIdSiteIdPageId, options GetSitePageCreatedByUserMailboxSettingOperationOptions) (result GetSitePageCreatedByUserMailboxSettingOperationResponse, err error) {
