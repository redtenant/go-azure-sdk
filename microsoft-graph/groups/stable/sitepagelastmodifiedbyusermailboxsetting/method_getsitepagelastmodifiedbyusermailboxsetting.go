...
func (c SitePageLastModifiedByUserMailboxSettingClient) GetSitePageLastModifiedByUserMailboxSetting(ctx context.Context, id stable.GroupIdSiteIdPageId, options GetSitePageLastModifiedByUserMailboxSettingOperationOptions) (result GetSitePageLastModifiedByUserMailboxSettingOperationResponse, err error) {
