...
func DefaultDeleteSitePermissionOperationOptions() DeleteSitePermissionOperationOptions {
	return DeleteSitePermissionOperationOptions{}
}
...
func (c SitePermissionClient) DeleteSitePermission(ctx context.Context, id stable.GroupIdSiteIdPermissionId, options DeleteSitePermissionOperationOptions) (result DeleteSitePermissionOperationResponse, err error) {
