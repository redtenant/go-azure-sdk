...
func DefaultGetSitePermissionOperationOptions() GetSitePermissionOperationOptions {
	return GetSitePermissionOperationOptions{}
}
...
func (c SitePermissionClient) GetSitePermission(ctx context.Context, id stable.GroupIdSiteIdPermissionId, options GetSitePermissionOperationOptions) (result GetSitePermissionOperationResponse, err error) {
