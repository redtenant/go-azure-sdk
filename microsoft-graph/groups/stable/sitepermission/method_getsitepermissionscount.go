...
func (c SitePermissionClient) GetSitePermissionsCount(ctx context.Context, id stable.GroupIdSiteId, options GetSitePermissionsCountOperationOptions) (result GetSitePermissionsCountOperationResponse, err error) {
