...
func (c SitePermissionClient) ListSitePermissionGrants(ctx context.Context, id stable.GroupIdSiteIdPermissionId, input ListSitePermissionGrantsRequest, options ListSitePermissionGrantsOperationOptions) (result ListSitePermissionGrantsOperationResponse, err error) {
...
func (c SitePermissionClient) ListSitePermissionGrantsComplete(ctx context.Context, id stable.GroupIdSiteIdPermissionId, input ListSitePermissionGrantsRequest, options ListSitePermissionGrantsOperationOptions) (ListSitePermissionGrantsCompleteResult, error) {
