...
func (c SitePermissionClient) ListSitePermissions(ctx context.Context, id stable.GroupIdSiteId, options ListSitePermissionsOperationOptions) (result ListSitePermissionsOperationResponse, err error) {
...
func (c SitePermissionClient) ListSitePermissionsComplete(ctx context.Context, id stable.GroupIdSiteId, options ListSitePermissionsOperationOptions) (ListSitePermissionsCompleteResult, error) {
