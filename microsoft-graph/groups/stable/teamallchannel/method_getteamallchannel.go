...
func DefaultGetTeamAllChannelOperationOptions() GetTeamAllChannelOperationOptions {
	return GetTeamAllChannelOperationOptions{}
}
...
// GetTeamAllChannel - Get allChannels from groups. List of channels either hosted in or shared with the team (incoming
// channels).
func (c TeamAllChannelClient) GetTeamAllChannel(ctx context.Context, id stable.GroupIdTeamAllChannelId, options GetTeamAllChannelOperationOptions) (result GetTeamAllChannelOperationResponse, err error) {
