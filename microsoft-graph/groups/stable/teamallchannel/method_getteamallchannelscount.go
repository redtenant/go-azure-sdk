...
func DefaultGetTeamAllChannelsCountOperationOptions() GetTeamAllChannelsCountOperationOptions {
	return GetTeamAllChannelsCountOperationOptions{}
}
...
func (c TeamAllChannelClient) GetTeamAllChannelsCount(ctx context.Context, id stable.GroupId, options GetTeamAllChannelsCountOperationOptions) (result GetTeamAllChannelsCountOperationResponse, err error) {
	opts := client.RequestOptions{
		...
		Path:          fmt.Sprintf("%s/team/allChannels/$count", id.ID()),
