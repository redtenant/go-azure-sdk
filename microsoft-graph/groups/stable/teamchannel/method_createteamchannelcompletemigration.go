...
// successful response.
func (c TeamChannelClient) CreateTeamChannelCompleteMigration(ctx context.Context, id stable.GroupIdTeamChannelId, options CreateTeamChannelCompleteMigrationOperationOptions) (result CreateTeamChannelCompleteMigrationOperationResponse, err error) {
