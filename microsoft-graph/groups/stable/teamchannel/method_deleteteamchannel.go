...
func (c TeamChannelClient) DeleteTeamChannel(ctx context.Context, id stable.GroupIdTeamChannelId, options DeleteTeamChannelOperationOptions) (result DeleteTeamChannelOperationResponse, err error) {
