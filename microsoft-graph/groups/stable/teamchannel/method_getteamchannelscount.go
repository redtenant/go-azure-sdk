...
func DefaultGetTeamChannelsCountOperationOptions() GetTeamChannelsCountOperationOptions {
	return GetTeamChannelsCountOperationOptions{}
}
...
func (c TeamChannelClient) GetTeamChannelsCount(ctx context.Context, id stable.GroupId, options GetTeamChannelsCountOperationOptions) (result GetTeamChannelsCountOperationResponse, err error) {
	opts := client.RequestOptions{
		...
		Path:          fmt.Sprintf("%s/team/channels/$count", id.ID()),
