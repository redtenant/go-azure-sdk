...
func (c TeamChannelClient) UpdateTeamChannel(ctx context.Context, id stable.GroupIdTeamChannelId, input stable.Channel, options UpdateTeamChannelOperationOptions) (result UpdateTeamChannelOperationResponse, err error) {
