...
func (c TeamChannelFilesFolderContentClient) GetTeamChannelFilesFolderContent(ctx context.Context, id stable.GroupIdTeamChannelId, options GetTeamChannelFilesFolderContentOperationOptions) (result GetTeamChannelFilesFolderContentOperationResponse, err error) {
