...
func (c TeamChannelSharedWithTeamClient) DeleteTeamChannelSharedWithTeam(ctx context.Context, id stable.GroupIdTeamChannelIdSharedWithTeamId, options DeleteTeamChannelSharedWithTeamOperationOptions) (result DeleteTeamChannelSharedWithTeamOperationResponse, err error) {
