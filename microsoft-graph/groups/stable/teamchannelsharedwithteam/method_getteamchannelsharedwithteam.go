...
func (c TeamChannelSharedWithTeamClient) GetTeamChannelSharedWithTeam(ctx context.Context, id stable.GroupIdTeamChannelIdSharedWithTeamId, options GetTeamChannelSharedWithTeamOperationOptions) (result GetTeamChannelSharedWithTeamOperationResponse, err error) {
