...
// shared.
func (c TeamChannelSharedWithTeamClient) ListTeamChannelSharedWithTeams(ctx context.Context, id stable.GroupIdTeamChannelId, options ListTeamChannelSharedWithTeamsOperationOptions) (result ListTeamChannelSharedWithTeamsOperationResponse, err error) {
...
func (c TeamChannelSharedWithTeamClient) ListTeamChannelSharedWithTeamsComplete(ctx context.Context, id stable.GroupIdTeamChannelId, options ListTeamChannelSharedWithTeamsOperationOptions) (ListTeamChannelSharedWithTeamsCompleteResult, error) {
...
func (c TeamChannelSharedWithTeamClient) ListTeamChannelSharedWithTeamsCompleteMatchingPredicate(ctx context.Context, id stable.GroupIdTeamChannelId, options ListTeamChannelSharedWithTeamsOperationOptions, predicate SharedWithChannelTeamInfoOperationPredicate) (result ListTeamChannelSharedWithTeamsCompleteResult, err error) {
