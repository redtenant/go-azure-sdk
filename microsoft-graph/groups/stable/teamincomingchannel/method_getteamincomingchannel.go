...
func (c TeamIncomingChannelClient) GetTeamIncomingChannel(ctx context.Context, id stable.GroupIdTeamIncomingChannelId, options GetTeamIncomingChannelOperationOptions) (result GetTeamIncomingChannelOperationResponse, err error) {
