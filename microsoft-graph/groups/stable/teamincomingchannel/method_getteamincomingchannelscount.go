...
func DefaultGetTeamIncomingChannelsCountOperationOptions() GetTeamIncomingChannelsCountOperationOptions {
	return GetTeamIncomingChannelsCountOperationOptions{}
}
...
func (c TeamIncomingChannelClient) GetTeamIncomingChannelsCount(ctx context.Context, id stable.GroupId, options GetTeamIncomingChannelsCountOperationOptions) (result GetTeamIncomingChannelsCountOperationResponse, err error) {
	opts := client.RequestOptions{
		...
		Path:          fmt.Sprintf("%s/team/incomingChannels/$count", id.ID()),
