...
func (c TeamIncomingChannelClient) ListTeamIncomingChannels(ctx context.Context, id stable.GroupId, options ListTeamIncomingChannelsOperationOptions) (result ListTeamIncomingChannelsOperationResponse, err error) {
...
func (c TeamIncomingChannelClient) ListTeamIncomingChannelsComplete(ctx context.Context, id stable.GroupId, options ListTeamIncomingChannelsOperationOptions) (ListTeamIncomingChannelsCompleteResult, error) {
...
func (c TeamIncomingChannelClient) ListTeamIncomingChannelsCompleteMatchingPredicate(ctx context.Context, id stable.GroupId, options ListTeamIncomingChannelsOperationOptions, predicate ChannelOperationPredicate) (result ListTeamIncomingChannelsCompleteResult, err error) {
