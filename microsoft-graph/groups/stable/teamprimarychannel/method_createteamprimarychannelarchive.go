...
func (c TeamPrimaryChannelClient) CreateTeamPrimaryChannelArchive(ctx context.Context, id stable.GroupId, input CreateTeamPrimaryChannelArchiveRequest, options CreateTeamPrimaryChannelArchiveOperationOptions) (result CreateTeamPrimaryChannelArchiveOperationResponse, err error) {
