...
func DefaultGetTeamPrimaryChannelOperationOptions() GetTeamPrimaryChannelOperationOptions {
	return GetTeamPrimaryChannelOperationOptions{}
}
...
func (c TeamPrimaryChannelClient) GetTeamPrimaryChannel(ctx context.Context, id stable.GroupId, options GetTeamPrimaryChannelOperationOptions) (result GetTeamPrimaryChannelOperationResponse, err error) {
