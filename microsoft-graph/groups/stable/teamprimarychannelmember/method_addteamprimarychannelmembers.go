...
func (c TeamPrimaryChannelMemberClient) AddTeamPrimaryChannelMembers(ctx context.Context, id stable.GroupId, input AddTeamPrimaryChannelMembersRequest, options AddTeamPrimaryChannelMembersOperationOptions) (result AddTeamPrimaryChannelMembersOperationResponse, err error) {
...
func (c TeamPrimaryChannelMemberClient) AddTeamPrimaryChannelMembersComplete(ctx context.Context, id stable.GroupId, input AddTeamPrimaryChannelMembersRequest, options AddTeamPrimaryChannelMembersOperationOptions) (AddTeamPrimaryChannelMembersCompleteResult, error) {
...
func (c TeamPrimaryChannelMemberClient) AddTeamPrimaryChannelMembersCompleteMatchingPredicate(ctx context.Context, id stable.GroupId, input AddTeamPrimaryChannelMembersRequest, options AddTeamPrimaryChannelMembersOperationOptions, predicate ActionResultPartOperationPredicate) (result AddTeamPrimaryChannelMembersCompleteResult, err error) {
