...
func (c TeamPrimaryChannelMessageHostedContentClient) ListTeamPrimaryChannelMessageHostedContents(ctx context.Context, id stable.GroupIdTeamPrimaryChannelMessageId, options ListTeamPrimaryChannelMessageHostedContentsOperationOptions) (result ListTeamPrimaryChannelMessageHostedContentsOperationResponse, err error) {
...
func (c TeamPrimaryChannelMessageHostedContentClient) ListTeamPrimaryChannelMessageHostedContentsComplete(ctx context.Context, id stable.GroupIdTeamPrimaryChannelMessageId, options ListTeamPrimaryChannelMessageHostedContentsOperationOptions) (ListTeamPrimaryChannelMessageHostedContentsCompleteResult, error) {
...
func (c TeamPrimaryChannelMessageHostedContentClient) ListTeamPrimaryChannelMessageHostedContentsCompleteMatchingPredicate(ctx context.Context, id stable.GroupIdTeamPrimaryChannelMessageId, options ListTeamPrimaryChannelMessageHostedContentsOperationOptions, predicate ChatMessageHostedContentOperationPredicate) (result ListTeamPrimaryChannelMessageHostedContentsCompleteResult, err error) {
