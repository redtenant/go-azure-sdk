...
// GetTeamPrimaryChannelSharedWithTeam - Get sharedWithTeams from groups. A collection of teams with which a channel is
// shared.
func (c TeamPrimaryChannelSharedWithTeamClient) GetTeamPrimaryChannelSharedWithTeam(ctx context.Context, id stable.GroupIdTeamPrimaryChannelSharedWithTeamId, options GetTeamPrimaryChannelSharedWithTeamOperationOptions) (result GetTeamPrimaryChannelSharedWithTeamOperationResponse, err error) {
