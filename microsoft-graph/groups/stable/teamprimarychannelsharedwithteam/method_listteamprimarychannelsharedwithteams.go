...
// is shared.
func (c TeamPrimaryChannelSharedWithTeamClient) ListTeamPrimaryChannelSharedWithTeams(ctx context.Context, id stable.GroupId, options ListTeamPrimaryChannelSharedWithTeamsOperationOptions) (result ListTeamPrimaryChannelSharedWithTeamsOperationResponse, err error) {
...
func (c TeamPrimaryChannelSharedWithTeamClient) ListTeamPrimaryChannelSharedWithTeamsComplete(ctx context.Context, id stable.GroupId, options ListTeamPrimaryChannelSharedWithTeamsOperationOptions) (ListTeamPrimaryChannelSharedWithTeamsCompleteResult, error) {
