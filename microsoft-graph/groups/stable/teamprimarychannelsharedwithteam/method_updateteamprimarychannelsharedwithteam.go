...
func (c TeamPrimaryChannelSharedWithTeamClient) UpdateTeamPrimaryChannelSharedWithTeam(ctx context.Context, id stable.GroupIdTeamPrimaryChannelSharedWithTeamId, input stable.SharedWithChannelTeamInfo, options UpdateTeamPrimaryChannelSharedWithTeamOperationOptions) (result UpdateTeamPrimaryChannelSharedWithTeamOperationResponse, err error) {
