...
func (c TeamPrimaryChannelTabClient) CreateTeamPrimaryChannelTab(ctx context.Context, id stable.GroupId, input stable.TeamsTab, options CreateTeamPrimaryChannelTabOperationOptions) (result CreateTeamPrimaryChannelTabOperationResponse, err error) {
