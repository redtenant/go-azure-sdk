...
func (c TeamPrimaryChannelTabClient) GetTeamPrimaryChannelTab(ctx context.Context, id stable.GroupIdTeamPrimaryChannelTabId, options GetTeamPrimaryChannelTabOperationOptions) (result GetTeamPrimaryChannelTabOperationResponse, err error) {
