...
func (c TeamScheduleOpenShiftClient) CreateTeamScheduleOpenShift(ctx context.Context, id stable.GroupId, input stable.OpenShift, options CreateTeamScheduleOpenShiftOperationOptions) (result CreateTeamScheduleOpenShiftOperationResponse, err error) {
