...
// schedule.
func (c TeamScheduleOpenShiftClient) ListTeamScheduleOpenShifts(ctx context.Context, id stable.GroupId, options ListTeamScheduleOpenShiftsOperationOptions) (result ListTeamScheduleOpenShiftsOperationResponse, err error) {
...
func (c TeamScheduleOpenShiftClient) ListTeamScheduleOpenShiftsComplete(ctx context.Context, id stable.GroupId, options ListTeamScheduleOpenShiftsOperationOptions) (ListTeamScheduleOpenShiftsCompleteResult, error) {
...
func (c TeamScheduleOpenShiftClient) ListTeamScheduleOpenShiftsCompleteMatchingPredicate(ctx context.Context, id stable.GroupId, options ListTeamScheduleOpenShiftsOperationOptions, predicate OpenShiftOperationPredicate) (result ListTeamScheduleOpenShiftsCompleteResult, err error) {
