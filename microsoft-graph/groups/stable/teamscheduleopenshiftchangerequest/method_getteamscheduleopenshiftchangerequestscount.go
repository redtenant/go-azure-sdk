...
func (c TeamScheduleOpenShiftChangeRequestClient) GetTeamScheduleOpenShiftChangeRequestsCount(ctx context.Context, id stable.GroupId, options GetTeamScheduleOpenShiftChangeRequestsCountOperationOptions) (result GetTeamScheduleOpenShiftChangeRequestsCountOperationResponse, err error) {
