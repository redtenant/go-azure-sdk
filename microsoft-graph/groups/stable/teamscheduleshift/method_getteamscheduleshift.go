...
type GetTeamScheduleShiftOperationResponse struct {
	HttpResponse *http.Response
	OData        *odata.OData
	Model        *stable.Shift
}

type GetTeamScheduleShiftOperationOptions struct {
	Expand    *odata.Expand
...
func DefaultGetTeamScheduleShiftOperationOptions() GetTeamScheduleShiftOperationOptions {
	return GetTeamScheduleShiftOperationOptions{}
}
...
func (c TeamScheduleShiftClient) GetTeamScheduleShift(ctx context.Context, id stable.GroupIdTeamScheduleShiftId, options GetTeamScheduleShiftOperationOptions) (result GetTeamScheduleShiftOperationResponse, err error) {
