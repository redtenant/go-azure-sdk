...
func (c TeamScheduleShiftClient) ListTeamScheduleShifts(ctx context.Context, id stable.GroupId, options ListTeamScheduleShiftsOperationOptions) (result ListTeamScheduleShiftsOperationResponse, err error) {
...
func (c TeamScheduleShiftClient) ListTeamScheduleShiftsComplete(ctx context.Context, id stable.GroupId, options ListTeamScheduleShiftsOperationOptions) (ListTeamScheduleShiftsCompleteResult, error) {
...
func (c TeamScheduleShiftClient) ListTeamScheduleShiftsCompleteMatchingPredicate(ctx context.Context, id stable.GroupId, options ListTeamScheduleShiftsOperationOptions, predicate ShiftOperationPredicate) (result ListTeamScheduleShiftsCompleteResult, err error) {
