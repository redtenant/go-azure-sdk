...
func (c TeamScheduleSwapShiftsChangeRequestClient) UpdateTeamScheduleSwapShiftsChangeRequest(ctx context.Context, id stable.GroupIdTeamScheduleSwapShiftsChangeRequestId, input stable.SwapShiftsChangeRequest, options UpdateTeamScheduleSwapShiftsChangeRequestOperationOptions) (result UpdateTeamScheduleSwapShiftsChangeRequestOperationResponse, err error) {
