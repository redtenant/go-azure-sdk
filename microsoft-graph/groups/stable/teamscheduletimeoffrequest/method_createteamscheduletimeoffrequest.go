...
func (c TeamScheduleTimeOffRequestClient) CreateTeamScheduleTimeOffRequest(ctx context.Context, id stable.GroupId, input stable.TimeOffRequest, options CreateTeamScheduleTimeOffRequestOperationOptions) (result CreateTeamScheduleTimeOffRequestOperationResponse, err error) {
