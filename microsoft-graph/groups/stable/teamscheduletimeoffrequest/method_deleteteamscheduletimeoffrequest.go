...
func (c TeamScheduleTimeOffRequestClient) DeleteTeamScheduleTimeOffRequest(ctx context.Context, id stable.GroupIdTeamScheduleTimeOffRequestId, options DeleteTeamScheduleTimeOffRequestOperationOptions) (result DeleteTeamScheduleTimeOffRequestOperationResponse, err error) {
