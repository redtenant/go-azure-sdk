...
type GetTeamScheduleTimeOffRequestOperationResponse struct {
	HttpResponse *http.Response
	OData        *odata.OData
	Model        *stable.TimeOffRequest
}

type GetTeamScheduleTimeOffRequestOperationOptions struct {
	Expand    *odata.Expand
...
func DefaultGetTeamScheduleTimeOffRequestOperationOptions() GetTeamScheduleTimeOffRequestOperationOptions {
	return GetTeamScheduleTimeOffRequestOperationOptions{}
}
...
func (c TeamScheduleTimeOffRequestClient) GetTeamScheduleTimeOffRequest(ctx context.Context, id stable.GroupIdTeamScheduleTimeOffRequestId, options GetTeamScheduleTimeOffRequestOperationOptions) (result GetTeamScheduleTimeOffRequestOperationResponse, err error) {
