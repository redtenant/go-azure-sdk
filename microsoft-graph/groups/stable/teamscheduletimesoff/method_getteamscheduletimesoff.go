...
type GetTeamScheduleTimesOffOperationResponse struct {
	HttpResponse *http.Response
	OData        *odata.OData
	Model        *stable.TimeOff
}

type GetTeamScheduleTimesOffOperationOptions struct {
	Expand    *odata.Expand
...
func DefaultGetTeamScheduleTimesOffOperationOptions() GetTeamScheduleTimesOffOperationOptions {
	return GetTeamScheduleTimesOffOperationOptions{}
}
...
func (c TeamScheduleTimesOffClient) GetTeamScheduleTimesOff(ctx context.Context, id stable.GroupIdTeamScheduleTimesOffId, options GetTeamScheduleTimesOffOperationOptions) (result GetTeamScheduleTimesOffOperationResponse, err error) {
