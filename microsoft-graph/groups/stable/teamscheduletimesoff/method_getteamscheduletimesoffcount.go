...
type GetTeamScheduleTimesOffCountOperationOptions struct {
	Filter    *string
...
func DefaultGetTeamScheduleTimesOffCountOperationOptions() GetTeamScheduleTimesOffCountOperationOptions {
	return GetTeamScheduleTimesOffCountOperationOptions{}
}
...
func (c TeamScheduleTimesOffClient) GetTeamScheduleTimesOffCount(ctx context.Context, id stable.GroupId, options GetTeamScheduleTimesOffCountOperationOptions) (result GetTeamScheduleTimesOffCountOperationResponse, err error) {
