...
func DefaultCreateThreadPostAttachmentsUploadSessionOperationOptions() CreateThreadPostAttachmentsUploadSessionOperationOptions {
	return CreateThreadPostAttachmentsUploadSessionOperationOptions{}
}
...
// CreateThreadPostAttachmentsUploadSession - Invoke action createUploadSession. Create an upload session that allows an
