...
func DefaultDeleteThreadPostAttachmentOperationOptions() DeleteThreadPostAttachmentOperationOptions {
	return DeleteThreadPostAttachmentOperationOptions{}
}
...
func (c ThreadPostAttachmentClient) DeleteThreadPostAttachment(ctx context.Context, id stable.GroupIdThreadIdPostIdAttachmentId, options DeleteThreadPostAttachmentOperationOptions) (result DeleteThreadPostAttachmentOperationResponse, err error) {
