...
func DefaultGetThreadPostAttachmentsCountOperationOptions() GetThreadPostAttachmentsCountOperationOptions {
	return GetThreadPostAttachmentsCountOperationOptions{}
}
...
func (c ThreadPostAttachmentClient) GetThreadPostAttachmentsCount(ctx context.Context, id stable.GroupIdThreadIdPostId, options GetThreadPostAttachmentsCountOperationOptions) (result GetThreadPostAttachmentsCountOperationResponse, err error) {
