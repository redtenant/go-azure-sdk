...
type DeleteThreadPostExtensionOperationResponse struct {
	HttpResponse *http.Response
	OData        *odata.OData
}

type DeleteThreadPostExtensionOperationOptions struct {
	IfMatch   *string
...
func DefaultDeleteThreadPostExtensionOperationOptions() DeleteThreadPostExtensionOperationOptions {
	return DeleteThreadPostExtensionOperationOptions{}
}
...
func (c ThreadPostExtensionClient) DeleteThreadPostExtension(ctx context.Context, id stable.GroupIdThreadIdPostIdExtensionId, options DeleteThreadPostExtensionOperationOptions) (result DeleteThreadPostExtensionOperationResponse, err error) {
