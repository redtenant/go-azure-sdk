...
func DefaultGetThreadPostInReplyToOperationOptions() GetThreadPostInReplyToOperationOptions {
	return GetThreadPostInReplyToOperationOptions{}
}
...
// GetThreadPostInReplyTo - Get inReplyTo from groups. Read-only. Supports $expand.
func (c ThreadPostInReplyToClient) GetThreadPostInReplyTo(ctx context.Context, id stable.GroupIdThreadIdPostId, options GetThreadPostInReplyToOperationOptions) (result GetThreadPostInReplyToOperationResponse, err error) {
