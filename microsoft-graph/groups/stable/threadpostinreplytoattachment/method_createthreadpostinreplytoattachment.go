...
func (c ThreadPostInReplyToAttachmentClient) CreateThreadPostInReplyToAttachment(ctx context.Context, id stable.GroupIdThreadIdPostId, input stable.Attachment, options CreateThreadPostInReplyToAttachmentOperationOptions) (result CreateThreadPostInReplyToAttachmentOperationResponse, err error) {
