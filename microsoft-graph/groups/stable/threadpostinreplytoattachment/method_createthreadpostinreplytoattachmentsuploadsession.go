...
func DefaultCreateThreadPostInReplyToAttachmentsUploadSessionOperationOptions() CreateThreadPostInReplyToAttachmentsUploadSessionOperationOptions {
	return CreateThreadPostInReplyToAttachmentsUploadSessionOperationOptions{}
}
...
// CreateThreadPostInReplyToAttachmentsUploadSession - Invoke action createUploadSession. Create an upload session that
...
func (c ThreadPostInReplyToAttachmentClient) CreateThreadPostInReplyToAttachmentsUploadSession(ctx context.Context, id stable.GroupIdThreadIdPostId, input CreateThreadPostInReplyToAttachmentsUploadSessionRequest, options CreateThreadPostInReplyToAttachmentsUploadSessionOperationOptions) (result CreateThreadPostInReplyToAttachmentsUploadSessionOperationResponse, err error) {
