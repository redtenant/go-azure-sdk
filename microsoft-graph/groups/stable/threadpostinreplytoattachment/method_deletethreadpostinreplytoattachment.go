...
func DefaultDeleteThreadPostInReplyToAttachmentOperationOptions() DeleteThreadPostInReplyToAttachmentOperationOptions {
	return DeleteThreadPostInReplyToAttachmentOperationOptions{}
}
...
func (c ThreadPostInReplyToAttachmentClient) DeleteThreadPostInReplyToAttachment(ctx context.Context, id stable.GroupIdThreadIdPostIdInReplyToAttachmentId, options DeleteThreadPostInReplyToAttachmentOperationOptions) (result DeleteThreadPostInReplyToAttachmentOperationResponse, err error) {
