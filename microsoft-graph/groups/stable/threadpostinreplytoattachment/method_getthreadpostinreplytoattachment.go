...
func DefaultGetThreadPostInReplyToAttachmentOperationOptions() GetThreadPostInReplyToAttachmentOperationOptions {
	return GetThreadPostInReplyToAttachmentOperationOptions{}
}
...
// GetThreadPostInReplyToAttachment - Get attachments from groups. Read-only. Nullable. Supports $expand.
func (c ThreadPostInReplyToAttachmentClient) GetThreadPostInReplyToAttachment(ctx context.Context, id stable.GroupIdThreadIdPostIdInReplyToAttachmentId, options GetThreadPostInReplyToAttachmentOperationOptions) (result GetThreadPostInReplyToAttachmentOperationResponse, err error) {
