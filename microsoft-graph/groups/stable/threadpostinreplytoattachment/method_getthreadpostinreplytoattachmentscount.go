...
func DefaultGetThreadPostInReplyToAttachmentsCountOperationOptions() GetThreadPostInReplyToAttachmentsCountOperationOptions {
	return GetThreadPostInReplyToAttachmentsCountOperationOptions{}
}
...
func (c ThreadPostInReplyToAttachmentClient) GetThreadPostInReplyToAttachmentsCount(ctx context.Context, id stable.GroupIdThreadIdPostId, options GetThreadPostInReplyToAttachmentsCountOperationOptions) (result GetThreadPostInReplyToAttachmentsCountOperationResponse, err error) {
