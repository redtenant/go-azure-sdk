...
func DefaultListThreadPostInReplyToAttachmentsOperationOptions() ListThreadPostInReplyToAttachmentsOperationOptions {
	return ListThreadPostInReplyToAttachmentsOperationOptions{}
}
...
// ListThreadPostInReplyToAttachments - Get attachments from groups. Read-only. Nullable. Supports $expand.
func (c ThreadPostInReplyToAttachmentClient) ListThreadPostInReplyToAttachments(ctx context.Context, id stable.GroupIdThreadIdPostId, options ListThreadPostInReplyToAttachmentsOperationOptions) (result ListThreadPostInReplyToAttachmentsOperationResponse, err error) {
...
func (c ThreadPostInReplyToAttachmentClient) ListThreadPostInReplyToAttachmentsComplete(ctx context.Context, id stable.GroupIdThreadIdPostId, options ListThreadPostInReplyToAttachmentsOperationOptions) (ListThreadPostInReplyToAttachmentsCompleteResult, error) {
	return c.ListThreadPostInReplyToAttachmentsCompleteMatchingPredicate(ctx, id, options, AttachmentOperationPredicate{})
}

// ListThreadPostInReplyToAttachmentsCompleteMatchingPredicate retrieves all the results and then applies the predicate
func (c ThreadPostInReplyToAttachmentClient) ListThreadPostInReplyToAttachmentsCompleteMatchingPredicate(ctx context.Context, id stable.GroupIdThreadIdPostId, options ListThreadPostInReplyToAttachmentsOperationOptions, predicate AttachmentOperationPredicate) (result ListThreadPostInReplyToAttachmentsCompleteResult, err error) {
	items := make([]stable.Attachment, 0)

	resp, err := c.ListThreadPostInReplyToAttachments(ctx, id, options)
	if err != nil {
