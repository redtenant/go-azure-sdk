...
func DefaultDeleteThreadPostInReplyToExtensionOperationOptions() DeleteThreadPostInReplyToExtensionOperationOptions {
	return DeleteThreadPostInReplyToExtensionOperationOptions{}
}
...
func (c ThreadPostInReplyToExtensionClient) DeleteThreadPostInReplyToExtension(ctx context.Context, id stable.GroupIdThreadIdPostIdInReplyToExtensionId, options DeleteThreadPostInReplyToExtensionOperationOptions) (result DeleteThreadPostInReplyToExtensionOperationResponse, err error) {
