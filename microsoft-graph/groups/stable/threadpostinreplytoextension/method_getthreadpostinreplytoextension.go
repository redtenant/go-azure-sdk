...
func DefaultGetThreadPostInReplyToExtensionOperationOptions() GetThreadPostInReplyToExtensionOperationOptions {
	return GetThreadPostInReplyToExtensionOperationOptions{}
}
...
// GetThreadPostInReplyToExtension - Get extensions from groups. The collection of open extensions defined for the post.
// Read-only. Nullable. Supports $expand.
func (c ThreadPostInReplyToExtensionClient) GetThreadPostInReplyToExtension(ctx context.Context, id stable.GroupIdThreadIdPostIdInReplyToExtensionId, options GetThreadPostInReplyToExtensionOperationOptions) (result GetThreadPostInReplyToExtensionOperationResponse, err error) {
