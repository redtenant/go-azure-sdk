...
func (c ThreadPostInReplyToExtensionClient) GetThreadPostInReplyToExtensionsCount(ctx context.Context, id stable.GroupIdThreadIdPostId, options GetThreadPostInReplyToExtensionsCountOperationOptions) (result GetThreadPostInReplyToExtensionsCountOperationResponse, err error) {
