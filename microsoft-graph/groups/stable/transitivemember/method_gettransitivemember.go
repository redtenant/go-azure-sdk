...
func DefaultGetTransitiveMemberOperationOptions() GetTransitiveMemberOperationOptions {
	return GetTransitiveMemberOperationOptions{}
}
...
func (c TransitiveMemberClient) GetTransitiveMember(ctx context.Context, id stable.GroupIdTransitiveMemberId, options GetTransitiveMemberOperationOptions) (result GetTransitiveMemberOperationResponse, err error) {
