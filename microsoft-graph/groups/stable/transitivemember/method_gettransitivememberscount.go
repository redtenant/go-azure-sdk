...
func (c TransitiveMemberClient) GetTransitiveMembersCount(ctx context.Context, id stable.GroupId, options GetTransitiveMembersCountOperationOptions) (result GetTransitiveMembersCountOperationResponse, err error) {
