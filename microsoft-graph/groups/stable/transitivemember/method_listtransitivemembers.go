...
func (c TransitiveMemberClient) ListTransitiveMembers(ctx context.Context, id stable.GroupId, options ListTransitiveMembersOperationOptions) (result ListTransitiveMembersOperationResponse, err error) {
...
func (c TransitiveMemberClient) ListTransitiveMembersComplete(ctx context.Context, id stable.GroupId, options ListTransitiveMembersOperationOptions) (ListTransitiveMembersCompleteResult, error) {
