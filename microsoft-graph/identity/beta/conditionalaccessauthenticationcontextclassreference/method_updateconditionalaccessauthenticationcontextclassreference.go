...
// UpdateConditionalAccessAuthenticationContextClassReference - Update authenticationContextClassReference. Update the
// properties of an authenticationContextClassReference object.
func (c ConditionalAccessAuthenticationContextClassReferenceClient) UpdateConditionalAccessAuthenticationContextClassReference(ctx context.Context, id beta.IdentityConditionalAccessAuthenticationContextClassReferenceId, input beta.AuthenticationContextClassReference, options UpdateConditionalAccessAuthenticationContextClassReferenceOperationOptions) (result UpdateConditionalAccessAuthenticationContextClassReferenceOperationResponse, err error) {
