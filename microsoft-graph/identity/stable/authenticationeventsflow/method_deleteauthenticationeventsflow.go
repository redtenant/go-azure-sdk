...
func DefaultDeleteAuthenticationEventsFlowOperationOptions() DeleteAuthenticationEventsFlowOperationOptions {
	return DeleteAuthenticationEventsFlowOperationOptions{}
}
...
// DeleteAuthenticationEventsFlow - Delete authenticationEventsFlow. Delete a specific authenticationEventsFlow resource
// by ID. This operation also removes or unlinks all applications from the flow, which disables the customized
// authentication experience defined for the application. The following derived subtypes are supported: -
