...
func (c AccessReviewDefinitionInstanceDecisionClient) GetAccessReviewDefinitionInstanceDecision(ctx context.Context, id beta.IdentityGovernanceAccessReviewDefinitionIdInstanceIdDecisionId, options GetAccessReviewDefinitionInstanceDecisionOperationOptions) (result GetAccessReviewDefinitionInstanceDecisionOperationResponse, err error) {
