...
func (c AccessReviewDefinitionInstanceDecisionInsightClient) GetAccessReviewDefinitionInstanceDecisionInsightsCount(ctx context.Context, id beta.IdentityGovernanceAccessReviewDefinitionIdInstanceIdDecisionId, options GetAccessReviewDefinitionInstanceDecisionInsightsCountOperationOptions) (result GetAccessReviewDefinitionInstanceDecisionInsightsCountOperationResponse, err error) {
