...
func (c AccessReviewDefinitionInstanceStageClient) DeleteAccessReviewDefinitionInstanceStage(ctx context.Context, id beta.IdentityGovernanceAccessReviewDefinitionIdInstanceIdStageId, options DeleteAccessReviewDefinitionInstanceStageOperationOptions) (result DeleteAccessReviewDefinitionInstanceStageOperationResponse, err error) {
