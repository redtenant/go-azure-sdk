...
func (c AccessReviewDefinitionInstanceStageClient) GetAccessReviewDefinitionInstanceStage(ctx context.Context, id beta.IdentityGovernanceAccessReviewDefinitionIdInstanceIdStageId, options GetAccessReviewDefinitionInstanceStageOperationOptions) (result GetAccessReviewDefinitionInstanceStageOperationResponse, err error) {
