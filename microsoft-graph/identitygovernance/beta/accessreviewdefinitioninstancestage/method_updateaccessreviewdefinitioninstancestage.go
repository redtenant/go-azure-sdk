...
func (c AccessReviewDefinitionInstanceStageClient) UpdateAccessReviewDefinitionInstanceStage(ctx context.Context, id beta.IdentityGovernanceAccessReviewDefinitionIdInstanceIdStageId, input beta.AccessReviewStage, options UpdateAccessReviewDefinitionInstanceStageOperationOptions) (result UpdateAccessReviewDefinitionInstanceStageOperationResponse, err error) {
