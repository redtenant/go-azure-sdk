...
// identityGovernance
func (c AccessReviewDefinitionInstanceStageDecisionClient) CreateAccessReviewDefinitionInstanceStageDecision(ctx context.Context, id beta.IdentityGovernanceAccessReviewDefinitionIdInstanceIdStageId, input beta.AccessReviewInstanceDecisionItem, options CreateAccessReviewDefinitionInstanceStageDecisionOperationOptions) (result CreateAccessReviewDefinitionInstanceStageDecisionOperationResponse, err error) {
