...
func (c AccessReviewDefinitionInstanceStageDecisionInsightClient) ListAccessReviewDefinitionInstanceStageDecisionInsights(ctx context.Context, id beta.IdentityGovernanceAccessReviewDefinitionIdInstanceIdStageIdDecisionId, options ListAccessReviewDefinitionInstanceStageDecisionInsightsOperationOptions) (result ListAccessReviewDefinitionInstanceStageDecisionInsightsOperationResponse, err error) {
...
func (c AccessReviewDefinitionInstanceStageDecisionInsightClient) ListAccessReviewDefinitionInstanceStageDecisionInsightsCompleteMatchingPredicate(ctx context.Context, id beta.IdentityGovernanceAccessReviewDefinitionIdInstanceIdStageIdDecisionId, options ListAccessReviewDefinitionInstanceStageDecisionInsightsOperationOptions, predicate GovernanceInsightOperationPredicate) (result ListAccessReviewDefinitionInstanceStageDecisionInsightsCompleteResult, err error) {
