...
// identityGovernance
func (c AccessReviewDefinitionInstanceStageDecisionInsightClient) UpdateAccessReviewDefinitionInstanceStageDecisionInsight(ctx context.Context, id beta.IdentityGovernanceAccessReviewDefinitionIdInstanceIdStageIdDecisionIdInsightId, input beta.GovernanceInsight, options UpdateAccessReviewDefinitionInstanceStageDecisionInsightOperationOptions) (result UpdateAccessReviewDefinitionInstanceStageDecisionInsightOperationResponse, err error) {
