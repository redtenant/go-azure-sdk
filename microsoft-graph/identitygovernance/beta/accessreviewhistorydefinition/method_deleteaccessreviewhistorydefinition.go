...
func (c AccessReviewHistoryDefinitionClient) DeleteAccessReviewHistoryDefinition(ctx context.Context, id beta.IdentityGovernanceAccessReviewHistoryDefinitionId, options DeleteAccessReviewHistoryDefinitionOperationOptions) (result DeleteAccessReviewHistoryDefinitionOperationResponse, err error) {
