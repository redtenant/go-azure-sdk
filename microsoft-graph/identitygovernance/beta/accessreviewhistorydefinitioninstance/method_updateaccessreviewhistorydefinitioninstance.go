...
func (c AccessReviewHistoryDefinitionInstanceClient) UpdateAccessReviewHistoryDefinitionInstance(ctx context.Context, id beta.IdentityGovernanceAccessReviewHistoryDefinitionIdInstanceId, input beta.AccessReviewHistoryInstance, options UpdateAccessReviewHistoryDefinitionInstanceOperationOptions) (result UpdateAccessReviewHistoryDefinitionInstanceOperationResponse, err error) {
