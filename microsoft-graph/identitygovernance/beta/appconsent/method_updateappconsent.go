...
type UpdateAppConsentOperationResponse struct {
...
func (c AppConsentClient) UpdateAppConsent(ctx context.Context, input beta.AppConsentApprovalRoute, options UpdateAppConsentOperationOptions) (result UpdateAppConsentOperationResponse, err error) {
