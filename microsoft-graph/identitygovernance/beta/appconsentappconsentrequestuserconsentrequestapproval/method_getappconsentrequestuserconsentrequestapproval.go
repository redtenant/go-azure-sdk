...
// with a request.
func (c AppConsentAppConsentRequestUserConsentRequestApprovalClient) GetAppConsentRequestUserConsentRequestApproval(ctx context.Context, id beta.IdentityGovernanceAppConsentAppConsentRequestIdUserConsentRequestId, options GetAppConsentRequestUserConsentRequestApprovalOperationOptions) (result GetAppConsentRequestUserConsentRequestApprovalOperationResponse, err error) {
