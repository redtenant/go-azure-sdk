...
// DeleteEntitlementManagementAccessPackageAssignmentPolicy - Delete navigation property accessPackageAssignmentPolicies
// for identityGovernance
func (c EntitlementManagementAccessPackageAccessPackageAssignmentPolicyClient) DeleteEntitlementManagementAccessPackageAssignmentPolicy(ctx context.Context, id beta.IdentityGovernanceEntitlementManagementAccessPackageIdAccessPackageAssignmentPolicyId, options DeleteEntitlementManagementAccessPackageAssignmentPolicyOperationOptions) (result DeleteEntitlementManagementAccessPackageAssignmentPolicyOperationResponse, err error) {
