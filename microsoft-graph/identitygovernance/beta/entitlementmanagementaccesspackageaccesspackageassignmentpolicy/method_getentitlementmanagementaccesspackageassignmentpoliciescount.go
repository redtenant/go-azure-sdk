...
func (c EntitlementManagementAccessPackageAccessPackageAssignmentPolicyClient) GetEntitlementManagementAccessPackageAssignmentPoliciesCount(ctx context.Context, id beta.IdentityGovernanceEntitlementManagementAccessPackageId, options GetEntitlementManagementAccessPackageAssignmentPoliciesCountOperationOptions) (result GetEntitlementManagementAccessPackageAssignmentPoliciesCountOperationResponse, err error) {
	opts := client.RequestOptions{
		...
		Path:          fmt.Sprintf("%s/accessPackageAssignmentPolicies/$count", id.ID()),
