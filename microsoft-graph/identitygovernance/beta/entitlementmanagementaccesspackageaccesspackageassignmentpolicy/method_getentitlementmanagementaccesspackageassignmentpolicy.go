...
// GetEntitlementManagementAccessPackageAssignmentPolicy - Get accessPackageAssignmentPolicies from identityGovernance.
// Read-only. Nullable. Supports $expand.
func (c EntitlementManagementAccessPackageAccessPackageAssignmentPolicyClient) GetEntitlementManagementAccessPackageAssignmentPolicy(ctx context.Context, id beta.IdentityGovernanceEntitlementManagementAccessPackageIdAccessPackageAssignmentPolicyId, options GetEntitlementManagementAccessPackageAssignmentPolicyOperationOptions) (result GetEntitlementManagementAccessPackageAssignmentPolicyOperationResponse, err error) {
