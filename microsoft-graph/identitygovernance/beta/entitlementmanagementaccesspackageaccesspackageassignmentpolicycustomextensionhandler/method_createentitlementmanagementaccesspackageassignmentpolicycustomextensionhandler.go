...
func (c EntitlementManagementAccessPackageAccessPackageAssignmentPolicyCustomExtensionHandlerClient) CreateEntitlementManagementAccessPackageAssignmentPolicyCustomExtensionHandler(ctx context.Context, id beta.IdentityGovernanceEntitlementManagementAccessPackageIdAccessPackageAssignmentPolicyId, input beta.CustomExtensionHandler, options CreateEntitlementManagementAccessPackageAssignmentPolicyCustomExtensionHandlerOperationOptions) (result CreateEntitlementManagementAccessPackageAssignmentPolicyCustomExtensionHandlerOperationResponse, err error) {
