...
func (c EntitlementManagementAccessPackageAccessPackageAssignmentPolicyCustomExtensionHandlerCustomExtensionClient) GetEntitlementManagementAccessPackageAssignmentPolicyCustomExtensionHandlerCustomExtension(ctx context.Context, id beta.IdentityGovernanceEntitlementManagementAccessPackageIdAccessPackageAssignmentPolicyIdCustomExtensionHandlerId, options GetEntitlementManagementAccessPackageAssignmentPolicyCustomExtensionHandlerCustomExtensionOperationOptions) (result GetEntitlementManagementAccessPackageAssignmentPolicyCustomExtensionHandlerCustomExtensionOperationResponse, err error) {
