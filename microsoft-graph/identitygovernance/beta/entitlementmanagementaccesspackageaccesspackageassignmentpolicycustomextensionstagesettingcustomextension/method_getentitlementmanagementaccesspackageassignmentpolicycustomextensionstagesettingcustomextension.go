...
// $expand.
func (c EntitlementManagementAccessPackageAccessPackageAssignmentPolicyCustomExtensionStageSettingCustomExtensionClient) GetEntitlementManagementAccessPackageAssignmentPolicyCustomExtensionStageSettingCustomExtension(ctx context.Context, id beta.IdentityGovernanceEntitlementManagementAccessPackageIdAccessPackageAssignmentPolicyIdCustomExtensionStageSettingId, options GetEntitlementManagementAccessPackageAssignmentPolicyCustomExtensionStageSettingCustomExtensionOperationOptions) (result GetEntitlementManagementAccessPackageAssignmentPolicyCustomExtensionStageSettingCustomExtensionOperationResponse, err error) {
