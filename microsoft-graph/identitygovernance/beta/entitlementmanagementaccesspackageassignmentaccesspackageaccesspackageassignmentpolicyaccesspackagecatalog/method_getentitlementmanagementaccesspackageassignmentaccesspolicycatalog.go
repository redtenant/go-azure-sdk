...
func (c EntitlementManagementAccessPackageAssignmentAccessPackageAccessPackageAssignmentPolicyAccessPackageCatalogClient) GetEntitlementManagementAccessPackageAssignmentAccessPolicyCatalog(ctx context.Context, id beta.IdentityGovernanceEntitlementManagementAccessPackageAssignmentIdAccessPackageAccessPackageAssignmentPolicyId, options GetEntitlementManagementAccessPackageAssignmentAccessPolicyCatalogOperationOptions) (result GetEntitlementManagementAccessPackageAssignmentAccessPolicyCatalogOperationResponse, err error) {
