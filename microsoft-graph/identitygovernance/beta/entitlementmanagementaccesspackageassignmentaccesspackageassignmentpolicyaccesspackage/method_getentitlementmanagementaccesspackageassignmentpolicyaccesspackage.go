...
func (c EntitlementManagementAccessPackageAssignmentAccessPackageAssignmentPolicyAccessPackageClient) GetEntitlementManagementAccessPackageAssignmentPolicyAccessPackage(ctx context.Context, id beta.IdentityGovernanceEntitlementManagementAccessPackageAssignmentId, options GetEntitlementManagementAccessPackageAssignmentPolicyAccessPackageOperationOptions) (result GetEntitlementManagementAccessPackageAssignmentPolicyAccessPackageOperationResponse, err error) {
	opts := client.RequestOptions{
		...
		Path:          fmt.Sprintf("%s/accessPackageAssignmentPolicy/accessPackage", id.ID()),
