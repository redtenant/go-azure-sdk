...
func (c EntitlementManagementAccessPackageAssignmentAccessPackageAssignmentPolicyAccessPackageCatalogClient) GetEntitlementManagementAccessPackageAssignmentPolicyCatalog(ctx context.Context, id beta.IdentityGovernanceEntitlementManagementAccessPackageAssignmentId, options GetEntitlementManagementAccessPackageAssignmentPolicyCatalogOperationOptions) (result GetEntitlementManagementAccessPackageAssignmentPolicyCatalogOperationResponse, err error) {
	opts := client.RequestOptions{
		...
		Path:          fmt.Sprintf("%s/accessPackageAssignmentPolicy/accessPackageCatalog", id.ID()),
