...
// Supports $expand.
func (c EntitlementManagementAccessPackageAssignmentAccessPackageAssignmentPolicyCustomExtensionHandlerClient) ListEntitlementManagementAccessPackageAssignmentPolicyCustomExtensionHandlers(ctx context.Context, id beta.IdentityGovernanceEntitlementManagementAccessPackageAssignmentId, options ListEntitlementManagementAccessPackageAssignmentPolicyCustomExtensionHandlersOperationOptions) (result ListEntitlementManagementAccessPackageAssignmentPolicyCustomExtensionHandlersOperationResponse, err error) {
...
func (c EntitlementManagementAccessPackageAssignmentAccessPackageAssignmentPolicyCustomExtensionHandlerClient) ListEntitlementManagementAccessPackageAssignmentPolicyCustomExtensionHandlersComplete(ctx context.Context, id beta.IdentityGovernanceEntitlementManagementAccessPackageAssignmentId, options ListEntitlementManagementAccessPackageAssignmentPolicyCustomExtensionHandlersOperationOptions) (ListEntitlementManagementAccessPackageAssignmentPolicyCustomExtensionHandlersCompleteResult, error) {
...
func (c EntitlementManagementAccessPackageAssignmentAccessPackageAssignmentPolicyCustomExtensionHandlerClient) ListEntitlementManagementAccessPackageAssignmentPolicyCustomExtensionHandlersCompleteMatchingPredicate(ctx context.Context, id beta.IdentityGovernanceEntitlementManagementAccessPackageAssignmentId, options ListEntitlementManagementAccessPackageAssignmentPolicyCustomExtensionHandlersOperationOptions, predicate CustomExtensionHandlerOperationPredicate) (result ListEntitlementManagementAccessPackageAssignmentPolicyCustomExtensionHandlersCompleteResult, err error) {
