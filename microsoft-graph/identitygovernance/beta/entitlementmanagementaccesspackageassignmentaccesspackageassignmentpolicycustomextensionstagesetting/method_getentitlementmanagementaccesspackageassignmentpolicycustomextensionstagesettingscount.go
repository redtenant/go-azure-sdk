...
func (c EntitlementManagementAccessPackageAssignmentAccessPackageAssignmentPolicyCustomExtensionStageSettingClient) GetEntitlementManagementAccessPackageAssignmentPolicyCustomExtensionStageSettingsCount(ctx context.Context, id beta.IdentityGovernanceEntitlementManagementAccessPackageAssignmentId, options GetEntitlementManagementAccessPackageAssignmentPolicyCustomExtensionStageSettingsCountOperationOptions) (result GetEntitlementManagementAccessPackageAssignmentPolicyCustomExtensionStageSettingsCountOperationResponse, err error) {
	opts := client.RequestOptions{
		...
		Path:          fmt.Sprintf("%s/accessPackageAssignmentPolicy/customExtensionStageSettings/$count", id.ID()),
