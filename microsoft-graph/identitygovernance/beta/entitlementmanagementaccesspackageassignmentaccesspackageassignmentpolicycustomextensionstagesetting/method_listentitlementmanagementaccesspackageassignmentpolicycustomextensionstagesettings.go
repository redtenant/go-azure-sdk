...
func (c EntitlementManagementAccessPackageAssignmentAccessPackageAssignmentPolicyCustomExtensionStageSettingClient) ListEntitlementManagementAccessPackageAssignmentPolicyCustomExtensionStageSettings(ctx context.Context, id beta.IdentityGovernanceEntitlementManagementAccessPackageAssignmentId, options ListEntitlementManagementAccessPackageAssignmentPolicyCustomExtensionStageSettingsOperationOptions) (result ListEntitlementManagementAccessPackageAssignmentPolicyCustomExtensionStageSettingsOperationResponse, err error) {
	opts := client.RequestOptions{
		...
		Path:          fmt.Sprintf("%s/accessPackageAssignmentPolicy/customExtensionStageSettings", id.ID()),
...
func (c EntitlementManagementAccessPackageAssignmentAccessPackageAssignmentPolicyCustomExtensionStageSettingClient) ListEntitlementManagementAccessPackageAssignmentPolicyCustomExtensionStageSettingsComplete(ctx context.Context, id beta.IdentityGovernanceEntitlementManagementAccessPackageAssignmentId, options ListEntitlementManagementAccessPackageAssignmentPolicyCustomExtensionStageSettingsOperationOptions) (ListEntitlementManagementAccessPackageAssignmentPolicyCustomExtensionStageSettingsCompleteResult, error) {
