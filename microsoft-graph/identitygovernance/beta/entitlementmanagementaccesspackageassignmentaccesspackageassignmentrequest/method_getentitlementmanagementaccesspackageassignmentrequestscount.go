...
func (c EntitlementManagementAccessPackageAssignmentAccessPackageAssignmentRequestClient) GetEntitlementManagementAccessPackageAssignmentRequestsCount(ctx context.Context, id beta.IdentityGovernanceEntitlementManagementAccessPackageAssignmentId, options GetEntitlementManagementAccessPackageAssignmentRequestsCountOperationOptions) (result GetEntitlementManagementAccessPackageAssignmentRequestsCountOperationResponse, err error) {
	opts := client.RequestOptions{
		...
		Path:          fmt.Sprintf("%s/accessPackageAssignmentRequests/$count", id.ID()),
