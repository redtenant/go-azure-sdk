...
// ListEntitlementManagementAccessPackageAssignmentRequests - Get accessPackageAssignmentRequests from
// identityGovernance
func (c EntitlementManagementAccessPackageAssignmentAccessPackageAssignmentRequestClient) ListEntitlementManagementAccessPackageAssignmentRequests(ctx context.Context, id beta.IdentityGovernanceEntitlementManagementAccessPackageAssignmentId, options ListEntitlementManagementAccessPackageAssignmentRequestsOperationOptions) (result ListEntitlementManagementAccessPackageAssignmentRequestsOperationResponse, err error) {
	opts := client.RequestOptions{
		...
		Path:          fmt.Sprintf("%s/accessPackageAssignmentRequests", id.ID()),
...
func (c EntitlementManagementAccessPackageAssignmentAccessPackageAssignmentRequestClient) ListEntitlementManagementAccessPackageAssignmentRequestsComplete(ctx context.Context, id beta.IdentityGovernanceEntitlementManagementAccessPackageAssignmentId, options ListEntitlementManagementAccessPackageAssignmentRequestsOperationOptions) (ListEntitlementManagementAccessPackageAssignmentRequestsCompleteResult, error) {
	return c.ListEntitlementManagementAccessPackageAssignmentRequestsCompleteMatchingPredicate(ctx, id, options, AccessPackageAssignmentRequestOperationPredicate{})
}
...
func (c EntitlementManagementAccessPackageAssignmentAccessPackageAssignmentRequestClient) ListEntitlementManagementAccessPackageAssignmentRequestsCompleteMatchingPredicate(ctx context.Context, id beta.IdentityGovernanceEntitlementManagementAccessPackageAssignmentId, options ListEntitlementManagementAccessPackageAssignmentRequestsOperationOptions, predicate AccessPackageAssignmentRequestOperationPredicate) (result ListEntitlementManagementAccessPackageAssignmentRequestsCompleteResult, err error) {
	items := make([]beta.AccessPackageAssignmentRequest, 0)

	resp, err := c.ListEntitlementManagementAccessPackageAssignmentRequests(ctx, id, options)
	if err != nil {
