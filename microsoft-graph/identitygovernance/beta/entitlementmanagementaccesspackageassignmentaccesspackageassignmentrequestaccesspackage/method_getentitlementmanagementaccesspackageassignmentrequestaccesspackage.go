...
// Supports $expand.
func (c EntitlementManagementAccessPackageAssignmentAccessPackageAssignmentRequestAccessPackageClient) GetEntitlementManagementAccessPackageAssignmentRequestAccessPackage(ctx context.Context, id beta.IdentityGovernanceEntitlementManagementAccessPackageAssignmentIdAccessPackageAssignmentRequestId, options GetEntitlementManagementAccessPackageAssignmentRequestAccessPackageOperationOptions) (result GetEntitlementManagementAccessPackageAssignmentRequestAccessPackageOperationResponse, err error) {
