...
func (c EntitlementManagementAccessPackageAssignmentAccessPackageIncompatibleGroupClient) ListEntitlementManagementAccessPackageAssignmentIncompatibleGroupRefs(ctx context.Context, id beta.IdentityGovernanceEntitlementManagementAccessPackageAssignmentId, options ListEntitlementManagementAccessPackageAssignmentIncompatibleGroupRefsOperationOptions) (result ListEntitlementManagementAccessPackageAssignmentIncompatibleGroupRefsOperationResponse, err error) {
