...
// the resource
func (c EntitlementManagementAccessPackageAssignmentAccessPackageIncompatibleGroupServiceProvisioningErrorClient) GetEntitlementManagementAccessPackageAssignmentIncompatibleGroupServiceProvisioningErrorsCount(ctx context.Context, id beta.IdentityGovernanceEntitlementManagementAccessPackageAssignmentIdAccessPackageIncompatibleGroupId, options GetEntitlementManagementAccessPackageAssignmentIncompatibleGroupServiceProvisioningErrorsCountOperationOptions) (result GetEntitlementManagementAccessPackageAssignmentIncompatibleGroupServiceProvisioningErrorsCountOperationResponse, err error) {
