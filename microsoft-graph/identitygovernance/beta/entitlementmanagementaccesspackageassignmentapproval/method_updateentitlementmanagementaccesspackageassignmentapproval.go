...
func (c EntitlementManagementAccessPackageAssignmentApprovalClient) UpdateEntitlementManagementAccessPackageAssignmentApproval(ctx context.Context, id beta.IdentityGovernanceEntitlementManagementAccessPackageAssignmentApprovalId, input beta.Approval, options UpdateEntitlementManagementAccessPackageAssignmentApprovalOperationOptions) (result UpdateEntitlementManagementAccessPackageAssignmentApprovalOperationResponse, err error) {
