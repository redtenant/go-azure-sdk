...
// GetEntitlementManagementAccessPackageAssignmentPolicy - Get accessPackageAssignmentPolicy. In Microsoft Entra
// entitlement management, retrieve the properties and relationships of an accessPackageAssignmentPolicy object.
