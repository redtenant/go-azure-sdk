...
func (c EntitlementManagementAccessPackageAssignmentPolicyAccessPackageClient) GetEntitlementManagementAccessPackageAssignmentPolicyAccessPackage(ctx context.Context, id beta.IdentityGovernanceEntitlementManagementAccessPackageAssignmentPolicyId, options GetEntitlementManagementAccessPackageAssignmentPolicyAccessPackageOperationOptions) (result GetEntitlementManagementAccessPackageAssignmentPolicyAccessPackageOperationResponse, err error) {
