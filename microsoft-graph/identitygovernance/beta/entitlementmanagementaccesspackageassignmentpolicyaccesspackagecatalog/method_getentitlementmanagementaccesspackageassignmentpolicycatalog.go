...
func (c EntitlementManagementAccessPackageAssignmentPolicyAccessPackageCatalogClient) GetEntitlementManagementAccessPackageAssignmentPolicyCatalog(ctx context.Context, id beta.IdentityGovernanceEntitlementManagementAccessPackageAssignmentPolicyId, options GetEntitlementManagementAccessPackageAssignmentPolicyCatalogOperationOptions) (result GetEntitlementManagementAccessPackageAssignmentPolicyCatalogOperationResponse, err error) {
