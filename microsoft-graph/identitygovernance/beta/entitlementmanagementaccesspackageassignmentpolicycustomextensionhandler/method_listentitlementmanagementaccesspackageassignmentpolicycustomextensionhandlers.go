...
// Supports $expand.
func (c EntitlementManagementAccessPackageAssignmentPolicyCustomExtensionHandlerClient) ListEntitlementManagementAccessPackageAssignmentPolicyCustomExtensionHandlers(ctx context.Context, id beta.IdentityGovernanceEntitlementManagementAccessPackageAssignmentPolicyId, options ListEntitlementManagementAccessPackageAssignmentPolicyCustomExtensionHandlersOperationOptions) (result ListEntitlementManagementAccessPackageAssignmentPolicyCustomExtensionHandlersOperationResponse, err error) {
...
func (c EntitlementManagementAccessPackageAssignmentPolicyCustomExtensionHandlerClient) ListEntitlementManagementAccessPackageAssignmentPolicyCustomExtensionHandlersComplete(ctx context.Context, id beta.IdentityGovernanceEntitlementManagementAccessPackageAssignmentPolicyId, options ListEntitlementManagementAccessPackageAssignmentPolicyCustomExtensionHandlersOperationOptions) (ListEntitlementManagementAccessPackageAssignmentPolicyCustomExtensionHandlersCompleteResult, error) {
