...
// identityGovernance
func (c EntitlementManagementAccessPackageAssignmentRequestRequestorClient) DeleteEntitlementManagementAccessPackageAssignmentRequestRequestor(ctx context.Context, id beta.IdentityGovernanceEntitlementManagementAccessPackageAssignmentRequestId, options DeleteEntitlementManagementAccessPackageAssignmentRequestRequestorOperationOptions) (result DeleteEntitlementManagementAccessPackageAssignmentRequestRequestorOperationResponse, err error) {
