...
// GetEntitlementManagementAccessPackageCatalog - Get accessPackageCatalog. Retrieve the properties and relationships of
// an accessPackageCatalog object.
func (c EntitlementManagementAccessPackageCatalogClient) GetEntitlementManagementAccessPackageCatalog(ctx context.Context, id beta.IdentityGovernanceEntitlementManagementAccessPackageCatalogId, options GetEntitlementManagementAccessPackageCatalogOperationOptions) (result GetEntitlementManagementAccessPackageCatalogOperationResponse, err error) {
