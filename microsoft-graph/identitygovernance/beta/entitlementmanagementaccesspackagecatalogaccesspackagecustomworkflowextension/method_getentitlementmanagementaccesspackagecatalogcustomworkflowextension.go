...
// GetEntitlementManagementAccessPackageCatalogCustomWorkflowExtension - Get
// accessPackageAssignmentRequestWorkflowExtension. Read the properties and relationships of an
// accessPackageAssignmentRequestWorkflowExtension object.
func (c EntitlementManagementAccessPackageCatalogAccessPackageCustomWorkflowExtensionClient) GetEntitlementManagementAccessPackageCatalogCustomWorkflowExtension(ctx context.Context, id beta.IdentityGovernanceEntitlementManagementAccessPackageCatalogIdAccessPackageCustomWorkflowExtensionId, options GetEntitlementManagementAccessPackageCatalogCustomWorkflowExtensionOperationOptions) (result GetEntitlementManagementAccessPackageCatalogCustomWorkflowExtensionOperationResponse, err error) {
