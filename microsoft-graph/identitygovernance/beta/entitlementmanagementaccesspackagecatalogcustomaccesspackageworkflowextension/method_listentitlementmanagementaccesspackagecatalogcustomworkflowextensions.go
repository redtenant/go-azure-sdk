...
func (c EntitlementManagementAccessPackageCatalogCustomAccessPackageWorkflowExtensionClient) ListEntitlementManagementAccessPackageCatalogCustomWorkflowExtensionsComplete(ctx context.Context, id beta.IdentityGovernanceEntitlementManagementAccessPackageCatalogId, options ListEntitlementManagementAccessPackageCatalogCustomWorkflowExtensionsOperationOptions) (ListEntitlementManagementAccessPackageCatalogCustomWorkflowExtensionsCompleteResult, error) {
