...
func (c EntitlementManagementAccessPackageIncompatibleAccessPackageClient) GetEntitlementManagementAccessPackageIncompatibleCount(ctx context.Context, id beta.IdentityGovernanceEntitlementManagementAccessPackageId, options GetEntitlementManagementAccessPackageIncompatibleCountOperationOptions) (result GetEntitlementManagementAccessPackageIncompatibleCountOperationResponse, err error) {
