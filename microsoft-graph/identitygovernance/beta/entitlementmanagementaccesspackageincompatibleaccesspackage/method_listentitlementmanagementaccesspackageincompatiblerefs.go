...
// accessPackage objects marked as incompatible on an accessPackage.
func (c EntitlementManagementAccessPackageIncompatibleAccessPackageClient) ListEntitlementManagementAccessPackageIncompatibleRefs(ctx context.Context, id beta.IdentityGovernanceEntitlementManagementAccessPackageId, options ListEntitlementManagementAccessPackageIncompatibleRefsOperationOptions) (result ListEntitlementManagementAccessPackageIncompatibleRefsOperationResponse, err error) {
...
func (c EntitlementManagementAccessPackageIncompatibleAccessPackageClient) ListEntitlementManagementAccessPackageIncompatibleRefsComplete(ctx context.Context, id beta.IdentityGovernanceEntitlementManagementAccessPackageId, options ListEntitlementManagementAccessPackageIncompatibleRefsOperationOptions) (ListEntitlementManagementAccessPackageIncompatibleRefsCompleteResult, error) {
