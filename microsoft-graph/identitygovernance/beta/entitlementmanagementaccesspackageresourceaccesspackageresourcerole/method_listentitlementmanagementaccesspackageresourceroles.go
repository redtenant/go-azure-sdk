...
func (c EntitlementManagementAccessPackageResourceAccessPackageResourceRoleClient) ListEntitlementManagementAccessPackageResourceRoles(ctx context.Context, id beta.IdentityGovernanceEntitlementManagementAccessPackageResourceId, options ListEntitlementManagementAccessPackageResourceRolesOperationOptions) (result ListEntitlementManagementAccessPackageResourceRolesOperationResponse, err error) {
...
func (c EntitlementManagementAccessPackageResourceAccessPackageResourceRoleClient) ListEntitlementManagementAccessPackageResourceRolesComplete(ctx context.Context, id beta.IdentityGovernanceEntitlementManagementAccessPackageResourceId, options ListEntitlementManagementAccessPackageResourceRolesOperationOptions) (ListEntitlementManagementAccessPackageResourceRolesCompleteResult, error) {
