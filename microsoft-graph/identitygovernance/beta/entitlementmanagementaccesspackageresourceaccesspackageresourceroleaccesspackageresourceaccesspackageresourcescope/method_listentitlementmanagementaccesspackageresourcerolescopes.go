...
// ListEntitlementManagementAccessPackageResourceRoleScopes - Get accessPackageResourceScopes from identityGovernance.
// Read-only. Nullable. Supports $expand.
func (c EntitlementManagementAccessPackageResourceAccessPackageResourceRoleAccessPackageResourceAccessPackageResourceScopeClient) ListEntitlementManagementAccessPackageResourceRoleScopes(ctx context.Context, id beta.IdentityGovernanceEntitlementManagementAccessPackageResourceIdAccessPackageResourceRoleId, options ListEntitlementManagementAccessPackageResourceRoleScopesOperationOptions) (result ListEntitlementManagementAccessPackageResourceRoleScopesOperationResponse, err error) {
...
func (c EntitlementManagementAccessPackageResourceAccessPackageResourceRoleAccessPackageResourceAccessPackageResourceScopeClient) ListEntitlementManagementAccessPackageResourceRoleScopesComplete(ctx context.Context, id beta.IdentityGovernanceEntitlementManagementAccessPackageResourceIdAccessPackageResourceRoleId, options ListEntitlementManagementAccessPackageResourceRoleScopesOperationOptions) (ListEntitlementManagementAccessPackageResourceRoleScopesCompleteResult, error) {
	return c.ListEntitlementManagementAccessPackageResourceRoleScopesCompleteMatchingPredicate(ctx, id, options, AccessPackageResourceScopeOperationPredicate{})
}
