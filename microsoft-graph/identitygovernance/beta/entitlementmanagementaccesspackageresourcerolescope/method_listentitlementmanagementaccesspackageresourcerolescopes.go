...
// identityGovernance. A reference to both a scope within a resource, and a role in that resource for that scope.
func (c EntitlementManagementAccessPackageResourceRoleScopeClient) ListEntitlementManagementAccessPackageResourceRoleScopes(ctx context.Context, options ListEntitlementManagementAccessPackageResourceRoleScopesOperationOptions) (result ListEntitlementManagementAccessPackageResourceRoleScopesOperationResponse, err error) {
...
func (c EntitlementManagementAccessPackageResourceRoleScopeClient) ListEntitlementManagementAccessPackageResourceRoleScopesComplete(ctx context.Context, options ListEntitlementManagementAccessPackageResourceRoleScopesOperationOptions) (ListEntitlementManagementAccessPackageResourceRoleScopesCompleteResult, error) {
	return c.ListEntitlementManagementAccessPackageResourceRoleScopesCompleteMatchingPredicate(ctx, options, AccessPackageResourceRoleScopeOperationPredicate{})
}
...
func (c EntitlementManagementAccessPackageResourceRoleScopeClient) ListEntitlementManagementAccessPackageResourceRoleScopesCompleteMatchingPredicate(ctx context.Context, options ListEntitlementManagementAccessPackageResourceRoleScopesOperationOptions, predicate AccessPackageResourceRoleScopeOperationPredicate) (result ListEntitlementManagementAccessPackageResourceRoleScopesCompleteResult, err error) {
	...
	resp, err := c.ListEntitlementManagementAccessPackageResourceRoleScopes(ctx, options)
	if err != nil {
