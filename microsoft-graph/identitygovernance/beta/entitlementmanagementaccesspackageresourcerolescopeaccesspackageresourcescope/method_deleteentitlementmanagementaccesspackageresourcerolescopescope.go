...
type DeleteEntitlementManagementAccessPackageResourceRoleScopeScopeOperationResponse struct {
	HttpResponse *http.Response
	OData        *odata.OData
}

type DeleteEntitlementManagementAccessPackageResourceRoleScopeScopeOperationOptions struct {
	IfMatch   *string
...
func DefaultDeleteEntitlementManagementAccessPackageResourceRoleScopeScopeOperationOptions() DeleteEntitlementManagementAccessPackageResourceRoleScopeScopeOperationOptions {
	return DeleteEntitlementManagementAccessPackageResourceRoleScopeScopeOperationOptions{}
}
...
// DeleteEntitlementManagementAccessPackageResourceRoleScopeScope - Delete navigation property
// accessPackageResourceScope for identityGovernance
func (c EntitlementManagementAccessPackageResourceRoleScopeAccessPackageResourceScopeClient) DeleteEntitlementManagementAccessPackageResourceRoleScopeScope(ctx context.Context, id beta.IdentityGovernanceEntitlementManagementAccessPackageResourceRoleScopeId, options DeleteEntitlementManagementAccessPackageResourceRoleScopeScopeOperationOptions) (result DeleteEntitlementManagementAccessPackageResourceRoleScopeScopeOperationResponse, err error) {
