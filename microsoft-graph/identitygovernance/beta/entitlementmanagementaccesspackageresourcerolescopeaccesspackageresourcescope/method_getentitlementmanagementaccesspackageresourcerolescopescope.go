...
// GetEntitlementManagementAccessPackageResourceRoleScopeScope - Get accessPackageResourceScope from identityGovernance
func (c EntitlementManagementAccessPackageResourceRoleScopeAccessPackageResourceScopeClient) GetEntitlementManagementAccessPackageResourceRoleScopeScope(ctx context.Context, id beta.IdentityGovernanceEntitlementManagementAccessPackageResourceRoleScopeId, options GetEntitlementManagementAccessPackageResourceRoleScopeScopeOperationOptions) (result GetEntitlementManagementAccessPackageResourceRoleScopeScopeOperationResponse, err error) {
