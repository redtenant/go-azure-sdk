...
// GetEntitlementManagementAssignmentRequest - Get assignmentRequests from identityGovernance. Represents access package
// assignment requests created by or on behalf of a user.
func (c EntitlementManagementAssignmentRequestClient) GetEntitlementManagementAssignmentRequest(ctx context.Context, id beta.IdentityGovernanceEntitlementManagementAssignmentRequestId, options GetEntitlementManagementAssignmentRequestOperationOptions) (result GetEntitlementManagementAssignmentRequestOperationResponse, err error) {
