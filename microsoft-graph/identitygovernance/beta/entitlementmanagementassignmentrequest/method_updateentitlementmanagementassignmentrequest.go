...
// identityGovernance
func (c EntitlementManagementAssignmentRequestClient) UpdateEntitlementManagementAssignmentRequest(ctx context.Context, id beta.IdentityGovernanceEntitlementManagementAssignmentRequestId, input beta.AccessPackageAssignmentRequest, options UpdateEntitlementManagementAssignmentRequestOperationOptions) (result UpdateEntitlementManagementAssignmentRequestOperationResponse, err error) {
