...
type GetEntitlementManagementSubjectOperationResponse struct {
	HttpResponse *http.Response
	OData        *odata.OData
	Model        *beta.AccessPackageSubject
}

type GetEntitlementManagementSubjectOperationOptions struct {
	Expand    *odata.Expand
...
func DefaultGetEntitlementManagementSubjectOperationOptions() GetEntitlementManagementSubjectOperationOptions {
	return GetEntitlementManagementSubjectOperationOptions{}
}
...
// GetEntitlementManagementSubject - Get subjects from identityGovernance. Represents the subjects within entitlement
// management.
