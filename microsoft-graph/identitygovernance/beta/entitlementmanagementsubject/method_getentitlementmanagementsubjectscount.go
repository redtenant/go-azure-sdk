...
type GetEntitlementManagementSubjectsCountOperationResponse struct {
	HttpResponse *http.Response
	OData        *odata.OData
	Model        *[]byte
}

type GetEntitlementManagementSubjectsCountOperationOptions struct {
	Filter    *string
...
func DefaultGetEntitlementManagementSubjectsCountOperationOptions() GetEntitlementManagementSubjectsCountOperationOptions {
	return GetEntitlementManagementSubjectsCountOperationOptions{}
}
