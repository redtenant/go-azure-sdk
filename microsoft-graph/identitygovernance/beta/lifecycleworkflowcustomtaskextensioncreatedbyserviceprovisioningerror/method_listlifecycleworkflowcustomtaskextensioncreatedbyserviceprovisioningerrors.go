...
func (c LifecycleWorkflowCustomTaskExtensionCreatedByServiceProvisioningErrorClient) ListLifecycleWorkflowCustomTaskExtensionCreatedByServiceProvisioningErrors(ctx context.Context, id beta.IdentityGovernanceLifecycleWorkflowCustomTaskExtensionId, options ListLifecycleWorkflowCustomTaskExtensionCreatedByServiceProvisioningErrorsOperationOptions) (result ListLifecycleWorkflowCustomTaskExtensionCreatedByServiceProvisioningErrorsOperationResponse, err error) {
...
func (c LifecycleWorkflowCustomTaskExtensionCreatedByServiceProvisioningErrorClient) ListLifecycleWorkflowCustomTaskExtensionCreatedByServiceProvisioningErrorsCompleteMatchingPredicate(ctx context.Context, id beta.IdentityGovernanceLifecycleWorkflowCustomTaskExtensionId, options ListLifecycleWorkflowCustomTaskExtensionCreatedByServiceProvisioningErrorsOperationOptions, predicate ServiceProvisioningErrorOperationPredicate) (result ListLifecycleWorkflowCustomTaskExtensionCreatedByServiceProvisioningErrorsCompleteResult, err error) {
