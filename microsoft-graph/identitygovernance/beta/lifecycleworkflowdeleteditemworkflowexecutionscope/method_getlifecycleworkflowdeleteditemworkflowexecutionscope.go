...
func (c LifecycleWorkflowDeletedItemWorkflowExecutionScopeClient) GetLifecycleWorkflowDeletedItemWorkflowExecutionScope(ctx context.Context, id beta.IdentityGovernanceLifecycleWorkflowDeletedItemWorkflowIdExecutionScopeId, options GetLifecycleWorkflowDeletedItemWorkflowExecutionScopeOperationOptions) (result GetLifecycleWorkflowDeletedItemWorkflowExecutionScopeOperationResponse, err error) {
