...
type GetLifecycleWorkflowDeletedItemWorkflowRunTaskProcessingResultSubjectMailboxSettingOperationResponse struct {
	HttpResponse *http.Response
	OData        *odata.OData
	Model        *beta.MailboxSettings
}

type GetLifecycleWorkflowDeletedItemWorkflowRunTaskProcessingResultSubjectMailboxSettingOperationOptions struct {
	Expand    *odata.Expand
...
func DefaultGetLifecycleWorkflowDeletedItemWorkflowRunTaskProcessingResultSubjectMailboxSettingOperationOptions() GetLifecycleWorkflowDeletedItemWorkflowRunTaskProcessingResultSubjectMailboxSettingOperationOptions {
	return GetLifecycleWorkflowDeletedItemWorkflowRunTaskProcessingResultSubjectMailboxSettingOperationOptions{}
}
...
// GetLifecycleWorkflowDeletedItemWorkflowRunTaskProcessingResultSubjectMailboxSetting - Get mailboxSettings property
