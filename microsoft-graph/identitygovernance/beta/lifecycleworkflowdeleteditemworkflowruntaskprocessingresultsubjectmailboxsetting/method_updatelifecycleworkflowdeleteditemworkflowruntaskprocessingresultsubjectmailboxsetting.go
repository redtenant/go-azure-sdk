...
type UpdateLifecycleWorkflowDeletedItemWorkflowRunTaskProcessingResultSubjectMailboxSettingOperationResponse struct {
	HttpResponse *http.Response
	OData        *odata.OData
}

type UpdateLifecycleWorkflowDeletedItemWorkflowRunTaskProcessingResultSubjectMailboxSettingOperationOptions struct {
...
func DefaultUpdateLifecycleWorkflowDeletedItemWorkflowRunTaskProcessingResultSubjectMailboxSettingOperationOptions() UpdateLifecycleWorkflowDeletedItemWorkflowRunTaskProcessingResultSubjectMailboxSettingOperationOptions {
	return UpdateLifecycleWorkflowDeletedItemWorkflowRunTaskProcessingResultSubjectMailboxSettingOperationOptions{}
}
...
// UpdateLifecycleWorkflowDeletedItemWorkflowRunTaskProcessingResultSubjectMailboxSetting - Update property
// mailboxSettings value.
func (c LifecycleWorkflowDeletedItemWorkflowRunTaskProcessingResultSubjectMailboxSettingClient) UpdateLifecycleWorkflowDeletedItemWorkflowRunTaskProcessingResultSubjectMailboxSetting(ctx context.Context, id beta.IdentityGovernanceLifecycleWorkflowDeletedItemWorkflowIdRunIdTaskProcessingResultId, input beta.MailboxSettings, options UpdateLifecycleWorkflowDeletedItemWorkflowRunTaskProcessingResultSubjectMailboxSettingOperationOptions) (result UpdateLifecycleWorkflowDeletedItemWorkflowRunTaskProcessingResultSubjectMailboxSettingOperationResponse, err error) {
