...
func (c LifecycleWorkflowDeletedItemWorkflowTaskClient) GetLifecycleWorkflowDeletedItemWorkflowTask(ctx context.Context, id beta.IdentityGovernanceLifecycleWorkflowDeletedItemWorkflowIdTaskId, options GetLifecycleWorkflowDeletedItemWorkflowTaskOperationOptions) (result GetLifecycleWorkflowDeletedItemWorkflowTaskOperationResponse, err error) {
