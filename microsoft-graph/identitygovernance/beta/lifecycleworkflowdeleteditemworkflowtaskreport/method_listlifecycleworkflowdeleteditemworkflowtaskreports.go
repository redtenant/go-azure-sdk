...
func (c LifecycleWorkflowDeletedItemWorkflowTaskReportClient) ListLifecycleWorkflowDeletedItemWorkflowTaskReports(ctx context.Context, id beta.IdentityGovernanceLifecycleWorkflowDeletedItemWorkflowId, options ListLifecycleWorkflowDeletedItemWorkflowTaskReportsOperationOptions) (result ListLifecycleWorkflowDeletedItemWorkflowTaskReportsOperationResponse, err error) {
...
func (c LifecycleWorkflowDeletedItemWorkflowTaskReportClient) ListLifecycleWorkflowDeletedItemWorkflowTaskReportsComplete(ctx context.Context, id beta.IdentityGovernanceLifecycleWorkflowDeletedItemWorkflowId, options ListLifecycleWorkflowDeletedItemWorkflowTaskReportsOperationOptions) (ListLifecycleWorkflowDeletedItemWorkflowTaskReportsCompleteResult, error) {
