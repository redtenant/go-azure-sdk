...
func (c LifecycleWorkflowDeletedItemWorkflowUserProcessingResultClient) GetLifecycleWorkflowDeletedItemWorkflowUserProcessingResult(ctx context.Context, id beta.IdentityGovernanceLifecycleWorkflowDeletedItemWorkflowIdUserProcessingResultId, options GetLifecycleWorkflowDeletedItemWorkflowUserProcessingResultOperationOptions) (result GetLifecycleWorkflowDeletedItemWorkflowUserProcessingResultOperationResponse, err error) {
