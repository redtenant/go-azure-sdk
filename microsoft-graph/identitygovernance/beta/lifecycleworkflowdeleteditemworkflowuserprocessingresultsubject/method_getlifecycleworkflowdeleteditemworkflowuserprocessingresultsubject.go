...
func (c LifecycleWorkflowDeletedItemWorkflowUserProcessingResultSubjectClient) GetLifecycleWorkflowDeletedItemWorkflowUserProcessingResultSubject(ctx context.Context, id beta.IdentityGovernanceLifecycleWorkflowDeletedItemWorkflowIdUserProcessingResultId, options GetLifecycleWorkflowDeletedItemWorkflowUserProcessingResultSubjectOperationOptions) (result GetLifecycleWorkflowDeletedItemWorkflowUserProcessingResultSubjectOperationResponse, err error) {
