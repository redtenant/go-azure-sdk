...
type GetLifecycleWorkflowDeletedItemWorkflowUserProcessingResultSubjectMailboxSettingOperationResponse struct {
	HttpResponse *http.Response
	OData        *odata.OData
	Model        *beta.MailboxSettings
}

type GetLifecycleWorkflowDeletedItemWorkflowUserProcessingResultSubjectMailboxSettingOperationOptions struct {
	Expand    *odata.Expand
...
func DefaultGetLifecycleWorkflowDeletedItemWorkflowUserProcessingResultSubjectMailboxSettingOperationOptions() GetLifecycleWorkflowDeletedItemWorkflowUserProcessingResultSubjectMailboxSettingOperationOptions {
	return GetLifecycleWorkflowDeletedItemWorkflowUserProcessingResultSubjectMailboxSettingOperationOptions{}
}
...
// GetLifecycleWorkflowDeletedItemWorkflowUserProcessingResultSubjectMailboxSetting - Get mailboxSettings property
