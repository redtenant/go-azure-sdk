...
type GetLifecycleWorkflowDeletedItemWorkflowUserProcessingResultTaskSubjectMailboxSettingOperationResponse struct {
	HttpResponse *http.Response
	OData        *odata.OData
	Model        *beta.MailboxSettings
}

type GetLifecycleWorkflowDeletedItemWorkflowUserProcessingResultTaskSubjectMailboxSettingOperationOptions struct {
	Expand    *odata.Expand
...
func DefaultGetLifecycleWorkflowDeletedItemWorkflowUserProcessingResultTaskSubjectMailboxSettingOperationOptions() GetLifecycleWorkflowDeletedItemWorkflowUserProcessingResultTaskSubjectMailboxSettingOperationOptions {
	return GetLifecycleWorkflowDeletedItemWorkflowUserProcessingResultTaskSubjectMailboxSettingOperationOptions{}
}
...
// GetLifecycleWorkflowDeletedItemWorkflowUserProcessingResultTaskSubjectMailboxSetting - Get mailboxSettings property
