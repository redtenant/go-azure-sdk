...
// the workflow.
func (c LifecycleWorkflowDeletedItemWorkflowVersionCreatedByClient) GetLifecycleWorkflowDeletedItemWorkflowVersionCreatedBy(ctx context.Context, id beta.IdentityGovernanceLifecycleWorkflowDeletedItemWorkflowIdVersionId, options GetLifecycleWorkflowDeletedItemWorkflowVersionCreatedByOperationOptions) (result GetLifecycleWorkflowDeletedItemWorkflowVersionCreatedByOperationResponse, err error) {
