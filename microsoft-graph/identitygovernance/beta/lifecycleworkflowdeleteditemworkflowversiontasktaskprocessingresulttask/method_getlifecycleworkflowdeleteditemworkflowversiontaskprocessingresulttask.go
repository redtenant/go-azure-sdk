...
func (c LifecycleWorkflowDeletedItemWorkflowVersionTaskTaskProcessingResultTaskClient) GetLifecycleWorkflowDeletedItemWorkflowVersionTaskProcessingResultTask(ctx context.Context, id beta.IdentityGovernanceLifecycleWorkflowDeletedItemWorkflowIdVersionIdTaskIdTaskProcessingResultId, options GetLifecycleWorkflowDeletedItemWorkflowVersionTaskProcessingResultTaskOperationOptions) (result GetLifecycleWorkflowDeletedItemWorkflowVersionTaskProcessingResultTaskOperationResponse, err error) {
