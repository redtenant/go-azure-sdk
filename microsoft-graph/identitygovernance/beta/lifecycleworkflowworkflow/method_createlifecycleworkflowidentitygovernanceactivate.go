...
func (c LifecycleWorkflowWorkflowClient) CreateLifecycleWorkflowIdentityGovernanceActivate(ctx context.Context, id beta.IdentityGovernanceLifecycleWorkflowWorkflowId, input CreateLifecycleWorkflowIdentityGovernanceActivateRequest, options CreateLifecycleWorkflowIdentityGovernanceActivateOperationOptions) (result CreateLifecycleWorkflowIdentityGovernanceActivateOperationResponse, err error) {
