...
// deletion.
func (c LifecycleWorkflowWorkflowClient) DeleteLifecycleWorkflowWorkflow(ctx context.Context, id beta.IdentityGovernanceLifecycleWorkflowWorkflowId, options DeleteLifecycleWorkflowWorkflowOperationOptions) (result DeleteLifecycleWorkflowWorkflowOperationResponse, err error) {
