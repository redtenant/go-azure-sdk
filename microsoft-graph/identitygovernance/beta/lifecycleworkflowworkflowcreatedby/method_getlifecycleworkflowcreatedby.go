...
type GetLifecycleWorkflowCreatedByOperationResponse struct {
	HttpResponse *http.Response
	OData        *odata.OData
	Model        *beta.User
}

type GetLifecycleWorkflowCreatedByOperationOptions struct {
	Expand    *odata.Expand
...
func DefaultGetLifecycleWorkflowCreatedByOperationOptions() GetLifecycleWorkflowCreatedByOperationOptions {
	return GetLifecycleWorkflowCreatedByOperationOptions{}
}
...
func (c LifecycleWorkflowWorkflowCreatedByClient) GetLifecycleWorkflowCreatedBy(ctx context.Context, id beta.IdentityGovernanceLifecycleWorkflowWorkflowId, options GetLifecycleWorkflowCreatedByOperationOptions) (result GetLifecycleWorkflowCreatedByOperationResponse, err error) {
