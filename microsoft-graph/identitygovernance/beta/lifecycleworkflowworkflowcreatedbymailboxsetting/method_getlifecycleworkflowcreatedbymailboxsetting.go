...
type GetLifecycleWorkflowCreatedByMailboxSettingOperationResponse struct {
	HttpResponse *http.Response
	OData        *odata.OData
	Model        *beta.MailboxSettings
}

type GetLifecycleWorkflowCreatedByMailboxSettingOperationOptions struct {
	Expand    *odata.Expand
...
func DefaultGetLifecycleWorkflowCreatedByMailboxSettingOperationOptions() GetLifecycleWorkflowCreatedByMailboxSettingOperationOptions {
	return GetLifecycleWorkflowCreatedByMailboxSettingOperationOptions{}
}
...
// GetLifecycleWorkflowCreatedByMailboxSetting - Get mailboxSettings property value. Settings for the primary mailbox of
