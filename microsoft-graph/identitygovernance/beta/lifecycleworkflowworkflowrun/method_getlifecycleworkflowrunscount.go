...
func (c LifecycleWorkflowWorkflowRunClient) GetLifecycleWorkflowRunsCount(ctx context.Context, id beta.IdentityGovernanceLifecycleWorkflowWorkflowId, options GetLifecycleWorkflowRunsCountOperationOptions) (result GetLifecycleWorkflowRunsCountOperationResponse, err error) {
