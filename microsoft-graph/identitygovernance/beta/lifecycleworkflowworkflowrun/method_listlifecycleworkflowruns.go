...
func (c LifecycleWorkflowWorkflowRunClient) ListLifecycleWorkflowRuns(ctx context.Context, id beta.IdentityGovernanceLifecycleWorkflowWorkflowId, options ListLifecycleWorkflowRunsOperationOptions) (result ListLifecycleWorkflowRunsOperationResponse, err error) {
...
func (c LifecycleWorkflowWorkflowRunClient) ListLifecycleWorkflowRunsComplete(ctx context.Context, id beta.IdentityGovernanceLifecycleWorkflowWorkflowId, options ListLifecycleWorkflowRunsOperationOptions) (ListLifecycleWorkflowRunsCompleteResult, error) {
