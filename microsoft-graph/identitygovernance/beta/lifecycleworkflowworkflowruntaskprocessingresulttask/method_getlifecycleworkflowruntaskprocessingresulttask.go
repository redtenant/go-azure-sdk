...
func (c LifecycleWorkflowWorkflowRunTaskProcessingResultTaskClient) GetLifecycleWorkflowRunTaskProcessingResultTask(ctx context.Context, id beta.IdentityGovernanceLifecycleWorkflowWorkflowIdRunIdTaskProcessingResultId, options GetLifecycleWorkflowRunTaskProcessingResultTaskOperationOptions) (result GetLifecycleWorkflowRunTaskProcessingResultTaskOperationResponse, err error) {
