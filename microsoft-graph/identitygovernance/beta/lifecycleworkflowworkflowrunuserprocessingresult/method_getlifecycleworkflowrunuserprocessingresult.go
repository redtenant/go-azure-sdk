...
func (c LifecycleWorkflowWorkflowRunUserProcessingResultClient) GetLifecycleWorkflowRunUserProcessingResult(ctx context.Context, id beta.IdentityGovernanceLifecycleWorkflowWorkflowIdRunIdUserProcessingResultId, options GetLifecycleWorkflowRunUserProcessingResultOperationOptions) (result GetLifecycleWorkflowRunUserProcessingResultOperationResponse, err error) {
