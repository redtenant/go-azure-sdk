...
func (c LifecycleWorkflowWorkflowRunUserProcessingResultClient) GetLifecycleWorkflowRunUserProcessingResultsCount(ctx context.Context, id beta.IdentityGovernanceLifecycleWorkflowWorkflowIdRunId, options GetLifecycleWorkflowRunUserProcessingResultsCountOperationOptions) (result GetLifecycleWorkflowRunUserProcessingResultsCountOperationResponse, err error) {
