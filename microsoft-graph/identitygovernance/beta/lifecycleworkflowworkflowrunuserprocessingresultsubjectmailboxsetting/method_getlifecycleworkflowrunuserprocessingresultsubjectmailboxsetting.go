...
type GetLifecycleWorkflowRunUserProcessingResultSubjectMailboxSettingOperationResponse struct {
	HttpResponse *http.Response
	OData        *odata.OData
	Model        *beta.MailboxSettings
}

type GetLifecycleWorkflowRunUserProcessingResultSubjectMailboxSettingOperationOptions struct {
	Expand    *odata.Expand
...
func DefaultGetLifecycleWorkflowRunUserProcessingResultSubjectMailboxSettingOperationOptions() GetLifecycleWorkflowRunUserProcessingResultSubjectMailboxSettingOperationOptions {
	return GetLifecycleWorkflowRunUserProcessingResultSubjectMailboxSettingOperationOptions{}
}
...
// GetLifecycleWorkflowRunUserProcessingResultSubjectMailboxSetting - Get mailboxSettings property value. Settings for
