...
func (c LifecycleWorkflowWorkflowRunUserProcessingResultTaskProcessingResultClient) GetLifecycleWorkflowRunUserProcessingResultTaskCount(ctx context.Context, id beta.IdentityGovernanceLifecycleWorkflowWorkflowIdRunIdUserProcessingResultId, options GetLifecycleWorkflowRunUserProcessingResultTaskCountOperationOptions) (result GetLifecycleWorkflowRunUserProcessingResultTaskCountOperationResponse, err error) {
