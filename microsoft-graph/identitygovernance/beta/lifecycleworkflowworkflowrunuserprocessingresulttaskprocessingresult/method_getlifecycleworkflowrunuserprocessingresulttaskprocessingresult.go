...
func DefaultGetLifecycleWorkflowRunUserProcessingResultTaskProcessingResultOperationOptions() GetLifecycleWorkflowRunUserProcessingResultTaskProcessingResultOperationOptions {
	return GetLifecycleWorkflowRunUserProcessingResultTaskProcessingResultOperationOptions{}
}
...
// GetLifecycleWorkflowRunUserProcessingResultTaskProcessingResult - Get taskProcessingResults from identityGovernance.
// The associated individual task execution.
func (c LifecycleWorkflowWorkflowRunUserProcessingResultTaskProcessingResultClient) GetLifecycleWorkflowRunUserProcessingResultTaskProcessingResult(ctx context.Context, id beta.IdentityGovernanceLifecycleWorkflowWorkflowIdRunIdUserProcessingResultIdTaskProcessingResultId, options GetLifecycleWorkflowRunUserProcessingResultTaskProcessingResultOperationOptions) (result GetLifecycleWorkflowRunUserProcessingResultTaskProcessingResultOperationResponse, err error) {
