...
func DefaultListLifecycleWorkflowRunUserProcessingResultTaskProcessingResultsOperationOptions() ListLifecycleWorkflowRunUserProcessingResultTaskProcessingResultsOperationOptions {
	return ListLifecycleWorkflowRunUserProcessingResultTaskProcessingResultsOperationOptions{}
}
...
// ListLifecycleWorkflowRunUserProcessingResultTaskProcessingResults - List taskProcessingResults. Get the task
// processing result from a userProcessingResult either directly or through a run.
func (c LifecycleWorkflowWorkflowRunUserProcessingResultTaskProcessingResultClient) ListLifecycleWorkflowRunUserProcessingResultTaskProcessingResults(ctx context.Context, id beta.IdentityGovernanceLifecycleWorkflowWorkflowIdRunIdUserProcessingResultId, options ListLifecycleWorkflowRunUserProcessingResultTaskProcessingResultsOperationOptions) (result ListLifecycleWorkflowRunUserProcessingResultTaskProcessingResultsOperationResponse, err error) {
	opts := client.RequestOptions{
		...
		Pager:         &ListLifecycleWorkflowRunUserProcessingResultTaskProcessingResultsCustomPager{},
...
func (c LifecycleWorkflowWorkflowRunUserProcessingResultTaskProcessingResultClient) ListLifecycleWorkflowRunUserProcessingResultTaskProcessingResultsComplete(ctx context.Context, id beta.IdentityGovernanceLifecycleWorkflowWorkflowIdRunIdUserProcessingResultId, options ListLifecycleWorkflowRunUserProcessingResultTaskProcessingResultsOperationOptions) (ListLifecycleWorkflowRunUserProcessingResultTaskProcessingResultsCompleteResult, error) {
	return c.ListLifecycleWorkflowRunUserProcessingResultTaskProcessingResultsCompleteMatchingPredicate(ctx, id, options, IdentityGovernanceTaskProcessingResultOperationPredicate{})
}
...
func (c LifecycleWorkflowWorkflowRunUserProcessingResultTaskProcessingResultClient) ListLifecycleWorkflowRunUserProcessingResultTaskProcessingResultsCompleteMatchingPredicate(ctx context.Context, id beta.IdentityGovernanceLifecycleWorkflowWorkflowIdRunIdUserProcessingResultId, options ListLifecycleWorkflowRunUserProcessingResultTaskProcessingResultsOperationOptions, predicate IdentityGovernanceTaskProcessingResultOperationPredicate) (result ListLifecycleWorkflowRunUserProcessingResultTaskProcessingResultsCompleteResult, err error) {
	...
	resp, err := c.ListLifecycleWorkflowRunUserProcessingResultTaskProcessingResults(ctx, id, options)
	if err != nil {
	...
	result = ListLifecycleWorkflowRunUserProcessingResultTaskProcessingResultsCompleteResult{
