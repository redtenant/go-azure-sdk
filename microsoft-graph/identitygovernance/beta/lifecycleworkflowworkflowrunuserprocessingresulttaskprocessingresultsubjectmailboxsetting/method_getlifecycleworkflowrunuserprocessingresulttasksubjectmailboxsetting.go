...
type GetLifecycleWorkflowRunUserProcessingResultTaskSubjectMailboxSettingOperationResponse struct {
	HttpResponse *http.Response
	OData        *odata.OData
	Model        *beta.MailboxSettings
}

type GetLifecycleWorkflowRunUserProcessingResultTaskSubjectMailboxSettingOperationOptions struct {
	Expand    *odata.Expand
...
func DefaultGetLifecycleWorkflowRunUserProcessingResultTaskSubjectMailboxSettingOperationOptions() GetLifecycleWorkflowRunUserProcessingResultTaskSubjectMailboxSettingOperationOptions {
	return GetLifecycleWorkflowRunUserProcessingResultTaskSubjectMailboxSettingOperationOptions{}
}
...
// GetLifecycleWorkflowRunUserProcessingResultTaskSubjectMailboxSetting - Get mailboxSettings property value. Settings
...
func (c LifecycleWorkflowWorkflowRunUserProcessingResultTaskProcessingResultSubjectMailboxSettingClient) GetLifecycleWorkflowRunUserProcessingResultTaskSubjectMailboxSetting(ctx context.Context, id beta.IdentityGovernanceLifecycleWorkflowWorkflowIdRunIdUserProcessingResultIdTaskProcessingResultId, options GetLifecycleWorkflowRunUserProcessingResultTaskSubjectMailboxSettingOperationOptions) (result GetLifecycleWorkflowRunUserProcessingResultTaskSubjectMailboxSettingOperationResponse, err error) {
