...
type UpdateLifecycleWorkflowRunUserProcessingResultTaskSubjectMailboxSettingOperationResponse struct {
...
func (c LifecycleWorkflowWorkflowRunUserProcessingResultTaskProcessingResultSubjectMailboxSettingClient) UpdateLifecycleWorkflowRunUserProcessingResultTaskSubjectMailboxSetting(ctx context.Context, id beta.IdentityGovernanceLifecycleWorkflowWorkflowIdRunIdUserProcessingResultIdTaskProcessingResultId, input beta.MailboxSettings, options UpdateLifecycleWorkflowRunUserProcessingResultTaskSubjectMailboxSettingOperationOptions) (result UpdateLifecycleWorkflowRunUserProcessingResultTaskSubjectMailboxSettingOperationResponse, err error) {
