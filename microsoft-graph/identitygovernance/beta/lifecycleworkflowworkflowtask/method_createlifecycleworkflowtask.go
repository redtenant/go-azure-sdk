...
func (c LifecycleWorkflowWorkflowTaskClient) CreateLifecycleWorkflowTask(ctx context.Context, id beta.IdentityGovernanceLifecycleWorkflowWorkflowId, input beta.IdentityGovernanceTask, options CreateLifecycleWorkflowTaskOperationOptions) (result CreateLifecycleWorkflowTaskOperationResponse, err error) {
