...
func (c LifecycleWorkflowWorkflowTaskClient) DeleteLifecycleWorkflowTask(ctx context.Context, id beta.IdentityGovernanceLifecycleWorkflowWorkflowIdTaskId, options DeleteLifecycleWorkflowTaskOperationOptions) (result DeleteLifecycleWorkflowTaskOperationResponse, err error) {
