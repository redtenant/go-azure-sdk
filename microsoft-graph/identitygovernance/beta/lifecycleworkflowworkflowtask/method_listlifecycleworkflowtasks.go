...
func (c LifecycleWorkflowWorkflowTaskClient) ListLifecycleWorkflowTasks(ctx context.Context, id beta.IdentityGovernanceLifecycleWorkflowWorkflowId, options ListLifecycleWorkflowTasksOperationOptions) (result ListLifecycleWorkflowTasksOperationResponse, err error) {
...
func (c LifecycleWorkflowWorkflowTaskClient) ListLifecycleWorkflowTasksComplete(ctx context.Context, id beta.IdentityGovernanceLifecycleWorkflowWorkflowId, options ListLifecycleWorkflowTasksOperationOptions) (ListLifecycleWorkflowTasksCompleteResult, error) {
