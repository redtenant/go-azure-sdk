...
type ListLifecycleWorkflowTaskReportsCompleteResult struct {
	...
	Items              []beta.IdentityGovernanceTaskReport
}
...
func (c LifecycleWorkflowWorkflowTaskReportClient) ListLifecycleWorkflowTaskReports(ctx context.Context, id beta.IdentityGovernanceLifecycleWorkflowWorkflowId, options ListLifecycleWorkflowTaskReportsOperationOptions) (result ListLifecycleWorkflowTaskReportsOperationResponse, err error) {
	...
	var values struct {
		Values *[]beta.IdentityGovernanceTaskReport `json:"value"`
	}
...
func (c LifecycleWorkflowWorkflowTaskReportClient) ListLifecycleWorkflowTaskReportsComplete(ctx context.Context, id beta.IdentityGovernanceLifecycleWorkflowWorkflowId, options ListLifecycleWorkflowTaskReportsOperationOptions) (ListLifecycleWorkflowTaskReportsCompleteResult, error) {
...
func (c LifecycleWorkflowWorkflowTaskReportClient) ListLifecycleWorkflowTaskReportsCompleteMatchingPredicate(ctx context.Context, id beta.IdentityGovernanceLifecycleWorkflowWorkflowId, options ListLifecycleWorkflowTaskReportsOperationOptions, predicate IdentityGovernanceTaskReportOperationPredicate) (result ListLifecycleWorkflowTaskReportsCompleteResult, err error) {
	items := make([]beta.IdentityGovernanceTaskReport, 0)
