...
func (c LifecycleWorkflowWorkflowTaskReportTaskClient) GetLifecycleWorkflowTaskReportTask(ctx context.Context, id beta.IdentityGovernanceLifecycleWorkflowWorkflowIdTaskReportId, options GetLifecycleWorkflowTaskReportTaskOperationOptions) (result GetLifecycleWorkflowTaskReportTaskOperationResponse, err error) {
