...
func (c LifecycleWorkflowWorkflowTaskReportTaskProcessingResultSubjectClient) GetLifecycleWorkflowTaskReportTaskProcessingResultSubject(ctx context.Context, id beta.IdentityGovernanceLifecycleWorkflowWorkflowIdTaskReportIdTaskProcessingResultId, options GetLifecycleWorkflowTaskReportTaskProcessingResultSubjectOperationOptions) (result GetLifecycleWorkflowTaskReportTaskProcessingResultSubjectOperationResponse, err error) {
