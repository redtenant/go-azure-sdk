...
// processing the task.
func (c LifecycleWorkflowWorkflowTaskTaskProcessingResultClient) ListLifecycleWorkflowTaskProcessingResults(ctx context.Context, id beta.IdentityGovernanceLifecycleWorkflowWorkflowIdTaskId, options ListLifecycleWorkflowTaskProcessingResultsOperationOptions) (result ListLifecycleWorkflowTaskProcessingResultsOperationResponse, err error) {
...
func (c LifecycleWorkflowWorkflowTaskTaskProcessingResultClient) ListLifecycleWorkflowTaskProcessingResultsComplete(ctx context.Context, id beta.IdentityGovernanceLifecycleWorkflowWorkflowIdTaskId, options ListLifecycleWorkflowTaskProcessingResultsOperationOptions) (ListLifecycleWorkflowTaskProcessingResultsCompleteResult, error) {
