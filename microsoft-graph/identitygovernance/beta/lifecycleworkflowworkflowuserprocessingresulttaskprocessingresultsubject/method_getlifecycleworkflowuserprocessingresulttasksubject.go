...
func (c LifecycleWorkflowWorkflowUserProcessingResultTaskProcessingResultSubjectClient) GetLifecycleWorkflowUserProcessingResultTaskSubject(ctx context.Context, id beta.IdentityGovernanceLifecycleWorkflowWorkflowIdUserProcessingResultIdTaskProcessingResultId, options GetLifecycleWorkflowUserProcessingResultTaskSubjectOperationOptions) (result GetLifecycleWorkflowUserProcessingResultTaskSubjectOperationResponse, err error) {
