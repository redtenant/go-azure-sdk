...
func DefaultGetLifecycleWorkflowVersionsCountOperationOptions() GetLifecycleWorkflowVersionsCountOperationOptions {
	return GetLifecycleWorkflowVersionsCountOperationOptions{}
}
...
func (c LifecycleWorkflowWorkflowVersionClient) GetLifecycleWorkflowVersionsCount(ctx context.Context, id beta.IdentityGovernanceLifecycleWorkflowWorkflowId, options GetLifecycleWorkflowVersionsCountOperationOptions) (result GetLifecycleWorkflowVersionsCountOperationResponse, err error) {
