...
type GetLifecycleWorkflowVersionCreatedByOperationResponse struct {
	HttpResponse *http.Response
	OData        *odata.OData
	Model        *beta.User
}

type GetLifecycleWorkflowVersionCreatedByOperationOptions struct {
	Expand    *odata.Expand
...
func DefaultGetLifecycleWorkflowVersionCreatedByOperationOptions() GetLifecycleWorkflowVersionCreatedByOperationOptions {
	return GetLifecycleWorkflowVersionCreatedByOperationOptions{}
}
...
func (c LifecycleWorkflowWorkflowVersionCreatedByClient) GetLifecycleWorkflowVersionCreatedBy(ctx context.Context, id beta.IdentityGovernanceLifecycleWorkflowWorkflowIdVersionId, options GetLifecycleWorkflowVersionCreatedByOperationOptions) (result GetLifecycleWorkflowVersionCreatedByOperationResponse, err error) {
