...
type GetLifecycleWorkflowVersionCreatedByMailboxSettingOperationResponse struct {
	HttpResponse *http.Response
	OData        *odata.OData
	Model        *beta.MailboxSettings
}

type GetLifecycleWorkflowVersionCreatedByMailboxSettingOperationOptions struct {
	Expand    *odata.Expand
...
func DefaultGetLifecycleWorkflowVersionCreatedByMailboxSettingOperationOptions() GetLifecycleWorkflowVersionCreatedByMailboxSettingOperationOptions {
	return GetLifecycleWorkflowVersionCreatedByMailboxSettingOperationOptions{}
}
...
// GetLifecycleWorkflowVersionCreatedByMailboxSetting - Get mailboxSettings property value. Settings for the primary
...
// on $select.
func (c LifecycleWorkflowWorkflowVersionCreatedByMailboxSettingClient) GetLifecycleWorkflowVersionCreatedByMailboxSetting(ctx context.Context, id beta.IdentityGovernanceLifecycleWorkflowWorkflowIdVersionId, options GetLifecycleWorkflowVersionCreatedByMailboxSettingOperationOptions) (result GetLifecycleWorkflowVersionCreatedByMailboxSettingOperationResponse, err error) {
