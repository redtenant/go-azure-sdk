...
func (c LifecycleWorkflowWorkflowVersionLastModifiedByServiceProvisioningErrorClient) ListLifecycleWorkflowVersionLastModifiedByServiceProvisioningErrors(ctx context.Context, id beta.IdentityGovernanceLifecycleWorkflowWorkflowIdVersionId, options ListLifecycleWorkflowVersionLastModifiedByServiceProvisioningErrorsOperationOptions) (result ListLifecycleWorkflowVersionLastModifiedByServiceProvisioningErrorsOperationResponse, err error) {
...
func (c LifecycleWorkflowWorkflowVersionLastModifiedByServiceProvisioningErrorClient) ListLifecycleWorkflowVersionLastModifiedByServiceProvisioningErrorsComplete(ctx context.Context, id beta.IdentityGovernanceLifecycleWorkflowWorkflowIdVersionId, options ListLifecycleWorkflowVersionLastModifiedByServiceProvisioningErrorsOperationOptions) (ListLifecycleWorkflowVersionLastModifiedByServiceProvisioningErrorsCompleteResult, error) {
