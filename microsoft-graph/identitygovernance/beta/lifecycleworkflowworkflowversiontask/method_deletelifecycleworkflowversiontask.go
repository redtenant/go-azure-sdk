...
func (c LifecycleWorkflowWorkflowVersionTaskClient) DeleteLifecycleWorkflowVersionTask(ctx context.Context, id beta.IdentityGovernanceLifecycleWorkflowWorkflowIdVersionIdTaskId, options DeleteLifecycleWorkflowVersionTaskOperationOptions) (result DeleteLifecycleWorkflowVersionTaskOperationResponse, err error) {
