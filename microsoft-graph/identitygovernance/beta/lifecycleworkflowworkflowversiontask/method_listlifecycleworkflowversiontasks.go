...
// workflowVersion.
func (c LifecycleWorkflowWorkflowVersionTaskClient) ListLifecycleWorkflowVersionTasks(ctx context.Context, id beta.IdentityGovernanceLifecycleWorkflowWorkflowIdVersionId, options ListLifecycleWorkflowVersionTasksOperationOptions) (result ListLifecycleWorkflowVersionTasksOperationResponse, err error) {
...
func (c LifecycleWorkflowWorkflowVersionTaskClient) ListLifecycleWorkflowVersionTasksComplete(ctx context.Context, id beta.IdentityGovernanceLifecycleWorkflowWorkflowIdVersionId, options ListLifecycleWorkflowVersionTasksOperationOptions) (ListLifecycleWorkflowVersionTasksCompleteResult, error) {
...
func (c LifecycleWorkflowWorkflowVersionTaskClient) ListLifecycleWorkflowVersionTasksCompleteMatchingPredicate(ctx context.Context, id beta.IdentityGovernanceLifecycleWorkflowWorkflowIdVersionId, options ListLifecycleWorkflowVersionTasksOperationOptions, predicate IdentityGovernanceTaskOperationPredicate) (result ListLifecycleWorkflowVersionTasksCompleteResult, err error) {
