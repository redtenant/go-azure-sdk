...
// processing the task.
func (c LifecycleWorkflowWorkflowVersionTaskTaskProcessingResultClient) ListLifecycleWorkflowVersionTaskProcessingResults(ctx context.Context, id beta.IdentityGovernanceLifecycleWorkflowWorkflowIdVersionIdTaskId, options ListLifecycleWorkflowVersionTaskProcessingResultsOperationOptions) (result ListLifecycleWorkflowVersionTaskProcessingResultsOperationResponse, err error) {
...
func (c LifecycleWorkflowWorkflowVersionTaskTaskProcessingResultClient) ListLifecycleWorkflowVersionTaskProcessingResultsComplete(ctx context.Context, id beta.IdentityGovernanceLifecycleWorkflowWorkflowIdVersionIdTaskId, options ListLifecycleWorkflowVersionTaskProcessingResultsOperationOptions) (ListLifecycleWorkflowVersionTaskProcessingResultsCompleteResult, error) {
...
func (c LifecycleWorkflowWorkflowVersionTaskTaskProcessingResultClient) ListLifecycleWorkflowVersionTaskProcessingResultsCompleteMatchingPredicate(ctx context.Context, id beta.IdentityGovernanceLifecycleWorkflowWorkflowIdVersionIdTaskId, options ListLifecycleWorkflowVersionTaskProcessingResultsOperationOptions, predicate IdentityGovernanceTaskProcessingResultOperationPredicate) (result ListLifecycleWorkflowVersionTaskProcessingResultsCompleteResult, err error) {
