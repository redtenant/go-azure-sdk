...
func (c PrivilegedAccessGroupAssignmentScheduleClient) GetPrivilegedAccessGroupAssignmentSchedule(ctx context.Context, id beta.IdentityGovernancePrivilegedAccessGroupAssignmentScheduleId, options GetPrivilegedAccessGroupAssignmentScheduleOperationOptions) (result GetPrivilegedAccessGroupAssignmentScheduleOperationResponse, err error) {
	...
	var model beta.PrivilegedAccessGroupAssignmentSchedule
	result.Model = &model
