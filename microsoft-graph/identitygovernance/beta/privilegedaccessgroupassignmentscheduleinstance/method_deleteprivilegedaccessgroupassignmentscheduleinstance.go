...
// identityGovernance
func (c PrivilegedAccessGroupAssignmentScheduleInstanceClient) DeletePrivilegedAccessGroupAssignmentScheduleInstance(ctx context.Context, id beta.IdentityGovernancePrivilegedAccessGroupAssignmentScheduleInstanceId, options DeletePrivilegedAccessGroupAssignmentScheduleInstanceOperationOptions) (result DeletePrivilegedAccessGroupAssignmentScheduleInstanceOperationResponse, err error) {
