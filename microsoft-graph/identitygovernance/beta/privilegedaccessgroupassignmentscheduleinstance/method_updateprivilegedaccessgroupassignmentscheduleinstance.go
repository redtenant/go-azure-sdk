...
// identityGovernance
func (c PrivilegedAccessGroupAssignmentScheduleInstanceClient) UpdatePrivilegedAccessGroupAssignmentScheduleInstance(ctx context.Context, id beta.IdentityGovernancePrivilegedAccessGroupAssignmentScheduleInstanceId, input beta.PrivilegedAccessGroupAssignmentScheduleInstance, options UpdatePrivilegedAccessGroupAssignmentScheduleInstanceOperationOptions) (result UpdatePrivilegedAccessGroupAssignmentScheduleInstanceOperationResponse, err error) {
