...
// the group. Otherwise, it's null.
func (c PrivilegedAccessGroupAssignmentScheduleInstanceActivatedUsingClient) GetPrivilegedAccessGroupAssignmentScheduleInstanceActivatedUsing(ctx context.Context, id beta.IdentityGovernancePrivilegedAccessGroupAssignmentScheduleInstanceId, options GetPrivilegedAccessGroupAssignmentScheduleInstanceActivatedUsingOperationOptions) (result GetPrivilegedAccessGroupAssignmentScheduleInstanceActivatedUsingOperationResponse, err error) {
	...
	var model beta.PrivilegedAccessGroupEligibilityScheduleInstance
	result.Model = &model
