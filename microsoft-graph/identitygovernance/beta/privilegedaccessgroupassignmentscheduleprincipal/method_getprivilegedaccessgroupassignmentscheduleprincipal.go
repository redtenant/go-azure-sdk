...
// that's in the scope of this membership or ownership assignment request to the group that's governed by PIM. Supports
// $expand and $select nested in $expand for id only.
