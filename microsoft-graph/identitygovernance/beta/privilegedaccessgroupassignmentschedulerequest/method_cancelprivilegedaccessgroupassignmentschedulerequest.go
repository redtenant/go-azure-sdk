...
func (c PrivilegedAccessGroupAssignmentScheduleRequestClient) CancelPrivilegedAccessGroupAssignmentScheduleRequest(ctx context.Context, id beta.IdentityGovernancePrivilegedAccessGroupAssignmentScheduleRequestId, options CancelPrivilegedAccessGroupAssignmentScheduleRequestOperationOptions) (result CancelPrivilegedAccessGroupAssignmentScheduleRequestOperationResponse, err error) {
