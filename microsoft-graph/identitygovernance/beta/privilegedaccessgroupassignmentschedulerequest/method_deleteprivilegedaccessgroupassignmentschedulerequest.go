...
// identityGovernance
func (c PrivilegedAccessGroupAssignmentScheduleRequestClient) DeletePrivilegedAccessGroupAssignmentScheduleRequest(ctx context.Context, id beta.IdentityGovernancePrivilegedAccessGroupAssignmentScheduleRequestId, options DeletePrivilegedAccessGroupAssignmentScheduleRequestOperationOptions) (result DeletePrivilegedAccessGroupAssignmentScheduleRequestOperationResponse, err error) {
