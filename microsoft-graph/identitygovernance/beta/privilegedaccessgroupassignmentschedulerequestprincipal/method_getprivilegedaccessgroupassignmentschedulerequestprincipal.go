...
func (c PrivilegedAccessGroupAssignmentScheduleRequestPrincipalClient) GetPrivilegedAccessGroupAssignmentScheduleRequestPrincipal(ctx context.Context, id beta.IdentityGovernancePrivilegedAccessGroupAssignmentScheduleRequestId, options GetPrivilegedAccessGroupAssignmentScheduleRequestPrincipalOperationOptions) (result GetPrivilegedAccessGroupAssignmentScheduleRequestPrincipalOperationResponse, err error) {
