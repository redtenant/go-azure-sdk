...
func (c PrivilegedAccessGroupAssignmentScheduleRequestTargetScheduleClient) GetPrivilegedAccessGroupAssignmentScheduleRequestTargetSchedule(ctx context.Context, id beta.IdentityGovernancePrivilegedAccessGroupAssignmentScheduleRequestId, options GetPrivilegedAccessGroupAssignmentScheduleRequestTargetScheduleOperationOptions) (result GetPrivilegedAccessGroupAssignmentScheduleRequestTargetScheduleOperationResponse, err error) {
