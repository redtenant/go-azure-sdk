...
// identityGovernance
func (c PrivilegedAccessGroupEligibilityScheduleClient) CreatePrivilegedAccessGroupEligibilitySchedule(ctx context.Context, input beta.PrivilegedAccessGroupEligibilitySchedule, options CreatePrivilegedAccessGroupEligibilityScheduleOperationOptions) (result CreatePrivilegedAccessGroupEligibilityScheduleOperationResponse, err error) {
