...
// identityGovernance
func (c PrivilegedAccessGroupEligibilityScheduleClient) UpdatePrivilegedAccessGroupEligibilitySchedule(ctx context.Context, id beta.IdentityGovernancePrivilegedAccessGroupEligibilityScheduleId, input beta.PrivilegedAccessGroupEligibilitySchedule, options UpdatePrivilegedAccessGroupEligibilityScheduleOperationOptions) (result UpdatePrivilegedAccessGroupEligibilityScheduleOperationResponse, err error) {
