...
// identityGovernance
func (c PrivilegedAccessGroupEligibilityScheduleRequestClient) DeletePrivilegedAccessGroupEligibilityScheduleRequest(ctx context.Context, id beta.IdentityGovernancePrivilegedAccessGroupEligibilityScheduleRequestId, options DeletePrivilegedAccessGroupEligibilityScheduleRequestOperationOptions) (result DeletePrivilegedAccessGroupEligibilityScheduleRequestOperationResponse, err error) {
