...
type GetPrivilegedAccessGroupEligibilityScheduleRequestOperationResponse struct {
	...
	OData        *odata.OData
	Model        *beta.PrivilegedAccessGroupEligibilityScheduleRequest
}
...
func (c PrivilegedAccessGroupEligibilityScheduleRequestClient) GetPrivilegedAccessGroupEligibilityScheduleRequest(ctx context.Context, id beta.IdentityGovernancePrivilegedAccessGroupEligibilityScheduleRequestId, options GetPrivilegedAccessGroupEligibilityScheduleRequestOperationOptions) (result GetPrivilegedAccessGroupEligibilityScheduleRequestOperationResponse, err error) {
	...
	var model beta.PrivilegedAccessGroupEligibilityScheduleRequest
	result.Model = &model
