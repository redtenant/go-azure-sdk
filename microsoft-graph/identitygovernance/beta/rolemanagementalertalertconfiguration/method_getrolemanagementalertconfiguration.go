...
func DefaultGetRoleManagementAlertConfigurationOperationOptions() GetRoleManagementAlertConfigurationOperationOptions {
	return GetRoleManagementAlertConfigurationOperationOptions{}
}
...
// GetRoleManagementAlertConfiguration - Get alertConfigurations from identityGovernance. The various configurations of
// an alert for Microsoft Entra roles. The configurations are predefined and can't be created or deleted, but some of
// the configurations can be modified.
func (c RoleManagementAlertAlertConfigurationClient) GetRoleManagementAlertConfiguration(ctx context.Context, id beta.IdentityGovernanceRoleManagementAlertAlertConfigurationId, options GetRoleManagementAlertConfigurationOperationOptions) (result GetRoleManagementAlertConfigurationOperationResponse, err error) {
