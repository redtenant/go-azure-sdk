...
// GetRoleManagementAlertDefinition - Get alertDefinitions from identityGovernance. Defines an alert, its impact, and
// measures to mitigate or prevent it.
func (c RoleManagementAlertAlertDefinitionClient) GetRoleManagementAlertDefinition(ctx context.Context, id beta.IdentityGovernanceRoleManagementAlertAlertDefinitionId, options GetRoleManagementAlertDefinitionOperationOptions) (result GetRoleManagementAlertDefinitionOperationResponse, err error) {
