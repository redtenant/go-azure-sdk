...
type GetRoleManagementAlertOperationsCountOperationResponse struct {
	HttpResponse *http.Response
	OData        *odata.OData
	Model        *[]byte
}

type GetRoleManagementAlertOperationsCountOperationOptions struct {
	Filter    *string
...
func DefaultGetRoleManagementAlertOperationsCountOperationOptions() GetRoleManagementAlertOperationsCountOperationOptions {
	return GetRoleManagementAlertOperationsCountOperationOptions{}
}
