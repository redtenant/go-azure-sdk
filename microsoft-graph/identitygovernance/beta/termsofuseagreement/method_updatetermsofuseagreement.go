...
func (c TermsOfUseAgreementClient) UpdateTermsOfUseAgreement(ctx context.Context, id beta.IdentityGovernanceTermsOfUseAgreementId, input beta.Agreement, options UpdateTermsOfUseAgreementOperationOptions) (result UpdateTermsOfUseAgreementOperationResponse, err error) {
