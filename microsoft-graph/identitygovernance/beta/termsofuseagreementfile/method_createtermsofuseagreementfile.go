...
func (c TermsOfUseAgreementFileClient) CreateTermsOfUseAgreementFile(ctx context.Context, id beta.IdentityGovernanceTermsOfUseAgreementId, input beta.AgreementFileLocalization, options CreateTermsOfUseAgreementFileOperationOptions) (result CreateTermsOfUseAgreementFileOperationResponse, err error) {
