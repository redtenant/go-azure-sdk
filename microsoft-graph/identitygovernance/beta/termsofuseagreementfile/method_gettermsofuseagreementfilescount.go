...
func (c TermsOfUseAgreementFileClient) GetTermsOfUseAgreementFilesCount(ctx context.Context, id beta.IdentityGovernanceTermsOfUseAgreementId, options GetTermsOfUseAgreementFilesCountOperationOptions) (result GetTermsOfUseAgreementFilesCountOperationResponse, err error) {
