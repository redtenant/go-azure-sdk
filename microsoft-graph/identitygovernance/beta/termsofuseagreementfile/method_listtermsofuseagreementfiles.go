...
// ListTermsOfUseAgreementFiles - Get files from identityGovernance. PDFs linked to this agreement. Note: This property
// is in the process of being deprecated. Use the file property instead.
func (c TermsOfUseAgreementFileClient) ListTermsOfUseAgreementFiles(ctx context.Context, id beta.IdentityGovernanceTermsOfUseAgreementId, options ListTermsOfUseAgreementFilesOperationOptions) (result ListTermsOfUseAgreementFilesOperationResponse, err error) {
...
func (c TermsOfUseAgreementFileClient) ListTermsOfUseAgreementFilesComplete(ctx context.Context, id beta.IdentityGovernanceTermsOfUseAgreementId, options ListTermsOfUseAgreementFilesOperationOptions) (ListTermsOfUseAgreementFilesCompleteResult, error) {
...
func (c TermsOfUseAgreementFileClient) ListTermsOfUseAgreementFilesCompleteMatchingPredicate(ctx context.Context, id beta.IdentityGovernanceTermsOfUseAgreementId, options ListTermsOfUseAgreementFilesOperationOptions, predicate AgreementFileLocalizationOperationPredicate) (result ListTermsOfUseAgreementFilesCompleteResult, err error) {
