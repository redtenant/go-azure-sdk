...
func (c TermsOfUseAgreementFileLocalizationClient) CreateTermsOfUseAgreementFileLocalization(ctx context.Context, id beta.IdentityGovernanceTermsOfUseAgreementId, input beta.AgreementFileLocalization, options CreateTermsOfUseAgreementFileLocalizationOperationOptions) (result CreateTermsOfUseAgreementFileLocalizationOperationResponse, err error) {
