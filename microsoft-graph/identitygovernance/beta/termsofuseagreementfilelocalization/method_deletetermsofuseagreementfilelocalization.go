...
func (c TermsOfUseAgreementFileLocalizationClient) DeleteTermsOfUseAgreementFileLocalization(ctx context.Context, id beta.IdentityGovernanceTermsOfUseAgreementIdFileLocalizationId, options DeleteTermsOfUseAgreementFileLocalizationOperationOptions) (result DeleteTermsOfUseAgreementFileLocalizationOperationResponse, err error) {
