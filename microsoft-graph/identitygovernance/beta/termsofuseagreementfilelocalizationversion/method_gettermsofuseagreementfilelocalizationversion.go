...
func (c TermsOfUseAgreementFileLocalizationVersionClient) GetTermsOfUseAgreementFileLocalizationVersion(ctx context.Context, id beta.IdentityGovernanceTermsOfUseAgreementIdFileLocalizationIdVersionId, options GetTermsOfUseAgreementFileLocalizationVersionOperationOptions) (result GetTermsOfUseAgreementFileLocalizationVersionOperationResponse, err error) {
