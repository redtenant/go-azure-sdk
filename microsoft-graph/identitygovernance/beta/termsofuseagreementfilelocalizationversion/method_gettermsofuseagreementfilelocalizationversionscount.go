...
func (c TermsOfUseAgreementFileLocalizationVersionClient) GetTermsOfUseAgreementFileLocalizationVersionsCount(ctx context.Context, id beta.IdentityGovernanceTermsOfUseAgreementIdFileLocalizationId, options GetTermsOfUseAgreementFileLocalizationVersionsCountOperationOptions) (result GetTermsOfUseAgreementFileLocalizationVersionsCountOperationResponse, err error) {
