...
func (c TermsOfUseAgreementFileLocalizationVersionClient) ListTermsOfUseAgreementFileLocalizationVersions(ctx context.Context, id beta.IdentityGovernanceTermsOfUseAgreementIdFileLocalizationId, options ListTermsOfUseAgreementFileLocalizationVersionsOperationOptions) (result ListTermsOfUseAgreementFileLocalizationVersionsOperationResponse, err error) {
...
func (c TermsOfUseAgreementFileLocalizationVersionClient) ListTermsOfUseAgreementFileLocalizationVersionsComplete(ctx context.Context, id beta.IdentityGovernanceTermsOfUseAgreementIdFileLocalizationId, options ListTermsOfUseAgreementFileLocalizationVersionsOperationOptions) (ListTermsOfUseAgreementFileLocalizationVersionsCompleteResult, error) {
...
func (c TermsOfUseAgreementFileLocalizationVersionClient) ListTermsOfUseAgreementFileLocalizationVersionsCompleteMatchingPredicate(ctx context.Context, id beta.IdentityGovernanceTermsOfUseAgreementIdFileLocalizationId, options ListTermsOfUseAgreementFileLocalizationVersionsOperationOptions, predicate AgreementFileVersionOperationPredicate) (result ListTermsOfUseAgreementFileLocalizationVersionsCompleteResult, err error) {
