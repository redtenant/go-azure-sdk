...
func (c TermsOfUseAgreementFileVersionClient) CreateTermsOfUseAgreementFileVersion(ctx context.Context, id beta.IdentityGovernanceTermsOfUseAgreementIdFileId, input beta.AgreementFileVersion, options CreateTermsOfUseAgreementFileVersionOperationOptions) (result CreateTermsOfUseAgreementFileVersionOperationResponse, err error) {
