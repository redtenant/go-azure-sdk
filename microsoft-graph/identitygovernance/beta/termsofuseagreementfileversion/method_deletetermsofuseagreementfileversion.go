...
func (c TermsOfUseAgreementFileVersionClient) DeleteTermsOfUseAgreementFileVersion(ctx context.Context, id beta.IdentityGovernanceTermsOfUseAgreementIdFileIdVersionId, options DeleteTermsOfUseAgreementFileVersionOperationOptions) (result DeleteTermsOfUseAgreementFileVersionOperationResponse, err error) {
