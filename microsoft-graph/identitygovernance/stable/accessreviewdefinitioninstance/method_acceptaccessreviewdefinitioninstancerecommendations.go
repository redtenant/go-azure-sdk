...
// recommendations on all accessReviewInstanceDecisionItem objects that haven't been reviewed on an accessReviewInstance
// object for which the calling user is a reviewer.
func (c AccessReviewDefinitionInstanceClient) AcceptAccessReviewDefinitionInstanceRecommendations(ctx context.Context, id stable.IdentityGovernanceAccessReviewDefinitionIdInstanceId, options AcceptAccessReviewDefinitionInstanceRecommendationsOperationOptions) (result AcceptAccessReviewDefinitionInstanceRecommendationsOperationResponse, err error) {
