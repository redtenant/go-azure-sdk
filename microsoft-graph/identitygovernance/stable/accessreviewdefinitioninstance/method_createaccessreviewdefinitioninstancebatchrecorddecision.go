...
func (c AccessReviewDefinitionInstanceClient) CreateAccessReviewDefinitionInstanceBatchRecordDecision(ctx context.Context, id stable.IdentityGovernanceAccessReviewDefinitionIdInstanceId, input CreateAccessReviewDefinitionInstanceBatchRecordDecisionRequest, options CreateAccessReviewDefinitionInstanceBatchRecordDecisionOperationOptions) (result CreateAccessReviewDefinitionInstanceBatchRecordDecisionOperationResponse, err error) {
