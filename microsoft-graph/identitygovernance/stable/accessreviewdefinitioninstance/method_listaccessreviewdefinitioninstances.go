...
type ListAccessReviewDefinitionInstancesCompleteResult struct {
	...
	Items              []stable.AccessReviewInstance
}
...
// ListAccessReviewDefinitionInstances - List instances. Get a list of the accessReviewInstance objects and their
// properties.
func (c AccessReviewDefinitionInstanceClient) ListAccessReviewDefinitionInstances(ctx context.Context, id stable.IdentityGovernanceAccessReviewDefinitionId, options ListAccessReviewDefinitionInstancesOperationOptions) (result ListAccessReviewDefinitionInstancesOperationResponse, err error) {
	...
	var values struct {
		Values *[]stable.AccessReviewInstance `json:"value"`
	}
...
func (c AccessReviewDefinitionInstanceClient) ListAccessReviewDefinitionInstancesComplete(ctx context.Context, id stable.IdentityGovernanceAccessReviewDefinitionId, options ListAccessReviewDefinitionInstancesOperationOptions) (ListAccessReviewDefinitionInstancesCompleteResult, error) {
...
func (c AccessReviewDefinitionInstanceClient) ListAccessReviewDefinitionInstancesCompleteMatchingPredicate(ctx context.Context, id stable.IdentityGovernanceAccessReviewDefinitionId, options ListAccessReviewDefinitionInstancesOperationOptions, predicate AccessReviewInstanceOperationPredicate) (result ListAccessReviewDefinitionInstancesCompleteResult, err error) {
	items := make([]stable.AccessReviewInstance, 0)
