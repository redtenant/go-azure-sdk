...
// ResetAccessReviewDefinitionInstanceDecisions - Invoke action resetDecisions. Resets all
// accessReviewInstanceDecisionItem objects on an accessReviewInstance to notReviewed.
func (c AccessReviewDefinitionInstanceClient) ResetAccessReviewDefinitionInstanceDecisions(ctx context.Context, id stable.IdentityGovernanceAccessReviewDefinitionIdInstanceId, options ResetAccessReviewDefinitionInstanceDecisionsOperationOptions) (result ResetAccessReviewDefinitionInstanceDecisionsOperationResponse, err error) {
