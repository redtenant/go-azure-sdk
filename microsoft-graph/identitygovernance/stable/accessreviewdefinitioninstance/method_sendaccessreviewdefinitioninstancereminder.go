...
// SendAccessReviewDefinitionInstanceReminder - Invoke action sendReminder. Send a reminder to the reviewers of an
// active accessReviewInstance.
func (c AccessReviewDefinitionInstanceClient) SendAccessReviewDefinitionInstanceReminder(ctx context.Context, id stable.IdentityGovernanceAccessReviewDefinitionIdInstanceId, options SendAccessReviewDefinitionInstanceReminderOperationOptions) (result SendAccessReviewDefinitionInstanceReminderOperationResponse, err error) {
