...
// identityGovernance
func (c AccessReviewDefinitionInstanceContactedReviewerClient) CreateAccessReviewDefinitionInstanceContactedReviewer(ctx context.Context, id stable.IdentityGovernanceAccessReviewDefinitionIdInstanceId, input stable.AccessReviewReviewer, options CreateAccessReviewDefinitionInstanceContactedReviewerOperationOptions) (result CreateAccessReviewDefinitionInstanceContactedReviewerOperationResponse, err error) {
