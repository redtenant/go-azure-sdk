...
func (c AccessReviewDefinitionInstanceContactedReviewerClient) ListAccessReviewDefinitionInstanceContactedReviewersComplete(ctx context.Context, id stable.IdentityGovernanceAccessReviewDefinitionIdInstanceId, options ListAccessReviewDefinitionInstanceContactedReviewersOperationOptions) (ListAccessReviewDefinitionInstanceContactedReviewersCompleteResult, error) {
...
func (c AccessReviewDefinitionInstanceContactedReviewerClient) ListAccessReviewDefinitionInstanceContactedReviewersCompleteMatchingPredicate(ctx context.Context, id stable.IdentityGovernanceAccessReviewDefinitionIdInstanceId, options ListAccessReviewDefinitionInstanceContactedReviewersOperationOptions, predicate AccessReviewReviewerOperationPredicate) (result ListAccessReviewDefinitionInstanceContactedReviewersCompleteResult, err error) {
