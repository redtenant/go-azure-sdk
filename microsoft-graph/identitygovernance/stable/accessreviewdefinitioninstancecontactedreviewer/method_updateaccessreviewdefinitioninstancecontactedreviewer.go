...
// identityGovernance
func (c AccessReviewDefinitionInstanceContactedReviewerClient) UpdateAccessReviewDefinitionInstanceContactedReviewer(ctx context.Context, id stable.IdentityGovernanceAccessReviewDefinitionIdInstanceIdContactedReviewerId, input stable.AccessReviewReviewer, options UpdateAccessReviewDefinitionInstanceContactedReviewerOperationOptions) (result UpdateAccessReviewDefinitionInstanceContactedReviewerOperationResponse, err error) {
