...
func (c AccessReviewDefinitionInstanceDecisionClient) ListAccessReviewDefinitionInstanceDecisions(ctx context.Context, id stable.IdentityGovernanceAccessReviewDefinitionIdInstanceId, options ListAccessReviewDefinitionInstanceDecisionsOperationOptions) (result ListAccessReviewDefinitionInstanceDecisionsOperationResponse, err error) {
...
func (c AccessReviewDefinitionInstanceDecisionClient) ListAccessReviewDefinitionInstanceDecisionsComplete(ctx context.Context, id stable.IdentityGovernanceAccessReviewDefinitionIdInstanceId, options ListAccessReviewDefinitionInstanceDecisionsOperationOptions) (ListAccessReviewDefinitionInstanceDecisionsCompleteResult, error) {
...
func (c AccessReviewDefinitionInstanceDecisionClient) ListAccessReviewDefinitionInstanceDecisionsCompleteMatchingPredicate(ctx context.Context, id stable.IdentityGovernanceAccessReviewDefinitionIdInstanceId, options ListAccessReviewDefinitionInstanceDecisionsOperationOptions, predicate AccessReviewInstanceDecisionItemOperationPredicate) (result ListAccessReviewDefinitionInstanceDecisionsCompleteResult, err error) {
