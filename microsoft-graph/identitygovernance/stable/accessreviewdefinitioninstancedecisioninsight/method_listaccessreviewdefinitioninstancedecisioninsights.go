...
func (c AccessReviewDefinitionInstanceDecisionInsightClient) ListAccessReviewDefinitionInstanceDecisionInsights(ctx context.Context, id stable.IdentityGovernanceAccessReviewDefinitionIdInstanceIdDecisionId, options ListAccessReviewDefinitionInstanceDecisionInsightsOperationOptions) (result ListAccessReviewDefinitionInstanceDecisionInsightsOperationResponse, err error) {
...
func (c AccessReviewDefinitionInstanceDecisionInsightClient) ListAccessReviewDefinitionInstanceDecisionInsightsCompleteMatchingPredicate(ctx context.Context, id stable.IdentityGovernanceAccessReviewDefinitionIdInstanceIdDecisionId, options ListAccessReviewDefinitionInstanceDecisionInsightsOperationOptions, predicate GovernanceInsightOperationPredicate) (result ListAccessReviewDefinitionInstanceDecisionInsightsCompleteResult, err error) {
