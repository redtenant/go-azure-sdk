...
func (c AccessReviewDefinitionInstanceDecisionInsightClient) UpdateAccessReviewDefinitionInstanceDecisionInsight(ctx context.Context, id stable.IdentityGovernanceAccessReviewDefinitionIdInstanceIdDecisionIdInsightId, input stable.GovernanceInsight, options UpdateAccessReviewDefinitionInstanceDecisionInsightOperationOptions) (result UpdateAccessReviewDefinitionInstanceDecisionInsightOperationResponse, err error) {
