...
// ListAccessReviewDefinitionInstanceStages - List stages (of an access review). Retrieve the stages in a multi-stage
// access review instance.
func (c AccessReviewDefinitionInstanceStageClient) ListAccessReviewDefinitionInstanceStages(ctx context.Context, id stable.IdentityGovernanceAccessReviewDefinitionIdInstanceId, options ListAccessReviewDefinitionInstanceStagesOperationOptions) (result ListAccessReviewDefinitionInstanceStagesOperationResponse, err error) {
...
func (c AccessReviewDefinitionInstanceStageClient) ListAccessReviewDefinitionInstanceStagesComplete(ctx context.Context, id stable.IdentityGovernanceAccessReviewDefinitionIdInstanceId, options ListAccessReviewDefinitionInstanceStagesOperationOptions) (ListAccessReviewDefinitionInstanceStagesCompleteResult, error) {
