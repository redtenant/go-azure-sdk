...
func (c AccessReviewDefinitionInstanceStageDecisionClient) ListAccessReviewDefinitionInstanceStageDecisions(ctx context.Context, id stable.IdentityGovernanceAccessReviewDefinitionIdInstanceIdStageId, options ListAccessReviewDefinitionInstanceStageDecisionsOperationOptions) (result ListAccessReviewDefinitionInstanceStageDecisionsOperationResponse, err error) {
...
func (c AccessReviewDefinitionInstanceStageDecisionClient) ListAccessReviewDefinitionInstanceStageDecisionsComplete(ctx context.Context, id stable.IdentityGovernanceAccessReviewDefinitionIdInstanceIdStageId, options ListAccessReviewDefinitionInstanceStageDecisionsOperationOptions) (ListAccessReviewDefinitionInstanceStageDecisionsCompleteResult, error) {
...
func (c AccessReviewDefinitionInstanceStageDecisionClient) ListAccessReviewDefinitionInstanceStageDecisionsCompleteMatchingPredicate(ctx context.Context, id stable.IdentityGovernanceAccessReviewDefinitionIdInstanceIdStageId, options ListAccessReviewDefinitionInstanceStageDecisionsOperationOptions, predicate AccessReviewInstanceDecisionItemOperationPredicate) (result ListAccessReviewDefinitionInstanceStageDecisionsCompleteResult, err error) {
