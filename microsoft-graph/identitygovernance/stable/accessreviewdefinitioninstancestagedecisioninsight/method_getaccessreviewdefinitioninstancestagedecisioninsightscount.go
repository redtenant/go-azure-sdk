...
func (c AccessReviewDefinitionInstanceStageDecisionInsightClient) GetAccessReviewDefinitionInstanceStageDecisionInsightsCount(ctx context.Context, id stable.IdentityGovernanceAccessReviewDefinitionIdInstanceIdStageIdDecisionId, options GetAccessReviewDefinitionInstanceStageDecisionInsightsCountOperationOptions) (result GetAccessReviewDefinitionInstanceStageDecisionInsightsCountOperationResponse, err error) {
