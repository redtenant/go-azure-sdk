...
type UpdateAccessReviewHistoryDefinitionOperationResponse struct {
...
func (c AccessReviewHistoryDefinitionClient) UpdateAccessReviewHistoryDefinition(ctx context.Context, id stable.IdentityGovernanceAccessReviewHistoryDefinitionId, input stable.AccessReviewHistoryDefinition, options UpdateAccessReviewHistoryDefinitionOperationOptions) (result UpdateAccessReviewHistoryDefinitionOperationResponse, err error) {
