...
func (c AccessReviewHistoryDefinitionInstanceClient) GetAccessReviewHistoryDefinitionInstancesCount(ctx context.Context, id stable.IdentityGovernanceAccessReviewHistoryDefinitionId, options GetAccessReviewHistoryDefinitionInstancesCountOperationOptions) (result GetAccessReviewHistoryDefinitionInstancesCountOperationResponse, err error) {
