...
func (c AccessReviewHistoryDefinitionInstanceClient) ListAccessReviewHistoryDefinitionInstances(ctx context.Context, id stable.IdentityGovernanceAccessReviewHistoryDefinitionId, options ListAccessReviewHistoryDefinitionInstancesOperationOptions) (result ListAccessReviewHistoryDefinitionInstancesOperationResponse, err error) {
...
func (c AccessReviewHistoryDefinitionInstanceClient) ListAccessReviewHistoryDefinitionInstancesCompleteMatchingPredicate(ctx context.Context, id stable.IdentityGovernanceAccessReviewHistoryDefinitionId, options ListAccessReviewHistoryDefinitionInstancesOperationOptions, predicate AccessReviewHistoryInstanceOperationPredicate) (result ListAccessReviewHistoryDefinitionInstancesCompleteResult, err error) {
