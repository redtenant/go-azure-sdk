...
func (c AppConsentAppConsentRequestClient) GetAppConsentRequest(ctx context.Context, id stable.IdentityGovernanceAppConsentAppConsentRequestId, options GetAppConsentRequestOperationOptions) (result GetAppConsentRequestOperationResponse, err error) {
	...
	var model stable.AppConsentRequest
	result.Model = &model
