...
func DefaultUpdateAppConsentRequestOperationOptions() UpdateAppConsentRequestOperationOptions {
	return UpdateAppConsentRequestOperationOptions{}
}
...
func (c AppConsentAppConsentRequestClient) UpdateAppConsentRequest(ctx context.Context, id stable.IdentityGovernanceAppConsentAppConsentRequestId, input stable.AppConsentRequest, options UpdateAppConsentRequestOperationOptions) (result UpdateAppConsentRequestOperationResponse, err error) {
