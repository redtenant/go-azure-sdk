...
type DeleteAppConsentRequestUserConsentRequestOperationResponse struct {
...
func DefaultDeleteAppConsentRequestUserConsentRequestOperationOptions() DeleteAppConsentRequestUserConsentRequestOperationOptions {
	return DeleteAppConsentRequestUserConsentRequestOperationOptions{}
}
...
func (c AppConsentAppConsentRequestUserConsentRequestClient) DeleteAppConsentRequestUserConsentRequest(ctx context.Context, id stable.IdentityGovernanceAppConsentAppConsentRequestIdUserConsentRequestId, options DeleteAppConsentRequestUserConsentRequestOperationOptions) (result DeleteAppConsentRequestUserConsentRequestOperationResponse, err error) {
