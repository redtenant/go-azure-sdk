...
func (c AppConsentAppConsentRequestUserConsentRequestClient) ListAppConsentRequestUserConsentRequestsCompleteMatchingPredicate(ctx context.Context, id stable.IdentityGovernanceAppConsentAppConsentRequestId, options ListAppConsentRequestUserConsentRequestsOperationOptions, predicate UserConsentRequestOperationPredicate) (result ListAppConsentRequestUserConsentRequestsCompleteResult, err error) {
