...
func (c EntitlementManagementClient) UpdateEntitlementManagement(ctx context.Context, input stable.EntitlementManagement, options UpdateEntitlementManagementOperationOptions) (result UpdateEntitlementManagementOperationResponse, err error) {
