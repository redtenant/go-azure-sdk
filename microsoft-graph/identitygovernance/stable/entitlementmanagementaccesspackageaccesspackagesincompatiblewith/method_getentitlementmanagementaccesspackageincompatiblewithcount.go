...
func (c EntitlementManagementAccessPackageAccessPackagesIncompatibleWithClient) GetEntitlementManagementAccessPackageIncompatibleWithCount(ctx context.Context, id stable.IdentityGovernanceEntitlementManagementAccessPackageId, options GetEntitlementManagementAccessPackageIncompatibleWithCountOperationOptions) (result GetEntitlementManagementAccessPackageIncompatibleWithCountOperationResponse, err error) {
