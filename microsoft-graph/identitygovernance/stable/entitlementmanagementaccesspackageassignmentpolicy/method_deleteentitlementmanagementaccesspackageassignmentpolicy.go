...
// DeleteEntitlementManagementAccessPackageAssignmentPolicy - Delete navigation property assignmentPolicies for
// identityGovernance
func (c EntitlementManagementAccessPackageAssignmentPolicyClient) DeleteEntitlementManagementAccessPackageAssignmentPolicy(ctx context.Context, id stable.IdentityGovernanceEntitlementManagementAccessPackageIdAssignmentPolicyId, options DeleteEntitlementManagementAccessPackageAssignmentPolicyOperationOptions) (result DeleteEntitlementManagementAccessPackageAssignmentPolicyOperationResponse, err error) {
