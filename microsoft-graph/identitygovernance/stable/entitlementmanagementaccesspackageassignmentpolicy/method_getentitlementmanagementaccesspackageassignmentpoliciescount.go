...
func (c EntitlementManagementAccessPackageAssignmentPolicyClient) GetEntitlementManagementAccessPackageAssignmentPoliciesCount(ctx context.Context, id stable.IdentityGovernanceEntitlementManagementAccessPackageId, options GetEntitlementManagementAccessPackageAssignmentPoliciesCountOperationOptions) (result GetEntitlementManagementAccessPackageAssignmentPoliciesCountOperationResponse, err error) {
	opts := client.RequestOptions{
		...
		Path:          fmt.Sprintf("%s/assignmentPolicies/$count", id.ID()),
