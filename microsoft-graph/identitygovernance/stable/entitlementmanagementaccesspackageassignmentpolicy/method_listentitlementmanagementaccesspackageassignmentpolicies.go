...
// ListEntitlementManagementAccessPackageAssignmentPolicies - Get assignmentPolicies from identityGovernance. Read-only.
// Nullable. Supports $expand.
func (c EntitlementManagementAccessPackageAssignmentPolicyClient) ListEntitlementManagementAccessPackageAssignmentPolicies(ctx context.Context, id stable.IdentityGovernanceEntitlementManagementAccessPackageId, options ListEntitlementManagementAccessPackageAssignmentPoliciesOperationOptions) (result ListEntitlementManagementAccessPackageAssignmentPoliciesOperationResponse, err error) {
...
func (c EntitlementManagementAccessPackageAssignmentPolicyClient) ListEntitlementManagementAccessPackageAssignmentPoliciesComplete(ctx context.Context, id stable.IdentityGovernanceEntitlementManagementAccessPackageId, options ListEntitlementManagementAccessPackageAssignmentPoliciesOperationOptions) (ListEntitlementManagementAccessPackageAssignmentPoliciesCompleteResult, error) {
	return c.ListEntitlementManagementAccessPackageAssignmentPoliciesCompleteMatchingPredicate(ctx, id, options, AccessPackageAssignmentPolicyOperationPredicate{})
}
...
func (c EntitlementManagementAccessPackageAssignmentPolicyClient) ListEntitlementManagementAccessPackageAssignmentPoliciesCompleteMatchingPredicate(ctx context.Context, id stable.IdentityGovernanceEntitlementManagementAccessPackageId, options ListEntitlementManagementAccessPackageAssignmentPoliciesOperationOptions, predicate AccessPackageAssignmentPolicyOperationPredicate) (result ListEntitlementManagementAccessPackageAssignmentPoliciesCompleteResult, err error) {
	items := make([]stable.AccessPackageAssignmentPolicy, 0)

	resp, err := c.ListEntitlementManagementAccessPackageAssignmentPolicies(ctx, id, options)
	if err != nil {
