...
// UpdateEntitlementManagementAccessPackageAssignmentPolicy - Update the navigation property assignmentPolicies in
// identityGovernance
func (c EntitlementManagementAccessPackageAssignmentPolicyClient) UpdateEntitlementManagementAccessPackageAssignmentPolicy(ctx context.Context, id stable.IdentityGovernanceEntitlementManagementAccessPackageIdAssignmentPolicyId, input stable.AccessPackageAssignmentPolicy, options UpdateEntitlementManagementAccessPackageAssignmentPolicyOperationOptions) (result UpdateEntitlementManagementAccessPackageAssignmentPolicyOperationResponse, err error) {
