...
// from identityGovernance. Indicates the custom workflow extension that will be executed at this stage. Nullable.
// Supports $expand.
func (c EntitlementManagementAccessPackageAssignmentPolicyCustomExtensionStageSettingCustomExtensionClient) GetEntitlementManagementAccessPackageAssignmentPolicyCustomExtensionStageSettingCustomExtension(ctx context.Context, id stable.IdentityGovernanceEntitlementManagementAccessPackageIdAssignmentPolicyIdCustomExtensionStageSettingId, options GetEntitlementManagementAccessPackageAssignmentPolicyCustomExtensionStageSettingCustomExtensionOperationOptions) (result GetEntitlementManagementAccessPackageAssignmentPolicyCustomExtensionStageSettingCustomExtensionOperationResponse, err error) {
