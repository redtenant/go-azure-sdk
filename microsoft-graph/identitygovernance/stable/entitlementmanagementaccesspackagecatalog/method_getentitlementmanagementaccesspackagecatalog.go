...
// GetEntitlementManagementAccessPackageCatalog - Get catalog from identityGovernance. Required when creating the access
// package. Read-only. Nullable.
func (c EntitlementManagementAccessPackageCatalogClient) GetEntitlementManagementAccessPackageCatalog(ctx context.Context, id stable.IdentityGovernanceEntitlementManagementAccessPackageId, options GetEntitlementManagementAccessPackageCatalogOperationOptions) (result GetEntitlementManagementAccessPackageCatalogOperationResponse, err error) {
