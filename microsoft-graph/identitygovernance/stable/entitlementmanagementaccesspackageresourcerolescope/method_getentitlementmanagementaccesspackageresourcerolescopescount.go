...
func (c EntitlementManagementAccessPackageResourceRoleScopeClient) GetEntitlementManagementAccessPackageResourceRoleScopesCount(ctx context.Context, id stable.IdentityGovernanceEntitlementManagementAccessPackageId, options GetEntitlementManagementAccessPackageResourceRoleScopesCountOperationOptions) (result GetEntitlementManagementAccessPackageResourceRoleScopesCountOperationResponse, err error) {
	opts := client.RequestOptions{
		...
		Path:          fmt.Sprintf("%s/resourceRoleScopes/$count", id.ID()),
