...
// ListEntitlementManagementAccessPackageResourceRoleScopes - Get resourceRoleScopes from identityGovernance. The
// resource roles and scopes in this access package.
func (c EntitlementManagementAccessPackageResourceRoleScopeClient) ListEntitlementManagementAccessPackageResourceRoleScopes(ctx context.Context, id stable.IdentityGovernanceEntitlementManagementAccessPackageId, options ListEntitlementManagementAccessPackageResourceRoleScopesOperationOptions) (result ListEntitlementManagementAccessPackageResourceRoleScopesOperationResponse, err error) {
...
func (c EntitlementManagementAccessPackageResourceRoleScopeClient) ListEntitlementManagementAccessPackageResourceRoleScopesComplete(ctx context.Context, id stable.IdentityGovernanceEntitlementManagementAccessPackageId, options ListEntitlementManagementAccessPackageResourceRoleScopesOperationOptions) (ListEntitlementManagementAccessPackageResourceRoleScopesCompleteResult, error) {
