...
type DeleteEntitlementManagementAccessPackageResourceRoleScopeRoleOperationResponse struct {
	HttpResponse *http.Response
	OData        *odata.OData
}

type DeleteEntitlementManagementAccessPackageResourceRoleScopeRoleOperationOptions struct {
	IfMatch   *string
...
func DefaultDeleteEntitlementManagementAccessPackageResourceRoleScopeRoleOperationOptions() DeleteEntitlementManagementAccessPackageResourceRoleScopeRoleOperationOptions {
	return DeleteEntitlementManagementAccessPackageResourceRoleScopeRoleOperationOptions{}
}
...
// DeleteEntitlementManagementAccessPackageResourceRoleScopeRole - Delete navigation property role for
// identityGovernance
