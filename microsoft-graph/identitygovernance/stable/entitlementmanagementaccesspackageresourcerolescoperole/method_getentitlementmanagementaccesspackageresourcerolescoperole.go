...
type GetEntitlementManagementAccessPackageResourceRoleScopeRoleOperationResponse struct {
	HttpResponse *http.Response
	OData        *odata.OData
	Model        *stable.AccessPackageResourceRole
}

type GetEntitlementManagementAccessPackageResourceRoleScopeRoleOperationOptions struct {
	Expand    *odata.Expand
...
func DefaultGetEntitlementManagementAccessPackageResourceRoleScopeRoleOperationOptions() GetEntitlementManagementAccessPackageResourceRoleScopeRoleOperationOptions {
	return GetEntitlementManagementAccessPackageResourceRoleScopeRoleOperationOptions{}
}
