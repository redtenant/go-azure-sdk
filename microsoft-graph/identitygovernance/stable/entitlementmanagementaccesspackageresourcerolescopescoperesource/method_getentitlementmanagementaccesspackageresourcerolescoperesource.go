...
func (c EntitlementManagementAccessPackageResourceRoleScopeScopeResourceClient) GetEntitlementManagementAccessPackageResourceRoleScopeResource(ctx context.Context, id stable.IdentityGovernanceEntitlementManagementAccessPackageIdResourceRoleScopeId, options GetEntitlementManagementAccessPackageResourceRoleScopeResourceOperationOptions) (result GetEntitlementManagementAccessPackageResourceRoleScopeResourceOperationResponse, err error) {
