...
type DeleteEntitlementManagementCatalogResourceRoleResourceScopeOperationResponse struct {
...
func DefaultDeleteEntitlementManagementCatalogResourceRoleResourceScopeOperationOptions() DeleteEntitlementManagementCatalogResourceRoleResourceScopeOperationOptions {
	return DeleteEntitlementManagementCatalogResourceRoleResourceScopeOperationOptions{}
}

func (o DeleteEntitlementManagementCatalogResourceRoleResourceScopeOperationOptions) ToHeaders() *client.Headers {
	out := client.Headers{}
	if o.IfMatch != nil {
...
func (o DeleteEntitlementManagementCatalogResourceRoleResourceScopeOperationOptions) ToQuery() *client.QueryParams {
