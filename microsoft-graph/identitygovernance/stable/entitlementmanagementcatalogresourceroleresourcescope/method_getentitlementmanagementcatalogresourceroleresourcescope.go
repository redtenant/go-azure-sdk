...
type GetEntitlementManagementCatalogResourceRoleResourceScopeOperationResponse struct {
...
func DefaultGetEntitlementManagementCatalogResourceRoleResourceScopeOperationOptions() GetEntitlementManagementCatalogResourceRoleResourceScopeOperationOptions {
	return GetEntitlementManagementCatalogResourceRoleResourceScopeOperationOptions{}
}

func (o GetEntitlementManagementCatalogResourceRoleResourceScopeOperationOptions) ToHeaders() *client.Headers {
	out := client.Headers{}

	return &out
}

func (o GetEntitlementManagementCatalogResourceRoleResourceScopeOperationOptions) ToOData() *odata.Query {
	out := odata.Query{}
	if o.Expand != nil {
		out.Expand = *o.Expand
	}
...
func (o GetEntitlementManagementCatalogResourceRoleResourceScopeOperationOptions) ToQuery() *client.QueryParams {
