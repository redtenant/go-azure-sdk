...
type GetEntitlementManagementCatalogResourceScopesCountOperationResponse struct {
...
func DefaultGetEntitlementManagementCatalogResourceScopesCountOperationOptions() GetEntitlementManagementCatalogResourceScopesCountOperationOptions {
	return GetEntitlementManagementCatalogResourceScopesCountOperationOptions{}
}

func (o GetEntitlementManagementCatalogResourceScopesCountOperationOptions) ToHeaders() *client.Headers {
	out := client.Headers{}

	return &out
}

func (o GetEntitlementManagementCatalogResourceScopesCountOperationOptions) ToOData() *odata.Query {
	out := odata.Query{}
	if o.Filter != nil {
		out.Filter = *o.Filter
	}
...
func (o GetEntitlementManagementCatalogResourceScopesCountOperationOptions) ToQuery() *client.QueryParams {
