...
func DefaultListEntitlementManagementCatalogResourceScopeResourceRolesOperationOptions() ListEntitlementManagementCatalogResourceScopeResourceRolesOperationOptions {
	return ListEntitlementManagementCatalogResourceScopeResourceRolesOperationOptions{}
}

func (o ListEntitlementManagementCatalogResourceScopeResourceRolesOperationOptions) ToHeaders() *client.Headers {
	out := client.Headers{}

	return &out
}

func (o ListEntitlementManagementCatalogResourceScopeResourceRolesOperationOptions) ToOData() *odata.Query {
	out := odata.Query{}
	if o.Count != nil {
		out.Count = *o.Count
	}
...
func (o ListEntitlementManagementCatalogResourceScopeResourceRolesOperationOptions) ToQuery() *client.QueryParams {
