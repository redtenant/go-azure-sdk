...
type GetEntitlementManagementResourceEnvironmentOperationResponse struct {
...
func DefaultGetEntitlementManagementResourceEnvironmentOperationOptions() GetEntitlementManagementResourceEnvironmentOperationOptions {
	return GetEntitlementManagementResourceEnvironmentOperationOptions{}
}

func (o GetEntitlementManagementResourceEnvironmentOperationOptions) ToHeaders() *client.Headers {
	out := client.Headers{}

	return &out
}

func (o GetEntitlementManagementResourceEnvironmentOperationOptions) ToOData() *odata.Query {
	out := odata.Query{}
	if o.Expand != nil {
		out.Expand = *o.Expand
	}
...
func (o GetEntitlementManagementResourceEnvironmentOperationOptions) ToQuery() *client.QueryParams {
