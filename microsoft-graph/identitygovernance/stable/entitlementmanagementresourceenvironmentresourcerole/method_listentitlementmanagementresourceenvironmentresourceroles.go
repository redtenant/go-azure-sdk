...
type ListEntitlementManagementResourceEnvironmentResourceRolesOperationOptions struct {
	Count     *bool
	Expand    *odata.Expand
	Filter    *string
...
func DefaultListEntitlementManagementResourceEnvironmentResourceRolesOperationOptions() ListEntitlementManagementResourceEnvironmentResourceRolesOperationOptions {
	return ListEntitlementManagementResourceEnvironmentResourceRolesOperationOptions{}
}

func (o ListEntitlementManagementResourceEnvironmentResourceRolesOperationOptions) ToHeaders() *client.Headers {
	out := client.Headers{}

	return &out
}

func (o ListEntitlementManagementResourceEnvironmentResourceRolesOperationOptions) ToOData() *odata.Query {
	out := odata.Query{}
	if o.Count != nil {
		out.Count = *o.Count
	}
...
func (o ListEntitlementManagementResourceEnvironmentResourceRolesOperationOptions) ToQuery() *client.QueryParams {
...
// ListEntitlementManagementResourceEnvironmentResourceRoles - Get roles from identityGovernance. Read-only. Nullable.
// Supports $expand.
func (c EntitlementManagementResourceEnvironmentResourceRoleClient) ListEntitlementManagementResourceEnvironmentResourceRoles(ctx context.Context, id stable.IdentityGovernanceEntitlementManagementResourceEnvironmentIdResourceId, options ListEntitlementManagementResourceEnvironmentResourceRolesOperationOptions) (result ListEntitlementManagementResourceEnvironmentResourceRolesOperationResponse, err error) {
...
func (c EntitlementManagementResourceEnvironmentResourceRoleClient) ListEntitlementManagementResourceEnvironmentResourceRolesComplete(ctx context.Context, id stable.IdentityGovernanceEntitlementManagementResourceEnvironmentIdResourceId, options ListEntitlementManagementResourceEnvironmentResourceRolesOperationOptions) (ListEntitlementManagementResourceEnvironmentResourceRolesCompleteResult, error) {
	return c.ListEntitlementManagementResourceEnvironmentResourceRolesCompleteMatchingPredicate(ctx, id, options, AccessPackageResourceRoleOperationPredicate{})
}
...
func (c EntitlementManagementResourceEnvironmentResourceRoleClient) ListEntitlementManagementResourceEnvironmentResourceRolesCompleteMatchingPredicate(ctx context.Context, id stable.IdentityGovernanceEntitlementManagementResourceEnvironmentIdResourceId, options ListEntitlementManagementResourceEnvironmentResourceRolesOperationOptions, predicate AccessPackageResourceRoleOperationPredicate) (result ListEntitlementManagementResourceEnvironmentResourceRolesCompleteResult, err error) {
	...
	resp, err := c.ListEntitlementManagementResourceEnvironmentResourceRoles(ctx, id, options)
	if err != nil {
