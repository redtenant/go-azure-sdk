...
type ListEntitlementManagementResourceRequestCatalogCustomWorkflowExtensionsOperationOptions struct {
	Count     *bool
	Expand    *odata.Expand
	Filter    *string
...
func DefaultListEntitlementManagementResourceRequestCatalogCustomWorkflowExtensionsOperationOptions() ListEntitlementManagementResourceRequestCatalogCustomWorkflowExtensionsOperationOptions {
	return ListEntitlementManagementResourceRequestCatalogCustomWorkflowExtensionsOperationOptions{}
}

func (o ListEntitlementManagementResourceRequestCatalogCustomWorkflowExtensionsOperationOptions) ToHeaders() *client.Headers {
	out := client.Headers{}

	return &out
}

func (o ListEntitlementManagementResourceRequestCatalogCustomWorkflowExtensionsOperationOptions) ToOData() *odata.Query {
	out := odata.Query{}
	if o.Count != nil {
		out.Count = *o.Count
	}
...
func (o ListEntitlementManagementResourceRequestCatalogCustomWorkflowExtensionsOperationOptions) ToQuery() *client.QueryParams {
...
// ListEntitlementManagementResourceRequestCatalogCustomWorkflowExtensions - Get customWorkflowExtensions from
// identityGovernance
func (c EntitlementManagementResourceRequestCatalogCustomWorkflowExtensionClient) ListEntitlementManagementResourceRequestCatalogCustomWorkflowExtensions(ctx context.Context, id stable.IdentityGovernanceEntitlementManagementResourceRequestId, options ListEntitlementManagementResourceRequestCatalogCustomWorkflowExtensionsOperationOptions) (result ListEntitlementManagementResourceRequestCatalogCustomWorkflowExtensionsOperationResponse, err error) {
...
func (c EntitlementManagementResourceRequestCatalogCustomWorkflowExtensionClient) ListEntitlementManagementResourceRequestCatalogCustomWorkflowExtensionsComplete(ctx context.Context, id stable.IdentityGovernanceEntitlementManagementResourceRequestId, options ListEntitlementManagementResourceRequestCatalogCustomWorkflowExtensionsOperationOptions) (ListEntitlementManagementResourceRequestCatalogCustomWorkflowExtensionsCompleteResult, error) {
	return c.ListEntitlementManagementResourceRequestCatalogCustomWorkflowExtensionsCompleteMatchingPredicate(ctx, id, options, CustomCalloutExtensionOperationPredicate{})
}
...
func (c EntitlementManagementResourceRequestCatalogCustomWorkflowExtensionClient) ListEntitlementManagementResourceRequestCatalogCustomWorkflowExtensionsCompleteMatchingPredicate(ctx context.Context, id stable.IdentityGovernanceEntitlementManagementResourceRequestId, options ListEntitlementManagementResourceRequestCatalogCustomWorkflowExtensionsOperationOptions, predicate CustomCalloutExtensionOperationPredicate) (result ListEntitlementManagementResourceRequestCatalogCustomWorkflowExtensionsCompleteResult, err error) {
	items := make([]stable.CustomCalloutExtension, 0)

	resp, err := c.ListEntitlementManagementResourceRequestCatalogCustomWorkflowExtensions(ctx, id, options)
	if err != nil {
