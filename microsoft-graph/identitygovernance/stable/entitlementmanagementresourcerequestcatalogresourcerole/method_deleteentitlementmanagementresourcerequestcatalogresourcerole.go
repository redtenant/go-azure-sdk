...
type DeleteEntitlementManagementResourceRequestCatalogResourceRoleOperationResponse struct {
...
func DefaultDeleteEntitlementManagementResourceRequestCatalogResourceRoleOperationOptions() DeleteEntitlementManagementResourceRequestCatalogResourceRoleOperationOptions {
	return DeleteEntitlementManagementResourceRequestCatalogResourceRoleOperationOptions{}
}

func (o DeleteEntitlementManagementResourceRequestCatalogResourceRoleOperationOptions) ToHeaders() *client.Headers {
	out := client.Headers{}
	if o.IfMatch != nil {
...
func (o DeleteEntitlementManagementResourceRequestCatalogResourceRoleOperationOptions) ToQuery() *client.QueryParams {
