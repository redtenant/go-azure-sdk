...
type GetEntitlementManagementResourceRequestCatalogResourceRoleOperationResponse struct {
...
func DefaultGetEntitlementManagementResourceRequestCatalogResourceRoleOperationOptions() GetEntitlementManagementResourceRequestCatalogResourceRoleOperationOptions {
	return GetEntitlementManagementResourceRequestCatalogResourceRoleOperationOptions{}
}

func (o GetEntitlementManagementResourceRequestCatalogResourceRoleOperationOptions) ToHeaders() *client.Headers {
	out := client.Headers{}

	return &out
}

func (o GetEntitlementManagementResourceRequestCatalogResourceRoleOperationOptions) ToOData() *odata.Query {
	out := odata.Query{}
	if o.Expand != nil {
		out.Expand = *o.Expand
	}
...
func (o GetEntitlementManagementResourceRequestCatalogResourceRoleOperationOptions) ToQuery() *client.QueryParams {
