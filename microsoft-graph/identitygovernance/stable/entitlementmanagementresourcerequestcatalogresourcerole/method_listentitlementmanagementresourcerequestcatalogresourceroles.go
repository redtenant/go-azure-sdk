...
func DefaultListEntitlementManagementResourceRequestCatalogResourceRolesOperationOptions() ListEntitlementManagementResourceRequestCatalogResourceRolesOperationOptions {
	return ListEntitlementManagementResourceRequestCatalogResourceRolesOperationOptions{}
}

func (o ListEntitlementManagementResourceRequestCatalogResourceRolesOperationOptions) ToHeaders() *client.Headers {
	out := client.Headers{}

	return &out
}

func (o ListEntitlementManagementResourceRequestCatalogResourceRolesOperationOptions) ToOData() *odata.Query {
	out := odata.Query{}
	if o.Count != nil {
		out.Count = *o.Count
	}
...
func (o ListEntitlementManagementResourceRequestCatalogResourceRolesOperationOptions) ToQuery() *client.QueryParams {
