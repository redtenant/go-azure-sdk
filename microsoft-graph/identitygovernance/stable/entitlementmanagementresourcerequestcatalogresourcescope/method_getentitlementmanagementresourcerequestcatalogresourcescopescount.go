...
type GetEntitlementManagementResourceRequestCatalogResourceScopesCountOperationResponse struct {
...
func DefaultGetEntitlementManagementResourceRequestCatalogResourceScopesCountOperationOptions() GetEntitlementManagementResourceRequestCatalogResourceScopesCountOperationOptions {
	return GetEntitlementManagementResourceRequestCatalogResourceScopesCountOperationOptions{}
}

func (o GetEntitlementManagementResourceRequestCatalogResourceScopesCountOperationOptions) ToHeaders() *client.Headers {
	out := client.Headers{}

	return &out
}

func (o GetEntitlementManagementResourceRequestCatalogResourceScopesCountOperationOptions) ToOData() *odata.Query {
	out := odata.Query{}
	if o.Filter != nil {
		out.Filter = *o.Filter
	}
...
func (o GetEntitlementManagementResourceRequestCatalogResourceScopesCountOperationOptions) ToQuery() *client.QueryParams {
