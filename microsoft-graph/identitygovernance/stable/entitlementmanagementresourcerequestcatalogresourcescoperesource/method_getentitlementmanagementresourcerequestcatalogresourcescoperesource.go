...
type GetEntitlementManagementResourceRequestCatalogResourceScopeResourceOperationResponse struct {
...
func DefaultGetEntitlementManagementResourceRequestCatalogResourceScopeResourceOperationOptions() GetEntitlementManagementResourceRequestCatalogResourceScopeResourceOperationOptions {
	return GetEntitlementManagementResourceRequestCatalogResourceScopeResourceOperationOptions{}
}

func (o GetEntitlementManagementResourceRequestCatalogResourceScopeResourceOperationOptions) ToHeaders() *client.Headers {
	out := client.Headers{}

	return &out
}

func (o GetEntitlementManagementResourceRequestCatalogResourceScopeResourceOperationOptions) ToOData() *odata.Query {
	out := odata.Query{}
	if o.Expand != nil {
		out.Expand = *o.Expand
	}
...
func (o GetEntitlementManagementResourceRequestCatalogResourceScopeResourceOperationOptions) ToQuery() *client.QueryParams {
