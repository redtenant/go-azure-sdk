...
type GetEntitlementManagementResourceRequestCatalogResourceScopeResourceEnvironmentOperationResponse struct {
...
func DefaultGetEntitlementManagementResourceRequestCatalogResourceScopeResourceEnvironmentOperationOptions() GetEntitlementManagementResourceRequestCatalogResourceScopeResourceEnvironmentOperationOptions {
	return GetEntitlementManagementResourceRequestCatalogResourceScopeResourceEnvironmentOperationOptions{}
}

func (o GetEntitlementManagementResourceRequestCatalogResourceScopeResourceEnvironmentOperationOptions) ToHeaders() *client.Headers {
	out := client.Headers{}

	return &out
}

func (o GetEntitlementManagementResourceRequestCatalogResourceScopeResourceEnvironmentOperationOptions) ToOData() *odata.Query {
	out := odata.Query{}
	if o.Expand != nil {
		out.Expand = *o.Expand
	}
...
func (o GetEntitlementManagementResourceRequestCatalogResourceScopeResourceEnvironmentOperationOptions) ToQuery() *client.QueryParams {
