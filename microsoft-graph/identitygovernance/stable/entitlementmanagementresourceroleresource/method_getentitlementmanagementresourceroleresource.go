...
type GetEntitlementManagementResourceRoleResourceOperationResponse struct {
	HttpResponse *http.Response
	OData        *odata.OData
	Model        *stable.AccessPackageResource
}

type GetEntitlementManagementResourceRoleResourceOperationOptions struct {
	Expand    *odata.Expand
...
func DefaultGetEntitlementManagementResourceRoleResourceOperationOptions() GetEntitlementManagementResourceRoleResourceOperationOptions {
	return GetEntitlementManagementResourceRoleResourceOperationOptions{}
}
