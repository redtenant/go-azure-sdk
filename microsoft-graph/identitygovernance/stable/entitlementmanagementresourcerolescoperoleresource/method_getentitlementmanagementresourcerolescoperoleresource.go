...
type GetEntitlementManagementResourceRoleScopeRoleResourceOperationResponse struct {
	HttpResponse *http.Response
	OData        *odata.OData
	Model        *stable.AccessPackageResource
}

type GetEntitlementManagementResourceRoleScopeRoleResourceOperationOptions struct {
	Expand    *odata.Expand
...
func DefaultGetEntitlementManagementResourceRoleScopeRoleResourceOperationOptions() GetEntitlementManagementResourceRoleScopeRoleResourceOperationOptions {
	return GetEntitlementManagementResourceRoleScopeRoleResourceOperationOptions{}
}
