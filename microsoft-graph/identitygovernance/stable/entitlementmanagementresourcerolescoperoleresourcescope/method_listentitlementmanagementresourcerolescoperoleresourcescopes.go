...
func DefaultListEntitlementManagementResourceRoleScopeRoleResourceScopesOperationOptions() ListEntitlementManagementResourceRoleScopeRoleResourceScopesOperationOptions {
	return ListEntitlementManagementResourceRoleScopeRoleResourceScopesOperationOptions{}
}

func (o ListEntitlementManagementResourceRoleScopeRoleResourceScopesOperationOptions) ToHeaders() *client.Headers {
	out := client.Headers{}

	return &out
}

func (o ListEntitlementManagementResourceRoleScopeRoleResourceScopesOperationOptions) ToOData() *odata.Query {
	out := odata.Query{}
	if o.Count != nil {
		out.Count = *o.Count
	}
...
func (o ListEntitlementManagementResourceRoleScopeRoleResourceScopesOperationOptions) ToQuery() *client.QueryParams {
...
// ListEntitlementManagementResourceRoleScopeRoleResourceScopes - Get scopes from identityGovernance. Read-only.
// Nullable. Supports $expand.
func (c EntitlementManagementResourceRoleScopeRoleResourceScopeClient) ListEntitlementManagementResourceRoleScopeRoleResourceScopes(ctx context.Context, id stable.IdentityGovernanceEntitlementManagementResourceRoleScopeId, options ListEntitlementManagementResourceRoleScopeRoleResourceScopesOperationOptions) (result ListEntitlementManagementResourceRoleScopeRoleResourceScopesOperationResponse, err error) {
...
func (c EntitlementManagementResourceRoleScopeRoleResourceScopeClient) ListEntitlementManagementResourceRoleScopeRoleResourceScopesComplete(ctx context.Context, id stable.IdentityGovernanceEntitlementManagementResourceRoleScopeId, options ListEntitlementManagementResourceRoleScopeRoleResourceScopesOperationOptions) (ListEntitlementManagementResourceRoleScopeRoleResourceScopesCompleteResult, error) {
	return c.ListEntitlementManagementResourceRoleScopeRoleResourceScopesCompleteMatchingPredicate(ctx, id, options, AccessPackageResourceScopeOperationPredicate{})
}
...
func (c EntitlementManagementResourceRoleScopeRoleResourceScopeClient) ListEntitlementManagementResourceRoleScopeRoleResourceScopesCompleteMatchingPredicate(ctx context.Context, id stable.IdentityGovernanceEntitlementManagementResourceRoleScopeId, options ListEntitlementManagementResourceRoleScopeRoleResourceScopesOperationOptions, predicate AccessPackageResourceScopeOperationPredicate) (result ListEntitlementManagementResourceRoleScopeRoleResourceScopesCompleteResult, err error) {
	...
	resp, err := c.ListEntitlementManagementResourceRoleScopeRoleResourceScopes(ctx, id, options)
	if err != nil {
