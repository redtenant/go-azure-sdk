...
// Supports $expand.
func (c EntitlementManagementResourceRoleScopeScopeResourceRoleClient) GetEntitlementManagementResourceRoleScopeResourceRole(ctx context.Context, id stable.IdentityGovernanceEntitlementManagementResourceRoleScopeIdScopeResourceRoleId, options GetEntitlementManagementResourceRoleScopeResourceRoleOperationOptions) (result GetEntitlementManagementResourceRoleScopeResourceRoleOperationResponse, err error) {
