...
func (c EntitlementManagementResourceRoleScopeScopeResourceRoleResourceScopeClient) GetEntitlementManagementResourceRoleScopeResourceScopesCount(ctx context.Context, id stable.IdentityGovernanceEntitlementManagementResourceRoleScopeIdScopeResourceRoleId, options GetEntitlementManagementResourceRoleScopeResourceScopesCountOperationOptions) (result GetEntitlementManagementResourceRoleScopeResourceScopesCountOperationResponse, err error) {
