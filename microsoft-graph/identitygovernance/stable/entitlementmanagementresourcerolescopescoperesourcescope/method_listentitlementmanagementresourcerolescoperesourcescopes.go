...
// Supports $expand.
func (c EntitlementManagementResourceRoleScopeScopeResourceScopeClient) ListEntitlementManagementResourceRoleScopeResourceScopes(ctx context.Context, id stable.IdentityGovernanceEntitlementManagementResourceRoleScopeId, options ListEntitlementManagementResourceRoleScopeResourceScopesOperationOptions) (result ListEntitlementManagementResourceRoleScopeResourceScopesOperationResponse, err error) {
...
func (c EntitlementManagementResourceRoleScopeScopeResourceScopeClient) ListEntitlementManagementResourceRoleScopeResourceScopesComplete(ctx context.Context, id stable.IdentityGovernanceEntitlementManagementResourceRoleScopeId, options ListEntitlementManagementResourceRoleScopeResourceScopesOperationOptions) (ListEntitlementManagementResourceRoleScopeResourceScopesCompleteResult, error) {
...
func (c EntitlementManagementResourceRoleScopeScopeResourceScopeClient) ListEntitlementManagementResourceRoleScopeResourceScopesCompleteMatchingPredicate(ctx context.Context, id stable.IdentityGovernanceEntitlementManagementResourceRoleScopeId, options ListEntitlementManagementResourceRoleScopeResourceScopesOperationOptions, predicate AccessPackageResourceScopeOperationPredicate) (result ListEntitlementManagementResourceRoleScopeResourceScopesCompleteResult, err error) {
