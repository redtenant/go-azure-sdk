...
func (c EntitlementManagementSettingClient) UpdateEntitlementManagementSetting(ctx context.Context, input stable.EntitlementManagementSettings, options UpdateEntitlementManagementSettingOperationOptions) (result UpdateEntitlementManagementSettingOperationResponse, err error) {
