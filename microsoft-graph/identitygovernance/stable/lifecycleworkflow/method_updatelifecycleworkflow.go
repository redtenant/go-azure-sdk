...
func (c LifecycleWorkflowClient) UpdateLifecycleWorkflow(ctx context.Context, input stable.IdentityGovernanceLifecycleWorkflowsContainer, options UpdateLifecycleWorkflowOperationOptions) (result UpdateLifecycleWorkflowOperationResponse, err error) {
