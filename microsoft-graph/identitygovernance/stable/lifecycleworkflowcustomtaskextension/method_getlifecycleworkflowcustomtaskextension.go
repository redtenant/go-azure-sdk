...
func DefaultGetLifecycleWorkflowCustomTaskExtensionOperationOptions() GetLifecycleWorkflowCustomTaskExtensionOperationOptions {
	return GetLifecycleWorkflowCustomTaskExtensionOperationOptions{}
}
...
// GetLifecycleWorkflowCustomTaskExtension - Get customTaskExtension. Read the properties and relationships of a
// customTaskExtension object.
func (c LifecycleWorkflowCustomTaskExtensionClient) GetLifecycleWorkflowCustomTaskExtension(ctx context.Context, id stable.IdentityGovernanceLifecycleWorkflowCustomTaskExtensionId, options GetLifecycleWorkflowCustomTaskExtensionOperationOptions) (result GetLifecycleWorkflowCustomTaskExtensionOperationResponse, err error) {
