...
type GetLifecycleWorkflowCustomTaskExtensionLastModifiedByMailboxSettingOperationResponse struct {
	HttpResponse *http.Response
	OData        *odata.OData
	Model        *stable.MailboxSettings
}

type GetLifecycleWorkflowCustomTaskExtensionLastModifiedByMailboxSettingOperationOptions struct {
	Expand    *odata.Expand
...
func DefaultGetLifecycleWorkflowCustomTaskExtensionLastModifiedByMailboxSettingOperationOptions() GetLifecycleWorkflowCustomTaskExtensionLastModifiedByMailboxSettingOperationOptions {
	return GetLifecycleWorkflowCustomTaskExtensionLastModifiedByMailboxSettingOperationOptions{}
}
...
// GetLifecycleWorkflowCustomTaskExtensionLastModifiedByMailboxSetting - Get mailboxSettings property value. Settings
...
func (c LifecycleWorkflowCustomTaskExtensionLastModifiedByMailboxSettingClient) GetLifecycleWorkflowCustomTaskExtensionLastModifiedByMailboxSetting(ctx context.Context, id stable.IdentityGovernanceLifecycleWorkflowCustomTaskExtensionId, options GetLifecycleWorkflowCustomTaskExtensionLastModifiedByMailboxSettingOperationOptions) (result GetLifecycleWorkflowCustomTaskExtensionLastModifiedByMailboxSettingOperationResponse, err error) {
