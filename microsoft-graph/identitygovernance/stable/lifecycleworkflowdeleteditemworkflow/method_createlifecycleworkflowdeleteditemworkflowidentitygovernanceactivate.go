...
func (c LifecycleWorkflowDeletedItemWorkflowClient) CreateLifecycleWorkflowDeletedItemWorkflowIdentityGovernanceActivate(ctx context.Context, id stable.IdentityGovernanceLifecycleWorkflowDeletedItemWorkflowId, input CreateLifecycleWorkflowDeletedItemWorkflowIdentityGovernanceActivateRequest, options CreateLifecycleWorkflowDeletedItemWorkflowIdentityGovernanceActivateOperationOptions) (result CreateLifecycleWorkflowDeletedItemWorkflowIdentityGovernanceActivateOperationResponse, err error) {
