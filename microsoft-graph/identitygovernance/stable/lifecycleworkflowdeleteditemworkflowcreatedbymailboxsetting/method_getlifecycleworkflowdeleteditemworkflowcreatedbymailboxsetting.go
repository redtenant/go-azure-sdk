...
type GetLifecycleWorkflowDeletedItemWorkflowCreatedByMailboxSettingOperationResponse struct {
	HttpResponse *http.Response
	OData        *odata.OData
	Model        *stable.MailboxSettings
}

type GetLifecycleWorkflowDeletedItemWorkflowCreatedByMailboxSettingOperationOptions struct {
	Expand    *odata.Expand
...
func DefaultGetLifecycleWorkflowDeletedItemWorkflowCreatedByMailboxSettingOperationOptions() GetLifecycleWorkflowDeletedItemWorkflowCreatedByMailboxSettingOperationOptions {
	return GetLifecycleWorkflowDeletedItemWorkflowCreatedByMailboxSettingOperationOptions{}
}
...
// GetLifecycleWorkflowDeletedItemWorkflowCreatedByMailboxSetting - Get mailboxSettings property value. Settings for the
