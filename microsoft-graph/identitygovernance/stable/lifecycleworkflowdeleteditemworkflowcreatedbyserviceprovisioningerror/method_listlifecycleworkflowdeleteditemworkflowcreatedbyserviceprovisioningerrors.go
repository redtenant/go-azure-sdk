...
type ListLifecycleWorkflowDeletedItemWorkflowCreatedByServiceProvisioningErrorsOperationOptions struct {
	Count     *bool
	Expand    *odata.Expand
	Filter    *string
...
func DefaultListLifecycleWorkflowDeletedItemWorkflowCreatedByServiceProvisioningErrorsOperationOptions() ListLifecycleWorkflowDeletedItemWorkflowCreatedByServiceProvisioningErrorsOperationOptions {
	return ListLifecycleWorkflowDeletedItemWorkflowCreatedByServiceProvisioningErrorsOperationOptions{}
}

func (o ListLifecycleWorkflowDeletedItemWorkflowCreatedByServiceProvisioningErrorsOperationOptions) ToHeaders() *client.Headers {
	out := client.Headers{}

	return &out
}

func (o ListLifecycleWorkflowDeletedItemWorkflowCreatedByServiceProvisioningErrorsOperationOptions) ToOData() *odata.Query {
	out := odata.Query{}
	if o.Count != nil {
		out.Count = *o.Count
	}
...
func (o ListLifecycleWorkflowDeletedItemWorkflowCreatedByServiceProvisioningErrorsOperationOptions) ToQuery() *client.QueryParams {
...
// ListLifecycleWorkflowDeletedItemWorkflowCreatedByServiceProvisioningErrors - Get serviceProvisioningErrors property
...
func (c LifecycleWorkflowDeletedItemWorkflowCreatedByServiceProvisioningErrorClient) ListLifecycleWorkflowDeletedItemWorkflowCreatedByServiceProvisioningErrors(ctx context.Context, id stable.IdentityGovernanceLifecycleWorkflowDeletedItemWorkflowId, options ListLifecycleWorkflowDeletedItemWorkflowCreatedByServiceProvisioningErrorsOperationOptions) (result ListLifecycleWorkflowDeletedItemWorkflowCreatedByServiceProvisioningErrorsOperationResponse, err error) {
...
func (c LifecycleWorkflowDeletedItemWorkflowCreatedByServiceProvisioningErrorClient) ListLifecycleWorkflowDeletedItemWorkflowCreatedByServiceProvisioningErrorsComplete(ctx context.Context, id stable.IdentityGovernanceLifecycleWorkflowDeletedItemWorkflowId, options ListLifecycleWorkflowDeletedItemWorkflowCreatedByServiceProvisioningErrorsOperationOptions) (ListLifecycleWorkflowDeletedItemWorkflowCreatedByServiceProvisioningErrorsCompleteResult, error) {
	return c.ListLifecycleWorkflowDeletedItemWorkflowCreatedByServiceProvisioningErrorsCompleteMatchingPredicate(ctx, id, options, ServiceProvisioningErrorOperationPredicate{})
}
...
func (c LifecycleWorkflowDeletedItemWorkflowCreatedByServiceProvisioningErrorClient) ListLifecycleWorkflowDeletedItemWorkflowCreatedByServiceProvisioningErrorsCompleteMatchingPredicate(ctx context.Context, id stable.IdentityGovernanceLifecycleWorkflowDeletedItemWorkflowId, options ListLifecycleWorkflowDeletedItemWorkflowCreatedByServiceProvisioningErrorsOperationOptions, predicate ServiceProvisioningErrorOperationPredicate) (result ListLifecycleWorkflowDeletedItemWorkflowCreatedByServiceProvisioningErrorsCompleteResult, err error) {
	items := make([]stable.ServiceProvisioningError, 0)

	resp, err := c.ListLifecycleWorkflowDeletedItemWorkflowCreatedByServiceProvisioningErrors(ctx, id, options)
	if err != nil {
