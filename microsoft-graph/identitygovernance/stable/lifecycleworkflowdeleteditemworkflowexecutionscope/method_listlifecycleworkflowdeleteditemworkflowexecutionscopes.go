...
func (c LifecycleWorkflowDeletedItemWorkflowExecutionScopeClient) ListLifecycleWorkflowDeletedItemWorkflowExecutionScopes(ctx context.Context, id stable.IdentityGovernanceLifecycleWorkflowDeletedItemWorkflowId, options ListLifecycleWorkflowDeletedItemWorkflowExecutionScopesOperationOptions) (result ListLifecycleWorkflowDeletedItemWorkflowExecutionScopesOperationResponse, err error) {
...
func (c LifecycleWorkflowDeletedItemWorkflowExecutionScopeClient) ListLifecycleWorkflowDeletedItemWorkflowExecutionScopesCompleteMatchingPredicate(ctx context.Context, id stable.IdentityGovernanceLifecycleWorkflowDeletedItemWorkflowId, options ListLifecycleWorkflowDeletedItemWorkflowExecutionScopesOperationOptions, predicate IdentityGovernanceUserProcessingResultOperationPredicate) (result ListLifecycleWorkflowDeletedItemWorkflowExecutionScopesCompleteResult, err error) {
