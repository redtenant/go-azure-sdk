...
type GetLifecycleWorkflowDeletedItemWorkflowLastModifiedByMailboxSettingOperationResponse struct {
	HttpResponse *http.Response
	OData        *odata.OData
	Model        *stable.MailboxSettings
}

type GetLifecycleWorkflowDeletedItemWorkflowLastModifiedByMailboxSettingOperationOptions struct {
	Expand    *odata.Expand
...
func DefaultGetLifecycleWorkflowDeletedItemWorkflowLastModifiedByMailboxSettingOperationOptions() GetLifecycleWorkflowDeletedItemWorkflowLastModifiedByMailboxSettingOperationOptions {
	return GetLifecycleWorkflowDeletedItemWorkflowLastModifiedByMailboxSettingOperationOptions{}
}
...
// GetLifecycleWorkflowDeletedItemWorkflowLastModifiedByMailboxSetting - Get mailboxSettings property value. Settings
