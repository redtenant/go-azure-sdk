...
type UpdateLifecycleWorkflowDeletedItemWorkflowLastModifiedByMailboxSettingOperationResponse struct {
	HttpResponse *http.Response
	OData        *odata.OData
}

type UpdateLifecycleWorkflowDeletedItemWorkflowLastModifiedByMailboxSettingOperationOptions struct {
...
func DefaultUpdateLifecycleWorkflowDeletedItemWorkflowLastModifiedByMailboxSettingOperationOptions() UpdateLifecycleWorkflowDeletedItemWorkflowLastModifiedByMailboxSettingOperationOptions {
	return UpdateLifecycleWorkflowDeletedItemWorkflowLastModifiedByMailboxSettingOperationOptions{}
}
...
func (c LifecycleWorkflowDeletedItemWorkflowLastModifiedByMailboxSettingClient) UpdateLifecycleWorkflowDeletedItemWorkflowLastModifiedByMailboxSetting(ctx context.Context, id stable.IdentityGovernanceLifecycleWorkflowDeletedItemWorkflowId, input stable.MailboxSettings, options UpdateLifecycleWorkflowDeletedItemWorkflowLastModifiedByMailboxSettingOperationOptions) (result UpdateLifecycleWorkflowDeletedItemWorkflowLastModifiedByMailboxSettingOperationResponse, err error) {
