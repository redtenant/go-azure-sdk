...
func (c LifecycleWorkflowDeletedItemWorkflowRunClient) ListLifecycleWorkflowDeletedItemWorkflowRunsComplete(ctx context.Context, id stable.IdentityGovernanceLifecycleWorkflowDeletedItemWorkflowId, options ListLifecycleWorkflowDeletedItemWorkflowRunsOperationOptions) (ListLifecycleWorkflowDeletedItemWorkflowRunsCompleteResult, error) {
