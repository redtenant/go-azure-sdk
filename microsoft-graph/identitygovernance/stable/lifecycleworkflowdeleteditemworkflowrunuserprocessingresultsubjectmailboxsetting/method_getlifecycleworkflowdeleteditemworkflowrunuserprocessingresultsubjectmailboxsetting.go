...
type GetLifecycleWorkflowDeletedItemWorkflowRunUserProcessingResultSubjectMailboxSettingOperationResponse struct {
	HttpResponse *http.Response
	OData        *odata.OData
	Model        *stable.MailboxSettings
}

type GetLifecycleWorkflowDeletedItemWorkflowRunUserProcessingResultSubjectMailboxSettingOperationOptions struct {
	Expand    *odata.Expand
...
func DefaultGetLifecycleWorkflowDeletedItemWorkflowRunUserProcessingResultSubjectMailboxSettingOperationOptions() GetLifecycleWorkflowDeletedItemWorkflowRunUserProcessingResultSubjectMailboxSettingOperationOptions {
	return GetLifecycleWorkflowDeletedItemWorkflowRunUserProcessingResultSubjectMailboxSettingOperationOptions{}
}
...
// GetLifecycleWorkflowDeletedItemWorkflowRunUserProcessingResultSubjectMailboxSetting - Get mailboxSettings property
