...
type UpdateLifecycleWorkflowDeletedItemWorkflowRunUserProcessingResultSubjectMailboxSettingOperationResponse struct {
	HttpResponse *http.Response
	OData        *odata.OData
}

type UpdateLifecycleWorkflowDeletedItemWorkflowRunUserProcessingResultSubjectMailboxSettingOperationOptions struct {
...
func DefaultUpdateLifecycleWorkflowDeletedItemWorkflowRunUserProcessingResultSubjectMailboxSettingOperationOptions() UpdateLifecycleWorkflowDeletedItemWorkflowRunUserProcessingResultSubjectMailboxSettingOperationOptions {
	return UpdateLifecycleWorkflowDeletedItemWorkflowRunUserProcessingResultSubjectMailboxSettingOperationOptions{}
}
...
// UpdateLifecycleWorkflowDeletedItemWorkflowRunUserProcessingResultSubjectMailboxSetting - Update property
// mailboxSettings value.
func (c LifecycleWorkflowDeletedItemWorkflowRunUserProcessingResultSubjectMailboxSettingClient) UpdateLifecycleWorkflowDeletedItemWorkflowRunUserProcessingResultSubjectMailboxSetting(ctx context.Context, id stable.IdentityGovernanceLifecycleWorkflowDeletedItemWorkflowIdRunIdUserProcessingResultId, input stable.MailboxSettings, options UpdateLifecycleWorkflowDeletedItemWorkflowRunUserProcessingResultSubjectMailboxSettingOperationOptions) (result UpdateLifecycleWorkflowDeletedItemWorkflowRunUserProcessingResultSubjectMailboxSettingOperationResponse, err error) {
