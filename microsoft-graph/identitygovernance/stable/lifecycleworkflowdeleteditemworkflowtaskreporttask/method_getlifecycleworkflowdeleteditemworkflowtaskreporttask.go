...
func (c LifecycleWorkflowDeletedItemWorkflowTaskReportTaskClient) GetLifecycleWorkflowDeletedItemWorkflowTaskReportTask(ctx context.Context, id stable.IdentityGovernanceLifecycleWorkflowDeletedItemWorkflowIdTaskReportId, options GetLifecycleWorkflowDeletedItemWorkflowTaskReportTaskOperationOptions) (result GetLifecycleWorkflowDeletedItemWorkflowTaskReportTaskOperationResponse, err error) {
