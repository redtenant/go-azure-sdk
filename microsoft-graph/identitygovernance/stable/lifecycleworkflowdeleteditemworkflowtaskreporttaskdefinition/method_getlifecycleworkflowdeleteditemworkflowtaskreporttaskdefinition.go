...
func (c LifecycleWorkflowDeletedItemWorkflowTaskReportTaskDefinitionClient) GetLifecycleWorkflowDeletedItemWorkflowTaskReportTaskDefinition(ctx context.Context, id stable.IdentityGovernanceLifecycleWorkflowDeletedItemWorkflowIdTaskReportId, options GetLifecycleWorkflowDeletedItemWorkflowTaskReportTaskDefinitionOperationOptions) (result GetLifecycleWorkflowDeletedItemWorkflowTaskReportTaskDefinitionOperationResponse, err error) {
