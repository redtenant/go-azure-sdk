...
type ListLifecycleWorkflowDeletedItemWorkflowTaskReportTaskProcessingResultsOperationOptions struct {
	Count     *bool
	Expand    *odata.Expand
	Filter    *string
...
func DefaultListLifecycleWorkflowDeletedItemWorkflowTaskReportTaskProcessingResultsOperationOptions() ListLifecycleWorkflowDeletedItemWorkflowTaskReportTaskProcessingResultsOperationOptions {
	return ListLifecycleWorkflowDeletedItemWorkflowTaskReportTaskProcessingResultsOperationOptions{}
}

func (o ListLifecycleWorkflowDeletedItemWorkflowTaskReportTaskProcessingResultsOperationOptions) ToHeaders() *client.Headers {
	out := client.Headers{}

	return &out
}

func (o ListLifecycleWorkflowDeletedItemWorkflowTaskReportTaskProcessingResultsOperationOptions) ToOData() *odata.Query {
	out := odata.Query{}
	if o.Count != nil {
		out.Count = *o.Count
	}
...
func (o ListLifecycleWorkflowDeletedItemWorkflowTaskReportTaskProcessingResultsOperationOptions) ToQuery() *client.QueryParams {
...
func (c LifecycleWorkflowDeletedItemWorkflowTaskReportTaskProcessingResultClient) ListLifecycleWorkflowDeletedItemWorkflowTaskReportTaskProcessingResultsComplete(ctx context.Context, id stable.IdentityGovernanceLifecycleWorkflowDeletedItemWorkflowIdTaskReportId, options ListLifecycleWorkflowDeletedItemWorkflowTaskReportTaskProcessingResultsOperationOptions) (ListLifecycleWorkflowDeletedItemWorkflowTaskReportTaskProcessingResultsCompleteResult, error) {
	return c.ListLifecycleWorkflowDeletedItemWorkflowTaskReportTaskProcessingResultsCompleteMatchingPredicate(ctx, id, options, IdentityGovernanceTaskProcessingResultOperationPredicate{})
}
...
func (c LifecycleWorkflowDeletedItemWorkflowTaskReportTaskProcessingResultClient) ListLifecycleWorkflowDeletedItemWorkflowTaskReportTaskProcessingResultsCompleteMatchingPredicate(ctx context.Context, id stable.IdentityGovernanceLifecycleWorkflowDeletedItemWorkflowIdTaskReportId, options ListLifecycleWorkflowDeletedItemWorkflowTaskReportTaskProcessingResultsOperationOptions, predicate IdentityGovernanceTaskProcessingResultOperationPredicate) (result ListLifecycleWorkflowDeletedItemWorkflowTaskReportTaskProcessingResultsCompleteResult, err error) {
	...
	resp, err := c.ListLifecycleWorkflowDeletedItemWorkflowTaskReportTaskProcessingResults(ctx, id, options)
	if err != nil {
