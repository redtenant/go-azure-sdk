...
type GetLifecycleWorkflowDeletedItemWorkflowVersionOperationResponse struct {
	HttpResponse *http.Response
	OData        *odata.OData
	Model        *stable.IdentityGovernanceWorkflowVersion
}

type GetLifecycleWorkflowDeletedItemWorkflowVersionOperationOptions struct {
	Expand    *odata.Expand
...
func DefaultGetLifecycleWorkflowDeletedItemWorkflowVersionOperationOptions() GetLifecycleWorkflowDeletedItemWorkflowVersionOperationOptions {
	return GetLifecycleWorkflowDeletedItemWorkflowVersionOperationOptions{}
}
...
// GetLifecycleWorkflowDeletedItemWorkflowVersion - Get versions from identityGovernance. The workflow versions that are
// available.
func (c LifecycleWorkflowDeletedItemWorkflowVersionClient) GetLifecycleWorkflowDeletedItemWorkflowVersion(ctx context.Context, id stable.IdentityGovernanceLifecycleWorkflowDeletedItemWorkflowIdVersionId, options GetLifecycleWorkflowDeletedItemWorkflowVersionOperationOptions) (result GetLifecycleWorkflowDeletedItemWorkflowVersionOperationResponse, err error) {
