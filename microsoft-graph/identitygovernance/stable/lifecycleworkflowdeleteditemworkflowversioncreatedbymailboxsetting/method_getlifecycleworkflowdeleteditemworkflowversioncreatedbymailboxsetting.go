...
type GetLifecycleWorkflowDeletedItemWorkflowVersionCreatedByMailboxSettingOperationResponse struct {
	HttpResponse *http.Response
	OData        *odata.OData
	Model        *stable.MailboxSettings
}

type GetLifecycleWorkflowDeletedItemWorkflowVersionCreatedByMailboxSettingOperationOptions struct {
	Expand    *odata.Expand
...
func DefaultGetLifecycleWorkflowDeletedItemWorkflowVersionCreatedByMailboxSettingOperationOptions() GetLifecycleWorkflowDeletedItemWorkflowVersionCreatedByMailboxSettingOperationOptions {
	return GetLifecycleWorkflowDeletedItemWorkflowVersionCreatedByMailboxSettingOperationOptions{}
}
...
// GetLifecycleWorkflowDeletedItemWorkflowVersionCreatedByMailboxSetting - Get mailboxSettings property value. Settings
...
func (c LifecycleWorkflowDeletedItemWorkflowVersionCreatedByMailboxSettingClient) GetLifecycleWorkflowDeletedItemWorkflowVersionCreatedByMailboxSetting(ctx context.Context, id stable.IdentityGovernanceLifecycleWorkflowDeletedItemWorkflowIdVersionId, options GetLifecycleWorkflowDeletedItemWorkflowVersionCreatedByMailboxSettingOperationOptions) (result GetLifecycleWorkflowDeletedItemWorkflowVersionCreatedByMailboxSettingOperationResponse, err error) {
