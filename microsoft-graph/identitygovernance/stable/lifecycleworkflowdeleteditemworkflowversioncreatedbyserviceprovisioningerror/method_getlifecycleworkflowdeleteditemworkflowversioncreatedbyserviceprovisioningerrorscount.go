...
// resource
func (c LifecycleWorkflowDeletedItemWorkflowVersionCreatedByServiceProvisioningErrorClient) GetLifecycleWorkflowDeletedItemWorkflowVersionCreatedByServiceProvisioningErrorsCount(ctx context.Context, id stable.IdentityGovernanceLifecycleWorkflowDeletedItemWorkflowIdVersionId, options GetLifecycleWorkflowDeletedItemWorkflowVersionCreatedByServiceProvisioningErrorsCountOperationOptions) (result GetLifecycleWorkflowDeletedItemWorkflowVersionCreatedByServiceProvisioningErrorsCountOperationResponse, err error) {
