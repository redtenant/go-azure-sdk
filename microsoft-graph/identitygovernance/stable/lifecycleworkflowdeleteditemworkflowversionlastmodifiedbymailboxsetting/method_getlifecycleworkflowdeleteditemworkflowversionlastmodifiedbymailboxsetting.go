...
type GetLifecycleWorkflowDeletedItemWorkflowVersionLastModifiedByMailboxSettingOperationResponse struct {
	HttpResponse *http.Response
	OData        *odata.OData
	Model        *stable.MailboxSettings
}

type GetLifecycleWorkflowDeletedItemWorkflowVersionLastModifiedByMailboxSettingOperationOptions struct {
	Expand    *odata.Expand
...
func DefaultGetLifecycleWorkflowDeletedItemWorkflowVersionLastModifiedByMailboxSettingOperationOptions() GetLifecycleWorkflowDeletedItemWorkflowVersionLastModifiedByMailboxSettingOperationOptions {
	return GetLifecycleWorkflowDeletedItemWorkflowVersionLastModifiedByMailboxSettingOperationOptions{}
}
...
// GetLifecycleWorkflowDeletedItemWorkflowVersionLastModifiedByMailboxSetting - Get mailboxSettings property value.
