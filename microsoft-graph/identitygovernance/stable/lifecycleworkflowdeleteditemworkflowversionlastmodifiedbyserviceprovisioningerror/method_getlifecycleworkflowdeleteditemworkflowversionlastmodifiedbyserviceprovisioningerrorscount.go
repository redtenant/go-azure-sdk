...
// resource
func (c LifecycleWorkflowDeletedItemWorkflowVersionLastModifiedByServiceProvisioningErrorClient) GetLifecycleWorkflowDeletedItemWorkflowVersionLastModifiedByServiceProvisioningErrorsCount(ctx context.Context, id stable.IdentityGovernanceLifecycleWorkflowDeletedItemWorkflowIdVersionId, options GetLifecycleWorkflowDeletedItemWorkflowVersionLastModifiedByServiceProvisioningErrorsCountOperationOptions) (result GetLifecycleWorkflowDeletedItemWorkflowVersionLastModifiedByServiceProvisioningErrorsCountOperationResponse, err error) {
