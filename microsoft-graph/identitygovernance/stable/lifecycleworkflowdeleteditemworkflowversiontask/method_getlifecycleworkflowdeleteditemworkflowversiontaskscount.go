...
func (c LifecycleWorkflowDeletedItemWorkflowVersionTaskClient) GetLifecycleWorkflowDeletedItemWorkflowVersionTasksCount(ctx context.Context, id stable.IdentityGovernanceLifecycleWorkflowDeletedItemWorkflowIdVersionId, options GetLifecycleWorkflowDeletedItemWorkflowVersionTasksCountOperationOptions) (result GetLifecycleWorkflowDeletedItemWorkflowVersionTasksCountOperationResponse, err error) {
