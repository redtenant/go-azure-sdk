...
type GetLifecycleWorkflowSettingOperationResponse struct {
	HttpResponse *http.Response
	OData        *odata.OData
	Model        *stable.IdentityGovernanceLifecycleManagementSettings
}

type GetLifecycleWorkflowSettingOperationOptions struct {
	Expand    *odata.Expand
...
func DefaultGetLifecycleWorkflowSettingOperationOptions() GetLifecycleWorkflowSettingOperationOptions {
	return GetLifecycleWorkflowSettingOperationOptions{}
}
...
// GetLifecycleWorkflowSetting - Get lifecycleManagementSettings. Read the properties and relationships of a
...
func (c LifecycleWorkflowSettingClient) GetLifecycleWorkflowSetting(ctx context.Context, options GetLifecycleWorkflowSettingOperationOptions) (result GetLifecycleWorkflowSettingOperationResponse, err error) {
	...
	var model stable.IdentityGovernanceLifecycleManagementSettings
	result.Model = &model
