...
type GetLifecycleWorkflowCreatedByServiceProvisioningErrorsCountOperationResponse struct {
	HttpResponse *http.Response
	OData        *odata.OData
	Model        *[]byte
}

type GetLifecycleWorkflowCreatedByServiceProvisioningErrorsCountOperationOptions struct {
	Filter    *string
...
func DefaultGetLifecycleWorkflowCreatedByServiceProvisioningErrorsCountOperationOptions() GetLifecycleWorkflowCreatedByServiceProvisioningErrorsCountOperationOptions {
	return GetLifecycleWorkflowCreatedByServiceProvisioningErrorsCountOperationOptions{}
}
...
func (c LifecycleWorkflowWorkflowCreatedByServiceProvisioningErrorClient) GetLifecycleWorkflowCreatedByServiceProvisioningErrorsCount(ctx context.Context, id stable.IdentityGovernanceLifecycleWorkflowWorkflowId, options GetLifecycleWorkflowCreatedByServiceProvisioningErrorsCountOperationOptions) (result GetLifecycleWorkflowCreatedByServiceProvisioningErrorsCountOperationResponse, err error) {
