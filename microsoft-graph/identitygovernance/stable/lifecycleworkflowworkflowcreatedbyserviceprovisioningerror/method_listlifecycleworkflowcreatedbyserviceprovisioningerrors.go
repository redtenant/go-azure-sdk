...
func (c LifecycleWorkflowWorkflowCreatedByServiceProvisioningErrorClient) ListLifecycleWorkflowCreatedByServiceProvisioningErrors(ctx context.Context, id stable.IdentityGovernanceLifecycleWorkflowWorkflowId, options ListLifecycleWorkflowCreatedByServiceProvisioningErrorsOperationOptions) (result ListLifecycleWorkflowCreatedByServiceProvisioningErrorsOperationResponse, err error) {
...
func (c LifecycleWorkflowWorkflowCreatedByServiceProvisioningErrorClient) ListLifecycleWorkflowCreatedByServiceProvisioningErrorsComplete(ctx context.Context, id stable.IdentityGovernanceLifecycleWorkflowWorkflowId, options ListLifecycleWorkflowCreatedByServiceProvisioningErrorsOperationOptions) (ListLifecycleWorkflowCreatedByServiceProvisioningErrorsCompleteResult, error) {
