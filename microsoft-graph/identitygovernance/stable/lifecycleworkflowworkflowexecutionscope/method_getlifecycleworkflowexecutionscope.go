...
func (c LifecycleWorkflowWorkflowExecutionScopeClient) GetLifecycleWorkflowExecutionScope(ctx context.Context, id stable.IdentityGovernanceLifecycleWorkflowWorkflowIdExecutionScopeId, options GetLifecycleWorkflowExecutionScopeOperationOptions) (result GetLifecycleWorkflowExecutionScopeOperationResponse, err error) {
