...
func (c LifecycleWorkflowWorkflowExecutionScopeClient) GetLifecycleWorkflowExecutionScopeCount(ctx context.Context, id stable.IdentityGovernanceLifecycleWorkflowWorkflowId, options GetLifecycleWorkflowExecutionScopeCountOperationOptions) (result GetLifecycleWorkflowExecutionScopeCountOperationResponse, err error) {
