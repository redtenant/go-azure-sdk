...
func (c LifecycleWorkflowWorkflowExecutionScopeClient) ListLifecycleWorkflowExecutionScopes(ctx context.Context, id stable.IdentityGovernanceLifecycleWorkflowWorkflowId, options ListLifecycleWorkflowExecutionScopesOperationOptions) (result ListLifecycleWorkflowExecutionScopesOperationResponse, err error) {
...
func (c LifecycleWorkflowWorkflowExecutionScopeClient) ListLifecycleWorkflowExecutionScopesComplete(ctx context.Context, id stable.IdentityGovernanceLifecycleWorkflowWorkflowId, options ListLifecycleWorkflowExecutionScopesOperationOptions) (ListLifecycleWorkflowExecutionScopesCompleteResult, error) {
...
func (c LifecycleWorkflowWorkflowExecutionScopeClient) ListLifecycleWorkflowExecutionScopesCompleteMatchingPredicate(ctx context.Context, id stable.IdentityGovernanceLifecycleWorkflowWorkflowId, options ListLifecycleWorkflowExecutionScopesOperationOptions, predicate IdentityGovernanceUserProcessingResultOperationPredicate) (result ListLifecycleWorkflowExecutionScopesCompleteResult, err error) {
