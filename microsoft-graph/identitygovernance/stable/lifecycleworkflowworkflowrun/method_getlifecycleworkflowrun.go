...
func (c LifecycleWorkflowWorkflowRunClient) GetLifecycleWorkflowRun(ctx context.Context, id stable.IdentityGovernanceLifecycleWorkflowWorkflowIdRunId, options GetLifecycleWorkflowRunOperationOptions) (result GetLifecycleWorkflowRunOperationResponse, err error) {
