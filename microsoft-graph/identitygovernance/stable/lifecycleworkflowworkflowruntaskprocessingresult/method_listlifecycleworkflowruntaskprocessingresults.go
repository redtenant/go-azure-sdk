...
func (c LifecycleWorkflowWorkflowRunTaskProcessingResultClient) ListLifecycleWorkflowRunTaskProcessingResultsComplete(ctx context.Context, id stable.IdentityGovernanceLifecycleWorkflowWorkflowIdRunId, options ListLifecycleWorkflowRunTaskProcessingResultsOperationOptions) (ListLifecycleWorkflowRunTaskProcessingResultsCompleteResult, error) {
...
func (c LifecycleWorkflowWorkflowRunTaskProcessingResultClient) ListLifecycleWorkflowRunTaskProcessingResultsCompleteMatchingPredicate(ctx context.Context, id stable.IdentityGovernanceLifecycleWorkflowWorkflowIdRunId, options ListLifecycleWorkflowRunTaskProcessingResultsOperationOptions, predicate IdentityGovernanceTaskProcessingResultOperationPredicate) (result ListLifecycleWorkflowRunTaskProcessingResultsCompleteResult, err error) {
