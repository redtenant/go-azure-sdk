...
func (c LifecycleWorkflowWorkflowRunTaskProcessingResultTaskClient) GetLifecycleWorkflowRunTaskProcessingResultTask(ctx context.Context, id stable.IdentityGovernanceLifecycleWorkflowWorkflowIdRunIdTaskProcessingResultId, options GetLifecycleWorkflowRunTaskProcessingResultTaskOperationOptions) (result GetLifecycleWorkflowRunTaskProcessingResultTaskOperationResponse, err error) {
