...
func (c LifecycleWorkflowWorkflowTaskClient) DeleteLifecycleWorkflowTask(ctx context.Context, id stable.IdentityGovernanceLifecycleWorkflowWorkflowIdTaskId, options DeleteLifecycleWorkflowTaskOperationOptions) (result DeleteLifecycleWorkflowTaskOperationResponse, err error) {
