...
func (c LifecycleWorkflowWorkflowTaskReportTaskClient) GetLifecycleWorkflowTaskReportTask(ctx context.Context, id stable.IdentityGovernanceLifecycleWorkflowWorkflowIdTaskReportId, options GetLifecycleWorkflowTaskReportTaskOperationOptions) (result GetLifecycleWorkflowTaskReportTaskOperationResponse, err error) {
