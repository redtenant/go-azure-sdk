...
func (c LifecycleWorkflowWorkflowTaskReportTaskProcessingResultSubjectClient) GetLifecycleWorkflowTaskReportTaskProcessingResultSubject(ctx context.Context, id stable.IdentityGovernanceLifecycleWorkflowWorkflowIdTaskReportIdTaskProcessingResultId, options GetLifecycleWorkflowTaskReportTaskProcessingResultSubjectOperationOptions) (result GetLifecycleWorkflowTaskReportTaskProcessingResultSubjectOperationResponse, err error) {
