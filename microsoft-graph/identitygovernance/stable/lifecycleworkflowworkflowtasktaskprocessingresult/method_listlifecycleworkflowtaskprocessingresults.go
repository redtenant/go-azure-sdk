...
// processing the task.
func (c LifecycleWorkflowWorkflowTaskTaskProcessingResultClient) ListLifecycleWorkflowTaskProcessingResults(ctx context.Context, id stable.IdentityGovernanceLifecycleWorkflowWorkflowIdTaskId, options ListLifecycleWorkflowTaskProcessingResultsOperationOptions) (result ListLifecycleWorkflowTaskProcessingResultsOperationResponse, err error) {
...
func (c LifecycleWorkflowWorkflowTaskTaskProcessingResultClient) ListLifecycleWorkflowTaskProcessingResultsComplete(ctx context.Context, id stable.IdentityGovernanceLifecycleWorkflowWorkflowIdTaskId, options ListLifecycleWorkflowTaskProcessingResultsOperationOptions) (ListLifecycleWorkflowTaskProcessingResultsCompleteResult, error) {
...
func (c LifecycleWorkflowWorkflowTaskTaskProcessingResultClient) ListLifecycleWorkflowTaskProcessingResultsCompleteMatchingPredicate(ctx context.Context, id stable.IdentityGovernanceLifecycleWorkflowWorkflowIdTaskId, options ListLifecycleWorkflowTaskProcessingResultsOperationOptions, predicate IdentityGovernanceTaskProcessingResultOperationPredicate) (result ListLifecycleWorkflowTaskProcessingResultsCompleteResult, err error) {
