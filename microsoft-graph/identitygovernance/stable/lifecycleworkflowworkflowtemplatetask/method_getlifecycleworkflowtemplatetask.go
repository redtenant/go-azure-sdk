...
func (c LifecycleWorkflowWorkflowTemplateTaskClient) GetLifecycleWorkflowTemplateTask(ctx context.Context, id stable.IdentityGovernanceLifecycleWorkflowWorkflowTemplateIdTaskId, options GetLifecycleWorkflowTemplateTaskOperationOptions) (result GetLifecycleWorkflowTemplateTaskOperationResponse, err error) {
