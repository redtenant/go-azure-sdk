...
func (c LifecycleWorkflowWorkflowTemplateTaskClient) GetLifecycleWorkflowTemplateTasksCount(ctx context.Context, id stable.IdentityGovernanceLifecycleWorkflowWorkflowTemplateId, options GetLifecycleWorkflowTemplateTasksCountOperationOptions) (result GetLifecycleWorkflowTemplateTasksCountOperationResponse, err error) {
