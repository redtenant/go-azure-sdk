...
func (c LifecycleWorkflowWorkflowTemplateTaskTaskProcessingResultSubjectMailboxSettingClient) UpdateLifecycleWorkflowTemplateTaskProcessingResultSubjectMailboxSetting(ctx context.Context, id stable.IdentityGovernanceLifecycleWorkflowWorkflowTemplateIdTaskIdTaskProcessingResultId, input stable.MailboxSettings, options UpdateLifecycleWorkflowTemplateTaskProcessingResultSubjectMailboxSettingOperationOptions) (result UpdateLifecycleWorkflowTemplateTaskProcessingResultSubjectMailboxSettingOperationResponse, err error) {
