...
// execution results.
func (c LifecycleWorkflowWorkflowUserProcessingResultClient) GetLifecycleWorkflowUserProcessingResult(ctx context.Context, id stable.IdentityGovernanceLifecycleWorkflowWorkflowIdUserProcessingResultId, options GetLifecycleWorkflowUserProcessingResultOperationOptions) (result GetLifecycleWorkflowUserProcessingResultOperationResponse, err error) {
