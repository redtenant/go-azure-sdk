...
func DefaultCreateLifecycleWorkflowUserProcessingResultTaskIdentityGovernanceResumeOperationOptions() CreateLifecycleWorkflowUserProcessingResultTaskIdentityGovernanceResumeOperationOptions {
	return CreateLifecycleWorkflowUserProcessingResultTaskIdentityGovernanceResumeOperationOptions{}
}
...
// CreateLifecycleWorkflowUserProcessingResultTaskIdentityGovernanceResume - Invoke action resume. Resume a task
...
func (c LifecycleWorkflowWorkflowUserProcessingResultTaskProcessingResultClient) CreateLifecycleWorkflowUserProcessingResultTaskIdentityGovernanceResume(ctx context.Context, id stable.IdentityGovernanceLifecycleWorkflowWorkflowIdUserProcessingResultIdTaskProcessingResultId, input CreateLifecycleWorkflowUserProcessingResultTaskIdentityGovernanceResumeRequest, options CreateLifecycleWorkflowUserProcessingResultTaskIdentityGovernanceResumeOperationOptions) (result CreateLifecycleWorkflowUserProcessingResultTaskIdentityGovernanceResumeOperationResponse, err error) {
