...
func (c LifecycleWorkflowWorkflowUserProcessingResultTaskProcessingResultSubjectMailboxSettingClient) UpdateLifecycleWorkflowUserProcessingResultTaskSubjectMailboxSetting(ctx context.Context, id stable.IdentityGovernanceLifecycleWorkflowWorkflowIdUserProcessingResultIdTaskProcessingResultId, input stable.MailboxSettings, options UpdateLifecycleWorkflowUserProcessingResultTaskSubjectMailboxSettingOperationOptions) (result UpdateLifecycleWorkflowUserProcessingResultTaskSubjectMailboxSettingOperationResponse, err error) {
