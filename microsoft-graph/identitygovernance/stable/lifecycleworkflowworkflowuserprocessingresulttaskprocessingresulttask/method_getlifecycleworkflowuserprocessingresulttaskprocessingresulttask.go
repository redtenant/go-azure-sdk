...
// workflow task
func (c LifecycleWorkflowWorkflowUserProcessingResultTaskProcessingResultTaskClient) GetLifecycleWorkflowUserProcessingResultTaskProcessingResultTask(ctx context.Context, id stable.IdentityGovernanceLifecycleWorkflowWorkflowIdUserProcessingResultIdTaskProcessingResultId, options GetLifecycleWorkflowUserProcessingResultTaskProcessingResultTaskOperationOptions) (result GetLifecycleWorkflowUserProcessingResultTaskProcessingResultTaskOperationResponse, err error) {
