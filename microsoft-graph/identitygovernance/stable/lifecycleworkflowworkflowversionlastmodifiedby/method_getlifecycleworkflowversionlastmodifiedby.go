...
// GetLifecycleWorkflowVersionLastModifiedBy - Get lastModifiedBy from identityGovernance. The unique identifier of the
// Microsoft Entra identity that last modified the workflow.
func (c LifecycleWorkflowWorkflowVersionLastModifiedByClient) GetLifecycleWorkflowVersionLastModifiedBy(ctx context.Context, id stable.IdentityGovernanceLifecycleWorkflowWorkflowIdVersionId, options GetLifecycleWorkflowVersionLastModifiedByOperationOptions) (result GetLifecycleWorkflowVersionLastModifiedByOperationResponse, err error) {
