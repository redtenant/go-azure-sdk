...
type GetLifecycleWorkflowVersionLastModifiedByMailboxSettingOperationResponse struct {
	HttpResponse *http.Response
	OData        *odata.OData
	Model        *stable.MailboxSettings
}

type GetLifecycleWorkflowVersionLastModifiedByMailboxSettingOperationOptions struct {
	Expand    *odata.Expand
...
func DefaultGetLifecycleWorkflowVersionLastModifiedByMailboxSettingOperationOptions() GetLifecycleWorkflowVersionLastModifiedByMailboxSettingOperationOptions {
	return GetLifecycleWorkflowVersionLastModifiedByMailboxSettingOperationOptions{}
}
...
// GetLifecycleWorkflowVersionLastModifiedByMailboxSetting - Get mailboxSettings property value. Settings for the
