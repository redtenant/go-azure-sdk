...
func (c LifecycleWorkflowWorkflowVersionTaskClient) CreateLifecycleWorkflowVersionTask(ctx context.Context, id stable.IdentityGovernanceLifecycleWorkflowWorkflowIdVersionId, input stable.IdentityGovernanceTask, options CreateLifecycleWorkflowVersionTaskOperationOptions) (result CreateLifecycleWorkflowVersionTaskOperationResponse, err error) {
