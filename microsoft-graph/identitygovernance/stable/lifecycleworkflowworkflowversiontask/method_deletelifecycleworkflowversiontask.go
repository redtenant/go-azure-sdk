...
func (c LifecycleWorkflowWorkflowVersionTaskClient) DeleteLifecycleWorkflowVersionTask(ctx context.Context, id stable.IdentityGovernanceLifecycleWorkflowWorkflowIdVersionIdTaskId, options DeleteLifecycleWorkflowVersionTaskOperationOptions) (result DeleteLifecycleWorkflowVersionTaskOperationResponse, err error) {
