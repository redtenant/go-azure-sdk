...
func (c LifecycleWorkflowWorkflowVersionTaskClient) GetLifecycleWorkflowVersionTask(ctx context.Context, id stable.IdentityGovernanceLifecycleWorkflowWorkflowIdVersionIdTaskId, options GetLifecycleWorkflowVersionTaskOperationOptions) (result GetLifecycleWorkflowVersionTaskOperationResponse, err error) {
