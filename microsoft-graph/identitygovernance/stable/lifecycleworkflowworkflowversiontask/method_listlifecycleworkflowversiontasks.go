...
// workflowVersion.
func (c LifecycleWorkflowWorkflowVersionTaskClient) ListLifecycleWorkflowVersionTasks(ctx context.Context, id stable.IdentityGovernanceLifecycleWorkflowWorkflowIdVersionId, options ListLifecycleWorkflowVersionTasksOperationOptions) (result ListLifecycleWorkflowVersionTasksOperationResponse, err error) {
...
func (c LifecycleWorkflowWorkflowVersionTaskClient) ListLifecycleWorkflowVersionTasksComplete(ctx context.Context, id stable.IdentityGovernanceLifecycleWorkflowWorkflowIdVersionId, options ListLifecycleWorkflowVersionTasksOperationOptions) (ListLifecycleWorkflowVersionTasksCompleteResult, error) {
