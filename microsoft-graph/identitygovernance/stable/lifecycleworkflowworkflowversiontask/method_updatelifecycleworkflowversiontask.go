...
func (c LifecycleWorkflowWorkflowVersionTaskClient) UpdateLifecycleWorkflowVersionTask(ctx context.Context, id stable.IdentityGovernanceLifecycleWorkflowWorkflowIdVersionIdTaskId, input stable.IdentityGovernanceTask, options UpdateLifecycleWorkflowVersionTaskOperationOptions) (result UpdateLifecycleWorkflowVersionTaskOperationResponse, err error) {
