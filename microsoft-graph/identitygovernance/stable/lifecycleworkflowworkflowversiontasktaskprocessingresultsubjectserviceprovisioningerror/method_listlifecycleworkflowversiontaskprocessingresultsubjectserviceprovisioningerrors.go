...
func (c LifecycleWorkflowWorkflowVersionTaskTaskProcessingResultSubjectServiceProvisioningErrorClient) ListLifecycleWorkflowVersionTaskProcessingResultSubjectServiceProvisioningErrors(ctx context.Context, id stable.IdentityGovernanceLifecycleWorkflowWorkflowIdVersionIdTaskIdTaskProcessingResultId, options ListLifecycleWorkflowVersionTaskProcessingResultSubjectServiceProvisioningErrorsOperationOptions) (result ListLifecycleWorkflowVersionTaskProcessingResultSubjectServiceProvisioningErrorsOperationResponse, err error) {
...
func (c LifecycleWorkflowWorkflowVersionTaskTaskProcessingResultSubjectServiceProvisioningErrorClient) ListLifecycleWorkflowVersionTaskProcessingResultSubjectServiceProvisioningErrorsCompleteMatchingPredicate(ctx context.Context, id stable.IdentityGovernanceLifecycleWorkflowWorkflowIdVersionIdTaskIdTaskProcessingResultId, options ListLifecycleWorkflowVersionTaskProcessingResultSubjectServiceProvisioningErrorsOperationOptions, predicate ServiceProvisioningErrorOperationPredicate) (result ListLifecycleWorkflowVersionTaskProcessingResultSubjectServiceProvisioningErrorsCompleteResult, err error) {
