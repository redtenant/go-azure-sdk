...
type UpdatePrivilegedAccessOperationResponse struct {
...
func (c PrivilegedAccessClient) UpdatePrivilegedAccess(ctx context.Context, input stable.PrivilegedAccessRoot, options UpdatePrivilegedAccessOperationOptions) (result UpdatePrivilegedAccessOperationResponse, err error) {
