...
type CreatePrivilegedAccessGroupAssignmentApprovalOperationResponse struct {
...
// identityGovernance
func (c PrivilegedAccessGroupAssignmentApprovalClient) CreatePrivilegedAccessGroupAssignmentApproval(ctx context.Context, input stable.Approval, options CreatePrivilegedAccessGroupAssignmentApprovalOperationOptions) (result CreatePrivilegedAccessGroupAssignmentApprovalOperationResponse, err error) {
