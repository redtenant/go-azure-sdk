...
// identityGovernance
func (c PrivilegedAccessGroupAssignmentApprovalClient) UpdatePrivilegedAccessGroupAssignmentApproval(ctx context.Context, id stable.IdentityGovernancePrivilegedAccessGroupAssignmentApprovalId, input stable.Approval, options UpdatePrivilegedAccessGroupAssignmentApprovalOperationOptions) (result UpdatePrivilegedAccessGroupAssignmentApprovalOperationResponse, err error) {
