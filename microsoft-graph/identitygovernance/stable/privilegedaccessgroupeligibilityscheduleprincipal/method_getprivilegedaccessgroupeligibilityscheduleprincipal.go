...
// PIM. Supports $expand.
func (c PrivilegedAccessGroupEligibilitySchedulePrincipalClient) GetPrivilegedAccessGroupEligibilitySchedulePrincipal(ctx context.Context, id stable.IdentityGovernancePrivilegedAccessGroupEligibilityScheduleId, options GetPrivilegedAccessGroupEligibilitySchedulePrincipalOperationOptions) (result GetPrivilegedAccessGroupEligibilitySchedulePrincipalOperationResponse, err error) {
