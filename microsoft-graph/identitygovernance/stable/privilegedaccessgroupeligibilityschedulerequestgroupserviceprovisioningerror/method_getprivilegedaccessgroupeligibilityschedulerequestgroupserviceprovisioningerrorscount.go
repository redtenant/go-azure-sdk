...
// resource
func (c PrivilegedAccessGroupEligibilityScheduleRequestGroupServiceProvisioningErrorClient) GetPrivilegedAccessGroupEligibilityScheduleRequestGroupServiceProvisioningErrorsCount(ctx context.Context, id stable.IdentityGovernancePrivilegedAccessGroupEligibilityScheduleRequestId, options GetPrivilegedAccessGroupEligibilityScheduleRequestGroupServiceProvisioningErrorsCountOperationOptions) (result GetPrivilegedAccessGroupEligibilityScheduleRequestGroupServiceProvisioningErrorsCountOperationResponse, err error) {
