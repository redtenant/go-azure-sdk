...
func (c TermsOfUseAgreementFileLocalizationClient) GetTermsOfUseAgreementFileLocalization(ctx context.Context, id stable.IdentityGovernanceTermsOfUseAgreementIdFileLocalizationId, options GetTermsOfUseAgreementFileLocalizationOperationOptions) (result GetTermsOfUseAgreementFileLocalizationOperationResponse, err error) {
