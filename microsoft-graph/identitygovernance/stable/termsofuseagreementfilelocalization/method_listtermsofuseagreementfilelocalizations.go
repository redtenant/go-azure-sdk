...
func (c TermsOfUseAgreementFileLocalizationClient) ListTermsOfUseAgreementFileLocalizations(ctx context.Context, id stable.IdentityGovernanceTermsOfUseAgreementId, options ListTermsOfUseAgreementFileLocalizationsOperationOptions) (result ListTermsOfUseAgreementFileLocalizationsOperationResponse, err error) {
...
func (c TermsOfUseAgreementFileLocalizationClient) ListTermsOfUseAgreementFileLocalizationsComplete(ctx context.Context, id stable.IdentityGovernanceTermsOfUseAgreementId, options ListTermsOfUseAgreementFileLocalizationsOperationOptions) (ListTermsOfUseAgreementFileLocalizationsCompleteResult, error) {
...
func (c TermsOfUseAgreementFileLocalizationClient) ListTermsOfUseAgreementFileLocalizationsCompleteMatchingPredicate(ctx context.Context, id stable.IdentityGovernanceTermsOfUseAgreementId, options ListTermsOfUseAgreementFileLocalizationsOperationOptions, predicate AgreementFileLocalizationOperationPredicate) (result ListTermsOfUseAgreementFileLocalizationsCompleteResult, err error) {
