...
func (c TermsOfUseAgreementFileVersionClient) ListTermsOfUseAgreementFileVersions(ctx context.Context, id stable.IdentityGovernanceTermsOfUseAgreementIdFileId, options ListTermsOfUseAgreementFileVersionsOperationOptions) (result ListTermsOfUseAgreementFileVersionsOperationResponse, err error) {
...
func (c TermsOfUseAgreementFileVersionClient) ListTermsOfUseAgreementFileVersionsComplete(ctx context.Context, id stable.IdentityGovernanceTermsOfUseAgreementIdFileId, options ListTermsOfUseAgreementFileVersionsOperationOptions) (ListTermsOfUseAgreementFileVersionsCompleteResult, error) {
