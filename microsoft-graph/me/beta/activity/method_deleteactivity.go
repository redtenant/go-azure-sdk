...
func (c ActivityClient) DeleteActivity(ctx context.Context, id beta.MeActivityId, options DeleteActivityOperationOptions) (result DeleteActivityOperationResponse, err error) {
