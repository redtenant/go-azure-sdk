...
func (c ActivityClient) GetActivity(ctx context.Context, id beta.MeActivityId, options GetActivityOperationOptions) (result GetActivityOperationResponse, err error) {
