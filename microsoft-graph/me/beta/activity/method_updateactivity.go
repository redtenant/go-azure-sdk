...
func (c ActivityClient) UpdateActivity(ctx context.Context, id beta.MeActivityId, input beta.UserActivity, options UpdateActivityOperationOptions) (result UpdateActivityOperationResponse, err error) {
