...
func (c ActivityHistoryItemClient) CreateActivityHistoryItem(ctx context.Context, id beta.MeActivityId, input beta.ActivityHistoryItem, options CreateActivityHistoryItemOperationOptions) (result CreateActivityHistoryItemOperationResponse, err error) {
