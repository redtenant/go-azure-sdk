...
func (c ActivityHistoryItemActivityClient) GetActivityHistoryItemActivity(ctx context.Context, id beta.MeActivityIdHistoryItemId, options GetActivityHistoryItemActivityOperationOptions) (result GetActivityHistoryItemActivityOperationResponse, err error) {
