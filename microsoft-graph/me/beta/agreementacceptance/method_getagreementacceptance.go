...
// Nullable.
func (c AgreementAcceptanceClient) GetAgreementAcceptance(ctx context.Context, id beta.MeAgreementAcceptanceId, options GetAgreementAcceptanceOperationOptions) (result GetAgreementAcceptanceOperationResponse, err error) {
