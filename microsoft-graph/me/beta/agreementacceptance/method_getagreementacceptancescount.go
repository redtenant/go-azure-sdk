...
func (c AgreementAcceptanceClient) GetAgreementAcceptancesCount(ctx context.Context, options GetAgreementAcceptancesCountOperationOptions) (result GetAgreementAcceptancesCountOperationResponse, err error) {
