...
// ListAgreementAcceptances - List agreementAcceptances. Retrieve a user's agreementAcceptance objects.
func (c AgreementAcceptanceClient) ListAgreementAcceptances(ctx context.Context, options ListAgreementAcceptancesOperationOptions) (result ListAgreementAcceptancesOperationResponse, err error) {
	...
	var values struct {
		Values *[]beta.AgreementAcceptance `json:"value"`
	}
...
func (c AgreementAcceptanceClient) ListAgreementAcceptancesComplete(ctx context.Context, options ListAgreementAcceptancesOperationOptions) (ListAgreementAcceptancesCompleteResult, error) {
	return c.ListAgreementAcceptancesCompleteMatchingPredicate(ctx, options, AgreementAcceptanceOperationPredicate{})
}

// ListAgreementAcceptancesCompleteMatchingPredicate retrieves all the results and then applies the predicate
func (c AgreementAcceptanceClient) ListAgreementAcceptancesCompleteMatchingPredicate(ctx context.Context, options ListAgreementAcceptancesOperationOptions, predicate AgreementAcceptanceOperationPredicate) (result ListAgreementAcceptancesCompleteResult, err error) {
	items := make([]beta.AgreementAcceptance, 0)

	resp, err := c.ListAgreementAcceptances(ctx, options)
	if err != nil {
