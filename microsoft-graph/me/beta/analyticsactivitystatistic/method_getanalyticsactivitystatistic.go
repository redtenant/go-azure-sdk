...
// GetAnalyticsActivityStatistic - Get activityStatistics from me. The collection of work activities that a user spent
// time on during and outside of working hours. Read-only. Nullable.
func (c AnalyticsActivityStatisticClient) GetAnalyticsActivityStatistic(ctx context.Context, id beta.MeAnalyticsActivityStatisticId, options GetAnalyticsActivityStatisticOperationOptions) (result GetAnalyticsActivityStatisticOperationResponse, err error) {
