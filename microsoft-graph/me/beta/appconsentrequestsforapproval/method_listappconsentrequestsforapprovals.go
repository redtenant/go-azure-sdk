...
// ListAppConsentRequestsForApprovals - Get appConsentRequestsForApproval from me
func (c AppConsentRequestsForApprovalClient) ListAppConsentRequestsForApprovals(ctx context.Context, options ListAppConsentRequestsForApprovalsOperationOptions) (result ListAppConsentRequestsForApprovalsOperationResponse, err error) {
...
func (c AppConsentRequestsForApprovalClient) ListAppConsentRequestsForApprovalsComplete(ctx context.Context, options ListAppConsentRequestsForApprovalsOperationOptions) (ListAppConsentRequestsForApprovalsCompleteResult, error) {
	return c.ListAppConsentRequestsForApprovalsCompleteMatchingPredicate(ctx, options, AppConsentRequestOperationPredicate{})
}

// ListAppConsentRequestsForApprovalsCompleteMatchingPredicate retrieves all the results and then applies the predicate
func (c AppConsentRequestsForApprovalClient) ListAppConsentRequestsForApprovalsCompleteMatchingPredicate(ctx context.Context, options ListAppConsentRequestsForApprovalsOperationOptions, predicate AppConsentRequestOperationPredicate) (result ListAppConsentRequestsForApprovalsCompleteResult, err error) {
	items := make([]beta.AppConsentRequest, 0)

	resp, err := c.ListAppConsentRequestsForApprovals(ctx, options)
	if err != nil {
