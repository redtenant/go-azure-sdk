...
// CreateAppConsentRequestsForApprovalUserConsentRequest - Create new navigation property to userConsentRequests for me
func (c AppConsentRequestsForApprovalUserConsentRequestClient) CreateAppConsentRequestsForApprovalUserConsentRequest(ctx context.Context, id beta.MeAppConsentRequestsForApprovalId, input beta.UserConsentRequest, options CreateAppConsentRequestsForApprovalUserConsentRequestOperationOptions) (result CreateAppConsentRequestsForApprovalUserConsentRequestOperationResponse, err error) {
