...
func (c AppRoleAssignmentClient) DeleteAppRoleAssignment(ctx context.Context, id beta.MeAppRoleAssignmentId, options DeleteAppRoleAssignmentOperationOptions) (result DeleteAppRoleAssignmentOperationResponse, err error) {
