...
func (c AppRoleAssignmentClient) UpdateAppRoleAssignment(ctx context.Context, id beta.MeAppRoleAssignmentId, input beta.AppRoleAssignment, options UpdateAppRoleAssignmentOperationOptions) (result UpdateAppRoleAssignmentOperationResponse, err error) {
