...
func DefaultGetApprovalOperationOptions() GetApprovalOperationOptions {
	return GetApprovalOperationOptions{}
}
...
// GetApproval - Get approvals from me
func (c ApprovalClient) GetApproval(ctx context.Context, id beta.MeApprovalId, options GetApprovalOperationOptions) (result GetApprovalOperationResponse, err error) {
