...
// ListApprovals - Get approvals from me
func (c ApprovalClient) ListApprovals(ctx context.Context, options ListApprovalsOperationOptions) (result ListApprovalsOperationResponse, err error) {
...
func (c ApprovalClient) ListApprovalsComplete(ctx context.Context, options ListApprovalsOperationOptions) (ListApprovalsCompleteResult, error) {
	return c.ListApprovalsCompleteMatchingPredicate(ctx, options, ApprovalOperationPredicate{})
}

// ListApprovalsCompleteMatchingPredicate retrieves all the results and then applies the predicate
func (c ApprovalClient) ListApprovalsCompleteMatchingPredicate(ctx context.Context, options ListApprovalsOperationOptions, predicate ApprovalOperationPredicate) (result ListApprovalsCompleteResult, err error) {
	items := make([]beta.Approval, 0)

	resp, err := c.ListApprovals(ctx, options)
	if err != nil {
