...
// UpdateApproval - Update the navigation property approvals in me
func (c ApprovalClient) UpdateApproval(ctx context.Context, id beta.MeApprovalId, input beta.Approval, options UpdateApprovalOperationOptions) (result UpdateApprovalOperationResponse, err error) {
