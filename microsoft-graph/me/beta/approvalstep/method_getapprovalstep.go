...
// GetApprovalStep - Get steps from me. Used to represent the decision associated with a single step in the approval
// process configured in approvalStage.
func (c ApprovalStepClient) GetApprovalStep(ctx context.Context, id beta.MeApprovalIdStepId, options GetApprovalStepOperationOptions) (result GetApprovalStepOperationResponse, err error) {
