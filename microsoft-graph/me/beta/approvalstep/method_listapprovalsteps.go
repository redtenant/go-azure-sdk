...
// ListApprovalSteps - Get steps from me. Used to represent the decision associated with a single step in the approval
// process configured in approvalStage.
func (c ApprovalStepClient) ListApprovalSteps(ctx context.Context, id beta.MeApprovalId, options ListApprovalStepsOperationOptions) (result ListApprovalStepsOperationResponse, err error) {
...
func (c ApprovalStepClient) ListApprovalStepsComplete(ctx context.Context, id beta.MeApprovalId, options ListApprovalStepsOperationOptions) (ListApprovalStepsCompleteResult, error) {
...
func (c ApprovalStepClient) ListApprovalStepsCompleteMatchingPredicate(ctx context.Context, id beta.MeApprovalId, options ListApprovalStepsOperationOptions, predicate ApprovalStepOperationPredicate) (result ListApprovalStepsCompleteResult, err error) {
