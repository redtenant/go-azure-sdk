...
func (c AuthenticationFido2MethodClient) DeleteAuthenticationFido2Method(ctx context.Context, id beta.MeAuthenticationFido2MethodId, options DeleteAuthenticationFido2MethodOperationOptions) (result DeleteAuthenticationFido2MethodOperationResponse, err error) {
