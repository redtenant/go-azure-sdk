...
func (c AuthenticationMethodClient) GetAuthenticationMethod(ctx context.Context, id beta.MeAuthenticationMethodId, options GetAuthenticationMethodOperationOptions) (result GetAuthenticationMethodOperationResponse, err error) {
