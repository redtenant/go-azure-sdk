...
func (c AuthenticationMethodClient) UpdateAuthenticationMethod(ctx context.Context, id beta.MeAuthenticationMethodId, input beta.AuthenticationMethod, options UpdateAuthenticationMethodOperationOptions) (result UpdateAuthenticationMethodOperationResponse, err error) {
