...
func (c AuthenticationMicrosoftAuthenticatorMethodClient) DeleteAuthenticationMicrosoftAuthenticatorMethod(ctx context.Context, id beta.MeAuthenticationMicrosoftAuthenticatorMethodId, options DeleteAuthenticationMicrosoftAuthenticatorMethodOperationOptions) (result DeleteAuthenticationMicrosoftAuthenticatorMethodOperationResponse, err error) {
