...
func (c AuthenticationOperationClient) DeleteAuthenticationOperation(ctx context.Context, id beta.MeAuthenticationOperationId, options DeleteAuthenticationOperationOperationOptions) (result DeleteAuthenticationOperationOperationResponse, err error) {
