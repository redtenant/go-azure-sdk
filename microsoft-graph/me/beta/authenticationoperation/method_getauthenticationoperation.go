...
func (c AuthenticationOperationClient) GetAuthenticationOperation(ctx context.Context, id beta.MeAuthenticationOperationId, options GetAuthenticationOperationOperationOptions) (result GetAuthenticationOperationOperationResponse, err error) {
