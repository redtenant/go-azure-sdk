...
func (c AuthenticationOperationClient) GetAuthenticationOperationsCount(ctx context.Context, options GetAuthenticationOperationsCountOperationOptions) (result GetAuthenticationOperationsCountOperationResponse, err error) {
