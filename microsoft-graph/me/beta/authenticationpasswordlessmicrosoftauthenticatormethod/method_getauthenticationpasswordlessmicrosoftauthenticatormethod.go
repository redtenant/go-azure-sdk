...
// GetAuthenticationPasswordlessMicrosoftAuthenticatorMethod - Get
// passwordlessMicrosoftAuthenticatorAuthenticationMethod (deprecated). Retrieve a user's single Microsoft Authenticator
