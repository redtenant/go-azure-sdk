...
// GetAuthenticationPasswordMethod - Get passwordAuthenticationMethod. Retrieve the properties and relationships of a
// password authentication method object.
func (c AuthenticationPasswordMethodClient) GetAuthenticationPasswordMethod(ctx context.Context, id beta.MeAuthenticationPasswordMethodId, options GetAuthenticationPasswordMethodOperationOptions) (result GetAuthenticationPasswordMethodOperationResponse, err error) {
