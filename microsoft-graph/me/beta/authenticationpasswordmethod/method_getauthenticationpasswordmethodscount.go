...
func (c AuthenticationPasswordMethodClient) GetAuthenticationPasswordMethodsCount(ctx context.Context, options GetAuthenticationPasswordMethodsCountOperationOptions) (result GetAuthenticationPasswordMethodsCountOperationResponse, err error) {
