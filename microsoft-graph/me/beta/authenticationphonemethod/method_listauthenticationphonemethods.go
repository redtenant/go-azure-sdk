...
// ListAuthenticationPhoneMethods - List phoneMethods. Retrieve a list of phone authentication method objects. This will
// return up to three objects, as a user can have up to three phones usable for authentication. This method is available
// only for standard Microsoft Entra ID and B2B users, but not B2C users.
