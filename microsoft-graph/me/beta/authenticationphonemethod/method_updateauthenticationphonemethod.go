...
func (c AuthenticationPhoneMethodClient) UpdateAuthenticationPhoneMethod(ctx context.Context, id beta.MeAuthenticationPhoneMethodId, input beta.PhoneAuthenticationMethod, options UpdateAuthenticationPhoneMethodOperationOptions) (result UpdateAuthenticationPhoneMethodOperationResponse, err error) {
