...
// GetAuthenticationPlatformCredentialMethod - Get platformCredentialAuthenticationMethod. Read the properties and
// relationships of a platformCredentialAuthenticationMethod object.
