...
func (c AuthenticationSoftwareOathMethodClient) DeleteAuthenticationSoftwareOathMethod(ctx context.Context, id beta.MeAuthenticationSoftwareOathMethodId, options DeleteAuthenticationSoftwareOathMethodOperationOptions) (result DeleteAuthenticationSoftwareOathMethodOperationResponse, err error) {
