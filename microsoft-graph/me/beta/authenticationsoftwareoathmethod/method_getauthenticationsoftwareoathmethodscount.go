...
func (c AuthenticationSoftwareOathMethodClient) GetAuthenticationSoftwareOathMethodsCount(ctx context.Context, options GetAuthenticationSoftwareOathMethodsCountOperationOptions) (result GetAuthenticationSoftwareOathMethodsCountOperationResponse, err error) {
