...
func (c AuthenticationTemporaryAccessPassMethodClient) GetAuthenticationTemporaryAccessPassMethod(ctx context.Context, id beta.MeAuthenticationTemporaryAccessPassMethodId, options GetAuthenticationTemporaryAccessPassMethodOperationOptions) (result GetAuthenticationTemporaryAccessPassMethodOperationResponse, err error) {
