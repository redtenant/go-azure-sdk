...
// ListAuthenticationTemporaryAccessPassMethods - Get temporaryAccessPassMethods from me. Represents a Temporary Access
// Pass registered to a user for authentication through time-limited passcodes.
func (c AuthenticationTemporaryAccessPassMethodClient) ListAuthenticationTemporaryAccessPassMethods(ctx context.Context, options ListAuthenticationTemporaryAccessPassMethodsOperationOptions) (result ListAuthenticationTemporaryAccessPassMethodsOperationResponse, err error) {
	...
	var values struct {
		Values *[]beta.TemporaryAccessPassAuthenticationMethod `json:"value"`
	}
...
func (c AuthenticationTemporaryAccessPassMethodClient) ListAuthenticationTemporaryAccessPassMethodsComplete(ctx context.Context, options ListAuthenticationTemporaryAccessPassMethodsOperationOptions) (ListAuthenticationTemporaryAccessPassMethodsCompleteResult, error) {
	return c.ListAuthenticationTemporaryAccessPassMethodsCompleteMatchingPredicate(ctx, options, TemporaryAccessPassAuthenticationMethodOperationPredicate{})
}
...
func (c AuthenticationTemporaryAccessPassMethodClient) ListAuthenticationTemporaryAccessPassMethodsCompleteMatchingPredicate(ctx context.Context, options ListAuthenticationTemporaryAccessPassMethodsOperationOptions, predicate TemporaryAccessPassAuthenticationMethodOperationPredicate) (result ListAuthenticationTemporaryAccessPassMethodsCompleteResult, err error) {
	items := make([]beta.TemporaryAccessPassAuthenticationMethod, 0)

	resp, err := c.ListAuthenticationTemporaryAccessPassMethods(ctx, options)
	if err != nil {
