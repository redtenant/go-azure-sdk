...
func (c AuthenticationWindowsHelloForBusinessMethodClient) DeleteAuthenticationWindowsHelloForBusinessMethod(ctx context.Context, id beta.MeAuthenticationWindowsHelloForBusinessMethodId, options DeleteAuthenticationWindowsHelloForBusinessMethodOperationOptions) (result DeleteAuthenticationWindowsHelloForBusinessMethodOperationResponse, err error) {
