...
func (c ChatClient) HideChatForUser(ctx context.Context, id beta.MeChatId, input HideChatForUserRequest, options HideChatForUserOperationOptions) (result HideChatForUserOperationResponse, err error) {
