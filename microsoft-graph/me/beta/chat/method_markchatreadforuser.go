...
func (c ChatClient) MarkChatReadForUser(ctx context.Context, id beta.MeChatId, input MarkChatReadForUserRequest, options MarkChatReadForUserOperationOptions) (result MarkChatReadForUserOperationResponse, err error) {
