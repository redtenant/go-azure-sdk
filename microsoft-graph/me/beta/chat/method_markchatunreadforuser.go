...
func (c ChatClient) MarkChatUnreadForUser(ctx context.Context, id beta.MeChatId, input MarkChatUnreadForUserRequest, options MarkChatUnreadForUserOperationOptions) (result MarkChatUnreadForUserOperationResponse, err error) {
