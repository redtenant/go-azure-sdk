...
func (c ChatClient) SendChatActivityNotification(ctx context.Context, id beta.MeChatId, input SendChatActivityNotificationRequest, options SendChatActivityNotificationOperationOptions) (result SendChatActivityNotificationOperationResponse, err error) {
