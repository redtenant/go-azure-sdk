...
func (c ChatClient) UnhideChatForUser(ctx context.Context, id beta.MeChatId, input UnhideChatForUserRequest, options UnhideChatForUserOperationOptions) (result UnhideChatForUserOperationResponse, err error) {
