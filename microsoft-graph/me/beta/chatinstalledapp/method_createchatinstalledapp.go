...
// CreateChatInstalledApp - Create new navigation property to installedApps for me
func (c ChatInstalledAppClient) CreateChatInstalledApp(ctx context.Context, id beta.MeChatId, input beta.TeamsAppInstallation, options CreateChatInstalledAppOperationOptions) (result CreateChatInstalledAppOperationResponse, err error) {
	...
	model, err := beta.UnmarshalTeamsAppInstallationImplementation(respObj)
	if err != nil {
		return
	}
	result.Model = model
