...
func (c ChatInstalledAppClient) CreateChatInstalledAppUpgrade(ctx context.Context, id beta.MeChatIdInstalledAppId, input CreateChatInstalledAppUpgradeRequest, options CreateChatInstalledAppUpgradeOperationOptions) (result CreateChatInstalledAppUpgradeOperationResponse, err error) {
