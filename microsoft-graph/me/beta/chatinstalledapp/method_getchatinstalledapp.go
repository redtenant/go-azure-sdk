...
func (c ChatInstalledAppClient) GetChatInstalledApp(ctx context.Context, id beta.MeChatIdInstalledAppId, options GetChatInstalledAppOperationOptions) (result GetChatInstalledAppOperationResponse, err error) {
