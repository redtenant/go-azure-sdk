...
func (c ChatInstalledAppClient) GetChatInstalledAppsCount(ctx context.Context, id beta.MeChatId, options GetChatInstalledAppsCountOperationOptions) (result GetChatInstalledAppsCountOperationResponse, err error) {
