...
func (c ChatInstalledAppClient) ListChatInstalledApps(ctx context.Context, id beta.MeChatId, options ListChatInstalledAppsOperationOptions) (result ListChatInstalledAppsOperationResponse, err error) {
...
func (c ChatInstalledAppClient) ListChatInstalledAppsComplete(ctx context.Context, id beta.MeChatId, options ListChatInstalledAppsOperationOptions) (ListChatInstalledAppsCompleteResult, error) {
...
func (c ChatInstalledAppClient) ListChatInstalledAppsCompleteMatchingPredicate(ctx context.Context, id beta.MeChatId, options ListChatInstalledAppsOperationOptions, predicate TeamsAppInstallationOperationPredicate) (result ListChatInstalledAppsCompleteResult, err error) {
