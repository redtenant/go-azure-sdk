...
func (c ChatInstalledAppClient) UpdateChatInstalledApp(ctx context.Context, id beta.MeChatIdInstalledAppId, input beta.TeamsAppInstallation, options UpdateChatInstalledAppOperationOptions) (result UpdateChatInstalledAppOperationResponse, err error) {
