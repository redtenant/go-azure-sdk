...
func (c ChatMessageClient) CreateChatMessageUndoSoftDelete(ctx context.Context, id beta.MeChatIdMessageId, options CreateChatMessageUndoSoftDeleteOperationOptions) (result CreateChatMessageUndoSoftDeleteOperationResponse, err error) {
