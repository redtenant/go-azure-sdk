...
func (c ChatMessageClient) DeleteChatMessage(ctx context.Context, id beta.MeChatIdMessageId, options DeleteChatMessageOperationOptions) (result DeleteChatMessageOperationResponse, err error) {
