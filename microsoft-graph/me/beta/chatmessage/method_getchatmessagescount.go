...
func (c ChatMessageClient) GetChatMessagesCount(ctx context.Context, id beta.MeChatId, options GetChatMessagesCountOperationOptions) (result GetChatMessagesCountOperationResponse, err error) {
