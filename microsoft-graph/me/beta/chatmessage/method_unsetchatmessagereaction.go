...
func (c ChatMessageClient) UnsetChatMessageReaction(ctx context.Context, id beta.MeChatIdMessageId, input UnsetChatMessageReactionRequest, options UnsetChatMessageReactionOperationOptions) (result UnsetChatMessageReactionOperationResponse, err error) {
