...
func (c ChatMessageClient) UpdateChatMessage(ctx context.Context, id beta.MeChatIdMessageId, input beta.ChatMessage, options UpdateChatMessageOperationOptions) (result UpdateChatMessageOperationResponse, err error) {
