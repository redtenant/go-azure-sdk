...
func (c ChatMessageHostedContentClient) ListChatMessageHostedContents(ctx context.Context, id beta.MeChatIdMessageId, options ListChatMessageHostedContentsOperationOptions) (result ListChatMessageHostedContentsOperationResponse, err error) {
...
func (c ChatMessageHostedContentClient) ListChatMessageHostedContentsComplete(ctx context.Context, id beta.MeChatIdMessageId, options ListChatMessageHostedContentsOperationOptions) (ListChatMessageHostedContentsCompleteResult, error) {
...
func (c ChatMessageHostedContentClient) ListChatMessageHostedContentsCompleteMatchingPredicate(ctx context.Context, id beta.MeChatIdMessageId, options ListChatMessageHostedContentsOperationOptions, predicate ChatMessageHostedContentOperationPredicate) (result ListChatMessageHostedContentsCompleteResult, err error) {
