...
func (c ChatMessageReplyHostedContentClient) ListChatMessageReplyHostedContents(ctx context.Context, id beta.MeChatIdMessageIdReplyId, options ListChatMessageReplyHostedContentsOperationOptions) (result ListChatMessageReplyHostedContentsOperationResponse, err error) {
...
func (c ChatMessageReplyHostedContentClient) ListChatMessageReplyHostedContentsComplete(ctx context.Context, id beta.MeChatIdMessageIdReplyId, options ListChatMessageReplyHostedContentsOperationOptions) (ListChatMessageReplyHostedContentsCompleteResult, error) {
...
func (c ChatMessageReplyHostedContentClient) ListChatMessageReplyHostedContentsCompleteMatchingPredicate(ctx context.Context, id beta.MeChatIdMessageIdReplyId, options ListChatMessageReplyHostedContentsOperationOptions, predicate ChatMessageHostedContentOperationPredicate) (result ListChatMessageReplyHostedContentsCompleteResult, err error) {
