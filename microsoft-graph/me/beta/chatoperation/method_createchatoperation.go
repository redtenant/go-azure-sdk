...
// CreateChatOperation - Create new navigation property to operations for me
func (c ChatOperationClient) CreateChatOperation(ctx context.Context, id beta.MeChatId, input beta.TeamsAsyncOperation, options CreateChatOperationOperationOptions) (result CreateChatOperationOperationResponse, err error) {
