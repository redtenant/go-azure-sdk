...
func DefaultGetChatOperationOperationOptions() GetChatOperationOperationOptions {
	return GetChatOperationOperationOptions{}
}
...
// GetChatOperation - Get operations from me. A collection of all the Teams async operations that ran or are running on
// the chat. Nullable.
func (c ChatOperationClient) GetChatOperation(ctx context.Context, id beta.MeChatIdOperationId, options GetChatOperationOperationOptions) (result GetChatOperationOperationResponse, err error) {
