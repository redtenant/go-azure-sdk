...
func DefaultGetChatOperationsCountOperationOptions() GetChatOperationsCountOperationOptions {
	return GetChatOperationsCountOperationOptions{}
}
...
func (c ChatOperationClient) GetChatOperationsCount(ctx context.Context, id beta.MeChatId, options GetChatOperationsCountOperationOptions) (result GetChatOperationsCountOperationResponse, err error) {
