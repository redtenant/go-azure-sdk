...
// ListChatOperations - Get operations from me. A collection of all the Teams async operations that ran or are running
// on the chat. Nullable.
func (c ChatOperationClient) ListChatOperations(ctx context.Context, id beta.MeChatId, options ListChatOperationsOperationOptions) (result ListChatOperationsOperationResponse, err error) {
...
func (c ChatOperationClient) ListChatOperationsComplete(ctx context.Context, id beta.MeChatId, options ListChatOperationsOperationOptions) (ListChatOperationsCompleteResult, error) {
...
func (c ChatOperationClient) ListChatOperationsCompleteMatchingPredicate(ctx context.Context, id beta.MeChatId, options ListChatOperationsOperationOptions, predicate TeamsAsyncOperationOperationPredicate) (result ListChatOperationsCompleteResult, err error) {
