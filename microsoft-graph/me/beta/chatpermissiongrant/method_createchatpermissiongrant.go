...
func (c ChatPermissionGrantClient) CreateChatPermissionGrant(ctx context.Context, id beta.MeChatId, input beta.ResourceSpecificPermissionGrant, options CreateChatPermissionGrantOperationOptions) (result CreateChatPermissionGrantOperationResponse, err error) {
