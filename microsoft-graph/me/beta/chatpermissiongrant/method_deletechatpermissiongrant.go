...
func (c ChatPermissionGrantClient) DeleteChatPermissionGrant(ctx context.Context, id beta.MeChatIdPermissionGrantId, options DeleteChatPermissionGrantOperationOptions) (result DeleteChatPermissionGrantOperationResponse, err error) {
