...
func (c ChatPermissionGrantClient) GetChatPermissionGrant(ctx context.Context, id beta.MeChatIdPermissionGrantId, options GetChatPermissionGrantOperationOptions) (result GetChatPermissionGrantOperationResponse, err error) {
