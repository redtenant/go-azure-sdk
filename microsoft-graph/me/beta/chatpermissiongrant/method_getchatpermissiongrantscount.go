...
func (c ChatPermissionGrantClient) GetChatPermissionGrantsCount(ctx context.Context, id beta.MeChatId, options GetChatPermissionGrantsCountOperationOptions) (result GetChatPermissionGrantsCountOperationResponse, err error) {
