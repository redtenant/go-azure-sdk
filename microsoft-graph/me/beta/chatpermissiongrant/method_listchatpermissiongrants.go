...
func (c ChatPermissionGrantClient) ListChatPermissionGrants(ctx context.Context, id beta.MeChatId, options ListChatPermissionGrantsOperationOptions) (result ListChatPermissionGrantsOperationResponse, err error) {
...
func (c ChatPermissionGrantClient) ListChatPermissionGrantsComplete(ctx context.Context, id beta.MeChatId, options ListChatPermissionGrantsOperationOptions) (ListChatPermissionGrantsCompleteResult, error) {
...
func (c ChatPermissionGrantClient) ListChatPermissionGrantsCompleteMatchingPredicate(ctx context.Context, id beta.MeChatId, options ListChatPermissionGrantsOperationOptions, predicate ResourceSpecificPermissionGrantOperationPredicate) (result ListChatPermissionGrantsCompleteResult, err error) {
