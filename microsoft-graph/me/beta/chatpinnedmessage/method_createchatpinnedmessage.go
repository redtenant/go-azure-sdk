...
func (c ChatPinnedMessageClient) CreateChatPinnedMessage(ctx context.Context, id beta.MeChatId, input beta.PinnedChatMessageInfo, options CreateChatPinnedMessageOperationOptions) (result CreateChatPinnedMessageOperationResponse, err error) {
