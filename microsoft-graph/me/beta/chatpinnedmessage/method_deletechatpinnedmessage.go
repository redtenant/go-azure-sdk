...
func (c ChatPinnedMessageClient) DeleteChatPinnedMessage(ctx context.Context, id beta.MeChatIdPinnedMessageId, options DeleteChatPinnedMessageOperationOptions) (result DeleteChatPinnedMessageOperationResponse, err error) {
