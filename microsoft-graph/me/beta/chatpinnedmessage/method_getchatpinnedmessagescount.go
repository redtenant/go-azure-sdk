...
func (c ChatPinnedMessageClient) GetChatPinnedMessagesCount(ctx context.Context, id beta.MeChatId, options GetChatPinnedMessagesCountOperationOptions) (result GetChatPinnedMessagesCountOperationResponse, err error) {
