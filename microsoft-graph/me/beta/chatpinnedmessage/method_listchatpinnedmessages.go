...
func (c ChatPinnedMessageClient) ListChatPinnedMessages(ctx context.Context, id beta.MeChatId, options ListChatPinnedMessagesOperationOptions) (result ListChatPinnedMessagesOperationResponse, err error) {
...
func (c ChatPinnedMessageClient) ListChatPinnedMessagesComplete(ctx context.Context, id beta.MeChatId, options ListChatPinnedMessagesOperationOptions) (ListChatPinnedMessagesCompleteResult, error) {
...
func (c ChatPinnedMessageClient) ListChatPinnedMessagesCompleteMatchingPredicate(ctx context.Context, id beta.MeChatId, options ListChatPinnedMessagesOperationOptions, predicate PinnedChatMessageInfoOperationPredicate) (result ListChatPinnedMessagesCompleteResult, err error) {
