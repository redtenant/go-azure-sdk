...
func (c ChatPinnedMessageMessageClient) GetChatPinnedMessageMessage(ctx context.Context, id beta.MeChatIdPinnedMessageId, options GetChatPinnedMessageMessageOperationOptions) (result GetChatPinnedMessageMessageOperationResponse, err error) {
