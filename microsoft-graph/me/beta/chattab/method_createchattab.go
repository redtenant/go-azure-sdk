...
func (c ChatTabClient) CreateChatTab(ctx context.Context, id beta.MeChatId, input beta.TeamsTab, options CreateChatTabOperationOptions) (result CreateChatTabOperationResponse, err error) {
