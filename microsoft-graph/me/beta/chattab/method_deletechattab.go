...
func (c ChatTabClient) DeleteChatTab(ctx context.Context, id beta.MeChatIdTabId, options DeleteChatTabOperationOptions) (result DeleteChatTabOperationResponse, err error) {
