...
func (c ChatTabClient) GetChatTab(ctx context.Context, id beta.MeChatIdTabId, options GetChatTabOperationOptions) (result GetChatTabOperationResponse, err error) {
