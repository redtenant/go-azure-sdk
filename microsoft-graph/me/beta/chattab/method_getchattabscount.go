...
func (c ChatTabClient) GetChatTabsCount(ctx context.Context, id beta.MeChatId, options GetChatTabsCountOperationOptions) (result GetChatTabsCountOperationResponse, err error) {
