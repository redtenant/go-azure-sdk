...
func (c ChatTabClient) ListChatTabs(ctx context.Context, id beta.MeChatId, options ListChatTabsOperationOptions) (result ListChatTabsOperationResponse, err error) {
...
func (c ChatTabClient) ListChatTabsComplete(ctx context.Context, id beta.MeChatId, options ListChatTabsOperationOptions) (ListChatTabsCompleteResult, error) {
...
func (c ChatTabClient) ListChatTabsCompleteMatchingPredicate(ctx context.Context, id beta.MeChatId, options ListChatTabsOperationOptions, predicate TeamsTabOperationPredicate) (result ListChatTabsCompleteResult, err error) {
