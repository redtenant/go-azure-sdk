...
func (c ChatTabClient) UpdateChatTab(ctx context.Context, id beta.MeChatIdTabId, input beta.TeamsTab, options UpdateChatTabOperationOptions) (result UpdateChatTabOperationResponse, err error) {
