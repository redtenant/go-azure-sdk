...
// DeleteCloudClipboard - Delete navigation property cloudClipboard for me
func (c CloudClipboardClient) DeleteCloudClipboard(ctx context.Context, options DeleteCloudClipboardOperationOptions) (result DeleteCloudClipboardOperationResponse, err error) {
