...
func (c CloudClipboardItemClient) DeleteCloudClipboardItem(ctx context.Context, id beta.MeCloudClipboardItemId, options DeleteCloudClipboardItemOperationOptions) (result DeleteCloudClipboardItemOperationResponse, err error) {
