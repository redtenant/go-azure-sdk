...
func (c CloudClipboardItemClient) GetCloudClipboardItem(ctx context.Context, id beta.MeCloudClipboardItemId, options GetCloudClipboardItemOperationOptions) (result GetCloudClipboardItemOperationResponse, err error) {
