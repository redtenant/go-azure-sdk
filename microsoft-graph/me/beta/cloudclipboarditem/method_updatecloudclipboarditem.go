...
func (c CloudClipboardItemClient) UpdateCloudClipboardItem(ctx context.Context, id beta.MeCloudClipboardItemId, input beta.CloudClipboardItem, options UpdateCloudClipboardItemOperationOptions) (result UpdateCloudClipboardItemOperationResponse, err error) {
