...
func (c CloudPCClient) CreateCloudPCSnapshot(ctx context.Context, id beta.MeCloudPCId, options CreateCloudPCSnapshotOperationOptions) (result CreateCloudPCSnapshotOperationResponse, err error) {
