...
func DefaultGetCloudPCOperationOptions() GetCloudPCOperationOptions {
	return GetCloudPCOperationOptions{}
}
...
// GetCloudPC - Get cloudPC. Read the properties and relationships of a specific cloudPC object.
func (c CloudPCClient) GetCloudPC(ctx context.Context, id beta.MeCloudPCId, options GetCloudPCOperationOptions) (result GetCloudPCOperationResponse, err error) {
