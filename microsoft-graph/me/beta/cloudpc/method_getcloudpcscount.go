...
func DefaultGetCloudPCsCountOperationOptions() GetCloudPCsCountOperationOptions {
	return GetCloudPCsCountOperationOptions{}
}
...
func (c CloudPCClient) GetCloudPCsCount(ctx context.Context, options GetCloudPCsCountOperationOptions) (result GetCloudPCsCountOperationResponse, err error) {
