...
func (c CloudPCClient) PowerOnCloudPC(ctx context.Context, id beta.MeCloudPCId, options PowerOnCloudPCOperationOptions) (result PowerOnCloudPCOperationResponse, err error) {
