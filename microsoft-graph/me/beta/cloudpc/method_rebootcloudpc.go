...
func (c CloudPCClient) RebootCloudPC(ctx context.Context, id beta.MeCloudPCId, options RebootCloudPCOperationOptions) (result RebootCloudPCOperationResponse, err error) {
