...
// and retry.
func (c CloudPCClient) RetryCloudPCPartnerAgentInstallation(ctx context.Context, id beta.MeCloudPCId, options RetryCloudPCPartnerAgentInstallationOperationOptions) (result RetryCloudPCPartnerAgentInstallationOperationResponse, err error) {
