...
func (c CloudPCClient) TroubleshootCloudPC(ctx context.Context, id beta.MeCloudPCId, options TroubleshootCloudPCOperationOptions) (result TroubleshootCloudPCOperationResponse, err error) {
