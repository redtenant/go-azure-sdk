...
func (c ContactClient) DeleteContact(ctx context.Context, id beta.MeContactId, options DeleteContactOperationOptions) (result DeleteContactOperationResponse, err error) {
