...
func (c ContactExtensionClient) UpdateContactExtension(ctx context.Context, id beta.MeContactIdExtensionId, input beta.Extension, options UpdateContactExtensionOperationOptions) (result UpdateContactExtensionOperationResponse, err error) {
