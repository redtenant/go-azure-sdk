...
func (c ContactFolderClient) GetContactFolder(ctx context.Context, id beta.MeContactFolderId, options GetContactFolderOperationOptions) (result GetContactFolderOperationResponse, err error) {
