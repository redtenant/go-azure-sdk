...
func (c ContactFolderClient) UpdateContactFolder(ctx context.Context, id beta.MeContactFolderId, input beta.ContactFolder, options UpdateContactFolderOperationOptions) (result UpdateContactFolderOperationResponse, err error) {
