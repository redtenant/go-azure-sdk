...
func (c ContactFolderChildFolderClient) DeleteContactFolderChildFolder(ctx context.Context, id beta.MeContactFolderIdChildFolderId, options DeleteContactFolderChildFolderOperationOptions) (result DeleteContactFolderChildFolderOperationResponse, err error) {
