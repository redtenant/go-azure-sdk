...
// GetContactFolderChildFolder - Get childFolders from me. The collection of child folders in the folder. Navigation
// property. Read-only. Nullable.
func (c ContactFolderChildFolderClient) GetContactFolderChildFolder(ctx context.Context, id beta.MeContactFolderIdChildFolderId, options GetContactFolderChildFolderOperationOptions) (result GetContactFolderChildFolderOperationResponse, err error) {
