...
func (c ContactFolderChildFolderClient) GetContactFolderChildFoldersCount(ctx context.Context, id beta.MeContactFolderId, options GetContactFolderChildFoldersCountOperationOptions) (result GetContactFolderChildFoldersCountOperationResponse, err error) {
