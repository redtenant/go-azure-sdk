...
// ListContactFolderChildFolders - List childFolders. Get a collection of child folders under the specified contact
// folder.
func (c ContactFolderChildFolderClient) ListContactFolderChildFolders(ctx context.Context, id beta.MeContactFolderId, options ListContactFolderChildFoldersOperationOptions) (result ListContactFolderChildFoldersOperationResponse, err error) {
...
func (c ContactFolderChildFolderClient) ListContactFolderChildFoldersComplete(ctx context.Context, id beta.MeContactFolderId, options ListContactFolderChildFoldersOperationOptions) (ListContactFolderChildFoldersCompleteResult, error) {
...
func (c ContactFolderChildFolderClient) ListContactFolderChildFoldersCompleteMatchingPredicate(ctx context.Context, id beta.MeContactFolderId, options ListContactFolderChildFoldersOperationOptions, predicate ContactFolderOperationPredicate) (result ListContactFolderChildFoldersCompleteResult, err error) {
