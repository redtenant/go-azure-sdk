...
func (c ContactFolderChildFolderContactClient) CreateContactFolderChildFolderContact(ctx context.Context, id beta.MeContactFolderIdChildFolderId, input beta.Contact, options CreateContactFolderChildFolderContactOperationOptions) (result CreateContactFolderChildFolderContactOperationResponse, err error) {
