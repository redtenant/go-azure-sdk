...
func (c ContactFolderChildFolderContactClient) DeleteContactFolderChildFolderContact(ctx context.Context, id beta.MeContactFolderIdChildFolderIdContactId, options DeleteContactFolderChildFolderContactOperationOptions) (result DeleteContactFolderChildFolderContactOperationResponse, err error) {
