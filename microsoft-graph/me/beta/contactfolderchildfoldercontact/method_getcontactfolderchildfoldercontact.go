...
// GetContactFolderChildFolderContact - Get contacts from me. The contacts in the folder. Navigation property.
// Read-only. Nullable.
func (c ContactFolderChildFolderContactClient) GetContactFolderChildFolderContact(ctx context.Context, id beta.MeContactFolderIdChildFolderIdContactId, options GetContactFolderChildFolderContactOperationOptions) (result GetContactFolderChildFolderContactOperationResponse, err error) {
