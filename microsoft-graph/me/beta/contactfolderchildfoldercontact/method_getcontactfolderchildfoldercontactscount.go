...
func (c ContactFolderChildFolderContactClient) GetContactFolderChildFolderContactsCount(ctx context.Context, id beta.MeContactFolderIdChildFolderId, options GetContactFolderChildFolderContactsCountOperationOptions) (result GetContactFolderChildFolderContactsCountOperationResponse, err error) {
