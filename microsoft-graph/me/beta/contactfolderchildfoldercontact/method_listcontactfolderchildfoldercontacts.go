...
// ListContactFolderChildFolderContacts - Get contacts from me. The contacts in the folder. Navigation property.
// Read-only. Nullable.
func (c ContactFolderChildFolderContactClient) ListContactFolderChildFolderContacts(ctx context.Context, id beta.MeContactFolderIdChildFolderId, options ListContactFolderChildFolderContactsOperationOptions) (result ListContactFolderChildFolderContactsOperationResponse, err error) {
...
func (c ContactFolderChildFolderContactClient) ListContactFolderChildFolderContactsComplete(ctx context.Context, id beta.MeContactFolderIdChildFolderId, options ListContactFolderChildFolderContactsOperationOptions) (ListContactFolderChildFolderContactsCompleteResult, error) {
