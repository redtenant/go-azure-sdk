...
func (c ContactFolderChildFolderContactExtensionClient) CreateContactFolderChildFolderContactExtension(ctx context.Context, id beta.MeContactFolderIdChildFolderIdContactId, input beta.Extension, options CreateContactFolderChildFolderContactExtensionOperationOptions) (result CreateContactFolderChildFolderContactExtensionOperationResponse, err error) {
