...
func (c ContactFolderChildFolderContactExtensionClient) DeleteContactFolderChildFolderContactExtension(ctx context.Context, id beta.MeContactFolderIdChildFolderIdContactIdExtensionId, options DeleteContactFolderChildFolderContactExtensionOperationOptions) (result DeleteContactFolderChildFolderContactExtensionOperationResponse, err error) {
