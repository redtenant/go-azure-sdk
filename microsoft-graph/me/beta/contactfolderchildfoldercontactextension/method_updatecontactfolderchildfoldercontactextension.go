...
func (c ContactFolderChildFolderContactExtensionClient) UpdateContactFolderChildFolderContactExtension(ctx context.Context, id beta.MeContactFolderIdChildFolderIdContactIdExtensionId, input beta.Extension, options UpdateContactFolderChildFolderContactExtensionOperationOptions) (result UpdateContactFolderChildFolderContactExtensionOperationResponse, err error) {
