...
func (c ContactFolderChildFolderContactPhotoClient) RemoveContactFolderChildFolderContactPhotoValue(ctx context.Context, id beta.MeContactFolderIdChildFolderIdContactId, options RemoveContactFolderChildFolderContactPhotoValueOperationOptions) (result RemoveContactFolderChildFolderContactPhotoValueOperationResponse, err error) {
