...
func (c ContactFolderContactExtensionClient) CreateContactFolderContactExtension(ctx context.Context, id beta.MeContactFolderIdContactId, input beta.Extension, options CreateContactFolderContactExtensionOperationOptions) (result CreateContactFolderContactExtensionOperationResponse, err error) {
