...
func (c ContactFolderContactExtensionClient) GetContactFolderContactExtensionsCount(ctx context.Context, id beta.MeContactFolderIdContactId, options GetContactFolderContactExtensionsCountOperationOptions) (result GetContactFolderContactExtensionsCountOperationResponse, err error) {
