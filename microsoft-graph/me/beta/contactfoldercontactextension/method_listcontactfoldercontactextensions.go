...
// contact. Nullable.
func (c ContactFolderContactExtensionClient) ListContactFolderContactExtensions(ctx context.Context, id beta.MeContactFolderIdContactId, options ListContactFolderContactExtensionsOperationOptions) (result ListContactFolderContactExtensionsOperationResponse, err error) {
...
func (c ContactFolderContactExtensionClient) ListContactFolderContactExtensionsComplete(ctx context.Context, id beta.MeContactFolderIdContactId, options ListContactFolderContactExtensionsOperationOptions) (ListContactFolderContactExtensionsCompleteResult, error) {
