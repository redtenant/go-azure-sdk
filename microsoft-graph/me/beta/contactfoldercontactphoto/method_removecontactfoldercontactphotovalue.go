...
func (c ContactFolderContactPhotoClient) RemoveContactFolderContactPhotoValue(ctx context.Context, id beta.MeContactFolderIdContactId, options RemoveContactFolderContactPhotoValueOperationOptions) (result RemoveContactFolderContactPhotoValueOperationResponse, err error) {
