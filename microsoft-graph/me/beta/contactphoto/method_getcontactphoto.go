...
func (c ContactPhotoClient) GetContactPhoto(ctx context.Context, id beta.MeContactId, options GetContactPhotoOperationOptions) (result GetContactPhotoOperationResponse, err error) {
