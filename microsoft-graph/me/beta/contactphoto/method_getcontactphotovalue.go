...
func (c ContactPhotoClient) GetContactPhotoValue(ctx context.Context, id beta.MeContactId, options GetContactPhotoValueOperationOptions) (result GetContactPhotoValueOperationResponse, err error) {
