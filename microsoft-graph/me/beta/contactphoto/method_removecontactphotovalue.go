...
func (c ContactPhotoClient) RemoveContactPhotoValue(ctx context.Context, id beta.MeContactId, options RemoveContactPhotoValueOperationOptions) (result RemoveContactPhotoValueOperationResponse, err error) {
