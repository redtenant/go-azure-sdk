...
func (c ContactPhotoClient) UpdateContactPhoto(ctx context.Context, id beta.MeContactId, input beta.ProfilePhoto, options UpdateContactPhotoOperationOptions) (result UpdateContactPhotoOperationResponse, err error) {
