...
func (c CreatedObjectClient) GetCreatedObject(ctx context.Context, id beta.MeCreatedObjectId, options GetCreatedObjectOperationOptions) (result GetCreatedObjectOperationResponse, err error) {
