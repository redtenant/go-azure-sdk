...
func DefaultDeleteDeviceOperationOptions() DeleteDeviceOperationOptions {
	return DeleteDeviceOperationOptions{}
}
...
// DeleteDevice - Delete navigation property devices for me
func (c DeviceClient) DeleteDevice(ctx context.Context, id beta.MeDeviceId, options DeleteDeviceOperationOptions) (result DeleteDeviceOperationResponse, err error) {
