...
// GetDevice - Get devices from me
func (c DeviceClient) GetDevice(ctx context.Context, id beta.MeDeviceId, options GetDeviceOperationOptions) (result GetDeviceOperationResponse, err error) {
