...
func DefaultListDevicesOperationOptions() ListDevicesOperationOptions {
	return ListDevicesOperationOptions{}
}
...
// ListDevices - Get devices from me
func (c DeviceClient) ListDevices(ctx context.Context, options ListDevicesOperationOptions) (result ListDevicesOperationResponse, err error) {
...
func (c DeviceClient) ListDevicesComplete(ctx context.Context, options ListDevicesOperationOptions) (ListDevicesCompleteResult, error) {
	return c.ListDevicesCompleteMatchingPredicate(ctx, options, DeviceOperationPredicate{})
}

// ListDevicesCompleteMatchingPredicate retrieves all the results and then applies the predicate
func (c DeviceClient) ListDevicesCompleteMatchingPredicate(ctx context.Context, options ListDevicesOperationOptions, predicate DeviceOperationPredicate) (result ListDevicesCompleteResult, err error) {
	items := make([]beta.Device, 0)

	resp, err := c.ListDevices(ctx, options)
	if err != nil {
