...
func DefaultDeleteDeviceCommandOperationOptions() DeleteDeviceCommandOperationOptions {
	return DeleteDeviceCommandOperationOptions{}
}
...
// DeleteDeviceCommand - Delete navigation property commands for me
func (c DeviceCommandClient) DeleteDeviceCommand(ctx context.Context, id beta.MeDeviceIdCommandId, options DeleteDeviceCommandOperationOptions) (result DeleteDeviceCommandOperationResponse, err error) {
