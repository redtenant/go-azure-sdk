...
func DefaultGetDeviceCommandOperationOptions() GetDeviceCommandOperationOptions {
	return GetDeviceCommandOperationOptions{}
}
...
// GetDeviceCommand - Get commands from me. Set of commands sent to this device.
func (c DeviceCommandClient) GetDeviceCommand(ctx context.Context, id beta.MeDeviceIdCommandId, options GetDeviceCommandOperationOptions) (result GetDeviceCommandOperationResponse, err error) {
