...
// ListDeviceCommands - Get commands from me. Set of commands sent to this device.
func (c DeviceCommandClient) ListDeviceCommands(ctx context.Context, id beta.MeDeviceId, options ListDeviceCommandsOperationOptions) (result ListDeviceCommandsOperationResponse, err error) {
...
func (c DeviceCommandClient) ListDeviceCommandsComplete(ctx context.Context, id beta.MeDeviceId, options ListDeviceCommandsOperationOptions) (ListDeviceCommandsCompleteResult, error) {
...
func (c DeviceCommandClient) ListDeviceCommandsCompleteMatchingPredicate(ctx context.Context, id beta.MeDeviceId, options ListDeviceCommandsOperationOptions, predicate CommandOperationPredicate) (result ListDeviceCommandsCompleteResult, err error) {
