...
func (c DeviceEnrollmentConfigurationClient) DeleteDeviceEnrollmentConfiguration(ctx context.Context, id beta.MeDeviceEnrollmentConfigurationId, options DeleteDeviceEnrollmentConfigurationOperationOptions) (result DeleteDeviceEnrollmentConfigurationOperationResponse, err error) {
