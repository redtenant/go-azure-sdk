...
func (c DeviceEnrollmentConfigurationClient) ListDeviceEnrollmentConfigurationHasPayloadLinks(ctx context.Context, input ListDeviceEnrollmentConfigurationHasPayloadLinksRequest, options ListDeviceEnrollmentConfigurationHasPayloadLinksOperationOptions) (result ListDeviceEnrollmentConfigurationHasPayloadLinksOperationResponse, err error) {
...
func (c DeviceEnrollmentConfigurationClient) ListDeviceEnrollmentConfigurationHasPayloadLinksComplete(ctx context.Context, input ListDeviceEnrollmentConfigurationHasPayloadLinksRequest, options ListDeviceEnrollmentConfigurationHasPayloadLinksOperationOptions) (ListDeviceEnrollmentConfigurationHasPayloadLinksCompleteResult, error) {
	return c.ListDeviceEnrollmentConfigurationHasPayloadLinksCompleteMatchingPredicate(ctx, input, options, HasPayloadLinkResultItemOperationPredicate{})
}
...
func (c DeviceEnrollmentConfigurationClient) ListDeviceEnrollmentConfigurationHasPayloadLinksCompleteMatchingPredicate(ctx context.Context, input ListDeviceEnrollmentConfigurationHasPayloadLinksRequest, options ListDeviceEnrollmentConfigurationHasPayloadLinksOperationOptions, predicate HasPayloadLinkResultItemOperationPredicate) (result ListDeviceEnrollmentConfigurationHasPayloadLinksCompleteResult, err error) {
	items := make([]beta.HasPayloadLinkResultItem, 0)

	resp, err := c.ListDeviceEnrollmentConfigurationHasPayloadLinks(ctx, input, options)
	if err != nil {
