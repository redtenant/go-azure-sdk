...
// CreateDeviceEnrollmentConfigurationAssignment - Create new navigation property to assignments for me
func (c DeviceEnrollmentConfigurationAssignmentClient) CreateDeviceEnrollmentConfigurationAssignment(ctx context.Context, id beta.MeDeviceEnrollmentConfigurationId, input beta.EnrollmentConfigurationAssignment, options CreateDeviceEnrollmentConfigurationAssignmentOperationOptions) (result CreateDeviceEnrollmentConfigurationAssignmentOperationResponse, err error) {
