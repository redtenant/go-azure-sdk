...
// DeleteDeviceEnrollmentConfigurationAssignment - Delete navigation property assignments for me
func (c DeviceEnrollmentConfigurationAssignmentClient) DeleteDeviceEnrollmentConfigurationAssignment(ctx context.Context, id beta.MeDeviceEnrollmentConfigurationIdAssignmentId, options DeleteDeviceEnrollmentConfigurationAssignmentOperationOptions) (result DeleteDeviceEnrollmentConfigurationAssignmentOperationResponse, err error) {
