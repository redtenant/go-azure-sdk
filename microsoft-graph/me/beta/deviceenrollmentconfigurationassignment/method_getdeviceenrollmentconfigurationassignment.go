...
// GetDeviceEnrollmentConfigurationAssignment - Get assignments from me. The list of group assignments for the device
// configuration profile
func (c DeviceEnrollmentConfigurationAssignmentClient) GetDeviceEnrollmentConfigurationAssignment(ctx context.Context, id beta.MeDeviceEnrollmentConfigurationIdAssignmentId, options GetDeviceEnrollmentConfigurationAssignmentOperationOptions) (result GetDeviceEnrollmentConfigurationAssignmentOperationResponse, err error) {
