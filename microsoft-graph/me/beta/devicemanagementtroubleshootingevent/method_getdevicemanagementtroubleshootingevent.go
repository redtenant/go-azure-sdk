...
func (c DeviceManagementTroubleshootingEventClient) GetDeviceManagementTroubleshootingEvent(ctx context.Context, id beta.MeDeviceManagementTroubleshootingEventId, options GetDeviceManagementTroubleshootingEventOperationOptions) (result GetDeviceManagementTroubleshootingEventOperationResponse, err error) {
