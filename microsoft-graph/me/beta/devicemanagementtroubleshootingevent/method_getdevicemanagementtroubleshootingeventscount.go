...
func (c DeviceManagementTroubleshootingEventClient) GetDeviceManagementTroubleshootingEventsCount(ctx context.Context, options GetDeviceManagementTroubleshootingEventsCountOperationOptions) (result GetDeviceManagementTroubleshootingEventsCountOperationResponse, err error) {
	opts := client.RequestOptions{
		...
		Path:          "/me/deviceManagementTroubleshootingEvents/$count",
