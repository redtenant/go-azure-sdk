...
func DefaultGetDeviceMemberOfOperationOptions() GetDeviceMemberOfOperationOptions {
	return GetDeviceMemberOfOperationOptions{}
}
...
// GetDeviceMemberOf - Get memberOf from me. Groups and administrative units that this device is a member of. Read-only.
// Nullable. Supports $expand.
func (c DeviceMemberOfClient) GetDeviceMemberOf(ctx context.Context, id beta.MeDeviceIdMemberOfId, options GetDeviceMemberOfOperationOptions) (result GetDeviceMemberOfOperationResponse, err error) {
