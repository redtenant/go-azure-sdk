...
func (c DeviceMemberOfClient) GetDeviceMemberOfCount(ctx context.Context, id beta.MeDeviceId, options GetDeviceMemberOfCountOperationOptions) (result GetDeviceMemberOfCountOperationResponse, err error) {
