...
// AddDeviceRegisteredOwnerRef - Create new navigation property ref to registeredOwners for me
func (c DeviceRegisteredOwnerClient) AddDeviceRegisteredOwnerRef(ctx context.Context, id beta.MeDeviceId, input beta.ReferenceCreate, options AddDeviceRegisteredOwnerRefOperationOptions) (result AddDeviceRegisteredOwnerRefOperationResponse, err error) {
