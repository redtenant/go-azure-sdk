...
func DefaultGetDeviceRegisteredOwnersCountOperationOptions() GetDeviceRegisteredOwnersCountOperationOptions {
	return GetDeviceRegisteredOwnersCountOperationOptions{}
}
...
func (c DeviceRegisteredOwnerClient) GetDeviceRegisteredOwnersCount(ctx context.Context, id beta.MeDeviceId, options GetDeviceRegisteredOwnersCountOperationOptions) (result GetDeviceRegisteredOwnersCountOperationResponse, err error) {
	opts := client.RequestOptions{
		...
		Path:          fmt.Sprintf("%s/registeredOwners/$count", id.ID()),
