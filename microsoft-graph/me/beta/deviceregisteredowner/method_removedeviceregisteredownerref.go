...
// RemoveDeviceRegisteredOwnerRef - Delete ref of navigation property registeredOwners for me
func (c DeviceRegisteredOwnerClient) RemoveDeviceRegisteredOwnerRef(ctx context.Context, id beta.MeDeviceIdRegisteredOwnerId, options RemoveDeviceRegisteredOwnerRefOperationOptions) (result RemoveDeviceRegisteredOwnerRefOperationResponse, err error) {
