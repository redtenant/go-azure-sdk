...
// RemoveDeviceRegisteredOwnerRefs - Delete ref of navigation property registeredOwners for me
func (c DeviceRegisteredOwnerClient) RemoveDeviceRegisteredOwnerRefs(ctx context.Context, id beta.MeDeviceId, options RemoveDeviceRegisteredOwnerRefsOperationOptions) (result RemoveDeviceRegisteredOwnerRefsOperationResponse, err error) {
