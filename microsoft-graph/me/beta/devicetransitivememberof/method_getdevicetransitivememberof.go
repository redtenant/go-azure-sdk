...
// GetDeviceTransitiveMemberOf - Get transitiveMemberOf from me. Groups and administrative units that this device is a
// member of. This operation is transitive. Supports $expand.
func (c DeviceTransitiveMemberOfClient) GetDeviceTransitiveMemberOf(ctx context.Context, id beta.MeDeviceIdTransitiveMemberOfId, options GetDeviceTransitiveMemberOfOperationOptions) (result GetDeviceTransitiveMemberOfOperationResponse, err error) {
