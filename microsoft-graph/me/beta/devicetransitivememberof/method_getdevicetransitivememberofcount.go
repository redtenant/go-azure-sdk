...
func DefaultGetDeviceTransitiveMemberOfCountOperationOptions() GetDeviceTransitiveMemberOfCountOperationOptions {
	return GetDeviceTransitiveMemberOfCountOperationOptions{}
}
...
func (c DeviceTransitiveMemberOfClient) GetDeviceTransitiveMemberOfCount(ctx context.Context, id beta.MeDeviceId, options GetDeviceTransitiveMemberOfCountOperationOptions) (result GetDeviceTransitiveMemberOfCountOperationResponse, err error) {
	opts := client.RequestOptions{
		...
		Path:          fmt.Sprintf("%s/transitiveMemberOf/$count", id.ID()),
