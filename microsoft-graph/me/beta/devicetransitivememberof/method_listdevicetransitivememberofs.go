...
// ListDeviceTransitiveMemberOfs - Get transitiveMemberOf from me. Groups and administrative units that this device is a
// member of. This operation is transitive. Supports $expand.
func (c DeviceTransitiveMemberOfClient) ListDeviceTransitiveMemberOfs(ctx context.Context, id beta.MeDeviceId, options ListDeviceTransitiveMemberOfsOperationOptions) (result ListDeviceTransitiveMemberOfsOperationResponse, err error) {
...
func (c DeviceTransitiveMemberOfClient) ListDeviceTransitiveMemberOfsComplete(ctx context.Context, id beta.MeDeviceId, options ListDeviceTransitiveMemberOfsOperationOptions) (ListDeviceTransitiveMemberOfsCompleteResult, error) {
...
func (c DeviceTransitiveMemberOfClient) ListDeviceTransitiveMemberOfsCompleteMatchingPredicate(ctx context.Context, id beta.MeDeviceId, options ListDeviceTransitiveMemberOfsOperationOptions, predicate DirectoryObjectOperationPredicate) (result ListDeviceTransitiveMemberOfsCompleteResult, err error) {
