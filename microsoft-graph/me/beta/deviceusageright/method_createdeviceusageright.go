...
func (c DeviceUsageRightClient) CreateDeviceUsageRight(ctx context.Context, id beta.MeDeviceId, input beta.UsageRight, options CreateDeviceUsageRightOperationOptions) (result CreateDeviceUsageRightOperationResponse, err error) {
