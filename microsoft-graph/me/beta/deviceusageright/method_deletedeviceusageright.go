...
func (c DeviceUsageRightClient) DeleteDeviceUsageRight(ctx context.Context, id beta.MeDeviceIdUsageRightId, options DeleteDeviceUsageRightOperationOptions) (result DeleteDeviceUsageRightOperationResponse, err error) {
