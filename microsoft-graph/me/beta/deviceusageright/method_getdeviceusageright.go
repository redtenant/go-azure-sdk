...
func DefaultGetDeviceUsageRightOperationOptions() GetDeviceUsageRightOperationOptions {
	return GetDeviceUsageRightOperationOptions{}
}
...
func (c DeviceUsageRightClient) GetDeviceUsageRight(ctx context.Context, id beta.MeDeviceIdUsageRightId, options GetDeviceUsageRightOperationOptions) (result GetDeviceUsageRightOperationResponse, err error) {
