...
func DefaultGetDeviceUsageRightsCountOperationOptions() GetDeviceUsageRightsCountOperationOptions {
	return GetDeviceUsageRightsCountOperationOptions{}
}
...
func (c DeviceUsageRightClient) GetDeviceUsageRightsCount(ctx context.Context, id beta.MeDeviceId, options GetDeviceUsageRightsCountOperationOptions) (result GetDeviceUsageRightsCountOperationResponse, err error) {
	opts := client.RequestOptions{
		...
		Path:          fmt.Sprintf("%s/usageRights/$count", id.ID()),
