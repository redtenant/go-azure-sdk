...
func (c DeviceUsageRightClient) ListDeviceUsageRights(ctx context.Context, id beta.MeDeviceId, options ListDeviceUsageRightsOperationOptions) (result ListDeviceUsageRightsOperationResponse, err error) {
...
func (c DeviceUsageRightClient) ListDeviceUsageRightsComplete(ctx context.Context, id beta.MeDeviceId, options ListDeviceUsageRightsOperationOptions) (ListDeviceUsageRightsCompleteResult, error) {
