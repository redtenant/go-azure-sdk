...
func DefaultUpdateDeviceUsageRightOperationOptions() UpdateDeviceUsageRightOperationOptions {
	return UpdateDeviceUsageRightOperationOptions{}
}
...
func (c DeviceUsageRightClient) UpdateDeviceUsageRight(ctx context.Context, id beta.MeDeviceIdUsageRightId, input beta.UsageRight, options UpdateDeviceUsageRightOperationOptions) (result UpdateDeviceUsageRightOperationResponse, err error) {
