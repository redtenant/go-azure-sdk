...
// GetDirectReport - Get directReports from me. The users and contacts that report to the user. (The users and contacts
// with their manager property set to this user.) Read-only. Nullable. Supports $expand.
func (c DirectReportClient) GetDirectReport(ctx context.Context, id beta.MeDirectReportId, options GetDirectReportOperationOptions) (result GetDirectReportOperationResponse, err error) {
