...
// CreateDriveActivity - Create new navigation property to activities for me
func (c DriveActivityClient) CreateDriveActivity(ctx context.Context, id beta.MeDriveId, input beta.ItemActivityOLD, options CreateDriveActivityOperationOptions) (result CreateDriveActivityOperationResponse, err error) {
