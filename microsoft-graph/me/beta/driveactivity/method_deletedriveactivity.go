...
// DeleteDriveActivity - Delete navigation property activities for me
func (c DriveActivityClient) DeleteDriveActivity(ctx context.Context, id beta.MeDriveIdActivityId, options DeleteDriveActivityOperationOptions) (result DeleteDriveActivityOperationResponse, err error) {
