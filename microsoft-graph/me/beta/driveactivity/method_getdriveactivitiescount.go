...
func (c DriveActivityClient) GetDriveActivitiesCount(ctx context.Context, id beta.MeDriveId, options GetDriveActivitiesCountOperationOptions) (result GetDriveActivitiesCountOperationResponse, err error) {
