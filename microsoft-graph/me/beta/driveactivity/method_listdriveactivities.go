...
// ListDriveActivities - Get activities from me. The list of recent activities that took place under this drive.
func (c DriveActivityClient) ListDriveActivities(ctx context.Context, id beta.MeDriveId, options ListDriveActivitiesOperationOptions) (result ListDriveActivitiesOperationResponse, err error) {
...
func (c DriveActivityClient) ListDriveActivitiesComplete(ctx context.Context, id beta.MeDriveId, options ListDriveActivitiesOperationOptions) (ListDriveActivitiesCompleteResult, error) {
...
func (c DriveActivityClient) ListDriveActivitiesCompleteMatchingPredicate(ctx context.Context, id beta.MeDriveId, options ListDriveActivitiesOperationOptions, predicate ItemActivityOLDOperationPredicate) (result ListDriveActivitiesCompleteResult, err error) {
