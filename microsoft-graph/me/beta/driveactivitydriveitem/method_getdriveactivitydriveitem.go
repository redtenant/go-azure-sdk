...
// GetDriveActivityDriveItem - Get driveItem from me
func (c DriveActivityDriveItemClient) GetDriveActivityDriveItem(ctx context.Context, id beta.MeDriveIdActivityId, options GetDriveActivityDriveItemOperationOptions) (result GetDriveActivityDriveItemOperationResponse, err error) {
