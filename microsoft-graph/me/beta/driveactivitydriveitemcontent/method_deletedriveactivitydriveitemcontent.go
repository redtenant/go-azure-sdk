...
// DeleteDriveActivityDriveItemContent - Delete content for the navigation property driveItem in me. The content stream,
...
func (c DriveActivityDriveItemContentClient) DeleteDriveActivityDriveItemContent(ctx context.Context, id beta.MeDriveIdActivityId, options DeleteDriveActivityDriveItemContentOperationOptions) (result DeleteDriveActivityDriveItemContentOperationResponse, err error) {
