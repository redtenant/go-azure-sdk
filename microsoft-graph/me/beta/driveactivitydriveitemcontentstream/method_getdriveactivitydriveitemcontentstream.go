...
// GetDriveActivityDriveItemContentStream - Get contentStream for the navigation property driveItem from me. The content
// stream, if the item represents a file.
func (c DriveActivityDriveItemContentStreamClient) GetDriveActivityDriveItemContentStream(ctx context.Context, id beta.MeDriveIdActivityId, options GetDriveActivityDriveItemContentStreamOperationOptions) (result GetDriveActivityDriveItemContentStreamOperationResponse, err error) {
