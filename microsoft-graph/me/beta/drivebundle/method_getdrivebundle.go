...
// personal OneDrive.
func (c DriveBundleClient) GetDriveBundle(ctx context.Context, id beta.MeDriveIdBundleId, options GetDriveBundleOperationOptions) (result GetDriveBundleOperationResponse, err error) {
