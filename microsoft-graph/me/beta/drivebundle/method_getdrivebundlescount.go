...
func (c DriveBundleClient) GetDriveBundlesCount(ctx context.Context, id beta.MeDriveId, options GetDriveBundlesCountOperationOptions) (result GetDriveBundlesCountOperationResponse, err error) {
