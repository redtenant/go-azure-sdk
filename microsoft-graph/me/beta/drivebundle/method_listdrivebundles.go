...
// personal OneDrive.
func (c DriveBundleClient) ListDriveBundles(ctx context.Context, id beta.MeDriveId, options ListDriveBundlesOperationOptions) (result ListDriveBundlesOperationResponse, err error) {
...
func (c DriveBundleClient) ListDriveBundlesComplete(ctx context.Context, id beta.MeDriveId, options ListDriveBundlesOperationOptions) (ListDriveBundlesCompleteResult, error) {
...
func (c DriveBundleClient) ListDriveBundlesCompleteMatchingPredicate(ctx context.Context, id beta.MeDriveId, options ListDriveBundlesOperationOptions, predicate DriveItemOperationPredicate) (result ListDriveBundlesCompleteResult, err error) {
