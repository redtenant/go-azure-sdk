...
func (c DriveBundleContentClient) DeleteDriveBundleContent(ctx context.Context, id beta.MeDriveIdBundleId, options DeleteDriveBundleContentOperationOptions) (result DeleteDriveBundleContentOperationResponse, err error) {
