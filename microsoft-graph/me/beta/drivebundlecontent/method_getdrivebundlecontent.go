...
func (c DriveBundleContentClient) GetDriveBundleContent(ctx context.Context, id beta.MeDriveIdBundleId, options GetDriveBundleContentOperationOptions) (result GetDriveBundleContentOperationResponse, err error) {
