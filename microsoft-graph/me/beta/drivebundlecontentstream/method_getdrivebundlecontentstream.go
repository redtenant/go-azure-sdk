...
// GetDriveBundleContentStream - Get contentStream for the navigation property bundles from me. The content stream, if
// the item represents a file.
func (c DriveBundleContentStreamClient) GetDriveBundleContentStream(ctx context.Context, id beta.MeDriveIdBundleId, options GetDriveBundleContentStreamOperationOptions) (result GetDriveBundleContentStreamOperationResponse, err error) {
