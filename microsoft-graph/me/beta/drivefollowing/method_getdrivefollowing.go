...
func (c DriveFollowingClient) GetDriveFollowing(ctx context.Context, id beta.MeDriveIdFollowingId, options GetDriveFollowingOperationOptions) (result GetDriveFollowingOperationResponse, err error) {
