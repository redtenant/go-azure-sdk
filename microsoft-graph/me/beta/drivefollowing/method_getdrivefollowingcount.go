...
func (c DriveFollowingClient) GetDriveFollowingCount(ctx context.Context, id beta.MeDriveId, options GetDriveFollowingCountOperationOptions) (result GetDriveFollowingCountOperationResponse, err error) {
