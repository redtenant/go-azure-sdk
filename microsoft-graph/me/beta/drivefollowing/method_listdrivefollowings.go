...
func (c DriveFollowingClient) ListDriveFollowings(ctx context.Context, id beta.MeDriveId, options ListDriveFollowingsOperationOptions) (result ListDriveFollowingsOperationResponse, err error) {
...
func (c DriveFollowingClient) ListDriveFollowingsComplete(ctx context.Context, id beta.MeDriveId, options ListDriveFollowingsOperationOptions) (ListDriveFollowingsCompleteResult, error) {
...
func (c DriveFollowingClient) ListDriveFollowingsCompleteMatchingPredicate(ctx context.Context, id beta.MeDriveId, options ListDriveFollowingsOperationOptions, predicate DriveItemOperationPredicate) (result ListDriveFollowingsCompleteResult, err error) {
