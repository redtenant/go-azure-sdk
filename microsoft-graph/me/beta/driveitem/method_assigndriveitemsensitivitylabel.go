...
func (c DriveItemClient) AssignDriveItemSensitivityLabel(ctx context.Context, id beta.MeDriveIdItemId, input AssignDriveItemSensitivityLabelRequest, options AssignDriveItemSensitivityLabelOperationOptions) (result AssignDriveItemSensitivityLabelOperationResponse, err error) {
