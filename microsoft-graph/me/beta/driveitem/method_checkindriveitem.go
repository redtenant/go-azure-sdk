...
func (c DriveItemClient) CheckinDriveItem(ctx context.Context, id beta.MeDriveIdItemId, input CheckinDriveItemRequest, options CheckinDriveItemOperationOptions) (result CheckinDriveItemOperationResponse, err error) {
