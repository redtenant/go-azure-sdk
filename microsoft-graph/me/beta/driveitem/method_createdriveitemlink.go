...
func (c DriveItemClient) CreateDriveItemLink(ctx context.Context, id beta.MeDriveIdItemId, input CreateDriveItemLinkRequest, options CreateDriveItemLinkOperationOptions) (result CreateDriveItemLinkOperationResponse, err error) {
