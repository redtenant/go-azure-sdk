...
func (c DriveItemClient) CreateDriveItemPermanentDelete(ctx context.Context, id beta.MeDriveIdItemId, options CreateDriveItemPermanentDeleteOperationOptions) (result CreateDriveItemPermanentDeleteOperationResponse, err error) {
