...
func (c DriveItemClient) DeleteDriveItem(ctx context.Context, id beta.MeDriveIdItemId, options DeleteDriveItemOperationOptions) (result DeleteDriveItemOperationResponse, err error) {
