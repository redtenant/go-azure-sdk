...
// permissions.
func (c DriveItemClient) DiscardDriveItemCheckout(ctx context.Context, id beta.MeDriveIdItemId, options DiscardDriveItemCheckoutOperationOptions) (result DiscardDriveItemCheckoutOperationResponse, err error) {
