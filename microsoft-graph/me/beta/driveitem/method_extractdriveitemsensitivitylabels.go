...
func (c DriveItemClient) ExtractDriveItemSensitivityLabels(ctx context.Context, id beta.MeDriveIdItemId, options ExtractDriveItemSensitivityLabelsOperationOptions) (result ExtractDriveItemSensitivityLabelsOperationResponse, err error) {
