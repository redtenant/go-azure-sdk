...
func (c DriveItemClient) FollowDriveItem(ctx context.Context, id beta.MeDriveIdItemId, options FollowDriveItemOperationOptions) (result FollowDriveItemOperationResponse, err error) {
