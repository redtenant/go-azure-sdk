...
func (c DriveItemClient) GetDriveItem(ctx context.Context, id beta.MeDriveIdItemId, options GetDriveItemOperationOptions) (result GetDriveItemOperationResponse, err error) {
