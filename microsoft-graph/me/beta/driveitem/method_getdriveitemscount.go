...
func (c DriveItemClient) GetDriveItemsCount(ctx context.Context, id beta.MeDriveId, options GetDriveItemsCountOperationOptions) (result GetDriveItemsCountOperationResponse, err error) {
