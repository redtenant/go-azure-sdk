...
// shared.
func (c DriveItemClient) ListDriveItemInvites(ctx context.Context, id beta.MeDriveIdItemId, input ListDriveItemInvitesRequest, options ListDriveItemInvitesOperationOptions) (result ListDriveItemInvitesOperationResponse, err error) {
...
func (c DriveItemClient) ListDriveItemInvitesComplete(ctx context.Context, id beta.MeDriveIdItemId, input ListDriveItemInvitesRequest, options ListDriveItemInvitesOperationOptions) (ListDriveItemInvitesCompleteResult, error) {
...
func (c DriveItemClient) ListDriveItemInvitesCompleteMatchingPredicate(ctx context.Context, id beta.MeDriveIdItemId, input ListDriveItemInvitesRequest, options ListDriveItemInvitesOperationOptions, predicate PermissionOperationPredicate) (result ListDriveItemInvitesCompleteResult, err error) {
