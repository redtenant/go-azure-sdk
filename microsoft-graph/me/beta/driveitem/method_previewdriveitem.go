...
func (c DriveItemClient) PreviewDriveItem(ctx context.Context, id beta.MeDriveIdItemId, input PreviewDriveItemRequest, options PreviewDriveItemOperationOptions) (result PreviewDriveItemOperationResponse, err error) {
