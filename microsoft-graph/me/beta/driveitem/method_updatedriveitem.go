...
func (c DriveItemClient) UpdateDriveItem(ctx context.Context, id beta.MeDriveIdItemId, input beta.DriveItem, options UpdateDriveItemOperationOptions) (result UpdateDriveItemOperationResponse, err error) {
