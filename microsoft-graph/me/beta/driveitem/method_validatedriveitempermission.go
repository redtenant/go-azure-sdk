...
func (c DriveItemClient) ValidateDriveItemPermission(ctx context.Context, id beta.MeDriveIdItemId, input ValidateDriveItemPermissionRequest, options ValidateDriveItemPermissionOperationOptions) (result ValidateDriveItemPermissionOperationResponse, err error) {
