...
func (c DriveItemAnalyticsClient) UpdateDriveItemAnalytic(ctx context.Context, id beta.MeDriveIdItemId, input beta.ItemAnalytics, options UpdateDriveItemAnalyticOperationOptions) (result UpdateDriveItemAnalyticOperationResponse, err error) {
