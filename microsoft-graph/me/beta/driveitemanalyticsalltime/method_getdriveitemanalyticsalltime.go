...
func (c DriveItemAnalyticsAllTimeClient) GetDriveItemAnalyticsAllTime(ctx context.Context, id beta.MeDriveIdItemId, options GetDriveItemAnalyticsAllTimeOperationOptions) (result GetDriveItemAnalyticsAllTimeOperationResponse, err error) {
