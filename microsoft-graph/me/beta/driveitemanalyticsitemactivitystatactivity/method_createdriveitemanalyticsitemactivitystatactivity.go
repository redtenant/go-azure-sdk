...
func (c DriveItemAnalyticsItemActivityStatActivityClient) CreateDriveItemAnalyticsItemActivityStatActivity(ctx context.Context, id beta.MeDriveIdItemIdAnalyticsItemActivityStatId, input beta.ItemActivity, options CreateDriveItemAnalyticsItemActivityStatActivityOperationOptions) (result CreateDriveItemAnalyticsItemActivityStatActivityOperationResponse, err error) {
