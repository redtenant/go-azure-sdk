...
func (c DriveItemAnalyticsItemActivityStatActivityClient) GetDriveItemAnalyticsItemActivityStatActivitiesCount(ctx context.Context, id beta.MeDriveIdItemIdAnalyticsItemActivityStatId, options GetDriveItemAnalyticsItemActivityStatActivitiesCountOperationOptions) (result GetDriveItemAnalyticsItemActivityStatActivitiesCountOperationResponse, err error) {
