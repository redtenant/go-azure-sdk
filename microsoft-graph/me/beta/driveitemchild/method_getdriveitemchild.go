...
func (c DriveItemChildClient) GetDriveItemChild(ctx context.Context, id beta.MeDriveIdItemIdChildId, options GetDriveItemChildOperationOptions) (result GetDriveItemChildOperationResponse, err error) {
