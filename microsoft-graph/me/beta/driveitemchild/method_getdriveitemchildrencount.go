...
func (c DriveItemChildClient) GetDriveItemChildrenCount(ctx context.Context, id beta.MeDriveIdItemId, options GetDriveItemChildrenCountOperationOptions) (result GetDriveItemChildrenCountOperationResponse, err error) {
