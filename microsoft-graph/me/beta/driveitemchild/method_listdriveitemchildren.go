...
func (c DriveItemChildClient) ListDriveItemChildren(ctx context.Context, id beta.MeDriveIdItemId, options ListDriveItemChildrenOperationOptions) (result ListDriveItemChildrenOperationResponse, err error) {
...
func (c DriveItemChildClient) ListDriveItemChildrenComplete(ctx context.Context, id beta.MeDriveIdItemId, options ListDriveItemChildrenOperationOptions) (ListDriveItemChildrenCompleteResult, error) {
...
func (c DriveItemChildClient) ListDriveItemChildrenCompleteMatchingPredicate(ctx context.Context, id beta.MeDriveIdItemId, options ListDriveItemChildrenOperationOptions, predicate DriveItemOperationPredicate) (result ListDriveItemChildrenCompleteResult, err error) {
