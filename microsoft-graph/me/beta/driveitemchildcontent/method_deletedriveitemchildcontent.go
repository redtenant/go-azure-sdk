...
// DeleteDriveItemChildContent - Delete content for the navigation property children in me. The content stream, if the
...
func (c DriveItemChildContentClient) DeleteDriveItemChildContent(ctx context.Context, id beta.MeDriveIdItemIdChildId, options DeleteDriveItemChildContentOperationOptions) (result DeleteDriveItemChildContentOperationResponse, err error) {
