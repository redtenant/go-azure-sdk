...
// SetDriveItemChildContent - Update content for the navigation property children in me. The content stream, if the item
...
func (c DriveItemChildContentClient) SetDriveItemChildContent(ctx context.Context, id beta.MeDriveIdItemIdChildId, input []byte, options SetDriveItemChildContentOperationOptions) (result SetDriveItemChildContentOperationResponse, err error) {
