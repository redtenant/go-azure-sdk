...
// DeleteDriveItemChildContentStream - Delete contentStream for the navigation property children in me. The content
// stream, if the item represents a file.
func (c DriveItemChildContentStreamClient) DeleteDriveItemChildContentStream(ctx context.Context, id beta.MeDriveIdItemIdChildId, options DeleteDriveItemChildContentStreamOperationOptions) (result DeleteDriveItemChildContentStreamOperationResponse, err error) {
