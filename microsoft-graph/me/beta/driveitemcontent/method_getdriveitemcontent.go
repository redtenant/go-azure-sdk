...
func (c DriveItemContentClient) GetDriveItemContent(ctx context.Context, id beta.MeDriveIdItemId, options GetDriveItemContentOperationOptions) (result GetDriveItemContentOperationResponse, err error) {
