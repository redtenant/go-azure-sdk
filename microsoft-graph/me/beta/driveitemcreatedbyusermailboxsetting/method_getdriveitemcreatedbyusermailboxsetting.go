...
func (c DriveItemCreatedByUserMailboxSettingClient) GetDriveItemCreatedByUserMailboxSetting(ctx context.Context, id beta.MeDriveIdItemId, options GetDriveItemCreatedByUserMailboxSettingOperationOptions) (result GetDriveItemCreatedByUserMailboxSettingOperationResponse, err error) {
