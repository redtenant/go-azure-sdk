...
func (c DriveItemListItemClient) DeleteDriveItemListItem(ctx context.Context, id beta.MeDriveIdItemId, options DeleteDriveItemListItemOperationOptions) (result DeleteDriveItemListItemOperationResponse, err error) {
