...
// GetDriveItemListItem - Get listItem from me. For drives in SharePoint, the associated document library list item.
// Read-only. Nullable.
func (c DriveItemListItemClient) GetDriveItemListItem(ctx context.Context, id beta.MeDriveIdItemId, options GetDriveItemListItemOperationOptions) (result GetDriveItemListItemOperationResponse, err error) {
