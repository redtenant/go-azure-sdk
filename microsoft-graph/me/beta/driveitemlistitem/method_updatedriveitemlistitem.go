...
func (c DriveItemListItemClient) UpdateDriveItemListItem(ctx context.Context, id beta.MeDriveIdItemId, input beta.ListItem, options UpdateDriveItemListItemOperationOptions) (result UpdateDriveItemListItemOperationResponse, err error) {
