...
// DeleteDriveItemListItemActivity - Delete navigation property activities for me
func (c DriveItemListItemActivityClient) DeleteDriveItemListItemActivity(ctx context.Context, id beta.MeDriveIdItemIdListItemActivityId, options DeleteDriveItemListItemActivityOperationOptions) (result DeleteDriveItemListItemActivityOperationResponse, err error) {
