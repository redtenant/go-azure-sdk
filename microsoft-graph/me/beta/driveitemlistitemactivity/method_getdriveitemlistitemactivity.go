...
// GetDriveItemListItemActivity - Get activities from me. The list of recent activities that took place on this item.
func (c DriveItemListItemActivityClient) GetDriveItemListItemActivity(ctx context.Context, id beta.MeDriveIdItemIdListItemActivityId, options GetDriveItemListItemActivityOperationOptions) (result GetDriveItemListItemActivityOperationResponse, err error) {
