...
// GetDriveItemListItemActivityContent - Get content for the navigation property driveItem from me. The content stream,
...
func (c DriveItemListItemActivityDriveItemContentClient) GetDriveItemListItemActivityContent(ctx context.Context, id beta.MeDriveIdItemIdListItemActivityId, options GetDriveItemListItemActivityContentOperationOptions) (result GetDriveItemListItemActivityContentOperationResponse, err error) {
