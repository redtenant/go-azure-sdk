...
// GetDriveItemListItemCreatedByUser - Get createdByUser from me
func (c DriveItemListItemCreatedByUserClient) GetDriveItemListItemCreatedByUser(ctx context.Context, id beta.MeDriveIdItemId, options GetDriveItemListItemCreatedByUserOperationOptions) (result GetDriveItemListItemCreatedByUserOperationResponse, err error) {
