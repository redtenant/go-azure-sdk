...
// on $select.
func (c DriveItemListItemCreatedByUserMailboxSettingClient) GetDriveItemListItemCreatedByUserMailboxSetting(ctx context.Context, id beta.MeDriveIdItemId, options GetDriveItemListItemCreatedByUserMailboxSettingOperationOptions) (result GetDriveItemListItemCreatedByUserMailboxSettingOperationResponse, err error) {
