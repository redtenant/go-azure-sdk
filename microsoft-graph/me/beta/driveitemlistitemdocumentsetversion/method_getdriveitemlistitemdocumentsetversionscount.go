...
func (c DriveItemListItemDocumentSetVersionClient) GetDriveItemListItemDocumentSetVersionsCount(ctx context.Context, id beta.MeDriveIdItemId, options GetDriveItemListItemDocumentSetVersionsCountOperationOptions) (result GetDriveItemListItemDocumentSetVersionsCountOperationResponse, err error) {
