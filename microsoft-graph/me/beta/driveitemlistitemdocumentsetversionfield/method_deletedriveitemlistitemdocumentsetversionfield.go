...
func (c DriveItemListItemDocumentSetVersionFieldClient) DeleteDriveItemListItemDocumentSetVersionField(ctx context.Context, id beta.MeDriveIdItemIdListItemDocumentSetVersionId, options DeleteDriveItemListItemDocumentSetVersionFieldOperationOptions) (result DeleteDriveItemListItemDocumentSetVersionFieldOperationResponse, err error) {
