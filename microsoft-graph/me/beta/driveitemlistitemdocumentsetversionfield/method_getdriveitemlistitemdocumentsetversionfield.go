...
// GetDriveItemListItemDocumentSetVersionField - Get fields from me. A collection of the fields and values for this
// version of the list item.
func (c DriveItemListItemDocumentSetVersionFieldClient) GetDriveItemListItemDocumentSetVersionField(ctx context.Context, id beta.MeDriveIdItemIdListItemDocumentSetVersionId, options GetDriveItemListItemDocumentSetVersionFieldOperationOptions) (result GetDriveItemListItemDocumentSetVersionFieldOperationResponse, err error) {
