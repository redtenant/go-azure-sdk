...
func (c DriveItemListItemDriveItemContentClient) GetDriveItemListItemDriveItemContent(ctx context.Context, id beta.MeDriveIdItemId, options GetDriveItemListItemDriveItemContentOperationOptions) (result GetDriveItemListItemDriveItemContentOperationResponse, err error) {
