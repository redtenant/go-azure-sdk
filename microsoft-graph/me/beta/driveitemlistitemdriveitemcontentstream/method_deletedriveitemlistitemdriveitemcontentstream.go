...
// DeleteDriveItemListItemDriveItemContentStream - Delete contentStream for the navigation property driveItem in me. The
// content stream, if the item represents a file.
func (c DriveItemListItemDriveItemContentStreamClient) DeleteDriveItemListItemDriveItemContentStream(ctx context.Context, id beta.MeDriveIdItemId, options DeleteDriveItemListItemDriveItemContentStreamOperationOptions) (result DeleteDriveItemListItemDriveItemContentStreamOperationResponse, err error) {
