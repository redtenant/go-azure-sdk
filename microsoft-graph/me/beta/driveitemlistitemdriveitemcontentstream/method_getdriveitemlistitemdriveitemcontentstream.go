...
// GetDriveItemListItemDriveItemContentStream - Get contentStream for the navigation property driveItem from me. The
// content stream, if the item represents a file.
func (c DriveItemListItemDriveItemContentStreamClient) GetDriveItemListItemDriveItemContentStream(ctx context.Context, id beta.MeDriveIdItemId, options GetDriveItemListItemDriveItemContentStreamOperationOptions) (result GetDriveItemListItemDriveItemContentStreamOperationResponse, err error) {
