...
// SetDriveItemListItemDriveItemContentStream - Update contentStream for the navigation property driveItem in me. The
// content stream, if the item represents a file.
func (c DriveItemListItemDriveItemContentStreamClient) SetDriveItemListItemDriveItemContentStream(ctx context.Context, id beta.MeDriveIdItemId, input []byte, options SetDriveItemListItemDriveItemContentStreamOperationOptions) (result SetDriveItemListItemDriveItemContentStreamOperationResponse, err error) {
