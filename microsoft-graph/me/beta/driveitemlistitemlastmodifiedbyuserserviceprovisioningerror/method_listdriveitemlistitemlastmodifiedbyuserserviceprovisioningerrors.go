...
func (c DriveItemListItemLastModifiedByUserServiceProvisioningErrorClient) ListDriveItemListItemLastModifiedByUserServiceProvisioningErrors(ctx context.Context, id beta.MeDriveIdItemId, options ListDriveItemListItemLastModifiedByUserServiceProvisioningErrorsOperationOptions) (result ListDriveItemListItemLastModifiedByUserServiceProvisioningErrorsOperationResponse, err error) {
...
func (c DriveItemListItemLastModifiedByUserServiceProvisioningErrorClient) ListDriveItemListItemLastModifiedByUserServiceProvisioningErrorsComplete(ctx context.Context, id beta.MeDriveIdItemId, options ListDriveItemListItemLastModifiedByUserServiceProvisioningErrorsOperationOptions) (ListDriveItemListItemLastModifiedByUserServiceProvisioningErrorsCompleteResult, error) {
...
func (c DriveItemListItemLastModifiedByUserServiceProvisioningErrorClient) ListDriveItemListItemLastModifiedByUserServiceProvisioningErrorsCompleteMatchingPredicate(ctx context.Context, id beta.MeDriveIdItemId, options ListDriveItemListItemLastModifiedByUserServiceProvisioningErrorsOperationOptions, predicate ServiceProvisioningErrorOperationPredicate) (result ListDriveItemListItemLastModifiedByUserServiceProvisioningErrorsCompleteResult, err error) {
