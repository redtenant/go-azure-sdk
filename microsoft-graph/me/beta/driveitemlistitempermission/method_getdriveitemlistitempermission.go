...
// GetDriveItemListItemPermission - Get permissions from me. The set of permissions for the item. Read-only. Nullable.
func (c DriveItemListItemPermissionClient) GetDriveItemListItemPermission(ctx context.Context, id beta.MeDriveIdItemIdListItemPermissionId, options GetDriveItemListItemPermissionOperationOptions) (result GetDriveItemListItemPermissionOperationResponse, err error) {
