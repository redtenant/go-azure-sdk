...
func (c DriveItemListItemPermissionClient) ListDriveItemListItemPermissionGrantsComplete(ctx context.Context, id beta.MeDriveIdItemIdListItemPermissionId, input ListDriveItemListItemPermissionGrantsRequest, options ListDriveItemListItemPermissionGrantsOperationOptions) (ListDriveItemListItemPermissionGrantsCompleteResult, error) {
