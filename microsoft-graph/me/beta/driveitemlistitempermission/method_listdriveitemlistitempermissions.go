...
// ListDriveItemListItemPermissions - Get permissions from me. The set of permissions for the item. Read-only. Nullable.
func (c DriveItemListItemPermissionClient) ListDriveItemListItemPermissions(ctx context.Context, id beta.MeDriveIdItemId, options ListDriveItemListItemPermissionsOperationOptions) (result ListDriveItemListItemPermissionsOperationResponse, err error) {
...
func (c DriveItemListItemPermissionClient) ListDriveItemListItemPermissionsComplete(ctx context.Context, id beta.MeDriveIdItemId, options ListDriveItemListItemPermissionsOperationOptions) (ListDriveItemListItemPermissionsCompleteResult, error) {
...
func (c DriveItemListItemPermissionClient) ListDriveItemListItemPermissionsCompleteMatchingPredicate(ctx context.Context, id beta.MeDriveIdItemId, options ListDriveItemListItemPermissionsOperationOptions, predicate PermissionOperationPredicate) (result ListDriveItemListItemPermissionsCompleteResult, err error) {
