...
func (c DriveItemListItemPermissionClient) RevokeDriveItemListItemPermissionGrants(ctx context.Context, id beta.MeDriveIdItemIdListItemPermissionId, input RevokeDriveItemListItemPermissionGrantsRequest, options RevokeDriveItemListItemPermissionGrantsOperationOptions) (result RevokeDriveItemListItemPermissionGrantsOperationResponse, err error) {
