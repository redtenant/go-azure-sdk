...
// UpdateDriveItemListItemPermission - Update the navigation property permissions in me
func (c DriveItemListItemPermissionClient) UpdateDriveItemListItemPermission(ctx context.Context, id beta.MeDriveIdItemIdListItemPermissionId, input beta.Permission, options UpdateDriveItemListItemPermissionOperationOptions) (result UpdateDriveItemListItemPermissionOperationResponse, err error) {
