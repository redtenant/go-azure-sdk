...
func (c DriveItemListItemVersionClient) DeleteDriveItemListItemVersion(ctx context.Context, id beta.MeDriveIdItemIdListItemVersionId, options DeleteDriveItemListItemVersionOperationOptions) (result DeleteDriveItemListItemVersionOperationResponse, err error) {
