...
func (c DriveItemListItemVersionClient) GetDriveItemListItemVersion(ctx context.Context, id beta.MeDriveIdItemIdListItemVersionId, options GetDriveItemListItemVersionOperationOptions) (result GetDriveItemListItemVersionOperationResponse, err error) {
