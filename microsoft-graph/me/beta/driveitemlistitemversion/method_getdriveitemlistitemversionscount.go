...
func (c DriveItemListItemVersionClient) GetDriveItemListItemVersionsCount(ctx context.Context, id beta.MeDriveIdItemId, options GetDriveItemListItemVersionsCountOperationOptions) (result GetDriveItemListItemVersionsCountOperationResponse, err error) {
