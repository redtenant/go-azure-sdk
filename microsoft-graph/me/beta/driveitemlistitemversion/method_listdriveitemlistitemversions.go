...
func (c DriveItemListItemVersionClient) ListDriveItemListItemVersions(ctx context.Context, id beta.MeDriveIdItemId, options ListDriveItemListItemVersionsOperationOptions) (result ListDriveItemListItemVersionsOperationResponse, err error) {
...
func (c DriveItemListItemVersionClient) ListDriveItemListItemVersionsComplete(ctx context.Context, id beta.MeDriveIdItemId, options ListDriveItemListItemVersionsOperationOptions) (ListDriveItemListItemVersionsCompleteResult, error) {
...
func (c DriveItemListItemVersionClient) ListDriveItemListItemVersionsCompleteMatchingPredicate(ctx context.Context, id beta.MeDriveIdItemId, options ListDriveItemListItemVersionsOperationOptions, predicate ListItemVersionOperationPredicate) (result ListDriveItemListItemVersionsCompleteResult, err error) {
