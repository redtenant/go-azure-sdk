...
func (c DriveItemListItemVersionClient) UpdateDriveItemListItemVersion(ctx context.Context, id beta.MeDriveIdItemIdListItemVersionId, input beta.ListItemVersion, options UpdateDriveItemListItemVersionOperationOptions) (result UpdateDriveItemListItemVersionOperationResponse, err error) {
