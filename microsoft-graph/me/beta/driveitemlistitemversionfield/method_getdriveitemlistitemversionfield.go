...
// list item.
func (c DriveItemListItemVersionFieldClient) GetDriveItemListItemVersionField(ctx context.Context, id beta.MeDriveIdItemIdListItemVersionId, options GetDriveItemListItemVersionFieldOperationOptions) (result GetDriveItemListItemVersionFieldOperationResponse, err error) {
