...
func (c DriveItemPermissionClient) CreateDriveItemPermission(ctx context.Context, id beta.MeDriveIdItemId, input beta.Permission, options CreateDriveItemPermissionOperationOptions) (result CreateDriveItemPermissionOperationResponse, err error) {
