...
func (c DriveItemPermissionClient) DeleteDriveItemPermission(ctx context.Context, id beta.MeDriveIdItemIdPermissionId, options DeleteDriveItemPermissionOperationOptions) (result DeleteDriveItemPermissionOperationResponse, err error) {
