...
func (c DriveItemPermissionClient) GetDriveItemPermission(ctx context.Context, id beta.MeDriveIdItemIdPermissionId, options GetDriveItemPermissionOperationOptions) (result GetDriveItemPermissionOperationResponse, err error) {
