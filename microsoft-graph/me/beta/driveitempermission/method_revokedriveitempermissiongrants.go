...
func (c DriveItemPermissionClient) RevokeDriveItemPermissionGrants(ctx context.Context, id beta.MeDriveIdItemIdPermissionId, input RevokeDriveItemPermissionGrantsRequest, options RevokeDriveItemPermissionGrantsOperationOptions) (result RevokeDriveItemPermissionGrantsOperationResponse, err error) {
