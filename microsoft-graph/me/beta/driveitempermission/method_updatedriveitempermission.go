...
func (c DriveItemPermissionClient) UpdateDriveItemPermission(ctx context.Context, id beta.MeDriveIdItemIdPermissionId, input beta.Permission, options UpdateDriveItemPermissionOperationOptions) (result UpdateDriveItemPermissionOperationResponse, err error) {
