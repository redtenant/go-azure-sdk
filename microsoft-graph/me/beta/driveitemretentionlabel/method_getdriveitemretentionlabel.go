...
func (c DriveItemRetentionLabelClient) GetDriveItemRetentionLabel(ctx context.Context, id beta.MeDriveIdItemId, options GetDriveItemRetentionLabelOperationOptions) (result GetDriveItemRetentionLabelOperationResponse, err error) {
