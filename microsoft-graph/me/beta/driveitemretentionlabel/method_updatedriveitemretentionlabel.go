...
func (c DriveItemRetentionLabelClient) UpdateDriveItemRetentionLabel(ctx context.Context, id beta.MeDriveIdItemId, input beta.ItemRetentionLabel, options UpdateDriveItemRetentionLabelOperationOptions) (result UpdateDriveItemRetentionLabelOperationResponse, err error) {
