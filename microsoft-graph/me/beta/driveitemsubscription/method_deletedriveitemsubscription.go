...
func (c DriveItemSubscriptionClient) DeleteDriveItemSubscription(ctx context.Context, id beta.MeDriveIdItemIdSubscriptionId, options DeleteDriveItemSubscriptionOperationOptions) (result DeleteDriveItemSubscriptionOperationResponse, err error) {
