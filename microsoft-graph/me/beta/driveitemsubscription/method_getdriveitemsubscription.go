...
// root of a drive.
func (c DriveItemSubscriptionClient) GetDriveItemSubscription(ctx context.Context, id beta.MeDriveIdItemIdSubscriptionId, options GetDriveItemSubscriptionOperationOptions) (result GetDriveItemSubscriptionOperationResponse, err error) {
