...
// root of a drive.
func (c DriveItemSubscriptionClient) ListDriveItemSubscriptions(ctx context.Context, id beta.MeDriveIdItemId, options ListDriveItemSubscriptionsOperationOptions) (result ListDriveItemSubscriptionsOperationResponse, err error) {
...
func (c DriveItemSubscriptionClient) ListDriveItemSubscriptionsComplete(ctx context.Context, id beta.MeDriveIdItemId, options ListDriveItemSubscriptionsOperationOptions) (ListDriveItemSubscriptionsCompleteResult, error) {
...
func (c DriveItemSubscriptionClient) ListDriveItemSubscriptionsCompleteMatchingPredicate(ctx context.Context, id beta.MeDriveIdItemId, options ListDriveItemSubscriptionsOperationOptions, predicate SubscriptionOperationPredicate) (result ListDriveItemSubscriptionsCompleteResult, err error) {
