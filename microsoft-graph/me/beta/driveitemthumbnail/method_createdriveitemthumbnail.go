...
func (c DriveItemThumbnailClient) CreateDriveItemThumbnail(ctx context.Context, id beta.MeDriveIdItemId, input beta.ThumbnailSet, options CreateDriveItemThumbnailOperationOptions) (result CreateDriveItemThumbnailOperationResponse, err error) {
