...
func (c DriveItemThumbnailClient) GetDriveItemThumbnail(ctx context.Context, id beta.MeDriveIdItemIdThumbnailId, options GetDriveItemThumbnailOperationOptions) (result GetDriveItemThumbnailOperationResponse, err error) {
