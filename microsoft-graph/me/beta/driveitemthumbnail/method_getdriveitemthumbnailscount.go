...
func (c DriveItemThumbnailClient) GetDriveItemThumbnailsCount(ctx context.Context, id beta.MeDriveIdItemId, options GetDriveItemThumbnailsCountOperationOptions) (result GetDriveItemThumbnailsCountOperationResponse, err error) {
