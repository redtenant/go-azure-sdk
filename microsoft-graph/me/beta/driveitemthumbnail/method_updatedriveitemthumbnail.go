...
func (c DriveItemThumbnailClient) UpdateDriveItemThumbnail(ctx context.Context, id beta.MeDriveIdItemIdThumbnailId, input beta.ThumbnailSet, options UpdateDriveItemThumbnailOperationOptions) (result UpdateDriveItemThumbnailOperationResponse, err error) {
