...
func (c DriveItemVersionClient) DeleteDriveItemVersion(ctx context.Context, id beta.MeDriveIdItemIdVersionId, options DeleteDriveItemVersionOperationOptions) (result DeleteDriveItemVersionOperationResponse, err error) {
