...
func (c DriveItemVersionClient) GetDriveItemVersion(ctx context.Context, id beta.MeDriveIdItemIdVersionId, options GetDriveItemVersionOperationOptions) (result GetDriveItemVersionOperationResponse, err error) {
