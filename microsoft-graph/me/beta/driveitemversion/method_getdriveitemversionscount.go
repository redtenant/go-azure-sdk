...
func (c DriveItemVersionClient) GetDriveItemVersionsCount(ctx context.Context, id beta.MeDriveIdItemId, options GetDriveItemVersionsCountOperationOptions) (result GetDriveItemVersionsCountOperationResponse, err error) {
