...
// DeleteDriveItemVersionContent - Delete content for the navigation property versions in me
func (c DriveItemVersionContentClient) DeleteDriveItemVersionContent(ctx context.Context, id beta.MeDriveIdItemIdVersionId, options DeleteDriveItemVersionContentOperationOptions) (result DeleteDriveItemVersionContentOperationResponse, err error) {
