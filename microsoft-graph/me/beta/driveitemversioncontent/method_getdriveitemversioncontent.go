...
// GetDriveItemVersionContent - Get content for the navigation property versions from me
func (c DriveItemVersionContentClient) GetDriveItemVersionContent(ctx context.Context, id beta.MeDriveIdItemIdVersionId, options GetDriveItemVersionContentOperationOptions) (result GetDriveItemVersionContentOperationResponse, err error) {
