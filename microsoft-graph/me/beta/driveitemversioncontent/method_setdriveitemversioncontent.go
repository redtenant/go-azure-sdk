...
// SetDriveItemVersionContent - Update content for the navigation property versions in me
func (c DriveItemVersionContentClient) SetDriveItemVersionContent(ctx context.Context, id beta.MeDriveIdItemIdVersionId, input []byte, options SetDriveItemVersionContentOperationOptions) (result SetDriveItemVersionContentOperationResponse, err error) {
