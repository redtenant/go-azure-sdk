...
// GetDriveLastModifiedByUser - Get lastModifiedByUser from me
func (c DriveLastModifiedByUserClient) GetDriveLastModifiedByUser(ctx context.Context, id beta.MeDriveId, options GetDriveLastModifiedByUserOperationOptions) (result GetDriveLastModifiedByUserOperationResponse, err error) {
