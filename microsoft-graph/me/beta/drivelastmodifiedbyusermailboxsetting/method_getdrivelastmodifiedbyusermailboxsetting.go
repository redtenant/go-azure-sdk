...
func (c DriveLastModifiedByUserMailboxSettingClient) GetDriveLastModifiedByUserMailboxSetting(ctx context.Context, id beta.MeDriveId, options GetDriveLastModifiedByUserMailboxSettingOperationOptions) (result GetDriveLastModifiedByUserMailboxSettingOperationResponse, err error) {
