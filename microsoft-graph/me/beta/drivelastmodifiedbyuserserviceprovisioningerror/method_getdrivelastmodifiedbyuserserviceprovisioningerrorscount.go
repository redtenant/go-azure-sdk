...
func (c DriveLastModifiedByUserServiceProvisioningErrorClient) GetDriveLastModifiedByUserServiceProvisioningErrorsCount(ctx context.Context, id beta.MeDriveId, options GetDriveLastModifiedByUserServiceProvisioningErrorsCountOperationOptions) (result GetDriveLastModifiedByUserServiceProvisioningErrorsCountOperationResponse, err error) {
