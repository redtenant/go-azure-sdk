...
func (c DriveListClient) DeleteDriveList(ctx context.Context, id beta.MeDriveId, options DeleteDriveListOperationOptions) (result DeleteDriveListOperationResponse, err error) {
