...
func (c DriveListClient) GetDriveList(ctx context.Context, id beta.MeDriveId, options GetDriveListOperationOptions) (result GetDriveListOperationResponse, err error) {
