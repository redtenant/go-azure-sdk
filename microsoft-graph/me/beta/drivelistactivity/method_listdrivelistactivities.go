...
// ListDriveListActivities - Get activities from me. The recent activities that took place within this list.
func (c DriveListActivityClient) ListDriveListActivities(ctx context.Context, id beta.MeDriveId, options ListDriveListActivitiesOperationOptions) (result ListDriveListActivitiesOperationResponse, err error) {
...
func (c DriveListActivityClient) ListDriveListActivitiesComplete(ctx context.Context, id beta.MeDriveId, options ListDriveListActivitiesOperationOptions) (ListDriveListActivitiesCompleteResult, error) {
...
func (c DriveListActivityClient) ListDriveListActivitiesCompleteMatchingPredicate(ctx context.Context, id beta.MeDriveId, options ListDriveListActivitiesOperationOptions, predicate ItemActivityOLDOperationPredicate) (result ListDriveListActivitiesCompleteResult, err error) {
