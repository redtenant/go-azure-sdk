...
func (c DriveListColumnClient) DeleteDriveListColumn(ctx context.Context, id beta.MeDriveIdListColumnId, options DeleteDriveListColumnOperationOptions) (result DeleteDriveListColumnOperationResponse, err error) {
