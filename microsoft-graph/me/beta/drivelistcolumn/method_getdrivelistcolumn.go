...
func (c DriveListColumnClient) GetDriveListColumn(ctx context.Context, id beta.MeDriveIdListColumnId, options GetDriveListColumnOperationOptions) (result GetDriveListColumnOperationResponse, err error) {
