...
func (c DriveListColumnClient) GetDriveListColumnsCount(ctx context.Context, id beta.MeDriveId, options GetDriveListColumnsCountOperationOptions) (result GetDriveListColumnsCountOperationResponse, err error) {
