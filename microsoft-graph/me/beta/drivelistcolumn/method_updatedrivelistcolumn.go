...
func (c DriveListColumnClient) UpdateDriveListColumn(ctx context.Context, id beta.MeDriveIdListColumnId, input beta.ColumnDefinition, options UpdateDriveListColumnOperationOptions) (result UpdateDriveListColumnOperationResponse, err error) {
