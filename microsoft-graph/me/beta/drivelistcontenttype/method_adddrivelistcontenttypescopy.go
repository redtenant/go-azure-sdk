...
func (c DriveListContentTypeClient) AddDriveListContentTypesCopy(ctx context.Context, id beta.MeDriveId, input AddDriveListContentTypesCopyRequest, options AddDriveListContentTypesCopyOperationOptions) (result AddDriveListContentTypesCopyOperationResponse, err error) {
