...
func (c DriveListContentTypeClient) CopyDriveListContentTypeToDefaultContentLocation(ctx context.Context, id beta.MeDriveIdListContentTypeId, input CopyDriveListContentTypeToDefaultContentLocationRequest, options CopyDriveListContentTypeToDefaultContentLocationOperationOptions) (result CopyDriveListContentTypeToDefaultContentLocationOperationResponse, err error) {
