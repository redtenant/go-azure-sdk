...
func (c DriveListContentTypeClient) CreateDriveListContentTypeAssociateWithHubSite(ctx context.Context, id beta.MeDriveIdListContentTypeId, input CreateDriveListContentTypeAssociateWithHubSiteRequest, options CreateDriveListContentTypeAssociateWithHubSiteOperationOptions) (result CreateDriveListContentTypeAssociateWithHubSiteOperationResponse, err error) {
