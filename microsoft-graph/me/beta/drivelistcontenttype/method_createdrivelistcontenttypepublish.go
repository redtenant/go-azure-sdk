...
func (c DriveListContentTypeClient) CreateDriveListContentTypePublish(ctx context.Context, id beta.MeDriveIdListContentTypeId, options CreateDriveListContentTypePublishOperationOptions) (result CreateDriveListContentTypePublishOperationResponse, err error) {
