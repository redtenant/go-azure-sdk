...
func (c DriveListContentTypeClient) CreateDriveListContentTypeUnpublish(ctx context.Context, id beta.MeDriveIdListContentTypeId, options CreateDriveListContentTypeUnpublishOperationOptions) (result CreateDriveListContentTypeUnpublishOperationResponse, err error) {
