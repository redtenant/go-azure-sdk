...
func (c DriveListContentTypeClient) UpdateDriveListContentType(ctx context.Context, id beta.MeDriveIdListContentTypeId, input beta.ContentType, options UpdateDriveListContentTypeOperationOptions) (result UpdateDriveListContentTypeOperationResponse, err error) {
