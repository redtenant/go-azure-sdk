...
func (c DriveListContentTypeBaseClient) GetDriveListContentTypeBase(ctx context.Context, id beta.MeDriveIdListContentTypeId, options GetDriveListContentTypeBaseOperationOptions) (result GetDriveListContentTypeBaseOperationResponse, err error) {
