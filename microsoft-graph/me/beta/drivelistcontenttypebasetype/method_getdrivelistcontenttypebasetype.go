...
// content type.
func (c DriveListContentTypeBaseTypeClient) GetDriveListContentTypeBaseType(ctx context.Context, id beta.MeDriveIdListContentTypeIdBaseTypeId, options GetDriveListContentTypeBaseTypeOperationOptions) (result GetDriveListContentTypeBaseTypeOperationResponse, err error) {
