...
func (c DriveListContentTypeBaseTypeClient) GetDriveListContentTypeBaseTypesCount(ctx context.Context, id beta.MeDriveIdListContentTypeId, options GetDriveListContentTypeBaseTypesCountOperationOptions) (result GetDriveListContentTypeBaseTypesCountOperationResponse, err error) {
