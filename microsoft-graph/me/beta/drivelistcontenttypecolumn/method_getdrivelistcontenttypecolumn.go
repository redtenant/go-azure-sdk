...
func (c DriveListContentTypeColumnClient) GetDriveListContentTypeColumn(ctx context.Context, id beta.MeDriveIdListContentTypeIdColumnId, options GetDriveListContentTypeColumnOperationOptions) (result GetDriveListContentTypeColumnOperationResponse, err error) {
