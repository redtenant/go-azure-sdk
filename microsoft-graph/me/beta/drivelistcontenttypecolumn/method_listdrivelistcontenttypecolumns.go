...
func (c DriveListContentTypeColumnClient) ListDriveListContentTypeColumns(ctx context.Context, id beta.MeDriveIdListContentTypeId, options ListDriveListContentTypeColumnsOperationOptions) (result ListDriveListContentTypeColumnsOperationResponse, err error) {
...
func (c DriveListContentTypeColumnClient) ListDriveListContentTypeColumnsComplete(ctx context.Context, id beta.MeDriveIdListContentTypeId, options ListDriveListContentTypeColumnsOperationOptions) (ListDriveListContentTypeColumnsCompleteResult, error) {
...
func (c DriveListContentTypeColumnClient) ListDriveListContentTypeColumnsCompleteMatchingPredicate(ctx context.Context, id beta.MeDriveIdListContentTypeId, options ListDriveListContentTypeColumnsOperationOptions, predicate ColumnDefinitionOperationPredicate) (result ListDriveListContentTypeColumnsCompleteResult, err error) {
