...
func (c DriveListContentTypeColumnClient) UpdateDriveListContentTypeColumn(ctx context.Context, id beta.MeDriveIdListContentTypeIdColumnId, input beta.ColumnDefinition, options UpdateDriveListContentTypeColumnOperationOptions) (result UpdateDriveListContentTypeColumnOperationResponse, err error) {
