...
func (c DriveListContentTypeColumnLinkClient) CreateDriveListContentTypeColumnLink(ctx context.Context, id beta.MeDriveIdListContentTypeId, input beta.ColumnLink, options CreateDriveListContentTypeColumnLinkOperationOptions) (result CreateDriveListContentTypeColumnLinkOperationResponse, err error) {
