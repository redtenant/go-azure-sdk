...
func (c DriveListContentTypeColumnLinkClient) DeleteDriveListContentTypeColumnLink(ctx context.Context, id beta.MeDriveIdListContentTypeIdColumnLinkId, options DeleteDriveListContentTypeColumnLinkOperationOptions) (result DeleteDriveListContentTypeColumnLinkOperationResponse, err error) {
