...
func (c DriveListContentTypeColumnLinkClient) GetDriveListContentTypeColumnLinksCount(ctx context.Context, id beta.MeDriveIdListContentTypeId, options GetDriveListContentTypeColumnLinksCountOperationOptions) (result GetDriveListContentTypeColumnLinksCountOperationResponse, err error) {
