...
func (c DriveListItemClient) CreateDriveListItem(ctx context.Context, id beta.MeDriveId, input beta.ListItem, options CreateDriveListItemOperationOptions) (result CreateDriveListItemOperationResponse, err error) {
