...
func (c DriveListItemClient) DeleteDriveListItem(ctx context.Context, id beta.MeDriveIdListItemId, options DeleteDriveListItemOperationOptions) (result DeleteDriveListItemOperationResponse, err error) {
