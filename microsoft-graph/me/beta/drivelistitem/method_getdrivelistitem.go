...
func (c DriveListItemClient) GetDriveListItem(ctx context.Context, id beta.MeDriveIdListItemId, options GetDriveListItemOperationOptions) (result GetDriveListItemOperationResponse, err error) {
