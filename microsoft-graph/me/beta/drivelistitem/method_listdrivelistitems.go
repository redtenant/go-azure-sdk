...
func (c DriveListItemClient) ListDriveListItems(ctx context.Context, id beta.MeDriveId, options ListDriveListItemsOperationOptions) (result ListDriveListItemsOperationResponse, err error) {
...
func (c DriveListItemClient) ListDriveListItemsComplete(ctx context.Context, id beta.MeDriveId, options ListDriveListItemsOperationOptions) (ListDriveListItemsCompleteResult, error) {
...
func (c DriveListItemClient) ListDriveListItemsCompleteMatchingPredicate(ctx context.Context, id beta.MeDriveId, options ListDriveListItemsOperationOptions, predicate ListItemOperationPredicate) (result ListDriveListItemsCompleteResult, err error) {
