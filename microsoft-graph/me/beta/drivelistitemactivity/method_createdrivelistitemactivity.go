...
// CreateDriveListItemActivity - Create new navigation property to activities for me
func (c DriveListItemActivityClient) CreateDriveListItemActivity(ctx context.Context, id beta.MeDriveIdListItemId, input beta.ItemActivityOLD, options CreateDriveListItemActivityOperationOptions) (result CreateDriveListItemActivityOperationResponse, err error) {
