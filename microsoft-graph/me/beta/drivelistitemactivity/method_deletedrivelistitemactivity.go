...
// DeleteDriveListItemActivity - Delete navigation property activities for me
func (c DriveListItemActivityClient) DeleteDriveListItemActivity(ctx context.Context, id beta.MeDriveIdListItemIdActivityId, options DeleteDriveListItemActivityOperationOptions) (result DeleteDriveListItemActivityOperationResponse, err error) {
