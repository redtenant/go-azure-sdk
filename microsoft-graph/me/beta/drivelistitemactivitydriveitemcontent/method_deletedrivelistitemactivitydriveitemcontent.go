...
// DeleteDriveListItemActivityDriveItemContent - Delete content for the navigation property driveItem in me. The content
...
func (c DriveListItemActivityDriveItemContentClient) DeleteDriveListItemActivityDriveItemContent(ctx context.Context, id beta.MeDriveIdListItemIdActivityId, options DeleteDriveListItemActivityDriveItemContentOperationOptions) (result DeleteDriveListItemActivityDriveItemContentOperationResponse, err error) {
