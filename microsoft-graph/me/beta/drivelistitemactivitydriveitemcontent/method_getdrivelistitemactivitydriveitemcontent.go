...
// GetDriveListItemActivityDriveItemContent - Get content for the navigation property driveItem from me. The content
...
func (c DriveListItemActivityDriveItemContentClient) GetDriveListItemActivityDriveItemContent(ctx context.Context, id beta.MeDriveIdListItemIdActivityId, options GetDriveListItemActivityDriveItemContentOperationOptions) (result GetDriveListItemActivityDriveItemContentOperationResponse, err error) {
