...
// SetDriveListItemActivityDriveItemContent - Update content for the navigation property driveItem in me. The content
...
func (c DriveListItemActivityDriveItemContentClient) SetDriveListItemActivityDriveItemContent(ctx context.Context, id beta.MeDriveIdListItemIdActivityId, input []byte, options SetDriveListItemActivityDriveItemContentOperationOptions) (result SetDriveListItemActivityDriveItemContentOperationResponse, err error) {
