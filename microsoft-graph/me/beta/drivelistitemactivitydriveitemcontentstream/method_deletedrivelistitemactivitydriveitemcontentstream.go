...
// DeleteDriveListItemActivityDriveItemContentStream - Delete contentStream for the navigation property driveItem in me.
// The content stream, if the item represents a file.
func (c DriveListItemActivityDriveItemContentStreamClient) DeleteDriveListItemActivityDriveItemContentStream(ctx context.Context, id beta.MeDriveIdListItemIdActivityId, options DeleteDriveListItemActivityDriveItemContentStreamOperationOptions) (result DeleteDriveListItemActivityDriveItemContentStreamOperationResponse, err error) {
