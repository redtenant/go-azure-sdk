...
// GetDriveListItemActivityDriveItemContentStream - Get contentStream for the navigation property driveItem from me. The
// content stream, if the item represents a file.
func (c DriveListItemActivityDriveItemContentStreamClient) GetDriveListItemActivityDriveItemContentStream(ctx context.Context, id beta.MeDriveIdListItemIdActivityId, options GetDriveListItemActivityDriveItemContentStreamOperationOptions) (result GetDriveListItemActivityDriveItemContentStreamOperationResponse, err error) {
