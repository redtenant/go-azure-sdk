...
func (c DriveListItemCreatedByUserMailboxSettingClient) GetDriveListItemCreatedByUserMailboxSetting(ctx context.Context, id beta.MeDriveIdListItemId, options GetDriveListItemCreatedByUserMailboxSettingOperationOptions) (result GetDriveListItemCreatedByUserMailboxSettingOperationResponse, err error) {
