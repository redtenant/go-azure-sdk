...
func (c DriveListItemDocumentSetVersionClient) CreateDriveListItemDocumentSetVersion(ctx context.Context, id beta.MeDriveIdListItemId, input beta.DocumentSetVersion, options CreateDriveListItemDocumentSetVersionOperationOptions) (result CreateDriveListItemDocumentSetVersionOperationResponse, err error) {
