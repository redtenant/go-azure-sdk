...
func (c DriveListItemDocumentSetVersionClient) DeleteDriveListItemDocumentSetVersion(ctx context.Context, id beta.MeDriveIdListItemIdDocumentSetVersionId, options DeleteDriveListItemDocumentSetVersionOperationOptions) (result DeleteDriveListItemDocumentSetVersionOperationResponse, err error) {
