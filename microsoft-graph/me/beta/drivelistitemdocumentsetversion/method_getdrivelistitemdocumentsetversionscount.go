...
func (c DriveListItemDocumentSetVersionClient) GetDriveListItemDocumentSetVersionsCount(ctx context.Context, id beta.MeDriveIdListItemId, options GetDriveListItemDocumentSetVersionsCountOperationOptions) (result GetDriveListItemDocumentSetVersionsCountOperationResponse, err error) {
