...
func (c DriveListItemDocumentSetVersionClient) RestoreDriveListItemDocumentSetVersion(ctx context.Context, id beta.MeDriveIdListItemIdDocumentSetVersionId, options RestoreDriveListItemDocumentSetVersionOperationOptions) (result RestoreDriveListItemDocumentSetVersionOperationResponse, err error) {
