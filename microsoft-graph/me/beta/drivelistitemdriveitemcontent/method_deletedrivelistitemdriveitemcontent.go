...
func (c DriveListItemDriveItemContentClient) DeleteDriveListItemDriveItemContent(ctx context.Context, id beta.MeDriveIdListItemId, options DeleteDriveListItemDriveItemContentOperationOptions) (result DeleteDriveListItemDriveItemContentOperationResponse, err error) {
