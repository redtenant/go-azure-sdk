...
func (c DriveListItemDriveItemContentClient) GetDriveListItemDriveItemContent(ctx context.Context, id beta.MeDriveIdListItemId, options GetDriveListItemDriveItemContentOperationOptions) (result GetDriveListItemDriveItemContentOperationResponse, err error) {
