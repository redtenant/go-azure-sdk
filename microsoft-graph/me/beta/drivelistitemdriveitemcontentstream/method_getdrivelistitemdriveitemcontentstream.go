...
// GetDriveListItemDriveItemContentStream - Get contentStream for the navigation property driveItem from me. The content
// stream, if the item represents a file.
func (c DriveListItemDriveItemContentStreamClient) GetDriveListItemDriveItemContentStream(ctx context.Context, id beta.MeDriveIdListItemId, options GetDriveListItemDriveItemContentStreamOperationOptions) (result GetDriveListItemDriveItemContentStreamOperationResponse, err error) {
