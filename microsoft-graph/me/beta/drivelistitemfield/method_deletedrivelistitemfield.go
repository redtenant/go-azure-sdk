...
func (c DriveListItemFieldClient) DeleteDriveListItemField(ctx context.Context, id beta.MeDriveIdListItemId, options DeleteDriveListItemFieldOperationOptions) (result DeleteDriveListItemFieldOperationResponse, err error) {
