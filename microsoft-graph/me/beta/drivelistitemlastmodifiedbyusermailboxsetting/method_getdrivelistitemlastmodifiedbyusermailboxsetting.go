...
// on $select.
func (c DriveListItemLastModifiedByUserMailboxSettingClient) GetDriveListItemLastModifiedByUserMailboxSetting(ctx context.Context, id beta.MeDriveIdListItemId, options GetDriveListItemLastModifiedByUserMailboxSettingOperationOptions) (result GetDriveListItemLastModifiedByUserMailboxSettingOperationResponse, err error) {
