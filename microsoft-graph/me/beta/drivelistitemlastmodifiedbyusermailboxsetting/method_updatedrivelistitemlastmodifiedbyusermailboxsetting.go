...
func (c DriveListItemLastModifiedByUserMailboxSettingClient) UpdateDriveListItemLastModifiedByUserMailboxSetting(ctx context.Context, id beta.MeDriveIdListItemId, input beta.MailboxSettings, options UpdateDriveListItemLastModifiedByUserMailboxSettingOperationOptions) (result UpdateDriveListItemLastModifiedByUserMailboxSettingOperationResponse, err error) {
