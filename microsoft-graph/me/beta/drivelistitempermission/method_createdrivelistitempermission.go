...
// CreateDriveListItemPermission - Create new navigation property to permissions for me
func (c DriveListItemPermissionClient) CreateDriveListItemPermission(ctx context.Context, id beta.MeDriveIdListItemId, input beta.Permission, options CreateDriveListItemPermissionOperationOptions) (result CreateDriveListItemPermissionOperationResponse, err error) {
