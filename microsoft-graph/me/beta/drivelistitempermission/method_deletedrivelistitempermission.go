...
// DeleteDriveListItemPermission - Delete navigation property permissions for me
func (c DriveListItemPermissionClient) DeleteDriveListItemPermission(ctx context.Context, id beta.MeDriveIdListItemIdPermissionId, options DeleteDriveListItemPermissionOperationOptions) (result DeleteDriveListItemPermissionOperationResponse, err error) {
