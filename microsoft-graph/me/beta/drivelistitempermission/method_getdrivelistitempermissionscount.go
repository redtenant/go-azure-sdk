...
func (c DriveListItemPermissionClient) GetDriveListItemPermissionsCount(ctx context.Context, id beta.MeDriveIdListItemId, options GetDriveListItemPermissionsCountOperationOptions) (result GetDriveListItemPermissionsCountOperationResponse, err error) {
