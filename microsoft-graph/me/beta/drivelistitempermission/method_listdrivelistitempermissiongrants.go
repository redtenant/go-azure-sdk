...
func (c DriveListItemPermissionClient) ListDriveListItemPermissionGrants(ctx context.Context, id beta.MeDriveIdListItemIdPermissionId, input ListDriveListItemPermissionGrantsRequest, options ListDriveListItemPermissionGrantsOperationOptions) (result ListDriveListItemPermissionGrantsOperationResponse, err error) {
...
func (c DriveListItemPermissionClient) ListDriveListItemPermissionGrantsComplete(ctx context.Context, id beta.MeDriveIdListItemIdPermissionId, input ListDriveListItemPermissionGrantsRequest, options ListDriveListItemPermissionGrantsOperationOptions) (ListDriveListItemPermissionGrantsCompleteResult, error) {
...
func (c DriveListItemPermissionClient) ListDriveListItemPermissionGrantsCompleteMatchingPredicate(ctx context.Context, id beta.MeDriveIdListItemIdPermissionId, input ListDriveListItemPermissionGrantsRequest, options ListDriveListItemPermissionGrantsOperationOptions, predicate PermissionOperationPredicate) (result ListDriveListItemPermissionGrantsCompleteResult, err error) {
