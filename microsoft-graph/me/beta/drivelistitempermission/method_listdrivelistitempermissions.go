...
// ListDriveListItemPermissions - Get permissions from me. The set of permissions for the item. Read-only. Nullable.
func (c DriveListItemPermissionClient) ListDriveListItemPermissions(ctx context.Context, id beta.MeDriveIdListItemId, options ListDriveListItemPermissionsOperationOptions) (result ListDriveListItemPermissionsOperationResponse, err error) {
...
func (c DriveListItemPermissionClient) ListDriveListItemPermissionsComplete(ctx context.Context, id beta.MeDriveIdListItemId, options ListDriveListItemPermissionsOperationOptions) (ListDriveListItemPermissionsCompleteResult, error) {
...
func (c DriveListItemPermissionClient) ListDriveListItemPermissionsCompleteMatchingPredicate(ctx context.Context, id beta.MeDriveIdListItemId, options ListDriveListItemPermissionsOperationOptions, predicate PermissionOperationPredicate) (result ListDriveListItemPermissionsCompleteResult, err error) {
