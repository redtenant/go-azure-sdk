...
func (c DriveListItemVersionClient) DeleteDriveListItemVersion(ctx context.Context, id beta.MeDriveIdListItemIdVersionId, options DeleteDriveListItemVersionOperationOptions) (result DeleteDriveListItemVersionOperationResponse, err error) {
