...
func (c DriveListItemVersionClient) GetDriveListItemVersion(ctx context.Context, id beta.MeDriveIdListItemIdVersionId, options GetDriveListItemVersionOperationOptions) (result GetDriveListItemVersionOperationResponse, err error) {
