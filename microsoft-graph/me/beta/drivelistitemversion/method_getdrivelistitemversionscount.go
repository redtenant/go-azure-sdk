...
func (c DriveListItemVersionClient) GetDriveListItemVersionsCount(ctx context.Context, id beta.MeDriveIdListItemId, options GetDriveListItemVersionsCountOperationOptions) (result GetDriveListItemVersionsCountOperationResponse, err error) {
