...
func (c DriveListItemVersionClient) RestoreDriveListItemVersionVersion(ctx context.Context, id beta.MeDriveIdListItemIdVersionId, options RestoreDriveListItemVersionVersionOperationOptions) (result RestoreDriveListItemVersionVersionOperationResponse, err error) {
