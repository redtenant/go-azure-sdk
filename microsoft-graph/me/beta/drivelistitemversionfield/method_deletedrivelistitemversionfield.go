...
func (c DriveListItemVersionFieldClient) DeleteDriveListItemVersionField(ctx context.Context, id beta.MeDriveIdListItemIdVersionId, options DeleteDriveListItemVersionFieldOperationOptions) (result DeleteDriveListItemVersionFieldOperationResponse, err error) {
