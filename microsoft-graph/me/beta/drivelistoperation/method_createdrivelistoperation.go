...
func (c DriveListOperationClient) CreateDriveListOperation(ctx context.Context, id beta.MeDriveId, input beta.RichLongRunningOperation, options CreateDriveListOperationOperationOptions) (result CreateDriveListOperationOperationResponse, err error) {
