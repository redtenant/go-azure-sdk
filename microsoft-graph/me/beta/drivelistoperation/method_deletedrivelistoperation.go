...
func (c DriveListOperationClient) DeleteDriveListOperation(ctx context.Context, id beta.MeDriveIdListOperationId, options DeleteDriveListOperationOperationOptions) (result DeleteDriveListOperationOperationResponse, err error) {
