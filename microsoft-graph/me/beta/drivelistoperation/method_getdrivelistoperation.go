...
func (c DriveListOperationClient) GetDriveListOperation(ctx context.Context, id beta.MeDriveIdListOperationId, options GetDriveListOperationOperationOptions) (result GetDriveListOperationOperationResponse, err error) {
