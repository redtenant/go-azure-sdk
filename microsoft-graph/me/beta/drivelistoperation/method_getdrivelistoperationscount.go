...
func (c DriveListOperationClient) GetDriveListOperationsCount(ctx context.Context, id beta.MeDriveId, options GetDriveListOperationsCountOperationOptions) (result GetDriveListOperationsCountOperationResponse, err error) {
