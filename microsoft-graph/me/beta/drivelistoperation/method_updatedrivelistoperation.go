...
func (c DriveListOperationClient) UpdateDriveListOperation(ctx context.Context, id beta.MeDriveIdListOperationId, input beta.RichLongRunningOperation, options UpdateDriveListOperationOperationOptions) (result UpdateDriveListOperationOperationResponse, err error) {
