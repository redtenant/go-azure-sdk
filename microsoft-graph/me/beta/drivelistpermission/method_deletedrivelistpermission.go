...
func DefaultDeleteDriveListPermissionOperationOptions() DeleteDriveListPermissionOperationOptions {
	return DeleteDriveListPermissionOperationOptions{}
}
...
// DeleteDriveListPermission - Delete navigation property permissions for me
func (c DriveListPermissionClient) DeleteDriveListPermission(ctx context.Context, id beta.MeDriveIdListPermissionId, options DeleteDriveListPermissionOperationOptions) (result DeleteDriveListPermissionOperationResponse, err error) {
