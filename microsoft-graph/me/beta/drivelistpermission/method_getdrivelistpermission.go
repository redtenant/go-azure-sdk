...
// GetDriveListPermission - Get permissions from me. The set of permissions for the item. Read-only. Nullable.
func (c DriveListPermissionClient) GetDriveListPermission(ctx context.Context, id beta.MeDriveIdListPermissionId, options GetDriveListPermissionOperationOptions) (result GetDriveListPermissionOperationResponse, err error) {
