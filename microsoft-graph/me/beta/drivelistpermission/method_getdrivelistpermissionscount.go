...
func (c DriveListPermissionClient) GetDriveListPermissionsCount(ctx context.Context, id beta.MeDriveId, options GetDriveListPermissionsCountOperationOptions) (result GetDriveListPermissionsCountOperationResponse, err error) {
