...
func (c DriveListPermissionClient) ListDriveListPermissionGrants(ctx context.Context, id beta.MeDriveIdListPermissionId, input ListDriveListPermissionGrantsRequest, options ListDriveListPermissionGrantsOperationOptions) (result ListDriveListPermissionGrantsOperationResponse, err error) {
...
func (c DriveListPermissionClient) ListDriveListPermissionGrantsComplete(ctx context.Context, id beta.MeDriveIdListPermissionId, input ListDriveListPermissionGrantsRequest, options ListDriveListPermissionGrantsOperationOptions) (ListDriveListPermissionGrantsCompleteResult, error) {
...
func (c DriveListPermissionClient) ListDriveListPermissionGrantsCompleteMatchingPredicate(ctx context.Context, id beta.MeDriveIdListPermissionId, input ListDriveListPermissionGrantsRequest, options ListDriveListPermissionGrantsOperationOptions, predicate PermissionOperationPredicate) (result ListDriveListPermissionGrantsCompleteResult, err error) {
