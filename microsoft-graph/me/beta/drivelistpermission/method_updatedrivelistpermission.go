...
// UpdateDriveListPermission - Update the navigation property permissions in me
func (c DriveListPermissionClient) UpdateDriveListPermission(ctx context.Context, id beta.MeDriveIdListPermissionId, input beta.Permission, options UpdateDriveListPermissionOperationOptions) (result UpdateDriveListPermissionOperationResponse, err error) {
