...
func (c DriveListSubscriptionClient) CreateDriveListSubscription(ctx context.Context, id beta.MeDriveId, input beta.Subscription, options CreateDriveListSubscriptionOperationOptions) (result CreateDriveListSubscriptionOperationResponse, err error) {
