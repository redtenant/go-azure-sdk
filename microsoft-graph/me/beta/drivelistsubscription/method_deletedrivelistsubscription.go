...
func (c DriveListSubscriptionClient) DeleteDriveListSubscription(ctx context.Context, id beta.MeDriveIdListSubscriptionId, options DeleteDriveListSubscriptionOperationOptions) (result DeleteDriveListSubscriptionOperationResponse, err error) {
