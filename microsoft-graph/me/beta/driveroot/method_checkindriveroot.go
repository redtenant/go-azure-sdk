...
func (c DriveRootClient) CheckinDriveRoot(ctx context.Context, id beta.MeDriveId, input CheckinDriveRootRequest, options CheckinDriveRootOperationOptions) (result CheckinDriveRootOperationResponse, err error) {
