...
func (c DriveRootClient) CheckoutDriveRoot(ctx context.Context, id beta.MeDriveId, options CheckoutDriveRootOperationOptions) (result CheckoutDriveRootOperationResponse, err error) {
