...
func (c DriveRootClient) CreateDriveRootLink(ctx context.Context, id beta.MeDriveId, input CreateDriveRootLinkRequest, options CreateDriveRootLinkOperationOptions) (result CreateDriveRootLinkOperationResponse, err error) {
