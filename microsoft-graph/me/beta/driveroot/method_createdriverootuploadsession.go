...
func (c DriveRootClient) CreateDriveRootUploadSession(ctx context.Context, id beta.MeDriveId, input CreateDriveRootUploadSessionRequest, options CreateDriveRootUploadSessionOperationOptions) (result CreateDriveRootUploadSessionOperationResponse, err error) {
