...
func (c DriveRootClient) DeleteDriveRoot(ctx context.Context, id beta.MeDriveId, options DeleteDriveRootOperationOptions) (result DeleteDriveRootOperationResponse, err error) {
