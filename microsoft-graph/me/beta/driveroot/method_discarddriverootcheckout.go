...
// permissions.
func (c DriveRootClient) DiscardDriveRootCheckout(ctx context.Context, id beta.MeDriveId, options DiscardDriveRootCheckoutOperationOptions) (result DiscardDriveRootCheckoutOperationResponse, err error) {
