...
func (c DriveRootClient) ExtractDriveRootSensitivityLabels(ctx context.Context, id beta.MeDriveId, options ExtractDriveRootSensitivityLabelsOperationOptions) (result ExtractDriveRootSensitivityLabelsOperationResponse, err error) {
