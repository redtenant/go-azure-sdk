...
func (c DriveRootClient) GetDriveRoot(ctx context.Context, id beta.MeDriveId, options GetDriveRootOperationOptions) (result GetDriveRootOperationResponse, err error) {
