...
// shared.
func (c DriveRootClient) ListDriveRootInvites(ctx context.Context, id beta.MeDriveId, input ListDriveRootInvitesRequest, options ListDriveRootInvitesOperationOptions) (result ListDriveRootInvitesOperationResponse, err error) {
...
func (c DriveRootClient) ListDriveRootInvitesComplete(ctx context.Context, id beta.MeDriveId, input ListDriveRootInvitesRequest, options ListDriveRootInvitesOperationOptions) (ListDriveRootInvitesCompleteResult, error) {
