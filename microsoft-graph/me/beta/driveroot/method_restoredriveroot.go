...
// bin.
func (c DriveRootClient) RestoreDriveRoot(ctx context.Context, id beta.MeDriveId, input RestoreDriveRootRequest, options RestoreDriveRootOperationOptions) (result RestoreDriveRootOperationResponse, err error) {
