...
func (c DriveRootClient) UnfollowDriveRoot(ctx context.Context, id beta.MeDriveId, options UnfollowDriveRootOperationOptions) (result UnfollowDriveRootOperationResponse, err error) {
