...
func (c DriveRootClient) ValidateDriveRootPermission(ctx context.Context, id beta.MeDriveId, input ValidateDriveRootPermissionRequest, options ValidateDriveRootPermissionOperationOptions) (result ValidateDriveRootPermissionOperationResponse, err error) {
