...
func (c DriveRootAnalyticsClient) DeleteDriveRootAnalytics(ctx context.Context, id beta.MeDriveId, options DeleteDriveRootAnalyticsOperationOptions) (result DeleteDriveRootAnalyticsOperationResponse, err error) {
