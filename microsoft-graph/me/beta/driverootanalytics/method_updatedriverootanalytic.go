...
func (c DriveRootAnalyticsClient) UpdateDriveRootAnalytic(ctx context.Context, id beta.MeDriveId, input beta.ItemAnalytics, options UpdateDriveRootAnalyticOperationOptions) (result UpdateDriveRootAnalyticOperationResponse, err error) {
