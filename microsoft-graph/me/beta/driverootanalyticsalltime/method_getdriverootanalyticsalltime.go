...
func (c DriveRootAnalyticsAllTimeClient) GetDriveRootAnalyticsAllTime(ctx context.Context, id beta.MeDriveId, options GetDriveRootAnalyticsAllTimeOperationOptions) (result GetDriveRootAnalyticsAllTimeOperationResponse, err error) {
