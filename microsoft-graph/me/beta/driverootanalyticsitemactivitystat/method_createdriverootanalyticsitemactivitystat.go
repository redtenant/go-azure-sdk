...
func (c DriveRootAnalyticsItemActivityStatClient) CreateDriveRootAnalyticsItemActivityStat(ctx context.Context, id beta.MeDriveId, input beta.ItemActivityStat, options CreateDriveRootAnalyticsItemActivityStatOperationOptions) (result CreateDriveRootAnalyticsItemActivityStatOperationResponse, err error) {
