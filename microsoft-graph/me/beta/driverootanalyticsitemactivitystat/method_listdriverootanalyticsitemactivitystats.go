...
// ListDriveRootAnalyticsItemActivityStats - Get itemActivityStats from me
func (c DriveRootAnalyticsItemActivityStatClient) ListDriveRootAnalyticsItemActivityStats(ctx context.Context, id beta.MeDriveId, options ListDriveRootAnalyticsItemActivityStatsOperationOptions) (result ListDriveRootAnalyticsItemActivityStatsOperationResponse, err error) {
...
func (c DriveRootAnalyticsItemActivityStatClient) ListDriveRootAnalyticsItemActivityStatsComplete(ctx context.Context, id beta.MeDriveId, options ListDriveRootAnalyticsItemActivityStatsOperationOptions) (ListDriveRootAnalyticsItemActivityStatsCompleteResult, error) {
