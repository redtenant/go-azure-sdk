...
func (c DriveRootAnalyticsItemActivityStatClient) UpdateDriveRootAnalyticsItemActivityStat(ctx context.Context, id beta.MeDriveIdRootAnalyticsItemActivityStatId, input beta.ItemActivityStat, options UpdateDriveRootAnalyticsItemActivityStatOperationOptions) (result UpdateDriveRootAnalyticsItemActivityStatOperationResponse, err error) {
