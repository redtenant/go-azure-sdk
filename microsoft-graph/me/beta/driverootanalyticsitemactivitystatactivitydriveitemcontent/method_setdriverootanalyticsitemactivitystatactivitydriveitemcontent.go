...
// in me. The content stream, if the item represents a file. The content property will have a potentially breaking
...
func (c DriveRootAnalyticsItemActivityStatActivityDriveItemContentClient) SetDriveRootAnalyticsItemActivityStatActivityDriveItemContent(ctx context.Context, id beta.MeDriveIdRootAnalyticsItemActivityStatIdActivityId, input []byte, options SetDriveRootAnalyticsItemActivityStatActivityDriveItemContentOperationOptions) (result SetDriveRootAnalyticsItemActivityStatActivityDriveItemContentOperationResponse, err error) {
