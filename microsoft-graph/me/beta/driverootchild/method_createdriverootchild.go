...
func (c DriveRootChildClient) CreateDriveRootChild(ctx context.Context, id beta.MeDriveId, input beta.DriveItem, options CreateDriveRootChildOperationOptions) (result CreateDriveRootChildOperationResponse, err error) {
