...
func (c DriveRootChildClient) GetDriveRootChild(ctx context.Context, id beta.MeDriveIdRootChildId, options GetDriveRootChildOperationOptions) (result GetDriveRootChildOperationResponse, err error) {
