...
func (c DriveRootChildClient) GetDriveRootChildrenCount(ctx context.Context, id beta.MeDriveId, options GetDriveRootChildrenCountOperationOptions) (result GetDriveRootChildrenCountOperationResponse, err error) {
