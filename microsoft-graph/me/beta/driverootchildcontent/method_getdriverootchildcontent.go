...
func (c DriveRootChildContentClient) GetDriveRootChildContent(ctx context.Context, id beta.MeDriveIdRootChildId, options GetDriveRootChildContentOperationOptions) (result GetDriveRootChildContentOperationResponse, err error) {
