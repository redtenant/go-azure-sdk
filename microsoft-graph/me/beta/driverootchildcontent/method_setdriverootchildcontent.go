...
func (c DriveRootChildContentClient) SetDriveRootChildContent(ctx context.Context, id beta.MeDriveIdRootChildId, input []byte, options SetDriveRootChildContentOperationOptions) (result SetDriveRootChildContentOperationResponse, err error) {
