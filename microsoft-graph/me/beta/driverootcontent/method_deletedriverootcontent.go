...
func (c DriveRootContentClient) DeleteDriveRootContent(ctx context.Context, id beta.MeDriveId, options DeleteDriveRootContentOperationOptions) (result DeleteDriveRootContentOperationResponse, err error) {
