...
// DeleteDriveRootContentStream - Delete contentStream for the navigation property root in me. The content stream, if
// the item represents a file.
func (c DriveRootContentStreamClient) DeleteDriveRootContentStream(ctx context.Context, id beta.MeDriveId, options DeleteDriveRootContentStreamOperationOptions) (result DeleteDriveRootContentStreamOperationResponse, err error) {
