...
// GetDriveRootContentStream - Get contentStream for the navigation property root from me. The content stream, if the
// item represents a file.
func (c DriveRootContentStreamClient) GetDriveRootContentStream(ctx context.Context, id beta.MeDriveId, options GetDriveRootContentStreamOperationOptions) (result GetDriveRootContentStreamOperationResponse, err error) {
