...
// GetDriveRootCreatedByUser - Get createdByUser from me
func (c DriveRootCreatedByUserClient) GetDriveRootCreatedByUser(ctx context.Context, id beta.MeDriveId, options GetDriveRootCreatedByUserOperationOptions) (result GetDriveRootCreatedByUserOperationResponse, err error) {
