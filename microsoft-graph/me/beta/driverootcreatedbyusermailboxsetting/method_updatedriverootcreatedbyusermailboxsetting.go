...
func (c DriveRootCreatedByUserMailboxSettingClient) UpdateDriveRootCreatedByUserMailboxSetting(ctx context.Context, id beta.MeDriveId, input beta.MailboxSettings, options UpdateDriveRootCreatedByUserMailboxSettingOperationOptions) (result UpdateDriveRootCreatedByUserMailboxSettingOperationResponse, err error) {
