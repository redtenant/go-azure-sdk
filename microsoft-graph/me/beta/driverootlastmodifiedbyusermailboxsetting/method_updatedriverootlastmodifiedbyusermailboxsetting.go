...
func (c DriveRootLastModifiedByUserMailboxSettingClient) UpdateDriveRootLastModifiedByUserMailboxSetting(ctx context.Context, id beta.MeDriveId, input beta.MailboxSettings, options UpdateDriveRootLastModifiedByUserMailboxSettingOperationOptions) (result UpdateDriveRootLastModifiedByUserMailboxSettingOperationResponse, err error) {
