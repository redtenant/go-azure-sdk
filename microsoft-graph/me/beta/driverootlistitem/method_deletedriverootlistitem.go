...
func (c DriveRootListItemClient) DeleteDriveRootListItem(ctx context.Context, id beta.MeDriveId, options DeleteDriveRootListItemOperationOptions) (result DeleteDriveRootListItemOperationResponse, err error) {
