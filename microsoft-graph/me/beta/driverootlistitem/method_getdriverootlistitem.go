...
// GetDriveRootListItem - Get listItem from me. For drives in SharePoint, the associated document library list item.
// Read-only. Nullable.
func (c DriveRootListItemClient) GetDriveRootListItem(ctx context.Context, id beta.MeDriveId, options GetDriveRootListItemOperationOptions) (result GetDriveRootListItemOperationResponse, err error) {
