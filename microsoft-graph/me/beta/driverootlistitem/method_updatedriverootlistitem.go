...
func (c DriveRootListItemClient) UpdateDriveRootListItem(ctx context.Context, id beta.MeDriveId, input beta.ListItem, options UpdateDriveRootListItemOperationOptions) (result UpdateDriveRootListItemOperationResponse, err error) {
