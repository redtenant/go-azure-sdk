...
// CreateDriveRootListItemActivity - Create new navigation property to activities for me
func (c DriveRootListItemActivityClient) CreateDriveRootListItemActivity(ctx context.Context, id beta.MeDriveId, input beta.ItemActivityOLD, options CreateDriveRootListItemActivityOperationOptions) (result CreateDriveRootListItemActivityOperationResponse, err error) {
