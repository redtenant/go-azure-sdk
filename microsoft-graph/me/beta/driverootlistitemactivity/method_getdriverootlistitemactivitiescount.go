...
func (c DriveRootListItemActivityClient) GetDriveRootListItemActivitiesCount(ctx context.Context, id beta.MeDriveId, options GetDriveRootListItemActivitiesCountOperationOptions) (result GetDriveRootListItemActivitiesCountOperationResponse, err error) {
