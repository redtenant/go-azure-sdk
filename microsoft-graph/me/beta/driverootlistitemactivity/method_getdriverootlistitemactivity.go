...
func DefaultGetDriveRootListItemActivityOperationOptions() GetDriveRootListItemActivityOperationOptions {
	return GetDriveRootListItemActivityOperationOptions{}
}
...
// GetDriveRootListItemActivity - Get activities from me. The list of recent activities that took place on this item.
func (c DriveRootListItemActivityClient) GetDriveRootListItemActivity(ctx context.Context, id beta.MeDriveIdRootListItemActivityId, options GetDriveRootListItemActivityOperationOptions) (result GetDriveRootListItemActivityOperationResponse, err error) {
