...
// UpdateDriveRootListItemActivity - Update the navigation property activities in me
func (c DriveRootListItemActivityClient) UpdateDriveRootListItemActivity(ctx context.Context, id beta.MeDriveIdRootListItemActivityId, input beta.ItemActivityOLD, options UpdateDriveRootListItemActivityOperationOptions) (result UpdateDriveRootListItemActivityOperationResponse, err error) {
