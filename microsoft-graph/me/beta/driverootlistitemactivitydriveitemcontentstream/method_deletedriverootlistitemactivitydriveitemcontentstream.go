...
type DeleteDriveRootListItemActivityDriveItemContentStreamOperationResponse struct {
...
func DefaultDeleteDriveRootListItemActivityDriveItemContentStreamOperationOptions() DeleteDriveRootListItemActivityDriveItemContentStreamOperationOptions {
	return DeleteDriveRootListItemActivityDriveItemContentStreamOperationOptions{}
}
...
// DeleteDriveRootListItemActivityDriveItemContentStream - Delete contentStream for the navigation property driveItem in
// me. The content stream, if the item represents a file.
func (c DriveRootListItemActivityDriveItemContentStreamClient) DeleteDriveRootListItemActivityDriveItemContentStream(ctx context.Context, id beta.MeDriveIdRootListItemActivityId, options DeleteDriveRootListItemActivityDriveItemContentStreamOperationOptions) (result DeleteDriveRootListItemActivityDriveItemContentStreamOperationResponse, err error) {
