...
// GetDriveRootListItemActivityDriveItemContentStream - Get contentStream for the navigation property driveItem from me.
// The content stream, if the item represents a file.
func (c DriveRootListItemActivityDriveItemContentStreamClient) GetDriveRootListItemActivityDriveItemContentStream(ctx context.Context, id beta.MeDriveIdRootListItemActivityId, options GetDriveRootListItemActivityDriveItemContentStreamOperationOptions) (result GetDriveRootListItemActivityDriveItemContentStreamOperationResponse, err error) {
