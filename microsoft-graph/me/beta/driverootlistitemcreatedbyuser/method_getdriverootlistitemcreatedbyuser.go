...
// GetDriveRootListItemCreatedByUser - Get createdByUser from me
func (c DriveRootListItemCreatedByUserClient) GetDriveRootListItemCreatedByUser(ctx context.Context, id beta.MeDriveId, options GetDriveRootListItemCreatedByUserOperationOptions) (result GetDriveRootListItemCreatedByUserOperationResponse, err error) {
