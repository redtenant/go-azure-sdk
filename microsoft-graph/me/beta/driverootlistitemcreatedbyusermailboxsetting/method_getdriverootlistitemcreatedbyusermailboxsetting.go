...
// on $select.
func (c DriveRootListItemCreatedByUserMailboxSettingClient) GetDriveRootListItemCreatedByUserMailboxSetting(ctx context.Context, id beta.MeDriveId, options GetDriveRootListItemCreatedByUserMailboxSettingOperationOptions) (result GetDriveRootListItemCreatedByUserMailboxSettingOperationResponse, err error) {
