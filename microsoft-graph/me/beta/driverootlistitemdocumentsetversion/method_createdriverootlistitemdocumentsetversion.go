...
// CreateDriveRootListItemDocumentSetVersion - Create new navigation property to documentSetVersions for me
func (c DriveRootListItemDocumentSetVersionClient) CreateDriveRootListItemDocumentSetVersion(ctx context.Context, id beta.MeDriveId, input beta.DocumentSetVersion, options CreateDriveRootListItemDocumentSetVersionOperationOptions) (result CreateDriveRootListItemDocumentSetVersionOperationResponse, err error) {
