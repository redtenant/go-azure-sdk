...
func (c DriveRootListItemDocumentSetVersionClient) DeleteDriveRootListItemDocumentSetVersion(ctx context.Context, id beta.MeDriveIdRootListItemDocumentSetVersionId, options DeleteDriveRootListItemDocumentSetVersionOperationOptions) (result DeleteDriveRootListItemDocumentSetVersionOperationResponse, err error) {
