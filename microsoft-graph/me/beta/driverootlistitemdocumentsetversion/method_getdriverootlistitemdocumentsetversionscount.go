...
func (c DriveRootListItemDocumentSetVersionClient) GetDriveRootListItemDocumentSetVersionsCount(ctx context.Context, id beta.MeDriveId, options GetDriveRootListItemDocumentSetVersionsCountOperationOptions) (result GetDriveRootListItemDocumentSetVersionsCountOperationResponse, err error) {
