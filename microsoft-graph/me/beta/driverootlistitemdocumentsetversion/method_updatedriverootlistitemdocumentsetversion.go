...
func (c DriveRootListItemDocumentSetVersionClient) UpdateDriveRootListItemDocumentSetVersion(ctx context.Context, id beta.MeDriveIdRootListItemDocumentSetVersionId, input beta.DocumentSetVersion, options UpdateDriveRootListItemDocumentSetVersionOperationOptions) (result UpdateDriveRootListItemDocumentSetVersionOperationResponse, err error) {
