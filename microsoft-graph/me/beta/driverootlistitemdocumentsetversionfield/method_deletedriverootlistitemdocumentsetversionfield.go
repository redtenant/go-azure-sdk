...
func (c DriveRootListItemDocumentSetVersionFieldClient) DeleteDriveRootListItemDocumentSetVersionField(ctx context.Context, id beta.MeDriveIdRootListItemDocumentSetVersionId, options DeleteDriveRootListItemDocumentSetVersionFieldOperationOptions) (result DeleteDriveRootListItemDocumentSetVersionFieldOperationResponse, err error) {
