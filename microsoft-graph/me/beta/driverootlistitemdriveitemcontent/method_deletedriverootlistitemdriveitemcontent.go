...
func (c DriveRootListItemDriveItemContentClient) DeleteDriveRootListItemDriveItemContent(ctx context.Context, id beta.MeDriveId, options DeleteDriveRootListItemDriveItemContentOperationOptions) (result DeleteDriveRootListItemDriveItemContentOperationResponse, err error) {
