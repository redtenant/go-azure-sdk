...
func (c DriveRootListItemDriveItemContentClient) GetDriveRootListItemDriveItemContent(ctx context.Context, id beta.MeDriveId, options GetDriveRootListItemDriveItemContentOperationOptions) (result GetDriveRootListItemDriveItemContentOperationResponse, err error) {
