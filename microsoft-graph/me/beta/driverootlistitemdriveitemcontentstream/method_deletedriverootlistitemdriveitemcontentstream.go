...
// DeleteDriveRootListItemDriveItemContentStream - Delete contentStream for the navigation property driveItem in me. The
// content stream, if the item represents a file.
func (c DriveRootListItemDriveItemContentStreamClient) DeleteDriveRootListItemDriveItemContentStream(ctx context.Context, id beta.MeDriveId, options DeleteDriveRootListItemDriveItemContentStreamOperationOptions) (result DeleteDriveRootListItemDriveItemContentStreamOperationResponse, err error) {
