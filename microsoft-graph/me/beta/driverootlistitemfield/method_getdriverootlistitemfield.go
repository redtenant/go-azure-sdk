...
func (c DriveRootListItemFieldClient) GetDriveRootListItemField(ctx context.Context, id beta.MeDriveId, options GetDriveRootListItemFieldOperationOptions) (result GetDriveRootListItemFieldOperationResponse, err error) {
