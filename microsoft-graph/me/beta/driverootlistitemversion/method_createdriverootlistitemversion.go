...
func (c DriveRootListItemVersionClient) CreateDriveRootListItemVersion(ctx context.Context, id beta.MeDriveId, input beta.ListItemVersion, options CreateDriveRootListItemVersionOperationOptions) (result CreateDriveRootListItemVersionOperationResponse, err error) {
