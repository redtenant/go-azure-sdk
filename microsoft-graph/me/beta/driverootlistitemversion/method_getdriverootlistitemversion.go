...
func (c DriveRootListItemVersionClient) GetDriveRootListItemVersion(ctx context.Context, id beta.MeDriveIdRootListItemVersionId, options GetDriveRootListItemVersionOperationOptions) (result GetDriveRootListItemVersionOperationResponse, err error) {
