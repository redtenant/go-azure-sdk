...
func (c DriveRootListItemVersionClient) GetDriveRootListItemVersionsCount(ctx context.Context, id beta.MeDriveId, options GetDriveRootListItemVersionsCountOperationOptions) (result GetDriveRootListItemVersionsCountOperationResponse, err error) {
