...
func (c DriveRootListItemVersionClient) ListDriveRootListItemVersions(ctx context.Context, id beta.MeDriveId, options ListDriveRootListItemVersionsOperationOptions) (result ListDriveRootListItemVersionsOperationResponse, err error) {
...
func (c DriveRootListItemVersionClient) ListDriveRootListItemVersionsComplete(ctx context.Context, id beta.MeDriveId, options ListDriveRootListItemVersionsOperationOptions) (ListDriveRootListItemVersionsCompleteResult, error) {
...
func (c DriveRootListItemVersionClient) ListDriveRootListItemVersionsCompleteMatchingPredicate(ctx context.Context, id beta.MeDriveId, options ListDriveRootListItemVersionsOperationOptions, predicate ListItemVersionOperationPredicate) (result ListDriveRootListItemVersionsCompleteResult, err error) {
