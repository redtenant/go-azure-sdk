...
func (c DriveRootListItemVersionClient) RestoreDriveRootListItemVersionVersion(ctx context.Context, id beta.MeDriveIdRootListItemVersionId, options RestoreDriveRootListItemVersionVersionOperationOptions) (result RestoreDriveRootListItemVersionVersionOperationResponse, err error) {
