...
func (c DriveRootListItemVersionClient) UpdateDriveRootListItemVersion(ctx context.Context, id beta.MeDriveIdRootListItemVersionId, input beta.ListItemVersion, options UpdateDriveRootListItemVersionOperationOptions) (result UpdateDriveRootListItemVersionOperationResponse, err error) {
