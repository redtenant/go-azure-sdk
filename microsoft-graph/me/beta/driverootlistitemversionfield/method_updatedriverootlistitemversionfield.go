...
func (c DriveRootListItemVersionFieldClient) UpdateDriveRootListItemVersionField(ctx context.Context, id beta.MeDriveIdRootListItemVersionId, input beta.FieldValueSet, options UpdateDriveRootListItemVersionFieldOperationOptions) (result UpdateDriveRootListItemVersionFieldOperationResponse, err error) {
