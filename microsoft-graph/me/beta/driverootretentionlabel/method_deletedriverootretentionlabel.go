...
func (c DriveRootRetentionLabelClient) DeleteDriveRootRetentionLabel(ctx context.Context, id beta.MeDriveId, options DeleteDriveRootRetentionLabelOperationOptions) (result DeleteDriveRootRetentionLabelOperationResponse, err error) {
