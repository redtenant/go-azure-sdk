...
func (c DriveRootSubscriptionClient) CreateDriveRootSubscription(ctx context.Context, id beta.MeDriveId, input beta.Subscription, options CreateDriveRootSubscriptionOperationOptions) (result CreateDriveRootSubscriptionOperationResponse, err error) {
