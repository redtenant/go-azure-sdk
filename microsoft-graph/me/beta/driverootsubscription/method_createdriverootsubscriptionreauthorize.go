...
func (c DriveRootSubscriptionClient) CreateDriveRootSubscriptionReauthorize(ctx context.Context, id beta.MeDriveIdRootSubscriptionId, options CreateDriveRootSubscriptionReauthorizeOperationOptions) (result CreateDriveRootSubscriptionReauthorizeOperationResponse, err error) {
