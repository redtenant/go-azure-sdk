...
func (c DriveRootSubscriptionClient) DeleteDriveRootSubscription(ctx context.Context, id beta.MeDriveIdRootSubscriptionId, options DeleteDriveRootSubscriptionOperationOptions) (result DeleteDriveRootSubscriptionOperationResponse, err error) {
