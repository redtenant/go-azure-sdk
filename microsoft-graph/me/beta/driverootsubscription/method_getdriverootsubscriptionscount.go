...
func (c DriveRootSubscriptionClient) GetDriveRootSubscriptionsCount(ctx context.Context, id beta.MeDriveId, options GetDriveRootSubscriptionsCountOperationOptions) (result GetDriveRootSubscriptionsCountOperationResponse, err error) {
