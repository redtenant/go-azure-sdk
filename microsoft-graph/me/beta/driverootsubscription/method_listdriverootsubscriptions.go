...
// root of a drive.
func (c DriveRootSubscriptionClient) ListDriveRootSubscriptions(ctx context.Context, id beta.MeDriveId, options ListDriveRootSubscriptionsOperationOptions) (result ListDriveRootSubscriptionsOperationResponse, err error) {
...
func (c DriveRootSubscriptionClient) ListDriveRootSubscriptionsComplete(ctx context.Context, id beta.MeDriveId, options ListDriveRootSubscriptionsOperationOptions) (ListDriveRootSubscriptionsCompleteResult, error) {
...
func (c DriveRootSubscriptionClient) ListDriveRootSubscriptionsCompleteMatchingPredicate(ctx context.Context, id beta.MeDriveId, options ListDriveRootSubscriptionsOperationOptions, predicate SubscriptionOperationPredicate) (result ListDriveRootSubscriptionsCompleteResult, err error) {
