...
func (c DriveRootThumbnailClient) DeleteDriveRootThumbnail(ctx context.Context, id beta.MeDriveIdRootThumbnailId, options DeleteDriveRootThumbnailOperationOptions) (result DeleteDriveRootThumbnailOperationResponse, err error) {
