...
func (c DriveRootThumbnailClient) GetDriveRootThumbnailsCount(ctx context.Context, id beta.MeDriveId, options GetDriveRootThumbnailsCountOperationOptions) (result GetDriveRootThumbnailsCountOperationResponse, err error) {
