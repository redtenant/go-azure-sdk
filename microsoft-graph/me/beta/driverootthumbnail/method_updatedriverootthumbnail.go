...
func (c DriveRootThumbnailClient) UpdateDriveRootThumbnail(ctx context.Context, id beta.MeDriveIdRootThumbnailId, input beta.ThumbnailSet, options UpdateDriveRootThumbnailOperationOptions) (result UpdateDriveRootThumbnailOperationResponse, err error) {
