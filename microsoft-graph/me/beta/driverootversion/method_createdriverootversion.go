...
func (c DriveRootVersionClient) CreateDriveRootVersion(ctx context.Context, id beta.MeDriveId, input beta.DriveItemVersion, options CreateDriveRootVersionOperationOptions) (result CreateDriveRootVersionOperationResponse, err error) {
