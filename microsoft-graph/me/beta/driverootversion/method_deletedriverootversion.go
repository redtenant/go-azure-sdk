...
func (c DriveRootVersionClient) DeleteDriveRootVersion(ctx context.Context, id beta.MeDriveIdRootVersionId, options DeleteDriveRootVersionOperationOptions) (result DeleteDriveRootVersionOperationResponse, err error) {
