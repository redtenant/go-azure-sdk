...
func (c DriveRootVersionClient) GetDriveRootVersion(ctx context.Context, id beta.MeDriveIdRootVersionId, options GetDriveRootVersionOperationOptions) (result GetDriveRootVersionOperationResponse, err error) {
