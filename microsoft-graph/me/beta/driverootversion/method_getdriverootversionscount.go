...
func (c DriveRootVersionClient) GetDriveRootVersionsCount(ctx context.Context, id beta.MeDriveId, options GetDriveRootVersionsCountOperationOptions) (result GetDriveRootVersionsCountOperationResponse, err error) {
