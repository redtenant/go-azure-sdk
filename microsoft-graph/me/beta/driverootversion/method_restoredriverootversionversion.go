...
func (c DriveRootVersionClient) RestoreDriveRootVersionVersion(ctx context.Context, id beta.MeDriveIdRootVersionId, options RestoreDriveRootVersionVersionOperationOptions) (result RestoreDriveRootVersionVersionOperationResponse, err error) {
