...
// DeleteDriveRootVersionContent - Delete content for the navigation property versions in me
func (c DriveRootVersionContentClient) DeleteDriveRootVersionContent(ctx context.Context, id beta.MeDriveIdRootVersionId, options DeleteDriveRootVersionContentOperationOptions) (result DeleteDriveRootVersionContentOperationResponse, err error) {
