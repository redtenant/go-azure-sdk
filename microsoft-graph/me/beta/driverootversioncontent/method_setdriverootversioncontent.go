...
// SetDriveRootVersionContent - Update content for the navigation property versions in me
func (c DriveRootVersionContentClient) SetDriveRootVersionContent(ctx context.Context, id beta.MeDriveIdRootVersionId, input []byte, options SetDriveRootVersionContentOperationOptions) (result SetDriveRootVersionContentOperationResponse, err error) {
