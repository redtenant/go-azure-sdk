...
func (c DriveSpecialClient) GetDriveSpecial(ctx context.Context, id beta.MeDriveIdSpecialId, options GetDriveSpecialOperationOptions) (result GetDriveSpecialOperationResponse, err error) {
