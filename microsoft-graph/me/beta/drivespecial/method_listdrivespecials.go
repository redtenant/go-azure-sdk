...
func (c DriveSpecialClient) ListDriveSpecials(ctx context.Context, id beta.MeDriveId, options ListDriveSpecialsOperationOptions) (result ListDriveSpecialsOperationResponse, err error) {
...
func (c DriveSpecialClient) ListDriveSpecialsComplete(ctx context.Context, id beta.MeDriveId, options ListDriveSpecialsOperationOptions) (ListDriveSpecialsCompleteResult, error) {
...
func (c DriveSpecialClient) ListDriveSpecialsCompleteMatchingPredicate(ctx context.Context, id beta.MeDriveId, options ListDriveSpecialsOperationOptions, predicate DriveItemOperationPredicate) (result ListDriveSpecialsCompleteResult, err error) {
