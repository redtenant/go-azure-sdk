...
func (c DriveSpecialContentClient) DeleteDriveSpecialContent(ctx context.Context, id beta.MeDriveIdSpecialId, options DeleteDriveSpecialContentOperationOptions) (result DeleteDriveSpecialContentOperationResponse, err error) {
