...
func (c DriveSpecialContentClient) GetDriveSpecialContent(ctx context.Context, id beta.MeDriveIdSpecialId, options GetDriveSpecialContentOperationOptions) (result GetDriveSpecialContentOperationResponse, err error) {
