...
func (c DriveSpecialContentClient) SetDriveSpecialContent(ctx context.Context, id beta.MeDriveIdSpecialId, input []byte, options SetDriveSpecialContentOperationOptions) (result SetDriveSpecialContentOperationResponse, err error) {
