...
// GetDriveSpecialContentStream - Get contentStream for the navigation property special from me. The content stream, if
// the item represents a file.
func (c DriveSpecialContentStreamClient) GetDriveSpecialContentStream(ctx context.Context, id beta.MeDriveIdSpecialId, options GetDriveSpecialContentStreamOperationOptions) (result GetDriveSpecialContentStreamOperationResponse, err error) {
