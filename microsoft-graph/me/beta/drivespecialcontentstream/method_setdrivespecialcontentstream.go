...
// SetDriveSpecialContentStream - Update contentStream for the navigation property special in me. The content stream, if
// the item represents a file.
func (c DriveSpecialContentStreamClient) SetDriveSpecialContentStream(ctx context.Context, id beta.MeDriveIdSpecialId, input []byte, options SetDriveSpecialContentStreamOperationOptions) (result SetDriveSpecialContentStreamOperationResponse, err error) {
