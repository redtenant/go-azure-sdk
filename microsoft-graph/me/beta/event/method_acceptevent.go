...
func (c EventClient) AcceptEvent(ctx context.Context, id beta.MeEventId, input AcceptEventRequest, options AcceptEventOperationOptions) (result AcceptEventOperationResponse, err error) {
