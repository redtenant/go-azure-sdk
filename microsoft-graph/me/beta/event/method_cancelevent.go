...
func (c EventClient) CancelEvent(ctx context.Context, id beta.MeEventId, input CancelEventRequest, options CancelEventOperationOptions) (result CancelEventOperationResponse, err error) {
