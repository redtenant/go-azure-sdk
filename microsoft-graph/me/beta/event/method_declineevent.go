...
func (c EventClient) DeclineEvent(ctx context.Context, id beta.MeEventId, input DeclineEventRequest, options DeclineEventOperationOptions) (result DeclineEventOperationResponse, err error) {
