...
func (c EventClient) DeleteEvent(ctx context.Context, id beta.MeEventId, options DeleteEventOperationOptions) (result DeleteEventOperationResponse, err error) {
