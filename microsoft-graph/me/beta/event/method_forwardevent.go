...
// account.
func (c EventClient) ForwardEvent(ctx context.Context, id beta.MeEventId, input ForwardEventRequest, options ForwardEventOperationOptions) (result ForwardEventOperationResponse, err error) {
