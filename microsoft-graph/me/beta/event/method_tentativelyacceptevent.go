...
func (c EventClient) TentativelyAcceptEvent(ctx context.Context, id beta.MeEventId, input TentativelyAcceptEventRequest, options TentativelyAcceptEventOperationOptions) (result TentativelyAcceptEventOperationResponse, err error) {
