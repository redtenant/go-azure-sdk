...
func (c EventClient) UpdateEvent(ctx context.Context, id beta.MeEventId, input beta.Event, options UpdateEventOperationOptions) (result UpdateEventOperationResponse, err error) {
