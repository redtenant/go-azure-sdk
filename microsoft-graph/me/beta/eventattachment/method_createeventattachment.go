...
func (c EventAttachmentClient) CreateEventAttachment(ctx context.Context, id beta.MeEventId, input beta.Attachment, options CreateEventAttachmentOperationOptions) (result CreateEventAttachmentOperationResponse, err error) {
