...
func (c EventAttachmentClient) GetEventAttachmentsCount(ctx context.Context, id beta.MeEventId, options GetEventAttachmentsCountOperationOptions) (result GetEventAttachmentsCountOperationResponse, err error) {
