...
func (c EventAttachmentClient) ListEventAttachments(ctx context.Context, id beta.MeEventId, options ListEventAttachmentsOperationOptions) (result ListEventAttachmentsOperationResponse, err error) {
...
func (c EventAttachmentClient) ListEventAttachmentsComplete(ctx context.Context, id beta.MeEventId, options ListEventAttachmentsOperationOptions) (ListEventAttachmentsCompleteResult, error) {
...
func (c EventAttachmentClient) ListEventAttachmentsCompleteMatchingPredicate(ctx context.Context, id beta.MeEventId, options ListEventAttachmentsOperationOptions, predicate AttachmentOperationPredicate) (result ListEventAttachmentsCompleteResult, err error) {
