...
func (c EventCalendarClient) GetEventCalendar(ctx context.Context, id beta.MeEventId, options GetEventCalendarOperationOptions) (result GetEventCalendarOperationResponse, err error) {
