...
func (c EventExceptionOccurrenceClient) AcceptEventExceptionOccurrence(ctx context.Context, id beta.MeEventIdExceptionOccurrenceId, input AcceptEventExceptionOccurrenceRequest, options AcceptEventExceptionOccurrenceOperationOptions) (result AcceptEventExceptionOccurrenceOperationResponse, err error) {
