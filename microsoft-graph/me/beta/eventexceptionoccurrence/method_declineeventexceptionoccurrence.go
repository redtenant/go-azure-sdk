...
func (c EventExceptionOccurrenceClient) DeclineEventExceptionOccurrence(ctx context.Context, id beta.MeEventIdExceptionOccurrenceId, input DeclineEventExceptionOccurrenceRequest, options DeclineEventExceptionOccurrenceOperationOptions) (result DeclineEventExceptionOccurrenceOperationResponse, err error) {
