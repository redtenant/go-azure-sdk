...
func (c EventExceptionOccurrenceClient) DismissEventExceptionOccurrenceReminder(ctx context.Context, id beta.MeEventIdExceptionOccurrenceId, options DismissEventExceptionOccurrenceReminderOperationOptions) (result DismissEventExceptionOccurrenceReminderOperationResponse, err error) {
