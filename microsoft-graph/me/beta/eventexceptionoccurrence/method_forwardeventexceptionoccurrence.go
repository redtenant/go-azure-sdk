...
func (c EventExceptionOccurrenceClient) ForwardEventExceptionOccurrence(ctx context.Context, id beta.MeEventIdExceptionOccurrenceId, input ForwardEventExceptionOccurrenceRequest, options ForwardEventExceptionOccurrenceOperationOptions) (result ForwardEventExceptionOccurrenceOperationResponse, err error) {
