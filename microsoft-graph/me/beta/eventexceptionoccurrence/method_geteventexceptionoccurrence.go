...
// GetEventExceptionOccurrence - Get exceptionOccurrences from me
func (c EventExceptionOccurrenceClient) GetEventExceptionOccurrence(ctx context.Context, id beta.MeEventIdExceptionOccurrenceId, options GetEventExceptionOccurrenceOperationOptions) (result GetEventExceptionOccurrenceOperationResponse, err error) {
