...
func (c EventExceptionOccurrenceClient) GetEventExceptionOccurrencesCount(ctx context.Context, id beta.MeEventId, options GetEventExceptionOccurrencesCountOperationOptions) (result GetEventExceptionOccurrencesCountOperationResponse, err error) {
