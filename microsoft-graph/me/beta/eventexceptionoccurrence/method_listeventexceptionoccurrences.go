...
// ListEventExceptionOccurrences - Get exceptionOccurrences from me
func (c EventExceptionOccurrenceClient) ListEventExceptionOccurrences(ctx context.Context, id beta.MeEventId, options ListEventExceptionOccurrencesOperationOptions) (result ListEventExceptionOccurrencesOperationResponse, err error) {
...
func (c EventExceptionOccurrenceClient) ListEventExceptionOccurrencesComplete(ctx context.Context, id beta.MeEventId, options ListEventExceptionOccurrencesOperationOptions) (ListEventExceptionOccurrencesCompleteResult, error) {
...
func (c EventExceptionOccurrenceClient) ListEventExceptionOccurrencesCompleteMatchingPredicate(ctx context.Context, id beta.MeEventId, options ListEventExceptionOccurrencesOperationOptions, predicate EventOperationPredicate) (result ListEventExceptionOccurrencesCompleteResult, err error) {
