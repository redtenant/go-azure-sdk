...
func (c EventExceptionOccurrenceClient) TentativelyAcceptEventExceptionOccurrence(ctx context.Context, id beta.MeEventIdExceptionOccurrenceId, input TentativelyAcceptEventExceptionOccurrenceRequest, options TentativelyAcceptEventExceptionOccurrenceOperationOptions) (result TentativelyAcceptEventExceptionOccurrenceOperationResponse, err error) {
