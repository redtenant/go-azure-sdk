...
// CreateEventExceptionOccurrenceAttachment - Create new navigation property to attachments for me
func (c EventExceptionOccurrenceAttachmentClient) CreateEventExceptionOccurrenceAttachment(ctx context.Context, id beta.MeEventIdExceptionOccurrenceId, input beta.Attachment, options CreateEventExceptionOccurrenceAttachmentOperationOptions) (result CreateEventExceptionOccurrenceAttachmentOperationResponse, err error) {
