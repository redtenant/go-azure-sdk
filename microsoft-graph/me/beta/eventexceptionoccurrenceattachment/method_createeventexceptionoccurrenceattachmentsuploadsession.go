...
func (c EventExceptionOccurrenceAttachmentClient) CreateEventExceptionOccurrenceAttachmentsUploadSession(ctx context.Context, id beta.MeEventIdExceptionOccurrenceId, input CreateEventExceptionOccurrenceAttachmentsUploadSessionRequest, options CreateEventExceptionOccurrenceAttachmentsUploadSessionOperationOptions) (result CreateEventExceptionOccurrenceAttachmentsUploadSessionOperationResponse, err error) {
