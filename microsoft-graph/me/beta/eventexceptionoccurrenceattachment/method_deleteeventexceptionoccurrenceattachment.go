...
func DefaultDeleteEventExceptionOccurrenceAttachmentOperationOptions() DeleteEventExceptionOccurrenceAttachmentOperationOptions {
	return DeleteEventExceptionOccurrenceAttachmentOperationOptions{}
}
...
// DeleteEventExceptionOccurrenceAttachment - Delete navigation property attachments for me
func (c EventExceptionOccurrenceAttachmentClient) DeleteEventExceptionOccurrenceAttachment(ctx context.Context, id beta.MeEventIdExceptionOccurrenceIdAttachmentId, options DeleteEventExceptionOccurrenceAttachmentOperationOptions) (result DeleteEventExceptionOccurrenceAttachmentOperationResponse, err error) {
