...
// GetEventExceptionOccurrenceAttachment - Get attachments from me. The collection of FileAttachment, ItemAttachment,
// and referenceAttachment attachments for the event. Navigation property. Read-only. Nullable.
func (c EventExceptionOccurrenceAttachmentClient) GetEventExceptionOccurrenceAttachment(ctx context.Context, id beta.MeEventIdExceptionOccurrenceIdAttachmentId, options GetEventExceptionOccurrenceAttachmentOperationOptions) (result GetEventExceptionOccurrenceAttachmentOperationResponse, err error) {
