...
func (c EventExceptionOccurrenceAttachmentClient) GetEventExceptionOccurrenceAttachmentsCount(ctx context.Context, id beta.MeEventIdExceptionOccurrenceId, options GetEventExceptionOccurrenceAttachmentsCountOperationOptions) (result GetEventExceptionOccurrenceAttachmentsCountOperationResponse, err error) {
