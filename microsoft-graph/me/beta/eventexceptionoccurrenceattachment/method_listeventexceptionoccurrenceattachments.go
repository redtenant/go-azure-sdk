...
// ListEventExceptionOccurrenceAttachments - Get attachments from me. The collection of FileAttachment, ItemAttachment,
// and referenceAttachment attachments for the event. Navigation property. Read-only. Nullable.
func (c EventExceptionOccurrenceAttachmentClient) ListEventExceptionOccurrenceAttachments(ctx context.Context, id beta.MeEventIdExceptionOccurrenceId, options ListEventExceptionOccurrenceAttachmentsOperationOptions) (result ListEventExceptionOccurrenceAttachmentsOperationResponse, err error) {
...
func (c EventExceptionOccurrenceAttachmentClient) ListEventExceptionOccurrenceAttachmentsComplete(ctx context.Context, id beta.MeEventIdExceptionOccurrenceId, options ListEventExceptionOccurrenceAttachmentsOperationOptions) (ListEventExceptionOccurrenceAttachmentsCompleteResult, error) {
...
func (c EventExceptionOccurrenceAttachmentClient) ListEventExceptionOccurrenceAttachmentsCompleteMatchingPredicate(ctx context.Context, id beta.MeEventIdExceptionOccurrenceId, options ListEventExceptionOccurrenceAttachmentsOperationOptions, predicate AttachmentOperationPredicate) (result ListEventExceptionOccurrenceAttachmentsCompleteResult, err error) {
