...
// DeleteEventExceptionOccurrenceExtension - Delete navigation property extensions for me
func (c EventExceptionOccurrenceExtensionClient) DeleteEventExceptionOccurrenceExtension(ctx context.Context, id beta.MeEventIdExceptionOccurrenceIdExtensionId, options DeleteEventExceptionOccurrenceExtensionOperationOptions) (result DeleteEventExceptionOccurrenceExtensionOperationResponse, err error) {
