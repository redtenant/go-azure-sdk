...
// GetEventExceptionOccurrenceExtension - Get extensions from me. The collection of open extensions defined for the
// event. Nullable.
func (c EventExceptionOccurrenceExtensionClient) GetEventExceptionOccurrenceExtension(ctx context.Context, id beta.MeEventIdExceptionOccurrenceIdExtensionId, options GetEventExceptionOccurrenceExtensionOperationOptions) (result GetEventExceptionOccurrenceExtensionOperationResponse, err error) {
