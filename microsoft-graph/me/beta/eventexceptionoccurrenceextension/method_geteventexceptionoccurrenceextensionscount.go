...
func (c EventExceptionOccurrenceExtensionClient) GetEventExceptionOccurrenceExtensionsCount(ctx context.Context, id beta.MeEventIdExceptionOccurrenceId, options GetEventExceptionOccurrenceExtensionsCountOperationOptions) (result GetEventExceptionOccurrenceExtensionsCountOperationResponse, err error) {
