...
// ListEventExceptionOccurrenceExtensions - Get extensions from me. The collection of open extensions defined for the
// event. Nullable.
func (c EventExceptionOccurrenceExtensionClient) ListEventExceptionOccurrenceExtensions(ctx context.Context, id beta.MeEventIdExceptionOccurrenceId, options ListEventExceptionOccurrenceExtensionsOperationOptions) (result ListEventExceptionOccurrenceExtensionsOperationResponse, err error) {
...
func (c EventExceptionOccurrenceExtensionClient) ListEventExceptionOccurrenceExtensionsComplete(ctx context.Context, id beta.MeEventIdExceptionOccurrenceId, options ListEventExceptionOccurrenceExtensionsOperationOptions) (ListEventExceptionOccurrenceExtensionsCompleteResult, error) {
