...
// UpdateEventExceptionOccurrenceExtension - Update the navigation property extensions in me
func (c EventExceptionOccurrenceExtensionClient) UpdateEventExceptionOccurrenceExtension(ctx context.Context, id beta.MeEventIdExceptionOccurrenceIdExtensionId, input beta.Extension, options UpdateEventExceptionOccurrenceExtensionOperationOptions) (result UpdateEventExceptionOccurrenceExtensionOperationResponse, err error) {
