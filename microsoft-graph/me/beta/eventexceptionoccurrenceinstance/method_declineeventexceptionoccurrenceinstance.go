...
func (c EventExceptionOccurrenceInstanceClient) DeclineEventExceptionOccurrenceInstance(ctx context.Context, id beta.MeEventIdExceptionOccurrenceIdInstanceId, input DeclineEventExceptionOccurrenceInstanceRequest, options DeclineEventExceptionOccurrenceInstanceOperationOptions) (result DeclineEventExceptionOccurrenceInstanceOperationResponse, err error) {
