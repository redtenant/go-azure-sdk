...
func (c EventExceptionOccurrenceInstanceClient) ForwardEventExceptionOccurrenceInstance(ctx context.Context, id beta.MeEventIdExceptionOccurrenceIdInstanceId, input ForwardEventExceptionOccurrenceInstanceRequest, options ForwardEventExceptionOccurrenceInstanceOperationOptions) (result ForwardEventExceptionOccurrenceInstanceOperationResponse, err error) {
