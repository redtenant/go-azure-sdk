...
// GetEventExceptionOccurrenceInstance - Get instances from me. The occurrences of a recurring series, if the event is a
...
// Read-only. Nullable.
func (c EventExceptionOccurrenceInstanceClient) GetEventExceptionOccurrenceInstance(ctx context.Context, id beta.MeEventIdExceptionOccurrenceIdInstanceId, options GetEventExceptionOccurrenceInstanceOperationOptions) (result GetEventExceptionOccurrenceInstanceOperationResponse, err error) {
