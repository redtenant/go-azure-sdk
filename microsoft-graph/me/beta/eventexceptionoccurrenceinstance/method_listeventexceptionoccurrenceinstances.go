...
// ListEventExceptionOccurrenceInstances - Get instances from me. The occurrences of a recurring series, if the event is
// a series master. This property includes occurrences that are part of the recurrence pattern, and exceptions that have
// been modified, but doesn't include occurrences that have been canceled from the series. Navigation property.
// Read-only. Nullable.
func (c EventExceptionOccurrenceInstanceClient) ListEventExceptionOccurrenceInstances(ctx context.Context, id beta.MeEventIdExceptionOccurrenceId, options ListEventExceptionOccurrenceInstancesOperationOptions) (result ListEventExceptionOccurrenceInstancesOperationResponse, err error) {
...
func (c EventExceptionOccurrenceInstanceClient) ListEventExceptionOccurrenceInstancesComplete(ctx context.Context, id beta.MeEventIdExceptionOccurrenceId, options ListEventExceptionOccurrenceInstancesOperationOptions) (ListEventExceptionOccurrenceInstancesCompleteResult, error) {
