...
func (c EventExceptionOccurrenceInstanceClient) TentativelyAcceptEventExceptionOccurrenceInstance(ctx context.Context, id beta.MeEventIdExceptionOccurrenceIdInstanceId, input TentativelyAcceptEventExceptionOccurrenceInstanceRequest, options TentativelyAcceptEventExceptionOccurrenceInstanceOperationOptions) (result TentativelyAcceptEventExceptionOccurrenceInstanceOperationResponse, err error) {
