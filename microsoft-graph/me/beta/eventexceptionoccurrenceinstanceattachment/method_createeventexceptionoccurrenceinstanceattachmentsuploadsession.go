...
func (c EventExceptionOccurrenceInstanceAttachmentClient) CreateEventExceptionOccurrenceInstanceAttachmentsUploadSession(ctx context.Context, id beta.MeEventIdExceptionOccurrenceIdInstanceId, input CreateEventExceptionOccurrenceInstanceAttachmentsUploadSessionRequest, options CreateEventExceptionOccurrenceInstanceAttachmentsUploadSessionOperationOptions) (result CreateEventExceptionOccurrenceInstanceAttachmentsUploadSessionOperationResponse, err error) {
