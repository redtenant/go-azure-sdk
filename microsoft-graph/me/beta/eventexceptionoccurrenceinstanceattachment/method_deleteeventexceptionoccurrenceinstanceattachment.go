...
// DeleteEventExceptionOccurrenceInstanceAttachment - Delete navigation property attachments for me
func (c EventExceptionOccurrenceInstanceAttachmentClient) DeleteEventExceptionOccurrenceInstanceAttachment(ctx context.Context, id beta.MeEventIdExceptionOccurrenceIdInstanceIdAttachmentId, options DeleteEventExceptionOccurrenceInstanceAttachmentOperationOptions) (result DeleteEventExceptionOccurrenceInstanceAttachmentOperationResponse, err error) {
