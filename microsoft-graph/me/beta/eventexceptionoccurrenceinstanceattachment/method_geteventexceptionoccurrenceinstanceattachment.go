...
// GetEventExceptionOccurrenceInstanceAttachment - Get attachments from me. The collection of FileAttachment,
// ItemAttachment, and referenceAttachment attachments for the event. Navigation property. Read-only. Nullable.
func (c EventExceptionOccurrenceInstanceAttachmentClient) GetEventExceptionOccurrenceInstanceAttachment(ctx context.Context, id beta.MeEventIdExceptionOccurrenceIdInstanceIdAttachmentId, options GetEventExceptionOccurrenceInstanceAttachmentOperationOptions) (result GetEventExceptionOccurrenceInstanceAttachmentOperationResponse, err error) {
