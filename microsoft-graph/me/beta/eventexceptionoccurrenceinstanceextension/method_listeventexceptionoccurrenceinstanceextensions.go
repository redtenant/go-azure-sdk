...
// ListEventExceptionOccurrenceInstanceExtensions - Get extensions from me. The collection of open extensions defined
// for the event. Nullable.
func (c EventExceptionOccurrenceInstanceExtensionClient) ListEventExceptionOccurrenceInstanceExtensions(ctx context.Context, id beta.MeEventIdExceptionOccurrenceIdInstanceId, options ListEventExceptionOccurrenceInstanceExtensionsOperationOptions) (result ListEventExceptionOccurrenceInstanceExtensionsOperationResponse, err error) {
...
func (c EventExceptionOccurrenceInstanceExtensionClient) ListEventExceptionOccurrenceInstanceExtensionsComplete(ctx context.Context, id beta.MeEventIdExceptionOccurrenceIdInstanceId, options ListEventExceptionOccurrenceInstanceExtensionsOperationOptions) (ListEventExceptionOccurrenceInstanceExtensionsCompleteResult, error) {
...
func (c EventExceptionOccurrenceInstanceExtensionClient) ListEventExceptionOccurrenceInstanceExtensionsCompleteMatchingPredicate(ctx context.Context, id beta.MeEventIdExceptionOccurrenceIdInstanceId, options ListEventExceptionOccurrenceInstanceExtensionsOperationOptions, predicate ExtensionOperationPredicate) (result ListEventExceptionOccurrenceInstanceExtensionsCompleteResult, err error) {
