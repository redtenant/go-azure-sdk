...
func (c EventExtensionClient) DeleteEventExtension(ctx context.Context, id beta.MeEventIdExtensionId, options DeleteEventExtensionOperationOptions) (result DeleteEventExtensionOperationResponse, err error) {
