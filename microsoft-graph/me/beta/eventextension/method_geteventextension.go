...
func (c EventExtensionClient) GetEventExtension(ctx context.Context, id beta.MeEventIdExtensionId, options GetEventExtensionOperationOptions) (result GetEventExtensionOperationResponse, err error) {
