...
func (c EventExtensionClient) ListEventExtensions(ctx context.Context, id beta.MeEventId, options ListEventExtensionsOperationOptions) (result ListEventExtensionsOperationResponse, err error) {
...
func (c EventExtensionClient) ListEventExtensionsComplete(ctx context.Context, id beta.MeEventId, options ListEventExtensionsOperationOptions) (ListEventExtensionsCompleteResult, error) {
...
func (c EventExtensionClient) ListEventExtensionsCompleteMatchingPredicate(ctx context.Context, id beta.MeEventId, options ListEventExtensionsOperationOptions, predicate ExtensionOperationPredicate) (result ListEventExtensionsCompleteResult, err error) {
