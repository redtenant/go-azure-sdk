...
func (c EventExtensionClient) UpdateEventExtension(ctx context.Context, id beta.MeEventIdExtensionId, input beta.Extension, options UpdateEventExtensionOperationOptions) (result UpdateEventExtensionOperationResponse, err error) {
