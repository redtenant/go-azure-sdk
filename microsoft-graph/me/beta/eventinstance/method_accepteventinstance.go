...
func (c EventInstanceClient) AcceptEventInstance(ctx context.Context, id beta.MeEventIdInstanceId, input AcceptEventInstanceRequest, options AcceptEventInstanceOperationOptions) (result AcceptEventInstanceOperationResponse, err error) {
