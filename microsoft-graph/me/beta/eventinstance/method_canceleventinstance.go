...
func (c EventInstanceClient) CancelEventInstance(ctx context.Context, id beta.MeEventIdInstanceId, input CancelEventInstanceRequest, options CancelEventInstanceOperationOptions) (result CancelEventInstanceOperationResponse, err error) {
