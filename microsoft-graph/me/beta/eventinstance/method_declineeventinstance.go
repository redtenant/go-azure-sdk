...
func (c EventInstanceClient) DeclineEventInstance(ctx context.Context, id beta.MeEventIdInstanceId, input DeclineEventInstanceRequest, options DeclineEventInstanceOperationOptions) (result DeclineEventInstanceOperationResponse, err error) {
