...
// in a user calendar.
func (c EventInstanceClient) DismissEventInstanceReminder(ctx context.Context, id beta.MeEventIdInstanceId, options DismissEventInstanceReminderOperationOptions) (result DismissEventInstanceReminderOperationResponse, err error) {
