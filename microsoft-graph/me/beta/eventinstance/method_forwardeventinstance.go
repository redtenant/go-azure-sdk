...
// Outlook.com account.
func (c EventInstanceClient) ForwardEventInstance(ctx context.Context, id beta.MeEventIdInstanceId, input ForwardEventInstanceRequest, options ForwardEventInstanceOperationOptions) (result ForwardEventInstanceOperationResponse, err error) {
