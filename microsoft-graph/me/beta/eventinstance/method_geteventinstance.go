...
// GetEventInstance - Get instances from me. The occurrences of a recurring series, if the event is a series master.
...
func (c EventInstanceClient) GetEventInstance(ctx context.Context, id beta.MeEventIdInstanceId, options GetEventInstanceOperationOptions) (result GetEventInstanceOperationResponse, err error) {
