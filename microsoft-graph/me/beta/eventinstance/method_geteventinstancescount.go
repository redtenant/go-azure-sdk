...
func (c EventInstanceClient) GetEventInstancesCount(ctx context.Context, id beta.MeEventId, options GetEventInstancesCountOperationOptions) (result GetEventInstancesCountOperationResponse, err error) {
