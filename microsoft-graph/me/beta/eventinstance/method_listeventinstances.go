...
// range.
func (c EventInstanceClient) ListEventInstances(ctx context.Context, id beta.MeEventId, options ListEventInstancesOperationOptions) (result ListEventInstancesOperationResponse, err error) {
...
func (c EventInstanceClient) ListEventInstancesComplete(ctx context.Context, id beta.MeEventId, options ListEventInstancesOperationOptions) (ListEventInstancesCompleteResult, error) {
...
func (c EventInstanceClient) ListEventInstancesCompleteMatchingPredicate(ctx context.Context, id beta.MeEventId, options ListEventInstancesOperationOptions, predicate EventOperationPredicate) (result ListEventInstancesCompleteResult, err error) {
