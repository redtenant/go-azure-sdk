...
func (c EventInstanceClient) TentativelyAcceptEventInstance(ctx context.Context, id beta.MeEventIdInstanceId, input TentativelyAcceptEventInstanceRequest, options TentativelyAcceptEventInstanceOperationOptions) (result TentativelyAcceptEventInstanceOperationResponse, err error) {
