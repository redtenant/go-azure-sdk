...
func (c EventInstanceAttachmentClient) DeleteEventInstanceAttachment(ctx context.Context, id beta.MeEventIdInstanceIdAttachmentId, options DeleteEventInstanceAttachmentOperationOptions) (result DeleteEventInstanceAttachmentOperationResponse, err error) {
