...
func (c EventInstanceAttachmentClient) GetEventInstanceAttachmentsCount(ctx context.Context, id beta.MeEventIdInstanceId, options GetEventInstanceAttachmentsCountOperationOptions) (result GetEventInstanceAttachmentsCountOperationResponse, err error) {
