...
func (c EventInstanceExceptionOccurrenceClient) DismissEventInstanceExceptionOccurrenceReminder(ctx context.Context, id beta.MeEventIdInstanceIdExceptionOccurrenceId, options DismissEventInstanceExceptionOccurrenceReminderOperationOptions) (result DismissEventInstanceExceptionOccurrenceReminderOperationResponse, err error) {
