...
// ListEventInstanceExceptionOccurrences - Get exceptionOccurrences from me
func (c EventInstanceExceptionOccurrenceClient) ListEventInstanceExceptionOccurrences(ctx context.Context, id beta.MeEventIdInstanceId, options ListEventInstanceExceptionOccurrencesOperationOptions) (result ListEventInstanceExceptionOccurrencesOperationResponse, err error) {
...
func (c EventInstanceExceptionOccurrenceClient) ListEventInstanceExceptionOccurrencesComplete(ctx context.Context, id beta.MeEventIdInstanceId, options ListEventInstanceExceptionOccurrencesOperationOptions) (ListEventInstanceExceptionOccurrencesCompleteResult, error) {
...
func (c EventInstanceExceptionOccurrenceClient) ListEventInstanceExceptionOccurrencesCompleteMatchingPredicate(ctx context.Context, id beta.MeEventIdInstanceId, options ListEventInstanceExceptionOccurrencesOperationOptions, predicate EventOperationPredicate) (result ListEventInstanceExceptionOccurrencesCompleteResult, err error) {
