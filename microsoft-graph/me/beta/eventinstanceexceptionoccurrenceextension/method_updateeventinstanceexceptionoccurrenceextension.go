...
func (c EventInstanceExceptionOccurrenceExtensionClient) UpdateEventInstanceExceptionOccurrenceExtension(ctx context.Context, id beta.MeEventIdInstanceIdExceptionOccurrenceIdExtensionId, input beta.Extension, options UpdateEventInstanceExceptionOccurrenceExtensionOperationOptions) (result UpdateEventInstanceExceptionOccurrenceExtensionOperationResponse, err error) {
