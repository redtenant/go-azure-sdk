...
func (c EventInstanceExtensionClient) CreateEventInstanceExtension(ctx context.Context, id beta.MeEventIdInstanceId, input beta.Extension, options CreateEventInstanceExtensionOperationOptions) (result CreateEventInstanceExtensionOperationResponse, err error) {
