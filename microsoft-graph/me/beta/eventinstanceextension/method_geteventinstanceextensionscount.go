...
func (c EventInstanceExtensionClient) GetEventInstanceExtensionsCount(ctx context.Context, id beta.MeEventIdInstanceId, options GetEventInstanceExtensionsCountOperationOptions) (result GetEventInstanceExtensionsCountOperationResponse, err error) {
