...
// Nullable.
func (c EventInstanceExtensionClient) ListEventInstanceExtensions(ctx context.Context, id beta.MeEventIdInstanceId, options ListEventInstanceExtensionsOperationOptions) (result ListEventInstanceExtensionsOperationResponse, err error) {
...
func (c EventInstanceExtensionClient) ListEventInstanceExtensionsComplete(ctx context.Context, id beta.MeEventIdInstanceId, options ListEventInstanceExtensionsOperationOptions) (ListEventInstanceExtensionsCompleteResult, error) {
...
func (c EventInstanceExtensionClient) ListEventInstanceExtensionsCompleteMatchingPredicate(ctx context.Context, id beta.MeEventIdInstanceId, options ListEventInstanceExtensionsOperationOptions, predicate ExtensionOperationPredicate) (result ListEventInstanceExtensionsCompleteResult, err error) {
