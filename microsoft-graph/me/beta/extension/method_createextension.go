...
func (c ExtensionClient) CreateExtension(ctx context.Context, input beta.Extension, options CreateExtensionOperationOptions) (result CreateExtensionOperationResponse, err error) {
