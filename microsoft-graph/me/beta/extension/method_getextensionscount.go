...
func (c ExtensionClient) GetExtensionsCount(ctx context.Context, options GetExtensionsCountOperationOptions) (result GetExtensionsCountOperationResponse, err error) {
