...
func (c ExtensionClient) UpdateExtension(ctx context.Context, id beta.MeExtensionId, input beta.Extension, options UpdateExtensionOperationOptions) (result UpdateExtensionOperationResponse, err error) {
