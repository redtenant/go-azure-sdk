...
func (c FollowedSiteClient) GetFollowedSite(ctx context.Context, id beta.MeFollowedSiteId, options GetFollowedSiteOperationOptions) (result GetFollowedSiteOperationResponse, err error) {
