...
func (c FollowedSiteClient) GetFollowedSitesCount(ctx context.Context, options GetFollowedSitesCountOperationOptions) (result GetFollowedSitesCountOperationResponse, err error) {
