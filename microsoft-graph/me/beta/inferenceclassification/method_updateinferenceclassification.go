...
func (c InferenceClassificationClient) UpdateInferenceClassification(ctx context.Context, input beta.InferenceClassification, options UpdateInferenceClassificationOperationOptions) (result UpdateInferenceClassificationOperationResponse, err error) {
