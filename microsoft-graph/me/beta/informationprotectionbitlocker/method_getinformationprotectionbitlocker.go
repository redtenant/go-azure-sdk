...
// GetInformationProtectionBitlocker - Get bitlocker from me
func (c InformationProtectionBitlockerClient) GetInformationProtectionBitlocker(ctx context.Context, options GetInformationProtectionBitlockerOperationOptions) (result GetInformationProtectionBitlockerOperationResponse, err error) {
