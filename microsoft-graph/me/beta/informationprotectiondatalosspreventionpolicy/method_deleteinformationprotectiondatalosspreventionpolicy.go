...
func DefaultDeleteInformationProtectionDataLossPreventionPolicyOperationOptions() DeleteInformationProtectionDataLossPreventionPolicyOperationOptions {
	return DeleteInformationProtectionDataLossPreventionPolicyOperationOptions{}
}
...
// DeleteInformationProtectionDataLossPreventionPolicy - Delete navigation property dataLossPreventionPolicies for me
func (c InformationProtectionDataLossPreventionPolicyClient) DeleteInformationProtectionDataLossPreventionPolicy(ctx context.Context, id beta.MeInformationProtectionDataLossPreventionPolicyId, options DeleteInformationProtectionDataLossPreventionPolicyOperationOptions) (result DeleteInformationProtectionDataLossPreventionPolicyOperationResponse, err error) {
