...
func DefaultGetInformationProtectionDataLossPreventionPolicyOperationOptions() GetInformationProtectionDataLossPreventionPolicyOperationOptions {
	return GetInformationProtectionDataLossPreventionPolicyOperationOptions{}
}
...
// GetInformationProtectionDataLossPreventionPolicy - Get dataLossPreventionPolicies from me
func (c InformationProtectionDataLossPreventionPolicyClient) GetInformationProtectionDataLossPreventionPolicy(ctx context.Context, id beta.MeInformationProtectionDataLossPreventionPolicyId, options GetInformationProtectionDataLossPreventionPolicyOperationOptions) (result GetInformationProtectionDataLossPreventionPolicyOperationResponse, err error) {
