...
func DefaultListInformationProtectionDataLossPreventionPoliciesOperationOptions() ListInformationProtectionDataLossPreventionPoliciesOperationOptions {
	return ListInformationProtectionDataLossPreventionPoliciesOperationOptions{}
}
...
// ListInformationProtectionDataLossPreventionPolicies - Get dataLossPreventionPolicies from me
func (c InformationProtectionDataLossPreventionPolicyClient) ListInformationProtectionDataLossPreventionPolicies(ctx context.Context, options ListInformationProtectionDataLossPreventionPoliciesOperationOptions) (result ListInformationProtectionDataLossPreventionPoliciesOperationResponse, err error) {
...
func (c InformationProtectionDataLossPreventionPolicyClient) ListInformationProtectionDataLossPreventionPoliciesComplete(ctx context.Context, options ListInformationProtectionDataLossPreventionPoliciesOperationOptions) (ListInformationProtectionDataLossPreventionPoliciesCompleteResult, error) {
	return c.ListInformationProtectionDataLossPreventionPoliciesCompleteMatchingPredicate(ctx, options, DataLossPreventionPolicyOperationPredicate{})
}
...
func (c InformationProtectionDataLossPreventionPolicyClient) ListInformationProtectionDataLossPreventionPoliciesCompleteMatchingPredicate(ctx context.Context, options ListInformationProtectionDataLossPreventionPoliciesOperationOptions, predicate DataLossPreventionPolicyOperationPredicate) (result ListInformationProtectionDataLossPreventionPoliciesCompleteResult, err error) {
	items := make([]beta.DataLossPreventionPolicy, 0)

	resp, err := c.ListInformationProtectionDataLossPreventionPolicies(ctx, options)
	if err != nil {
