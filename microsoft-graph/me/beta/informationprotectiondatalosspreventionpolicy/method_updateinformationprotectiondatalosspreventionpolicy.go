...
// UpdateInformationProtectionDataLossPreventionPolicy - Update the navigation property dataLossPreventionPolicies in me
func (c InformationProtectionDataLossPreventionPolicyClient) UpdateInformationProtectionDataLossPreventionPolicy(ctx context.Context, id beta.MeInformationProtectionDataLossPreventionPolicyId, input beta.DataLossPreventionPolicy, options UpdateInformationProtectionDataLossPreventionPolicyOperationOptions) (result UpdateInformationProtectionDataLossPreventionPolicyOperationResponse, err error) {
