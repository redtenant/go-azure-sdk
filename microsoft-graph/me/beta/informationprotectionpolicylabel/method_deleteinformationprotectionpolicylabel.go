...
func (c InformationProtectionPolicyLabelClient) DeleteInformationProtectionPolicyLabel(ctx context.Context, id beta.MeInformationProtectionPolicyLabelId, options DeleteInformationProtectionPolicyLabelOperationOptions) (result DeleteInformationProtectionPolicyLabelOperationResponse, err error) {
