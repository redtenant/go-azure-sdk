...
func (c InformationProtectionPolicyLabelClient) EvaluateInformationProtectionPolicyLabelsRemovals(ctx context.Context, input EvaluateInformationProtectionPolicyLabelsRemovalsRequest, options EvaluateInformationProtectionPolicyLabelsRemovalsOperationOptions) (result EvaluateInformationProtectionPolicyLabelsRemovalsOperationResponse, err error) {
...
func (c InformationProtectionPolicyLabelClient) EvaluateInformationProtectionPolicyLabelsRemovalsComplete(ctx context.Context, input EvaluateInformationProtectionPolicyLabelsRemovalsRequest, options EvaluateInformationProtectionPolicyLabelsRemovalsOperationOptions) (EvaluateInformationProtectionPolicyLabelsRemovalsCompleteResult, error) {
	return c.EvaluateInformationProtectionPolicyLabelsRemovalsCompleteMatchingPredicate(ctx, input, options, InformationProtectionActionOperationPredicate{})
}
...
func (c InformationProtectionPolicyLabelClient) EvaluateInformationProtectionPolicyLabelsRemovalsCompleteMatchingPredicate(ctx context.Context, input EvaluateInformationProtectionPolicyLabelsRemovalsRequest, options EvaluateInformationProtectionPolicyLabelsRemovalsOperationOptions, predicate InformationProtectionActionOperationPredicate) (result EvaluateInformationProtectionPolicyLabelsRemovalsCompleteResult, err error) {
	items := make([]beta.InformationProtectionAction, 0)

	resp, err := c.EvaluateInformationProtectionPolicyLabelsRemovals(ctx, input, options)
	if err != nil {
