...
func DefaultGetInformationProtectionPolicyLabelsCountOperationOptions() GetInformationProtectionPolicyLabelsCountOperationOptions {
	return GetInformationProtectionPolicyLabelsCountOperationOptions{}
}
...
func (c InformationProtectionPolicyLabelClient) GetInformationProtectionPolicyLabelsCount(ctx context.Context, options GetInformationProtectionPolicyLabelsCountOperationOptions) (result GetInformationProtectionPolicyLabelsCountOperationResponse, err error) {
	opts := client.RequestOptions{
		...
		Path:          "/me/informationProtection/policy/labels/$count",
