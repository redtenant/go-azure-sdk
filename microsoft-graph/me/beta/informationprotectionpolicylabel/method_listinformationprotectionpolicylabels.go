...
// ListInformationProtectionPolicyLabels - informationProtectionLabel: listLabels (deprecated). Get a collection of
// information protection labels available to the user or to the organization.
func (c InformationProtectionPolicyLabelClient) ListInformationProtectionPolicyLabels(ctx context.Context, options ListInformationProtectionPolicyLabelsOperationOptions) (result ListInformationProtectionPolicyLabelsOperationResponse, err error) {
...
func (c InformationProtectionPolicyLabelClient) ListInformationProtectionPolicyLabelsComplete(ctx context.Context, options ListInformationProtectionPolicyLabelsOperationOptions) (ListInformationProtectionPolicyLabelsCompleteResult, error) {
	return c.ListInformationProtectionPolicyLabelsCompleteMatchingPredicate(ctx, options, InformationProtectionLabelOperationPredicate{})
}

// ListInformationProtectionPolicyLabelsCompleteMatchingPredicate retrieves all the results and then applies the predicate
func (c InformationProtectionPolicyLabelClient) ListInformationProtectionPolicyLabelsCompleteMatchingPredicate(ctx context.Context, options ListInformationProtectionPolicyLabelsOperationOptions, predicate InformationProtectionLabelOperationPredicate) (result ListInformationProtectionPolicyLabelsCompleteResult, err error) {
	items := make([]beta.InformationProtectionLabel, 0)

	resp, err := c.ListInformationProtectionPolicyLabels(ctx, options)
	if err != nil {
