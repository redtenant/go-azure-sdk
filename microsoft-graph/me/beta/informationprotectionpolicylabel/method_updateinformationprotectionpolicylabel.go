...
func (c InformationProtectionPolicyLabelClient) UpdateInformationProtectionPolicyLabel(ctx context.Context, id beta.MeInformationProtectionPolicyLabelId, input beta.InformationProtectionLabel, options UpdateInformationProtectionPolicyLabelOperationOptions) (result UpdateInformationProtectionPolicyLabelOperationResponse, err error) {
