...
type CreateInformationProtectionThreatAssessmentRequestResultOperationResponse struct {
...
// CreateInformationProtectionThreatAssessmentRequestResult - Create new navigation property to results for me
func (c InformationProtectionThreatAssessmentRequestResultClient) CreateInformationProtectionThreatAssessmentRequestResult(ctx context.Context, id beta.MeInformationProtectionThreatAssessmentRequestId, input beta.ThreatAssessmentResult, options CreateInformationProtectionThreatAssessmentRequestResultOperationOptions) (result CreateInformationProtectionThreatAssessmentRequestResultOperationResponse, err error) {
