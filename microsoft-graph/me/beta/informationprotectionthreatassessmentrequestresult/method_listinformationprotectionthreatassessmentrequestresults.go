...
// ListInformationProtectionThreatAssessmentRequestResults - Get results from me. A collection of threat assessment
// results. Read-only. By default, a GET /threatAssessmentRequests/{id} does not return this property unless you apply
// $expand on it.
func (c InformationProtectionThreatAssessmentRequestResultClient) ListInformationProtectionThreatAssessmentRequestResults(ctx context.Context, id beta.MeInformationProtectionThreatAssessmentRequestId, options ListInformationProtectionThreatAssessmentRequestResultsOperationOptions) (result ListInformationProtectionThreatAssessmentRequestResultsOperationResponse, err error) {
...
func (c InformationProtectionThreatAssessmentRequestResultClient) ListInformationProtectionThreatAssessmentRequestResultsComplete(ctx context.Context, id beta.MeInformationProtectionThreatAssessmentRequestId, options ListInformationProtectionThreatAssessmentRequestResultsOperationOptions) (ListInformationProtectionThreatAssessmentRequestResultsCompleteResult, error) {
