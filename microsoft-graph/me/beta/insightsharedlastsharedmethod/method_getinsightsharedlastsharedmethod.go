...
// GetInsightSharedLastSharedMethod - Get lastSharedMethod from me
func (c InsightSharedLastSharedMethodClient) GetInsightSharedLastSharedMethod(ctx context.Context, id beta.MeInsightSharedId, options GetInsightSharedLastSharedMethodOperationOptions) (result GetInsightSharedLastSharedMethodOperationResponse, err error) {
