...
// GetInsightSharedResource - Get resource from me. Used for navigating to the item that was shared. For file
// attachments, the type is fileAttachment. For linked attachments, the type is driveItem.
func (c InsightSharedResourceClient) GetInsightSharedResource(ctx context.Context, id beta.MeInsightSharedId, options GetInsightSharedResourceOperationOptions) (result GetInsightSharedResourceOperationResponse, err error) {
