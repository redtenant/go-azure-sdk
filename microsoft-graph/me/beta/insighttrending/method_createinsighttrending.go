...
func (c InsightTrendingClient) CreateInsightTrending(ctx context.Context, input beta.Trending, options CreateInsightTrendingOperationOptions) (result CreateInsightTrendingOperationResponse, err error) {
