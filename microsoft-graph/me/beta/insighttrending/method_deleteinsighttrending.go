...
func (c InsightTrendingClient) DeleteInsightTrending(ctx context.Context, id beta.MeInsightTrendingId, options DeleteInsightTrendingOperationOptions) (result DeleteInsightTrendingOperationResponse, err error) {
