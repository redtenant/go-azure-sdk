...
// GetInsightTrending - Get trending from me. Access this property from the derived type itemInsights.
func (c InsightTrendingClient) GetInsightTrending(ctx context.Context, id beta.MeInsightTrendingId, options GetInsightTrendingOperationOptions) (result GetInsightTrendingOperationResponse, err error) {
