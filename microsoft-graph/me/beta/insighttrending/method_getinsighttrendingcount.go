...
func (c InsightTrendingClient) GetInsightTrendingCount(ctx context.Context, options GetInsightTrendingCountOperationOptions) (result GetInsightTrendingCountOperationResponse, err error) {
