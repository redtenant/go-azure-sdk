...
func (c InsightTrendingClient) UpdateInsightTrending(ctx context.Context, id beta.MeInsightTrendingId, input beta.Trending, options UpdateInsightTrendingOperationOptions) (result UpdateInsightTrendingOperationResponse, err error) {
