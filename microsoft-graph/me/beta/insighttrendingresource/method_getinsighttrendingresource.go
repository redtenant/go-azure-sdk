...
// GetInsightTrendingResource - Get resource from me. Used for navigating to the trending document.
func (c InsightTrendingResourceClient) GetInsightTrendingResource(ctx context.Context, id beta.MeInsightTrendingId, options GetInsightTrendingResourceOperationOptions) (result GetInsightTrendingResourceOperationResponse, err error) {
