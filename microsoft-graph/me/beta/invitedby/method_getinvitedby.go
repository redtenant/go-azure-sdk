...
// GetInvitedBy - Get invitedBy from me. The user or service principal that invited the user.
func (c InvitedByClient) GetInvitedBy(ctx context.Context, options GetInvitedByOperationOptions) (result GetInvitedByOperationResponse, err error) {
