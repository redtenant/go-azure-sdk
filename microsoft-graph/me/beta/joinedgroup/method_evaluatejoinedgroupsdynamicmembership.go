...
func (c JoinedGroupClient) EvaluateJoinedGroupsDynamicMembership(ctx context.Context, input EvaluateJoinedGroupsDynamicMembershipRequest, options EvaluateJoinedGroupsDynamicMembershipOperationOptions) (result EvaluateJoinedGroupsDynamicMembershipOperationResponse, err error) {
