...
func DefaultGetJoinedTeamOperationOptions() GetJoinedTeamOperationOptions {
	return GetJoinedTeamOperationOptions{}
}
...
// GetJoinedTeam - Get joinedTeams from me. The Microsoft Teams teams the user is a member of. Read-only. Nullable.
func (c JoinedTeamClient) GetJoinedTeam(ctx context.Context, id beta.MeJoinedTeamId, options GetJoinedTeamOperationOptions) (result GetJoinedTeamOperationResponse, err error) {
