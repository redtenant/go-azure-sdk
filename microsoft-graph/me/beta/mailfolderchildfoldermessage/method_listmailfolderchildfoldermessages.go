...
func (c MailFolderChildFolderMessageClient) ListMailFolderChildFolderMessages(ctx context.Context, id beta.MeMailFolderIdChildFolderId, options ListMailFolderChildFolderMessagesOperationOptions) (result ListMailFolderChildFolderMessagesOperationResponse, err error) {
...
func (c MailFolderChildFolderMessageClient) ListMailFolderChildFolderMessagesComplete(ctx context.Context, id beta.MeMailFolderIdChildFolderId, options ListMailFolderChildFolderMessagesOperationOptions) (ListMailFolderChildFolderMessagesCompleteResult, error) {
...
func (c MailFolderChildFolderMessageClient) ListMailFolderChildFolderMessagesCompleteMatchingPredicate(ctx context.Context, id beta.MeMailFolderIdChildFolderId, options ListMailFolderChildFolderMessagesOperationOptions, predicate MessageOperationPredicate) (result ListMailFolderChildFolderMessagesCompleteResult, err error) {
