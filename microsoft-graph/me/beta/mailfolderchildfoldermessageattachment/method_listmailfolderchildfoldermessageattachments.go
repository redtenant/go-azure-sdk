...
// ListMailFolderChildFolderMessageAttachments - Get attachments from me. The fileAttachment and itemAttachment
// attachments for the message.
func (c MailFolderChildFolderMessageAttachmentClient) ListMailFolderChildFolderMessageAttachments(ctx context.Context, id beta.MeMailFolderIdChildFolderIdMessageId, options ListMailFolderChildFolderMessageAttachmentsOperationOptions) (result ListMailFolderChildFolderMessageAttachmentsOperationResponse, err error) {
...
func (c MailFolderChildFolderMessageAttachmentClient) ListMailFolderChildFolderMessageAttachmentsComplete(ctx context.Context, id beta.MeMailFolderIdChildFolderIdMessageId, options ListMailFolderChildFolderMessageAttachmentsOperationOptions) (ListMailFolderChildFolderMessageAttachmentsCompleteResult, error) {
