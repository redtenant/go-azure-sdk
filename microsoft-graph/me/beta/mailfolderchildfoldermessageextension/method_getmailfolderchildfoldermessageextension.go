...
// message. Nullable.
func (c MailFolderChildFolderMessageExtensionClient) GetMailFolderChildFolderMessageExtension(ctx context.Context, id beta.MeMailFolderIdChildFolderIdMessageIdExtensionId, options GetMailFolderChildFolderMessageExtensionOperationOptions) (result GetMailFolderChildFolderMessageExtensionOperationResponse, err error) {
