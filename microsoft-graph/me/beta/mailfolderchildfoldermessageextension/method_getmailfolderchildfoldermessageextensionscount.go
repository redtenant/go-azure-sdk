...
func (c MailFolderChildFolderMessageExtensionClient) GetMailFolderChildFolderMessageExtensionsCount(ctx context.Context, id beta.MeMailFolderIdChildFolderIdMessageId, options GetMailFolderChildFolderMessageExtensionsCountOperationOptions) (result GetMailFolderChildFolderMessageExtensionsCountOperationResponse, err error) {
