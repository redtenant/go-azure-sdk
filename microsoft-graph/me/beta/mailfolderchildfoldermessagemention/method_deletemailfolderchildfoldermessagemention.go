...
// DeleteMailFolderChildFolderMessageMention - Delete navigation property mentions for me
func (c MailFolderChildFolderMessageMentionClient) DeleteMailFolderChildFolderMessageMention(ctx context.Context, id beta.MeMailFolderIdChildFolderIdMessageIdMentionId, options DeleteMailFolderChildFolderMessageMentionOperationOptions) (result DeleteMailFolderChildFolderMessageMentionOperationResponse, err error) {
