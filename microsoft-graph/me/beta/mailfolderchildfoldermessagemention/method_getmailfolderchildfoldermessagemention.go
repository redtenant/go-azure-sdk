...
// GetMailFolderChildFolderMessageMention - Get mentions from me. A collection of mentions in the message, ordered by
...
func (c MailFolderChildFolderMessageMentionClient) GetMailFolderChildFolderMessageMention(ctx context.Context, id beta.MeMailFolderIdChildFolderIdMessageIdMentionId, options GetMailFolderChildFolderMessageMentionOperationOptions) (result GetMailFolderChildFolderMessageMentionOperationResponse, err error) {
