...
func (c MailFolderChildFolderMessageMentionClient) GetMailFolderChildFolderMessageMentionsCount(ctx context.Context, id beta.MeMailFolderIdChildFolderIdMessageId, options GetMailFolderChildFolderMessageMentionsCountOperationOptions) (result GetMailFolderChildFolderMessageMentionsCountOperationResponse, err error) {
