...
// CreateMailFolderChildFolderMessageRule - Create new navigation property to messageRules for me
func (c MailFolderChildFolderMessageRuleClient) CreateMailFolderChildFolderMessageRule(ctx context.Context, id beta.MeMailFolderIdChildFolderId, input beta.MessageRule, options CreateMailFolderChildFolderMessageRuleOperationOptions) (result CreateMailFolderChildFolderMessageRuleOperationResponse, err error) {
