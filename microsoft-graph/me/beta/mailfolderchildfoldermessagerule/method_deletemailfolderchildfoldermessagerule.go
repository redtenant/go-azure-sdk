...
func (c MailFolderChildFolderMessageRuleClient) DeleteMailFolderChildFolderMessageRule(ctx context.Context, id beta.MeMailFolderIdChildFolderIdMessageRuleId, options DeleteMailFolderChildFolderMessageRuleOperationOptions) (result DeleteMailFolderChildFolderMessageRuleOperationResponse, err error) {
