...
// Inbox folder.
func (c MailFolderChildFolderMessageRuleClient) GetMailFolderChildFolderMessageRule(ctx context.Context, id beta.MeMailFolderIdChildFolderIdMessageRuleId, options GetMailFolderChildFolderMessageRuleOperationOptions) (result GetMailFolderChildFolderMessageRuleOperationResponse, err error) {
