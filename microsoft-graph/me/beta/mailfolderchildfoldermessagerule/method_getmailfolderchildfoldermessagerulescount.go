...
func (c MailFolderChildFolderMessageRuleClient) GetMailFolderChildFolderMessageRulesCount(ctx context.Context, id beta.MeMailFolderIdChildFolderId, options GetMailFolderChildFolderMessageRulesCountOperationOptions) (result GetMailFolderChildFolderMessageRulesCountOperationResponse, err error) {
