...
// Inbox folder.
func (c MailFolderChildFolderMessageRuleClient) ListMailFolderChildFolderMessageRules(ctx context.Context, id beta.MeMailFolderIdChildFolderId, options ListMailFolderChildFolderMessageRulesOperationOptions) (result ListMailFolderChildFolderMessageRulesOperationResponse, err error) {
...
func (c MailFolderChildFolderMessageRuleClient) ListMailFolderChildFolderMessageRulesComplete(ctx context.Context, id beta.MeMailFolderIdChildFolderId, options ListMailFolderChildFolderMessageRulesOperationOptions) (ListMailFolderChildFolderMessageRulesCompleteResult, error) {
