...
type UpdateMailFolderChildFolderMessageRuleOperationResponse struct {
...
// UpdateMailFolderChildFolderMessageRule - Update the navigation property messageRules in me
func (c MailFolderChildFolderMessageRuleClient) UpdateMailFolderChildFolderMessageRule(ctx context.Context, id beta.MeMailFolderIdChildFolderIdMessageRuleId, input beta.MessageRule, options UpdateMailFolderChildFolderMessageRuleOperationOptions) (result UpdateMailFolderChildFolderMessageRuleOperationResponse, err error) {
