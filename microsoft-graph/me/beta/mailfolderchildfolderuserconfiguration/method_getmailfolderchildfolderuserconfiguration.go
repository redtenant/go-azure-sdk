...
// GetMailFolderChildFolderUserConfiguration - Get userConfigurations from me
func (c MailFolderChildFolderUserConfigurationClient) GetMailFolderChildFolderUserConfiguration(ctx context.Context, id beta.MeMailFolderIdChildFolderIdUserConfigurationId, options GetMailFolderChildFolderUserConfigurationOperationOptions) (result GetMailFolderChildFolderUserConfigurationOperationResponse, err error) {
