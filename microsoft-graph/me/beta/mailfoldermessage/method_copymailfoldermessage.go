...
func (c MailFolderMessageClient) CopyMailFolderMessage(ctx context.Context, id beta.MeMailFolderIdMessageId, input CopyMailFolderMessageRequest, options CopyMailFolderMessageOperationOptions) (result CopyMailFolderMessageOperationResponse, err error) {
