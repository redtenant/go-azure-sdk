...
func (c MailFolderMessageClient) CreateMailFolderMessageReplyAll(ctx context.Context, id beta.MeMailFolderIdMessageId, input CreateMailFolderMessageReplyAllRequest, options CreateMailFolderMessageReplyAllOperationOptions) (result CreateMailFolderMessageReplyAllOperationResponse, err error) {
