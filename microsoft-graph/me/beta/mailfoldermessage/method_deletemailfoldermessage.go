...
func (c MailFolderMessageClient) DeleteMailFolderMessage(ctx context.Context, id beta.MeMailFolderIdMessageId, options DeleteMailFolderMessageOperationOptions) (result DeleteMailFolderMessageOperationResponse, err error) {
