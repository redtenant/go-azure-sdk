...
func (c MailFolderMessageClient) ForwardMailFolderMessage(ctx context.Context, id beta.MeMailFolderIdMessageId, input ForwardMailFolderMessageRequest, options ForwardMailFolderMessageOperationOptions) (result ForwardMailFolderMessageOperationResponse, err error) {
