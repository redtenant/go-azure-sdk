...
func (c MailFolderMessageClient) GetMailFolderMessage(ctx context.Context, id beta.MeMailFolderIdMessageId, options GetMailFolderMessageOperationOptions) (result GetMailFolderMessageOperationResponse, err error) {
