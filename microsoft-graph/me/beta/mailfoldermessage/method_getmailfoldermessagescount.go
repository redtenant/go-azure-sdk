...
func (c MailFolderMessageClient) GetMailFolderMessagesCount(ctx context.Context, id beta.MeMailFolderId, options GetMailFolderMessagesCountOperationOptions) (result GetMailFolderMessagesCountOperationResponse, err error) {
