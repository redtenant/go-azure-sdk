...
// saves the message in the Sent Items folder. Alternatively, create a draft to reply to a message, and send it later.
func (c MailFolderMessageClient) ReplyMailFolderMessage(ctx context.Context, id beta.MeMailFolderIdMessageId, input ReplyMailFolderMessageRequest, options ReplyMailFolderMessageOperationOptions) (result ReplyMailFolderMessageOperationResponse, err error) {
