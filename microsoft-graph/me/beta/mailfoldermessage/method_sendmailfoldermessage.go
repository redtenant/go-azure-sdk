...
func (c MailFolderMessageClient) SendMailFolderMessage(ctx context.Context, id beta.MeMailFolderIdMessageId, options SendMailFolderMessageOperationOptions) (result SendMailFolderMessageOperationResponse, err error) {
