...
func (c MailFolderMessageClient) UpdateMailFolderMessage(ctx context.Context, id beta.MeMailFolderIdMessageId, input beta.Message, options UpdateMailFolderMessageOperationOptions) (result UpdateMailFolderMessageOperationResponse, err error) {
