...
func (c MailFolderMessageAttachmentClient) CreateMailFolderMessageAttachment(ctx context.Context, id beta.MeMailFolderIdMessageId, input beta.Attachment, options CreateMailFolderMessageAttachmentOperationOptions) (result CreateMailFolderMessageAttachmentOperationResponse, err error) {
