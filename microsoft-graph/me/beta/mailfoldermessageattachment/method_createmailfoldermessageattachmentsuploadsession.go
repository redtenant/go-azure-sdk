...
func (c MailFolderMessageAttachmentClient) CreateMailFolderMessageAttachmentsUploadSession(ctx context.Context, id beta.MeMailFolderIdMessageId, input CreateMailFolderMessageAttachmentsUploadSessionRequest, options CreateMailFolderMessageAttachmentsUploadSessionOperationOptions) (result CreateMailFolderMessageAttachmentsUploadSessionOperationResponse, err error) {
