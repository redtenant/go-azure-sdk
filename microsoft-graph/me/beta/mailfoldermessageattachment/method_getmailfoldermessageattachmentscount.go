...
func (c MailFolderMessageAttachmentClient) GetMailFolderMessageAttachmentsCount(ctx context.Context, id beta.MeMailFolderIdMessageId, options GetMailFolderMessageAttachmentsCountOperationOptions) (result GetMailFolderMessageAttachmentsCountOperationResponse, err error) {
