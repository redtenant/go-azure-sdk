...
func (c MailFolderMessageExtensionClient) CreateMailFolderMessageExtension(ctx context.Context, id beta.MeMailFolderIdMessageId, input beta.Extension, options CreateMailFolderMessageExtensionOperationOptions) (result CreateMailFolderMessageExtensionOperationResponse, err error) {
