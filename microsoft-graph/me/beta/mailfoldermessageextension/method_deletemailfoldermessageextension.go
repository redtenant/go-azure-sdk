...
func (c MailFolderMessageExtensionClient) DeleteMailFolderMessageExtension(ctx context.Context, id beta.MeMailFolderIdMessageIdExtensionId, options DeleteMailFolderMessageExtensionOperationOptions) (result DeleteMailFolderMessageExtensionOperationResponse, err error) {
