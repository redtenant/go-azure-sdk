...
func (c MailFolderMessageExtensionClient) GetMailFolderMessageExtensionsCount(ctx context.Context, id beta.MeMailFolderIdMessageId, options GetMailFolderMessageExtensionsCountOperationOptions) (result GetMailFolderMessageExtensionsCountOperationResponse, err error) {
