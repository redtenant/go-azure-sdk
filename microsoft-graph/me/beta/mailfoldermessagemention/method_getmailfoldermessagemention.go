...
// GetMailFolderMessageMention - Get mentions from me. A collection of mentions in the message, ordered by the
...
func (c MailFolderMessageMentionClient) GetMailFolderMessageMention(ctx context.Context, id beta.MeMailFolderIdMessageIdMentionId, options GetMailFolderMessageMentionOperationOptions) (result GetMailFolderMessageMentionOperationResponse, err error) {
