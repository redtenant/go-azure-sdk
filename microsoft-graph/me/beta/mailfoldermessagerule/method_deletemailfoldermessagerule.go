...
// DeleteMailFolderMessageRule - Delete navigation property messageRules for me
func (c MailFolderMessageRuleClient) DeleteMailFolderMessageRule(ctx context.Context, id beta.MeMailFolderIdMessageRuleId, options DeleteMailFolderMessageRuleOperationOptions) (result DeleteMailFolderMessageRuleOperationResponse, err error) {
