...
func (c MailFolderMessageRuleClient) GetMailFolderMessageRulesCount(ctx context.Context, id beta.MeMailFolderId, options GetMailFolderMessageRulesCountOperationOptions) (result GetMailFolderMessageRulesCountOperationResponse, err error) {
