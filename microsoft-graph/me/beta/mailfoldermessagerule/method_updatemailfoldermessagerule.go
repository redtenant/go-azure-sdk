...
// UpdateMailFolderMessageRule - Update the navigation property messageRules in me
func (c MailFolderMessageRuleClient) UpdateMailFolderMessageRule(ctx context.Context, id beta.MeMailFolderIdMessageRuleId, input beta.MessageRule, options UpdateMailFolderMessageRuleOperationOptions) (result UpdateMailFolderMessageRuleOperationResponse, err error) {
