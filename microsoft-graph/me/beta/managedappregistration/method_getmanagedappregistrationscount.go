...
func (c ManagedAppRegistrationClient) GetManagedAppRegistrationsCount(ctx context.Context, options GetManagedAppRegistrationsCountOperationOptions) (result GetManagedAppRegistrationsCountOperationResponse, err error) {
