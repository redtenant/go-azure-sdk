...
func (c ManagedDeviceClient) ChangeManagedDeviceAssignments(ctx context.Context, id beta.MeManagedDeviceId, input ChangeManagedDeviceAssignmentsRequest, options ChangeManagedDeviceAssignmentsOperationOptions) (result ChangeManagedDeviceAssignmentsOperationResponse, err error) {
