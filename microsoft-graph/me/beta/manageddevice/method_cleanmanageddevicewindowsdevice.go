...
func (c ManagedDeviceClient) CleanManagedDeviceWindowsDevice(ctx context.Context, id beta.MeManagedDeviceId, input CleanManagedDeviceWindowsDeviceRequest, options CleanManagedDeviceWindowsDeviceOperationOptions) (result CleanManagedDeviceWindowsDeviceOperationResponse, err error) {
