...
func (c ManagedDeviceClient) CreateManagedDeviceActivateDeviceEsim(ctx context.Context, id beta.MeManagedDeviceId, input CreateManagedDeviceActivateDeviceEsimRequest, options CreateManagedDeviceActivateDeviceEsimOperationOptions) (result CreateManagedDeviceActivateDeviceEsimOperationResponse, err error) {
