...
func (c ManagedDeviceClient) CreateManagedDeviceDeprovision(ctx context.Context, id beta.MeManagedDeviceId, input CreateManagedDeviceDeprovisionRequest, options CreateManagedDeviceDeprovisionOperationOptions) (result CreateManagedDeviceDeprovisionOperationResponse, err error) {
