...
func (c ManagedDeviceClient) CreateManagedDeviceInitiateDeviceAttestation(ctx context.Context, id beta.MeManagedDeviceId, options CreateManagedDeviceInitiateDeviceAttestationOperationOptions) (result CreateManagedDeviceInitiateDeviceAttestationOperationResponse, err error) {
