...
func (c ManagedDeviceClient) CreateManagedDeviceInitiateMobileDeviceManagementKeyRecovery(ctx context.Context, id beta.MeManagedDeviceId, options CreateManagedDeviceInitiateMobileDeviceManagementKeyRecoveryOperationOptions) (result CreateManagedDeviceInitiateMobileDeviceManagementKeyRecoveryOperationResponse, err error) {
