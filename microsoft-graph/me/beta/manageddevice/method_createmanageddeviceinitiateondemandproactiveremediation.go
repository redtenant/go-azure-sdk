...
func (c ManagedDeviceClient) CreateManagedDeviceInitiateOnDemandProactiveRemediation(ctx context.Context, id beta.MeManagedDeviceId, input CreateManagedDeviceInitiateOnDemandProactiveRemediationRequest, options CreateManagedDeviceInitiateOnDemandProactiveRemediationOperationOptions) (result CreateManagedDeviceInitiateOnDemandProactiveRemediationOperationResponse, err error) {
