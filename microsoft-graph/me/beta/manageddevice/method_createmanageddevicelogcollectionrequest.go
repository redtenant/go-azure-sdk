...
func (c ManagedDeviceClient) CreateManagedDeviceLogCollectionRequest(ctx context.Context, id beta.MeManagedDeviceId, input CreateManagedDeviceLogCollectionRequestRequest, options CreateManagedDeviceLogCollectionRequestOperationOptions) (result CreateManagedDeviceLogCollectionRequestOperationResponse, err error) {
