...
func (c ManagedDeviceClient) CreateManagedDeviceReenable(ctx context.Context, id beta.MeManagedDeviceId, options CreateManagedDeviceReenableOperationOptions) (result CreateManagedDeviceReenableOperationResponse, err error) {
