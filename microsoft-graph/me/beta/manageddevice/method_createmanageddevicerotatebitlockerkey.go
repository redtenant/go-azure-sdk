...
func (c ManagedDeviceClient) CreateManagedDeviceRotateBitLockerKey(ctx context.Context, id beta.MeManagedDeviceId, options CreateManagedDeviceRotateBitLockerKeyOperationOptions) (result CreateManagedDeviceRotateBitLockerKeyOperationResponse, err error) {
