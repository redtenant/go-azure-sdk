...
func (c ManagedDeviceClient) CreateManagedDeviceWindowsDefenderScan(ctx context.Context, id beta.MeManagedDeviceId, input CreateManagedDeviceWindowsDefenderScanRequest, options CreateManagedDeviceWindowsDefenderScanOperationOptions) (result CreateManagedDeviceWindowsDefenderScanOperationResponse, err error) {
