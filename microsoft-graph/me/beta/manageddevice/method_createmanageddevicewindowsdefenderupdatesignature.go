...
func (c ManagedDeviceClient) CreateManagedDeviceWindowsDefenderUpdateSignature(ctx context.Context, id beta.MeManagedDeviceId, options CreateManagedDeviceWindowsDefenderUpdateSignatureOperationOptions) (result CreateManagedDeviceWindowsDefenderUpdateSignatureOperationResponse, err error) {
