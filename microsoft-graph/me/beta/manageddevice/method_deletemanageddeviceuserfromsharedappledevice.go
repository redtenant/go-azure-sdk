...
// Apple device
func (c ManagedDeviceClient) DeleteManagedDeviceUserFromSharedAppleDevice(ctx context.Context, id beta.MeManagedDeviceId, input DeleteManagedDeviceUserFromSharedAppleDeviceRequest, options DeleteManagedDeviceUserFromSharedAppleDeviceOperationOptions) (result DeleteManagedDeviceUserFromSharedAppleDeviceOperationResponse, err error) {
