...
func (c ManagedDeviceClient) DisableManagedDevice(ctx context.Context, id beta.MeManagedDeviceId, options DisableManagedDeviceOperationOptions) (result DisableManagedDeviceOperationResponse, err error) {
