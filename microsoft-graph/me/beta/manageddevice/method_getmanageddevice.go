...
func (c ManagedDeviceClient) GetManagedDevice(ctx context.Context, id beta.MeManagedDeviceId, options GetManagedDeviceOperationOptions) (result GetManagedDeviceOperationResponse, err error) {
