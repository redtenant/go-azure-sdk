...
func (c ManagedDeviceClient) LocateManagedDeviceDevice(ctx context.Context, id beta.MeManagedDeviceId, options LocateManagedDeviceDeviceOperationOptions) (result LocateManagedDeviceDeviceOperationResponse, err error) {
