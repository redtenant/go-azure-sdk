...
// device active user
func (c ManagedDeviceClient) LogoutManagedDeviceSharedAppleDeviceActiveUser(ctx context.Context, id beta.MeManagedDeviceId, options LogoutManagedDeviceSharedAppleDeviceActiveUserOperationOptions) (result LogoutManagedDeviceSharedAppleDeviceActiveUserOperationResponse, err error) {
