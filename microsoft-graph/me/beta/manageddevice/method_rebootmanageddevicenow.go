...
func (c ManagedDeviceClient) RebootManagedDeviceNow(ctx context.Context, id beta.MeManagedDeviceId, options RebootManagedDeviceNowOperationOptions) (result RebootManagedDeviceNowOperationResponse, err error) {
