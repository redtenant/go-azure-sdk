...
// device ID.
func (c ManagedDeviceClient) ReprovisionManagedDeviceCloudPC(ctx context.Context, id beta.MeManagedDeviceId, options ReprovisionManagedDeviceCloudPCOperationOptions) (result ReprovisionManagedDeviceCloudPCOperationResponse, err error) {
