...
func (c ManagedDeviceClient) RequestManagedDeviceRemoteAssistance(ctx context.Context, id beta.MeManagedDeviceId, options RequestManagedDeviceRemoteAssistanceOperationOptions) (result RequestManagedDeviceRemoteAssistanceOperationResponse, err error) {
