...
func (c ManagedDeviceClient) ResizeManagedDeviceCloudPC(ctx context.Context, id beta.MeManagedDeviceId, input ResizeManagedDeviceCloudPCRequest, options ResizeManagedDeviceCloudPCOperationOptions) (result ResizeManagedDeviceCloudPCOperationResponse, err error) {
