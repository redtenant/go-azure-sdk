...
func (c ManagedDeviceClient) RetireManagedDevice(ctx context.Context, id beta.MeManagedDeviceId, options RetireManagedDeviceOperationOptions) (result RetireManagedDeviceOperationResponse, err error) {
