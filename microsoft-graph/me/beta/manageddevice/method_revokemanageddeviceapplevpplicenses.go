...
// device
func (c ManagedDeviceClient) RevokeManagedDeviceAppleVppLicenses(ctx context.Context, id beta.MeManagedDeviceId, options RevokeManagedDeviceAppleVppLicensesOperationOptions) (result RevokeManagedDeviceAppleVppLicensesOperationResponse, err error) {
