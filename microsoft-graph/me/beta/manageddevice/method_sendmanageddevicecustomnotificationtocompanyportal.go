...
func (c ManagedDeviceClient) SendManagedDeviceCustomNotificationToCompanyPortal(ctx context.Context, id beta.MeManagedDeviceId, input SendManagedDeviceCustomNotificationToCompanyPortalRequest, options SendManagedDeviceCustomNotificationToCompanyPortalOperationOptions) (result SendManagedDeviceCustomNotificationToCompanyPortalOperationResponse, err error) {
