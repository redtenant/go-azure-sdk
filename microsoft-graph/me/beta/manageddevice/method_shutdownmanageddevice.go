...
func (c ManagedDeviceClient) ShutDownManagedDevice(ctx context.Context, id beta.MeManagedDeviceId, options ShutDownManagedDeviceOperationOptions) (result ShutDownManagedDeviceOperationResponse, err error) {
