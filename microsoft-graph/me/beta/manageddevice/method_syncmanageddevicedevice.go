...
func (c ManagedDeviceClient) SyncManagedDeviceDevice(ctx context.Context, id beta.MeManagedDeviceId, options SyncManagedDeviceDeviceOperationOptions) (result SyncManagedDeviceDeviceOperationResponse, err error) {
