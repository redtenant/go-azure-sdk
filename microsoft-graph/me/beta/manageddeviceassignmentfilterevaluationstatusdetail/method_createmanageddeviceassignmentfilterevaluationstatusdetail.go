...
// assignmentFilterEvaluationStatusDetails for me
func (c ManagedDeviceAssignmentFilterEvaluationStatusDetailClient) CreateManagedDeviceAssignmentFilterEvaluationStatusDetail(ctx context.Context, id beta.MeManagedDeviceId, input beta.AssignmentFilterEvaluationStatusDetails, options CreateManagedDeviceAssignmentFilterEvaluationStatusDetailOperationOptions) (result CreateManagedDeviceAssignmentFilterEvaluationStatusDetailOperationResponse, err error) {
