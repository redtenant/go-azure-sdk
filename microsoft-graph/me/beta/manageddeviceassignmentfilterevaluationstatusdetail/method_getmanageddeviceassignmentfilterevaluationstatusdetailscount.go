...
func (c ManagedDeviceAssignmentFilterEvaluationStatusDetailClient) GetManagedDeviceAssignmentFilterEvaluationStatusDetailsCount(ctx context.Context, id beta.MeManagedDeviceId, options GetManagedDeviceAssignmentFilterEvaluationStatusDetailsCountOperationOptions) (result GetManagedDeviceAssignmentFilterEvaluationStatusDetailsCountOperationResponse, err error) {
