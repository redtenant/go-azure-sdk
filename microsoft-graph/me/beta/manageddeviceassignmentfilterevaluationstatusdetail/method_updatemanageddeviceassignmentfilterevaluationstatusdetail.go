...
// assignmentFilterEvaluationStatusDetails in me
func (c ManagedDeviceAssignmentFilterEvaluationStatusDetailClient) UpdateManagedDeviceAssignmentFilterEvaluationStatusDetail(ctx context.Context, id beta.MeManagedDeviceIdAssignmentFilterEvaluationStatusDetailId, input beta.AssignmentFilterEvaluationStatusDetails, options UpdateManagedDeviceAssignmentFilterEvaluationStatusDetailOperationOptions) (result UpdateManagedDeviceAssignmentFilterEvaluationStatusDetailOperationResponse, err error) {
