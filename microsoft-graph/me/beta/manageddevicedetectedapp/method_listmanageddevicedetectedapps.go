...
func (c ManagedDeviceDetectedAppClient) ListManagedDeviceDetectedApps(ctx context.Context, id beta.MeManagedDeviceId, options ListManagedDeviceDetectedAppsOperationOptions) (result ListManagedDeviceDetectedAppsOperationResponse, err error) {
...
func (c ManagedDeviceDetectedAppClient) ListManagedDeviceDetectedAppsComplete(ctx context.Context, id beta.MeManagedDeviceId, options ListManagedDeviceDetectedAppsOperationOptions) (ListManagedDeviceDetectedAppsCompleteResult, error) {
...
func (c ManagedDeviceDetectedAppClient) ListManagedDeviceDetectedAppsCompleteMatchingPredicate(ctx context.Context, id beta.MeManagedDeviceId, options ListManagedDeviceDetectedAppsOperationOptions, predicate DetectedAppOperationPredicate) (result ListManagedDeviceDetectedAppsCompleteResult, err error) {
