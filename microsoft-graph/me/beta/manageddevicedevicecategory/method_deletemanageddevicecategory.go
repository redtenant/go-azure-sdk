...
func (c ManagedDeviceDeviceCategoryClient) DeleteManagedDeviceCategory(ctx context.Context, id beta.MeManagedDeviceId, options DeleteManagedDeviceCategoryOperationOptions) (result DeleteManagedDeviceCategoryOperationResponse, err error) {
