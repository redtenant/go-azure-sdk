...
// CreateManagedDeviceConfigurationState - Create new navigation property to deviceConfigurationStates for me
func (c ManagedDeviceDeviceConfigurationStateClient) CreateManagedDeviceConfigurationState(ctx context.Context, id beta.MeManagedDeviceId, input beta.DeviceConfigurationState, options CreateManagedDeviceConfigurationStateOperationOptions) (result CreateManagedDeviceConfigurationStateOperationResponse, err error) {
