...
// device.
func (c ManagedDeviceDeviceConfigurationStateClient) ListManagedDeviceConfigurationStates(ctx context.Context, id beta.MeManagedDeviceId, options ListManagedDeviceConfigurationStatesOperationOptions) (result ListManagedDeviceConfigurationStatesOperationResponse, err error) {
...
func (c ManagedDeviceDeviceConfigurationStateClient) ListManagedDeviceConfigurationStatesComplete(ctx context.Context, id beta.MeManagedDeviceId, options ListManagedDeviceConfigurationStatesOperationOptions) (ListManagedDeviceConfigurationStatesCompleteResult, error) {
