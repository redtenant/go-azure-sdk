...
type CreateManagedDeviceHealthScriptStateOperationResponse struct {
...
// CreateManagedDeviceHealthScriptState - Create new navigation property to deviceHealthScriptStates for me
func (c ManagedDeviceDeviceHealthScriptStateClient) CreateManagedDeviceHealthScriptState(ctx context.Context, id beta.MeManagedDeviceId, input beta.DeviceHealthScriptPolicyState, options CreateManagedDeviceHealthScriptStateOperationOptions) (result CreateManagedDeviceHealthScriptStateOperationResponse, err error) {
