...
func (c ManagedDeviceDeviceHealthScriptStateClient) GetManagedDeviceHealthScriptStatesCount(ctx context.Context, id beta.MeManagedDeviceId, options GetManagedDeviceHealthScriptStatesCountOperationOptions) (result GetManagedDeviceHealthScriptStatesCountOperationResponse, err error) {
