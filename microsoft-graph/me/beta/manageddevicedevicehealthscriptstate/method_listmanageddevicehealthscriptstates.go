...
// ListManagedDeviceHealthScriptStates - Get deviceHealthScriptStates from me. Results of device health scripts that ran
// for this device. Default is empty list. This property is read-only.
func (c ManagedDeviceDeviceHealthScriptStateClient) ListManagedDeviceHealthScriptStates(ctx context.Context, id beta.MeManagedDeviceId, options ListManagedDeviceHealthScriptStatesOperationOptions) (result ListManagedDeviceHealthScriptStatesOperationResponse, err error) {
...
func (c ManagedDeviceDeviceHealthScriptStateClient) ListManagedDeviceHealthScriptStatesComplete(ctx context.Context, id beta.MeManagedDeviceId, options ListManagedDeviceHealthScriptStatesOperationOptions) (ListManagedDeviceHealthScriptStatesCompleteResult, error) {
...
func (c ManagedDeviceDeviceHealthScriptStateClient) ListManagedDeviceHealthScriptStatesCompleteMatchingPredicate(ctx context.Context, id beta.MeManagedDeviceId, options ListManagedDeviceHealthScriptStatesOperationOptions, predicate DeviceHealthScriptPolicyStateOperationPredicate) (result ListManagedDeviceHealthScriptStatesCompleteResult, err error) {
