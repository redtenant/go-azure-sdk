...
func (c ManagedDeviceLogCollectionRequestClient) DeleteManagedDeviceLogCollectionRequest(ctx context.Context, id beta.MeManagedDeviceIdLogCollectionRequestId, options DeleteManagedDeviceLogCollectionRequestOperationOptions) (result DeleteManagedDeviceLogCollectionRequestOperationResponse, err error) {
