...
func (c ManagedDeviceLogCollectionRequestClient) GetManagedDeviceLogCollectionRequest(ctx context.Context, id beta.MeManagedDeviceIdLogCollectionRequestId, options GetManagedDeviceLogCollectionRequestOperationOptions) (result GetManagedDeviceLogCollectionRequestOperationResponse, err error) {
