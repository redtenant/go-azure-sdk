...
func (c ManagedDeviceLogCollectionRequestClient) GetManagedDeviceLogCollectionRequestsCount(ctx context.Context, id beta.MeManagedDeviceId, options GetManagedDeviceLogCollectionRequestsCountOperationOptions) (result GetManagedDeviceLogCollectionRequestsCountOperationResponse, err error) {
