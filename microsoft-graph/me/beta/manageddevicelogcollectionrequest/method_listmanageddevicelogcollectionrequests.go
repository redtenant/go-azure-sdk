...
func (c ManagedDeviceLogCollectionRequestClient) ListManagedDeviceLogCollectionRequests(ctx context.Context, id beta.MeManagedDeviceId, options ListManagedDeviceLogCollectionRequestsOperationOptions) (result ListManagedDeviceLogCollectionRequestsOperationResponse, err error) {
...
func (c ManagedDeviceLogCollectionRequestClient) ListManagedDeviceLogCollectionRequestsComplete(ctx context.Context, id beta.MeManagedDeviceId, options ListManagedDeviceLogCollectionRequestsOperationOptions) (ListManagedDeviceLogCollectionRequestsCompleteResult, error) {
