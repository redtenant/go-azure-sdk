...
// GetManagedDeviceMobileAppConfigurationState - Get managedDeviceMobileAppConfigurationStates from me. Managed device
// mobile app configuration states for this device.
func (c ManagedDeviceManagedDeviceMobileAppConfigurationStateClient) GetManagedDeviceMobileAppConfigurationState(ctx context.Context, id beta.MeManagedDeviceIdManagedDeviceMobileAppConfigurationStateId, options GetManagedDeviceMobileAppConfigurationStateOperationOptions) (result GetManagedDeviceMobileAppConfigurationStateOperationResponse, err error) {
