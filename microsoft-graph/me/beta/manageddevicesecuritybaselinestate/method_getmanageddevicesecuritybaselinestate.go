...
// GetManagedDeviceSecurityBaselineState - Get securityBaselineStates from me. Security baseline states for this device.
func (c ManagedDeviceSecurityBaselineStateClient) GetManagedDeviceSecurityBaselineState(ctx context.Context, id beta.MeManagedDeviceIdSecurityBaselineStateId, options GetManagedDeviceSecurityBaselineStateOperationOptions) (result GetManagedDeviceSecurityBaselineStateOperationResponse, err error) {
