...
// DeleteManagedDeviceSecurityBaselineStateSettingState - Delete navigation property settingStates for me
func (c ManagedDeviceSecurityBaselineStateSettingStateClient) DeleteManagedDeviceSecurityBaselineStateSettingState(ctx context.Context, id beta.MeManagedDeviceIdSecurityBaselineStateIdSettingStateId, options DeleteManagedDeviceSecurityBaselineStateSettingStateOperationOptions) (result DeleteManagedDeviceSecurityBaselineStateSettingStateOperationResponse, err error) {
