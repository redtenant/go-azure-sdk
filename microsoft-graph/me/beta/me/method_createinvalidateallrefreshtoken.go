...
// the user to sign in.
func (c MeClient) CreateInvalidateAllRefreshToken(ctx context.Context, options CreateInvalidateAllRefreshTokenOperationOptions) (result CreateInvalidateAllRefreshTokenOperationResponse, err error) {
