...
func (c MeClient) WipeAndBlockManagedApps(ctx context.Context, options WipeAndBlockManagedAppsOperationOptions) (result WipeAndBlockManagedAppsOperationResponse, err error) {
