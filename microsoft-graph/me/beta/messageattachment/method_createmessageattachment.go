...
func (c MessageAttachmentClient) CreateMessageAttachment(ctx context.Context, id beta.MeMessageId, input beta.Attachment, options CreateMessageAttachmentOperationOptions) (result CreateMessageAttachmentOperationResponse, err error) {
