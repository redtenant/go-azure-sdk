...
func (c MessageAttachmentClient) CreateMessageAttachmentsUploadSession(ctx context.Context, id beta.MeMessageId, input CreateMessageAttachmentsUploadSessionRequest, options CreateMessageAttachmentsUploadSessionOperationOptions) (result CreateMessageAttachmentsUploadSessionOperationResponse, err error) {
