...
func (c MessageAttachmentClient) DeleteMessageAttachment(ctx context.Context, id beta.MeMessageIdAttachmentId, options DeleteMessageAttachmentOperationOptions) (result DeleteMessageAttachmentOperationResponse, err error) {
