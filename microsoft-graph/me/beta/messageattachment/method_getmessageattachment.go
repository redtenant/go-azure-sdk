...
func (c MessageAttachmentClient) GetMessageAttachment(ctx context.Context, id beta.MeMessageIdAttachmentId, options GetMessageAttachmentOperationOptions) (result GetMessageAttachmentOperationResponse, err error) {
