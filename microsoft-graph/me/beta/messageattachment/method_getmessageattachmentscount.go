...
func (c MessageAttachmentClient) GetMessageAttachmentsCount(ctx context.Context, id beta.MeMessageId, options GetMessageAttachmentsCountOperationOptions) (result GetMessageAttachmentsCountOperationResponse, err error) {
