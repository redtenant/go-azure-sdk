...
func (c MessageAttachmentClient) ListMessageAttachments(ctx context.Context, id beta.MeMessageId, options ListMessageAttachmentsOperationOptions) (result ListMessageAttachmentsOperationResponse, err error) {
...
func (c MessageAttachmentClient) ListMessageAttachmentsComplete(ctx context.Context, id beta.MeMessageId, options ListMessageAttachmentsOperationOptions) (ListMessageAttachmentsCompleteResult, error) {
...
func (c MessageAttachmentClient) ListMessageAttachmentsCompleteMatchingPredicate(ctx context.Context, id beta.MeMessageId, options ListMessageAttachmentsOperationOptions, predicate AttachmentOperationPredicate) (result ListMessageAttachmentsCompleteResult, err error) {
