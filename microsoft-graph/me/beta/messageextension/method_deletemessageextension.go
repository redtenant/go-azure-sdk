...
// DeleteMessageExtension - Delete openTypeExtension. Delete an open extension (openTypeExtension object) from the
// specified instance of a resource. For the list of resources that support open extensions, see the table in the
// Permissions section.
func (c MessageExtensionClient) DeleteMessageExtension(ctx context.Context, id beta.MeMessageIdExtensionId, options DeleteMessageExtensionOperationOptions) (result DeleteMessageExtensionOperationResponse, err error) {
