...
// GetMessageExtension - Get openTypeExtension. Get an open extension (openTypeExtension object) identified by name or
...
func (c MessageExtensionClient) GetMessageExtension(ctx context.Context, id beta.MeMessageIdExtensionId, options GetMessageExtensionOperationOptions) (result GetMessageExtensionOperationResponse, err error) {
