...
func (c MessageExtensionClient) GetMessageExtensionsCount(ctx context.Context, id beta.MeMessageId, options GetMessageExtensionsCountOperationOptions) (result GetMessageExtensionsCountOperationResponse, err error) {
