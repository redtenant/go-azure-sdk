...
// ListMessageExtensions - Get openTypeExtension. Get an open extension (openTypeExtension object) identified by name or
...
func (c MessageExtensionClient) ListMessageExtensions(ctx context.Context, id beta.MeMessageId, options ListMessageExtensionsOperationOptions) (result ListMessageExtensionsOperationResponse, err error) {
...
func (c MessageExtensionClient) ListMessageExtensionsComplete(ctx context.Context, id beta.MeMessageId, options ListMessageExtensionsOperationOptions) (ListMessageExtensionsCompleteResult, error) {
...
func (c MessageExtensionClient) ListMessageExtensionsCompleteMatchingPredicate(ctx context.Context, id beta.MeMessageId, options ListMessageExtensionsOperationOptions, predicate ExtensionOperationPredicate) (result ListMessageExtensionsCompleteResult, err error) {
