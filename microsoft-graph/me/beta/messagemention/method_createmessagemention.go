...
func DefaultCreateMessageMentionOperationOptions() CreateMessageMentionOperationOptions {
	return CreateMessageMentionOperationOptions{}
}
...
// CreateMessageMention - Create new navigation property to mentions for me
func (c MessageMentionClient) CreateMessageMention(ctx context.Context, id beta.MeMessageId, input beta.Mention, options CreateMessageMentionOperationOptions) (result CreateMessageMentionOperationResponse, err error) {
