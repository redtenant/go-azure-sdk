...
// GetMessageMention - Get mentions from me. A collection of mentions in the message, ordered by the createdDateTime
// from the newest to the oldest. By default, a GET /messages does not return this property unless you apply $expand on
// the property.
func (c MessageMentionClient) GetMessageMention(ctx context.Context, id beta.MeMessageIdMentionId, options GetMessageMentionOperationOptions) (result GetMessageMentionOperationResponse, err error) {
