...
func DefaultGetMessageMentionsCountOperationOptions() GetMessageMentionsCountOperationOptions {
	return GetMessageMentionsCountOperationOptions{}
}
...
func (c MessageMentionClient) GetMessageMentionsCount(ctx context.Context, id beta.MeMessageId, options GetMessageMentionsCountOperationOptions) (result GetMessageMentionsCountOperationResponse, err error) {
