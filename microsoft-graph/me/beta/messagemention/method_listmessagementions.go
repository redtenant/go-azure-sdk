...
// ListMessageMentions - Get mentions from me. A collection of mentions in the message, ordered by the createdDateTime
// from the newest to the oldest. By default, a GET /messages does not return this property unless you apply $expand on
// the property.
func (c MessageMentionClient) ListMessageMentions(ctx context.Context, id beta.MeMessageId, options ListMessageMentionsOperationOptions) (result ListMessageMentionsOperationResponse, err error) {
...
func (c MessageMentionClient) ListMessageMentionsComplete(ctx context.Context, id beta.MeMessageId, options ListMessageMentionsOperationOptions) (ListMessageMentionsCompleteResult, error) {
...
func (c MessageMentionClient) ListMessageMentionsCompleteMatchingPredicate(ctx context.Context, id beta.MeMessageId, options ListMessageMentionsOperationOptions, predicate MentionOperationPredicate) (result ListMessageMentionsCompleteResult, err error) {
