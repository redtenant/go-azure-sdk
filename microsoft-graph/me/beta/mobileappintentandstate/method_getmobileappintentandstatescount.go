...
func DefaultGetMobileAppIntentAndStatesCountOperationOptions() GetMobileAppIntentAndStatesCountOperationOptions {
	return GetMobileAppIntentAndStatesCountOperationOptions{}
}
...
func (c MobileAppIntentAndStateClient) GetMobileAppIntentAndStatesCount(ctx context.Context, options GetMobileAppIntentAndStatesCountOperationOptions) (result GetMobileAppIntentAndStatesCountOperationResponse, err error) {
	opts := client.RequestOptions{
		...
		Path:          "/me/mobileAppIntentAndStates/$count",
