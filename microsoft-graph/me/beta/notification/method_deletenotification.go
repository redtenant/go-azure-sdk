...
func DefaultDeleteNotificationOperationOptions() DeleteNotificationOperationOptions {
	return DeleteNotificationOperationOptions{}
}
...
// DeleteNotification - Delete navigation property notifications for me
func (c NotificationClient) DeleteNotification(ctx context.Context, id beta.MeNotificationId, options DeleteNotificationOperationOptions) (result DeleteNotificationOperationResponse, err error) {
