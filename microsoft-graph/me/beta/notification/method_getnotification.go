...
// GetNotification - Get notifications from me
func (c NotificationClient) GetNotification(ctx context.Context, id beta.MeNotificationId, options GetNotificationOperationOptions) (result GetNotificationOperationResponse, err error) {
