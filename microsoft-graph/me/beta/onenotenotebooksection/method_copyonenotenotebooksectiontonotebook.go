...
func (c OnenoteNotebookSectionClient) CopyOnenoteNotebookSectionToNotebook(ctx context.Context, id beta.MeOnenoteNotebookIdSectionId, input CopyOnenoteNotebookSectionToNotebookRequest, options CopyOnenoteNotebookSectionToNotebookOperationOptions) (result CopyOnenoteNotebookSectionToNotebookOperationResponse, err error) {
