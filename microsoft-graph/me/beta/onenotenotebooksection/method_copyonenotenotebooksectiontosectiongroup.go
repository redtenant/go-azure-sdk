...
func (c OnenoteNotebookSectionClient) CopyOnenoteNotebookSectionToSectionGroup(ctx context.Context, id beta.MeOnenoteNotebookIdSectionId, input CopyOnenoteNotebookSectionToSectionGroupRequest, options CopyOnenoteNotebookSectionToSectionGroupOperationOptions) (result CopyOnenoteNotebookSectionToSectionGroupOperationResponse, err error) {
