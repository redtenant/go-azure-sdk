...
func (c OnenoteNotebookSectionClient) CreateOnenoteNotebookSection(ctx context.Context, id beta.MeOnenoteNotebookId, input beta.OnenoteSection, options CreateOnenoteNotebookSectionOperationOptions) (result CreateOnenoteNotebookSectionOperationResponse, err error) {
