...
func (c OnenoteNotebookSectionClient) DeleteOnenoteNotebookSection(ctx context.Context, id beta.MeOnenoteNotebookIdSectionId, options DeleteOnenoteNotebookSectionOperationOptions) (result DeleteOnenoteNotebookSectionOperationResponse, err error) {
