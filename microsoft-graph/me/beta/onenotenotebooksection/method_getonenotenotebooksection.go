...
func (c OnenoteNotebookSectionClient) GetOnenoteNotebookSection(ctx context.Context, id beta.MeOnenoteNotebookIdSectionId, options GetOnenoteNotebookSectionOperationOptions) (result GetOnenoteNotebookSectionOperationResponse, err error) {
