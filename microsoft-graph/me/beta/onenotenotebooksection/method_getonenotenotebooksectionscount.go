...
func (c OnenoteNotebookSectionClient) GetOnenoteNotebookSectionsCount(ctx context.Context, id beta.MeOnenoteNotebookId, options GetOnenoteNotebookSectionsCountOperationOptions) (result GetOnenoteNotebookSectionsCountOperationResponse, err error) {
