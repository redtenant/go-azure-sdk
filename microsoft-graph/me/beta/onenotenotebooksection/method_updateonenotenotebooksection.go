...
func (c OnenoteNotebookSectionClient) UpdateOnenoteNotebookSection(ctx context.Context, id beta.MeOnenoteNotebookIdSectionId, input beta.OnenoteSection, options UpdateOnenoteNotebookSectionOperationOptions) (result UpdateOnenoteNotebookSectionOperationResponse, err error) {
