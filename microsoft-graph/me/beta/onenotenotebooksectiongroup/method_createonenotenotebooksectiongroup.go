...
func (c OnenoteNotebookSectionGroupClient) CreateOnenoteNotebookSectionGroup(ctx context.Context, id beta.MeOnenoteNotebookId, input beta.SectionGroup, options CreateOnenoteNotebookSectionGroupOperationOptions) (result CreateOnenoteNotebookSectionGroupOperationResponse, err error) {
