...
func (c OnenoteNotebookSectionGroupClient) DeleteOnenoteNotebookSectionGroup(ctx context.Context, id beta.MeOnenoteNotebookIdSectionGroupId, options DeleteOnenoteNotebookSectionGroupOperationOptions) (result DeleteOnenoteNotebookSectionGroupOperationResponse, err error) {
