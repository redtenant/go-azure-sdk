...
func (c OnenoteNotebookSectionGroupClient) GetOnenoteNotebookSectionGroup(ctx context.Context, id beta.MeOnenoteNotebookIdSectionGroupId, options GetOnenoteNotebookSectionGroupOperationOptions) (result GetOnenoteNotebookSectionGroupOperationResponse, err error) {
