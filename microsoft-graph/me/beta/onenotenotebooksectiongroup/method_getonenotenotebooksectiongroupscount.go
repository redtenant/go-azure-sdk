...
func (c OnenoteNotebookSectionGroupClient) GetOnenoteNotebookSectionGroupsCount(ctx context.Context, id beta.MeOnenoteNotebookId, options GetOnenoteNotebookSectionGroupsCountOperationOptions) (result GetOnenoteNotebookSectionGroupsCountOperationResponse, err error) {
