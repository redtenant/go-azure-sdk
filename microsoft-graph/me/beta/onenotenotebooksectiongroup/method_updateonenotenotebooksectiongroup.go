...
func (c OnenoteNotebookSectionGroupClient) UpdateOnenoteNotebookSectionGroup(ctx context.Context, id beta.MeOnenoteNotebookIdSectionGroupId, input beta.SectionGroup, options UpdateOnenoteNotebookSectionGroupOperationOptions) (result UpdateOnenoteNotebookSectionGroupOperationResponse, err error) {
