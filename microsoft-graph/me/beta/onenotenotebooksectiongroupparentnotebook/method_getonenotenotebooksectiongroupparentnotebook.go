...
// group. Read-only.
func (c OnenoteNotebookSectionGroupParentNotebookClient) GetOnenoteNotebookSectionGroupParentNotebook(ctx context.Context, id beta.MeOnenoteNotebookIdSectionGroupId, options GetOnenoteNotebookSectionGroupParentNotebookOperationOptions) (result GetOnenoteNotebookSectionGroupParentNotebookOperationResponse, err error) {
