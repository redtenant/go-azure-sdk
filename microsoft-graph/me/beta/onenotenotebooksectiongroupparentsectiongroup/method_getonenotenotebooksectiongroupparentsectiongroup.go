...
func (c OnenoteNotebookSectionGroupParentSectionGroupClient) GetOnenoteNotebookSectionGroupParentSectionGroup(ctx context.Context, id beta.MeOnenoteNotebookIdSectionGroupId, options GetOnenoteNotebookSectionGroupParentSectionGroupOperationOptions) (result GetOnenoteNotebookSectionGroupParentSectionGroupOperationResponse, err error) {
