...
func (c OnenoteNotebookSectionGroupSectionClient) CopyOnenoteNotebookSectionGroupSectionToNotebook(ctx context.Context, id beta.MeOnenoteNotebookIdSectionGroupIdSectionId, input CopyOnenoteNotebookSectionGroupSectionToNotebookRequest, options CopyOnenoteNotebookSectionGroupSectionToNotebookOperationOptions) (result CopyOnenoteNotebookSectionGroupSectionToNotebookOperationResponse, err error) {
