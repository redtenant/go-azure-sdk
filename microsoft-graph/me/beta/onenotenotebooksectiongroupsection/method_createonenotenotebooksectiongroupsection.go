...
func (c OnenoteNotebookSectionGroupSectionClient) CreateOnenoteNotebookSectionGroupSection(ctx context.Context, id beta.MeOnenoteNotebookIdSectionGroupId, input beta.OnenoteSection, options CreateOnenoteNotebookSectionGroupSectionOperationOptions) (result CreateOnenoteNotebookSectionGroupSectionOperationResponse, err error) {
