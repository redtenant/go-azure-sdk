...
// DeleteOnenoteNotebookSectionGroupSection - Delete navigation property sections for me
func (c OnenoteNotebookSectionGroupSectionClient) DeleteOnenoteNotebookSectionGroupSection(ctx context.Context, id beta.MeOnenoteNotebookIdSectionGroupIdSectionId, options DeleteOnenoteNotebookSectionGroupSectionOperationOptions) (result DeleteOnenoteNotebookSectionGroupSectionOperationResponse, err error) {
