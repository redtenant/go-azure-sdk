...
func (c OnenoteNotebookSectionGroupSectionClient) GetOnenoteNotebookSectionGroupSectionsCount(ctx context.Context, id beta.MeOnenoteNotebookIdSectionGroupId, options GetOnenoteNotebookSectionGroupSectionsCountOperationOptions) (result GetOnenoteNotebookSectionGroupSectionsCountOperationResponse, err error) {
