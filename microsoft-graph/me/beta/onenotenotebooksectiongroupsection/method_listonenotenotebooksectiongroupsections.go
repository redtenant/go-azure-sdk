...
// Nullable.
func (c OnenoteNotebookSectionGroupSectionClient) ListOnenoteNotebookSectionGroupSections(ctx context.Context, id beta.MeOnenoteNotebookIdSectionGroupId, options ListOnenoteNotebookSectionGroupSectionsOperationOptions) (result ListOnenoteNotebookSectionGroupSectionsOperationResponse, err error) {
...
func (c OnenoteNotebookSectionGroupSectionClient) ListOnenoteNotebookSectionGroupSectionsComplete(ctx context.Context, id beta.MeOnenoteNotebookIdSectionGroupId, options ListOnenoteNotebookSectionGroupSectionsOperationOptions) (ListOnenoteNotebookSectionGroupSectionsCompleteResult, error) {
