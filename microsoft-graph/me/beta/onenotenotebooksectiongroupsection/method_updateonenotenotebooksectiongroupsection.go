...
func (c OnenoteNotebookSectionGroupSectionClient) UpdateOnenoteNotebookSectionGroupSection(ctx context.Context, id beta.MeOnenoteNotebookIdSectionGroupIdSectionId, input beta.OnenoteSection, options UpdateOnenoteNotebookSectionGroupSectionOperationOptions) (result UpdateOnenoteNotebookSectionGroupSectionOperationResponse, err error) {
