...
func (c OnenoteNotebookSectionGroupSectionGroupClient) GetOnenoteNotebookSectionGroupCount(ctx context.Context, id beta.MeOnenoteNotebookIdSectionGroupId, options GetOnenoteNotebookSectionGroupCountOperationOptions) (result GetOnenoteNotebookSectionGroupCountOperationResponse, err error) {
