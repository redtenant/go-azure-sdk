...
func (c OnenoteNotebookSectionGroupSectionPageClient) CopyOnenoteNotebookSectionGroupSectionPageToSection(ctx context.Context, id beta.MeOnenoteNotebookIdSectionGroupIdSectionIdPageId, input CopyOnenoteNotebookSectionGroupSectionPageToSectionRequest, options CopyOnenoteNotebookSectionGroupSectionPageToSectionOperationOptions) (result CopyOnenoteNotebookSectionGroupSectionPageToSectionOperationResponse, err error) {
