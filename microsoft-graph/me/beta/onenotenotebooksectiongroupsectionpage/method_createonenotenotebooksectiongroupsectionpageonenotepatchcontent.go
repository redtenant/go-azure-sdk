...
func (c OnenoteNotebookSectionGroupSectionPageClient) CreateOnenoteNotebookSectionGroupSectionPageOnenotePatchContent(ctx context.Context, id beta.MeOnenoteNotebookIdSectionGroupIdSectionIdPageId, input CreateOnenoteNotebookSectionGroupSectionPageOnenotePatchContentRequest, options CreateOnenoteNotebookSectionGroupSectionPageOnenotePatchContentOperationOptions) (result CreateOnenoteNotebookSectionGroupSectionPageOnenotePatchContentOperationResponse, err error) {
