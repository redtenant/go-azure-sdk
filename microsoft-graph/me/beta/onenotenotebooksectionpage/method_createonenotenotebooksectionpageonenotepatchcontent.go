...
func (c OnenoteNotebookSectionPageClient) CreateOnenoteNotebookSectionPageOnenotePatchContent(ctx context.Context, id beta.MeOnenoteNotebookIdSectionIdPageId, input CreateOnenoteNotebookSectionPageOnenotePatchContentRequest, options CreateOnenoteNotebookSectionPageOnenotePatchContentOperationOptions) (result CreateOnenoteNotebookSectionPageOnenotePatchContentOperationResponse, err error) {
