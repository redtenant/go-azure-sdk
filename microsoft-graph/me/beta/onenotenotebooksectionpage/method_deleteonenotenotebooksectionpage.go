...
func (c OnenoteNotebookSectionPageClient) DeleteOnenoteNotebookSectionPage(ctx context.Context, id beta.MeOnenoteNotebookIdSectionIdPageId, options DeleteOnenoteNotebookSectionPageOperationOptions) (result DeleteOnenoteNotebookSectionPageOperationResponse, err error) {
