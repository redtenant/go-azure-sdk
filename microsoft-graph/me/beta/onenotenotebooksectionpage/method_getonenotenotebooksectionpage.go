...
func (c OnenoteNotebookSectionPageClient) GetOnenoteNotebookSectionPage(ctx context.Context, id beta.MeOnenoteNotebookIdSectionIdPageId, options GetOnenoteNotebookSectionPageOperationOptions) (result GetOnenoteNotebookSectionPageOperationResponse, err error) {
