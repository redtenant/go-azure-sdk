...
func (c OnenoteNotebookSectionPageClient) GetOnenoteNotebookSectionPagesCount(ctx context.Context, id beta.MeOnenoteNotebookIdSectionId, options GetOnenoteNotebookSectionPagesCountOperationOptions) (result GetOnenoteNotebookSectionPagesCountOperationResponse, err error) {
