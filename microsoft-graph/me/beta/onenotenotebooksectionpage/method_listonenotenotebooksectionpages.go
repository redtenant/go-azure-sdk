...
func (c OnenoteNotebookSectionPageClient) ListOnenoteNotebookSectionPages(ctx context.Context, id beta.MeOnenoteNotebookIdSectionId, options ListOnenoteNotebookSectionPagesOperationOptions) (result ListOnenoteNotebookSectionPagesOperationResponse, err error) {
...
func (c OnenoteNotebookSectionPageClient) ListOnenoteNotebookSectionPagesComplete(ctx context.Context, id beta.MeOnenoteNotebookIdSectionId, options ListOnenoteNotebookSectionPagesOperationOptions) (ListOnenoteNotebookSectionPagesCompleteResult, error) {
