...
func (c OnenoteNotebookSectionPageClient) UpdateOnenoteNotebookSectionPage(ctx context.Context, id beta.MeOnenoteNotebookIdSectionIdPageId, input beta.OnenotePage, options UpdateOnenoteNotebookSectionPageOperationOptions) (result UpdateOnenoteNotebookSectionPageOperationResponse, err error) {
