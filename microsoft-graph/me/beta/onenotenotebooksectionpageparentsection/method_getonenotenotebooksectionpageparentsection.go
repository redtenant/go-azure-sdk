...
// Read-only.
func (c OnenoteNotebookSectionPageParentSectionClient) GetOnenoteNotebookSectionPageParentSection(ctx context.Context, id beta.MeOnenoteNotebookIdSectionIdPageId, options GetOnenoteNotebookSectionPageParentSectionOperationOptions) (result GetOnenoteNotebookSectionPageParentSectionOperationResponse, err error) {
