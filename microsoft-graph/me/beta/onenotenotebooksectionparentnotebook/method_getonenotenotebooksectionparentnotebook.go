...
// Read-only.
func (c OnenoteNotebookSectionParentNotebookClient) GetOnenoteNotebookSectionParentNotebook(ctx context.Context, id beta.MeOnenoteNotebookIdSectionId, options GetOnenoteNotebookSectionParentNotebookOperationOptions) (result GetOnenoteNotebookSectionParentNotebookOperationResponse, err error) {
