...
func (c OnenoteOperationClient) CreateOnenoteOperation(ctx context.Context, input beta.OnenoteOperation, options CreateOnenoteOperationOperationOptions) (result CreateOnenoteOperationOperationResponse, err error) {
