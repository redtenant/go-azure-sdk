...
func (c OnenoteOperationClient) DeleteOnenoteOperation(ctx context.Context, id beta.MeOnenoteOperationId, options DeleteOnenoteOperationOperationOptions) (result DeleteOnenoteOperationOperationResponse, err error) {
