...
func (c OnenoteOperationClient) UpdateOnenoteOperation(ctx context.Context, id beta.MeOnenoteOperationId, input beta.OnenoteOperation, options UpdateOnenoteOperationOperationOptions) (result UpdateOnenoteOperationOperationResponse, err error) {
