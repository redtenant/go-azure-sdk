...
// result.
func (c OnenotePageClient) CopyOnenotePageToSection(ctx context.Context, id beta.MeOnenotePageId, input CopyOnenotePageToSectionRequest, options CopyOnenotePageToSectionOperationOptions) (result CopyOnenotePageToSectionOperationResponse, err error) {
