...
// CreateOnenotePage - Create new navigation property to pages for me
func (c OnenotePageClient) CreateOnenotePage(ctx context.Context, input beta.OnenotePage, options CreateOnenotePageOperationOptions) (result CreateOnenotePageOperationResponse, err error) {
