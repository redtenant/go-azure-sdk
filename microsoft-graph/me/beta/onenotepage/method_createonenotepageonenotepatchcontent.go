...
func (c OnenotePageClient) CreateOnenotePageOnenotePatchContent(ctx context.Context, id beta.MeOnenotePageId, input CreateOnenotePageOnenotePatchContentRequest, options CreateOnenotePageOnenotePatchContentOperationOptions) (result CreateOnenotePageOnenotePatchContentOperationResponse, err error) {
