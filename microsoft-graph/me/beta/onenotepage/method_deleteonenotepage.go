...
func (c OnenotePageClient) DeleteOnenotePage(ctx context.Context, id beta.MeOnenotePageId, options DeleteOnenotePageOperationOptions) (result DeleteOnenotePageOperationResponse, err error) {
