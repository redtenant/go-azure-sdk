...
// GetOnenotePage - Get pages from me. The pages in all OneNote notebooks that are owned by the user or group.
// Read-only. Nullable.
func (c OnenotePageClient) GetOnenotePage(ctx context.Context, id beta.MeOnenotePageId, options GetOnenotePageOperationOptions) (result GetOnenotePageOperationResponse, err error) {
