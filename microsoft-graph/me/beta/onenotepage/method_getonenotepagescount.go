...
func (c OnenotePageClient) GetOnenotePagesCount(ctx context.Context, options GetOnenotePagesCountOperationOptions) (result GetOnenotePagesCountOperationResponse, err error) {
