...
func (c OnenotePageClient) UpdateOnenotePage(ctx context.Context, id beta.MeOnenotePageId, input beta.OnenotePage, options UpdateOnenotePageOperationOptions) (result UpdateOnenotePageOperationResponse, err error) {
