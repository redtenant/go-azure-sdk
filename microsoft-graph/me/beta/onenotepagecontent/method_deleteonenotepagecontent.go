...
func (c OnenotePageContentClient) DeleteOnenotePageContent(ctx context.Context, id beta.MeOnenotePageId, options DeleteOnenotePageContentOperationOptions) (result DeleteOnenotePageContentOperationResponse, err error) {
