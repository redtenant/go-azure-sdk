...
func (c OnenotePageContentClient) GetOnenotePageContent(ctx context.Context, id beta.MeOnenotePageId, options GetOnenotePageContentOperationOptions) (result GetOnenotePageContentOperationResponse, err error) {
