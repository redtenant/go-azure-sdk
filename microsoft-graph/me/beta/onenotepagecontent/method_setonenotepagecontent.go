...
func (c OnenotePageContentClient) SetOnenotePageContent(ctx context.Context, id beta.MeOnenotePageId, input []byte, options SetOnenotePageContentOperationOptions) (result SetOnenotePageContentOperationResponse, err error) {
