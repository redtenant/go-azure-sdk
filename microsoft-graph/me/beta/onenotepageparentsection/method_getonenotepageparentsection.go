...
func (c OnenotePageParentSectionClient) GetOnenotePageParentSection(ctx context.Context, id beta.MeOnenotePageId, options GetOnenotePageParentSectionOperationOptions) (result GetOnenotePageParentSectionOperationResponse, err error) {
