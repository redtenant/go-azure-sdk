...
func (c OnenoteResourceClient) UpdateOnenoteResource(ctx context.Context, id beta.MeOnenoteResourceId, input beta.OnenoteResource, options UpdateOnenoteResourceOperationOptions) (result UpdateOnenoteResourceOperationResponse, err error) {
