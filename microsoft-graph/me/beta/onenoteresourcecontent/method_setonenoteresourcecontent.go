...
// SetOnenoteResourceContent - Update content for the navigation property resources in me. The content of the resource.
func (c OnenoteResourceContentClient) SetOnenoteResourceContent(ctx context.Context, id beta.MeOnenoteResourceId, input []byte, options SetOnenoteResourceContentOperationOptions) (result SetOnenoteResourceContentOperationResponse, err error) {
