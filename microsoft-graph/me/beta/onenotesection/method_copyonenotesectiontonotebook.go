...
func (c OnenoteSectionClient) CopyOnenoteSectionToNotebook(ctx context.Context, id beta.MeOnenoteSectionId, input CopyOnenoteSectionToNotebookRequest, options CopyOnenoteSectionToNotebookOperationOptions) (result CopyOnenoteSectionToNotebookOperationResponse, err error) {
