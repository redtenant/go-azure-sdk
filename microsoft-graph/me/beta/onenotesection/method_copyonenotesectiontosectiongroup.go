...
func (c OnenoteSectionClient) CopyOnenoteSectionToSectionGroup(ctx context.Context, id beta.MeOnenoteSectionId, input CopyOnenoteSectionToSectionGroupRequest, options CopyOnenoteSectionToSectionGroupOperationOptions) (result CopyOnenoteSectionToSectionGroupOperationResponse, err error) {
