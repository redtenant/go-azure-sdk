...
func (c OnenoteSectionClient) CreateOnenoteSection(ctx context.Context, input beta.OnenoteSection, options CreateOnenoteSectionOperationOptions) (result CreateOnenoteSectionOperationResponse, err error) {
