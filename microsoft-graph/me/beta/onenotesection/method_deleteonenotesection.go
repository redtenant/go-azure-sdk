...
func (c OnenoteSectionClient) DeleteOnenoteSection(ctx context.Context, id beta.MeOnenoteSectionId, options DeleteOnenoteSectionOperationOptions) (result DeleteOnenoteSectionOperationResponse, err error) {
