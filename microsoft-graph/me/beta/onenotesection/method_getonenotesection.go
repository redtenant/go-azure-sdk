...
// GetOnenoteSection - Get section. Retrieve the properties and relationships of a section object.
func (c OnenoteSectionClient) GetOnenoteSection(ctx context.Context, id beta.MeOnenoteSectionId, options GetOnenoteSectionOperationOptions) (result GetOnenoteSectionOperationResponse, err error) {
