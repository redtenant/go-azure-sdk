...
func DefaultGetOnenoteSectionsCountOperationOptions() GetOnenoteSectionsCountOperationOptions {
	return GetOnenoteSectionsCountOperationOptions{}
}
...
func (c OnenoteSectionClient) GetOnenoteSectionsCount(ctx context.Context, options GetOnenoteSectionsCountOperationOptions) (result GetOnenoteSectionsCountOperationResponse, err error) {
	opts := client.RequestOptions{
		...
		Path:          "/me/onenote/sections/$count",
