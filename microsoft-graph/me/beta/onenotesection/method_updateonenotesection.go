...
func (c OnenoteSectionClient) UpdateOnenoteSection(ctx context.Context, id beta.MeOnenoteSectionId, input beta.OnenoteSection, options UpdateOnenoteSectionOperationOptions) (result UpdateOnenoteSectionOperationResponse, err error) {
