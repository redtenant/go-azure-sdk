...
func (c OnenoteSectionGroupClient) CreateOnenoteSectionGroup(ctx context.Context, input beta.SectionGroup, options CreateOnenoteSectionGroupOperationOptions) (result CreateOnenoteSectionGroupOperationResponse, err error) {
