...
func (c OnenoteSectionGroupClient) DeleteOnenoteSectionGroup(ctx context.Context, id beta.MeOnenoteSectionGroupId, options DeleteOnenoteSectionGroupOperationOptions) (result DeleteOnenoteSectionGroupOperationResponse, err error) {
