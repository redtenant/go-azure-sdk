...
func (c OnenoteSectionGroupClient) GetOnenoteSectionGroup(ctx context.Context, id beta.MeOnenoteSectionGroupId, options GetOnenoteSectionGroupOperationOptions) (result GetOnenoteSectionGroupOperationResponse, err error) {
