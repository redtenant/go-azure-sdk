...
func (c OnenoteSectionGroupClient) UpdateOnenoteSectionGroup(ctx context.Context, id beta.MeOnenoteSectionGroupId, input beta.SectionGroup, options UpdateOnenoteSectionGroupOperationOptions) (result UpdateOnenoteSectionGroupOperationResponse, err error) {
