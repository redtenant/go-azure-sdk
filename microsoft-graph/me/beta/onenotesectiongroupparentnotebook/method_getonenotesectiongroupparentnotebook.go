...
// Read-only.
func (c OnenoteSectionGroupParentNotebookClient) GetOnenoteSectionGroupParentNotebook(ctx context.Context, id beta.MeOnenoteSectionGroupId, options GetOnenoteSectionGroupParentNotebookOperationOptions) (result GetOnenoteSectionGroupParentNotebookOperationResponse, err error) {
