...
func (c OnenoteSectionGroupParentSectionGroupClient) GetOnenoteSectionGroupParentSectionGroup(ctx context.Context, id beta.MeOnenoteSectionGroupId, options GetOnenoteSectionGroupParentSectionGroupOperationOptions) (result GetOnenoteSectionGroupParentSectionGroupOperationResponse, err error) {
