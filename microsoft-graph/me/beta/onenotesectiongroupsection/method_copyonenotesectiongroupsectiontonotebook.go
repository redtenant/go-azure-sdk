...
func (c OnenoteSectionGroupSectionClient) CopyOnenoteSectionGroupSectionToNotebook(ctx context.Context, id beta.MeOnenoteSectionGroupIdSectionId, input CopyOnenoteSectionGroupSectionToNotebookRequest, options CopyOnenoteSectionGroupSectionToNotebookOperationOptions) (result CopyOnenoteSectionGroupSectionToNotebookOperationResponse, err error) {
