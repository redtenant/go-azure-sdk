...
func (c OnenoteSectionGroupSectionClient) CopyOnenoteSectionGroupSectionToSectionGroup(ctx context.Context, id beta.MeOnenoteSectionGroupIdSectionId, input CopyOnenoteSectionGroupSectionToSectionGroupRequest, options CopyOnenoteSectionGroupSectionToSectionGroupOperationOptions) (result CopyOnenoteSectionGroupSectionToSectionGroupOperationResponse, err error) {
