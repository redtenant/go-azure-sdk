...
// CreateOnenoteSectionGroupSection - Create section. Create a new section in the specified section group.
func (c OnenoteSectionGroupSectionClient) CreateOnenoteSectionGroupSection(ctx context.Context, id beta.MeOnenoteSectionGroupId, input beta.OnenoteSection, options CreateOnenoteSectionGroupSectionOperationOptions) (result CreateOnenoteSectionGroupSectionOperationResponse, err error) {
