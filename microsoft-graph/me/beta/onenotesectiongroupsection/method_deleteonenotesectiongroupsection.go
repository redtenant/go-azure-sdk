...
func (c OnenoteSectionGroupSectionClient) DeleteOnenoteSectionGroupSection(ctx context.Context, id beta.MeOnenoteSectionGroupIdSectionId, options DeleteOnenoteSectionGroupSectionOperationOptions) (result DeleteOnenoteSectionGroupSectionOperationResponse, err error) {
