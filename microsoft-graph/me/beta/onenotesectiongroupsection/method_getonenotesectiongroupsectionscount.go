...
func (c OnenoteSectionGroupSectionClient) GetOnenoteSectionGroupSectionsCount(ctx context.Context, id beta.MeOnenoteSectionGroupId, options GetOnenoteSectionGroupSectionsCountOperationOptions) (result GetOnenoteSectionGroupSectionsCountOperationResponse, err error) {
