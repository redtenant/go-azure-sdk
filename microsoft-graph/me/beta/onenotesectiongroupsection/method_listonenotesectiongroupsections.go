...
// ListOnenoteSectionGroupSections - List sections. Retrieve a list of onenoteSection objects from the specified section
// group.
func (c OnenoteSectionGroupSectionClient) ListOnenoteSectionGroupSections(ctx context.Context, id beta.MeOnenoteSectionGroupId, options ListOnenoteSectionGroupSectionsOperationOptions) (result ListOnenoteSectionGroupSectionsOperationResponse, err error) {
...
func (c OnenoteSectionGroupSectionClient) ListOnenoteSectionGroupSectionsComplete(ctx context.Context, id beta.MeOnenoteSectionGroupId, options ListOnenoteSectionGroupSectionsOperationOptions) (ListOnenoteSectionGroupSectionsCompleteResult, error) {
