...
func (c OnenoteSectionGroupSectionPageClient) CopyOnenoteSectionGroupSectionPageToSection(ctx context.Context, id beta.MeOnenoteSectionGroupIdSectionIdPageId, input CopyOnenoteSectionGroupSectionPageToSectionRequest, options CopyOnenoteSectionGroupSectionPageToSectionOperationOptions) (result CopyOnenoteSectionGroupSectionPageToSectionOperationResponse, err error) {
