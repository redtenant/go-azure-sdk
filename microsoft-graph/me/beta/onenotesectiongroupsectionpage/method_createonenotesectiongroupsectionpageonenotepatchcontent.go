...
func (c OnenoteSectionGroupSectionPageClient) CreateOnenoteSectionGroupSectionPageOnenotePatchContent(ctx context.Context, id beta.MeOnenoteSectionGroupIdSectionIdPageId, input CreateOnenoteSectionGroupSectionPageOnenotePatchContentRequest, options CreateOnenoteSectionGroupSectionPageOnenotePatchContentOperationOptions) (result CreateOnenoteSectionGroupSectionPageOnenotePatchContentOperationResponse, err error) {
