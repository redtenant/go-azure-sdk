...
func (c OnenoteSectionGroupSectionPageClient) DeleteOnenoteSectionGroupSectionPage(ctx context.Context, id beta.MeOnenoteSectionGroupIdSectionIdPageId, options DeleteOnenoteSectionGroupSectionPageOperationOptions) (result DeleteOnenoteSectionGroupSectionPageOperationResponse, err error) {
