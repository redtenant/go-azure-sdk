...
func (c OnenoteSectionGroupSectionPageClient) ListOnenoteSectionGroupSectionPages(ctx context.Context, id beta.MeOnenoteSectionGroupIdSectionId, options ListOnenoteSectionGroupSectionPagesOperationOptions) (result ListOnenoteSectionGroupSectionPagesOperationResponse, err error) {
...
func (c OnenoteSectionGroupSectionPageClient) ListOnenoteSectionGroupSectionPagesComplete(ctx context.Context, id beta.MeOnenoteSectionGroupIdSectionId, options ListOnenoteSectionGroupSectionPagesOperationOptions) (ListOnenoteSectionGroupSectionPagesCompleteResult, error) {
...
func (c OnenoteSectionGroupSectionPageClient) ListOnenoteSectionGroupSectionPagesCompleteMatchingPredicate(ctx context.Context, id beta.MeOnenoteSectionGroupIdSectionId, options ListOnenoteSectionGroupSectionPagesOperationOptions, predicate OnenotePageOperationPredicate) (result ListOnenoteSectionGroupSectionPagesCompleteResult, err error) {
