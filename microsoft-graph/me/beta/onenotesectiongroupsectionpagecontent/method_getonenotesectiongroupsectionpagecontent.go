...
// content.
func (c OnenoteSectionGroupSectionPageContentClient) GetOnenoteSectionGroupSectionPageContent(ctx context.Context, id beta.MeOnenoteSectionGroupIdSectionIdPageId, options GetOnenoteSectionGroupSectionPageContentOperationOptions) (result GetOnenoteSectionGroupSectionPageContentOperationResponse, err error) {
