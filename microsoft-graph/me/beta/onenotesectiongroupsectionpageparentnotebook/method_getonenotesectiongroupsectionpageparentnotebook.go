...
// Read-only.
func (c OnenoteSectionGroupSectionPageParentNotebookClient) GetOnenoteSectionGroupSectionPageParentNotebook(ctx context.Context, id beta.MeOnenoteSectionGroupIdSectionIdPageId, options GetOnenoteSectionGroupSectionPageParentNotebookOperationOptions) (result GetOnenoteSectionGroupSectionPageParentNotebookOperationResponse, err error) {
