...
// Read-only.
func (c OnenoteSectionGroupSectionPageParentSectionClient) GetOnenoteSectionGroupSectionPageParentSection(ctx context.Context, id beta.MeOnenoteSectionGroupIdSectionIdPageId, options GetOnenoteSectionGroupSectionPageParentSectionOperationOptions) (result GetOnenoteSectionGroupSectionPageParentSectionOperationResponse, err error) {
