...
// Read-only.
func (c OnenoteSectionGroupSectionParentNotebookClient) GetOnenoteSectionGroupSectionParentNotebook(ctx context.Context, id beta.MeOnenoteSectionGroupIdSectionId, options GetOnenoteSectionGroupSectionParentNotebookOperationOptions) (result GetOnenoteSectionGroupSectionParentNotebookOperationResponse, err error) {
