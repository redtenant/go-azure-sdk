...
func (c OnenoteSectionPageClient) CopyOnenoteSectionPageToSection(ctx context.Context, id beta.MeOnenoteSectionIdPageId, input CopyOnenoteSectionPageToSectionRequest, options CopyOnenoteSectionPageToSectionOperationOptions) (result CopyOnenoteSectionPageToSectionOperationResponse, err error) {
