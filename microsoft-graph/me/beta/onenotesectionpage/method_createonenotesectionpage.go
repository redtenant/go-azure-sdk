...
// CreateOnenoteSectionPage - Create new navigation property to pages for me
func (c OnenoteSectionPageClient) CreateOnenoteSectionPage(ctx context.Context, id beta.MeOnenoteSectionId, input beta.OnenotePage, options CreateOnenoteSectionPageOperationOptions) (result CreateOnenoteSectionPageOperationResponse, err error) {
