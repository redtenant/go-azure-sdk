...
func (c OnenoteSectionPageClient) DeleteOnenoteSectionPage(ctx context.Context, id beta.MeOnenoteSectionIdPageId, options DeleteOnenoteSectionPageOperationOptions) (result DeleteOnenoteSectionPageOperationResponse, err error) {
