...
func (c OnenoteSectionPageClient) GetOnenoteSectionPage(ctx context.Context, id beta.MeOnenoteSectionIdPageId, options GetOnenoteSectionPageOperationOptions) (result GetOnenoteSectionPageOperationResponse, err error) {
