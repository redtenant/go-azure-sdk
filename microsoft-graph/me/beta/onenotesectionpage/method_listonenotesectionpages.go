...
// ListOnenoteSectionPages - Get pages from me. The collection of pages in the section. Read-only. Nullable.
func (c OnenoteSectionPageClient) ListOnenoteSectionPages(ctx context.Context, id beta.MeOnenoteSectionId, options ListOnenoteSectionPagesOperationOptions) (result ListOnenoteSectionPagesOperationResponse, err error) {
...
func (c OnenoteSectionPageClient) ListOnenoteSectionPagesComplete(ctx context.Context, id beta.MeOnenoteSectionId, options ListOnenoteSectionPagesOperationOptions) (ListOnenoteSectionPagesCompleteResult, error) {
...
func (c OnenoteSectionPageClient) ListOnenoteSectionPagesCompleteMatchingPredicate(ctx context.Context, id beta.MeOnenoteSectionId, options ListOnenoteSectionPagesOperationOptions, predicate OnenotePageOperationPredicate) (result ListOnenoteSectionPagesCompleteResult, err error) {
