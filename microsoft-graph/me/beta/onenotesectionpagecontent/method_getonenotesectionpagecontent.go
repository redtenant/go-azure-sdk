...
func (c OnenoteSectionPageContentClient) GetOnenoteSectionPageContent(ctx context.Context, id beta.MeOnenoteSectionIdPageId, options GetOnenoteSectionPageContentOperationOptions) (result GetOnenoteSectionPageContentOperationResponse, err error) {
