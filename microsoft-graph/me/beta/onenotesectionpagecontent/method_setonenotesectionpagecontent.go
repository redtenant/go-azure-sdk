...
func (c OnenoteSectionPageContentClient) SetOnenoteSectionPageContent(ctx context.Context, id beta.MeOnenoteSectionIdPageId, input []byte, options SetOnenoteSectionPageContentOperationOptions) (result SetOnenoteSectionPageContentOperationResponse, err error) {
