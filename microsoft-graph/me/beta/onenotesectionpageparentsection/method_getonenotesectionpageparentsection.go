...
func (c OnenoteSectionPageParentSectionClient) GetOnenoteSectionPageParentSection(ctx context.Context, id beta.MeOnenoteSectionIdPageId, options GetOnenoteSectionPageParentSectionOperationOptions) (result GetOnenoteSectionPageParentSectionOperationResponse, err error) {
