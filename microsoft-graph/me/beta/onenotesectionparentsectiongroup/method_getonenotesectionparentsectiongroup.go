...
// Read-only.
func (c OnenoteSectionParentSectionGroupClient) GetOnenoteSectionParentSectionGroup(ctx context.Context, id beta.MeOnenoteSectionId, options GetOnenoteSectionParentSectionGroupOperationOptions) (result GetOnenoteSectionParentSectionGroupOperationResponse, err error) {
