...
func (c OnlineMeetingClient) CreateOnlineMeeting(ctx context.Context, input beta.OnlineMeeting, options CreateOnlineMeetingOperationOptions) (result CreateOnlineMeetingOperationResponse, err error) {
