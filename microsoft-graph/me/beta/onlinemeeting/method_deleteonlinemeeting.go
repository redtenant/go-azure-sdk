...
func (c OnlineMeetingClient) DeleteOnlineMeeting(ctx context.Context, id beta.MeOnlineMeetingId, options DeleteOnlineMeetingOperationOptions) (result DeleteOnlineMeetingOperationResponse, err error) {
