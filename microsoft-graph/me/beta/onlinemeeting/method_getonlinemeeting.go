...
// GetOnlineMeeting - Get onlineMeetings from me. Information about a meeting, including the URL used to join a meeting,
// the attendees list, and the description.
func (c OnlineMeetingClient) GetOnlineMeeting(ctx context.Context, id beta.MeOnlineMeetingId, options GetOnlineMeetingOperationOptions) (result GetOnlineMeetingOperationResponse, err error) {
