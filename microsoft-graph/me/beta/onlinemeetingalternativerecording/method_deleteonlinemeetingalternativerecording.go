...
// me. The content stream of the alternative recording of a Microsoft Teams live event. Read-only.
func (c OnlineMeetingAlternativeRecordingClient) DeleteOnlineMeetingAlternativeRecording(ctx context.Context, id beta.MeOnlineMeetingId, options DeleteOnlineMeetingAlternativeRecordingOperationOptions) (result DeleteOnlineMeetingAlternativeRecordingOperationResponse, err error) {
