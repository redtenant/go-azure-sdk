...
type SetOnlineMeetingAlternativeRecordingOperationResponse struct {
...
// SetOnlineMeetingAlternativeRecording - Update alternativeRecording for the navigation property onlineMeetings in me.
// The content stream of the alternative recording of a Microsoft Teams live event. Read-only.
func (c OnlineMeetingAlternativeRecordingClient) SetOnlineMeetingAlternativeRecording(ctx context.Context, id beta.MeOnlineMeetingId, input []byte, options SetOnlineMeetingAlternativeRecordingOperationOptions) (result SetOnlineMeetingAlternativeRecordingOperationResponse, err error) {
