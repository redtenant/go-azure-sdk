...
// CreateOnlineMeetingAttendanceReport - Create new navigation property to attendanceReports for me
func (c OnlineMeetingAttendanceReportClient) CreateOnlineMeetingAttendanceReport(ctx context.Context, id beta.MeOnlineMeetingId, input beta.MeetingAttendanceReport, options CreateOnlineMeetingAttendanceReportOperationOptions) (result CreateOnlineMeetingAttendanceReportOperationResponse, err error) {
