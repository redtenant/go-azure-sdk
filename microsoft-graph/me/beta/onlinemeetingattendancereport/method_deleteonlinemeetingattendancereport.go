...
func (c OnlineMeetingAttendanceReportClient) DeleteOnlineMeetingAttendanceReport(ctx context.Context, id beta.MeOnlineMeetingIdAttendanceReportId, options DeleteOnlineMeetingAttendanceReportOperationOptions) (result DeleteOnlineMeetingAttendanceReportOperationResponse, err error) {
