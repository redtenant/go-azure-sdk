...
// GetOnlineMeetingAttendanceReport - Get meetingAttendanceReport. Get the meetingAttendanceReport for an onlineMeeting
// or a virtualEvent. When an online meeting ends, an attendance report is generated for that session.
func (c OnlineMeetingAttendanceReportClient) GetOnlineMeetingAttendanceReport(ctx context.Context, id beta.MeOnlineMeetingIdAttendanceReportId, options GetOnlineMeetingAttendanceReportOperationOptions) (result GetOnlineMeetingAttendanceReportOperationResponse, err error) {
	...
	var model beta.MeetingAttendanceReport
	result.Model = &model
