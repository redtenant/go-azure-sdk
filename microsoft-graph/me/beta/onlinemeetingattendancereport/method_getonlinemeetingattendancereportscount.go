...
func (c OnlineMeetingAttendanceReportClient) GetOnlineMeetingAttendanceReportsCount(ctx context.Context, id beta.MeOnlineMeetingId, options GetOnlineMeetingAttendanceReportsCountOperationOptions) (result GetOnlineMeetingAttendanceReportsCountOperationResponse, err error) {
