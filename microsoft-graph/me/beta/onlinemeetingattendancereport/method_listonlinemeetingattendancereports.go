...
func (c OnlineMeetingAttendanceReportClient) ListOnlineMeetingAttendanceReports(ctx context.Context, id beta.MeOnlineMeetingId, options ListOnlineMeetingAttendanceReportsOperationOptions) (result ListOnlineMeetingAttendanceReportsOperationResponse, err error) {
...
func (c OnlineMeetingAttendanceReportClient) ListOnlineMeetingAttendanceReportsComplete(ctx context.Context, id beta.MeOnlineMeetingId, options ListOnlineMeetingAttendanceReportsOperationOptions) (ListOnlineMeetingAttendanceReportsCompleteResult, error) {
