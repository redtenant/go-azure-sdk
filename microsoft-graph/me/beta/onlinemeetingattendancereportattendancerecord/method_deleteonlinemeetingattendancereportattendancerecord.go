...
func (c OnlineMeetingAttendanceReportAttendanceRecordClient) DeleteOnlineMeetingAttendanceReportAttendanceRecord(ctx context.Context, id beta.MeOnlineMeetingIdAttendanceReportIdAttendanceRecordId, options DeleteOnlineMeetingAttendanceReportAttendanceRecordOperationOptions) (result DeleteOnlineMeetingAttendanceReportAttendanceRecordOperationResponse, err error) {
