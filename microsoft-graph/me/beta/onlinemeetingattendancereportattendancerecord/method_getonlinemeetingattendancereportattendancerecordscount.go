...
func (c OnlineMeetingAttendanceReportAttendanceRecordClient) GetOnlineMeetingAttendanceReportAttendanceRecordsCount(ctx context.Context, id beta.MeOnlineMeetingIdAttendanceReportId, options GetOnlineMeetingAttendanceReportAttendanceRecordsCountOperationOptions) (result GetOnlineMeetingAttendanceReportAttendanceRecordsCountOperationResponse, err error) {
