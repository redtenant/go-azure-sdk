...
func (c OnlineMeetingAttendanceReportAttendanceRecordClient) UpdateOnlineMeetingAttendanceReportAttendanceRecord(ctx context.Context, id beta.MeOnlineMeetingIdAttendanceReportIdAttendanceRecordId, input beta.AttendanceRecord, options UpdateOnlineMeetingAttendanceReportAttendanceRecordOperationOptions) (result UpdateOnlineMeetingAttendanceReportAttendanceRecordOperationResponse, err error) {
