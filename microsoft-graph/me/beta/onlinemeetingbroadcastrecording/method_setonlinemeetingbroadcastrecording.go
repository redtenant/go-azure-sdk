...
// SetOnlineMeetingBroadcastRecording - Update broadcastRecording for the navigation property onlineMeetings in me
func (c OnlineMeetingBroadcastRecordingClient) SetOnlineMeetingBroadcastRecording(ctx context.Context, id beta.MeOnlineMeetingId, input []byte, options SetOnlineMeetingBroadcastRecordingOperationOptions) (result SetOnlineMeetingBroadcastRecordingOperationResponse, err error) {
