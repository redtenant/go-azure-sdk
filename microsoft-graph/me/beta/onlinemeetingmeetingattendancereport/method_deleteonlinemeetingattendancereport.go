...
// DeleteOnlineMeetingAttendanceReport - Delete navigation property meetingAttendanceReport for me
func (c OnlineMeetingMeetingAttendanceReportClient) DeleteOnlineMeetingAttendanceReport(ctx context.Context, id beta.MeOnlineMeetingId, options DeleteOnlineMeetingAttendanceReportOperationOptions) (result DeleteOnlineMeetingAttendanceReportOperationResponse, err error) {
