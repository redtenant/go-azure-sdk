...
func (c OnlineMeetingMeetingAttendanceReportClient) GetOnlineMeetingAttendanceReport(ctx context.Context, id beta.MeOnlineMeetingId, options GetOnlineMeetingAttendanceReportOperationOptions) (result GetOnlineMeetingAttendanceReportOperationResponse, err error) {
