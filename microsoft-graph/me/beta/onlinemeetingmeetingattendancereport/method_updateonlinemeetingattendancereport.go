...
// UpdateOnlineMeetingAttendanceReport - Update the navigation property meetingAttendanceReport in me
func (c OnlineMeetingMeetingAttendanceReportClient) UpdateOnlineMeetingAttendanceReport(ctx context.Context, id beta.MeOnlineMeetingId, input beta.MeetingAttendanceReport, options UpdateOnlineMeetingAttendanceReportOperationOptions) (result UpdateOnlineMeetingAttendanceReportOperationResponse, err error) {
