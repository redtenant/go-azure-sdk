...
func (c OnlineMeetingMeetingAttendanceReportAttendanceRecordClient) CreateOnlineMeetingAttendanceReportAttendanceRecord(ctx context.Context, id beta.MeOnlineMeetingId, input beta.AttendanceRecord, options CreateOnlineMeetingAttendanceReportAttendanceRecordOperationOptions) (result CreateOnlineMeetingAttendanceReportAttendanceRecordOperationResponse, err error) {
