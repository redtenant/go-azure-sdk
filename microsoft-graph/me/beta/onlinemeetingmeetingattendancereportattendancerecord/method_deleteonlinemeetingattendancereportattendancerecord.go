...
// DeleteOnlineMeetingAttendanceReportAttendanceRecord - Delete navigation property attendanceRecords for me
func (c OnlineMeetingMeetingAttendanceReportAttendanceRecordClient) DeleteOnlineMeetingAttendanceReportAttendanceRecord(ctx context.Context, id beta.MeOnlineMeetingIdMeetingAttendanceReportAttendanceRecordId, options DeleteOnlineMeetingAttendanceReportAttendanceRecordOperationOptions) (result DeleteOnlineMeetingAttendanceReportAttendanceRecordOperationResponse, err error) {
