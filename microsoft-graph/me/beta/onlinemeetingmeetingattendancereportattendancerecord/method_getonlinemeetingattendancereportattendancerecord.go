...
// GetOnlineMeetingAttendanceReportAttendanceRecord - Get attendanceRecords from me. List of attendance records of an
// attendance report. Read-only.
func (c OnlineMeetingMeetingAttendanceReportAttendanceRecordClient) GetOnlineMeetingAttendanceReportAttendanceRecord(ctx context.Context, id beta.MeOnlineMeetingIdMeetingAttendanceReportAttendanceRecordId, options GetOnlineMeetingAttendanceReportAttendanceRecordOperationOptions) (result GetOnlineMeetingAttendanceReportAttendanceRecordOperationResponse, err error) {
