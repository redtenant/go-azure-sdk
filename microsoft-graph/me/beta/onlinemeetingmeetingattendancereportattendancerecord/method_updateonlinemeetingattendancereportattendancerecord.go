...
func (c OnlineMeetingMeetingAttendanceReportAttendanceRecordClient) UpdateOnlineMeetingAttendanceReportAttendanceRecord(ctx context.Context, id beta.MeOnlineMeetingIdMeetingAttendanceReportAttendanceRecordId, input beta.AttendanceRecord, options UpdateOnlineMeetingAttendanceReportAttendanceRecordOperationOptions) (result UpdateOnlineMeetingAttendanceReportAttendanceRecordOperationResponse, err error) {
