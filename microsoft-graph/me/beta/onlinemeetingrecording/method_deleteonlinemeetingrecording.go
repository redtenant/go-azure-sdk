...
func (c OnlineMeetingRecordingClient) DeleteOnlineMeetingRecording(ctx context.Context, id beta.MeOnlineMeetingIdRecordingId, options DeleteOnlineMeetingRecordingOperationOptions) (result DeleteOnlineMeetingRecordingOperationResponse, err error) {
