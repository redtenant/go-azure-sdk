...
func (c OnlineMeetingRecordingClient) GetOnlineMeetingRecordingsCount(ctx context.Context, id beta.MeOnlineMeetingId, options GetOnlineMeetingRecordingsCountOperationOptions) (result GetOnlineMeetingRecordingsCountOperationResponse, err error) {
