...
// SetOnlineMeetingRecording - Update recording for the navigation property onlineMeetings in me. The content stream of
// the recording of a Teams live event. Read-only.
func (c OnlineMeetingRecordingClient) SetOnlineMeetingRecording(ctx context.Context, id beta.MeOnlineMeetingId, input []byte, options SetOnlineMeetingRecordingOperationOptions) (result SetOnlineMeetingRecordingOperationResponse, err error) {
