...
func (c OnlineMeetingRecordingClient) UpdateOnlineMeetingRecording(ctx context.Context, id beta.MeOnlineMeetingIdRecordingId, input beta.CallRecording, options UpdateOnlineMeetingRecordingOperationOptions) (result UpdateOnlineMeetingRecordingOperationResponse, err error) {
