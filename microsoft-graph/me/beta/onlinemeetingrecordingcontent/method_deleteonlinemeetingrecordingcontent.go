...
// recording. Read-only.
func (c OnlineMeetingRecordingContentClient) DeleteOnlineMeetingRecordingContent(ctx context.Context, id beta.MeOnlineMeetingIdRecordingId, options DeleteOnlineMeetingRecordingContentOperationOptions) (result DeleteOnlineMeetingRecordingContentOperationResponse, err error) {
