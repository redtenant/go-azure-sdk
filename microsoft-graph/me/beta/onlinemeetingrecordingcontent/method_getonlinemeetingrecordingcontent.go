...
// recording. Read-only.
func (c OnlineMeetingRecordingContentClient) GetOnlineMeetingRecordingContent(ctx context.Context, id beta.MeOnlineMeetingIdRecordingId, options GetOnlineMeetingRecordingContentOperationOptions) (result GetOnlineMeetingRecordingContentOperationResponse, err error) {
