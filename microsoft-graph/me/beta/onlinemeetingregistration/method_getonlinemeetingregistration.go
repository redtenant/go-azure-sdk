...
// GetOnlineMeetingRegistration - Get meetingRegistration (deprecated). Get the meetingRegistration details associated
// with an onlineMeeting on behalf of the organizer.
func (c OnlineMeetingRegistrationClient) GetOnlineMeetingRegistration(ctx context.Context, id beta.MeOnlineMeetingId, options GetOnlineMeetingRegistrationOperationOptions) (result GetOnlineMeetingRegistrationOperationResponse, err error) {
