...
func (c OnlineMeetingTranscriptClient) CreateOnlineMeetingTranscript(ctx context.Context, id beta.MeOnlineMeetingId, input beta.CallTranscript, options CreateOnlineMeetingTranscriptOperationOptions) (result CreateOnlineMeetingTranscriptOperationResponse, err error) {
