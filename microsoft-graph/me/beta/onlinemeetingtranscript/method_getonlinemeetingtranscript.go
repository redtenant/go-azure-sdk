...
// GetOnlineMeetingTranscript - Get transcripts from me. The transcripts of an online meeting. Read-only.
func (c OnlineMeetingTranscriptClient) GetOnlineMeetingTranscript(ctx context.Context, id beta.MeOnlineMeetingIdTranscriptId, options GetOnlineMeetingTranscriptOperationOptions) (result GetOnlineMeetingTranscriptOperationResponse, err error) {
