...
// ListOnlineMeetingTranscripts - Get transcripts from me. The transcripts of an online meeting. Read-only.
func (c OnlineMeetingTranscriptClient) ListOnlineMeetingTranscripts(ctx context.Context, id beta.MeOnlineMeetingId, options ListOnlineMeetingTranscriptsOperationOptions) (result ListOnlineMeetingTranscriptsOperationResponse, err error) {
	...
	var values struct {
		Values *[]beta.CallTranscript `json:"value"`
	}
...
func (c OnlineMeetingTranscriptClient) ListOnlineMeetingTranscriptsComplete(ctx context.Context, id beta.MeOnlineMeetingId, options ListOnlineMeetingTranscriptsOperationOptions) (ListOnlineMeetingTranscriptsCompleteResult, error) {
...
func (c OnlineMeetingTranscriptClient) ListOnlineMeetingTranscriptsCompleteMatchingPredicate(ctx context.Context, id beta.MeOnlineMeetingId, options ListOnlineMeetingTranscriptsOperationOptions, predicate CallTranscriptOperationPredicate) (result ListOnlineMeetingTranscriptsCompleteResult, err error) {
	items := make([]beta.CallTranscript, 0)
