...
func (c OnlineMeetingTranscriptClient) UpdateOnlineMeetingTranscript(ctx context.Context, id beta.MeOnlineMeetingIdTranscriptId, input beta.CallTranscript, options UpdateOnlineMeetingTranscriptOperationOptions) (result UpdateOnlineMeetingTranscriptOperationResponse, err error) {
