...
func (c OnlineMeetingTranscriptContentClient) DeleteOnlineMeetingTranscriptContent(ctx context.Context, id beta.MeOnlineMeetingIdTranscriptId, options DeleteOnlineMeetingTranscriptContentOperationOptions) (result DeleteOnlineMeetingTranscriptContentOperationResponse, err error) {
