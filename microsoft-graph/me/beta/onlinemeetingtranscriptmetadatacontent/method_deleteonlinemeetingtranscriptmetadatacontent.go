...
func (c OnlineMeetingTranscriptMetadataContentClient) DeleteOnlineMeetingTranscriptMetadataContent(ctx context.Context, id beta.MeOnlineMeetingIdTranscriptId, options DeleteOnlineMeetingTranscriptMetadataContentOperationOptions) (result DeleteOnlineMeetingTranscriptMetadataContentOperationResponse, err error) {
