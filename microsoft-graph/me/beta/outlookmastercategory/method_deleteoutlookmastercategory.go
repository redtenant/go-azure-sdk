...
func (c OutlookMasterCategoryClient) DeleteOutlookMasterCategory(ctx context.Context, id beta.MeOutlookMasterCategoryId, options DeleteOutlookMasterCategoryOperationOptions) (result DeleteOutlookMasterCategoryOperationResponse, err error) {
