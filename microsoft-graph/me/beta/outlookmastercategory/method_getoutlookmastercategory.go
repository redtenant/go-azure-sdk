...
// GetOutlookMasterCategory - Get Outlook category. Get the properties and relationships of the specified
// outlookCategory object.
func (c OutlookMasterCategoryClient) GetOutlookMasterCategory(ctx context.Context, id beta.MeOutlookMasterCategoryId, options GetOutlookMasterCategoryOperationOptions) (result GetOutlookMasterCategoryOperationResponse, err error) {
