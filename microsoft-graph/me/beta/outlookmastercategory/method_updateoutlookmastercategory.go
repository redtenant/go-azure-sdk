...
func (c OutlookMasterCategoryClient) UpdateOutlookMasterCategory(ctx context.Context, id beta.MeOutlookMasterCategoryId, input beta.OutlookCategory, options UpdateOutlookMasterCategoryOperationOptions) (result UpdateOutlookMasterCategoryOperationResponse, err error) {
