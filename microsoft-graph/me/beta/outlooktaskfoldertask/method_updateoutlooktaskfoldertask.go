...
func DefaultUpdateOutlookTaskFolderTaskOperationOptions() UpdateOutlookTaskFolderTaskOperationOptions {
	return UpdateOutlookTaskFolderTaskOperationOptions{}
}
...
// UpdateOutlookTaskFolderTask - Update the navigation property tasks in me
func (c OutlookTaskFolderTaskClient) UpdateOutlookTaskFolderTask(ctx context.Context, id beta.MeOutlookTaskFolderIdTaskId, input beta.OutlookTask, options UpdateOutlookTaskFolderTaskOperationOptions) (result UpdateOutlookTaskFolderTaskOperationResponse, err error) {
