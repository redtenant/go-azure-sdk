...
// CreateOutlookTaskFolderTaskAttachment - Create new navigation property to attachments for me
func (c OutlookTaskFolderTaskAttachmentClient) CreateOutlookTaskFolderTaskAttachment(ctx context.Context, id beta.MeOutlookTaskFolderIdTaskId, input beta.Attachment, options CreateOutlookTaskFolderTaskAttachmentOperationOptions) (result CreateOutlookTaskFolderTaskAttachmentOperationResponse, err error) {
