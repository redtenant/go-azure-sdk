...
// GetOutlookTaskFolderTaskAttachment - Get attachments from me. The collection of fileAttachment, itemAttachment, and
// referenceAttachment attachments for the task. Read-only. Nullable.
func (c OutlookTaskFolderTaskAttachmentClient) GetOutlookTaskFolderTaskAttachment(ctx context.Context, id beta.MeOutlookTaskFolderIdTaskIdAttachmentId, options GetOutlookTaskFolderTaskAttachmentOperationOptions) (result GetOutlookTaskFolderTaskAttachmentOperationResponse, err error) {
