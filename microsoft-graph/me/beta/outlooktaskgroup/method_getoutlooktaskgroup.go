...
// GetOutlookTaskGroup - Get outlookTaskGroup (deprecated). Get the properties and relationships of the specified
// Outlook task group.
func (c OutlookTaskGroupClient) GetOutlookTaskGroup(ctx context.Context, id beta.MeOutlookTaskGroupId, options GetOutlookTaskGroupOperationOptions) (result GetOutlookTaskGroupOperationResponse, err error) {
