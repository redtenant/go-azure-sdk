...
func (c OutlookTaskGroupClient) GetOutlookTaskGroupsCount(ctx context.Context, options GetOutlookTaskGroupsCountOperationOptions) (result GetOutlookTaskGroupsCountOperationResponse, err error) {
	opts := client.RequestOptions{
		...
		Path:          "/me/outlook/taskGroups/$count",
