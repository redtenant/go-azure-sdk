...
func (c OutlookTaskGroupTaskFolderTaskClient) DeleteOutlookTaskGroupTaskFolderTask(ctx context.Context, id beta.MeOutlookTaskGroupIdTaskFolderIdTaskId, options DeleteOutlookTaskGroupTaskFolderTaskOperationOptions) (result DeleteOutlookTaskGroupTaskFolderTaskOperationResponse, err error) {
