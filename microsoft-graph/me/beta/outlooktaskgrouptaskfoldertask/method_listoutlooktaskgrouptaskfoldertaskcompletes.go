...
func (c OutlookTaskGroupTaskFolderTaskClient) ListOutlookTaskGroupTaskFolderTaskCompletes(ctx context.Context, id beta.MeOutlookTaskGroupIdTaskFolderIdTaskId, options ListOutlookTaskGroupTaskFolderTaskCompletesOperationOptions) (result ListOutlookTaskGroupTaskFolderTaskCompletesOperationResponse, err error) {
...
func (c OutlookTaskGroupTaskFolderTaskClient) ListOutlookTaskGroupTaskFolderTaskCompletesComplete(ctx context.Context, id beta.MeOutlookTaskGroupIdTaskFolderIdTaskId, options ListOutlookTaskGroupTaskFolderTaskCompletesOperationOptions) (ListOutlookTaskGroupTaskFolderTaskCompletesCompleteResult, error) {
...
func (c OutlookTaskGroupTaskFolderTaskClient) ListOutlookTaskGroupTaskFolderTaskCompletesCompleteMatchingPredicate(ctx context.Context, id beta.MeOutlookTaskGroupIdTaskFolderIdTaskId, options ListOutlookTaskGroupTaskFolderTaskCompletesOperationOptions, predicate OutlookTaskOperationPredicate) (result ListOutlookTaskGroupTaskFolderTaskCompletesCompleteResult, err error) {
