...
func (c OutlookTaskGroupTaskFolderTaskClient) ListOutlookTaskGroupTaskFolderTasks(ctx context.Context, id beta.MeOutlookTaskGroupIdTaskFolderId, options ListOutlookTaskGroupTaskFolderTasksOperationOptions) (result ListOutlookTaskGroupTaskFolderTasksOperationResponse, err error) {
...
func (c OutlookTaskGroupTaskFolderTaskClient) ListOutlookTaskGroupTaskFolderTasksComplete(ctx context.Context, id beta.MeOutlookTaskGroupIdTaskFolderId, options ListOutlookTaskGroupTaskFolderTasksOperationOptions) (ListOutlookTaskGroupTaskFolderTasksCompleteResult, error) {
