...
// CreateOutlookTaskGroupTaskFolderTaskAttachment - Create new navigation property to attachments for me
func (c OutlookTaskGroupTaskFolderTaskAttachmentClient) CreateOutlookTaskGroupTaskFolderTaskAttachment(ctx context.Context, id beta.MeOutlookTaskGroupIdTaskFolderIdTaskId, input beta.Attachment, options CreateOutlookTaskGroupTaskFolderTaskAttachmentOperationOptions) (result CreateOutlookTaskGroupTaskFolderTaskAttachmentOperationResponse, err error) {
