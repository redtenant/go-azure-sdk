...
func (c OutlookTaskGroupTaskFolderTaskAttachmentClient) CreateOutlookTaskGroupTaskFolderTaskAttachmentsUploadSession(ctx context.Context, id beta.MeOutlookTaskGroupIdTaskFolderIdTaskId, input CreateOutlookTaskGroupTaskFolderTaskAttachmentsUploadSessionRequest, options CreateOutlookTaskGroupTaskFolderTaskAttachmentsUploadSessionOperationOptions) (result CreateOutlookTaskGroupTaskFolderTaskAttachmentsUploadSessionOperationResponse, err error) {
