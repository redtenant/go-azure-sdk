...
type DeleteOutlookTaskGroupTaskFolderTaskAttachmentOperationResponse struct {
	HttpResponse *http.Response
	OData        *odata.OData
}

type DeleteOutlookTaskGroupTaskFolderTaskAttachmentOperationOptions struct {
	IfMatch   *string
...
func DefaultDeleteOutlookTaskGroupTaskFolderTaskAttachmentOperationOptions() DeleteOutlookTaskGroupTaskFolderTaskAttachmentOperationOptions {
	return DeleteOutlookTaskGroupTaskFolderTaskAttachmentOperationOptions{}
}
...
// DeleteOutlookTaskGroupTaskFolderTaskAttachment - Delete navigation property attachments for me
func (c OutlookTaskGroupTaskFolderTaskAttachmentClient) DeleteOutlookTaskGroupTaskFolderTaskAttachment(ctx context.Context, id beta.MeOutlookTaskGroupIdTaskFolderIdTaskIdAttachmentId, options DeleteOutlookTaskGroupTaskFolderTaskAttachmentOperationOptions) (result DeleteOutlookTaskGroupTaskFolderTaskAttachmentOperationResponse, err error) {
