...
type GetOutlookTaskGroupTaskFolderTaskAttachmentOperationResponse struct {
	HttpResponse *http.Response
	OData        *odata.OData
	Model        beta.Attachment
}

type GetOutlookTaskGroupTaskFolderTaskAttachmentOperationOptions struct {
	Expand    *odata.Expand
...
func DefaultGetOutlookTaskGroupTaskFolderTaskAttachmentOperationOptions() GetOutlookTaskGroupTaskFolderTaskAttachmentOperationOptions {
	return GetOutlookTaskGroupTaskFolderTaskAttachmentOperationOptions{}
}
