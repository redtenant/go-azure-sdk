...
type ListOutlookTaskGroupTaskFolderTaskAttachmentsOperationOptions struct {
	Count     *bool
	Expand    *odata.Expand
	Filter    *string
...
func DefaultListOutlookTaskGroupTaskFolderTaskAttachmentsOperationOptions() ListOutlookTaskGroupTaskFolderTaskAttachmentsOperationOptions {
	return ListOutlookTaskGroupTaskFolderTaskAttachmentsOperationOptions{}
}
...
// ListOutlookTaskGroupTaskFolderTaskAttachments - Get attachments from me. The collection of fileAttachment,
// itemAttachment, and referenceAttachment attachments for the task. Read-only. Nullable.
func (c OutlookTaskGroupTaskFolderTaskAttachmentClient) ListOutlookTaskGroupTaskFolderTaskAttachments(ctx context.Context, id beta.MeOutlookTaskGroupIdTaskFolderIdTaskId, options ListOutlookTaskGroupTaskFolderTaskAttachmentsOperationOptions) (result ListOutlookTaskGroupTaskFolderTaskAttachmentsOperationResponse, err error) {
...
func (c OutlookTaskGroupTaskFolderTaskAttachmentClient) ListOutlookTaskGroupTaskFolderTaskAttachmentsComplete(ctx context.Context, id beta.MeOutlookTaskGroupIdTaskFolderIdTaskId, options ListOutlookTaskGroupTaskFolderTaskAttachmentsOperationOptions) (ListOutlookTaskGroupTaskFolderTaskAttachmentsCompleteResult, error) {
	return c.ListOutlookTaskGroupTaskFolderTaskAttachmentsCompleteMatchingPredicate(ctx, id, options, AttachmentOperationPredicate{})
}
...
func (c OutlookTaskGroupTaskFolderTaskAttachmentClient) ListOutlookTaskGroupTaskFolderTaskAttachmentsCompleteMatchingPredicate(ctx context.Context, id beta.MeOutlookTaskGroupIdTaskFolderIdTaskId, options ListOutlookTaskGroupTaskFolderTaskAttachmentsOperationOptions, predicate AttachmentOperationPredicate) (result ListOutlookTaskGroupTaskFolderTaskAttachmentsCompleteResult, err error) {
	items := make([]beta.Attachment, 0)

	resp, err := c.ListOutlookTaskGroupTaskFolderTaskAttachments(ctx, id, options)
	if err != nil {
