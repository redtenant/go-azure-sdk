...
func (c OwnedDeviceClient) GetOwnedDevice(ctx context.Context, id beta.MeOwnedDeviceId, options GetOwnedDeviceOperationOptions) (result GetOwnedDeviceOperationResponse, err error) {
