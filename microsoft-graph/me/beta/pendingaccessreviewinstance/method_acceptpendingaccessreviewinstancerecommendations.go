...
func (c PendingAccessReviewInstanceClient) AcceptPendingAccessReviewInstanceRecommendations(ctx context.Context, id beta.MePendingAccessReviewInstanceId, options AcceptPendingAccessReviewInstanceRecommendationsOperationOptions) (result AcceptPendingAccessReviewInstanceRecommendationsOperationResponse, err error) {
