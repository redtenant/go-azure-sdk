...
// ListPendingAccessReviewInstanceDecisions - List accessReviewInstanceDecisionItems pending approval (deprecated).
// Retrieve the accessReviewInstanceDecisionItem objects for a specific accessReviewInstance pending approval by the
// calling user. A list of zero or more accessReviewInstanceDecisionItem objects are returned, including all of their
// nested properties.
func (c PendingAccessReviewInstanceDecisionClient) ListPendingAccessReviewInstanceDecisions(ctx context.Context, id beta.MePendingAccessReviewInstanceId, options ListPendingAccessReviewInstanceDecisionsOperationOptions) (result ListPendingAccessReviewInstanceDecisionsOperationResponse, err error) {
...
func (c PendingAccessReviewInstanceDecisionClient) ListPendingAccessReviewInstanceDecisionsComplete(ctx context.Context, id beta.MePendingAccessReviewInstanceId, options ListPendingAccessReviewInstanceDecisionsOperationOptions) (ListPendingAccessReviewInstanceDecisionsCompleteResult, error) {
...
func (c PendingAccessReviewInstanceDecisionClient) ListPendingAccessReviewInstanceDecisionsCompleteMatchingPredicate(ctx context.Context, id beta.MePendingAccessReviewInstanceId, options ListPendingAccessReviewInstanceDecisionsOperationOptions, predicate AccessReviewInstanceDecisionItemOperationPredicate) (result ListPendingAccessReviewInstanceDecisionsCompleteResult, err error) {
