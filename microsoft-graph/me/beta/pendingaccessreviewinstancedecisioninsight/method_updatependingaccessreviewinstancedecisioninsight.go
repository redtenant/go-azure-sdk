...
type UpdatePendingAccessReviewInstanceDecisionInsightOperationResponse struct {
...
// UpdatePendingAccessReviewInstanceDecisionInsight - Update the navigation property insights in me
func (c PendingAccessReviewInstanceDecisionInsightClient) UpdatePendingAccessReviewInstanceDecisionInsight(ctx context.Context, id beta.MePendingAccessReviewInstanceIdDecisionIdInsightId, input beta.GovernanceInsight, options UpdatePendingAccessReviewInstanceDecisionInsightOperationOptions) (result UpdatePendingAccessReviewInstanceDecisionInsightOperationResponse, err error) {
