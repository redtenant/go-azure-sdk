...
func (c PendingAccessReviewInstanceDecisionInstanceClient) AcceptPendingAccessReviewInstanceDecisionInstanceRecommendations(ctx context.Context, id beta.MePendingAccessReviewInstanceIdDecisionId, options AcceptPendingAccessReviewInstanceDecisionInstanceRecommendationsOperationOptions) (result AcceptPendingAccessReviewInstanceDecisionInstanceRecommendationsOperationResponse, err error) {
