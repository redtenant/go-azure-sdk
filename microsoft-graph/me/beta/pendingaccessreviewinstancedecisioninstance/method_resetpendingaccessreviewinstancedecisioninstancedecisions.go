...
func (c PendingAccessReviewInstanceDecisionInstanceClient) ResetPendingAccessReviewInstanceDecisionInstanceDecisions(ctx context.Context, id beta.MePendingAccessReviewInstanceIdDecisionId, options ResetPendingAccessReviewInstanceDecisionInstanceDecisionsOperationOptions) (result ResetPendingAccessReviewInstanceDecisionInstanceDecisionsOperationResponse, err error) {
