...
// ListPendingAccessReviewInstanceDecisionInstanceStages - Get stages from me. If the instance has multiple stages, this
...
func (c PendingAccessReviewInstanceDecisionInstanceStageClient) ListPendingAccessReviewInstanceDecisionInstanceStagesComplete(ctx context.Context, id beta.MePendingAccessReviewInstanceIdDecisionId, options ListPendingAccessReviewInstanceDecisionInstanceStagesOperationOptions) (ListPendingAccessReviewInstanceDecisionInstanceStagesCompleteResult, error) {
