...
// ListPendingAccessReviewInstanceStageDecisionInsights - Get insights from me. Insights are recommendations to
// reviewers on whether to approve or deny a decision. There can be multiple insights associated with an
// accessReviewInstanceDecisionItem.
func (c PendingAccessReviewInstanceStageDecisionInsightClient) ListPendingAccessReviewInstanceStageDecisionInsights(ctx context.Context, id beta.MePendingAccessReviewInstanceIdStageIdDecisionId, options ListPendingAccessReviewInstanceStageDecisionInsightsOperationOptions) (result ListPendingAccessReviewInstanceStageDecisionInsightsOperationResponse, err error) {
...
func (c PendingAccessReviewInstanceStageDecisionInsightClient) ListPendingAccessReviewInstanceStageDecisionInsightsComplete(ctx context.Context, id beta.MePendingAccessReviewInstanceIdStageIdDecisionId, options ListPendingAccessReviewInstanceStageDecisionInsightsOperationOptions) (ListPendingAccessReviewInstanceStageDecisionInsightsCompleteResult, error) {
