...
func (c PendingAccessReviewInstanceStageDecisionInstanceClient) StopPendingAccessReviewInstanceStageDecisionInstance(ctx context.Context, id beta.MePendingAccessReviewInstanceIdStageIdDecisionId, options StopPendingAccessReviewInstanceStageDecisionInstanceOperationOptions) (result StopPendingAccessReviewInstanceStageDecisionInstanceOperationResponse, err error) {
