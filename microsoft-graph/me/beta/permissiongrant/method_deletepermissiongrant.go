...
func (c PermissionGrantClient) DeletePermissionGrant(ctx context.Context, id beta.MePermissionGrantId, options DeletePermissionGrantOperationOptions) (result DeletePermissionGrantOperationResponse, err error) {
