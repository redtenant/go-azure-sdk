...
func (c PermissionGrantClient) GetPermissionGrant(ctx context.Context, id beta.MePermissionGrantId, options GetPermissionGrantOperationOptions) (result GetPermissionGrantOperationResponse, err error) {
