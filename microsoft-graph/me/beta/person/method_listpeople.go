...
// ListPeople - List people. Retrieve a list of person objects ordered by their relevance to the user, which is
// determined by the user's communication and collaboration patterns, and business relationships.
