...
type GetPlannerAllOperationResponse struct {
	HttpResponse *http.Response
	OData        *odata.OData
	Model        beta.PlannerDelta
}

type GetPlannerAllOperationOptions struct {
	Expand    *odata.Expand
...
func DefaultGetPlannerAllOperationOptions() GetPlannerAllOperationOptions {
	return GetPlannerAllOperationOptions{}
}
...
// GetPlannerAll - Get all from me
func (c PlannerAllClient) GetPlannerAll(ctx context.Context, id beta.MePlannerAllId, options GetPlannerAllOperationOptions) (result GetPlannerAllOperationResponse, err error) {
