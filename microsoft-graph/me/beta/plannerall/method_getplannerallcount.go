...
func (c PlannerAllClient) GetPlannerAllCount(ctx context.Context, options GetPlannerAllCountOperationOptions) (result GetPlannerAllCountOperationResponse, err error) {
