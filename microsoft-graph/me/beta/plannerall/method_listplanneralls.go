...
// ListPlannerAlls - Get all from me
func (c PlannerAllClient) ListPlannerAlls(ctx context.Context, options ListPlannerAllsOperationOptions) (result ListPlannerAllsOperationResponse, err error) {
...
func (c PlannerAllClient) ListPlannerAllsComplete(ctx context.Context, options ListPlannerAllsOperationOptions) (ListPlannerAllsCompleteResult, error) {
	return c.ListPlannerAllsCompleteMatchingPredicate(ctx, options, PlannerDeltaOperationPredicate{})
}

// ListPlannerAllsCompleteMatchingPredicate retrieves all the results and then applies the predicate
func (c PlannerAllClient) ListPlannerAllsCompleteMatchingPredicate(ctx context.Context, options ListPlannerAllsOperationOptions, predicate PlannerDeltaOperationPredicate) (result ListPlannerAllsCompleteResult, err error) {
	items := make([]beta.PlannerDelta, 0)

	resp, err := c.ListPlannerAlls(ctx, options)
	if err != nil {
