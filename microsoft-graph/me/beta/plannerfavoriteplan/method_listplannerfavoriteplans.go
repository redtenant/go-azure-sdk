...
// ListPlannerFavoritePlans - List favoritePlans. Retrieve a list of plannerPlans that are marked as favorite by a user.
// You can mark a plan as favorite by updating the plannerUser resource.
func (c PlannerFavoritePlanClient) ListPlannerFavoritePlans(ctx context.Context, options ListPlannerFavoritePlansOperationOptions) (result ListPlannerFavoritePlansOperationResponse, err error) {
...
func (c PlannerFavoritePlanClient) ListPlannerFavoritePlansComplete(ctx context.Context, options ListPlannerFavoritePlansOperationOptions) (ListPlannerFavoritePlansCompleteResult, error) {
	return c.ListPlannerFavoritePlansCompleteMatchingPredicate(ctx, options, PlannerPlanOperationPredicate{})
}
...
func (c PlannerFavoritePlanClient) ListPlannerFavoritePlansCompleteMatchingPredicate(ctx context.Context, options ListPlannerFavoritePlansOperationOptions, predicate PlannerPlanOperationPredicate) (result ListPlannerFavoritePlansCompleteResult, err error) {
	...
	resp, err := c.ListPlannerFavoritePlans(ctx, options)
	if err != nil {
