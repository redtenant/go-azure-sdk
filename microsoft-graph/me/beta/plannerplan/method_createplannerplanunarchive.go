...
func (c PlannerPlanClient) CreatePlannerPlanUnarchive(ctx context.Context, id beta.MePlannerPlanId, input CreatePlannerPlanUnarchiveRequest, options CreatePlannerPlanUnarchiveOperationOptions) (result CreatePlannerPlanUnarchiveOperationResponse, err error) {
