...
func (c PlannerPlanClient) DeletePlannerPlan(ctx context.Context, id beta.MePlannerPlanId, options DeletePlannerPlanOperationOptions) (result DeletePlannerPlanOperationResponse, err error) {
