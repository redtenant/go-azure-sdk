...
func (c PlannerPlanClient) GetPlannerPlan(ctx context.Context, id beta.MePlannerPlanId, options GetPlannerPlanOperationOptions) (result GetPlannerPlanOperationResponse, err error) {
