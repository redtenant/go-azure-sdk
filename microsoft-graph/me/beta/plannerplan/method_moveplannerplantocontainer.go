...
func (c PlannerPlanClient) MovePlannerPlanToContainer(ctx context.Context, id beta.MePlannerPlanId, input MovePlannerPlanToContainerRequest, options MovePlannerPlanToContainerOperationOptions) (result MovePlannerPlanToContainerOperationResponse, err error) {
