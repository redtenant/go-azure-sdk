...
func (c PlannerPlanBucketClient) CreatePlannerPlanBucket(ctx context.Context, id beta.MePlannerPlanId, input beta.PlannerBucket, options CreatePlannerPlanBucketOperationOptions) (result CreatePlannerPlanBucketOperationResponse, err error) {
