...
func (c PlannerPlanBucketTaskAssignedToTaskBoardFormatClient) GetPlannerPlanBucketTaskAssignedToTaskBoardFormat(ctx context.Context, id beta.MePlannerPlanIdBucketIdTaskId, options GetPlannerPlanBucketTaskAssignedToTaskBoardFormatOperationOptions) (result GetPlannerPlanBucketTaskAssignedToTaskBoardFormatOperationResponse, err error) {
