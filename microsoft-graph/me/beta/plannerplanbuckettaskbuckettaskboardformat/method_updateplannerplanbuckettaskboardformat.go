...
// UpdatePlannerPlanBucketTaskBoardFormat - Update the navigation property bucketTaskBoardFormat in me
func (c PlannerPlanBucketTaskBucketTaskBoardFormatClient) UpdatePlannerPlanBucketTaskBoardFormat(ctx context.Context, id beta.MePlannerPlanIdBucketIdTaskId, input beta.PlannerBucketTaskBoardTaskFormat, options UpdatePlannerPlanBucketTaskBoardFormatOperationOptions) (result UpdatePlannerPlanBucketTaskBoardFormatOperationResponse, err error) {
