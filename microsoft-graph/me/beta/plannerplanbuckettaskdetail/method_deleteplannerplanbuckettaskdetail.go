...
func (c PlannerPlanBucketTaskDetailClient) DeletePlannerPlanBucketTaskDetail(ctx context.Context, id beta.MePlannerPlanIdBucketIdTaskId, options DeletePlannerPlanBucketTaskDetailOperationOptions) (result DeletePlannerPlanBucketTaskDetailOperationResponse, err error) {
