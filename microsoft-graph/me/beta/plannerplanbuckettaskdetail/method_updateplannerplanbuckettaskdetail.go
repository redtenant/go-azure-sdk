...
func (c PlannerPlanBucketTaskDetailClient) UpdatePlannerPlanBucketTaskDetail(ctx context.Context, id beta.MePlannerPlanIdBucketIdTaskId, input beta.PlannerTaskDetails, options UpdatePlannerPlanBucketTaskDetailOperationOptions) (result UpdatePlannerPlanBucketTaskDetailOperationResponse, err error) {
