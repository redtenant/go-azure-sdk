...
func (c PlannerPlanBucketTaskProgressTaskBoardFormatClient) GetPlannerPlanBucketTaskProgressTaskBoardFormat(ctx context.Context, id beta.MePlannerPlanIdBucketIdTaskId, options GetPlannerPlanBucketTaskProgressTaskBoardFormatOperationOptions) (result GetPlannerPlanBucketTaskProgressTaskBoardFormatOperationResponse, err error) {
