...
func (c PlannerPlanDetailClient) UpdatePlannerPlanDetail(ctx context.Context, id beta.MePlannerPlanId, input beta.PlannerPlanDetails, options UpdatePlannerPlanDetailOperationOptions) (result UpdatePlannerPlanDetailOperationResponse, err error) {
