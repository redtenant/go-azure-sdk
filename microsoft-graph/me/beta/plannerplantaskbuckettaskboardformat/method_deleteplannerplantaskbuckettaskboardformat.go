...
func (c PlannerPlanTaskBucketTaskBoardFormatClient) DeletePlannerPlanTaskBucketTaskBoardFormat(ctx context.Context, id beta.MePlannerPlanIdTaskId, options DeletePlannerPlanTaskBucketTaskBoardFormatOperationOptions) (result DeletePlannerPlanTaskBucketTaskBoardFormatOperationResponse, err error) {
