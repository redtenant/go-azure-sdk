...
func (c PlannerPlanTaskBucketTaskBoardFormatClient) UpdatePlannerPlanTaskBucketTaskBoardFormat(ctx context.Context, id beta.MePlannerPlanIdTaskId, input beta.PlannerBucketTaskBoardTaskFormat, options UpdatePlannerPlanTaskBucketTaskBoardFormatOperationOptions) (result UpdatePlannerPlanTaskBucketTaskBoardFormatOperationResponse, err error) {
