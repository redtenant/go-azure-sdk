...
func (c PlannerPlanTaskProgressTaskBoardFormatClient) DeletePlannerPlanTaskProgressTaskBoardFormat(ctx context.Context, id beta.MePlannerPlanIdTaskId, options DeletePlannerPlanTaskProgressTaskBoardFormatOperationOptions) (result DeletePlannerPlanTaskProgressTaskBoardFormatOperationResponse, err error) {
