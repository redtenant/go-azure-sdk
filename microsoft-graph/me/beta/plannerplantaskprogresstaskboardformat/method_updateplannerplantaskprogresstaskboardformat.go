...
func (c PlannerPlanTaskProgressTaskBoardFormatClient) UpdatePlannerPlanTaskProgressTaskBoardFormat(ctx context.Context, id beta.MePlannerPlanIdTaskId, input beta.PlannerProgressTaskBoardTaskFormat, options UpdatePlannerPlanTaskProgressTaskBoardFormatOperationOptions) (result UpdatePlannerPlanTaskProgressTaskBoardFormatOperationResponse, err error) {
