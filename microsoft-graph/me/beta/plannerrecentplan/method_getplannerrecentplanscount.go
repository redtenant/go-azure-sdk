...
func (c PlannerRecentPlanClient) GetPlannerRecentPlansCount(ctx context.Context, options GetPlannerRecentPlansCountOperationOptions) (result GetPlannerRecentPlansCountOperationResponse, err error) {
	opts := client.RequestOptions{
		...
		Path:          "/me/planner/recentPlans/$count",
