...
func DefaultListPlannerRecentPlansOperationOptions() ListPlannerRecentPlansOperationOptions {
	return ListPlannerRecentPlansOperationOptions{}
}
...
// ListPlannerRecentPlans - List recentPlans. Retrieve a list of plannerPlans recently viewed by a user. You can update
// recently viewed plans by updating the plannerUser resource.
func (c PlannerRecentPlanClient) ListPlannerRecentPlans(ctx context.Context, options ListPlannerRecentPlansOperationOptions) (result ListPlannerRecentPlansOperationResponse, err error) {
	opts := client.RequestOptions{
		...
		Pager:         &ListPlannerRecentPlansCustomPager{},
...
func (c PlannerRecentPlanClient) ListPlannerRecentPlansComplete(ctx context.Context, options ListPlannerRecentPlansOperationOptions) (ListPlannerRecentPlansCompleteResult, error) {
	return c.ListPlannerRecentPlansCompleteMatchingPredicate(ctx, options, PlannerPlanOperationPredicate{})
}
...
func (c PlannerRecentPlanClient) ListPlannerRecentPlansCompleteMatchingPredicate(ctx context.Context, options ListPlannerRecentPlansOperationOptions, predicate PlannerPlanOperationPredicate) (result ListPlannerRecentPlansCompleteResult, err error) {
	...
	resp, err := c.ListPlannerRecentPlans(ctx, options)
	if err != nil {
	...
	result = ListPlannerRecentPlansCompleteResult{
