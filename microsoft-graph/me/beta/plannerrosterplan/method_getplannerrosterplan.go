...
func DefaultGetPlannerRosterPlanOperationOptions() GetPlannerRosterPlanOperationOptions {
	return GetPlannerRosterPlanOperationOptions{}
}
...
// GetPlannerRosterPlan - Get rosterPlans from me. Read-only. Nullable. Returns the plannerPlans contained by the
// plannerRosters the user is a member.
func (c PlannerRosterPlanClient) GetPlannerRosterPlan(ctx context.Context, id beta.MePlannerRosterPlanId, options GetPlannerRosterPlanOperationOptions) (result GetPlannerRosterPlanOperationResponse, err error) {
