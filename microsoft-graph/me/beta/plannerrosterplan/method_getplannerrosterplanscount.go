...
func DefaultGetPlannerRosterPlansCountOperationOptions() GetPlannerRosterPlansCountOperationOptions {
	return GetPlannerRosterPlansCountOperationOptions{}
}
...
func (c PlannerRosterPlanClient) GetPlannerRosterPlansCount(ctx context.Context, options GetPlannerRosterPlansCountOperationOptions) (result GetPlannerRosterPlansCountOperationResponse, err error) {
	opts := client.RequestOptions{
		...
		Path:          "/me/planner/rosterPlans/$count",
