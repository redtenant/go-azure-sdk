...
func (c PlannerTaskAssignedToTaskBoardFormatClient) DeletePlannerTaskAssignedToTaskBoardFormat(ctx context.Context, id beta.MePlannerTaskId, options DeletePlannerTaskAssignedToTaskBoardFormatOperationOptions) (result DeletePlannerTaskAssignedToTaskBoardFormatOperationResponse, err error) {
