...
func (c PlannerTaskAssignedToTaskBoardFormatClient) UpdatePlannerTaskAssignedToTaskBoardFormat(ctx context.Context, id beta.MePlannerTaskId, input beta.PlannerAssignedToTaskBoardTaskFormat, options UpdatePlannerTaskAssignedToTaskBoardFormatOperationOptions) (result UpdatePlannerTaskAssignedToTaskBoardFormatOperationResponse, err error) {
