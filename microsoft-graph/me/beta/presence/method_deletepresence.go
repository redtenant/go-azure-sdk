...
func DefaultDeletePresenceOperationOptions() DeletePresenceOperationOptions {
	return DeletePresenceOperationOptions{}
}
...
func (c PresenceClient) DeletePresence(ctx context.Context, options DeletePresenceOperationOptions) (result DeletePresenceOperationResponse, err error) {
