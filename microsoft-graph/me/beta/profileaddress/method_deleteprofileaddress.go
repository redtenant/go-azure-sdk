...
func DefaultDeleteProfileAddressOperationOptions() DeleteProfileAddressOperationOptions {
	return DeleteProfileAddressOperationOptions{}
}
...
// DeleteProfileAddress - Delete navigation property addresses for me
func (c ProfileAddressClient) DeleteProfileAddress(ctx context.Context, id beta.MeProfileAddressId, options DeleteProfileAddressOperationOptions) (result DeleteProfileAddressOperationResponse, err error) {
