...
func DefaultGetProfileAddressOperationOptions() GetProfileAddressOperationOptions {
	return GetProfileAddressOperationOptions{}
}
...
// GetProfileAddress - Get itemAddress. Read the properties and relationships of an itemAddress object.
func (c ProfileAddressClient) GetProfileAddress(ctx context.Context, id beta.MeProfileAddressId, options GetProfileAddressOperationOptions) (result GetProfileAddressOperationResponse, err error) {
