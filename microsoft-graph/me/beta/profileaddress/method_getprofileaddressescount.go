...
func DefaultGetProfileAddressesCountOperationOptions() GetProfileAddressesCountOperationOptions {
	return GetProfileAddressesCountOperationOptions{}
}
...
func (c ProfileAddressClient) GetProfileAddressesCount(ctx context.Context, options GetProfileAddressesCountOperationOptions) (result GetProfileAddressesCountOperationResponse, err error) {
	opts := client.RequestOptions{
		...
		Path:          "/me/profile/addresses/$count",
