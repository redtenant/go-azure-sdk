...
// ListProfileAnniversaries - List anniversaries. Retrieve a list of personAnniversary objects for the given user from
// their profile.
func (c ProfileAnniversaryClient) ListProfileAnniversaries(ctx context.Context, options ListProfileAnniversariesOperationOptions) (result ListProfileAnniversariesOperationResponse, err error) {
...
func (c ProfileAnniversaryClient) ListProfileAnniversariesComplete(ctx context.Context, options ListProfileAnniversariesOperationOptions) (ListProfileAnniversariesCompleteResult, error) {
	return c.ListProfileAnniversariesCompleteMatchingPredicate(ctx, options, PersonAnnualEventOperationPredicate{})
}
...
func (c ProfileAnniversaryClient) ListProfileAnniversariesCompleteMatchingPredicate(ctx context.Context, options ListProfileAnniversariesOperationOptions, predicate PersonAnnualEventOperationPredicate) (result ListProfileAnniversariesCompleteResult, err error) {
	...
	resp, err := c.ListProfileAnniversaries(ctx, options)
	if err != nil {
