...
func DefaultDeleteProfileAwardOperationOptions() DeleteProfileAwardOperationOptions {
	return DeleteProfileAwardOperationOptions{}
}
...
// DeleteProfileAward - Delete navigation property awards for me
func (c ProfileAwardClient) DeleteProfileAward(ctx context.Context, id beta.MeProfileAwardId, options DeleteProfileAwardOperationOptions) (result DeleteProfileAwardOperationResponse, err error) {
