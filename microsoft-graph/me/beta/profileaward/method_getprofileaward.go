...
// GetProfileAward - Get personAward. Read the properties and relationships of a personAward object from a user's
// profile.
func (c ProfileAwardClient) GetProfileAward(ctx context.Context, id beta.MeProfileAwardId, options GetProfileAwardOperationOptions) (result GetProfileAwardOperationResponse, err error) {
