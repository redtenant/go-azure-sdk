...
// ListProfileAwards - List awards. Retrieve a list of personAward objects from a user's profile.
func (c ProfileAwardClient) ListProfileAwards(ctx context.Context, options ListProfileAwardsOperationOptions) (result ListProfileAwardsOperationResponse, err error) {
...
func (c ProfileAwardClient) ListProfileAwardsComplete(ctx context.Context, options ListProfileAwardsOperationOptions) (ListProfileAwardsCompleteResult, error) {
	return c.ListProfileAwardsCompleteMatchingPredicate(ctx, options, PersonAwardOperationPredicate{})
}

// ListProfileAwardsCompleteMatchingPredicate retrieves all the results and then applies the predicate
func (c ProfileAwardClient) ListProfileAwardsCompleteMatchingPredicate(ctx context.Context, options ListProfileAwardsOperationOptions, predicate PersonAwardOperationPredicate) (result ListProfileAwardsCompleteResult, err error) {
	items := make([]beta.PersonAward, 0)

	resp, err := c.ListProfileAwards(ctx, options)
	if err != nil {
