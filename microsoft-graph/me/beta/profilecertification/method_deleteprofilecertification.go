...
func DefaultDeleteProfileCertificationOperationOptions() DeleteProfileCertificationOperationOptions {
	return DeleteProfileCertificationOperationOptions{}
}
...
// DeleteProfileCertification - Delete navigation property certifications for me
func (c ProfileCertificationClient) DeleteProfileCertification(ctx context.Context, id beta.MeProfileCertificationId, options DeleteProfileCertificationOperationOptions) (result DeleteProfileCertificationOperationResponse, err error) {
