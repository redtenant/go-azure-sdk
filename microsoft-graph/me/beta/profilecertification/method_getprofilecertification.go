...
func DefaultGetProfileCertificationOperationOptions() GetProfileCertificationOperationOptions {
	return GetProfileCertificationOperationOptions{}
}
...
// GetProfileCertification - Get personCertification. Read the properties and relationships of a personCertification
// object in a user's profile.
func (c ProfileCertificationClient) GetProfileCertification(ctx context.Context, id beta.MeProfileCertificationId, options GetProfileCertificationOperationOptions) (result GetProfileCertificationOperationResponse, err error) {
