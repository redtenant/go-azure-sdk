...
func DefaultListProfileCertificationsOperationOptions() ListProfileCertificationsOperationOptions {
	return ListProfileCertificationsOperationOptions{}
}
...
// ListProfileCertifications - List certifications. Retrieve a list of personCertification objects from a user's
// profile.
func (c ProfileCertificationClient) ListProfileCertifications(ctx context.Context, options ListProfileCertificationsOperationOptions) (result ListProfileCertificationsOperationResponse, err error) {
...
func (c ProfileCertificationClient) ListProfileCertificationsComplete(ctx context.Context, options ListProfileCertificationsOperationOptions) (ListProfileCertificationsCompleteResult, error) {
	return c.ListProfileCertificationsCompleteMatchingPredicate(ctx, options, PersonCertificationOperationPredicate{})
}

// ListProfileCertificationsCompleteMatchingPredicate retrieves all the results and then applies the predicate
func (c ProfileCertificationClient) ListProfileCertificationsCompleteMatchingPredicate(ctx context.Context, options ListProfileCertificationsOperationOptions, predicate PersonCertificationOperationPredicate) (result ListProfileCertificationsCompleteResult, err error) {
	items := make([]beta.PersonCertification, 0)

	resp, err := c.ListProfileCertifications(ctx, options)
	if err != nil {
