...
// GetProfileEducationalActivity - Get educationalActivity. Retrieve the properties and relationships of an
// educationalActivity object from a users profile.
func (c ProfileEducationalActivityClient) GetProfileEducationalActivity(ctx context.Context, id beta.MeProfileEducationalActivityId, options GetProfileEducationalActivityOperationOptions) (result GetProfileEducationalActivityOperationResponse, err error) {
