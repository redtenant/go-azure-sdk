...
// ListProfileEducationalActivities - List educationalActivities. Retrieve a list of educationalActivity objects from a
// user's profile.
func (c ProfileEducationalActivityClient) ListProfileEducationalActivities(ctx context.Context, options ListProfileEducationalActivitiesOperationOptions) (result ListProfileEducationalActivitiesOperationResponse, err error) {
...
func (c ProfileEducationalActivityClient) ListProfileEducationalActivitiesComplete(ctx context.Context, options ListProfileEducationalActivitiesOperationOptions) (ListProfileEducationalActivitiesCompleteResult, error) {
	return c.ListProfileEducationalActivitiesCompleteMatchingPredicate(ctx, options, EducationalActivityOperationPredicate{})
}

// ListProfileEducationalActivitiesCompleteMatchingPredicate retrieves all the results and then applies the predicate
func (c ProfileEducationalActivityClient) ListProfileEducationalActivitiesCompleteMatchingPredicate(ctx context.Context, options ListProfileEducationalActivitiesOperationOptions, predicate EducationalActivityOperationPredicate) (result ListProfileEducationalActivitiesCompleteResult, err error) {
	items := make([]beta.EducationalActivity, 0)

	resp, err := c.ListProfileEducationalActivities(ctx, options)
	if err != nil {
