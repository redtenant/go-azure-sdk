...
func DefaultDeleteProfileEmailOperationOptions() DeleteProfileEmailOperationOptions {
	return DeleteProfileEmailOperationOptions{}
}
...
func (c ProfileEmailClient) DeleteProfileEmail(ctx context.Context, id beta.MeProfileEmailId, options DeleteProfileEmailOperationOptions) (result DeleteProfileEmailOperationResponse, err error) {
