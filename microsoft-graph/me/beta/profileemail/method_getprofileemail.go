...
func (c ProfileEmailClient) GetProfileEmail(ctx context.Context, id beta.MeProfileEmailId, options GetProfileEmailOperationOptions) (result GetProfileEmailOperationResponse, err error) {
