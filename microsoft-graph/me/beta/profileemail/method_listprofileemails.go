...
func DefaultListProfileEmailsOperationOptions() ListProfileEmailsOperationOptions {
	return ListProfileEmailsOperationOptions{}
}
...
func (c ProfileEmailClient) ListProfileEmails(ctx context.Context, options ListProfileEmailsOperationOptions) (result ListProfileEmailsOperationResponse, err error) {
...
func (c ProfileEmailClient) ListProfileEmailsComplete(ctx context.Context, options ListProfileEmailsOperationOptions) (ListProfileEmailsCompleteResult, error) {
	return c.ListProfileEmailsCompleteMatchingPredicate(ctx, options, ItemEmailOperationPredicate{})
}
...
func (c ProfileEmailClient) ListProfileEmailsCompleteMatchingPredicate(ctx context.Context, options ListProfileEmailsOperationOptions, predicate ItemEmailOperationPredicate) (result ListProfileEmailsCompleteResult, err error) {
	...
	resp, err := c.ListProfileEmails(ctx, options)
	if err != nil {
