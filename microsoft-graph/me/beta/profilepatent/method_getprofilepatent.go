...
func DefaultGetProfilePatentOperationOptions() GetProfilePatentOperationOptions {
	return GetProfilePatentOperationOptions{}
}
...
// GetProfilePatent - Get itemPatent. Read the properties and relationships of an itemPatent object.
func (c ProfilePatentClient) GetProfilePatent(ctx context.Context, id beta.MeProfilePatentId, options GetProfilePatentOperationOptions) (result GetProfilePatentOperationResponse, err error) {
