...
func DefaultGetProfilePatentsCountOperationOptions() GetProfilePatentsCountOperationOptions {
	return GetProfilePatentsCountOperationOptions{}
}
...
func (c ProfilePatentClient) GetProfilePatentsCount(ctx context.Context, options GetProfilePatentsCountOperationOptions) (result GetProfilePatentsCountOperationResponse, err error) {
