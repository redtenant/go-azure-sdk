...
// UpdateProfilePatent - Update the navigation property patents in me
func (c ProfilePatentClient) UpdateProfilePatent(ctx context.Context, id beta.MeProfilePatentId, input beta.ItemPatent, options UpdateProfilePatentOperationOptions) (result UpdateProfilePatentOperationResponse, err error) {
