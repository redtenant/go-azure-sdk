...
func DefaultDeleteProfilePhoneOperationOptions() DeleteProfilePhoneOperationOptions {
	return DeleteProfilePhoneOperationOptions{}
}
...
// DeleteProfilePhone - Delete navigation property phones for me
func (c ProfilePhoneClient) DeleteProfilePhone(ctx context.Context, id beta.MeProfilePhoneId, options DeleteProfilePhoneOperationOptions) (result DeleteProfilePhoneOperationResponse, err error) {
