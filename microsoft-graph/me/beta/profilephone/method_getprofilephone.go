...
// GetProfilePhone - Get itemPhoneNumber. Retrieve the properties and relationships of an itemPhone object in a user's
// profile.
func (c ProfilePhoneClient) GetProfilePhone(ctx context.Context, id beta.MeProfilePhoneId, options GetProfilePhoneOperationOptions) (result GetProfilePhoneOperationResponse, err error) {
