...
func DefaultGetProfilePhonesCountOperationOptions() GetProfilePhonesCountOperationOptions {
	return GetProfilePhonesCountOperationOptions{}
}
...
func (c ProfilePhoneClient) GetProfilePhonesCount(ctx context.Context, options GetProfilePhonesCountOperationOptions) (result GetProfilePhonesCountOperationResponse, err error) {
