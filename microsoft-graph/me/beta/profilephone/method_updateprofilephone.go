...
// UpdateProfilePhone - Update the navigation property phones in me
func (c ProfilePhoneClient) UpdateProfilePhone(ctx context.Context, id beta.MeProfilePhoneId, input beta.ItemPhone, options UpdateProfilePhoneOperationOptions) (result UpdateProfilePhoneOperationResponse, err error) {
