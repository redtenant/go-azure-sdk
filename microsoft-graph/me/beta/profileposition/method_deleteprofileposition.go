...
func DefaultDeleteProfilePositionOperationOptions() DeleteProfilePositionOperationOptions {
	return DeleteProfilePositionOperationOptions{}
}
...
func (c ProfilePositionClient) DeleteProfilePosition(ctx context.Context, id beta.MeProfilePositionId, options DeleteProfilePositionOperationOptions) (result DeleteProfilePositionOperationResponse, err error) {
