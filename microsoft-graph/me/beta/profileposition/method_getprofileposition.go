...
// GetProfilePosition - Get workPosition. Retrieve the properties and relationships of a workPosition object in a user's
// profile.
func (c ProfilePositionClient) GetProfilePosition(ctx context.Context, id beta.MeProfilePositionId, options GetProfilePositionOperationOptions) (result GetProfilePositionOperationResponse, err error) {
