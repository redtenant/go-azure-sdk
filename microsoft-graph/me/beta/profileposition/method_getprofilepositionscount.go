...
func (c ProfilePositionClient) GetProfilePositionsCount(ctx context.Context, options GetProfilePositionsCountOperationOptions) (result GetProfilePositionsCountOperationResponse, err error) {
	opts := client.RequestOptions{
		...
		Path:          "/me/profile/positions/$count",
