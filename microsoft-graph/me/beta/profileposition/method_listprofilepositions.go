...
func (c ProfilePositionClient) ListProfilePositions(ctx context.Context, options ListProfilePositionsOperationOptions) (result ListProfilePositionsOperationResponse, err error) {
...
func (c ProfilePositionClient) ListProfilePositionsComplete(ctx context.Context, options ListProfilePositionsOperationOptions) (ListProfilePositionsCompleteResult, error) {
	return c.ListProfilePositionsCompleteMatchingPredicate(ctx, options, WorkPositionOperationPredicate{})
}
...
func (c ProfilePositionClient) ListProfilePositionsCompleteMatchingPredicate(ctx context.Context, options ListProfilePositionsOperationOptions, predicate WorkPositionOperationPredicate) (result ListProfilePositionsCompleteResult, err error) {
	...
	resp, err := c.ListProfilePositions(ctx, options)
	if err != nil {
