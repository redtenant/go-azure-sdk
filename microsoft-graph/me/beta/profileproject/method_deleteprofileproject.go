...
func DefaultDeleteProfileProjectOperationOptions() DeleteProfileProjectOperationOptions {
	return DeleteProfileProjectOperationOptions{}
}
...
func (c ProfileProjectClient) DeleteProfileProject(ctx context.Context, id beta.MeProfileProjectId, options DeleteProfileProjectOperationOptions) (result DeleteProfileProjectOperationResponse, err error) {
