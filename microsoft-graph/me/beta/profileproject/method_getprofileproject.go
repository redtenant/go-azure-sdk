...
func DefaultGetProfileProjectOperationOptions() GetProfileProjectOperationOptions {
	return GetProfileProjectOperationOptions{}
}
...
// GetProfileProject - Get projectParticipation. Retrieve the properties and relationships of a projectParticipation
// object in a user's profile.
func (c ProfileProjectClient) GetProfileProject(ctx context.Context, id beta.MeProfileProjectId, options GetProfileProjectOperationOptions) (result GetProfileProjectOperationResponse, err error) {
