...
func (c ProfileProjectClient) ListProfileProjects(ctx context.Context, options ListProfileProjectsOperationOptions) (result ListProfileProjectsOperationResponse, err error) {
...
func (c ProfileProjectClient) ListProfileProjectsComplete(ctx context.Context, options ListProfileProjectsOperationOptions) (ListProfileProjectsCompleteResult, error) {
	return c.ListProfileProjectsCompleteMatchingPredicate(ctx, options, ProjectParticipationOperationPredicate{})
}
...
func (c ProfileProjectClient) ListProfileProjectsCompleteMatchingPredicate(ctx context.Context, options ListProfileProjectsOperationOptions, predicate ProjectParticipationOperationPredicate) (result ListProfileProjectsCompleteResult, err error) {
	...
	resp, err := c.ListProfileProjects(ctx, options)
	if err != nil {
