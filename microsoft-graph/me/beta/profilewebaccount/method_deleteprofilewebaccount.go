...
// DeleteProfileWebAccount - Delete webAccount. Delete a webAccount object from a user's profile.
func (c ProfileWebAccountClient) DeleteProfileWebAccount(ctx context.Context, id beta.MeProfileWebAccountId, options DeleteProfileWebAccountOperationOptions) (result DeleteProfileWebAccountOperationResponse, err error) {
