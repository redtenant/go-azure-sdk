...
func DefaultGetProfileWebAccountOperationOptions() GetProfileWebAccountOperationOptions {
	return GetProfileWebAccountOperationOptions{}
}
...
// GetProfileWebAccount - Get webAccount. Retrieve the properties and relationships of a webAccount object from a user's
// profile.
func (c ProfileWebAccountClient) GetProfileWebAccount(ctx context.Context, id beta.MeProfileWebAccountId, options GetProfileWebAccountOperationOptions) (result GetProfileWebAccountOperationResponse, err error) {
