...
// ListProfileWebAccounts - List webAccounts. Retrieve a list of webAccounts objects from the user's profile.
func (c ProfileWebAccountClient) ListProfileWebAccounts(ctx context.Context, options ListProfileWebAccountsOperationOptions) (result ListProfileWebAccountsOperationResponse, err error) {
...
func (c ProfileWebAccountClient) ListProfileWebAccountsComplete(ctx context.Context, options ListProfileWebAccountsOperationOptions) (ListProfileWebAccountsCompleteResult, error) {
	return c.ListProfileWebAccountsCompleteMatchingPredicate(ctx, options, WebAccountOperationPredicate{})
}

// ListProfileWebAccountsCompleteMatchingPredicate retrieves all the results and then applies the predicate
func (c ProfileWebAccountClient) ListProfileWebAccountsCompleteMatchingPredicate(ctx context.Context, options ListProfileWebAccountsOperationOptions, predicate WebAccountOperationPredicate) (result ListProfileWebAccountsCompleteResult, err error) {
	items := make([]beta.WebAccount, 0)

	resp, err := c.ListProfileWebAccounts(ctx, options)
	if err != nil {
