...
func (c ProfileWebsiteClient) DeleteProfileWebsite(ctx context.Context, id beta.MeProfileWebsiteId, options DeleteProfileWebsiteOperationOptions) (result DeleteProfileWebsiteOperationResponse, err error) {
