...
// GetProfileWebsite - Get personWebsite. Retrieve the properties and relationships of a personWebsite object from a
// user's profile.
func (c ProfileWebsiteClient) GetProfileWebsite(ctx context.Context, id beta.MeProfileWebsiteId, options GetProfileWebsiteOperationOptions) (result GetProfileWebsiteOperationResponse, err error) {
