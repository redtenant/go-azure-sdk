...
func (c ProfileWebsiteClient) ListProfileWebsites(ctx context.Context, options ListProfileWebsitesOperationOptions) (result ListProfileWebsitesOperationResponse, err error) {
...
func (c ProfileWebsiteClient) ListProfileWebsitesComplete(ctx context.Context, options ListProfileWebsitesOperationOptions) (ListProfileWebsitesCompleteResult, error) {
	return c.ListProfileWebsitesCompleteMatchingPredicate(ctx, options, PersonWebsiteOperationPredicate{})
}
...
func (c ProfileWebsiteClient) ListProfileWebsitesCompleteMatchingPredicate(ctx context.Context, options ListProfileWebsitesOperationOptions, predicate PersonWebsiteOperationPredicate) (result ListProfileWebsitesCompleteResult, err error) {
	...
	resp, err := c.ListProfileWebsites(ctx, options)
	if err != nil {
