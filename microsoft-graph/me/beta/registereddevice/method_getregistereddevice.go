...
// GetRegisteredDevice - Get registeredDevices from me. Devices that are registered for the user. Read-only. Nullable.
// Supports $expand and returns up to 100 objects.
func (c RegisteredDeviceClient) GetRegisteredDevice(ctx context.Context, id beta.MeRegisteredDeviceId, options GetRegisteredDeviceOperationOptions) (result GetRegisteredDeviceOperationResponse, err error) {
