...
func (c ScopedRoleMemberOfClient) CreateScopedRoleMemberOf(ctx context.Context, input beta.ScopedRoleMembership, options CreateScopedRoleMemberOfOperationOptions) (result CreateScopedRoleMemberOfOperationResponse, err error) {
