...
func (c ScopedRoleMemberOfClient) UpdateScopedRoleMemberOf(ctx context.Context, id beta.MeScopedRoleMemberOfId, input beta.ScopedRoleMembership, options UpdateScopedRoleMemberOfOperationOptions) (result UpdateScopedRoleMemberOfOperationResponse, err error) {
