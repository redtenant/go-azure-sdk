...
// GetSecurityInformationProtection - Get informationProtection from me
func (c SecurityInformationProtectionClient) GetSecurityInformationProtection(ctx context.Context, options GetSecurityInformationProtectionOperationOptions) (result GetSecurityInformationProtectionOperationResponse, err error) {
