...
// GetSecurityInformationProtectionLabelPolicySetting - Get labelPolicySettings from me. Read the Microsoft Purview
// Information Protection policy settings for the user or organization.
