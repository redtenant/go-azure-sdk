...
func (c SecurityInformationProtectionSensitivityLabelClient) ListSecurityInformationProtectionSensitivityLabelSecurityEvaluateRemovals(ctx context.Context, input ListSecurityInformationProtectionSensitivityLabelSecurityEvaluateRemovalsRequest, options ListSecurityInformationProtectionSensitivityLabelSecurityEvaluateRemovalsOperationOptions) (result ListSecurityInformationProtectionSensitivityLabelSecurityEvaluateRemovalsOperationResponse, err error) {
	opts := client.RequestOptions{
		...
		Path:          "/me/security/informationProtection/sensitivityLabels/security.evaluateRemoval",
...
func (c SecurityInformationProtectionSensitivityLabelClient) ListSecurityInformationProtectionSensitivityLabelSecurityEvaluateRemovalsComplete(ctx context.Context, input ListSecurityInformationProtectionSensitivityLabelSecurityEvaluateRemovalsRequest, options ListSecurityInformationProtectionSensitivityLabelSecurityEvaluateRemovalsOperationOptions) (ListSecurityInformationProtectionSensitivityLabelSecurityEvaluateRemovalsCompleteResult, error) {
	return c.ListSecurityInformationProtectionSensitivityLabelSecurityEvaluateRemovalsCompleteMatchingPredicate(ctx, input, options, SecurityInformationProtectionActionOperationPredicate{})
}
...
func (c SecurityInformationProtectionSensitivityLabelClient) ListSecurityInformationProtectionSensitivityLabelSecurityEvaluateRemovalsCompleteMatchingPredicate(ctx context.Context, input ListSecurityInformationProtectionSensitivityLabelSecurityEvaluateRemovalsRequest, options ListSecurityInformationProtectionSensitivityLabelSecurityEvaluateRemovalsOperationOptions, predicate SecurityInformationProtectionActionOperationPredicate) (result ListSecurityInformationProtectionSensitivityLabelSecurityEvaluateRemovalsCompleteResult, err error) {
	...
	resp, err := c.ListSecurityInformationProtectionSensitivityLabelSecurityEvaluateRemovals(ctx, input, options)
	if err != nil {
