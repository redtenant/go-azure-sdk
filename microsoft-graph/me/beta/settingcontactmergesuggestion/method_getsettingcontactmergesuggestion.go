...
// GetSettingContactMergeSuggestion - Get contactMergeSuggestions. Read the properties and relationships of a
// contactMergeSuggestions object.
func (c SettingContactMergeSuggestionClient) GetSettingContactMergeSuggestion(ctx context.Context, options GetSettingContactMergeSuggestionOperationOptions) (result GetSettingContactMergeSuggestionOperationResponse, err error) {
