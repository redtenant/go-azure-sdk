...
func (c SettingItemInsightClient) UpdateSettingItemInsight(ctx context.Context, input beta.UserInsightsSettings, options UpdateSettingItemInsightOperationOptions) (result UpdateSettingItemInsightOperationResponse, err error) {
