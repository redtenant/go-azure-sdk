...
// DeleteSettingShiftPreference - Delete navigation property shiftPreferences for me
func (c SettingShiftPreferenceClient) DeleteSettingShiftPreference(ctx context.Context, options DeleteSettingShiftPreferenceOperationOptions) (result DeleteSettingShiftPreferenceOperationResponse, err error) {
