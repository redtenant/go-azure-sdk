...
func (c SettingStorageClient) UpdateSettingStorage(ctx context.Context, input beta.UserStorage, options UpdateSettingStorageOperationOptions) (result UpdateSettingStorageOperationResponse, err error) {
