...
// object.
func (c SettingStorageQuotaClient) GetSettingStorageQuota(ctx context.Context, options GetSettingStorageQuotaOperationOptions) (result GetSettingStorageQuotaOperationResponse, err error) {
