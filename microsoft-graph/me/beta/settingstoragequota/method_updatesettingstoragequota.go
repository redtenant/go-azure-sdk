...
func (c SettingStorageQuotaClient) UpdateSettingStorageQuota(ctx context.Context, input beta.UnifiedStorageQuota, options UpdateSettingStorageQuotaOperationOptions) (result UpdateSettingStorageQuotaOperationResponse, err error) {
