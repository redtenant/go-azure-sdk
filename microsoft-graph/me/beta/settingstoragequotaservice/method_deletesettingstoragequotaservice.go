...
func (c SettingStorageQuotaServiceClient) DeleteSettingStorageQuotaService(ctx context.Context, id beta.MeSettingStorageQuotaServiceId, options DeleteSettingStorageQuotaServiceOperationOptions) (result DeleteSettingStorageQuotaServiceOperationResponse, err error) {
