...
func (c SettingStorageQuotaServiceClient) UpdateSettingStorageQuotaService(ctx context.Context, id beta.MeSettingStorageQuotaServiceId, input beta.ServiceStorageQuotaBreakdown, options UpdateSettingStorageQuotaServiceOperationOptions) (result UpdateSettingStorageQuotaServiceOperationResponse, err error) {
