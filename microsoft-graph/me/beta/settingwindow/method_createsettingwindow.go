...
func (c SettingWindowClient) CreateSettingWindow(ctx context.Context, input beta.WindowsSetting, options CreateSettingWindowOperationOptions) (result CreateSettingWindowOperationResponse, err error) {
