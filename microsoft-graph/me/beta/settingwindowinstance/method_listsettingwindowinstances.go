...
func (c SettingWindowInstanceClient) ListSettingWindowInstancesComplete(ctx context.Context, id beta.MeSettingWindowId, options ListSettingWindowInstancesOperationOptions) (ListSettingWindowInstancesCompleteResult, error) {
...
func (c SettingWindowInstanceClient) ListSettingWindowInstancesCompleteMatchingPredicate(ctx context.Context, id beta.MeSettingWindowId, options ListSettingWindowInstancesOperationOptions, predicate WindowsSettingInstanceOperationPredicate) (result ListSettingWindowInstancesCompleteResult, err error) {
