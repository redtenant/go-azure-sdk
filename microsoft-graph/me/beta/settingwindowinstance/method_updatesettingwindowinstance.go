...
func (c SettingWindowInstanceClient) UpdateSettingWindowInstance(ctx context.Context, id beta.MeSettingWindowIdInstanceId, input beta.WindowsSettingInstance, options UpdateSettingWindowInstanceOperationOptions) (result UpdateSettingWindowInstanceOperationResponse, err error) {
