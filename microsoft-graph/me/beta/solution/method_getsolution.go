...
// GetSolution - Get solutions from me
func (c SolutionClient) GetSolution(ctx context.Context, options GetSolutionOperationOptions) (result GetSolutionOperationResponse, err error) {
