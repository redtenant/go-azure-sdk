...
// UpdateSolutionWorkingTimeSchedule - Update the navigation property workingTimeSchedule in me
func (c SolutionWorkingTimeScheduleClient) UpdateSolutionWorkingTimeSchedule(ctx context.Context, input beta.WorkingTimeSchedule, options UpdateSolutionWorkingTimeScheduleOperationOptions) (result UpdateSolutionWorkingTimeScheduleOperationResponse, err error) {
