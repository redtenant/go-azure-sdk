...
func (c TeamworkClient) UpdateTeamwork(ctx context.Context, input beta.UserTeamwork, options UpdateTeamworkOperationOptions) (result UpdateTeamworkOperationResponse, err error) {
