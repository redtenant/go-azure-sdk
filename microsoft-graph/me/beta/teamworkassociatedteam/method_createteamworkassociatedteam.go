...
func (c TeamworkAssociatedTeamClient) CreateTeamworkAssociatedTeam(ctx context.Context, input beta.AssociatedTeamInfo, options CreateTeamworkAssociatedTeamOperationOptions) (result CreateTeamworkAssociatedTeamOperationResponse, err error) {
