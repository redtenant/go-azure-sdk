...
func (c TeamworkAssociatedTeamClient) UpdateTeamworkAssociatedTeam(ctx context.Context, id beta.MeTeamworkAssociatedTeamId, input beta.AssociatedTeamInfo, options UpdateTeamworkAssociatedTeamOperationOptions) (result UpdateTeamworkAssociatedTeamOperationResponse, err error) {
