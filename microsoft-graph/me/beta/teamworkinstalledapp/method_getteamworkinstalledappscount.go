...
func (c TeamworkInstalledAppClient) GetTeamworkInstalledAppsCount(ctx context.Context, options GetTeamworkInstalledAppsCountOperationOptions) (result GetTeamworkInstalledAppsCountOperationResponse, err error) {
