...
func (c TeamworkInstalledAppClient) UpdateTeamworkInstalledApp(ctx context.Context, id beta.MeTeamworkInstalledAppId, input beta.UserScopeTeamsAppInstallation, options UpdateTeamworkInstalledAppOperationOptions) (result UpdateTeamworkInstalledAppOperationResponse, err error) {
