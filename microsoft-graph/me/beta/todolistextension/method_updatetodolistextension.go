...
func (c TodoListExtensionClient) UpdateTodoListExtension(ctx context.Context, id beta.MeTodoListIdExtensionId, input beta.Extension, options UpdateTodoListExtensionOperationOptions) (result UpdateTodoListExtensionOperationResponse, err error) {
