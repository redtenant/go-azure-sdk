...
func (c TodoListTaskAttachmentClient) CreateTodoListTaskAttachment(ctx context.Context, id beta.MeTodoListIdTaskId, input beta.AttachmentBase, options CreateTodoListTaskAttachmentOperationOptions) (result CreateTodoListTaskAttachmentOperationResponse, err error) {
