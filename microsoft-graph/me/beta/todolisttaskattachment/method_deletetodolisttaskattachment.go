...
// resource.
func (c TodoListTaskAttachmentClient) DeleteTodoListTaskAttachment(ctx context.Context, id beta.MeTodoListIdTaskIdAttachmentId, options DeleteTodoListTaskAttachmentOperationOptions) (result DeleteTodoListTaskAttachmentOperationResponse, err error) {
