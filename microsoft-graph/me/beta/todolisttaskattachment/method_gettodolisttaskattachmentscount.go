...
func (c TodoListTaskAttachmentClient) GetTodoListTaskAttachmentsCount(ctx context.Context, id beta.MeTodoListIdTaskId, options GetTodoListTaskAttachmentsCountOperationOptions) (result GetTodoListTaskAttachmentsCountOperationResponse, err error) {
