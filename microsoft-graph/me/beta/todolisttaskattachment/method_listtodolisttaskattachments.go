...
// contentBytes.
func (c TodoListTaskAttachmentClient) ListTodoListTaskAttachments(ctx context.Context, id beta.MeTodoListIdTaskId, options ListTodoListTaskAttachmentsOperationOptions) (result ListTodoListTaskAttachmentsOperationResponse, err error) {
...
func (c TodoListTaskAttachmentClient) ListTodoListTaskAttachmentsComplete(ctx context.Context, id beta.MeTodoListIdTaskId, options ListTodoListTaskAttachmentsOperationOptions) (ListTodoListTaskAttachmentsCompleteResult, error) {
...
func (c TodoListTaskAttachmentClient) ListTodoListTaskAttachmentsCompleteMatchingPredicate(ctx context.Context, id beta.MeTodoListIdTaskId, options ListTodoListTaskAttachmentsOperationOptions, predicate AttachmentBaseOperationPredicate) (result ListTodoListTaskAttachmentsCompleteResult, err error) {
