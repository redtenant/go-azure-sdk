...
// resource.
func (c TodoListTaskAttachmentClient) RemoveTodoListTaskAttachmentValue(ctx context.Context, id beta.MeTodoListIdTaskIdAttachmentId, options RemoveTodoListTaskAttachmentValueOperationOptions) (result RemoveTodoListTaskAttachmentValueOperationResponse, err error) {
