...
func (c TodoListTaskAttachmentSessionClient) DeleteTodoListTaskAttachmentSession(ctx context.Context, id beta.MeTodoListIdTaskIdAttachmentSessionId, options DeleteTodoListTaskAttachmentSessionOperationOptions) (result DeleteTodoListTaskAttachmentSessionOperationResponse, err error) {
