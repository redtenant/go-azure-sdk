...
func DefaultGetTodoListTaskAttachmentSessionOperationOptions() GetTodoListTaskAttachmentSessionOperationOptions {
	return GetTodoListTaskAttachmentSessionOperationOptions{}
}
...
// GetTodoListTaskAttachmentSession - Get attachmentSessions from me
func (c TodoListTaskAttachmentSessionClient) GetTodoListTaskAttachmentSession(ctx context.Context, id beta.MeTodoListIdTaskIdAttachmentSessionId, options GetTodoListTaskAttachmentSessionOperationOptions) (result GetTodoListTaskAttachmentSessionOperationResponse, err error) {
	...
	var model beta.AttachmentSession
	result.Model = &model
