...
func (c TodoListTaskAttachmentSessionClient) GetTodoListTaskAttachmentSessionsCount(ctx context.Context, id beta.MeTodoListIdTaskId, options GetTodoListTaskAttachmentSessionsCountOperationOptions) (result GetTodoListTaskAttachmentSessionsCountOperationResponse, err error) {
