...
func (c TodoListTaskAttachmentSessionClient) ListTodoListTaskAttachmentSessions(ctx context.Context, id beta.MeTodoListIdTaskId, options ListTodoListTaskAttachmentSessionsOperationOptions) (result ListTodoListTaskAttachmentSessionsOperationResponse, err error) {
...
func (c TodoListTaskAttachmentSessionClient) ListTodoListTaskAttachmentSessionsComplete(ctx context.Context, id beta.MeTodoListIdTaskId, options ListTodoListTaskAttachmentSessionsOperationOptions) (ListTodoListTaskAttachmentSessionsCompleteResult, error) {
...
func (c TodoListTaskAttachmentSessionClient) ListTodoListTaskAttachmentSessionsCompleteMatchingPredicate(ctx context.Context, id beta.MeTodoListIdTaskId, options ListTodoListTaskAttachmentSessionsOperationOptions, predicate AttachmentSessionOperationPredicate) (result ListTodoListTaskAttachmentSessionsCompleteResult, err error) {
