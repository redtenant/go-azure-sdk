...
func (c TodoListTaskAttachmentSessionClient) UpdateTodoListTaskAttachmentSession(ctx context.Context, id beta.MeTodoListIdTaskIdAttachmentSessionId, input beta.AttachmentSession, options UpdateTodoListTaskAttachmentSessionOperationOptions) (result UpdateTodoListTaskAttachmentSessionOperationResponse, err error) {
