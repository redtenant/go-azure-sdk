...
func (c TodoListTaskAttachmentSessionContentClient) GetTodoListTaskAttachmentSessionContent(ctx context.Context, id beta.MeTodoListIdTaskIdAttachmentSessionId, options GetTodoListTaskAttachmentSessionContentOperationOptions) (result GetTodoListTaskAttachmentSessionContentOperationResponse, err error) {
