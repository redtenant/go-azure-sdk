...
func (c TodoListTaskAttachmentSessionContentClient) SetTodoListTaskAttachmentSessionContent(ctx context.Context, id beta.MeTodoListIdTaskIdAttachmentSessionId, input []byte, options SetTodoListTaskAttachmentSessionContentOperationOptions) (result SetTodoListTaskAttachmentSessionContentOperationResponse, err error) {
