...
func (c TodoListTaskChecklistItemClient) DeleteTodoListTaskChecklistItem(ctx context.Context, id beta.MeTodoListIdTaskIdChecklistItemId, options DeleteTodoListTaskChecklistItemOperationOptions) (result DeleteTodoListTaskChecklistItemOperationResponse, err error) {
