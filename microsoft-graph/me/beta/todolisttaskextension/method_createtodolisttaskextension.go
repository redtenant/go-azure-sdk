...
func (c TodoListTaskExtensionClient) CreateTodoListTaskExtension(ctx context.Context, id beta.MeTodoListIdTaskId, input beta.Extension, options CreateTodoListTaskExtensionOperationOptions) (result CreateTodoListTaskExtensionOperationResponse, err error) {
