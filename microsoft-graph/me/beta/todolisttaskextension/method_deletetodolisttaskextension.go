...
func (c TodoListTaskExtensionClient) DeleteTodoListTaskExtension(ctx context.Context, id beta.MeTodoListIdTaskIdExtensionId, options DeleteTodoListTaskExtensionOperationOptions) (result DeleteTodoListTaskExtensionOperationResponse, err error) {
