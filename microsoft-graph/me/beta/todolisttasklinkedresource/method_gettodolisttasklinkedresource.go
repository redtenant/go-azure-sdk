...
func (c TodoListTaskLinkedResourceClient) GetTodoListTaskLinkedResource(ctx context.Context, id beta.MeTodoListIdTaskIdLinkedResourceId, options GetTodoListTaskLinkedResourceOperationOptions) (result GetTodoListTaskLinkedResourceOperationResponse, err error) {
