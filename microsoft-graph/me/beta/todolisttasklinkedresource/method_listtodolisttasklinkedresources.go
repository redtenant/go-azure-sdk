...
// ListTodoListTaskLinkedResources - List linkedResources. Get information of one or more items in a partner
// application, based on which a specified task was created. The information is represented in a linkedResource object
// for each item. It includes an external ID for the item in the partner application, and if applicable, a deep link to
// that item in the application.
func (c TodoListTaskLinkedResourceClient) ListTodoListTaskLinkedResources(ctx context.Context, id beta.MeTodoListIdTaskId, options ListTodoListTaskLinkedResourcesOperationOptions) (result ListTodoListTaskLinkedResourcesOperationResponse, err error) {
	...
	var values struct {
		Values *[]beta.LinkedResource `json:"value"`
	}
...
func (c TodoListTaskLinkedResourceClient) ListTodoListTaskLinkedResourcesComplete(ctx context.Context, id beta.MeTodoListIdTaskId, options ListTodoListTaskLinkedResourcesOperationOptions) (ListTodoListTaskLinkedResourcesCompleteResult, error) {
