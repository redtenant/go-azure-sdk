...
func (c TransitiveMemberOfClient) GetTransitiveMemberOf(ctx context.Context, id beta.MeTransitiveMemberOfId, options GetTransitiveMemberOfOperationOptions) (result GetTransitiveMemberOfOperationResponse, err error) {
