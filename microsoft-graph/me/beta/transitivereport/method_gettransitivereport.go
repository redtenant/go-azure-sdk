...
// GetTransitiveReport - Get transitiveReports from me. The transitive reports for a user. Read-only.
func (c TransitiveReportClient) GetTransitiveReport(ctx context.Context, id beta.MeTransitiveReportId, options GetTransitiveReportOperationOptions) (result GetTransitiveReportOperationResponse, err error) {
