...
// GetAppRoleAssignment - Get appRoleAssignments from me. Represents the app roles a user is granted for an application.
// Supports $expand.
func (c AppRoleAssignmentClient) GetAppRoleAssignment(ctx context.Context, id stable.MeAppRoleAssignmentId, options GetAppRoleAssignmentOperationOptions) (result GetAppRoleAssignmentOperationResponse, err error) {
