...
func (c AppRoleAssignmentClient) GetAppRoleAssignmentsCount(ctx context.Context, options GetAppRoleAssignmentsCountOperationOptions) (result GetAppRoleAssignmentsCountOperationResponse, err error) {
