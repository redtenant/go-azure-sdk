...
// UpdateAppRoleAssignment - Update the navigation property appRoleAssignments in me
func (c AppRoleAssignmentClient) UpdateAppRoleAssignment(ctx context.Context, id stable.MeAppRoleAssignmentId, input stable.AppRoleAssignment, options UpdateAppRoleAssignmentOperationOptions) (result UpdateAppRoleAssignmentOperationResponse, err error) {
