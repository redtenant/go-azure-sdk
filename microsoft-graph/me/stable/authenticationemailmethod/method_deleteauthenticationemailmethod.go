...
func (c AuthenticationEmailMethodClient) DeleteAuthenticationEmailMethod(ctx context.Context, id stable.MeAuthenticationEmailMethodId, options DeleteAuthenticationEmailMethodOperationOptions) (result DeleteAuthenticationEmailMethodOperationResponse, err error) {
