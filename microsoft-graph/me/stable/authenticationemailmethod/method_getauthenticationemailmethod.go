...
// object.
func (c AuthenticationEmailMethodClient) GetAuthenticationEmailMethod(ctx context.Context, id stable.MeAuthenticationEmailMethodId, options GetAuthenticationEmailMethodOperationOptions) (result GetAuthenticationEmailMethodOperationResponse, err error) {
