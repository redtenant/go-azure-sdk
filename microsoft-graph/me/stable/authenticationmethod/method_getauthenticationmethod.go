...
// GetAuthenticationMethod - Get authenticationMethod. Retrieve the properties and relationships of an
// authenticationMethod object.
func (c AuthenticationMethodClient) GetAuthenticationMethod(ctx context.Context, id stable.MeAuthenticationMethodId, options GetAuthenticationMethodOperationOptions) (result GetAuthenticationMethodOperationResponse, err error) {
