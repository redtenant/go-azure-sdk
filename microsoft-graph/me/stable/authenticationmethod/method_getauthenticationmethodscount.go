...
func (c AuthenticationMethodClient) GetAuthenticationMethodsCount(ctx context.Context, options GetAuthenticationMethodsCountOperationOptions) (result GetAuthenticationMethodsCountOperationResponse, err error) {
