...
func (c AuthenticationMethodClient) ResetAuthenticationMethodPassword(ctx context.Context, id stable.MeAuthenticationMethodId, input ResetAuthenticationMethodPasswordRequest, options ResetAuthenticationMethodPasswordOperationOptions) (result ResetAuthenticationMethodPasswordOperationResponse, err error) {
