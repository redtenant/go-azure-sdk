...
func (c AuthenticationMethodClient) UpdateAuthenticationMethod(ctx context.Context, id stable.MeAuthenticationMethodId, input stable.AuthenticationMethod, options UpdateAuthenticationMethodOperationOptions) (result UpdateAuthenticationMethodOperationResponse, err error) {
