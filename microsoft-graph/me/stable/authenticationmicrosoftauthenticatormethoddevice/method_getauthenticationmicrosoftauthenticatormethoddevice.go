...
func (c AuthenticationMicrosoftAuthenticatorMethodDeviceClient) GetAuthenticationMicrosoftAuthenticatorMethodDevice(ctx context.Context, id stable.MeAuthenticationMicrosoftAuthenticatorMethodId, options GetAuthenticationMicrosoftAuthenticatorMethodDeviceOperationOptions) (result GetAuthenticationMicrosoftAuthenticatorMethodDeviceOperationResponse, err error) {
