...
func (c AuthenticationOperationClient) CreateAuthenticationOperation(ctx context.Context, input stable.LongRunningOperation, options CreateAuthenticationOperationOperationOptions) (result CreateAuthenticationOperationOperationResponse, err error) {
