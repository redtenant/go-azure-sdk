...
// DeleteAuthenticationOperation - Delete navigation property operations for me
func (c AuthenticationOperationClient) DeleteAuthenticationOperation(ctx context.Context, id stable.MeAuthenticationOperationId, options DeleteAuthenticationOperationOperationOptions) (result DeleteAuthenticationOperationOperationResponse, err error) {
