...
// GetAuthenticationOperation - Get operations from me. Represents the status of a long-running operation, such as a
// password reset operation.
func (c AuthenticationOperationClient) GetAuthenticationOperation(ctx context.Context, id stable.MeAuthenticationOperationId, options GetAuthenticationOperationOperationOptions) (result GetAuthenticationOperationOperationResponse, err error) {
