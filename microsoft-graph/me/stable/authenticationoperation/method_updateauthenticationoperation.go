...
// UpdateAuthenticationOperation - Update the navigation property operations in me
func (c AuthenticationOperationClient) UpdateAuthenticationOperation(ctx context.Context, id stable.MeAuthenticationOperationId, input stable.LongRunningOperation, options UpdateAuthenticationOperationOperationOptions) (result UpdateAuthenticationOperationOperationResponse, err error) {
