...
// DeleteAuthenticationSoftwareOathMethod - Delete navigation property softwareOathMethods for me
func (c AuthenticationSoftwareOathMethodClient) DeleteAuthenticationSoftwareOathMethod(ctx context.Context, id stable.MeAuthenticationSoftwareOathMethodId, options DeleteAuthenticationSoftwareOathMethodOperationOptions) (result DeleteAuthenticationSoftwareOathMethodOperationResponse, err error) {
