...
func (c AuthenticationSoftwareOathMethodClient) GetAuthenticationSoftwareOathMethod(ctx context.Context, id stable.MeAuthenticationSoftwareOathMethodId, options GetAuthenticationSoftwareOathMethodOperationOptions) (result GetAuthenticationSoftwareOathMethodOperationResponse, err error) {
	...
	var model stable.SoftwareOathAuthenticationMethod
	result.Model = &model
