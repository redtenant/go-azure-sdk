...
func DefaultDeleteAuthenticationTemporaryAccessPassMethodOperationOptions() DeleteAuthenticationTemporaryAccessPassMethodOperationOptions {
	return DeleteAuthenticationTemporaryAccessPassMethodOperationOptions{}
}
...
// DeleteAuthenticationTemporaryAccessPassMethod - Delete navigation property temporaryAccessPassMethods for me
func (c AuthenticationTemporaryAccessPassMethodClient) DeleteAuthenticationTemporaryAccessPassMethod(ctx context.Context, id stable.MeAuthenticationTemporaryAccessPassMethodId, options DeleteAuthenticationTemporaryAccessPassMethodOperationOptions) (result DeleteAuthenticationTemporaryAccessPassMethodOperationResponse, err error) {
