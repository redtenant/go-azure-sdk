...
func (c AuthenticationTemporaryAccessPassMethodClient) GetAuthenticationTemporaryAccessPassMethodsCount(ctx context.Context, options GetAuthenticationTemporaryAccessPassMethodsCountOperationOptions) (result GetAuthenticationTemporaryAccessPassMethodsCountOperationResponse, err error) {
