...
// DeleteAuthenticationWindowsHelloForBusinessMethod - Delete navigation property windowsHelloForBusinessMethods for me
func (c AuthenticationWindowsHelloForBusinessMethodClient) DeleteAuthenticationWindowsHelloForBusinessMethod(ctx context.Context, id stable.MeAuthenticationWindowsHelloForBusinessMethodId, options DeleteAuthenticationWindowsHelloForBusinessMethodOperationOptions) (result DeleteAuthenticationWindowsHelloForBusinessMethodOperationResponse, err error) {
