...
func (c ChatInstalledAppClient) CreateChatInstalledApp(ctx context.Context, id stable.MeChatId, input stable.TeamsAppInstallation, options CreateChatInstalledAppOperationOptions) (result CreateChatInstalledAppOperationResponse, err error) {
