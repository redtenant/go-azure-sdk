...
func (c ChatInstalledAppClient) DeleteChatInstalledApp(ctx context.Context, id stable.MeChatIdInstalledAppId, options DeleteChatInstalledAppOperationOptions) (result DeleteChatInstalledAppOperationResponse, err error) {
