...
func (c ChatInstalledAppClient) GetChatInstalledAppsCount(ctx context.Context, id stable.MeChatId, options GetChatInstalledAppsCountOperationOptions) (result GetChatInstalledAppsCountOperationResponse, err error) {
