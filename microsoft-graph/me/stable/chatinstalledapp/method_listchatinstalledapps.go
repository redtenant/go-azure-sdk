...
// ListChatInstalledApps - Get installedApps from me. A collection of all the apps in the chat. Nullable.
func (c ChatInstalledAppClient) ListChatInstalledApps(ctx context.Context, id stable.MeChatId, options ListChatInstalledAppsOperationOptions) (result ListChatInstalledAppsOperationResponse, err error) {
...
func (c ChatInstalledAppClient) ListChatInstalledAppsComplete(ctx context.Context, id stable.MeChatId, options ListChatInstalledAppsOperationOptions) (ListChatInstalledAppsCompleteResult, error) {
...
func (c ChatInstalledAppClient) ListChatInstalledAppsCompleteMatchingPredicate(ctx context.Context, id stable.MeChatId, options ListChatInstalledAppsOperationOptions, predicate TeamsAppInstallationOperationPredicate) (result ListChatInstalledAppsCompleteResult, err error) {
