...
func (c ChatInstalledAppTeamsAppClient) GetChatInstalledAppTeamsApp(ctx context.Context, id stable.MeChatIdInstalledAppId, options GetChatInstalledAppTeamsAppOperationOptions) (result GetChatInstalledAppTeamsAppOperationResponse, err error) {
