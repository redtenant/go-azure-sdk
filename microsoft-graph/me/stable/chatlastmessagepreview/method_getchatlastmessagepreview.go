...
// messages were sent in the chat. Currently, only the list chats operation supports this property.
func (c ChatLastMessagePreviewClient) GetChatLastMessagePreview(ctx context.Context, id stable.MeChatId, options GetChatLastMessagePreviewOperationOptions) (result GetChatLastMessagePreviewOperationResponse, err error) {
