...
func (c ChatMemberClient) AddChatMembers(ctx context.Context, id stable.MeChatId, input AddChatMembersRequest, options AddChatMembersOperationOptions) (result AddChatMembersOperationResponse, err error) {
...
func (c ChatMemberClient) AddChatMembersComplete(ctx context.Context, id stable.MeChatId, input AddChatMembersRequest, options AddChatMembersOperationOptions) (AddChatMembersCompleteResult, error) {
...
func (c ChatMemberClient) AddChatMembersCompleteMatchingPredicate(ctx context.Context, id stable.MeChatId, input AddChatMembersRequest, options AddChatMembersOperationOptions, predicate ActionResultPartOperationPredicate) (result AddChatMembersCompleteResult, err error) {
