...
func (c ChatMemberClient) CreateChatMember(ctx context.Context, id stable.MeChatId, input stable.ConversationMember, options CreateChatMemberOperationOptions) (result CreateChatMemberOperationResponse, err error) {
