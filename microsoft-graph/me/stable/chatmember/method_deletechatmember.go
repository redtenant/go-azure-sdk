...
func (c ChatMemberClient) DeleteChatMember(ctx context.Context, id stable.MeChatIdMemberId, options DeleteChatMemberOperationOptions) (result DeleteChatMemberOperationResponse, err error) {
