...
func (c ChatMemberClient) GetChatMember(ctx context.Context, id stable.MeChatIdMemberId, options GetChatMemberOperationOptions) (result GetChatMemberOperationResponse, err error) {
