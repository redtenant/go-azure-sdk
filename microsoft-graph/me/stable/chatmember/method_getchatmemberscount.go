...
func (c ChatMemberClient) GetChatMembersCount(ctx context.Context, id stable.MeChatId, options GetChatMembersCountOperationOptions) (result GetChatMembersCountOperationResponse, err error) {
