...
func (c ChatMemberClient) ListChatMembers(ctx context.Context, id stable.MeChatId, options ListChatMembersOperationOptions) (result ListChatMembersOperationResponse, err error) {
...
func (c ChatMemberClient) ListChatMembersComplete(ctx context.Context, id stable.MeChatId, options ListChatMembersOperationOptions) (ListChatMembersCompleteResult, error) {
...
func (c ChatMemberClient) ListChatMembersCompleteMatchingPredicate(ctx context.Context, id stable.MeChatId, options ListChatMembersOperationOptions, predicate ConversationMemberOperationPredicate) (result ListChatMembersCompleteResult, err error) {
