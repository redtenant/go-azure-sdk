...
func (c ChatMemberClient) UpdateChatMember(ctx context.Context, id stable.MeChatIdMemberId, input stable.ConversationMember, options UpdateChatMemberOperationOptions) (result UpdateChatMemberOperationResponse, err error) {
