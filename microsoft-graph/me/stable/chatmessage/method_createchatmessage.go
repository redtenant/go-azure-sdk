...
// CreateChatMessage - Create new navigation property to messages for me
func (c ChatMessageClient) CreateChatMessage(ctx context.Context, id stable.MeChatId, input stable.ChatMessage, options CreateChatMessageOperationOptions) (result CreateChatMessageOperationResponse, err error) {
