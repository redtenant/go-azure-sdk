...
// channel or a chat.
func (c ChatMessageClient) CreateChatMessageSoftDelete(ctx context.Context, id stable.MeChatIdMessageId, options CreateChatMessageSoftDeleteOperationOptions) (result CreateChatMessageSoftDeleteOperationResponse, err error) {
