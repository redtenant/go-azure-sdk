...
// DeleteChatMessage - Delete navigation property messages for me
func (c ChatMessageClient) DeleteChatMessage(ctx context.Context, id stable.MeChatIdMessageId, options DeleteChatMessageOperationOptions) (result DeleteChatMessageOperationResponse, err error) {
