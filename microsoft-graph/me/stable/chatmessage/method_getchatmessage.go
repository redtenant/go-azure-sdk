...
func (c ChatMessageClient) GetChatMessage(ctx context.Context, id stable.MeChatIdMessageId, options GetChatMessageOperationOptions) (result GetChatMessageOperationResponse, err error) {
