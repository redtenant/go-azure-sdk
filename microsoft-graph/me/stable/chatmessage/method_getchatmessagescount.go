...
func (c ChatMessageClient) GetChatMessagesCount(ctx context.Context, id stable.MeChatId, options GetChatMessagesCountOperationOptions) (result GetChatMessagesCountOperationResponse, err error) {
