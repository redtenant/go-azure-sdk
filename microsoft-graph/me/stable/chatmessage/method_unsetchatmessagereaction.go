...
func (c ChatMessageClient) UnsetChatMessageReaction(ctx context.Context, id stable.MeChatIdMessageId, input UnsetChatMessageReactionRequest, options UnsetChatMessageReactionOperationOptions) (result UnsetChatMessageReactionOperationResponse, err error) {
