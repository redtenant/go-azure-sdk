...
func (c ChatMessageHostedContentClient) CreateChatMessageHostedContent(ctx context.Context, id stable.MeChatIdMessageId, input stable.ChatMessageHostedContent, options CreateChatMessageHostedContentOperationOptions) (result CreateChatMessageHostedContentOperationResponse, err error) {
