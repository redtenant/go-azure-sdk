...
func (c ChatMessageHostedContentClient) GetChatMessageHostedContentValue(ctx context.Context, id stable.MeChatIdMessageIdHostedContentId, options GetChatMessageHostedContentValueOperationOptions) (result GetChatMessageHostedContentValueOperationResponse, err error) {
