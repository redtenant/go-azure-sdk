...
func (c ChatMessageHostedContentClient) SetChatMessageHostedContentValue(ctx context.Context, id stable.MeChatIdMessageIdHostedContentId, input []byte, options SetChatMessageHostedContentValueOperationOptions) (result SetChatMessageHostedContentValueOperationResponse, err error) {
