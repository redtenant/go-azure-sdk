...
func (c ChatMessageHostedContentClient) UpdateChatMessageHostedContent(ctx context.Context, id stable.MeChatIdMessageIdHostedContentId, input stable.ChatMessageHostedContent, options UpdateChatMessageHostedContentOperationOptions) (result UpdateChatMessageHostedContentOperationResponse, err error) {
