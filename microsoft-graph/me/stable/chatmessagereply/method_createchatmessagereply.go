...
func (c ChatMessageReplyClient) CreateChatMessageReply(ctx context.Context, id stable.MeChatIdMessageId, input stable.ChatMessage, options CreateChatMessageReplyOperationOptions) (result CreateChatMessageReplyOperationResponse, err error) {
