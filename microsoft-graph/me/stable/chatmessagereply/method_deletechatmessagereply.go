...
func (c ChatMessageReplyClient) DeleteChatMessageReply(ctx context.Context, id stable.MeChatIdMessageIdReplyId, options DeleteChatMessageReplyOperationOptions) (result DeleteChatMessageReplyOperationResponse, err error) {
