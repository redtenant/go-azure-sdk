...
func (c ChatMessageReplyClient) GetChatMessageRepliesCount(ctx context.Context, id stable.MeChatIdMessageId, options GetChatMessageRepliesCountOperationOptions) (result GetChatMessageRepliesCountOperationResponse, err error) {
