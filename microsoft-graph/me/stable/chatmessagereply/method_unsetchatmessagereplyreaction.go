...
func (c ChatMessageReplyClient) UnsetChatMessageReplyReaction(ctx context.Context, id stable.MeChatIdMessageIdReplyId, input UnsetChatMessageReplyReactionRequest, options UnsetChatMessageReplyReactionOperationOptions) (result UnsetChatMessageReplyReactionOperationResponse, err error) {
