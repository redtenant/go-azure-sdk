...
// GetChatMessageReplyHostedContent - Get hostedContents from me. Content in a message hosted by Microsoft Teams - for
// example, images or code snippets.
func (c ChatMessageReplyHostedContentClient) GetChatMessageReplyHostedContent(ctx context.Context, id stable.MeChatIdMessageIdReplyIdHostedContentId, options GetChatMessageReplyHostedContentOperationOptions) (result GetChatMessageReplyHostedContentOperationResponse, err error) {
