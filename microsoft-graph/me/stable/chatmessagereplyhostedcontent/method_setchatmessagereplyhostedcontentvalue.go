...
func (c ChatMessageReplyHostedContentClient) SetChatMessageReplyHostedContentValue(ctx context.Context, id stable.MeChatIdMessageIdReplyIdHostedContentId, input []byte, options SetChatMessageReplyHostedContentValueOperationOptions) (result SetChatMessageReplyHostedContentValueOperationResponse, err error) {
