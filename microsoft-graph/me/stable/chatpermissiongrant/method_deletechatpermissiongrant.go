...
func DefaultDeleteChatPermissionGrantOperationOptions() DeleteChatPermissionGrantOperationOptions {
	return DeleteChatPermissionGrantOperationOptions{}
}
...
// DeleteChatPermissionGrant - Delete navigation property permissionGrants for me
func (c ChatPermissionGrantClient) DeleteChatPermissionGrant(ctx context.Context, id stable.MeChatIdPermissionGrantId, options DeleteChatPermissionGrantOperationOptions) (result DeleteChatPermissionGrantOperationResponse, err error) {
