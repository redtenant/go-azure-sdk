...
func DefaultGetChatPermissionGrantOperationOptions() GetChatPermissionGrantOperationOptions {
	return GetChatPermissionGrantOperationOptions{}
}
...
// GetChatPermissionGrant - Get permissionGrants from me. A collection of permissions granted to apps for the chat.
func (c ChatPermissionGrantClient) GetChatPermissionGrant(ctx context.Context, id stable.MeChatIdPermissionGrantId, options GetChatPermissionGrantOperationOptions) (result GetChatPermissionGrantOperationResponse, err error) {
