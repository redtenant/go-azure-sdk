...
func (c ChatPermissionGrantClient) GetChatPermissionGrantsCount(ctx context.Context, id stable.MeChatId, options GetChatPermissionGrantsCountOperationOptions) (result GetChatPermissionGrantsCountOperationResponse, err error) {
