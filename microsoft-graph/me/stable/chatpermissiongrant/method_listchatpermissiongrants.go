...
// ListChatPermissionGrants - Get permissionGrants from me. A collection of permissions granted to apps for the chat.
func (c ChatPermissionGrantClient) ListChatPermissionGrants(ctx context.Context, id stable.MeChatId, options ListChatPermissionGrantsOperationOptions) (result ListChatPermissionGrantsOperationResponse, err error) {
...
func (c ChatPermissionGrantClient) ListChatPermissionGrantsComplete(ctx context.Context, id stable.MeChatId, options ListChatPermissionGrantsOperationOptions) (ListChatPermissionGrantsCompleteResult, error) {
...
func (c ChatPermissionGrantClient) ListChatPermissionGrantsCompleteMatchingPredicate(ctx context.Context, id stable.MeChatId, options ListChatPermissionGrantsOperationOptions, predicate ResourceSpecificPermissionGrantOperationPredicate) (result ListChatPermissionGrantsCompleteResult, err error) {
