...
func (c ChatPinnedMessageClient) CreateChatPinnedMessage(ctx context.Context, id stable.MeChatId, input stable.PinnedChatMessageInfo, options CreateChatPinnedMessageOperationOptions) (result CreateChatPinnedMessageOperationResponse, err error) {
	...
	var model stable.PinnedChatMessageInfo
	result.Model = &model
