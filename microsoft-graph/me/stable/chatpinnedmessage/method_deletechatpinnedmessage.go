...
func (c ChatPinnedMessageClient) DeleteChatPinnedMessage(ctx context.Context, id stable.MeChatIdPinnedMessageId, options DeleteChatPinnedMessageOperationOptions) (result DeleteChatPinnedMessageOperationResponse, err error) {
