...
func (c ChatPinnedMessageClient) GetChatPinnedMessage(ctx context.Context, id stable.MeChatIdPinnedMessageId, options GetChatPinnedMessageOperationOptions) (result GetChatPinnedMessageOperationResponse, err error) {
