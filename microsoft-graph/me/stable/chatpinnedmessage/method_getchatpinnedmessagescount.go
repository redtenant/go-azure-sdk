...
func (c ChatPinnedMessageClient) GetChatPinnedMessagesCount(ctx context.Context, id stable.MeChatId, options GetChatPinnedMessagesCountOperationOptions) (result GetChatPinnedMessagesCountOperationResponse, err error) {
