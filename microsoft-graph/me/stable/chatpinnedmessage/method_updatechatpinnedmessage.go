...
func (c ChatPinnedMessageClient) UpdateChatPinnedMessage(ctx context.Context, id stable.MeChatIdPinnedMessageId, input stable.PinnedChatMessageInfo, options UpdateChatPinnedMessageOperationOptions) (result UpdateChatPinnedMessageOperationResponse, err error) {
