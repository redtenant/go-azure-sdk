...
func (c ChatTabClient) CreateChatTab(ctx context.Context, id stable.MeChatId, input stable.TeamsTab, options CreateChatTabOperationOptions) (result CreateChatTabOperationResponse, err error) {
