...
func (c ChatTabClient) DeleteChatTab(ctx context.Context, id stable.MeChatIdTabId, options DeleteChatTabOperationOptions) (result DeleteChatTabOperationResponse, err error) {
