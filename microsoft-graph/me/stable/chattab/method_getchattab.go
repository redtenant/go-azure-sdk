...
func (c ChatTabClient) GetChatTab(ctx context.Context, id stable.MeChatIdTabId, options GetChatTabOperationOptions) (result GetChatTabOperationResponse, err error) {
