...
func (c ChatTabClient) GetChatTabsCount(ctx context.Context, id stable.MeChatId, options GetChatTabsCountOperationOptions) (result GetChatTabsCountOperationResponse, err error) {
