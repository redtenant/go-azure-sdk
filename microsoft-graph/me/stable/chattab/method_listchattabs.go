...
func (c ChatTabClient) ListChatTabs(ctx context.Context, id stable.MeChatId, options ListChatTabsOperationOptions) (result ListChatTabsOperationResponse, err error) {
...
func (c ChatTabClient) ListChatTabsComplete(ctx context.Context, id stable.MeChatId, options ListChatTabsOperationOptions) (ListChatTabsCompleteResult, error) {
