...
func (c ChatTabClient) UpdateChatTab(ctx context.Context, id stable.MeChatIdTabId, input stable.TeamsTab, options UpdateChatTabOperationOptions) (result UpdateChatTabOperationResponse, err error) {
