...
type GetCloudClipboardOperationResponse struct {
	...
	OData        *odata.OData
	Model        *stable.CloudClipboardRoot
}
...
// GetCloudClipboard - Get cloudClipboard from me
func (c CloudClipboardClient) GetCloudClipboard(ctx context.Context, options GetCloudClipboardOperationOptions) (result GetCloudClipboardOperationResponse, err error) {
	...
	var model stable.CloudClipboardRoot
	result.Model = &model
