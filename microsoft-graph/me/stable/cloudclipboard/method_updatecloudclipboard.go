...
func (c CloudClipboardClient) UpdateCloudClipboard(ctx context.Context, input stable.CloudClipboardRoot, options UpdateCloudClipboardOperationOptions) (result UpdateCloudClipboardOperationResponse, err error) {
