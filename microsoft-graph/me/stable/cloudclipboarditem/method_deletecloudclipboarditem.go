...
// DeleteCloudClipboardItem - Delete navigation property items for me
func (c CloudClipboardItemClient) DeleteCloudClipboardItem(ctx context.Context, id stable.MeCloudClipboardItemId, options DeleteCloudClipboardItemOperationOptions) (result DeleteCloudClipboardItemOperationResponse, err error) {
