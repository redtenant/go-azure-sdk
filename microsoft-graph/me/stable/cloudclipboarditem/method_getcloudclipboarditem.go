...
// GetCloudClipboardItem - Get items from me. Represents a collection of Cloud Clipboard items.
func (c CloudClipboardItemClient) GetCloudClipboardItem(ctx context.Context, id stable.MeCloudClipboardItemId, options GetCloudClipboardItemOperationOptions) (result GetCloudClipboardItemOperationResponse, err error) {
