...
// UpdateContactExtension - Update the navigation property extensions in me
func (c ContactExtensionClient) UpdateContactExtension(ctx context.Context, id stable.MeContactIdExtensionId, input stable.Extension, options UpdateContactExtensionOperationOptions) (result UpdateContactExtensionOperationResponse, err error) {
