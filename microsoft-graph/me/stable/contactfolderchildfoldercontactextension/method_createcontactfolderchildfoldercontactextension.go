...
// CreateContactFolderChildFolderContactExtension - Create new navigation property to extensions for me
func (c ContactFolderChildFolderContactExtensionClient) CreateContactFolderChildFolderContactExtension(ctx context.Context, id stable.MeContactFolderIdChildFolderIdContactId, input stable.Extension, options CreateContactFolderChildFolderContactExtensionOperationOptions) (result CreateContactFolderChildFolderContactExtensionOperationResponse, err error) {
