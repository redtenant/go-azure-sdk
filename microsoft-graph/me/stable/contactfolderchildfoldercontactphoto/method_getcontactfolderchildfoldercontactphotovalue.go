...
func (c ContactFolderChildFolderContactPhotoClient) GetContactFolderChildFolderContactPhotoValue(ctx context.Context, id stable.MeContactFolderIdChildFolderIdContactId, options GetContactFolderChildFolderContactPhotoValueOperationOptions) (result GetContactFolderChildFolderContactPhotoValueOperationResponse, err error) {
