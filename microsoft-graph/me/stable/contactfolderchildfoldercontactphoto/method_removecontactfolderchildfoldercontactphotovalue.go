...
// RemoveContactFolderChildFolderContactPhotoValue - Delete media content for the navigation property photo in me.
// Optional contact picture. You can get or set a photo for a contact.
func (c ContactFolderChildFolderContactPhotoClient) RemoveContactFolderChildFolderContactPhotoValue(ctx context.Context, id stable.MeContactFolderIdChildFolderIdContactId, options RemoveContactFolderChildFolderContactPhotoValueOperationOptions) (result RemoveContactFolderChildFolderContactPhotoValueOperationResponse, err error) {
