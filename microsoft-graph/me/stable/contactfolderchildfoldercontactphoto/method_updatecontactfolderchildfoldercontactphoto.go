...
func (c ContactFolderChildFolderContactPhotoClient) UpdateContactFolderChildFolderContactPhoto(ctx context.Context, id stable.MeContactFolderIdChildFolderIdContactId, input stable.ProfilePhoto, options UpdateContactFolderChildFolderContactPhotoOperationOptions) (result UpdateContactFolderChildFolderContactPhotoOperationResponse, err error) {
