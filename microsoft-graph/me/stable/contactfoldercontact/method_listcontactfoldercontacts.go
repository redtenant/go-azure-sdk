...
// ListContactFolderContacts - List contacts. Get a contact collection from the default Contacts folder of the signed-in
// user (.../me/contacts), or from the specified contact folder.
func (c ContactFolderContactClient) ListContactFolderContacts(ctx context.Context, id stable.MeContactFolderId, options ListContactFolderContactsOperationOptions) (result ListContactFolderContactsOperationResponse, err error) {
...
func (c ContactFolderContactClient) ListContactFolderContactsComplete(ctx context.Context, id stable.MeContactFolderId, options ListContactFolderContactsOperationOptions) (ListContactFolderContactsCompleteResult, error) {
...
func (c ContactFolderContactClient) ListContactFolderContactsCompleteMatchingPredicate(ctx context.Context, id stable.MeContactFolderId, options ListContactFolderContactsOperationOptions, predicate ContactOperationPredicate) (result ListContactFolderContactsCompleteResult, err error) {
