...
func (c ContactFolderContactClient) UpdateContactFolderContact(ctx context.Context, id stable.MeContactFolderIdContactId, input stable.Contact, options UpdateContactFolderContactOperationOptions) (result UpdateContactFolderContactOperationResponse, err error) {
