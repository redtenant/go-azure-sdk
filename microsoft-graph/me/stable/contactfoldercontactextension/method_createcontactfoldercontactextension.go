...
// CreateContactFolderContactExtension - Create new navigation property to extensions for me
func (c ContactFolderContactExtensionClient) CreateContactFolderContactExtension(ctx context.Context, id stable.MeContactFolderIdContactId, input stable.Extension, options CreateContactFolderContactExtensionOperationOptions) (result CreateContactFolderContactExtensionOperationResponse, err error) {
