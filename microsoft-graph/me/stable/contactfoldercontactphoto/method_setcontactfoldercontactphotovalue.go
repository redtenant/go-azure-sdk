...
func (c ContactFolderContactPhotoClient) SetContactFolderContactPhotoValue(ctx context.Context, id stable.MeContactFolderIdContactId, input []byte, options SetContactFolderContactPhotoValueOperationOptions) (result SetContactFolderContactPhotoValueOperationResponse, err error) {
