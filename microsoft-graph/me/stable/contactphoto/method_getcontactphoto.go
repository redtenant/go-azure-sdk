...
func DefaultGetContactPhotoOperationOptions() GetContactPhotoOperationOptions {
	return GetContactPhotoOperationOptions{}
}
...
// GetContactPhoto - Get photo from me. Optional contact picture. You can get or set a photo for a contact.
func (c ContactPhotoClient) GetContactPhoto(ctx context.Context, id stable.MeContactId, options GetContactPhotoOperationOptions) (result GetContactPhotoOperationResponse, err error) {
