...
// RemoveContactPhotoValue - Delete media content for the navigation property photo in me. Optional contact picture. You
// can get or set a photo for a contact.
func (c ContactPhotoClient) RemoveContactPhotoValue(ctx context.Context, id stable.MeContactId, options RemoveContactPhotoValueOperationOptions) (result RemoveContactPhotoValueOperationResponse, err error) {
