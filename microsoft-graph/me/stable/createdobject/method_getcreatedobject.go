...
func (c CreatedObjectClient) GetCreatedObject(ctx context.Context, id stable.MeCreatedObjectId, options GetCreatedObjectOperationOptions) (result GetCreatedObjectOperationResponse, err error) {
