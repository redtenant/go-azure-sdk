...
// DeleteDeviceManagementTroubleshootingEvent - Delete navigation property deviceManagementTroubleshootingEvents for me
func (c DeviceManagementTroubleshootingEventClient) DeleteDeviceManagementTroubleshootingEvent(ctx context.Context, id stable.MeDeviceManagementTroubleshootingEventId, options DeleteDeviceManagementTroubleshootingEventOperationOptions) (result DeleteDeviceManagementTroubleshootingEventOperationResponse, err error) {
