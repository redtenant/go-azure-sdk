...
// ListDeviceManagementTroubleshootingEvents - Get deviceManagementTroubleshootingEvents from me. The list of
// troubleshooting events for this user.
func (c DeviceManagementTroubleshootingEventClient) ListDeviceManagementTroubleshootingEvents(ctx context.Context, options ListDeviceManagementTroubleshootingEventsOperationOptions) (result ListDeviceManagementTroubleshootingEventsOperationResponse, err error) {
	...
	temp := make([]stable.DeviceManagementTroubleshootingEvent, 0)
	if values.Values != nil {
		for i, v := range *values.Values {
			val, err := stable.UnmarshalDeviceManagementTroubleshootingEventImplementation(v)
			if err != nil {
				err = fmt.Errorf("unmarshalling item %d for stable.DeviceManagementTroubleshootingEvent (%q): %+v", i, v, err)
				return result, err
			}
...
func (c DeviceManagementTroubleshootingEventClient) ListDeviceManagementTroubleshootingEventsComplete(ctx context.Context, options ListDeviceManagementTroubleshootingEventsOperationOptions) (ListDeviceManagementTroubleshootingEventsCompleteResult, error) {
	return c.ListDeviceManagementTroubleshootingEventsCompleteMatchingPredicate(ctx, options, DeviceManagementTroubleshootingEventOperationPredicate{})
}
...
func (c DeviceManagementTroubleshootingEventClient) ListDeviceManagementTroubleshootingEventsCompleteMatchingPredicate(ctx context.Context, options ListDeviceManagementTroubleshootingEventsOperationOptions, predicate DeviceManagementTroubleshootingEventOperationPredicate) (result ListDeviceManagementTroubleshootingEventsCompleteResult, err error) {
	items := make([]stable.DeviceManagementTroubleshootingEvent, 0)

	resp, err := c.ListDeviceManagementTroubleshootingEvents(ctx, options)
	if err != nil {
