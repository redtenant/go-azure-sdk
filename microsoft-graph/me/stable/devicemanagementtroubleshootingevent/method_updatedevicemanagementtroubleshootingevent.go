...
// me
func (c DeviceManagementTroubleshootingEventClient) UpdateDeviceManagementTroubleshootingEvent(ctx context.Context, id stable.MeDeviceManagementTroubleshootingEventId, input stable.DeviceManagementTroubleshootingEvent, options UpdateDeviceManagementTroubleshootingEventOperationOptions) (result UpdateDeviceManagementTroubleshootingEventOperationResponse, err error) {
