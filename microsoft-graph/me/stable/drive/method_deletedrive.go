...
func (c DriveClient) DeleteDrive(ctx context.Context, id stable.MeDriveId, options DeleteDriveOperationOptions) (result DeleteDriveOperationResponse, err error) {
