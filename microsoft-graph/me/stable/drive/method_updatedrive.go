...
func (c DriveClient) UpdateDrive(ctx context.Context, id stable.MeDriveId, input stable.Drive, options UpdateDriveOperationOptions) (result UpdateDriveOperationResponse, err error) {
