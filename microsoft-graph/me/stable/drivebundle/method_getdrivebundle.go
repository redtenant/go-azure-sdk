...
// GetDriveBundle - Get bundles from me. Collection of bundles (albums and multi-select-shared sets of items). Only in
// personal OneDrive.
func (c DriveBundleClient) GetDriveBundle(ctx context.Context, id stable.MeDriveIdBundleId, options GetDriveBundleOperationOptions) (result GetDriveBundleOperationResponse, err error) {
