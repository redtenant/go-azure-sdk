...
func (c DriveBundleClient) GetDriveBundlesCount(ctx context.Context, id stable.MeDriveId, options GetDriveBundlesCountOperationOptions) (result GetDriveBundlesCountOperationResponse, err error) {
