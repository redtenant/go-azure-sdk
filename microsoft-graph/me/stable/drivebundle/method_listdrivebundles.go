...
// ListDriveBundles - Get bundles from me. Collection of bundles (albums and multi-select-shared sets of items). Only in
// personal OneDrive.
func (c DriveBundleClient) ListDriveBundles(ctx context.Context, id stable.MeDriveId, options ListDriveBundlesOperationOptions) (result ListDriveBundlesOperationResponse, err error) {
...
func (c DriveBundleClient) ListDriveBundlesComplete(ctx context.Context, id stable.MeDriveId, options ListDriveBundlesOperationOptions) (ListDriveBundlesCompleteResult, error) {
...
func (c DriveBundleClient) ListDriveBundlesCompleteMatchingPredicate(ctx context.Context, id stable.MeDriveId, options ListDriveBundlesOperationOptions, predicate DriveItemOperationPredicate) (result ListDriveBundlesCompleteResult, err error) {
