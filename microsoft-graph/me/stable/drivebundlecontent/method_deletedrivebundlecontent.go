...
// DeleteDriveBundleContent - Delete content for the navigation property bundles in me. The content stream, if the item
// represents a file.
func (c DriveBundleContentClient) DeleteDriveBundleContent(ctx context.Context, id stable.MeDriveIdBundleId, options DeleteDriveBundleContentOperationOptions) (result DeleteDriveBundleContentOperationResponse, err error) {
