...
// GetDriveBundleContent - Get content for the navigation property bundles from me. The content stream, if the item
// represents a file.
func (c DriveBundleContentClient) GetDriveBundleContent(ctx context.Context, id stable.MeDriveIdBundleId, options GetDriveBundleContentOperationOptions) (result GetDriveBundleContentOperationResponse, err error) {
