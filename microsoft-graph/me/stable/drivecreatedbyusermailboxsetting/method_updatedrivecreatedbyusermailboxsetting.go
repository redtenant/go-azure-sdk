...
func (c DriveCreatedByUserMailboxSettingClient) UpdateDriveCreatedByUserMailboxSetting(ctx context.Context, id stable.MeDriveId, input stable.MailboxSettings, options UpdateDriveCreatedByUserMailboxSettingOperationOptions) (result UpdateDriveCreatedByUserMailboxSettingOperationResponse, err error) {
