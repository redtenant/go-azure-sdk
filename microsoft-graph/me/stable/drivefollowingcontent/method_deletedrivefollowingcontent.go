...
// DeleteDriveFollowingContent - Delete content for the navigation property following in me. The content stream, if the
// item represents a file.
func (c DriveFollowingContentClient) DeleteDriveFollowingContent(ctx context.Context, id stable.MeDriveIdFollowingId, options DeleteDriveFollowingContentOperationOptions) (result DeleteDriveFollowingContentOperationResponse, err error) {
