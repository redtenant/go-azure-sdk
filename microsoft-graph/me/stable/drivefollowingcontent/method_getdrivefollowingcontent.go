...
// GetDriveFollowingContent - Get content for the navigation property following from me. The content stream, if the item
// represents a file.
func (c DriveFollowingContentClient) GetDriveFollowingContent(ctx context.Context, id stable.MeDriveIdFollowingId, options GetDriveFollowingContentOperationOptions) (result GetDriveFollowingContentOperationResponse, err error) {
