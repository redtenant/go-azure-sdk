...
// SetDriveFollowingContent - Update content for the navigation property following in me. The content stream, if the
// item represents a file.
func (c DriveFollowingContentClient) SetDriveFollowingContent(ctx context.Context, id stable.MeDriveIdFollowingId, input []byte, options SetDriveFollowingContentOperationOptions) (result SetDriveFollowingContentOperationResponse, err error) {
