...
func (c DriveItemClient) CheckinDriveItem(ctx context.Context, id stable.MeDriveIdItemId, input CheckinDriveItemRequest, options CheckinDriveItemOperationOptions) (result CheckinDriveItemOperationResponse, err error) {
