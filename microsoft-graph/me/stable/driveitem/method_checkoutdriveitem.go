...
func (c DriveItemClient) CheckoutDriveItem(ctx context.Context, id stable.MeDriveIdItemId, options CheckoutDriveItemOperationOptions) (result CheckoutDriveItemOperationResponse, err error) {
