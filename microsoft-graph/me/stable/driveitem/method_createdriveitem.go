...
func (c DriveItemClient) CreateDriveItem(ctx context.Context, id stable.MeDriveId, input stable.DriveItem, options CreateDriveItemOperationOptions) (result CreateDriveItemOperationResponse, err error) {
