...
func (c DriveItemClient) CreateDriveItemLink(ctx context.Context, id stable.MeDriveIdItemId, input CreateDriveItemLinkRequest, options CreateDriveItemLinkOperationOptions) (result CreateDriveItemLinkOperationResponse, err error) {
