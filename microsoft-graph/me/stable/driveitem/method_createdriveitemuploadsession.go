...
func (c DriveItemClient) CreateDriveItemUploadSession(ctx context.Context, id stable.MeDriveIdItemId, input CreateDriveItemUploadSessionRequest, options CreateDriveItemUploadSessionOperationOptions) (result CreateDriveItemUploadSessionOperationResponse, err error) {
