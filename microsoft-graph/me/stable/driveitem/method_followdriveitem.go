...
func (c DriveItemClient) FollowDriveItem(ctx context.Context, id stable.MeDriveIdItemId, options FollowDriveItemOperationOptions) (result FollowDriveItemOperationResponse, err error) {
