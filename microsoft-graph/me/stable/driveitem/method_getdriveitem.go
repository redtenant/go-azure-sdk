...
func DefaultGetDriveItemOperationOptions() GetDriveItemOperationOptions {
	return GetDriveItemOperationOptions{}
}
...
// GetDriveItem - Get items from me. All items contained in the drive. Read-only. Nullable.
func (c DriveItemClient) GetDriveItem(ctx context.Context, id stable.MeDriveIdItemId, options GetDriveItemOperationOptions) (result GetDriveItemOperationResponse, err error) {
