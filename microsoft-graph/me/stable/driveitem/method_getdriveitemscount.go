...
func (c DriveItemClient) GetDriveItemsCount(ctx context.Context, id stable.MeDriveId, options GetDriveItemsCountOperationOptions) (result GetDriveItemsCountOperationResponse, err error) {
