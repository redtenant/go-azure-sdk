...
func (c DriveItemClient) RestoreDriveItem(ctx context.Context, id stable.MeDriveIdItemId, input RestoreDriveItemRequest, options RestoreDriveItemOperationOptions) (result RestoreDriveItemOperationResponse, err error) {
