...
func DefaultUpdateDriveItemOperationOptions() UpdateDriveItemOperationOptions {
	return UpdateDriveItemOperationOptions{}
}
...
// UpdateDriveItem - Update the navigation property items in me
func (c DriveItemClient) UpdateDriveItem(ctx context.Context, id stable.MeDriveIdItemId, input stable.DriveItem, options UpdateDriveItemOperationOptions) (result UpdateDriveItemOperationResponse, err error) {
