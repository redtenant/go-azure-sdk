...
func (c DriveItemClient) ValidateDriveItemPermission(ctx context.Context, id stable.MeDriveIdItemId, input ValidateDriveItemPermissionRequest, options ValidateDriveItemPermissionOperationOptions) (result ValidateDriveItemPermissionOperationResponse, err error) {
