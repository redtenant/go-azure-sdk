...
// UpdateDriveItemAnalytic - Update the navigation property analytics in me
func (c DriveItemAnalyticsClient) UpdateDriveItemAnalytic(ctx context.Context, id stable.MeDriveIdItemId, input stable.ItemAnalytics, options UpdateDriveItemAnalyticOperationOptions) (result UpdateDriveItemAnalyticOperationResponse, err error) {
