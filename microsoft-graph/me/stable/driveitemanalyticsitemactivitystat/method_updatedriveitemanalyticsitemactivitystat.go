...
// UpdateDriveItemAnalyticsItemActivityStat - Update the navigation property itemActivityStats in me
func (c DriveItemAnalyticsItemActivityStatClient) UpdateDriveItemAnalyticsItemActivityStat(ctx context.Context, id stable.MeDriveIdItemIdAnalyticsItemActivityStatId, input stable.ItemActivityStat, options UpdateDriveItemAnalyticsItemActivityStatOperationOptions) (result UpdateDriveItemAnalyticsItemActivityStatOperationResponse, err error) {
