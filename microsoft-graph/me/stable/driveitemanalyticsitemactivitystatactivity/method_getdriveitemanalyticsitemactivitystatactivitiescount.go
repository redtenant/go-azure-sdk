...
func (c DriveItemAnalyticsItemActivityStatActivityClient) GetDriveItemAnalyticsItemActivityStatActivitiesCount(ctx context.Context, id stable.MeDriveIdItemIdAnalyticsItemActivityStatId, options GetDriveItemAnalyticsItemActivityStatActivitiesCountOperationOptions) (result GetDriveItemAnalyticsItemActivityStatActivitiesCountOperationResponse, err error) {
