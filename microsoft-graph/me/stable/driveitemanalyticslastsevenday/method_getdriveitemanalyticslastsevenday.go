...
func (c DriveItemAnalyticsLastSevenDayClient) GetDriveItemAnalyticsLastSevenDay(ctx context.Context, id stable.MeDriveIdItemId, options GetDriveItemAnalyticsLastSevenDayOperationOptions) (result GetDriveItemAnalyticsLastSevenDayOperationResponse, err error) {
