...
// GetDriveItemChild - Get children from me. Collection containing Item objects for the immediate children of Item. Only
// items representing folders have children. Read-only. Nullable.
func (c DriveItemChildClient) GetDriveItemChild(ctx context.Context, id stable.MeDriveIdItemIdChildId, options GetDriveItemChildOperationOptions) (result GetDriveItemChildOperationResponse, err error) {
