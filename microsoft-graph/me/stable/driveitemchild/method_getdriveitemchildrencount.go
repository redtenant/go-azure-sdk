...
func (c DriveItemChildClient) GetDriveItemChildrenCount(ctx context.Context, id stable.MeDriveIdItemId, options GetDriveItemChildrenCountOperationOptions) (result GetDriveItemChildrenCountOperationResponse, err error) {
