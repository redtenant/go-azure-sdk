...
// GetDriveItemContent - Get content for the navigation property items from me. The content stream, if the item
// represents a file.
func (c DriveItemContentClient) GetDriveItemContent(ctx context.Context, id stable.MeDriveIdItemId, options GetDriveItemContentOperationOptions) (result GetDriveItemContentOperationResponse, err error) {
