...
// represents a file.
func (c DriveItemContentClient) SetDriveItemContent(ctx context.Context, id stable.MeDriveIdItemId, input []byte, options SetDriveItemContentOperationOptions) (result SetDriveItemContentOperationResponse, err error) {
