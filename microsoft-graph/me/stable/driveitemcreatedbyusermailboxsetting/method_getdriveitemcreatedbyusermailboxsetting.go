...
func (c DriveItemCreatedByUserMailboxSettingClient) GetDriveItemCreatedByUserMailboxSetting(ctx context.Context, id stable.MeDriveIdItemId, options GetDriveItemCreatedByUserMailboxSettingOperationOptions) (result GetDriveItemCreatedByUserMailboxSettingOperationResponse, err error) {
