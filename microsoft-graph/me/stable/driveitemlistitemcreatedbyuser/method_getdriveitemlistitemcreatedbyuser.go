...
// GetDriveItemListItemCreatedByUser - Get createdByUser from me. Identity of the user who created the item. Read-only.
func (c DriveItemListItemCreatedByUserClient) GetDriveItemListItemCreatedByUser(ctx context.Context, id stable.MeDriveIdItemId, options GetDriveItemListItemCreatedByUserOperationOptions) (result GetDriveItemListItemCreatedByUserOperationResponse, err error) {
