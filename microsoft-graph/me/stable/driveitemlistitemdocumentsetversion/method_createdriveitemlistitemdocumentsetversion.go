...
func (c DriveItemListItemDocumentSetVersionClient) CreateDriveItemListItemDocumentSetVersion(ctx context.Context, id stable.MeDriveIdItemId, input stable.DocumentSetVersion, options CreateDriveItemListItemDocumentSetVersionOperationOptions) (result CreateDriveItemListItemDocumentSetVersionOperationResponse, err error) {
