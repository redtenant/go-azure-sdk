...
func (c DriveItemListItemDocumentSetVersionClient) GetDriveItemListItemDocumentSetVersionsCount(ctx context.Context, id stable.MeDriveIdItemId, options GetDriveItemListItemDocumentSetVersionsCountOperationOptions) (result GetDriveItemListItemDocumentSetVersionsCountOperationResponse, err error) {
