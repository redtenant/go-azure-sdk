...
// UpdateDriveItemListItemDocumentSetVersion - Update the navigation property documentSetVersions in me
func (c DriveItemListItemDocumentSetVersionClient) UpdateDriveItemListItemDocumentSetVersion(ctx context.Context, id stable.MeDriveIdItemIdListItemDocumentSetVersionId, input stable.DocumentSetVersion, options UpdateDriveItemListItemDocumentSetVersionOperationOptions) (result UpdateDriveItemListItemDocumentSetVersionOperationResponse, err error) {
