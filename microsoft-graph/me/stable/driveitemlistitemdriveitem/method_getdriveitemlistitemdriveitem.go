...
// GetDriveItemListItemDriveItem - Get driveItem from me. For document libraries, the driveItem relationship exposes the
// listItem as a driveItem
func (c DriveItemListItemDriveItemClient) GetDriveItemListItemDriveItem(ctx context.Context, id stable.MeDriveIdItemId, options GetDriveItemListItemDriveItemOperationOptions) (result GetDriveItemListItemDriveItemOperationResponse, err error) {
