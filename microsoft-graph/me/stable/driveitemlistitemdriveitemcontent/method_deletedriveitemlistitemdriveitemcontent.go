...
// DeleteDriveItemListItemDriveItemContent - Delete content for the navigation property driveItem in me. The content
// stream, if the item represents a file.
func (c DriveItemListItemDriveItemContentClient) DeleteDriveItemListItemDriveItemContent(ctx context.Context, id stable.MeDriveIdItemId, options DeleteDriveItemListItemDriveItemContentOperationOptions) (result DeleteDriveItemListItemDriveItemContentOperationResponse, err error) {
