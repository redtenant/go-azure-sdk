...
// GetDriveItemListItemField - Get fields from me. The values of the columns set on this list item.
func (c DriveItemListItemFieldClient) GetDriveItemListItemField(ctx context.Context, id stable.MeDriveIdItemId, options GetDriveItemListItemFieldOperationOptions) (result GetDriveItemListItemFieldOperationResponse, err error) {
