...
// UpdateDriveItemListItemField - Update the navigation property fields in me
func (c DriveItemListItemFieldClient) UpdateDriveItemListItemField(ctx context.Context, id stable.MeDriveIdItemId, input stable.FieldValueSet, options UpdateDriveItemListItemFieldOperationOptions) (result UpdateDriveItemListItemFieldOperationResponse, err error) {
