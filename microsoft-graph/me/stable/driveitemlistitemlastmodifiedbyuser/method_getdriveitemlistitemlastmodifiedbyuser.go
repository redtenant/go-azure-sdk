...
// GetDriveItemListItemLastModifiedByUser - Get lastModifiedByUser from me. Identity of the user who last modified the
// item. Read-only.
func (c DriveItemListItemLastModifiedByUserClient) GetDriveItemListItemLastModifiedByUser(ctx context.Context, id stable.MeDriveIdItemId, options GetDriveItemListItemLastModifiedByUserOperationOptions) (result GetDriveItemListItemLastModifiedByUserOperationResponse, err error) {
