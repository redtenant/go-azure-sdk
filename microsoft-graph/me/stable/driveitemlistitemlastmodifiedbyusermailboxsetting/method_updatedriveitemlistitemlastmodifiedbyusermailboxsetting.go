...
func (c DriveItemListItemLastModifiedByUserMailboxSettingClient) UpdateDriveItemListItemLastModifiedByUserMailboxSetting(ctx context.Context, id stable.MeDriveIdItemId, input stable.MailboxSettings, options UpdateDriveItemListItemLastModifiedByUserMailboxSettingOperationOptions) (result UpdateDriveItemListItemLastModifiedByUserMailboxSettingOperationResponse, err error) {
