...
func (c DriveItemListItemLastModifiedByUserServiceProvisioningErrorClient) ListDriveItemListItemLastModifiedByUserServiceProvisioningErrors(ctx context.Context, id stable.MeDriveIdItemId, options ListDriveItemListItemLastModifiedByUserServiceProvisioningErrorsOperationOptions) (result ListDriveItemListItemLastModifiedByUserServiceProvisioningErrorsOperationResponse, err error) {
...
func (c DriveItemListItemLastModifiedByUserServiceProvisioningErrorClient) ListDriveItemListItemLastModifiedByUserServiceProvisioningErrorsComplete(ctx context.Context, id stable.MeDriveIdItemId, options ListDriveItemListItemLastModifiedByUserServiceProvisioningErrorsOperationOptions) (ListDriveItemListItemLastModifiedByUserServiceProvisioningErrorsCompleteResult, error) {
