...
// DeleteDriveItemListItemVersionField - Delete navigation property fields for me
func (c DriveItemListItemVersionFieldClient) DeleteDriveItemListItemVersionField(ctx context.Context, id stable.MeDriveIdItemIdListItemVersionId, options DeleteDriveItemListItemVersionFieldOperationOptions) (result DeleteDriveItemListItemVersionFieldOperationResponse, err error) {
