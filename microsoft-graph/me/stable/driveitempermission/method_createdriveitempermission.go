...
// CreateDriveItemPermission - Create new navigation property to permissions for me
func (c DriveItemPermissionClient) CreateDriveItemPermission(ctx context.Context, id stable.MeDriveIdItemId, input stable.Permission, options CreateDriveItemPermissionOperationOptions) (result CreateDriveItemPermissionOperationResponse, err error) {
