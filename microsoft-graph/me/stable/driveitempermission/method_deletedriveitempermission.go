...
// DeleteDriveItemPermission - Delete navigation property permissions for me
func (c DriveItemPermissionClient) DeleteDriveItemPermission(ctx context.Context, id stable.MeDriveIdItemIdPermissionId, options DeleteDriveItemPermissionOperationOptions) (result DeleteDriveItemPermissionOperationResponse, err error) {
