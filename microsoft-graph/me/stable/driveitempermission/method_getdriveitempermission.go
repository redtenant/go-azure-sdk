...
// GetDriveItemPermission - Get permissions from me. The set of permissions for the item. Read-only. Nullable.
func (c DriveItemPermissionClient) GetDriveItemPermission(ctx context.Context, id stable.MeDriveIdItemIdPermissionId, options GetDriveItemPermissionOperationOptions) (result GetDriveItemPermissionOperationResponse, err error) {
