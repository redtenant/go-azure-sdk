...
func (c DriveItemPermissionClient) GetDriveItemPermissionsCount(ctx context.Context, id stable.MeDriveIdItemId, options GetDriveItemPermissionsCountOperationOptions) (result GetDriveItemPermissionsCountOperationResponse, err error) {
