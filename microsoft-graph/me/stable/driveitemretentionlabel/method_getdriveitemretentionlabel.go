...
// GetDriveItemRetentionLabel - Get retentionLabel from me. Information about retention label and settings enforced on
// the driveItem. Read-write.
func (c DriveItemRetentionLabelClient) GetDriveItemRetentionLabel(ctx context.Context, id stable.MeDriveIdItemId, options GetDriveItemRetentionLabelOperationOptions) (result GetDriveItemRetentionLabelOperationResponse, err error) {
