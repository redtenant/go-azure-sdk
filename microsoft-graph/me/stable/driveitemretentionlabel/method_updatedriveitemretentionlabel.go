...
// UpdateDriveItemRetentionLabel - Update the navigation property retentionLabel in me
func (c DriveItemRetentionLabelClient) UpdateDriveItemRetentionLabel(ctx context.Context, id stable.MeDriveIdItemId, input stable.ItemRetentionLabel, options UpdateDriveItemRetentionLabelOperationOptions) (result UpdateDriveItemRetentionLabelOperationResponse, err error) {
