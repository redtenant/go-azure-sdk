...
func (c DriveItemSubscriptionClient) CreateDriveItemSubscription(ctx context.Context, id stable.MeDriveIdItemId, input stable.Subscription, options CreateDriveItemSubscriptionOperationOptions) (result CreateDriveItemSubscriptionOperationResponse, err error) {
