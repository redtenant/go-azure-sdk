...
func (c DriveItemSubscriptionClient) CreateDriveItemSubscriptionReauthorize(ctx context.Context, id stable.MeDriveIdItemIdSubscriptionId, options CreateDriveItemSubscriptionReauthorizeOperationOptions) (result CreateDriveItemSubscriptionReauthorizeOperationResponse, err error) {
