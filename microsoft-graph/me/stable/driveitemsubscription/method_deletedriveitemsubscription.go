...
// DeleteDriveItemSubscription - Delete navigation property subscriptions for me
func (c DriveItemSubscriptionClient) DeleteDriveItemSubscription(ctx context.Context, id stable.MeDriveIdItemIdSubscriptionId, options DeleteDriveItemSubscriptionOperationOptions) (result DeleteDriveItemSubscriptionOperationResponse, err error) {
