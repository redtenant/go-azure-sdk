...
// GetDriveItemSubscription - Get subscriptions from me. The set of subscriptions on the item. Only supported on the
// root of a drive.
func (c DriveItemSubscriptionClient) GetDriveItemSubscription(ctx context.Context, id stable.MeDriveIdItemIdSubscriptionId, options GetDriveItemSubscriptionOperationOptions) (result GetDriveItemSubscriptionOperationResponse, err error) {
