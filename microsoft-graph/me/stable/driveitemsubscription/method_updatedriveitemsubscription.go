...
func (c DriveItemSubscriptionClient) UpdateDriveItemSubscription(ctx context.Context, id stable.MeDriveIdItemIdSubscriptionId, input stable.Subscription, options UpdateDriveItemSubscriptionOperationOptions) (result UpdateDriveItemSubscriptionOperationResponse, err error) {
