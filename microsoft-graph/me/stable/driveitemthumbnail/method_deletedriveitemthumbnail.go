...
func (c DriveItemThumbnailClient) DeleteDriveItemThumbnail(ctx context.Context, id stable.MeDriveIdItemIdThumbnailId, options DeleteDriveItemThumbnailOperationOptions) (result DeleteDriveItemThumbnailOperationResponse, err error) {
