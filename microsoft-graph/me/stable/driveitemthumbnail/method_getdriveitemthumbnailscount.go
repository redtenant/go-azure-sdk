...
func (c DriveItemThumbnailClient) GetDriveItemThumbnailsCount(ctx context.Context, id stable.MeDriveIdItemId, options GetDriveItemThumbnailsCountOperationOptions) (result GetDriveItemThumbnailsCountOperationResponse, err error) {
