...
// UpdateDriveItemThumbnail - Update the navigation property thumbnails in me
func (c DriveItemThumbnailClient) UpdateDriveItemThumbnail(ctx context.Context, id stable.MeDriveIdItemIdThumbnailId, input stable.ThumbnailSet, options UpdateDriveItemThumbnailOperationOptions) (result UpdateDriveItemThumbnailOperationResponse, err error) {
