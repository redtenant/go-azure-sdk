...
// DeleteDriveItemVersion - Delete navigation property versions for me
func (c DriveItemVersionClient) DeleteDriveItemVersion(ctx context.Context, id stable.MeDriveIdItemIdVersionId, options DeleteDriveItemVersionOperationOptions) (result DeleteDriveItemVersionOperationResponse, err error) {
