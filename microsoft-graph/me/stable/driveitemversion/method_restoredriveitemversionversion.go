...
func (c DriveItemVersionClient) RestoreDriveItemVersionVersion(ctx context.Context, id stable.MeDriveIdItemIdVersionId, options RestoreDriveItemVersionVersionOperationOptions) (result RestoreDriveItemVersionVersionOperationResponse, err error) {
