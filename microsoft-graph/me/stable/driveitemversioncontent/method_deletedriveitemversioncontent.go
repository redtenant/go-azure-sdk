...
// DeleteDriveItemVersionContent - Delete content for the navigation property versions in me. The content stream for
// this version of the item.
func (c DriveItemVersionContentClient) DeleteDriveItemVersionContent(ctx context.Context, id stable.MeDriveIdItemIdVersionId, options DeleteDriveItemVersionContentOperationOptions) (result DeleteDriveItemVersionContentOperationResponse, err error) {
