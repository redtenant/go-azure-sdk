...
// GetDriveItemVersionContent - Get content for the navigation property versions from me. The content stream for this
// version of the item.
func (c DriveItemVersionContentClient) GetDriveItemVersionContent(ctx context.Context, id stable.MeDriveIdItemIdVersionId, options GetDriveItemVersionContentOperationOptions) (result GetDriveItemVersionContentOperationResponse, err error) {
