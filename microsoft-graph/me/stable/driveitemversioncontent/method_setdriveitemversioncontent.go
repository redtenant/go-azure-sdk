...
// SetDriveItemVersionContent - Update content for the navigation property versions in me. The content stream for this
// version of the item.
func (c DriveItemVersionContentClient) SetDriveItemVersionContent(ctx context.Context, id stable.MeDriveIdItemIdVersionId, input []byte, options SetDriveItemVersionContentOperationOptions) (result SetDriveItemVersionContentOperationResponse, err error) {
