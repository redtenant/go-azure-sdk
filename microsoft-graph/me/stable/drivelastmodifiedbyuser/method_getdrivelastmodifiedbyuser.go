...
// GetDriveLastModifiedByUser - Get lastModifiedByUser from me. Identity of the user who last modified the item.
// Read-only.
func (c DriveLastModifiedByUserClient) GetDriveLastModifiedByUser(ctx context.Context, id stable.MeDriveId, options GetDriveLastModifiedByUserOperationOptions) (result GetDriveLastModifiedByUserOperationResponse, err error) {
