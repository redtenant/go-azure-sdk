...
func (c DriveLastModifiedByUserMailboxSettingClient) GetDriveLastModifiedByUserMailboxSetting(ctx context.Context, id stable.MeDriveId, options GetDriveLastModifiedByUserMailboxSettingOperationOptions) (result GetDriveLastModifiedByUserMailboxSettingOperationResponse, err error) {
