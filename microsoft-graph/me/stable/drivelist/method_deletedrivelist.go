...
// DeleteDriveList - Delete navigation property list for me
func (c DriveListClient) DeleteDriveList(ctx context.Context, id stable.MeDriveId, options DeleteDriveListOperationOptions) (result DeleteDriveListOperationResponse, err error) {
