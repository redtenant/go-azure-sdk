...
// GetDriveList - Get list from me. For drives in SharePoint, the underlying document library list. Read-only. Nullable.
func (c DriveListClient) GetDriveList(ctx context.Context, id stable.MeDriveId, options GetDriveListOperationOptions) (result GetDriveListOperationResponse, err error) {
