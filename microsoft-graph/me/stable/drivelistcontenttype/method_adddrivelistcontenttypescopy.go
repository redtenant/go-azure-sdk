...
func (c DriveListContentTypeClient) AddDriveListContentTypesCopy(ctx context.Context, id stable.MeDriveId, input AddDriveListContentTypesCopyRequest, options AddDriveListContentTypesCopyOperationOptions) (result AddDriveListContentTypesCopyOperationResponse, err error) {
