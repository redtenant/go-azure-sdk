...
func (c DriveListContentTypeClient) CreateDriveListContentType(ctx context.Context, id stable.MeDriveId, input stable.ContentType, options CreateDriveListContentTypeOperationOptions) (result CreateDriveListContentTypeOperationResponse, err error) {
