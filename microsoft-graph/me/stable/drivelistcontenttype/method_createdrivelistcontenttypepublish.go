...
// site.
func (c DriveListContentTypeClient) CreateDriveListContentTypePublish(ctx context.Context, id stable.MeDriveIdListContentTypeId, options CreateDriveListContentTypePublishOperationOptions) (result CreateDriveListContentTypePublishOperationResponse, err error) {
