...
func (c DriveListContentTypeClient) DeleteDriveListContentType(ctx context.Context, id stable.MeDriveIdListContentTypeId, options DeleteDriveListContentTypeOperationOptions) (result DeleteDriveListContentTypeOperationResponse, err error) {
