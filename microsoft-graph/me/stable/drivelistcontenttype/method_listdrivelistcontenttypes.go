...
// ListDriveListContentTypes - Get contentTypes from me. The collection of content types present in this list.
func (c DriveListContentTypeClient) ListDriveListContentTypes(ctx context.Context, id stable.MeDriveId, options ListDriveListContentTypesOperationOptions) (result ListDriveListContentTypesOperationResponse, err error) {
...
func (c DriveListContentTypeClient) ListDriveListContentTypesComplete(ctx context.Context, id stable.MeDriveId, options ListDriveListContentTypesOperationOptions) (ListDriveListContentTypesCompleteResult, error) {
...
func (c DriveListContentTypeClient) ListDriveListContentTypesCompleteMatchingPredicate(ctx context.Context, id stable.MeDriveId, options ListDriveListContentTypesOperationOptions, predicate ContentTypeOperationPredicate) (result ListDriveListContentTypesCompleteResult, err error) {
