...
// GetDriveListContentTypeBase - Get base from me. Parent contentType from which this content type is derived.
func (c DriveListContentTypeBaseClient) GetDriveListContentTypeBase(ctx context.Context, id stable.MeDriveIdListContentTypeId, options GetDriveListContentTypeBaseOperationOptions) (result GetDriveListContentTypeBaseOperationResponse, err error) {
