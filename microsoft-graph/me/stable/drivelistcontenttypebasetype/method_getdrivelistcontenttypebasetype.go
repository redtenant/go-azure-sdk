...
// GetDriveListContentTypeBaseType - Get baseTypes from me. The collection of content types that are ancestors of this
// content type.
func (c DriveListContentTypeBaseTypeClient) GetDriveListContentTypeBaseType(ctx context.Context, id stable.MeDriveIdListContentTypeIdBaseTypeId, options GetDriveListContentTypeBaseTypeOperationOptions) (result GetDriveListContentTypeBaseTypeOperationResponse, err error) {
