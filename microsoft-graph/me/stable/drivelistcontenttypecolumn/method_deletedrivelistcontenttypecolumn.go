...
func (c DriveListContentTypeColumnClient) DeleteDriveListContentTypeColumn(ctx context.Context, id stable.MeDriveIdListContentTypeIdColumnId, options DeleteDriveListContentTypeColumnOperationOptions) (result DeleteDriveListContentTypeColumnOperationResponse, err error) {
