...
// GetDriveListContentTypeColumn - Get columns from me. The collection of column definitions for this content type.
func (c DriveListContentTypeColumnClient) GetDriveListContentTypeColumn(ctx context.Context, id stable.MeDriveIdListContentTypeIdColumnId, options GetDriveListContentTypeColumnOperationOptions) (result GetDriveListContentTypeColumnOperationResponse, err error) {
