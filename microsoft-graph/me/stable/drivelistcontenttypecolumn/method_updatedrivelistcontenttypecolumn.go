...
// UpdateDriveListContentTypeColumn - Update the navigation property columns in me
func (c DriveListContentTypeColumnClient) UpdateDriveListContentTypeColumn(ctx context.Context, id stable.MeDriveIdListContentTypeIdColumnId, input stable.ColumnDefinition, options UpdateDriveListContentTypeColumnOperationOptions) (result UpdateDriveListContentTypeColumnOperationResponse, err error) {
