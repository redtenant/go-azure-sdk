...
// CreateDriveListContentTypeColumnLink - Create new navigation property to columnLinks for me
func (c DriveListContentTypeColumnLinkClient) CreateDriveListContentTypeColumnLink(ctx context.Context, id stable.MeDriveIdListContentTypeId, input stable.ColumnLink, options CreateDriveListContentTypeColumnLinkOperationOptions) (result CreateDriveListContentTypeColumnLinkOperationResponse, err error) {
