...
// DeleteDriveListContentTypeColumnLink - Delete navigation property columnLinks for me
func (c DriveListContentTypeColumnLinkClient) DeleteDriveListContentTypeColumnLink(ctx context.Context, id stable.MeDriveIdListContentTypeIdColumnLinkId, options DeleteDriveListContentTypeColumnLinkOperationOptions) (result DeleteDriveListContentTypeColumnLinkOperationResponse, err error) {
