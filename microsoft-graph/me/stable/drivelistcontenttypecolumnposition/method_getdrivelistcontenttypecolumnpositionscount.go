...
func (c DriveListContentTypeColumnPositionClient) GetDriveListContentTypeColumnPositionsCount(ctx context.Context, id stable.MeDriveIdListContentTypeId, options GetDriveListContentTypeColumnPositionsCountOperationOptions) (result GetDriveListContentTypeColumnPositionsCountOperationResponse, err error) {
