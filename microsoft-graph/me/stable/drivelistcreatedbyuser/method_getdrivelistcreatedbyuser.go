...
// GetDriveListCreatedByUser - Get createdByUser from me. Identity of the user who created the item. Read-only.
func (c DriveListCreatedByUserClient) GetDriveListCreatedByUser(ctx context.Context, id stable.MeDriveId, options GetDriveListCreatedByUserOperationOptions) (result GetDriveListCreatedByUserOperationResponse, err error) {
