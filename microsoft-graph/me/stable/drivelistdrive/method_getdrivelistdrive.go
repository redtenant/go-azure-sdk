...
// document libraries.
func (c DriveListDriveClient) GetDriveListDrive(ctx context.Context, id stable.MeDriveId, options GetDriveListDriveOperationOptions) (result GetDriveListDriveOperationResponse, err error) {
