...
// GetDriveListItemCreatedByUser - Get createdByUser from me. Identity of the user who created the item. Read-only.
func (c DriveListItemCreatedByUserClient) GetDriveListItemCreatedByUser(ctx context.Context, id stable.MeDriveIdListItemId, options GetDriveListItemCreatedByUserOperationOptions) (result GetDriveListItemCreatedByUserOperationResponse, err error) {
