...
func (c DriveListItemCreatedByUserMailboxSettingClient) GetDriveListItemCreatedByUserMailboxSetting(ctx context.Context, id stable.MeDriveIdListItemId, options GetDriveListItemCreatedByUserMailboxSettingOperationOptions) (result GetDriveListItemCreatedByUserMailboxSettingOperationResponse, err error) {
