...
// CreateDriveListItemDocumentSetVersion - Create new navigation property to documentSetVersions for me
func (c DriveListItemDocumentSetVersionClient) CreateDriveListItemDocumentSetVersion(ctx context.Context, id stable.MeDriveIdListItemId, input stable.DocumentSetVersion, options CreateDriveListItemDocumentSetVersionOperationOptions) (result CreateDriveListItemDocumentSetVersionOperationResponse, err error) {
