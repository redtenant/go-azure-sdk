...
// created by a user.
func (c DriveListItemDocumentSetVersionClient) GetDriveListItemDocumentSetVersion(ctx context.Context, id stable.MeDriveIdListItemIdDocumentSetVersionId, options GetDriveListItemDocumentSetVersionOperationOptions) (result GetDriveListItemDocumentSetVersionOperationResponse, err error) {
