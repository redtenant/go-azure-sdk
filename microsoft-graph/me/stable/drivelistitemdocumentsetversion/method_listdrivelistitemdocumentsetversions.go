...
// ListDriveListItemDocumentSetVersions - Get documentSetVersions from me. Version information for a document set
// version created by a user.
func (c DriveListItemDocumentSetVersionClient) ListDriveListItemDocumentSetVersions(ctx context.Context, id stable.MeDriveIdListItemId, options ListDriveListItemDocumentSetVersionsOperationOptions) (result ListDriveListItemDocumentSetVersionsOperationResponse, err error) {
...
func (c DriveListItemDocumentSetVersionClient) ListDriveListItemDocumentSetVersionsComplete(ctx context.Context, id stable.MeDriveIdListItemId, options ListDriveListItemDocumentSetVersionsOperationOptions) (ListDriveListItemDocumentSetVersionsCompleteResult, error) {
...
func (c DriveListItemDocumentSetVersionClient) ListDriveListItemDocumentSetVersionsCompleteMatchingPredicate(ctx context.Context, id stable.MeDriveIdListItemId, options ListDriveListItemDocumentSetVersionsOperationOptions, predicate DocumentSetVersionOperationPredicate) (result ListDriveListItemDocumentSetVersionsCompleteResult, err error) {
