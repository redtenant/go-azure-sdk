...
func (c DriveListItemDocumentSetVersionClient) RestoreDriveListItemDocumentSetVersion(ctx context.Context, id stable.MeDriveIdListItemIdDocumentSetVersionId, options RestoreDriveListItemDocumentSetVersionOperationOptions) (result RestoreDriveListItemDocumentSetVersionOperationResponse, err error) {
