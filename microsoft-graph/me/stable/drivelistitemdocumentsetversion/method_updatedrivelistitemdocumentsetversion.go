...
// UpdateDriveListItemDocumentSetVersion - Update the navigation property documentSetVersions in me
func (c DriveListItemDocumentSetVersionClient) UpdateDriveListItemDocumentSetVersion(ctx context.Context, id stable.MeDriveIdListItemIdDocumentSetVersionId, input stable.DocumentSetVersion, options UpdateDriveListItemDocumentSetVersionOperationOptions) (result UpdateDriveListItemDocumentSetVersionOperationResponse, err error) {
