...
// DeleteDriveListItemDriveItemContent - Delete content for the navigation property driveItem in me. The content stream,
// if the item represents a file.
func (c DriveListItemDriveItemContentClient) DeleteDriveListItemDriveItemContent(ctx context.Context, id stable.MeDriveIdListItemId, options DeleteDriveListItemDriveItemContentOperationOptions) (result DeleteDriveListItemDriveItemContentOperationResponse, err error) {
