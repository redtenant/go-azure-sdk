...
// SetDriveListItemDriveItemContent - Update content for the navigation property driveItem in me. The content stream, if
// the item represents a file.
func (c DriveListItemDriveItemContentClient) SetDriveListItemDriveItemContent(ctx context.Context, id stable.MeDriveIdListItemId, input []byte, options SetDriveListItemDriveItemContentOperationOptions) (result SetDriveListItemDriveItemContentOperationResponse, err error) {
