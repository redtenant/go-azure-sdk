...
// GetDriveListItemField - Get fields from me. The values of the columns set on this list item.
func (c DriveListItemFieldClient) GetDriveListItemField(ctx context.Context, id stable.MeDriveIdListItemId, options GetDriveListItemFieldOperationOptions) (result GetDriveListItemFieldOperationResponse, err error) {
