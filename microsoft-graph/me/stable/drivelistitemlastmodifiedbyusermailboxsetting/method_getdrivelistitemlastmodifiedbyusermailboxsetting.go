...
func (c DriveListItemLastModifiedByUserMailboxSettingClient) GetDriveListItemLastModifiedByUserMailboxSetting(ctx context.Context, id stable.MeDriveIdListItemId, options GetDriveListItemLastModifiedByUserMailboxSettingOperationOptions) (result GetDriveListItemLastModifiedByUserMailboxSettingOperationResponse, err error) {
