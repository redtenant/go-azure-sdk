...
// CreateDriveListItemVersion - Create new navigation property to versions for me
func (c DriveListItemVersionClient) CreateDriveListItemVersion(ctx context.Context, id stable.MeDriveIdListItemId, input stable.ListItemVersion, options CreateDriveListItemVersionOperationOptions) (result CreateDriveListItemVersionOperationResponse, err error) {
