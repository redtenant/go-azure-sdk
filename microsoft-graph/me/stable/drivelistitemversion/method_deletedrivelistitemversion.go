...
// DeleteDriveListItemVersion - Delete navigation property versions for me
func (c DriveListItemVersionClient) DeleteDriveListItemVersion(ctx context.Context, id stable.MeDriveIdListItemIdVersionId, options DeleteDriveListItemVersionOperationOptions) (result DeleteDriveListItemVersionOperationResponse, err error) {
