...
// GetDriveListItemVersion - Get versions from me. The list of previous versions of the list item.
func (c DriveListItemVersionClient) GetDriveListItemVersion(ctx context.Context, id stable.MeDriveIdListItemIdVersionId, options GetDriveListItemVersionOperationOptions) (result GetDriveListItemVersionOperationResponse, err error) {
