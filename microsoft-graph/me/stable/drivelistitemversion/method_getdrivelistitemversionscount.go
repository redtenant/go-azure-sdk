...
func (c DriveListItemVersionClient) GetDriveListItemVersionsCount(ctx context.Context, id stable.MeDriveIdListItemId, options GetDriveListItemVersionsCountOperationOptions) (result GetDriveListItemVersionsCountOperationResponse, err error) {
