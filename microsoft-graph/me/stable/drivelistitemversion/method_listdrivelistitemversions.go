...
// ListDriveListItemVersions - Get versions from me. The list of previous versions of the list item.
func (c DriveListItemVersionClient) ListDriveListItemVersions(ctx context.Context, id stable.MeDriveIdListItemId, options ListDriveListItemVersionsOperationOptions) (result ListDriveListItemVersionsOperationResponse, err error) {
...
func (c DriveListItemVersionClient) ListDriveListItemVersionsComplete(ctx context.Context, id stable.MeDriveIdListItemId, options ListDriveListItemVersionsOperationOptions) (ListDriveListItemVersionsCompleteResult, error) {
...
func (c DriveListItemVersionClient) ListDriveListItemVersionsCompleteMatchingPredicate(ctx context.Context, id stable.MeDriveIdListItemId, options ListDriveListItemVersionsOperationOptions, predicate ListItemVersionOperationPredicate) (result ListDriveListItemVersionsCompleteResult, err error) {
