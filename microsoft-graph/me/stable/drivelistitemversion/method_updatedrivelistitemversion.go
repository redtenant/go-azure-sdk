...
// UpdateDriveListItemVersion - Update the navigation property versions in me
func (c DriveListItemVersionClient) UpdateDriveListItemVersion(ctx context.Context, id stable.MeDriveIdListItemIdVersionId, input stable.ListItemVersion, options UpdateDriveListItemVersionOperationOptions) (result UpdateDriveListItemVersionOperationResponse, err error) {
