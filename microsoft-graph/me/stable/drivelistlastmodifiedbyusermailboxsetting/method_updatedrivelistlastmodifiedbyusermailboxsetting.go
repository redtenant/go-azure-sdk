...
func (c DriveListLastModifiedByUserMailboxSettingClient) UpdateDriveListLastModifiedByUserMailboxSetting(ctx context.Context, id stable.MeDriveId, input stable.MailboxSettings, options UpdateDriveListLastModifiedByUserMailboxSettingOperationOptions) (result UpdateDriveListLastModifiedByUserMailboxSettingOperationResponse, err error) {
