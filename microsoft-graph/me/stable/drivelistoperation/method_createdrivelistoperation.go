...
// CreateDriveListOperation - Create new navigation property to operations for me
func (c DriveListOperationClient) CreateDriveListOperation(ctx context.Context, id stable.MeDriveId, input stable.RichLongRunningOperation, options CreateDriveListOperationOperationOptions) (result CreateDriveListOperationOperationResponse, err error) {
