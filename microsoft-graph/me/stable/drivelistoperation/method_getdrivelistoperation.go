...
// GetDriveListOperation - Get operations from me. The collection of long-running operations on the list.
func (c DriveListOperationClient) GetDriveListOperation(ctx context.Context, id stable.MeDriveIdListOperationId, options GetDriveListOperationOperationOptions) (result GetDriveListOperationOperationResponse, err error) {
