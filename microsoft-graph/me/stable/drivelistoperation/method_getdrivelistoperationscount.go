...
func (c DriveListOperationClient) GetDriveListOperationsCount(ctx context.Context, id stable.MeDriveId, options GetDriveListOperationsCountOperationOptions) (result GetDriveListOperationsCountOperationResponse, err error) {
