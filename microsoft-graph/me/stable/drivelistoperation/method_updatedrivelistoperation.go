...
// UpdateDriveListOperation - Update the navigation property operations in me
func (c DriveListOperationClient) UpdateDriveListOperation(ctx context.Context, id stable.MeDriveIdListOperationId, input stable.RichLongRunningOperation, options UpdateDriveListOperationOperationOptions) (result UpdateDriveListOperationOperationResponse, err error) {
