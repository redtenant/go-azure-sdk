...
// CreateDriveListSubscription - Create new navigation property to subscriptions for me
func (c DriveListSubscriptionClient) CreateDriveListSubscription(ctx context.Context, id stable.MeDriveId, input stable.Subscription, options CreateDriveListSubscriptionOperationOptions) (result CreateDriveListSubscriptionOperationResponse, err error) {
