...
func (c DriveListSubscriptionClient) GetDriveListSubscription(ctx context.Context, id stable.MeDriveIdListSubscriptionId, options GetDriveListSubscriptionOperationOptions) (result GetDriveListSubscriptionOperationResponse, err error) {
