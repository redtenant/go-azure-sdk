...
func (c DriveRootClient) AssignDriveRootSensitivityLabel(ctx context.Context, id stable.MeDriveId, input AssignDriveRootSensitivityLabelRequest, options AssignDriveRootSensitivityLabelOperationOptions) (result AssignDriveRootSensitivityLabelOperationResponse, err error) {
