...
func (c DriveRootClient) CheckoutDriveRoot(ctx context.Context, id stable.MeDriveId, options CheckoutDriveRootOperationOptions) (result CheckoutDriveRootOperationResponse, err error) {
