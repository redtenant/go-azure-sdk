...
func (c DriveRootClient) CopyDriveRoot(ctx context.Context, id stable.MeDriveId, input CopyDriveRootRequest, options CopyDriveRootOperationOptions) (result CopyDriveRootOperationResponse, err error) {
