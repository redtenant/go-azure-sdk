...
func (c DriveRootClient) CreateDriveRootPermanentDelete(ctx context.Context, id stable.MeDriveId, options CreateDriveRootPermanentDeleteOperationOptions) (result CreateDriveRootPermanentDeleteOperationResponse, err error) {
