...
func (c DriveRootClient) DeleteDriveRoot(ctx context.Context, id stable.MeDriveId, options DeleteDriveRootOperationOptions) (result DeleteDriveRootOperationResponse, err error) {
