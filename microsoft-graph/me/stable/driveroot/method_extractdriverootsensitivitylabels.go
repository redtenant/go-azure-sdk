...
func (c DriveRootClient) ExtractDriveRootSensitivityLabels(ctx context.Context, id stable.MeDriveId, options ExtractDriveRootSensitivityLabelsOperationOptions) (result ExtractDriveRootSensitivityLabelsOperationResponse, err error) {
