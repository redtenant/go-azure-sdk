...
func (c DriveRootClient) GetDriveRoot(ctx context.Context, id stable.MeDriveId, options GetDriveRootOperationOptions) (result GetDriveRootOperationResponse, err error) {
