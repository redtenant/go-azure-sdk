...
func (c DriveRootClient) PreviewDriveRoot(ctx context.Context, id stable.MeDriveId, input PreviewDriveRootRequest, options PreviewDriveRootOperationOptions) (result PreviewDriveRootOperationResponse, err error) {
