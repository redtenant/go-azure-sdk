...
func (c DriveRootClient) RestoreDriveRoot(ctx context.Context, id stable.MeDriveId, input RestoreDriveRootRequest, options RestoreDriveRootOperationOptions) (result RestoreDriveRootOperationResponse, err error) {
