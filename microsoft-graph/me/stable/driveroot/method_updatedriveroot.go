...
func (c DriveRootClient) UpdateDriveRoot(ctx context.Context, id stable.MeDriveId, input stable.DriveItem, options UpdateDriveRootOperationOptions) (result UpdateDriveRootOperationResponse, err error) {
