...
func (c DriveRootClient) ValidateDriveRootPermission(ctx context.Context, id stable.MeDriveId, input ValidateDriveRootPermissionRequest, options ValidateDriveRootPermissionOperationOptions) (result ValidateDriveRootPermissionOperationResponse, err error) {
