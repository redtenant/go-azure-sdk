...
// DeleteDriveRootAnalytics - Delete navigation property analytics for me
func (c DriveRootAnalyticsClient) DeleteDriveRootAnalytics(ctx context.Context, id stable.MeDriveId, options DeleteDriveRootAnalyticsOperationOptions) (result DeleteDriveRootAnalyticsOperationResponse, err error) {
