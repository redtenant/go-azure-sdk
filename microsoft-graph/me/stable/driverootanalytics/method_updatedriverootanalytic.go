...
// UpdateDriveRootAnalytic - Update the navigation property analytics in me
func (c DriveRootAnalyticsClient) UpdateDriveRootAnalytic(ctx context.Context, id stable.MeDriveId, input stable.ItemAnalytics, options UpdateDriveRootAnalyticOperationOptions) (result UpdateDriveRootAnalyticOperationResponse, err error) {
