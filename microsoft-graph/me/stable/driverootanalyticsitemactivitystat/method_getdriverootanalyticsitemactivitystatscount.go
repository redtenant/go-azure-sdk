...
func (c DriveRootAnalyticsItemActivityStatClient) GetDriveRootAnalyticsItemActivityStatsCount(ctx context.Context, id stable.MeDriveId, options GetDriveRootAnalyticsItemActivityStatsCountOperationOptions) (result GetDriveRootAnalyticsItemActivityStatsCountOperationResponse, err error) {
