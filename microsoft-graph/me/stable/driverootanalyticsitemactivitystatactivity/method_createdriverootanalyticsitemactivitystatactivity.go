...
// CreateDriveRootAnalyticsItemActivityStatActivity - Create new navigation property to activities for me
func (c DriveRootAnalyticsItemActivityStatActivityClient) CreateDriveRootAnalyticsItemActivityStatActivity(ctx context.Context, id stable.MeDriveIdRootAnalyticsItemActivityStatId, input stable.ItemActivity, options CreateDriveRootAnalyticsItemActivityStatActivityOperationOptions) (result CreateDriveRootAnalyticsItemActivityStatActivityOperationResponse, err error) {
