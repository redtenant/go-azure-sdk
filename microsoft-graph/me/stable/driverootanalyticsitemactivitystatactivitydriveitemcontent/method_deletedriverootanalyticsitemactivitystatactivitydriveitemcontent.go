...
// driveItem in me. The content stream, if the item represents a file.
func (c DriveRootAnalyticsItemActivityStatActivityDriveItemContentClient) DeleteDriveRootAnalyticsItemActivityStatActivityDriveItemContent(ctx context.Context, id stable.MeDriveIdRootAnalyticsItemActivityStatIdActivityId, options DeleteDriveRootAnalyticsItemActivityStatActivityDriveItemContentOperationOptions) (result DeleteDriveRootAnalyticsItemActivityStatActivityDriveItemContentOperationResponse, err error) {
