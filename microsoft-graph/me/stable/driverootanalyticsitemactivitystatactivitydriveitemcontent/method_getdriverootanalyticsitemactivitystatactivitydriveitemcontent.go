...
// from me. The content stream, if the item represents a file.
func (c DriveRootAnalyticsItemActivityStatActivityDriveItemContentClient) GetDriveRootAnalyticsItemActivityStatActivityDriveItemContent(ctx context.Context, id stable.MeDriveIdRootAnalyticsItemActivityStatIdActivityId, options GetDriveRootAnalyticsItemActivityStatActivityDriveItemContentOperationOptions) (result GetDriveRootAnalyticsItemActivityStatActivityDriveItemContentOperationResponse, err error) {
