...
// GetDriveRootAnalyticsLastSevenDay - Get lastSevenDays from me
func (c DriveRootAnalyticsLastSevenDayClient) GetDriveRootAnalyticsLastSevenDay(ctx context.Context, id stable.MeDriveId, options GetDriveRootAnalyticsLastSevenDayOperationOptions) (result GetDriveRootAnalyticsLastSevenDayOperationResponse, err error) {
