...
// CreateDriveRootChild - Create new navigation property to children for me
func (c DriveRootChildClient) CreateDriveRootChild(ctx context.Context, id stable.MeDriveId, input stable.DriveItem, options CreateDriveRootChildOperationOptions) (result CreateDriveRootChildOperationResponse, err error) {
