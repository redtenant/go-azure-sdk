...
// GetDriveRootChild - Get children from me. Collection containing Item objects for the immediate children of Item. Only
// items representing folders have children. Read-only. Nullable.
func (c DriveRootChildClient) GetDriveRootChild(ctx context.Context, id stable.MeDriveIdRootChildId, options GetDriveRootChildOperationOptions) (result GetDriveRootChildOperationResponse, err error) {
