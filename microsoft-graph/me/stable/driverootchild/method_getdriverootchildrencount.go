...
func (c DriveRootChildClient) GetDriveRootChildrenCount(ctx context.Context, id stable.MeDriveId, options GetDriveRootChildrenCountOperationOptions) (result GetDriveRootChildrenCountOperationResponse, err error) {
