...
// ListDriveRootChildren - Get children from me. Collection containing Item objects for the immediate children of Item.
// Only items representing folders have children. Read-only. Nullable.
func (c DriveRootChildClient) ListDriveRootChildren(ctx context.Context, id stable.MeDriveId, options ListDriveRootChildrenOperationOptions) (result ListDriveRootChildrenOperationResponse, err error) {
...
func (c DriveRootChildClient) ListDriveRootChildrenComplete(ctx context.Context, id stable.MeDriveId, options ListDriveRootChildrenOperationOptions) (ListDriveRootChildrenCompleteResult, error) {
...
func (c DriveRootChildClient) ListDriveRootChildrenCompleteMatchingPredicate(ctx context.Context, id stable.MeDriveId, options ListDriveRootChildrenOperationOptions, predicate DriveItemOperationPredicate) (result ListDriveRootChildrenCompleteResult, err error) {
