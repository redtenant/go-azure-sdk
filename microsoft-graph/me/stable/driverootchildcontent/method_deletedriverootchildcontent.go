...
func (c DriveRootChildContentClient) DeleteDriveRootChildContent(ctx context.Context, id stable.MeDriveIdRootChildId, options DeleteDriveRootChildContentOperationOptions) (result DeleteDriveRootChildContentOperationResponse, err error) {
