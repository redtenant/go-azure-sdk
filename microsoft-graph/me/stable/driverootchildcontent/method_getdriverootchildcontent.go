...
// GetDriveRootChildContent - Get content for the navigation property children from me. The content stream, if the item
// represents a file.
func (c DriveRootChildContentClient) GetDriveRootChildContent(ctx context.Context, id stable.MeDriveIdRootChildId, options GetDriveRootChildContentOperationOptions) (result GetDriveRootChildContentOperationResponse, err error) {
