...
// DeleteDriveRootContent - Delete content for the navigation property root in me. The content stream, if the item
// represents a file.
func (c DriveRootContentClient) DeleteDriveRootContent(ctx context.Context, id stable.MeDriveId, options DeleteDriveRootContentOperationOptions) (result DeleteDriveRootContentOperationResponse, err error) {
