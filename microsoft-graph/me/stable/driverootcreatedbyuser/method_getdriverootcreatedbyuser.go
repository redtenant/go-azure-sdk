...
// GetDriveRootCreatedByUser - Get createdByUser from me. Identity of the user who created the item. Read-only.
func (c DriveRootCreatedByUserClient) GetDriveRootCreatedByUser(ctx context.Context, id stable.MeDriveId, options GetDriveRootCreatedByUserOperationOptions) (result GetDriveRootCreatedByUserOperationResponse, err error) {
