...
func (c DriveRootCreatedByUserMailboxSettingClient) GetDriveRootCreatedByUserMailboxSetting(ctx context.Context, id stable.MeDriveId, options GetDriveRootCreatedByUserMailboxSettingOperationOptions) (result GetDriveRootCreatedByUserMailboxSettingOperationResponse, err error) {
