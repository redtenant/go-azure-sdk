...
func (c DriveRootCreatedByUserMailboxSettingClient) UpdateDriveRootCreatedByUserMailboxSetting(ctx context.Context, id stable.MeDriveId, input stable.MailboxSettings, options UpdateDriveRootCreatedByUserMailboxSettingOperationOptions) (result UpdateDriveRootCreatedByUserMailboxSettingOperationResponse, err error) {
