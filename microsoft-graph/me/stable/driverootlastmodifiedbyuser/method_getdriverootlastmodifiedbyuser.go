...
// GetDriveRootLastModifiedByUser - Get lastModifiedByUser from me. Identity of the user who last modified the item.
// Read-only.
func (c DriveRootLastModifiedByUserClient) GetDriveRootLastModifiedByUser(ctx context.Context, id stable.MeDriveId, options GetDriveRootLastModifiedByUserOperationOptions) (result GetDriveRootLastModifiedByUserOperationResponse, err error) {
