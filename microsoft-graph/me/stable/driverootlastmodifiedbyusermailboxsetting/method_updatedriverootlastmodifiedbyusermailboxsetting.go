...
func (c DriveRootLastModifiedByUserMailboxSettingClient) UpdateDriveRootLastModifiedByUserMailboxSetting(ctx context.Context, id stable.MeDriveId, input stable.MailboxSettings, options UpdateDriveRootLastModifiedByUserMailboxSettingOperationOptions) (result UpdateDriveRootLastModifiedByUserMailboxSettingOperationResponse, err error) {
