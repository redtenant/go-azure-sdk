...
func (c DriveRootLastModifiedByUserServiceProvisioningErrorClient) ListDriveRootLastModifiedByUserServiceProvisioningErrorsCompleteMatchingPredicate(ctx context.Context, id stable.MeDriveId, options ListDriveRootLastModifiedByUserServiceProvisioningErrorsOperationOptions, predicate ServiceProvisioningErrorOperationPredicate) (result ListDriveRootLastModifiedByUserServiceProvisioningErrorsCompleteResult, err error) {
