...
type GetDriveRootListItemCreatedByUserMailboxSettingOperationResponse struct {
	HttpResponse *http.Response
	OData        *odata.OData
	Model        *stable.MailboxSettings
}

type GetDriveRootListItemCreatedByUserMailboxSettingOperationOptions struct {
	Expand    *odata.Expand
...
func DefaultGetDriveRootListItemCreatedByUserMailboxSettingOperationOptions() GetDriveRootListItemCreatedByUserMailboxSettingOperationOptions {
	return GetDriveRootListItemCreatedByUserMailboxSettingOperationOptions{}
}
...
// GetDriveRootListItemCreatedByUserMailboxSetting - Get mailboxSettings property value. Settings for the primary
...
func (c DriveRootListItemCreatedByUserMailboxSettingClient) GetDriveRootListItemCreatedByUserMailboxSetting(ctx context.Context, id stable.MeDriveId, options GetDriveRootListItemCreatedByUserMailboxSettingOperationOptions) (result GetDriveRootListItemCreatedByUserMailboxSettingOperationResponse, err error) {
