...
func (c DriveRootListItemCreatedByUserMailboxSettingClient) UpdateDriveRootListItemCreatedByUserMailboxSetting(ctx context.Context, id stable.MeDriveId, input stable.MailboxSettings, options UpdateDriveRootListItemCreatedByUserMailboxSettingOperationOptions) (result UpdateDriveRootListItemCreatedByUserMailboxSettingOperationResponse, err error) {
