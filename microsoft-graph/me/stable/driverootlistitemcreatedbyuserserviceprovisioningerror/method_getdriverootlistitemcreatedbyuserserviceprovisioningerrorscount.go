...
func (c DriveRootListItemCreatedByUserServiceProvisioningErrorClient) GetDriveRootListItemCreatedByUserServiceProvisioningErrorsCount(ctx context.Context, id stable.MeDriveId, options GetDriveRootListItemCreatedByUserServiceProvisioningErrorsCountOperationOptions) (result GetDriveRootListItemCreatedByUserServiceProvisioningErrorsCountOperationResponse, err error) {
