...
// DeleteDriveRootListItemDocumentSetVersion - Delete navigation property documentSetVersions for me
func (c DriveRootListItemDocumentSetVersionClient) DeleteDriveRootListItemDocumentSetVersion(ctx context.Context, id stable.MeDriveIdRootListItemDocumentSetVersionId, options DeleteDriveRootListItemDocumentSetVersionOperationOptions) (result DeleteDriveRootListItemDocumentSetVersionOperationResponse, err error) {
