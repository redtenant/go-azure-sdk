...
// GetDriveRootListItemDocumentSetVersion - Get documentSetVersions from me. Version information for a document set
// version created by a user.
func (c DriveRootListItemDocumentSetVersionClient) GetDriveRootListItemDocumentSetVersion(ctx context.Context, id stable.MeDriveIdRootListItemDocumentSetVersionId, options GetDriveRootListItemDocumentSetVersionOperationOptions) (result GetDriveRootListItemDocumentSetVersionOperationResponse, err error) {
