...
// ListDriveRootListItemDocumentSetVersions - Get documentSetVersions from me. Version information for a document set
// version created by a user.
func (c DriveRootListItemDocumentSetVersionClient) ListDriveRootListItemDocumentSetVersions(ctx context.Context, id stable.MeDriveId, options ListDriveRootListItemDocumentSetVersionsOperationOptions) (result ListDriveRootListItemDocumentSetVersionsOperationResponse, err error) {
...
func (c DriveRootListItemDocumentSetVersionClient) ListDriveRootListItemDocumentSetVersionsComplete(ctx context.Context, id stable.MeDriveId, options ListDriveRootListItemDocumentSetVersionsOperationOptions) (ListDriveRootListItemDocumentSetVersionsCompleteResult, error) {
...
func (c DriveRootListItemDocumentSetVersionClient) ListDriveRootListItemDocumentSetVersionsCompleteMatchingPredicate(ctx context.Context, id stable.MeDriveId, options ListDriveRootListItemDocumentSetVersionsOperationOptions, predicate DocumentSetVersionOperationPredicate) (result ListDriveRootListItemDocumentSetVersionsCompleteResult, err error) {
