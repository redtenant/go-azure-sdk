...
func (c DriveRootListItemDocumentSetVersionClient) RestoreDriveRootListItemDocumentSetVersion(ctx context.Context, id stable.MeDriveIdRootListItemDocumentSetVersionId, options RestoreDriveRootListItemDocumentSetVersionOperationOptions) (result RestoreDriveRootListItemDocumentSetVersionOperationResponse, err error) {
