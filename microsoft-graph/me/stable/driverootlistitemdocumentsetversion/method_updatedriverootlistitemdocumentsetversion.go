...
// UpdateDriveRootListItemDocumentSetVersion - Update the navigation property documentSetVersions in me
func (c DriveRootListItemDocumentSetVersionClient) UpdateDriveRootListItemDocumentSetVersion(ctx context.Context, id stable.MeDriveIdRootListItemDocumentSetVersionId, input stable.DocumentSetVersion, options UpdateDriveRootListItemDocumentSetVersionOperationOptions) (result UpdateDriveRootListItemDocumentSetVersionOperationResponse, err error) {
