...
// GetDriveRootListItemDocumentSetVersionField - Get fields from me. A collection of the fields and values for this
// version of the list item.
func (c DriveRootListItemDocumentSetVersionFieldClient) GetDriveRootListItemDocumentSetVersionField(ctx context.Context, id stable.MeDriveIdRootListItemDocumentSetVersionId, options GetDriveRootListItemDocumentSetVersionFieldOperationOptions) (result GetDriveRootListItemDocumentSetVersionFieldOperationResponse, err error) {
