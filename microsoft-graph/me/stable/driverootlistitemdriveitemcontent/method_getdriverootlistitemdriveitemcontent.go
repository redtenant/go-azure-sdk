...
// GetDriveRootListItemDriveItemContent - Get content for the navigation property driveItem from me. The content stream,
// if the item represents a file.
func (c DriveRootListItemDriveItemContentClient) GetDriveRootListItemDriveItemContent(ctx context.Context, id stable.MeDriveId, options GetDriveRootListItemDriveItemContentOperationOptions) (result GetDriveRootListItemDriveItemContentOperationResponse, err error) {
