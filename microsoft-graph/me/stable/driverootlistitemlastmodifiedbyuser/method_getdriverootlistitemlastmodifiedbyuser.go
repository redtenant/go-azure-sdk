...
// GetDriveRootListItemLastModifiedByUser - Get lastModifiedByUser from me. Identity of the user who last modified the
// item. Read-only.
func (c DriveRootListItemLastModifiedByUserClient) GetDriveRootListItemLastModifiedByUser(ctx context.Context, id stable.MeDriveId, options GetDriveRootListItemLastModifiedByUserOperationOptions) (result GetDriveRootListItemLastModifiedByUserOperationResponse, err error) {
