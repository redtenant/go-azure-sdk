...
// CreateDriveRootListItemVersion - Create new navigation property to versions for me
func (c DriveRootListItemVersionClient) CreateDriveRootListItemVersion(ctx context.Context, id stable.MeDriveId, input stable.ListItemVersion, options CreateDriveRootListItemVersionOperationOptions) (result CreateDriveRootListItemVersionOperationResponse, err error) {
