...
// DeleteDriveRootListItemVersion - Delete navigation property versions for me
func (c DriveRootListItemVersionClient) DeleteDriveRootListItemVersion(ctx context.Context, id stable.MeDriveIdRootListItemVersionId, options DeleteDriveRootListItemVersionOperationOptions) (result DeleteDriveRootListItemVersionOperationResponse, err error) {
