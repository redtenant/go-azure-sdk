...
func (c DriveRootListItemVersionClient) GetDriveRootListItemVersionsCount(ctx context.Context, id stable.MeDriveId, options GetDriveRootListItemVersionsCountOperationOptions) (result GetDriveRootListItemVersionsCountOperationResponse, err error) {
