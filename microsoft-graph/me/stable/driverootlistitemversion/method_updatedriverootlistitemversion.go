...
// UpdateDriveRootListItemVersion - Update the navigation property versions in me
func (c DriveRootListItemVersionClient) UpdateDriveRootListItemVersion(ctx context.Context, id stable.MeDriveIdRootListItemVersionId, input stable.ListItemVersion, options UpdateDriveRootListItemVersionOperationOptions) (result UpdateDriveRootListItemVersionOperationResponse, err error) {
