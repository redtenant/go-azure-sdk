...
// list item.
func (c DriveRootListItemVersionFieldClient) GetDriveRootListItemVersionField(ctx context.Context, id stable.MeDriveIdRootListItemVersionId, options GetDriveRootListItemVersionFieldOperationOptions) (result GetDriveRootListItemVersionFieldOperationResponse, err error) {
