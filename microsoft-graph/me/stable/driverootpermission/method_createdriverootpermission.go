...
func (c DriveRootPermissionClient) CreateDriveRootPermission(ctx context.Context, id stable.MeDriveId, input stable.Permission, options CreateDriveRootPermissionOperationOptions) (result CreateDriveRootPermissionOperationResponse, err error) {
