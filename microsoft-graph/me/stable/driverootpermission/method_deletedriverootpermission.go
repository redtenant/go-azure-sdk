...
func (c DriveRootPermissionClient) DeleteDriveRootPermission(ctx context.Context, id stable.MeDriveIdRootPermissionId, options DeleteDriveRootPermissionOperationOptions) (result DeleteDriveRootPermissionOperationResponse, err error) {
