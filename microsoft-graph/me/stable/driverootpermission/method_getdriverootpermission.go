...
func (c DriveRootPermissionClient) GetDriveRootPermission(ctx context.Context, id stable.MeDriveIdRootPermissionId, options GetDriveRootPermissionOperationOptions) (result GetDriveRootPermissionOperationResponse, err error) {
