...
func (c DriveRootPermissionClient) GetDriveRootPermissionsCount(ctx context.Context, id stable.MeDriveId, options GetDriveRootPermissionsCountOperationOptions) (result GetDriveRootPermissionsCountOperationResponse, err error) {
