...
func (c DriveRootPermissionClient) ListDriveRootPermissionGrants(ctx context.Context, id stable.MeDriveIdRootPermissionId, input ListDriveRootPermissionGrantsRequest, options ListDriveRootPermissionGrantsOperationOptions) (result ListDriveRootPermissionGrantsOperationResponse, err error) {
...
func (c DriveRootPermissionClient) ListDriveRootPermissionGrantsComplete(ctx context.Context, id stable.MeDriveIdRootPermissionId, input ListDriveRootPermissionGrantsRequest, options ListDriveRootPermissionGrantsOperationOptions) (ListDriveRootPermissionGrantsCompleteResult, error) {
