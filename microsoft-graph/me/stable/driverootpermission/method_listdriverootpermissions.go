...
func (c DriveRootPermissionClient) ListDriveRootPermissions(ctx context.Context, id stable.MeDriveId, options ListDriveRootPermissionsOperationOptions) (result ListDriveRootPermissionsOperationResponse, err error) {
...
func (c DriveRootPermissionClient) ListDriveRootPermissionsComplete(ctx context.Context, id stable.MeDriveId, options ListDriveRootPermissionsOperationOptions) (ListDriveRootPermissionsCompleteResult, error) {
...
func (c DriveRootPermissionClient) ListDriveRootPermissionsCompleteMatchingPredicate(ctx context.Context, id stable.MeDriveId, options ListDriveRootPermissionsOperationOptions, predicate PermissionOperationPredicate) (result ListDriveRootPermissionsCompleteResult, err error) {
