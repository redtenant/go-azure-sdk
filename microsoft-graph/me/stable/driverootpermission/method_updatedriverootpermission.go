...
func (c DriveRootPermissionClient) UpdateDriveRootPermission(ctx context.Context, id stable.MeDriveIdRootPermissionId, input stable.Permission, options UpdateDriveRootPermissionOperationOptions) (result UpdateDriveRootPermissionOperationResponse, err error) {
