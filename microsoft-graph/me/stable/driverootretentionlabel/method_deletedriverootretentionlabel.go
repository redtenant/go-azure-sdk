...
// DeleteDriveRootRetentionLabel - Delete navigation property retentionLabel for me
func (c DriveRootRetentionLabelClient) DeleteDriveRootRetentionLabel(ctx context.Context, id stable.MeDriveId, options DeleteDriveRootRetentionLabelOperationOptions) (result DeleteDriveRootRetentionLabelOperationResponse, err error) {
