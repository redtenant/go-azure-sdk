...
func (c DriveRootRetentionLabelClient) UpdateDriveRootRetentionLabel(ctx context.Context, id stable.MeDriveId, input stable.ItemRetentionLabel, options UpdateDriveRootRetentionLabelOperationOptions) (result UpdateDriveRootRetentionLabelOperationResponse, err error) {
