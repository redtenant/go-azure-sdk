...
// CreateDriveRootSubscription - Create new navigation property to subscriptions for me
func (c DriveRootSubscriptionClient) CreateDriveRootSubscription(ctx context.Context, id stable.MeDriveId, input stable.Subscription, options CreateDriveRootSubscriptionOperationOptions) (result CreateDriveRootSubscriptionOperationResponse, err error) {
