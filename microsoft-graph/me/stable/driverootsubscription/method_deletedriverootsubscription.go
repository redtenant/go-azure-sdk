...
// DeleteDriveRootSubscription - Delete navigation property subscriptions for me
func (c DriveRootSubscriptionClient) DeleteDriveRootSubscription(ctx context.Context, id stable.MeDriveIdRootSubscriptionId, options DeleteDriveRootSubscriptionOperationOptions) (result DeleteDriveRootSubscriptionOperationResponse, err error) {
