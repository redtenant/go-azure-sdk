...
// GetDriveRootSubscription - Get subscriptions from me. The set of subscriptions on the item. Only supported on the
// root of a drive.
func (c DriveRootSubscriptionClient) GetDriveRootSubscription(ctx context.Context, id stable.MeDriveIdRootSubscriptionId, options GetDriveRootSubscriptionOperationOptions) (result GetDriveRootSubscriptionOperationResponse, err error) {
