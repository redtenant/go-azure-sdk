...
func (c DriveRootSubscriptionClient) GetDriveRootSubscriptionsCount(ctx context.Context, id stable.MeDriveId, options GetDriveRootSubscriptionsCountOperationOptions) (result GetDriveRootSubscriptionsCountOperationResponse, err error) {
