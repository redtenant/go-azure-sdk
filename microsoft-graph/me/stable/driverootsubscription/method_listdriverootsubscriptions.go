...
// ListDriveRootSubscriptions - Get subscriptions from me. The set of subscriptions on the item. Only supported on the
// root of a drive.
func (c DriveRootSubscriptionClient) ListDriveRootSubscriptions(ctx context.Context, id stable.MeDriveId, options ListDriveRootSubscriptionsOperationOptions) (result ListDriveRootSubscriptionsOperationResponse, err error) {
...
func (c DriveRootSubscriptionClient) ListDriveRootSubscriptionsComplete(ctx context.Context, id stable.MeDriveId, options ListDriveRootSubscriptionsOperationOptions) (ListDriveRootSubscriptionsCompleteResult, error) {
...
func (c DriveRootSubscriptionClient) ListDriveRootSubscriptionsCompleteMatchingPredicate(ctx context.Context, id stable.MeDriveId, options ListDriveRootSubscriptionsOperationOptions, predicate SubscriptionOperationPredicate) (result ListDriveRootSubscriptionsCompleteResult, err error) {
