...
func (c DriveRootSubscriptionClient) UpdateDriveRootSubscription(ctx context.Context, id stable.MeDriveIdRootSubscriptionId, input stable.Subscription, options UpdateDriveRootSubscriptionOperationOptions) (result UpdateDriveRootSubscriptionOperationResponse, err error) {
