...
func (c DriveRootVersionClient) DeleteDriveRootVersion(ctx context.Context, id stable.MeDriveIdRootVersionId, options DeleteDriveRootVersionOperationOptions) (result DeleteDriveRootVersionOperationResponse, err error) {
