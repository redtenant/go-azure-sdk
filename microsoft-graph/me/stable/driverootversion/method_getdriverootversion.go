...
// GetDriveRootVersion - Get versions from me. The list of previous versions of the item. For more info, see getting
// previous versions. Read-only. Nullable.
func (c DriveRootVersionClient) GetDriveRootVersion(ctx context.Context, id stable.MeDriveIdRootVersionId, options GetDriveRootVersionOperationOptions) (result GetDriveRootVersionOperationResponse, err error) {
