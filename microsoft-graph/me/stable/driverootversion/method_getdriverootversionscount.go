...
func (c DriveRootVersionClient) GetDriveRootVersionsCount(ctx context.Context, id stable.MeDriveId, options GetDriveRootVersionsCountOperationOptions) (result GetDriveRootVersionsCountOperationResponse, err error) {
