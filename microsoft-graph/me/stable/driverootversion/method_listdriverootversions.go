...
func (c DriveRootVersionClient) ListDriveRootVersions(ctx context.Context, id stable.MeDriveId, options ListDriveRootVersionsOperationOptions) (result ListDriveRootVersionsOperationResponse, err error) {
...
func (c DriveRootVersionClient) ListDriveRootVersionsComplete(ctx context.Context, id stable.MeDriveId, options ListDriveRootVersionsOperationOptions) (ListDriveRootVersionsCompleteResult, error) {
