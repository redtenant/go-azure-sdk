...
// ListDriveSpecials - Get special from me. Collection of common folders available in OneDrive. Read-only. Nullable.
func (c DriveSpecialClient) ListDriveSpecials(ctx context.Context, id stable.MeDriveId, options ListDriveSpecialsOperationOptions) (result ListDriveSpecialsOperationResponse, err error) {
...
func (c DriveSpecialClient) ListDriveSpecialsComplete(ctx context.Context, id stable.MeDriveId, options ListDriveSpecialsOperationOptions) (ListDriveSpecialsCompleteResult, error) {
...
func (c DriveSpecialClient) ListDriveSpecialsCompleteMatchingPredicate(ctx context.Context, id stable.MeDriveId, options ListDriveSpecialsOperationOptions, predicate DriveItemOperationPredicate) (result ListDriveSpecialsCompleteResult, err error) {
