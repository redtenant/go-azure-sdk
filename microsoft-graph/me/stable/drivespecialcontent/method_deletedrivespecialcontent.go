...
// DeleteDriveSpecialContent - Delete content for the navigation property special in me. The content stream, if the item
// represents a file.
func (c DriveSpecialContentClient) DeleteDriveSpecialContent(ctx context.Context, id stable.MeDriveIdSpecialId, options DeleteDriveSpecialContentOperationOptions) (result DeleteDriveSpecialContentOperationResponse, err error) {
