...
// SetDriveSpecialContent - Update content for the navigation property special in me. The content stream, if the item
// represents a file.
func (c DriveSpecialContentClient) SetDriveSpecialContent(ctx context.Context, id stable.MeDriveIdSpecialId, input []byte, options SetDriveSpecialContentOperationOptions) (result SetDriveSpecialContentOperationResponse, err error) {
