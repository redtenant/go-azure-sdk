...
func (c EmployeeExperienceLearningCourseActivityClient) GetEmployeeExperienceLearningCourseActivity(ctx context.Context, id stable.MeEmployeeExperienceLearningCourseActivityId, options GetEmployeeExperienceLearningCourseActivityOperationOptions) (result GetEmployeeExperienceLearningCourseActivityOperationResponse, err error) {
