...
// DeleteEventAttachment - Delete attachment. Delete an attachment from a user calendar event, mail message, or group
// post.
func (c EventAttachmentClient) DeleteEventAttachment(ctx context.Context, id stable.MeEventIdAttachmentId, options DeleteEventAttachmentOperationOptions) (result DeleteEventAttachmentOperationResponse, err error) {
