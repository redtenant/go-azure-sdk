...
// GetEventAttachment - Get attachments from me. The collection of FileAttachment, ItemAttachment, and
// referenceAttachment attachments for the event. Navigation property. Read-only. Nullable.
func (c EventAttachmentClient) GetEventAttachment(ctx context.Context, id stable.MeEventIdAttachmentId, options GetEventAttachmentOperationOptions) (result GetEventAttachmentOperationResponse, err error) {
