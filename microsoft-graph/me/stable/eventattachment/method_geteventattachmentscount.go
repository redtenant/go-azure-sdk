...
func (c EventAttachmentClient) GetEventAttachmentsCount(ctx context.Context, id stable.MeEventId, options GetEventAttachmentsCountOperationOptions) (result GetEventAttachmentsCountOperationResponse, err error) {
