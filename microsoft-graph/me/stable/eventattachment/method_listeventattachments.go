...
// ListEventAttachments - List attachments. Retrieve a list of attachment objects attached to an event.
func (c EventAttachmentClient) ListEventAttachments(ctx context.Context, id stable.MeEventId, options ListEventAttachmentsOperationOptions) (result ListEventAttachmentsOperationResponse, err error) {
...
func (c EventAttachmentClient) ListEventAttachmentsComplete(ctx context.Context, id stable.MeEventId, options ListEventAttachmentsOperationOptions) (ListEventAttachmentsCompleteResult, error) {
...
func (c EventAttachmentClient) ListEventAttachmentsCompleteMatchingPredicate(ctx context.Context, id stable.MeEventId, options ListEventAttachmentsOperationOptions, predicate AttachmentOperationPredicate) (result ListEventAttachmentsCompleteResult, err error) {
