...
// CreateEventExtension - Create new navigation property to extensions for me
func (c EventExtensionClient) CreateEventExtension(ctx context.Context, id stable.MeEventId, input stable.Extension, options CreateEventExtensionOperationOptions) (result CreateEventExtensionOperationResponse, err error) {
