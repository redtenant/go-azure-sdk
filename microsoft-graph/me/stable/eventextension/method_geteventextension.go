...
// GetEventExtension - Get extensions from me. The collection of open extensions defined for the event. Nullable.
func (c EventExtensionClient) GetEventExtension(ctx context.Context, id stable.MeEventIdExtensionId, options GetEventExtensionOperationOptions) (result GetEventExtensionOperationResponse, err error) {
