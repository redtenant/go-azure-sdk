...
// ListEventExtensions - Get extensions from me. The collection of open extensions defined for the event. Nullable.
func (c EventExtensionClient) ListEventExtensions(ctx context.Context, id stable.MeEventId, options ListEventExtensionsOperationOptions) (result ListEventExtensionsOperationResponse, err error) {
...
func (c EventExtensionClient) ListEventExtensionsComplete(ctx context.Context, id stable.MeEventId, options ListEventExtensionsOperationOptions) (ListEventExtensionsCompleteResult, error) {
...
func (c EventExtensionClient) ListEventExtensionsCompleteMatchingPredicate(ctx context.Context, id stable.MeEventId, options ListEventExtensionsOperationOptions, predicate ExtensionOperationPredicate) (result ListEventExtensionsCompleteResult, err error) {
