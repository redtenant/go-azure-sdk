...
func (c EventInstanceClient) DeclineEventInstance(ctx context.Context, id stable.MeEventIdInstanceId, input DeclineEventInstanceRequest, options DeclineEventInstanceOperationOptions) (result DeclineEventInstanceOperationResponse, err error) {
