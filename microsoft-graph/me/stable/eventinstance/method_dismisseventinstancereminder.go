...
// in a user calendar.
func (c EventInstanceClient) DismissEventInstanceReminder(ctx context.Context, id stable.MeEventIdInstanceId, options DismissEventInstanceReminderOperationOptions) (result DismissEventInstanceReminderOperationResponse, err error) {
