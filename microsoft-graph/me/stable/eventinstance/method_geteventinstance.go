...
func (c EventInstanceClient) GetEventInstance(ctx context.Context, id stable.MeEventIdInstanceId, options GetEventInstanceOperationOptions) (result GetEventInstanceOperationResponse, err error) {
