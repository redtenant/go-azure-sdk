...
// ListEventInstances - List instances. Get the instances (occurrences) of an event for a specified time range. If the
// event is a seriesMaster type, this API returns the occurrences and exceptions of the event in the specified time
// range.
func (c EventInstanceClient) ListEventInstances(ctx context.Context, id stable.MeEventId, options ListEventInstancesOperationOptions) (result ListEventInstancesOperationResponse, err error) {
...
func (c EventInstanceClient) ListEventInstancesComplete(ctx context.Context, id stable.MeEventId, options ListEventInstancesOperationOptions) (ListEventInstancesCompleteResult, error) {
...
func (c EventInstanceClient) ListEventInstancesCompleteMatchingPredicate(ctx context.Context, id stable.MeEventId, options ListEventInstancesOperationOptions, predicate EventOperationPredicate) (result ListEventInstancesCompleteResult, err error) {
