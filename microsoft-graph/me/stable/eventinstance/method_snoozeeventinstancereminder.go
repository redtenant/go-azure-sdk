...
// a new time.
func (c EventInstanceClient) SnoozeEventInstanceReminder(ctx context.Context, id stable.MeEventIdInstanceId, input SnoozeEventInstanceReminderRequest, options SnoozeEventInstanceReminderOperationOptions) (result SnoozeEventInstanceReminderOperationResponse, err error) {
