...
func (c EventInstanceClient) TentativelyAcceptEventInstance(ctx context.Context, id stable.MeEventIdInstanceId, input TentativelyAcceptEventInstanceRequest, options TentativelyAcceptEventInstanceOperationOptions) (result TentativelyAcceptEventInstanceOperationResponse, err error) {
