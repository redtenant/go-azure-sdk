...
func (c EventInstanceAttachmentClient) CreateEventInstanceAttachment(ctx context.Context, id stable.MeEventIdInstanceId, input stable.Attachment, options CreateEventInstanceAttachmentOperationOptions) (result CreateEventInstanceAttachmentOperationResponse, err error) {
