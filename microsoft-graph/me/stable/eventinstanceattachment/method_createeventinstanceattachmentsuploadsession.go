...
func (c EventInstanceAttachmentClient) CreateEventInstanceAttachmentsUploadSession(ctx context.Context, id stable.MeEventIdInstanceId, input CreateEventInstanceAttachmentsUploadSessionRequest, options CreateEventInstanceAttachmentsUploadSessionOperationOptions) (result CreateEventInstanceAttachmentsUploadSessionOperationResponse, err error) {
