...
func (c EventInstanceAttachmentClient) DeleteEventInstanceAttachment(ctx context.Context, id stable.MeEventIdInstanceIdAttachmentId, options DeleteEventInstanceAttachmentOperationOptions) (result DeleteEventInstanceAttachmentOperationResponse, err error) {
