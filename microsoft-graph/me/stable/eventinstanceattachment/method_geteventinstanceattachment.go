...
func (c EventInstanceAttachmentClient) GetEventInstanceAttachment(ctx context.Context, id stable.MeEventIdInstanceIdAttachmentId, options GetEventInstanceAttachmentOperationOptions) (result GetEventInstanceAttachmentOperationResponse, err error) {
