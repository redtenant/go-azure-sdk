...
func (c EventInstanceAttachmentClient) GetEventInstanceAttachmentsCount(ctx context.Context, id stable.MeEventIdInstanceId, options GetEventInstanceAttachmentsCountOperationOptions) (result GetEventInstanceAttachmentsCountOperationResponse, err error) {
