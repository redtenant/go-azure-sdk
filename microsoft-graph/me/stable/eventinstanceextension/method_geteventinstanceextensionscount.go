...
func (c EventInstanceExtensionClient) GetEventInstanceExtensionsCount(ctx context.Context, id stable.MeEventIdInstanceId, options GetEventInstanceExtensionsCountOperationOptions) (result GetEventInstanceExtensionsCountOperationResponse, err error) {
