...
// ListEventInstanceExtensions - Get extensions from me. The collection of open extensions defined for the event.
// Nullable.
func (c EventInstanceExtensionClient) ListEventInstanceExtensions(ctx context.Context, id stable.MeEventIdInstanceId, options ListEventInstanceExtensionsOperationOptions) (result ListEventInstanceExtensionsOperationResponse, err error) {
...
func (c EventInstanceExtensionClient) ListEventInstanceExtensionsComplete(ctx context.Context, id stable.MeEventIdInstanceId, options ListEventInstanceExtensionsOperationOptions) (ListEventInstanceExtensionsCompleteResult, error) {
...
func (c EventInstanceExtensionClient) ListEventInstanceExtensionsCompleteMatchingPredicate(ctx context.Context, id stable.MeEventIdInstanceId, options ListEventInstanceExtensionsOperationOptions, predicate ExtensionOperationPredicate) (result ListEventInstanceExtensionsCompleteResult, err error) {
