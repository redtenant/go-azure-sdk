...
// CreateExtension - Create new navigation property to extensions for me
func (c ExtensionClient) CreateExtension(ctx context.Context, input stable.Extension, options CreateExtensionOperationOptions) (result CreateExtensionOperationResponse, err error) {
