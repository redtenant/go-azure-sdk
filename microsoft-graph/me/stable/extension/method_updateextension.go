...
// UpdateExtension - Update the navigation property extensions in me
func (c ExtensionClient) UpdateExtension(ctx context.Context, id stable.MeExtensionId, input stable.Extension, options UpdateExtensionOperationOptions) (result UpdateExtensionOperationResponse, err error) {
