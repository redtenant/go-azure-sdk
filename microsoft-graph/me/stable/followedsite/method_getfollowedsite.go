...
func DefaultGetFollowedSiteOperationOptions() GetFollowedSiteOperationOptions {
	return GetFollowedSiteOperationOptions{}
}
...
// GetFollowedSite - Get followedSites from me
func (c FollowedSiteClient) GetFollowedSite(ctx context.Context, id stable.MeFollowedSiteId, options GetFollowedSiteOperationOptions) (result GetFollowedSiteOperationResponse, err error) {
