...
func (c FollowedSiteClient) RemoveFollowedSites(ctx context.Context, input RemoveFollowedSitesRequest, options RemoveFollowedSitesOperationOptions) (result RemoveFollowedSitesOperationResponse, err error) {
...
func (c FollowedSiteClient) RemoveFollowedSitesComplete(ctx context.Context, input RemoveFollowedSitesRequest, options RemoveFollowedSitesOperationOptions) (RemoveFollowedSitesCompleteResult, error) {
	return c.RemoveFollowedSitesCompleteMatchingPredicate(ctx, input, options, SiteOperationPredicate{})
}

// RemoveFollowedSitesCompleteMatchingPredicate retrieves all the results and then applies the predicate
func (c FollowedSiteClient) RemoveFollowedSitesCompleteMatchingPredicate(ctx context.Context, input RemoveFollowedSitesRequest, options RemoveFollowedSitesOperationOptions, predicate SiteOperationPredicate) (result RemoveFollowedSitesCompleteResult, err error) {
	items := make([]stable.Site, 0)

	resp, err := c.RemoveFollowedSites(ctx, input, options)
	if err != nil {
