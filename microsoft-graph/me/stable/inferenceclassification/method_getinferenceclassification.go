...
// GetInferenceClassification - Get inferenceClassification from me. Relevance classification of the user's messages
// based on explicit designations that override inferred relevance or importance.
func (c InferenceClassificationClient) GetInferenceClassification(ctx context.Context, options GetInferenceClassificationOperationOptions) (result GetInferenceClassificationOperationResponse, err error) {
