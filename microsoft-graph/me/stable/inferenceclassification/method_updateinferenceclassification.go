...
// UpdateInferenceClassification - Update the navigation property inferenceClassification in me
func (c InferenceClassificationClient) UpdateInferenceClassification(ctx context.Context, input stable.InferenceClassification, options UpdateInferenceClassificationOperationOptions) (result UpdateInferenceClassificationOperationResponse, err error) {
