...
// DeleteInferenceClassificationOverride - Delete inferenceClassificationOverride. Delete an override specified by its
// ID.
func (c InferenceClassificationOverrideClient) DeleteInferenceClassificationOverride(ctx context.Context, id stable.MeInferenceClassificationOverrideId, options DeleteInferenceClassificationOverrideOperationOptions) (result DeleteInferenceClassificationOverrideOperationResponse, err error) {
