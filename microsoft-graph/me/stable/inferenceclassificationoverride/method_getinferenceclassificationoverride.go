...
func (c InferenceClassificationOverrideClient) GetInferenceClassificationOverride(ctx context.Context, id stable.MeInferenceClassificationOverrideId, options GetInferenceClassificationOverrideOperationOptions) (result GetInferenceClassificationOverrideOperationResponse, err error) {
