...
func (c InsightSharedClient) CreateInsightShared(ctx context.Context, input stable.SharedInsight, options CreateInsightSharedOperationOptions) (result CreateInsightSharedOperationResponse, err error) {
