...
func (c InsightSharedClient) DeleteInsightShared(ctx context.Context, id stable.MeInsightSharedId, options DeleteInsightSharedOperationOptions) (result DeleteInsightSharedOperationResponse, err error) {
