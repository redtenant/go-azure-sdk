...
func (c InsightSharedClient) UpdateInsightShared(ctx context.Context, id stable.MeInsightSharedId, input stable.SharedInsight, options UpdateInsightSharedOperationOptions) (result UpdateInsightSharedOperationResponse, err error) {
