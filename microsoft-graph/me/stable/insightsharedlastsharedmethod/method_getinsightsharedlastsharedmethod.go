...
func (c InsightSharedLastSharedMethodClient) GetInsightSharedLastSharedMethod(ctx context.Context, id stable.MeInsightSharedId, options GetInsightSharedLastSharedMethodOperationOptions) (result GetInsightSharedLastSharedMethodOperationResponse, err error) {
