...
func (c InsightSharedResourceClient) GetInsightSharedResource(ctx context.Context, id stable.MeInsightSharedId, options GetInsightSharedResourceOperationOptions) (result GetInsightSharedResourceOperationResponse, err error) {
