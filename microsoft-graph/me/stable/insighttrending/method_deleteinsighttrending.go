...
func DefaultDeleteInsightTrendingOperationOptions() DeleteInsightTrendingOperationOptions {
	return DeleteInsightTrendingOperationOptions{}
}
...
// DeleteInsightTrending - Delete navigation property trending for me
func (c InsightTrendingClient) DeleteInsightTrending(ctx context.Context, id stable.MeInsightTrendingId, options DeleteInsightTrendingOperationOptions) (result DeleteInsightTrendingOperationResponse, err error) {
