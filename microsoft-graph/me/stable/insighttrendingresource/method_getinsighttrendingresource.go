...
func (c InsightTrendingResourceClient) GetInsightTrendingResource(ctx context.Context, id stable.MeInsightTrendingId, options GetInsightTrendingResourceOperationOptions) (result GetInsightTrendingResourceOperationResponse, err error) {
