...
func (c InsightUsedClient) DeleteInsightUsed(ctx context.Context, id stable.MeInsightUsedId, options DeleteInsightUsedOperationOptions) (result DeleteInsightUsedOperationResponse, err error) {
