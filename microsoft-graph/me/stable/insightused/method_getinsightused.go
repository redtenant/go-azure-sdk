...
// GetInsightUsed - Get used from me. Calculated relationship that identifies the latest documents viewed or modified by
// a user, including OneDrive for work or school and SharePoint documents, ranked by recency of use.
func (c InsightUsedClient) GetInsightUsed(ctx context.Context, id stable.MeInsightUsedId, options GetInsightUsedOperationOptions) (result GetInsightUsedOperationResponse, err error) {
