...
func (c InsightUsedClient) UpdateInsightUsed(ctx context.Context, id stable.MeInsightUsedId, input stable.UsedInsight, options UpdateInsightUsedOperationOptions) (result UpdateInsightUsedOperationResponse, err error) {
