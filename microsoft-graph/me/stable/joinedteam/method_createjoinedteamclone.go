...
func (c JoinedTeamClient) CreateJoinedTeamClone(ctx context.Context, id stable.MeJoinedTeamId, input CreateJoinedTeamCloneRequest, options CreateJoinedTeamCloneOperationOptions) (result CreateJoinedTeamCloneOperationResponse, err error) {
