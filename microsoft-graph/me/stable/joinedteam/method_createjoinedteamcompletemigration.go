...
// successful response.
func (c JoinedTeamClient) CreateJoinedTeamCompleteMigration(ctx context.Context, id stable.MeJoinedTeamId, options CreateJoinedTeamCompleteMigrationOperationOptions) (result CreateJoinedTeamCompleteMigrationOperationResponse, err error) {
