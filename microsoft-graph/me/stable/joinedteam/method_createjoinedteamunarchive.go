...
func (c JoinedTeamClient) CreateJoinedTeamUnarchive(ctx context.Context, id stable.MeJoinedTeamId, options CreateJoinedTeamUnarchiveOperationOptions) (result CreateJoinedTeamUnarchiveOperationResponse, err error) {
