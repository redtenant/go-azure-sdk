...
func DefaultDeleteJoinedTeamOperationOptions() DeleteJoinedTeamOperationOptions {
	return DeleteJoinedTeamOperationOptions{}
}
...
func (c JoinedTeamClient) DeleteJoinedTeam(ctx context.Context, id stable.MeJoinedTeamId, options DeleteJoinedTeamOperationOptions) (result DeleteJoinedTeamOperationResponse, err error) {
