...
func (c JoinedTeamClient) GetJoinedTeam(ctx context.Context, id stable.MeJoinedTeamId, options GetJoinedTeamOperationOptions) (result GetJoinedTeamOperationResponse, err error) {
