...
func (c JoinedTeamClient) GetJoinedTeamsCount(ctx context.Context, options GetJoinedTeamsCountOperationOptions) (result GetJoinedTeamsCountOperationResponse, err error) {
