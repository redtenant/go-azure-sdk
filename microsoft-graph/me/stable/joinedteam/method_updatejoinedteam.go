...
func (c JoinedTeamClient) UpdateJoinedTeam(ctx context.Context, id stable.MeJoinedTeamId, input stable.Team, options UpdateJoinedTeamOperationOptions) (result UpdateJoinedTeamOperationResponse, err error) {
