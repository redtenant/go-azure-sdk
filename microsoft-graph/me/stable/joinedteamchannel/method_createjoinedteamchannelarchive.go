...
func (c JoinedTeamChannelClient) CreateJoinedTeamChannelArchive(ctx context.Context, id stable.MeJoinedTeamIdChannelId, input CreateJoinedTeamChannelArchiveRequest, options CreateJoinedTeamChannelArchiveOperationOptions) (result CreateJoinedTeamChannelArchiveOperationResponse, err error) {
