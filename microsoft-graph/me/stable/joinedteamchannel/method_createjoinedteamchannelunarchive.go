...
func (c JoinedTeamChannelClient) CreateJoinedTeamChannelUnarchive(ctx context.Context, id stable.MeJoinedTeamIdChannelId, options CreateJoinedTeamChannelUnarchiveOperationOptions) (result CreateJoinedTeamChannelUnarchiveOperationResponse, err error) {
