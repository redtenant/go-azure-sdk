...
// GetJoinedTeamChannel - Get channels from me. The collection of channels and messages associated with the team.
func (c JoinedTeamChannelClient) GetJoinedTeamChannel(ctx context.Context, id stable.MeJoinedTeamIdChannelId, options GetJoinedTeamChannelOperationOptions) (result GetJoinedTeamChannelOperationResponse, err error) {
