...
func (c JoinedTeamChannelClient) GetJoinedTeamChannelsCount(ctx context.Context, id stable.MeJoinedTeamId, options GetJoinedTeamChannelsCountOperationOptions) (result GetJoinedTeamChannelsCountOperationResponse, err error) {
