...
// UpdateJoinedTeamChannel - Update the navigation property channels in me
func (c JoinedTeamChannelClient) UpdateJoinedTeamChannel(ctx context.Context, id stable.MeJoinedTeamIdChannelId, input stable.Channel, options UpdateJoinedTeamChannelOperationOptions) (result UpdateJoinedTeamChannelOperationResponse, err error) {
