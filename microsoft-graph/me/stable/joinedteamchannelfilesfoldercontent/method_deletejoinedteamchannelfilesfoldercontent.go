...
// DeleteJoinedTeamChannelFilesFolderContent - Delete content for the navigation property filesFolder in me. The content
// stream, if the item represents a file.
func (c JoinedTeamChannelFilesFolderContentClient) DeleteJoinedTeamChannelFilesFolderContent(ctx context.Context, id stable.MeJoinedTeamIdChannelId, options DeleteJoinedTeamChannelFilesFolderContentOperationOptions) (result DeleteJoinedTeamChannelFilesFolderContentOperationResponse, err error) {
