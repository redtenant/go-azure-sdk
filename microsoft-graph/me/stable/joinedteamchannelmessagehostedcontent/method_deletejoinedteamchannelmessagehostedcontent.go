...
// DeleteJoinedTeamChannelMessageHostedContent - Delete navigation property hostedContents for me
func (c JoinedTeamChannelMessageHostedContentClient) DeleteJoinedTeamChannelMessageHostedContent(ctx context.Context, id stable.MeJoinedTeamIdChannelIdMessageIdHostedContentId, options DeleteJoinedTeamChannelMessageHostedContentOperationOptions) (result DeleteJoinedTeamChannelMessageHostedContentOperationResponse, err error) {
