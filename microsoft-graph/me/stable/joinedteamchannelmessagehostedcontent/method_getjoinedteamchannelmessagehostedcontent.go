...
// GetJoinedTeamChannelMessageHostedContent - Get hostedContents from me. Content in a message hosted by Microsoft Teams
// - for example, images or code snippets.
func (c JoinedTeamChannelMessageHostedContentClient) GetJoinedTeamChannelMessageHostedContent(ctx context.Context, id stable.MeJoinedTeamIdChannelIdMessageIdHostedContentId, options GetJoinedTeamChannelMessageHostedContentOperationOptions) (result GetJoinedTeamChannelMessageHostedContentOperationResponse, err error) {
