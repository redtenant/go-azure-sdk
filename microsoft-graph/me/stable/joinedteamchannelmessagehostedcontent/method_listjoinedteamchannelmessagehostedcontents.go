...
// ListJoinedTeamChannelMessageHostedContents - Get hostedContents from me. Content in a message hosted by Microsoft
// Teams - for example, images or code snippets.
func (c JoinedTeamChannelMessageHostedContentClient) ListJoinedTeamChannelMessageHostedContents(ctx context.Context, id stable.MeJoinedTeamIdChannelIdMessageId, options ListJoinedTeamChannelMessageHostedContentsOperationOptions) (result ListJoinedTeamChannelMessageHostedContentsOperationResponse, err error) {
...
func (c JoinedTeamChannelMessageHostedContentClient) ListJoinedTeamChannelMessageHostedContentsComplete(ctx context.Context, id stable.MeJoinedTeamIdChannelIdMessageId, options ListJoinedTeamChannelMessageHostedContentsOperationOptions) (ListJoinedTeamChannelMessageHostedContentsCompleteResult, error) {
