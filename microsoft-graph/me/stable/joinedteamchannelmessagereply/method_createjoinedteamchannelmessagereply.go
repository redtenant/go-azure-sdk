...
// CreateJoinedTeamChannelMessageReply - Create new navigation property to replies for me
func (c JoinedTeamChannelMessageReplyClient) CreateJoinedTeamChannelMessageReply(ctx context.Context, id stable.MeJoinedTeamIdChannelIdMessageId, input stable.ChatMessage, options CreateJoinedTeamChannelMessageReplyOperationOptions) (result CreateJoinedTeamChannelMessageReplyOperationResponse, err error) {
