...
// ListJoinedTeamChannelMessageReplyHostedContents - Get hostedContents from me. Content in a message hosted by
// Microsoft Teams - for example, images or code snippets.
func (c JoinedTeamChannelMessageReplyHostedContentClient) ListJoinedTeamChannelMessageReplyHostedContents(ctx context.Context, id stable.MeJoinedTeamIdChannelIdMessageIdReplyId, options ListJoinedTeamChannelMessageReplyHostedContentsOperationOptions) (result ListJoinedTeamChannelMessageReplyHostedContentsOperationResponse, err error) {
