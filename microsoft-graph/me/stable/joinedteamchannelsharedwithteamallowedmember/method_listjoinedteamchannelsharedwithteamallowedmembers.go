...
// ListJoinedTeamChannelSharedWithTeamAllowedMembers - Get allowedMembers from me. A collection of team members who have
// access to the shared channel.
func (c JoinedTeamChannelSharedWithTeamAllowedMemberClient) ListJoinedTeamChannelSharedWithTeamAllowedMembers(ctx context.Context, id stable.MeJoinedTeamIdChannelIdSharedWithTeamId, options ListJoinedTeamChannelSharedWithTeamAllowedMembersOperationOptions) (result ListJoinedTeamChannelSharedWithTeamAllowedMembersOperationResponse, err error) {
...
func (c JoinedTeamChannelSharedWithTeamAllowedMemberClient) ListJoinedTeamChannelSharedWithTeamAllowedMembersComplete(ctx context.Context, id stable.MeJoinedTeamIdChannelIdSharedWithTeamId, options ListJoinedTeamChannelSharedWithTeamAllowedMembersOperationOptions) (ListJoinedTeamChannelSharedWithTeamAllowedMembersCompleteResult, error) {
