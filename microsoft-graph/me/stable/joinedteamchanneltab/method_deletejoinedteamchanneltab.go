...
func (c JoinedTeamChannelTabClient) DeleteJoinedTeamChannelTab(ctx context.Context, id stable.MeJoinedTeamIdChannelIdTabId, options DeleteJoinedTeamChannelTabOperationOptions) (result DeleteJoinedTeamChannelTabOperationResponse, err error) {
