...
func (c JoinedTeamIncomingChannelClient) GetJoinedTeamIncomingChannel(ctx context.Context, id stable.MeJoinedTeamIdIncomingChannelId, options GetJoinedTeamIncomingChannelOperationOptions) (result GetJoinedTeamIncomingChannelOperationResponse, err error) {
