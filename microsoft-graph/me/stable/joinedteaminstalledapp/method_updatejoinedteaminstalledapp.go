...
// UpdateJoinedTeamInstalledApp - Update the navigation property installedApps in me
func (c JoinedTeamInstalledAppClient) UpdateJoinedTeamInstalledApp(ctx context.Context, id stable.MeJoinedTeamIdInstalledAppId, input stable.TeamsAppInstallation, options UpdateJoinedTeamInstalledAppOperationOptions) (result UpdateJoinedTeamInstalledAppOperationResponse, err error) {
