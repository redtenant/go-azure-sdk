...
func (c JoinedTeamMemberClient) DeleteJoinedTeamMember(ctx context.Context, id stable.MeJoinedTeamIdMemberId, options DeleteJoinedTeamMemberOperationOptions) (result DeleteJoinedTeamMemberOperationResponse, err error) {
