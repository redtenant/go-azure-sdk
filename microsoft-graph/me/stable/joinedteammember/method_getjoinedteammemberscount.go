...
func (c JoinedTeamMemberClient) GetJoinedTeamMembersCount(ctx context.Context, id stable.MeJoinedTeamId, options GetJoinedTeamMembersCountOperationOptions) (result GetJoinedTeamMembersCountOperationResponse, err error) {
