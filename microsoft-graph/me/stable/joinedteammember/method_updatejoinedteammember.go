...
func (c JoinedTeamMemberClient) UpdateJoinedTeamMember(ctx context.Context, id stable.MeJoinedTeamIdMemberId, input stable.ConversationMember, options UpdateJoinedTeamMemberOperationOptions) (result UpdateJoinedTeamMemberOperationResponse, err error) {
