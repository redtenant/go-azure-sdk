...
// CreateJoinedTeamOperation - Create new navigation property to operations for me
func (c JoinedTeamOperationClient) CreateJoinedTeamOperation(ctx context.Context, id stable.MeJoinedTeamId, input stable.TeamsAsyncOperation, options CreateJoinedTeamOperationOperationOptions) (result CreateJoinedTeamOperationOperationResponse, err error) {
