...
// ListJoinedTeamOperations - Get operations from me. The async operations that ran or are running on this team.
func (c JoinedTeamOperationClient) ListJoinedTeamOperations(ctx context.Context, id stable.MeJoinedTeamId, options ListJoinedTeamOperationsOperationOptions) (result ListJoinedTeamOperationsOperationResponse, err error) {
...
func (c JoinedTeamOperationClient) ListJoinedTeamOperationsComplete(ctx context.Context, id stable.MeJoinedTeamId, options ListJoinedTeamOperationsOperationOptions) (ListJoinedTeamOperationsCompleteResult, error) {
...
func (c JoinedTeamOperationClient) ListJoinedTeamOperationsCompleteMatchingPredicate(ctx context.Context, id stable.MeJoinedTeamId, options ListJoinedTeamOperationsOperationOptions, predicate TeamsAsyncOperationOperationPredicate) (result ListJoinedTeamOperationsCompleteResult, err error) {
