...
// DeleteJoinedTeamPrimaryChannel - Delete navigation property primaryChannel for me
func (c JoinedTeamPrimaryChannelClient) DeleteJoinedTeamPrimaryChannel(ctx context.Context, id stable.MeJoinedTeamId, options DeleteJoinedTeamPrimaryChannelOperationOptions) (result DeleteJoinedTeamPrimaryChannelOperationResponse, err error) {
