...
func (c JoinedTeamPrimaryChannelMemberClient) AddJoinedTeamPrimaryChannelMembers(ctx context.Context, id stable.MeJoinedTeamId, input AddJoinedTeamPrimaryChannelMembersRequest, options AddJoinedTeamPrimaryChannelMembersOperationOptions) (result AddJoinedTeamPrimaryChannelMembersOperationResponse, err error) {
...
func (c JoinedTeamPrimaryChannelMemberClient) AddJoinedTeamPrimaryChannelMembersComplete(ctx context.Context, id stable.MeJoinedTeamId, input AddJoinedTeamPrimaryChannelMembersRequest, options AddJoinedTeamPrimaryChannelMembersOperationOptions) (AddJoinedTeamPrimaryChannelMembersCompleteResult, error) {
