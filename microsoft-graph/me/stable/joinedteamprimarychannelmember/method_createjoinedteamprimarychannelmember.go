...
// CreateJoinedTeamPrimaryChannelMember - Create new navigation property to members for me
func (c JoinedTeamPrimaryChannelMemberClient) CreateJoinedTeamPrimaryChannelMember(ctx context.Context, id stable.MeJoinedTeamId, input stable.ConversationMember, options CreateJoinedTeamPrimaryChannelMemberOperationOptions) (result CreateJoinedTeamPrimaryChannelMemberOperationResponse, err error) {
