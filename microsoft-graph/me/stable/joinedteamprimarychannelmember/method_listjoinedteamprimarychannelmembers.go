...
// ListJoinedTeamPrimaryChannelMembers - Get members from me. A collection of membership records associated with the
// channel.
func (c JoinedTeamPrimaryChannelMemberClient) ListJoinedTeamPrimaryChannelMembers(ctx context.Context, id stable.MeJoinedTeamId, options ListJoinedTeamPrimaryChannelMembersOperationOptions) (result ListJoinedTeamPrimaryChannelMembersOperationResponse, err error) {
...
func (c JoinedTeamPrimaryChannelMemberClient) ListJoinedTeamPrimaryChannelMembersComplete(ctx context.Context, id stable.MeJoinedTeamId, options ListJoinedTeamPrimaryChannelMembersOperationOptions) (ListJoinedTeamPrimaryChannelMembersCompleteResult, error) {
