...
// CreateJoinedTeamPrimaryChannelMessageHostedContent - Create new navigation property to hostedContents for me
func (c JoinedTeamPrimaryChannelMessageHostedContentClient) CreateJoinedTeamPrimaryChannelMessageHostedContent(ctx context.Context, id stable.MeJoinedTeamIdPrimaryChannelMessageId, input stable.ChatMessageHostedContent, options CreateJoinedTeamPrimaryChannelMessageHostedContentOperationOptions) (result CreateJoinedTeamPrimaryChannelMessageHostedContentOperationResponse, err error) {
