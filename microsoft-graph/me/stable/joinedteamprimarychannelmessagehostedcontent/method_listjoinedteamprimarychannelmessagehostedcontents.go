...
// ListJoinedTeamPrimaryChannelMessageHostedContents - Get hostedContents from me. Content in a message hosted by
// Microsoft Teams - for example, images or code snippets.
func (c JoinedTeamPrimaryChannelMessageHostedContentClient) ListJoinedTeamPrimaryChannelMessageHostedContents(ctx context.Context, id stable.MeJoinedTeamIdPrimaryChannelMessageId, options ListJoinedTeamPrimaryChannelMessageHostedContentsOperationOptions) (result ListJoinedTeamPrimaryChannelMessageHostedContentsOperationResponse, err error) {
