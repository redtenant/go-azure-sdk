...
func DefaultGetJoinedTeamPrimaryChannelMessageRepliesCountOperationOptions() GetJoinedTeamPrimaryChannelMessageRepliesCountOperationOptions {
	return GetJoinedTeamPrimaryChannelMessageRepliesCountOperationOptions{}
}
...
func (c JoinedTeamPrimaryChannelMessageReplyClient) GetJoinedTeamPrimaryChannelMessageRepliesCount(ctx context.Context, id stable.MeJoinedTeamIdPrimaryChannelMessageId, options GetJoinedTeamPrimaryChannelMessageRepliesCountOperationOptions) (result GetJoinedTeamPrimaryChannelMessageRepliesCountOperationResponse, err error) {
