...
// ListJoinedTeamPrimaryChannelMessageReplyHostedContents - Get hostedContents from me. Content in a message hosted by
// Microsoft Teams - for example, images or code snippets.
func (c JoinedTeamPrimaryChannelMessageReplyHostedContentClient) ListJoinedTeamPrimaryChannelMessageReplyHostedContents(ctx context.Context, id stable.MeJoinedTeamIdPrimaryChannelMessageIdReplyId, options ListJoinedTeamPrimaryChannelMessageReplyHostedContentsOperationOptions) (result ListJoinedTeamPrimaryChannelMessageReplyHostedContentsOperationResponse, err error) {
...
func (c JoinedTeamPrimaryChannelMessageReplyHostedContentClient) ListJoinedTeamPrimaryChannelMessageReplyHostedContentsComplete(ctx context.Context, id stable.MeJoinedTeamIdPrimaryChannelMessageIdReplyId, options ListJoinedTeamPrimaryChannelMessageReplyHostedContentsOperationOptions) (ListJoinedTeamPrimaryChannelMessageReplyHostedContentsCompleteResult, error) {
...
func (c JoinedTeamPrimaryChannelMessageReplyHostedContentClient) ListJoinedTeamPrimaryChannelMessageReplyHostedContentsCompleteMatchingPredicate(ctx context.Context, id stable.MeJoinedTeamIdPrimaryChannelMessageIdReplyId, options ListJoinedTeamPrimaryChannelMessageReplyHostedContentsOperationOptions, predicate ChatMessageHostedContentOperationPredicate) (result ListJoinedTeamPrimaryChannelMessageReplyHostedContentsCompleteResult, err error) {
