...
// GetJoinedTeamPrimaryChannelSharedWithTeam - Get sharedWithTeams from me. A collection of teams with which a channel
// is shared.
func (c JoinedTeamPrimaryChannelSharedWithTeamClient) GetJoinedTeamPrimaryChannelSharedWithTeam(ctx context.Context, id stable.MeJoinedTeamIdPrimaryChannelSharedWithTeamId, options GetJoinedTeamPrimaryChannelSharedWithTeamOperationOptions) (result GetJoinedTeamPrimaryChannelSharedWithTeamOperationResponse, err error) {
