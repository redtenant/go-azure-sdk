...
// ListJoinedTeamPrimaryChannelSharedWithTeamAllowedMembers - Get allowedMembers from me. A collection of team members
// who have access to the shared channel.
func (c JoinedTeamPrimaryChannelSharedWithTeamAllowedMemberClient) ListJoinedTeamPrimaryChannelSharedWithTeamAllowedMembers(ctx context.Context, id stable.MeJoinedTeamIdPrimaryChannelSharedWithTeamId, options ListJoinedTeamPrimaryChannelSharedWithTeamAllowedMembersOperationOptions) (result ListJoinedTeamPrimaryChannelSharedWithTeamAllowedMembersOperationResponse, err error) {
...
func (c JoinedTeamPrimaryChannelSharedWithTeamAllowedMemberClient) ListJoinedTeamPrimaryChannelSharedWithTeamAllowedMembersComplete(ctx context.Context, id stable.MeJoinedTeamIdPrimaryChannelSharedWithTeamId, options ListJoinedTeamPrimaryChannelSharedWithTeamAllowedMembersOperationOptions) (ListJoinedTeamPrimaryChannelSharedWithTeamAllowedMembersCompleteResult, error) {
...
func (c JoinedTeamPrimaryChannelSharedWithTeamAllowedMemberClient) ListJoinedTeamPrimaryChannelSharedWithTeamAllowedMembersCompleteMatchingPredicate(ctx context.Context, id stable.MeJoinedTeamIdPrimaryChannelSharedWithTeamId, options ListJoinedTeamPrimaryChannelSharedWithTeamAllowedMembersOperationOptions, predicate ConversationMemberOperationPredicate) (result ListJoinedTeamPrimaryChannelSharedWithTeamAllowedMembersCompleteResult, err error) {
