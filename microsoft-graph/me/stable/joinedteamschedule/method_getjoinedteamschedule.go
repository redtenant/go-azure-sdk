...
func DefaultGetJoinedTeamScheduleOperationOptions() GetJoinedTeamScheduleOperationOptions {
	return GetJoinedTeamScheduleOperationOptions{}
}
...
// GetJoinedTeamSchedule - Get schedule from me. The schedule of shifts for this team.
func (c JoinedTeamScheduleClient) GetJoinedTeamSchedule(ctx context.Context, id stable.MeJoinedTeamId, options GetJoinedTeamScheduleOperationOptions) (result GetJoinedTeamScheduleOperationResponse, err error) {
