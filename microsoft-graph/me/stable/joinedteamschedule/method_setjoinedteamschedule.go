...
// SetJoinedTeamSchedule - Update the navigation property schedule in me
func (c JoinedTeamScheduleClient) SetJoinedTeamSchedule(ctx context.Context, id stable.MeJoinedTeamId, input stable.Schedule, options SetJoinedTeamScheduleOperationOptions) (result SetJoinedTeamScheduleOperationResponse, err error) {
