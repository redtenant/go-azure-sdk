...
func (c JoinedTeamScheduleOfferShiftRequestClient) GetJoinedTeamScheduleOfferShiftRequestsCount(ctx context.Context, id stable.MeJoinedTeamId, options GetJoinedTeamScheduleOfferShiftRequestsCountOperationOptions) (result GetJoinedTeamScheduleOfferShiftRequestsCountOperationResponse, err error) {
