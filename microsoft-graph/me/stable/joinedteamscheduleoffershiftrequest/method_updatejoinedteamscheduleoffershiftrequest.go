...
// UpdateJoinedTeamScheduleOfferShiftRequest - Update the navigation property offerShiftRequests in me
func (c JoinedTeamScheduleOfferShiftRequestClient) UpdateJoinedTeamScheduleOfferShiftRequest(ctx context.Context, id stable.MeJoinedTeamIdScheduleOfferShiftRequestId, input stable.OfferShiftRequest, options UpdateJoinedTeamScheduleOfferShiftRequestOperationOptions) (result UpdateJoinedTeamScheduleOfferShiftRequestOperationResponse, err error) {
