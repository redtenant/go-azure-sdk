...
// GetJoinedTeamScheduleOpenShift - Get openShifts from me. The set of open shifts in a scheduling group in the
// schedule.
func (c JoinedTeamScheduleOpenShiftClient) GetJoinedTeamScheduleOpenShift(ctx context.Context, id stable.MeJoinedTeamIdScheduleOpenShiftId, options GetJoinedTeamScheduleOpenShiftOperationOptions) (result GetJoinedTeamScheduleOpenShiftOperationResponse, err error) {
