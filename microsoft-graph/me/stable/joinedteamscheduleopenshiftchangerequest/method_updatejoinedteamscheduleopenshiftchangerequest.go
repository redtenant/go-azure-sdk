...
// UpdateJoinedTeamScheduleOpenShiftChangeRequest - Update the navigation property openShiftChangeRequests in me
func (c JoinedTeamScheduleOpenShiftChangeRequestClient) UpdateJoinedTeamScheduleOpenShiftChangeRequest(ctx context.Context, id stable.MeJoinedTeamIdScheduleOpenShiftChangeRequestId, input stable.OpenShiftChangeRequest, options UpdateJoinedTeamScheduleOpenShiftChangeRequestOperationOptions) (result UpdateJoinedTeamScheduleOpenShiftChangeRequestOperationResponse, err error) {
