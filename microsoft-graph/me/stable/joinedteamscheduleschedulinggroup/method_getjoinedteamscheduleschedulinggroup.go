...
// GetJoinedTeamScheduleSchedulingGroup - Get schedulingGroups from me. The logical grouping of users in the schedule
// (usually by role).
func (c JoinedTeamScheduleSchedulingGroupClient) GetJoinedTeamScheduleSchedulingGroup(ctx context.Context, id stable.MeJoinedTeamIdScheduleSchedulingGroupId, options GetJoinedTeamScheduleSchedulingGroupOperationOptions) (result GetJoinedTeamScheduleSchedulingGroupOperationResponse, err error) {
