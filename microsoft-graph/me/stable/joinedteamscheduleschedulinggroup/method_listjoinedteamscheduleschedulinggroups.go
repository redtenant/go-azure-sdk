...
// ListJoinedTeamScheduleSchedulingGroups - Get schedulingGroups from me. The logical grouping of users in the schedule
// (usually by role).
func (c JoinedTeamScheduleSchedulingGroupClient) ListJoinedTeamScheduleSchedulingGroups(ctx context.Context, id stable.MeJoinedTeamId, options ListJoinedTeamScheduleSchedulingGroupsOperationOptions) (result ListJoinedTeamScheduleSchedulingGroupsOperationResponse, err error) {
...
func (c JoinedTeamScheduleSchedulingGroupClient) ListJoinedTeamScheduleSchedulingGroupsComplete(ctx context.Context, id stable.MeJoinedTeamId, options ListJoinedTeamScheduleSchedulingGroupsOperationOptions) (ListJoinedTeamScheduleSchedulingGroupsCompleteResult, error) {
...
func (c JoinedTeamScheduleSchedulingGroupClient) ListJoinedTeamScheduleSchedulingGroupsCompleteMatchingPredicate(ctx context.Context, id stable.MeJoinedTeamId, options ListJoinedTeamScheduleSchedulingGroupsOperationOptions, predicate SchedulingGroupOperationPredicate) (result ListJoinedTeamScheduleSchedulingGroupsCompleteResult, err error) {
