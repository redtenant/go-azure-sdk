...
func (c JoinedTeamScheduleShiftClient) GetJoinedTeamScheduleShiftsCount(ctx context.Context, id stable.MeJoinedTeamId, options GetJoinedTeamScheduleShiftsCountOperationOptions) (result GetJoinedTeamScheduleShiftsCountOperationResponse, err error) {
