...
// UpdateJoinedTeamScheduleSwapShiftsChangeRequest - Update the navigation property swapShiftsChangeRequests in me
func (c JoinedTeamScheduleSwapShiftsChangeRequestClient) UpdateJoinedTeamScheduleSwapShiftsChangeRequest(ctx context.Context, id stable.MeJoinedTeamIdScheduleSwapShiftsChangeRequestId, input stable.SwapShiftsChangeRequest, options UpdateJoinedTeamScheduleSwapShiftsChangeRequestOperationOptions) (result UpdateJoinedTeamScheduleSwapShiftsChangeRequestOperationResponse, err error) {
