...
// CreateJoinedTeamScheduleTimeOffReason - Create new navigation property to timeOffReasons for me
func (c JoinedTeamScheduleTimeOffReasonClient) CreateJoinedTeamScheduleTimeOffReason(ctx context.Context, id stable.MeJoinedTeamId, input stable.TimeOffReason, options CreateJoinedTeamScheduleTimeOffReasonOperationOptions) (result CreateJoinedTeamScheduleTimeOffReasonOperationResponse, err error) {
