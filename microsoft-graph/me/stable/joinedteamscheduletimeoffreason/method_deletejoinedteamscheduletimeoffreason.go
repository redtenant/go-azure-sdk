...
// DeleteJoinedTeamScheduleTimeOffReason - Delete navigation property timeOffReasons for me
func (c JoinedTeamScheduleTimeOffReasonClient) DeleteJoinedTeamScheduleTimeOffReason(ctx context.Context, id stable.MeJoinedTeamIdScheduleTimeOffReasonId, options DeleteJoinedTeamScheduleTimeOffReasonOperationOptions) (result DeleteJoinedTeamScheduleTimeOffReasonOperationResponse, err error) {
