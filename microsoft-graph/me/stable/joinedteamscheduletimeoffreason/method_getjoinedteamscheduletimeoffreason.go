...
// GetJoinedTeamScheduleTimeOffReason - Get timeOffReasons from me. The set of reasons for a time off in the schedule.
func (c JoinedTeamScheduleTimeOffReasonClient) GetJoinedTeamScheduleTimeOffReason(ctx context.Context, id stable.MeJoinedTeamIdScheduleTimeOffReasonId, options GetJoinedTeamScheduleTimeOffReasonOperationOptions) (result GetJoinedTeamScheduleTimeOffReasonOperationResponse, err error) {
