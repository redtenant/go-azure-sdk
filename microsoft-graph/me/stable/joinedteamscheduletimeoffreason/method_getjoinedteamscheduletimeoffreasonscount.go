...
func (c JoinedTeamScheduleTimeOffReasonClient) GetJoinedTeamScheduleTimeOffReasonsCount(ctx context.Context, id stable.MeJoinedTeamId, options GetJoinedTeamScheduleTimeOffReasonsCountOperationOptions) (result GetJoinedTeamScheduleTimeOffReasonsCountOperationResponse, err error) {
