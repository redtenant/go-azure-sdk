...
// UpdateJoinedTeamScheduleTimeOffReason - Update the navigation property timeOffReasons in me
func (c JoinedTeamScheduleTimeOffReasonClient) UpdateJoinedTeamScheduleTimeOffReason(ctx context.Context, id stable.MeJoinedTeamIdScheduleTimeOffReasonId, input stable.TimeOffReason, options UpdateJoinedTeamScheduleTimeOffReasonOperationOptions) (result UpdateJoinedTeamScheduleTimeOffReasonOperationResponse, err error) {
