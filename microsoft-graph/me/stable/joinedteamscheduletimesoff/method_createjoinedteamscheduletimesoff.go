...
// CreateJoinedTeamScheduleTimesOff - Create new navigation property to timesOff for me
func (c JoinedTeamScheduleTimesOffClient) CreateJoinedTeamScheduleTimesOff(ctx context.Context, id stable.MeJoinedTeamId, input stable.TimeOff, options CreateJoinedTeamScheduleTimesOffOperationOptions) (result CreateJoinedTeamScheduleTimesOffOperationResponse, err error) {
