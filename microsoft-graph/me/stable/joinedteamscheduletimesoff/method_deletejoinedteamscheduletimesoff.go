...
// DeleteJoinedTeamScheduleTimesOff - Delete navigation property timesOff for me
func (c JoinedTeamScheduleTimesOffClient) DeleteJoinedTeamScheduleTimesOff(ctx context.Context, id stable.MeJoinedTeamIdScheduleTimesOffId, options DeleteJoinedTeamScheduleTimesOffOperationOptions) (result DeleteJoinedTeamScheduleTimesOffOperationResponse, err error) {
