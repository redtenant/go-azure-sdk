...
func DefaultGetJoinedTeamScheduleTimesOffOperationOptions() GetJoinedTeamScheduleTimesOffOperationOptions {
	return GetJoinedTeamScheduleTimesOffOperationOptions{}
}
...
// GetJoinedTeamScheduleTimesOff - Get timesOff from me. The instances of times off in the schedule.
func (c JoinedTeamScheduleTimesOffClient) GetJoinedTeamScheduleTimesOff(ctx context.Context, id stable.MeJoinedTeamIdScheduleTimesOffId, options GetJoinedTeamScheduleTimesOffOperationOptions) (result GetJoinedTeamScheduleTimesOffOperationResponse, err error) {
