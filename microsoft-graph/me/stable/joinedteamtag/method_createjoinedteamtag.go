...
func (c JoinedTeamTagClient) CreateJoinedTeamTag(ctx context.Context, id stable.MeJoinedTeamId, input stable.TeamworkTag, options CreateJoinedTeamTagOperationOptions) (result CreateJoinedTeamTagOperationResponse, err error) {
