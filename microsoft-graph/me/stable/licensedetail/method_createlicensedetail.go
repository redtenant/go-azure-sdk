...
func (c LicenseDetailClient) CreateLicenseDetail(ctx context.Context, input stable.LicenseDetails, options CreateLicenseDetailOperationOptions) (result CreateLicenseDetailOperationResponse, err error) {
