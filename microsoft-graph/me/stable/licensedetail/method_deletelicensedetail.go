...
func (c LicenseDetailClient) DeleteLicenseDetail(ctx context.Context, id stable.MeLicenseDetailId, options DeleteLicenseDetailOperationOptions) (result DeleteLicenseDetailOperationResponse, err error) {
