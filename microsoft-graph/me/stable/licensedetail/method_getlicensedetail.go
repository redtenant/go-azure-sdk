...
func (c LicenseDetailClient) GetLicenseDetail(ctx context.Context, id stable.MeLicenseDetailId, options GetLicenseDetailOperationOptions) (result GetLicenseDetailOperationResponse, err error) {
