...
// ListLicenseDetails - List licenseDetails. Retrieve a list of licenseDetails objects for enterprise users. This API
// returns details for licenses that are directly assigned and those transitively assigned through memberships in
// licensed groups.
...
func (c LicenseDetailClient) ListLicenseDetailsComplete(ctx context.Context, options ListLicenseDetailsOperationOptions) (ListLicenseDetailsCompleteResult, error) {
	return c.ListLicenseDetailsCompleteMatchingPredicate(ctx, options, LicenseDetailsOperationPredicate{})
}
...
func (c LicenseDetailClient) ListLicenseDetailsCompleteMatchingPredicate(ctx context.Context, options ListLicenseDetailsOperationOptions, predicate LicenseDetailsOperationPredicate) (result ListLicenseDetailsCompleteResult, err error) {
	...
	resp, err := c.ListLicenseDetails(ctx, options)
	if err != nil {
