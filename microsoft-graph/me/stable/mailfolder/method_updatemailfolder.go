...
func (c MailFolderClient) UpdateMailFolder(ctx context.Context, id stable.MeMailFolderId, input stable.MailFolder, options UpdateMailFolderOperationOptions) (result UpdateMailFolderOperationResponse, err error) {
