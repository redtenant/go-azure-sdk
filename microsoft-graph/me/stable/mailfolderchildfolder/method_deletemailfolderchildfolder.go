...
func (c MailFolderChildFolderClient) DeleteMailFolderChildFolder(ctx context.Context, id stable.MeMailFolderIdChildFolderId, options DeleteMailFolderChildFolderOperationOptions) (result DeleteMailFolderChildFolderOperationResponse, err error) {
