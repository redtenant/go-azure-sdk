...
func (c MailFolderChildFolderClient) GetMailFolderChildFolder(ctx context.Context, id stable.MeMailFolderIdChildFolderId, options GetMailFolderChildFolderOperationOptions) (result GetMailFolderChildFolderOperationResponse, err error) {
