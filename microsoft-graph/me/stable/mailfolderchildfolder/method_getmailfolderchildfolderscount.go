...
func (c MailFolderChildFolderClient) GetMailFolderChildFoldersCount(ctx context.Context, id stable.MeMailFolderId, options GetMailFolderChildFoldersCountOperationOptions) (result GetMailFolderChildFoldersCountOperationResponse, err error) {
