...
// ListMailFolderChildFolders - List childFolders. Get the folder collection under the specified folder. You can use the
// .../me/mailFolders shortcut to get the top-level folder collection and navigate to another folder. By default, this
// operation does not return hidden folders. Use a query parameter includeHiddenFolders to include them in the response.
func (c MailFolderChildFolderClient) ListMailFolderChildFolders(ctx context.Context, id stable.MeMailFolderId, options ListMailFolderChildFoldersOperationOptions) (result ListMailFolderChildFoldersOperationResponse, err error) {
...
func (c MailFolderChildFolderClient) ListMailFolderChildFoldersComplete(ctx context.Context, id stable.MeMailFolderId, options ListMailFolderChildFoldersOperationOptions) (ListMailFolderChildFoldersCompleteResult, error) {
...
func (c MailFolderChildFolderClient) ListMailFolderChildFoldersCompleteMatchingPredicate(ctx context.Context, id stable.MeMailFolderId, options ListMailFolderChildFoldersOperationOptions, predicate MailFolderOperationPredicate) (result ListMailFolderChildFoldersCompleteResult, err error) {
