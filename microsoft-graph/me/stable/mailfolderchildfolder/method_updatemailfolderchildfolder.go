...
func (c MailFolderChildFolderClient) UpdateMailFolderChildFolder(ctx context.Context, id stable.MeMailFolderIdChildFolderId, input stable.MailFolder, options UpdateMailFolderChildFolderOperationOptions) (result UpdateMailFolderChildFolderOperationResponse, err error) {
