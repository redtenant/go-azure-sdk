...
func (c MailFolderChildFolderMessageClient) CreateMailFolderChildFolderMessage(ctx context.Context, id stable.MeMailFolderIdChildFolderId, input stable.Message, options CreateMailFolderChildFolderMessageOperationOptions) (result CreateMailFolderChildFolderMessageOperationResponse, err error) {
