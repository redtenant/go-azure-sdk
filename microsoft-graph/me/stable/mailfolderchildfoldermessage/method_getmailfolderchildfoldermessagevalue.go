...
// GetMailFolderChildFolderMessageValue - Get media content for the navigation property messages from me. The unique
// identifier for an entity. Read-only.
func (c MailFolderChildFolderMessageClient) GetMailFolderChildFolderMessageValue(ctx context.Context, id stable.MeMailFolderIdChildFolderIdMessageId, options GetMailFolderChildFolderMessageValueOperationOptions) (result GetMailFolderChildFolderMessageValueOperationResponse, err error) {
