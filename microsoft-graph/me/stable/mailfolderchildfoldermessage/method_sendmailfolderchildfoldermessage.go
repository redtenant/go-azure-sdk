...
func (c MailFolderChildFolderMessageClient) SendMailFolderChildFolderMessage(ctx context.Context, id stable.MeMailFolderIdChildFolderIdMessageId, options SendMailFolderChildFolderMessageOperationOptions) (result SendMailFolderChildFolderMessageOperationResponse, err error) {
