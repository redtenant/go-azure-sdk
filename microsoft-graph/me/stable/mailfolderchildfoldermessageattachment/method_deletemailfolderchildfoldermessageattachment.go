...
func DefaultDeleteMailFolderChildFolderMessageAttachmentOperationOptions() DeleteMailFolderChildFolderMessageAttachmentOperationOptions {
	return DeleteMailFolderChildFolderMessageAttachmentOperationOptions{}
}
...
// DeleteMailFolderChildFolderMessageAttachment - Delete navigation property attachments for me
func (c MailFolderChildFolderMessageAttachmentClient) DeleteMailFolderChildFolderMessageAttachment(ctx context.Context, id stable.MeMailFolderIdChildFolderIdMessageIdAttachmentId, options DeleteMailFolderChildFolderMessageAttachmentOperationOptions) (result DeleteMailFolderChildFolderMessageAttachmentOperationResponse, err error) {
