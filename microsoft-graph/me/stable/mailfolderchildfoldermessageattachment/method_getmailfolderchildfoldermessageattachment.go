...
// GetMailFolderChildFolderMessageAttachment - Get attachments from me. The fileAttachment and itemAttachment
// attachments for the message.
func (c MailFolderChildFolderMessageAttachmentClient) GetMailFolderChildFolderMessageAttachment(ctx context.Context, id stable.MeMailFolderIdChildFolderIdMessageIdAttachmentId, options GetMailFolderChildFolderMessageAttachmentOperationOptions) (result GetMailFolderChildFolderMessageAttachmentOperationResponse, err error) {
