...
func (c MailFolderChildFolderMessageRuleClient) CreateMailFolderChildFolderMessageRule(ctx context.Context, id stable.MeMailFolderIdChildFolderId, input stable.MessageRule, options CreateMailFolderChildFolderMessageRuleOperationOptions) (result CreateMailFolderChildFolderMessageRuleOperationResponse, err error) {
