...
// GetMailFolderChildFolderMessageRule - Get messageRules from me. The collection of rules that apply to the user's
// Inbox folder.
func (c MailFolderChildFolderMessageRuleClient) GetMailFolderChildFolderMessageRule(ctx context.Context, id stable.MeMailFolderIdChildFolderIdMessageRuleId, options GetMailFolderChildFolderMessageRuleOperationOptions) (result GetMailFolderChildFolderMessageRuleOperationResponse, err error) {
