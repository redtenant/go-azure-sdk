...
func (c MailFolderChildFolderMessageRuleClient) GetMailFolderChildFolderMessageRulesCount(ctx context.Context, id stable.MeMailFolderIdChildFolderId, options GetMailFolderChildFolderMessageRulesCountOperationOptions) (result GetMailFolderChildFolderMessageRulesCountOperationResponse, err error) {
