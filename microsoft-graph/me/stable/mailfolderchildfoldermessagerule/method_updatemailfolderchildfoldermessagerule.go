...
func (c MailFolderChildFolderMessageRuleClient) UpdateMailFolderChildFolderMessageRule(ctx context.Context, id stable.MeMailFolderIdChildFolderIdMessageRuleId, input stable.MessageRule, options UpdateMailFolderChildFolderMessageRuleOperationOptions) (result UpdateMailFolderChildFolderMessageRuleOperationResponse, err error) {
