...
func (c MailFolderMessageClient) CopyMailFolderMessage(ctx context.Context, id stable.MeMailFolderIdMessageId, input CopyMailFolderMessageRequest, options CopyMailFolderMessageOperationOptions) (result CopyMailFolderMessageOperationResponse, err error) {
