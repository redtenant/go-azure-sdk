...
func (c MailFolderMessageClient) CreateMailFolderMessageForward(ctx context.Context, id stable.MeMailFolderIdMessageId, input CreateMailFolderMessageForwardRequest, options CreateMailFolderMessageForwardOperationOptions) (result CreateMailFolderMessageForwardOperationResponse, err error) {
