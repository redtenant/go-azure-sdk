...
func (c MailFolderMessageClient) CreateMailFolderMessageReply(ctx context.Context, id stable.MeMailFolderIdMessageId, input CreateMailFolderMessageReplyRequest, options CreateMailFolderMessageReplyOperationOptions) (result CreateMailFolderMessageReplyOperationResponse, err error) {
