...
func (c MailFolderMessageClient) CreateMailFolderMessageReplyAll(ctx context.Context, id stable.MeMailFolderIdMessageId, input CreateMailFolderMessageReplyAllRequest, options CreateMailFolderMessageReplyAllOperationOptions) (result CreateMailFolderMessageReplyAllOperationResponse, err error) {
