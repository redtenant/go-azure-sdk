...
func (c MailFolderMessageClient) DeleteMailFolderMessage(ctx context.Context, id stable.MeMailFolderIdMessageId, options DeleteMailFolderMessageOperationOptions) (result DeleteMailFolderMessageOperationResponse, err error) {
