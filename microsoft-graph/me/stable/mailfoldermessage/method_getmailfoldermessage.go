...
func (c MailFolderMessageClient) GetMailFolderMessage(ctx context.Context, id stable.MeMailFolderIdMessageId, options GetMailFolderMessageOperationOptions) (result GetMailFolderMessageOperationResponse, err error) {
