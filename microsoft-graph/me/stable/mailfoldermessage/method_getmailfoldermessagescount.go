...
func (c MailFolderMessageClient) GetMailFolderMessagesCount(ctx context.Context, id stable.MeMailFolderId, options GetMailFolderMessagesCountOperationOptions) (result GetMailFolderMessagesCountOperationResponse, err error) {
