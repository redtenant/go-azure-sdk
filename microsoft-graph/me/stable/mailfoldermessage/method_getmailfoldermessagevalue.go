...
// GetMailFolderMessageValue - List messages. Get all the messages in the specified user's mailbox, or those messages in
// a specified folder in the mailbox.
func (c MailFolderMessageClient) GetMailFolderMessageValue(ctx context.Context, id stable.MeMailFolderIdMessageId, options GetMailFolderMessageValueOperationOptions) (result GetMailFolderMessageValueOperationResponse, err error) {
