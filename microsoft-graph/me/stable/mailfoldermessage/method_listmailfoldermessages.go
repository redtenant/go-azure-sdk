...
// ListMailFolderMessages - List messages. Get all the messages in the specified user's mailbox, or those messages in a
// specified folder in the mailbox.
func (c MailFolderMessageClient) ListMailFolderMessages(ctx context.Context, id stable.MeMailFolderId, options ListMailFolderMessagesOperationOptions) (result ListMailFolderMessagesOperationResponse, err error) {
...
func (c MailFolderMessageClient) ListMailFolderMessagesComplete(ctx context.Context, id stable.MeMailFolderId, options ListMailFolderMessagesOperationOptions) (ListMailFolderMessagesCompleteResult, error) {
