...
func (c MailFolderMessageClient) MoveMailFolderMessage(ctx context.Context, id stable.MeMailFolderIdMessageId, input MoveMailFolderMessageRequest, options MoveMailFolderMessageOperationOptions) (result MoveMailFolderMessageOperationResponse, err error) {
