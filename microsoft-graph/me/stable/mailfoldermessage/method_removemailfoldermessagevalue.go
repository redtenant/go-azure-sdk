...
// RemoveMailFolderMessageValue - Delete media content for the navigation property messages in me. The unique identifier
// for an entity. Read-only.
func (c MailFolderMessageClient) RemoveMailFolderMessageValue(ctx context.Context, id stable.MeMailFolderIdMessageId, options RemoveMailFolderMessageValueOperationOptions) (result RemoveMailFolderMessageValueOperationResponse, err error) {
