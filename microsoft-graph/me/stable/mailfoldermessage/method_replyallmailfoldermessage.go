...
// send it later.
func (c MailFolderMessageClient) ReplyAllMailFolderMessage(ctx context.Context, id stable.MeMailFolderIdMessageId, input ReplyAllMailFolderMessageRequest, options ReplyAllMailFolderMessageOperationOptions) (result ReplyAllMailFolderMessageOperationResponse, err error) {
