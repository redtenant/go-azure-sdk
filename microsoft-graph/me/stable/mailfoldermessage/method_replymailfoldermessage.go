...
// later.
func (c MailFolderMessageClient) ReplyMailFolderMessage(ctx context.Context, id stable.MeMailFolderIdMessageId, input ReplyMailFolderMessageRequest, options ReplyMailFolderMessageOperationOptions) (result ReplyMailFolderMessageOperationResponse, err error) {
