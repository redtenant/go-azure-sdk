...
func (c MailFolderMessageClient) SetMailFolderMessageValue(ctx context.Context, id stable.MeMailFolderIdMessageId, input []byte, options SetMailFolderMessageValueOperationOptions) (result SetMailFolderMessageValueOperationResponse, err error) {
