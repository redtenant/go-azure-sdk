...
func (c MailFolderMessageClient) UpdateMailFolderMessage(ctx context.Context, id stable.MeMailFolderIdMessageId, input stable.Message, options UpdateMailFolderMessageOperationOptions) (result UpdateMailFolderMessageOperationResponse, err error) {
