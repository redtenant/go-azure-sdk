...
// message.
func (c MailFolderMessageAttachmentClient) GetMailFolderMessageAttachment(ctx context.Context, id stable.MeMailFolderIdMessageIdAttachmentId, options GetMailFolderMessageAttachmentOperationOptions) (result GetMailFolderMessageAttachmentOperationResponse, err error) {
