...
func (c MailFolderMessageAttachmentClient) GetMailFolderMessageAttachmentsCount(ctx context.Context, id stable.MeMailFolderIdMessageId, options GetMailFolderMessageAttachmentsCountOperationOptions) (result GetMailFolderMessageAttachmentsCountOperationResponse, err error) {
