...
// message.
func (c MailFolderMessageAttachmentClient) ListMailFolderMessageAttachments(ctx context.Context, id stable.MeMailFolderIdMessageId, options ListMailFolderMessageAttachmentsOperationOptions) (result ListMailFolderMessageAttachmentsOperationResponse, err error) {
...
func (c MailFolderMessageAttachmentClient) ListMailFolderMessageAttachmentsComplete(ctx context.Context, id stable.MeMailFolderIdMessageId, options ListMailFolderMessageAttachmentsOperationOptions) (ListMailFolderMessageAttachmentsCompleteResult, error) {
...
func (c MailFolderMessageAttachmentClient) ListMailFolderMessageAttachmentsCompleteMatchingPredicate(ctx context.Context, id stable.MeMailFolderIdMessageId, options ListMailFolderMessageAttachmentsOperationOptions, predicate AttachmentOperationPredicate) (result ListMailFolderMessageAttachmentsCompleteResult, err error) {
