...
func (c MailFolderMessageExtensionClient) GetMailFolderMessageExtensionsCount(ctx context.Context, id stable.MeMailFolderIdMessageId, options GetMailFolderMessageExtensionsCountOperationOptions) (result GetMailFolderMessageExtensionsCountOperationResponse, err error) {
