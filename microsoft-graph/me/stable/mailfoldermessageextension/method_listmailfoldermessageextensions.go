...
// Nullable.
func (c MailFolderMessageExtensionClient) ListMailFolderMessageExtensions(ctx context.Context, id stable.MeMailFolderIdMessageId, options ListMailFolderMessageExtensionsOperationOptions) (result ListMailFolderMessageExtensionsOperationResponse, err error) {
...
func (c MailFolderMessageExtensionClient) ListMailFolderMessageExtensionsComplete(ctx context.Context, id stable.MeMailFolderIdMessageId, options ListMailFolderMessageExtensionsOperationOptions) (ListMailFolderMessageExtensionsCompleteResult, error) {
