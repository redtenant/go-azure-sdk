...
func (c ManagedDeviceClient) CreateManagedDeviceWindowsDefenderScan(ctx context.Context, id stable.MeManagedDeviceId, input CreateManagedDeviceWindowsDefenderScanRequest, options CreateManagedDeviceWindowsDefenderScanOperationOptions) (result CreateManagedDeviceWindowsDefenderScanOperationResponse, err error) {
