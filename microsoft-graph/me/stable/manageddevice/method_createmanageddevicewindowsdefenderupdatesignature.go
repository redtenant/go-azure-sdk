...
func (c ManagedDeviceClient) CreateManagedDeviceWindowsDefenderUpdateSignature(ctx context.Context, id stable.MeManagedDeviceId, options CreateManagedDeviceWindowsDefenderUpdateSignatureOperationOptions) (result CreateManagedDeviceWindowsDefenderUpdateSignatureOperationResponse, err error) {
