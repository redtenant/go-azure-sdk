...
// Apple device
func (c ManagedDeviceClient) DeleteManagedDeviceUserFromSharedAppleDevice(ctx context.Context, id stable.MeManagedDeviceId, input DeleteManagedDeviceUserFromSharedAppleDeviceRequest, options DeleteManagedDeviceUserFromSharedAppleDeviceOperationOptions) (result DeleteManagedDeviceUserFromSharedAppleDeviceOperationResponse, err error) {
