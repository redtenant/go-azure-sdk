...
func (c ManagedDeviceClient) GetManagedDevice(ctx context.Context, id stable.MeManagedDeviceId, options GetManagedDeviceOperationOptions) (result GetManagedDeviceOperationResponse, err error) {
