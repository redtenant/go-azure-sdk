...
func (c ManagedDeviceClient) RemoteLockManagedDevice(ctx context.Context, id stable.MeManagedDeviceId, options RemoteLockManagedDeviceOperationOptions) (result RemoteLockManagedDeviceOperationResponse, err error) {
