...
func (c ManagedDeviceClient) RequestManagedDeviceRemoteAssistance(ctx context.Context, id stable.MeManagedDeviceId, options RequestManagedDeviceRemoteAssistanceOperationOptions) (result RequestManagedDeviceRemoteAssistanceOperationResponse, err error) {
