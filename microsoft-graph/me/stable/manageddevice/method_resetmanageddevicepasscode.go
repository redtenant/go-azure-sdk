...
func (c ManagedDeviceClient) ResetManagedDevicePasscode(ctx context.Context, id stable.MeManagedDeviceId, options ResetManagedDevicePasscodeOperationOptions) (result ResetManagedDevicePasscodeOperationResponse, err error) {
