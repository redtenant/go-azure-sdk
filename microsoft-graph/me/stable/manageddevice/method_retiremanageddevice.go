...
func (c ManagedDeviceClient) RetireManagedDevice(ctx context.Context, id stable.MeManagedDeviceId, options RetireManagedDeviceOperationOptions) (result RetireManagedDeviceOperationResponse, err error) {
