...
func (c ManagedDeviceClient) SyncManagedDeviceDevice(ctx context.Context, id stable.MeManagedDeviceId, options SyncManagedDeviceDeviceOperationOptions) (result SyncManagedDeviceDeviceOperationResponse, err error) {
