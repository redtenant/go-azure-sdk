...
func (c ManagedDeviceClient) UpdateManagedDevice(ctx context.Context, id stable.MeManagedDeviceId, input stable.ManagedDevice, options UpdateManagedDeviceOperationOptions) (result UpdateManagedDeviceOperationResponse, err error) {
