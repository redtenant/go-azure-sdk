...
func (c ManagedDeviceClient) UpdateManagedDeviceWindowsDeviceAccount(ctx context.Context, id stable.MeManagedDeviceId, input UpdateManagedDeviceWindowsDeviceAccountRequest, options UpdateManagedDeviceWindowsDeviceAccountOperationOptions) (result UpdateManagedDeviceWindowsDeviceAccountOperationResponse, err error) {
