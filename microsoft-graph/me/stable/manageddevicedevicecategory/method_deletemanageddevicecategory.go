...
func (c ManagedDeviceDeviceCategoryClient) DeleteManagedDeviceCategory(ctx context.Context, id stable.MeManagedDeviceId, options DeleteManagedDeviceCategoryOperationOptions) (result DeleteManagedDeviceCategoryOperationResponse, err error) {
