...
func (c ManagedDeviceDeviceCategoryClient) UpdateManagedDeviceCategory(ctx context.Context, id stable.MeManagedDeviceId, input stable.DeviceCategory, options UpdateManagedDeviceCategoryOperationOptions) (result UpdateManagedDeviceCategoryOperationResponse, err error) {
