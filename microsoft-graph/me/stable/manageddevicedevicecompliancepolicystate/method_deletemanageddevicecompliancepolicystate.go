...
// DeleteManagedDeviceCompliancePolicyState - Delete navigation property deviceCompliancePolicyStates for me
func (c ManagedDeviceDeviceCompliancePolicyStateClient) DeleteManagedDeviceCompliancePolicyState(ctx context.Context, id stable.MeManagedDeviceIdDeviceCompliancePolicyStateId, options DeleteManagedDeviceCompliancePolicyStateOperationOptions) (result DeleteManagedDeviceCompliancePolicyStateOperationResponse, err error) {
