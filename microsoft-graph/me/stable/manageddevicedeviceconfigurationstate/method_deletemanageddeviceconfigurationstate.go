...
// DeleteManagedDeviceConfigurationState - Delete navigation property deviceConfigurationStates for me
func (c ManagedDeviceDeviceConfigurationStateClient) DeleteManagedDeviceConfigurationState(ctx context.Context, id stable.MeManagedDeviceIdDeviceConfigurationStateId, options DeleteManagedDeviceConfigurationStateOperationOptions) (result DeleteManagedDeviceConfigurationStateOperationResponse, err error) {
