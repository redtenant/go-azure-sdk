...
// device.
func (c ManagedDeviceDeviceConfigurationStateClient) GetManagedDeviceConfigurationState(ctx context.Context, id stable.MeManagedDeviceIdDeviceConfigurationStateId, options GetManagedDeviceConfigurationStateOperationOptions) (result GetManagedDeviceConfigurationStateOperationResponse, err error) {
