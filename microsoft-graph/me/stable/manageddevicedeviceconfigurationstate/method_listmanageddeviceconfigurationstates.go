...
// ListManagedDeviceConfigurationStates - Get deviceConfigurationStates from me. Device configuration states for this
// device.
func (c ManagedDeviceDeviceConfigurationStateClient) ListManagedDeviceConfigurationStates(ctx context.Context, id stable.MeManagedDeviceId, options ListManagedDeviceConfigurationStatesOperationOptions) (result ListManagedDeviceConfigurationStatesOperationResponse, err error) {
...
func (c ManagedDeviceDeviceConfigurationStateClient) ListManagedDeviceConfigurationStatesComplete(ctx context.Context, id stable.MeManagedDeviceId, options ListManagedDeviceConfigurationStatesOperationOptions) (ListManagedDeviceConfigurationStatesCompleteResult, error) {
...
func (c ManagedDeviceDeviceConfigurationStateClient) ListManagedDeviceConfigurationStatesCompleteMatchingPredicate(ctx context.Context, id stable.MeManagedDeviceId, options ListManagedDeviceConfigurationStatesOperationOptions, predicate DeviceConfigurationStateOperationPredicate) (result ListManagedDeviceConfigurationStatesCompleteResult, err error) {
