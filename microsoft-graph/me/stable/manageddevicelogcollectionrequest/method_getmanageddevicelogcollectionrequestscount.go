...
func (c ManagedDeviceLogCollectionRequestClient) GetManagedDeviceLogCollectionRequestsCount(ctx context.Context, id stable.MeManagedDeviceId, options GetManagedDeviceLogCollectionRequestsCountOperationOptions) (result GetManagedDeviceLogCollectionRequestsCountOperationResponse, err error) {
