...
func (c ManagedDeviceLogCollectionRequestClient) ListManagedDeviceLogCollectionRequests(ctx context.Context, id stable.MeManagedDeviceId, options ListManagedDeviceLogCollectionRequestsOperationOptions) (result ListManagedDeviceLogCollectionRequestsOperationResponse, err error) {
...
func (c ManagedDeviceLogCollectionRequestClient) ListManagedDeviceLogCollectionRequestsComplete(ctx context.Context, id stable.MeManagedDeviceId, options ListManagedDeviceLogCollectionRequestsOperationOptions) (ListManagedDeviceLogCollectionRequestsCompleteResult, error) {
