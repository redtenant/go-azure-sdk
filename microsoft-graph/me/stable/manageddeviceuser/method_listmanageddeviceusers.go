...
func (c ManagedDeviceUserClient) ListManagedDeviceUsers(ctx context.Context, id stable.MeManagedDeviceId, options ListManagedDeviceUsersOperationOptions) (result ListManagedDeviceUsersOperationResponse, err error) {
...
func (c ManagedDeviceUserClient) ListManagedDeviceUsersComplete(ctx context.Context, id stable.MeManagedDeviceId, options ListManagedDeviceUsersOperationOptions) (ListManagedDeviceUsersCompleteResult, error) {
