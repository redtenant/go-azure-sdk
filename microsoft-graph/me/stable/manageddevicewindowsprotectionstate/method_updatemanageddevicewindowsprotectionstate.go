...
// UpdateManagedDeviceWindowsProtectionState - Update the navigation property windowsProtectionState in me
func (c ManagedDeviceWindowsProtectionStateClient) UpdateManagedDeviceWindowsProtectionState(ctx context.Context, id stable.MeManagedDeviceId, input stable.WindowsProtectionState, options UpdateManagedDeviceWindowsProtectionStateOperationOptions) (result UpdateManagedDeviceWindowsProtectionStateOperationResponse, err error) {
