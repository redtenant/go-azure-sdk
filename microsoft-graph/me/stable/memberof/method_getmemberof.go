...
// GetMemberOf - Get memberOf from me. The groups and directory roles that the user is a member of. Read-only. Nullable.
// Supports $expand.
func (c MemberOfClient) GetMemberOf(ctx context.Context, id stable.MeMemberOfId, options GetMemberOfOperationOptions) (result GetMemberOfOperationResponse, err error) {
