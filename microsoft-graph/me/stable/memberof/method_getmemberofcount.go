...
func (c MemberOfClient) GetMemberOfCount(ctx context.Context, options GetMemberOfCountOperationOptions) (result GetMemberOfCountOperationResponse, err error) {
