...
// CreateMessageAttachment - Add attachment. Use this API to create a new Attachment. An attachment can be one of the
// following types: All these types of attachment resources are derived from the attachment resource.
func (c MessageAttachmentClient) CreateMessageAttachment(ctx context.Context, id stable.MeMessageId, input stable.Attachment, options CreateMessageAttachmentOperationOptions) (result CreateMessageAttachmentOperationResponse, err error) {
