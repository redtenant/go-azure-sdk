...
func (c MessageAttachmentClient) CreateMessageAttachmentsUploadSession(ctx context.Context, id stable.MeMessageId, input CreateMessageAttachmentsUploadSessionRequest, options CreateMessageAttachmentsUploadSessionOperationOptions) (result CreateMessageAttachmentsUploadSessionOperationResponse, err error) {
