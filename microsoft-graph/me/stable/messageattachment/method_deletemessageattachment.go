...
func (c MessageAttachmentClient) DeleteMessageAttachment(ctx context.Context, id stable.MeMessageIdAttachmentId, options DeleteMessageAttachmentOperationOptions) (result DeleteMessageAttachmentOperationResponse, err error) {
