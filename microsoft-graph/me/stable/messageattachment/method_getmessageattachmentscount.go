...
func (c MessageAttachmentClient) GetMessageAttachmentsCount(ctx context.Context, id stable.MeMessageId, options GetMessageAttachmentsCountOperationOptions) (result GetMessageAttachmentsCountOperationResponse, err error) {
