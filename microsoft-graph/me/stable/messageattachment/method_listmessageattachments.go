...
func (c MessageAttachmentClient) ListMessageAttachmentsComplete(ctx context.Context, id stable.MeMessageId, options ListMessageAttachmentsOperationOptions) (ListMessageAttachmentsCompleteResult, error) {
