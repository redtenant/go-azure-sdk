...
// GetOAuth2PermissionGrant - Get oauth2PermissionGrants from me
func (c OAuth2PermissionGrantClient) GetOAuth2PermissionGrant(ctx context.Context, id stable.MeOAuth2PermissionGrantId, options GetOAuth2PermissionGrantOperationOptions) (result GetOAuth2PermissionGrantOperationResponse, err error) {
