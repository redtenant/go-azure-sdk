...
func (c OAuth2PermissionGrantClient) GetOAuth2PermissionGrantsCount(ctx context.Context, options GetOAuth2PermissionGrantsCountOperationOptions) (result GetOAuth2PermissionGrantsCountOperationResponse, err error) {
