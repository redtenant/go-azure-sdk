...
// DeleteOnenote - Delete navigation property onenote for me
func (c OnenoteClient) DeleteOnenote(ctx context.Context, options DeleteOnenoteOperationOptions) (result DeleteOnenoteOperationResponse, err error) {
