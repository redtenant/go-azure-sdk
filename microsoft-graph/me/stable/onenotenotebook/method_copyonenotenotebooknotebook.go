...
func (c OnenoteNotebookClient) CopyOnenoteNotebookNotebook(ctx context.Context, id stable.MeOnenoteNotebookId, input CopyOnenoteNotebookNotebookRequest, options CopyOnenoteNotebookNotebookOperationOptions) (result CopyOnenoteNotebookNotebookOperationResponse, err error) {
