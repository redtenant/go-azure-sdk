...
func (c OnenoteNotebookClient) DeleteOnenoteNotebook(ctx context.Context, id stable.MeOnenoteNotebookId, options DeleteOnenoteNotebookOperationOptions) (result DeleteOnenoteNotebookOperationResponse, err error) {
