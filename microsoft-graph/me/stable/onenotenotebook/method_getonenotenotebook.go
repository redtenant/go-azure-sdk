...
func (c OnenoteNotebookClient) GetOnenoteNotebook(ctx context.Context, id stable.MeOnenoteNotebookId, options GetOnenoteNotebookOperationOptions) (result GetOnenoteNotebookOperationResponse, err error) {
