...
func (c OnenoteNotebookClient) UpdateOnenoteNotebook(ctx context.Context, id stable.MeOnenoteNotebookId, input stable.Notebook, options UpdateOnenoteNotebookOperationOptions) (result UpdateOnenoteNotebookOperationResponse, err error) {
