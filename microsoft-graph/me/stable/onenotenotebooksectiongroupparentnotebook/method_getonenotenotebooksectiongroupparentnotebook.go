...
type GetOnenoteNotebookSectionGroupParentNotebookOperationResponse struct {
	HttpResponse *http.Response
	OData        *odata.OData
	Model        *stable.Notebook
}

type GetOnenoteNotebookSectionGroupParentNotebookOperationOptions struct {
	Expand    *odata.Expand
...
func DefaultGetOnenoteNotebookSectionGroupParentNotebookOperationOptions() GetOnenoteNotebookSectionGroupParentNotebookOperationOptions {
	return GetOnenoteNotebookSectionGroupParentNotebookOperationOptions{}
}
...
// GetOnenoteNotebookSectionGroupParentNotebook - Get parentNotebook from me. The notebook that contains the section
// group. Read-only.
func (c OnenoteNotebookSectionGroupParentNotebookClient) GetOnenoteNotebookSectionGroupParentNotebook(ctx context.Context, id stable.MeOnenoteNotebookIdSectionGroupId, options GetOnenoteNotebookSectionGroupParentNotebookOperationOptions) (result GetOnenoteNotebookSectionGroupParentNotebookOperationResponse, err error) {
