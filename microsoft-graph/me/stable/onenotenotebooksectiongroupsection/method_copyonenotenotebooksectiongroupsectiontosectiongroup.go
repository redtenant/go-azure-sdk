...
// result.
func (c OnenoteNotebookSectionGroupSectionClient) CopyOnenoteNotebookSectionGroupSectionToSectionGroup(ctx context.Context, id stable.MeOnenoteNotebookIdSectionGroupIdSectionId, input CopyOnenoteNotebookSectionGroupSectionToSectionGroupRequest, options CopyOnenoteNotebookSectionGroupSectionToSectionGroupOperationOptions) (result CopyOnenoteNotebookSectionGroupSectionToSectionGroupOperationResponse, err error) {
