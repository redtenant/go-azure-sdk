...
// CreateOnenoteNotebookSectionGroupSection - Create new navigation property to sections for me
func (c OnenoteNotebookSectionGroupSectionClient) CreateOnenoteNotebookSectionGroupSection(ctx context.Context, id stable.MeOnenoteNotebookIdSectionGroupId, input stable.OnenoteSection, options CreateOnenoteNotebookSectionGroupSectionOperationOptions) (result CreateOnenoteNotebookSectionGroupSectionOperationResponse, err error) {
