...
// GetOnenoteNotebookSectionGroupSection - Get sections from me. The sections in the section group. Read-only. Nullable.
func (c OnenoteNotebookSectionGroupSectionClient) GetOnenoteNotebookSectionGroupSection(ctx context.Context, id stable.MeOnenoteNotebookIdSectionGroupIdSectionId, options GetOnenoteNotebookSectionGroupSectionOperationOptions) (result GetOnenoteNotebookSectionGroupSectionOperationResponse, err error) {
