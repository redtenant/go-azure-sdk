...
// UpdateOnenoteNotebookSectionGroupSection - Update the navigation property sections in me
func (c OnenoteNotebookSectionGroupSectionClient) UpdateOnenoteNotebookSectionGroupSection(ctx context.Context, id stable.MeOnenoteNotebookIdSectionGroupIdSectionId, input stable.OnenoteSection, options UpdateOnenoteNotebookSectionGroupSectionOperationOptions) (result UpdateOnenoteNotebookSectionGroupSectionOperationResponse, err error) {
