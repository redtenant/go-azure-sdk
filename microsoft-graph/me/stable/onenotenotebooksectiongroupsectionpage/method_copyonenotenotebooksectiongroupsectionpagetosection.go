...
func (c OnenoteNotebookSectionGroupSectionPageClient) CopyOnenoteNotebookSectionGroupSectionPageToSection(ctx context.Context, id stable.MeOnenoteNotebookIdSectionGroupIdSectionIdPageId, input CopyOnenoteNotebookSectionGroupSectionPageToSectionRequest, options CopyOnenoteNotebookSectionGroupSectionPageToSectionOperationOptions) (result CopyOnenoteNotebookSectionGroupSectionPageToSectionOperationResponse, err error) {
