...
func (c OnenoteNotebookSectionGroupSectionPageClient) CreateOnenoteNotebookSectionGroupSectionPageOnenotePatchContent(ctx context.Context, id stable.MeOnenoteNotebookIdSectionGroupIdSectionIdPageId, input CreateOnenoteNotebookSectionGroupSectionPageOnenotePatchContentRequest, options CreateOnenoteNotebookSectionGroupSectionPageOnenotePatchContentOperationOptions) (result CreateOnenoteNotebookSectionGroupSectionPageOnenotePatchContentOperationResponse, err error) {
