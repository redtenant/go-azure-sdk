...
// page's HTML content.
func (c OnenoteNotebookSectionGroupSectionPageContentClient) DeleteOnenoteNotebookSectionGroupSectionPageContent(ctx context.Context, id stable.MeOnenoteNotebookIdSectionGroupIdSectionIdPageId, options DeleteOnenoteNotebookSectionGroupSectionPageContentOperationOptions) (result DeleteOnenoteNotebookSectionGroupSectionPageContentOperationResponse, err error) {
