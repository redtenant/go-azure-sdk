...
// GetOnenoteNotebookSectionGroupSectionPageContent - Get content for the navigation property pages from me. The page's
// HTML content.
func (c OnenoteNotebookSectionGroupSectionPageContentClient) GetOnenoteNotebookSectionGroupSectionPageContent(ctx context.Context, id stable.MeOnenoteNotebookIdSectionGroupIdSectionIdPageId, options GetOnenoteNotebookSectionGroupSectionPageContentOperationOptions) (result GetOnenoteNotebookSectionGroupSectionPageContentOperationResponse, err error) {
