...
// GetOnenoteNotebookSectionGroupSectionPageParentNotebook - Get parentNotebook from me. The notebook that contains the
// page. Read-only.
func (c OnenoteNotebookSectionGroupSectionPageParentNotebookClient) GetOnenoteNotebookSectionGroupSectionPageParentNotebook(ctx context.Context, id stable.MeOnenoteNotebookIdSectionGroupIdSectionIdPageId, options GetOnenoteNotebookSectionGroupSectionPageParentNotebookOperationOptions) (result GetOnenoteNotebookSectionGroupSectionPageParentNotebookOperationResponse, err error) {
