...
func (c OnenoteNotebookSectionGroupSectionParentSectionGroupClient) GetOnenoteNotebookSectionGroupSectionParentSectionGroup(ctx context.Context, id stable.MeOnenoteNotebookIdSectionGroupIdSectionId, options GetOnenoteNotebookSectionGroupSectionParentSectionGroupOperationOptions) (result GetOnenoteNotebookSectionGroupSectionParentSectionGroupOperationResponse, err error) {
