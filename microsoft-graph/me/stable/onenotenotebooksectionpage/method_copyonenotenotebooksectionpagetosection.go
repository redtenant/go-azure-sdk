...
func (c OnenoteNotebookSectionPageClient) CopyOnenoteNotebookSectionPageToSection(ctx context.Context, id stable.MeOnenoteNotebookIdSectionIdPageId, input CopyOnenoteNotebookSectionPageToSectionRequest, options CopyOnenoteNotebookSectionPageToSectionOperationOptions) (result CopyOnenoteNotebookSectionPageToSectionOperationResponse, err error) {
