...
func (c OnenoteNotebookSectionPageClient) CreateOnenoteNotebookSectionPage(ctx context.Context, id stable.MeOnenoteNotebookIdSectionId, input stable.OnenotePage, options CreateOnenoteNotebookSectionPageOperationOptions) (result CreateOnenoteNotebookSectionPageOperationResponse, err error) {
