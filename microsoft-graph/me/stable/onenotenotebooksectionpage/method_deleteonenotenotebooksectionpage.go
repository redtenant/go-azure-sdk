...
func DefaultDeleteOnenoteNotebookSectionPageOperationOptions() DeleteOnenoteNotebookSectionPageOperationOptions {
	return DeleteOnenoteNotebookSectionPageOperationOptions{}
}
...
// DeleteOnenoteNotebookSectionPage - Delete navigation property pages for me
func (c OnenoteNotebookSectionPageClient) DeleteOnenoteNotebookSectionPage(ctx context.Context, id stable.MeOnenoteNotebookIdSectionIdPageId, options DeleteOnenoteNotebookSectionPageOperationOptions) (result DeleteOnenoteNotebookSectionPageOperationResponse, err error) {
