...
func (c OnenoteNotebookSectionPageClient) GetOnenoteNotebookSectionPagesCount(ctx context.Context, id stable.MeOnenoteNotebookIdSectionId, options GetOnenoteNotebookSectionPagesCountOperationOptions) (result GetOnenoteNotebookSectionPagesCountOperationResponse, err error) {
