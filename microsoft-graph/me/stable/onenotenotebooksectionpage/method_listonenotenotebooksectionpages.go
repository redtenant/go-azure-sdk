...
func DefaultListOnenoteNotebookSectionPagesOperationOptions() ListOnenoteNotebookSectionPagesOperationOptions {
	return ListOnenoteNotebookSectionPagesOperationOptions{}
}
...
// ListOnenoteNotebookSectionPages - Get pages from me. The collection of pages in the section. Read-only. Nullable.
func (c OnenoteNotebookSectionPageClient) ListOnenoteNotebookSectionPages(ctx context.Context, id stable.MeOnenoteNotebookIdSectionId, options ListOnenoteNotebookSectionPagesOperationOptions) (result ListOnenoteNotebookSectionPagesOperationResponse, err error) {
	opts := client.RequestOptions{
		...
		Pager:         &ListOnenoteNotebookSectionPagesCustomPager{},
...
func (c OnenoteNotebookSectionPageClient) ListOnenoteNotebookSectionPagesComplete(ctx context.Context, id stable.MeOnenoteNotebookIdSectionId, options ListOnenoteNotebookSectionPagesOperationOptions) (ListOnenoteNotebookSectionPagesCompleteResult, error) {
	return c.ListOnenoteNotebookSectionPagesCompleteMatchingPredicate(ctx, id, options, OnenotePageOperationPredicate{})
}

// ListOnenoteNotebookSectionPagesCompleteMatchingPredicate retrieves all the results and then applies the predicate
func (c OnenoteNotebookSectionPageClient) ListOnenoteNotebookSectionPagesCompleteMatchingPredicate(ctx context.Context, id stable.MeOnenoteNotebookIdSectionId, options ListOnenoteNotebookSectionPagesOperationOptions, predicate OnenotePageOperationPredicate) (result ListOnenoteNotebookSectionPagesCompleteResult, err error) {
	items := make([]stable.OnenotePage, 0)

	resp, err := c.ListOnenoteNotebookSectionPages(ctx, id, options)
	if err != nil {
	...
	result = ListOnenoteNotebookSectionPagesCompleteResult{
