...
// UpdateOnenoteNotebookSectionPage - Update the navigation property pages in me
func (c OnenoteNotebookSectionPageClient) UpdateOnenoteNotebookSectionPage(ctx context.Context, id stable.MeOnenoteNotebookIdSectionIdPageId, input stable.OnenotePage, options UpdateOnenoteNotebookSectionPageOperationOptions) (result UpdateOnenoteNotebookSectionPageOperationResponse, err error) {
