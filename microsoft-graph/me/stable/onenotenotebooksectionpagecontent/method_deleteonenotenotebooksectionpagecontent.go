...
// content.
func (c OnenoteNotebookSectionPageContentClient) DeleteOnenoteNotebookSectionPageContent(ctx context.Context, id stable.MeOnenoteNotebookIdSectionIdPageId, options DeleteOnenoteNotebookSectionPageContentOperationOptions) (result DeleteOnenoteNotebookSectionPageContentOperationResponse, err error) {
