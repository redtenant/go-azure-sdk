...
// content.
func (c OnenoteNotebookSectionPageContentClient) GetOnenoteNotebookSectionPageContent(ctx context.Context, id stable.MeOnenoteNotebookIdSectionIdPageId, options GetOnenoteNotebookSectionPageContentOperationOptions) (result GetOnenoteNotebookSectionPageContentOperationResponse, err error) {
