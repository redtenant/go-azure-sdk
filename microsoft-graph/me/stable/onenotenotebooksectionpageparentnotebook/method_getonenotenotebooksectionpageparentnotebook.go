...
// GetOnenoteNotebookSectionPageParentNotebook - Get parentNotebook from me. The notebook that contains the page.
// Read-only.
func (c OnenoteNotebookSectionPageParentNotebookClient) GetOnenoteNotebookSectionPageParentNotebook(ctx context.Context, id stable.MeOnenoteNotebookIdSectionIdPageId, options GetOnenoteNotebookSectionPageParentNotebookOperationOptions) (result GetOnenoteNotebookSectionPageParentNotebookOperationResponse, err error) {
