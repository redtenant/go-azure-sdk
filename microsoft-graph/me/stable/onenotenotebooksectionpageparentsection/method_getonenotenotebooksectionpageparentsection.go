...
// GetOnenoteNotebookSectionPageParentSection - Get parentSection from me. The section that contains the page.
// Read-only.
func (c OnenoteNotebookSectionPageParentSectionClient) GetOnenoteNotebookSectionPageParentSection(ctx context.Context, id stable.MeOnenoteNotebookIdSectionIdPageId, options GetOnenoteNotebookSectionPageParentSectionOperationOptions) (result GetOnenoteNotebookSectionPageParentSectionOperationResponse, err error) {
