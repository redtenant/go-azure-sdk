...
// section. Read-only.
func (c OnenoteNotebookSectionParentSectionGroupClient) GetOnenoteNotebookSectionParentSectionGroup(ctx context.Context, id stable.MeOnenoteNotebookIdSectionId, options GetOnenoteNotebookSectionParentSectionGroupOperationOptions) (result GetOnenoteNotebookSectionParentSectionGroupOperationResponse, err error) {
