...
func (c OnenoteOperationClient) CreateOnenoteOperation(ctx context.Context, input stable.OnenoteOperation, options CreateOnenoteOperationOperationOptions) (result CreateOnenoteOperationOperationResponse, err error) {
