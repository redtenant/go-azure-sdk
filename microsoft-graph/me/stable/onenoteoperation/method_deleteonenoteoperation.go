...
func (c OnenoteOperationClient) DeleteOnenoteOperation(ctx context.Context, id stable.MeOnenoteOperationId, options DeleteOnenoteOperationOperationOptions) (result DeleteOnenoteOperationOperationResponse, err error) {
