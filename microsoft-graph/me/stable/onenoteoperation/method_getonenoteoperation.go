...
// GetOnenoteOperation - Get onenoteOperation. Get the status of a long-running OneNote operation. This applies to
...
func (c OnenoteOperationClient) GetOnenoteOperation(ctx context.Context, id stable.MeOnenoteOperationId, options GetOnenoteOperationOperationOptions) (result GetOnenoteOperationOperationResponse, err error) {
