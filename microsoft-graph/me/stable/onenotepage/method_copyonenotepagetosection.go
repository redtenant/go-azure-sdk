...
// result.
func (c OnenotePageClient) CopyOnenotePageToSection(ctx context.Context, id stable.MeOnenotePageId, input CopyOnenotePageToSectionRequest, options CopyOnenotePageToSectionOperationOptions) (result CopyOnenotePageToSectionOperationResponse, err error) {
