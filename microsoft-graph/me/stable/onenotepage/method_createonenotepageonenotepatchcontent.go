...
func (c OnenotePageClient) CreateOnenotePageOnenotePatchContent(ctx context.Context, id stable.MeOnenotePageId, input CreateOnenotePageOnenotePatchContentRequest, options CreateOnenotePageOnenotePatchContentOperationOptions) (result CreateOnenotePageOnenotePatchContentOperationResponse, err error) {
