...
// SetOnenotePageContent - Update page. Update the content of a OneNote page.
func (c OnenotePageContentClient) SetOnenotePageContent(ctx context.Context, id stable.MeOnenotePageId, input []byte, options SetOnenotePageContentOperationOptions) (result SetOnenotePageContentOperationResponse, err error) {
