...
func (c OnenotePageParentNotebookClient) GetOnenotePageParentNotebook(ctx context.Context, id stable.MeOnenotePageId, options GetOnenotePageParentNotebookOperationOptions) (result GetOnenotePageParentNotebookOperationResponse, err error) {
