...
func (c OnenoteResourceClient) CreateOnenoteResource(ctx context.Context, input stable.OnenoteResource, options CreateOnenoteResourceOperationOptions) (result CreateOnenoteResourceOperationResponse, err error) {
