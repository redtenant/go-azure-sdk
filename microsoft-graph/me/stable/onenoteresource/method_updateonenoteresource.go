...
// UpdateOnenoteResource - Update the navigation property resources in me
func (c OnenoteResourceClient) UpdateOnenoteResource(ctx context.Context, id stable.MeOnenoteResourceId, input stable.OnenoteResource, options UpdateOnenoteResourceOperationOptions) (result UpdateOnenoteResourceOperationResponse, err error) {
