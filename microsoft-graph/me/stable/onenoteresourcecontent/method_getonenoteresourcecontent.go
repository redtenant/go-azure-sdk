...
func (c OnenoteResourceContentClient) GetOnenoteResourceContent(ctx context.Context, id stable.MeOnenoteResourceId, options GetOnenoteResourceContentOperationOptions) (result GetOnenoteResourceContentOperationResponse, err error) {
