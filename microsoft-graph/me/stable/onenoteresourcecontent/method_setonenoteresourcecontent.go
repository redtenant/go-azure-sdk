...
// SetOnenoteResourceContent - Update content for the navigation property resources in me. The content stream
func (c OnenoteResourceContentClient) SetOnenoteResourceContent(ctx context.Context, id stable.MeOnenoteResourceId, input []byte, options SetOnenoteResourceContentOperationOptions) (result SetOnenoteResourceContentOperationResponse, err error) {
