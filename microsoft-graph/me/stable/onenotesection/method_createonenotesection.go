...
// CreateOnenoteSection - Create new navigation property to sections for me
func (c OnenoteSectionClient) CreateOnenoteSection(ctx context.Context, input stable.OnenoteSection, options CreateOnenoteSectionOperationOptions) (result CreateOnenoteSectionOperationResponse, err error) {
