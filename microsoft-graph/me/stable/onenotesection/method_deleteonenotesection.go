...
// DeleteOnenoteSection - Delete navigation property sections for me
func (c OnenoteSectionClient) DeleteOnenoteSection(ctx context.Context, id stable.MeOnenoteSectionId, options DeleteOnenoteSectionOperationOptions) (result DeleteOnenoteSectionOperationResponse, err error) {
