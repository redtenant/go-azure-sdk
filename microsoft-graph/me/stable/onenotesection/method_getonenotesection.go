...
// GetOnenoteSection - Get section. Retrieve the properties and relationships of a onenoteSection object.
func (c OnenoteSectionClient) GetOnenoteSection(ctx context.Context, id stable.MeOnenoteSectionId, options GetOnenoteSectionOperationOptions) (result GetOnenoteSectionOperationResponse, err error) {
