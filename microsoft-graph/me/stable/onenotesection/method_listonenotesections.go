...
// ListOnenoteSections - List sections. Retrieve a list of onenoteSection objects.
func (c OnenoteSectionClient) ListOnenoteSections(ctx context.Context, options ListOnenoteSectionsOperationOptions) (result ListOnenoteSectionsOperationResponse, err error) {
...
func (c OnenoteSectionClient) ListOnenoteSectionsComplete(ctx context.Context, options ListOnenoteSectionsOperationOptions) (ListOnenoteSectionsCompleteResult, error) {
	return c.ListOnenoteSectionsCompleteMatchingPredicate(ctx, options, OnenoteSectionOperationPredicate{})
}

// ListOnenoteSectionsCompleteMatchingPredicate retrieves all the results and then applies the predicate
func (c OnenoteSectionClient) ListOnenoteSectionsCompleteMatchingPredicate(ctx context.Context, options ListOnenoteSectionsOperationOptions, predicate OnenoteSectionOperationPredicate) (result ListOnenoteSectionsCompleteResult, err error) {
	items := make([]stable.OnenoteSection, 0)

	resp, err := c.ListOnenoteSections(ctx, options)
	if err != nil {
