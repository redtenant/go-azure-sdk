...
// UpdateOnenoteSection - Update the navigation property sections in me
func (c OnenoteSectionClient) UpdateOnenoteSection(ctx context.Context, id stable.MeOnenoteSectionId, input stable.OnenoteSection, options UpdateOnenoteSectionOperationOptions) (result UpdateOnenoteSectionOperationResponse, err error) {
