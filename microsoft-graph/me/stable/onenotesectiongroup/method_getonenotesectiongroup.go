...
// GetOnenoteSectionGroup - Get sectionGroup. Retrieve the properties and relationships of a sectionGroup object.
func (c OnenoteSectionGroupClient) GetOnenoteSectionGroup(ctx context.Context, id stable.MeOnenoteSectionGroupId, options GetOnenoteSectionGroupOperationOptions) (result GetOnenoteSectionGroupOperationResponse, err error) {
