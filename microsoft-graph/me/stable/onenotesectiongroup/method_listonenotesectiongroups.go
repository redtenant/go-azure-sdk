...
// ListOnenoteSectionGroups - List sectionGroups. Retrieve a list of sectionGroup objects.
func (c OnenoteSectionGroupClient) ListOnenoteSectionGroups(ctx context.Context, options ListOnenoteSectionGroupsOperationOptions) (result ListOnenoteSectionGroupsOperationResponse, err error) {
...
func (c OnenoteSectionGroupClient) ListOnenoteSectionGroupsComplete(ctx context.Context, options ListOnenoteSectionGroupsOperationOptions) (ListOnenoteSectionGroupsCompleteResult, error) {
	return c.ListOnenoteSectionGroupsCompleteMatchingPredicate(ctx, options, SectionGroupOperationPredicate{})
}

// ListOnenoteSectionGroupsCompleteMatchingPredicate retrieves all the results and then applies the predicate
func (c OnenoteSectionGroupClient) ListOnenoteSectionGroupsCompleteMatchingPredicate(ctx context.Context, options ListOnenoteSectionGroupsOperationOptions, predicate SectionGroupOperationPredicate) (result ListOnenoteSectionGroupsCompleteResult, err error) {
	items := make([]stable.SectionGroup, 0)

	resp, err := c.ListOnenoteSectionGroups(ctx, options)
	if err != nil {
