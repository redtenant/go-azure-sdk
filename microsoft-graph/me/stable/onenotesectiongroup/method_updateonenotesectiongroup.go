...
// UpdateOnenoteSectionGroup - Update the navigation property sectionGroups in me
func (c OnenoteSectionGroupClient) UpdateOnenoteSectionGroup(ctx context.Context, id stable.MeOnenoteSectionGroupId, input stable.SectionGroup, options UpdateOnenoteSectionGroupOperationOptions) (result UpdateOnenoteSectionGroupOperationResponse, err error) {
