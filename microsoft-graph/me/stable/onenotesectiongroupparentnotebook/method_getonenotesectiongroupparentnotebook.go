...
// GetOnenoteSectionGroupParentNotebook - Get parentNotebook from me. The notebook that contains the section group.
// Read-only.
func (c OnenoteSectionGroupParentNotebookClient) GetOnenoteSectionGroupParentNotebook(ctx context.Context, id stable.MeOnenoteSectionGroupId, options GetOnenoteSectionGroupParentNotebookOperationOptions) (result GetOnenoteSectionGroupParentNotebookOperationResponse, err error) {
