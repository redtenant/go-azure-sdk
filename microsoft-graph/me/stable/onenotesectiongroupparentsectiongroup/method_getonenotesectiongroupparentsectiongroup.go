...
// GetOnenoteSectionGroupParentSectionGroup - Get parentSectionGroup from me. The section group that contains the
// section group. Read-only.
func (c OnenoteSectionGroupParentSectionGroupClient) GetOnenoteSectionGroupParentSectionGroup(ctx context.Context, id stable.MeOnenoteSectionGroupId, options GetOnenoteSectionGroupParentSectionGroupOperationOptions) (result GetOnenoteSectionGroupParentSectionGroupOperationResponse, err error) {
