...
func (c OnenoteSectionGroupSectionPageClient) CopyOnenoteSectionGroupSectionPageToSection(ctx context.Context, id stable.MeOnenoteSectionGroupIdSectionIdPageId, input CopyOnenoteSectionGroupSectionPageToSectionRequest, options CopyOnenoteSectionGroupSectionPageToSectionOperationOptions) (result CopyOnenoteSectionGroupSectionPageToSectionOperationResponse, err error) {
