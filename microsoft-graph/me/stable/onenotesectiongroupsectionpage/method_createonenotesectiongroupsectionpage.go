...
func DefaultCreateOnenoteSectionGroupSectionPageOperationOptions() CreateOnenoteSectionGroupSectionPageOperationOptions {
	return CreateOnenoteSectionGroupSectionPageOperationOptions{}
}
...
// CreateOnenoteSectionGroupSectionPage - Create new navigation property to pages for me
func (c OnenoteSectionGroupSectionPageClient) CreateOnenoteSectionGroupSectionPage(ctx context.Context, id stable.MeOnenoteSectionGroupIdSectionId, input stable.OnenotePage, options CreateOnenoteSectionGroupSectionPageOperationOptions) (result CreateOnenoteSectionGroupSectionPageOperationResponse, err error) {
