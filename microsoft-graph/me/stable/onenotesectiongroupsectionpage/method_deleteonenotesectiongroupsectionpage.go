...
// DeleteOnenoteSectionGroupSectionPage - Delete navigation property pages for me
func (c OnenoteSectionGroupSectionPageClient) DeleteOnenoteSectionGroupSectionPage(ctx context.Context, id stable.MeOnenoteSectionGroupIdSectionIdPageId, options DeleteOnenoteSectionGroupSectionPageOperationOptions) (result DeleteOnenoteSectionGroupSectionPageOperationResponse, err error) {
