...
func DefaultGetOnenoteSectionGroupSectionPageOperationOptions() GetOnenoteSectionGroupSectionPageOperationOptions {
	return GetOnenoteSectionGroupSectionPageOperationOptions{}
}
...
// GetOnenoteSectionGroupSectionPage - Get pages from me. The collection of pages in the section. Read-only. Nullable.
func (c OnenoteSectionGroupSectionPageClient) GetOnenoteSectionGroupSectionPage(ctx context.Context, id stable.MeOnenoteSectionGroupIdSectionIdPageId, options GetOnenoteSectionGroupSectionPageOperationOptions) (result GetOnenoteSectionGroupSectionPageOperationResponse, err error) {
