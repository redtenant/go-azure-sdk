...
func (c OnenoteSectionGroupSectionPageClient) GetOnenoteSectionGroupSectionPagesCount(ctx context.Context, id stable.MeOnenoteSectionGroupIdSectionId, options GetOnenoteSectionGroupSectionPagesCountOperationOptions) (result GetOnenoteSectionGroupSectionPagesCountOperationResponse, err error) {
