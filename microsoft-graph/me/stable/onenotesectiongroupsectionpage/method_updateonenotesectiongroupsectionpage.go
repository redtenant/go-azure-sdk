...
func (c OnenoteSectionGroupSectionPageClient) UpdateOnenoteSectionGroupSectionPage(ctx context.Context, id stable.MeOnenoteSectionGroupIdSectionIdPageId, input stable.OnenotePage, options UpdateOnenoteSectionGroupSectionPageOperationOptions) (result UpdateOnenoteSectionGroupSectionPageOperationResponse, err error) {
