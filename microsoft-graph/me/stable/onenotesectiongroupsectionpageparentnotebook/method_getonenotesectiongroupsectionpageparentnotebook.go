...
// GetOnenoteSectionGroupSectionPageParentNotebook - Get parentNotebook from me. The notebook that contains the page.
// Read-only.
func (c OnenoteSectionGroupSectionPageParentNotebookClient) GetOnenoteSectionGroupSectionPageParentNotebook(ctx context.Context, id stable.MeOnenoteSectionGroupIdSectionIdPageId, options GetOnenoteSectionGroupSectionPageParentNotebookOperationOptions) (result GetOnenoteSectionGroupSectionPageParentNotebookOperationResponse, err error) {
