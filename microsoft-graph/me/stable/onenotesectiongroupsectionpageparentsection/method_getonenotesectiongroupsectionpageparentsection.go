...
// GetOnenoteSectionGroupSectionPageParentSection - Get parentSection from me. The section that contains the page.
// Read-only.
func (c OnenoteSectionGroupSectionPageParentSectionClient) GetOnenoteSectionGroupSectionPageParentSection(ctx context.Context, id stable.MeOnenoteSectionGroupIdSectionIdPageId, options GetOnenoteSectionGroupSectionPageParentSectionOperationOptions) (result GetOnenoteSectionGroupSectionPageParentSectionOperationResponse, err error) {
