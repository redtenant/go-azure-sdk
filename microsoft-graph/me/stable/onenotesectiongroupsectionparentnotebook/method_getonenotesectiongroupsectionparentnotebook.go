...
// GetOnenoteSectionGroupSectionParentNotebook - Get parentNotebook from me. The notebook that contains the section.
// Read-only.
func (c OnenoteSectionGroupSectionParentNotebookClient) GetOnenoteSectionGroupSectionParentNotebook(ctx context.Context, id stable.MeOnenoteSectionGroupIdSectionId, options GetOnenoteSectionGroupSectionParentNotebookOperationOptions) (result GetOnenoteSectionGroupSectionParentNotebookOperationResponse, err error) {
