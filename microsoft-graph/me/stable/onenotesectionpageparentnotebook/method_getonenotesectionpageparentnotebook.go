...
func (c OnenoteSectionPageParentNotebookClient) GetOnenoteSectionPageParentNotebook(ctx context.Context, id stable.MeOnenoteSectionIdPageId, options GetOnenoteSectionPageParentNotebookOperationOptions) (result GetOnenoteSectionPageParentNotebookOperationResponse, err error) {
