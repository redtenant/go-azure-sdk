...
// GetOnenoteSectionParentNotebook - Get parentNotebook from me. The notebook that contains the section. Read-only.
func (c OnenoteSectionParentNotebookClient) GetOnenoteSectionParentNotebook(ctx context.Context, id stable.MeOnenoteSectionId, options GetOnenoteSectionParentNotebookOperationOptions) (result GetOnenoteSectionParentNotebookOperationResponse, err error) {
