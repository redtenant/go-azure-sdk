...
// GetOnenoteSectionParentSectionGroup - Get parentSectionGroup from me. The section group that contains the section.
// Read-only.
func (c OnenoteSectionParentSectionGroupClient) GetOnenoteSectionParentSectionGroup(ctx context.Context, id stable.MeOnenoteSectionId, options GetOnenoteSectionParentSectionGroupOperationOptions) (result GetOnenoteSectionParentSectionGroupOperationResponse, err error) {
