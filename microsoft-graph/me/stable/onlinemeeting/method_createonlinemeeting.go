...
// CreateOnlineMeeting - Create onlineMeeting. Create an online meeting on behalf of a user.
func (c OnlineMeetingClient) CreateOnlineMeeting(ctx context.Context, input stable.OnlineMeeting, options CreateOnlineMeetingOperationOptions) (result CreateOnlineMeetingOperationResponse, err error) {
