...
// DeleteOnlineMeeting - Delete onlineMeeting. Delete an onlineMeeting object.
func (c OnlineMeetingClient) DeleteOnlineMeeting(ctx context.Context, id stable.MeOnlineMeetingId, options DeleteOnlineMeetingOperationOptions) (result DeleteOnlineMeetingOperationResponse, err error) {
