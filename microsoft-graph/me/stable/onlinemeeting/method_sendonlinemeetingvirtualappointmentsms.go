...
func (c OnlineMeetingClient) SendOnlineMeetingVirtualAppointmentSms(ctx context.Context, id stable.MeOnlineMeetingId, input SendOnlineMeetingVirtualAppointmentSmsRequest, options SendOnlineMeetingVirtualAppointmentSmsOperationOptions) (result SendOnlineMeetingVirtualAppointmentSmsOperationResponse, err error) {
