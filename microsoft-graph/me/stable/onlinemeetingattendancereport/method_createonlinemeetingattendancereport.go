...
func (c OnlineMeetingAttendanceReportClient) CreateOnlineMeetingAttendanceReport(ctx context.Context, id stable.MeOnlineMeetingId, input stable.MeetingAttendanceReport, options CreateOnlineMeetingAttendanceReportOperationOptions) (result CreateOnlineMeetingAttendanceReportOperationResponse, err error) {
