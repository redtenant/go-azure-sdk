...
func (c OnlineMeetingAttendanceReportClient) GetOnlineMeetingAttendanceReport(ctx context.Context, id stable.MeOnlineMeetingIdAttendanceReportId, options GetOnlineMeetingAttendanceReportOperationOptions) (result GetOnlineMeetingAttendanceReportOperationResponse, err error) {
