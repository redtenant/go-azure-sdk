...
func (c OnlineMeetingAttendanceReportClient) GetOnlineMeetingAttendanceReportsCount(ctx context.Context, id stable.MeOnlineMeetingId, options GetOnlineMeetingAttendanceReportsCountOperationOptions) (result GetOnlineMeetingAttendanceReportsCountOperationResponse, err error) {
