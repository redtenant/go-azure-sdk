...
func (c OnlineMeetingAttendanceReportAttendanceRecordClient) GetOnlineMeetingAttendanceReportAttendanceRecordsCount(ctx context.Context, id stable.MeOnlineMeetingIdAttendanceReportId, options GetOnlineMeetingAttendanceReportAttendanceRecordsCountOperationOptions) (result GetOnlineMeetingAttendanceReportAttendanceRecordsCountOperationResponse, err error) {
