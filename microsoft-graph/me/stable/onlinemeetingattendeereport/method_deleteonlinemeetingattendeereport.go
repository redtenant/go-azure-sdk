...
func (c OnlineMeetingAttendeeReportClient) DeleteOnlineMeetingAttendeeReport(ctx context.Context, id stable.MeOnlineMeetingId, options DeleteOnlineMeetingAttendeeReportOperationOptions) (result DeleteOnlineMeetingAttendeeReportOperationResponse, err error) {
