...
func (c OnlineMeetingRecordingClient) CreateOnlineMeetingRecording(ctx context.Context, id stable.MeOnlineMeetingId, input stable.CallRecording, options CreateOnlineMeetingRecordingOperationOptions) (result CreateOnlineMeetingRecordingOperationResponse, err error) {
