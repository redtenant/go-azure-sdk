...
func (c OnlineMeetingRecordingClient) GetOnlineMeetingRecording(ctx context.Context, id stable.MeOnlineMeetingIdRecordingId, options GetOnlineMeetingRecordingOperationOptions) (result GetOnlineMeetingRecordingOperationResponse, err error) {
