...
func (c OnlineMeetingRecordingClient) ListOnlineMeetingRecordings(ctx context.Context, id stable.MeOnlineMeetingId, options ListOnlineMeetingRecordingsOperationOptions) (result ListOnlineMeetingRecordingsOperationResponse, err error) {
...
func (c OnlineMeetingRecordingClient) ListOnlineMeetingRecordingsComplete(ctx context.Context, id stable.MeOnlineMeetingId, options ListOnlineMeetingRecordingsOperationOptions) (ListOnlineMeetingRecordingsCompleteResult, error) {
...
func (c OnlineMeetingRecordingClient) ListOnlineMeetingRecordingsCompleteMatchingPredicate(ctx context.Context, id stable.MeOnlineMeetingId, options ListOnlineMeetingRecordingsOperationOptions, predicate CallRecordingOperationPredicate) (result ListOnlineMeetingRecordingsCompleteResult, err error) {
