...
// UpdateOnlineMeetingRecording - Update the navigation property recordings in me
func (c OnlineMeetingRecordingClient) UpdateOnlineMeetingRecording(ctx context.Context, id stable.MeOnlineMeetingIdRecordingId, input stable.CallRecording, options UpdateOnlineMeetingRecordingOperationOptions) (result UpdateOnlineMeetingRecordingOperationResponse, err error) {
