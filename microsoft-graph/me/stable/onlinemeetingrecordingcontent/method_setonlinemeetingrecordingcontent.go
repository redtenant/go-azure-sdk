...
// recording. Read-only.
func (c OnlineMeetingRecordingContentClient) SetOnlineMeetingRecordingContent(ctx context.Context, id stable.MeOnlineMeetingIdRecordingId, input []byte, options SetOnlineMeetingRecordingContentOperationOptions) (result SetOnlineMeetingRecordingContentOperationResponse, err error) {
