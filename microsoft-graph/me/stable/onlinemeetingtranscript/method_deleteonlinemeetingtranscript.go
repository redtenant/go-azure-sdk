...
func (c OnlineMeetingTranscriptClient) DeleteOnlineMeetingTranscript(ctx context.Context, id stable.MeOnlineMeetingIdTranscriptId, options DeleteOnlineMeetingTranscriptOperationOptions) (result DeleteOnlineMeetingTranscriptOperationResponse, err error) {
