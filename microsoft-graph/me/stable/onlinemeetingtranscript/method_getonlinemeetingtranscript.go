...
func (c OnlineMeetingTranscriptClient) GetOnlineMeetingTranscript(ctx context.Context, id stable.MeOnlineMeetingIdTranscriptId, options GetOnlineMeetingTranscriptOperationOptions) (result GetOnlineMeetingTranscriptOperationResponse, err error) {
