...
func (c OnlineMeetingTranscriptClient) ListOnlineMeetingTranscripts(ctx context.Context, id stable.MeOnlineMeetingId, options ListOnlineMeetingTranscriptsOperationOptions) (result ListOnlineMeetingTranscriptsOperationResponse, err error) {
...
func (c OnlineMeetingTranscriptClient) ListOnlineMeetingTranscriptsComplete(ctx context.Context, id stable.MeOnlineMeetingId, options ListOnlineMeetingTranscriptsOperationOptions) (ListOnlineMeetingTranscriptsCompleteResult, error) {
...
func (c OnlineMeetingTranscriptClient) ListOnlineMeetingTranscriptsCompleteMatchingPredicate(ctx context.Context, id stable.MeOnlineMeetingId, options ListOnlineMeetingTranscriptsOperationOptions, predicate CallTranscriptOperationPredicate) (result ListOnlineMeetingTranscriptsCompleteResult, err error) {
