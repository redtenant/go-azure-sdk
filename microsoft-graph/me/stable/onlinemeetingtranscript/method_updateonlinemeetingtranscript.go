...
// UpdateOnlineMeetingTranscript - Update the navigation property transcripts in me
func (c OnlineMeetingTranscriptClient) UpdateOnlineMeetingTranscript(ctx context.Context, id stable.MeOnlineMeetingIdTranscriptId, input stable.CallTranscript, options UpdateOnlineMeetingTranscriptOperationOptions) (result UpdateOnlineMeetingTranscriptOperationResponse, err error) {
