...
func (c OnlineMeetingTranscriptContentClient) GetOnlineMeetingTranscriptContent(ctx context.Context, id stable.MeOnlineMeetingIdTranscriptId, options GetOnlineMeetingTranscriptContentOperationOptions) (result GetOnlineMeetingTranscriptContentOperationResponse, err error) {
