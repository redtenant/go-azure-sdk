...
// DeleteOnlineMeetingTranscriptMetadataContent - Delete metadataContent for the navigation property transcripts in me.
// The time-aligned metadata of the utterances in the transcript. Read-only.
func (c OnlineMeetingTranscriptMetadataContentClient) DeleteOnlineMeetingTranscriptMetadataContent(ctx context.Context, id stable.MeOnlineMeetingIdTranscriptId, options DeleteOnlineMeetingTranscriptMetadataContentOperationOptions) (result DeleteOnlineMeetingTranscriptMetadataContentOperationResponse, err error) {
