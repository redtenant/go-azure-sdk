...
type GetOnlineMeetingTranscriptMetadataContentOperationResponse struct {
...
func (c OnlineMeetingTranscriptMetadataContentClient) GetOnlineMeetingTranscriptMetadataContent(ctx context.Context, id stable.MeOnlineMeetingIdTranscriptId, options GetOnlineMeetingTranscriptMetadataContentOperationOptions) (result GetOnlineMeetingTranscriptMetadataContentOperationResponse, err error) {
