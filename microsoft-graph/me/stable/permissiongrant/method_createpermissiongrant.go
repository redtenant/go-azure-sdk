...
func (c PermissionGrantClient) CreatePermissionGrant(ctx context.Context, input stable.ResourceSpecificPermissionGrant, options CreatePermissionGrantOperationOptions) (result CreatePermissionGrantOperationResponse, err error) {
