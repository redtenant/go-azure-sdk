...
func (c PermissionGrantClient) DeletePermissionGrant(ctx context.Context, id stable.MePermissionGrantId, options DeletePermissionGrantOperationOptions) (result DeletePermissionGrantOperationResponse, err error) {
