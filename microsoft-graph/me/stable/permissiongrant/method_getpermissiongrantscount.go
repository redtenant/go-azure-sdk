...
func (c PermissionGrantClient) GetPermissionGrantsCount(ctx context.Context, options GetPermissionGrantsCountOperationOptions) (result GetPermissionGrantsCountOperationResponse, err error) {
