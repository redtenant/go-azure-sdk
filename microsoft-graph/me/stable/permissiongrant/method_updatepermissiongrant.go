...
func (c PermissionGrantClient) UpdatePermissionGrant(ctx context.Context, id stable.MePermissionGrantId, input stable.ResourceSpecificPermissionGrant, options UpdatePermissionGrantOperationOptions) (result UpdatePermissionGrantOperationResponse, err error) {
