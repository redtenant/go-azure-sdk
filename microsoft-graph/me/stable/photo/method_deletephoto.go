...
func DefaultDeletePhotoOperationOptions() DeletePhotoOperationOptions {
	return DeletePhotoOperationOptions{}
}
...
// DeletePhoto - Delete profilePhoto. Delete the photo for the signed-in user or the specified group.
func (c PhotoClient) DeletePhoto(ctx context.Context, options DeletePhotoOperationOptions) (result DeletePhotoOperationResponse, err error) {
