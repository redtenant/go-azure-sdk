...
// entity. Read-only.
func (c PhotoClient) RemovePhotoValue(ctx context.Context, id stable.MePhotoId, options RemovePhotoValueOperationOptions) (result RemovePhotoValueOperationResponse, err error) {
