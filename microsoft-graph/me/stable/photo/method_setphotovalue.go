...
// Read-only.
func (c PhotoClient) SetPhotoValue(ctx context.Context, id stable.MePhotoId, input []byte, options SetPhotoValueOperationOptions) (result SetPhotoValueOperationResponse, err error) {
