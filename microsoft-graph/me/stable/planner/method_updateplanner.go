...
// UpdatePlanner - Update the navigation property planner in me
func (c PlannerClient) UpdatePlanner(ctx context.Context, input stable.PlannerUser, options UpdatePlannerOperationOptions) (result UpdatePlannerOperationResponse, err error) {
