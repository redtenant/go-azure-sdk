...
// ListPlannerPlanBuckets - Get buckets from me. Read-only. Nullable. Collection of buckets in the plan.
func (c PlannerPlanBucketClient) ListPlannerPlanBuckets(ctx context.Context, id stable.MePlannerPlanId, options ListPlannerPlanBucketsOperationOptions) (result ListPlannerPlanBucketsOperationResponse, err error) {
...
func (c PlannerPlanBucketClient) ListPlannerPlanBucketsComplete(ctx context.Context, id stable.MePlannerPlanId, options ListPlannerPlanBucketsOperationOptions) (ListPlannerPlanBucketsCompleteResult, error) {
...
func (c PlannerPlanBucketClient) ListPlannerPlanBucketsCompleteMatchingPredicate(ctx context.Context, id stable.MePlannerPlanId, options ListPlannerPlanBucketsOperationOptions, predicate PlannerBucketOperationPredicate) (result ListPlannerPlanBucketsCompleteResult, err error) {
