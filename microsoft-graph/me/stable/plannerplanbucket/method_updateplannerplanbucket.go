...
func (c PlannerPlanBucketClient) UpdatePlannerPlanBucket(ctx context.Context, id stable.MePlannerPlanIdBucketId, input stable.PlannerBucket, options UpdatePlannerPlanBucketOperationOptions) (result UpdatePlannerPlanBucketOperationResponse, err error) {
