...
// ListPlannerPlanBucketTasks - Get tasks from me. Read-only. Nullable. The collection of tasks in the bucket.
func (c PlannerPlanBucketTaskClient) ListPlannerPlanBucketTasks(ctx context.Context, id stable.MePlannerPlanIdBucketId, options ListPlannerPlanBucketTasksOperationOptions) (result ListPlannerPlanBucketTasksOperationResponse, err error) {
...
func (c PlannerPlanBucketTaskClient) ListPlannerPlanBucketTasksComplete(ctx context.Context, id stable.MePlannerPlanIdBucketId, options ListPlannerPlanBucketTasksOperationOptions) (ListPlannerPlanBucketTasksCompleteResult, error) {
...
func (c PlannerPlanBucketTaskClient) ListPlannerPlanBucketTasksCompleteMatchingPredicate(ctx context.Context, id stable.MePlannerPlanIdBucketId, options ListPlannerPlanBucketTasksOperationOptions, predicate PlannerTaskOperationPredicate) (result ListPlannerPlanBucketTasksCompleteResult, err error) {
