...
func (c PlannerPlanBucketTaskClient) UpdatePlannerPlanBucketTask(ctx context.Context, id stable.MePlannerPlanIdBucketIdTaskId, input stable.PlannerTask, options UpdatePlannerPlanBucketTaskOperationOptions) (result UpdatePlannerPlanBucketTaskOperationResponse, err error) {
