...
// DeletePlannerPlanBucketTaskAssignedToTaskBoardFormat - Delete navigation property assignedToTaskBoardFormat for me
func (c PlannerPlanBucketTaskAssignedToTaskBoardFormatClient) DeletePlannerPlanBucketTaskAssignedToTaskBoardFormat(ctx context.Context, id stable.MePlannerPlanIdBucketIdTaskId, options DeletePlannerPlanBucketTaskAssignedToTaskBoardFormatOperationOptions) (result DeletePlannerPlanBucketTaskAssignedToTaskBoardFormatOperationResponse, err error) {
