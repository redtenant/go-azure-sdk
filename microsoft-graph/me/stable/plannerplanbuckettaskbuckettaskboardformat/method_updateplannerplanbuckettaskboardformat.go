...
func (c PlannerPlanBucketTaskBucketTaskBoardFormatClient) UpdatePlannerPlanBucketTaskBoardFormat(ctx context.Context, id stable.MePlannerPlanIdBucketIdTaskId, input stable.PlannerBucketTaskBoardTaskFormat, options UpdatePlannerPlanBucketTaskBoardFormatOperationOptions) (result UpdatePlannerPlanBucketTaskBoardFormatOperationResponse, err error) {
