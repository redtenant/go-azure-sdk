...
// DeletePlannerPlanBucketTaskDetail - Delete navigation property details for me
func (c PlannerPlanBucketTaskDetailClient) DeletePlannerPlanBucketTaskDetail(ctx context.Context, id stable.MePlannerPlanIdBucketIdTaskId, options DeletePlannerPlanBucketTaskDetailOperationOptions) (result DeletePlannerPlanBucketTaskDetailOperationResponse, err error) {
