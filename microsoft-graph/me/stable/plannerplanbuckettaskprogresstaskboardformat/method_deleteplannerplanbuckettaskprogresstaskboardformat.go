...
// DeletePlannerPlanBucketTaskProgressTaskBoardFormat - Delete navigation property progressTaskBoardFormat for me
func (c PlannerPlanBucketTaskProgressTaskBoardFormatClient) DeletePlannerPlanBucketTaskProgressTaskBoardFormat(ctx context.Context, id stable.MePlannerPlanIdBucketIdTaskId, options DeletePlannerPlanBucketTaskProgressTaskBoardFormatOperationOptions) (result DeletePlannerPlanBucketTaskProgressTaskBoardFormatOperationResponse, err error) {
