...
// UpdatePlannerPlanBucketTaskProgressTaskBoardFormat - Update the navigation property progressTaskBoardFormat in me
func (c PlannerPlanBucketTaskProgressTaskBoardFormatClient) UpdatePlannerPlanBucketTaskProgressTaskBoardFormat(ctx context.Context, id stable.MePlannerPlanIdBucketIdTaskId, input stable.PlannerProgressTaskBoardTaskFormat, options UpdatePlannerPlanBucketTaskProgressTaskBoardFormatOperationOptions) (result UpdatePlannerPlanBucketTaskProgressTaskBoardFormatOperationResponse, err error) {
