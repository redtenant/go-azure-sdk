...
// DeletePlannerPlanTaskProgressTaskBoardFormat - Delete navigation property progressTaskBoardFormat for me
func (c PlannerPlanTaskProgressTaskBoardFormatClient) DeletePlannerPlanTaskProgressTaskBoardFormat(ctx context.Context, id stable.MePlannerPlanIdTaskId, options DeletePlannerPlanTaskProgressTaskBoardFormatOperationOptions) (result DeletePlannerPlanTaskProgressTaskBoardFormatOperationResponse, err error) {
