...
// GetPlannerPlanTaskProgressTaskBoardFormat - Get progressTaskBoardFormat from me. Read-only. Nullable. Used to render
// the task correctly in the task board view when grouped by progress.
func (c PlannerPlanTaskProgressTaskBoardFormatClient) GetPlannerPlanTaskProgressTaskBoardFormat(ctx context.Context, id stable.MePlannerPlanIdTaskId, options GetPlannerPlanTaskProgressTaskBoardFormatOperationOptions) (result GetPlannerPlanTaskProgressTaskBoardFormatOperationResponse, err error) {
