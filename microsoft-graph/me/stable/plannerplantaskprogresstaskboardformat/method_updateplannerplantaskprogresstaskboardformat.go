...
// UpdatePlannerPlanTaskProgressTaskBoardFormat - Update the navigation property progressTaskBoardFormat in me
func (c PlannerPlanTaskProgressTaskBoardFormatClient) UpdatePlannerPlanTaskProgressTaskBoardFormat(ctx context.Context, id stable.MePlannerPlanIdTaskId, input stable.PlannerProgressTaskBoardTaskFormat, options UpdatePlannerPlanTaskProgressTaskBoardFormatOperationOptions) (result UpdatePlannerPlanTaskProgressTaskBoardFormatOperationResponse, err error) {
