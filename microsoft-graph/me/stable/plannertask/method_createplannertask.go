...
func (c PlannerTaskClient) CreatePlannerTask(ctx context.Context, input stable.PlannerTask, options CreatePlannerTaskOperationOptions) (result CreatePlannerTaskOperationResponse, err error) {
