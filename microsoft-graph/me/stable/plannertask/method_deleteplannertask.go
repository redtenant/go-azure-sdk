...
func (c PlannerTaskClient) DeletePlannerTask(ctx context.Context, id stable.MePlannerTaskId, options DeletePlannerTaskOperationOptions) (result DeletePlannerTaskOperationResponse, err error) {
