...
// DeletePlannerTaskAssignedToTaskBoardFormat - Delete navigation property assignedToTaskBoardFormat for me
func (c PlannerTaskAssignedToTaskBoardFormatClient) DeletePlannerTaskAssignedToTaskBoardFormat(ctx context.Context, id stable.MePlannerTaskId, options DeletePlannerTaskAssignedToTaskBoardFormatOperationOptions) (result DeletePlannerTaskAssignedToTaskBoardFormatOperationResponse, err error) {
