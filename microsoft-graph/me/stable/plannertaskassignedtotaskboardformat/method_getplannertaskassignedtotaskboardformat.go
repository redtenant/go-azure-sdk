...
func (c PlannerTaskAssignedToTaskBoardFormatClient) GetPlannerTaskAssignedToTaskBoardFormat(ctx context.Context, id stable.MePlannerTaskId, options GetPlannerTaskAssignedToTaskBoardFormatOperationOptions) (result GetPlannerTaskAssignedToTaskBoardFormatOperationResponse, err error) {
