...
func (c PlannerTaskDetailClient) DeletePlannerTaskDetail(ctx context.Context, id stable.MePlannerTaskId, options DeletePlannerTaskDetailOperationOptions) (result DeletePlannerTaskDetailOperationResponse, err error) {
