...
func (c PlannerTaskDetailClient) UpdatePlannerTaskDetail(ctx context.Context, id stable.MePlannerTaskId, input stable.PlannerTaskDetails, options UpdatePlannerTaskDetailOperationOptions) (result UpdatePlannerTaskDetailOperationResponse, err error) {
