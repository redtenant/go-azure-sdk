...
// expiration.
func (c PresenceClient) SetPresenceUserPreferredPresence(ctx context.Context, input SetPresenceUserPreferredPresenceRequest, options SetPresenceUserPreferredPresenceOperationOptions) (result SetPresenceUserPreferredPresenceOperationResponse, err error) {
