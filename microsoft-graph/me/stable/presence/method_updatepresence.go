...
func (c PresenceClient) UpdatePresence(ctx context.Context, input stable.Presence, options UpdatePresenceOperationOptions) (result UpdatePresenceOperationResponse, err error) {
