...
// GetSettingStorage - Get storage from me
func (c SettingStorageClient) GetSettingStorage(ctx context.Context, options GetSettingStorageOperationOptions) (result GetSettingStorageOperationResponse, err error) {
