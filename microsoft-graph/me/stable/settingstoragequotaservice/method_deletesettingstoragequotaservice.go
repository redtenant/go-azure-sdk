...
// DeleteSettingStorageQuotaService - Delete navigation property services for me
func (c SettingStorageQuotaServiceClient) DeleteSettingStorageQuotaService(ctx context.Context, id stable.MeSettingStorageQuotaServiceId, options DeleteSettingStorageQuotaServiceOperationOptions) (result DeleteSettingStorageQuotaServiceOperationResponse, err error) {
