...
// GetSettingStorageQuotaService - Get services from me
func (c SettingStorageQuotaServiceClient) GetSettingStorageQuotaService(ctx context.Context, id stable.MeSettingStorageQuotaServiceId, options GetSettingStorageQuotaServiceOperationOptions) (result GetSettingStorageQuotaServiceOperationResponse, err error) {
