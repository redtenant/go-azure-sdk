...
func (c SettingWindowClient) GetSettingWindow(ctx context.Context, id stable.MeSettingWindowId, options GetSettingWindowOperationOptions) (result GetSettingWindowOperationResponse, err error) {
