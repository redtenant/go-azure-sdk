...
func (c SettingWindowClient) UpdateSettingWindow(ctx context.Context, id stable.MeSettingWindowId, input stable.WindowsSetting, options UpdateSettingWindowOperationOptions) (result UpdateSettingWindowOperationResponse, err error) {
