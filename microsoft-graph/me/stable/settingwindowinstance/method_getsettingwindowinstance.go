...
// method gets a windowsSettingInstance for the signed-in user.
func (c SettingWindowInstanceClient) GetSettingWindowInstance(ctx context.Context, id stable.MeSettingWindowIdInstanceId, options GetSettingWindowInstanceOperationOptions) (result GetSettingWindowInstanceOperationResponse, err error) {
