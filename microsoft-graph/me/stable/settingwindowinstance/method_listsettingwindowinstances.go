...
func (c SettingWindowInstanceClient) ListSettingWindowInstances(ctx context.Context, id stable.MeSettingWindowId, options ListSettingWindowInstancesOperationOptions) (result ListSettingWindowInstancesOperationResponse, err error) {
...
func (c SettingWindowInstanceClient) ListSettingWindowInstancesComplete(ctx context.Context, id stable.MeSettingWindowId, options ListSettingWindowInstancesOperationOptions) (ListSettingWindowInstancesCompleteResult, error) {
...
func (c SettingWindowInstanceClient) ListSettingWindowInstancesCompleteMatchingPredicate(ctx context.Context, id stable.MeSettingWindowId, options ListSettingWindowInstancesOperationOptions, predicate WindowsSettingInstanceOperationPredicate) (result ListSettingWindowInstancesCompleteResult, err error) {
