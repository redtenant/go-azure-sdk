...
func (c TeamworkAssociatedTeamClient) GetTeamworkAssociatedTeamsCount(ctx context.Context, options GetTeamworkAssociatedTeamsCountOperationOptions) (result GetTeamworkAssociatedTeamsCountOperationResponse, err error) {
