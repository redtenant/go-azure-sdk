...
// GetTeamworkAssociatedTeamTeam - Get team from me
func (c TeamworkAssociatedTeamTeamClient) GetTeamworkAssociatedTeamTeam(ctx context.Context, id stable.MeTeamworkAssociatedTeamId, options GetTeamworkAssociatedTeamTeamOperationOptions) (result GetTeamworkAssociatedTeamTeamOperationResponse, err error) {
