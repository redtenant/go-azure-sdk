...
func (c TeamworkInstalledAppClient) DeleteTeamworkInstalledApp(ctx context.Context, id stable.MeTeamworkInstalledAppId, options DeleteTeamworkInstalledAppOperationOptions) (result DeleteTeamworkInstalledAppOperationResponse, err error) {
