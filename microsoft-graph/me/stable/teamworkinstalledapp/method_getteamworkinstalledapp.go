...
// GetTeamworkInstalledApp - Get installedApps from me. The apps installed in the personal scope of this user.
func (c TeamworkInstalledAppClient) GetTeamworkInstalledApp(ctx context.Context, id stable.MeTeamworkInstalledAppId, options GetTeamworkInstalledAppOperationOptions) (result GetTeamworkInstalledAppOperationResponse, err error) {
