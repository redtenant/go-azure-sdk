...
func (c TeamworkInstalledAppTeamsAppDefinitionClient) GetTeamworkInstalledAppTeamsAppDefinition(ctx context.Context, id stable.MeTeamworkInstalledAppId, options GetTeamworkInstalledAppTeamsAppDefinitionOperationOptions) (result GetTeamworkInstalledAppTeamsAppDefinitionOperationResponse, err error) {
