...
// GetTodo - Get todo from me. Represents the To Do services available to a user.
func (c TodoClient) GetTodo(ctx context.Context, options GetTodoOperationOptions) (result GetTodoOperationResponse, err error) {
