...
func (c TodoListClient) CreateTodoList(ctx context.Context, input stable.TodoTaskList, options CreateTodoListOperationOptions) (result CreateTodoListOperationResponse, err error) {
