...
func (c TodoListClient) DeleteTodoList(ctx context.Context, id stable.MeTodoListId, options DeleteTodoListOperationOptions) (result DeleteTodoListOperationResponse, err error) {
