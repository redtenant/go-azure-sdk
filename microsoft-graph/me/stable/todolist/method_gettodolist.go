...
func (c TodoListClient) GetTodoList(ctx context.Context, id stable.MeTodoListId, options GetTodoListOperationOptions) (result GetTodoListOperationResponse, err error) {
