...
func (c TodoListClient) UpdateTodoList(ctx context.Context, id stable.MeTodoListId, input stable.TodoTaskList, options UpdateTodoListOperationOptions) (result UpdateTodoListOperationResponse, err error) {
