...
// UpdateTodoListExtension - Update the navigation property extensions in me
func (c TodoListExtensionClient) UpdateTodoListExtension(ctx context.Context, id stable.MeTodoListIdExtensionId, input stable.Extension, options UpdateTodoListExtensionOperationOptions) (result UpdateTodoListExtensionOperationResponse, err error) {
