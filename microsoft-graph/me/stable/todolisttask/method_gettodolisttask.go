...
func (c TodoListTaskClient) GetTodoListTask(ctx context.Context, id stable.MeTodoListIdTaskId, options GetTodoListTaskOperationOptions) (result GetTodoListTaskOperationResponse, err error) {
