...
func DefaultDeleteTodoListTaskAttachmentOperationOptions() DeleteTodoListTaskAttachmentOperationOptions {
	return DeleteTodoListTaskAttachmentOperationOptions{}
}
...
// DeleteTodoListTaskAttachment - Delete taskFileAttachment. Delete a taskFileAttachment object from a todoTask
// resource.
func (c TodoListTaskAttachmentClient) DeleteTodoListTaskAttachment(ctx context.Context, id stable.MeTodoListIdTaskIdAttachmentId, options DeleteTodoListTaskAttachmentOperationOptions) (result DeleteTodoListTaskAttachmentOperationResponse, err error) {
