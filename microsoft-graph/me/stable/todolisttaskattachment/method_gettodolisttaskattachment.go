...
// object.
func (c TodoListTaskAttachmentClient) GetTodoListTaskAttachment(ctx context.Context, id stable.MeTodoListIdTaskIdAttachmentId, options GetTodoListTaskAttachmentOperationOptions) (result GetTodoListTaskAttachmentOperationResponse, err error) {
