...
func (c TodoListTaskAttachmentClient) GetTodoListTaskAttachmentsCount(ctx context.Context, id stable.MeTodoListIdTaskId, options GetTodoListTaskAttachmentsCountOperationOptions) (result GetTodoListTaskAttachmentsCountOperationResponse, err error) {
