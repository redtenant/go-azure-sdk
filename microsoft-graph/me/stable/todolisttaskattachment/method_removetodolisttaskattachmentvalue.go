...
// RemoveTodoListTaskAttachmentValue - Delete taskFileAttachment. Delete a taskFileAttachment object from a todoTask
// resource.
func (c TodoListTaskAttachmentClient) RemoveTodoListTaskAttachmentValue(ctx context.Context, id stable.MeTodoListIdTaskIdAttachmentId, options RemoveTodoListTaskAttachmentValueOperationOptions) (result RemoveTodoListTaskAttachmentValueOperationResponse, err error) {
