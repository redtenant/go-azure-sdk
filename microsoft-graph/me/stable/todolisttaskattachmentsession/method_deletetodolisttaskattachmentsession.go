...
func DefaultDeleteTodoListTaskAttachmentSessionOperationOptions() DeleteTodoListTaskAttachmentSessionOperationOptions {
	return DeleteTodoListTaskAttachmentSessionOperationOptions{}
}
...
// DeleteTodoListTaskAttachmentSession - Delete navigation property attachmentSessions for me
func (c TodoListTaskAttachmentSessionClient) DeleteTodoListTaskAttachmentSession(ctx context.Context, id stable.MeTodoListIdTaskIdAttachmentSessionId, options DeleteTodoListTaskAttachmentSessionOperationOptions) (result DeleteTodoListTaskAttachmentSessionOperationResponse, err error) {
