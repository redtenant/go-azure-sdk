...
func (c TodoListTaskAttachmentSessionClient) GetTodoListTaskAttachmentSession(ctx context.Context, id stable.MeTodoListIdTaskIdAttachmentSessionId, options GetTodoListTaskAttachmentSessionOperationOptions) (result GetTodoListTaskAttachmentSessionOperationResponse, err error) {
