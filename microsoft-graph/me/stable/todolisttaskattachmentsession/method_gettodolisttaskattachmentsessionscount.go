...
func (c TodoListTaskAttachmentSessionClient) GetTodoListTaskAttachmentSessionsCount(ctx context.Context, id stable.MeTodoListIdTaskId, options GetTodoListTaskAttachmentSessionsCountOperationOptions) (result GetTodoListTaskAttachmentSessionsCountOperationResponse, err error) {
