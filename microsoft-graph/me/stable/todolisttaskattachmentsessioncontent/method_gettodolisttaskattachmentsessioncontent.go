...
type GetTodoListTaskAttachmentSessionContentOperationResponse struct {
...
// GetTodoListTaskAttachmentSessionContent - Get content for the navigation property attachmentSessions from me. The
// content streams that are uploaded.
func (c TodoListTaskAttachmentSessionContentClient) GetTodoListTaskAttachmentSessionContent(ctx context.Context, id stable.MeTodoListIdTaskIdAttachmentSessionId, options GetTodoListTaskAttachmentSessionContentOperationOptions) (result GetTodoListTaskAttachmentSessionContentOperationResponse, err error) {
