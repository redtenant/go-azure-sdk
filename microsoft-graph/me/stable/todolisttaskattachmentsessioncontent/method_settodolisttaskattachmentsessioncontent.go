...
// SetTodoListTaskAttachmentSessionContent - Update content for the navigation property attachmentSessions in me. The
// content streams that are uploaded.
func (c TodoListTaskAttachmentSessionContentClient) SetTodoListTaskAttachmentSessionContent(ctx context.Context, id stable.MeTodoListIdTaskIdAttachmentSessionId, input []byte, options SetTodoListTaskAttachmentSessionContentOperationOptions) (result SetTodoListTaskAttachmentSessionContentOperationResponse, err error) {
