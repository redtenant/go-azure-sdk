...
// CreateTodoListTaskChecklistItem - Create checklistItem. Create a new checklistItem object.
func (c TodoListTaskChecklistItemClient) CreateTodoListTaskChecklistItem(ctx context.Context, id stable.MeTodoListIdTaskId, input stable.ChecklistItem, options CreateTodoListTaskChecklistItemOperationOptions) (result CreateTodoListTaskChecklistItemOperationResponse, err error) {
