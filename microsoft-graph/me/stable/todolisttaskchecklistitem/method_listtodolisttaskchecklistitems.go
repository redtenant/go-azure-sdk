...
// ListTodoListTaskChecklistItems - List checklistItems. Get the checklistItem resources associated to a todoTask from
// the checklistItems navigation property.
func (c TodoListTaskChecklistItemClient) ListTodoListTaskChecklistItems(ctx context.Context, id stable.MeTodoListIdTaskId, options ListTodoListTaskChecklistItemsOperationOptions) (result ListTodoListTaskChecklistItemsOperationResponse, err error) {
...
func (c TodoListTaskChecklistItemClient) ListTodoListTaskChecklistItemsComplete(ctx context.Context, id stable.MeTodoListIdTaskId, options ListTodoListTaskChecklistItemsOperationOptions) (ListTodoListTaskChecklistItemsCompleteResult, error) {
...
func (c TodoListTaskChecklistItemClient) ListTodoListTaskChecklistItemsCompleteMatchingPredicate(ctx context.Context, id stable.MeTodoListIdTaskId, options ListTodoListTaskChecklistItemsOperationOptions, predicate ChecklistItemOperationPredicate) (result ListTodoListTaskChecklistItemsCompleteResult, err error) {
