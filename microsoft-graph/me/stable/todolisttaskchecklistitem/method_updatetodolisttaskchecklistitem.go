...
func (c TodoListTaskChecklistItemClient) UpdateTodoListTaskChecklistItem(ctx context.Context, id stable.MeTodoListIdTaskIdChecklistItemId, input stable.ChecklistItem, options UpdateTodoListTaskChecklistItemOperationOptions) (result UpdateTodoListTaskChecklistItemOperationResponse, err error) {
