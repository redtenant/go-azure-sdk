...
// DeleteTodoListTaskExtension - Delete navigation property extensions for me
func (c TodoListTaskExtensionClient) DeleteTodoListTaskExtension(ctx context.Context, id stable.MeTodoListIdTaskIdExtensionId, options DeleteTodoListTaskExtensionOperationOptions) (result DeleteTodoListTaskExtensionOperationResponse, err error) {
