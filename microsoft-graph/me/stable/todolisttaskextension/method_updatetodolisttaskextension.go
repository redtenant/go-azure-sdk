...
func (c TodoListTaskExtensionClient) UpdateTodoListTaskExtension(ctx context.Context, id stable.MeTodoListIdTaskIdExtensionId, input stable.Extension, options UpdateTodoListTaskExtensionOperationOptions) (result UpdateTodoListTaskExtensionOperationResponse, err error) {
