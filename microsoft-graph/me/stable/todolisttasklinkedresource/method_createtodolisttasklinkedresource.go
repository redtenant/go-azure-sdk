...
func (c TodoListTaskLinkedResourceClient) CreateTodoListTaskLinkedResource(ctx context.Context, id stable.MeTodoListIdTaskId, input stable.LinkedResource, options CreateTodoListTaskLinkedResourceOperationOptions) (result CreateTodoListTaskLinkedResourceOperationResponse, err error) {
