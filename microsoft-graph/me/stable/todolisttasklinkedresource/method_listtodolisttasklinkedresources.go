...
func (c TodoListTaskLinkedResourceClient) ListTodoListTaskLinkedResources(ctx context.Context, id stable.MeTodoListIdTaskId, options ListTodoListTaskLinkedResourcesOperationOptions) (result ListTodoListTaskLinkedResourcesOperationResponse, err error) {
...
func (c TodoListTaskLinkedResourceClient) ListTodoListTaskLinkedResourcesComplete(ctx context.Context, id stable.MeTodoListIdTaskId, options ListTodoListTaskLinkedResourcesOperationOptions) (ListTodoListTaskLinkedResourcesCompleteResult, error) {
