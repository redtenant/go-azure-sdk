...
// GetTransitiveMemberOf - Get transitiveMemberOf from me. The groups, including nested groups, and directory roles that
// a user is a member of. Nullable.
func (c TransitiveMemberOfClient) GetTransitiveMemberOf(ctx context.Context, id stable.MeTransitiveMemberOfId, options GetTransitiveMemberOfOperationOptions) (result GetTransitiveMemberOfOperationResponse, err error) {
