...
type GetAppManagementPolicyAppliesToCountOperationResponse struct {
	HttpResponse *http.Response
	OData        *odata.OData
	Model        *[]byte
}

type GetAppManagementPolicyAppliesToCountOperationOptions struct {
	Filter    *string
...
func DefaultGetAppManagementPolicyAppliesToCountOperationOptions() GetAppManagementPolicyAppliesToCountOperationOptions {
	return GetAppManagementPolicyAppliesToCountOperationOptions{}
}
...
func (c AppManagementPolicyAppliesToClient) GetAppManagementPolicyAppliesToCount(ctx context.Context, id beta.PolicyAppManagementPolicyId, options GetAppManagementPolicyAppliesToCountOperationOptions) (result GetAppManagementPolicyAppliesToCountOperationResponse, err error) {
