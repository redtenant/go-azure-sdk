...
type ListAppManagementPolicyAppliesTosOperationOptions struct {
	Count     *bool
	Expand    *odata.Expand
	Filter    *string
...
func DefaultListAppManagementPolicyAppliesTosOperationOptions() ListAppManagementPolicyAppliesTosOperationOptions {
	return ListAppManagementPolicyAppliesTosOperationOptions{}
}
...
// ListAppManagementPolicyAppliesTos - List appliesTo. List application and service principal objects assigned an
// appManagementPolicy policy object.
func (c AppManagementPolicyAppliesToClient) ListAppManagementPolicyAppliesTos(ctx context.Context, id beta.PolicyAppManagementPolicyId, options ListAppManagementPolicyAppliesTosOperationOptions) (result ListAppManagementPolicyAppliesTosOperationResponse, err error) {
...
func (c AppManagementPolicyAppliesToClient) ListAppManagementPolicyAppliesTosComplete(ctx context.Context, id beta.PolicyAppManagementPolicyId, options ListAppManagementPolicyAppliesTosOperationOptions) (ListAppManagementPolicyAppliesTosCompleteResult, error) {
	return c.ListAppManagementPolicyAppliesTosCompleteMatchingPredicate(ctx, id, options, DirectoryObjectOperationPredicate{})
}

// ListAppManagementPolicyAppliesTosCompleteMatchingPredicate retrieves all the results and then applies the predicate
func (c AppManagementPolicyAppliesToClient) ListAppManagementPolicyAppliesTosCompleteMatchingPredicate(ctx context.Context, id beta.PolicyAppManagementPolicyId, options ListAppManagementPolicyAppliesTosOperationOptions, predicate DirectoryObjectOperationPredicate) (result ListAppManagementPolicyAppliesTosCompleteResult, err error) {
	items := make([]beta.DirectoryObject, 0)

	resp, err := c.ListAppManagementPolicyAppliesTos(ctx, id, options)
	if err != nil {
