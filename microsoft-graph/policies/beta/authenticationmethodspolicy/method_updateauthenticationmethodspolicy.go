...
func (c AuthenticationMethodsPolicyClient) UpdateAuthenticationMethodsPolicy(ctx context.Context, input beta.AuthenticationMethodsPolicy, options UpdateAuthenticationMethodsPolicyOperationOptions) (result UpdateAuthenticationMethodsPolicyOperationResponse, err error) {
