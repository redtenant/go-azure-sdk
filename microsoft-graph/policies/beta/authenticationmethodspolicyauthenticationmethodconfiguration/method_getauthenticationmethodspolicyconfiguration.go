...
// GetAuthenticationMethodsPolicyConfiguration - Get externalAuthenticationMethodConfiguration. Read the properties and
// relationships of an externalAuthenticationMethodConfiguration object.
func (c AuthenticationMethodsPolicyAuthenticationMethodConfigurationClient) GetAuthenticationMethodsPolicyConfiguration(ctx context.Context, id beta.PolicyAuthenticationMethodsPolicyAuthenticationMethodConfigurationId, options GetAuthenticationMethodsPolicyConfigurationOperationOptions) (result GetAuthenticationMethodsPolicyConfigurationOperationResponse, err error) {
