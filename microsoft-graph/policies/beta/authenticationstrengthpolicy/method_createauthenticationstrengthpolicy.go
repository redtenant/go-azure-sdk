...
func (c AuthenticationStrengthPolicyClient) CreateAuthenticationStrengthPolicy(ctx context.Context, input beta.AuthenticationStrengthPolicy, options CreateAuthenticationStrengthPolicyOperationOptions) (result CreateAuthenticationStrengthPolicyOperationResponse, err error) {
	...
	var model beta.AuthenticationStrengthPolicy
	result.Model = &model
