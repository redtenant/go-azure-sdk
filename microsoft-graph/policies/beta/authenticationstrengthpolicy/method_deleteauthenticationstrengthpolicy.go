...
func (c AuthenticationStrengthPolicyClient) DeleteAuthenticationStrengthPolicy(ctx context.Context, id beta.PolicyAuthenticationStrengthPolicyId, options DeleteAuthenticationStrengthPolicyOperationOptions) (result DeleteAuthenticationStrengthPolicyOperationResponse, err error) {
