...
func (c AuthenticationStrengthPolicyClient) GetAuthenticationStrengthPolicy(ctx context.Context, id beta.PolicyAuthenticationStrengthPolicyId, options GetAuthenticationStrengthPolicyOperationOptions) (result GetAuthenticationStrengthPolicyOperationResponse, err error) {
