...
type ListAuthenticationStrengthPoliciesOperationResponse struct {
	...
	OData        *odata.OData
	Model        *[]beta.AuthenticationStrengthPolicy
}

type ListAuthenticationStrengthPoliciesCompleteResult struct {
	LatestHttpResponse *http.Response
	Items              []beta.AuthenticationStrengthPolicy
}
...
func DefaultListAuthenticationStrengthPoliciesOperationOptions() ListAuthenticationStrengthPoliciesOperationOptions {
	return ListAuthenticationStrengthPoliciesOperationOptions{}
}
...
// ListAuthenticationStrengthPolicies - List authenticationStrengthPolicies. Get a list of the
// authenticationStrengthPolicy objects and their properties. This API returns both built-in and custom policies.
func (c AuthenticationStrengthPolicyClient) ListAuthenticationStrengthPolicies(ctx context.Context, options ListAuthenticationStrengthPoliciesOperationOptions) (result ListAuthenticationStrengthPoliciesOperationResponse, err error) {
	opts := client.RequestOptions{
		...
		Pager:         &ListAuthenticationStrengthPoliciesCustomPager{},
	...
	var values struct {
		Values *[]beta.AuthenticationStrengthPolicy `json:"value"`
	}
...
func (c AuthenticationStrengthPolicyClient) ListAuthenticationStrengthPoliciesComplete(ctx context.Context, options ListAuthenticationStrengthPoliciesOperationOptions) (ListAuthenticationStrengthPoliciesCompleteResult, error) {
	return c.ListAuthenticationStrengthPoliciesCompleteMatchingPredicate(ctx, options, AuthenticationStrengthPolicyOperationPredicate{})
}
...
func (c AuthenticationStrengthPolicyClient) ListAuthenticationStrengthPoliciesCompleteMatchingPredicate(ctx context.Context, options ListAuthenticationStrengthPoliciesOperationOptions, predicate AuthenticationStrengthPolicyOperationPredicate) (result ListAuthenticationStrengthPoliciesCompleteResult, err error) {
	items := make([]beta.AuthenticationStrengthPolicy, 0)

	resp, err := c.ListAuthenticationStrengthPolicies(ctx, options)
	if err != nil {
	...
	result = ListAuthenticationStrengthPoliciesCompleteResult{
