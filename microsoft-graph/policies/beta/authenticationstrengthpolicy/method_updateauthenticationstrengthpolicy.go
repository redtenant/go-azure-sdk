...
func (c AuthenticationStrengthPolicyClient) UpdateAuthenticationStrengthPolicy(ctx context.Context, id beta.PolicyAuthenticationStrengthPolicyId, input beta.AuthenticationStrengthPolicy, options UpdateAuthenticationStrengthPolicyOperationOptions) (result UpdateAuthenticationStrengthPolicyOperationResponse, err error) {
