...
type UpdateAuthenticationStrengthPolicyAllowedCombinationsOperationResponse struct {
	...
	OData        *odata.OData
	Model        *beta.UpdateAllowedCombinationsResult
}
...
func (c AuthenticationStrengthPolicyClient) UpdateAuthenticationStrengthPolicyAllowedCombinations(ctx context.Context, id beta.PolicyAuthenticationStrengthPolicyId, input UpdateAuthenticationStrengthPolicyAllowedCombinationsRequest, options UpdateAuthenticationStrengthPolicyAllowedCombinationsOperationOptions) (result UpdateAuthenticationStrengthPolicyAllowedCombinationsOperationResponse, err error) {
	...
	var model beta.UpdateAllowedCombinationsResult
	result.Model = &model
