...
func (c AuthenticationStrengthPolicyCombinationConfigurationClient) CreateAuthenticationStrengthPolicyCombinationConfiguration(ctx context.Context, id beta.PolicyAuthenticationStrengthPolicyId, input beta.AuthenticationCombinationConfiguration, options CreateAuthenticationStrengthPolicyCombinationConfigurationOperationOptions) (result CreateAuthenticationStrengthPolicyCombinationConfigurationOperationResponse, err error) {
	...
	model, err := beta.UnmarshalAuthenticationCombinationConfigurationImplementation(respObj)
	if err != nil {
		return
	}
	result.Model = model
