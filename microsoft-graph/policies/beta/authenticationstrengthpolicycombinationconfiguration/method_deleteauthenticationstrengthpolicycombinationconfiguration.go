...
// policies
func (c AuthenticationStrengthPolicyCombinationConfigurationClient) DeleteAuthenticationStrengthPolicyCombinationConfiguration(ctx context.Context, id beta.PolicyAuthenticationStrengthPolicyIdCombinationConfigurationId, options DeleteAuthenticationStrengthPolicyCombinationConfigurationOperationOptions) (result DeleteAuthenticationStrengthPolicyCombinationConfigurationOperationResponse, err error) {
