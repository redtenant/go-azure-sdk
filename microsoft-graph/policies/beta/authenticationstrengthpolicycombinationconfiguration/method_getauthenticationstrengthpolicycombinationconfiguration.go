...
func (c AuthenticationStrengthPolicyCombinationConfigurationClient) GetAuthenticationStrengthPolicyCombinationConfiguration(ctx context.Context, id beta.PolicyAuthenticationStrengthPolicyIdCombinationConfigurationId, options GetAuthenticationStrengthPolicyCombinationConfigurationOperationOptions) (result GetAuthenticationStrengthPolicyCombinationConfigurationOperationResponse, err error) {
