...
// in policies
func (c AuthenticationStrengthPolicyCombinationConfigurationClient) UpdateAuthenticationStrengthPolicyCombinationConfiguration(ctx context.Context, id beta.PolicyAuthenticationStrengthPolicyIdCombinationConfigurationId, input beta.AuthenticationCombinationConfiguration, options UpdateAuthenticationStrengthPolicyCombinationConfigurationOperationOptions) (result UpdateAuthenticationStrengthPolicyCombinationConfigurationOperationResponse, err error) {
