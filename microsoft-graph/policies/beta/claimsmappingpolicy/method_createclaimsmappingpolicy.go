...
func (c ClaimsMappingPolicyClient) CreateClaimsMappingPolicy(ctx context.Context, input beta.ClaimsMappingPolicy, options CreateClaimsMappingPolicyOperationOptions) (result CreateClaimsMappingPolicyOperationResponse, err error) {
	...
	var model beta.ClaimsMappingPolicy
	result.Model = &model
