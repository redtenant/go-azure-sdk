...
// object.
func (c ClaimsMappingPolicyClient) GetClaimsMappingPolicy(ctx context.Context, id beta.PolicyClaimsMappingPolicyId, options GetClaimsMappingPolicyOperationOptions) (result GetClaimsMappingPolicyOperationResponse, err error) {
