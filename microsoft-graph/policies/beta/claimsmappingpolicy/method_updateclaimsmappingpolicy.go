...
func (c ClaimsMappingPolicyClient) UpdateClaimsMappingPolicy(ctx context.Context, id beta.PolicyClaimsMappingPolicyId, input beta.ClaimsMappingPolicy, options UpdateClaimsMappingPolicyOperationOptions) (result UpdateClaimsMappingPolicyOperationResponse, err error) {
