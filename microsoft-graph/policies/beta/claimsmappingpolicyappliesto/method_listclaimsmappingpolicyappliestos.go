...
// resources.
func (c ClaimsMappingPolicyAppliesToClient) ListClaimsMappingPolicyAppliesTos(ctx context.Context, id beta.PolicyClaimsMappingPolicyId, options ListClaimsMappingPolicyAppliesTosOperationOptions) (result ListClaimsMappingPolicyAppliesTosOperationResponse, err error) {
...
func (c ClaimsMappingPolicyAppliesToClient) ListClaimsMappingPolicyAppliesTosComplete(ctx context.Context, id beta.PolicyClaimsMappingPolicyId, options ListClaimsMappingPolicyAppliesTosOperationOptions) (ListClaimsMappingPolicyAppliesTosCompleteResult, error) {
...
func (c ClaimsMappingPolicyAppliesToClient) ListClaimsMappingPolicyAppliesTosCompleteMatchingPredicate(ctx context.Context, id beta.PolicyClaimsMappingPolicyId, options ListClaimsMappingPolicyAppliesTosOperationOptions, predicate DirectoryObjectOperationPredicate) (result ListClaimsMappingPolicyAppliesTosCompleteResult, err error) {
