...
func (c CrossTenantAccessPolicyPartnerIdentitySynchronizationClient) DeleteCrossTenantAccessPolicyPartnerIdentitySynchronization(ctx context.Context, id beta.PolicyCrossTenantAccessPolicyPartnerId, options DeleteCrossTenantAccessPolicyPartnerIdentitySynchronizationOperationOptions) (result DeleteCrossTenantAccessPolicyPartnerIdentitySynchronizationOperationResponse, err error) {
