...
// RemoveFeatureRolloutPolicyAppliesToRef - Remove appliesTo. Remove an appliesTo on a featureRolloutPolicy object to
// remove the directoryObject from feature rollout.
