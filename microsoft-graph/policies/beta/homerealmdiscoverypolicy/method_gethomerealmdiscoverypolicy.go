...
func (c HomeRealmDiscoveryPolicyClient) GetHomeRealmDiscoveryPolicy(ctx context.Context, id beta.PolicyHomeRealmDiscoveryPolicyId, options GetHomeRealmDiscoveryPolicyOperationOptions) (result GetHomeRealmDiscoveryPolicyOperationResponse, err error) {
