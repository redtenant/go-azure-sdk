...
// homeRealmDiscoveryPolicy object has been applied to. The homeRealmDiscoveryPolicy can only be applied to
// servicePrincipal resources.
func (c HomeRealmDiscoveryPolicyAppliesToClient) ListHomeRealmDiscoveryPolicyAppliesTos(ctx context.Context, id beta.PolicyHomeRealmDiscoveryPolicyId, options ListHomeRealmDiscoveryPolicyAppliesTosOperationOptions) (result ListHomeRealmDiscoveryPolicyAppliesTosOperationResponse, err error) {
...
func (c HomeRealmDiscoveryPolicyAppliesToClient) ListHomeRealmDiscoveryPolicyAppliesTosComplete(ctx context.Context, id beta.PolicyHomeRealmDiscoveryPolicyId, options ListHomeRealmDiscoveryPolicyAppliesTosOperationOptions) (ListHomeRealmDiscoveryPolicyAppliesTosCompleteResult, error) {
...
func (c HomeRealmDiscoveryPolicyAppliesToClient) ListHomeRealmDiscoveryPolicyAppliesTosCompleteMatchingPredicate(ctx context.Context, id beta.PolicyHomeRealmDiscoveryPolicyId, options ListHomeRealmDiscoveryPolicyAppliesTosOperationOptions, predicate DirectoryObjectOperationPredicate) (result ListHomeRealmDiscoveryPolicyAppliesTosCompleteResult, err error) {
