...
func DefaultGetMobileDeviceManagementPolicyOperationOptions() GetMobileDeviceManagementPolicyOperationOptions {
	return GetMobileDeviceManagementPolicyOperationOptions{}
}
...
// GetMobileDeviceManagementPolicy - Get mobileDeviceManagementPolicy. Read the properties and relationships of a
