...
func DefaultRemoveMobileDeviceManagementPolicyIncludedGroupRefOperationOptions() RemoveMobileDeviceManagementPolicyIncludedGroupRefOperationOptions {
	return RemoveMobileDeviceManagementPolicyIncludedGroupRefOperationOptions{}
}
...
// RemoveMobileDeviceManagementPolicyIncludedGroupRef - Delete includedGroup. Delete a group from the list of groups
