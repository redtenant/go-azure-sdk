...
func DefaultGetPermissionGrantPolicyOperationOptions() GetPermissionGrantPolicyOperationOptions {
	return GetPermissionGrantPolicyOperationOptions{}
}
...
func (c PermissionGrantPolicyClient) GetPermissionGrantPolicy(ctx context.Context, id beta.PolicyPermissionGrantPolicyId, options GetPermissionGrantPolicyOperationOptions) (result GetPermissionGrantPolicyOperationResponse, err error) {
