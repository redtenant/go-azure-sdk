...
func (c PermissionGrantPolicyClient) UpdatePermissionGrantPolicy(ctx context.Context, id beta.PolicyPermissionGrantPolicyId, input beta.PermissionGrantPolicy, options UpdatePermissionGrantPolicyOperationOptions) (result UpdatePermissionGrantPolicyOperationResponse, err error) {
