...
func (c PermissionGrantPolicyExcludeClient) CreatePermissionGrantPolicyExclude(ctx context.Context, id beta.PolicyPermissionGrantPolicyId, input beta.PermissionGrantConditionSet, options CreatePermissionGrantPolicyExcludeOperationOptions) (result CreatePermissionGrantPolicyExcludeOperationResponse, err error) {
