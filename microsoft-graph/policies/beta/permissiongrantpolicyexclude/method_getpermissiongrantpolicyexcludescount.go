...
type GetPermissionGrantPolicyExcludesCountOperationResponse struct {
	HttpResponse *http.Response
	OData        *odata.OData
	Model        *[]byte
}

type GetPermissionGrantPolicyExcludesCountOperationOptions struct {
	Filter    *string
...
func DefaultGetPermissionGrantPolicyExcludesCountOperationOptions() GetPermissionGrantPolicyExcludesCountOperationOptions {
	return GetPermissionGrantPolicyExcludesCountOperationOptions{}
}
...
func (c PermissionGrantPolicyExcludeClient) GetPermissionGrantPolicyExcludesCount(ctx context.Context, id beta.PolicyPermissionGrantPolicyId, options GetPermissionGrantPolicyExcludesCountOperationOptions) (result GetPermissionGrantPolicyExcludesCountOperationResponse, err error) {
