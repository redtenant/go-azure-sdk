...
// that are *included* in a permissionGrantPolicy.
func (c PermissionGrantPolicyIncludeClient) ListPermissionGrantPolicyIncludes(ctx context.Context, id beta.PolicyPermissionGrantPolicyId, options ListPermissionGrantPolicyIncludesOperationOptions) (result ListPermissionGrantPolicyIncludesOperationResponse, err error) {
...
func (c PermissionGrantPolicyIncludeClient) ListPermissionGrantPolicyIncludesComplete(ctx context.Context, id beta.PolicyPermissionGrantPolicyId, options ListPermissionGrantPolicyIncludesOperationOptions) (ListPermissionGrantPolicyIncludesCompleteResult, error) {
...
func (c PermissionGrantPolicyIncludeClient) ListPermissionGrantPolicyIncludesCompleteMatchingPredicate(ctx context.Context, id beta.PolicyPermissionGrantPolicyId, options ListPermissionGrantPolicyIncludesOperationOptions, predicate PermissionGrantConditionSetOperationPredicate) (result ListPermissionGrantPolicyIncludesCompleteResult, err error) {
