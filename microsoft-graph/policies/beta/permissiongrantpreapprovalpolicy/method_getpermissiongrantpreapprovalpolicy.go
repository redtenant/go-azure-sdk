...
// GetPermissionGrantPreApprovalPolicy - Get permissionGrantPreApprovalPolicy. Read the properties and relationships of
// a permissionGrantPreApprovalPolicy object.
func (c PermissionGrantPreApprovalPolicyClient) GetPermissionGrantPreApprovalPolicy(ctx context.Context, id beta.PolicyPermissionGrantPreApprovalPolicyId, options GetPermissionGrantPreApprovalPolicyOperationOptions) (result GetPermissionGrantPreApprovalPolicyOperationResponse, err error) {
