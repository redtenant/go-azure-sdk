...
func (c PolicyClient) UpdatePolicy(ctx context.Context, input beta.PolicyRoot, options UpdatePolicyOperationOptions) (result UpdatePolicyOperationResponse, err error) {
