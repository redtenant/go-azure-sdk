...
func (c RoleManagementPolicyAssignmentClient) CreateRoleManagementPolicyAssignment(ctx context.Context, input beta.UnifiedRoleManagementPolicyAssignment, options CreateRoleManagementPolicyAssignmentOperationOptions) (result CreateRoleManagementPolicyAssignmentOperationResponse, err error) {
