...
func (c RoleManagementPolicyAssignmentClient) DeleteRoleManagementPolicyAssignment(ctx context.Context, id beta.PolicyRoleManagementPolicyAssignmentId, options DeleteRoleManagementPolicyAssignmentOperationOptions) (result DeleteRoleManagementPolicyAssignmentOperationResponse, err error) {
