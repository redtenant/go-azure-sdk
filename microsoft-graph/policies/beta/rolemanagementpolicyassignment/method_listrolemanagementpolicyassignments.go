...
type ListRoleManagementPolicyAssignmentsOperationResponse struct {
	...
	OData        *odata.OData
	Model        *[]beta.UnifiedRoleManagementPolicyAssignment
}

type ListRoleManagementPolicyAssignmentsCompleteResult struct {
	LatestHttpResponse *http.Response
	Items              []beta.UnifiedRoleManagementPolicyAssignment
}

type ListRoleManagementPolicyAssignmentsOperationOptions struct {
	Count     *bool
	Expand    *odata.Expand
	Filter    *string
...
func DefaultListRoleManagementPolicyAssignmentsOperationOptions() ListRoleManagementPolicyAssignmentsOperationOptions {
	return ListRoleManagementPolicyAssignmentsOperationOptions{}
}
...
// ListRoleManagementPolicyAssignments - List roleManagementPolicyAssignments. Get the details of all role management
// policy assignments made in PIM for Microsoft Entra roles and PIM for groups.
func (c RoleManagementPolicyAssignmentClient) ListRoleManagementPolicyAssignments(ctx context.Context, options ListRoleManagementPolicyAssignmentsOperationOptions) (result ListRoleManagementPolicyAssignmentsOperationResponse, err error) {
	...
	var values struct {
		Values *[]beta.UnifiedRoleManagementPolicyAssignment `json:"value"`
	}
...
func (c RoleManagementPolicyAssignmentClient) ListRoleManagementPolicyAssignmentsComplete(ctx context.Context, options ListRoleManagementPolicyAssignmentsOperationOptions) (ListRoleManagementPolicyAssignmentsCompleteResult, error) {
	return c.ListRoleManagementPolicyAssignmentsCompleteMatchingPredicate(ctx, options, UnifiedRoleManagementPolicyAssignmentOperationPredicate{})
}
...
func (c RoleManagementPolicyAssignmentClient) ListRoleManagementPolicyAssignmentsCompleteMatchingPredicate(ctx context.Context, options ListRoleManagementPolicyAssignmentsOperationOptions, predicate UnifiedRoleManagementPolicyAssignmentOperationPredicate) (result ListRoleManagementPolicyAssignmentsCompleteResult, err error) {
	items := make([]beta.UnifiedRoleManagementPolicyAssignment, 0)

	resp, err := c.ListRoleManagementPolicyAssignments(ctx, options)
	if err != nil {
