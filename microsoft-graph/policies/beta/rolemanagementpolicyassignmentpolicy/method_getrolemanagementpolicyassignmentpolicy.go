...
func (c RoleManagementPolicyAssignmentPolicyClient) GetRoleManagementPolicyAssignmentPolicy(ctx context.Context, id beta.PolicyRoleManagementPolicyAssignmentId, options GetRoleManagementPolicyAssignmentPolicyOperationOptions) (result GetRoleManagementPolicyAssignmentPolicyOperationResponse, err error) {
