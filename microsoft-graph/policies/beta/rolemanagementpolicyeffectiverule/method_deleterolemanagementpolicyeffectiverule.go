...
func DefaultDeleteRoleManagementPolicyEffectiveRuleOperationOptions() DeleteRoleManagementPolicyEffectiveRuleOperationOptions {
	return DeleteRoleManagementPolicyEffectiveRuleOperationOptions{}
}
...
func (c RoleManagementPolicyEffectiveRuleClient) DeleteRoleManagementPolicyEffectiveRule(ctx context.Context, id beta.PolicyRoleManagementPolicyIdEffectiveRuleId, options DeleteRoleManagementPolicyEffectiveRuleOperationOptions) (result DeleteRoleManagementPolicyEffectiveRuleOperationResponse, err error) {
