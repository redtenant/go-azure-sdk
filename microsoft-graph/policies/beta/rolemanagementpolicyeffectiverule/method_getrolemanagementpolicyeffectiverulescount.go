...
func (c RoleManagementPolicyEffectiveRuleClient) GetRoleManagementPolicyEffectiveRulesCount(ctx context.Context, id beta.PolicyRoleManagementPolicyId, options GetRoleManagementPolicyEffectiveRulesCountOperationOptions) (result GetRoleManagementPolicyEffectiveRulesCountOperationResponse, err error) {
