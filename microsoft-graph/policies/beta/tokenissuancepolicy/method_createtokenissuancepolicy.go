...
func (c TokenIssuancePolicyClient) CreateTokenIssuancePolicy(ctx context.Context, input beta.TokenIssuancePolicy, options CreateTokenIssuancePolicyOperationOptions) (result CreateTokenIssuancePolicyOperationResponse, err error) {
