...
func (c TokenIssuancePolicyClient) UpdateTokenIssuancePolicy(ctx context.Context, id beta.PolicyTokenIssuancePolicyId, input beta.TokenIssuancePolicy, options UpdateTokenIssuancePolicyOperationOptions) (result UpdateTokenIssuancePolicyOperationResponse, err error) {
