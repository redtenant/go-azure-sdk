...
func (c TokenIssuancePolicyAppliesToClient) GetTokenIssuancePolicyAppliesToCount(ctx context.Context, id beta.PolicyTokenIssuancePolicyId, options GetTokenIssuancePolicyAppliesToCountOperationOptions) (result GetTokenIssuancePolicyAppliesToCountOperationResponse, err error) {
