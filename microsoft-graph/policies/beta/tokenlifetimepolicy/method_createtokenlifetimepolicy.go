...
func (c TokenLifetimePolicyClient) CreateTokenLifetimePolicy(ctx context.Context, input beta.TokenLifetimePolicy, options CreateTokenLifetimePolicyOperationOptions) (result CreateTokenLifetimePolicyOperationResponse, err error) {
