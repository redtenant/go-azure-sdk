...
func DefaultDeleteTokenLifetimePolicyOperationOptions() DeleteTokenLifetimePolicyOperationOptions {
	return DeleteTokenLifetimePolicyOperationOptions{}
}
...
func (c TokenLifetimePolicyClient) DeleteTokenLifetimePolicy(ctx context.Context, id beta.PolicyTokenLifetimePolicyId, options DeleteTokenLifetimePolicyOperationOptions) (result DeleteTokenLifetimePolicyOperationResponse, err error) {
