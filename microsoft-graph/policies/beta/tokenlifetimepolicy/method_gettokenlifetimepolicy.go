...
// GetTokenLifetimePolicy - Get tokenLifetimePolicy. Retrieve the properties and relationships of a tokenLifetimePolicy
// object.
func (c TokenLifetimePolicyClient) GetTokenLifetimePolicy(ctx context.Context, id beta.PolicyTokenLifetimePolicyId, options GetTokenLifetimePolicyOperationOptions) (result GetTokenLifetimePolicyOperationResponse, err error) {
