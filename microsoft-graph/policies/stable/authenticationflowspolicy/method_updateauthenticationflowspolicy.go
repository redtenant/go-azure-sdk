...
// UpdateAuthenticationFlowsPolicy - Update authenticationFlowsPolicy. Update the selfServiceSignUp property of an
// authenticationFlowsPolicy object. The properties id, type, and description cannot be modified.
func (c AuthenticationFlowsPolicyClient) UpdateAuthenticationFlowsPolicy(ctx context.Context, input stable.AuthenticationFlowsPolicy, options UpdateAuthenticationFlowsPolicyOperationOptions) (result UpdateAuthenticationFlowsPolicyOperationResponse, err error) {
