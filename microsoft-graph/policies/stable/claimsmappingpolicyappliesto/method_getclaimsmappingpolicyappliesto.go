...
func (c ClaimsMappingPolicyAppliesToClient) GetClaimsMappingPolicyAppliesTo(ctx context.Context, id stable.PolicyClaimsMappingPolicyIdAppliesToId, options GetClaimsMappingPolicyAppliesToOperationOptions) (result GetClaimsMappingPolicyAppliesToOperationResponse, err error) {
