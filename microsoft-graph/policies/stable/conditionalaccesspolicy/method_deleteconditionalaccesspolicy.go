...
func (c ConditionalAccessPolicyClient) DeleteConditionalAccessPolicy(ctx context.Context, id stable.PolicyConditionalAccessPolicyId, options DeleteConditionalAccessPolicyOperationOptions) (result DeleteConditionalAccessPolicyOperationResponse, err error) {
