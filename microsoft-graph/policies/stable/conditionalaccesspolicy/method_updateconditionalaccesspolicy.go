...
type UpdateConditionalAccessPolicyOperationResponse struct {
...
func (c ConditionalAccessPolicyClient) UpdateConditionalAccessPolicy(ctx context.Context, id stable.PolicyConditionalAccessPolicyId, input stable.ConditionalAccessPolicy, options UpdateConditionalAccessPolicyOperationOptions) (result UpdateConditionalAccessPolicyOperationResponse, err error) {
