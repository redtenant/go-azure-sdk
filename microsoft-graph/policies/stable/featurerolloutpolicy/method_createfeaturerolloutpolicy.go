...
func (c FeatureRolloutPolicyClient) CreateFeatureRolloutPolicy(ctx context.Context, input stable.FeatureRolloutPolicy, options CreateFeatureRolloutPolicyOperationOptions) (result CreateFeatureRolloutPolicyOperationResponse, err error) {
