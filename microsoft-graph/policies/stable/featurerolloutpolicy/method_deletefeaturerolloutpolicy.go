...
func (c FeatureRolloutPolicyClient) DeleteFeatureRolloutPolicy(ctx context.Context, id stable.PolicyFeatureRolloutPolicyId, options DeleteFeatureRolloutPolicyOperationOptions) (result DeleteFeatureRolloutPolicyOperationResponse, err error) {
