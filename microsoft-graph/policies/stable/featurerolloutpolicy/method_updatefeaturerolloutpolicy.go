...
func (c FeatureRolloutPolicyClient) UpdateFeatureRolloutPolicy(ctx context.Context, id stable.PolicyFeatureRolloutPolicyId, input stable.FeatureRolloutPolicy, options UpdateFeatureRolloutPolicyOperationOptions) (result UpdateFeatureRolloutPolicyOperationResponse, err error) {
