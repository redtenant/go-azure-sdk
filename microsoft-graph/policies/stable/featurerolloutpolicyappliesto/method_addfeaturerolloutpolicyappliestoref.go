...
// AddFeatureRolloutPolicyAppliesToRef - Assign appliesTo on a featureRolloutPolicy. Add an appliesTo on a
// featureRolloutPolicy object to specify the directoryObject to which the featureRolloutPolicy should be applied.
func (c FeatureRolloutPolicyAppliesToClient) AddFeatureRolloutPolicyAppliesToRef(ctx context.Context, id stable.PolicyFeatureRolloutPolicyId, input stable.ReferenceCreate, options AddFeatureRolloutPolicyAppliesToRefOperationOptions) (result AddFeatureRolloutPolicyAppliesToRefOperationResponse, err error) {
