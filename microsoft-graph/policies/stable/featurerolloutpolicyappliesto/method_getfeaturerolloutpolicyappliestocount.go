...
func (c FeatureRolloutPolicyAppliesToClient) GetFeatureRolloutPolicyAppliesToCount(ctx context.Context, id stable.PolicyFeatureRolloutPolicyId, options GetFeatureRolloutPolicyAppliesToCountOperationOptions) (result GetFeatureRolloutPolicyAppliesToCountOperationResponse, err error) {
