...
// ListFeatureRolloutPolicyAppliesTos - Get appliesTo from policies. Nullable. Specifies a list of directoryObject
// resources that feature is enabled for.
func (c FeatureRolloutPolicyAppliesToClient) ListFeatureRolloutPolicyAppliesTos(ctx context.Context, id stable.PolicyFeatureRolloutPolicyId, options ListFeatureRolloutPolicyAppliesTosOperationOptions) (result ListFeatureRolloutPolicyAppliesTosOperationResponse, err error) {
...
func (c FeatureRolloutPolicyAppliesToClient) ListFeatureRolloutPolicyAppliesTosComplete(ctx context.Context, id stable.PolicyFeatureRolloutPolicyId, options ListFeatureRolloutPolicyAppliesTosOperationOptions) (ListFeatureRolloutPolicyAppliesTosCompleteResult, error) {
...
func (c FeatureRolloutPolicyAppliesToClient) ListFeatureRolloutPolicyAppliesTosCompleteMatchingPredicate(ctx context.Context, id stable.PolicyFeatureRolloutPolicyId, options ListFeatureRolloutPolicyAppliesTosOperationOptions, predicate DirectoryObjectOperationPredicate) (result ListFeatureRolloutPolicyAppliesTosCompleteResult, err error) {
