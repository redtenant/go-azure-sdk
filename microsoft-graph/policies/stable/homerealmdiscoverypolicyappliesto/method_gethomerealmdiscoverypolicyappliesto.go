...
func (c HomeRealmDiscoveryPolicyAppliesToClient) GetHomeRealmDiscoveryPolicyAppliesTo(ctx context.Context, id stable.PolicyHomeRealmDiscoveryPolicyIdAppliesToId, options GetHomeRealmDiscoveryPolicyAppliesToOperationOptions) (result GetHomeRealmDiscoveryPolicyAppliesToOperationResponse, err error) {
