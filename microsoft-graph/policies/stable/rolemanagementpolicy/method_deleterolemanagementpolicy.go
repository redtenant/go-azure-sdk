...
func DefaultDeleteRoleManagementPolicyOperationOptions() DeleteRoleManagementPolicyOperationOptions {
	return DeleteRoleManagementPolicyOperationOptions{}
}
...
func (c RoleManagementPolicyClient) DeleteRoleManagementPolicy(ctx context.Context, id stable.PolicyRoleManagementPolicyId, options DeleteRoleManagementPolicyOperationOptions) (result DeleteRoleManagementPolicyOperationResponse, err error) {
