...
func DefaultGetRoleManagementPolicyOperationOptions() GetRoleManagementPolicyOperationOptions {
	return GetRoleManagementPolicyOperationOptions{}
}
...
// GetRoleManagementPolicy - Get unifiedRoleManagementPolicy. Retrieve the details of a role management policy.
func (c RoleManagementPolicyClient) GetRoleManagementPolicy(ctx context.Context, id stable.PolicyRoleManagementPolicyId, options GetRoleManagementPolicyOperationOptions) (result GetRoleManagementPolicyOperationResponse, err error) {
