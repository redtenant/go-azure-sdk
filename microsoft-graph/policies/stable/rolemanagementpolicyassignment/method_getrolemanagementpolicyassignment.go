...
// GetRoleManagementPolicyAssignment - Get unifiedRoleManagementPolicyAssignment. Get the details of a policy assignment
// in PIM that's assigned to Microsoft Entra roles or group membership or ownership.
