...
func DefaultDeleteRoleManagementPolicyRuleOperationOptions() DeleteRoleManagementPolicyRuleOperationOptions {
	return DeleteRoleManagementPolicyRuleOperationOptions{}
}
...
func (c RoleManagementPolicyRuleClient) DeleteRoleManagementPolicyRule(ctx context.Context, id stable.PolicyRoleManagementPolicyIdRuleId, options DeleteRoleManagementPolicyRuleOperationOptions) (result DeleteRoleManagementPolicyRuleOperationResponse, err error) {
