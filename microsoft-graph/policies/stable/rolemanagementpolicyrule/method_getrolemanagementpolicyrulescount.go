...
func (c RoleManagementPolicyRuleClient) GetRoleManagementPolicyRulesCount(ctx context.Context, id stable.PolicyRoleManagementPolicyId, options GetRoleManagementPolicyRulesCountOperationOptions) (result GetRoleManagementPolicyRulesCountOperationResponse, err error) {
