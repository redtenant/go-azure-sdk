...
func (c RoleManagementPolicyRuleClient) ListRoleManagementPolicyRulesComplete(ctx context.Context, id stable.PolicyRoleManagementPolicyId, options ListRoleManagementPolicyRulesOperationOptions) (ListRoleManagementPolicyRulesCompleteResult, error) {
...
func (c RoleManagementPolicyRuleClient) ListRoleManagementPolicyRulesCompleteMatchingPredicate(ctx context.Context, id stable.PolicyRoleManagementPolicyId, options ListRoleManagementPolicyRulesOperationOptions, predicate UnifiedRoleManagementPolicyRuleOperationPredicate) (result ListRoleManagementPolicyRulesCompleteResult, err error) {
