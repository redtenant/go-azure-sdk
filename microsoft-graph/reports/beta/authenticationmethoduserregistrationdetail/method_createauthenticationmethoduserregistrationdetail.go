...
// reports
func (c AuthenticationMethodUserRegistrationDetailClient) CreateAuthenticationMethodUserRegistrationDetail(ctx context.Context, input beta.UserRegistrationDetails, options CreateAuthenticationMethodUserRegistrationDetailOperationOptions) (result CreateAuthenticationMethodUserRegistrationDetailOperationResponse, err error) {
