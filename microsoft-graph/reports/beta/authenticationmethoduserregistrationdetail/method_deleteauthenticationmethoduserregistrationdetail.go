...
func (c AuthenticationMethodUserRegistrationDetailClient) DeleteAuthenticationMethodUserRegistrationDetail(ctx context.Context, id beta.ReportAuthenticationMethodUserRegistrationDetailId, options DeleteAuthenticationMethodUserRegistrationDetailOperationOptions) (result DeleteAuthenticationMethodUserRegistrationDetailOperationResponse, err error) {
