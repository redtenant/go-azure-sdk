...
func (c DailyPrintUsageByPrinterClient) DeleteDailyPrintUsageByPrinter(ctx context.Context, id beta.ReportDailyPrintUsageByPrinterId, options DeleteDailyPrintUsageByPrinterOperationOptions) (result DeleteDailyPrintUsageByPrinterOperationResponse, err error) {
