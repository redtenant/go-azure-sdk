...
func (c MonthlyPrintUsageByPrinterClient) UpdateMonthlyPrintUsageByPrinter(ctx context.Context, id beta.ReportMonthlyPrintUsageByPrinterId, input beta.PrintUsageByPrinter, options UpdateMonthlyPrintUsageByPrinterOperationOptions) (result UpdateMonthlyPrintUsageByPrinterOperationResponse, err error) {
