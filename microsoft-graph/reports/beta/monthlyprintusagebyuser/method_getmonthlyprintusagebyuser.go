...
func (c MonthlyPrintUsageByUserClient) GetMonthlyPrintUsageByUser(ctx context.Context, id beta.ReportMonthlyPrintUsageByUserId, options GetMonthlyPrintUsageByUserOperationOptions) (result GetMonthlyPrintUsageByUserOperationResponse, err error) {
