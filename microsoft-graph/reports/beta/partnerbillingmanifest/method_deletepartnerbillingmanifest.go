...
func DefaultDeletePartnerBillingManifestOperationOptions() DeletePartnerBillingManifestOperationOptions {
	return DeletePartnerBillingManifestOperationOptions{}
}
...
func (c PartnerBillingManifestClient) DeletePartnerBillingManifest(ctx context.Context, id beta.ReportPartnerBillingManifestId, options DeletePartnerBillingManifestOperationOptions) (result DeletePartnerBillingManifestOperationResponse, err error) {
