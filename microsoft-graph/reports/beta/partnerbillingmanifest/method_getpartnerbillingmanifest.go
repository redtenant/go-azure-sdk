...
func DefaultGetPartnerBillingManifestOperationOptions() GetPartnerBillingManifestOperationOptions {
	return GetPartnerBillingManifestOperationOptions{}
}
...
func (c PartnerBillingManifestClient) GetPartnerBillingManifest(ctx context.Context, id beta.ReportPartnerBillingManifestId, options GetPartnerBillingManifestOperationOptions) (result GetPartnerBillingManifestOperationResponse, err error) {
