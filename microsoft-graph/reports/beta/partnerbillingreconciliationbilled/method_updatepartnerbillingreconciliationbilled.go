...
func (c PartnerBillingReconciliationBilledClient) UpdatePartnerBillingReconciliationBilled(ctx context.Context, input beta.PartnersBillingBilledReconciliation, options UpdatePartnerBillingReconciliationBilledOperationOptions) (result UpdatePartnerBillingReconciliationBilledOperationResponse, err error) {
