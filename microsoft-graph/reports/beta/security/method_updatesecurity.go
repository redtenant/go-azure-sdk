...
func (c SecurityClient) UpdateSecurity(ctx context.Context, input beta.SecurityReportsRoot, options UpdateSecurityOperationOptions) (result UpdateSecurityOperationResponse, err error) {
