...
type GetUserInsightDailyMfaCompletionOperationResponse struct {
	HttpResponse *http.Response
	OData        *odata.OData
	Model        *beta.MfaCompletionMetric
}

type GetUserInsightDailyMfaCompletionOperationOptions struct {
	Expand    *odata.Expand
...
func DefaultGetUserInsightDailyMfaCompletionOperationOptions() GetUserInsightDailyMfaCompletionOperationOptions {
	return GetUserInsightDailyMfaCompletionOperationOptions{}
}
...
// GetUserInsightDailyMfaCompletion - Get mfaCompletions from reports. Insights for MFA usage on apps registered in the
