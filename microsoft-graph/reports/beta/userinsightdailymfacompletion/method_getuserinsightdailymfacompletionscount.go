...
type GetUserInsightDailyMfaCompletionsCountOperationResponse struct {
	HttpResponse *http.Response
	OData        *odata.OData
	Model        *[]byte
}

type GetUserInsightDailyMfaCompletionsCountOperationOptions struct {
	Filter    *string
...
func DefaultGetUserInsightDailyMfaCompletionsCountOperationOptions() GetUserInsightDailyMfaCompletionsCountOperationOptions {
	return GetUserInsightDailyMfaCompletionsCountOperationOptions{}
}
