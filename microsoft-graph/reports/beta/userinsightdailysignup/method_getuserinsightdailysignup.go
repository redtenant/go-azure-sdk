...
type GetUserInsightDailySignUpOperationResponse struct {
	HttpResponse *http.Response
	OData        *odata.OData
	Model        *beta.UserSignUpMetric
}

type GetUserInsightDailySignUpOperationOptions struct {
	Expand    *odata.Expand
...
func DefaultGetUserInsightDailySignUpOperationOptions() GetUserInsightDailySignUpOperationOptions {
	return GetUserInsightDailySignUpOperationOptions{}
}
...
// GetUserInsightDailySignUp - Get signUps from reports. Total sign-ups on apps registered in the tenant for a specified
// period.
