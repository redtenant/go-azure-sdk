...
type GetUserInsightMonthlyActiveUserOperationOptions struct {
	Expand    *odata.Expand
...
func DefaultGetUserInsightMonthlyActiveUserOperationOptions() GetUserInsightMonthlyActiveUserOperationOptions {
	return GetUserInsightMonthlyActiveUserOperationOptions{}
}
...
// GetUserInsightMonthlyActiveUser - Get activeUsers from reports. Insights for active users on apps registered in the
