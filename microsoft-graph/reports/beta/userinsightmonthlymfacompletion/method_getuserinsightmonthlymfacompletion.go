...
type GetUserInsightMonthlyMfaCompletionOperationResponse struct {
	HttpResponse *http.Response
	OData        *odata.OData
	Model        *beta.MfaCompletionMetric
}

type GetUserInsightMonthlyMfaCompletionOperationOptions struct {
	Expand    *odata.Expand
...
func DefaultGetUserInsightMonthlyMfaCompletionOperationOptions() GetUserInsightMonthlyMfaCompletionOperationOptions {
	return GetUserInsightMonthlyMfaCompletionOperationOptions{}
}
...
// GetUserInsightMonthlyMfaCompletion - Get mfaCompletions from reports. Insights for MFA usage on apps registered in
// the tenant for a specified period.
func (c UserInsightMonthlyMfaCompletionClient) GetUserInsightMonthlyMfaCompletion(ctx context.Context, id beta.ReportUserInsightMonthlyMfaCompletionId, options GetUserInsightMonthlyMfaCompletionOperationOptions) (result GetUserInsightMonthlyMfaCompletionOperationResponse, err error) {
	...
	var model beta.MfaCompletionMetric
	result.Model = &model
