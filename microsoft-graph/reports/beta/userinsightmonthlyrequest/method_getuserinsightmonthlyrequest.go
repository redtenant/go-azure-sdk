...
func DefaultGetUserInsightMonthlyRequestOperationOptions() GetUserInsightMonthlyRequestOperationOptions {
	return GetUserInsightMonthlyRequestOperationOptions{}
}
...
// GetUserInsightMonthlyRequest - Get requests from reports. Insights for all user requests on apps registered in the
