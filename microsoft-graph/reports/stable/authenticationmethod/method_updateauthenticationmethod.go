...
func (c AuthenticationMethodClient) UpdateAuthenticationMethod(ctx context.Context, input stable.AuthenticationMethodsRoot, options UpdateAuthenticationMethodOperationOptions) (result UpdateAuthenticationMethodOperationResponse, err error) {
