...
func (c DailyPrintUsageByUserClient) DeleteDailyPrintUsageByUser(ctx context.Context, id stable.ReportDailyPrintUsageByUserId, options DeleteDailyPrintUsageByUserOperationOptions) (result DeleteDailyPrintUsageByUserOperationResponse, err error) {
