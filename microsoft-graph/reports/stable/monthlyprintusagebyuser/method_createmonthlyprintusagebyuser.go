...
func (c MonthlyPrintUsageByUserClient) CreateMonthlyPrintUsageByUser(ctx context.Context, input stable.PrintUsageByUser, options CreateMonthlyPrintUsageByUserOperationOptions) (result CreateMonthlyPrintUsageByUserOperationResponse, err error) {
