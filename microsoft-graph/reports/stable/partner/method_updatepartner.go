...
func (c PartnerClient) UpdatePartner(ctx context.Context, input stable.Partners, options UpdatePartnerOperationOptions) (result UpdatePartnerOperationResponse, err error) {
