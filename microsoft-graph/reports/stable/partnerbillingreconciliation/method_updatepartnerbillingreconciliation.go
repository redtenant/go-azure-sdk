...
func (c PartnerBillingReconciliationClient) UpdatePartnerBillingReconciliation(ctx context.Context, input stable.PartnersBillingBillingReconciliation, options UpdatePartnerBillingReconciliationOperationOptions) (result UpdatePartnerBillingReconciliationOperationResponse, err error) {
