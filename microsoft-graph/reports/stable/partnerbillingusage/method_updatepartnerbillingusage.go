...
func (c PartnerBillingUsageClient) UpdatePartnerBillingUsage(ctx context.Context, input stable.PartnersBillingAzureUsage, options UpdatePartnerBillingUsageOperationOptions) (result UpdatePartnerBillingUsageOperationResponse, err error) {
