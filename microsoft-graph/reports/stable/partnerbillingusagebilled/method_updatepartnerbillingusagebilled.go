...
func (c PartnerBillingUsageBilledClient) UpdatePartnerBillingUsageBilled(ctx context.Context, input stable.PartnersBillingBilledUsage, options UpdatePartnerBillingUsageBilledOperationOptions) (result UpdatePartnerBillingUsageBilledOperationResponse, err error) {
