...
type GetSecurityOperationResponse struct {
	...
	OData        *odata.OData
	Model        *stable.SecurityReportsRoot
}
...
// GetSecurity - Get security from reports. Represents an abstract type that contains resources for attack simulation
...
func (c SecurityClient) GetSecurity(ctx context.Context, options GetSecurityOperationOptions) (result GetSecurityOperationResponse, err error) {
	...
	var model stable.SecurityReportsRoot
	result.Model = &model
