...
// DeleteCloudPC - Delete navigation property cloudPC for roleManagement
func (c CloudPCClient) DeleteCloudPC(ctx context.Context, options DeleteCloudPCOperationOptions) (result DeleteCloudPCOperationResponse, err error) {
