...
// GetCloudPC - Get cloudPC from roleManagement
func (c CloudPCClient) GetCloudPC(ctx context.Context, options GetCloudPCOperationOptions) (result GetCloudPCOperationResponse, err error) {
