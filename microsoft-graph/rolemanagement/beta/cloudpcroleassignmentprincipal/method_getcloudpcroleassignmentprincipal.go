...
type GetCloudPCRoleAssignmentPrincipalOperationResponse struct {
	HttpResponse *http.Response
	OData        *odata.OData
	Model        beta.DirectoryObject
}

type GetCloudPCRoleAssignmentPrincipalOperationOptions struct {
	Expand    *odata.Expand
...
func DefaultGetCloudPCRoleAssignmentPrincipalOperationOptions() GetCloudPCRoleAssignmentPrincipalOperationOptions {
	return GetCloudPCRoleAssignmentPrincipalOperationOptions{}
}
...
// GetCloudPCRoleAssignmentPrincipal - Get principals from roleManagement. Read-only collection that references the
