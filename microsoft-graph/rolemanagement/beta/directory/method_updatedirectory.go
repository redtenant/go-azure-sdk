...
type UpdateDirectoryOperationResponse struct {
...
func (c DirectoryClient) UpdateDirectory(ctx context.Context, input beta.RbacApplication, options UpdateDirectoryOperationOptions) (result UpdateDirectoryOperationResponse, err error) {
