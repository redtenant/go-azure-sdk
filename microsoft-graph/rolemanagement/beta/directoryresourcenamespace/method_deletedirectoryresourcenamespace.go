...
func (c DirectoryResourceNamespaceClient) DeleteDirectoryResourceNamespace(ctx context.Context, id beta.RoleManagementDirectoryResourceNamespaceId, options DeleteDirectoryResourceNamespaceOperationOptions) (result DeleteDirectoryResourceNamespaceOperationResponse, err error) {
