...
type DeleteDirectoryRoleAssignmentAppScopeOperationResponse struct {
	HttpResponse *http.Response
	OData        *odata.OData
}

type DeleteDirectoryRoleAssignmentAppScopeOperationOptions struct {
	IfMatch   *string
...
func DefaultDeleteDirectoryRoleAssignmentAppScopeOperationOptions() DeleteDirectoryRoleAssignmentAppScopeOperationOptions {
	return DeleteDirectoryRoleAssignmentAppScopeOperationOptions{}
}
...
func (c DirectoryRoleAssignmentAppScopeClient) DeleteDirectoryRoleAssignmentAppScope(ctx context.Context, id beta.RoleManagementDirectoryRoleAssignmentId, options DeleteDirectoryRoleAssignmentAppScopeOperationOptions) (result DeleteDirectoryRoleAssignmentAppScopeOperationResponse, err error) {
