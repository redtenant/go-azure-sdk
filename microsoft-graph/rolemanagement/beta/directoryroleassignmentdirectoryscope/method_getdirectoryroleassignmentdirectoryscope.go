...
func (c DirectoryRoleAssignmentDirectoryScopeClient) GetDirectoryRoleAssignmentDirectoryScope(ctx context.Context, id beta.RoleManagementDirectoryRoleAssignmentId, options GetDirectoryRoleAssignmentDirectoryScopeOperationOptions) (result GetDirectoryRoleAssignmentDirectoryScopeOperationResponse, err error) {
