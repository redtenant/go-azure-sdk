...
func (c DirectoryRoleAssignmentPrincipalClient) GetDirectoryRoleAssignmentPrincipal(ctx context.Context, id beta.RoleManagementDirectoryRoleAssignmentId, options GetDirectoryRoleAssignmentPrincipalOperationOptions) (result GetDirectoryRoleAssignmentPrincipalOperationResponse, err error) {
