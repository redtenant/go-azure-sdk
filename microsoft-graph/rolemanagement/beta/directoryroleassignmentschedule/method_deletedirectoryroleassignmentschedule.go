...
func (c DirectoryRoleAssignmentScheduleClient) DeleteDirectoryRoleAssignmentSchedule(ctx context.Context, id beta.RoleManagementDirectoryRoleAssignmentScheduleId, options DeleteDirectoryRoleAssignmentScheduleOperationOptions) (result DeleteDirectoryRoleAssignmentScheduleOperationResponse, err error) {
