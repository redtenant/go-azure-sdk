...
func (c DirectoryRoleAssignmentScheduleClient) GetDirectoryRoleAssignmentSchedule(ctx context.Context, id beta.RoleManagementDirectoryRoleAssignmentScheduleId, options GetDirectoryRoleAssignmentScheduleOperationOptions) (result GetDirectoryRoleAssignmentScheduleOperationResponse, err error) {
