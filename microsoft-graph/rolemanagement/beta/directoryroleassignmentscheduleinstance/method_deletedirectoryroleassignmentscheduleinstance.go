...
// roleManagement
func (c DirectoryRoleAssignmentScheduleInstanceClient) DeleteDirectoryRoleAssignmentScheduleInstance(ctx context.Context, id beta.RoleManagementDirectoryRoleAssignmentScheduleInstanceId, options DeleteDirectoryRoleAssignmentScheduleInstanceOperationOptions) (result DeleteDirectoryRoleAssignmentScheduleInstanceOperationResponse, err error) {
