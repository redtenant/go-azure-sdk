...
// role assignment.
func (c DirectoryRoleAssignmentScheduleInstanceClient) GetDirectoryRoleAssignmentScheduleInstance(ctx context.Context, id beta.RoleManagementDirectoryRoleAssignmentScheduleInstanceId, options GetDirectoryRoleAssignmentScheduleInstanceOperationOptions) (result GetDirectoryRoleAssignmentScheduleInstanceOperationResponse, err error) {
