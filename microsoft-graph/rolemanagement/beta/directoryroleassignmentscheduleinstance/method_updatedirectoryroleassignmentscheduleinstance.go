...
// roleManagement
func (c DirectoryRoleAssignmentScheduleInstanceClient) UpdateDirectoryRoleAssignmentScheduleInstance(ctx context.Context, id beta.RoleManagementDirectoryRoleAssignmentScheduleInstanceId, input beta.UnifiedRoleAssignmentScheduleInstance, options UpdateDirectoryRoleAssignmentScheduleInstanceOperationOptions) (result UpdateDirectoryRoleAssignmentScheduleInstanceOperationResponse, err error) {
