...
type GetDirectoryRoleAssignmentScheduleInstancePrincipalOperationResponse struct {
	HttpResponse *http.Response
	OData        *odata.OData
	Model        beta.DirectoryObject
}

type GetDirectoryRoleAssignmentScheduleInstancePrincipalOperationOptions struct {
	Expand    *odata.Expand
...
func DefaultGetDirectoryRoleAssignmentScheduleInstancePrincipalOperationOptions() GetDirectoryRoleAssignmentScheduleInstancePrincipalOperationOptions {
	return GetDirectoryRoleAssignmentScheduleInstancePrincipalOperationOptions{}
}
...
// GetDirectoryRoleAssignmentScheduleInstancePrincipal - Get principal from roleManagement. The principal that's getting
// a role assignment or role eligibility through the request.
func (c DirectoryRoleAssignmentScheduleInstancePrincipalClient) GetDirectoryRoleAssignmentScheduleInstancePrincipal(ctx context.Context, id beta.RoleManagementDirectoryRoleAssignmentScheduleInstanceId, options GetDirectoryRoleAssignmentScheduleInstancePrincipalOperationOptions) (result GetDirectoryRoleAssignmentScheduleInstancePrincipalOperationResponse, err error) {
