...
func (c DirectoryRoleAssignmentScheduleRequestActivatedUsingClient) GetDirectoryRoleAssignmentScheduleRequestActivatedUsing(ctx context.Context, id beta.RoleManagementDirectoryRoleAssignmentScheduleRequestId, options GetDirectoryRoleAssignmentScheduleRequestActivatedUsingOperationOptions) (result GetDirectoryRoleAssignmentScheduleRequestActivatedUsingOperationResponse, err error) {
