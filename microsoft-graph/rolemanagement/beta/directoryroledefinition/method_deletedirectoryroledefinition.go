...
// DeleteDirectoryRoleDefinition - Delete unifiedRoleDefinition. Delete a unifiedRoleDefinition object for an RBAC
...
// Entra ID)
func (c DirectoryRoleDefinitionClient) DeleteDirectoryRoleDefinition(ctx context.Context, id beta.RoleManagementDirectoryRoleDefinitionId, options DeleteDirectoryRoleDefinitionOperationOptions) (result DeleteDirectoryRoleDefinitionOperationResponse, err error) {
