...
// roleManagement
func (c DirectoryRoleDefinitionInheritsPermissionsFromClient) CreateDirectoryRoleDefinitionInheritsPermissionsFrom(ctx context.Context, id beta.RoleManagementDirectoryRoleDefinitionId, input beta.UnifiedRoleDefinition, options CreateDirectoryRoleDefinitionInheritsPermissionsFromOperationOptions) (result CreateDirectoryRoleDefinitionInheritsPermissionsFromOperationResponse, err error) {
