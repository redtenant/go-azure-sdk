...
func (c DirectoryRoleDefinitionInheritsPermissionsFromClient) GetDirectoryRoleDefinitionInheritsPermissionsFrom(ctx context.Context, id beta.RoleManagementDirectoryRoleDefinitionIdInheritsPermissionsFromId, options GetDirectoryRoleDefinitionInheritsPermissionsFromOperationOptions) (result GetDirectoryRoleDefinitionInheritsPermissionsFromOperationResponse, err error) {
