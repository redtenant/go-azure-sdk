...
func (c DirectoryRoleDefinitionInheritsPermissionsFromClient) ListDirectoryRoleDefinitionInheritsPermissionsFroms(ctx context.Context, id beta.RoleManagementDirectoryRoleDefinitionId, options ListDirectoryRoleDefinitionInheritsPermissionsFromsOperationOptions) (result ListDirectoryRoleDefinitionInheritsPermissionsFromsOperationResponse, err error) {
...
func (c DirectoryRoleDefinitionInheritsPermissionsFromClient) ListDirectoryRoleDefinitionInheritsPermissionsFromsComplete(ctx context.Context, id beta.RoleManagementDirectoryRoleDefinitionId, options ListDirectoryRoleDefinitionInheritsPermissionsFromsOperationOptions) (ListDirectoryRoleDefinitionInheritsPermissionsFromsCompleteResult, error) {
...
func (c DirectoryRoleDefinitionInheritsPermissionsFromClient) ListDirectoryRoleDefinitionInheritsPermissionsFromsCompleteMatchingPredicate(ctx context.Context, id beta.RoleManagementDirectoryRoleDefinitionId, options ListDirectoryRoleDefinitionInheritsPermissionsFromsOperationOptions, predicate UnifiedRoleDefinitionOperationPredicate) (result ListDirectoryRoleDefinitionInheritsPermissionsFromsCompleteResult, err error) {
