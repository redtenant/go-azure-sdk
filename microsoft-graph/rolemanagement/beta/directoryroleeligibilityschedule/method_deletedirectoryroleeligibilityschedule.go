...
func (c DirectoryRoleEligibilityScheduleClient) DeleteDirectoryRoleEligibilitySchedule(ctx context.Context, id beta.RoleManagementDirectoryRoleEligibilityScheduleId, options DeleteDirectoryRoleEligibilityScheduleOperationOptions) (result DeleteDirectoryRoleEligibilityScheduleOperationResponse, err error) {
