...
func (c DirectoryRoleEligibilityScheduleClient) UpdateDirectoryRoleEligibilitySchedule(ctx context.Context, id beta.RoleManagementDirectoryRoleEligibilityScheduleId, input beta.UnifiedRoleEligibilitySchedule, options UpdateDirectoryRoleEligibilityScheduleOperationOptions) (result UpdateDirectoryRoleEligibilityScheduleOperationResponse, err error) {
