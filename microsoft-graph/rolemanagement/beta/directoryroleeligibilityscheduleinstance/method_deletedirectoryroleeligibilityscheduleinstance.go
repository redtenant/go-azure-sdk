...
// roleManagement
func (c DirectoryRoleEligibilityScheduleInstanceClient) DeleteDirectoryRoleEligibilityScheduleInstance(ctx context.Context, id beta.RoleManagementDirectoryRoleEligibilityScheduleInstanceId, options DeleteDirectoryRoleEligibilityScheduleInstanceOperationOptions) (result DeleteDirectoryRoleEligibilityScheduleInstanceOperationResponse, err error) {
