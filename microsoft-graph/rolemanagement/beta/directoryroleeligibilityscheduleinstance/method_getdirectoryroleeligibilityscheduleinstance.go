...
// GetDirectoryRoleEligibilityScheduleInstance - Get unifiedRoleEligibilityScheduleInstance. Read the properties and
// relationships of an unifiedRoleEligibilityScheduleInstance object.
func (c DirectoryRoleEligibilityScheduleInstanceClient) GetDirectoryRoleEligibilityScheduleInstance(ctx context.Context, id beta.RoleManagementDirectoryRoleEligibilityScheduleInstanceId, options GetDirectoryRoleEligibilityScheduleInstanceOperationOptions) (result GetDirectoryRoleEligibilityScheduleInstanceOperationResponse, err error) {
