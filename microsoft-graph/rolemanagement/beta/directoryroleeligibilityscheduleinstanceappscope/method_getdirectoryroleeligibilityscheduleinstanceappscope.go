...
func (c DirectoryRoleEligibilityScheduleInstanceAppScopeClient) GetDirectoryRoleEligibilityScheduleInstanceAppScope(ctx context.Context, id beta.RoleManagementDirectoryRoleEligibilityScheduleInstanceId, options GetDirectoryRoleEligibilityScheduleInstanceAppScopeOperationOptions) (result GetDirectoryRoleEligibilityScheduleInstanceAppScopeOperationResponse, err error) {
