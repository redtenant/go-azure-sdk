...
func (c DirectoryRoleEligibilityScheduleRequestClient) CancelDirectoryRoleEligibilityScheduleRequest(ctx context.Context, id beta.RoleManagementDirectoryRoleEligibilityScheduleRequestId, options CancelDirectoryRoleEligibilityScheduleRequestOperationOptions) (result CancelDirectoryRoleEligibilityScheduleRequestOperationResponse, err error) {
