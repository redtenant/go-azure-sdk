...
func (c DirectoryRoleEligibilityScheduleRequestDirectoryScopeClient) GetDirectoryRoleEligibilityScheduleRequestDirectoryScope(ctx context.Context, id beta.RoleManagementDirectoryRoleEligibilityScheduleRequestId, options GetDirectoryRoleEligibilityScheduleRequestDirectoryScopeOperationOptions) (result GetDirectoryRoleEligibilityScheduleRequestDirectoryScopeOperationResponse, err error) {
