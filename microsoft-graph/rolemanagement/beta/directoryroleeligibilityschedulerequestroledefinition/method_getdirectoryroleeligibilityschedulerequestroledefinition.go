...
// $expand.
func (c DirectoryRoleEligibilityScheduleRequestRoleDefinitionClient) GetDirectoryRoleEligibilityScheduleRequestRoleDefinition(ctx context.Context, id beta.RoleManagementDirectoryRoleEligibilityScheduleRequestId, options GetDirectoryRoleEligibilityScheduleRequestRoleDefinitionOperationOptions) (result GetDirectoryRoleEligibilityScheduleRequestRoleDefinitionOperationResponse, err error) {
