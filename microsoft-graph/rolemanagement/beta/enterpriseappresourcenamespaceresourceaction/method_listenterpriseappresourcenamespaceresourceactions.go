...
type ListEnterpriseAppResourceNamespaceResourceActionsOperationOptions struct {
	Count     *bool
	Expand    *odata.Expand
	Filter    *string
...
func DefaultListEnterpriseAppResourceNamespaceResourceActionsOperationOptions() ListEnterpriseAppResourceNamespaceResourceActionsOperationOptions {
	return ListEnterpriseAppResourceNamespaceResourceActionsOperationOptions{}
}

func (o ListEnterpriseAppResourceNamespaceResourceActionsOperationOptions) ToHeaders() *client.Headers {
	out := client.Headers{}

	return &out
}

func (o ListEnterpriseAppResourceNamespaceResourceActionsOperationOptions) ToOData() *odata.Query {
	out := odata.Query{}
	if o.Count != nil {
		out.Count = *o.Count
	}
...
func (o ListEnterpriseAppResourceNamespaceResourceActionsOperationOptions) ToQuery() *client.QueryParams {
...
// ListEnterpriseAppResourceNamespaceResourceActions - Get resourceActions from roleManagement. Operations that an
// authorized principal is allowed to perform.
func (c EnterpriseAppResourceNamespaceResourceActionClient) ListEnterpriseAppResourceNamespaceResourceActions(ctx context.Context, id beta.RoleManagementEnterpriseAppIdResourceNamespaceId, options ListEnterpriseAppResourceNamespaceResourceActionsOperationOptions) (result ListEnterpriseAppResourceNamespaceResourceActionsOperationResponse, err error) {
...
func (c EnterpriseAppResourceNamespaceResourceActionClient) ListEnterpriseAppResourceNamespaceResourceActionsComplete(ctx context.Context, id beta.RoleManagementEnterpriseAppIdResourceNamespaceId, options ListEnterpriseAppResourceNamespaceResourceActionsOperationOptions) (ListEnterpriseAppResourceNamespaceResourceActionsCompleteResult, error) {
	return c.ListEnterpriseAppResourceNamespaceResourceActionsCompleteMatchingPredicate(ctx, id, options, UnifiedRbacResourceActionOperationPredicate{})
}
...
func (c EnterpriseAppResourceNamespaceResourceActionClient) ListEnterpriseAppResourceNamespaceResourceActionsCompleteMatchingPredicate(ctx context.Context, id beta.RoleManagementEnterpriseAppIdResourceNamespaceId, options ListEnterpriseAppResourceNamespaceResourceActionsOperationOptions, predicate UnifiedRbacResourceActionOperationPredicate) (result ListEnterpriseAppResourceNamespaceResourceActionsCompleteResult, err error) {
	...
	resp, err := c.ListEnterpriseAppResourceNamespaceResourceActions(ctx, id, options)
	if err != nil {
