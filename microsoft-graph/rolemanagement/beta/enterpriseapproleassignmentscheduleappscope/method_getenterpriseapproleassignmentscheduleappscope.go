...
type GetEnterpriseAppRoleAssignmentScheduleAppScopeOperationResponse struct {
	HttpResponse *http.Response
	OData        *odata.OData
	Model        beta.AppScope
}

type GetEnterpriseAppRoleAssignmentScheduleAppScopeOperationOptions struct {
	Expand    *odata.Expand
...
func DefaultGetEnterpriseAppRoleAssignmentScheduleAppScopeOperationOptions() GetEnterpriseAppRoleAssignmentScheduleAppScopeOperationOptions {
	return GetEnterpriseAppRoleAssignmentScheduleAppScopeOperationOptions{}
}
...
// GetEnterpriseAppRoleAssignmentScheduleAppScope - Get appScope from roleManagement. Read-only property with details of
