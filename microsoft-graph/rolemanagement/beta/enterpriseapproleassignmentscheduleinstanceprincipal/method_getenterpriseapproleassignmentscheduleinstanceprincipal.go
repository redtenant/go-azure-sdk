...
type GetEnterpriseAppRoleAssignmentScheduleInstancePrincipalOperationResponse struct {
	HttpResponse *http.Response
	OData        *odata.OData
	Model        beta.DirectoryObject
}

type GetEnterpriseAppRoleAssignmentScheduleInstancePrincipalOperationOptions struct {
	Expand    *odata.Expand
...
func DefaultGetEnterpriseAppRoleAssignmentScheduleInstancePrincipalOperationOptions() GetEnterpriseAppRoleAssignmentScheduleInstancePrincipalOperationOptions {
	return GetEnterpriseAppRoleAssignmentScheduleInstancePrincipalOperationOptions{}
}
...
// GetEnterpriseAppRoleAssignmentScheduleInstancePrincipal - Get principal from roleManagement. The principal that's
