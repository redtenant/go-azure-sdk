...
func (c EntitlementManagementClient) UpdateEntitlementManagement(ctx context.Context, input beta.RbacApplication, options UpdateEntitlementManagementOperationOptions) (result UpdateEntitlementManagementOperationResponse, err error) {
