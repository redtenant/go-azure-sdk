...
func (c EntitlementManagementResourceNamespaceResourceActionClient) GetEntitlementManagementResourceNamespaceResourceActionsCount(ctx context.Context, id beta.RoleManagementEntitlementManagementResourceNamespaceId, options GetEntitlementManagementResourceNamespaceResourceActionsCountOperationOptions) (result GetEntitlementManagementResourceNamespaceResourceActionsCountOperationResponse, err error) {
