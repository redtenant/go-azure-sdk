...
// ListEntitlementManagementResourceNamespaceResourceActions - Get resourceActions from roleManagement. Operations that
// an authorized principal is allowed to perform.
func (c EntitlementManagementResourceNamespaceResourceActionClient) ListEntitlementManagementResourceNamespaceResourceActions(ctx context.Context, id beta.RoleManagementEntitlementManagementResourceNamespaceId, options ListEntitlementManagementResourceNamespaceResourceActionsOperationOptions) (result ListEntitlementManagementResourceNamespaceResourceActionsOperationResponse, err error) {
...
func (c EntitlementManagementResourceNamespaceResourceActionClient) ListEntitlementManagementResourceNamespaceResourceActionsCompleteMatchingPredicate(ctx context.Context, id beta.RoleManagementEntitlementManagementResourceNamespaceId, options ListEntitlementManagementResourceNamespaceResourceActionsOperationOptions, predicate UnifiedRbacResourceActionOperationPredicate) (result ListEntitlementManagementResourceNamespaceResourceActionsCompleteResult, err error) {
