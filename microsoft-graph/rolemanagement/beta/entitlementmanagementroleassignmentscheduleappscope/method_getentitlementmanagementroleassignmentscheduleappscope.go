...
func (c EntitlementManagementRoleAssignmentScheduleAppScopeClient) GetEntitlementManagementRoleAssignmentScheduleAppScope(ctx context.Context, id beta.RoleManagementEntitlementManagementRoleAssignmentScheduleId, options GetEntitlementManagementRoleAssignmentScheduleAppScopeOperationOptions) (result GetEntitlementManagementRoleAssignmentScheduleAppScopeOperationResponse, err error) {
