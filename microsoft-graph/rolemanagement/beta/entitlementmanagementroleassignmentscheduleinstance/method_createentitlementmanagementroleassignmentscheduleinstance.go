...
func (c EntitlementManagementRoleAssignmentScheduleInstanceClient) CreateEntitlementManagementRoleAssignmentScheduleInstance(ctx context.Context, input beta.UnifiedRoleAssignmentScheduleInstance, options CreateEntitlementManagementRoleAssignmentScheduleInstanceOperationOptions) (result CreateEntitlementManagementRoleAssignmentScheduleInstanceOperationResponse, err error) {
