...
func (c EntitlementManagementRoleAssignmentScheduleRequestClient) UpdateEntitlementManagementRoleAssignmentScheduleRequest(ctx context.Context, id beta.RoleManagementEntitlementManagementRoleAssignmentScheduleRequestId, input beta.UnifiedRoleAssignmentScheduleRequest, options UpdateEntitlementManagementRoleAssignmentScheduleRequestOperationOptions) (result UpdateEntitlementManagementRoleAssignmentScheduleRequestOperationResponse, err error) {
