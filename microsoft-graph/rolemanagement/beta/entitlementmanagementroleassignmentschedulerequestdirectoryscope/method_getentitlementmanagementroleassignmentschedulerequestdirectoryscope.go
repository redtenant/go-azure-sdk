...
func (c EntitlementManagementRoleAssignmentScheduleRequestDirectoryScopeClient) GetEntitlementManagementRoleAssignmentScheduleRequestDirectoryScope(ctx context.Context, id beta.RoleManagementEntitlementManagementRoleAssignmentScheduleRequestId, options GetEntitlementManagementRoleAssignmentScheduleRequestDirectoryScopeOperationOptions) (result GetEntitlementManagementRoleAssignmentScheduleRequestDirectoryScopeOperationResponse, err error) {
