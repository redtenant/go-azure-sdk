...
func (c EntitlementManagementRoleDefinitionClient) DeleteEntitlementManagementRoleDefinition(ctx context.Context, id beta.RoleManagementEntitlementManagementRoleDefinitionId, options DeleteEntitlementManagementRoleDefinitionOperationOptions) (result DeleteEntitlementManagementRoleDefinitionOperationResponse, err error) {
