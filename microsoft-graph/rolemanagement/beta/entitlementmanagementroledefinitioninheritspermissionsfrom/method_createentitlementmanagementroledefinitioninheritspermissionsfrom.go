...
func (c EntitlementManagementRoleDefinitionInheritsPermissionsFromClient) CreateEntitlementManagementRoleDefinitionInheritsPermissionsFrom(ctx context.Context, id beta.RoleManagementEntitlementManagementRoleDefinitionId, input beta.UnifiedRoleDefinition, options CreateEntitlementManagementRoleDefinitionInheritsPermissionsFromOperationOptions) (result CreateEntitlementManagementRoleDefinitionInheritsPermissionsFromOperationResponse, err error) {
