...
func (c EntitlementManagementRoleDefinitionInheritsPermissionsFromClient) ListEntitlementManagementRoleDefinitionInheritsPermissionsFromsComplete(ctx context.Context, id beta.RoleManagementEntitlementManagementRoleDefinitionId, options ListEntitlementManagementRoleDefinitionInheritsPermissionsFromsOperationOptions) (ListEntitlementManagementRoleDefinitionInheritsPermissionsFromsCompleteResult, error) {
