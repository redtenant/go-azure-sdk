...
type UpdateEntitlementManagementRoleDefinitionInheritsPermissionsFromOperationResponse struct {
...
func (c EntitlementManagementRoleDefinitionInheritsPermissionsFromClient) UpdateEntitlementManagementRoleDefinitionInheritsPermissionsFrom(ctx context.Context, id beta.RoleManagementEntitlementManagementRoleDefinitionIdInheritsPermissionsFromId, input beta.UnifiedRoleDefinition, options UpdateEntitlementManagementRoleDefinitionInheritsPermissionsFromOperationOptions) (result UpdateEntitlementManagementRoleDefinitionInheritsPermissionsFromOperationResponse, err error) {
