...
// roleManagement
func (c EntitlementManagementRoleEligibilityScheduleClient) DeleteEntitlementManagementRoleEligibilitySchedule(ctx context.Context, id beta.RoleManagementEntitlementManagementRoleEligibilityScheduleId, options DeleteEntitlementManagementRoleEligibilityScheduleOperationOptions) (result DeleteEntitlementManagementRoleEligibilityScheduleOperationResponse, err error) {
