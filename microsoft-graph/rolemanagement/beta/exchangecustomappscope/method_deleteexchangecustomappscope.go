...
func DefaultDeleteExchangeCustomAppScopeOperationOptions() DeleteExchangeCustomAppScopeOperationOptions {
	return DeleteExchangeCustomAppScopeOperationOptions{}
}
...
// DeleteExchangeCustomAppScope - Delete customAppScope. Delete a customAppScope object of an RBAC provider. Currently
// only the Exchange Online RBAC provider is supported.
