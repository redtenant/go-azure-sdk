...
type UpdateExchangeRoleAssignmentAppScopeOperationResponse struct {
	HttpResponse *http.Response
	OData        *odata.OData
}

type UpdateExchangeRoleAssignmentAppScopeOperationOptions struct {
...
func DefaultUpdateExchangeRoleAssignmentAppScopeOperationOptions() UpdateExchangeRoleAssignmentAppScopeOperationOptions {
	return UpdateExchangeRoleAssignmentAppScopeOperationOptions{}
}
