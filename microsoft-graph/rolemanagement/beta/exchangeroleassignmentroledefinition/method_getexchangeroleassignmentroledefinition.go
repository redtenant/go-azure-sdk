...
type GetExchangeRoleAssignmentRoleDefinitionOperationResponse struct {
	HttpResponse *http.Response
	OData        *odata.OData
	Model        *beta.UnifiedRoleDefinition
}

type GetExchangeRoleAssignmentRoleDefinitionOperationOptions struct {
	Expand    *odata.Expand
...
func DefaultGetExchangeRoleAssignmentRoleDefinitionOperationOptions() GetExchangeRoleAssignmentRoleDefinitionOperationOptions {
	return GetExchangeRoleAssignmentRoleDefinitionOperationOptions{}
}
...
// GetExchangeRoleAssignmentRoleDefinition - Get roleDefinition from roleManagement. The roleDefinition the assignment
