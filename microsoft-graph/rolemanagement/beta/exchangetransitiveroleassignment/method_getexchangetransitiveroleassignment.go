...
type GetExchangeTransitiveRoleAssignmentOperationResponse struct {
	HttpResponse *http.Response
	OData        *odata.OData
	Model        *beta.UnifiedRoleAssignment
}

type GetExchangeTransitiveRoleAssignmentOperationOptions struct {
	Expand    *odata.Expand
...
func DefaultGetExchangeTransitiveRoleAssignmentOperationOptions() GetExchangeTransitiveRoleAssignmentOperationOptions {
	return GetExchangeTransitiveRoleAssignmentOperationOptions{}
}
...
// GetExchangeTransitiveRoleAssignment - Get transitiveRoleAssignments from roleManagement. Resource to grant access to
// users or groups that are transitive.
