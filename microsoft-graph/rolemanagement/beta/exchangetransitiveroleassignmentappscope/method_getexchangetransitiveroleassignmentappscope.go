...
type GetExchangeTransitiveRoleAssignmentAppScopeOperationResponse struct {
	HttpResponse *http.Response
	OData        *odata.OData
	Model        beta.AppScope
}

type GetExchangeTransitiveRoleAssignmentAppScopeOperationOptions struct {
	Expand    *odata.Expand
...
func DefaultGetExchangeTransitiveRoleAssignmentAppScopeOperationOptions() GetExchangeTransitiveRoleAssignmentAppScopeOperationOptions {
	return GetExchangeTransitiveRoleAssignmentAppScopeOperationOptions{}
}
...
// GetExchangeTransitiveRoleAssignmentAppScope - Get appScope from roleManagement. Read-only property with details of
