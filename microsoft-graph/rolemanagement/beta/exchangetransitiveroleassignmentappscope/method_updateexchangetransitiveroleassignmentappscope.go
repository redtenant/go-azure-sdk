...
type UpdateExchangeTransitiveRoleAssignmentAppScopeOperationResponse struct {
	HttpResponse *http.Response
	OData        *odata.OData
}

type UpdateExchangeTransitiveRoleAssignmentAppScopeOperationOptions struct {
...
func DefaultUpdateExchangeTransitiveRoleAssignmentAppScopeOperationOptions() UpdateExchangeTransitiveRoleAssignmentAppScopeOperationOptions {
	return UpdateExchangeTransitiveRoleAssignmentAppScopeOperationOptions{}
}
