package exchangetransitiveroleassignmentdirectoryscope
...
type GetExchangeTransitiveRoleAssignmentDirectoryScopeOperationResponse struct {
	HttpResponse *http.Response
	OData        *odata.OData
	Model        beta.DirectoryObject
}

type GetExchangeTransitiveRoleAssignmentDirectoryScopeOperationOptions struct {
	Expand    *odata.Expand
...
func DefaultGetExchangeTransitiveRoleAssignmentDirectoryScopeOperationOptions() GetExchangeTransitiveRoleAssignmentDirectoryScopeOperationOptions {
	return GetExchangeTransitiveRoleAssignmentDirectoryScopeOperationOptions{}
}
...
// GetExchangeTransitiveRoleAssignmentDirectoryScope - Get directoryScope from roleManagement. The directory object that
// is the scope of the assignment. Read-only. Supports $expand for the directory provider.
