...
type GetExchangeTransitiveRoleAssignmentPrincipalOperationResponse struct {
	HttpResponse *http.Response
	OData        *odata.OData
	Model        beta.DirectoryObject
}

type GetExchangeTransitiveRoleAssignmentPrincipalOperationOptions struct {
	Expand    *odata.Expand
...
func DefaultGetExchangeTransitiveRoleAssignmentPrincipalOperationOptions() GetExchangeTransitiveRoleAssignmentPrincipalOperationOptions {
	return GetExchangeTransitiveRoleAssignmentPrincipalOperationOptions{}
}
...
// GetExchangeTransitiveRoleAssignmentPrincipal - Get principal from roleManagement. Referencing the assigned principal.
