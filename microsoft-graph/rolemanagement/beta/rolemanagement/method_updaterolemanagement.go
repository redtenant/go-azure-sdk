...
type UpdateRoleManagementOperationResponse struct {
...
func (c RoleManagementClient) UpdateRoleManagement(ctx context.Context, input beta.RoleManagement, options UpdateRoleManagementOperationOptions) (result UpdateRoleManagementOperationResponse, err error) {
