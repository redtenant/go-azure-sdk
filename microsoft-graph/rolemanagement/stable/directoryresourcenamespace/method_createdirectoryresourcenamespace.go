...
func (c DirectoryResourceNamespaceClient) CreateDirectoryResourceNamespace(ctx context.Context, input stable.UnifiedRbacResourceNamespace, options CreateDirectoryResourceNamespaceOperationOptions) (result CreateDirectoryResourceNamespaceOperationResponse, err error) {
