...
func (c DirectoryResourceNamespaceResourceActionClient) CreateDirectoryResourceNamespaceResourceAction(ctx context.Context, id stable.RoleManagementDirectoryResourceNamespaceId, input stable.UnifiedRbacResourceAction, options CreateDirectoryResourceNamespaceResourceActionOperationOptions) (result CreateDirectoryResourceNamespaceResourceActionOperationResponse, err error) {
