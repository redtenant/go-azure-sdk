...
func (c DirectoryResourceNamespaceResourceActionClient) UpdateDirectoryResourceNamespaceResourceAction(ctx context.Context, id stable.RoleManagementDirectoryResourceNamespaceIdResourceActionId, input stable.UnifiedRbacResourceAction, options UpdateDirectoryResourceNamespaceResourceActionOperationOptions) (result UpdateDirectoryResourceNamespaceResourceActionOperationResponse, err error) {
