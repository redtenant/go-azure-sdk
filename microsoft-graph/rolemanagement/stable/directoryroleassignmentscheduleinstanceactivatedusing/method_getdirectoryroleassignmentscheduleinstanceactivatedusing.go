...
func (c DirectoryRoleAssignmentScheduleInstanceActivatedUsingClient) GetDirectoryRoleAssignmentScheduleInstanceActivatedUsing(ctx context.Context, id stable.RoleManagementDirectoryRoleAssignmentScheduleInstanceId, options GetDirectoryRoleAssignmentScheduleInstanceActivatedUsingOperationOptions) (result GetDirectoryRoleAssignmentScheduleInstanceActivatedUsingOperationResponse, err error) {
