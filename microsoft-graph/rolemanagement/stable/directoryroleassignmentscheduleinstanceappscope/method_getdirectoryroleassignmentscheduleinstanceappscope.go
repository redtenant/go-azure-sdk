...
type GetDirectoryRoleAssignmentScheduleInstanceAppScopeOperationResponse struct {
	HttpResponse *http.Response
	OData        *odata.OData
	Model        *stable.AppScope
}

type GetDirectoryRoleAssignmentScheduleInstanceAppScopeOperationOptions struct {
	Expand    *odata.Expand
...
func DefaultGetDirectoryRoleAssignmentScheduleInstanceAppScopeOperationOptions() GetDirectoryRoleAssignmentScheduleInstanceAppScopeOperationOptions {
	return GetDirectoryRoleAssignmentScheduleInstanceAppScopeOperationOptions{}
}
