...
func (c DirectoryRoleAssignmentScheduleInstanceDirectoryScopeClient) GetDirectoryRoleAssignmentScheduleInstanceDirectoryScope(ctx context.Context, id stable.RoleManagementDirectoryRoleAssignmentScheduleInstanceId, options GetDirectoryRoleAssignmentScheduleInstanceDirectoryScopeOperationOptions) (result GetDirectoryRoleAssignmentScheduleInstanceDirectoryScopeOperationResponse, err error) {
