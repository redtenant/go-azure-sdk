...
type GetDirectoryRoleAssignmentSchedulePrincipalOperationResponse struct {
	HttpResponse *http.Response
	OData        *odata.OData
	Model        stable.DirectoryObject
}

type GetDirectoryRoleAssignmentSchedulePrincipalOperationOptions struct {
	Expand    *odata.Expand
...
func DefaultGetDirectoryRoleAssignmentSchedulePrincipalOperationOptions() GetDirectoryRoleAssignmentSchedulePrincipalOperationOptions {
	return GetDirectoryRoleAssignmentSchedulePrincipalOperationOptions{}
}
...
// GetDirectoryRoleAssignmentSchedulePrincipal - Get principal from roleManagement. The principal that's getting a role
// assignment or that's eligible for a role through the request.
func (c DirectoryRoleAssignmentSchedulePrincipalClient) GetDirectoryRoleAssignmentSchedulePrincipal(ctx context.Context, id stable.RoleManagementDirectoryRoleAssignmentScheduleId, options GetDirectoryRoleAssignmentSchedulePrincipalOperationOptions) (result GetDirectoryRoleAssignmentSchedulePrincipalOperationResponse, err error) {
