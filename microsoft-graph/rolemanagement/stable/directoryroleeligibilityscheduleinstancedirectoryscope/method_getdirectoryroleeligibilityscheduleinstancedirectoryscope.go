...
func (c DirectoryRoleEligibilityScheduleInstanceDirectoryScopeClient) GetDirectoryRoleEligibilityScheduleInstanceDirectoryScope(ctx context.Context, id stable.RoleManagementDirectoryRoleEligibilityScheduleInstanceId, options GetDirectoryRoleEligibilityScheduleInstanceDirectoryScopeOperationOptions) (result GetDirectoryRoleEligibilityScheduleInstanceDirectoryScopeOperationResponse, err error) {
