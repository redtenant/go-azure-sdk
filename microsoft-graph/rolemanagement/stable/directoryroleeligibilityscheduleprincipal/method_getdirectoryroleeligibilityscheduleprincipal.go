...
func (c DirectoryRoleEligibilitySchedulePrincipalClient) GetDirectoryRoleEligibilitySchedulePrincipal(ctx context.Context, id stable.RoleManagementDirectoryRoleEligibilityScheduleId, options GetDirectoryRoleEligibilitySchedulePrincipalOperationOptions) (result GetDirectoryRoleEligibilitySchedulePrincipalOperationResponse, err error) {
