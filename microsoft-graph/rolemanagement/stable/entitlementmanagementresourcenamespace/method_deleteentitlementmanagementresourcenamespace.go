...
type DeleteEntitlementManagementResourceNamespaceOperationResponse struct {
	HttpResponse *http.Response
	OData        *odata.OData
}

type DeleteEntitlementManagementResourceNamespaceOperationOptions struct {
	IfMatch   *string
...
func DefaultDeleteEntitlementManagementResourceNamespaceOperationOptions() DeleteEntitlementManagementResourceNamespaceOperationOptions {
	return DeleteEntitlementManagementResourceNamespaceOperationOptions{}
}
...
func (c EntitlementManagementResourceNamespaceClient) DeleteEntitlementManagementResourceNamespace(ctx context.Context, id stable.RoleManagementEntitlementManagementResourceNamespaceId, options DeleteEntitlementManagementResourceNamespaceOperationOptions) (result DeleteEntitlementManagementResourceNamespaceOperationResponse, err error) {
