...
type GetEntitlementManagementResourceNamespaceOperationOptions struct {
	Expand    *odata.Expand
...
func DefaultGetEntitlementManagementResourceNamespaceOperationOptions() GetEntitlementManagementResourceNamespaceOperationOptions {
	return GetEntitlementManagementResourceNamespaceOperationOptions{}
}
...
func (c EntitlementManagementResourceNamespaceClient) GetEntitlementManagementResourceNamespace(ctx context.Context, id stable.RoleManagementEntitlementManagementResourceNamespaceId, options GetEntitlementManagementResourceNamespaceOperationOptions) (result GetEntitlementManagementResourceNamespaceOperationResponse, err error) {
