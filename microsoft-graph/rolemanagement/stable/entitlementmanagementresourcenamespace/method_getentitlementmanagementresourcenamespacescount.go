...
type GetEntitlementManagementResourceNamespacesCountOperationResponse struct {
	HttpResponse *http.Response
	OData        *odata.OData
	Model        *[]byte
}

type GetEntitlementManagementResourceNamespacesCountOperationOptions struct {
	Filter    *string
...
func DefaultGetEntitlementManagementResourceNamespacesCountOperationOptions() GetEntitlementManagementResourceNamespacesCountOperationOptions {
	return GetEntitlementManagementResourceNamespacesCountOperationOptions{}
}
