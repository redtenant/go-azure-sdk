...
func (c EntitlementManagementResourceNamespaceClient) UpdateEntitlementManagementResourceNamespace(ctx context.Context, id stable.RoleManagementEntitlementManagementResourceNamespaceId, input stable.UnifiedRbacResourceNamespace, options UpdateEntitlementManagementResourceNamespaceOperationOptions) (result UpdateEntitlementManagementResourceNamespaceOperationResponse, err error) {
