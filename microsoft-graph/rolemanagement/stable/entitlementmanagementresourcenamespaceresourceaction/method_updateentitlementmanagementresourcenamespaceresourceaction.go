...
// roleManagement
func (c EntitlementManagementResourceNamespaceResourceActionClient) UpdateEntitlementManagementResourceNamespaceResourceAction(ctx context.Context, id stable.RoleManagementEntitlementManagementResourceNamespaceIdResourceActionId, input stable.UnifiedRbacResourceAction, options UpdateEntitlementManagementResourceNamespaceResourceActionOperationOptions) (result UpdateEntitlementManagementResourceNamespaceResourceActionOperationResponse, err error) {
