...
type GetEntitlementManagementRoleAssignmentAppScopeOperationResponse struct {
	HttpResponse *http.Response
	OData        *odata.OData
	Model        *stable.AppScope
}

type GetEntitlementManagementRoleAssignmentAppScopeOperationOptions struct {
	Expand    *odata.Expand
...
func DefaultGetEntitlementManagementRoleAssignmentAppScopeOperationOptions() GetEntitlementManagementRoleAssignmentAppScopeOperationOptions {
	return GetEntitlementManagementRoleAssignmentAppScopeOperationOptions{}
}
...
// GetEntitlementManagementRoleAssignmentAppScope - Get appScope from roleManagement. Read-only property with details of
