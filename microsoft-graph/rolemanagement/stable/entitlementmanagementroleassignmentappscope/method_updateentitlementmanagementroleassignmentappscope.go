...
type UpdateEntitlementManagementRoleAssignmentAppScopeOperationResponse struct {
...
func (c EntitlementManagementRoleAssignmentAppScopeClient) UpdateEntitlementManagementRoleAssignmentAppScope(ctx context.Context, id stable.RoleManagementEntitlementManagementRoleAssignmentId, input stable.AppScope, options UpdateEntitlementManagementRoleAssignmentAppScopeOperationOptions) (result UpdateEntitlementManagementRoleAssignmentAppScopeOperationResponse, err error) {
