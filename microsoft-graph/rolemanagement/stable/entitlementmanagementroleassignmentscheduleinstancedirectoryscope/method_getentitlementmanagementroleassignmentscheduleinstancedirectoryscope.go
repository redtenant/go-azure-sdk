...
func (c EntitlementManagementRoleAssignmentScheduleInstanceDirectoryScopeClient) GetEntitlementManagementRoleAssignmentScheduleInstanceDirectoryScope(ctx context.Context, id stable.RoleManagementEntitlementManagementRoleAssignmentScheduleInstanceId, options GetEntitlementManagementRoleAssignmentScheduleInstanceDirectoryScopeOperationOptions) (result GetEntitlementManagementRoleAssignmentScheduleInstanceDirectoryScopeOperationResponse, err error) {
