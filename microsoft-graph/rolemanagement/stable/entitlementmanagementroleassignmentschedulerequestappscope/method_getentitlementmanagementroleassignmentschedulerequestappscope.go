...
type GetEntitlementManagementRoleAssignmentScheduleRequestAppScopeOperationResponse struct {
	HttpResponse *http.Response
	OData        *odata.OData
	Model        *stable.AppScope
}

type GetEntitlementManagementRoleAssignmentScheduleRequestAppScopeOperationOptions struct {
	Expand    *odata.Expand
...
func DefaultGetEntitlementManagementRoleAssignmentScheduleRequestAppScopeOperationOptions() GetEntitlementManagementRoleAssignmentScheduleRequestAppScopeOperationOptions {
	return GetEntitlementManagementRoleAssignmentScheduleRequestAppScopeOperationOptions{}
}
...
// GetEntitlementManagementRoleAssignmentScheduleRequestAppScope - Get appScope from roleManagement. Read-only property
// with details of the app-specific scope when the assignment is scoped to an app. Nullable. Supports $expand.
func (c EntitlementManagementRoleAssignmentScheduleRequestAppScopeClient) GetEntitlementManagementRoleAssignmentScheduleRequestAppScope(ctx context.Context, id stable.RoleManagementEntitlementManagementRoleAssignmentScheduleRequestId, options GetEntitlementManagementRoleAssignmentScheduleRequestAppScopeOperationOptions) (result GetEntitlementManagementRoleAssignmentScheduleRequestAppScopeOperationResponse, err error) {
