...
// GetEntitlementManagementRoleDefinition - Get roleDefinitions from roleManagement. Resource representing the roles
// allowed by RBAC providers and the permissions assigned to the roles.
