...
func (c EntitlementManagementRoleEligibilityScheduleInstancePrincipalClient) GetEntitlementManagementRoleEligibilityScheduleInstancePrincipal(ctx context.Context, id stable.RoleManagementEntitlementManagementRoleEligibilityScheduleInstanceId, options GetEntitlementManagementRoleEligibilityScheduleInstancePrincipalOperationOptions) (result GetEntitlementManagementRoleEligibilityScheduleInstancePrincipalOperationResponse, err error) {
