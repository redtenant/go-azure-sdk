...
func (c EntitlementManagementRoleEligibilityScheduleRoleDefinitionClient) GetEntitlementManagementRoleEligibilityScheduleRoleDefinition(ctx context.Context, id stable.RoleManagementEntitlementManagementRoleEligibilityScheduleId, options GetEntitlementManagementRoleEligibilityScheduleRoleDefinitionOperationOptions) (result GetEntitlementManagementRoleEligibilityScheduleRoleDefinitionOperationResponse, err error) {
