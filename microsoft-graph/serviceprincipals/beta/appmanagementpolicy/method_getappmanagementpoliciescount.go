...
func (c AppManagementPolicyClient) GetAppManagementPoliciesCount(ctx context.Context, id beta.ServicePrincipalId, options GetAppManagementPoliciesCountOperationOptions) (result GetAppManagementPoliciesCountOperationResponse, err error) {
