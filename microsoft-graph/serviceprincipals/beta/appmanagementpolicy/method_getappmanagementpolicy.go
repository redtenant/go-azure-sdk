...
// service principal.
func (c AppManagementPolicyClient) GetAppManagementPolicy(ctx context.Context, id beta.ServicePrincipalIdAppManagementPolicyId, options GetAppManagementPolicyOperationOptions) (result GetAppManagementPolicyOperationResponse, err error) {
