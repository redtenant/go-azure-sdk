...
// service principal.
func (c AppManagementPolicyClient) ListAppManagementPolicies(ctx context.Context, id beta.ServicePrincipalId, options ListAppManagementPoliciesOperationOptions) (result ListAppManagementPoliciesOperationResponse, err error) {
...
func (c AppManagementPolicyClient) ListAppManagementPoliciesComplete(ctx context.Context, id beta.ServicePrincipalId, options ListAppManagementPoliciesOperationOptions) (ListAppManagementPoliciesCompleteResult, error) {
...
func (c AppManagementPolicyClient) ListAppManagementPoliciesCompleteMatchingPredicate(ctx context.Context, id beta.ServicePrincipalId, options ListAppManagementPoliciesOperationOptions, predicate AppManagementPolicyOperationPredicate) (result ListAppManagementPoliciesCompleteResult, err error) {
