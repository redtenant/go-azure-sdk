...
func (c AppRoleAssignedToClient) DeleteAppRoleAssignedTo(ctx context.Context, id beta.ServicePrincipalIdAppRoleAssignedToId, options DeleteAppRoleAssignedToOperationOptions) (result DeleteAppRoleAssignedToOperationResponse, err error) {
