...
func (c AppRoleAssignedToClient) GetAppRoleAssignedTo(ctx context.Context, id beta.ServicePrincipalIdAppRoleAssignedToId, options GetAppRoleAssignedToOperationOptions) (result GetAppRoleAssignedToOperationResponse, err error) {
