...
func (c AppRoleAssignedToClient) GetAppRoleAssignedToCount(ctx context.Context, id beta.ServicePrincipalId, options GetAppRoleAssignedToCountOperationOptions) (result GetAppRoleAssignedToCountOperationResponse, err error) {
