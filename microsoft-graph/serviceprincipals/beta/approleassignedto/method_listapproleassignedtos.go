...
func (c AppRoleAssignedToClient) ListAppRoleAssignedTos(ctx context.Context, id beta.ServicePrincipalId, options ListAppRoleAssignedTosOperationOptions) (result ListAppRoleAssignedTosOperationResponse, err error) {
...
func (c AppRoleAssignedToClient) ListAppRoleAssignedTosComplete(ctx context.Context, id beta.ServicePrincipalId, options ListAppRoleAssignedTosOperationOptions) (ListAppRoleAssignedTosCompleteResult, error) {
...
func (c AppRoleAssignedToClient) ListAppRoleAssignedTosCompleteMatchingPredicate(ctx context.Context, id beta.ServicePrincipalId, options ListAppRoleAssignedTosOperationOptions, predicate AppRoleAssignmentOperationPredicate) (result ListAppRoleAssignedTosCompleteResult, err error) {
