...
func (c AppRoleAssignmentClient) GetAppRoleAssignmentsCount(ctx context.Context, id beta.ServicePrincipalId, options GetAppRoleAssignmentsCountOperationOptions) (result GetAppRoleAssignmentsCountOperationResponse, err error) {
