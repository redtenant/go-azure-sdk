...
func (c AppRoleAssignmentClient) UpdateAppRoleAssignment(ctx context.Context, id beta.ServicePrincipalIdAppRoleAssignmentId, input beta.AppRoleAssignment, options UpdateAppRoleAssignmentOperationOptions) (result UpdateAppRoleAssignmentOperationResponse, err error) {
