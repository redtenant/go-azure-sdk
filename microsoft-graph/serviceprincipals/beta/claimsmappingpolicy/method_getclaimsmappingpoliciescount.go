...
func (c ClaimsMappingPolicyClient) GetClaimsMappingPoliciesCount(ctx context.Context, id beta.ServicePrincipalId, options GetClaimsMappingPoliciesCountOperationOptions) (result GetClaimsMappingPoliciesCountOperationResponse, err error) {
