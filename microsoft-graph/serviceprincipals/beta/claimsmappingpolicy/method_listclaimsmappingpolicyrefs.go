...
func (c ClaimsMappingPolicyClient) ListClaimsMappingPolicyRefs(ctx context.Context, id beta.ServicePrincipalId, options ListClaimsMappingPolicyRefsOperationOptions) (result ListClaimsMappingPolicyRefsOperationResponse, err error) {
...
func (c ClaimsMappingPolicyClient) ListClaimsMappingPolicyRefsComplete(ctx context.Context, id beta.ServicePrincipalId, options ListClaimsMappingPolicyRefsOperationOptions) (ListClaimsMappingPolicyRefsCompleteResult, error) {
...
func (c ClaimsMappingPolicyClient) ListClaimsMappingPolicyRefsCompleteMatchingPredicate(ctx context.Context, id beta.ServicePrincipalId, options ListClaimsMappingPolicyRefsOperationOptions, predicate DirectoryObjectOperationPredicate) (result ListClaimsMappingPolicyRefsCompleteResult, err error) {
