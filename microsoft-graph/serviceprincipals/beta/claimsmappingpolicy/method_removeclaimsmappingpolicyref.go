...
func (c ClaimsMappingPolicyClient) RemoveClaimsMappingPolicyRef(ctx context.Context, id beta.ServicePrincipalIdClaimsMappingPolicyId, options RemoveClaimsMappingPolicyRefOperationOptions) (result RemoveClaimsMappingPolicyRefOperationResponse, err error) {
