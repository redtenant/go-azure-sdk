...
func (c ClaimsMappingPolicyClient) RemoveClaimsMappingPolicyRefs(ctx context.Context, id beta.ServicePrincipalId, options RemoveClaimsMappingPolicyRefsOperationOptions) (result RemoveClaimsMappingPolicyRefsOperationResponse, err error) {
