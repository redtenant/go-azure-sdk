...
// Read-only. Nullable.
func (c CreatedObjectClient) GetCreatedObject(ctx context.Context, id beta.ServicePrincipalIdCreatedObjectId, options GetCreatedObjectOperationOptions) (result GetCreatedObjectOperationResponse, err error) {
