...
// ListCreatedObjects - servicePrincipal: List createdObjects. Retrieve a list of directoryobject objects.
func (c CreatedObjectClient) ListCreatedObjects(ctx context.Context, id beta.ServicePrincipalId, options ListCreatedObjectsOperationOptions) (result ListCreatedObjectsOperationResponse, err error) {
...
func (c CreatedObjectClient) ListCreatedObjectsComplete(ctx context.Context, id beta.ServicePrincipalId, options ListCreatedObjectsOperationOptions) (ListCreatedObjectsCompleteResult, error) {
...
func (c CreatedObjectClient) ListCreatedObjectsCompleteMatchingPredicate(ctx context.Context, id beta.ServicePrincipalId, options ListCreatedObjectsOperationOptions, predicate DirectoryObjectOperationPredicate) (result ListCreatedObjectsCompleteResult, err error) {
