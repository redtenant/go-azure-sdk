...
func (c DelegatedPermissionClassificationClient) DeleteDelegatedPermissionClassification(ctx context.Context, id beta.ServicePrincipalIdDelegatedPermissionClassificationId, options DeleteDelegatedPermissionClassificationOperationOptions) (result DeleteDelegatedPermissionClassificationOperationResponse, err error) {
