...
// GetDelegatedPermissionClassification - Get delegatedPermissionClassifications from servicePrincipals. The permission
// classifications for delegated permissions exposed by the app that this service principal represents. Supports
// $expand.
func (c DelegatedPermissionClassificationClient) GetDelegatedPermissionClassification(ctx context.Context, id beta.ServicePrincipalIdDelegatedPermissionClassificationId, options GetDelegatedPermissionClassificationOperationOptions) (result GetDelegatedPermissionClassificationOperationResponse, err error) {
