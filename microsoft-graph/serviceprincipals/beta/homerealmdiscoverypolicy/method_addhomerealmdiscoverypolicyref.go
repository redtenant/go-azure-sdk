...
type AddHomeRealmDiscoveryPolicyRefOperationResponse struct {
...
// servicePrincipal.
func (c HomeRealmDiscoveryPolicyClient) AddHomeRealmDiscoveryPolicyRef(ctx context.Context, id beta.ServicePrincipalId, input beta.ReferenceCreate, options AddHomeRealmDiscoveryPolicyRefOperationOptions) (result AddHomeRealmDiscoveryPolicyRefOperationResponse, err error) {
