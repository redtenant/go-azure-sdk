...
func (c HomeRealmDiscoveryPolicyClient) GetHomeRealmDiscoveryPoliciesCount(ctx context.Context, id beta.ServicePrincipalId, options GetHomeRealmDiscoveryPoliciesCountOperationOptions) (result GetHomeRealmDiscoveryPoliciesCountOperationResponse, err error) {
