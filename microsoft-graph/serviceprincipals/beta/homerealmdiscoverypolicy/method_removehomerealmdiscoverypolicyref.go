...
// servicePrincipal.
func (c HomeRealmDiscoveryPolicyClient) RemoveHomeRealmDiscoveryPolicyRef(ctx context.Context, id beta.ServicePrincipalIdHomeRealmDiscoveryPolicyId, options RemoveHomeRealmDiscoveryPolicyRefOperationOptions) (result RemoveHomeRealmDiscoveryPolicyRefOperationResponse, err error) {
