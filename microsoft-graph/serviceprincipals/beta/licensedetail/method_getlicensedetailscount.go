...
func (c LicenseDetailClient) GetLicenseDetailsCount(ctx context.Context, id beta.ServicePrincipalId, options GetLicenseDetailsCountOperationOptions) (result GetLicenseDetailsCountOperationResponse, err error) {
