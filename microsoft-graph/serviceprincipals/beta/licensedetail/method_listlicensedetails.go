...
// ListLicenseDetails - Get licenseDetails from servicePrincipals
func (c LicenseDetailClient) ListLicenseDetails(ctx context.Context, id beta.ServicePrincipalId, options ListLicenseDetailsOperationOptions) (result ListLicenseDetailsOperationResponse, err error) {
...
func (c LicenseDetailClient) ListLicenseDetailsComplete(ctx context.Context, id beta.ServicePrincipalId, options ListLicenseDetailsOperationOptions) (ListLicenseDetailsCompleteResult, error) {
...
func (c LicenseDetailClient) ListLicenseDetailsCompleteMatchingPredicate(ctx context.Context, id beta.ServicePrincipalId, options ListLicenseDetailsOperationOptions, predicate LicenseDetailsOperationPredicate) (result ListLicenseDetailsCompleteResult, err error) {
