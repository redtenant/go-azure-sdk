...
// UpdateLicenseDetail - Update the navigation property licenseDetails in servicePrincipals
func (c LicenseDetailClient) UpdateLicenseDetail(ctx context.Context, id beta.ServicePrincipalIdLicenseDetailId, input beta.LicenseDetails, options UpdateLicenseDetailOperationOptions) (result UpdateLicenseDetailOperationResponse, err error) {
