...
type GetMemberOfOperationOptions struct {
...
// GetMemberOf - Get memberOf from servicePrincipals. Roles that this service principal is a member of. HTTP Methods:
// GET Read-only. Nullable. Supports $expand.
func (c MemberOfClient) GetMemberOf(ctx context.Context, id beta.ServicePrincipalIdMemberOfId, options GetMemberOfOperationOptions) (result GetMemberOfOperationResponse, err error) {
