...
type GetMemberOfCountOperationResponse struct {
	HttpResponse *http.Response
	OData        *odata.OData
	Model        *[]byte
}

type GetMemberOfCountOperationOptions struct {
...
func DefaultGetMemberOfCountOperationOptions() GetMemberOfCountOperationOptions {
	return GetMemberOfCountOperationOptions{}
}
...
func (c MemberOfClient) GetMemberOfCount(ctx context.Context, id beta.ServicePrincipalId, options GetMemberOfCountOperationOptions) (result GetMemberOfCountOperationResponse, err error) {
