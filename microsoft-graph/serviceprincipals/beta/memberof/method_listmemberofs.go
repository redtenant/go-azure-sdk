...
// ListMemberOfs - List servicePrincipal memberOf. Get the groups and directory roles that this servicePrincipal is a
// direct member of. This operation isn't transitive.
func (c MemberOfClient) ListMemberOfs(ctx context.Context, id beta.ServicePrincipalId, options ListMemberOfsOperationOptions) (result ListMemberOfsOperationResponse, err error) {
...
func (c MemberOfClient) ListMemberOfsComplete(ctx context.Context, id beta.ServicePrincipalId, options ListMemberOfsOperationOptions) (ListMemberOfsCompleteResult, error) {
...
func (c MemberOfClient) ListMemberOfsCompleteMatchingPredicate(ctx context.Context, id beta.ServicePrincipalId, options ListMemberOfsOperationOptions, predicate DirectoryObjectOperationPredicate) (result ListMemberOfsCompleteResult, err error) {
