...
func (c OwnedObjectClient) GetOwnedObjectsCount(ctx context.Context, id beta.ServicePrincipalId, options GetOwnedObjectsCountOperationOptions) (result GetOwnedObjectsCountOperationResponse, err error) {
