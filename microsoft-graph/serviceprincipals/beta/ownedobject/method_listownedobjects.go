...
// ListOwnedObjects - servicePrincipals: List ownedObjects. Retrieve a list of objects owned by the servicePrincipal.
// This could include applications or groups.
func (c OwnedObjectClient) ListOwnedObjects(ctx context.Context, id beta.ServicePrincipalId, options ListOwnedObjectsOperationOptions) (result ListOwnedObjectsOperationResponse, err error) {
...
func (c OwnedObjectClient) ListOwnedObjectsComplete(ctx context.Context, id beta.ServicePrincipalId, options ListOwnedObjectsOperationOptions) (ListOwnedObjectsCompleteResult, error) {
...
func (c OwnedObjectClient) ListOwnedObjectsCompleteMatchingPredicate(ctx context.Context, id beta.ServicePrincipalId, options ListOwnedObjectsOperationOptions, predicate DirectoryObjectOperationPredicate) (result ListOwnedObjectsCompleteResult, err error) {
