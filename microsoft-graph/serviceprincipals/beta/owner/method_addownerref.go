...
// AddOwnerRef - servicePrincipal: Add owner. Add an owner for the servicePrincipal. Service principal owners can be
// users, the service principal itself, or other service principals.
func (c OwnerClient) AddOwnerRef(ctx context.Context, id beta.ServicePrincipalId, input beta.ReferenceCreate, options AddOwnerRefOperationOptions) (result AddOwnerRefOperationResponse, err error) {
