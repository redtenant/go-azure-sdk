...
func (c OwnerClient) GetOwnersCount(ctx context.Context, id beta.ServicePrincipalId, options GetOwnersCountOperationOptions) (result GetOwnersCountOperationResponse, err error) {
