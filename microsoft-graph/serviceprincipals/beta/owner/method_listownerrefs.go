...
func (c OwnerClient) ListOwnerRefs(ctx context.Context, id beta.ServicePrincipalId, options ListOwnerRefsOperationOptions) (result ListOwnerRefsOperationResponse, err error) {
...
func (c OwnerClient) ListOwnerRefsComplete(ctx context.Context, id beta.ServicePrincipalId, options ListOwnerRefsOperationOptions) (ListOwnerRefsCompleteResult, error) {
...
func (c OwnerClient) ListOwnerRefsCompleteMatchingPredicate(ctx context.Context, id beta.ServicePrincipalId, options ListOwnerRefsOperationOptions, predicate DirectoryObjectOperationPredicate) (result ListOwnerRefsCompleteResult, err error) {
