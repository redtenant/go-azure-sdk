...
func (c OwnerClient) ListOwners(ctx context.Context, id beta.ServicePrincipalId, options ListOwnersOperationOptions) (result ListOwnersOperationResponse, err error) {
...
func (c OwnerClient) ListOwnersComplete(ctx context.Context, id beta.ServicePrincipalId, options ListOwnersOperationOptions) (ListOwnersCompleteResult, error) {
...
func (c OwnerClient) ListOwnersCompleteMatchingPredicate(ctx context.Context, id beta.ServicePrincipalId, options ListOwnersOperationOptions, predicate DirectoryObjectOperationPredicate) (result ListOwnersCompleteResult, err error) {
