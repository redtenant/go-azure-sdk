...
// RemoveOwnerRef - Remove owner. Remove an owner from a servicePrincipal object. As a recommended best practice,
// service principals should have at least two owners.
func (c OwnerClient) RemoveOwnerRef(ctx context.Context, id beta.ServicePrincipalIdOwnerId, options RemoveOwnerRefOperationOptions) (result RemoveOwnerRefOperationResponse, err error) {
