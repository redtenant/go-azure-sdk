...
// RemoveOwnerRefs - Remove owner. Remove an owner from a servicePrincipal object. As a recommended best practice,
// service principals should have at least two owners.
func (c OwnerClient) RemoveOwnerRefs(ctx context.Context, id beta.ServicePrincipalId, options RemoveOwnerRefsOperationOptions) (result RemoveOwnerRefsOperationResponse, err error) {
