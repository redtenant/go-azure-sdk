...
func (c PermissionGrantPreApprovalPolicyClient) GetPermissionGrantPreApprovalPoliciesCount(ctx context.Context, id beta.ServicePrincipalId, options GetPermissionGrantPreApprovalPoliciesCountOperationOptions) (result GetPermissionGrantPreApprovalPoliciesCountOperationResponse, err error) {
	opts := client.RequestOptions{
		...
		Path:          fmt.Sprintf("%s/permissionGrantPreApprovalPolicies/$count", id.ID()),
