...
func (c ServicePrincipalClient) CheckMemberObjects(ctx context.Context, id beta.ServicePrincipalId, input CheckMemberObjectsRequest, options CheckMemberObjectsOperationOptions) (result CheckMemberObjectsOperationResponse, err error) {
...
func (c ServicePrincipalClient) CheckMemberObjectsComplete(ctx context.Context, id beta.ServicePrincipalId, input CheckMemberObjectsRequest, options CheckMemberObjectsOperationOptions) (result CheckMemberObjectsCompleteResult, err error) {
	items := make([]string, 0)
