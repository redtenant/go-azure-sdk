...
// DeletePasswordSingleSignOnCredentials - Invoke action deletePasswordSingleSignOnCredentials. Delete single sign-on
// credentials using a password for a user or group.
func (c ServicePrincipalClient) DeletePasswordSingleSignOnCredentials(ctx context.Context, id beta.ServicePrincipalId, input DeletePasswordSingleSignOnCredentialsRequest, options DeletePasswordSingleSignOnCredentialsOperationOptions) (result DeletePasswordSingleSignOnCredentialsOperationResponse, err error) {
