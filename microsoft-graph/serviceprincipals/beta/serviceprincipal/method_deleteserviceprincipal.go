...
func (c ServicePrincipalClient) DeleteServicePrincipal(ctx context.Context, id beta.ServicePrincipalId, options DeleteServicePrincipalOperationOptions) (result DeleteServicePrincipalOperationResponse, err error) {
