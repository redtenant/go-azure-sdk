...
func (c ServicePrincipalClient) GetMemberGroups(ctx context.Context, id beta.ServicePrincipalId, input GetMemberGroupsRequest, options GetMemberGroupsOperationOptions) (result GetMemberGroupsOperationResponse, err error) {
...
func (c ServicePrincipalClient) GetMemberGroupsComplete(ctx context.Context, id beta.ServicePrincipalId, input GetMemberGroupsRequest, options GetMemberGroupsOperationOptions) (result GetMemberGroupsCompleteResult, err error) {
	items := make([]string, 0)
