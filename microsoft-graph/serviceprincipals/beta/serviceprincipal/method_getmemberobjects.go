...
func (c ServicePrincipalClient) GetMemberObjects(ctx context.Context, id beta.ServicePrincipalId, input GetMemberObjectsRequest, options GetMemberObjectsOperationOptions) (result GetMemberObjectsOperationResponse, err error) {
...
func (c ServicePrincipalClient) GetMemberObjectsComplete(ctx context.Context, id beta.ServicePrincipalId, input GetMemberObjectsRequest, options GetMemberObjectsOperationOptions) (result GetMemberObjectsCompleteResult, err error) {
	items := make([]string, 0)
