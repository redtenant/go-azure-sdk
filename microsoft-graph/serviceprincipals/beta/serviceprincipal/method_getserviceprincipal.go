...
func DefaultGetServicePrincipalOperationOptions() GetServicePrincipalOperationOptions {
	return GetServicePrincipalOperationOptions{}
}
...
func (c ServicePrincipalClient) GetServicePrincipal(ctx context.Context, id beta.ServicePrincipalId, options GetServicePrincipalOperationOptions) (result GetServicePrincipalOperationResponse, err error) {
