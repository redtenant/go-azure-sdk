...
func (c ServicePrincipalClient) Restore(ctx context.Context, id beta.ServicePrincipalId, input RestoreRequest, options RestoreOperationOptions) (result RestoreOperationResponse, err error) {
