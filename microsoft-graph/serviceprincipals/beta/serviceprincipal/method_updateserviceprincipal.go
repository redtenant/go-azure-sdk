...
func (c ServicePrincipalClient) UpdateServicePrincipal(ctx context.Context, id beta.ServicePrincipalId, input beta.ServicePrincipal, options UpdateServicePrincipalOperationOptions) (result UpdateServicePrincipalOperationResponse, err error) {
