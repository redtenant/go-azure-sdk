...
// GetSynchronization - Get synchronization from servicePrincipals. Represents the capability for Microsoft Entra
// identity synchronization through the Microsoft Graph API.
func (c SynchronizationClient) GetSynchronization(ctx context.Context, id beta.ServicePrincipalId, options GetSynchronizationOperationOptions) (result GetSynchronizationOperationResponse, err error) {
