...
func (c SynchronizationClient) SetSynchronization(ctx context.Context, id beta.ServicePrincipalId, input beta.Synchronization, options SetSynchronizationOperationOptions) (result SetSynchronizationOperationResponse, err error) {
