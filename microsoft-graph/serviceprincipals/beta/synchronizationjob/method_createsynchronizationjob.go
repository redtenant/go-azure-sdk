...
func (c SynchronizationJobClient) CreateSynchronizationJob(ctx context.Context, id beta.ServicePrincipalId, input beta.SynchronizationJob, options CreateSynchronizationJobOperationOptions) (result CreateSynchronizationJobOperationResponse, err error) {
