...
func (c SynchronizationJobClient) DeleteSynchronizationJob(ctx context.Context, id beta.ServicePrincipalIdSynchronizationJobId, options DeleteSynchronizationJobOperationOptions) (result DeleteSynchronizationJobOperationResponse, err error) {
