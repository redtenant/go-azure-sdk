...
func (c SynchronizationJobClient) GetSynchronizationJob(ctx context.Context, id beta.ServicePrincipalIdSynchronizationJobId, options GetSynchronizationJobOperationOptions) (result GetSynchronizationJobOperationResponse, err error) {
