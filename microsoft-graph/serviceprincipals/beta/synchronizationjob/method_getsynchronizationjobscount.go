...
func (c SynchronizationJobClient) GetSynchronizationJobsCount(ctx context.Context, id beta.ServicePrincipalId, options GetSynchronizationJobsCountOperationOptions) (result GetSynchronizationJobsCountOperationResponse, err error) {
