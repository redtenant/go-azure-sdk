...
// principal).
func (c SynchronizationJobClient) ListSynchronizationJobs(ctx context.Context, id beta.ServicePrincipalId, options ListSynchronizationJobsOperationOptions) (result ListSynchronizationJobsOperationResponse, err error) {
...
func (c SynchronizationJobClient) ListSynchronizationJobsComplete(ctx context.Context, id beta.ServicePrincipalId, options ListSynchronizationJobsOperationOptions) (ListSynchronizationJobsCompleteResult, error) {
...
func (c SynchronizationJobClient) ListSynchronizationJobsCompleteMatchingPredicate(ctx context.Context, id beta.ServicePrincipalId, options ListSynchronizationJobsOperationOptions, predicate SynchronizationJobOperationPredicate) (result ListSynchronizationJobsCompleteResult, err error) {
