...
func (c SynchronizationJobClient) RestartSynchronizationJob(ctx context.Context, id beta.ServicePrincipalIdSynchronizationJobId, input RestartSynchronizationJobRequest, options RestartSynchronizationJobOperationOptions) (result RestartSynchronizationJobOperationResponse, err error) {
