...
func (c SynchronizationJobClient) StartSynchronizationJob(ctx context.Context, id beta.ServicePrincipalIdSynchronizationJobId, options StartSynchronizationJobOperationOptions) (result StartSynchronizationJobOperationResponse, err error) {
