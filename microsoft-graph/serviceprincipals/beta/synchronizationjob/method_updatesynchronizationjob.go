...
func (c SynchronizationJobClient) UpdateSynchronizationJob(ctx context.Context, id beta.ServicePrincipalIdSynchronizationJobId, input beta.SynchronizationJob, options UpdateSynchronizationJobOperationOptions) (result UpdateSynchronizationJobOperationResponse, err error) {
