...
func (c SynchronizationJobBulkUploadClient) GetSynchronizationJobBulkUpload(ctx context.Context, id beta.ServicePrincipalIdSynchronizationJobId, options GetSynchronizationJobBulkUploadOperationOptions) (result GetSynchronizationJobBulkUploadOperationResponse, err error) {
