...
func (c SynchronizationJobBulkUploadClient) UpdateSynchronizationJobBulkUpload(ctx context.Context, id beta.ServicePrincipalIdSynchronizationJobId, input beta.BulkUpload, options UpdateSynchronizationJobBulkUploadOperationOptions) (result UpdateSynchronizationJobBulkUploadOperationResponse, err error) {
