...
func (c SynchronizationJobSchemaDirectoryClient) CreateSynchronizationJobSchemaDirectory(ctx context.Context, id beta.ServicePrincipalIdSynchronizationJobId, input beta.DirectoryDefinition, options CreateSynchronizationJobSchemaDirectoryOperationOptions) (result CreateSynchronizationJobSchemaDirectoryOperationResponse, err error) {
