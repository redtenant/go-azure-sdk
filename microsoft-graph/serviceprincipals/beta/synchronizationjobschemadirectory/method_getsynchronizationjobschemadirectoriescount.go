...
func (c SynchronizationJobSchemaDirectoryClient) GetSynchronizationJobSchemaDirectoriesCount(ctx context.Context, id beta.ServicePrincipalIdSynchronizationJobId, options GetSynchronizationJobSchemaDirectoriesCountOperationOptions) (result GetSynchronizationJobSchemaDirectoriesCountOperationResponse, err error) {
