...
func (c SynchronizationJobSchemaDirectoryClient) GetSynchronizationJobSchemaDirectory(ctx context.Context, id beta.ServicePrincipalIdSynchronizationJobIdSchemaDirectoryId, options GetSynchronizationJobSchemaDirectoryOperationOptions) (result GetSynchronizationJobSchemaDirectoryOperationResponse, err error) {
