...
func (c SynchronizationJobSchemaDirectoryClient) UpdateSynchronizationJobSchemaDirectory(ctx context.Context, id beta.ServicePrincipalIdSynchronizationJobIdSchemaDirectoryId, input beta.DirectoryDefinition, options UpdateSynchronizationJobSchemaDirectoryOperationOptions) (result UpdateSynchronizationJobSchemaDirectoryOperationResponse, err error) {
