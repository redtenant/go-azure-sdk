...
func (c SynchronizationSecretClient) GetSynchronizationSecretsCount(ctx context.Context, id beta.ServicePrincipalId, options GetSynchronizationSecretsCountOperationOptions) (result GetSynchronizationSecretsCountOperationResponse, err error) {
