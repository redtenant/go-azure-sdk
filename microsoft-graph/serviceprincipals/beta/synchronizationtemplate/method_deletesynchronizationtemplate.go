...
func (c SynchronizationTemplateClient) DeleteSynchronizationTemplate(ctx context.Context, id beta.ServicePrincipalIdSynchronizationTemplateId, options DeleteSynchronizationTemplateOperationOptions) (result DeleteSynchronizationTemplateOperationResponse, err error) {
