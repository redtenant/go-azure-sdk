...
func (c SynchronizationTemplateClient) GetSynchronizationTemplatesCount(ctx context.Context, id beta.ServicePrincipalId, options GetSynchronizationTemplatesCountOperationOptions) (result GetSynchronizationTemplatesCountOperationResponse, err error) {
