...
// ListSynchronizationTemplates - List existing synchronization templates. List the synchronization templates associated
// with a given application or service principal.
func (c SynchronizationTemplateClient) ListSynchronizationTemplates(ctx context.Context, id beta.ServicePrincipalId, options ListSynchronizationTemplatesOperationOptions) (result ListSynchronizationTemplatesOperationResponse, err error) {
...
func (c SynchronizationTemplateClient) ListSynchronizationTemplatesComplete(ctx context.Context, id beta.ServicePrincipalId, options ListSynchronizationTemplatesOperationOptions) (ListSynchronizationTemplatesCompleteResult, error) {
...
func (c SynchronizationTemplateClient) ListSynchronizationTemplatesCompleteMatchingPredicate(ctx context.Context, id beta.ServicePrincipalId, options ListSynchronizationTemplatesOperationOptions, predicate SynchronizationTemplateOperationPredicate) (result ListSynchronizationTemplatesCompleteResult, err error) {
