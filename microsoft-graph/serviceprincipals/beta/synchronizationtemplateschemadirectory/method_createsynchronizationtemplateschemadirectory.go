...
func (c SynchronizationTemplateSchemaDirectoryClient) CreateSynchronizationTemplateSchemaDirectory(ctx context.Context, id beta.ServicePrincipalIdSynchronizationTemplateId, input beta.DirectoryDefinition, options CreateSynchronizationTemplateSchemaDirectoryOperationOptions) (result CreateSynchronizationTemplateSchemaDirectoryOperationResponse, err error) {
