...
func (c SynchronizationTemplateSchemaDirectoryClient) DeleteSynchronizationTemplateSchemaDirectory(ctx context.Context, id beta.ServicePrincipalIdSynchronizationTemplateIdSchemaDirectoryId, options DeleteSynchronizationTemplateSchemaDirectoryOperationOptions) (result DeleteSynchronizationTemplateSchemaDirectoryOperationResponse, err error) {
