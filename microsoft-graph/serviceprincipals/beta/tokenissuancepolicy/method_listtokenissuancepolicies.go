...
// this service principal. Supports $expand.
func (c TokenIssuancePolicyClient) ListTokenIssuancePolicies(ctx context.Context, id beta.ServicePrincipalId, options ListTokenIssuancePoliciesOperationOptions) (result ListTokenIssuancePoliciesOperationResponse, err error) {
...
func (c TokenIssuancePolicyClient) ListTokenIssuancePoliciesComplete(ctx context.Context, id beta.ServicePrincipalId, options ListTokenIssuancePoliciesOperationOptions) (ListTokenIssuancePoliciesCompleteResult, error) {
...
func (c TokenIssuancePolicyClient) ListTokenIssuancePoliciesCompleteMatchingPredicate(ctx context.Context, id beta.ServicePrincipalId, options ListTokenIssuancePoliciesOperationOptions, predicate TokenIssuancePolicyOperationPredicate) (result ListTokenIssuancePoliciesCompleteResult, err error) {
