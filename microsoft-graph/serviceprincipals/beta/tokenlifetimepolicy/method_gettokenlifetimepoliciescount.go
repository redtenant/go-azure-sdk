...
func (c TokenLifetimePolicyClient) GetTokenLifetimePoliciesCount(ctx context.Context, id beta.ServicePrincipalId, options GetTokenLifetimePoliciesCountOperationOptions) (result GetTokenLifetimePoliciesCountOperationResponse, err error) {
