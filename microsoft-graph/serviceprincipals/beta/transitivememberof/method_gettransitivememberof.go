...
func (c TransitiveMemberOfClient) GetTransitiveMemberOf(ctx context.Context, id beta.ServicePrincipalIdTransitiveMemberOfId, options GetTransitiveMemberOfOperationOptions) (result GetTransitiveMemberOfOperationResponse, err error) {
