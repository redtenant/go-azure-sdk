...
func (c TransitiveMemberOfClient) GetTransitiveMemberOfCount(ctx context.Context, id beta.ServicePrincipalId, options GetTransitiveMemberOfCountOperationOptions) (result GetTransitiveMemberOfCountOperationResponse, err error) {
