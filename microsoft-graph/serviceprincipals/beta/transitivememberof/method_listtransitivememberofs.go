...
// ListTransitiveMemberOfs - List servicePrincipal transitive memberOf. Get the groups and directory roles that this
// servicePrincipal is a member of. This operation is transitive and will include all groups that this service principal
// is a nested member of.
func (c TransitiveMemberOfClient) ListTransitiveMemberOfs(ctx context.Context, id beta.ServicePrincipalId, options ListTransitiveMemberOfsOperationOptions) (result ListTransitiveMemberOfsOperationResponse, err error) {
...
func (c TransitiveMemberOfClient) ListTransitiveMemberOfsComplete(ctx context.Context, id beta.ServicePrincipalId, options ListTransitiveMemberOfsOperationOptions) (ListTransitiveMemberOfsCompleteResult, error) {
...
func (c TransitiveMemberOfClient) ListTransitiveMemberOfsCompleteMatchingPredicate(ctx context.Context, id beta.ServicePrincipalId, options ListTransitiveMemberOfsOperationOptions, predicate DirectoryObjectOperationPredicate) (result ListTransitiveMemberOfsCompleteResult, err error) {
