...
func (c ClaimsMappingPolicyClient) GetClaimsMappingPoliciesCount(ctx context.Context, id stable.ServicePrincipalId, options GetClaimsMappingPoliciesCountOperationOptions) (result GetClaimsMappingPoliciesCountOperationResponse, err error) {
	opts := client.RequestOptions{
		...
		Path:          fmt.Sprintf("%s/claimsMappingPolicies/$count", id.ID()),
