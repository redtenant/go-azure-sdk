...
func (c EndpointClient) DeleteEndpoint(ctx context.Context, id stable.ServicePrincipalIdEndpointId, options DeleteEndpointOperationOptions) (result DeleteEndpointOperationResponse, err error) {
