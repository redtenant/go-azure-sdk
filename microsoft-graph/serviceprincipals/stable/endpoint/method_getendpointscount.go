...
func (c EndpointClient) GetEndpointsCount(ctx context.Context, id stable.ServicePrincipalId, options GetEndpointsCountOperationOptions) (result GetEndpointsCountOperationResponse, err error) {
