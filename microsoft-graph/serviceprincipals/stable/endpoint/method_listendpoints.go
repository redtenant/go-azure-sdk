...
// ListEndpoints - Get endpoints from servicePrincipals
func (c EndpointClient) ListEndpoints(ctx context.Context, id stable.ServicePrincipalId, options ListEndpointsOperationOptions) (result ListEndpointsOperationResponse, err error) {
...
func (c EndpointClient) ListEndpointsComplete(ctx context.Context, id stable.ServicePrincipalId, options ListEndpointsOperationOptions) (ListEndpointsCompleteResult, error) {
...
func (c EndpointClient) ListEndpointsCompleteMatchingPredicate(ctx context.Context, id stable.ServicePrincipalId, options ListEndpointsOperationOptions, predicate EndpointOperationPredicate) (result ListEndpointsCompleteResult, err error) {
