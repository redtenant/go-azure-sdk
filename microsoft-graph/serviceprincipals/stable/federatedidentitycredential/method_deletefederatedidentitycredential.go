...
// DeleteFederatedIdentityCredential - Delete navigation property federatedIdentityCredentials for servicePrincipals
func (c FederatedIdentityCredentialClient) DeleteFederatedIdentityCredential(ctx context.Context, id stable.ServicePrincipalIdFederatedIdentityCredentialId, options DeleteFederatedIdentityCredentialOperationOptions) (result DeleteFederatedIdentityCredentialOperationResponse, err error) {
