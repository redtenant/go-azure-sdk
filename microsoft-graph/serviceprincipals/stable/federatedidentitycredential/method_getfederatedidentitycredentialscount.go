...
func (c FederatedIdentityCredentialClient) GetFederatedIdentityCredentialsCount(ctx context.Context, id stable.ServicePrincipalId, options GetFederatedIdentityCredentialsCountOperationOptions) (result GetFederatedIdentityCredentialsCountOperationResponse, err error) {
