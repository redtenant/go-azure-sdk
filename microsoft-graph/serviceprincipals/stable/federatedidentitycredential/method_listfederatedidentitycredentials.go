...
// ListFederatedIdentityCredentials - Get federatedIdentityCredentials from servicePrincipals. Federated identities for
// a specific type of service principal - managed identity. Supports $expand and $filter (/$count eq 0, /$count ne 0).
func (c FederatedIdentityCredentialClient) ListFederatedIdentityCredentials(ctx context.Context, id stable.ServicePrincipalId, options ListFederatedIdentityCredentialsOperationOptions) (result ListFederatedIdentityCredentialsOperationResponse, err error) {
...
func (c FederatedIdentityCredentialClient) ListFederatedIdentityCredentialsComplete(ctx context.Context, id stable.ServicePrincipalId, options ListFederatedIdentityCredentialsOperationOptions) (ListFederatedIdentityCredentialsCompleteResult, error) {
...
func (c FederatedIdentityCredentialClient) ListFederatedIdentityCredentialsCompleteMatchingPredicate(ctx context.Context, id stable.ServicePrincipalId, options ListFederatedIdentityCredentialsOperationOptions, predicate FederatedIdentityCredentialOperationPredicate) (result ListFederatedIdentityCredentialsCompleteResult, err error) {
