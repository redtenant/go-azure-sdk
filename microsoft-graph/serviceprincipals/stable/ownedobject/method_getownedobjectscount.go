...
func DefaultGetOwnedObjectsCountOperationOptions() GetOwnedObjectsCountOperationOptions {
	return GetOwnedObjectsCountOperationOptions{}
}
...
func (c OwnedObjectClient) GetOwnedObjectsCount(ctx context.Context, id stable.ServicePrincipalId, options GetOwnedObjectsCountOperationOptions) (result GetOwnedObjectsCountOperationResponse, err error) {
	opts := client.RequestOptions{
		...
		Path:          fmt.Sprintf("%s/ownedObjects/$count", id.ID()),
