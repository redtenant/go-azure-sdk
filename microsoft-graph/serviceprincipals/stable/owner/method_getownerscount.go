...
func DefaultGetOwnersCountOperationOptions() GetOwnersCountOperationOptions {
	return GetOwnersCountOperationOptions{}
}
...
func (c OwnerClient) GetOwnersCount(ctx context.Context, id stable.ServicePrincipalId, options GetOwnersCountOperationOptions) (result GetOwnersCountOperationResponse, err error) {
