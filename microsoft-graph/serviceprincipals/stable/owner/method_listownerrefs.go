...
func (c OwnerClient) ListOwnerRefsComplete(ctx context.Context, id stable.ServicePrincipalId, options ListOwnerRefsOperationOptions) (ListOwnerRefsCompleteResult, error) {
...
func (c OwnerClient) ListOwnerRefsCompleteMatchingPredicate(ctx context.Context, id stable.ServicePrincipalId, options ListOwnerRefsOperationOptions, predicate DirectoryObjectOperationPredicate) (result ListOwnerRefsCompleteResult, err error) {
