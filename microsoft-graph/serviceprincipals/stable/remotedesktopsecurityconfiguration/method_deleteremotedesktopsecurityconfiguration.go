...
func (c RemoteDesktopSecurityConfigurationClient) DeleteRemoteDesktopSecurityConfiguration(ctx context.Context, id stable.ServicePrincipalId, options DeleteRemoteDesktopSecurityConfigurationOperationOptions) (result DeleteRemoteDesktopSecurityConfigurationOperationResponse, err error) {
