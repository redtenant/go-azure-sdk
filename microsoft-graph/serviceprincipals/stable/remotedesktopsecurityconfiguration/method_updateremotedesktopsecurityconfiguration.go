...
func (c RemoteDesktopSecurityConfigurationClient) UpdateRemoteDesktopSecurityConfiguration(ctx context.Context, id stable.ServicePrincipalId, input stable.RemoteDesktopSecurityConfiguration, options UpdateRemoteDesktopSecurityConfigurationOperationOptions) (result UpdateRemoteDesktopSecurityConfigurationOperationResponse, err error) {
