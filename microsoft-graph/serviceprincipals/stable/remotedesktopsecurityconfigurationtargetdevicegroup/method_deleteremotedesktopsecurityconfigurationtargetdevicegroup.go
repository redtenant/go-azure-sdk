...
func (c RemoteDesktopSecurityConfigurationTargetDeviceGroupClient) DeleteRemoteDesktopSecurityConfigurationTargetDeviceGroup(ctx context.Context, id stable.ServicePrincipalIdRemoteDesktopSecurityConfigurationTargetDeviceGroupId, options DeleteRemoteDesktopSecurityConfigurationTargetDeviceGroupOperationOptions) (result DeleteRemoteDesktopSecurityConfigurationTargetDeviceGroupOperationResponse, err error) {
