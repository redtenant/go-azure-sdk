...
func DefaultGetRemoteDesktopSecurityConfigurationTargetDeviceGroupsCountOperationOptions() GetRemoteDesktopSecurityConfigurationTargetDeviceGroupsCountOperationOptions {
	return GetRemoteDesktopSecurityConfigurationTargetDeviceGroupsCountOperationOptions{}
}
...
func (c RemoteDesktopSecurityConfigurationTargetDeviceGroupClient) GetRemoteDesktopSecurityConfigurationTargetDeviceGroupsCount(ctx context.Context, id stable.ServicePrincipalId, options GetRemoteDesktopSecurityConfigurationTargetDeviceGroupsCountOperationOptions) (result GetRemoteDesktopSecurityConfigurationTargetDeviceGroupsCountOperationResponse, err error) {
