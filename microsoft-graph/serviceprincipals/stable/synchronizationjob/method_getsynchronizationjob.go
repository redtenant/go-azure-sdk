...
func (c SynchronizationJobClient) GetSynchronizationJob(ctx context.Context, id stable.ServicePrincipalIdSynchronizationJobId, options GetSynchronizationJobOperationOptions) (result GetSynchronizationJobOperationResponse, err error) {
