...
func (c SynchronizationJobBulkUploadClient) DeleteSynchronizationJobBulkUpload(ctx context.Context, id stable.ServicePrincipalIdSynchronizationJobId, options DeleteSynchronizationJobBulkUploadOperationOptions) (result DeleteSynchronizationJobBulkUploadOperationResponse, err error) {
