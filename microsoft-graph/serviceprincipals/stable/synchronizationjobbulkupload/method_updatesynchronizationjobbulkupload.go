...
// UpdateSynchronizationJobBulkUpload - Update the navigation property bulkUpload in servicePrincipals
func (c SynchronizationJobBulkUploadClient) UpdateSynchronizationJobBulkUpload(ctx context.Context, id stable.ServicePrincipalIdSynchronizationJobId, input stable.BulkUpload, options UpdateSynchronizationJobBulkUploadOperationOptions) (result UpdateSynchronizationJobBulkUploadOperationResponse, err error) {
