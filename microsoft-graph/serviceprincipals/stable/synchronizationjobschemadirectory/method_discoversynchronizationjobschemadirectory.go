...
func (c SynchronizationJobSchemaDirectoryClient) DiscoverSynchronizationJobSchemaDirectory(ctx context.Context, id stable.ServicePrincipalIdSynchronizationJobIdSchemaDirectoryId, options DiscoverSynchronizationJobSchemaDirectoryOperationOptions) (result DiscoverSynchronizationJobSchemaDirectoryOperationResponse, err error) {
