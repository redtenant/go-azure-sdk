...
// GetSynchronizationJobSchemaDirectory - Get directories from servicePrincipals. Contains the collection of directories
// and all of their objects.
func (c SynchronizationJobSchemaDirectoryClient) GetSynchronizationJobSchemaDirectory(ctx context.Context, id stable.ServicePrincipalIdSynchronizationJobIdSchemaDirectoryId, options GetSynchronizationJobSchemaDirectoryOperationOptions) (result GetSynchronizationJobSchemaDirectoryOperationResponse, err error) {
