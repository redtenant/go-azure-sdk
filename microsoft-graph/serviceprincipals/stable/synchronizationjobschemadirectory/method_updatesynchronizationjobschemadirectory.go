...
// UpdateSynchronizationJobSchemaDirectory - Update the navigation property directories in servicePrincipals
func (c SynchronizationJobSchemaDirectoryClient) UpdateSynchronizationJobSchemaDirectory(ctx context.Context, id stable.ServicePrincipalIdSynchronizationJobIdSchemaDirectoryId, input stable.DirectoryDefinition, options UpdateSynchronizationJobSchemaDirectoryOperationOptions) (result UpdateSynchronizationJobSchemaDirectoryOperationResponse, err error) {
