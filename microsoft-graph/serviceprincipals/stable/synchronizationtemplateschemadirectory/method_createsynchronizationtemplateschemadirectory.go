...
// CreateSynchronizationTemplateSchemaDirectory - Create new navigation property to directories for servicePrincipals
func (c SynchronizationTemplateSchemaDirectoryClient) CreateSynchronizationTemplateSchemaDirectory(ctx context.Context, id stable.ServicePrincipalIdSynchronizationTemplateId, input stable.DirectoryDefinition, options CreateSynchronizationTemplateSchemaDirectoryOperationOptions) (result CreateSynchronizationTemplateSchemaDirectoryOperationResponse, err error) {
