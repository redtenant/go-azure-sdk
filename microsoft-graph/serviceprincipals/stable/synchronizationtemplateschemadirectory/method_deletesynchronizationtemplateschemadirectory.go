...
// DeleteSynchronizationTemplateSchemaDirectory - Delete navigation property directories for servicePrincipals
func (c SynchronizationTemplateSchemaDirectoryClient) DeleteSynchronizationTemplateSchemaDirectory(ctx context.Context, id stable.ServicePrincipalIdSynchronizationTemplateIdSchemaDirectoryId, options DeleteSynchronizationTemplateSchemaDirectoryOperationOptions) (result DeleteSynchronizationTemplateSchemaDirectoryOperationResponse, err error) {
