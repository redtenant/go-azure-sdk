...
func DefaultGetTokenLifetimePoliciesCountOperationOptions() GetTokenLifetimePoliciesCountOperationOptions {
	return GetTokenLifetimePoliciesCountOperationOptions{}
}
...
func (c TokenLifetimePolicyClient) GetTokenLifetimePoliciesCount(ctx context.Context, id stable.ServicePrincipalId, options GetTokenLifetimePoliciesCountOperationOptions) (result GetTokenLifetimePoliciesCountOperationResponse, err error) {
	opts := client.RequestOptions{
		...
		Path:          fmt.Sprintf("%s/tokenLifetimePolicies/$count", id.ID()),
