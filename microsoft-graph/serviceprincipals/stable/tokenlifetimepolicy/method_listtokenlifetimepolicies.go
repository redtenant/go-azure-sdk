...
// ListTokenLifetimePolicies - List assigned tokenLifetimePolicies. List the tokenLifetimePolicy objects that are
// assigned to a servicePrincipal. Only one object is returned in the collection because only one tokenLifetimePolicy
// can be assigned to a service principal.
func (c TokenLifetimePolicyClient) ListTokenLifetimePolicies(ctx context.Context, id stable.ServicePrincipalId, options ListTokenLifetimePoliciesOperationOptions) (result ListTokenLifetimePoliciesOperationResponse, err error) {
...
func (c TokenLifetimePolicyClient) ListTokenLifetimePoliciesComplete(ctx context.Context, id stable.ServicePrincipalId, options ListTokenLifetimePoliciesOperationOptions) (ListTokenLifetimePoliciesCompleteResult, error) {
...
func (c TokenLifetimePolicyClient) ListTokenLifetimePoliciesCompleteMatchingPredicate(ctx context.Context, id stable.ServicePrincipalId, options ListTokenLifetimePoliciesOperationOptions, predicate TokenLifetimePolicyOperationPredicate) (result ListTokenLifetimePoliciesCompleteResult, err error) {
