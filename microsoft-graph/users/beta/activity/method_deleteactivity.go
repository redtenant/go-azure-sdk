...
func (c ActivityClient) DeleteActivity(ctx context.Context, id beta.UserIdActivityId, options DeleteActivityOperationOptions) (result DeleteActivityOperationResponse, err error) {
