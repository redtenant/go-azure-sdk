...
func (c ActivityClient) GetActivity(ctx context.Context, id beta.UserIdActivityId, options GetActivityOperationOptions) (result GetActivityOperationResponse, err error) {
