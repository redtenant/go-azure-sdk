...
func (c ActivityClient) ListActivities(ctx context.Context, id beta.UserId, options ListActivitiesOperationOptions) (result ListActivitiesOperationResponse, err error) {
...
func (c ActivityClient) ListActivitiesComplete(ctx context.Context, id beta.UserId, options ListActivitiesOperationOptions) (ListActivitiesCompleteResult, error) {
...
func (c ActivityClient) ListActivitiesCompleteMatchingPredicate(ctx context.Context, id beta.UserId, options ListActivitiesOperationOptions, predicate UserActivityOperationPredicate) (result ListActivitiesCompleteResult, err error) {
