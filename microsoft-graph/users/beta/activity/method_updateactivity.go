...
func (c ActivityClient) UpdateActivity(ctx context.Context, id beta.UserIdActivityId, input beta.UserActivity, options UpdateActivityOperationOptions) (result UpdateActivityOperationResponse, err error) {
