...
func (c ActivityHistoryItemClient) CreateActivityHistoryItem(ctx context.Context, id beta.UserIdActivityId, input beta.ActivityHistoryItem, options CreateActivityHistoryItemOperationOptions) (result CreateActivityHistoryItemOperationResponse, err error) {
