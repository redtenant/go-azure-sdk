...
func (c ActivityHistoryItemClient) UpdateActivityHistoryItem(ctx context.Context, id beta.UserIdActivityIdHistoryItemId, input beta.ActivityHistoryItem, options UpdateActivityHistoryItemOperationOptions) (result UpdateActivityHistoryItemOperationResponse, err error) {
