...
func (c ActivityHistoryItemActivityClient) GetActivityHistoryItemActivity(ctx context.Context, id beta.UserIdActivityIdHistoryItemId, options GetActivityHistoryItemActivityOperationOptions) (result GetActivityHistoryItemActivityOperationResponse, err error) {
