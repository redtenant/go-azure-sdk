...
// GetAnalytics - Get analytics from users
func (c AnalyticsClient) GetAnalytics(ctx context.Context, id beta.UserId, options GetAnalyticsOperationOptions) (result GetAnalyticsOperationResponse, err error) {
