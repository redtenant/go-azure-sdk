...
// DeleteAnalyticsActivityStatistic - Delete navigation property activityStatistics for users
func (c AnalyticsActivityStatisticClient) DeleteAnalyticsActivityStatistic(ctx context.Context, id beta.UserIdAnalyticsActivityStatisticId, options DeleteAnalyticsActivityStatisticOperationOptions) (result DeleteAnalyticsActivityStatisticOperationResponse, err error) {
