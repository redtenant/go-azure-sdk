...
// UpdateAnalyticsActivityStatistic - Update the navigation property activityStatistics in users
func (c AnalyticsActivityStatisticClient) UpdateAnalyticsActivityStatistic(ctx context.Context, id beta.UserIdAnalyticsActivityStatisticId, input beta.ActivityStatistics, options UpdateAnalyticsActivityStatisticOperationOptions) (result UpdateAnalyticsActivityStatisticOperationResponse, err error) {
