...
// GetAppConsentRequestsForApproval - Get appConsentRequestsForApproval from users
func (c AppConsentRequestsForApprovalClient) GetAppConsentRequestsForApproval(ctx context.Context, id beta.UserIdAppConsentRequestsForApprovalId, options GetAppConsentRequestsForApprovalOperationOptions) (result GetAppConsentRequestsForApprovalOperationResponse, err error) {
