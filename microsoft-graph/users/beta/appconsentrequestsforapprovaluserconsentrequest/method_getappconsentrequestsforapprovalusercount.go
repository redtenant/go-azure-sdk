...
func (c AppConsentRequestsForApprovalUserConsentRequestClient) GetAppConsentRequestsForApprovalUserCount(ctx context.Context, id beta.UserIdAppConsentRequestsForApprovalId, options GetAppConsentRequestsForApprovalUserCountOperationOptions) (result GetAppConsentRequestsForApprovalUserCountOperationResponse, err error) {
