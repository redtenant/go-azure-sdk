...
// ListAppConsentRequestsForApprovalUserConsentRequests - Get userConsentRequests from users. A list of pending user
// consent requests. Supports $filter (eq).
func (c AppConsentRequestsForApprovalUserConsentRequestClient) ListAppConsentRequestsForApprovalUserConsentRequests(ctx context.Context, id beta.UserIdAppConsentRequestsForApprovalId, options ListAppConsentRequestsForApprovalUserConsentRequestsOperationOptions) (result ListAppConsentRequestsForApprovalUserConsentRequestsOperationResponse, err error) {
...
func (c AppConsentRequestsForApprovalUserConsentRequestClient) ListAppConsentRequestsForApprovalUserConsentRequestsCompleteMatchingPredicate(ctx context.Context, id beta.UserIdAppConsentRequestsForApprovalId, options ListAppConsentRequestsForApprovalUserConsentRequestsOperationOptions, predicate UserConsentRequestOperationPredicate) (result ListAppConsentRequestsForApprovalUserConsentRequestsCompleteResult, err error) {
