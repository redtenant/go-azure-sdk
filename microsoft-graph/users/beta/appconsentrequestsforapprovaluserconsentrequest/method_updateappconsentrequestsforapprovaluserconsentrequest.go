...
// UpdateAppConsentRequestsForApprovalUserConsentRequest - Update the navigation property userConsentRequests in users
func (c AppConsentRequestsForApprovalUserConsentRequestClient) UpdateAppConsentRequestsForApprovalUserConsentRequest(ctx context.Context, id beta.UserIdAppConsentRequestsForApprovalIdUserConsentRequestId, input beta.UserConsentRequest, options UpdateAppConsentRequestsForApprovalUserConsentRequestOperationOptions) (result UpdateAppConsentRequestsForApprovalUserConsentRequestOperationResponse, err error) {
