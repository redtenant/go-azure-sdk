...
// DeleteAppConsentRequestsForApprovalUserApprovalStep - Delete navigation property steps for users
func (c AppConsentRequestsForApprovalUserConsentRequestApprovalStepClient) DeleteAppConsentRequestsForApprovalUserApprovalStep(ctx context.Context, id beta.UserIdAppConsentRequestsForApprovalIdUserConsentRequestIdApprovalStepId, options DeleteAppConsentRequestsForApprovalUserApprovalStepOperationOptions) (result DeleteAppConsentRequestsForApprovalUserApprovalStepOperationResponse, err error) {
