...
// ListAppRoleAssignments - List appRoleAssignments granted to a user. Retrieve the list of appRoleAssignments that a
// user has been granted. This operation also returns app role assignments granted to groups that the user is a direct
// member of.
