...
type UpdateApprovalStepOperationResponse struct {
...
// UpdateApprovalStep - Update the navigation property steps in users
func (c ApprovalStepClient) UpdateApprovalStep(ctx context.Context, id beta.UserIdApprovalIdStepId, input beta.ApprovalStep, options UpdateApprovalStepOperationOptions) (result UpdateApprovalStepOperationResponse, err error) {
