...
func (c AuthenticationClient) DeleteAuthentication(ctx context.Context, id beta.UserId, options DeleteAuthenticationOperationOptions) (result DeleteAuthenticationOperationResponse, err error) {
