...
func (c AuthenticationClient) GetAuthentication(ctx context.Context, id beta.UserId, options GetAuthenticationOperationOptions) (result GetAuthenticationOperationResponse, err error) {
