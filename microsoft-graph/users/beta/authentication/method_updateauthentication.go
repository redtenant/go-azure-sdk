...
func (c AuthenticationClient) UpdateAuthentication(ctx context.Context, id beta.UserId, input beta.Authentication, options UpdateAuthenticationOperationOptions) (result UpdateAuthenticationOperationResponse, err error) {
