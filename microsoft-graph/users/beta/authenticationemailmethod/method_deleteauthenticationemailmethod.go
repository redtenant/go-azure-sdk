...
func DefaultDeleteAuthenticationEmailMethodOperationOptions() DeleteAuthenticationEmailMethodOperationOptions {
	return DeleteAuthenticationEmailMethodOperationOptions{}
}
...
// DeleteAuthenticationEmailMethod - Delete emailAuthenticationMethod. Deletes a user's email Authentication Method
// object.
func (c AuthenticationEmailMethodClient) DeleteAuthenticationEmailMethod(ctx context.Context, id beta.UserIdAuthenticationEmailMethodId, options DeleteAuthenticationEmailMethodOperationOptions) (result DeleteAuthenticationEmailMethodOperationResponse, err error) {
