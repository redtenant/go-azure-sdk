...
func DefaultGetAuthenticationEmailMethodsCountOperationOptions() GetAuthenticationEmailMethodsCountOperationOptions {
	return GetAuthenticationEmailMethodsCountOperationOptions{}
}
...
func (c AuthenticationEmailMethodClient) GetAuthenticationEmailMethodsCount(ctx context.Context, id beta.UserId, options GetAuthenticationEmailMethodsCountOperationOptions) (result GetAuthenticationEmailMethodsCountOperationResponse, err error) {
	opts := client.RequestOptions{
		...
		Path:          fmt.Sprintf("%s/authentication/emailMethods/$count", id.ID()),
