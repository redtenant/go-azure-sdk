...
func DefaultListAuthenticationEmailMethodsOperationOptions() ListAuthenticationEmailMethodsOperationOptions {
	return ListAuthenticationEmailMethodsOperationOptions{}
}
...
// ListAuthenticationEmailMethods - Get emailMethods from users. Represents the email addresses registered to a user for
// authentication.
func (c AuthenticationEmailMethodClient) ListAuthenticationEmailMethods(ctx context.Context, id beta.UserId, options ListAuthenticationEmailMethodsOperationOptions) (result ListAuthenticationEmailMethodsOperationResponse, err error) {
...
func (c AuthenticationEmailMethodClient) ListAuthenticationEmailMethodsComplete(ctx context.Context, id beta.UserId, options ListAuthenticationEmailMethodsOperationOptions) (ListAuthenticationEmailMethodsCompleteResult, error) {
	return c.ListAuthenticationEmailMethodsCompleteMatchingPredicate(ctx, id, options, EmailAuthenticationMethodOperationPredicate{})
}

// ListAuthenticationEmailMethodsCompleteMatchingPredicate retrieves all the results and then applies the predicate
func (c AuthenticationEmailMethodClient) ListAuthenticationEmailMethodsCompleteMatchingPredicate(ctx context.Context, id beta.UserId, options ListAuthenticationEmailMethodsOperationOptions, predicate EmailAuthenticationMethodOperationPredicate) (result ListAuthenticationEmailMethodsCompleteResult, err error) {
	items := make([]beta.EmailAuthenticationMethod, 0)

	resp, err := c.ListAuthenticationEmailMethods(ctx, id, options)
	if err != nil {
