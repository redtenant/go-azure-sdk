...
// for authentication.
func (c AuthenticationFido2MethodClient) GetAuthenticationFido2Method(ctx context.Context, id beta.UserIdAuthenticationFido2MethodId, options GetAuthenticationFido2MethodOperationOptions) (result GetAuthenticationFido2MethodOperationResponse, err error) {
