...
func (c AuthenticationMicrosoftAuthenticatorMethodClient) GetAuthenticationMicrosoftAuthenticatorMethod(ctx context.Context, id beta.UserIdAuthenticationMicrosoftAuthenticatorMethodId, options GetAuthenticationMicrosoftAuthenticatorMethodOperationOptions) (result GetAuthenticationMicrosoftAuthenticatorMethodOperationResponse, err error) {
