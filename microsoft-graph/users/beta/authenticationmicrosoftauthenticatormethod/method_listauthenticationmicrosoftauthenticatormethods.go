...
func (c AuthenticationMicrosoftAuthenticatorMethodClient) ListAuthenticationMicrosoftAuthenticatorMethods(ctx context.Context, id beta.UserId, options ListAuthenticationMicrosoftAuthenticatorMethodsOperationOptions) (result ListAuthenticationMicrosoftAuthenticatorMethodsOperationResponse, err error) {
...
func (c AuthenticationMicrosoftAuthenticatorMethodClient) ListAuthenticationMicrosoftAuthenticatorMethodsComplete(ctx context.Context, id beta.UserId, options ListAuthenticationMicrosoftAuthenticatorMethodsOperationOptions) (ListAuthenticationMicrosoftAuthenticatorMethodsCompleteResult, error) {
...
func (c AuthenticationMicrosoftAuthenticatorMethodClient) ListAuthenticationMicrosoftAuthenticatorMethodsCompleteMatchingPredicate(ctx context.Context, id beta.UserId, options ListAuthenticationMicrosoftAuthenticatorMethodsOperationOptions, predicate MicrosoftAuthenticatorAuthenticationMethodOperationPredicate) (result ListAuthenticationMicrosoftAuthenticatorMethodsCompleteResult, err error) {
