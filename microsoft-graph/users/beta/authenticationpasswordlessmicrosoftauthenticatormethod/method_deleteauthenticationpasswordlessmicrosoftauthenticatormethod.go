...
func DefaultDeleteAuthenticationPasswordlessMicrosoftAuthenticatorMethodOperationOptions() DeleteAuthenticationPasswordlessMicrosoftAuthenticatorMethodOperationOptions {
	return DeleteAuthenticationPasswordlessMicrosoftAuthenticatorMethodOperationOptions{}
}
...
// DeleteAuthenticationPasswordlessMicrosoftAuthenticatorMethod - Delete
// passwordlessMicrosoftAuthenticatorAuthenticationMethod (deprecated). Deletes a user's Microsoft Authenticator
// Passwordless Phone Sign-in method object.
func (c AuthenticationPasswordlessMicrosoftAuthenticatorMethodClient) DeleteAuthenticationPasswordlessMicrosoftAuthenticatorMethod(ctx context.Context, id beta.UserIdAuthenticationPasswordlessMicrosoftAuthenticatorMethodId, options DeleteAuthenticationPasswordlessMicrosoftAuthenticatorMethodOperationOptions) (result DeleteAuthenticationPasswordlessMicrosoftAuthenticatorMethodOperationResponse, err error) {
