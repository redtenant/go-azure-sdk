...
type GetAuthenticationPasswordlessMicrosoftAuthenticatorMethodOperationResponse struct {
	HttpResponse *http.Response
	OData        *odata.OData
	Model        *beta.PasswordlessMicrosoftAuthenticatorAuthenticationMethod
}

type GetAuthenticationPasswordlessMicrosoftAuthenticatorMethodOperationOptions struct {
	Expand    *odata.Expand
...
func DefaultGetAuthenticationPasswordlessMicrosoftAuthenticatorMethodOperationOptions() GetAuthenticationPasswordlessMicrosoftAuthenticatorMethodOperationOptions {
	return GetAuthenticationPasswordlessMicrosoftAuthenticatorMethodOperationOptions{}
}
...
// GetAuthenticationPasswordlessMicrosoftAuthenticatorMethod - Get passwordlessMicrosoftAuthenticatorMethods from users.
// Represents the Microsoft Authenticator Passwordless Phone Sign-in methods registered to a user for authentication.
func (c AuthenticationPasswordlessMicrosoftAuthenticatorMethodClient) GetAuthenticationPasswordlessMicrosoftAuthenticatorMethod(ctx context.Context, id beta.UserIdAuthenticationPasswordlessMicrosoftAuthenticatorMethodId, options GetAuthenticationPasswordlessMicrosoftAuthenticatorMethodOperationOptions) (result GetAuthenticationPasswordlessMicrosoftAuthenticatorMethodOperationResponse, err error) {
	...
	var model beta.PasswordlessMicrosoftAuthenticatorAuthenticationMethod
	result.Model = &model
