...
type GetAuthenticationPasswordlessMicrosoftAuthenticatorMethodsCountOperationResponse struct {
	HttpResponse *http.Response
	OData        *odata.OData
	Model        *[]byte
}

type GetAuthenticationPasswordlessMicrosoftAuthenticatorMethodsCountOperationOptions struct {
	Filter    *string
...
func DefaultGetAuthenticationPasswordlessMicrosoftAuthenticatorMethodsCountOperationOptions() GetAuthenticationPasswordlessMicrosoftAuthenticatorMethodsCountOperationOptions {
	return GetAuthenticationPasswordlessMicrosoftAuthenticatorMethodsCountOperationOptions{}
}
...
func (c AuthenticationPasswordlessMicrosoftAuthenticatorMethodClient) GetAuthenticationPasswordlessMicrosoftAuthenticatorMethodsCount(ctx context.Context, id beta.UserId, options GetAuthenticationPasswordlessMicrosoftAuthenticatorMethodsCountOperationOptions) (result GetAuthenticationPasswordlessMicrosoftAuthenticatorMethodsCountOperationResponse, err error) {
	opts := client.RequestOptions{
		...
		Path:          fmt.Sprintf("%s/authentication/passwordlessMicrosoftAuthenticatorMethods/$count", id.ID()),
