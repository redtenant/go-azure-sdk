...
// GetAuthenticationPasswordlessMicrosoftAuthenticatorMethodDevice - Get device from users
func (c AuthenticationPasswordlessMicrosoftAuthenticatorMethodDeviceClient) GetAuthenticationPasswordlessMicrosoftAuthenticatorMethodDevice(ctx context.Context, id beta.UserIdAuthenticationPasswordlessMicrosoftAuthenticatorMethodId, options GetAuthenticationPasswordlessMicrosoftAuthenticatorMethodDeviceOperationOptions) (result GetAuthenticationPasswordlessMicrosoftAuthenticatorMethodDeviceOperationResponse, err error) {
