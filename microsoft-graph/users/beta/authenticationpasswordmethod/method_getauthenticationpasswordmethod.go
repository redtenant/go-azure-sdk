...
// GetAuthenticationPasswordMethod - Get passwordMethods from users. Represents the details of the password
// authentication method registered to a user for authentication.
func (c AuthenticationPasswordMethodClient) GetAuthenticationPasswordMethod(ctx context.Context, id beta.UserIdAuthenticationPasswordMethodId, options GetAuthenticationPasswordMethodOperationOptions) (result GetAuthenticationPasswordMethodOperationResponse, err error) {
	...
	var model beta.PasswordAuthenticationMethod
	result.Model = &model
