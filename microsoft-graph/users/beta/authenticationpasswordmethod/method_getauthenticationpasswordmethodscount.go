...
func DefaultGetAuthenticationPasswordMethodsCountOperationOptions() GetAuthenticationPasswordMethodsCountOperationOptions {
	return GetAuthenticationPasswordMethodsCountOperationOptions{}
}
...
func (c AuthenticationPasswordMethodClient) GetAuthenticationPasswordMethodsCount(ctx context.Context, id beta.UserId, options GetAuthenticationPasswordMethodsCountOperationOptions) (result GetAuthenticationPasswordMethodsCountOperationResponse, err error) {
	opts := client.RequestOptions{
		...
		Path:          fmt.Sprintf("%s/authentication/passwordMethods/$count", id.ID()),
