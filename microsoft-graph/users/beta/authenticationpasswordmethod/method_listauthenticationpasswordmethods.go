...
// ListAuthenticationPasswordMethods - Get passwordMethods from users. Represents the details of the password
// authentication method registered to a user for authentication.
func (c AuthenticationPasswordMethodClient) ListAuthenticationPasswordMethods(ctx context.Context, id beta.UserId, options ListAuthenticationPasswordMethodsOperationOptions) (result ListAuthenticationPasswordMethodsOperationResponse, err error) {
...
func (c AuthenticationPasswordMethodClient) ListAuthenticationPasswordMethodsComplete(ctx context.Context, id beta.UserId, options ListAuthenticationPasswordMethodsOperationOptions) (ListAuthenticationPasswordMethodsCompleteResult, error) {
	return c.ListAuthenticationPasswordMethodsCompleteMatchingPredicate(ctx, id, options, PasswordAuthenticationMethodOperationPredicate{})
}

// ListAuthenticationPasswordMethodsCompleteMatchingPredicate retrieves all the results and then applies the predicate
func (c AuthenticationPasswordMethodClient) ListAuthenticationPasswordMethodsCompleteMatchingPredicate(ctx context.Context, id beta.UserId, options ListAuthenticationPasswordMethodsOperationOptions, predicate PasswordAuthenticationMethodOperationPredicate) (result ListAuthenticationPasswordMethodsCompleteResult, err error) {
	items := make([]beta.PasswordAuthenticationMethod, 0)

	resp, err := c.ListAuthenticationPasswordMethods(ctx, id, options)
	if err != nil {
