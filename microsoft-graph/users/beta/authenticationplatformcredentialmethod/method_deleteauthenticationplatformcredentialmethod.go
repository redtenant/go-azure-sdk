...
type DeleteAuthenticationPlatformCredentialMethodOperationResponse struct {
	HttpResponse *http.Response
	OData        *odata.OData
}

type DeleteAuthenticationPlatformCredentialMethodOperationOptions struct {
	IfMatch   *string
...
func DefaultDeleteAuthenticationPlatformCredentialMethodOperationOptions() DeleteAuthenticationPlatformCredentialMethodOperationOptions {
	return DeleteAuthenticationPlatformCredentialMethodOperationOptions{}
}
...
// DeleteAuthenticationPlatformCredentialMethod - Delete platformCredentialAuthenticationMethod. Delete a
