...
func (c AuthenticationPlatformCredentialMethodClient) GetAuthenticationPlatformCredentialMethodsCount(ctx context.Context, id beta.UserId, options GetAuthenticationPlatformCredentialMethodsCountOperationOptions) (result GetAuthenticationPlatformCredentialMethodsCountOperationResponse, err error) {
