...
func (c AuthenticationSoftwareOathMethodClient) DeleteAuthenticationSoftwareOathMethod(ctx context.Context, id beta.UserIdAuthenticationSoftwareOathMethodId, options DeleteAuthenticationSoftwareOathMethodOperationOptions) (result DeleteAuthenticationSoftwareOathMethodOperationResponse, err error) {
