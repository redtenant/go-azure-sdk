...
func DefaultGetAuthenticationSoftwareOathMethodsCountOperationOptions() GetAuthenticationSoftwareOathMethodsCountOperationOptions {
	return GetAuthenticationSoftwareOathMethodsCountOperationOptions{}
}
...
func (c AuthenticationSoftwareOathMethodClient) GetAuthenticationSoftwareOathMethodsCount(ctx context.Context, id beta.UserId, options GetAuthenticationSoftwareOathMethodsCountOperationOptions) (result GetAuthenticationSoftwareOathMethodsCountOperationResponse, err error) {
	opts := client.RequestOptions{
		...
		Path:          fmt.Sprintf("%s/authentication/softwareOathMethods/$count", id.ID()),
