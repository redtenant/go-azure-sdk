...
// GetAuthenticationTemporaryAccessPassMethod - Get temporaryAccessPassAuthenticationMethod. Retrieve a user's single
// temporaryAccessPassAuthenticationMethod object.
func (c AuthenticationTemporaryAccessPassMethodClient) GetAuthenticationTemporaryAccessPassMethod(ctx context.Context, id beta.UserIdAuthenticationTemporaryAccessPassMethodId, options GetAuthenticationTemporaryAccessPassMethodOperationOptions) (result GetAuthenticationTemporaryAccessPassMethodOperationResponse, err error) {
