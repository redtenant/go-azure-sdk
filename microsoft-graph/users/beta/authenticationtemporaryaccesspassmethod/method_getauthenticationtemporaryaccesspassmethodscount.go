...
func DefaultGetAuthenticationTemporaryAccessPassMethodsCountOperationOptions() GetAuthenticationTemporaryAccessPassMethodsCountOperationOptions {
	return GetAuthenticationTemporaryAccessPassMethodsCountOperationOptions{}
}
...
func (c AuthenticationTemporaryAccessPassMethodClient) GetAuthenticationTemporaryAccessPassMethodsCount(ctx context.Context, id beta.UserId, options GetAuthenticationTemporaryAccessPassMethodsCountOperationOptions) (result GetAuthenticationTemporaryAccessPassMethodsCountOperationResponse, err error) {
	opts := client.RequestOptions{
		...
		Path:          fmt.Sprintf("%s/authentication/temporaryAccessPassMethods/$count", id.ID()),
