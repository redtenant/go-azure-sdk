...
// the collection as a user can have only one Temporary Access Pass (TAP) method.
func (c AuthenticationTemporaryAccessPassMethodClient) ListAuthenticationTemporaryAccessPassMethods(ctx context.Context, id beta.UserId, options ListAuthenticationTemporaryAccessPassMethodsOperationOptions) (result ListAuthenticationTemporaryAccessPassMethodsOperationResponse, err error) {
...
func (c AuthenticationTemporaryAccessPassMethodClient) ListAuthenticationTemporaryAccessPassMethodsComplete(ctx context.Context, id beta.UserId, options ListAuthenticationTemporaryAccessPassMethodsOperationOptions) (ListAuthenticationTemporaryAccessPassMethodsCompleteResult, error) {
...
func (c AuthenticationTemporaryAccessPassMethodClient) ListAuthenticationTemporaryAccessPassMethodsCompleteMatchingPredicate(ctx context.Context, id beta.UserId, options ListAuthenticationTemporaryAccessPassMethodsOperationOptions, predicate TemporaryAccessPassAuthenticationMethodOperationPredicate) (result ListAuthenticationTemporaryAccessPassMethodsCompleteResult, err error) {
