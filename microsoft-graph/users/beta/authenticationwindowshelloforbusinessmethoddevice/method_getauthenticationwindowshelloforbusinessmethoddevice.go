...
// GetAuthenticationWindowsHelloForBusinessMethodDevice - Get device from users. The registered device on which this
...
func (c AuthenticationWindowsHelloForBusinessMethodDeviceClient) GetAuthenticationWindowsHelloForBusinessMethodDevice(ctx context.Context, id beta.UserIdAuthenticationWindowsHelloForBusinessMethodId, options GetAuthenticationWindowsHelloForBusinessMethodDeviceOperationOptions) (result GetAuthenticationWindowsHelloForBusinessMethodDeviceOperationResponse, err error) {
