...
func (c ChatInstalledAppClient) CreateChatInstalledApp(ctx context.Context, id beta.UserIdChatId, input beta.TeamsAppInstallation, options CreateChatInstalledAppOperationOptions) (result CreateChatInstalledAppOperationResponse, err error) {
