...
func (c ChatInstalledAppClient) DeleteChatInstalledApp(ctx context.Context, id beta.UserIdChatIdInstalledAppId, options DeleteChatInstalledAppOperationOptions) (result DeleteChatInstalledAppOperationResponse, err error) {
