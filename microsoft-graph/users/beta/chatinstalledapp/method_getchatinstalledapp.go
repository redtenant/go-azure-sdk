...
func (c ChatInstalledAppClient) GetChatInstalledApp(ctx context.Context, id beta.UserIdChatIdInstalledAppId, options GetChatInstalledAppOperationOptions) (result GetChatInstalledAppOperationResponse, err error) {
