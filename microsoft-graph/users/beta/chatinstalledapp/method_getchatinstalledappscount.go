...
func DefaultGetChatInstalledAppsCountOperationOptions() GetChatInstalledAppsCountOperationOptions {
	return GetChatInstalledAppsCountOperationOptions{}
}
...
func (c ChatInstalledAppClient) GetChatInstalledAppsCount(ctx context.Context, id beta.UserIdChatId, options GetChatInstalledAppsCountOperationOptions) (result GetChatInstalledAppsCountOperationResponse, err error) {
