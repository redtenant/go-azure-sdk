...
// no messages are sent in the chat. Currently, only the list chats operation supports this property.
func (c ChatLastMessagePreviewClient) GetChatLastMessagePreview(ctx context.Context, id beta.UserIdChatId, options GetChatLastMessagePreviewOperationOptions) (result GetChatLastMessagePreviewOperationResponse, err error) {
