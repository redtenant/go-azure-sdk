...
func (c ChatMemberClient) CreateChatMember(ctx context.Context, id beta.UserIdChatId, input beta.ConversationMember, options CreateChatMemberOperationOptions) (result CreateChatMemberOperationResponse, err error) {
