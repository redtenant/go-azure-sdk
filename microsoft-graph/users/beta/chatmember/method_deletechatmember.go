...
func (c ChatMemberClient) DeleteChatMember(ctx context.Context, id beta.UserIdChatIdMemberId, options DeleteChatMemberOperationOptions) (result DeleteChatMemberOperationResponse, err error) {
