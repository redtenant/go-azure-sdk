...
func (c ChatMemberClient) GetChatMember(ctx context.Context, id beta.UserIdChatIdMemberId, options GetChatMemberOperationOptions) (result GetChatMemberOperationResponse, err error) {
