...
func (c ChatMemberClient) GetChatMembersCount(ctx context.Context, id beta.UserIdChatId, options GetChatMembersCountOperationOptions) (result GetChatMembersCountOperationResponse, err error) {
