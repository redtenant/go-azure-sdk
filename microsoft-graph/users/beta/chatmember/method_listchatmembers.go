...
func (c ChatMemberClient) ListChatMembers(ctx context.Context, id beta.UserIdChatId, options ListChatMembersOperationOptions) (result ListChatMembersOperationResponse, err error) {
...
func (c ChatMemberClient) ListChatMembersComplete(ctx context.Context, id beta.UserIdChatId, options ListChatMembersOperationOptions) (ListChatMembersCompleteResult, error) {
...
func (c ChatMemberClient) ListChatMembersCompleteMatchingPredicate(ctx context.Context, id beta.UserIdChatId, options ListChatMembersOperationOptions, predicate ConversationMemberOperationPredicate) (result ListChatMembersCompleteResult, err error) {
