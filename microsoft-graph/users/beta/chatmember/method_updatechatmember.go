...
func (c ChatMemberClient) UpdateChatMember(ctx context.Context, id beta.UserIdChatIdMemberId, input beta.ConversationMember, options UpdateChatMemberOperationOptions) (result UpdateChatMemberOperationResponse, err error) {
