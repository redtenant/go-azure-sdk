...
func (c ChatMessageHostedContentClient) GetChatMessageHostedContentValue(ctx context.Context, id beta.UserIdChatIdMessageIdHostedContentId, options GetChatMessageHostedContentValueOperationOptions) (result GetChatMessageHostedContentValueOperationResponse, err error) {
