...
func (c ChatMessageHostedContentClient) ListChatMessageHostedContents(ctx context.Context, id beta.UserIdChatIdMessageId, options ListChatMessageHostedContentsOperationOptions) (result ListChatMessageHostedContentsOperationResponse, err error) {
...
func (c ChatMessageHostedContentClient) ListChatMessageHostedContentsComplete(ctx context.Context, id beta.UserIdChatIdMessageId, options ListChatMessageHostedContentsOperationOptions) (ListChatMessageHostedContentsCompleteResult, error) {
...
func (c ChatMessageHostedContentClient) ListChatMessageHostedContentsCompleteMatchingPredicate(ctx context.Context, id beta.UserIdChatIdMessageId, options ListChatMessageHostedContentsOperationOptions, predicate ChatMessageHostedContentOperationPredicate) (result ListChatMessageHostedContentsCompleteResult, err error) {
