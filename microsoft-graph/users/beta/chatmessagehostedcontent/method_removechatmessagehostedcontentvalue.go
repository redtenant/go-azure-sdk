...
func (c ChatMessageHostedContentClient) RemoveChatMessageHostedContentValue(ctx context.Context, id beta.UserIdChatIdMessageIdHostedContentId, options RemoveChatMessageHostedContentValueOperationOptions) (result RemoveChatMessageHostedContentValueOperationResponse, err error) {
