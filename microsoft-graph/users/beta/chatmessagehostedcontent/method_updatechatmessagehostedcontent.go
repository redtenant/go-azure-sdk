...
func (c ChatMessageHostedContentClient) UpdateChatMessageHostedContent(ctx context.Context, id beta.UserIdChatIdMessageIdHostedContentId, input beta.ChatMessageHostedContent, options UpdateChatMessageHostedContentOperationOptions) (result UpdateChatMessageHostedContentOperationResponse, err error) {
