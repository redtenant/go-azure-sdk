...
// channel or a chat.
func (c ChatMessageReplyClient) CreateChatMessageReplySoftDelete(ctx context.Context, id beta.UserIdChatIdMessageIdReplyId, options CreateChatMessageReplySoftDeleteOperationOptions) (result CreateChatMessageReplySoftDeleteOperationResponse, err error) {
