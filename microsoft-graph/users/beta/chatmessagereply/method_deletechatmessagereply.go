...
func (c ChatMessageReplyClient) DeleteChatMessageReply(ctx context.Context, id beta.UserIdChatIdMessageIdReplyId, options DeleteChatMessageReplyOperationOptions) (result DeleteChatMessageReplyOperationResponse, err error) {
