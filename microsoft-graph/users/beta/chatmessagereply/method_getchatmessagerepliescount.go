...
func (c ChatMessageReplyClient) GetChatMessageRepliesCount(ctx context.Context, id beta.UserIdChatIdMessageId, options GetChatMessageRepliesCountOperationOptions) (result GetChatMessageRepliesCountOperationResponse, err error) {
