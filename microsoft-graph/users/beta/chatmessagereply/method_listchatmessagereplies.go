...
// messages.
func (c ChatMessageReplyClient) ListChatMessageReplies(ctx context.Context, id beta.UserIdChatIdMessageId, options ListChatMessageRepliesOperationOptions) (result ListChatMessageRepliesOperationResponse, err error) {
...
func (c ChatMessageReplyClient) ListChatMessageRepliesComplete(ctx context.Context, id beta.UserIdChatIdMessageId, options ListChatMessageRepliesOperationOptions) (ListChatMessageRepliesCompleteResult, error) {
...
func (c ChatMessageReplyClient) ListChatMessageRepliesCompleteMatchingPredicate(ctx context.Context, id beta.UserIdChatIdMessageId, options ListChatMessageRepliesOperationOptions, predicate ChatMessageOperationPredicate) (result ListChatMessageRepliesCompleteResult, err error) {
