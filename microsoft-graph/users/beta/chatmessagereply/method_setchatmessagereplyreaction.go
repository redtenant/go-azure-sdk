...
func (c ChatMessageReplyClient) SetChatMessageReplyReaction(ctx context.Context, id beta.UserIdChatIdMessageIdReplyId, input SetChatMessageReplyReactionRequest, options SetChatMessageReplyReactionOperationOptions) (result SetChatMessageReplyReactionOperationResponse, err error) {
