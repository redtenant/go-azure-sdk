...
func (c ChatMessageReplyClient) UnsetChatMessageReplyReaction(ctx context.Context, id beta.UserIdChatIdMessageIdReplyId, input UnsetChatMessageReplyReactionRequest, options UnsetChatMessageReplyReactionOperationOptions) (result UnsetChatMessageReplyReactionOperationResponse, err error) {
