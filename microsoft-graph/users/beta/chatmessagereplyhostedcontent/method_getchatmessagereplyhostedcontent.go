...
func (c ChatMessageReplyHostedContentClient) GetChatMessageReplyHostedContent(ctx context.Context, id beta.UserIdChatIdMessageIdReplyIdHostedContentId, options GetChatMessageReplyHostedContentOperationOptions) (result GetChatMessageReplyHostedContentOperationResponse, err error) {
