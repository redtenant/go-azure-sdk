...
func (c ChatMessageReplyHostedContentClient) GetChatMessageReplyHostedContentValue(ctx context.Context, id beta.UserIdChatIdMessageIdReplyIdHostedContentId, options GetChatMessageReplyHostedContentValueOperationOptions) (result GetChatMessageReplyHostedContentValueOperationResponse, err error) {
