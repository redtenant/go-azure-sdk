...
func (c ChatMessageReplyHostedContentClient) ListChatMessageReplyHostedContents(ctx context.Context, id beta.UserIdChatIdMessageIdReplyId, options ListChatMessageReplyHostedContentsOperationOptions) (result ListChatMessageReplyHostedContentsOperationResponse, err error) {
...
func (c ChatMessageReplyHostedContentClient) ListChatMessageReplyHostedContentsComplete(ctx context.Context, id beta.UserIdChatIdMessageIdReplyId, options ListChatMessageReplyHostedContentsOperationOptions) (ListChatMessageReplyHostedContentsCompleteResult, error) {
...
func (c ChatMessageReplyHostedContentClient) ListChatMessageReplyHostedContentsCompleteMatchingPredicate(ctx context.Context, id beta.UserIdChatIdMessageIdReplyId, options ListChatMessageReplyHostedContentsOperationOptions, predicate ChatMessageHostedContentOperationPredicate) (result ListChatMessageReplyHostedContentsCompleteResult, err error) {
