...
func (c ChatPermissionGrantClient) CreateChatPermissionGrant(ctx context.Context, id beta.UserIdChatId, input beta.ResourceSpecificPermissionGrant, options CreateChatPermissionGrantOperationOptions) (result CreateChatPermissionGrantOperationResponse, err error) {
