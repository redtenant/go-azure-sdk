...
func (c ChatPermissionGrantClient) DeleteChatPermissionGrant(ctx context.Context, id beta.UserIdChatIdPermissionGrantId, options DeleteChatPermissionGrantOperationOptions) (result DeleteChatPermissionGrantOperationResponse, err error) {
