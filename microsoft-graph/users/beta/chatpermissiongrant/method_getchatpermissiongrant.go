...
func (c ChatPermissionGrantClient) GetChatPermissionGrant(ctx context.Context, id beta.UserIdChatIdPermissionGrantId, options GetChatPermissionGrantOperationOptions) (result GetChatPermissionGrantOperationResponse, err error) {
