...
func DefaultGetChatPermissionGrantsCountOperationOptions() GetChatPermissionGrantsCountOperationOptions {
	return GetChatPermissionGrantsCountOperationOptions{}
}
...
func (c ChatPermissionGrantClient) GetChatPermissionGrantsCount(ctx context.Context, id beta.UserIdChatId, options GetChatPermissionGrantsCountOperationOptions) (result GetChatPermissionGrantsCountOperationResponse, err error) {
