...
func (c ChatPermissionGrantClient) UpdateChatPermissionGrant(ctx context.Context, id beta.UserIdChatIdPermissionGrantId, input beta.ResourceSpecificPermissionGrant, options UpdateChatPermissionGrantOperationOptions) (result UpdateChatPermissionGrantOperationResponse, err error) {
