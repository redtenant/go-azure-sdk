...
func DefaultDeleteChatPinnedMessageOperationOptions() DeleteChatPinnedMessageOperationOptions {
	return DeleteChatPinnedMessageOperationOptions{}
}
...
func (c ChatPinnedMessageClient) DeleteChatPinnedMessage(ctx context.Context, id beta.UserIdChatIdPinnedMessageId, options DeleteChatPinnedMessageOperationOptions) (result DeleteChatPinnedMessageOperationResponse, err error) {
