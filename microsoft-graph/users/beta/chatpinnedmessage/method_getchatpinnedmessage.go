...
func (c ChatPinnedMessageClient) GetChatPinnedMessage(ctx context.Context, id beta.UserIdChatIdPinnedMessageId, options GetChatPinnedMessageOperationOptions) (result GetChatPinnedMessageOperationResponse, err error) {
