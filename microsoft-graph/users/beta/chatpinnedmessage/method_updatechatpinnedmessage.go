...
func (c ChatPinnedMessageClient) UpdateChatPinnedMessage(ctx context.Context, id beta.UserIdChatIdPinnedMessageId, input beta.PinnedChatMessageInfo, options UpdateChatPinnedMessageOperationOptions) (result UpdateChatPinnedMessageOperationResponse, err error) {
