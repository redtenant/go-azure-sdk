...
// GetChatTabTeamsApp - Get teamsApp from users. The application that is linked to the tab.
func (c ChatTabTeamsAppClient) GetChatTabTeamsApp(ctx context.Context, id beta.UserIdChatIdTabId, options GetChatTabTeamsAppOperationOptions) (result GetChatTabTeamsAppOperationResponse, err error) {
