...
func (c CloudClipboardItemClient) CreateCloudClipboardItem(ctx context.Context, id beta.UserId, input beta.CloudClipboardItem, options CreateCloudClipboardItemOperationOptions) (result CreateCloudClipboardItemOperationResponse, err error) {
