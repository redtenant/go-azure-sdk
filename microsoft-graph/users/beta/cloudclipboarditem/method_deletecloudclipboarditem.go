...
func (c CloudClipboardItemClient) DeleteCloudClipboardItem(ctx context.Context, id beta.UserIdCloudClipboardItemId, options DeleteCloudClipboardItemOperationOptions) (result DeleteCloudClipboardItemOperationResponse, err error) {
