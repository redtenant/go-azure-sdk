...
func (c CloudClipboardItemClient) GetCloudClipboardItem(ctx context.Context, id beta.UserIdCloudClipboardItemId, options GetCloudClipboardItemOperationOptions) (result GetCloudClipboardItemOperationResponse, err error) {
