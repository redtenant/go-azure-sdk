...
func (c CloudClipboardItemClient) UpdateCloudClipboardItem(ctx context.Context, id beta.UserIdCloudClipboardItemId, input beta.CloudClipboardItem, options UpdateCloudClipboardItemOperationOptions) (result UpdateCloudClipboardItemOperationResponse, err error) {
