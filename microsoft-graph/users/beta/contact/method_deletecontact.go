...
func (c ContactClient) DeleteContact(ctx context.Context, id beta.UserIdContactId, options DeleteContactOperationOptions) (result DeleteContactOperationResponse, err error) {
