...
func (c ContactClient) GetContact(ctx context.Context, id beta.UserIdContactId, options GetContactOperationOptions) (result GetContactOperationResponse, err error) {
