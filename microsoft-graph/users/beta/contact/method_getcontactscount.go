...
func (c ContactClient) GetContactsCount(ctx context.Context, id beta.UserId, options GetContactsCountOperationOptions) (result GetContactsCountOperationResponse, err error) {
