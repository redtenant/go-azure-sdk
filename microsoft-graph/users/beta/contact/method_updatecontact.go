...
func (c ContactClient) UpdateContact(ctx context.Context, id beta.UserIdContactId, input beta.Contact, options UpdateContactOperationOptions) (result UpdateContactOperationResponse, err error) {
