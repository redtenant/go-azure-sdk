...
func (c ContactExtensionClient) DeleteContactExtension(ctx context.Context, id beta.UserIdContactIdExtensionId, options DeleteContactExtensionOperationOptions) (result DeleteContactExtensionOperationResponse, err error) {
