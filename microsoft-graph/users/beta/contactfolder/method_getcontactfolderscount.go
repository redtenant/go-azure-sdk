...
func (c ContactFolderClient) GetContactFoldersCount(ctx context.Context, id beta.UserId, options GetContactFoldersCountOperationOptions) (result GetContactFoldersCountOperationResponse, err error) {
