...
func (c ContactFolderClient) ListContactFolders(ctx context.Context, id beta.UserId, options ListContactFoldersOperationOptions) (result ListContactFoldersOperationResponse, err error) {
...
func (c ContactFolderClient) ListContactFoldersComplete(ctx context.Context, id beta.UserId, options ListContactFoldersOperationOptions) (ListContactFoldersCompleteResult, error) {
