...
func (c ContactFolderClient) UpdateContactFolder(ctx context.Context, id beta.UserIdContactFolderId, input beta.ContactFolder, options UpdateContactFolderOperationOptions) (result UpdateContactFolderOperationResponse, err error) {
