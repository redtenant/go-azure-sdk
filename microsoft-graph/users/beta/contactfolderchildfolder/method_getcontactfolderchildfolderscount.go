...
func (c ContactFolderChildFolderClient) GetContactFolderChildFoldersCount(ctx context.Context, id beta.UserIdContactFolderId, options GetContactFolderChildFoldersCountOperationOptions) (result GetContactFolderChildFoldersCountOperationResponse, err error) {
