...
func (c ContactFolderChildFolderClient) ListContactFolderChildFolders(ctx context.Context, id beta.UserIdContactFolderId, options ListContactFolderChildFoldersOperationOptions) (result ListContactFolderChildFoldersOperationResponse, err error) {
...
func (c ContactFolderChildFolderClient) ListContactFolderChildFoldersComplete(ctx context.Context, id beta.UserIdContactFolderId, options ListContactFolderChildFoldersOperationOptions) (ListContactFolderChildFoldersCompleteResult, error) {
...
func (c ContactFolderChildFolderClient) ListContactFolderChildFoldersCompleteMatchingPredicate(ctx context.Context, id beta.UserIdContactFolderId, options ListContactFolderChildFoldersOperationOptions, predicate ContactFolderOperationPredicate) (result ListContactFolderChildFoldersCompleteResult, err error) {
