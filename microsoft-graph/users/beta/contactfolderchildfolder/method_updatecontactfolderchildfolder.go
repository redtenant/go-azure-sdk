...
func (c ContactFolderChildFolderClient) UpdateContactFolderChildFolder(ctx context.Context, id beta.UserIdContactFolderIdChildFolderId, input beta.ContactFolder, options UpdateContactFolderChildFolderOperationOptions) (result UpdateContactFolderChildFolderOperationResponse, err error) {
