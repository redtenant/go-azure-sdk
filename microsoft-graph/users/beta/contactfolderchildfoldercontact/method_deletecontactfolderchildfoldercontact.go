...
func (c ContactFolderChildFolderContactClient) DeleteContactFolderChildFolderContact(ctx context.Context, id beta.UserIdContactFolderIdChildFolderIdContactId, options DeleteContactFolderChildFolderContactOperationOptions) (result DeleteContactFolderChildFolderContactOperationResponse, err error) {
