...
func (c ContactFolderChildFolderContactClient) GetContactFolderChildFolderContactsCount(ctx context.Context, id beta.UserIdContactFolderIdChildFolderId, options GetContactFolderChildFolderContactsCountOperationOptions) (result GetContactFolderChildFolderContactsCountOperationResponse, err error) {
