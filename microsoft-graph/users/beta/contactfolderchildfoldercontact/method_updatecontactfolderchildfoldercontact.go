...
func (c ContactFolderChildFolderContactClient) UpdateContactFolderChildFolderContact(ctx context.Context, id beta.UserIdContactFolderIdChildFolderIdContactId, input beta.Contact, options UpdateContactFolderChildFolderContactOperationOptions) (result UpdateContactFolderChildFolderContactOperationResponse, err error) {
