...
func (c ContactFolderChildFolderContactExtensionClient) DeleteContactFolderChildFolderContactExtension(ctx context.Context, id beta.UserIdContactFolderIdChildFolderIdContactIdExtensionId, options DeleteContactFolderChildFolderContactExtensionOperationOptions) (result DeleteContactFolderChildFolderContactExtensionOperationResponse, err error) {
