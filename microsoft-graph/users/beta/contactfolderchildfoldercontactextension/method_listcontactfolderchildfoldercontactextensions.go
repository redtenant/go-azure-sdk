...
// ListContactFolderChildFolderContactExtensions - Get extensions from users. The collection of open extensions defined
// for the contact. Nullable.
func (c ContactFolderChildFolderContactExtensionClient) ListContactFolderChildFolderContactExtensions(ctx context.Context, id beta.UserIdContactFolderIdChildFolderIdContactId, options ListContactFolderChildFolderContactExtensionsOperationOptions) (result ListContactFolderChildFolderContactExtensionsOperationResponse, err error) {
