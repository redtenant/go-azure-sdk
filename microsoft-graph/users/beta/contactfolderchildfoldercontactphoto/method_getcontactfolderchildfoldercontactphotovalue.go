...
func (c ContactFolderChildFolderContactPhotoClient) GetContactFolderChildFolderContactPhotoValue(ctx context.Context, id beta.UserIdContactFolderIdChildFolderIdContactId, options GetContactFolderChildFolderContactPhotoValueOperationOptions) (result GetContactFolderChildFolderContactPhotoValueOperationResponse, err error) {
