...
type RemoveContactFolderChildFolderContactPhotoValueOperationResponse struct {
...
func DefaultRemoveContactFolderChildFolderContactPhotoValueOperationOptions() RemoveContactFolderChildFolderContactPhotoValueOperationOptions {
	return RemoveContactFolderChildFolderContactPhotoValueOperationOptions{}
}
...
// RemoveContactFolderChildFolderContactPhotoValue - Delete media content for the navigation property photo in users.
// Optional contact picture. You can get or set a photo for a contact.
func (c ContactFolderChildFolderContactPhotoClient) RemoveContactFolderChildFolderContactPhotoValue(ctx context.Context, id beta.UserIdContactFolderIdChildFolderIdContactId, options RemoveContactFolderChildFolderContactPhotoValueOperationOptions) (result RemoveContactFolderChildFolderContactPhotoValueOperationResponse, err error) {
