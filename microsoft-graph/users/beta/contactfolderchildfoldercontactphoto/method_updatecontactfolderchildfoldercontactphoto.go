...
func (c ContactFolderChildFolderContactPhotoClient) UpdateContactFolderChildFolderContactPhoto(ctx context.Context, id beta.UserIdContactFolderIdChildFolderIdContactId, input beta.ProfilePhoto, options UpdateContactFolderChildFolderContactPhotoOperationOptions) (result UpdateContactFolderChildFolderContactPhotoOperationResponse, err error) {
