...
func (c ContactFolderContactClient) CreateContactFolderContact(ctx context.Context, id beta.UserIdContactFolderId, input beta.Contact, options CreateContactFolderContactOperationOptions) (result CreateContactFolderContactOperationResponse, err error) {
