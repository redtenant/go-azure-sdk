...
// Nullable.
func (c ContactFolderContactClient) ListContactFolderContacts(ctx context.Context, id beta.UserIdContactFolderId, options ListContactFolderContactsOperationOptions) (result ListContactFolderContactsOperationResponse, err error) {
...
func (c ContactFolderContactClient) ListContactFolderContactsComplete(ctx context.Context, id beta.UserIdContactFolderId, options ListContactFolderContactsOperationOptions) (ListContactFolderContactsCompleteResult, error) {
...
func (c ContactFolderContactClient) ListContactFolderContactsCompleteMatchingPredicate(ctx context.Context, id beta.UserIdContactFolderId, options ListContactFolderContactsOperationOptions, predicate ContactOperationPredicate) (result ListContactFolderContactsCompleteResult, err error) {
