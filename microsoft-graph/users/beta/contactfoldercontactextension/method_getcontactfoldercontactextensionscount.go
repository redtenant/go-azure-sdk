...
func (c ContactFolderContactExtensionClient) GetContactFolderContactExtensionsCount(ctx context.Context, id beta.UserIdContactFolderIdContactId, options GetContactFolderContactExtensionsCountOperationOptions) (result GetContactFolderContactExtensionsCountOperationResponse, err error) {
