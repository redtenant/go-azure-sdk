...
// contact. Nullable.
func (c ContactFolderContactExtensionClient) ListContactFolderContactExtensions(ctx context.Context, id beta.UserIdContactFolderIdContactId, options ListContactFolderContactExtensionsOperationOptions) (result ListContactFolderContactExtensionsOperationResponse, err error) {
...
func (c ContactFolderContactExtensionClient) ListContactFolderContactExtensionsComplete(ctx context.Context, id beta.UserIdContactFolderIdContactId, options ListContactFolderContactExtensionsOperationOptions) (ListContactFolderContactExtensionsCompleteResult, error) {
...
func (c ContactFolderContactExtensionClient) ListContactFolderContactExtensionsCompleteMatchingPredicate(ctx context.Context, id beta.UserIdContactFolderIdContactId, options ListContactFolderContactExtensionsOperationOptions, predicate ExtensionOperationPredicate) (result ListContactFolderContactExtensionsCompleteResult, err error) {
