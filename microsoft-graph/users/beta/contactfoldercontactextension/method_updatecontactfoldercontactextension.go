...
func (c ContactFolderContactExtensionClient) UpdateContactFolderContactExtension(ctx context.Context, id beta.UserIdContactFolderIdContactIdExtensionId, input beta.Extension, options UpdateContactFolderContactExtensionOperationOptions) (result UpdateContactFolderContactExtensionOperationResponse, err error) {
