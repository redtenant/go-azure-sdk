...
func (c ContactFolderContactPhotoClient) RemoveContactFolderContactPhotoValue(ctx context.Context, id beta.UserIdContactFolderIdContactId, options RemoveContactFolderContactPhotoValueOperationOptions) (result RemoveContactFolderContactPhotoValueOperationResponse, err error) {
