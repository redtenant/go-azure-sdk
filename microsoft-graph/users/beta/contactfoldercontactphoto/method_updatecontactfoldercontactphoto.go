...
func (c ContactFolderContactPhotoClient) UpdateContactFolderContactPhoto(ctx context.Context, id beta.UserIdContactFolderIdContactId, input beta.ProfilePhoto, options UpdateContactFolderContactPhotoOperationOptions) (result UpdateContactFolderContactPhotoOperationResponse, err error) {
