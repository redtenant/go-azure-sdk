...
func (c ContactPhotoClient) GetContactPhoto(ctx context.Context, id beta.UserIdContactId, options GetContactPhotoOperationOptions) (result GetContactPhotoOperationResponse, err error) {
