...
func (c ContactPhotoClient) GetContactPhotoValue(ctx context.Context, id beta.UserIdContactId, options GetContactPhotoValueOperationOptions) (result GetContactPhotoValueOperationResponse, err error) {
