...
func (c ContactPhotoClient) SetContactPhotoValue(ctx context.Context, id beta.UserIdContactId, input []byte, options SetContactPhotoValueOperationOptions) (result SetContactPhotoValueOperationResponse, err error) {
