...
func (c CreatedObjectClient) GetCreatedObject(ctx context.Context, id beta.UserIdCreatedObjectId, options GetCreatedObjectOperationOptions) (result GetCreatedObjectOperationResponse, err error) {
