...
// CreateDeviceEnrollmentConfiguration - Create new navigation property to deviceEnrollmentConfigurations for users
func (c DeviceEnrollmentConfigurationClient) CreateDeviceEnrollmentConfiguration(ctx context.Context, id beta.UserId, input beta.DeviceEnrollmentConfiguration, options CreateDeviceEnrollmentConfigurationOperationOptions) (result CreateDeviceEnrollmentConfigurationOperationResponse, err error) {
