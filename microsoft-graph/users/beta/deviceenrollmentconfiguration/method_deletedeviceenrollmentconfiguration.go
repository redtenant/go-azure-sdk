...
// DeleteDeviceEnrollmentConfiguration - Delete navigation property deviceEnrollmentConfigurations for users
func (c DeviceEnrollmentConfigurationClient) DeleteDeviceEnrollmentConfiguration(ctx context.Context, id beta.UserIdDeviceEnrollmentConfigurationId, options DeleteDeviceEnrollmentConfigurationOperationOptions) (result DeleteDeviceEnrollmentConfigurationOperationResponse, err error) {
