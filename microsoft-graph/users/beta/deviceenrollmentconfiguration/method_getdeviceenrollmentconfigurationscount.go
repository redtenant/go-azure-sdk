...
func (c DeviceEnrollmentConfigurationClient) GetDeviceEnrollmentConfigurationsCount(ctx context.Context, id beta.UserId, options GetDeviceEnrollmentConfigurationsCountOperationOptions) (result GetDeviceEnrollmentConfigurationsCountOperationResponse, err error) {
	opts := client.RequestOptions{
		...
		Path:          fmt.Sprintf("%s/deviceEnrollmentConfigurations/$count", id.ID()),
