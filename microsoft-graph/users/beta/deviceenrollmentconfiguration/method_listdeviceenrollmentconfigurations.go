...
// ListDeviceEnrollmentConfigurations - Get deviceEnrollmentConfigurations from users. Get enrollment configurations
// targeted to the user
func (c DeviceEnrollmentConfigurationClient) ListDeviceEnrollmentConfigurations(ctx context.Context, id beta.UserId, options ListDeviceEnrollmentConfigurationsOperationOptions) (result ListDeviceEnrollmentConfigurationsOperationResponse, err error) {
...
func (c DeviceEnrollmentConfigurationClient) ListDeviceEnrollmentConfigurationsComplete(ctx context.Context, id beta.UserId, options ListDeviceEnrollmentConfigurationsOperationOptions) (ListDeviceEnrollmentConfigurationsCompleteResult, error) {
	return c.ListDeviceEnrollmentConfigurationsCompleteMatchingPredicate(ctx, id, options, DeviceEnrollmentConfigurationOperationPredicate{})
}

// ListDeviceEnrollmentConfigurationsCompleteMatchingPredicate retrieves all the results and then applies the predicate
func (c DeviceEnrollmentConfigurationClient) ListDeviceEnrollmentConfigurationsCompleteMatchingPredicate(ctx context.Context, id beta.UserId, options ListDeviceEnrollmentConfigurationsOperationOptions, predicate DeviceEnrollmentConfigurationOperationPredicate) (result ListDeviceEnrollmentConfigurationsCompleteResult, err error) {
	items := make([]beta.DeviceEnrollmentConfiguration, 0)

	resp, err := c.ListDeviceEnrollmentConfigurations(ctx, id, options)
	if err != nil {
