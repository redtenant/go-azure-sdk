...
// UpdateDeviceEnrollmentConfiguration - Update the navigation property deviceEnrollmentConfigurations in users
func (c DeviceEnrollmentConfigurationClient) UpdateDeviceEnrollmentConfiguration(ctx context.Context, id beta.UserIdDeviceEnrollmentConfigurationId, input beta.DeviceEnrollmentConfiguration, options UpdateDeviceEnrollmentConfigurationOperationOptions) (result UpdateDeviceEnrollmentConfigurationOperationResponse, err error) {
