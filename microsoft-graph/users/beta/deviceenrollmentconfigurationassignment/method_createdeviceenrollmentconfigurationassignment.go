...
// CreateDeviceEnrollmentConfigurationAssignment - Create new navigation property to assignments for users
func (c DeviceEnrollmentConfigurationAssignmentClient) CreateDeviceEnrollmentConfigurationAssignment(ctx context.Context, id beta.UserIdDeviceEnrollmentConfigurationId, input beta.EnrollmentConfigurationAssignment, options CreateDeviceEnrollmentConfigurationAssignmentOperationOptions) (result CreateDeviceEnrollmentConfigurationAssignmentOperationResponse, err error) {
