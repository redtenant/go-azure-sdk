...
// DeleteDeviceEnrollmentConfigurationAssignment - Delete navigation property assignments for users
func (c DeviceEnrollmentConfigurationAssignmentClient) DeleteDeviceEnrollmentConfigurationAssignment(ctx context.Context, id beta.UserIdDeviceEnrollmentConfigurationIdAssignmentId, options DeleteDeviceEnrollmentConfigurationAssignmentOperationOptions) (result DeleteDeviceEnrollmentConfigurationAssignmentOperationResponse, err error) {
