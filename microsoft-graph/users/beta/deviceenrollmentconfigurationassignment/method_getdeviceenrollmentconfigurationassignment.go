...
// GetDeviceEnrollmentConfigurationAssignment - Get assignments from users. The list of group assignments for the device
// configuration profile
func (c DeviceEnrollmentConfigurationAssignmentClient) GetDeviceEnrollmentConfigurationAssignment(ctx context.Context, id beta.UserIdDeviceEnrollmentConfigurationIdAssignmentId, options GetDeviceEnrollmentConfigurationAssignmentOperationOptions) (result GetDeviceEnrollmentConfigurationAssignmentOperationResponse, err error) {
