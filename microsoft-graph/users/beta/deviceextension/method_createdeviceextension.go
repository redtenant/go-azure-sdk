...
func (c DeviceExtensionClient) CreateDeviceExtension(ctx context.Context, id beta.UserIdDeviceId, input beta.Extension, options CreateDeviceExtensionOperationOptions) (result CreateDeviceExtensionOperationResponse, err error) {
