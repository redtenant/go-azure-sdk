...
func DefaultDeleteDeviceExtensionOperationOptions() DeleteDeviceExtensionOperationOptions {
	return DeleteDeviceExtensionOperationOptions{}
}
...
func (c DeviceExtensionClient) DeleteDeviceExtension(ctx context.Context, id beta.UserIdDeviceIdExtensionId, options DeleteDeviceExtensionOperationOptions) (result DeleteDeviceExtensionOperationResponse, err error) {
