...
func DefaultGetDeviceExtensionOperationOptions() GetDeviceExtensionOperationOptions {
	return GetDeviceExtensionOperationOptions{}
}
...
// GetDeviceExtension - Get extensions from users. The collection of open extensions defined for the device. Read-only.
// Nullable.
func (c DeviceExtensionClient) GetDeviceExtension(ctx context.Context, id beta.UserIdDeviceIdExtensionId, options GetDeviceExtensionOperationOptions) (result GetDeviceExtensionOperationResponse, err error) {
