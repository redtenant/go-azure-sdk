...
func (c DeviceExtensionClient) GetDeviceExtensionsCount(ctx context.Context, id beta.UserIdDeviceId, options GetDeviceExtensionsCountOperationOptions) (result GetDeviceExtensionsCountOperationResponse, err error) {
