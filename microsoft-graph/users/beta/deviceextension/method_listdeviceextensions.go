...
func DefaultListDeviceExtensionsOperationOptions() ListDeviceExtensionsOperationOptions {
	return ListDeviceExtensionsOperationOptions{}
}
...
// ListDeviceExtensions - Get extensions from users. The collection of open extensions defined for the device.
// Read-only. Nullable.
func (c DeviceExtensionClient) ListDeviceExtensions(ctx context.Context, id beta.UserIdDeviceId, options ListDeviceExtensionsOperationOptions) (result ListDeviceExtensionsOperationResponse, err error) {
...
func (c DeviceExtensionClient) ListDeviceExtensionsComplete(ctx context.Context, id beta.UserIdDeviceId, options ListDeviceExtensionsOperationOptions) (ListDeviceExtensionsCompleteResult, error) {
	return c.ListDeviceExtensionsCompleteMatchingPredicate(ctx, id, options, ExtensionOperationPredicate{})
}
...
func (c DeviceExtensionClient) ListDeviceExtensionsCompleteMatchingPredicate(ctx context.Context, id beta.UserIdDeviceId, options ListDeviceExtensionsOperationOptions, predicate ExtensionOperationPredicate) (result ListDeviceExtensionsCompleteResult, err error) {
	...
	resp, err := c.ListDeviceExtensions(ctx, id, options)
	if err != nil {
