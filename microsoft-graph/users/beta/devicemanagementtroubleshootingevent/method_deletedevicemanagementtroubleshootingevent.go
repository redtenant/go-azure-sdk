...
// users
func (c DeviceManagementTroubleshootingEventClient) DeleteDeviceManagementTroubleshootingEvent(ctx context.Context, id beta.UserIdDeviceManagementTroubleshootingEventId, options DeleteDeviceManagementTroubleshootingEventOperationOptions) (result DeleteDeviceManagementTroubleshootingEventOperationResponse, err error) {
