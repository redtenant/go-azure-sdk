...
// GetDeviceManagementTroubleshootingEvent - Get deviceManagementTroubleshootingEvents from users. The list of
// troubleshooting events for this user.
func (c DeviceManagementTroubleshootingEventClient) GetDeviceManagementTroubleshootingEvent(ctx context.Context, id beta.UserIdDeviceManagementTroubleshootingEventId, options GetDeviceManagementTroubleshootingEventOperationOptions) (result GetDeviceManagementTroubleshootingEventOperationResponse, err error) {
