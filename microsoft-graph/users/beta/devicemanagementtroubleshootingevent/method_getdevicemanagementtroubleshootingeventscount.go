...
func DefaultGetDeviceManagementTroubleshootingEventsCountOperationOptions() GetDeviceManagementTroubleshootingEventsCountOperationOptions {
	return GetDeviceManagementTroubleshootingEventsCountOperationOptions{}
}
...
func (c DeviceManagementTroubleshootingEventClient) GetDeviceManagementTroubleshootingEventsCount(ctx context.Context, id beta.UserId, options GetDeviceManagementTroubleshootingEventsCountOperationOptions) (result GetDeviceManagementTroubleshootingEventsCountOperationResponse, err error) {
	opts := client.RequestOptions{
		...
		Path:          fmt.Sprintf("%s/deviceManagementTroubleshootingEvents/$count", id.ID()),
