...
func DefaultListDeviceManagementTroubleshootingEventsOperationOptions() ListDeviceManagementTroubleshootingEventsOperationOptions {
	return ListDeviceManagementTroubleshootingEventsOperationOptions{}
}
...
// ListDeviceManagementTroubleshootingEvents - Get deviceManagementTroubleshootingEvents from users. The list of
// troubleshooting events for this user.
func (c DeviceManagementTroubleshootingEventClient) ListDeviceManagementTroubleshootingEvents(ctx context.Context, id beta.UserId, options ListDeviceManagementTroubleshootingEventsOperationOptions) (result ListDeviceManagementTroubleshootingEventsOperationResponse, err error) {
	...
	temp := make([]beta.DeviceManagementTroubleshootingEvent, 0)
	if values.Values != nil {
		for i, v := range *values.Values {
			val, err := beta.UnmarshalDeviceManagementTroubleshootingEventImplementation(v)
			if err != nil {
				err = fmt.Errorf("unmarshalling item %d for beta.DeviceManagementTroubleshootingEvent (%q): %+v", i, v, err)
				return result, err
			}
...
func (c DeviceManagementTroubleshootingEventClient) ListDeviceManagementTroubleshootingEventsComplete(ctx context.Context, id beta.UserId, options ListDeviceManagementTroubleshootingEventsOperationOptions) (ListDeviceManagementTroubleshootingEventsCompleteResult, error) {
	return c.ListDeviceManagementTroubleshootingEventsCompleteMatchingPredicate(ctx, id, options, DeviceManagementTroubleshootingEventOperationPredicate{})
}
...
func (c DeviceManagementTroubleshootingEventClient) ListDeviceManagementTroubleshootingEventsCompleteMatchingPredicate(ctx context.Context, id beta.UserId, options ListDeviceManagementTroubleshootingEventsOperationOptions, predicate DeviceManagementTroubleshootingEventOperationPredicate) (result ListDeviceManagementTroubleshootingEventsCompleteResult, err error) {
	items := make([]beta.DeviceManagementTroubleshootingEvent, 0)

	resp, err := c.ListDeviceManagementTroubleshootingEvents(ctx, id, options)
	if err != nil {
