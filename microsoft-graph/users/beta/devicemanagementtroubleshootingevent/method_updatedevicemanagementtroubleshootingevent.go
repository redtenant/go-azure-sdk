...
// users
func (c DeviceManagementTroubleshootingEventClient) UpdateDeviceManagementTroubleshootingEvent(ctx context.Context, id beta.UserIdDeviceManagementTroubleshootingEventId, input beta.DeviceManagementTroubleshootingEvent, options UpdateDeviceManagementTroubleshootingEventOperationOptions) (result UpdateDeviceManagementTroubleshootingEventOperationResponse, err error) {
