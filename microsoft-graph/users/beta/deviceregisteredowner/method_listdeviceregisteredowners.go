...
// ListDeviceRegisteredOwners - Get registeredOwners from users. The user that cloud joined the device or registered
// their personal device. The registered owner is set at the time of registration. Read-only. Nullable. Supports
// $expand.
