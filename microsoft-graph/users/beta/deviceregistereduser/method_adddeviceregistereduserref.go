...
// AddDeviceRegisteredUserRef - Create new navigation property ref to registeredUsers for users
func (c DeviceRegisteredUserClient) AddDeviceRegisteredUserRef(ctx context.Context, id beta.UserIdDeviceId, input beta.ReferenceCreate, options AddDeviceRegisteredUserRefOperationOptions) (result AddDeviceRegisteredUserRefOperationResponse, err error) {
