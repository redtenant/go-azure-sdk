...
// ListDeviceRegisteredUserRefs - Get ref of registeredUsers from users. Collection of registered users of the device.
// For cloud joined devices and registered personal devices, registered users are set to the same value as registered
// owners at the time of registration. Read-only. Nullable. Supports $expand.
func (c DeviceRegisteredUserClient) ListDeviceRegisteredUserRefs(ctx context.Context, id beta.UserIdDeviceId, options ListDeviceRegisteredUserRefsOperationOptions) (result ListDeviceRegisteredUserRefsOperationResponse, err error) {
...
func (c DeviceRegisteredUserClient) ListDeviceRegisteredUserRefsComplete(ctx context.Context, id beta.UserIdDeviceId, options ListDeviceRegisteredUserRefsOperationOptions) (ListDeviceRegisteredUserRefsCompleteResult, error) {
...
func (c DeviceRegisteredUserClient) ListDeviceRegisteredUserRefsCompleteMatchingPredicate(ctx context.Context, id beta.UserIdDeviceId, options ListDeviceRegisteredUserRefsOperationOptions, predicate DirectoryObjectOperationPredicate) (result ListDeviceRegisteredUserRefsCompleteResult, err error) {
