...
func (c DirectReportClient) GetDirectReport(ctx context.Context, id beta.UserIdDirectReportId, options GetDirectReportOperationOptions) (result GetDirectReportOperationResponse, err error) {
