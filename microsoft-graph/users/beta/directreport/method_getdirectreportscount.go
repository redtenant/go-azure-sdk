...
func (c DirectReportClient) GetDirectReportsCount(ctx context.Context, id beta.UserId, options GetDirectReportsCountOperationOptions) (result GetDirectReportsCountOperationResponse, err error) {
