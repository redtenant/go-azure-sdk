...
// contacts with their manager property set to this user.) Read-only. Nullable. Supports $expand.
func (c DirectReportClient) ListDirectReports(ctx context.Context, id beta.UserId, options ListDirectReportsOperationOptions) (result ListDirectReportsOperationResponse, err error) {
...
func (c DirectReportClient) ListDirectReportsComplete(ctx context.Context, id beta.UserId, options ListDirectReportsOperationOptions) (ListDirectReportsCompleteResult, error) {
...
func (c DirectReportClient) ListDirectReportsCompleteMatchingPredicate(ctx context.Context, id beta.UserId, options ListDirectReportsOperationOptions, predicate DirectoryObjectOperationPredicate) (result ListDirectReportsCompleteResult, err error) {
