...
func (c DriveClient) CreateDrive(ctx context.Context, id beta.UserId, input beta.Drive, options CreateDriveOperationOptions) (result CreateDriveOperationResponse, err error) {
