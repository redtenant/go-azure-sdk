...
func (c DriveClient) DeleteDrive(ctx context.Context, id beta.UserIdDriveId, options DeleteDriveOperationOptions) (result DeleteDriveOperationResponse, err error) {
