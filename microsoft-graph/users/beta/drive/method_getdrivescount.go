...
func (c DriveClient) GetDrivesCount(ctx context.Context, id beta.UserId, options GetDrivesCountOperationOptions) (result GetDrivesCountOperationResponse, err error) {
