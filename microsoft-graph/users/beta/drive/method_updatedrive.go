...
func (c DriveClient) UpdateDrive(ctx context.Context, id beta.UserIdDriveId, input beta.Drive, options UpdateDriveOperationOptions) (result UpdateDriveOperationResponse, err error) {
