...
// DeleteDriveActivity - Delete navigation property activities for users
func (c DriveActivityClient) DeleteDriveActivity(ctx context.Context, id beta.UserIdDriveIdActivityId, options DeleteDriveActivityOperationOptions) (result DeleteDriveActivityOperationResponse, err error) {
