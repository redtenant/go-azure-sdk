...
func (c DriveActivityClient) GetDriveActivitiesCount(ctx context.Context, id beta.UserIdDriveId, options GetDriveActivitiesCountOperationOptions) (result GetDriveActivitiesCountOperationResponse, err error) {
