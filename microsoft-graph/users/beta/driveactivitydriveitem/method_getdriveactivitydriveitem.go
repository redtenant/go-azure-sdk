...
// GetDriveActivityDriveItem - Get driveItem from users
func (c DriveActivityDriveItemClient) GetDriveActivityDriveItem(ctx context.Context, id beta.UserIdDriveIdActivityId, options GetDriveActivityDriveItemOperationOptions) (result GetDriveActivityDriveItemOperationResponse, err error) {
