...
// GetDriveActivityDriveItemContentStream - Get contentStream for the navigation property driveItem from users. The
// content stream, if the item represents a file.
func (c DriveActivityDriveItemContentStreamClient) GetDriveActivityDriveItemContentStream(ctx context.Context, id beta.UserIdDriveIdActivityId, options GetDriveActivityDriveItemContentStreamOperationOptions) (result GetDriveActivityDriveItemContentStreamOperationResponse, err error) {
