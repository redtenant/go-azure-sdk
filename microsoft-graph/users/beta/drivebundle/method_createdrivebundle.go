...
func (c DriveBundleClient) CreateDriveBundle(ctx context.Context, id beta.UserIdDriveId, input beta.DriveItem, options CreateDriveBundleOperationOptions) (result CreateDriveBundleOperationResponse, err error) {
