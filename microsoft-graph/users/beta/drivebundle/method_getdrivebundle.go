...
// GetDriveBundle - Get bundles from users. Collection of bundles (albums and multi-select-shared sets of items). Only
// in personal OneDrive.
func (c DriveBundleClient) GetDriveBundle(ctx context.Context, id beta.UserIdDriveIdBundleId, options GetDriveBundleOperationOptions) (result GetDriveBundleOperationResponse, err error) {
