...
func (c DriveBundleClient) GetDriveBundlesCount(ctx context.Context, id beta.UserIdDriveId, options GetDriveBundlesCountOperationOptions) (result GetDriveBundlesCountOperationResponse, err error) {
