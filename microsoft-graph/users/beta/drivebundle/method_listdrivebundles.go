...
func (c DriveBundleClient) ListDriveBundles(ctx context.Context, id beta.UserIdDriveId, options ListDriveBundlesOperationOptions) (result ListDriveBundlesOperationResponse, err error) {
...
func (c DriveBundleClient) ListDriveBundlesComplete(ctx context.Context, id beta.UserIdDriveId, options ListDriveBundlesOperationOptions) (ListDriveBundlesCompleteResult, error) {
