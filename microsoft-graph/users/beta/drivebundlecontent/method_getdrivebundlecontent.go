...
func (c DriveBundleContentClient) GetDriveBundleContent(ctx context.Context, id beta.UserIdDriveIdBundleId, options GetDriveBundleContentOperationOptions) (result GetDriveBundleContentOperationResponse, err error) {
