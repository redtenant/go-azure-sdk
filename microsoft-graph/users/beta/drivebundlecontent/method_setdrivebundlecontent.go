...
func (c DriveBundleContentClient) SetDriveBundleContent(ctx context.Context, id beta.UserIdDriveIdBundleId, input []byte, options SetDriveBundleContentOperationOptions) (result SetDriveBundleContentOperationResponse, err error) {
