...
func (c DriveCreatedByUserMailboxSettingClient) UpdateDriveCreatedByUserMailboxSetting(ctx context.Context, id beta.UserIdDriveId, input beta.MailboxSettings, options UpdateDriveCreatedByUserMailboxSettingOperationOptions) (result UpdateDriveCreatedByUserMailboxSettingOperationResponse, err error) {
