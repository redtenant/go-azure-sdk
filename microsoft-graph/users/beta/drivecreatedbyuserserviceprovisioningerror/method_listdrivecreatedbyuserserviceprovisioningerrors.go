...
// object.
func (c DriveCreatedByUserServiceProvisioningErrorClient) ListDriveCreatedByUserServiceProvisioningErrors(ctx context.Context, id beta.UserIdDriveId, options ListDriveCreatedByUserServiceProvisioningErrorsOperationOptions) (result ListDriveCreatedByUserServiceProvisioningErrorsOperationResponse, err error) {
...
func (c DriveCreatedByUserServiceProvisioningErrorClient) ListDriveCreatedByUserServiceProvisioningErrorsComplete(ctx context.Context, id beta.UserIdDriveId, options ListDriveCreatedByUserServiceProvisioningErrorsOperationOptions) (ListDriveCreatedByUserServiceProvisioningErrorsCompleteResult, error) {
...
func (c DriveCreatedByUserServiceProvisioningErrorClient) ListDriveCreatedByUserServiceProvisioningErrorsCompleteMatchingPredicate(ctx context.Context, id beta.UserIdDriveId, options ListDriveCreatedByUserServiceProvisioningErrorsOperationOptions, predicate ServiceProvisioningErrorOperationPredicate) (result ListDriveCreatedByUserServiceProvisioningErrorsCompleteResult, err error) {
