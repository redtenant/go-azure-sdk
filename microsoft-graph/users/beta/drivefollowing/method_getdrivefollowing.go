...
func (c DriveFollowingClient) GetDriveFollowing(ctx context.Context, id beta.UserIdDriveIdFollowingId, options GetDriveFollowingOperationOptions) (result GetDriveFollowingOperationResponse, err error) {
