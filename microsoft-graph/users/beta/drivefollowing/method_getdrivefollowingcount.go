...
func (c DriveFollowingClient) GetDriveFollowingCount(ctx context.Context, id beta.UserIdDriveId, options GetDriveFollowingCountOperationOptions) (result GetDriveFollowingCountOperationResponse, err error) {
