...
func (c DriveFollowingContentClient) GetDriveFollowingContent(ctx context.Context, id beta.UserIdDriveIdFollowingId, options GetDriveFollowingContentOperationOptions) (result GetDriveFollowingContentOperationResponse, err error) {
