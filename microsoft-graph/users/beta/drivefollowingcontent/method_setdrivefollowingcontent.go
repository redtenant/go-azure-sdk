...
func (c DriveFollowingContentClient) SetDriveFollowingContent(ctx context.Context, id beta.UserIdDriveIdFollowingId, input []byte, options SetDriveFollowingContentOperationOptions) (result SetDriveFollowingContentOperationResponse, err error) {
