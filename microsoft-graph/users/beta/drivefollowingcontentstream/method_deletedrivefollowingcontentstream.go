...
// DeleteDriveFollowingContentStream - Delete contentStream for the navigation property following in users. The content
// stream, if the item represents a file.
func (c DriveFollowingContentStreamClient) DeleteDriveFollowingContentStream(ctx context.Context, id beta.UserIdDriveIdFollowingId, options DeleteDriveFollowingContentStreamOperationOptions) (result DeleteDriveFollowingContentStreamOperationResponse, err error) {
