...
func (c DriveItemClient) AssignDriveItemSensitivityLabel(ctx context.Context, id beta.UserIdDriveIdItemId, input AssignDriveItemSensitivityLabelRequest, options AssignDriveItemSensitivityLabelOperationOptions) (result AssignDriveItemSensitivityLabelOperationResponse, err error) {
