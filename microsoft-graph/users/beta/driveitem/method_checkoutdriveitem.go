...
func (c DriveItemClient) CheckoutDriveItem(ctx context.Context, id beta.UserIdDriveIdItemId, options CheckoutDriveItemOperationOptions) (result CheckoutDriveItemOperationResponse, err error) {
