...
func (c DriveItemClient) CreateDriveItem(ctx context.Context, id beta.UserIdDriveId, input beta.DriveItem, options CreateDriveItemOperationOptions) (result CreateDriveItemOperationResponse, err error) {
