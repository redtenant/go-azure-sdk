...
func (c DriveItemClient) CreateDriveItemUploadSession(ctx context.Context, id beta.UserIdDriveIdItemId, input CreateDriveItemUploadSessionRequest, options CreateDriveItemUploadSessionOperationOptions) (result CreateDriveItemUploadSessionOperationResponse, err error) {
