...
func (c DriveItemClient) DeleteDriveItem(ctx context.Context, id beta.UserIdDriveIdItemId, options DeleteDriveItemOperationOptions) (result DeleteDriveItemOperationResponse, err error) {
