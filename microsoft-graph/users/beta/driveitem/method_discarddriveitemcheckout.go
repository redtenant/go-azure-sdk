...
// permissions.
func (c DriveItemClient) DiscardDriveItemCheckout(ctx context.Context, id beta.UserIdDriveIdItemId, options DiscardDriveItemCheckoutOperationOptions) (result DiscardDriveItemCheckoutOperationResponse, err error) {
