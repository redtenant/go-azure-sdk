...
func (c DriveItemClient) FollowDriveItem(ctx context.Context, id beta.UserIdDriveIdItemId, options FollowDriveItemOperationOptions) (result FollowDriveItemOperationResponse, err error) {
