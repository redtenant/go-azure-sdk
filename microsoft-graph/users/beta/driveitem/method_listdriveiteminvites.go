...
// provides permissions to the recipients and optionally sends an email to the recipients to notify them the item was
// shared.
func (c DriveItemClient) ListDriveItemInvites(ctx context.Context, id beta.UserIdDriveIdItemId, input ListDriveItemInvitesRequest, options ListDriveItemInvitesOperationOptions) (result ListDriveItemInvitesOperationResponse, err error) {
...
func (c DriveItemClient) ListDriveItemInvitesComplete(ctx context.Context, id beta.UserIdDriveIdItemId, input ListDriveItemInvitesRequest, options ListDriveItemInvitesOperationOptions) (ListDriveItemInvitesCompleteResult, error) {
...
func (c DriveItemClient) ListDriveItemInvitesCompleteMatchingPredicate(ctx context.Context, id beta.UserIdDriveIdItemId, input ListDriveItemInvitesRequest, options ListDriveItemInvitesOperationOptions, predicate PermissionOperationPredicate) (result ListDriveItemInvitesCompleteResult, err error) {
