...
func (c DriveItemClient) ListDriveItems(ctx context.Context, id beta.UserIdDriveId, options ListDriveItemsOperationOptions) (result ListDriveItemsOperationResponse, err error) {
...
func (c DriveItemClient) ListDriveItemsComplete(ctx context.Context, id beta.UserIdDriveId, options ListDriveItemsOperationOptions) (ListDriveItemsCompleteResult, error) {
...
func (c DriveItemClient) ListDriveItemsCompleteMatchingPredicate(ctx context.Context, id beta.UserIdDriveId, options ListDriveItemsOperationOptions, predicate DriveItemOperationPredicate) (result ListDriveItemsCompleteResult, err error) {
