...
func (c DriveItemClient) PreviewDriveItem(ctx context.Context, id beta.UserIdDriveIdItemId, input PreviewDriveItemRequest, options PreviewDriveItemOperationOptions) (result PreviewDriveItemOperationResponse, err error) {
