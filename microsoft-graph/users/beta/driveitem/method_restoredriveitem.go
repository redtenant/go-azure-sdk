...
// bin.
func (c DriveItemClient) RestoreDriveItem(ctx context.Context, id beta.UserIdDriveIdItemId, input RestoreDriveItemRequest, options RestoreDriveItemOperationOptions) (result RestoreDriveItemOperationResponse, err error) {
