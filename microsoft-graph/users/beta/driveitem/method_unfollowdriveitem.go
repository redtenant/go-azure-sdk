...
func (c DriveItemClient) UnfollowDriveItem(ctx context.Context, id beta.UserIdDriveIdItemId, options UnfollowDriveItemOperationOptions) (result UnfollowDriveItemOperationResponse, err error) {
