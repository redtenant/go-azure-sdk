...
func (c DriveItemClient) UpdateDriveItem(ctx context.Context, id beta.UserIdDriveIdItemId, input beta.DriveItem, options UpdateDriveItemOperationOptions) (result UpdateDriveItemOperationResponse, err error) {
