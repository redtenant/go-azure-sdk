...
func (c DriveItemClient) ValidateDriveItemPermission(ctx context.Context, id beta.UserIdDriveIdItemId, input ValidateDriveItemPermissionRequest, options ValidateDriveItemPermissionOperationOptions) (result ValidateDriveItemPermissionOperationResponse, err error) {
