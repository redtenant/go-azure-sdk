...
func (c DriveItemAnalyticsClient) UpdateDriveItemAnalytic(ctx context.Context, id beta.UserIdDriveIdItemId, input beta.ItemAnalytics, options UpdateDriveItemAnalyticOperationOptions) (result UpdateDriveItemAnalyticOperationResponse, err error) {
