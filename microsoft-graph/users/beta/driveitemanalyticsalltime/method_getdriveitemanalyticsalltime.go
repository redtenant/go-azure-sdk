...
func (c DriveItemAnalyticsAllTimeClient) GetDriveItemAnalyticsAllTime(ctx context.Context, id beta.UserIdDriveIdItemId, options GetDriveItemAnalyticsAllTimeOperationOptions) (result GetDriveItemAnalyticsAllTimeOperationResponse, err error) {
