...
func (c DriveItemAnalyticsItemActivityStatActivityClient) CreateDriveItemAnalyticsItemActivityStatActivity(ctx context.Context, id beta.UserIdDriveIdItemIdAnalyticsItemActivityStatId, input beta.ItemActivity, options CreateDriveItemAnalyticsItemActivityStatActivityOperationOptions) (result CreateDriveItemAnalyticsItemActivityStatActivityOperationResponse, err error) {
