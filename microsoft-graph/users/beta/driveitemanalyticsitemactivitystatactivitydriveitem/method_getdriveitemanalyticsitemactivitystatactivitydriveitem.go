...
// GetDriveItemAnalyticsItemActivityStatActivityDriveItem - Get driveItem from users. Exposes the driveItem that was the
// target of this activity.
func (c DriveItemAnalyticsItemActivityStatActivityDriveItemClient) GetDriveItemAnalyticsItemActivityStatActivityDriveItem(ctx context.Context, id beta.UserIdDriveIdItemIdAnalyticsItemActivityStatIdActivityId, options GetDriveItemAnalyticsItemActivityStatActivityDriveItemOperationOptions) (result GetDriveItemAnalyticsItemActivityStatActivityDriveItemOperationResponse, err error) {
