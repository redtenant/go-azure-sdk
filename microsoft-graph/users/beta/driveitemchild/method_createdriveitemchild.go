...
func (c DriveItemChildClient) CreateDriveItemChild(ctx context.Context, id beta.UserIdDriveIdItemId, input beta.DriveItem, options CreateDriveItemChildOperationOptions) (result CreateDriveItemChildOperationResponse, err error) {
