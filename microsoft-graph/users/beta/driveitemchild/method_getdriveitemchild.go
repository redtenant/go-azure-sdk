...
func (c DriveItemChildClient) GetDriveItemChild(ctx context.Context, id beta.UserIdDriveIdItemIdChildId, options GetDriveItemChildOperationOptions) (result GetDriveItemChildOperationResponse, err error) {
