...
func (c DriveItemChildClient) GetDriveItemChildrenCount(ctx context.Context, id beta.UserIdDriveIdItemId, options GetDriveItemChildrenCountOperationOptions) (result GetDriveItemChildrenCountOperationResponse, err error) {
