...
func (c DriveItemChildContentClient) DeleteDriveItemChildContent(ctx context.Context, id beta.UserIdDriveIdItemIdChildId, options DeleteDriveItemChildContentOperationOptions) (result DeleteDriveItemChildContentOperationResponse, err error) {
