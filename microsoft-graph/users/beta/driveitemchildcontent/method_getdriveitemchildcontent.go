...
func (c DriveItemChildContentClient) GetDriveItemChildContent(ctx context.Context, id beta.UserIdDriveIdItemIdChildId, options GetDriveItemChildContentOperationOptions) (result GetDriveItemChildContentOperationResponse, err error) {
