...
func (c DriveItemChildContentClient) SetDriveItemChildContent(ctx context.Context, id beta.UserIdDriveIdItemIdChildId, input []byte, options SetDriveItemChildContentOperationOptions) (result SetDriveItemChildContentOperationResponse, err error) {
