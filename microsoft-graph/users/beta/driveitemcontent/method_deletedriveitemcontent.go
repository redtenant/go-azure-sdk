...
// DeleteDriveItemContent - Delete content for the navigation property items in users. The content stream, if the item
...
func (c DriveItemContentClient) DeleteDriveItemContent(ctx context.Context, id beta.UserIdDriveIdItemId, options DeleteDriveItemContentOperationOptions) (result DeleteDriveItemContentOperationResponse, err error) {
