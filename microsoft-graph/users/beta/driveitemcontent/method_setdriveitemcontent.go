...
// SetDriveItemContent - Update content for the navigation property items in users. The content stream, if the item
...
func (c DriveItemContentClient) SetDriveItemContent(ctx context.Context, id beta.UserIdDriveIdItemId, input []byte, options SetDriveItemContentOperationOptions) (result SetDriveItemContentOperationResponse, err error) {
