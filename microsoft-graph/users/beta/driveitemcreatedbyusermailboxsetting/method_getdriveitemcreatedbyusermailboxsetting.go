...
func (c DriveItemCreatedByUserMailboxSettingClient) GetDriveItemCreatedByUserMailboxSetting(ctx context.Context, id beta.UserIdDriveIdItemId, options GetDriveItemCreatedByUserMailboxSettingOperationOptions) (result GetDriveItemCreatedByUserMailboxSettingOperationResponse, err error) {
