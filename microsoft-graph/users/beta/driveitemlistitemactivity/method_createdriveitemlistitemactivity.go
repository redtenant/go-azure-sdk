...
// CreateDriveItemListItemActivity - Create new navigation property to activities for users
func (c DriveItemListItemActivityClient) CreateDriveItemListItemActivity(ctx context.Context, id beta.UserIdDriveIdItemId, input beta.ItemActivityOLD, options CreateDriveItemListItemActivityOperationOptions) (result CreateDriveItemListItemActivityOperationResponse, err error) {
