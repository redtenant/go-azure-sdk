...
// UpdateDriveItemListItemActivity - Update the navigation property activities in users
func (c DriveItemListItemActivityClient) UpdateDriveItemListItemActivity(ctx context.Context, id beta.UserIdDriveIdItemIdListItemActivityId, input beta.ItemActivityOLD, options UpdateDriveItemListItemActivityOperationOptions) (result UpdateDriveItemListItemActivityOperationResponse, err error) {
