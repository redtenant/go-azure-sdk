...
// DeleteDriveItemListItemActivityContentStream - Delete contentStream for the navigation property driveItem in users.
// The content stream, if the item represents a file.
func (c DriveItemListItemActivityDriveItemContentStreamClient) DeleteDriveItemListItemActivityContentStream(ctx context.Context, id beta.UserIdDriveIdItemIdListItemActivityId, options DeleteDriveItemListItemActivityContentStreamOperationOptions) (result DeleteDriveItemListItemActivityContentStreamOperationResponse, err error) {
