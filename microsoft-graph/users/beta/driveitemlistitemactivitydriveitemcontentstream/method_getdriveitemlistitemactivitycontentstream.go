...
// GetDriveItemListItemActivityContentStream - Get contentStream for the navigation property driveItem from users. The
// content stream, if the item represents a file.
func (c DriveItemListItemActivityDriveItemContentStreamClient) GetDriveItemListItemActivityContentStream(ctx context.Context, id beta.UserIdDriveIdItemIdListItemActivityId, options GetDriveItemListItemActivityContentStreamOperationOptions) (result GetDriveItemListItemActivityContentStreamOperationResponse, err error) {
