...
// SetDriveItemListItemActivityContentStream - Update contentStream for the navigation property driveItem in users. The
// content stream, if the item represents a file.
func (c DriveItemListItemActivityDriveItemContentStreamClient) SetDriveItemListItemActivityContentStream(ctx context.Context, id beta.UserIdDriveIdItemIdListItemActivityId, input []byte, options SetDriveItemListItemActivityContentStreamOperationOptions) (result SetDriveItemListItemActivityContentStreamOperationResponse, err error) {
