...
// GetDriveItemListItemCreatedByUser - Get createdByUser from users
func (c DriveItemListItemCreatedByUserClient) GetDriveItemListItemCreatedByUser(ctx context.Context, id beta.UserIdDriveIdItemId, options GetDriveItemListItemCreatedByUserOperationOptions) (result GetDriveItemListItemCreatedByUserOperationResponse, err error) {
