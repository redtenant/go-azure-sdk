...
// on $select.
func (c DriveItemListItemCreatedByUserMailboxSettingClient) GetDriveItemListItemCreatedByUserMailboxSetting(ctx context.Context, id beta.UserIdDriveIdItemId, options GetDriveItemListItemCreatedByUserMailboxSettingOperationOptions) (result GetDriveItemListItemCreatedByUserMailboxSettingOperationResponse, err error) {
