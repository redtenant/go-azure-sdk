...
func (c DriveItemListItemDocumentSetVersionClient) CreateDriveItemListItemDocumentSetVersion(ctx context.Context, id beta.UserIdDriveIdItemId, input beta.DocumentSetVersion, options CreateDriveItemListItemDocumentSetVersionOperationOptions) (result CreateDriveItemListItemDocumentSetVersionOperationResponse, err error) {
