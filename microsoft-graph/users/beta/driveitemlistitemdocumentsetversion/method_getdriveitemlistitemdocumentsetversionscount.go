...
func (c DriveItemListItemDocumentSetVersionClient) GetDriveItemListItemDocumentSetVersionsCount(ctx context.Context, id beta.UserIdDriveIdItemId, options GetDriveItemListItemDocumentSetVersionsCountOperationOptions) (result GetDriveItemListItemDocumentSetVersionsCountOperationResponse, err error) {
