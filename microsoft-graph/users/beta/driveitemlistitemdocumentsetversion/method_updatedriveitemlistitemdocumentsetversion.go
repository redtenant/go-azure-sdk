...
// UpdateDriveItemListItemDocumentSetVersion - Update the navigation property documentSetVersions in users
func (c DriveItemListItemDocumentSetVersionClient) UpdateDriveItemListItemDocumentSetVersion(ctx context.Context, id beta.UserIdDriveIdItemIdListItemDocumentSetVersionId, input beta.DocumentSetVersion, options UpdateDriveItemListItemDocumentSetVersionOperationOptions) (result UpdateDriveItemListItemDocumentSetVersionOperationResponse, err error) {
