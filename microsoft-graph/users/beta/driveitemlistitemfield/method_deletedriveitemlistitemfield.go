...
func (c DriveItemListItemFieldClient) DeleteDriveItemListItemField(ctx context.Context, id beta.UserIdDriveIdItemId, options DeleteDriveItemListItemFieldOperationOptions) (result DeleteDriveItemListItemFieldOperationResponse, err error) {
