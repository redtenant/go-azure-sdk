...
func (c DriveItemListItemFieldClient) GetDriveItemListItemField(ctx context.Context, id beta.UserIdDriveIdItemId, options GetDriveItemListItemFieldOperationOptions) (result GetDriveItemListItemFieldOperationResponse, err error) {
