...
// on $select.
func (c DriveItemListItemLastModifiedByUserMailboxSettingClient) GetDriveItemListItemLastModifiedByUserMailboxSetting(ctx context.Context, id beta.UserIdDriveIdItemId, options GetDriveItemListItemLastModifiedByUserMailboxSettingOperationOptions) (result GetDriveItemListItemLastModifiedByUserMailboxSettingOperationResponse, err error) {
