...
func (c DriveItemListItemPermissionClient) CreateDriveItemListItemPermission(ctx context.Context, id beta.UserIdDriveIdItemId, input beta.Permission, options CreateDriveItemListItemPermissionOperationOptions) (result CreateDriveItemListItemPermissionOperationResponse, err error) {
