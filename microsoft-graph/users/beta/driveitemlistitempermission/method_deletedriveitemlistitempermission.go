...
func (c DriveItemListItemPermissionClient) DeleteDriveItemListItemPermission(ctx context.Context, id beta.UserIdDriveIdItemIdListItemPermissionId, options DeleteDriveItemListItemPermissionOperationOptions) (result DeleteDriveItemListItemPermissionOperationResponse, err error) {
