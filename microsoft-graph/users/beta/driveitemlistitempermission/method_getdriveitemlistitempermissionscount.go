...
func (c DriveItemListItemPermissionClient) GetDriveItemListItemPermissionsCount(ctx context.Context, id beta.UserIdDriveIdItemId, options GetDriveItemListItemPermissionsCountOperationOptions) (result GetDriveItemListItemPermissionsCountOperationResponse, err error) {
