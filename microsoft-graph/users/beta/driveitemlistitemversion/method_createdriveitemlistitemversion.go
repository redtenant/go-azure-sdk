...
func (c DriveItemListItemVersionClient) CreateDriveItemListItemVersion(ctx context.Context, id beta.UserIdDriveIdItemId, input beta.ListItemVersion, options CreateDriveItemListItemVersionOperationOptions) (result CreateDriveItemListItemVersionOperationResponse, err error) {
