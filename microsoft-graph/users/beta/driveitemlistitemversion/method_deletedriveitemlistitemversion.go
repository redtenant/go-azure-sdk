...
func (c DriveItemListItemVersionClient) DeleteDriveItemListItemVersion(ctx context.Context, id beta.UserIdDriveIdItemIdListItemVersionId, options DeleteDriveItemListItemVersionOperationOptions) (result DeleteDriveItemListItemVersionOperationResponse, err error) {
