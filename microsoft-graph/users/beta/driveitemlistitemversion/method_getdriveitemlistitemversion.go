...
func (c DriveItemListItemVersionClient) GetDriveItemListItemVersion(ctx context.Context, id beta.UserIdDriveIdItemIdListItemVersionId, options GetDriveItemListItemVersionOperationOptions) (result GetDriveItemListItemVersionOperationResponse, err error) {
