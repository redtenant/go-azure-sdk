...
func (c DriveItemListItemVersionClient) GetDriveItemListItemVersionsCount(ctx context.Context, id beta.UserIdDriveIdItemId, options GetDriveItemListItemVersionsCountOperationOptions) (result GetDriveItemListItemVersionsCountOperationResponse, err error) {
