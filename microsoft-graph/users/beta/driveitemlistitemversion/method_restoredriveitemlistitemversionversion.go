...
func (c DriveItemListItemVersionClient) RestoreDriveItemListItemVersionVersion(ctx context.Context, id beta.UserIdDriveIdItemIdListItemVersionId, options RestoreDriveItemListItemVersionVersionOperationOptions) (result RestoreDriveItemListItemVersionVersionOperationResponse, err error) {
