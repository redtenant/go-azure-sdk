...
// the list item.
func (c DriveItemListItemVersionFieldClient) GetDriveItemListItemVersionField(ctx context.Context, id beta.UserIdDriveIdItemIdListItemVersionId, options GetDriveItemListItemVersionFieldOperationOptions) (result GetDriveItemListItemVersionFieldOperationResponse, err error) {
