...
func (c DriveItemPermissionClient) CreateDriveItemPermission(ctx context.Context, id beta.UserIdDriveIdItemId, input beta.Permission, options CreateDriveItemPermissionOperationOptions) (result CreateDriveItemPermissionOperationResponse, err error) {
