...
func (c DriveItemPermissionClient) DeleteDriveItemPermission(ctx context.Context, id beta.UserIdDriveIdItemIdPermissionId, options DeleteDriveItemPermissionOperationOptions) (result DeleteDriveItemPermissionOperationResponse, err error) {
