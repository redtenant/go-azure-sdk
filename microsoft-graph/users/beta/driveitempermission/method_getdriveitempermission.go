...
func (c DriveItemPermissionClient) GetDriveItemPermission(ctx context.Context, id beta.UserIdDriveIdItemIdPermissionId, options GetDriveItemPermissionOperationOptions) (result GetDriveItemPermissionOperationResponse, err error) {
