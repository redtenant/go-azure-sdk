...
func (c DriveItemPermissionClient) GetDriveItemPermissionsCount(ctx context.Context, id beta.UserIdDriveIdItemId, options GetDriveItemPermissionsCountOperationOptions) (result GetDriveItemPermissionsCountOperationResponse, err error) {
