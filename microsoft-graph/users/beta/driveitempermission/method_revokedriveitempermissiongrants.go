...
func DefaultRevokeDriveItemPermissionGrantsOperationOptions() RevokeDriveItemPermissionGrantsOperationOptions {
	return RevokeDriveItemPermissionGrantsOperationOptions{}
}
...
// RevokeDriveItemPermissionGrants - Invoke action revokeGrants. Revoke access to a listItem or driveItem granted via a
// sharing link by removing the specified recipient from the link.
func (c DriveItemPermissionClient) RevokeDriveItemPermissionGrants(ctx context.Context, id beta.UserIdDriveIdItemIdPermissionId, input RevokeDriveItemPermissionGrantsRequest, options RevokeDriveItemPermissionGrantsOperationOptions) (result RevokeDriveItemPermissionGrantsOperationResponse, err error) {
