...
func (c DriveItemPermissionClient) UpdateDriveItemPermission(ctx context.Context, id beta.UserIdDriveIdItemIdPermissionId, input beta.Permission, options UpdateDriveItemPermissionOperationOptions) (result UpdateDriveItemPermissionOperationResponse, err error) {
