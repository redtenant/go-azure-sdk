...
func (c DriveItemRetentionLabelClient) UpdateDriveItemRetentionLabel(ctx context.Context, id beta.UserIdDriveIdItemId, input beta.ItemRetentionLabel, options UpdateDriveItemRetentionLabelOperationOptions) (result UpdateDriveItemRetentionLabelOperationResponse, err error) {
