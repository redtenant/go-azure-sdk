...
func (c DriveItemSubscriptionClient) CreateDriveItemSubscription(ctx context.Context, id beta.UserIdDriveIdItemId, input beta.Subscription, options CreateDriveItemSubscriptionOperationOptions) (result CreateDriveItemSubscriptionOperationResponse, err error) {
