...
func (c DriveItemSubscriptionClient) CreateDriveItemSubscriptionReauthorize(ctx context.Context, id beta.UserIdDriveIdItemIdSubscriptionId, options CreateDriveItemSubscriptionReauthorizeOperationOptions) (result CreateDriveItemSubscriptionReauthorizeOperationResponse, err error) {
