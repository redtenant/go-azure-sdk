...
func (c DriveItemSubscriptionClient) DeleteDriveItemSubscription(ctx context.Context, id beta.UserIdDriveIdItemIdSubscriptionId, options DeleteDriveItemSubscriptionOperationOptions) (result DeleteDriveItemSubscriptionOperationResponse, err error) {
