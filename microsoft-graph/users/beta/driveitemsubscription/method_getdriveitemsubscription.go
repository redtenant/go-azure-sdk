...
// root of a drive.
func (c DriveItemSubscriptionClient) GetDriveItemSubscription(ctx context.Context, id beta.UserIdDriveIdItemIdSubscriptionId, options GetDriveItemSubscriptionOperationOptions) (result GetDriveItemSubscriptionOperationResponse, err error) {
