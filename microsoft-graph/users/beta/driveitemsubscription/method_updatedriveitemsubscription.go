...
func (c DriveItemSubscriptionClient) UpdateDriveItemSubscription(ctx context.Context, id beta.UserIdDriveIdItemIdSubscriptionId, input beta.Subscription, options UpdateDriveItemSubscriptionOperationOptions) (result UpdateDriveItemSubscriptionOperationResponse, err error) {
