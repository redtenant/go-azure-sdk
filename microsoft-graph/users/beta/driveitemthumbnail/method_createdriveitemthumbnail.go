...
func (c DriveItemThumbnailClient) CreateDriveItemThumbnail(ctx context.Context, id beta.UserIdDriveIdItemId, input beta.ThumbnailSet, options CreateDriveItemThumbnailOperationOptions) (result CreateDriveItemThumbnailOperationResponse, err error) {
