...
func (c DriveItemThumbnailClient) DeleteDriveItemThumbnail(ctx context.Context, id beta.UserIdDriveIdItemIdThumbnailId, options DeleteDriveItemThumbnailOperationOptions) (result DeleteDriveItemThumbnailOperationResponse, err error) {
