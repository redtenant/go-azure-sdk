...
func (c DriveItemThumbnailClient) GetDriveItemThumbnail(ctx context.Context, id beta.UserIdDriveIdItemIdThumbnailId, options GetDriveItemThumbnailOperationOptions) (result GetDriveItemThumbnailOperationResponse, err error) {
