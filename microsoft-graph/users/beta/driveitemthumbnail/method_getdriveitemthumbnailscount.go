...
func (c DriveItemThumbnailClient) GetDriveItemThumbnailsCount(ctx context.Context, id beta.UserIdDriveIdItemId, options GetDriveItemThumbnailsCountOperationOptions) (result GetDriveItemThumbnailsCountOperationResponse, err error) {
