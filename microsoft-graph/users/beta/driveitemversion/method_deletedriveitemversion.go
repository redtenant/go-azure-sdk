...
func (c DriveItemVersionClient) DeleteDriveItemVersion(ctx context.Context, id beta.UserIdDriveIdItemIdVersionId, options DeleteDriveItemVersionOperationOptions) (result DeleteDriveItemVersionOperationResponse, err error) {
