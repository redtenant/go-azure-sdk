...
func (c DriveItemVersionClient) GetDriveItemVersionsCount(ctx context.Context, id beta.UserIdDriveIdItemId, options GetDriveItemVersionsCountOperationOptions) (result GetDriveItemVersionsCountOperationResponse, err error) {
