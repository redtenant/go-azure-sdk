...
// ListDriveItemVersions - Get versions from users. The list of previous versions of the item. For more info, see
// getting previous versions. Read-only. Nullable.
func (c DriveItemVersionClient) ListDriveItemVersions(ctx context.Context, id beta.UserIdDriveIdItemId, options ListDriveItemVersionsOperationOptions) (result ListDriveItemVersionsOperationResponse, err error) {
...
func (c DriveItemVersionClient) ListDriveItemVersionsComplete(ctx context.Context, id beta.UserIdDriveIdItemId, options ListDriveItemVersionsOperationOptions) (ListDriveItemVersionsCompleteResult, error) {
...
func (c DriveItemVersionClient) ListDriveItemVersionsCompleteMatchingPredicate(ctx context.Context, id beta.UserIdDriveIdItemId, options ListDriveItemVersionsOperationOptions, predicate DriveItemVersionOperationPredicate) (result ListDriveItemVersionsCompleteResult, err error) {
