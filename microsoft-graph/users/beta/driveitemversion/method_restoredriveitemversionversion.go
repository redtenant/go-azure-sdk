...
func (c DriveItemVersionClient) RestoreDriveItemVersionVersion(ctx context.Context, id beta.UserIdDriveIdItemIdVersionId, options RestoreDriveItemVersionVersionOperationOptions) (result RestoreDriveItemVersionVersionOperationResponse, err error) {
