...
func (c DriveItemVersionClient) UpdateDriveItemVersion(ctx context.Context, id beta.UserIdDriveIdItemIdVersionId, input beta.DriveItemVersion, options UpdateDriveItemVersionOperationOptions) (result UpdateDriveItemVersionOperationResponse, err error) {
