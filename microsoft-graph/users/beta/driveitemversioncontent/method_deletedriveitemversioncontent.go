...
// DeleteDriveItemVersionContent - Delete content for the navigation property versions in users
func (c DriveItemVersionContentClient) DeleteDriveItemVersionContent(ctx context.Context, id beta.UserIdDriveIdItemIdVersionId, options DeleteDriveItemVersionContentOperationOptions) (result DeleteDriveItemVersionContentOperationResponse, err error) {
