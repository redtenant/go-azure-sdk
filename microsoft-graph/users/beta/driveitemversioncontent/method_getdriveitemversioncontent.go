...
// GetDriveItemVersionContent - Get content for the navigation property versions from users
func (c DriveItemVersionContentClient) GetDriveItemVersionContent(ctx context.Context, id beta.UserIdDriveIdItemIdVersionId, options GetDriveItemVersionContentOperationOptions) (result GetDriveItemVersionContentOperationResponse, err error) {
