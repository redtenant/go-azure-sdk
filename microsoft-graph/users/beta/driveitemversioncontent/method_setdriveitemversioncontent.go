...
// SetDriveItemVersionContent - Update content for the navigation property versions in users
func (c DriveItemVersionContentClient) SetDriveItemVersionContent(ctx context.Context, id beta.UserIdDriveIdItemIdVersionId, input []byte, options SetDriveItemVersionContentOperationOptions) (result SetDriveItemVersionContentOperationResponse, err error) {
