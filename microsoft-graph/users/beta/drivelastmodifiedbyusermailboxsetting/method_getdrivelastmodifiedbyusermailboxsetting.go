...
func (c DriveLastModifiedByUserMailboxSettingClient) GetDriveLastModifiedByUserMailboxSetting(ctx context.Context, id beta.UserIdDriveId, options GetDriveLastModifiedByUserMailboxSettingOperationOptions) (result GetDriveLastModifiedByUserMailboxSettingOperationResponse, err error) {
