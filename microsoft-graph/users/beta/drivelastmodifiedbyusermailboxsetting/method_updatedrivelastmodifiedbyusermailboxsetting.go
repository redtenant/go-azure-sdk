...
func (c DriveLastModifiedByUserMailboxSettingClient) UpdateDriveLastModifiedByUserMailboxSetting(ctx context.Context, id beta.UserIdDriveId, input beta.MailboxSettings, options UpdateDriveLastModifiedByUserMailboxSettingOperationOptions) (result UpdateDriveLastModifiedByUserMailboxSettingOperationResponse, err error) {
