...
func (c DriveLastModifiedByUserServiceProvisioningErrorClient) GetDriveLastModifiedByUserServiceProvisioningErrorsCount(ctx context.Context, id beta.UserIdDriveId, options GetDriveLastModifiedByUserServiceProvisioningErrorsCountOperationOptions) (result GetDriveLastModifiedByUserServiceProvisioningErrorsCountOperationResponse, err error) {
