...
func (c DriveListColumnClient) DeleteDriveListColumn(ctx context.Context, id beta.UserIdDriveIdListColumnId, options DeleteDriveListColumnOperationOptions) (result DeleteDriveListColumnOperationResponse, err error) {
