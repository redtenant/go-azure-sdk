...
func (c DriveListColumnClient) GetDriveListColumn(ctx context.Context, id beta.UserIdDriveIdListColumnId, options GetDriveListColumnOperationOptions) (result GetDriveListColumnOperationResponse, err error) {
