...
// Updates – August 2021.
func (c DriveListContentTypeClient) AddDriveListContentTypesCopyFromHub(ctx context.Context, id beta.UserIdDriveId, input AddDriveListContentTypesCopyFromHubRequest, options AddDriveListContentTypesCopyFromHubOperationOptions) (result AddDriveListContentTypesCopyFromHubOperationResponse, err error) {
