...
func (c DriveListContentTypeClient) CopyDriveListContentTypeToDefaultContentLocation(ctx context.Context, id beta.UserIdDriveIdListContentTypeId, input CopyDriveListContentTypeToDefaultContentLocationRequest, options CopyDriveListContentTypeToDefaultContentLocationOperationOptions) (result CopyDriveListContentTypeToDefaultContentLocationOperationResponse, err error) {
