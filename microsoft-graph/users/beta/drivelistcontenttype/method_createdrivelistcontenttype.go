...
func (c DriveListContentTypeClient) CreateDriveListContentType(ctx context.Context, id beta.UserIdDriveId, input beta.ContentType, options CreateDriveListContentTypeOperationOptions) (result CreateDriveListContentTypeOperationResponse, err error) {
