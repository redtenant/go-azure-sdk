...
func (c DriveListContentTypeClient) CreateDriveListContentTypeUnpublish(ctx context.Context, id beta.UserIdDriveIdListContentTypeId, options CreateDriveListContentTypeUnpublishOperationOptions) (result CreateDriveListContentTypeUnpublishOperationResponse, err error) {
