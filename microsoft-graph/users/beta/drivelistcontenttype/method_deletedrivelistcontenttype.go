...
func (c DriveListContentTypeClient) DeleteDriveListContentType(ctx context.Context, id beta.UserIdDriveIdListContentTypeId, options DeleteDriveListContentTypeOperationOptions) (result DeleteDriveListContentTypeOperationResponse, err error) {
