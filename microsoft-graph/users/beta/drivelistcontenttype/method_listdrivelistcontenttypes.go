...
func (c DriveListContentTypeClient) ListDriveListContentTypes(ctx context.Context, id beta.UserIdDriveId, options ListDriveListContentTypesOperationOptions) (result ListDriveListContentTypesOperationResponse, err error) {
...
func (c DriveListContentTypeClient) ListDriveListContentTypesComplete(ctx context.Context, id beta.UserIdDriveId, options ListDriveListContentTypesOperationOptions) (ListDriveListContentTypesCompleteResult, error) {
...
func (c DriveListContentTypeClient) ListDriveListContentTypesCompleteMatchingPredicate(ctx context.Context, id beta.UserIdDriveId, options ListDriveListContentTypesOperationOptions, predicate ContentTypeOperationPredicate) (result ListDriveListContentTypesCompleteResult, err error) {
