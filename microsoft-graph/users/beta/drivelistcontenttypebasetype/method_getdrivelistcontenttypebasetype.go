...
// this content type.
func (c DriveListContentTypeBaseTypeClient) GetDriveListContentTypeBaseType(ctx context.Context, id beta.UserIdDriveIdListContentTypeIdBaseTypeId, options GetDriveListContentTypeBaseTypeOperationOptions) (result GetDriveListContentTypeBaseTypeOperationResponse, err error) {
