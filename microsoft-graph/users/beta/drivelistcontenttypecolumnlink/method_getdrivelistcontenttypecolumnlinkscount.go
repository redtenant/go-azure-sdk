...
func (c DriveListContentTypeColumnLinkClient) GetDriveListContentTypeColumnLinksCount(ctx context.Context, id beta.UserIdDriveIdListContentTypeId, options GetDriveListContentTypeColumnLinksCountOperationOptions) (result GetDriveListContentTypeColumnLinksCountOperationResponse, err error) {
