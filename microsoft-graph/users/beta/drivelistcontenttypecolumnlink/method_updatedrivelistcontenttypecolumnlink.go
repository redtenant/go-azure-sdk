...
func (c DriveListContentTypeColumnLinkClient) UpdateDriveListContentTypeColumnLink(ctx context.Context, id beta.UserIdDriveIdListContentTypeIdColumnLinkId, input beta.ColumnLink, options UpdateDriveListContentTypeColumnLinkOperationOptions) (result UpdateDriveListContentTypeColumnLinkOperationResponse, err error) {
