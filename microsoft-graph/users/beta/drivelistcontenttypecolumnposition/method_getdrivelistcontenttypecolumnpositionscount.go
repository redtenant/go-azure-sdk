...
func (c DriveListContentTypeColumnPositionClient) GetDriveListContentTypeColumnPositionsCount(ctx context.Context, id beta.UserIdDriveIdListContentTypeId, options GetDriveListContentTypeColumnPositionsCountOperationOptions) (result GetDriveListContentTypeColumnPositionsCountOperationResponse, err error) {
