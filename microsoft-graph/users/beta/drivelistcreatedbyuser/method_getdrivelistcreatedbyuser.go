...
// GetDriveListCreatedByUser - Get createdByUser from users
func (c DriveListCreatedByUserClient) GetDriveListCreatedByUser(ctx context.Context, id beta.UserIdDriveId, options GetDriveListCreatedByUserOperationOptions) (result GetDriveListCreatedByUserOperationResponse, err error) {
