...
func (c DriveListItemClient) CreateDriveListItemLink(ctx context.Context, id beta.UserIdDriveIdListItemId, input CreateDriveListItemLinkRequest, options CreateDriveListItemLinkOperationOptions) (result CreateDriveListItemLinkOperationResponse, err error) {
