...
func (c DriveListItemClient) DeleteDriveListItem(ctx context.Context, id beta.UserIdDriveIdListItemId, options DeleteDriveListItemOperationOptions) (result DeleteDriveListItemOperationResponse, err error) {
