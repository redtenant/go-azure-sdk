...
func (c DriveListItemClient) GetDriveListItem(ctx context.Context, id beta.UserIdDriveIdListItemId, options GetDriveListItemOperationOptions) (result GetDriveListItemOperationResponse, err error) {
