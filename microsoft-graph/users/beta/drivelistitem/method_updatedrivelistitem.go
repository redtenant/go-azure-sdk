...
func (c DriveListItemClient) UpdateDriveListItem(ctx context.Context, id beta.UserIdDriveIdListItemId, input beta.ListItem, options UpdateDriveListItemOperationOptions) (result UpdateDriveListItemOperationResponse, err error) {
