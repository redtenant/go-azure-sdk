...
// DeleteDriveListItemActivity - Delete navigation property activities for users
func (c DriveListItemActivityClient) DeleteDriveListItemActivity(ctx context.Context, id beta.UserIdDriveIdListItemIdActivityId, options DeleteDriveListItemActivityOperationOptions) (result DeleteDriveListItemActivityOperationResponse, err error) {
