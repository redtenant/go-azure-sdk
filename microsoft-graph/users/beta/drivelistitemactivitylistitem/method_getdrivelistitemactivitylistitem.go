...
// GetDriveListItemActivityListItem - Get listItem from users
func (c DriveListItemActivityListItemClient) GetDriveListItemActivityListItem(ctx context.Context, id beta.UserIdDriveIdListItemIdActivityId, options GetDriveListItemActivityListItemOperationOptions) (result GetDriveListItemActivityListItemOperationResponse, err error) {
