...
func (c DriveListItemCreatedByUserMailboxSettingClient) GetDriveListItemCreatedByUserMailboxSetting(ctx context.Context, id beta.UserIdDriveIdListItemId, options GetDriveListItemCreatedByUserMailboxSettingOperationOptions) (result GetDriveListItemCreatedByUserMailboxSettingOperationResponse, err error) {
