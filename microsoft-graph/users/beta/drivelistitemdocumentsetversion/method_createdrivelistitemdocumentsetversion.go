...
func (c DriveListItemDocumentSetVersionClient) CreateDriveListItemDocumentSetVersion(ctx context.Context, id beta.UserIdDriveIdListItemId, input beta.DocumentSetVersion, options CreateDriveListItemDocumentSetVersionOperationOptions) (result CreateDriveListItemDocumentSetVersionOperationResponse, err error) {
