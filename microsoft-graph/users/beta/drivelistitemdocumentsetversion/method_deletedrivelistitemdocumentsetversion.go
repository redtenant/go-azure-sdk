...
func (c DriveListItemDocumentSetVersionClient) DeleteDriveListItemDocumentSetVersion(ctx context.Context, id beta.UserIdDriveIdListItemIdDocumentSetVersionId, options DeleteDriveListItemDocumentSetVersionOperationOptions) (result DeleteDriveListItemDocumentSetVersionOperationResponse, err error) {
