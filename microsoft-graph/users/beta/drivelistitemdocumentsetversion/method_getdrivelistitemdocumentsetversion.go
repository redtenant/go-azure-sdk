...
func (c DriveListItemDocumentSetVersionClient) GetDriveListItemDocumentSetVersion(ctx context.Context, id beta.UserIdDriveIdListItemIdDocumentSetVersionId, options GetDriveListItemDocumentSetVersionOperationOptions) (result GetDriveListItemDocumentSetVersionOperationResponse, err error) {
