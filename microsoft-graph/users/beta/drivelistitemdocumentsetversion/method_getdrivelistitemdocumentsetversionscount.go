...
func (c DriveListItemDocumentSetVersionClient) GetDriveListItemDocumentSetVersionsCount(ctx context.Context, id beta.UserIdDriveIdListItemId, options GetDriveListItemDocumentSetVersionsCountOperationOptions) (result GetDriveListItemDocumentSetVersionsCountOperationResponse, err error) {
