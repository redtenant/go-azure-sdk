...
func (c DriveListItemDocumentSetVersionClient) ListDriveListItemDocumentSetVersions(ctx context.Context, id beta.UserIdDriveIdListItemId, options ListDriveListItemDocumentSetVersionsOperationOptions) (result ListDriveListItemDocumentSetVersionsOperationResponse, err error) {
...
func (c DriveListItemDocumentSetVersionClient) ListDriveListItemDocumentSetVersionsComplete(ctx context.Context, id beta.UserIdDriveIdListItemId, options ListDriveListItemDocumentSetVersionsOperationOptions) (ListDriveListItemDocumentSetVersionsCompleteResult, error) {
...
func (c DriveListItemDocumentSetVersionClient) ListDriveListItemDocumentSetVersionsCompleteMatchingPredicate(ctx context.Context, id beta.UserIdDriveIdListItemId, options ListDriveListItemDocumentSetVersionsOperationOptions, predicate DocumentSetVersionOperationPredicate) (result ListDriveListItemDocumentSetVersionsCompleteResult, err error) {
