...
func (c DriveListItemDocumentSetVersionClient) UpdateDriveListItemDocumentSetVersion(ctx context.Context, id beta.UserIdDriveIdListItemIdDocumentSetVersionId, input beta.DocumentSetVersion, options UpdateDriveListItemDocumentSetVersionOperationOptions) (result UpdateDriveListItemDocumentSetVersionOperationResponse, err error) {
