...
func (c DriveListItemDocumentSetVersionFieldClient) DeleteDriveListItemDocumentSetVersionField(ctx context.Context, id beta.UserIdDriveIdListItemIdDocumentSetVersionId, options DeleteDriveListItemDocumentSetVersionFieldOperationOptions) (result DeleteDriveListItemDocumentSetVersionFieldOperationResponse, err error) {
