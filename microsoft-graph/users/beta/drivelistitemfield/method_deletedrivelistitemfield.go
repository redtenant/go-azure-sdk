...
func (c DriveListItemFieldClient) DeleteDriveListItemField(ctx context.Context, id beta.UserIdDriveIdListItemId, options DeleteDriveListItemFieldOperationOptions) (result DeleteDriveListItemFieldOperationResponse, err error) {
