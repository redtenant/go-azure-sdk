...
func (c DriveListItemFieldClient) GetDriveListItemField(ctx context.Context, id beta.UserIdDriveIdListItemId, options GetDriveListItemFieldOperationOptions) (result GetDriveListItemFieldOperationResponse, err error) {
