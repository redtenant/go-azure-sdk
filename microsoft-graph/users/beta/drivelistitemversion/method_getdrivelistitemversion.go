...
func (c DriveListItemVersionClient) GetDriveListItemVersion(ctx context.Context, id beta.UserIdDriveIdListItemIdVersionId, options GetDriveListItemVersionOperationOptions) (result GetDriveListItemVersionOperationResponse, err error) {
