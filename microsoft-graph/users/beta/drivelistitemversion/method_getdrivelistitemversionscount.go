...
func (c DriveListItemVersionClient) GetDriveListItemVersionsCount(ctx context.Context, id beta.UserIdDriveIdListItemId, options GetDriveListItemVersionsCountOperationOptions) (result GetDriveListItemVersionsCountOperationResponse, err error) {
