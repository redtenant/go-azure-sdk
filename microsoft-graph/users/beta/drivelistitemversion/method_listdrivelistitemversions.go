...
func (c DriveListItemVersionClient) ListDriveListItemVersions(ctx context.Context, id beta.UserIdDriveIdListItemId, options ListDriveListItemVersionsOperationOptions) (result ListDriveListItemVersionsOperationResponse, err error) {
...
func (c DriveListItemVersionClient) ListDriveListItemVersionsComplete(ctx context.Context, id beta.UserIdDriveIdListItemId, options ListDriveListItemVersionsOperationOptions) (ListDriveListItemVersionsCompleteResult, error) {
...
func (c DriveListItemVersionClient) ListDriveListItemVersionsCompleteMatchingPredicate(ctx context.Context, id beta.UserIdDriveIdListItemId, options ListDriveListItemVersionsOperationOptions, predicate ListItemVersionOperationPredicate) (result ListDriveListItemVersionsCompleteResult, err error) {
