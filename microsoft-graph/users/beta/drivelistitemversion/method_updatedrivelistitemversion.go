...
func (c DriveListItemVersionClient) UpdateDriveListItemVersion(ctx context.Context, id beta.UserIdDriveIdListItemIdVersionId, input beta.ListItemVersion, options UpdateDriveListItemVersionOperationOptions) (result UpdateDriveListItemVersionOperationResponse, err error) {
