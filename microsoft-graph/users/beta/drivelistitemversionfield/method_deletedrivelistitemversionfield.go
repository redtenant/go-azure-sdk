...
func (c DriveListItemVersionFieldClient) DeleteDriveListItemVersionField(ctx context.Context, id beta.UserIdDriveIdListItemIdVersionId, options DeleteDriveListItemVersionFieldOperationOptions) (result DeleteDriveListItemVersionFieldOperationResponse, err error) {
