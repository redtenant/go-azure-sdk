...
// list item.
func (c DriveListItemVersionFieldClient) GetDriveListItemVersionField(ctx context.Context, id beta.UserIdDriveIdListItemIdVersionId, options GetDriveListItemVersionFieldOperationOptions) (result GetDriveListItemVersionFieldOperationResponse, err error) {
