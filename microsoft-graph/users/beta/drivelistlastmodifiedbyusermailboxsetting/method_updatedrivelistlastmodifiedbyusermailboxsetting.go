...
func (c DriveListLastModifiedByUserMailboxSettingClient) UpdateDriveListLastModifiedByUserMailboxSetting(ctx context.Context, id beta.UserIdDriveId, input beta.MailboxSettings, options UpdateDriveListLastModifiedByUserMailboxSettingOperationOptions) (result UpdateDriveListLastModifiedByUserMailboxSettingOperationResponse, err error) {
