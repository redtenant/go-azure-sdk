...
func (c DriveListOperationClient) CreateDriveListOperation(ctx context.Context, id beta.UserIdDriveId, input beta.RichLongRunningOperation, options CreateDriveListOperationOperationOptions) (result CreateDriveListOperationOperationResponse, err error) {
