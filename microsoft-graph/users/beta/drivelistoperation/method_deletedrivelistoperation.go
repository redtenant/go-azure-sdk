...
func (c DriveListOperationClient) DeleteDriveListOperation(ctx context.Context, id beta.UserIdDriveIdListOperationId, options DeleteDriveListOperationOperationOptions) (result DeleteDriveListOperationOperationResponse, err error) {
