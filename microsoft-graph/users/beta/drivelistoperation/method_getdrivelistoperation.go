...
func (c DriveListOperationClient) GetDriveListOperation(ctx context.Context, id beta.UserIdDriveIdListOperationId, options GetDriveListOperationOperationOptions) (result GetDriveListOperationOperationResponse, err error) {
