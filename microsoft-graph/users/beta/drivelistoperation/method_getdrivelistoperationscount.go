...
func (c DriveListOperationClient) GetDriveListOperationsCount(ctx context.Context, id beta.UserIdDriveId, options GetDriveListOperationsCountOperationOptions) (result GetDriveListOperationsCountOperationResponse, err error) {
