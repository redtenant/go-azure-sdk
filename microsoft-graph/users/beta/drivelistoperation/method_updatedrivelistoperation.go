...
func (c DriveListOperationClient) UpdateDriveListOperation(ctx context.Context, id beta.UserIdDriveIdListOperationId, input beta.RichLongRunningOperation, options UpdateDriveListOperationOperationOptions) (result UpdateDriveListOperationOperationResponse, err error) {
