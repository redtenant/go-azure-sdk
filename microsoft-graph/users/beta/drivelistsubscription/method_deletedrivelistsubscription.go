...
func (c DriveListSubscriptionClient) DeleteDriveListSubscription(ctx context.Context, id beta.UserIdDriveIdListSubscriptionId, options DeleteDriveListSubscriptionOperationOptions) (result DeleteDriveListSubscriptionOperationResponse, err error) {
