...
func (c DriveRootClient) AssignDriveRootSensitivityLabel(ctx context.Context, id beta.UserIdDriveId, input AssignDriveRootSensitivityLabelRequest, options AssignDriveRootSensitivityLabelOperationOptions) (result AssignDriveRootSensitivityLabelOperationResponse, err error) {
