...
func (c DriveRootClient) CheckinDriveRoot(ctx context.Context, id beta.UserIdDriveId, input CheckinDriveRootRequest, options CheckinDriveRootOperationOptions) (result CheckinDriveRootOperationResponse, err error) {
