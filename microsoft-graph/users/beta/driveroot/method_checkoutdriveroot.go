...
func (c DriveRootClient) CheckoutDriveRoot(ctx context.Context, id beta.UserIdDriveId, options CheckoutDriveRootOperationOptions) (result CheckoutDriveRootOperationResponse, err error) {
