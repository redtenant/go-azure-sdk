...
func (c DriveRootClient) DeleteDriveRoot(ctx context.Context, id beta.UserIdDriveId, options DeleteDriveRootOperationOptions) (result DeleteDriveRootOperationResponse, err error) {
