...
func (c DriveRootClient) ExtractDriveRootSensitivityLabels(ctx context.Context, id beta.UserIdDriveId, options ExtractDriveRootSensitivityLabelsOperationOptions) (result ExtractDriveRootSensitivityLabelsOperationResponse, err error) {
