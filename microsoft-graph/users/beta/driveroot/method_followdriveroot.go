...
func (c DriveRootClient) FollowDriveRoot(ctx context.Context, id beta.UserIdDriveId, options FollowDriveRootOperationOptions) (result FollowDriveRootOperationResponse, err error) {
