...
func (c DriveRootClient) GetDriveRoot(ctx context.Context, id beta.UserIdDriveId, options GetDriveRootOperationOptions) (result GetDriveRootOperationResponse, err error) {
