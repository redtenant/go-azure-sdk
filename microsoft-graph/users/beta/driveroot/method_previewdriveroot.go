...
func (c DriveRootClient) PreviewDriveRoot(ctx context.Context, id beta.UserIdDriveId, input PreviewDriveRootRequest, options PreviewDriveRootOperationOptions) (result PreviewDriveRootOperationResponse, err error) {
