...
// bin.
func (c DriveRootClient) RestoreDriveRoot(ctx context.Context, id beta.UserIdDriveId, input RestoreDriveRootRequest, options RestoreDriveRootOperationOptions) (result RestoreDriveRootOperationResponse, err error) {
