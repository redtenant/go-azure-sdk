...
func (c DriveRootClient) UpdateDriveRoot(ctx context.Context, id beta.UserIdDriveId, input beta.DriveItem, options UpdateDriveRootOperationOptions) (result UpdateDriveRootOperationResponse, err error) {
