...
func (c DriveRootClient) ValidateDriveRootPermission(ctx context.Context, id beta.UserIdDriveId, input ValidateDriveRootPermissionRequest, options ValidateDriveRootPermissionOperationOptions) (result ValidateDriveRootPermissionOperationResponse, err error) {
