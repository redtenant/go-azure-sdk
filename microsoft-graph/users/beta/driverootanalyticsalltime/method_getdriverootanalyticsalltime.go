...
func (c DriveRootAnalyticsAllTimeClient) GetDriveRootAnalyticsAllTime(ctx context.Context, id beta.UserIdDriveId, options GetDriveRootAnalyticsAllTimeOperationOptions) (result GetDriveRootAnalyticsAllTimeOperationResponse, err error) {
