...
// ListDriveRootAnalyticsItemActivityStats - Get itemActivityStats from users
func (c DriveRootAnalyticsItemActivityStatClient) ListDriveRootAnalyticsItemActivityStats(ctx context.Context, id beta.UserIdDriveId, options ListDriveRootAnalyticsItemActivityStatsOperationOptions) (result ListDriveRootAnalyticsItemActivityStatsOperationResponse, err error) {
...
func (c DriveRootAnalyticsItemActivityStatClient) ListDriveRootAnalyticsItemActivityStatsComplete(ctx context.Context, id beta.UserIdDriveId, options ListDriveRootAnalyticsItemActivityStatsOperationOptions) (ListDriveRootAnalyticsItemActivityStatsCompleteResult, error) {
