...
func (c DriveRootAnalyticsItemActivityStatActivityClient) UpdateDriveRootAnalyticsItemActivityStatActivity(ctx context.Context, id beta.UserIdDriveIdRootAnalyticsItemActivityStatIdActivityId, input beta.ItemActivity, options UpdateDriveRootAnalyticsItemActivityStatActivityOperationOptions) (result UpdateDriveRootAnalyticsItemActivityStatActivityOperationResponse, err error) {
