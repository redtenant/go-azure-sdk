...
func (c DriveRootAnalyticsItemActivityStatActivityDriveItemContentClient) GetDriveRootAnalyticsItemActivityStatActivityDriveItemContent(ctx context.Context, id beta.UserIdDriveIdRootAnalyticsItemActivityStatIdActivityId, options GetDriveRootAnalyticsItemActivityStatActivityDriveItemContentOperationOptions) (result GetDriveRootAnalyticsItemActivityStatActivityDriveItemContentOperationResponse, err error) {
