...
func (c DriveRootAnalyticsLastSevenDayClient) GetDriveRootAnalyticsLastSevenDay(ctx context.Context, id beta.UserIdDriveId, options GetDriveRootAnalyticsLastSevenDayOperationOptions) (result GetDriveRootAnalyticsLastSevenDayOperationResponse, err error) {
