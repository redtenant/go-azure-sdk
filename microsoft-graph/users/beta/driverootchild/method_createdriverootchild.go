...
func (c DriveRootChildClient) CreateDriveRootChild(ctx context.Context, id beta.UserIdDriveId, input beta.DriveItem, options CreateDriveRootChildOperationOptions) (result CreateDriveRootChildOperationResponse, err error) {
