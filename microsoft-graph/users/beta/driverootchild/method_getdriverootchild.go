...
func (c DriveRootChildClient) GetDriveRootChild(ctx context.Context, id beta.UserIdDriveIdRootChildId, options GetDriveRootChildOperationOptions) (result GetDriveRootChildOperationResponse, err error) {
