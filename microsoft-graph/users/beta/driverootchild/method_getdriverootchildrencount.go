...
func (c DriveRootChildClient) GetDriveRootChildrenCount(ctx context.Context, id beta.UserIdDriveId, options GetDriveRootChildrenCountOperationOptions) (result GetDriveRootChildrenCountOperationResponse, err error) {
