...
// GetDriveRootChildContent - Get content for the navigation property children from users. The content stream, if the
...
func (c DriveRootChildContentClient) GetDriveRootChildContent(ctx context.Context, id beta.UserIdDriveIdRootChildId, options GetDriveRootChildContentOperationOptions) (result GetDriveRootChildContentOperationResponse, err error) {
