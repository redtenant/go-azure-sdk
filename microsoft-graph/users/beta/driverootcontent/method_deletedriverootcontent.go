...
func (c DriveRootContentClient) DeleteDriveRootContent(ctx context.Context, id beta.UserIdDriveId, options DeleteDriveRootContentOperationOptions) (result DeleteDriveRootContentOperationResponse, err error) {
