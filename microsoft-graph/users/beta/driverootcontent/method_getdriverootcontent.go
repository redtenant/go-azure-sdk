...
func (c DriveRootContentClient) GetDriveRootContent(ctx context.Context, id beta.UserIdDriveId, options GetDriveRootContentOperationOptions) (result GetDriveRootContentOperationResponse, err error) {
