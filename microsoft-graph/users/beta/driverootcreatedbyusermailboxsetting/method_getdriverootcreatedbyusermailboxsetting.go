...
func (c DriveRootCreatedByUserMailboxSettingClient) GetDriveRootCreatedByUserMailboxSetting(ctx context.Context, id beta.UserIdDriveId, options GetDriveRootCreatedByUserMailboxSettingOperationOptions) (result GetDriveRootCreatedByUserMailboxSettingOperationResponse, err error) {
