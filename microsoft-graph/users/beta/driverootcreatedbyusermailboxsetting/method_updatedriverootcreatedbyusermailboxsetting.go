...
func (c DriveRootCreatedByUserMailboxSettingClient) UpdateDriveRootCreatedByUserMailboxSetting(ctx context.Context, id beta.UserIdDriveId, input beta.MailboxSettings, options UpdateDriveRootCreatedByUserMailboxSettingOperationOptions) (result UpdateDriveRootCreatedByUserMailboxSettingOperationResponse, err error) {
