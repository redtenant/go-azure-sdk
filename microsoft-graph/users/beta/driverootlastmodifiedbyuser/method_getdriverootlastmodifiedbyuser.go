...
// GetDriveRootLastModifiedByUser - Get lastModifiedByUser from users
func (c DriveRootLastModifiedByUserClient) GetDriveRootLastModifiedByUser(ctx context.Context, id beta.UserIdDriveId, options GetDriveRootLastModifiedByUserOperationOptions) (result GetDriveRootLastModifiedByUserOperationResponse, err error) {
