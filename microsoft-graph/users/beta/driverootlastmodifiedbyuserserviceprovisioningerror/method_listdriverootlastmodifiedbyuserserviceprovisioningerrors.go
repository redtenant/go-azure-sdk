...
func (c DriveRootLastModifiedByUserServiceProvisioningErrorClient) ListDriveRootLastModifiedByUserServiceProvisioningErrorsCompleteMatchingPredicate(ctx context.Context, id beta.UserIdDriveId, options ListDriveRootLastModifiedByUserServiceProvisioningErrorsOperationOptions, predicate ServiceProvisioningErrorOperationPredicate) (result ListDriveRootLastModifiedByUserServiceProvisioningErrorsCompleteResult, err error) {
