...
func (c DriveRootListItemActivityClient) DeleteDriveRootListItemActivity(ctx context.Context, id beta.UserIdDriveIdRootListItemActivityId, options DeleteDriveRootListItemActivityOperationOptions) (result DeleteDriveRootListItemActivityOperationResponse, err error) {
