...
func DefaultGetDriveRootListItemActivitiesCountOperationOptions() GetDriveRootListItemActivitiesCountOperationOptions {
	return GetDriveRootListItemActivitiesCountOperationOptions{}
}
...
func (c DriveRootListItemActivityClient) GetDriveRootListItemActivitiesCount(ctx context.Context, id beta.UserIdDriveId, options GetDriveRootListItemActivitiesCountOperationOptions) (result GetDriveRootListItemActivitiesCountOperationResponse, err error) {
	opts := client.RequestOptions{
		...
		Path:          fmt.Sprintf("%s/root/listItem/activities/$count", id.ID()),
