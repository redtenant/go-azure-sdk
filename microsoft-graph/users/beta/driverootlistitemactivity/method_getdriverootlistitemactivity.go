...
func (c DriveRootListItemActivityClient) GetDriveRootListItemActivity(ctx context.Context, id beta.UserIdDriveIdRootListItemActivityId, options GetDriveRootListItemActivityOperationOptions) (result GetDriveRootListItemActivityOperationResponse, err error) {
