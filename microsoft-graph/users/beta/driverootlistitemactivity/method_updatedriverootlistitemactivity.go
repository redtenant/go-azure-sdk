...
func (c DriveRootListItemActivityClient) UpdateDriveRootListItemActivity(ctx context.Context, id beta.UserIdDriveIdRootListItemActivityId, input beta.ItemActivityOLD, options UpdateDriveRootListItemActivityOperationOptions) (result UpdateDriveRootListItemActivityOperationResponse, err error) {
