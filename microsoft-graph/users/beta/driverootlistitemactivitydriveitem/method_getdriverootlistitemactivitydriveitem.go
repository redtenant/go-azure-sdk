...
// GetDriveRootListItemActivityDriveItem - Get driveItem from users
func (c DriveRootListItemActivityDriveItemClient) GetDriveRootListItemActivityDriveItem(ctx context.Context, id beta.UserIdDriveIdRootListItemActivityId, options GetDriveRootListItemActivityDriveItemOperationOptions) (result GetDriveRootListItemActivityDriveItemOperationResponse, err error) {
