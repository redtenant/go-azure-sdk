...
// DeleteDriveRootListItemActivityDriveItemContent - Delete content for the navigation property driveItem in users. The
...
func (c DriveRootListItemActivityDriveItemContentClient) DeleteDriveRootListItemActivityDriveItemContent(ctx context.Context, id beta.UserIdDriveIdRootListItemActivityId, options DeleteDriveRootListItemActivityDriveItemContentOperationOptions) (result DeleteDriveRootListItemActivityDriveItemContentOperationResponse, err error) {
