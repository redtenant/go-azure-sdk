...
// GetDriveRootListItemActivityDriveItemContent - Get content for the navigation property driveItem from users. The
...
func (c DriveRootListItemActivityDriveItemContentClient) GetDriveRootListItemActivityDriveItemContent(ctx context.Context, id beta.UserIdDriveIdRootListItemActivityId, options GetDriveRootListItemActivityDriveItemContentOperationOptions) (result GetDriveRootListItemActivityDriveItemContentOperationResponse, err error) {
