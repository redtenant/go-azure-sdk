...
func (c DriveRootListItemCreatedByUserServiceProvisioningErrorClient) GetDriveRootListItemCreatedByUserServiceProvisioningErrorsCount(ctx context.Context, id beta.UserIdDriveId, options GetDriveRootListItemCreatedByUserServiceProvisioningErrorsCountOperationOptions) (result GetDriveRootListItemCreatedByUserServiceProvisioningErrorsCountOperationResponse, err error) {
