...
func (c DriveRootListItemDriveItemContentClient) DeleteDriveRootListItemDriveItemContent(ctx context.Context, id beta.UserIdDriveId, options DeleteDriveRootListItemDriveItemContentOperationOptions) (result DeleteDriveRootListItemDriveItemContentOperationResponse, err error) {
