...
func (c DriveRootListItemDriveItemContentClient) SetDriveRootListItemDriveItemContent(ctx context.Context, id beta.UserIdDriveId, input []byte, options SetDriveRootListItemDriveItemContentOperationOptions) (result SetDriveRootListItemDriveItemContentOperationResponse, err error) {
