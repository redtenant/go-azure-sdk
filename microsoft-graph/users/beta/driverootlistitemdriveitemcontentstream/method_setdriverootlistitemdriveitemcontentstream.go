...
// SetDriveRootListItemDriveItemContentStream - Update contentStream for the navigation property driveItem in users. The
// content stream, if the item represents a file.
func (c DriveRootListItemDriveItemContentStreamClient) SetDriveRootListItemDriveItemContentStream(ctx context.Context, id beta.UserIdDriveId, input []byte, options SetDriveRootListItemDriveItemContentStreamOperationOptions) (result SetDriveRootListItemDriveItemContentStreamOperationResponse, err error) {
