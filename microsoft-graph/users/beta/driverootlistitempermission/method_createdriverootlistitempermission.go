...
func (c DriveRootListItemPermissionClient) CreateDriveRootListItemPermission(ctx context.Context, id beta.UserIdDriveId, input beta.Permission, options CreateDriveRootListItemPermissionOperationOptions) (result CreateDriveRootListItemPermissionOperationResponse, err error) {
