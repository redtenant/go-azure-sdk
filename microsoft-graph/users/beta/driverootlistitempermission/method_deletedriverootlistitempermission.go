...
func (c DriveRootListItemPermissionClient) DeleteDriveRootListItemPermission(ctx context.Context, id beta.UserIdDriveIdRootListItemPermissionId, options DeleteDriveRootListItemPermissionOperationOptions) (result DeleteDriveRootListItemPermissionOperationResponse, err error) {
