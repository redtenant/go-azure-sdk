...
// GetDriveRootListItemPermission - Get permissions from users. The set of permissions for the item. Read-only.
// Nullable.
func (c DriveRootListItemPermissionClient) GetDriveRootListItemPermission(ctx context.Context, id beta.UserIdDriveIdRootListItemPermissionId, options GetDriveRootListItemPermissionOperationOptions) (result GetDriveRootListItemPermissionOperationResponse, err error) {
