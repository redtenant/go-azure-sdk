...
func (c DriveRootListItemPermissionClient) GetDriveRootListItemPermissionsCount(ctx context.Context, id beta.UserIdDriveId, options GetDriveRootListItemPermissionsCountOperationOptions) (result GetDriveRootListItemPermissionsCountOperationResponse, err error) {
