...
// permission.
func (c DriveRootListItemPermissionClient) ListDriveRootListItemPermissionGrants(ctx context.Context, id beta.UserIdDriveIdRootListItemPermissionId, input ListDriveRootListItemPermissionGrantsRequest, options ListDriveRootListItemPermissionGrantsOperationOptions) (result ListDriveRootListItemPermissionGrantsOperationResponse, err error) {
...
func (c DriveRootListItemPermissionClient) ListDriveRootListItemPermissionGrantsComplete(ctx context.Context, id beta.UserIdDriveIdRootListItemPermissionId, input ListDriveRootListItemPermissionGrantsRequest, options ListDriveRootListItemPermissionGrantsOperationOptions) (ListDriveRootListItemPermissionGrantsCompleteResult, error) {
...
func (c DriveRootListItemPermissionClient) ListDriveRootListItemPermissionGrantsCompleteMatchingPredicate(ctx context.Context, id beta.UserIdDriveIdRootListItemPermissionId, input ListDriveRootListItemPermissionGrantsRequest, options ListDriveRootListItemPermissionGrantsOperationOptions, predicate PermissionOperationPredicate) (result ListDriveRootListItemPermissionGrantsCompleteResult, err error) {
