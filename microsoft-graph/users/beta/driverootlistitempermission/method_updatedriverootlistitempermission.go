...
func (c DriveRootListItemPermissionClient) UpdateDriveRootListItemPermission(ctx context.Context, id beta.UserIdDriveIdRootListItemPermissionId, input beta.Permission, options UpdateDriveRootListItemPermissionOperationOptions) (result UpdateDriveRootListItemPermissionOperationResponse, err error) {
