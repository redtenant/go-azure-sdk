...
func (c DriveRootListItemVersionFieldClient) DeleteDriveRootListItemVersionField(ctx context.Context, id beta.UserIdDriveIdRootListItemVersionId, options DeleteDriveRootListItemVersionFieldOperationOptions) (result DeleteDriveRootListItemVersionFieldOperationResponse, err error) {
