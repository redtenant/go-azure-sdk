...
// the list item.
func (c DriveRootListItemVersionFieldClient) GetDriveRootListItemVersionField(ctx context.Context, id beta.UserIdDriveIdRootListItemVersionId, options GetDriveRootListItemVersionFieldOperationOptions) (result GetDriveRootListItemVersionFieldOperationResponse, err error) {
