...
func (c DriveRootPermissionClient) DeleteDriveRootPermission(ctx context.Context, id beta.UserIdDriveIdRootPermissionId, options DeleteDriveRootPermissionOperationOptions) (result DeleteDriveRootPermissionOperationResponse, err error) {
