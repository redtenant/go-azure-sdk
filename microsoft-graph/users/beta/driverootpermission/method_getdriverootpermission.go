...
func (c DriveRootPermissionClient) GetDriveRootPermission(ctx context.Context, id beta.UserIdDriveIdRootPermissionId, options GetDriveRootPermissionOperationOptions) (result GetDriveRootPermissionOperationResponse, err error) {
