...
func (c DriveRootPermissionClient) GetDriveRootPermissionsCount(ctx context.Context, id beta.UserIdDriveId, options GetDriveRootPermissionsCountOperationOptions) (result GetDriveRootPermissionsCountOperationResponse, err error) {
