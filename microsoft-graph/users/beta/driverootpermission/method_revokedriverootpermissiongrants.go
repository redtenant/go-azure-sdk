...
func (c DriveRootPermissionClient) RevokeDriveRootPermissionGrants(ctx context.Context, id beta.UserIdDriveIdRootPermissionId, input RevokeDriveRootPermissionGrantsRequest, options RevokeDriveRootPermissionGrantsOperationOptions) (result RevokeDriveRootPermissionGrantsOperationResponse, err error) {
