...
func (c DriveRootRetentionLabelClient) DeleteDriveRootRetentionLabel(ctx context.Context, id beta.UserIdDriveId, options DeleteDriveRootRetentionLabelOperationOptions) (result DeleteDriveRootRetentionLabelOperationResponse, err error) {
