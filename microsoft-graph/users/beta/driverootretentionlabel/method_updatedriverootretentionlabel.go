...
func (c DriveRootRetentionLabelClient) UpdateDriveRootRetentionLabel(ctx context.Context, id beta.UserIdDriveId, input beta.ItemRetentionLabel, options UpdateDriveRootRetentionLabelOperationOptions) (result UpdateDriveRootRetentionLabelOperationResponse, err error) {
