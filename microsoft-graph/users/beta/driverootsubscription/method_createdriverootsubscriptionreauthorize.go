...
func (c DriveRootSubscriptionClient) CreateDriveRootSubscriptionReauthorize(ctx context.Context, id beta.UserIdDriveIdRootSubscriptionId, options CreateDriveRootSubscriptionReauthorizeOperationOptions) (result CreateDriveRootSubscriptionReauthorizeOperationResponse, err error) {
