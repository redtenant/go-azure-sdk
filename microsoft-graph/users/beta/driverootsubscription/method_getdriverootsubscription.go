...
// root of a drive.
func (c DriveRootSubscriptionClient) GetDriveRootSubscription(ctx context.Context, id beta.UserIdDriveIdRootSubscriptionId, options GetDriveRootSubscriptionOperationOptions) (result GetDriveRootSubscriptionOperationResponse, err error) {
