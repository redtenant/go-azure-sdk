...
func (c DriveRootSubscriptionClient) GetDriveRootSubscriptionsCount(ctx context.Context, id beta.UserIdDriveId, options GetDriveRootSubscriptionsCountOperationOptions) (result GetDriveRootSubscriptionsCountOperationResponse, err error) {
