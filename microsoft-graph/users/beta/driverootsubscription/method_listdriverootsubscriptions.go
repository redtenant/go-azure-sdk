...
// the root of a drive.
func (c DriveRootSubscriptionClient) ListDriveRootSubscriptions(ctx context.Context, id beta.UserIdDriveId, options ListDriveRootSubscriptionsOperationOptions) (result ListDriveRootSubscriptionsOperationResponse, err error) {
...
func (c DriveRootSubscriptionClient) ListDriveRootSubscriptionsComplete(ctx context.Context, id beta.UserIdDriveId, options ListDriveRootSubscriptionsOperationOptions) (ListDriveRootSubscriptionsCompleteResult, error) {
...
func (c DriveRootSubscriptionClient) ListDriveRootSubscriptionsCompleteMatchingPredicate(ctx context.Context, id beta.UserIdDriveId, options ListDriveRootSubscriptionsOperationOptions, predicate SubscriptionOperationPredicate) (result ListDriveRootSubscriptionsCompleteResult, err error) {
