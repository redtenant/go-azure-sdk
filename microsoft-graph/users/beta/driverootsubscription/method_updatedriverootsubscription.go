...
func (c DriveRootSubscriptionClient) UpdateDriveRootSubscription(ctx context.Context, id beta.UserIdDriveIdRootSubscriptionId, input beta.Subscription, options UpdateDriveRootSubscriptionOperationOptions) (result UpdateDriveRootSubscriptionOperationResponse, err error) {
