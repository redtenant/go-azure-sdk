...
func (c DriveRootThumbnailClient) GetDriveRootThumbnail(ctx context.Context, id beta.UserIdDriveIdRootThumbnailId, options GetDriveRootThumbnailOperationOptions) (result GetDriveRootThumbnailOperationResponse, err error) {
