...
func (c DriveRootThumbnailClient) GetDriveRootThumbnailsCount(ctx context.Context, id beta.UserIdDriveId, options GetDriveRootThumbnailsCountOperationOptions) (result GetDriveRootThumbnailsCountOperationResponse, err error) {
