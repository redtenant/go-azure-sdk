...
func (c DriveRootVersionClient) CreateDriveRootVersion(ctx context.Context, id beta.UserIdDriveId, input beta.DriveItemVersion, options CreateDriveRootVersionOperationOptions) (result CreateDriveRootVersionOperationResponse, err error) {
