...
func (c DriveRootVersionClient) DeleteDriveRootVersion(ctx context.Context, id beta.UserIdDriveIdRootVersionId, options DeleteDriveRootVersionOperationOptions) (result DeleteDriveRootVersionOperationResponse, err error) {
