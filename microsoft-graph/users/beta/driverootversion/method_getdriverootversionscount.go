...
func (c DriveRootVersionClient) GetDriveRootVersionsCount(ctx context.Context, id beta.UserIdDriveId, options GetDriveRootVersionsCountOperationOptions) (result GetDriveRootVersionsCountOperationResponse, err error) {
