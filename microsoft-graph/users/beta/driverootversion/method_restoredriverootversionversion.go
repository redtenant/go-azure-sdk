...
func (c DriveRootVersionClient) RestoreDriveRootVersionVersion(ctx context.Context, id beta.UserIdDriveIdRootVersionId, options RestoreDriveRootVersionVersionOperationOptions) (result RestoreDriveRootVersionVersionOperationResponse, err error) {
