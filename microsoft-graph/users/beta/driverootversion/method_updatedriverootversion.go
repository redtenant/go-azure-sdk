...
func (c DriveRootVersionClient) UpdateDriveRootVersion(ctx context.Context, id beta.UserIdDriveIdRootVersionId, input beta.DriveItemVersion, options UpdateDriveRootVersionOperationOptions) (result UpdateDriveRootVersionOperationResponse, err error) {
