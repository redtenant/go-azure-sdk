...
// DeleteDriveRootVersionContent - Delete content for the navigation property versions in users
func (c DriveRootVersionContentClient) DeleteDriveRootVersionContent(ctx context.Context, id beta.UserIdDriveIdRootVersionId, options DeleteDriveRootVersionContentOperationOptions) (result DeleteDriveRootVersionContentOperationResponse, err error) {
