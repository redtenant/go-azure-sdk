...
// GetDriveRootVersionContent - Get content for the navigation property versions from users
func (c DriveRootVersionContentClient) GetDriveRootVersionContent(ctx context.Context, id beta.UserIdDriveIdRootVersionId, options GetDriveRootVersionContentOperationOptions) (result GetDriveRootVersionContentOperationResponse, err error) {
