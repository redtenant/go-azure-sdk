...
func (c DriveSpecialClient) GetDriveSpecial(ctx context.Context, id beta.UserIdDriveIdSpecialId, options GetDriveSpecialOperationOptions) (result GetDriveSpecialOperationResponse, err error) {
