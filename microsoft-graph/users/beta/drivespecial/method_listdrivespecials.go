...
func (c DriveSpecialClient) ListDriveSpecials(ctx context.Context, id beta.UserIdDriveId, options ListDriveSpecialsOperationOptions) (result ListDriveSpecialsOperationResponse, err error) {
...
func (c DriveSpecialClient) ListDriveSpecialsComplete(ctx context.Context, id beta.UserIdDriveId, options ListDriveSpecialsOperationOptions) (ListDriveSpecialsCompleteResult, error) {
...
func (c DriveSpecialClient) ListDriveSpecialsCompleteMatchingPredicate(ctx context.Context, id beta.UserIdDriveId, options ListDriveSpecialsOperationOptions, predicate DriveItemOperationPredicate) (result ListDriveSpecialsCompleteResult, err error) {
