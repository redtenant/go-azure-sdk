...
func (c EmployeeExperienceClient) GetEmployeeExperience(ctx context.Context, id beta.UserId, options GetEmployeeExperienceOperationOptions) (result GetEmployeeExperienceOperationResponse, err error) {
