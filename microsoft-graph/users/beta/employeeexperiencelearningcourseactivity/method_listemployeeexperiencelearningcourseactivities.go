...
func (c EmployeeExperienceLearningCourseActivityClient) ListEmployeeExperienceLearningCourseActivities(ctx context.Context, id beta.UserId, options ListEmployeeExperienceLearningCourseActivitiesOperationOptions) (result ListEmployeeExperienceLearningCourseActivitiesOperationResponse, err error) {
...
func (c EmployeeExperienceLearningCourseActivityClient) ListEmployeeExperienceLearningCourseActivitiesComplete(ctx context.Context, id beta.UserId, options ListEmployeeExperienceLearningCourseActivitiesOperationOptions) (ListEmployeeExperienceLearningCourseActivitiesCompleteResult, error) {
