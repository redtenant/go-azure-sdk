...
func (c EventClient) AcceptEvent(ctx context.Context, id beta.UserIdEventId, input AcceptEventRequest, options AcceptEventOperationOptions) (result AcceptEventOperationResponse, err error) {
