...
func (c EventClient) DeclineEvent(ctx context.Context, id beta.UserIdEventId, input DeclineEventRequest, options DeclineEventOperationOptions) (result DeclineEventOperationResponse, err error) {
