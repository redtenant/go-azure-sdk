...
func (c EventClient) DeleteEvent(ctx context.Context, id beta.UserIdEventId, options DeleteEventOperationOptions) (result DeleteEventOperationResponse, err error) {
