...
// user calendar.
func (c EventClient) DismissEventReminder(ctx context.Context, id beta.UserIdEventId, options DismissEventReminderOperationOptions) (result DismissEventReminderOperationResponse, err error) {
