...
// account.
func (c EventClient) ForwardEvent(ctx context.Context, id beta.UserIdEventId, input ForwardEventRequest, options ForwardEventOperationOptions) (result ForwardEventOperationResponse, err error) {
