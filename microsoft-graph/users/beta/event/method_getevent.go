...
// GetEvent - Get events from users. The user's events. The default is to show events under the Default Calendar.
// Read-only. Nullable.
func (c EventClient) GetEvent(ctx context.Context, id beta.UserIdEventId, options GetEventOperationOptions) (result GetEventOperationResponse, err error) {
