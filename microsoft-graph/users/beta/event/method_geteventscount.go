...
func (c EventClient) GetEventsCount(ctx context.Context, id beta.UserId, options GetEventsCountOperationOptions) (result GetEventsCountOperationResponse, err error) {
