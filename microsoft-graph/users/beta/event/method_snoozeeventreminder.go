...
// time.
func (c EventClient) SnoozeEventReminder(ctx context.Context, id beta.UserIdEventId, input SnoozeEventReminderRequest, options SnoozeEventReminderOperationOptions) (result SnoozeEventReminderOperationResponse, err error) {
