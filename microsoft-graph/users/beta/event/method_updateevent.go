...
func (c EventClient) UpdateEvent(ctx context.Context, id beta.UserIdEventId, input beta.Event, options UpdateEventOperationOptions) (result UpdateEventOperationResponse, err error) {
