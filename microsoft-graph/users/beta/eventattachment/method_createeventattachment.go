...
func (c EventAttachmentClient) CreateEventAttachment(ctx context.Context, id beta.UserIdEventId, input beta.Attachment, options CreateEventAttachmentOperationOptions) (result CreateEventAttachmentOperationResponse, err error) {
