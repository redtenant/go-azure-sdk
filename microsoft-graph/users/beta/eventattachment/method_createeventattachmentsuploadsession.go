...
func (c EventAttachmentClient) CreateEventAttachmentsUploadSession(ctx context.Context, id beta.UserIdEventId, input CreateEventAttachmentsUploadSessionRequest, options CreateEventAttachmentsUploadSessionOperationOptions) (result CreateEventAttachmentsUploadSessionOperationResponse, err error) {
