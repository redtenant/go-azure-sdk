...
func (c EventAttachmentClient) DeleteEventAttachment(ctx context.Context, id beta.UserIdEventIdAttachmentId, options DeleteEventAttachmentOperationOptions) (result DeleteEventAttachmentOperationResponse, err error) {
