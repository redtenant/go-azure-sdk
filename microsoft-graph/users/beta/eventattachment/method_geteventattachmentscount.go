...
func (c EventAttachmentClient) GetEventAttachmentsCount(ctx context.Context, id beta.UserIdEventId, options GetEventAttachmentsCountOperationOptions) (result GetEventAttachmentsCountOperationResponse, err error) {
