...
func (c EventCalendarClient) GetEventCalendar(ctx context.Context, id beta.UserIdEventId, options GetEventCalendarOperationOptions) (result GetEventCalendarOperationResponse, err error) {
