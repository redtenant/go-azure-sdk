...
func DefaultCreateEventExceptionOccurrenceAttachmentOperationOptions() CreateEventExceptionOccurrenceAttachmentOperationOptions {
	return CreateEventExceptionOccurrenceAttachmentOperationOptions{}
}
...
// CreateEventExceptionOccurrenceAttachment - Create new navigation property to attachments for users
func (c EventExceptionOccurrenceAttachmentClient) CreateEventExceptionOccurrenceAttachment(ctx context.Context, id beta.UserIdEventIdExceptionOccurrenceId, input beta.Attachment, options CreateEventExceptionOccurrenceAttachmentOperationOptions) (result CreateEventExceptionOccurrenceAttachmentOperationResponse, err error) {
