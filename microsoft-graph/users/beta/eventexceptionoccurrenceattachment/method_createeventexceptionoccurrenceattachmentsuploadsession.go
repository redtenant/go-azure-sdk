...
func DefaultCreateEventExceptionOccurrenceAttachmentsUploadSessionOperationOptions() CreateEventExceptionOccurrenceAttachmentsUploadSessionOperationOptions {
	return CreateEventExceptionOccurrenceAttachmentsUploadSessionOperationOptions{}
}
...
// CreateEventExceptionOccurrenceAttachmentsUploadSession - Invoke action createUploadSession. Create an upload session
...
func (c EventExceptionOccurrenceAttachmentClient) CreateEventExceptionOccurrenceAttachmentsUploadSession(ctx context.Context, id beta.UserIdEventIdExceptionOccurrenceId, input CreateEventExceptionOccurrenceAttachmentsUploadSessionRequest, options CreateEventExceptionOccurrenceAttachmentsUploadSessionOperationOptions) (result CreateEventExceptionOccurrenceAttachmentsUploadSessionOperationResponse, err error) {
