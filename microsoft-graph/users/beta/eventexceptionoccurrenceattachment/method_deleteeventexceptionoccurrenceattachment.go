...
// DeleteEventExceptionOccurrenceAttachment - Delete navigation property attachments for users
func (c EventExceptionOccurrenceAttachmentClient) DeleteEventExceptionOccurrenceAttachment(ctx context.Context, id beta.UserIdEventIdExceptionOccurrenceIdAttachmentId, options DeleteEventExceptionOccurrenceAttachmentOperationOptions) (result DeleteEventExceptionOccurrenceAttachmentOperationResponse, err error) {
