...
func DefaultGetEventExceptionOccurrenceAttachmentOperationOptions() GetEventExceptionOccurrenceAttachmentOperationOptions {
	return GetEventExceptionOccurrenceAttachmentOperationOptions{}
}
...
// GetEventExceptionOccurrenceAttachment - Get attachments from users. The collection of FileAttachment, ItemAttachment,
// and referenceAttachment attachments for the event. Navigation property. Read-only. Nullable.
func (c EventExceptionOccurrenceAttachmentClient) GetEventExceptionOccurrenceAttachment(ctx context.Context, id beta.UserIdEventIdExceptionOccurrenceIdAttachmentId, options GetEventExceptionOccurrenceAttachmentOperationOptions) (result GetEventExceptionOccurrenceAttachmentOperationResponse, err error) {
