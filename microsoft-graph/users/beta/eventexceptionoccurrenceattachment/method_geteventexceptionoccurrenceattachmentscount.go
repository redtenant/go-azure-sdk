...
func DefaultGetEventExceptionOccurrenceAttachmentsCountOperationOptions() GetEventExceptionOccurrenceAttachmentsCountOperationOptions {
	return GetEventExceptionOccurrenceAttachmentsCountOperationOptions{}
}
...
func (c EventExceptionOccurrenceAttachmentClient) GetEventExceptionOccurrenceAttachmentsCount(ctx context.Context, id beta.UserIdEventIdExceptionOccurrenceId, options GetEventExceptionOccurrenceAttachmentsCountOperationOptions) (result GetEventExceptionOccurrenceAttachmentsCountOperationResponse, err error) {
