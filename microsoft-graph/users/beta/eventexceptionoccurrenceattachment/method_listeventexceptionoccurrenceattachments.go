...
// ListEventExceptionOccurrenceAttachments - Get attachments from users. The collection of FileAttachment,
// ItemAttachment, and referenceAttachment attachments for the event. Navigation property. Read-only. Nullable.
func (c EventExceptionOccurrenceAttachmentClient) ListEventExceptionOccurrenceAttachments(ctx context.Context, id beta.UserIdEventIdExceptionOccurrenceId, options ListEventExceptionOccurrenceAttachmentsOperationOptions) (result ListEventExceptionOccurrenceAttachmentsOperationResponse, err error) {
...
func (c EventExceptionOccurrenceAttachmentClient) ListEventExceptionOccurrenceAttachmentsComplete(ctx context.Context, id beta.UserIdEventIdExceptionOccurrenceId, options ListEventExceptionOccurrenceAttachmentsOperationOptions) (ListEventExceptionOccurrenceAttachmentsCompleteResult, error) {
...
func (c EventExceptionOccurrenceAttachmentClient) ListEventExceptionOccurrenceAttachmentsCompleteMatchingPredicate(ctx context.Context, id beta.UserIdEventIdExceptionOccurrenceId, options ListEventExceptionOccurrenceAttachmentsOperationOptions, predicate AttachmentOperationPredicate) (result ListEventExceptionOccurrenceAttachmentsCompleteResult, err error) {
