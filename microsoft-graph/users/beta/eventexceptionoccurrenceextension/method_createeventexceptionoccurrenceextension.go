...
// CreateEventExceptionOccurrenceExtension - Create new navigation property to extensions for users
func (c EventExceptionOccurrenceExtensionClient) CreateEventExceptionOccurrenceExtension(ctx context.Context, id beta.UserIdEventIdExceptionOccurrenceId, input beta.Extension, options CreateEventExceptionOccurrenceExtensionOperationOptions) (result CreateEventExceptionOccurrenceExtensionOperationResponse, err error) {
