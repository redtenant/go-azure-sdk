...
func DefaultGetEventExceptionOccurrenceExtensionOperationOptions() GetEventExceptionOccurrenceExtensionOperationOptions {
	return GetEventExceptionOccurrenceExtensionOperationOptions{}
}
...
// GetEventExceptionOccurrenceExtension - Get extensions from users. The collection of open extensions defined for the
// event. Nullable.
func (c EventExceptionOccurrenceExtensionClient) GetEventExceptionOccurrenceExtension(ctx context.Context, id beta.UserIdEventIdExceptionOccurrenceIdExtensionId, options GetEventExceptionOccurrenceExtensionOperationOptions) (result GetEventExceptionOccurrenceExtensionOperationResponse, err error) {
