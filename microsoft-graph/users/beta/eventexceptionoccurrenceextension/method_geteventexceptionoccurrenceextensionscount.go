...
func DefaultGetEventExceptionOccurrenceExtensionsCountOperationOptions() GetEventExceptionOccurrenceExtensionsCountOperationOptions {
	return GetEventExceptionOccurrenceExtensionsCountOperationOptions{}
}
...
func (c EventExceptionOccurrenceExtensionClient) GetEventExceptionOccurrenceExtensionsCount(ctx context.Context, id beta.UserIdEventIdExceptionOccurrenceId, options GetEventExceptionOccurrenceExtensionsCountOperationOptions) (result GetEventExceptionOccurrenceExtensionsCountOperationResponse, err error) {
