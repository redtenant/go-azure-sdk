...
func (c EventExceptionOccurrenceInstanceClient) DismissEventExceptionOccurrenceInstanceReminder(ctx context.Context, id beta.UserIdEventIdExceptionOccurrenceIdInstanceId, options DismissEventExceptionOccurrenceInstanceReminderOperationOptions) (result DismissEventExceptionOccurrenceInstanceReminderOperationResponse, err error) {
