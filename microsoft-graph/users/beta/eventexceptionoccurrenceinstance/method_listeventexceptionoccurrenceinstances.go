...
// ListEventExceptionOccurrenceInstances - Get instances from users. The occurrences of a recurring series, if the event
...
// Read-only. Nullable.
func (c EventExceptionOccurrenceInstanceClient) ListEventExceptionOccurrenceInstances(ctx context.Context, id beta.UserIdEventIdExceptionOccurrenceId, options ListEventExceptionOccurrenceInstancesOperationOptions) (result ListEventExceptionOccurrenceInstancesOperationResponse, err error) {
...
func (c EventExceptionOccurrenceInstanceClient) ListEventExceptionOccurrenceInstancesComplete(ctx context.Context, id beta.UserIdEventIdExceptionOccurrenceId, options ListEventExceptionOccurrenceInstancesOperationOptions) (ListEventExceptionOccurrenceInstancesCompleteResult, error) {
