...
// GetEventExceptionOccurrenceInstanceCalendar - Get calendar from users. The calendar that contains the event.
// Navigation property. Read-only.
func (c EventExceptionOccurrenceInstanceCalendarClient) GetEventExceptionOccurrenceInstanceCalendar(ctx context.Context, id beta.UserIdEventIdExceptionOccurrenceIdInstanceId, options GetEventExceptionOccurrenceInstanceCalendarOperationOptions) (result GetEventExceptionOccurrenceInstanceCalendarOperationResponse, err error) {
