...
func (c EventExceptionOccurrenceInstanceExtensionClient) GetEventExceptionOccurrenceInstanceExtensionsCount(ctx context.Context, id beta.UserIdEventIdExceptionOccurrenceIdInstanceId, options GetEventExceptionOccurrenceInstanceExtensionsCountOperationOptions) (result GetEventExceptionOccurrenceInstanceExtensionsCountOperationResponse, err error) {
