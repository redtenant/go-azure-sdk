...
func (c EventExtensionClient) CreateEventExtension(ctx context.Context, id beta.UserIdEventId, input beta.Extension, options CreateEventExtensionOperationOptions) (result CreateEventExtensionOperationResponse, err error) {
