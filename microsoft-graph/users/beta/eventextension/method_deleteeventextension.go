...
func (c EventExtensionClient) DeleteEventExtension(ctx context.Context, id beta.UserIdEventIdExtensionId, options DeleteEventExtensionOperationOptions) (result DeleteEventExtensionOperationResponse, err error) {
