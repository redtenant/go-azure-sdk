...
func (c EventExtensionClient) GetEventExtension(ctx context.Context, id beta.UserIdEventIdExtensionId, options GetEventExtensionOperationOptions) (result GetEventExtensionOperationResponse, err error) {
