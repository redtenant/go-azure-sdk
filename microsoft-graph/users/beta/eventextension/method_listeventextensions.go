...
func (c EventExtensionClient) ListEventExtensions(ctx context.Context, id beta.UserIdEventId, options ListEventExtensionsOperationOptions) (result ListEventExtensionsOperationResponse, err error) {
...
func (c EventExtensionClient) ListEventExtensionsComplete(ctx context.Context, id beta.UserIdEventId, options ListEventExtensionsOperationOptions) (ListEventExtensionsCompleteResult, error) {
...
func (c EventExtensionClient) ListEventExtensionsCompleteMatchingPredicate(ctx context.Context, id beta.UserIdEventId, options ListEventExtensionsOperationOptions, predicate ExtensionOperationPredicate) (result ListEventExtensionsCompleteResult, err error) {
