...
func (c EventExtensionClient) UpdateEventExtension(ctx context.Context, id beta.UserIdEventIdExtensionId, input beta.Extension, options UpdateEventExtensionOperationOptions) (result UpdateEventExtensionOperationResponse, err error) {
