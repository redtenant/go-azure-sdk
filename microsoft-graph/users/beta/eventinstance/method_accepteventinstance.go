...
func (c EventInstanceClient) AcceptEventInstance(ctx context.Context, id beta.UserIdEventIdInstanceId, input AcceptEventInstanceRequest, options AcceptEventInstanceOperationOptions) (result AcceptEventInstanceOperationResponse, err error) {
