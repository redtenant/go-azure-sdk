...
func (c EventInstanceClient) CancelEventInstance(ctx context.Context, id beta.UserIdEventIdInstanceId, input CancelEventInstanceRequest, options CancelEventInstanceOperationOptions) (result CancelEventInstanceOperationResponse, err error) {
