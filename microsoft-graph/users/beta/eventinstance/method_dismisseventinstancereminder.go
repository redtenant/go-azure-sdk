...
// in a user calendar.
func (c EventInstanceClient) DismissEventInstanceReminder(ctx context.Context, id beta.UserIdEventIdInstanceId, options DismissEventInstanceReminderOperationOptions) (result DismissEventInstanceReminderOperationResponse, err error) {
