...
// Outlook.com account.
func (c EventInstanceClient) ForwardEventInstance(ctx context.Context, id beta.UserIdEventIdInstanceId, input ForwardEventInstanceRequest, options ForwardEventInstanceOperationOptions) (result ForwardEventInstanceOperationResponse, err error) {
