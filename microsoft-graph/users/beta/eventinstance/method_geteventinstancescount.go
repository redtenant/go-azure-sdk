...
func (c EventInstanceClient) GetEventInstancesCount(ctx context.Context, id beta.UserIdEventId, options GetEventInstancesCountOperationOptions) (result GetEventInstancesCountOperationResponse, err error) {
