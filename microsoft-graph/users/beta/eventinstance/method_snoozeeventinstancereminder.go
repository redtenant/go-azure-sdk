...
// a new time.
func (c EventInstanceClient) SnoozeEventInstanceReminder(ctx context.Context, id beta.UserIdEventIdInstanceId, input SnoozeEventInstanceReminderRequest, options SnoozeEventInstanceReminderOperationOptions) (result SnoozeEventInstanceReminderOperationResponse, err error) {
