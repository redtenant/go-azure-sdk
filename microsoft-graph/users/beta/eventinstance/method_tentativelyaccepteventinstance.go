...
func (c EventInstanceClient) TentativelyAcceptEventInstance(ctx context.Context, id beta.UserIdEventIdInstanceId, input TentativelyAcceptEventInstanceRequest, options TentativelyAcceptEventInstanceOperationOptions) (result TentativelyAcceptEventInstanceOperationResponse, err error) {
