...
func (c EventInstanceExceptionOccurrenceClient) DismissEventInstanceExceptionOccurrenceReminder(ctx context.Context, id beta.UserIdEventIdInstanceIdExceptionOccurrenceId, options DismissEventInstanceExceptionOccurrenceReminderOperationOptions) (result DismissEventInstanceExceptionOccurrenceReminderOperationResponse, err error) {
