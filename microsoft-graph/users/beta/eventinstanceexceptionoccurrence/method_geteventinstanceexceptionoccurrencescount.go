...
func (c EventInstanceExceptionOccurrenceClient) GetEventInstanceExceptionOccurrencesCount(ctx context.Context, id beta.UserIdEventIdInstanceId, options GetEventInstanceExceptionOccurrencesCountOperationOptions) (result GetEventInstanceExceptionOccurrencesCountOperationResponse, err error) {
