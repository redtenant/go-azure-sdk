...
// DeleteEventInstanceExceptionOccurrenceAttachment - Delete navigation property attachments for users
func (c EventInstanceExceptionOccurrenceAttachmentClient) DeleteEventInstanceExceptionOccurrenceAttachment(ctx context.Context, id beta.UserIdEventIdInstanceIdExceptionOccurrenceIdAttachmentId, options DeleteEventInstanceExceptionOccurrenceAttachmentOperationOptions) (result DeleteEventInstanceExceptionOccurrenceAttachmentOperationResponse, err error) {
