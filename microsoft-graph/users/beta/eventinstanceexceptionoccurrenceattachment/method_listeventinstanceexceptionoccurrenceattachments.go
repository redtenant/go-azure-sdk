...
// ListEventInstanceExceptionOccurrenceAttachments - Get attachments from users. The collection of FileAttachment,
// ItemAttachment, and referenceAttachment attachments for the event. Navigation property. Read-only. Nullable.
func (c EventInstanceExceptionOccurrenceAttachmentClient) ListEventInstanceExceptionOccurrenceAttachments(ctx context.Context, id beta.UserIdEventIdInstanceIdExceptionOccurrenceId, options ListEventInstanceExceptionOccurrenceAttachmentsOperationOptions) (result ListEventInstanceExceptionOccurrenceAttachmentsOperationResponse, err error) {
...
func (c EventInstanceExceptionOccurrenceAttachmentClient) ListEventInstanceExceptionOccurrenceAttachmentsComplete(ctx context.Context, id beta.UserIdEventIdInstanceIdExceptionOccurrenceId, options ListEventInstanceExceptionOccurrenceAttachmentsOperationOptions) (ListEventInstanceExceptionOccurrenceAttachmentsCompleteResult, error) {
...
func (c EventInstanceExceptionOccurrenceAttachmentClient) ListEventInstanceExceptionOccurrenceAttachmentsCompleteMatchingPredicate(ctx context.Context, id beta.UserIdEventIdInstanceIdExceptionOccurrenceId, options ListEventInstanceExceptionOccurrenceAttachmentsOperationOptions, predicate AttachmentOperationPredicate) (result ListEventInstanceExceptionOccurrenceAttachmentsCompleteResult, err error) {
