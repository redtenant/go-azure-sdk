...
// DeleteEventInstanceExceptionOccurrenceExtension - Delete navigation property extensions for users
func (c EventInstanceExceptionOccurrenceExtensionClient) DeleteEventInstanceExceptionOccurrenceExtension(ctx context.Context, id beta.UserIdEventIdInstanceIdExceptionOccurrenceIdExtensionId, options DeleteEventInstanceExceptionOccurrenceExtensionOperationOptions) (result DeleteEventInstanceExceptionOccurrenceExtensionOperationResponse, err error) {
