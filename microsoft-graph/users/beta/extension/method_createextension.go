...
func (c ExtensionClient) CreateExtension(ctx context.Context, id beta.UserId, input beta.Extension, options CreateExtensionOperationOptions) (result CreateExtensionOperationResponse, err error) {
