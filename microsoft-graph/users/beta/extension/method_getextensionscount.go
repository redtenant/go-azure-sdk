...
func (c ExtensionClient) GetExtensionsCount(ctx context.Context, id beta.UserId, options GetExtensionsCountOperationOptions) (result GetExtensionsCountOperationResponse, err error) {
