...
// ListExtensions - Get extensions from users. The collection of open extensions defined for the user. Supports $expand.
// Nullable.
func (c ExtensionClient) ListExtensions(ctx context.Context, id beta.UserId, options ListExtensionsOperationOptions) (result ListExtensionsOperationResponse, err error) {
...
func (c ExtensionClient) ListExtensionsComplete(ctx context.Context, id beta.UserId, options ListExtensionsOperationOptions) (ListExtensionsCompleteResult, error) {
...
func (c ExtensionClient) ListExtensionsCompleteMatchingPredicate(ctx context.Context, id beta.UserId, options ListExtensionsOperationOptions, predicate ExtensionOperationPredicate) (result ListExtensionsCompleteResult, err error) {
