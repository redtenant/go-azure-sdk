...
func (c ExtensionClient) UpdateExtension(ctx context.Context, id beta.UserIdExtensionId, input beta.Extension, options UpdateExtensionOperationOptions) (result UpdateExtensionOperationResponse, err error) {
