...
func (c FollowedSiteClient) AddFollowedSites(ctx context.Context, id beta.UserId, input AddFollowedSitesRequest, options AddFollowedSitesOperationOptions) (result AddFollowedSitesOperationResponse, err error) {
	opts := client.RequestOptions{
		...
		Path:          fmt.Sprintf("%s/followedSites/add", id.ID()),
...
func (c FollowedSiteClient) AddFollowedSitesComplete(ctx context.Context, id beta.UserId, input AddFollowedSitesRequest, options AddFollowedSitesOperationOptions) (AddFollowedSitesCompleteResult, error) {
	return c.AddFollowedSitesCompleteMatchingPredicate(ctx, id, input, options, SiteOperationPredicate{})
}

// AddFollowedSitesCompleteMatchingPredicate retrieves all the results and then applies the predicate
func (c FollowedSiteClient) AddFollowedSitesCompleteMatchingPredicate(ctx context.Context, id beta.UserId, input AddFollowedSitesRequest, options AddFollowedSitesOperationOptions, predicate SiteOperationPredicate) (result AddFollowedSitesCompleteResult, err error) {
	items := make([]beta.Site, 0)

	resp, err := c.AddFollowedSites(ctx, id, input, options)
	if err != nil {
