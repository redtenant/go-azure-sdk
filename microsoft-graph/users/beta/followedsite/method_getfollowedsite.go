...
func (c FollowedSiteClient) GetFollowedSite(ctx context.Context, id beta.UserIdFollowedSiteId, options GetFollowedSiteOperationOptions) (result GetFollowedSiteOperationResponse, err error) {
