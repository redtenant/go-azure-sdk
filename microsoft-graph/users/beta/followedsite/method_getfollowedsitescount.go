...
func DefaultGetFollowedSitesCountOperationOptions() GetFollowedSitesCountOperationOptions {
	return GetFollowedSitesCountOperationOptions{}
}
...
func (c FollowedSiteClient) GetFollowedSitesCount(ctx context.Context, id beta.UserId, options GetFollowedSitesCountOperationOptions) (result GetFollowedSitesCountOperationResponse, err error) {
	opts := client.RequestOptions{
		...
		Path:          fmt.Sprintf("%s/followedSites/$count", id.ID()),
