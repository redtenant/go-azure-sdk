...
func (c FollowedSiteClient) ListFollowedSites(ctx context.Context, id beta.UserId, options ListFollowedSitesOperationOptions) (result ListFollowedSitesOperationResponse, err error) {
...
func (c FollowedSiteClient) ListFollowedSitesComplete(ctx context.Context, id beta.UserId, options ListFollowedSitesOperationOptions) (ListFollowedSitesCompleteResult, error) {
	return c.ListFollowedSitesCompleteMatchingPredicate(ctx, id, options, SiteOperationPredicate{})
}

// ListFollowedSitesCompleteMatchingPredicate retrieves all the results and then applies the predicate
func (c FollowedSiteClient) ListFollowedSitesCompleteMatchingPredicate(ctx context.Context, id beta.UserId, options ListFollowedSitesOperationOptions, predicate SiteOperationPredicate) (result ListFollowedSitesCompleteResult, err error) {
	items := make([]beta.Site, 0)

	resp, err := c.ListFollowedSites(ctx, id, options)
	if err != nil {
