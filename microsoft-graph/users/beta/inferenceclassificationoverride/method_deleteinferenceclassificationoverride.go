...
func (c InferenceClassificationOverrideClient) DeleteInferenceClassificationOverride(ctx context.Context, id beta.UserIdInferenceClassificationOverrideId, options DeleteInferenceClassificationOverrideOperationOptions) (result DeleteInferenceClassificationOverrideOperationResponse, err error) {
