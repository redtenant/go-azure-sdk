...
func (c InferenceClassificationOverrideClient) GetInferenceClassificationOverridesCount(ctx context.Context, id beta.UserId, options GetInferenceClassificationOverridesCountOperationOptions) (result GetInferenceClassificationOverridesCountOperationResponse, err error) {
