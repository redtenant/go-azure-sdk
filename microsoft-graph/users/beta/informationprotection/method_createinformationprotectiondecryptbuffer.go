...
func (c InformationProtectionClient) CreateInformationProtectionDecryptBuffer(ctx context.Context, id beta.UserId, input CreateInformationProtectionDecryptBufferRequest, options CreateInformationProtectionDecryptBufferOperationOptions) (result CreateInformationProtectionDecryptBufferOperationResponse, err error) {
