...
// DeleteInformationProtection - Delete navigation property informationProtection for users
func (c InformationProtectionClient) DeleteInformationProtection(ctx context.Context, id beta.UserId, options DeleteInformationProtectionOperationOptions) (result DeleteInformationProtectionOperationResponse, err error) {
