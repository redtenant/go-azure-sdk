...
// GetInformationProtection - Get informationProtection from users
func (c InformationProtectionClient) GetInformationProtection(ctx context.Context, id beta.UserId, options GetInformationProtectionOperationOptions) (result GetInformationProtectionOperationResponse, err error) {
