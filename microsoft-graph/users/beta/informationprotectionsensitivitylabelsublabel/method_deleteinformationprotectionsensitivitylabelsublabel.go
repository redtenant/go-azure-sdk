...
func DefaultDeleteInformationProtectionSensitivityLabelSublabelOperationOptions() DeleteInformationProtectionSensitivityLabelSublabelOperationOptions {
	return DeleteInformationProtectionSensitivityLabelSublabelOperationOptions{}
}
...
// DeleteInformationProtectionSensitivityLabelSublabel - Delete navigation property sublabels for users
func (c InformationProtectionSensitivityLabelSublabelClient) DeleteInformationProtectionSensitivityLabelSublabel(ctx context.Context, id beta.UserIdInformationProtectionSensitivityLabelIdSublabelId, options DeleteInformationProtectionSensitivityLabelSublabelOperationOptions) (result DeleteInformationProtectionSensitivityLabelSublabelOperationResponse, err error) {
