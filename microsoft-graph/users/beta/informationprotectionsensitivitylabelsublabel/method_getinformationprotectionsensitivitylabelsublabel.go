...
func DefaultGetInformationProtectionSensitivityLabelSublabelOperationOptions() GetInformationProtectionSensitivityLabelSublabelOperationOptions {
	return GetInformationProtectionSensitivityLabelSublabelOperationOptions{}
}
...
// GetInformationProtectionSensitivityLabelSublabel - Get sublabels from users
func (c InformationProtectionSensitivityLabelSublabelClient) GetInformationProtectionSensitivityLabelSublabel(ctx context.Context, id beta.UserIdInformationProtectionSensitivityLabelIdSublabelId, options GetInformationProtectionSensitivityLabelSublabelOperationOptions) (result GetInformationProtectionSensitivityLabelSublabelOperationResponse, err error) {
