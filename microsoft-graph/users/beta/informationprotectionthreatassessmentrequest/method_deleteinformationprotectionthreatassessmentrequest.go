...
// DeleteInformationProtectionThreatAssessmentRequest - Delete navigation property threatAssessmentRequests for users
func (c InformationProtectionThreatAssessmentRequestClient) DeleteInformationProtectionThreatAssessmentRequest(ctx context.Context, id beta.UserIdInformationProtectionThreatAssessmentRequestId, options DeleteInformationProtectionThreatAssessmentRequestOperationOptions) (result DeleteInformationProtectionThreatAssessmentRequestOperationResponse, err error) {
