...
// DeleteInformationProtectionThreatAssessmentRequestResult - Delete navigation property results for users
func (c InformationProtectionThreatAssessmentRequestResultClient) DeleteInformationProtectionThreatAssessmentRequestResult(ctx context.Context, id beta.UserIdInformationProtectionThreatAssessmentRequestIdResultId, options DeleteInformationProtectionThreatAssessmentRequestResultOperationOptions) (result DeleteInformationProtectionThreatAssessmentRequestResultOperationResponse, err error) {
