...
// GetInformationProtectionThreatAssessmentRequestResult - Get results from users. A collection of threat assessment
// results. Read-only. By default, a GET /threatAssessmentRequests/{id} does not return this property unless you apply
// $expand on it.
func (c InformationProtectionThreatAssessmentRequestResultClient) GetInformationProtectionThreatAssessmentRequestResult(ctx context.Context, id beta.UserIdInformationProtectionThreatAssessmentRequestIdResultId, options GetInformationProtectionThreatAssessmentRequestResultOperationOptions) (result GetInformationProtectionThreatAssessmentRequestResultOperationResponse, err error) {
