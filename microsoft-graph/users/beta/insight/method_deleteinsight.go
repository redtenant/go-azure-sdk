...
func (c InsightClient) DeleteInsight(ctx context.Context, id beta.UserId, options DeleteInsightOperationOptions) (result DeleteInsightOperationResponse, err error) {
