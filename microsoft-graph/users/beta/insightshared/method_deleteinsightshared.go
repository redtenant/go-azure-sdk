...
func DefaultDeleteInsightSharedOperationOptions() DeleteInsightSharedOperationOptions {
	return DeleteInsightSharedOperationOptions{}
}
...
func (c InsightSharedClient) DeleteInsightShared(ctx context.Context, id beta.UserIdInsightSharedId, options DeleteInsightSharedOperationOptions) (result DeleteInsightSharedOperationResponse, err error) {
