...
func (c InsightSharedClient) GetInsightSharedCount(ctx context.Context, id beta.UserId, options GetInsightSharedCountOperationOptions) (result GetInsightSharedCountOperationResponse, err error) {
	opts := client.RequestOptions{
		...
		Path:          fmt.Sprintf("%s/insights/shared/$count", id.ID()),
