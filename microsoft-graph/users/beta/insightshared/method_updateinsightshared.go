...
func (c InsightSharedClient) UpdateInsightShared(ctx context.Context, id beta.UserIdInsightSharedId, input beta.SharedInsight, options UpdateInsightSharedOperationOptions) (result UpdateInsightSharedOperationResponse, err error) {
