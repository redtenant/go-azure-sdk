...
func (c InsightSharedLastSharedMethodClient) GetInsightSharedLastSharedMethod(ctx context.Context, id beta.UserIdInsightSharedId, options GetInsightSharedLastSharedMethodOperationOptions) (result GetInsightSharedLastSharedMethodOperationResponse, err error) {
