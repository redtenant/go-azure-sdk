...
func (c InsightSharedResourceClient) GetInsightSharedResource(ctx context.Context, id beta.UserIdInsightSharedId, options GetInsightSharedResourceOperationOptions) (result GetInsightSharedResourceOperationResponse, err error) {
