...
func (c InsightTrendingClient) CreateInsightTrending(ctx context.Context, id beta.UserId, input beta.Trending, options CreateInsightTrendingOperationOptions) (result CreateInsightTrendingOperationResponse, err error) {
