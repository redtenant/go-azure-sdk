...
func (c InsightTrendingClient) DeleteInsightTrending(ctx context.Context, id beta.UserIdInsightTrendingId, options DeleteInsightTrendingOperationOptions) (result DeleteInsightTrendingOperationResponse, err error) {
