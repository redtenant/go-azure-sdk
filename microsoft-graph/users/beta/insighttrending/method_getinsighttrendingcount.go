...
func (c InsightTrendingClient) GetInsightTrendingCount(ctx context.Context, id beta.UserId, options GetInsightTrendingCountOperationOptions) (result GetInsightTrendingCountOperationResponse, err error) {
