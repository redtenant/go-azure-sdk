...
func (c InsightTrendingClient) ListInsightTrendings(ctx context.Context, id beta.UserId, options ListInsightTrendingsOperationOptions) (result ListInsightTrendingsOperationResponse, err error) {
...
func (c InsightTrendingClient) ListInsightTrendingsComplete(ctx context.Context, id beta.UserId, options ListInsightTrendingsOperationOptions) (ListInsightTrendingsCompleteResult, error) {
