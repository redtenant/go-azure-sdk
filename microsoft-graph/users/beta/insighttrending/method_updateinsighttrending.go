...
func (c InsightTrendingClient) UpdateInsightTrending(ctx context.Context, id beta.UserIdInsightTrendingId, input beta.Trending, options UpdateInsightTrendingOperationOptions) (result UpdateInsightTrendingOperationResponse, err error) {
