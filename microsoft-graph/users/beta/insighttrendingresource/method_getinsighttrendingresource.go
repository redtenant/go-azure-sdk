...
func (c InsightTrendingResourceClient) GetInsightTrendingResource(ctx context.Context, id beta.UserIdInsightTrendingId, options GetInsightTrendingResourceOperationOptions) (result GetInsightTrendingResourceOperationResponse, err error) {
