...
func (c InsightUsedClient) CreateInsightUsed(ctx context.Context, id beta.UserId, input beta.UsedInsight, options CreateInsightUsedOperationOptions) (result CreateInsightUsedOperationResponse, err error) {
