...
func (c InsightUsedClient) DeleteInsightUsed(ctx context.Context, id beta.UserIdInsightUsedId, options DeleteInsightUsedOperationOptions) (result DeleteInsightUsedOperationResponse, err error) {
