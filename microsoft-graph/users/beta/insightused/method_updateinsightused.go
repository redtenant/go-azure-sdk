...
func (c InsightUsedClient) UpdateInsightUsed(ctx context.Context, id beta.UserIdInsightUsedId, input beta.UsedInsight, options UpdateInsightUsedOperationOptions) (result UpdateInsightUsedOperationResponse, err error) {
