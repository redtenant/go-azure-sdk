...
func (c JoinedGroupClient) ListJoinedGroups(ctx context.Context, id beta.UserId, options ListJoinedGroupsOperationOptions) (result ListJoinedGroupsOperationResponse, err error) {
	opts := client.RequestOptions{
		...
		Path:          fmt.Sprintf("%s/joinedGroups", id.ID()),
...
func (c JoinedGroupClient) ListJoinedGroupsComplete(ctx context.Context, id beta.UserId, options ListJoinedGroupsOperationOptions) (ListJoinedGroupsCompleteResult, error) {
	return c.ListJoinedGroupsCompleteMatchingPredicate(ctx, id, options, GroupOperationPredicate{})
}
...
func (c JoinedGroupClient) ListJoinedGroupsCompleteMatchingPredicate(ctx context.Context, id beta.UserId, options ListJoinedGroupsOperationOptions, predicate GroupOperationPredicate) (result ListJoinedGroupsCompleteResult, err error) {
	...
	resp, err := c.ListJoinedGroups(ctx, id, options)
	if err != nil {
