...
func (c JoinedTeamClient) GetJoinedTeam(ctx context.Context, id beta.UserIdJoinedTeamId, options GetJoinedTeamOperationOptions) (result GetJoinedTeamOperationResponse, err error) {
