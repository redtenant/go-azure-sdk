...
func (c JoinedTeamClient) GetJoinedTeamsCount(ctx context.Context, id beta.UserId, options GetJoinedTeamsCountOperationOptions) (result GetJoinedTeamsCountOperationResponse, err error) {
