...
func (c LicenseDetailClient) CreateLicenseDetail(ctx context.Context, id beta.UserId, input beta.LicenseDetails, options CreateLicenseDetailOperationOptions) (result CreateLicenseDetailOperationResponse, err error) {
