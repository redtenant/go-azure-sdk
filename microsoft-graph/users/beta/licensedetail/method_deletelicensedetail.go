...
func (c LicenseDetailClient) DeleteLicenseDetail(ctx context.Context, id beta.UserIdLicenseDetailId, options DeleteLicenseDetailOperationOptions) (result DeleteLicenseDetailOperationResponse, err error) {
