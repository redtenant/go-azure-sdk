...
// GetLicenseDetail - Get licenseDetails from users
func (c LicenseDetailClient) GetLicenseDetail(ctx context.Context, id beta.UserIdLicenseDetailId, options GetLicenseDetailOperationOptions) (result GetLicenseDetailOperationResponse, err error) {
