...
// ListLicenseDetails - Get licenseDetails from users
func (c LicenseDetailClient) ListLicenseDetails(ctx context.Context, id beta.UserId, options ListLicenseDetailsOperationOptions) (result ListLicenseDetailsOperationResponse, err error) {
...
func (c LicenseDetailClient) ListLicenseDetailsComplete(ctx context.Context, id beta.UserId, options ListLicenseDetailsOperationOptions) (ListLicenseDetailsCompleteResult, error) {
...
func (c LicenseDetailClient) ListLicenseDetailsCompleteMatchingPredicate(ctx context.Context, id beta.UserId, options ListLicenseDetailsOperationOptions, predicate LicenseDetailsOperationPredicate) (result ListLicenseDetailsCompleteResult, err error) {
