...
func (c LicenseDetailClient) UpdateLicenseDetail(ctx context.Context, id beta.UserIdLicenseDetailId, input beta.LicenseDetails, options UpdateLicenseDetailOperationOptions) (result UpdateLicenseDetailOperationResponse, err error) {
