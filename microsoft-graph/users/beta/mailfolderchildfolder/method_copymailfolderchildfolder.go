...
func (c MailFolderChildFolderClient) CopyMailFolderChildFolder(ctx context.Context, id beta.UserIdMailFolderIdChildFolderId, input CopyMailFolderChildFolderRequest, options CopyMailFolderChildFolderOperationOptions) (result CopyMailFolderChildFolderOperationResponse, err error) {
