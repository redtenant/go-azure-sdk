...
func (c MailFolderChildFolderClient) CreateMailFolderChildFolder(ctx context.Context, id beta.UserIdMailFolderId, input beta.MailFolder, options CreateMailFolderChildFolderOperationOptions) (result CreateMailFolderChildFolderOperationResponse, err error) {
