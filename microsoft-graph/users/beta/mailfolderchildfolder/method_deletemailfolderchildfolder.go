...
func (c MailFolderChildFolderClient) DeleteMailFolderChildFolder(ctx context.Context, id beta.UserIdMailFolderIdChildFolderId, options DeleteMailFolderChildFolderOperationOptions) (result DeleteMailFolderChildFolderOperationResponse, err error) {
