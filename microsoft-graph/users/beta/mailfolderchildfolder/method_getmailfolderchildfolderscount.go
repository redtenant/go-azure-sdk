...
func (c MailFolderChildFolderClient) GetMailFolderChildFoldersCount(ctx context.Context, id beta.UserIdMailFolderId, options GetMailFolderChildFoldersCountOperationOptions) (result GetMailFolderChildFoldersCountOperationResponse, err error) {
