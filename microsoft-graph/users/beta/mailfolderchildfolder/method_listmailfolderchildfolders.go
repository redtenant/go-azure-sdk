...
func (c MailFolderChildFolderClient) ListMailFolderChildFolders(ctx context.Context, id beta.UserIdMailFolderId, options ListMailFolderChildFoldersOperationOptions) (result ListMailFolderChildFoldersOperationResponse, err error) {
...
func (c MailFolderChildFolderClient) ListMailFolderChildFoldersComplete(ctx context.Context, id beta.UserIdMailFolderId, options ListMailFolderChildFoldersOperationOptions) (ListMailFolderChildFoldersCompleteResult, error) {
...
func (c MailFolderChildFolderClient) ListMailFolderChildFoldersCompleteMatchingPredicate(ctx context.Context, id beta.UserIdMailFolderId, options ListMailFolderChildFoldersOperationOptions, predicate MailFolderOperationPredicate) (result ListMailFolderChildFoldersCompleteResult, err error) {
