...
func (c MailFolderChildFolderClient) MoveMailFolderChildFolder(ctx context.Context, id beta.UserIdMailFolderIdChildFolderId, input MoveMailFolderChildFolderRequest, options MoveMailFolderChildFolderOperationOptions) (result MoveMailFolderChildFolderOperationResponse, err error) {
