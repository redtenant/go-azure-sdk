...
func (c MailFolderChildFolderClient) UpdateMailFolderChildFolder(ctx context.Context, id beta.UserIdMailFolderIdChildFolderId, input beta.MailFolder, options UpdateMailFolderChildFolderOperationOptions) (result UpdateMailFolderChildFolderOperationResponse, err error) {
