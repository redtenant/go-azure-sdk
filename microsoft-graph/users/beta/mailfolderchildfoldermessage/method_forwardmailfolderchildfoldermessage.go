...
func (c MailFolderChildFolderMessageClient) ForwardMailFolderChildFolderMessage(ctx context.Context, id beta.UserIdMailFolderIdChildFolderIdMessageId, input ForwardMailFolderChildFolderMessageRequest, options ForwardMailFolderChildFolderMessageOperationOptions) (result ForwardMailFolderChildFolderMessageOperationResponse, err error) {
