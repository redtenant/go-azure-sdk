...
func (c MailFolderChildFolderMessageClient) ListMailFolderChildFolderMessages(ctx context.Context, id beta.UserIdMailFolderIdChildFolderId, options ListMailFolderChildFolderMessagesOperationOptions) (result ListMailFolderChildFolderMessagesOperationResponse, err error) {
...
func (c MailFolderChildFolderMessageClient) ListMailFolderChildFolderMessagesComplete(ctx context.Context, id beta.UserIdMailFolderIdChildFolderId, options ListMailFolderChildFolderMessagesOperationOptions) (ListMailFolderChildFolderMessagesCompleteResult, error) {
...
func (c MailFolderChildFolderMessageClient) ListMailFolderChildFolderMessagesCompleteMatchingPredicate(ctx context.Context, id beta.UserIdMailFolderIdChildFolderId, options ListMailFolderChildFolderMessagesOperationOptions, predicate MessageOperationPredicate) (result ListMailFolderChildFolderMessagesCompleteResult, err error) {
