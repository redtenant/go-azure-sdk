...
func (c MailFolderChildFolderMessageClient) MoveMailFolderChildFolderMessage(ctx context.Context, id beta.UserIdMailFolderIdChildFolderIdMessageId, input MoveMailFolderChildFolderMessageRequest, options MoveMailFolderChildFolderMessageOperationOptions) (result MoveMailFolderChildFolderMessageOperationResponse, err error) {
