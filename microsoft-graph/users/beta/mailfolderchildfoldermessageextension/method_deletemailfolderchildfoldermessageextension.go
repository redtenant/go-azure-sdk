...
func (c MailFolderChildFolderMessageExtensionClient) DeleteMailFolderChildFolderMessageExtension(ctx context.Context, id beta.UserIdMailFolderIdChildFolderIdMessageIdExtensionId, options DeleteMailFolderChildFolderMessageExtensionOperationOptions) (result DeleteMailFolderChildFolderMessageExtensionOperationResponse, err error) {
