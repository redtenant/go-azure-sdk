...
func (c MailFolderChildFolderMessageExtensionClient) GetMailFolderChildFolderMessageExtension(ctx context.Context, id beta.UserIdMailFolderIdChildFolderIdMessageIdExtensionId, options GetMailFolderChildFolderMessageExtensionOperationOptions) (result GetMailFolderChildFolderMessageExtensionOperationResponse, err error) {
