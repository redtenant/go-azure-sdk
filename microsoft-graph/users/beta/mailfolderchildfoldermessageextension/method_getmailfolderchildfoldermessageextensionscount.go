...
func (c MailFolderChildFolderMessageExtensionClient) GetMailFolderChildFolderMessageExtensionsCount(ctx context.Context, id beta.UserIdMailFolderIdChildFolderIdMessageId, options GetMailFolderChildFolderMessageExtensionsCountOperationOptions) (result GetMailFolderChildFolderMessageExtensionsCountOperationResponse, err error) {
