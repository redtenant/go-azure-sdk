...
// ListMailFolderChildFolderMessageExtensions - Get extensions from users. The collection of open extensions defined for
// the message. Nullable.
func (c MailFolderChildFolderMessageExtensionClient) ListMailFolderChildFolderMessageExtensions(ctx context.Context, id beta.UserIdMailFolderIdChildFolderIdMessageId, options ListMailFolderChildFolderMessageExtensionsOperationOptions) (result ListMailFolderChildFolderMessageExtensionsOperationResponse, err error) {
...
func (c MailFolderChildFolderMessageExtensionClient) ListMailFolderChildFolderMessageExtensionsComplete(ctx context.Context, id beta.UserIdMailFolderIdChildFolderIdMessageId, options ListMailFolderChildFolderMessageExtensionsOperationOptions) (ListMailFolderChildFolderMessageExtensionsCompleteResult, error) {
...
func (c MailFolderChildFolderMessageExtensionClient) ListMailFolderChildFolderMessageExtensionsCompleteMatchingPredicate(ctx context.Context, id beta.UserIdMailFolderIdChildFolderIdMessageId, options ListMailFolderChildFolderMessageExtensionsOperationOptions, predicate ExtensionOperationPredicate) (result ListMailFolderChildFolderMessageExtensionsCompleteResult, err error) {
