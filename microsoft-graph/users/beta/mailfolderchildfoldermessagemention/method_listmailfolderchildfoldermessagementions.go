...
// ListMailFolderChildFolderMessageMentions - Get mentions from users. A collection of mentions in the message, ordered
// by the createdDateTime from the newest to the oldest. By default, a GET /messages does not return this property
// unless you apply $expand on the property.
func (c MailFolderChildFolderMessageMentionClient) ListMailFolderChildFolderMessageMentions(ctx context.Context, id beta.UserIdMailFolderIdChildFolderIdMessageId, options ListMailFolderChildFolderMessageMentionsOperationOptions) (result ListMailFolderChildFolderMessageMentionsOperationResponse, err error) {
...
func (c MailFolderChildFolderMessageMentionClient) ListMailFolderChildFolderMessageMentionsComplete(ctx context.Context, id beta.UserIdMailFolderIdChildFolderIdMessageId, options ListMailFolderChildFolderMessageMentionsOperationOptions) (ListMailFolderChildFolderMessageMentionsCompleteResult, error) {
...
func (c MailFolderChildFolderMessageMentionClient) ListMailFolderChildFolderMessageMentionsCompleteMatchingPredicate(ctx context.Context, id beta.UserIdMailFolderIdChildFolderIdMessageId, options ListMailFolderChildFolderMessageMentionsOperationOptions, predicate MentionOperationPredicate) (result ListMailFolderChildFolderMessageMentionsCompleteResult, err error) {
