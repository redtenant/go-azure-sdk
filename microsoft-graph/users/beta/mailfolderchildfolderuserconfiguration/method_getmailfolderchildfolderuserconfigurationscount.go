...
func (c MailFolderChildFolderUserConfigurationClient) GetMailFolderChildFolderUserConfigurationsCount(ctx context.Context, id beta.UserIdMailFolderIdChildFolderId, options GetMailFolderChildFolderUserConfigurationsCountOperationOptions) (result GetMailFolderChildFolderUserConfigurationsCountOperationResponse, err error) {
