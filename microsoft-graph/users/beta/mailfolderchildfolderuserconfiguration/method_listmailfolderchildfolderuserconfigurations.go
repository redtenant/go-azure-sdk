...
func (c MailFolderChildFolderUserConfigurationClient) ListMailFolderChildFolderUserConfigurations(ctx context.Context, id beta.UserIdMailFolderIdChildFolderId, options ListMailFolderChildFolderUserConfigurationsOperationOptions) (result ListMailFolderChildFolderUserConfigurationsOperationResponse, err error) {
...
func (c MailFolderChildFolderUserConfigurationClient) ListMailFolderChildFolderUserConfigurationsComplete(ctx context.Context, id beta.UserIdMailFolderIdChildFolderId, options ListMailFolderChildFolderUserConfigurationsOperationOptions) (ListMailFolderChildFolderUserConfigurationsCompleteResult, error) {
...
func (c MailFolderChildFolderUserConfigurationClient) ListMailFolderChildFolderUserConfigurationsCompleteMatchingPredicate(ctx context.Context, id beta.UserIdMailFolderIdChildFolderId, options ListMailFolderChildFolderUserConfigurationsOperationOptions, predicate UserConfigurationOperationPredicate) (result ListMailFolderChildFolderUserConfigurationsCompleteResult, err error) {
