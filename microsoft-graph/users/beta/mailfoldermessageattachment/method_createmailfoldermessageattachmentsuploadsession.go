...
type CreateMailFolderMessageAttachmentsUploadSessionOperationResponse struct {
	HttpResponse *http.Response
	OData        *odata.OData
	Model        *beta.UploadSession
}

type CreateMailFolderMessageAttachmentsUploadSessionOperationOptions struct {
...
func DefaultCreateMailFolderMessageAttachmentsUploadSessionOperationOptions() CreateMailFolderMessageAttachmentsUploadSessionOperationOptions {
	return CreateMailFolderMessageAttachmentsUploadSessionOperationOptions{}
}
...
// CreateMailFolderMessageAttachmentsUploadSession - Invoke action createUploadSession. Create an upload session that
...
func (c MailFolderMessageAttachmentClient) CreateMailFolderMessageAttachmentsUploadSession(ctx context.Context, id beta.UserIdMailFolderIdMessageId, input CreateMailFolderMessageAttachmentsUploadSessionRequest, options CreateMailFolderMessageAttachmentsUploadSessionOperationOptions) (result CreateMailFolderMessageAttachmentsUploadSessionOperationResponse, err error) {
