...
func (c MailFolderMessageAttachmentClient) DeleteMailFolderMessageAttachment(ctx context.Context, id beta.UserIdMailFolderIdMessageIdAttachmentId, options DeleteMailFolderMessageAttachmentOperationOptions) (result DeleteMailFolderMessageAttachmentOperationResponse, err error) {
