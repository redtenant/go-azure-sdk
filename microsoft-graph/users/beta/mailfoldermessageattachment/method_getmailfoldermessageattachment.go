...
// GetMailFolderMessageAttachment - Get attachments from users. The fileAttachment and itemAttachment attachments for
// the message.
func (c MailFolderMessageAttachmentClient) GetMailFolderMessageAttachment(ctx context.Context, id beta.UserIdMailFolderIdMessageIdAttachmentId, options GetMailFolderMessageAttachmentOperationOptions) (result GetMailFolderMessageAttachmentOperationResponse, err error) {
