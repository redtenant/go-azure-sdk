...
type GetMailFolderMessageAttachmentsCountOperationResponse struct {
	HttpResponse *http.Response
	OData        *odata.OData
	Model        *[]byte
}

type GetMailFolderMessageAttachmentsCountOperationOptions struct {
	Filter    *string
...
func DefaultGetMailFolderMessageAttachmentsCountOperationOptions() GetMailFolderMessageAttachmentsCountOperationOptions {
	return GetMailFolderMessageAttachmentsCountOperationOptions{}
}
...
func (c MailFolderMessageAttachmentClient) GetMailFolderMessageAttachmentsCount(ctx context.Context, id beta.UserIdMailFolderIdMessageId, options GetMailFolderMessageAttachmentsCountOperationOptions) (result GetMailFolderMessageAttachmentsCountOperationResponse, err error) {
