...
// ListMailFolderMessageAttachments - Get attachments from users. The fileAttachment and itemAttachment attachments for
// the message.
func (c MailFolderMessageAttachmentClient) ListMailFolderMessageAttachments(ctx context.Context, id beta.UserIdMailFolderIdMessageId, options ListMailFolderMessageAttachmentsOperationOptions) (result ListMailFolderMessageAttachmentsOperationResponse, err error) {
...
func (c MailFolderMessageAttachmentClient) ListMailFolderMessageAttachmentsComplete(ctx context.Context, id beta.UserIdMailFolderIdMessageId, options ListMailFolderMessageAttachmentsOperationOptions) (ListMailFolderMessageAttachmentsCompleteResult, error) {
...
func (c MailFolderMessageAttachmentClient) ListMailFolderMessageAttachmentsCompleteMatchingPredicate(ctx context.Context, id beta.UserIdMailFolderIdMessageId, options ListMailFolderMessageAttachmentsOperationOptions, predicate AttachmentOperationPredicate) (result ListMailFolderMessageAttachmentsCompleteResult, err error) {
