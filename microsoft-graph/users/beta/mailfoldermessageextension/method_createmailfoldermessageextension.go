...
func (c MailFolderMessageExtensionClient) CreateMailFolderMessageExtension(ctx context.Context, id beta.UserIdMailFolderIdMessageId, input beta.Extension, options CreateMailFolderMessageExtensionOperationOptions) (result CreateMailFolderMessageExtensionOperationResponse, err error) {
