...
func (c MailFolderMessageExtensionClient) DeleteMailFolderMessageExtension(ctx context.Context, id beta.UserIdMailFolderIdMessageIdExtensionId, options DeleteMailFolderMessageExtensionOperationOptions) (result DeleteMailFolderMessageExtensionOperationResponse, err error) {
