...
func (c MailFolderMessageExtensionClient) GetMailFolderMessageExtensionsCount(ctx context.Context, id beta.UserIdMailFolderIdMessageId, options GetMailFolderMessageExtensionsCountOperationOptions) (result GetMailFolderMessageExtensionsCountOperationResponse, err error) {
