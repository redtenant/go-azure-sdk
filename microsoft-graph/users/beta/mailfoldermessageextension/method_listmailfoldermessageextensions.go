...
// message. Nullable.
func (c MailFolderMessageExtensionClient) ListMailFolderMessageExtensions(ctx context.Context, id beta.UserIdMailFolderIdMessageId, options ListMailFolderMessageExtensionsOperationOptions) (result ListMailFolderMessageExtensionsOperationResponse, err error) {
...
func (c MailFolderMessageExtensionClient) ListMailFolderMessageExtensionsComplete(ctx context.Context, id beta.UserIdMailFolderIdMessageId, options ListMailFolderMessageExtensionsOperationOptions) (ListMailFolderMessageExtensionsCompleteResult, error) {
...
func (c MailFolderMessageExtensionClient) ListMailFolderMessageExtensionsCompleteMatchingPredicate(ctx context.Context, id beta.UserIdMailFolderIdMessageId, options ListMailFolderMessageExtensionsOperationOptions, predicate ExtensionOperationPredicate) (result ListMailFolderMessageExtensionsCompleteResult, err error) {
