...
func (c MailFolderMessageExtensionClient) UpdateMailFolderMessageExtension(ctx context.Context, id beta.UserIdMailFolderIdMessageIdExtensionId, input beta.Extension, options UpdateMailFolderMessageExtensionOperationOptions) (result UpdateMailFolderMessageExtensionOperationResponse, err error) {
