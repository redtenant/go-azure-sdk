...
func (c MailFolderMessageMentionClient) GetMailFolderMessageMentionsCount(ctx context.Context, id beta.UserIdMailFolderIdMessageId, options GetMailFolderMessageMentionsCountOperationOptions) (result GetMailFolderMessageMentionsCountOperationResponse, err error) {
