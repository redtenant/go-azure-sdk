...
// ListMailFolderMessageMentions - Get mentions from users. A collection of mentions in the message, ordered by the
...
func (c MailFolderMessageMentionClient) ListMailFolderMessageMentions(ctx context.Context, id beta.UserIdMailFolderIdMessageId, options ListMailFolderMessageMentionsOperationOptions) (result ListMailFolderMessageMentionsOperationResponse, err error) {
...
func (c MailFolderMessageMentionClient) ListMailFolderMessageMentionsComplete(ctx context.Context, id beta.UserIdMailFolderIdMessageId, options ListMailFolderMessageMentionsOperationOptions) (ListMailFolderMessageMentionsCompleteResult, error) {
...
func (c MailFolderMessageMentionClient) ListMailFolderMessageMentionsCompleteMatchingPredicate(ctx context.Context, id beta.UserIdMailFolderIdMessageId, options ListMailFolderMessageMentionsOperationOptions, predicate MentionOperationPredicate) (result ListMailFolderMessageMentionsCompleteResult, err error) {
