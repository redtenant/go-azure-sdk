...
func (c MailFolderMessageRuleClient) CreateMailFolderMessageRule(ctx context.Context, id beta.UserIdMailFolderId, input beta.MessageRule, options CreateMailFolderMessageRuleOperationOptions) (result CreateMailFolderMessageRuleOperationResponse, err error) {
