...
func (c MailFolderMessageRuleClient) DeleteMailFolderMessageRule(ctx context.Context, id beta.UserIdMailFolderIdMessageRuleId, options DeleteMailFolderMessageRuleOperationOptions) (result DeleteMailFolderMessageRuleOperationResponse, err error) {
