...
// folder.
func (c MailFolderMessageRuleClient) GetMailFolderMessageRule(ctx context.Context, id beta.UserIdMailFolderIdMessageRuleId, options GetMailFolderMessageRuleOperationOptions) (result GetMailFolderMessageRuleOperationResponse, err error) {
