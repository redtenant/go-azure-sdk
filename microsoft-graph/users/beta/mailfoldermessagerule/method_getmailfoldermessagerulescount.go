...
func (c MailFolderMessageRuleClient) GetMailFolderMessageRulesCount(ctx context.Context, id beta.UserIdMailFolderId, options GetMailFolderMessageRulesCountOperationOptions) (result GetMailFolderMessageRulesCountOperationResponse, err error) {
