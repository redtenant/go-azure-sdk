...
// folder.
func (c MailFolderMessageRuleClient) ListMailFolderMessageRules(ctx context.Context, id beta.UserIdMailFolderId, options ListMailFolderMessageRulesOperationOptions) (result ListMailFolderMessageRulesOperationResponse, err error) {
...
func (c MailFolderMessageRuleClient) ListMailFolderMessageRulesComplete(ctx context.Context, id beta.UserIdMailFolderId, options ListMailFolderMessageRulesOperationOptions) (ListMailFolderMessageRulesCompleteResult, error) {
...
func (c MailFolderMessageRuleClient) ListMailFolderMessageRulesCompleteMatchingPredicate(ctx context.Context, id beta.UserIdMailFolderId, options ListMailFolderMessageRulesOperationOptions, predicate MessageRuleOperationPredicate) (result ListMailFolderMessageRulesCompleteResult, err error) {
