...
// GetMailFolderUserConfiguration - Get userConfigurations from users
func (c MailFolderUserConfigurationClient) GetMailFolderUserConfiguration(ctx context.Context, id beta.UserIdMailFolderIdUserConfigurationId, options GetMailFolderUserConfigurationOperationOptions) (result GetMailFolderUserConfigurationOperationResponse, err error) {
