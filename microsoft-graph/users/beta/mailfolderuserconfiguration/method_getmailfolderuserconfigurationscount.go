...
func (c MailFolderUserConfigurationClient) GetMailFolderUserConfigurationsCount(ctx context.Context, id beta.UserIdMailFolderId, options GetMailFolderUserConfigurationsCountOperationOptions) (result GetMailFolderUserConfigurationsCountOperationResponse, err error) {
