...
// GetManagedAppLogCollectionRequest - Get managedAppLogCollectionRequests from users. Zero or more log collection
// requests triggered for the user.
func (c ManagedAppLogCollectionRequestClient) GetManagedAppLogCollectionRequest(ctx context.Context, id beta.UserIdManagedAppLogCollectionRequestId, options GetManagedAppLogCollectionRequestOperationOptions) (result GetManagedAppLogCollectionRequestOperationResponse, err error) {
