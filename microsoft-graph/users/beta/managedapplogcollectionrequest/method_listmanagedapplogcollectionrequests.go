...
// ListManagedAppLogCollectionRequests - Get managedAppLogCollectionRequests from users. Zero or more log collection
// requests triggered for the user.
func (c ManagedAppLogCollectionRequestClient) ListManagedAppLogCollectionRequests(ctx context.Context, id beta.UserId, options ListManagedAppLogCollectionRequestsOperationOptions) (result ListManagedAppLogCollectionRequestsOperationResponse, err error) {
...
func (c ManagedAppLogCollectionRequestClient) ListManagedAppLogCollectionRequestsComplete(ctx context.Context, id beta.UserId, options ListManagedAppLogCollectionRequestsOperationOptions) (ListManagedAppLogCollectionRequestsCompleteResult, error) {
	return c.ListManagedAppLogCollectionRequestsCompleteMatchingPredicate(ctx, id, options, ManagedAppLogCollectionRequestOperationPredicate{})
}

// ListManagedAppLogCollectionRequestsCompleteMatchingPredicate retrieves all the results and then applies the predicate
func (c ManagedAppLogCollectionRequestClient) ListManagedAppLogCollectionRequestsCompleteMatchingPredicate(ctx context.Context, id beta.UserId, options ListManagedAppLogCollectionRequestsOperationOptions, predicate ManagedAppLogCollectionRequestOperationPredicate) (result ListManagedAppLogCollectionRequestsCompleteResult, err error) {
	items := make([]beta.ManagedAppLogCollectionRequest, 0)

	resp, err := c.ListManagedAppLogCollectionRequests(ctx, id, options)
	if err != nil {
