...
// GetManagedAppRegistration - Get managedAppRegistrations from users. Zero or more managed app registrations that
// belong to the user.
func (c ManagedAppRegistrationClient) GetManagedAppRegistration(ctx context.Context, id beta.UserIdManagedAppRegistrationId, options GetManagedAppRegistrationOperationOptions) (result GetManagedAppRegistrationOperationResponse, err error) {
