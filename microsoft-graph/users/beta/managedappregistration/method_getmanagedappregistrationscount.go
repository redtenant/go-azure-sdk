...
func DefaultGetManagedAppRegistrationsCountOperationOptions() GetManagedAppRegistrationsCountOperationOptions {
	return GetManagedAppRegistrationsCountOperationOptions{}
}
...
func (c ManagedAppRegistrationClient) GetManagedAppRegistrationsCount(ctx context.Context, id beta.UserId, options GetManagedAppRegistrationsCountOperationOptions) (result GetManagedAppRegistrationsCountOperationResponse, err error) {
	opts := client.RequestOptions{
		...
		Path:          fmt.Sprintf("%s/managedAppRegistrations/$count", id.ID()),
