...
func (c ManagedDeviceDetectedAppClient) GetManagedDeviceDetectedAppsCount(ctx context.Context, id beta.UserIdManagedDeviceId, options GetManagedDeviceDetectedAppsCountOperationOptions) (result GetManagedDeviceDetectedAppsCountOperationResponse, err error) {
