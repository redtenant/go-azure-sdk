...
// ListManagedDeviceDetectedApps - Get detectedApps from users. All applications currently installed on the device
func (c ManagedDeviceDetectedAppClient) ListManagedDeviceDetectedApps(ctx context.Context, id beta.UserIdManagedDeviceId, options ListManagedDeviceDetectedAppsOperationOptions) (result ListManagedDeviceDetectedAppsOperationResponse, err error) {
...
func (c ManagedDeviceDetectedAppClient) ListManagedDeviceDetectedAppsComplete(ctx context.Context, id beta.UserIdManagedDeviceId, options ListManagedDeviceDetectedAppsOperationOptions) (ListManagedDeviceDetectedAppsCompleteResult, error) {
...
func (c ManagedDeviceDetectedAppClient) ListManagedDeviceDetectedAppsCompleteMatchingPredicate(ctx context.Context, id beta.UserIdManagedDeviceId, options ListManagedDeviceDetectedAppsOperationOptions, predicate DetectedAppOperationPredicate) (result ListManagedDeviceDetectedAppsCompleteResult, err error) {
