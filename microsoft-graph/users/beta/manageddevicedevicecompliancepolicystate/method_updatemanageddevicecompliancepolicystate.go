...
func (c ManagedDeviceDeviceCompliancePolicyStateClient) UpdateManagedDeviceCompliancePolicyState(ctx context.Context, id beta.UserIdManagedDeviceIdDeviceCompliancePolicyStateId, input beta.DeviceCompliancePolicyState, options UpdateManagedDeviceCompliancePolicyStateOperationOptions) (result UpdateManagedDeviceCompliancePolicyStateOperationResponse, err error) {
