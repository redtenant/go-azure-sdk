...
func (c ManagedDeviceDeviceConfigurationStateClient) CreateManagedDeviceConfigurationState(ctx context.Context, id beta.UserIdManagedDeviceId, input beta.DeviceConfigurationState, options CreateManagedDeviceConfigurationStateOperationOptions) (result CreateManagedDeviceConfigurationStateOperationResponse, err error) {
