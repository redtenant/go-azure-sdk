...
func (c ManagedDeviceDeviceConfigurationStateClient) DeleteManagedDeviceConfigurationState(ctx context.Context, id beta.UserIdManagedDeviceIdDeviceConfigurationStateId, options DeleteManagedDeviceConfigurationStateOperationOptions) (result DeleteManagedDeviceConfigurationStateOperationResponse, err error) {
