...
// device.
func (c ManagedDeviceDeviceConfigurationStateClient) GetManagedDeviceConfigurationState(ctx context.Context, id beta.UserIdManagedDeviceIdDeviceConfigurationStateId, options GetManagedDeviceConfigurationStateOperationOptions) (result GetManagedDeviceConfigurationStateOperationResponse, err error) {
