...
// GetManagedDeviceMobileAppConfigurationState - Get managedDeviceMobileAppConfigurationStates from users. Managed
// device mobile app configuration states for this device.
func (c ManagedDeviceManagedDeviceMobileAppConfigurationStateClient) GetManagedDeviceMobileAppConfigurationState(ctx context.Context, id beta.UserIdManagedDeviceIdManagedDeviceMobileAppConfigurationStateId, options GetManagedDeviceMobileAppConfigurationStateOperationOptions) (result GetManagedDeviceMobileAppConfigurationStateOperationResponse, err error) {
