...
// DeleteManagedDeviceSecurityBaselineState - Delete navigation property securityBaselineStates for users
func (c ManagedDeviceSecurityBaselineStateClient) DeleteManagedDeviceSecurityBaselineState(ctx context.Context, id beta.UserIdManagedDeviceIdSecurityBaselineStateId, options DeleteManagedDeviceSecurityBaselineStateOperationOptions) (result DeleteManagedDeviceSecurityBaselineStateOperationResponse, err error) {
