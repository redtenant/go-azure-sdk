...
// GetManagedDeviceSecurityBaselineState - Get securityBaselineStates from users. Security baseline states for this
// device.
func (c ManagedDeviceSecurityBaselineStateClient) GetManagedDeviceSecurityBaselineState(ctx context.Context, id beta.UserIdManagedDeviceIdSecurityBaselineStateId, options GetManagedDeviceSecurityBaselineStateOperationOptions) (result GetManagedDeviceSecurityBaselineStateOperationResponse, err error) {
