...
// CreateManagedDeviceSecurityBaselineStateSettingState - Create new navigation property to settingStates for users
func (c ManagedDeviceSecurityBaselineStateSettingStateClient) CreateManagedDeviceSecurityBaselineStateSettingState(ctx context.Context, id beta.UserIdManagedDeviceIdSecurityBaselineStateId, input beta.SecurityBaselineSettingState, options CreateManagedDeviceSecurityBaselineStateSettingStateOperationOptions) (result CreateManagedDeviceSecurityBaselineStateSettingStateOperationResponse, err error) {
