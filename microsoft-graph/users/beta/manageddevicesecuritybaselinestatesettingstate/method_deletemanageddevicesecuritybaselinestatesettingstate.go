...
// DeleteManagedDeviceSecurityBaselineStateSettingState - Delete navigation property settingStates for users
func (c ManagedDeviceSecurityBaselineStateSettingStateClient) DeleteManagedDeviceSecurityBaselineStateSettingState(ctx context.Context, id beta.UserIdManagedDeviceIdSecurityBaselineStateIdSettingStateId, options DeleteManagedDeviceSecurityBaselineStateSettingStateOperationOptions) (result DeleteManagedDeviceSecurityBaselineStateSettingStateOperationResponse, err error) {
