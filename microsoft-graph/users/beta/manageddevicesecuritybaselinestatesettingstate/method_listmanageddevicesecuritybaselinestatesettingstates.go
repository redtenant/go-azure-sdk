...
// ListManagedDeviceSecurityBaselineStateSettingStates - Get settingStates from users. The security baseline state for
// different settings for a device
func (c ManagedDeviceSecurityBaselineStateSettingStateClient) ListManagedDeviceSecurityBaselineStateSettingStates(ctx context.Context, id beta.UserIdManagedDeviceIdSecurityBaselineStateId, options ListManagedDeviceSecurityBaselineStateSettingStatesOperationOptions) (result ListManagedDeviceSecurityBaselineStateSettingStatesOperationResponse, err error) {
...
func (c ManagedDeviceSecurityBaselineStateSettingStateClient) ListManagedDeviceSecurityBaselineStateSettingStatesComplete(ctx context.Context, id beta.UserIdManagedDeviceIdSecurityBaselineStateId, options ListManagedDeviceSecurityBaselineStateSettingStatesOperationOptions) (ListManagedDeviceSecurityBaselineStateSettingStatesCompleteResult, error) {
...
func (c ManagedDeviceSecurityBaselineStateSettingStateClient) ListManagedDeviceSecurityBaselineStateSettingStatesCompleteMatchingPredicate(ctx context.Context, id beta.UserIdManagedDeviceIdSecurityBaselineStateId, options ListManagedDeviceSecurityBaselineStateSettingStatesOperationOptions, predicate SecurityBaselineSettingStateOperationPredicate) (result ListManagedDeviceSecurityBaselineStateSettingStatesCompleteResult, err error) {
