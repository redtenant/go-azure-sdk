...
func (c ManagedDeviceWindowsProtectionStateClient) DeleteManagedDeviceWindowsProtectionState(ctx context.Context, id beta.UserIdManagedDeviceId, options DeleteManagedDeviceWindowsProtectionStateOperationOptions) (result DeleteManagedDeviceWindowsProtectionStateOperationResponse, err error) {
