...
func (c ManagerClient) GetManagerRef(ctx context.Context, id beta.UserId, options GetManagerRefOperationOptions) (result GetManagerRefOperationResponse, err error) {
