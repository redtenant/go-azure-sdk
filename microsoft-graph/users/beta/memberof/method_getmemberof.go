...
// GetMemberOf - Get memberOf from users. The groups, directory roles, and administrative units that the user is a
// member of. Read-only. Nullable. Supports $expand.
func (c MemberOfClient) GetMemberOf(ctx context.Context, id beta.UserIdMemberOfId, options GetMemberOfOperationOptions) (result GetMemberOfOperationResponse, err error) {
