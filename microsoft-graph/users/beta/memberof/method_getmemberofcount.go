...
func (c MemberOfClient) GetMemberOfCount(ctx context.Context, id beta.UserId, options GetMemberOfCountOperationOptions) (result GetMemberOfCountOperationResponse, err error) {
