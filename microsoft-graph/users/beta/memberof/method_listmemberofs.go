...
func (c MemberOfClient) ListMemberOfs(ctx context.Context, id beta.UserId, options ListMemberOfsOperationOptions) (result ListMemberOfsOperationResponse, err error) {
...
func (c MemberOfClient) ListMemberOfsComplete(ctx context.Context, id beta.UserId, options ListMemberOfsOperationOptions) (ListMemberOfsCompleteResult, error) {
...
func (c MemberOfClient) ListMemberOfsCompleteMatchingPredicate(ctx context.Context, id beta.UserId, options ListMemberOfsOperationOptions, predicate DirectoryObjectOperationPredicate) (result ListMemberOfsCompleteResult, err error) {
