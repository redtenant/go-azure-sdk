...
func (c MessageClient) DeleteMessage(ctx context.Context, id beta.UserIdMessageId, options DeleteMessageOperationOptions) (result DeleteMessageOperationResponse, err error) {
