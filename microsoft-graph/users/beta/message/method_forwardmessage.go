...
func (c MessageClient) ForwardMessage(ctx context.Context, id beta.UserIdMessageId, input ForwardMessageRequest, options ForwardMessageOperationOptions) (result ForwardMessageOperationResponse, err error) {
