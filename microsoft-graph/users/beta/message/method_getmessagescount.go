...
func (c MessageClient) GetMessagesCount(ctx context.Context, id beta.UserId, options GetMessagesCountOperationOptions) (result GetMessagesCountOperationResponse, err error) {
