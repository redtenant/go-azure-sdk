...
func (c MessageClient) ListMessages(ctx context.Context, id beta.UserId, options ListMessagesOperationOptions) (result ListMessagesOperationResponse, err error) {
...
func (c MessageClient) ListMessagesComplete(ctx context.Context, id beta.UserId, options ListMessagesOperationOptions) (ListMessagesCompleteResult, error) {
...
func (c MessageClient) ListMessagesCompleteMatchingPredicate(ctx context.Context, id beta.UserId, options ListMessagesOperationOptions, predicate MessageOperationPredicate) (result ListMessagesCompleteResult, err error) {
