...
func (c MessageClient) SendMessage(ctx context.Context, id beta.UserIdMessageId, options SendMessageOperationOptions) (result SendMessageOperationResponse, err error) {
