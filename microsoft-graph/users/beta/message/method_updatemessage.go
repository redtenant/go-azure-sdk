...
func (c MessageClient) UpdateMessage(ctx context.Context, id beta.UserIdMessageId, input beta.Message, options UpdateMessageOperationOptions) (result UpdateMessageOperationResponse, err error) {
