...
func (c MessageExtensionClient) CreateMessageExtension(ctx context.Context, id beta.UserIdMessageId, input beta.Extension, options CreateMessageExtensionOperationOptions) (result CreateMessageExtensionOperationResponse, err error) {
