...
func (c MessageExtensionClient) DeleteMessageExtension(ctx context.Context, id beta.UserIdMessageIdExtensionId, options DeleteMessageExtensionOperationOptions) (result DeleteMessageExtensionOperationResponse, err error) {
