...
func (c MessageExtensionClient) GetMessageExtension(ctx context.Context, id beta.UserIdMessageIdExtensionId, options GetMessageExtensionOperationOptions) (result GetMessageExtensionOperationResponse, err error) {
