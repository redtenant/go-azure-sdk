...
func (c MessageExtensionClient) GetMessageExtensionsCount(ctx context.Context, id beta.UserIdMessageId, options GetMessageExtensionsCountOperationOptions) (result GetMessageExtensionsCountOperationResponse, err error) {
