...
func (c MessageExtensionClient) UpdateMessageExtension(ctx context.Context, id beta.UserIdMessageIdExtensionId, input beta.Extension, options UpdateMessageExtensionOperationOptions) (result UpdateMessageExtensionOperationResponse, err error) {
