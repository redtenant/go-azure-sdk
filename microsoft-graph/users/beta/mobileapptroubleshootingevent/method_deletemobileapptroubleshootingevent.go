...
// DeleteMobileAppTroubleshootingEvent - Delete navigation property mobileAppTroubleshootingEvents for users
func (c MobileAppTroubleshootingEventClient) DeleteMobileAppTroubleshootingEvent(ctx context.Context, id beta.UserIdMobileAppTroubleshootingEventId, options DeleteMobileAppTroubleshootingEventOperationOptions) (result DeleteMobileAppTroubleshootingEventOperationResponse, err error) {
