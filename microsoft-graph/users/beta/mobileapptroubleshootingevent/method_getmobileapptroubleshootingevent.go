...
// GetMobileAppTroubleshootingEvent - Get mobileAppTroubleshootingEvents from users. The list of mobile app
// troubleshooting events for this user.
func (c MobileAppTroubleshootingEventClient) GetMobileAppTroubleshootingEvent(ctx context.Context, id beta.UserIdMobileAppTroubleshootingEventId, options GetMobileAppTroubleshootingEventOperationOptions) (result GetMobileAppTroubleshootingEventOperationResponse, err error) {
