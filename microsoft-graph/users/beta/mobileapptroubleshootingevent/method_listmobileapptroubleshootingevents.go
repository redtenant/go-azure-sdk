...
// ListMobileAppTroubleshootingEvents - Get mobileAppTroubleshootingEvents from users. The list of mobile app
// troubleshooting events for this user.
func (c MobileAppTroubleshootingEventClient) ListMobileAppTroubleshootingEvents(ctx context.Context, id beta.UserId, options ListMobileAppTroubleshootingEventsOperationOptions) (result ListMobileAppTroubleshootingEventsOperationResponse, err error) {
	opts := client.RequestOptions{
		...
		Path:          fmt.Sprintf("%s/mobileAppTroubleshootingEvents", id.ID()),
	...
	var values struct {
		Values *[]beta.MobileAppTroubleshootingEvent `json:"value"`
	}
...
func (c MobileAppTroubleshootingEventClient) ListMobileAppTroubleshootingEventsComplete(ctx context.Context, id beta.UserId, options ListMobileAppTroubleshootingEventsOperationOptions) (ListMobileAppTroubleshootingEventsCompleteResult, error) {
	return c.ListMobileAppTroubleshootingEventsCompleteMatchingPredicate(ctx, id, options, MobileAppTroubleshootingEventOperationPredicate{})
}

// ListMobileAppTroubleshootingEventsCompleteMatchingPredicate retrieves all the results and then applies the predicate
func (c MobileAppTroubleshootingEventClient) ListMobileAppTroubleshootingEventsCompleteMatchingPredicate(ctx context.Context, id beta.UserId, options ListMobileAppTroubleshootingEventsOperationOptions, predicate MobileAppTroubleshootingEventOperationPredicate) (result ListMobileAppTroubleshootingEventsCompleteResult, err error) {
	items := make([]beta.MobileAppTroubleshootingEvent, 0)

	resp, err := c.ListMobileAppTroubleshootingEvents(ctx, id, options)
	if err != nil {
