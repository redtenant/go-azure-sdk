...
// GetMobileAppTroubleshootingEventAppLogCollectionRequest - Get appLogCollectionRequests from users. Indicates
// collection of App Log Upload Request.
func (c MobileAppTroubleshootingEventAppLogCollectionRequestClient) GetMobileAppTroubleshootingEventAppLogCollectionRequest(ctx context.Context, id beta.UserIdMobileAppTroubleshootingEventIdAppLogCollectionRequestId, options GetMobileAppTroubleshootingEventAppLogCollectionRequestOperationOptions) (result GetMobileAppTroubleshootingEventAppLogCollectionRequestOperationResponse, err error) {
