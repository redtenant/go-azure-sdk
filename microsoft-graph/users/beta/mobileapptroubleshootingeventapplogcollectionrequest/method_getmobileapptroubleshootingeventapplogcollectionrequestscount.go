...
func (c MobileAppTroubleshootingEventAppLogCollectionRequestClient) GetMobileAppTroubleshootingEventAppLogCollectionRequestsCount(ctx context.Context, id beta.UserIdMobileAppTroubleshootingEventId, options GetMobileAppTroubleshootingEventAppLogCollectionRequestsCountOperationOptions) (result GetMobileAppTroubleshootingEventAppLogCollectionRequestsCountOperationResponse, err error) {
