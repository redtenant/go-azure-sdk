...
// in users
func (c MobileAppTroubleshootingEventAppLogCollectionRequestClient) UpdateMobileAppTroubleshootingEventAppLogCollectionRequest(ctx context.Context, id beta.UserIdMobileAppTroubleshootingEventIdAppLogCollectionRequestId, input beta.AppLogCollectionRequest, options UpdateMobileAppTroubleshootingEventAppLogCollectionRequestOperationOptions) (result UpdateMobileAppTroubleshootingEventAppLogCollectionRequestOperationResponse, err error) {
