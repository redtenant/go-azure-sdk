...
func (c OAuth2PermissionGrantClient) GetOAuth2PermissionGrant(ctx context.Context, id beta.UserIdOAuth2PermissionGrantId, options GetOAuth2PermissionGrantOperationOptions) (result GetOAuth2PermissionGrantOperationResponse, err error) {
