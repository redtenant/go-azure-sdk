...
func (c OAuth2PermissionGrantClient) GetOAuth2PermissionGrantsCount(ctx context.Context, id beta.UserId, options GetOAuth2PermissionGrantsCountOperationOptions) (result GetOAuth2PermissionGrantsCountOperationResponse, err error) {
