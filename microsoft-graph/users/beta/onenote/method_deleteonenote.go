...
func (c OnenoteClient) DeleteOnenote(ctx context.Context, id beta.UserId, options DeleteOnenoteOperationOptions) (result DeleteOnenoteOperationResponse, err error) {
