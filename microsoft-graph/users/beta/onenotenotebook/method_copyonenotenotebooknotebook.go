...
func (c OnenoteNotebookClient) CopyOnenoteNotebookNotebook(ctx context.Context, id beta.UserIdOnenoteNotebookId, input CopyOnenoteNotebookNotebookRequest, options CopyOnenoteNotebookNotebookOperationOptions) (result CopyOnenoteNotebookNotebookOperationResponse, err error) {
