...
func (c OnenoteNotebookClient) CreateOnenoteNotebook(ctx context.Context, id beta.UserId, input beta.Notebook, options CreateOnenoteNotebookOperationOptions) (result CreateOnenoteNotebookOperationResponse, err error) {
