...
func (c OnenoteNotebookClient) DeleteOnenoteNotebook(ctx context.Context, id beta.UserIdOnenoteNotebookId, options DeleteOnenoteNotebookOperationOptions) (result DeleteOnenoteNotebookOperationResponse, err error) {
