...
func (c OnenoteNotebookClient) GetOnenoteNotebook(ctx context.Context, id beta.UserIdOnenoteNotebookId, options GetOnenoteNotebookOperationOptions) (result GetOnenoteNotebookOperationResponse, err error) {
