...
func (c OnenoteNotebookClient) GetOnenoteNotebooksCount(ctx context.Context, id beta.UserId, options GetOnenoteNotebooksCountOperationOptions) (result GetOnenoteNotebooksCountOperationResponse, err error) {
