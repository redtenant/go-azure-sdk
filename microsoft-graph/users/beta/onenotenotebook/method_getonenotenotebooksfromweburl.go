...
func (c OnenoteNotebookClient) GetOnenoteNotebooksFromWebUrl(ctx context.Context, id beta.UserId, input GetOnenoteNotebooksFromWebUrlRequest, options GetOnenoteNotebooksFromWebUrlOperationOptions) (result GetOnenoteNotebooksFromWebUrlOperationResponse, err error) {
