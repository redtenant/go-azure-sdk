...
func (c OnenoteNotebookClient) ListOnenoteNotebooks(ctx context.Context, id beta.UserId, options ListOnenoteNotebooksOperationOptions) (result ListOnenoteNotebooksOperationResponse, err error) {
...
func (c OnenoteNotebookClient) ListOnenoteNotebooksComplete(ctx context.Context, id beta.UserId, options ListOnenoteNotebooksOperationOptions) (ListOnenoteNotebooksCompleteResult, error) {
...
func (c OnenoteNotebookClient) ListOnenoteNotebooksCompleteMatchingPredicate(ctx context.Context, id beta.UserId, options ListOnenoteNotebooksOperationOptions, predicate NotebookOperationPredicate) (result ListOnenoteNotebooksCompleteResult, err error) {
