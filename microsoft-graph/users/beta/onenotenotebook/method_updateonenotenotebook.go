...
func (c OnenoteNotebookClient) UpdateOnenoteNotebook(ctx context.Context, id beta.UserIdOnenoteNotebookId, input beta.Notebook, options UpdateOnenoteNotebookOperationOptions) (result UpdateOnenoteNotebookOperationResponse, err error) {
