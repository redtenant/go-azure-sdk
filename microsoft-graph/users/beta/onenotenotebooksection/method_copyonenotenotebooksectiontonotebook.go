...
func (c OnenoteNotebookSectionClient) CopyOnenoteNotebookSectionToNotebook(ctx context.Context, id beta.UserIdOnenoteNotebookIdSectionId, input CopyOnenoteNotebookSectionToNotebookRequest, options CopyOnenoteNotebookSectionToNotebookOperationOptions) (result CopyOnenoteNotebookSectionToNotebookOperationResponse, err error) {
