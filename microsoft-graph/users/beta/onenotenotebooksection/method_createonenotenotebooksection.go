...
func (c OnenoteNotebookSectionClient) CreateOnenoteNotebookSection(ctx context.Context, id beta.UserIdOnenoteNotebookId, input beta.OnenoteSection, options CreateOnenoteNotebookSectionOperationOptions) (result CreateOnenoteNotebookSectionOperationResponse, err error) {
