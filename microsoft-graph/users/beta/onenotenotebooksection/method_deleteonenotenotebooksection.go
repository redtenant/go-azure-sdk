...
func (c OnenoteNotebookSectionClient) DeleteOnenoteNotebookSection(ctx context.Context, id beta.UserIdOnenoteNotebookIdSectionId, options DeleteOnenoteNotebookSectionOperationOptions) (result DeleteOnenoteNotebookSectionOperationResponse, err error) {
