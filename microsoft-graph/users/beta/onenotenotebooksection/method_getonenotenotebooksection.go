...
func (c OnenoteNotebookSectionClient) GetOnenoteNotebookSection(ctx context.Context, id beta.UserIdOnenoteNotebookIdSectionId, options GetOnenoteNotebookSectionOperationOptions) (result GetOnenoteNotebookSectionOperationResponse, err error) {
