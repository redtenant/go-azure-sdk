...
func (c OnenoteNotebookSectionClient) GetOnenoteNotebookSectionsCount(ctx context.Context, id beta.UserIdOnenoteNotebookId, options GetOnenoteNotebookSectionsCountOperationOptions) (result GetOnenoteNotebookSectionsCountOperationResponse, err error) {
