...
func (c OnenoteNotebookSectionClient) ListOnenoteNotebookSections(ctx context.Context, id beta.UserIdOnenoteNotebookId, options ListOnenoteNotebookSectionsOperationOptions) (result ListOnenoteNotebookSectionsOperationResponse, err error) {
...
func (c OnenoteNotebookSectionClient) ListOnenoteNotebookSectionsComplete(ctx context.Context, id beta.UserIdOnenoteNotebookId, options ListOnenoteNotebookSectionsOperationOptions) (ListOnenoteNotebookSectionsCompleteResult, error) {
...
func (c OnenoteNotebookSectionClient) ListOnenoteNotebookSectionsCompleteMatchingPredicate(ctx context.Context, id beta.UserIdOnenoteNotebookId, options ListOnenoteNotebookSectionsOperationOptions, predicate OnenoteSectionOperationPredicate) (result ListOnenoteNotebookSectionsCompleteResult, err error) {
