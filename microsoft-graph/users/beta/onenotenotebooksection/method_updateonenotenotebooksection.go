...
func (c OnenoteNotebookSectionClient) UpdateOnenoteNotebookSection(ctx context.Context, id beta.UserIdOnenoteNotebookIdSectionId, input beta.OnenoteSection, options UpdateOnenoteNotebookSectionOperationOptions) (result UpdateOnenoteNotebookSectionOperationResponse, err error) {
