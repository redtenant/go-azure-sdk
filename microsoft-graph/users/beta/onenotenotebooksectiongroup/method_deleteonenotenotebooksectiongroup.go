...
func (c OnenoteNotebookSectionGroupClient) DeleteOnenoteNotebookSectionGroup(ctx context.Context, id beta.UserIdOnenoteNotebookIdSectionGroupId, options DeleteOnenoteNotebookSectionGroupOperationOptions) (result DeleteOnenoteNotebookSectionGroupOperationResponse, err error) {
