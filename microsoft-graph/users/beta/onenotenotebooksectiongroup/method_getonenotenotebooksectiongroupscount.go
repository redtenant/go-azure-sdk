...
func (c OnenoteNotebookSectionGroupClient) GetOnenoteNotebookSectionGroupsCount(ctx context.Context, id beta.UserIdOnenoteNotebookId, options GetOnenoteNotebookSectionGroupsCountOperationOptions) (result GetOnenoteNotebookSectionGroupsCountOperationResponse, err error) {
