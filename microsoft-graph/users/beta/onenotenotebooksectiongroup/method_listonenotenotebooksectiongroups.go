...
// Nullable.
func (c OnenoteNotebookSectionGroupClient) ListOnenoteNotebookSectionGroups(ctx context.Context, id beta.UserIdOnenoteNotebookId, options ListOnenoteNotebookSectionGroupsOperationOptions) (result ListOnenoteNotebookSectionGroupsOperationResponse, err error) {
...
func (c OnenoteNotebookSectionGroupClient) ListOnenoteNotebookSectionGroupsComplete(ctx context.Context, id beta.UserIdOnenoteNotebookId, options ListOnenoteNotebookSectionGroupsOperationOptions) (ListOnenoteNotebookSectionGroupsCompleteResult, error) {
...
func (c OnenoteNotebookSectionGroupClient) ListOnenoteNotebookSectionGroupsCompleteMatchingPredicate(ctx context.Context, id beta.UserIdOnenoteNotebookId, options ListOnenoteNotebookSectionGroupsOperationOptions, predicate SectionGroupOperationPredicate) (result ListOnenoteNotebookSectionGroupsCompleteResult, err error) {
