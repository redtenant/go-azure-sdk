...
func (c OnenoteNotebookSectionGroupClient) UpdateOnenoteNotebookSectionGroup(ctx context.Context, id beta.UserIdOnenoteNotebookIdSectionGroupId, input beta.SectionGroup, options UpdateOnenoteNotebookSectionGroupOperationOptions) (result UpdateOnenoteNotebookSectionGroupOperationResponse, err error) {
