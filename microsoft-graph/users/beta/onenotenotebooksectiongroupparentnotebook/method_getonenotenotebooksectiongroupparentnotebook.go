...
// GetOnenoteNotebookSectionGroupParentNotebook - Get parentNotebook from users. The notebook that contains the section
// group. Read-only.
func (c OnenoteNotebookSectionGroupParentNotebookClient) GetOnenoteNotebookSectionGroupParentNotebook(ctx context.Context, id beta.UserIdOnenoteNotebookIdSectionGroupId, options GetOnenoteNotebookSectionGroupParentNotebookOperationOptions) (result GetOnenoteNotebookSectionGroupParentNotebookOperationResponse, err error) {
