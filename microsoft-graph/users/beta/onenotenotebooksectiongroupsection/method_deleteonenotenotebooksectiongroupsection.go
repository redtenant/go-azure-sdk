...
func (c OnenoteNotebookSectionGroupSectionClient) DeleteOnenoteNotebookSectionGroupSection(ctx context.Context, id beta.UserIdOnenoteNotebookIdSectionGroupIdSectionId, options DeleteOnenoteNotebookSectionGroupSectionOperationOptions) (result DeleteOnenoteNotebookSectionGroupSectionOperationResponse, err error) {
