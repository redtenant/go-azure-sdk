...
// GetOnenoteNotebookSectionGroupSection - Get sections from users. The sections in the section group. Read-only.
// Nullable.
func (c OnenoteNotebookSectionGroupSectionClient) GetOnenoteNotebookSectionGroupSection(ctx context.Context, id beta.UserIdOnenoteNotebookIdSectionGroupIdSectionId, options GetOnenoteNotebookSectionGroupSectionOperationOptions) (result GetOnenoteNotebookSectionGroupSectionOperationResponse, err error) {
