...
// ListOnenoteNotebookSectionGroupSections - Get sections from users. The sections in the section group. Read-only.
// Nullable.
func (c OnenoteNotebookSectionGroupSectionClient) ListOnenoteNotebookSectionGroupSections(ctx context.Context, id beta.UserIdOnenoteNotebookIdSectionGroupId, options ListOnenoteNotebookSectionGroupSectionsOperationOptions) (result ListOnenoteNotebookSectionGroupSectionsOperationResponse, err error) {
...
func (c OnenoteNotebookSectionGroupSectionClient) ListOnenoteNotebookSectionGroupSectionsComplete(ctx context.Context, id beta.UserIdOnenoteNotebookIdSectionGroupId, options ListOnenoteNotebookSectionGroupSectionsOperationOptions) (ListOnenoteNotebookSectionGroupSectionsCompleteResult, error) {
