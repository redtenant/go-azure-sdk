...
func (c OnenoteNotebookSectionGroupSectionPageClient) CopyOnenoteNotebookSectionGroupSectionPageToSection(ctx context.Context, id beta.UserIdOnenoteNotebookIdSectionGroupIdSectionIdPageId, input CopyOnenoteNotebookSectionGroupSectionPageToSectionRequest, options CopyOnenoteNotebookSectionGroupSectionPageToSectionOperationOptions) (result CopyOnenoteNotebookSectionGroupSectionPageToSectionOperationResponse, err error) {
