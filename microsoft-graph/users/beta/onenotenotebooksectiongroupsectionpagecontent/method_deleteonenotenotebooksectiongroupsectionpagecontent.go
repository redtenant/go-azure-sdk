...
// page's HTML content.
func (c OnenoteNotebookSectionGroupSectionPageContentClient) DeleteOnenoteNotebookSectionGroupSectionPageContent(ctx context.Context, id beta.UserIdOnenoteNotebookIdSectionGroupIdSectionIdPageId, options DeleteOnenoteNotebookSectionGroupSectionPageContentOperationOptions) (result DeleteOnenoteNotebookSectionGroupSectionPageContentOperationResponse, err error) {
