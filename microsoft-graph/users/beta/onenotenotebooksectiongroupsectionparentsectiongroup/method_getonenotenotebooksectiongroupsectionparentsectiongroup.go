...
func (c OnenoteNotebookSectionGroupSectionParentSectionGroupClient) GetOnenoteNotebookSectionGroupSectionParentSectionGroup(ctx context.Context, id beta.UserIdOnenoteNotebookIdSectionGroupIdSectionId, options GetOnenoteNotebookSectionGroupSectionParentSectionGroupOperationOptions) (result GetOnenoteNotebookSectionGroupSectionParentSectionGroupOperationResponse, err error) {
