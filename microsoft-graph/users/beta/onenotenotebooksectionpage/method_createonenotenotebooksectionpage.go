...
func (c OnenoteNotebookSectionPageClient) CreateOnenoteNotebookSectionPage(ctx context.Context, id beta.UserIdOnenoteNotebookIdSectionId, input beta.OnenotePage, options CreateOnenoteNotebookSectionPageOperationOptions) (result CreateOnenoteNotebookSectionPageOperationResponse, err error) {
