...
func (c OnenoteNotebookSectionPageClient) DeleteOnenoteNotebookSectionPage(ctx context.Context, id beta.UserIdOnenoteNotebookIdSectionIdPageId, options DeleteOnenoteNotebookSectionPageOperationOptions) (result DeleteOnenoteNotebookSectionPageOperationResponse, err error) {
