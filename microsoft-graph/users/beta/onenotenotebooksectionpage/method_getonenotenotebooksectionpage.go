...
func (c OnenoteNotebookSectionPageClient) GetOnenoteNotebookSectionPage(ctx context.Context, id beta.UserIdOnenoteNotebookIdSectionIdPageId, options GetOnenoteNotebookSectionPageOperationOptions) (result GetOnenoteNotebookSectionPageOperationResponse, err error) {
