...
func (c OnenoteNotebookSectionPageClient) GetOnenoteNotebookSectionPagesCount(ctx context.Context, id beta.UserIdOnenoteNotebookIdSectionId, options GetOnenoteNotebookSectionPagesCountOperationOptions) (result GetOnenoteNotebookSectionPagesCountOperationResponse, err error) {
