...
// Read-only.
func (c OnenoteNotebookSectionPageParentNotebookClient) GetOnenoteNotebookSectionPageParentNotebook(ctx context.Context, id beta.UserIdOnenoteNotebookIdSectionIdPageId, options GetOnenoteNotebookSectionPageParentNotebookOperationOptions) (result GetOnenoteNotebookSectionPageParentNotebookOperationResponse, err error) {
