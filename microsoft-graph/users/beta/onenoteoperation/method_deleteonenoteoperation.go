...
func (c OnenoteOperationClient) DeleteOnenoteOperation(ctx context.Context, id beta.UserIdOnenoteOperationId, options DeleteOnenoteOperationOperationOptions) (result DeleteOnenoteOperationOperationResponse, err error) {
