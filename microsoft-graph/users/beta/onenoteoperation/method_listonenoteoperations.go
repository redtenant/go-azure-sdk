...
func (c OnenoteOperationClient) ListOnenoteOperations(ctx context.Context, id beta.UserId, options ListOnenoteOperationsOperationOptions) (result ListOnenoteOperationsOperationResponse, err error) {
...
func (c OnenoteOperationClient) ListOnenoteOperationsComplete(ctx context.Context, id beta.UserId, options ListOnenoteOperationsOperationOptions) (ListOnenoteOperationsCompleteResult, error) {
...
func (c OnenoteOperationClient) ListOnenoteOperationsCompleteMatchingPredicate(ctx context.Context, id beta.UserId, options ListOnenoteOperationsOperationOptions, predicate OnenoteOperationOperationPredicate) (result ListOnenoteOperationsCompleteResult, err error) {
