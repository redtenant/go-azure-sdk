...
func (c OnenoteOperationClient) UpdateOnenoteOperation(ctx context.Context, id beta.UserIdOnenoteOperationId, input beta.OnenoteOperation, options UpdateOnenoteOperationOperationOptions) (result UpdateOnenoteOperationOperationResponse, err error) {
