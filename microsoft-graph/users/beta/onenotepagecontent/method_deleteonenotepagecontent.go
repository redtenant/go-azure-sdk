...
func (c OnenotePageContentClient) DeleteOnenotePageContent(ctx context.Context, id beta.UserIdOnenotePageId, options DeleteOnenotePageContentOperationOptions) (result DeleteOnenotePageContentOperationResponse, err error) {
