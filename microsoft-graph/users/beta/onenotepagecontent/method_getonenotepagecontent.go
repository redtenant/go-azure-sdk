...
func (c OnenotePageContentClient) GetOnenotePageContent(ctx context.Context, id beta.UserIdOnenotePageId, options GetOnenotePageContentOperationOptions) (result GetOnenotePageContentOperationResponse, err error) {
