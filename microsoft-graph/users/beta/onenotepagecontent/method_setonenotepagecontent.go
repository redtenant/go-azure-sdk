...
func (c OnenotePageContentClient) SetOnenotePageContent(ctx context.Context, id beta.UserIdOnenotePageId, input []byte, options SetOnenotePageContentOperationOptions) (result SetOnenotePageContentOperationResponse, err error) {
