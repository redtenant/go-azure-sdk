...
func (c OnenoteResourceClient) CreateOnenoteResource(ctx context.Context, id beta.UserId, input beta.OnenoteResource, options CreateOnenoteResourceOperationOptions) (result CreateOnenoteResourceOperationResponse, err error) {
