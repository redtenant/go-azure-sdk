...
func (c OnenoteResourceClient) UpdateOnenoteResource(ctx context.Context, id beta.UserIdOnenoteResourceId, input beta.OnenoteResource, options UpdateOnenoteResourceOperationOptions) (result UpdateOnenoteResourceOperationResponse, err error) {
