...
// GetOnenoteResourceContent - Get content for the navigation property resources from users. The content of the
// resource.
func (c OnenoteResourceContentClient) GetOnenoteResourceContent(ctx context.Context, id beta.UserIdOnenoteResourceId, options GetOnenoteResourceContentOperationOptions) (result GetOnenoteResourceContentOperationResponse, err error) {
