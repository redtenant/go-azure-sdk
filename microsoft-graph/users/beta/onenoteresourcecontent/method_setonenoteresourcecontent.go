...
// SetOnenoteResourceContent - Update content for the navigation property resources in users. The content of the
// resource.
func (c OnenoteResourceContentClient) SetOnenoteResourceContent(ctx context.Context, id beta.UserIdOnenoteResourceId, input []byte, options SetOnenoteResourceContentOperationOptions) (result SetOnenoteResourceContentOperationResponse, err error) {
