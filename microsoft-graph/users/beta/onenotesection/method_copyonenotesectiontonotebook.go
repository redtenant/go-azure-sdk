...
// CopyOnenoteSectionToNotebook - Invoke action copyToNotebook. Copies a section to a specific notebook. For Copy
...
func (c OnenoteSectionClient) CopyOnenoteSectionToNotebook(ctx context.Context, id beta.UserIdOnenoteSectionId, input CopyOnenoteSectionToNotebookRequest, options CopyOnenoteSectionToNotebookOperationOptions) (result CopyOnenoteSectionToNotebookOperationResponse, err error) {
