...
// CopyOnenoteSectionToSectionGroup - Invoke action copyToSectionGroup. Copies a section to a specific section group.
...
func (c OnenoteSectionClient) CopyOnenoteSectionToSectionGroup(ctx context.Context, id beta.UserIdOnenoteSectionId, input CopyOnenoteSectionToSectionGroupRequest, options CopyOnenoteSectionToSectionGroupOperationOptions) (result CopyOnenoteSectionToSectionGroupOperationResponse, err error) {
