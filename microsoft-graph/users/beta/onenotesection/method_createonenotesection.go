...
func (c OnenoteSectionClient) CreateOnenoteSection(ctx context.Context, id beta.UserId, input beta.OnenoteSection, options CreateOnenoteSectionOperationOptions) (result CreateOnenoteSectionOperationResponse, err error) {
