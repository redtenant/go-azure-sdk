...
// GetOnenoteSection - Get sections from users. The sections in all OneNote notebooks that are owned by the user or
// group. Read-only. Nullable.
func (c OnenoteSectionClient) GetOnenoteSection(ctx context.Context, id beta.UserIdOnenoteSectionId, options GetOnenoteSectionOperationOptions) (result GetOnenoteSectionOperationResponse, err error) {
