...
func (c OnenoteSectionClient) GetOnenoteSectionsCount(ctx context.Context, id beta.UserId, options GetOnenoteSectionsCountOperationOptions) (result GetOnenoteSectionsCountOperationResponse, err error) {
