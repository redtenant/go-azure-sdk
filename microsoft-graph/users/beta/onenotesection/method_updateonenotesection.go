...
func (c OnenoteSectionClient) UpdateOnenoteSection(ctx context.Context, id beta.UserIdOnenoteSectionId, input beta.OnenoteSection, options UpdateOnenoteSectionOperationOptions) (result UpdateOnenoteSectionOperationResponse, err error) {
