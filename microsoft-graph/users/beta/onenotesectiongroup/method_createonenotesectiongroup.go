...
func (c OnenoteSectionGroupClient) CreateOnenoteSectionGroup(ctx context.Context, id beta.UserId, input beta.SectionGroup, options CreateOnenoteSectionGroupOperationOptions) (result CreateOnenoteSectionGroupOperationResponse, err error) {
