...
func (c OnenoteSectionGroupClient) DeleteOnenoteSectionGroup(ctx context.Context, id beta.UserIdOnenoteSectionGroupId, options DeleteOnenoteSectionGroupOperationOptions) (result DeleteOnenoteSectionGroupOperationResponse, err error) {
