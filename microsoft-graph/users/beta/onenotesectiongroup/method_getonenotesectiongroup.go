...
func (c OnenoteSectionGroupClient) GetOnenoteSectionGroup(ctx context.Context, id beta.UserIdOnenoteSectionGroupId, options GetOnenoteSectionGroupOperationOptions) (result GetOnenoteSectionGroupOperationResponse, err error) {
