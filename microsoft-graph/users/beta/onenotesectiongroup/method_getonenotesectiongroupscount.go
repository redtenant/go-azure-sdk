...
func (c OnenoteSectionGroupClient) GetOnenoteSectionGroupsCount(ctx context.Context, id beta.UserId, options GetOnenoteSectionGroupsCountOperationOptions) (result GetOnenoteSectionGroupsCountOperationResponse, err error) {
