...
func (c OnenoteSectionGroupClient) ListOnenoteSectionGroups(ctx context.Context, id beta.UserId, options ListOnenoteSectionGroupsOperationOptions) (result ListOnenoteSectionGroupsOperationResponse, err error) {
...
func (c OnenoteSectionGroupClient) ListOnenoteSectionGroupsComplete(ctx context.Context, id beta.UserId, options ListOnenoteSectionGroupsOperationOptions) (ListOnenoteSectionGroupsCompleteResult, error) {
