...
func (c OnenoteSectionGroupClient) UpdateOnenoteSectionGroup(ctx context.Context, id beta.UserIdOnenoteSectionGroupId, input beta.SectionGroup, options UpdateOnenoteSectionGroupOperationOptions) (result UpdateOnenoteSectionGroupOperationResponse, err error) {
