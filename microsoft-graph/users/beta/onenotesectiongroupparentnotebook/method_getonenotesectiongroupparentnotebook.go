...
// Read-only.
func (c OnenoteSectionGroupParentNotebookClient) GetOnenoteSectionGroupParentNotebook(ctx context.Context, id beta.UserIdOnenoteSectionGroupId, options GetOnenoteSectionGroupParentNotebookOperationOptions) (result GetOnenoteSectionGroupParentNotebookOperationResponse, err error) {
