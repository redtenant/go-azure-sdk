...
func (c OnenoteSectionGroupParentSectionGroupClient) GetOnenoteSectionGroupParentSectionGroup(ctx context.Context, id beta.UserIdOnenoteSectionGroupId, options GetOnenoteSectionGroupParentSectionGroupOperationOptions) (result GetOnenoteSectionGroupParentSectionGroupOperationResponse, err error) {
