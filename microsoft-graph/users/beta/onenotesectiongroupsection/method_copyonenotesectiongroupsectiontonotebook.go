...
func (c OnenoteSectionGroupSectionClient) CopyOnenoteSectionGroupSectionToNotebook(ctx context.Context, id beta.UserIdOnenoteSectionGroupIdSectionId, input CopyOnenoteSectionGroupSectionToNotebookRequest, options CopyOnenoteSectionGroupSectionToNotebookOperationOptions) (result CopyOnenoteSectionGroupSectionToNotebookOperationResponse, err error) {
