...
func (c OnenoteSectionGroupSectionClient) CreateOnenoteSectionGroupSection(ctx context.Context, id beta.UserIdOnenoteSectionGroupId, input beta.OnenoteSection, options CreateOnenoteSectionGroupSectionOperationOptions) (result CreateOnenoteSectionGroupSectionOperationResponse, err error) {
