...
func (c OnenoteSectionGroupSectionClient) DeleteOnenoteSectionGroupSection(ctx context.Context, id beta.UserIdOnenoteSectionGroupIdSectionId, options DeleteOnenoteSectionGroupSectionOperationOptions) (result DeleteOnenoteSectionGroupSectionOperationResponse, err error) {
