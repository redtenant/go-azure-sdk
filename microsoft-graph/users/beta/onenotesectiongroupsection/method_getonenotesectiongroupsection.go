...
func (c OnenoteSectionGroupSectionClient) GetOnenoteSectionGroupSection(ctx context.Context, id beta.UserIdOnenoteSectionGroupIdSectionId, options GetOnenoteSectionGroupSectionOperationOptions) (result GetOnenoteSectionGroupSectionOperationResponse, err error) {
