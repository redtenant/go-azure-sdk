...
func (c OnenoteSectionGroupSectionClient) GetOnenoteSectionGroupSectionsCount(ctx context.Context, id beta.UserIdOnenoteSectionGroupId, options GetOnenoteSectionGroupSectionsCountOperationOptions) (result GetOnenoteSectionGroupSectionsCountOperationResponse, err error) {
