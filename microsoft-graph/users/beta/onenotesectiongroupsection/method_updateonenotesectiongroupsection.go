...
func (c OnenoteSectionGroupSectionClient) UpdateOnenoteSectionGroupSection(ctx context.Context, id beta.UserIdOnenoteSectionGroupIdSectionId, input beta.OnenoteSection, options UpdateOnenoteSectionGroupSectionOperationOptions) (result UpdateOnenoteSectionGroupSectionOperationResponse, err error) {
