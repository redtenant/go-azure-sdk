...
func (c OnenoteSectionGroupSectionGroupClient) GetOnenoteSectionGroupCount(ctx context.Context, id beta.UserIdOnenoteSectionGroupId, options GetOnenoteSectionGroupCountOperationOptions) (result GetOnenoteSectionGroupCountOperationResponse, err error) {
