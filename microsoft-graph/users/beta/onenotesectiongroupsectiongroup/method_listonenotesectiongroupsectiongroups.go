...
// Nullable.
func (c OnenoteSectionGroupSectionGroupClient) ListOnenoteSectionGroupSectionGroups(ctx context.Context, id beta.UserIdOnenoteSectionGroupId, options ListOnenoteSectionGroupSectionGroupsOperationOptions) (result ListOnenoteSectionGroupSectionGroupsOperationResponse, err error) {
...
func (c OnenoteSectionGroupSectionGroupClient) ListOnenoteSectionGroupSectionGroupsComplete(ctx context.Context, id beta.UserIdOnenoteSectionGroupId, options ListOnenoteSectionGroupSectionGroupsOperationOptions) (ListOnenoteSectionGroupSectionGroupsCompleteResult, error) {
...
func (c OnenoteSectionGroupSectionGroupClient) ListOnenoteSectionGroupSectionGroupsCompleteMatchingPredicate(ctx context.Context, id beta.UserIdOnenoteSectionGroupId, options ListOnenoteSectionGroupSectionGroupsOperationOptions, predicate SectionGroupOperationPredicate) (result ListOnenoteSectionGroupSectionGroupsCompleteResult, err error) {
