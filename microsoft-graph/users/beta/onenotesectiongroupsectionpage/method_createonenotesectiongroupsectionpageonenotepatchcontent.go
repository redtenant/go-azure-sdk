...
func (c OnenoteSectionGroupSectionPageClient) CreateOnenoteSectionGroupSectionPageOnenotePatchContent(ctx context.Context, id beta.UserIdOnenoteSectionGroupIdSectionIdPageId, input CreateOnenoteSectionGroupSectionPageOnenotePatchContentRequest, options CreateOnenoteSectionGroupSectionPageOnenotePatchContentOperationOptions) (result CreateOnenoteSectionGroupSectionPageOnenotePatchContentOperationResponse, err error) {
