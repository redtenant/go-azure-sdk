...
func (c OnenoteSectionGroupSectionPageClient) DeleteOnenoteSectionGroupSectionPage(ctx context.Context, id beta.UserIdOnenoteSectionGroupIdSectionIdPageId, options DeleteOnenoteSectionGroupSectionPageOperationOptions) (result DeleteOnenoteSectionGroupSectionPageOperationResponse, err error) {
