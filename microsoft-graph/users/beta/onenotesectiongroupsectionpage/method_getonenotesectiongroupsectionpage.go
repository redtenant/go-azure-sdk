...
// GetOnenoteSectionGroupSectionPage - Get pages from users. The collection of pages in the section. Read-only.
// Nullable.
func (c OnenoteSectionGroupSectionPageClient) GetOnenoteSectionGroupSectionPage(ctx context.Context, id beta.UserIdOnenoteSectionGroupIdSectionIdPageId, options GetOnenoteSectionGroupSectionPageOperationOptions) (result GetOnenoteSectionGroupSectionPageOperationResponse, err error) {
