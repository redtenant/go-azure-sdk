...
func (c OnenoteSectionGroupSectionPageClient) UpdateOnenoteSectionGroupSectionPage(ctx context.Context, id beta.UserIdOnenoteSectionGroupIdSectionIdPageId, input beta.OnenotePage, options UpdateOnenoteSectionGroupSectionPageOperationOptions) (result UpdateOnenoteSectionGroupSectionPageOperationResponse, err error) {
