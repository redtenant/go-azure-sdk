...
// Read-only.
func (c OnenoteSectionGroupSectionPageParentNotebookClient) GetOnenoteSectionGroupSectionPageParentNotebook(ctx context.Context, id beta.UserIdOnenoteSectionGroupIdSectionIdPageId, options GetOnenoteSectionGroupSectionPageParentNotebookOperationOptions) (result GetOnenoteSectionGroupSectionPageParentNotebookOperationResponse, err error) {
