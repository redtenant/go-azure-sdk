...
// Read-only.
func (c OnenoteSectionGroupSectionPageParentSectionClient) GetOnenoteSectionGroupSectionPageParentSection(ctx context.Context, id beta.UserIdOnenoteSectionGroupIdSectionIdPageId, options GetOnenoteSectionGroupSectionPageParentSectionOperationOptions) (result GetOnenoteSectionGroupSectionPageParentSectionOperationResponse, err error) {
