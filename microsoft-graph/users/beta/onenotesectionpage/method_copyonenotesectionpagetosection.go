...
func (c OnenoteSectionPageClient) CopyOnenoteSectionPageToSection(ctx context.Context, id beta.UserIdOnenoteSectionIdPageId, input CopyOnenoteSectionPageToSectionRequest, options CopyOnenoteSectionPageToSectionOperationOptions) (result CopyOnenoteSectionPageToSectionOperationResponse, err error) {
