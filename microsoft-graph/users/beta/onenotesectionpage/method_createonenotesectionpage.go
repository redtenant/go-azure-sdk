...
func (c OnenoteSectionPageClient) CreateOnenoteSectionPage(ctx context.Context, id beta.UserIdOnenoteSectionId, input beta.OnenotePage, options CreateOnenoteSectionPageOperationOptions) (result CreateOnenoteSectionPageOperationResponse, err error) {
