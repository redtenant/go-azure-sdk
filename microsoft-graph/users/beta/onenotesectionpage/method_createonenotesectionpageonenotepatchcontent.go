...
func (c OnenoteSectionPageClient) CreateOnenoteSectionPageOnenotePatchContent(ctx context.Context, id beta.UserIdOnenoteSectionIdPageId, input CreateOnenoteSectionPageOnenotePatchContentRequest, options CreateOnenoteSectionPageOnenotePatchContentOperationOptions) (result CreateOnenoteSectionPageOnenotePatchContentOperationResponse, err error) {
