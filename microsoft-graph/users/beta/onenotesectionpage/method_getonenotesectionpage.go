...
func (c OnenoteSectionPageClient) GetOnenoteSectionPage(ctx context.Context, id beta.UserIdOnenoteSectionIdPageId, options GetOnenoteSectionPageOperationOptions) (result GetOnenoteSectionPageOperationResponse, err error) {
