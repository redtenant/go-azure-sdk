...
func (c OnenoteSectionPageClient) GetOnenoteSectionPagesCount(ctx context.Context, id beta.UserIdOnenoteSectionId, options GetOnenoteSectionPagesCountOperationOptions) (result GetOnenoteSectionPagesCountOperationResponse, err error) {
