...
func (c OnenoteSectionPageClient) ListOnenoteSectionPages(ctx context.Context, id beta.UserIdOnenoteSectionId, options ListOnenoteSectionPagesOperationOptions) (result ListOnenoteSectionPagesOperationResponse, err error) {
...
func (c OnenoteSectionPageClient) ListOnenoteSectionPagesComplete(ctx context.Context, id beta.UserIdOnenoteSectionId, options ListOnenoteSectionPagesOperationOptions) (ListOnenoteSectionPagesCompleteResult, error) {
...
func (c OnenoteSectionPageClient) ListOnenoteSectionPagesCompleteMatchingPredicate(ctx context.Context, id beta.UserIdOnenoteSectionId, options ListOnenoteSectionPagesOperationOptions, predicate OnenotePageOperationPredicate) (result ListOnenoteSectionPagesCompleteResult, err error) {
