...
func (c OnenoteSectionPageClient) UpdateOnenoteSectionPage(ctx context.Context, id beta.UserIdOnenoteSectionIdPageId, input beta.OnenotePage, options UpdateOnenoteSectionPageOperationOptions) (result UpdateOnenoteSectionPageOperationResponse, err error) {
