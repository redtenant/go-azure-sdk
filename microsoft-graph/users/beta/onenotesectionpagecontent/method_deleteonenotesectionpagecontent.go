...
func (c OnenoteSectionPageContentClient) DeleteOnenoteSectionPageContent(ctx context.Context, id beta.UserIdOnenoteSectionIdPageId, options DeleteOnenoteSectionPageContentOperationOptions) (result DeleteOnenoteSectionPageContentOperationResponse, err error) {
