...
func (c OnenoteSectionPageContentClient) SetOnenoteSectionPageContent(ctx context.Context, id beta.UserIdOnenoteSectionIdPageId, input []byte, options SetOnenoteSectionPageContentOperationOptions) (result SetOnenoteSectionPageContentOperationResponse, err error) {
