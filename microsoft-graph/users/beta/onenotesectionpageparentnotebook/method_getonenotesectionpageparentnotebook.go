...
func (c OnenoteSectionPageParentNotebookClient) GetOnenoteSectionPageParentNotebook(ctx context.Context, id beta.UserIdOnenoteSectionIdPageId, options GetOnenoteSectionPageParentNotebookOperationOptions) (result GetOnenoteSectionPageParentNotebookOperationResponse, err error) {
