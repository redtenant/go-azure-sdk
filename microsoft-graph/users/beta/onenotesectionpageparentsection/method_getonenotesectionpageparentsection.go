...
func (c OnenoteSectionPageParentSectionClient) GetOnenoteSectionPageParentSection(ctx context.Context, id beta.UserIdOnenoteSectionIdPageId, options GetOnenoteSectionPageParentSectionOperationOptions) (result GetOnenoteSectionPageParentSectionOperationResponse, err error) {
