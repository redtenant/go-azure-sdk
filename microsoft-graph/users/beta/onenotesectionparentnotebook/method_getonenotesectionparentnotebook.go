...
func (c OnenoteSectionParentNotebookClient) GetOnenoteSectionParentNotebook(ctx context.Context, id beta.UserIdOnenoteSectionId, options GetOnenoteSectionParentNotebookOperationOptions) (result GetOnenoteSectionParentNotebookOperationResponse, err error) {
