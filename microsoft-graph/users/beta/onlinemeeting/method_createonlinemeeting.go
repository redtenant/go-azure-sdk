...
func (c OnlineMeetingClient) CreateOnlineMeeting(ctx context.Context, id beta.UserId, input beta.OnlineMeeting, options CreateOnlineMeetingOperationOptions) (result CreateOnlineMeetingOperationResponse, err error) {
