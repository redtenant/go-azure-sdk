...
func DefaultGetOnlineMeetingsCountOperationOptions() GetOnlineMeetingsCountOperationOptions {
	return GetOnlineMeetingsCountOperationOptions{}
}
...
func (c OnlineMeetingClient) GetOnlineMeetingsCount(ctx context.Context, id beta.UserId, options GetOnlineMeetingsCountOperationOptions) (result GetOnlineMeetingsCountOperationResponse, err error) {
	opts := client.RequestOptions{
		...
		Path:          fmt.Sprintf("%s/onlineMeetings/$count", id.ID()),
