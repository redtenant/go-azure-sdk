...
// ListOnlineMeetings - Get onlineMeetings from users. Information about a meeting, including the URL used to join a
// meeting, the attendees list, and the description.
func (c OnlineMeetingClient) ListOnlineMeetings(ctx context.Context, id beta.UserId, options ListOnlineMeetingsOperationOptions) (result ListOnlineMeetingsOperationResponse, err error) {
...
func (c OnlineMeetingClient) ListOnlineMeetingsComplete(ctx context.Context, id beta.UserId, options ListOnlineMeetingsOperationOptions) (ListOnlineMeetingsCompleteResult, error) {
	return c.ListOnlineMeetingsCompleteMatchingPredicate(ctx, id, options, OnlineMeetingOperationPredicate{})
}
...
func (c OnlineMeetingClient) ListOnlineMeetingsCompleteMatchingPredicate(ctx context.Context, id beta.UserId, options ListOnlineMeetingsOperationOptions, predicate OnlineMeetingOperationPredicate) (result ListOnlineMeetingsCompleteResult, err error) {
	...
	resp, err := c.ListOnlineMeetings(ctx, id, options)
	if err != nil {
