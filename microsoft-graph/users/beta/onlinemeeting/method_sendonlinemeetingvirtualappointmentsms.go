...
func (c OnlineMeetingClient) SendOnlineMeetingVirtualAppointmentSms(ctx context.Context, id beta.UserIdOnlineMeetingId, input SendOnlineMeetingVirtualAppointmentSmsRequest, options SendOnlineMeetingVirtualAppointmentSmsOperationOptions) (result SendOnlineMeetingVirtualAppointmentSmsOperationResponse, err error) {
