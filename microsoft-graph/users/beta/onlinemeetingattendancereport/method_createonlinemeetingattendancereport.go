...
func (c OnlineMeetingAttendanceReportClient) CreateOnlineMeetingAttendanceReport(ctx context.Context, id beta.UserIdOnlineMeetingId, input beta.MeetingAttendanceReport, options CreateOnlineMeetingAttendanceReportOperationOptions) (result CreateOnlineMeetingAttendanceReportOperationResponse, err error) {
