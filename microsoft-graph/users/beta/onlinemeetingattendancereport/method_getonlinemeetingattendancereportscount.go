...
func (c OnlineMeetingAttendanceReportClient) GetOnlineMeetingAttendanceReportsCount(ctx context.Context, id beta.UserIdOnlineMeetingId, options GetOnlineMeetingAttendanceReportsCountOperationOptions) (result GetOnlineMeetingAttendanceReportsCountOperationResponse, err error) {
