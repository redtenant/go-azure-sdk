...
func (c OnlineMeetingAttendanceReportClient) UpdateOnlineMeetingAttendanceReport(ctx context.Context, id beta.UserIdOnlineMeetingIdAttendanceReportId, input beta.MeetingAttendanceReport, options UpdateOnlineMeetingAttendanceReportOperationOptions) (result UpdateOnlineMeetingAttendanceReportOperationResponse, err error) {
