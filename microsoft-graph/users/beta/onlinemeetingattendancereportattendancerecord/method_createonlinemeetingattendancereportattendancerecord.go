...
func (c OnlineMeetingAttendanceReportAttendanceRecordClient) CreateOnlineMeetingAttendanceReportAttendanceRecord(ctx context.Context, id beta.UserIdOnlineMeetingIdAttendanceReportId, input beta.AttendanceRecord, options CreateOnlineMeetingAttendanceReportAttendanceRecordOperationOptions) (result CreateOnlineMeetingAttendanceReportAttendanceRecordOperationResponse, err error) {
