...
func (c OnlineMeetingAttendanceReportAttendanceRecordClient) UpdateOnlineMeetingAttendanceReportAttendanceRecord(ctx context.Context, id beta.UserIdOnlineMeetingIdAttendanceReportIdAttendanceRecordId, input beta.AttendanceRecord, options UpdateOnlineMeetingAttendanceReportAttendanceRecordOperationOptions) (result UpdateOnlineMeetingAttendanceReportAttendanceRecordOperationResponse, err error) {
