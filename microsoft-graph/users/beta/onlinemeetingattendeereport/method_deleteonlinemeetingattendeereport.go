...
func (c OnlineMeetingAttendeeReportClient) DeleteOnlineMeetingAttendeeReport(ctx context.Context, id beta.UserIdOnlineMeetingId, options DeleteOnlineMeetingAttendeeReportOperationOptions) (result DeleteOnlineMeetingAttendeeReportOperationResponse, err error) {
