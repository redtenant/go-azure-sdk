...
// DeleteOnlineMeetingAttendanceReport - Delete navigation property meetingAttendanceReport for users
func (c OnlineMeetingMeetingAttendanceReportClient) DeleteOnlineMeetingAttendanceReport(ctx context.Context, id beta.UserIdOnlineMeetingId, options DeleteOnlineMeetingAttendanceReportOperationOptions) (result DeleteOnlineMeetingAttendanceReportOperationResponse, err error) {
