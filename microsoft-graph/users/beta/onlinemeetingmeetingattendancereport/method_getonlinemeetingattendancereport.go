...
// GetOnlineMeetingAttendanceReport - Get meetingAttendanceReport from users. The attendance report of the latest online
// meeting session. Read-only.
func (c OnlineMeetingMeetingAttendanceReportClient) GetOnlineMeetingAttendanceReport(ctx context.Context, id beta.UserIdOnlineMeetingId, options GetOnlineMeetingAttendanceReportOperationOptions) (result GetOnlineMeetingAttendanceReportOperationResponse, err error) {
