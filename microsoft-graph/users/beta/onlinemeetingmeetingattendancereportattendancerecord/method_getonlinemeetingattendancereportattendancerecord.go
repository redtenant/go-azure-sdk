...
func (c OnlineMeetingMeetingAttendanceReportAttendanceRecordClient) GetOnlineMeetingAttendanceReportAttendanceRecord(ctx context.Context, id beta.UserIdOnlineMeetingIdMeetingAttendanceReportAttendanceRecordId, options GetOnlineMeetingAttendanceReportAttendanceRecordOperationOptions) (result GetOnlineMeetingAttendanceReportAttendanceRecordOperationResponse, err error) {
