...
func (c OnlineMeetingMeetingAttendanceReportAttendanceRecordClient) GetOnlineMeetingAttendanceReportAttendanceRecordsCount(ctx context.Context, id beta.UserIdOnlineMeetingId, options GetOnlineMeetingAttendanceReportAttendanceRecordsCountOperationOptions) (result GetOnlineMeetingAttendanceReportAttendanceRecordsCountOperationResponse, err error) {
	opts := client.RequestOptions{
		...
		Path:          fmt.Sprintf("%s/meetingAttendanceReport/attendanceRecords/$count", id.ID()),
