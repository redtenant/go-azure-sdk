...
func (c OnlineMeetingRecordingClient) GetOnlineMeetingRecordingsCount(ctx context.Context, id beta.UserIdOnlineMeetingId, options GetOnlineMeetingRecordingsCountOperationOptions) (result GetOnlineMeetingRecordingsCountOperationResponse, err error) {
