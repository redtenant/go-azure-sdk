...
func (c OnlineMeetingRecordingClient) ListOnlineMeetingRecordings(ctx context.Context, id beta.UserIdOnlineMeetingId, options ListOnlineMeetingRecordingsOperationOptions) (result ListOnlineMeetingRecordingsOperationResponse, err error) {
	...
	var values struct {
		Values *[]beta.CallRecording `json:"value"`
	}
...
func (c OnlineMeetingRecordingClient) ListOnlineMeetingRecordingsComplete(ctx context.Context, id beta.UserIdOnlineMeetingId, options ListOnlineMeetingRecordingsOperationOptions) (ListOnlineMeetingRecordingsCompleteResult, error) {
...
func (c OnlineMeetingRecordingClient) ListOnlineMeetingRecordingsCompleteMatchingPredicate(ctx context.Context, id beta.UserIdOnlineMeetingId, options ListOnlineMeetingRecordingsOperationOptions, predicate CallRecordingOperationPredicate) (result ListOnlineMeetingRecordingsCompleteResult, err error) {
	items := make([]beta.CallRecording, 0)
