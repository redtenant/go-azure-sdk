...
func (c OnlineMeetingRecordingClient) UpdateOnlineMeetingRecording(ctx context.Context, id beta.UserIdOnlineMeetingIdRecordingId, input beta.CallRecording, options UpdateOnlineMeetingRecordingOperationOptions) (result UpdateOnlineMeetingRecordingOperationResponse, err error) {
