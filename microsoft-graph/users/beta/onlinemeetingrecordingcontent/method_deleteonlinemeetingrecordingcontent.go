...
func (c OnlineMeetingRecordingContentClient) DeleteOnlineMeetingRecordingContent(ctx context.Context, id beta.UserIdOnlineMeetingIdRecordingId, options DeleteOnlineMeetingRecordingContentOperationOptions) (result DeleteOnlineMeetingRecordingContentOperationResponse, err error) {
