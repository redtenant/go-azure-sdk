...
// recording. Read-only.
func (c OnlineMeetingRecordingContentClient) SetOnlineMeetingRecordingContent(ctx context.Context, id beta.UserIdOnlineMeetingIdRecordingId, input []byte, options SetOnlineMeetingRecordingContentOperationOptions) (result SetOnlineMeetingRecordingContentOperationResponse, err error) {
