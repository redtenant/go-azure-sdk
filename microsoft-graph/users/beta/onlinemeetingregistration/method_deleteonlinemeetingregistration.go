...
// DeleteOnlineMeetingRegistration - Delete navigation property registration for users
func (c OnlineMeetingRegistrationClient) DeleteOnlineMeetingRegistration(ctx context.Context, id beta.UserIdOnlineMeetingId, options DeleteOnlineMeetingRegistrationOperationOptions) (result DeleteOnlineMeetingRegistrationOperationResponse, err error) {
