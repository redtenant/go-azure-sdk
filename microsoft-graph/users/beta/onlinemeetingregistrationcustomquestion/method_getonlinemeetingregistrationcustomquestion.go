...
// GetOnlineMeetingRegistrationCustomQuestion - Get customQuestions from users. Custom registration questions.
func (c OnlineMeetingRegistrationCustomQuestionClient) GetOnlineMeetingRegistrationCustomQuestion(ctx context.Context, id beta.UserIdOnlineMeetingIdRegistrationCustomQuestionId, options GetOnlineMeetingRegistrationCustomQuestionOperationOptions) (result GetOnlineMeetingRegistrationCustomQuestionOperationResponse, err error) {
