...
type UpdateOnlineMeetingRegistrationRegistrantOperationResponse struct {
...
// UpdateOnlineMeetingRegistrationRegistrant - Update the navigation property registrants in users
func (c OnlineMeetingRegistrationRegistrantClient) UpdateOnlineMeetingRegistrationRegistrant(ctx context.Context, id beta.UserIdOnlineMeetingIdRegistrationRegistrantId, input beta.MeetingRegistrantBase, options UpdateOnlineMeetingRegistrationRegistrantOperationOptions) (result UpdateOnlineMeetingRegistrationRegistrantOperationResponse, err error) {
