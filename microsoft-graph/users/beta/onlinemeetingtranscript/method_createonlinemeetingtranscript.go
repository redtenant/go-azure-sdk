...
func (c OnlineMeetingTranscriptClient) CreateOnlineMeetingTranscript(ctx context.Context, id beta.UserIdOnlineMeetingId, input beta.CallTranscript, options CreateOnlineMeetingTranscriptOperationOptions) (result CreateOnlineMeetingTranscriptOperationResponse, err error) {
