...
func (c OnlineMeetingTranscriptClient) DeleteOnlineMeetingTranscript(ctx context.Context, id beta.UserIdOnlineMeetingIdTranscriptId, options DeleteOnlineMeetingTranscriptOperationOptions) (result DeleteOnlineMeetingTranscriptOperationResponse, err error) {
