...
func (c OnlineMeetingTranscriptClient) GetOnlineMeetingTranscript(ctx context.Context, id beta.UserIdOnlineMeetingIdTranscriptId, options GetOnlineMeetingTranscriptOperationOptions) (result GetOnlineMeetingTranscriptOperationResponse, err error) {
