...
func (c OnlineMeetingTranscriptClient) ListOnlineMeetingTranscriptsComplete(ctx context.Context, id beta.UserIdOnlineMeetingId, options ListOnlineMeetingTranscriptsOperationOptions) (ListOnlineMeetingTranscriptsCompleteResult, error) {
...
func (c OnlineMeetingTranscriptClient) ListOnlineMeetingTranscriptsCompleteMatchingPredicate(ctx context.Context, id beta.UserIdOnlineMeetingId, options ListOnlineMeetingTranscriptsOperationOptions, predicate CallTranscriptOperationPredicate) (result ListOnlineMeetingTranscriptsCompleteResult, err error) {
