...
// DeleteOnlineMeetingTranscriptContent - Delete content for the navigation property transcripts in users. The content
// of the transcript. Read-only.
func (c OnlineMeetingTranscriptContentClient) DeleteOnlineMeetingTranscriptContent(ctx context.Context, id beta.UserIdOnlineMeetingIdTranscriptId, options DeleteOnlineMeetingTranscriptContentOperationOptions) (result DeleteOnlineMeetingTranscriptContentOperationResponse, err error) {
