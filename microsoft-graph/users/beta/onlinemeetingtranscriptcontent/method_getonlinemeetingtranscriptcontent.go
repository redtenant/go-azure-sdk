...
func (c OnlineMeetingTranscriptContentClient) GetOnlineMeetingTranscriptContent(ctx context.Context, id beta.UserIdOnlineMeetingIdTranscriptId, options GetOnlineMeetingTranscriptContentOperationOptions) (result GetOnlineMeetingTranscriptContentOperationResponse, err error) {
