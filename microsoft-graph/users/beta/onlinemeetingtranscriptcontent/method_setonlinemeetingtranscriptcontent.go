...
func (c OnlineMeetingTranscriptContentClient) SetOnlineMeetingTranscriptContent(ctx context.Context, id beta.UserIdOnlineMeetingIdTranscriptId, input []byte, options SetOnlineMeetingTranscriptContentOperationOptions) (result SetOnlineMeetingTranscriptContentOperationResponse, err error) {
