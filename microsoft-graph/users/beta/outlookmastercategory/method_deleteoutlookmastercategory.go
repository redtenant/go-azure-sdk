...
func (c OutlookMasterCategoryClient) DeleteOutlookMasterCategory(ctx context.Context, id beta.UserIdOutlookMasterCategoryId, options DeleteOutlookMasterCategoryOperationOptions) (result DeleteOutlookMasterCategoryOperationResponse, err error) {
