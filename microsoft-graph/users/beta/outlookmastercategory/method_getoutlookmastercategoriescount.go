...
func (c OutlookMasterCategoryClient) GetOutlookMasterCategoriesCount(ctx context.Context, id beta.UserId, options GetOutlookMasterCategoriesCountOperationOptions) (result GetOutlookMasterCategoriesCountOperationResponse, err error) {
