...
func (c OutlookMasterCategoryClient) GetOutlookMasterCategory(ctx context.Context, id beta.UserIdOutlookMasterCategoryId, options GetOutlookMasterCategoryOperationOptions) (result GetOutlookMasterCategoryOperationResponse, err error) {
