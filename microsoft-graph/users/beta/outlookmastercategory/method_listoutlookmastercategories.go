...
func (c OutlookMasterCategoryClient) ListOutlookMasterCategories(ctx context.Context, id beta.UserId, options ListOutlookMasterCategoriesOperationOptions) (result ListOutlookMasterCategoriesOperationResponse, err error) {
...
func (c OutlookMasterCategoryClient) ListOutlookMasterCategoriesComplete(ctx context.Context, id beta.UserId, options ListOutlookMasterCategoriesOperationOptions) (ListOutlookMasterCategoriesCompleteResult, error) {
...
func (c OutlookMasterCategoryClient) ListOutlookMasterCategoriesCompleteMatchingPredicate(ctx context.Context, id beta.UserId, options ListOutlookMasterCategoriesOperationOptions, predicate OutlookCategoryOperationPredicate) (result ListOutlookMasterCategoriesCompleteResult, err error) {
