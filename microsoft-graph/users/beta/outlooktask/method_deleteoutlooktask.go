...
func (c OutlookTaskClient) DeleteOutlookTask(ctx context.Context, id beta.UserIdOutlookTaskId, options DeleteOutlookTaskOperationOptions) (result DeleteOutlookTaskOperationResponse, err error) {
