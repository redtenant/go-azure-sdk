...
func (c OutlookTaskClient) GetOutlookTask(ctx context.Context, id beta.UserIdOutlookTaskId, options GetOutlookTaskOperationOptions) (result GetOutlookTaskOperationResponse, err error) {
