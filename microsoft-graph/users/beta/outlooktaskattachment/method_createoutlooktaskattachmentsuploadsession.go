...
func DefaultCreateOutlookTaskAttachmentsUploadSessionOperationOptions() CreateOutlookTaskAttachmentsUploadSessionOperationOptions {
	return CreateOutlookTaskAttachmentsUploadSessionOperationOptions{}
}
...
// CreateOutlookTaskAttachmentsUploadSession - Invoke action createUploadSession. Create an upload session that allows
...
func (c OutlookTaskAttachmentClient) CreateOutlookTaskAttachmentsUploadSession(ctx context.Context, id beta.UserIdOutlookTaskId, input CreateOutlookTaskAttachmentsUploadSessionRequest, options CreateOutlookTaskAttachmentsUploadSessionOperationOptions) (result CreateOutlookTaskAttachmentsUploadSessionOperationResponse, err error) {
