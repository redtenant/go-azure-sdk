...
func DefaultGetOutlookTaskAttachmentOperationOptions() GetOutlookTaskAttachmentOperationOptions {
	return GetOutlookTaskAttachmentOperationOptions{}
}
...
// GetOutlookTaskAttachment - Get attachments from users. The collection of fileAttachment, itemAttachment, and
// referenceAttachment attachments for the task. Read-only. Nullable.
func (c OutlookTaskAttachmentClient) GetOutlookTaskAttachment(ctx context.Context, id beta.UserIdOutlookTaskIdAttachmentId, options GetOutlookTaskAttachmentOperationOptions) (result GetOutlookTaskAttachmentOperationResponse, err error) {
