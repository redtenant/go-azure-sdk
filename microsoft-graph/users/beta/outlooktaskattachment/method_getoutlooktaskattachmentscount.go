...
func (c OutlookTaskAttachmentClient) GetOutlookTaskAttachmentsCount(ctx context.Context, id beta.UserIdOutlookTaskId, options GetOutlookTaskAttachmentsCountOperationOptions) (result GetOutlookTaskAttachmentsCountOperationResponse, err error) {
