...
func DefaultDeleteOutlookTaskFolderOperationOptions() DeleteOutlookTaskFolderOperationOptions {
	return DeleteOutlookTaskFolderOperationOptions{}
}
...
// DeleteOutlookTaskFolder - Delete navigation property taskFolders for users
func (c OutlookTaskFolderClient) DeleteOutlookTaskFolder(ctx context.Context, id beta.UserIdOutlookTaskFolderId, options DeleteOutlookTaskFolderOperationOptions) (result DeleteOutlookTaskFolderOperationResponse, err error) {
