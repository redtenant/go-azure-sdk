...
func DefaultGetOutlookTaskFolderOperationOptions() GetOutlookTaskFolderOperationOptions {
	return GetOutlookTaskFolderOperationOptions{}
}
...
// GetOutlookTaskFolder - Get taskFolders from users. The user's Outlook task folders. Read-only. Nullable.
func (c OutlookTaskFolderClient) GetOutlookTaskFolder(ctx context.Context, id beta.UserIdOutlookTaskFolderId, options GetOutlookTaskFolderOperationOptions) (result GetOutlookTaskFolderOperationResponse, err error) {
