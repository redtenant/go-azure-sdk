...
func (c OutlookTaskFolderTaskAttachmentClient) GetOutlookTaskFolderTaskAttachmentsCount(ctx context.Context, id beta.UserIdOutlookTaskFolderIdTaskId, options GetOutlookTaskFolderTaskAttachmentsCountOperationOptions) (result GetOutlookTaskFolderTaskAttachmentsCountOperationResponse, err error) {
