...
// ListOutlookTaskFolderTaskAttachments - Get attachments from users. The collection of fileAttachment, itemAttachment,
// and referenceAttachment attachments for the task. Read-only. Nullable.
func (c OutlookTaskFolderTaskAttachmentClient) ListOutlookTaskFolderTaskAttachments(ctx context.Context, id beta.UserIdOutlookTaskFolderIdTaskId, options ListOutlookTaskFolderTaskAttachmentsOperationOptions) (result ListOutlookTaskFolderTaskAttachmentsOperationResponse, err error) {
...
func (c OutlookTaskFolderTaskAttachmentClient) ListOutlookTaskFolderTaskAttachmentsComplete(ctx context.Context, id beta.UserIdOutlookTaskFolderIdTaskId, options ListOutlookTaskFolderTaskAttachmentsOperationOptions) (ListOutlookTaskFolderTaskAttachmentsCompleteResult, error) {
...
func (c OutlookTaskFolderTaskAttachmentClient) ListOutlookTaskFolderTaskAttachmentsCompleteMatchingPredicate(ctx context.Context, id beta.UserIdOutlookTaskFolderIdTaskId, options ListOutlookTaskFolderTaskAttachmentsOperationOptions, predicate AttachmentOperationPredicate) (result ListOutlookTaskFolderTaskAttachmentsCompleteResult, err error) {
