...
type UpdateOutlookTaskGroupOperationResponse struct {
...
// UpdateOutlookTaskGroup - Update the navigation property taskGroups in users
func (c OutlookTaskGroupClient) UpdateOutlookTaskGroup(ctx context.Context, id beta.UserIdOutlookTaskGroupId, input beta.OutlookTaskGroup, options UpdateOutlookTaskGroupOperationOptions) (result UpdateOutlookTaskGroupOperationResponse, err error) {
