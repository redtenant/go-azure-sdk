...
// GetOutlookTaskGroupTaskFolder - Get taskFolders from users. The collection of task folders in the task group.
// Read-only. Nullable.
func (c OutlookTaskGroupTaskFolderClient) GetOutlookTaskGroupTaskFolder(ctx context.Context, id beta.UserIdOutlookTaskGroupIdTaskFolderId, options GetOutlookTaskGroupTaskFolderOperationOptions) (result GetOutlookTaskGroupTaskFolderOperationResponse, err error) {
