...
func (c OwnedDeviceClient) GetOwnedDevicesCount(ctx context.Context, id beta.UserId, options GetOwnedDevicesCountOperationOptions) (result GetOwnedDevicesCountOperationResponse, err error) {
