...
// call this method.
func (c PendingAccessReviewInstanceClient) CreatePendingAccessReviewInstanceApplyDecision(ctx context.Context, id beta.UserIdPendingAccessReviewInstanceId, options CreatePendingAccessReviewInstanceApplyDecisionOperationOptions) (result CreatePendingAccessReviewInstanceApplyDecisionOperationResponse, err error) {
