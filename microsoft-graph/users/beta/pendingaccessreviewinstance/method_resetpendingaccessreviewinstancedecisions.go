...
func (c PendingAccessReviewInstanceClient) ResetPendingAccessReviewInstanceDecisions(ctx context.Context, id beta.UserIdPendingAccessReviewInstanceId, options ResetPendingAccessReviewInstanceDecisionsOperationOptions) (result ResetPendingAccessReviewInstanceDecisionsOperationResponse, err error) {
