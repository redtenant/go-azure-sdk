...
func (c PendingAccessReviewInstanceClient) StopPendingAccessReviewInstance(ctx context.Context, id beta.UserIdPendingAccessReviewInstanceId, options StopPendingAccessReviewInstanceOperationOptions) (result StopPendingAccessReviewInstanceOperationResponse, err error) {
