...
func (c PendingAccessReviewInstanceClient) StopPendingAccessReviewInstanceApplyDecisions(ctx context.Context, id beta.UserIdPendingAccessReviewInstanceId, options StopPendingAccessReviewInstanceApplyDecisionsOperationOptions) (result StopPendingAccessReviewInstanceApplyDecisionsOperationResponse, err error) {
