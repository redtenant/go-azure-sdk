...
// GetPendingAccessReviewInstanceDecisionInsight - Get insights from users. Insights are recommendations to reviewers on
// whether to approve or deny a decision. There can be multiple insights associated with an
// accessReviewInstanceDecisionItem.
func (c PendingAccessReviewInstanceDecisionInsightClient) GetPendingAccessReviewInstanceDecisionInsight(ctx context.Context, id beta.UserIdPendingAccessReviewInstanceIdDecisionIdInsightId, options GetPendingAccessReviewInstanceDecisionInsightOperationOptions) (result GetPendingAccessReviewInstanceDecisionInsightOperationResponse, err error) {
