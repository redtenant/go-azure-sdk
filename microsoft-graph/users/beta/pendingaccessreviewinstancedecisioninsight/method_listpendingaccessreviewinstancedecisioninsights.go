...
// ListPendingAccessReviewInstanceDecisionInsights - Get insights from users. Insights are recommendations to reviewers
...
func (c PendingAccessReviewInstanceDecisionInsightClient) ListPendingAccessReviewInstanceDecisionInsightsComplete(ctx context.Context, id beta.UserIdPendingAccessReviewInstanceIdDecisionId, options ListPendingAccessReviewInstanceDecisionInsightsOperationOptions) (ListPendingAccessReviewInstanceDecisionInsightsCompleteResult, error) {
