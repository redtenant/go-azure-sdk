...
func (c PendingAccessReviewInstanceDecisionInstanceClient) StopPendingAccessReviewInstanceDecisionInstanceApplyDecisions(ctx context.Context, id beta.UserIdPendingAccessReviewInstanceIdDecisionId, options StopPendingAccessReviewInstanceDecisionInstanceApplyDecisionsOperationOptions) (result StopPendingAccessReviewInstanceDecisionInstanceApplyDecisionsOperationResponse, err error) {
