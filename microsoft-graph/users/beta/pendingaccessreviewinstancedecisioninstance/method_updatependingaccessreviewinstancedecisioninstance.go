...
func (c PendingAccessReviewInstanceDecisionInstanceClient) UpdatePendingAccessReviewInstanceDecisionInstance(ctx context.Context, id beta.UserIdPendingAccessReviewInstanceIdDecisionId, input beta.AccessReviewInstance, options UpdatePendingAccessReviewInstanceDecisionInstanceOperationOptions) (result UpdatePendingAccessReviewInstanceDecisionInstanceOperationResponse, err error) {
