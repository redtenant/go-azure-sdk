...
// ListPendingAccessReviewInstanceDecisionInstanceContactedReviewers - Get contactedReviewers from users. Returns the
...
func (c PendingAccessReviewInstanceDecisionInstanceContactedReviewerClient) ListPendingAccessReviewInstanceDecisionInstanceContactedReviewersComplete(ctx context.Context, id beta.UserIdPendingAccessReviewInstanceIdDecisionId, options ListPendingAccessReviewInstanceDecisionInstanceContactedReviewersOperationOptions) (ListPendingAccessReviewInstanceDecisionInstanceContactedReviewersCompleteResult, error) {
...
func (c PendingAccessReviewInstanceDecisionInstanceContactedReviewerClient) ListPendingAccessReviewInstanceDecisionInstanceContactedReviewersCompleteMatchingPredicate(ctx context.Context, id beta.UserIdPendingAccessReviewInstanceIdDecisionId, options ListPendingAccessReviewInstanceDecisionInstanceContactedReviewersOperationOptions, predicate AccessReviewReviewerOperationPredicate) (result ListPendingAccessReviewInstanceDecisionInstanceContactedReviewersCompleteResult, err error) {
