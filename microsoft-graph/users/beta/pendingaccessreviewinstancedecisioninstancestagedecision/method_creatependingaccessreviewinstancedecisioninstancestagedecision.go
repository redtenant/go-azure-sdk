...
// CreatePendingAccessReviewInstanceDecisionInstanceStageDecision - Create new navigation property to decisions for
// users
func (c PendingAccessReviewInstanceDecisionInstanceStageDecisionClient) CreatePendingAccessReviewInstanceDecisionInstanceStageDecision(ctx context.Context, id beta.UserIdPendingAccessReviewInstanceIdDecisionIdInstanceStageId, input beta.AccessReviewInstanceDecisionItem, options CreatePendingAccessReviewInstanceDecisionInstanceStageDecisionOperationOptions) (result CreatePendingAccessReviewInstanceDecisionInstanceStageDecisionOperationResponse, err error) {
