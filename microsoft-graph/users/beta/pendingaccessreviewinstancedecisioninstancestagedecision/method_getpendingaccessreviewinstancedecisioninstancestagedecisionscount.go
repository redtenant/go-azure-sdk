...
func (c PendingAccessReviewInstanceDecisionInstanceStageDecisionClient) GetPendingAccessReviewInstanceDecisionInstanceStageDecisionsCount(ctx context.Context, id beta.UserIdPendingAccessReviewInstanceIdDecisionIdInstanceStageId, options GetPendingAccessReviewInstanceDecisionInstanceStageDecisionsCountOperationOptions) (result GetPendingAccessReviewInstanceDecisionInstanceStageDecisionsCountOperationResponse, err error) {
