...
// GetPendingAccessReviewInstanceDefinition - Get definition from users. There's exactly one
...
func (c PendingAccessReviewInstanceDefinitionClient) GetPendingAccessReviewInstanceDefinition(ctx context.Context, id beta.UserIdPendingAccessReviewInstanceId, options GetPendingAccessReviewInstanceDefinitionOperationOptions) (result GetPendingAccessReviewInstanceDefinitionOperationResponse, err error) {
