...
// CreatePendingAccessReviewInstanceStage - Create new navigation property to stages for users
func (c PendingAccessReviewInstanceStageClient) CreatePendingAccessReviewInstanceStage(ctx context.Context, id beta.UserIdPendingAccessReviewInstanceId, input beta.AccessReviewStage, options CreatePendingAccessReviewInstanceStageOperationOptions) (result CreatePendingAccessReviewInstanceStageOperationResponse, err error) {
