...
// ListPendingAccessReviewInstanceStages - Get stages from users. If the instance has multiple stages, this returns the
...
func (c PendingAccessReviewInstanceStageClient) ListPendingAccessReviewInstanceStages(ctx context.Context, id beta.UserIdPendingAccessReviewInstanceId, options ListPendingAccessReviewInstanceStagesOperationOptions) (result ListPendingAccessReviewInstanceStagesOperationResponse, err error) {
...
func (c PendingAccessReviewInstanceStageClient) ListPendingAccessReviewInstanceStagesComplete(ctx context.Context, id beta.UserIdPendingAccessReviewInstanceId, options ListPendingAccessReviewInstanceStagesOperationOptions) (ListPendingAccessReviewInstanceStagesCompleteResult, error) {
