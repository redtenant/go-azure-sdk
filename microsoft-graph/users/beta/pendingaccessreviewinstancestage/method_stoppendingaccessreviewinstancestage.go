...
func (c PendingAccessReviewInstanceStageClient) StopPendingAccessReviewInstanceStage(ctx context.Context, id beta.UserIdPendingAccessReviewInstanceIdStageId, options StopPendingAccessReviewInstanceStageOperationOptions) (result StopPendingAccessReviewInstanceStageOperationResponse, err error) {
