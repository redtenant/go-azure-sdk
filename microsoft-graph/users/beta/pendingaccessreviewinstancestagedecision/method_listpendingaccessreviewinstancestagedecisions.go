...
func (c PendingAccessReviewInstanceStageDecisionClient) ListPendingAccessReviewInstanceStageDecisionsCompleteMatchingPredicate(ctx context.Context, id beta.UserIdPendingAccessReviewInstanceIdStageId, options ListPendingAccessReviewInstanceStageDecisionsOperationOptions, predicate AccessReviewInstanceDecisionItemOperationPredicate) (result ListPendingAccessReviewInstanceStageDecisionsCompleteResult, err error) {
