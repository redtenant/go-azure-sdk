...
// CreatePendingAccessReviewInstanceStageDecisionInsight - Create new navigation property to insights for users
func (c PendingAccessReviewInstanceStageDecisionInsightClient) CreatePendingAccessReviewInstanceStageDecisionInsight(ctx context.Context, id beta.UserIdPendingAccessReviewInstanceIdStageIdDecisionId, input beta.GovernanceInsight, options CreatePendingAccessReviewInstanceStageDecisionInsightOperationOptions) (result CreatePendingAccessReviewInstanceStageDecisionInsightOperationResponse, err error) {
