...
type UpdatePendingAccessReviewInstanceStageDecisionInsightOperationResponse struct {
...
// UpdatePendingAccessReviewInstanceStageDecisionInsight - Update the navigation property insights in users
func (c PendingAccessReviewInstanceStageDecisionInsightClient) UpdatePendingAccessReviewInstanceStageDecisionInsight(ctx context.Context, id beta.UserIdPendingAccessReviewInstanceIdStageIdDecisionIdInsightId, input beta.GovernanceInsight, options UpdatePendingAccessReviewInstanceStageDecisionInsightOperationOptions) (result UpdatePendingAccessReviewInstanceStageDecisionInsightOperationResponse, err error) {
