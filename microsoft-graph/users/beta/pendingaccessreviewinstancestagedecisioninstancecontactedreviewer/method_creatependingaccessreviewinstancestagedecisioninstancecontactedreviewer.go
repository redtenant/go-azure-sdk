...
type CreatePendingAccessReviewInstanceStageDecisionInstanceContactedReviewerOperationResponse struct {
...
// contactedReviewers for users
func (c PendingAccessReviewInstanceStageDecisionInstanceContactedReviewerClient) CreatePendingAccessReviewInstanceStageDecisionInstanceContactedReviewer(ctx context.Context, id beta.UserIdPendingAccessReviewInstanceIdStageIdDecisionId, input beta.AccessReviewReviewer, options CreatePendingAccessReviewInstanceStageDecisionInstanceContactedReviewerOperationOptions) (result CreatePendingAccessReviewInstanceStageDecisionInstanceContactedReviewerOperationResponse, err error) {
