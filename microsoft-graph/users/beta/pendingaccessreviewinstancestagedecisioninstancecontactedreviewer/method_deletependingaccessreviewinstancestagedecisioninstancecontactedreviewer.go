...
func (c PendingAccessReviewInstanceStageDecisionInstanceContactedReviewerClient) DeletePendingAccessReviewInstanceStageDecisionInstanceContactedReviewer(ctx context.Context, id beta.UserIdPendingAccessReviewInstanceIdStageIdDecisionIdInstanceContactedReviewerId, options DeletePendingAccessReviewInstanceStageDecisionInstanceContactedReviewerOperationOptions) (result DeletePendingAccessReviewInstanceStageDecisionInstanceContactedReviewerOperationResponse, err error) {
