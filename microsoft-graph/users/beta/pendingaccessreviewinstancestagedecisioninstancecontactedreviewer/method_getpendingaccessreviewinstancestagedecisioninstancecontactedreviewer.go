...
// GetPendingAccessReviewInstanceStageDecisionInstanceContactedReviewer - Get contactedReviewers from users. Returns the
...
func (c PendingAccessReviewInstanceStageDecisionInstanceContactedReviewerClient) GetPendingAccessReviewInstanceStageDecisionInstanceContactedReviewer(ctx context.Context, id beta.UserIdPendingAccessReviewInstanceIdStageIdDecisionIdInstanceContactedReviewerId, options GetPendingAccessReviewInstanceStageDecisionInstanceContactedReviewerOperationOptions) (result GetPendingAccessReviewInstanceStageDecisionInstanceContactedReviewerOperationResponse, err error) {
