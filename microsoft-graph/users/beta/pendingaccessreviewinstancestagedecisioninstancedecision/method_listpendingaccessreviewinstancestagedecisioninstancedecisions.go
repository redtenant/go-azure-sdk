...
// ListPendingAccessReviewInstanceStageDecisionInstanceDecisions - Get decisions from users. Each user reviewed in an
// accessReviewInstance has a decision item representing if they were approved, denied, or not yet reviewed.
func (c PendingAccessReviewInstanceStageDecisionInstanceDecisionClient) ListPendingAccessReviewInstanceStageDecisionInstanceDecisions(ctx context.Context, id beta.UserIdPendingAccessReviewInstanceIdStageIdDecisionId, options ListPendingAccessReviewInstanceStageDecisionInstanceDecisionsOperationOptions) (result ListPendingAccessReviewInstanceStageDecisionInstanceDecisionsOperationResponse, err error) {
...
func (c PendingAccessReviewInstanceStageDecisionInstanceDecisionClient) ListPendingAccessReviewInstanceStageDecisionInstanceDecisionsComplete(ctx context.Context, id beta.UserIdPendingAccessReviewInstanceIdStageIdDecisionId, options ListPendingAccessReviewInstanceStageDecisionInstanceDecisionsOperationOptions) (ListPendingAccessReviewInstanceStageDecisionInstanceDecisionsCompleteResult, error) {
