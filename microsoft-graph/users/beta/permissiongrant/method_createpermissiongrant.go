...
func (c PermissionGrantClient) CreatePermissionGrant(ctx context.Context, id beta.UserId, input beta.ResourceSpecificPermissionGrant, options CreatePermissionGrantOperationOptions) (result CreatePermissionGrantOperationResponse, err error) {
