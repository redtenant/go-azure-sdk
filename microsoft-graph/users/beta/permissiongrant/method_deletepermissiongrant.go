...
func (c PermissionGrantClient) DeletePermissionGrant(ctx context.Context, id beta.UserIdPermissionGrantId, options DeletePermissionGrantOperationOptions) (result DeletePermissionGrantOperationResponse, err error) {
