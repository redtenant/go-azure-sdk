...
func (c PermissionGrantClient) GetPermissionGrant(ctx context.Context, id beta.UserIdPermissionGrantId, options GetPermissionGrantOperationOptions) (result GetPermissionGrantOperationResponse, err error) {
