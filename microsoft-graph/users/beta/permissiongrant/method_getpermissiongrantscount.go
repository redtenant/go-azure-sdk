...
func (c PermissionGrantClient) GetPermissionGrantsCount(ctx context.Context, id beta.UserId, options GetPermissionGrantsCountOperationOptions) (result GetPermissionGrantsCountOperationResponse, err error) {
