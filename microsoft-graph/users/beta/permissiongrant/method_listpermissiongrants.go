...
// list specifies the Microsoft Entra apps that have access to the user, along with the corresponding kind of
// resource-specific access that each app has.
func (c PermissionGrantClient) ListPermissionGrants(ctx context.Context, id beta.UserId, options ListPermissionGrantsOperationOptions) (result ListPermissionGrantsOperationResponse, err error) {
...
func (c PermissionGrantClient) ListPermissionGrantsComplete(ctx context.Context, id beta.UserId, options ListPermissionGrantsOperationOptions) (ListPermissionGrantsCompleteResult, error) {
...
func (c PermissionGrantClient) ListPermissionGrantsCompleteMatchingPredicate(ctx context.Context, id beta.UserId, options ListPermissionGrantsOperationOptions, predicate ResourceSpecificPermissionGrantOperationPredicate) (result ListPermissionGrantsCompleteResult, err error) {
