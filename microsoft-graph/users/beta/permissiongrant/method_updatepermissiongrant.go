...
func (c PermissionGrantClient) UpdatePermissionGrant(ctx context.Context, id beta.UserIdPermissionGrantId, input beta.ResourceSpecificPermissionGrant, options UpdatePermissionGrantOperationOptions) (result UpdatePermissionGrantOperationResponse, err error) {
