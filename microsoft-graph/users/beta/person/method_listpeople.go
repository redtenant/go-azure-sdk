...
// ListPeople - Get people from users. Read-only. The most relevant people to the user. The collection is ordered by
// their relevance to the user, which is determined by the user's communication, collaboration, and business
// relationships. A person aggregates information from mail, contacts, and social networks.
