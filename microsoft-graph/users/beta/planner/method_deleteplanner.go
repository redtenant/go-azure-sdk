...
func (c PlannerClient) DeletePlanner(ctx context.Context, id beta.UserId, options DeletePlannerOperationOptions) (result DeletePlannerOperationResponse, err error) {
