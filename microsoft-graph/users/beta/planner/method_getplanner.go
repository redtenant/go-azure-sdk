...
// GetPlanner - Get planner from users. Selective Planner services available to the user. Read-only. Nullable.
func (c PlannerClient) GetPlanner(ctx context.Context, id beta.UserId, options GetPlannerOperationOptions) (result GetPlannerOperationResponse, err error) {
