...
func (c PlannerClient) UpdatePlanner(ctx context.Context, id beta.UserId, input beta.PlannerUser, options UpdatePlannerOperationOptions) (result UpdatePlannerOperationResponse, err error) {
