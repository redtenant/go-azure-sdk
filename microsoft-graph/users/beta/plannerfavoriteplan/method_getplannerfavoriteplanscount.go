...
func (c PlannerFavoritePlanClient) GetPlannerFavoritePlansCount(ctx context.Context, id beta.UserId, options GetPlannerFavoritePlansCountOperationOptions) (result GetPlannerFavoritePlansCountOperationResponse, err error) {
	opts := client.RequestOptions{
		...
		Path:          fmt.Sprintf("%s/planner/favoritePlans/$count", id.ID()),
