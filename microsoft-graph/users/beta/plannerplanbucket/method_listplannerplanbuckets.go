...
// ListPlannerPlanBuckets - Get buckets from users. Collection of buckets in the plan. Read-only. Nullable.
func (c PlannerPlanBucketClient) ListPlannerPlanBuckets(ctx context.Context, id beta.UserIdPlannerPlanId, options ListPlannerPlanBucketsOperationOptions) (result ListPlannerPlanBucketsOperationResponse, err error) {
...
func (c PlannerPlanBucketClient) ListPlannerPlanBucketsComplete(ctx context.Context, id beta.UserIdPlannerPlanId, options ListPlannerPlanBucketsOperationOptions) (ListPlannerPlanBucketsCompleteResult, error) {
...
func (c PlannerPlanBucketClient) ListPlannerPlanBucketsCompleteMatchingPredicate(ctx context.Context, id beta.UserIdPlannerPlanId, options ListPlannerPlanBucketsOperationOptions, predicate PlannerBucketOperationPredicate) (result ListPlannerPlanBucketsCompleteResult, err error) {
