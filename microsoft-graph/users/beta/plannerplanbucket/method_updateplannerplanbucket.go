...
func (c PlannerPlanBucketClient) UpdatePlannerPlanBucket(ctx context.Context, id beta.UserIdPlannerPlanIdBucketId, input beta.PlannerBucket, options UpdatePlannerPlanBucketOperationOptions) (result UpdatePlannerPlanBucketOperationResponse, err error) {
