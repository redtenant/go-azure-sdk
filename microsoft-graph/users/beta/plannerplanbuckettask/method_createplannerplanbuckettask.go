...
func (c PlannerPlanBucketTaskClient) CreatePlannerPlanBucketTask(ctx context.Context, id beta.UserIdPlannerPlanIdBucketId, input beta.PlannerTask, options CreatePlannerPlanBucketTaskOperationOptions) (result CreatePlannerPlanBucketTaskOperationResponse, err error) {
