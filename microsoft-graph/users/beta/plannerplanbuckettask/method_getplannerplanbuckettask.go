...
func (c PlannerPlanBucketTaskClient) GetPlannerPlanBucketTask(ctx context.Context, id beta.UserIdPlannerPlanIdBucketIdTaskId, options GetPlannerPlanBucketTaskOperationOptions) (result GetPlannerPlanBucketTaskOperationResponse, err error) {
