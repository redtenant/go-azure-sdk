...
func (c PlannerPlanBucketTaskClient) ListPlannerPlanBucketTasks(ctx context.Context, id beta.UserIdPlannerPlanIdBucketId, options ListPlannerPlanBucketTasksOperationOptions) (result ListPlannerPlanBucketTasksOperationResponse, err error) {
...
func (c PlannerPlanBucketTaskClient) ListPlannerPlanBucketTasksComplete(ctx context.Context, id beta.UserIdPlannerPlanIdBucketId, options ListPlannerPlanBucketTasksOperationOptions) (ListPlannerPlanBucketTasksCompleteResult, error) {
...
func (c PlannerPlanBucketTaskClient) ListPlannerPlanBucketTasksCompleteMatchingPredicate(ctx context.Context, id beta.UserIdPlannerPlanIdBucketId, options ListPlannerPlanBucketTasksOperationOptions, predicate PlannerTaskOperationPredicate) (result ListPlannerPlanBucketTasksCompleteResult, err error) {
