...
func (c PlannerPlanBucketTaskAssignedToTaskBoardFormatClient) GetPlannerPlanBucketTaskAssignedToTaskBoardFormat(ctx context.Context, id beta.UserIdPlannerPlanIdBucketIdTaskId, options GetPlannerPlanBucketTaskAssignedToTaskBoardFormatOperationOptions) (result GetPlannerPlanBucketTaskAssignedToTaskBoardFormatOperationResponse, err error) {
