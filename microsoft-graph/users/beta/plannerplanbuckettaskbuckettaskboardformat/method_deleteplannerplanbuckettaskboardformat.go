...
func (c PlannerPlanBucketTaskBucketTaskBoardFormatClient) DeletePlannerPlanBucketTaskBoardFormat(ctx context.Context, id beta.UserIdPlannerPlanIdBucketIdTaskId, options DeletePlannerPlanBucketTaskBoardFormatOperationOptions) (result DeletePlannerPlanBucketTaskBoardFormatOperationResponse, err error) {
