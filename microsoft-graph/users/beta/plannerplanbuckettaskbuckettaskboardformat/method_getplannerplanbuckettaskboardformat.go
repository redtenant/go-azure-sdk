...
// GetPlannerPlanBucketTaskBoardFormat - Get bucketTaskBoardFormat from users. Read-only. Nullable. Used to render the
// task correctly in the task board view when grouped by bucket.
func (c PlannerPlanBucketTaskBucketTaskBoardFormatClient) GetPlannerPlanBucketTaskBoardFormat(ctx context.Context, id beta.UserIdPlannerPlanIdBucketIdTaskId, options GetPlannerPlanBucketTaskBoardFormatOperationOptions) (result GetPlannerPlanBucketTaskBoardFormatOperationResponse, err error) {
