...
func (c PlannerPlanBucketTaskDetailClient) UpdatePlannerPlanBucketTaskDetail(ctx context.Context, id beta.UserIdPlannerPlanIdBucketIdTaskId, input beta.PlannerTaskDetails, options UpdatePlannerPlanBucketTaskDetailOperationOptions) (result UpdatePlannerPlanBucketTaskDetailOperationResponse, err error) {
