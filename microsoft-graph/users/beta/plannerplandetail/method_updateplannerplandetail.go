...
func (c PlannerPlanDetailClient) UpdatePlannerPlanDetail(ctx context.Context, id beta.UserIdPlannerPlanId, input beta.PlannerPlanDetails, options UpdatePlannerPlanDetailOperationOptions) (result UpdatePlannerPlanDetailOperationResponse, err error) {
