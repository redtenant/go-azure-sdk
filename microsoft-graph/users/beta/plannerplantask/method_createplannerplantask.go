...
func (c PlannerPlanTaskClient) CreatePlannerPlanTask(ctx context.Context, id beta.UserIdPlannerPlanId, input beta.PlannerTask, options CreatePlannerPlanTaskOperationOptions) (result CreatePlannerPlanTaskOperationResponse, err error) {
