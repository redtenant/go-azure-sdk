...
func (c PlannerPlanTaskClient) ListPlannerPlanTasks(ctx context.Context, id beta.UserIdPlannerPlanId, options ListPlannerPlanTasksOperationOptions) (result ListPlannerPlanTasksOperationResponse, err error) {
...
func (c PlannerPlanTaskClient) ListPlannerPlanTasksComplete(ctx context.Context, id beta.UserIdPlannerPlanId, options ListPlannerPlanTasksOperationOptions) (ListPlannerPlanTasksCompleteResult, error) {
