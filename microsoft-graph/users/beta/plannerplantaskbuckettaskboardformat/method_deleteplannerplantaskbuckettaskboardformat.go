...
func (c PlannerPlanTaskBucketTaskBoardFormatClient) DeletePlannerPlanTaskBucketTaskBoardFormat(ctx context.Context, id beta.UserIdPlannerPlanIdTaskId, options DeletePlannerPlanTaskBucketTaskBoardFormatOperationOptions) (result DeletePlannerPlanTaskBucketTaskBoardFormatOperationResponse, err error) {
