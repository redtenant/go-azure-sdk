...
// UpdatePlannerPlanTaskBucketTaskBoardFormat - Update the navigation property bucketTaskBoardFormat in users
func (c PlannerPlanTaskBucketTaskBoardFormatClient) UpdatePlannerPlanTaskBucketTaskBoardFormat(ctx context.Context, id beta.UserIdPlannerPlanIdTaskId, input beta.PlannerBucketTaskBoardTaskFormat, options UpdatePlannerPlanTaskBucketTaskBoardFormatOperationOptions) (result UpdatePlannerPlanTaskBucketTaskBoardFormatOperationResponse, err error) {
