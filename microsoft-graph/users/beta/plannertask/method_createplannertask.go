...
func (c PlannerTaskClient) CreatePlannerTask(ctx context.Context, id beta.UserId, input beta.PlannerTask, options CreatePlannerTaskOperationOptions) (result CreatePlannerTaskOperationResponse, err error) {
