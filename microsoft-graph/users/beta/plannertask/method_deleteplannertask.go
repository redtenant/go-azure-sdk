...
func (c PlannerTaskClient) DeletePlannerTask(ctx context.Context, id beta.UserIdPlannerTaskId, options DeletePlannerTaskOperationOptions) (result DeletePlannerTaskOperationResponse, err error) {
