...
func (c PlannerTaskClient) UpdatePlannerTask(ctx context.Context, id beta.UserIdPlannerTaskId, input beta.PlannerTask, options UpdatePlannerTaskOperationOptions) (result UpdatePlannerTaskOperationResponse, err error) {
