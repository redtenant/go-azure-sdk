...
func (c PlannerTaskAssignedToTaskBoardFormatClient) DeletePlannerTaskAssignedToTaskBoardFormat(ctx context.Context, id beta.UserIdPlannerTaskId, options DeletePlannerTaskAssignedToTaskBoardFormatOperationOptions) (result DeletePlannerTaskAssignedToTaskBoardFormatOperationResponse, err error) {
