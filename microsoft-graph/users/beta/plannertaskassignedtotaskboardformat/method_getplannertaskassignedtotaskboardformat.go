...
func (c PlannerTaskAssignedToTaskBoardFormatClient) GetPlannerTaskAssignedToTaskBoardFormat(ctx context.Context, id beta.UserIdPlannerTaskId, options GetPlannerTaskAssignedToTaskBoardFormatOperationOptions) (result GetPlannerTaskAssignedToTaskBoardFormatOperationResponse, err error) {
