...
func (c PlannerTaskAssignedToTaskBoardFormatClient) UpdatePlannerTaskAssignedToTaskBoardFormat(ctx context.Context, id beta.UserIdPlannerTaskId, input beta.PlannerAssignedToTaskBoardTaskFormat, options UpdatePlannerTaskAssignedToTaskBoardFormatOperationOptions) (result UpdatePlannerTaskAssignedToTaskBoardFormatOperationResponse, err error) {
