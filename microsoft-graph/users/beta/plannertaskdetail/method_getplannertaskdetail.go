...
func (c PlannerTaskDetailClient) GetPlannerTaskDetail(ctx context.Context, id beta.UserIdPlannerTaskId, options GetPlannerTaskDetailOperationOptions) (result GetPlannerTaskDetailOperationResponse, err error) {
