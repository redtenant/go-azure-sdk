...
func (c PlannerTaskDetailClient) UpdatePlannerTaskDetail(ctx context.Context, id beta.UserIdPlannerTaskId, input beta.PlannerTaskDetails, options UpdatePlannerTaskDetailOperationOptions) (result UpdatePlannerTaskDetailOperationResponse, err error) {
