...
func DefaultDeleteProfileOperationOptions() DeleteProfileOperationOptions {
	return DeleteProfileOperationOptions{}
}
...
func (c ProfileClient) DeleteProfile(ctx context.Context, id beta.UserId, options DeleteProfileOperationOptions) (result DeleteProfileOperationResponse, err error) {
