...
// DeleteProfileAccount - Delete navigation property account for users
func (c ProfileAccountClient) DeleteProfileAccount(ctx context.Context, id beta.UserIdProfileAccountId, options DeleteProfileAccountOperationOptions) (result DeleteProfileAccountOperationResponse, err error) {
