...
func DefaultGetProfileAccountOperationOptions() GetProfileAccountOperationOptions {
	return GetProfileAccountOperationOptions{}
}
...
// GetProfileAccount - Get account from users
func (c ProfileAccountClient) GetProfileAccount(ctx context.Context, id beta.UserIdProfileAccountId, options GetProfileAccountOperationOptions) (result GetProfileAccountOperationResponse, err error) {
	...
	var model beta.UserAccountInformation
	result.Model = &model
