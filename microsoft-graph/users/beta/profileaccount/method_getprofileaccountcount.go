...
func DefaultGetProfileAccountCountOperationOptions() GetProfileAccountCountOperationOptions {
	return GetProfileAccountCountOperationOptions{}
}
...
func (c ProfileAccountClient) GetProfileAccountCount(ctx context.Context, id beta.UserId, options GetProfileAccountCountOperationOptions) (result GetProfileAccountCountOperationResponse, err error) {
	opts := client.RequestOptions{
		...
		Path:          fmt.Sprintf("%s/profile/account/$count", id.ID()),
