...
// UpdateProfileAccount - Update the navigation property account in users
func (c ProfileAccountClient) UpdateProfileAccount(ctx context.Context, id beta.UserIdProfileAccountId, input beta.UserAccountInformation, options UpdateProfileAccountOperationOptions) (result UpdateProfileAccountOperationResponse, err error) {
