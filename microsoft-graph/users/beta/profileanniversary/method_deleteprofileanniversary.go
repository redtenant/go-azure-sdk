...
// DeleteProfileAnniversary - Delete navigation property anniversaries for users
func (c ProfileAnniversaryClient) DeleteProfileAnniversary(ctx context.Context, id beta.UserIdProfileAnniversaryId, options DeleteProfileAnniversaryOperationOptions) (result DeleteProfileAnniversaryOperationResponse, err error) {
