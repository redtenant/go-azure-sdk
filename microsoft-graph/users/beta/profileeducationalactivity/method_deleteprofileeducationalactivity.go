...
// DeleteProfileEducationalActivity - Delete navigation property educationalActivities for users
func (c ProfileEducationalActivityClient) DeleteProfileEducationalActivity(ctx context.Context, id beta.UserIdProfileEducationalActivityId, options DeleteProfileEducationalActivityOperationOptions) (result DeleteProfileEducationalActivityOperationResponse, err error) {
