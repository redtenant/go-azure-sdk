...
// UpdateProfileEducationalActivity - Update the navigation property educationalActivities in users
func (c ProfileEducationalActivityClient) UpdateProfileEducationalActivity(ctx context.Context, id beta.UserIdProfileEducationalActivityId, input beta.EducationalActivity, options UpdateProfileEducationalActivityOperationOptions) (result UpdateProfileEducationalActivityOperationResponse, err error) {
