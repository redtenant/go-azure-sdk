...
// GetProfileInterest - Get interests from users. Provides detailed information about interests the user has associated
// with themselves in various services.
func (c ProfileInterestClient) GetProfileInterest(ctx context.Context, id beta.UserIdProfileInterestId, options GetProfileInterestOperationOptions) (result GetProfileInterestOperationResponse, err error) {
