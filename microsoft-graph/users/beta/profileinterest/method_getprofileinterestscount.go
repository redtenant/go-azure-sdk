...
func DefaultGetProfileInterestsCountOperationOptions() GetProfileInterestsCountOperationOptions {
	return GetProfileInterestsCountOperationOptions{}
}
...
func (c ProfileInterestClient) GetProfileInterestsCount(ctx context.Context, id beta.UserId, options GetProfileInterestsCountOperationOptions) (result GetProfileInterestsCountOperationResponse, err error) {
	opts := client.RequestOptions{
		...
		Path:          fmt.Sprintf("%s/profile/interests/$count", id.ID()),
