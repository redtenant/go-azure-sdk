...
// CreateProfileLanguage - Create new navigation property to languages for users
func (c ProfileLanguageClient) CreateProfileLanguage(ctx context.Context, id beta.UserId, input beta.LanguageProficiency, options CreateProfileLanguageOperationOptions) (result CreateProfileLanguageOperationResponse, err error) {
