...
func DefaultDeleteProfileNameOperationOptions() DeleteProfileNameOperationOptions {
	return DeleteProfileNameOperationOptions{}
}
...
// DeleteProfileName - Delete navigation property names for users
func (c ProfileNameClient) DeleteProfileName(ctx context.Context, id beta.UserIdProfileNameId, options DeleteProfileNameOperationOptions) (result DeleteProfileNameOperationResponse, err error) {
