...
func (c ProfileNameClient) GetProfileNamesCount(ctx context.Context, id beta.UserId, options GetProfileNamesCountOperationOptions) (result GetProfileNamesCountOperationResponse, err error) {
	opts := client.RequestOptions{
		...
		Path:          fmt.Sprintf("%s/profile/names/$count", id.ID()),
