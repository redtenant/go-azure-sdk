...
func DefaultGetProfileNoteOperationOptions() GetProfileNoteOperationOptions {
	return GetProfileNoteOperationOptions{}
}
...
func (c ProfileNoteClient) GetProfileNote(ctx context.Context, id beta.UserIdProfileNoteId, options GetProfileNoteOperationOptions) (result GetProfileNoteOperationResponse, err error) {
