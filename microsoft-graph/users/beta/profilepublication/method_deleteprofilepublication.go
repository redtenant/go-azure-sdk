...
func DefaultDeleteProfilePublicationOperationOptions() DeleteProfilePublicationOperationOptions {
	return DeleteProfilePublicationOperationOptions{}
}
...
// DeleteProfilePublication - Delete navigation property publications for users
func (c ProfilePublicationClient) DeleteProfilePublication(ctx context.Context, id beta.UserIdProfilePublicationId, options DeleteProfilePublicationOperationOptions) (result DeleteProfilePublicationOperationResponse, err error) {
