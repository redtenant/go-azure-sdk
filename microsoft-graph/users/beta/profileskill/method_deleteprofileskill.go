...
func (c ProfileSkillClient) DeleteProfileSkill(ctx context.Context, id beta.UserIdProfileSkillId, options DeleteProfileSkillOperationOptions) (result DeleteProfileSkillOperationResponse, err error) {
