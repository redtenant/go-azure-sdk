...
func DefaultGetProfileSkillsCountOperationOptions() GetProfileSkillsCountOperationOptions {
	return GetProfileSkillsCountOperationOptions{}
}
...
func (c ProfileSkillClient) GetProfileSkillsCount(ctx context.Context, id beta.UserId, options GetProfileSkillsCountOperationOptions) (result GetProfileSkillsCountOperationResponse, err error) {
	opts := client.RequestOptions{
		...
		Path:          fmt.Sprintf("%s/profile/skills/$count", id.ID()),
