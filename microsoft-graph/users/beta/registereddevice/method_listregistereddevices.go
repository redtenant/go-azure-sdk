...
func (c RegisteredDeviceClient) ListRegisteredDevices(ctx context.Context, id beta.UserId, options ListRegisteredDevicesOperationOptions) (result ListRegisteredDevicesOperationResponse, err error) {
...
func (c RegisteredDeviceClient) ListRegisteredDevicesComplete(ctx context.Context, id beta.UserId, options ListRegisteredDevicesOperationOptions) (ListRegisteredDevicesCompleteResult, error) {
...
func (c RegisteredDeviceClient) ListRegisteredDevicesCompleteMatchingPredicate(ctx context.Context, id beta.UserId, options ListRegisteredDevicesOperationOptions, predicate DirectoryObjectOperationPredicate) (result ListRegisteredDevicesCompleteResult, err error) {
