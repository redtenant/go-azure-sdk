...
func (c ScopedRoleMemberOfClient) CreateScopedRoleMemberOf(ctx context.Context, id beta.UserId, input beta.ScopedRoleMembership, options CreateScopedRoleMemberOfOperationOptions) (result CreateScopedRoleMemberOfOperationResponse, err error) {
