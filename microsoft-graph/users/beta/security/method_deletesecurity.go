...
func DefaultDeleteSecurityOperationOptions() DeleteSecurityOperationOptions {
	return DeleteSecurityOperationOptions{}
}
...
// DeleteSecurity - Delete navigation property security for users
func (c SecurityClient) DeleteSecurity(ctx context.Context, id beta.UserId, options DeleteSecurityOperationOptions) (result DeleteSecurityOperationResponse, err error) {
