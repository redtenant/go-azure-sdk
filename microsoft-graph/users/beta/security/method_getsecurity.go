...
// GetSecurity - Get security from users
func (c SecurityClient) GetSecurity(ctx context.Context, id beta.UserId, options GetSecurityOperationOptions) (result GetSecurityOperationResponse, err error) {
