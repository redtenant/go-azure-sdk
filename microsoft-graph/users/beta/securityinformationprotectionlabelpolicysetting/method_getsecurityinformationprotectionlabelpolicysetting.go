...
type GetSecurityInformationProtectionLabelPolicySettingOperationResponse struct {
	HttpResponse *http.Response
	OData        *odata.OData
	Model        *beta.SecurityInformationProtectionPolicySetting
}

type GetSecurityInformationProtectionLabelPolicySettingOperationOptions struct {
	Expand    *odata.Expand
...
func DefaultGetSecurityInformationProtectionLabelPolicySettingOperationOptions() GetSecurityInformationProtectionLabelPolicySettingOperationOptions {
	return GetSecurityInformationProtectionLabelPolicySettingOperationOptions{}
}
...
// GetSecurityInformationProtectionLabelPolicySetting - Get informationProtectionPolicySetting. Read the properties and
// relationships of an informationProtectionPolicySetting object. The settings exposed by this API should be used in
// applications to populate the moreInfoUrl property for Microsoft Purview Information Protection help, and indicate
...
func (c SecurityInformationProtectionLabelPolicySettingClient) GetSecurityInformationProtectionLabelPolicySetting(ctx context.Context, id beta.UserId, options GetSecurityInformationProtectionLabelPolicySettingOperationOptions) (result GetSecurityInformationProtectionLabelPolicySettingOperationResponse, err error) {
	...
	var model beta.SecurityInformationProtectionPolicySetting
	result.Model = &model
