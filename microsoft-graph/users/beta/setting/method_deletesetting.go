...
func (c SettingClient) DeleteSetting(ctx context.Context, id beta.UserId, options DeleteSettingOperationOptions) (result DeleteSettingOperationResponse, err error) {
