...
// GetSetting - Get settings from users
func (c SettingClient) GetSetting(ctx context.Context, id beta.UserId, options GetSettingOperationOptions) (result GetSettingOperationResponse, err error) {
