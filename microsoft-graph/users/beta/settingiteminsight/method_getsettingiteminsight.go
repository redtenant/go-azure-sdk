...
type GetSettingItemInsightOperationResponse struct {
	...
	OData        *odata.OData
	Model        *beta.UserInsightsSettings
}
...
func (c SettingItemInsightClient) GetSettingItemInsight(ctx context.Context, id beta.UserId, options GetSettingItemInsightOperationOptions) (result GetSettingItemInsightOperationResponse, err error) {
	...
	var model beta.UserInsightsSettings
	result.Model = &model
