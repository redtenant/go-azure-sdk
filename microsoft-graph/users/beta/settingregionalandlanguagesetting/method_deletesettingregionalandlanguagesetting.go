...
// DeleteSettingRegionalAndLanguageSetting - Delete navigation property regionalAndLanguageSettings for users
func (c SettingRegionalAndLanguageSettingClient) DeleteSettingRegionalAndLanguageSetting(ctx context.Context, id beta.UserId, options DeleteSettingRegionalAndLanguageSettingOperationOptions) (result DeleteSettingRegionalAndLanguageSettingOperationResponse, err error) {
