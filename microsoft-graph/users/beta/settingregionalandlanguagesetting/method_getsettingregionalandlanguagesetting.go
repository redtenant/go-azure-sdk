...
// GetSettingRegionalAndLanguageSetting - Get regionalAndLanguageSettings from users. The user's preferences for
// languages, regional locale and date/time formatting.
func (c SettingRegionalAndLanguageSettingClient) GetSettingRegionalAndLanguageSetting(ctx context.Context, id beta.UserId, options GetSettingRegionalAndLanguageSettingOperationOptions) (result GetSettingRegionalAndLanguageSettingOperationResponse, err error) {
