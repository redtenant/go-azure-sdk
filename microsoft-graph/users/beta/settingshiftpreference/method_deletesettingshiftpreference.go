...
func (c SettingShiftPreferenceClient) DeleteSettingShiftPreference(ctx context.Context, id beta.UserId, options DeleteSettingShiftPreferenceOperationOptions) (result DeleteSettingShiftPreferenceOperationResponse, err error) {
