...
func (c SettingStorageClient) UpdateSettingStorage(ctx context.Context, id beta.UserId, input beta.UserStorage, options UpdateSettingStorageOperationOptions) (result UpdateSettingStorageOperationResponse, err error) {
