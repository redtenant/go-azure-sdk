...
func (c SettingStorageQuotaClient) DeleteSettingStorageQuota(ctx context.Context, id beta.UserId, options DeleteSettingStorageQuotaOperationOptions) (result DeleteSettingStorageQuotaOperationResponse, err error) {
