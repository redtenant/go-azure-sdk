...
type GetSettingStorageQuotaOperationResponse struct {
	...
	OData        *odata.OData
	Model        *beta.UnifiedStorageQuota
}
...
// GetSettingStorageQuota - Get unifiedStorageQuota. Read the properties and relationships of a unifiedStorageQuota
// object.
func (c SettingStorageQuotaClient) GetSettingStorageQuota(ctx context.Context, id beta.UserId, options GetSettingStorageQuotaOperationOptions) (result GetSettingStorageQuotaOperationResponse, err error) {
	...
	var model beta.UnifiedStorageQuota
	result.Model = &model
