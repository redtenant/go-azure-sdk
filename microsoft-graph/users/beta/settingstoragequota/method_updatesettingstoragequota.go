...
func (c SettingStorageQuotaClient) UpdateSettingStorageQuota(ctx context.Context, id beta.UserId, input beta.UnifiedStorageQuota, options UpdateSettingStorageQuotaOperationOptions) (result UpdateSettingStorageQuotaOperationResponse, err error) {
