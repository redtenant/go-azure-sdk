...
// GetSettingStorageQuotaService - Get services from users. The breakdown of services contributing to the user's quota
// usage.
func (c SettingStorageQuotaServiceClient) GetSettingStorageQuotaService(ctx context.Context, id beta.UserIdSettingStorageQuotaServiceId, options GetSettingStorageQuotaServiceOperationOptions) (result GetSettingStorageQuotaServiceOperationResponse, err error) {
