...
func (c SettingStorageQuotaServiceClient) GetSettingStorageQuotaServicesCount(ctx context.Context, id beta.UserId, options GetSettingStorageQuotaServicesCountOperationOptions) (result GetSettingStorageQuotaServicesCountOperationResponse, err error) {
	opts := client.RequestOptions{
		...
		Path:          fmt.Sprintf("%s/settings/storage/quota/services/$count", id.ID()),
