...
// ListSettingStorageQuotaServices - Get services from users. The breakdown of services contributing to the user's quota
// usage.
func (c SettingStorageQuotaServiceClient) ListSettingStorageQuotaServices(ctx context.Context, id beta.UserId, options ListSettingStorageQuotaServicesOperationOptions) (result ListSettingStorageQuotaServicesOperationResponse, err error) {
...
func (c SettingStorageQuotaServiceClient) ListSettingStorageQuotaServicesComplete(ctx context.Context, id beta.UserId, options ListSettingStorageQuotaServicesOperationOptions) (ListSettingStorageQuotaServicesCompleteResult, error) {
