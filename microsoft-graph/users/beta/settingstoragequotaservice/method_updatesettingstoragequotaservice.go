...
func (c SettingStorageQuotaServiceClient) UpdateSettingStorageQuotaService(ctx context.Context, id beta.UserIdSettingStorageQuotaServiceId, input beta.ServiceStorageQuotaBreakdown, options UpdateSettingStorageQuotaServiceOperationOptions) (result UpdateSettingStorageQuotaServiceOperationResponse, err error) {
