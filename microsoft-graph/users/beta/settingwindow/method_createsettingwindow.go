...
func (c SettingWindowClient) CreateSettingWindow(ctx context.Context, id beta.UserId, input beta.WindowsSetting, options CreateSettingWindowOperationOptions) (result CreateSettingWindowOperationResponse, err error) {
