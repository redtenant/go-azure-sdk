...
// GetSettingWindow - Get windows from users. The Windows settings of the user stored in the cloud.
func (c SettingWindowClient) GetSettingWindow(ctx context.Context, id beta.UserIdSettingWindowId, options GetSettingWindowOperationOptions) (result GetSettingWindowOperationResponse, err error) {
