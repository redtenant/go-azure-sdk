...
// ListSettingWindows - Get windows from users. The Windows settings of the user stored in the cloud.
func (c SettingWindowClient) ListSettingWindows(ctx context.Context, id beta.UserId, options ListSettingWindowsOperationOptions) (result ListSettingWindowsOperationResponse, err error) {
...
func (c SettingWindowClient) ListSettingWindowsComplete(ctx context.Context, id beta.UserId, options ListSettingWindowsOperationOptions) (ListSettingWindowsCompleteResult, error) {
...
func (c SettingWindowClient) ListSettingWindowsCompleteMatchingPredicate(ctx context.Context, id beta.UserId, options ListSettingWindowsOperationOptions, predicate WindowsSettingOperationPredicate) (result ListSettingWindowsCompleteResult, err error) {
