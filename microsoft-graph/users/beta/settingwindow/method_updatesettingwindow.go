...
func (c SettingWindowClient) UpdateSettingWindow(ctx context.Context, id beta.UserIdSettingWindowId, input beta.WindowsSetting, options UpdateSettingWindowOperationOptions) (result UpdateSettingWindowOperationResponse, err error) {
