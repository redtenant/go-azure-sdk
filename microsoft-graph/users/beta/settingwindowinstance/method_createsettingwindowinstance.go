...
func (c SettingWindowInstanceClient) CreateSettingWindowInstance(ctx context.Context, id beta.UserIdSettingWindowId, input beta.WindowsSettingInstance, options CreateSettingWindowInstanceOperationOptions) (result CreateSettingWindowInstanceOperationResponse, err error) {
