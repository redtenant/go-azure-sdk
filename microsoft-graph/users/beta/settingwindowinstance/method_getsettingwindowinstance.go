...
func (c SettingWindowInstanceClient) GetSettingWindowInstance(ctx context.Context, id beta.UserIdSettingWindowIdInstanceId, options GetSettingWindowInstanceOperationOptions) (result GetSettingWindowInstanceOperationResponse, err error) {
