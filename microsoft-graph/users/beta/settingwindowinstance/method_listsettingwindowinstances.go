...
type ListSettingWindowInstancesCompleteResult struct {
	...
	Items              []beta.WindowsSettingInstance
}
...
func (c SettingWindowInstanceClient) ListSettingWindowInstances(ctx context.Context, id beta.UserIdSettingWindowId, options ListSettingWindowInstancesOperationOptions) (result ListSettingWindowInstancesOperationResponse, err error) {
	...
	var values struct {
		Values *[]beta.WindowsSettingInstance `json:"value"`
	}
...
func (c SettingWindowInstanceClient) ListSettingWindowInstancesComplete(ctx context.Context, id beta.UserIdSettingWindowId, options ListSettingWindowInstancesOperationOptions) (ListSettingWindowInstancesCompleteResult, error) {
...
func (c SettingWindowInstanceClient) ListSettingWindowInstancesCompleteMatchingPredicate(ctx context.Context, id beta.UserIdSettingWindowId, options ListSettingWindowInstancesOperationOptions, predicate WindowsSettingInstanceOperationPredicate) (result ListSettingWindowInstancesCompleteResult, err error) {
	items := make([]beta.WindowsSettingInstance, 0)
