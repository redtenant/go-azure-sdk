...
func (c SponsorClient) GetSponsorsCount(ctx context.Context, id beta.UserId, options GetSponsorsCountOperationOptions) (result GetSponsorsCountOperationResponse, err error) {
