...
// associated with.
func (c TeamworkAssociatedTeamClient) GetTeamworkAssociatedTeam(ctx context.Context, id beta.UserIdTeamworkAssociatedTeamId, options GetTeamworkAssociatedTeamOperationOptions) (result GetTeamworkAssociatedTeamOperationResponse, err error) {
