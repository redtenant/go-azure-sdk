...
func (c TeamworkAssociatedTeamClient) GetTeamworkAssociatedTeamsCount(ctx context.Context, id beta.UserId, options GetTeamworkAssociatedTeamsCountOperationOptions) (result GetTeamworkAssociatedTeamsCountOperationResponse, err error) {
