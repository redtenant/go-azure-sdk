...
func (c TeamworkAssociatedTeamClient) UpdateTeamworkAssociatedTeam(ctx context.Context, id beta.UserIdTeamworkAssociatedTeamId, input beta.AssociatedTeamInfo, options UpdateTeamworkAssociatedTeamOperationOptions) (result UpdateTeamworkAssociatedTeamOperationResponse, err error) {
