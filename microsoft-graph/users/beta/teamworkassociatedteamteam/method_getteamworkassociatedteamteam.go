...
func (c TeamworkAssociatedTeamTeamClient) GetTeamworkAssociatedTeamTeam(ctx context.Context, id beta.UserIdTeamworkAssociatedTeamId, options GetTeamworkAssociatedTeamTeamOperationOptions) (result GetTeamworkAssociatedTeamTeamOperationResponse, err error) {
