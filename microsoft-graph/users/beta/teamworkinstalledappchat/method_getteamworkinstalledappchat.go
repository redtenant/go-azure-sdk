...
// app.
func (c TeamworkInstalledAppChatClient) GetTeamworkInstalledAppChat(ctx context.Context, id beta.UserIdTeamworkInstalledAppId, options GetTeamworkInstalledAppChatOperationOptions) (result GetTeamworkInstalledAppChatOperationResponse, err error) {
