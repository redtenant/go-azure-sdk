...
// app.
func (c TeamworkInstalledAppTeamsAppDefinitionClient) GetTeamworkInstalledAppTeamsAppDefinition(ctx context.Context, id beta.UserIdTeamworkInstalledAppId, options GetTeamworkInstalledAppTeamsAppDefinitionOperationOptions) (result GetTeamworkInstalledAppTeamsAppDefinitionOperationResponse, err error) {
