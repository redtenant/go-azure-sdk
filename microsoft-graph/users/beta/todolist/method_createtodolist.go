...
func (c TodoListClient) CreateTodoList(ctx context.Context, id beta.UserId, input beta.TodoTaskList, options CreateTodoListOperationOptions) (result CreateTodoListOperationResponse, err error) {
