...
func (c TodoListClient) DeleteTodoList(ctx context.Context, id beta.UserIdTodoListId, options DeleteTodoListOperationOptions) (result DeleteTodoListOperationResponse, err error) {
