...
func (c TodoListClient) GetTodoList(ctx context.Context, id beta.UserIdTodoListId, options GetTodoListOperationOptions) (result GetTodoListOperationResponse, err error) {
