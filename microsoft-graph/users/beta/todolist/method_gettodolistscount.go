...
func (c TodoListClient) GetTodoListsCount(ctx context.Context, id beta.UserId, options GetTodoListsCountOperationOptions) (result GetTodoListsCountOperationResponse, err error) {
