...
func (c TodoListClient) ListTodoLists(ctx context.Context, id beta.UserId, options ListTodoListsOperationOptions) (result ListTodoListsOperationResponse, err error) {
...
func (c TodoListClient) ListTodoListsComplete(ctx context.Context, id beta.UserId, options ListTodoListsOperationOptions) (ListTodoListsCompleteResult, error) {
...
func (c TodoListClient) ListTodoListsCompleteMatchingPredicate(ctx context.Context, id beta.UserId, options ListTodoListsOperationOptions, predicate TodoTaskListOperationPredicate) (result ListTodoListsCompleteResult, err error) {
