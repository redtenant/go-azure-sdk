...
func (c TodoListExtensionClient) CreateTodoListExtension(ctx context.Context, id beta.UserIdTodoListId, input beta.Extension, options CreateTodoListExtensionOperationOptions) (result CreateTodoListExtensionOperationResponse, err error) {
