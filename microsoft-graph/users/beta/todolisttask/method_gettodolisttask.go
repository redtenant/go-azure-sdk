...
func (c TodoListTaskClient) GetTodoListTask(ctx context.Context, id beta.UserIdTodoListIdTaskId, options GetTodoListTaskOperationOptions) (result GetTodoListTaskOperationResponse, err error) {
