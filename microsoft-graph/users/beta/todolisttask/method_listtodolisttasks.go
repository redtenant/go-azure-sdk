...
func (c TodoListTaskClient) ListTodoListTasks(ctx context.Context, id beta.UserIdTodoListId, options ListTodoListTasksOperationOptions) (result ListTodoListTasksOperationResponse, err error) {
...
func (c TodoListTaskClient) ListTodoListTasksComplete(ctx context.Context, id beta.UserIdTodoListId, options ListTodoListTasksOperationOptions) (ListTodoListTasksCompleteResult, error) {
...
func (c TodoListTaskClient) ListTodoListTasksCompleteMatchingPredicate(ctx context.Context, id beta.UserIdTodoListId, options ListTodoListTasksOperationOptions, predicate TodoTaskOperationPredicate) (result ListTodoListTasksCompleteResult, err error) {
