...
func (c TodoListTaskAttachmentClient) DeleteTodoListTaskAttachment(ctx context.Context, id beta.UserIdTodoListIdTaskIdAttachmentId, options DeleteTodoListTaskAttachmentOperationOptions) (result DeleteTodoListTaskAttachmentOperationResponse, err error) {
