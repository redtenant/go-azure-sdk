...
func (c TodoListTaskAttachmentClient) GetTodoListTaskAttachment(ctx context.Context, id beta.UserIdTodoListIdTaskIdAttachmentId, options GetTodoListTaskAttachmentOperationOptions) (result GetTodoListTaskAttachmentOperationResponse, err error) {
