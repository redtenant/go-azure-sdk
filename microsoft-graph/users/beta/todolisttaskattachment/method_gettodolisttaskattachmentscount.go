...
func DefaultGetTodoListTaskAttachmentsCountOperationOptions() GetTodoListTaskAttachmentsCountOperationOptions {
	return GetTodoListTaskAttachmentsCountOperationOptions{}
}
...
func (c TodoListTaskAttachmentClient) GetTodoListTaskAttachmentsCount(ctx context.Context, id beta.UserIdTodoListIdTaskId, options GetTodoListTaskAttachmentsCountOperationOptions) (result GetTodoListTaskAttachmentsCountOperationResponse, err error) {
