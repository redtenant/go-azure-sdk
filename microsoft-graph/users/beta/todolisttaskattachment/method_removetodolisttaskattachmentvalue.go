...
func DefaultRemoveTodoListTaskAttachmentValueOperationOptions() RemoveTodoListTaskAttachmentValueOperationOptions {
	return RemoveTodoListTaskAttachmentValueOperationOptions{}
}
...
// RemoveTodoListTaskAttachmentValue - Delete media content for the navigation property attachments in users. The unique
// identifier for an entity. Read-only.
func (c TodoListTaskAttachmentClient) RemoveTodoListTaskAttachmentValue(ctx context.Context, id beta.UserIdTodoListIdTaskIdAttachmentId, options RemoveTodoListTaskAttachmentValueOperationOptions) (result RemoveTodoListTaskAttachmentValueOperationResponse, err error) {
