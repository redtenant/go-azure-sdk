...
func (c TodoListTaskAttachmentSessionContentClient) GetTodoListTaskAttachmentSessionContent(ctx context.Context, id beta.UserIdTodoListIdTaskIdAttachmentSessionId, options GetTodoListTaskAttachmentSessionContentOperationOptions) (result GetTodoListTaskAttachmentSessionContentOperationResponse, err error) {
