...
func (c TodoListTaskChecklistItemClient) DeleteTodoListTaskChecklistItem(ctx context.Context, id beta.UserIdTodoListIdTaskIdChecklistItemId, options DeleteTodoListTaskChecklistItemOperationOptions) (result DeleteTodoListTaskChecklistItemOperationResponse, err error) {
