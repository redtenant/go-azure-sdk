...
// ListTodoListTaskChecklistItems - Get checklistItems from users. A collection of smaller subtasks linked to the more
// complex parent task.
func (c TodoListTaskChecklistItemClient) ListTodoListTaskChecklistItems(ctx context.Context, id beta.UserIdTodoListIdTaskId, options ListTodoListTaskChecklistItemsOperationOptions) (result ListTodoListTaskChecklistItemsOperationResponse, err error) {
...
func (c TodoListTaskChecklistItemClient) ListTodoListTaskChecklistItemsComplete(ctx context.Context, id beta.UserIdTodoListIdTaskId, options ListTodoListTaskChecklistItemsOperationOptions) (ListTodoListTaskChecklistItemsCompleteResult, error) {
...
func (c TodoListTaskChecklistItemClient) ListTodoListTaskChecklistItemsCompleteMatchingPredicate(ctx context.Context, id beta.UserIdTodoListIdTaskId, options ListTodoListTaskChecklistItemsOperationOptions, predicate ChecklistItemOperationPredicate) (result ListTodoListTaskChecklistItemsCompleteResult, err error) {
