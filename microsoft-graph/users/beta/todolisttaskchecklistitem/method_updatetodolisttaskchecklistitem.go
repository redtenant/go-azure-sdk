...
func (c TodoListTaskChecklistItemClient) UpdateTodoListTaskChecklistItem(ctx context.Context, id beta.UserIdTodoListIdTaskIdChecklistItemId, input beta.ChecklistItem, options UpdateTodoListTaskChecklistItemOperationOptions) (result UpdateTodoListTaskChecklistItemOperationResponse, err error) {
