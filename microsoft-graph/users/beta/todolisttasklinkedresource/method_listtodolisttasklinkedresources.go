...
func (c TodoListTaskLinkedResourceClient) ListTodoListTaskLinkedResources(ctx context.Context, id beta.UserIdTodoListIdTaskId, options ListTodoListTaskLinkedResourcesOperationOptions) (result ListTodoListTaskLinkedResourcesOperationResponse, err error) {
...
func (c TodoListTaskLinkedResourceClient) ListTodoListTaskLinkedResourcesComplete(ctx context.Context, id beta.UserIdTodoListIdTaskId, options ListTodoListTaskLinkedResourcesOperationOptions) (ListTodoListTaskLinkedResourcesCompleteResult, error) {
