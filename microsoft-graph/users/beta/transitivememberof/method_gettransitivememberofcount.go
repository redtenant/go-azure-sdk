...
func (c TransitiveMemberOfClient) GetTransitiveMemberOfCount(ctx context.Context, id beta.UserId, options GetTransitiveMemberOfCountOperationOptions) (result GetTransitiveMemberOfCountOperationResponse, err error) {
