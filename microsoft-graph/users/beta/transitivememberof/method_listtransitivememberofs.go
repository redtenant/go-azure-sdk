...
// ListTransitiveMemberOfs - List a user's memberships (direct and transitive). Get groups, directory roles, and
// administrative units that the user is a member of through either direct or transitive membership.
func (c TransitiveMemberOfClient) ListTransitiveMemberOfs(ctx context.Context, id beta.UserId, options ListTransitiveMemberOfsOperationOptions) (result ListTransitiveMemberOfsOperationResponse, err error) {
...
func (c TransitiveMemberOfClient) ListTransitiveMemberOfsComplete(ctx context.Context, id beta.UserId, options ListTransitiveMemberOfsOperationOptions) (ListTransitiveMemberOfsCompleteResult, error) {
...
func (c TransitiveMemberOfClient) ListTransitiveMemberOfsCompleteMatchingPredicate(ctx context.Context, id beta.UserId, options ListTransitiveMemberOfsOperationOptions, predicate DirectoryObjectOperationPredicate) (result ListTransitiveMemberOfsCompleteResult, err error) {
