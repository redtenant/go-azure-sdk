...
func DefaultDeleteUsageRightOperationOptions() DeleteUsageRightOperationOptions {
	return DeleteUsageRightOperationOptions{}
}
...
// DeleteUsageRight - Delete navigation property usageRights for users
func (c UsageRightClient) DeleteUsageRight(ctx context.Context, id beta.UserIdUsageRightId, options DeleteUsageRightOperationOptions) (result DeleteUsageRightOperationResponse, err error) {
