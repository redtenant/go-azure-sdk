...
func DefaultGetUsageRightOperationOptions() GetUsageRightOperationOptions {
	return GetUsageRightOperationOptions{}
}
...
// GetUsageRight - Get usageRights from users. Represents the usage rights a user has been granted.
func (c UsageRightClient) GetUsageRight(ctx context.Context, id beta.UserIdUsageRightId, options GetUsageRightOperationOptions) (result GetUsageRightOperationResponse, err error) {
