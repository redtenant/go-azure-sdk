...
func DefaultGetUsageRightsCountOperationOptions() GetUsageRightsCountOperationOptions {
	return GetUsageRightsCountOperationOptions{}
}
...
func (c UsageRightClient) GetUsageRightsCount(ctx context.Context, id beta.UserId, options GetUsageRightsCountOperationOptions) (result GetUsageRightsCountOperationResponse, err error) {
