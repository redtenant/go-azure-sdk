...
// DeleteVirtualEvent - Delete navigation property virtualEvents for users
func (c VirtualEventClient) DeleteVirtualEvent(ctx context.Context, id beta.UserId, options DeleteVirtualEventOperationOptions) (result DeleteVirtualEventOperationResponse, err error) {
