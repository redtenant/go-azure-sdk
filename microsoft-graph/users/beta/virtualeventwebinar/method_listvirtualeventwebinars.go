...
// ListVirtualEventWebinars - Get webinars from users
func (c VirtualEventWebinarClient) ListVirtualEventWebinars(ctx context.Context, id beta.UserId, options ListVirtualEventWebinarsOperationOptions) (result ListVirtualEventWebinarsOperationResponse, err error) {
	opts := client.RequestOptions{
		...
		Path:          fmt.Sprintf("%s/virtualEvents/webinars", id.ID()),
...
func (c VirtualEventWebinarClient) ListVirtualEventWebinarsComplete(ctx context.Context, id beta.UserId, options ListVirtualEventWebinarsOperationOptions) (ListVirtualEventWebinarsCompleteResult, error) {
	return c.ListVirtualEventWebinarsCompleteMatchingPredicate(ctx, id, options, VirtualEventWebinarOperationPredicate{})
}

// ListVirtualEventWebinarsCompleteMatchingPredicate retrieves all the results and then applies the predicate
func (c VirtualEventWebinarClient) ListVirtualEventWebinarsCompleteMatchingPredicate(ctx context.Context, id beta.UserId, options ListVirtualEventWebinarsOperationOptions, predicate VirtualEventWebinarOperationPredicate) (result ListVirtualEventWebinarsCompleteResult, err error) {
	items := make([]beta.VirtualEventWebinar, 0)

	resp, err := c.ListVirtualEventWebinars(ctx, id, options)
	if err != nil {
