...
// CreateActivity - Create new navigation property to activities for users
func (c ActivityClient) CreateActivity(ctx context.Context, id stable.UserId, input stable.UserActivity, options CreateActivityOperationOptions) (result CreateActivityOperationResponse, err error) {
