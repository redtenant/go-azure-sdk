...
func DefaultDeleteActivityOperationOptions() DeleteActivityOperationOptions {
	return DeleteActivityOperationOptions{}
}
...
// DeleteActivity - Delete navigation property activities for users
func (c ActivityClient) DeleteActivity(ctx context.Context, id stable.UserIdActivityId, options DeleteActivityOperationOptions) (result DeleteActivityOperationResponse, err error) {
