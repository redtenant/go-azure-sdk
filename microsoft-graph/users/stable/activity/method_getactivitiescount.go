...
func (c ActivityClient) GetActivitiesCount(ctx context.Context, id stable.UserId, options GetActivitiesCountOperationOptions) (result GetActivitiesCountOperationResponse, err error) {
