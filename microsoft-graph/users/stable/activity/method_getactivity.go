...
// GetActivity - Get activities from users. The user's activities across devices. Read-only. Nullable.
func (c ActivityClient) GetActivity(ctx context.Context, id stable.UserIdActivityId, options GetActivityOperationOptions) (result GetActivityOperationResponse, err error) {
