...
func (c ActivityHistoryItemClient) CreateActivityHistoryItem(ctx context.Context, id stable.UserIdActivityId, input stable.ActivityHistoryItem, options CreateActivityHistoryItemOperationOptions) (result CreateActivityHistoryItemOperationResponse, err error) {
