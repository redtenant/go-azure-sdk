...
// GetActivityHistoryItemActivity - Get activity from users. Optional. NavigationProperty/Containment; navigation
// property to the associated activity.
func (c ActivityHistoryItemActivityClient) GetActivityHistoryItemActivity(ctx context.Context, id stable.UserIdActivityIdHistoryItemId, options GetActivityHistoryItemActivityOperationOptions) (result GetActivityHistoryItemActivityOperationResponse, err error) {
