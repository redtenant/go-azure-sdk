...
// GetAgreementAcceptance - Get agreementAcceptances from users. The user's terms of use acceptance statuses. Read-only.
// Nullable.
func (c AgreementAcceptanceClient) GetAgreementAcceptance(ctx context.Context, id stable.UserIdAgreementAcceptanceId, options GetAgreementAcceptanceOperationOptions) (result GetAgreementAcceptanceOperationResponse, err error) {
