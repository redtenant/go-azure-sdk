...
func DefaultGetAgreementAcceptancesCountOperationOptions() GetAgreementAcceptancesCountOperationOptions {
	return GetAgreementAcceptancesCountOperationOptions{}
}
...
func (c AgreementAcceptanceClient) GetAgreementAcceptancesCount(ctx context.Context, id stable.UserId, options GetAgreementAcceptancesCountOperationOptions) (result GetAgreementAcceptancesCountOperationResponse, err error) {
	opts := client.RequestOptions{
		...
		Path:          fmt.Sprintf("%s/agreementAcceptances/$count", id.ID()),
