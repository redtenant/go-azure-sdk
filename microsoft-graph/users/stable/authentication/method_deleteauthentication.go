...
func DefaultDeleteAuthenticationOperationOptions() DeleteAuthenticationOperationOptions {
	return DeleteAuthenticationOperationOptions{}
}
...
func (c AuthenticationClient) DeleteAuthentication(ctx context.Context, id stable.UserId, options DeleteAuthenticationOperationOptions) (result DeleteAuthenticationOperationResponse, err error) {
