...
func (c AuthenticationClient) GetAuthentication(ctx context.Context, id stable.UserId, options GetAuthenticationOperationOptions) (result GetAuthenticationOperationResponse, err error) {
