...
func (c AuthenticationMicrosoftAuthenticatorMethodClient) DeleteAuthenticationMicrosoftAuthenticatorMethod(ctx context.Context, id stable.UserIdAuthenticationMicrosoftAuthenticatorMethodId, options DeleteAuthenticationMicrosoftAuthenticatorMethodOperationOptions) (result DeleteAuthenticationMicrosoftAuthenticatorMethodOperationResponse, err error) {
