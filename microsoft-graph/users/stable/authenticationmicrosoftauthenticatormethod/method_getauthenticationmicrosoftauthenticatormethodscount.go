...
type GetAuthenticationMicrosoftAuthenticatorMethodsCountOperationResponse struct {
	HttpResponse *http.Response
	OData        *odata.OData
	Model        *[]byte
}

type GetAuthenticationMicrosoftAuthenticatorMethodsCountOperationOptions struct {
	Filter    *string
...
func DefaultGetAuthenticationMicrosoftAuthenticatorMethodsCountOperationOptions() GetAuthenticationMicrosoftAuthenticatorMethodsCountOperationOptions {
	return GetAuthenticationMicrosoftAuthenticatorMethodsCountOperationOptions{}
}
...
func (c AuthenticationMicrosoftAuthenticatorMethodClient) GetAuthenticationMicrosoftAuthenticatorMethodsCount(ctx context.Context, id stable.UserId, options GetAuthenticationMicrosoftAuthenticatorMethodsCountOperationOptions) (result GetAuthenticationMicrosoftAuthenticatorMethodsCountOperationResponse, err error) {
	opts := client.RequestOptions{
		...
		Path:          fmt.Sprintf("%s/authentication/microsoftAuthenticatorMethods/$count", id.ID()),
