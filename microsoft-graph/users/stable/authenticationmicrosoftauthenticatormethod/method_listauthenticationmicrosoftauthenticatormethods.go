...
type ListAuthenticationMicrosoftAuthenticatorMethodsCompleteResult struct {
	...
	Items              []stable.MicrosoftAuthenticatorAuthenticationMethod
}
...
// ListAuthenticationMicrosoftAuthenticatorMethods - List microsoftAuthenticatorAuthenticationMethods. Get a list of the
// microsoftAuthenticatorAuthenticationMethod objects and their properties.
func (c AuthenticationMicrosoftAuthenticatorMethodClient) ListAuthenticationMicrosoftAuthenticatorMethods(ctx context.Context, id stable.UserId, options ListAuthenticationMicrosoftAuthenticatorMethodsOperationOptions) (result ListAuthenticationMicrosoftAuthenticatorMethodsOperationResponse, err error) {
	...
	var values struct {
		Values *[]stable.MicrosoftAuthenticatorAuthenticationMethod `json:"value"`
	}
...
func (c AuthenticationMicrosoftAuthenticatorMethodClient) ListAuthenticationMicrosoftAuthenticatorMethodsComplete(ctx context.Context, id stable.UserId, options ListAuthenticationMicrosoftAuthenticatorMethodsOperationOptions) (ListAuthenticationMicrosoftAuthenticatorMethodsCompleteResult, error) {
	return c.ListAuthenticationMicrosoftAuthenticatorMethodsCompleteMatchingPredicate(ctx, id, options, MicrosoftAuthenticatorAuthenticationMethodOperationPredicate{})
}
...
func (c AuthenticationMicrosoftAuthenticatorMethodClient) ListAuthenticationMicrosoftAuthenticatorMethodsCompleteMatchingPredicate(ctx context.Context, id stable.UserId, options ListAuthenticationMicrosoftAuthenticatorMethodsOperationOptions, predicate MicrosoftAuthenticatorAuthenticationMethodOperationPredicate) (result ListAuthenticationMicrosoftAuthenticatorMethodsCompleteResult, err error) {
	items := make([]stable.MicrosoftAuthenticatorAuthenticationMethod, 0)

	resp, err := c.ListAuthenticationMicrosoftAuthenticatorMethods(ctx, id, options)
	if err != nil {
