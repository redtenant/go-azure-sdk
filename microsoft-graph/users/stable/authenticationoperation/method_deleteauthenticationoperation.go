...
func (c AuthenticationOperationClient) DeleteAuthenticationOperation(ctx context.Context, id stable.UserIdAuthenticationOperationId, options DeleteAuthenticationOperationOperationOptions) (result DeleteAuthenticationOperationOperationResponse, err error) {
