...
func DefaultGetAuthenticationOperationsCountOperationOptions() GetAuthenticationOperationsCountOperationOptions {
	return GetAuthenticationOperationsCountOperationOptions{}
}
...
func (c AuthenticationOperationClient) GetAuthenticationOperationsCount(ctx context.Context, id stable.UserId, options GetAuthenticationOperationsCountOperationOptions) (result GetAuthenticationOperationsCountOperationResponse, err error) {
	opts := client.RequestOptions{
		...
		Path:          fmt.Sprintf("%s/authentication/operations/$count", id.ID()),
