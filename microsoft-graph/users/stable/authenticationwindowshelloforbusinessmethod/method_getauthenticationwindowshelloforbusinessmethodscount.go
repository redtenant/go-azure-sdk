...
func (c AuthenticationWindowsHelloForBusinessMethodClient) GetAuthenticationWindowsHelloForBusinessMethodsCount(ctx context.Context, id stable.UserId, options GetAuthenticationWindowsHelloForBusinessMethodsCountOperationOptions) (result GetAuthenticationWindowsHelloForBusinessMethodsCountOperationResponse, err error) {
