...
// ListAuthenticationWindowsHelloForBusinessMethods - List windowsHelloForBusinessAuthenticationMethods. Get a list of
// the windowsHelloForBusinessAuthenticationMethod objects and their properties.
func (c AuthenticationWindowsHelloForBusinessMethodClient) ListAuthenticationWindowsHelloForBusinessMethods(ctx context.Context, id stable.UserId, options ListAuthenticationWindowsHelloForBusinessMethodsOperationOptions) (result ListAuthenticationWindowsHelloForBusinessMethodsOperationResponse, err error) {
...
func (c AuthenticationWindowsHelloForBusinessMethodClient) ListAuthenticationWindowsHelloForBusinessMethodsComplete(ctx context.Context, id stable.UserId, options ListAuthenticationWindowsHelloForBusinessMethodsOperationOptions) (ListAuthenticationWindowsHelloForBusinessMethodsCompleteResult, error) {
	return c.ListAuthenticationWindowsHelloForBusinessMethodsCompleteMatchingPredicate(ctx, id, options, WindowsHelloForBusinessAuthenticationMethodOperationPredicate{})
}
