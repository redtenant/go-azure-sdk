...
func (c ChatClient) CreateChat(ctx context.Context, id stable.UserId, input stable.Chat, options CreateChatOperationOptions) (result CreateChatOperationResponse, err error) {
