...
func DefaultDeleteChatOperationOptions() DeleteChatOperationOptions {
	return DeleteChatOperationOptions{}
}
...
func (c ChatClient) DeleteChat(ctx context.Context, id stable.UserIdChatId, options DeleteChatOperationOptions) (result DeleteChatOperationResponse, err error) {
