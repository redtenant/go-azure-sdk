...
func (c ChatClient) GetChatsCount(ctx context.Context, id stable.UserId, options GetChatsCountOperationOptions) (result GetChatsCountOperationResponse, err error) {
	opts := client.RequestOptions{
		...
		Path:          fmt.Sprintf("%s/chats/$count", id.ID()),
