...
func (c ChatClient) HideChatForUser(ctx context.Context, id stable.UserIdChatId, input HideChatForUserRequest, options HideChatForUserOperationOptions) (result HideChatForUserOperationResponse, err error) {
