...
func (c ChatClient) ListChats(ctx context.Context, id stable.UserId, options ListChatsOperationOptions) (result ListChatsOperationResponse, err error) {
...
func (c ChatClient) ListChatsComplete(ctx context.Context, id stable.UserId, options ListChatsOperationOptions) (ListChatsCompleteResult, error) {
...
func (c ChatClient) ListChatsCompleteMatchingPredicate(ctx context.Context, id stable.UserId, options ListChatsOperationOptions, predicate ChatOperationPredicate) (result ListChatsCompleteResult, err error) {
	items := make([]stable.Chat, 0)
