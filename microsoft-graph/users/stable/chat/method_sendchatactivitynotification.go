...
// SendChatActivityNotification - Invoke action sendActivityNotification. Send an activity feed notification in scope of
// a chat. For more information about sending notifications and the requirements for doing so, see sending Teams
// activity notifications.
func (c ChatClient) SendChatActivityNotification(ctx context.Context, id stable.UserIdChatId, input SendChatActivityNotificationRequest, options SendChatActivityNotificationOperationOptions) (result SendChatActivityNotificationOperationResponse, err error) {
