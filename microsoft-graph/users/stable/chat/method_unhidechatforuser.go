...
func (c ChatClient) UnhideChatForUser(ctx context.Context, id stable.UserIdChatId, input UnhideChatForUserRequest, options UnhideChatForUserOperationOptions) (result UnhideChatForUserOperationResponse, err error) {
