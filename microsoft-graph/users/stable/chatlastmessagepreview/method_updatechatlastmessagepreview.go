...
func (c ChatLastMessagePreviewClient) UpdateChatLastMessagePreview(ctx context.Context, id stable.UserIdChatId, input stable.ChatMessageInfo, options UpdateChatLastMessagePreviewOperationOptions) (result UpdateChatLastMessagePreviewOperationResponse, err error) {
