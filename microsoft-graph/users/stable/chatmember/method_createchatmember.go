...
func DefaultCreateChatMemberOperationOptions() CreateChatMemberOperationOptions {
	return CreateChatMemberOperationOptions{}
}
...
// CreateChatMember - Create new navigation property to members for users
func (c ChatMemberClient) CreateChatMember(ctx context.Context, id stable.UserIdChatId, input stable.ConversationMember, options CreateChatMemberOperationOptions) (result CreateChatMemberOperationResponse, err error) {
