...
func DefaultDeleteChatMemberOperationOptions() DeleteChatMemberOperationOptions {
	return DeleteChatMemberOperationOptions{}
}
...
// DeleteChatMember - Delete navigation property members for users
func (c ChatMemberClient) DeleteChatMember(ctx context.Context, id stable.UserIdChatIdMemberId, options DeleteChatMemberOperationOptions) (result DeleteChatMemberOperationResponse, err error) {
