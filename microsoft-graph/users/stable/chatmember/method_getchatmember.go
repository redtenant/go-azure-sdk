...
func DefaultGetChatMemberOperationOptions() GetChatMemberOperationOptions {
	return GetChatMemberOperationOptions{}
}
...
// GetChatMember - Get members from users. A collection of all the members in the chat. Nullable.
func (c ChatMemberClient) GetChatMember(ctx context.Context, id stable.UserIdChatIdMemberId, options GetChatMemberOperationOptions) (result GetChatMemberOperationResponse, err error) {
