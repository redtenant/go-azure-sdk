...
func DefaultGetChatMembersCountOperationOptions() GetChatMembersCountOperationOptions {
	return GetChatMembersCountOperationOptions{}
}
...
func (c ChatMemberClient) GetChatMembersCount(ctx context.Context, id stable.UserIdChatId, options GetChatMembersCountOperationOptions) (result GetChatMembersCountOperationResponse, err error) {
