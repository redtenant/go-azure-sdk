...
// ListChatMembers - Get members from users. A collection of all the members in the chat. Nullable.
func (c ChatMemberClient) ListChatMembers(ctx context.Context, id stable.UserIdChatId, options ListChatMembersOperationOptions) (result ListChatMembersOperationResponse, err error) {
...
func (c ChatMemberClient) ListChatMembersComplete(ctx context.Context, id stable.UserIdChatId, options ListChatMembersOperationOptions) (ListChatMembersCompleteResult, error) {
...
func (c ChatMemberClient) ListChatMembersCompleteMatchingPredicate(ctx context.Context, id stable.UserIdChatId, options ListChatMembersOperationOptions, predicate ConversationMemberOperationPredicate) (result ListChatMembersCompleteResult, err error) {
