...
func (c ChatMessageClient) CreateChatMessageUndoSoftDelete(ctx context.Context, id stable.UserIdChatIdMessageId, options CreateChatMessageUndoSoftDeleteOperationOptions) (result CreateChatMessageUndoSoftDeleteOperationResponse, err error) {
