...
func (c ChatMessageClient) GetChatMessage(ctx context.Context, id stable.UserIdChatIdMessageId, options GetChatMessageOperationOptions) (result GetChatMessageOperationResponse, err error) {
