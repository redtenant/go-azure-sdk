...
func DefaultGetChatMessagesCountOperationOptions() GetChatMessagesCountOperationOptions {
	return GetChatMessagesCountOperationOptions{}
}
...
func (c ChatMessageClient) GetChatMessagesCount(ctx context.Context, id stable.UserIdChatId, options GetChatMessagesCountOperationOptions) (result GetChatMessagesCountOperationResponse, err error) {
