...
func (c ChatMessageClient) ListChatMessages(ctx context.Context, id stable.UserIdChatId, options ListChatMessagesOperationOptions) (result ListChatMessagesOperationResponse, err error) {
...
func (c ChatMessageClient) ListChatMessagesComplete(ctx context.Context, id stable.UserIdChatId, options ListChatMessagesOperationOptions) (ListChatMessagesCompleteResult, error) {
