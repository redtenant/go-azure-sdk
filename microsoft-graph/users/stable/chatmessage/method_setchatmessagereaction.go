...
func (c ChatMessageClient) SetChatMessageReaction(ctx context.Context, id stable.UserIdChatIdMessageId, input SetChatMessageReactionRequest, options SetChatMessageReactionOperationOptions) (result SetChatMessageReactionOperationResponse, err error) {
