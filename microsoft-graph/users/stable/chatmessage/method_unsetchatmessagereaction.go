...
func DefaultUnsetChatMessageReactionOperationOptions() UnsetChatMessageReactionOperationOptions {
	return UnsetChatMessageReactionOperationOptions{}
}
...
func (c ChatMessageClient) UnsetChatMessageReaction(ctx context.Context, id stable.UserIdChatIdMessageId, input UnsetChatMessageReactionRequest, options UnsetChatMessageReactionOperationOptions) (result UnsetChatMessageReactionOperationResponse, err error) {
