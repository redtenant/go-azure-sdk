...
func (c ChatMessageClient) UpdateChatMessage(ctx context.Context, id stable.UserIdChatIdMessageId, input stable.ChatMessage, options UpdateChatMessageOperationOptions) (result UpdateChatMessageOperationResponse, err error) {
