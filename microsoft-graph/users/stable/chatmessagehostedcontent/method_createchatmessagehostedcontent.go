...
// CreateChatMessageHostedContent - Create new navigation property to hostedContents for users
func (c ChatMessageHostedContentClient) CreateChatMessageHostedContent(ctx context.Context, id stable.UserIdChatIdMessageId, input stable.ChatMessageHostedContent, options CreateChatMessageHostedContentOperationOptions) (result CreateChatMessageHostedContentOperationResponse, err error) {
