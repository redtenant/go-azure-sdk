...
// ListChatMessageHostedContents - Get hostedContents from users. Content in a message hosted by Microsoft Teams - for
// example, images or code snippets.
func (c ChatMessageHostedContentClient) ListChatMessageHostedContents(ctx context.Context, id stable.UserIdChatIdMessageId, options ListChatMessageHostedContentsOperationOptions) (result ListChatMessageHostedContentsOperationResponse, err error) {
...
func (c ChatMessageHostedContentClient) ListChatMessageHostedContentsComplete(ctx context.Context, id stable.UserIdChatIdMessageId, options ListChatMessageHostedContentsOperationOptions) (ListChatMessageHostedContentsCompleteResult, error) {
...
func (c ChatMessageHostedContentClient) ListChatMessageHostedContentsCompleteMatchingPredicate(ctx context.Context, id stable.UserIdChatIdMessageId, options ListChatMessageHostedContentsOperationOptions, predicate ChatMessageHostedContentOperationPredicate) (result ListChatMessageHostedContentsCompleteResult, err error) {
