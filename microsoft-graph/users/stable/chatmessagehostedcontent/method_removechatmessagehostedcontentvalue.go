...
// RemoveChatMessageHostedContentValue - Delete media content for the navigation property hostedContents in users. The
// unique identifier for an entity. Read-only.
func (c ChatMessageHostedContentClient) RemoveChatMessageHostedContentValue(ctx context.Context, id stable.UserIdChatIdMessageIdHostedContentId, options RemoveChatMessageHostedContentValueOperationOptions) (result RemoveChatMessageHostedContentValueOperationResponse, err error) {
