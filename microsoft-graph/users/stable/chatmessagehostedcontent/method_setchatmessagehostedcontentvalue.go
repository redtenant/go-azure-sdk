...
// SetChatMessageHostedContentValue - Update media content for the navigation property hostedContents in users. The
// unique identifier for an entity. Read-only.
func (c ChatMessageHostedContentClient) SetChatMessageHostedContentValue(ctx context.Context, id stable.UserIdChatIdMessageIdHostedContentId, input []byte, options SetChatMessageHostedContentValueOperationOptions) (result SetChatMessageHostedContentValueOperationResponse, err error) {
