...
type UpdateChatMessageHostedContentOperationResponse struct {
...
// UpdateChatMessageHostedContent - Update the navigation property hostedContents in users
func (c ChatMessageHostedContentClient) UpdateChatMessageHostedContent(ctx context.Context, id stable.UserIdChatIdMessageIdHostedContentId, input stable.ChatMessageHostedContent, options UpdateChatMessageHostedContentOperationOptions) (result UpdateChatMessageHostedContentOperationResponse, err error) {
