...
func DefaultDeleteChatMessageReplyOperationOptions() DeleteChatMessageReplyOperationOptions {
	return DeleteChatMessageReplyOperationOptions{}
}
...
// DeleteChatMessageReply - Delete navigation property replies for users
func (c ChatMessageReplyClient) DeleteChatMessageReply(ctx context.Context, id stable.UserIdChatIdMessageIdReplyId, options DeleteChatMessageReplyOperationOptions) (result DeleteChatMessageReplyOperationResponse, err error) {
