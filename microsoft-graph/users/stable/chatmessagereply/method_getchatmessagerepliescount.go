...
func DefaultGetChatMessageRepliesCountOperationOptions() GetChatMessageRepliesCountOperationOptions {
	return GetChatMessageRepliesCountOperationOptions{}
}
...
func (c ChatMessageReplyClient) GetChatMessageRepliesCount(ctx context.Context, id stable.UserIdChatIdMessageId, options GetChatMessageRepliesCountOperationOptions) (result GetChatMessageRepliesCountOperationResponse, err error) {
