...
func (c ChatMessageReplyClient) SetChatMessageReplyReaction(ctx context.Context, id stable.UserIdChatIdMessageIdReplyId, input SetChatMessageReplyReactionRequest, options SetChatMessageReplyReactionOperationOptions) (result SetChatMessageReplyReactionOperationResponse, err error) {
