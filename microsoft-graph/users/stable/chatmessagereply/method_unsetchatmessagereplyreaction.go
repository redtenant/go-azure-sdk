...
func (c ChatMessageReplyClient) UnsetChatMessageReplyReaction(ctx context.Context, id stable.UserIdChatIdMessageIdReplyId, input UnsetChatMessageReplyReactionRequest, options UnsetChatMessageReplyReactionOperationOptions) (result UnsetChatMessageReplyReactionOperationResponse, err error) {
