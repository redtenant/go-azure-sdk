...
// ListChatMessageReplyHostedContents - Get hostedContents from users. Content in a message hosted by Microsoft Teams -
// for example, images or code snippets.
func (c ChatMessageReplyHostedContentClient) ListChatMessageReplyHostedContents(ctx context.Context, id stable.UserIdChatIdMessageIdReplyId, options ListChatMessageReplyHostedContentsOperationOptions) (result ListChatMessageReplyHostedContentsOperationResponse, err error) {
...
func (c ChatMessageReplyHostedContentClient) ListChatMessageReplyHostedContentsComplete(ctx context.Context, id stable.UserIdChatIdMessageIdReplyId, options ListChatMessageReplyHostedContentsOperationOptions) (ListChatMessageReplyHostedContentsCompleteResult, error) {
...
func (c ChatMessageReplyHostedContentClient) ListChatMessageReplyHostedContentsCompleteMatchingPredicate(ctx context.Context, id stable.UserIdChatIdMessageIdReplyId, options ListChatMessageReplyHostedContentsOperationOptions, predicate ChatMessageHostedContentOperationPredicate) (result ListChatMessageReplyHostedContentsCompleteResult, err error) {
