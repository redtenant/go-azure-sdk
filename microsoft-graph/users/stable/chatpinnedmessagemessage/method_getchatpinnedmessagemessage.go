...
func (c ChatPinnedMessageMessageClient) GetChatPinnedMessageMessage(ctx context.Context, id stable.UserIdChatIdPinnedMessageId, options GetChatPinnedMessageMessageOperationOptions) (result GetChatPinnedMessageMessageOperationResponse, err error) {
