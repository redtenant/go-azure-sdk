...
func (c ChatTabClient) DeleteChatTab(ctx context.Context, id stable.UserIdChatIdTabId, options DeleteChatTabOperationOptions) (result DeleteChatTabOperationResponse, err error) {
