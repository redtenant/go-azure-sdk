...
func (c ChatTabClient) GetChatTab(ctx context.Context, id stable.UserIdChatIdTabId, options GetChatTabOperationOptions) (result GetChatTabOperationResponse, err error) {
