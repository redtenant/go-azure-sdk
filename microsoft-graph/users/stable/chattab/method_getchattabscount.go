...
func DefaultGetChatTabsCountOperationOptions() GetChatTabsCountOperationOptions {
	return GetChatTabsCountOperationOptions{}
}
...
func (c ChatTabClient) GetChatTabsCount(ctx context.Context, id stable.UserIdChatId, options GetChatTabsCountOperationOptions) (result GetChatTabsCountOperationResponse, err error) {
