...
func (c ChatTabClient) UpdateChatTab(ctx context.Context, id stable.UserIdChatIdTabId, input stable.TeamsTab, options UpdateChatTabOperationOptions) (result UpdateChatTabOperationResponse, err error) {
