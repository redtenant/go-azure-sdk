...
// GetChatTabTeamsApp - Get teamsApp from users. The application that is linked to the tab. This can't be changed after
// tab creation.
func (c ChatTabTeamsAppClient) GetChatTabTeamsApp(ctx context.Context, id stable.UserIdChatIdTabId, options GetChatTabTeamsAppOperationOptions) (result GetChatTabTeamsAppOperationResponse, err error) {
