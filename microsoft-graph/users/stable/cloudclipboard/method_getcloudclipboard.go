...
func (c CloudClipboardClient) GetCloudClipboard(ctx context.Context, id stable.UserId, options GetCloudClipboardOperationOptions) (result GetCloudClipboardOperationResponse, err error) {
