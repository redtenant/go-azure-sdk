...
func DefaultDeleteContactOperationOptions() DeleteContactOperationOptions {
	return DeleteContactOperationOptions{}
}
...
func (c ContactClient) DeleteContact(ctx context.Context, id stable.UserIdContactId, options DeleteContactOperationOptions) (result DeleteContactOperationResponse, err error) {
