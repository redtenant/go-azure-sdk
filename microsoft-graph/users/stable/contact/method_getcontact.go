...
func (c ContactClient) GetContact(ctx context.Context, id stable.UserIdContactId, options GetContactOperationOptions) (result GetContactOperationResponse, err error) {
