...
func (c ContactClient) ListContacts(ctx context.Context, id stable.UserId, options ListContactsOperationOptions) (result ListContactsOperationResponse, err error) {
...
func (c ContactClient) ListContactsComplete(ctx context.Context, id stable.UserId, options ListContactsOperationOptions) (ListContactsCompleteResult, error) {
...
func (c ContactClient) ListContactsCompleteMatchingPredicate(ctx context.Context, id stable.UserId, options ListContactsOperationOptions, predicate ContactOperationPredicate) (result ListContactsCompleteResult, err error) {
