...
// DeleteContactExtension - Delete navigation property extensions for users
func (c ContactExtensionClient) DeleteContactExtension(ctx context.Context, id stable.UserIdContactIdExtensionId, options DeleteContactExtensionOperationOptions) (result DeleteContactExtensionOperationResponse, err error) {
