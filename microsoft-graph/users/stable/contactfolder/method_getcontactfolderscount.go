...
func (c ContactFolderClient) GetContactFoldersCount(ctx context.Context, id stable.UserId, options GetContactFoldersCountOperationOptions) (result GetContactFoldersCountOperationResponse, err error) {
	opts := client.RequestOptions{
		...
		Path:          fmt.Sprintf("%s/contactFolders/$count", id.ID()),
