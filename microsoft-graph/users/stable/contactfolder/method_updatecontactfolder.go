...
func (c ContactFolderClient) UpdateContactFolder(ctx context.Context, id stable.UserIdContactFolderId, input stable.ContactFolder, options UpdateContactFolderOperationOptions) (result UpdateContactFolderOperationResponse, err error) {
