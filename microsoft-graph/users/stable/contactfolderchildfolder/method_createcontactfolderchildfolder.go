...
func (c ContactFolderChildFolderClient) CreateContactFolderChildFolder(ctx context.Context, id stable.UserIdContactFolderId, input stable.ContactFolder, options CreateContactFolderChildFolderOperationOptions) (result CreateContactFolderChildFolderOperationResponse, err error) {
