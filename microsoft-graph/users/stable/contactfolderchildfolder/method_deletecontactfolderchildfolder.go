...
func DefaultDeleteContactFolderChildFolderOperationOptions() DeleteContactFolderChildFolderOperationOptions {
	return DeleteContactFolderChildFolderOperationOptions{}
}
...
func (c ContactFolderChildFolderClient) DeleteContactFolderChildFolder(ctx context.Context, id stable.UserIdContactFolderIdChildFolderId, options DeleteContactFolderChildFolderOperationOptions) (result DeleteContactFolderChildFolderOperationResponse, err error) {
