...
func (c ContactFolderChildFolderClient) GetContactFolderChildFolder(ctx context.Context, id stable.UserIdContactFolderIdChildFolderId, options GetContactFolderChildFolderOperationOptions) (result GetContactFolderChildFolderOperationResponse, err error) {
