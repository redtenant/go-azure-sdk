...
func (c ContactFolderChildFolderClient) UpdateContactFolderChildFolder(ctx context.Context, id stable.UserIdContactFolderIdChildFolderId, input stable.ContactFolder, options UpdateContactFolderChildFolderOperationOptions) (result UpdateContactFolderChildFolderOperationResponse, err error) {
