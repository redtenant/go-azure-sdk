...
func DefaultDeleteContactFolderChildFolderContactOperationOptions() DeleteContactFolderChildFolderContactOperationOptions {
	return DeleteContactFolderChildFolderContactOperationOptions{}
}
...
// DeleteContactFolderChildFolderContact - Delete navigation property contacts for users
func (c ContactFolderChildFolderContactClient) DeleteContactFolderChildFolderContact(ctx context.Context, id stable.UserIdContactFolderIdChildFolderIdContactId, options DeleteContactFolderChildFolderContactOperationOptions) (result DeleteContactFolderChildFolderContactOperationResponse, err error) {
