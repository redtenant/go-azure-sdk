...
func DefaultGetContactFolderChildFolderContactsCountOperationOptions() GetContactFolderChildFolderContactsCountOperationOptions {
	return GetContactFolderChildFolderContactsCountOperationOptions{}
}
...
func (c ContactFolderChildFolderContactClient) GetContactFolderChildFolderContactsCount(ctx context.Context, id stable.UserIdContactFolderIdChildFolderId, options GetContactFolderChildFolderContactsCountOperationOptions) (result GetContactFolderChildFolderContactsCountOperationResponse, err error) {
