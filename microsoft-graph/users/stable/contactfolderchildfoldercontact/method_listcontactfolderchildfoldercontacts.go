...
// Read-only. Nullable.
func (c ContactFolderChildFolderContactClient) ListContactFolderChildFolderContacts(ctx context.Context, id stable.UserIdContactFolderIdChildFolderId, options ListContactFolderChildFolderContactsOperationOptions) (result ListContactFolderChildFolderContactsOperationResponse, err error) {
...
func (c ContactFolderChildFolderContactClient) ListContactFolderChildFolderContactsComplete(ctx context.Context, id stable.UserIdContactFolderIdChildFolderId, options ListContactFolderChildFolderContactsOperationOptions) (ListContactFolderChildFolderContactsCompleteResult, error) {
