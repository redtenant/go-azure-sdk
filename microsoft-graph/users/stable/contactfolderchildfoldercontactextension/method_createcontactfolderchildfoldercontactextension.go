...
func (c ContactFolderChildFolderContactExtensionClient) CreateContactFolderChildFolderContactExtension(ctx context.Context, id stable.UserIdContactFolderIdChildFolderIdContactId, input stable.Extension, options CreateContactFolderChildFolderContactExtensionOperationOptions) (result CreateContactFolderChildFolderContactExtensionOperationResponse, err error) {
