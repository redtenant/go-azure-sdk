...
// DeleteContactFolderChildFolderContactExtension - Delete navigation property extensions for users
func (c ContactFolderChildFolderContactExtensionClient) DeleteContactFolderChildFolderContactExtension(ctx context.Context, id stable.UserIdContactFolderIdChildFolderIdContactIdExtensionId, options DeleteContactFolderChildFolderContactExtensionOperationOptions) (result DeleteContactFolderChildFolderContactExtensionOperationResponse, err error) {
