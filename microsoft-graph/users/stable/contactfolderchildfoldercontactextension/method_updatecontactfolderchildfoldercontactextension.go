...
func (c ContactFolderChildFolderContactExtensionClient) UpdateContactFolderChildFolderContactExtension(ctx context.Context, id stable.UserIdContactFolderIdChildFolderIdContactIdExtensionId, input stable.Extension, options UpdateContactFolderChildFolderContactExtensionOperationOptions) (result UpdateContactFolderChildFolderContactExtensionOperationResponse, err error) {
