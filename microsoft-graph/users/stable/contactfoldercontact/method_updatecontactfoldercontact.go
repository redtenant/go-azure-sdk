...
func (c ContactFolderContactClient) UpdateContactFolderContact(ctx context.Context, id stable.UserIdContactFolderIdContactId, input stable.Contact, options UpdateContactFolderContactOperationOptions) (result UpdateContactFolderContactOperationResponse, err error) {
