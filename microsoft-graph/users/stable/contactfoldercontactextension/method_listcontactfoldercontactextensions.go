...
// ListContactFolderContactExtensions - Get extensions from users. The collection of open extensions defined for the
// contact. Read-only. Nullable.
func (c ContactFolderContactExtensionClient) ListContactFolderContactExtensions(ctx context.Context, id stable.UserIdContactFolderIdContactId, options ListContactFolderContactExtensionsOperationOptions) (result ListContactFolderContactExtensionsOperationResponse, err error) {
...
func (c ContactFolderContactExtensionClient) ListContactFolderContactExtensionsComplete(ctx context.Context, id stable.UserIdContactFolderIdContactId, options ListContactFolderContactExtensionsOperationOptions) (ListContactFolderContactExtensionsCompleteResult, error) {
...
func (c ContactFolderContactExtensionClient) ListContactFolderContactExtensionsCompleteMatchingPredicate(ctx context.Context, id stable.UserIdContactFolderIdContactId, options ListContactFolderContactExtensionsOperationOptions, predicate ExtensionOperationPredicate) (result ListContactFolderContactExtensionsCompleteResult, err error) {
