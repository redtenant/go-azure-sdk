...
func (c ContactFolderContactPhotoClient) GetContactFolderContactPhotoValue(ctx context.Context, id stable.UserIdContactFolderIdContactId, options GetContactFolderContactPhotoValueOperationOptions) (result GetContactFolderContactPhotoValueOperationResponse, err error) {
