...
// RemoveContactFolderContactPhotoValue - Delete media content for the navigation property photo in users. Optional
// contact picture. You can get or set a photo for a contact.
func (c ContactFolderContactPhotoClient) RemoveContactFolderContactPhotoValue(ctx context.Context, id stable.UserIdContactFolderIdContactId, options RemoveContactFolderContactPhotoValueOperationOptions) (result RemoveContactFolderContactPhotoValueOperationResponse, err error) {
