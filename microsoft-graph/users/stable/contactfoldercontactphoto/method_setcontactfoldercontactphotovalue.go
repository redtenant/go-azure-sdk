...
func (c ContactFolderContactPhotoClient) SetContactFolderContactPhotoValue(ctx context.Context, id stable.UserIdContactFolderIdContactId, input []byte, options SetContactFolderContactPhotoValueOperationOptions) (result SetContactFolderContactPhotoValueOperationResponse, err error) {
