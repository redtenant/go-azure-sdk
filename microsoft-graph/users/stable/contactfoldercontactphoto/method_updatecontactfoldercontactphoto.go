...
// UpdateContactFolderContactPhoto - Update the navigation property photo in users
func (c ContactFolderContactPhotoClient) UpdateContactFolderContactPhoto(ctx context.Context, id stable.UserIdContactFolderIdContactId, input stable.ProfilePhoto, options UpdateContactFolderContactPhotoOperationOptions) (result UpdateContactFolderContactPhotoOperationResponse, err error) {
