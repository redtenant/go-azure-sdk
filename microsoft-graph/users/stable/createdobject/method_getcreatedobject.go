...
// GetCreatedObject - Get createdObjects from users. Directory objects that the user created. Read-only. Nullable.
func (c CreatedObjectClient) GetCreatedObject(ctx context.Context, id stable.UserIdCreatedObjectId, options GetCreatedObjectOperationOptions) (result GetCreatedObjectOperationResponse, err error) {
