...
// ListCreatedObjects - Get createdObjects from users. Directory objects that the user created. Read-only. Nullable.
func (c CreatedObjectClient) ListCreatedObjects(ctx context.Context, id stable.UserId, options ListCreatedObjectsOperationOptions) (result ListCreatedObjectsOperationResponse, err error) {
...
func (c CreatedObjectClient) ListCreatedObjectsComplete(ctx context.Context, id stable.UserId, options ListCreatedObjectsOperationOptions) (ListCreatedObjectsCompleteResult, error) {
...
func (c CreatedObjectClient) ListCreatedObjectsCompleteMatchingPredicate(ctx context.Context, id stable.UserId, options ListCreatedObjectsOperationOptions, predicate DirectoryObjectOperationPredicate) (result ListCreatedObjectsCompleteResult, err error) {
