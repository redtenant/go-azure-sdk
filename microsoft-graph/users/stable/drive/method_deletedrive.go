...
// DeleteDrive - Delete navigation property drives for users
func (c DriveClient) DeleteDrive(ctx context.Context, id stable.UserIdDriveId, options DeleteDriveOperationOptions) (result DeleteDriveOperationResponse, err error) {
