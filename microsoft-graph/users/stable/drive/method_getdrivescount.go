...
func (c DriveClient) GetDrivesCount(ctx context.Context, id stable.UserId, options GetDrivesCountOperationOptions) (result GetDrivesCountOperationResponse, err error) {
