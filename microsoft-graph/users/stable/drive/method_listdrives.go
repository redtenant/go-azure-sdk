...
// ListDrives - Get drives from users. A collection of drives available for this user. Read-only.
func (c DriveClient) ListDrives(ctx context.Context, id stable.UserId, options ListDrivesOperationOptions) (result ListDrivesOperationResponse, err error) {
...
func (c DriveClient) ListDrivesComplete(ctx context.Context, id stable.UserId, options ListDrivesOperationOptions) (ListDrivesCompleteResult, error) {
...
func (c DriveClient) ListDrivesCompleteMatchingPredicate(ctx context.Context, id stable.UserId, options ListDrivesOperationOptions, predicate DriveOperationPredicate) (result ListDrivesCompleteResult, err error) {
