...
// UpdateDrive - Update the navigation property drives in users
func (c DriveClient) UpdateDrive(ctx context.Context, id stable.UserIdDriveId, input stable.Drive, options UpdateDriveOperationOptions) (result UpdateDriveOperationResponse, err error) {
