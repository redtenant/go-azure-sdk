...
// GetDriveBundleContent - Get content for the navigation property bundles from users. The content stream, if the item
// represents a file.
func (c DriveBundleContentClient) GetDriveBundleContent(ctx context.Context, id stable.UserIdDriveIdBundleId, options GetDriveBundleContentOperationOptions) (result GetDriveBundleContentOperationResponse, err error) {
