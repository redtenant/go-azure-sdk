...
func (c DriveCreatedByUserMailboxSettingClient) UpdateDriveCreatedByUserMailboxSetting(ctx context.Context, id stable.UserIdDriveId, input stable.MailboxSettings, options UpdateDriveCreatedByUserMailboxSettingOperationOptions) (result UpdateDriveCreatedByUserMailboxSettingOperationResponse, err error) {
