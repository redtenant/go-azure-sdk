...
func (c DriveCreatedByUserServiceProvisioningErrorClient) ListDriveCreatedByUserServiceProvisioningErrorsComplete(ctx context.Context, id stable.UserIdDriveId, options ListDriveCreatedByUserServiceProvisioningErrorsOperationOptions) (ListDriveCreatedByUserServiceProvisioningErrorsCompleteResult, error) {
...
func (c DriveCreatedByUserServiceProvisioningErrorClient) ListDriveCreatedByUserServiceProvisioningErrorsCompleteMatchingPredicate(ctx context.Context, id stable.UserIdDriveId, options ListDriveCreatedByUserServiceProvisioningErrorsOperationOptions, predicate ServiceProvisioningErrorOperationPredicate) (result ListDriveCreatedByUserServiceProvisioningErrorsCompleteResult, err error) {
