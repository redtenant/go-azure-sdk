...
func DefaultGetDriveFollowingOperationOptions() GetDriveFollowingOperationOptions {
	return GetDriveFollowingOperationOptions{}
}
...
// GetDriveFollowing - Get following from users. The list of items the user is following. Only in OneDrive for Business.
func (c DriveFollowingClient) GetDriveFollowing(ctx context.Context, id stable.UserIdDriveIdFollowingId, options GetDriveFollowingOperationOptions) (result GetDriveFollowingOperationResponse, err error) {
