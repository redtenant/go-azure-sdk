...
func (c DriveFollowingContentClient) DeleteDriveFollowingContent(ctx context.Context, id stable.UserIdDriveIdFollowingId, options DeleteDriveFollowingContentOperationOptions) (result DeleteDriveFollowingContentOperationResponse, err error) {
