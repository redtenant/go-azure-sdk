...
// SetDriveFollowingContent - Update content for the navigation property following in users. The content stream, if the
// item represents a file.
func (c DriveFollowingContentClient) SetDriveFollowingContent(ctx context.Context, id stable.UserIdDriveIdFollowingId, input []byte, options SetDriveFollowingContentOperationOptions) (result SetDriveFollowingContentOperationResponse, err error) {
