...
func (c DriveItemClient) CheckoutDriveItem(ctx context.Context, id stable.UserIdDriveIdItemId, options CheckoutDriveItemOperationOptions) (result CheckoutDriveItemOperationResponse, err error) {
