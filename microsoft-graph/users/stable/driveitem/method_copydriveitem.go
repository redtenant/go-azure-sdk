...
func (c DriveItemClient) CopyDriveItem(ctx context.Context, id stable.UserIdDriveIdItemId, input CopyDriveItemRequest, options CopyDriveItemOperationOptions) (result CopyDriveItemOperationResponse, err error) {
