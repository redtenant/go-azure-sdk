...
func (c DriveItemClient) CreateDriveItem(ctx context.Context, id stable.UserIdDriveId, input stable.DriveItem, options CreateDriveItemOperationOptions) (result CreateDriveItemOperationResponse, err error) {
