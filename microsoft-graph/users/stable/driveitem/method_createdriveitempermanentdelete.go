...
func (c DriveItemClient) CreateDriveItemPermanentDelete(ctx context.Context, id stable.UserIdDriveIdItemId, options CreateDriveItemPermanentDeleteOperationOptions) (result CreateDriveItemPermanentDeleteOperationResponse, err error) {
