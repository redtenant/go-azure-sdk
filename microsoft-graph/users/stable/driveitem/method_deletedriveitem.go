...
func (c DriveItemClient) DeleteDriveItem(ctx context.Context, id stable.UserIdDriveIdItemId, options DeleteDriveItemOperationOptions) (result DeleteDriveItemOperationResponse, err error) {
