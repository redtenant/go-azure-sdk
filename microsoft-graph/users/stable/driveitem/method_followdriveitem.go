...
func (c DriveItemClient) FollowDriveItem(ctx context.Context, id stable.UserIdDriveIdItemId, options FollowDriveItemOperationOptions) (result FollowDriveItemOperationResponse, err error) {
