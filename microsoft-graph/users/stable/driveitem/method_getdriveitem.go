...
func (c DriveItemClient) GetDriveItem(ctx context.Context, id stable.UserIdDriveIdItemId, options GetDriveItemOperationOptions) (result GetDriveItemOperationResponse, err error) {
