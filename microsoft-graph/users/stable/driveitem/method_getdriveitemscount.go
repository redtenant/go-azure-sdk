...
func (c DriveItemClient) GetDriveItemsCount(ctx context.Context, id stable.UserIdDriveId, options GetDriveItemsCountOperationOptions) (result GetDriveItemsCountOperationResponse, err error) {
