...
func (c DriveItemClient) ListDriveItems(ctx context.Context, id stable.UserIdDriveId, options ListDriveItemsOperationOptions) (result ListDriveItemsOperationResponse, err error) {
...
func (c DriveItemClient) ListDriveItemsComplete(ctx context.Context, id stable.UserIdDriveId, options ListDriveItemsOperationOptions) (ListDriveItemsCompleteResult, error) {
