...
func (c DriveItemClient) RestoreDriveItem(ctx context.Context, id stable.UserIdDriveIdItemId, input RestoreDriveItemRequest, options RestoreDriveItemOperationOptions) (result RestoreDriveItemOperationResponse, err error) {
