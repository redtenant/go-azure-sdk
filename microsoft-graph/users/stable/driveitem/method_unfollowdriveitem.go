...
func (c DriveItemClient) UnfollowDriveItem(ctx context.Context, id stable.UserIdDriveIdItemId, options UnfollowDriveItemOperationOptions) (result UnfollowDriveItemOperationResponse, err error) {
