...
func (c DriveItemClient) UpdateDriveItem(ctx context.Context, id stable.UserIdDriveIdItemId, input stable.DriveItem, options UpdateDriveItemOperationOptions) (result UpdateDriveItemOperationResponse, err error) {
