...
type UpdateDriveItemAnalyticOperationResponse struct {
...
// UpdateDriveItemAnalytic - Update the navigation property analytics in users
func (c DriveItemAnalyticsClient) UpdateDriveItemAnalytic(ctx context.Context, id stable.UserIdDriveIdItemId, input stable.ItemAnalytics, options UpdateDriveItemAnalyticOperationOptions) (result UpdateDriveItemAnalyticOperationResponse, err error) {
