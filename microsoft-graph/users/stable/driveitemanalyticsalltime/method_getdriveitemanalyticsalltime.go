...
// GetDriveItemAnalyticsAllTime - Get allTime from users
func (c DriveItemAnalyticsAllTimeClient) GetDriveItemAnalyticsAllTime(ctx context.Context, id stable.UserIdDriveIdItemId, options GetDriveItemAnalyticsAllTimeOperationOptions) (result GetDriveItemAnalyticsAllTimeOperationResponse, err error) {
