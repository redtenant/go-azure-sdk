...
// CreateDriveItemAnalyticsItemActivityStat - Create new navigation property to itemActivityStats for users
func (c DriveItemAnalyticsItemActivityStatClient) CreateDriveItemAnalyticsItemActivityStat(ctx context.Context, id stable.UserIdDriveIdItemId, input stable.ItemActivityStat, options CreateDriveItemAnalyticsItemActivityStatOperationOptions) (result CreateDriveItemAnalyticsItemActivityStatOperationResponse, err error) {
