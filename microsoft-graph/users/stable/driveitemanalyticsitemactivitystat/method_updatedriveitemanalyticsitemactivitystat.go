...
// UpdateDriveItemAnalyticsItemActivityStat - Update the navigation property itemActivityStats in users
func (c DriveItemAnalyticsItemActivityStatClient) UpdateDriveItemAnalyticsItemActivityStat(ctx context.Context, id stable.UserIdDriveIdItemIdAnalyticsItemActivityStatId, input stable.ItemActivityStat, options UpdateDriveItemAnalyticsItemActivityStatOperationOptions) (result UpdateDriveItemAnalyticsItemActivityStatOperationResponse, err error) {
