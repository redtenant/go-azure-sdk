...
// CreateDriveItemAnalyticsItemActivityStatActivity - Create new navigation property to activities for users
func (c DriveItemAnalyticsItemActivityStatActivityClient) CreateDriveItemAnalyticsItemActivityStatActivity(ctx context.Context, id stable.UserIdDriveIdItemIdAnalyticsItemActivityStatId, input stable.ItemActivity, options CreateDriveItemAnalyticsItemActivityStatActivityOperationOptions) (result CreateDriveItemAnalyticsItemActivityStatActivityOperationResponse, err error) {
