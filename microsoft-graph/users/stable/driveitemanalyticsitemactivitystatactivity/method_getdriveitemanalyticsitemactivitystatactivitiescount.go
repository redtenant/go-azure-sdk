...
func (c DriveItemAnalyticsItemActivityStatActivityClient) GetDriveItemAnalyticsItemActivityStatActivitiesCount(ctx context.Context, id stable.UserIdDriveIdItemIdAnalyticsItemActivityStatId, options GetDriveItemAnalyticsItemActivityStatActivitiesCountOperationOptions) (result GetDriveItemAnalyticsItemActivityStatActivitiesCountOperationResponse, err error) {
