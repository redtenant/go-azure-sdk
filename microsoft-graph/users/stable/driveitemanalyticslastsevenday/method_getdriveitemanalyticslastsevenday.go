...
// GetDriveItemAnalyticsLastSevenDay - Get lastSevenDays from users
func (c DriveItemAnalyticsLastSevenDayClient) GetDriveItemAnalyticsLastSevenDay(ctx context.Context, id stable.UserIdDriveIdItemId, options GetDriveItemAnalyticsLastSevenDayOperationOptions) (result GetDriveItemAnalyticsLastSevenDayOperationResponse, err error) {
