...
func DefaultGetDriveItemChildOperationOptions() GetDriveItemChildOperationOptions {
	return GetDriveItemChildOperationOptions{}
}
...
// GetDriveItemChild - Get children from users. Collection containing Item objects for the immediate children of Item.
// Only items representing folders have children. Read-only. Nullable.
func (c DriveItemChildClient) GetDriveItemChild(ctx context.Context, id stable.UserIdDriveIdItemIdChildId, options GetDriveItemChildOperationOptions) (result GetDriveItemChildOperationResponse, err error) {
