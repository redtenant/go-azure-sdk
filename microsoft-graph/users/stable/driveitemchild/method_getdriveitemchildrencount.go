...
func (c DriveItemChildClient) GetDriveItemChildrenCount(ctx context.Context, id stable.UserIdDriveIdItemId, options GetDriveItemChildrenCountOperationOptions) (result GetDriveItemChildrenCountOperationResponse, err error) {
