...
// ListDriveItemChildren - Get children from users. Collection containing Item objects for the immediate children of
// Item. Only items representing folders have children. Read-only. Nullable.
func (c DriveItemChildClient) ListDriveItemChildren(ctx context.Context, id stable.UserIdDriveIdItemId, options ListDriveItemChildrenOperationOptions) (result ListDriveItemChildrenOperationResponse, err error) {
...
func (c DriveItemChildClient) ListDriveItemChildrenComplete(ctx context.Context, id stable.UserIdDriveIdItemId, options ListDriveItemChildrenOperationOptions) (ListDriveItemChildrenCompleteResult, error) {
...
func (c DriveItemChildClient) ListDriveItemChildrenCompleteMatchingPredicate(ctx context.Context, id stable.UserIdDriveIdItemId, options ListDriveItemChildrenOperationOptions, predicate DriveItemOperationPredicate) (result ListDriveItemChildrenCompleteResult, err error) {
