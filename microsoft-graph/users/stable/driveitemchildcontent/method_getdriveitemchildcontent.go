...
// GetDriveItemChildContent - Get content for the navigation property children from users. The content stream, if the
// item represents a file.
func (c DriveItemChildContentClient) GetDriveItemChildContent(ctx context.Context, id stable.UserIdDriveIdItemIdChildId, options GetDriveItemChildContentOperationOptions) (result GetDriveItemChildContentOperationResponse, err error) {
