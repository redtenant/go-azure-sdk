...
func (c DriveItemListItemClient) CreateDriveItemListItemLink(ctx context.Context, id stable.UserIdDriveIdItemId, input CreateDriveItemListItemLinkRequest, options CreateDriveItemListItemLinkOperationOptions) (result CreateDriveItemListItemLinkOperationResponse, err error) {
