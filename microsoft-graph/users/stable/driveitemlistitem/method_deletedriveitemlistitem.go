...
func (c DriveItemListItemClient) DeleteDriveItemListItem(ctx context.Context, id stable.UserIdDriveIdItemId, options DeleteDriveItemListItemOperationOptions) (result DeleteDriveItemListItemOperationResponse, err error) {
