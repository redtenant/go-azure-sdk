...
// GetDriveItemListItem - Get listItem from users. For drives in SharePoint, the associated document library list item.
// Read-only. Nullable.
func (c DriveItemListItemClient) GetDriveItemListItem(ctx context.Context, id stable.UserIdDriveIdItemId, options GetDriveItemListItemOperationOptions) (result GetDriveItemListItemOperationResponse, err error) {
