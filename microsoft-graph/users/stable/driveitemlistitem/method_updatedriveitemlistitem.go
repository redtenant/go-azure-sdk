...
func (c DriveItemListItemClient) UpdateDriveItemListItem(ctx context.Context, id stable.UserIdDriveIdItemId, input stable.ListItem, options UpdateDriveItemListItemOperationOptions) (result UpdateDriveItemListItemOperationResponse, err error) {
