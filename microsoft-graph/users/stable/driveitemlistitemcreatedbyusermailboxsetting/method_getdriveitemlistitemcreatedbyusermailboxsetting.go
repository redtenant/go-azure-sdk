...
func (c DriveItemListItemCreatedByUserMailboxSettingClient) GetDriveItemListItemCreatedByUserMailboxSetting(ctx context.Context, id stable.UserIdDriveIdItemId, options GetDriveItemListItemCreatedByUserMailboxSettingOperationOptions) (result GetDriveItemListItemCreatedByUserMailboxSettingOperationResponse, err error) {
