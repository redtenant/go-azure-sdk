...
// CreateDriveItemListItemDocumentSetVersion - Create new navigation property to documentSetVersions for users
func (c DriveItemListItemDocumentSetVersionClient) CreateDriveItemListItemDocumentSetVersion(ctx context.Context, id stable.UserIdDriveIdItemId, input stable.DocumentSetVersion, options CreateDriveItemListItemDocumentSetVersionOperationOptions) (result CreateDriveItemListItemDocumentSetVersionOperationResponse, err error) {
