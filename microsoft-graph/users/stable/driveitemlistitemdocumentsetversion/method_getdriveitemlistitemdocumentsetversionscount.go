...
func (c DriveItemListItemDocumentSetVersionClient) GetDriveItemListItemDocumentSetVersionsCount(ctx context.Context, id stable.UserIdDriveIdItemId, options GetDriveItemListItemDocumentSetVersionsCountOperationOptions) (result GetDriveItemListItemDocumentSetVersionsCountOperationResponse, err error) {
