...
func (c DriveItemListItemDriveItemContentClient) DeleteDriveItemListItemDriveItemContent(ctx context.Context, id stable.UserIdDriveIdItemId, options DeleteDriveItemListItemDriveItemContentOperationOptions) (result DeleteDriveItemListItemDriveItemContentOperationResponse, err error) {
