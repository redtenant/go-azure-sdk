...
// GetDriveItemListItemField - Get fields from users. The values of the columns set on this list item.
func (c DriveItemListItemFieldClient) GetDriveItemListItemField(ctx context.Context, id stable.UserIdDriveIdItemId, options GetDriveItemListItemFieldOperationOptions) (result GetDriveItemListItemFieldOperationResponse, err error) {
