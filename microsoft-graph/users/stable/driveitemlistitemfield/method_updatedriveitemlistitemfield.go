...
func (c DriveItemListItemFieldClient) UpdateDriveItemListItemField(ctx context.Context, id stable.UserIdDriveIdItemId, input stable.FieldValueSet, options UpdateDriveItemListItemFieldOperationOptions) (result UpdateDriveItemListItemFieldOperationResponse, err error) {
