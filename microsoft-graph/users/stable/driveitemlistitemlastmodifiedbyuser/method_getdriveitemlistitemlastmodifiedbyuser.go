...
// GetDriveItemListItemLastModifiedByUser - Get lastModifiedByUser from users. Identity of the user who last modified
// the item. Read-only.
func (c DriveItemListItemLastModifiedByUserClient) GetDriveItemListItemLastModifiedByUser(ctx context.Context, id stable.UserIdDriveIdItemId, options GetDriveItemListItemLastModifiedByUserOperationOptions) (result GetDriveItemListItemLastModifiedByUserOperationResponse, err error) {
