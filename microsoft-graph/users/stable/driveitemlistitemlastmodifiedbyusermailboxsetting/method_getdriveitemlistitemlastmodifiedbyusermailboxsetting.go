...
func (c DriveItemListItemLastModifiedByUserMailboxSettingClient) GetDriveItemListItemLastModifiedByUserMailboxSetting(ctx context.Context, id stable.UserIdDriveIdItemId, options GetDriveItemListItemLastModifiedByUserMailboxSettingOperationOptions) (result GetDriveItemListItemLastModifiedByUserMailboxSettingOperationResponse, err error) {
