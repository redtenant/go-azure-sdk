...
func (c DriveItemListItemLastModifiedByUserMailboxSettingClient) UpdateDriveItemListItemLastModifiedByUserMailboxSetting(ctx context.Context, id stable.UserIdDriveIdItemId, input stable.MailboxSettings, options UpdateDriveItemListItemLastModifiedByUserMailboxSettingOperationOptions) (result UpdateDriveItemListItemLastModifiedByUserMailboxSettingOperationResponse, err error) {
