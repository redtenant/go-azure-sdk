...
func (c DriveItemListItemVersionClient) CreateDriveItemListItemVersion(ctx context.Context, id stable.UserIdDriveIdItemId, input stable.ListItemVersion, options CreateDriveItemListItemVersionOperationOptions) (result CreateDriveItemListItemVersionOperationResponse, err error) {
