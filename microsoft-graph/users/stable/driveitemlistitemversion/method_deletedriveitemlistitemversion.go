...
func (c DriveItemListItemVersionClient) DeleteDriveItemListItemVersion(ctx context.Context, id stable.UserIdDriveIdItemIdListItemVersionId, options DeleteDriveItemListItemVersionOperationOptions) (result DeleteDriveItemListItemVersionOperationResponse, err error) {
