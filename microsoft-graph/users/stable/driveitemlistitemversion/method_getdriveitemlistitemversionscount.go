...
func (c DriveItemListItemVersionClient) GetDriveItemListItemVersionsCount(ctx context.Context, id stable.UserIdDriveIdItemId, options GetDriveItemListItemVersionsCountOperationOptions) (result GetDriveItemListItemVersionsCountOperationResponse, err error) {
