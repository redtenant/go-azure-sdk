...
func (c DriveItemListItemVersionClient) UpdateDriveItemListItemVersion(ctx context.Context, id stable.UserIdDriveIdItemIdListItemVersionId, input stable.ListItemVersion, options UpdateDriveItemListItemVersionOperationOptions) (result UpdateDriveItemListItemVersionOperationResponse, err error) {
