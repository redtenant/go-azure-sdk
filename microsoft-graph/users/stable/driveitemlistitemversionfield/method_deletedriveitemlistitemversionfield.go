...
func (c DriveItemListItemVersionFieldClient) DeleteDriveItemListItemVersionField(ctx context.Context, id stable.UserIdDriveIdItemIdListItemVersionId, options DeleteDriveItemListItemVersionFieldOperationOptions) (result DeleteDriveItemListItemVersionFieldOperationResponse, err error) {
