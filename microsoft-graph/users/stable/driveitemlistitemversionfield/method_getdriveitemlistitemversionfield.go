...
// GetDriveItemListItemVersionField - Get fields from users. A collection of the fields and values for this version of
// the list item.
func (c DriveItemListItemVersionFieldClient) GetDriveItemListItemVersionField(ctx context.Context, id stable.UserIdDriveIdItemIdListItemVersionId, options GetDriveItemListItemVersionFieldOperationOptions) (result GetDriveItemListItemVersionFieldOperationResponse, err error) {
