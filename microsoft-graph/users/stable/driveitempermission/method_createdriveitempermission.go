...
// CreateDriveItemPermission - Create new navigation property to permissions for users
func (c DriveItemPermissionClient) CreateDriveItemPermission(ctx context.Context, id stable.UserIdDriveIdItemId, input stable.Permission, options CreateDriveItemPermissionOperationOptions) (result CreateDriveItemPermissionOperationResponse, err error) {
