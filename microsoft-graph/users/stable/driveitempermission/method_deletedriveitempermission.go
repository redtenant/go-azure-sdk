...
func DefaultDeleteDriveItemPermissionOperationOptions() DeleteDriveItemPermissionOperationOptions {
	return DeleteDriveItemPermissionOperationOptions{}
}
...
// DeleteDriveItemPermission - Delete navigation property permissions for users
func (c DriveItemPermissionClient) DeleteDriveItemPermission(ctx context.Context, id stable.UserIdDriveIdItemIdPermissionId, options DeleteDriveItemPermissionOperationOptions) (result DeleteDriveItemPermissionOperationResponse, err error) {
