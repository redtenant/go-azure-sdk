...
func DefaultGetDriveItemPermissionOperationOptions() GetDriveItemPermissionOperationOptions {
	return GetDriveItemPermissionOperationOptions{}
}
...
// GetDriveItemPermission - Get permissions from users. The set of permissions for the item. Read-only. Nullable.
func (c DriveItemPermissionClient) GetDriveItemPermission(ctx context.Context, id stable.UserIdDriveIdItemIdPermissionId, options GetDriveItemPermissionOperationOptions) (result GetDriveItemPermissionOperationResponse, err error) {
