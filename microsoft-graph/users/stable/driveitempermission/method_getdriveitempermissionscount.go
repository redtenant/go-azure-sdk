...
func (c DriveItemPermissionClient) GetDriveItemPermissionsCount(ctx context.Context, id stable.UserIdDriveIdItemId, options GetDriveItemPermissionsCountOperationOptions) (result GetDriveItemPermissionsCountOperationResponse, err error) {
