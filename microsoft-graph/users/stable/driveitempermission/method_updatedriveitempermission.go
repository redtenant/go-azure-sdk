...
// UpdateDriveItemPermission - Update the navigation property permissions in users
func (c DriveItemPermissionClient) UpdateDriveItemPermission(ctx context.Context, id stable.UserIdDriveIdItemIdPermissionId, input stable.Permission, options UpdateDriveItemPermissionOperationOptions) (result UpdateDriveItemPermissionOperationResponse, err error) {
