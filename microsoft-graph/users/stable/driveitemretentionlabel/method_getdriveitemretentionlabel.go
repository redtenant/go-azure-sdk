...
func (c DriveItemRetentionLabelClient) GetDriveItemRetentionLabel(ctx context.Context, id stable.UserIdDriveIdItemId, options GetDriveItemRetentionLabelOperationOptions) (result GetDriveItemRetentionLabelOperationResponse, err error) {
