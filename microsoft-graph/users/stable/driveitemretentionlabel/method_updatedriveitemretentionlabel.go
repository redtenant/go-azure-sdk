...
type UpdateDriveItemRetentionLabelOperationResponse struct {
...
// UpdateDriveItemRetentionLabel - Update the navigation property retentionLabel in users
func (c DriveItemRetentionLabelClient) UpdateDriveItemRetentionLabel(ctx context.Context, id stable.UserIdDriveIdItemId, input stable.ItemRetentionLabel, options UpdateDriveItemRetentionLabelOperationOptions) (result UpdateDriveItemRetentionLabelOperationResponse, err error) {
