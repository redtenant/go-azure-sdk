...
// GetDriveItemSubscription - Get subscriptions from users. The set of subscriptions on the item. Only supported on the
// root of a drive.
func (c DriveItemSubscriptionClient) GetDriveItemSubscription(ctx context.Context, id stable.UserIdDriveIdItemIdSubscriptionId, options GetDriveItemSubscriptionOperationOptions) (result GetDriveItemSubscriptionOperationResponse, err error) {
