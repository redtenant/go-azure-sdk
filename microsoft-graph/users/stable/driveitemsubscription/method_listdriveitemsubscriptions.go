...
// ListDriveItemSubscriptions - Get subscriptions from users. The set of subscriptions on the item. Only supported on
// the root of a drive.
func (c DriveItemSubscriptionClient) ListDriveItemSubscriptions(ctx context.Context, id stable.UserIdDriveIdItemId, options ListDriveItemSubscriptionsOperationOptions) (result ListDriveItemSubscriptionsOperationResponse, err error) {
...
func (c DriveItemSubscriptionClient) ListDriveItemSubscriptionsComplete(ctx context.Context, id stable.UserIdDriveIdItemId, options ListDriveItemSubscriptionsOperationOptions) (ListDriveItemSubscriptionsCompleteResult, error) {
...
func (c DriveItemSubscriptionClient) ListDriveItemSubscriptionsCompleteMatchingPredicate(ctx context.Context, id stable.UserIdDriveIdItemId, options ListDriveItemSubscriptionsOperationOptions, predicate SubscriptionOperationPredicate) (result ListDriveItemSubscriptionsCompleteResult, err error) {
