...
// UpdateDriveItemSubscription - Update the navigation property subscriptions in users
func (c DriveItemSubscriptionClient) UpdateDriveItemSubscription(ctx context.Context, id stable.UserIdDriveIdItemIdSubscriptionId, input stable.Subscription, options UpdateDriveItemSubscriptionOperationOptions) (result UpdateDriveItemSubscriptionOperationResponse, err error) {
