...
// GetDriveItemThumbnail - Get thumbnails from users. Collection of thumbnailSet objects associated with the item. For
// more information, see getting thumbnails. Read-only. Nullable.
func (c DriveItemThumbnailClient) GetDriveItemThumbnail(ctx context.Context, id stable.UserIdDriveIdItemIdThumbnailId, options GetDriveItemThumbnailOperationOptions) (result GetDriveItemThumbnailOperationResponse, err error) {
