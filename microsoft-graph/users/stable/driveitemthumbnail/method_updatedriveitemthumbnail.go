...
func (c DriveItemThumbnailClient) UpdateDriveItemThumbnail(ctx context.Context, id stable.UserIdDriveIdItemIdThumbnailId, input stable.ThumbnailSet, options UpdateDriveItemThumbnailOperationOptions) (result UpdateDriveItemThumbnailOperationResponse, err error) {
