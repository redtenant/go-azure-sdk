...
// CreateDriveItemVersion - Create new navigation property to versions for users
func (c DriveItemVersionClient) CreateDriveItemVersion(ctx context.Context, id stable.UserIdDriveIdItemId, input stable.DriveItemVersion, options CreateDriveItemVersionOperationOptions) (result CreateDriveItemVersionOperationResponse, err error) {
