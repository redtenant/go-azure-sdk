...
func DefaultDeleteDriveItemVersionOperationOptions() DeleteDriveItemVersionOperationOptions {
	return DeleteDriveItemVersionOperationOptions{}
}
...
// DeleteDriveItemVersion - Delete navigation property versions for users
func (c DriveItemVersionClient) DeleteDriveItemVersion(ctx context.Context, id stable.UserIdDriveIdItemIdVersionId, options DeleteDriveItemVersionOperationOptions) (result DeleteDriveItemVersionOperationResponse, err error) {
