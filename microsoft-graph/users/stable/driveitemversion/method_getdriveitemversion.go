...
func (c DriveItemVersionClient) GetDriveItemVersion(ctx context.Context, id stable.UserIdDriveIdItemIdVersionId, options GetDriveItemVersionOperationOptions) (result GetDriveItemVersionOperationResponse, err error) {
