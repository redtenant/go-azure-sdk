...
func (c DriveItemVersionClient) ListDriveItemVersions(ctx context.Context, id stable.UserIdDriveIdItemId, options ListDriveItemVersionsOperationOptions) (result ListDriveItemVersionsOperationResponse, err error) {
...
func (c DriveItemVersionClient) ListDriveItemVersionsComplete(ctx context.Context, id stable.UserIdDriveIdItemId, options ListDriveItemVersionsOperationOptions) (ListDriveItemVersionsCompleteResult, error) {
...
func (c DriveItemVersionClient) ListDriveItemVersionsCompleteMatchingPredicate(ctx context.Context, id stable.UserIdDriveIdItemId, options ListDriveItemVersionsOperationOptions, predicate DriveItemVersionOperationPredicate) (result ListDriveItemVersionsCompleteResult, err error) {
