...
func (c DriveItemVersionClient) RestoreDriveItemVersionVersion(ctx context.Context, id stable.UserIdDriveIdItemIdVersionId, options RestoreDriveItemVersionVersionOperationOptions) (result RestoreDriveItemVersionVersionOperationResponse, err error) {
