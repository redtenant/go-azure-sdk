...
// UpdateDriveItemVersion - Update the navigation property versions in users
func (c DriveItemVersionClient) UpdateDriveItemVersion(ctx context.Context, id stable.UserIdDriveIdItemIdVersionId, input stable.DriveItemVersion, options UpdateDriveItemVersionOperationOptions) (result UpdateDriveItemVersionOperationResponse, err error) {
