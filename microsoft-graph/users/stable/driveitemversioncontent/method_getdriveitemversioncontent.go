...
// GetDriveItemVersionContent - Get content for the navigation property versions from users. The content stream for this
// version of the item.
func (c DriveItemVersionContentClient) GetDriveItemVersionContent(ctx context.Context, id stable.UserIdDriveIdItemIdVersionId, options GetDriveItemVersionContentOperationOptions) (result GetDriveItemVersionContentOperationResponse, err error) {
