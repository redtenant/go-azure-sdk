...
func (c DriveLastModifiedByUserMailboxSettingClient) UpdateDriveLastModifiedByUserMailboxSetting(ctx context.Context, id stable.UserIdDriveId, input stable.MailboxSettings, options UpdateDriveLastModifiedByUserMailboxSettingOperationOptions) (result UpdateDriveLastModifiedByUserMailboxSettingOperationResponse, err error) {
