...
func (c DriveLastModifiedByUserServiceProvisioningErrorClient) GetDriveLastModifiedByUserServiceProvisioningErrorsCount(ctx context.Context, id stable.UserIdDriveId, options GetDriveLastModifiedByUserServiceProvisioningErrorsCountOperationOptions) (result GetDriveLastModifiedByUserServiceProvisioningErrorsCountOperationResponse, err error) {
