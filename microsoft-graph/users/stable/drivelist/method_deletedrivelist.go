...
func (c DriveListClient) DeleteDriveList(ctx context.Context, id stable.UserIdDriveId, options DeleteDriveListOperationOptions) (result DeleteDriveListOperationResponse, err error) {
