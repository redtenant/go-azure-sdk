...
// GetDriveList - Get list from users. For drives in SharePoint, the underlying document library list. Read-only.
// Nullable.
func (c DriveListClient) GetDriveList(ctx context.Context, id stable.UserIdDriveId, options GetDriveListOperationOptions) (result GetDriveListOperationResponse, err error) {
