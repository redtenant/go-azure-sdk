...
func (c DriveListColumnClient) CreateDriveListColumn(ctx context.Context, id stable.UserIdDriveId, input stable.ColumnDefinition, options CreateDriveListColumnOperationOptions) (result CreateDriveListColumnOperationResponse, err error) {
