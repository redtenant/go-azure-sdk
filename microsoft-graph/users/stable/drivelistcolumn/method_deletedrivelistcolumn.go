...
// DeleteDriveListColumn - Delete navigation property columns for users
func (c DriveListColumnClient) DeleteDriveListColumn(ctx context.Context, id stable.UserIdDriveIdListColumnId, options DeleteDriveListColumnOperationOptions) (result DeleteDriveListColumnOperationResponse, err error) {
