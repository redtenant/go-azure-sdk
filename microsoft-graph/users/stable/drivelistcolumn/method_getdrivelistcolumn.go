...
// GetDriveListColumn - Get columns from users. The collection of field definitions for this list.
func (c DriveListColumnClient) GetDriveListColumn(ctx context.Context, id stable.UserIdDriveIdListColumnId, options GetDriveListColumnOperationOptions) (result GetDriveListColumnOperationResponse, err error) {
