...
func (c DriveListColumnClient) GetDriveListColumnsCount(ctx context.Context, id stable.UserIdDriveId, options GetDriveListColumnsCountOperationOptions) (result GetDriveListColumnsCountOperationResponse, err error) {
