...
// ListDriveListColumns - Get columns from users. The collection of field definitions for this list.
func (c DriveListColumnClient) ListDriveListColumns(ctx context.Context, id stable.UserIdDriveId, options ListDriveListColumnsOperationOptions) (result ListDriveListColumnsOperationResponse, err error) {
...
func (c DriveListColumnClient) ListDriveListColumnsComplete(ctx context.Context, id stable.UserIdDriveId, options ListDriveListColumnsOperationOptions) (ListDriveListColumnsCompleteResult, error) {
...
func (c DriveListColumnClient) ListDriveListColumnsCompleteMatchingPredicate(ctx context.Context, id stable.UserIdDriveId, options ListDriveListColumnsOperationOptions, predicate ColumnDefinitionOperationPredicate) (result ListDriveListColumnsCompleteResult, err error) {
