...
func (c DriveListContentTypeClient) AddDriveListContentTypesCopy(ctx context.Context, id stable.UserIdDriveId, input AddDriveListContentTypesCopyRequest, options AddDriveListContentTypesCopyOperationOptions) (result AddDriveListContentTypesCopyOperationResponse, err error) {
