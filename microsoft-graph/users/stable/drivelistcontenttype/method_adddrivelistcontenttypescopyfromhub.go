...
func (c DriveListContentTypeClient) AddDriveListContentTypesCopyFromHub(ctx context.Context, id stable.UserIdDriveId, input AddDriveListContentTypesCopyFromHubRequest, options AddDriveListContentTypesCopyFromHubOperationOptions) (result AddDriveListContentTypesCopyFromHubOperationResponse, err error) {
