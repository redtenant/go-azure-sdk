...
func (c DriveListContentTypeClient) CreateDriveListContentTypeAssociateWithHubSite(ctx context.Context, id stable.UserIdDriveIdListContentTypeId, input CreateDriveListContentTypeAssociateWithHubSiteRequest, options CreateDriveListContentTypeAssociateWithHubSiteOperationOptions) (result CreateDriveListContentTypeAssociateWithHubSiteOperationResponse, err error) {
