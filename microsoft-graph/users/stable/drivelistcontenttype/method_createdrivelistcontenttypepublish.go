...
// site.
func (c DriveListContentTypeClient) CreateDriveListContentTypePublish(ctx context.Context, id stable.UserIdDriveIdListContentTypeId, options CreateDriveListContentTypePublishOperationOptions) (result CreateDriveListContentTypePublishOperationResponse, err error) {
