...
// DeleteDriveListContentType - Delete navigation property contentTypes for users
func (c DriveListContentTypeClient) DeleteDriveListContentType(ctx context.Context, id stable.UserIdDriveIdListContentTypeId, options DeleteDriveListContentTypeOperationOptions) (result DeleteDriveListContentTypeOperationResponse, err error) {
