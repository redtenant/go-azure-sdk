...
func (c DriveListContentTypeClient) UpdateDriveListContentType(ctx context.Context, id stable.UserIdDriveIdListContentTypeId, input stable.ContentType, options UpdateDriveListContentTypeOperationOptions) (result UpdateDriveListContentTypeOperationResponse, err error) {
