...
// GetDriveListContentTypeBaseType - Get baseTypes from users. The collection of content types that are ancestors of
// this content type.
func (c DriveListContentTypeBaseTypeClient) GetDriveListContentTypeBaseType(ctx context.Context, id stable.UserIdDriveIdListContentTypeIdBaseTypeId, options GetDriveListContentTypeBaseTypeOperationOptions) (result GetDriveListContentTypeBaseTypeOperationResponse, err error) {
