...
func (c DriveListContentTypeBaseTypeClient) GetDriveListContentTypeBaseTypesCount(ctx context.Context, id stable.UserIdDriveIdListContentTypeId, options GetDriveListContentTypeBaseTypesCountOperationOptions) (result GetDriveListContentTypeBaseTypesCountOperationResponse, err error) {
