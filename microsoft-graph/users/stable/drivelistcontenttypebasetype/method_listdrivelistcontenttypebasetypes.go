...
// this content type.
func (c DriveListContentTypeBaseTypeClient) ListDriveListContentTypeBaseTypes(ctx context.Context, id stable.UserIdDriveIdListContentTypeId, options ListDriveListContentTypeBaseTypesOperationOptions) (result ListDriveListContentTypeBaseTypesOperationResponse, err error) {
...
func (c DriveListContentTypeBaseTypeClient) ListDriveListContentTypeBaseTypesComplete(ctx context.Context, id stable.UserIdDriveIdListContentTypeId, options ListDriveListContentTypeBaseTypesOperationOptions) (ListDriveListContentTypeBaseTypesCompleteResult, error) {
...
func (c DriveListContentTypeBaseTypeClient) ListDriveListContentTypeBaseTypesCompleteMatchingPredicate(ctx context.Context, id stable.UserIdDriveIdListContentTypeId, options ListDriveListContentTypeBaseTypesOperationOptions, predicate ContentTypeOperationPredicate) (result ListDriveListContentTypeBaseTypesCompleteResult, err error) {
