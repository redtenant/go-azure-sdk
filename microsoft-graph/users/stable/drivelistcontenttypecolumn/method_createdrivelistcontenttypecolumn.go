...
// CreateDriveListContentTypeColumn - Create new navigation property to columns for users
func (c DriveListContentTypeColumnClient) CreateDriveListContentTypeColumn(ctx context.Context, id stable.UserIdDriveIdListContentTypeId, input stable.ColumnDefinition, options CreateDriveListContentTypeColumnOperationOptions) (result CreateDriveListContentTypeColumnOperationResponse, err error) {
