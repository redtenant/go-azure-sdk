...
// DeleteDriveListContentTypeColumn - Delete navigation property columns for users
func (c DriveListContentTypeColumnClient) DeleteDriveListContentTypeColumn(ctx context.Context, id stable.UserIdDriveIdListContentTypeIdColumnId, options DeleteDriveListContentTypeColumnOperationOptions) (result DeleteDriveListContentTypeColumnOperationResponse, err error) {
