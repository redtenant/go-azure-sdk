...
func (c DriveListContentTypeColumnClient) GetDriveListContentTypeColumn(ctx context.Context, id stable.UserIdDriveIdListContentTypeIdColumnId, options GetDriveListContentTypeColumnOperationOptions) (result GetDriveListContentTypeColumnOperationResponse, err error) {
