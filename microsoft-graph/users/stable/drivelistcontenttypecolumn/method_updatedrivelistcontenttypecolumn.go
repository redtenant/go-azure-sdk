...
// UpdateDriveListContentTypeColumn - Update the navigation property columns in users
func (c DriveListContentTypeColumnClient) UpdateDriveListContentTypeColumn(ctx context.Context, id stable.UserIdDriveIdListContentTypeIdColumnId, input stable.ColumnDefinition, options UpdateDriveListContentTypeColumnOperationOptions) (result UpdateDriveListContentTypeColumnOperationResponse, err error) {
