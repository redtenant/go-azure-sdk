...
func (c DriveListContentTypeColumnLinkClient) GetDriveListContentTypeColumnLinksCount(ctx context.Context, id stable.UserIdDriveIdListContentTypeId, options GetDriveListContentTypeColumnLinksCountOperationOptions) (result GetDriveListContentTypeColumnLinksCountOperationResponse, err error) {
