...
func (c DriveListContentTypeColumnPositionClient) GetDriveListContentTypeColumnPositionsCount(ctx context.Context, id stable.UserIdDriveIdListContentTypeId, options GetDriveListContentTypeColumnPositionsCountOperationOptions) (result GetDriveListContentTypeColumnPositionsCountOperationResponse, err error) {
