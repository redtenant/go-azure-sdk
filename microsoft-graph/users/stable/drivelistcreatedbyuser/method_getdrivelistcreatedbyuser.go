...
// GetDriveListCreatedByUser - Get createdByUser from users. Identity of the user who created the item. Read-only.
func (c DriveListCreatedByUserClient) GetDriveListCreatedByUser(ctx context.Context, id stable.UserIdDriveId, options GetDriveListCreatedByUserOperationOptions) (result GetDriveListCreatedByUserOperationResponse, err error) {
