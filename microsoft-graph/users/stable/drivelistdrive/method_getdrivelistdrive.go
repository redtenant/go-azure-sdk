...
func (c DriveListDriveClient) GetDriveListDrive(ctx context.Context, id stable.UserIdDriveId, options GetDriveListDriveOperationOptions) (result GetDriveListDriveOperationResponse, err error) {
