...
// CreateDriveListItem - Create new navigation property to items for users
func (c DriveListItemClient) CreateDriveListItem(ctx context.Context, id stable.UserIdDriveId, input stable.ListItem, options CreateDriveListItemOperationOptions) (result CreateDriveListItemOperationResponse, err error) {
