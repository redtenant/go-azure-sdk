...
// DeleteDriveListItem - Delete navigation property items for users
func (c DriveListItemClient) DeleteDriveListItem(ctx context.Context, id stable.UserIdDriveIdListItemId, options DeleteDriveListItemOperationOptions) (result DeleteDriveListItemOperationResponse, err error) {
