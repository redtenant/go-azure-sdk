...
// GetDriveListItem - Get items from users. All items contained in the list.
func (c DriveListItemClient) GetDriveListItem(ctx context.Context, id stable.UserIdDriveIdListItemId, options GetDriveListItemOperationOptions) (result GetDriveListItemOperationResponse, err error) {
