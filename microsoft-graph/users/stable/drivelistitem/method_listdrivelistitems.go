...
func (c DriveListItemClient) ListDriveListItems(ctx context.Context, id stable.UserIdDriveId, options ListDriveListItemsOperationOptions) (result ListDriveListItemsOperationResponse, err error) {
...
func (c DriveListItemClient) ListDriveListItemsComplete(ctx context.Context, id stable.UserIdDriveId, options ListDriveListItemsOperationOptions) (ListDriveListItemsCompleteResult, error) {
...
func (c DriveListItemClient) ListDriveListItemsCompleteMatchingPredicate(ctx context.Context, id stable.UserIdDriveId, options ListDriveListItemsOperationOptions, predicate ListItemOperationPredicate) (result ListDriveListItemsCompleteResult, err error) {
