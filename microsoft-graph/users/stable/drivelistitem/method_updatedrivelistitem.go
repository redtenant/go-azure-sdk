...
// UpdateDriveListItem - Update the navigation property items in users
func (c DriveListItemClient) UpdateDriveListItem(ctx context.Context, id stable.UserIdDriveIdListItemId, input stable.ListItem, options UpdateDriveListItemOperationOptions) (result UpdateDriveListItemOperationResponse, err error) {
