...
// GetDriveListItemCreatedByUser - Get createdByUser from users. Identity of the user who created the item. Read-only.
func (c DriveListItemCreatedByUserClient) GetDriveListItemCreatedByUser(ctx context.Context, id stable.UserIdDriveIdListItemId, options GetDriveListItemCreatedByUserOperationOptions) (result GetDriveListItemCreatedByUserOperationResponse, err error) {
