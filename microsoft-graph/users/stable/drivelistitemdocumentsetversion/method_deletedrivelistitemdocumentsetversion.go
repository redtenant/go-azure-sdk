...
// DeleteDriveListItemDocumentSetVersion - Delete navigation property documentSetVersions for users
func (c DriveListItemDocumentSetVersionClient) DeleteDriveListItemDocumentSetVersion(ctx context.Context, id stable.UserIdDriveIdListItemIdDocumentSetVersionId, options DeleteDriveListItemDocumentSetVersionOperationOptions) (result DeleteDriveListItemDocumentSetVersionOperationResponse, err error) {
