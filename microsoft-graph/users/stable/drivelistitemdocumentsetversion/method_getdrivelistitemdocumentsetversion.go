...
// GetDriveListItemDocumentSetVersion - Get documentSetVersions from users. Version information for a document set
// version created by a user.
func (c DriveListItemDocumentSetVersionClient) GetDriveListItemDocumentSetVersion(ctx context.Context, id stable.UserIdDriveIdListItemIdDocumentSetVersionId, options GetDriveListItemDocumentSetVersionOperationOptions) (result GetDriveListItemDocumentSetVersionOperationResponse, err error) {
