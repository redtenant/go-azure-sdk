...
func (c DriveListItemDocumentSetVersionClient) GetDriveListItemDocumentSetVersionsCount(ctx context.Context, id stable.UserIdDriveIdListItemId, options GetDriveListItemDocumentSetVersionsCountOperationOptions) (result GetDriveListItemDocumentSetVersionsCountOperationResponse, err error) {
