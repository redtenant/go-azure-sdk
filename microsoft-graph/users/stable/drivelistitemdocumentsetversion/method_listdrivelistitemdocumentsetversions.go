...
// ListDriveListItemDocumentSetVersions - Get documentSetVersions from users. Version information for a document set
// version created by a user.
func (c DriveListItemDocumentSetVersionClient) ListDriveListItemDocumentSetVersions(ctx context.Context, id stable.UserIdDriveIdListItemId, options ListDriveListItemDocumentSetVersionsOperationOptions) (result ListDriveListItemDocumentSetVersionsOperationResponse, err error) {
...
func (c DriveListItemDocumentSetVersionClient) ListDriveListItemDocumentSetVersionsComplete(ctx context.Context, id stable.UserIdDriveIdListItemId, options ListDriveListItemDocumentSetVersionsOperationOptions) (ListDriveListItemDocumentSetVersionsCompleteResult, error) {
...
func (c DriveListItemDocumentSetVersionClient) ListDriveListItemDocumentSetVersionsCompleteMatchingPredicate(ctx context.Context, id stable.UserIdDriveIdListItemId, options ListDriveListItemDocumentSetVersionsOperationOptions, predicate DocumentSetVersionOperationPredicate) (result ListDriveListItemDocumentSetVersionsCompleteResult, err error) {
