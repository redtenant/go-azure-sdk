...
func DefaultUpdateDriveListItemDocumentSetVersionOperationOptions() UpdateDriveListItemDocumentSetVersionOperationOptions {
	return UpdateDriveListItemDocumentSetVersionOperationOptions{}
}
...
// UpdateDriveListItemDocumentSetVersion - Update the navigation property documentSetVersions in users
func (c DriveListItemDocumentSetVersionClient) UpdateDriveListItemDocumentSetVersion(ctx context.Context, id stable.UserIdDriveIdListItemIdDocumentSetVersionId, input stable.DocumentSetVersion, options UpdateDriveListItemDocumentSetVersionOperationOptions) (result UpdateDriveListItemDocumentSetVersionOperationResponse, err error) {
