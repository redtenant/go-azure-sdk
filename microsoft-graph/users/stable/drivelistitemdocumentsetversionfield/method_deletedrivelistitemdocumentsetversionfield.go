...
// DeleteDriveListItemDocumentSetVersionField - Delete navigation property fields for users
func (c DriveListItemDocumentSetVersionFieldClient) DeleteDriveListItemDocumentSetVersionField(ctx context.Context, id stable.UserIdDriveIdListItemIdDocumentSetVersionId, options DeleteDriveListItemDocumentSetVersionFieldOperationOptions) (result DeleteDriveListItemDocumentSetVersionFieldOperationResponse, err error) {
