...
// DeleteDriveListItemDriveItemContent - Delete content for the navigation property driveItem in users. The content
// stream, if the item represents a file.
func (c DriveListItemDriveItemContentClient) DeleteDriveListItemDriveItemContent(ctx context.Context, id stable.UserIdDriveIdListItemId, options DeleteDriveListItemDriveItemContentOperationOptions) (result DeleteDriveListItemDriveItemContentOperationResponse, err error) {
