...
// GetDriveListItemDriveItemContent - Get content for the navigation property driveItem from users. The content stream,
// if the item represents a file.
func (c DriveListItemDriveItemContentClient) GetDriveListItemDriveItemContent(ctx context.Context, id stable.UserIdDriveIdListItemId, options GetDriveListItemDriveItemContentOperationOptions) (result GetDriveListItemDriveItemContentOperationResponse, err error) {
