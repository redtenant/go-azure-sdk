...
// UpdateDriveListItemField - Update the navigation property fields in users
func (c DriveListItemFieldClient) UpdateDriveListItemField(ctx context.Context, id stable.UserIdDriveIdListItemId, input stable.FieldValueSet, options UpdateDriveListItemFieldOperationOptions) (result UpdateDriveListItemFieldOperationResponse, err error) {
