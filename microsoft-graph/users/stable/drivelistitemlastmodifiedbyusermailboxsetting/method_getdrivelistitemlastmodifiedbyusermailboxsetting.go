...
func (c DriveListItemLastModifiedByUserMailboxSettingClient) GetDriveListItemLastModifiedByUserMailboxSetting(ctx context.Context, id stable.UserIdDriveIdListItemId, options GetDriveListItemLastModifiedByUserMailboxSettingOperationOptions) (result GetDriveListItemLastModifiedByUserMailboxSettingOperationResponse, err error) {
