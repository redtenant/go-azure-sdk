...
// DeleteDriveListItemVersionField - Delete navigation property fields for users
func (c DriveListItemVersionFieldClient) DeleteDriveListItemVersionField(ctx context.Context, id stable.UserIdDriveIdListItemIdVersionId, options DeleteDriveListItemVersionFieldOperationOptions) (result DeleteDriveListItemVersionFieldOperationResponse, err error) {
