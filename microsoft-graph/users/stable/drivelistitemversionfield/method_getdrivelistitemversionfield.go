...
// GetDriveListItemVersionField - Get fields from users. A collection of the fields and values for this version of the
// list item.
func (c DriveListItemVersionFieldClient) GetDriveListItemVersionField(ctx context.Context, id stable.UserIdDriveIdListItemIdVersionId, options GetDriveListItemVersionFieldOperationOptions) (result GetDriveListItemVersionFieldOperationResponse, err error) {
