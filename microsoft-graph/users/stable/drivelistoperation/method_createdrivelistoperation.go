...
// CreateDriveListOperation - Create new navigation property to operations for users
func (c DriveListOperationClient) CreateDriveListOperation(ctx context.Context, id stable.UserIdDriveId, input stable.RichLongRunningOperation, options CreateDriveListOperationOperationOptions) (result CreateDriveListOperationOperationResponse, err error) {
