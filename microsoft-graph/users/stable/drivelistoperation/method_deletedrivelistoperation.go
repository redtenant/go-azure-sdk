...
// DeleteDriveListOperation - Delete navigation property operations for users
func (c DriveListOperationClient) DeleteDriveListOperation(ctx context.Context, id stable.UserIdDriveIdListOperationId, options DeleteDriveListOperationOperationOptions) (result DeleteDriveListOperationOperationResponse, err error) {
