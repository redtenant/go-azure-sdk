...
func DefaultGetDriveListOperationOperationOptions() GetDriveListOperationOperationOptions {
	return GetDriveListOperationOperationOptions{}
}
...
// GetDriveListOperation - Get operations from users. The collection of long-running operations on the list.
func (c DriveListOperationClient) GetDriveListOperation(ctx context.Context, id stable.UserIdDriveIdListOperationId, options GetDriveListOperationOperationOptions) (result GetDriveListOperationOperationResponse, err error) {
