...
func (c DriveListOperationClient) GetDriveListOperationsCount(ctx context.Context, id stable.UserIdDriveId, options GetDriveListOperationsCountOperationOptions) (result GetDriveListOperationsCountOperationResponse, err error) {
