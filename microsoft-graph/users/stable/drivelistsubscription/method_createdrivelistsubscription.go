...
func (c DriveListSubscriptionClient) CreateDriveListSubscription(ctx context.Context, id stable.UserIdDriveId, input stable.Subscription, options CreateDriveListSubscriptionOperationOptions) (result CreateDriveListSubscriptionOperationResponse, err error) {
