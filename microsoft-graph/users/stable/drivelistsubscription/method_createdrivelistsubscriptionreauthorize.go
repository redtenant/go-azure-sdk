...
func (c DriveListSubscriptionClient) CreateDriveListSubscriptionReauthorize(ctx context.Context, id stable.UserIdDriveIdListSubscriptionId, options CreateDriveListSubscriptionReauthorizeOperationOptions) (result CreateDriveListSubscriptionReauthorizeOperationResponse, err error) {
