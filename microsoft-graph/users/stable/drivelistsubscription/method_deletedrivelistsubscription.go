...
// DeleteDriveListSubscription - Delete navigation property subscriptions for users
func (c DriveListSubscriptionClient) DeleteDriveListSubscription(ctx context.Context, id stable.UserIdDriveIdListSubscriptionId, options DeleteDriveListSubscriptionOperationOptions) (result DeleteDriveListSubscriptionOperationResponse, err error) {
