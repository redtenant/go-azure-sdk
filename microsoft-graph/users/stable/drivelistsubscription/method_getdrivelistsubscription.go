...
func (c DriveListSubscriptionClient) GetDriveListSubscription(ctx context.Context, id stable.UserIdDriveIdListSubscriptionId, options GetDriveListSubscriptionOperationOptions) (result GetDriveListSubscriptionOperationResponse, err error) {
