...
func (c DriveRootAnalyticsClient) GetDriveRootAnalytic(ctx context.Context, id stable.UserIdDriveId, options GetDriveRootAnalyticOperationOptions) (result GetDriveRootAnalyticOperationResponse, err error) {
