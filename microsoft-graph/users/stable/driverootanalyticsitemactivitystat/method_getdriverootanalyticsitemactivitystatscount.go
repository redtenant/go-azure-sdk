...
func (c DriveRootAnalyticsItemActivityStatClient) GetDriveRootAnalyticsItemActivityStatsCount(ctx context.Context, id stable.UserIdDriveId, options GetDriveRootAnalyticsItemActivityStatsCountOperationOptions) (result GetDriveRootAnalyticsItemActivityStatsCountOperationResponse, err error) {
