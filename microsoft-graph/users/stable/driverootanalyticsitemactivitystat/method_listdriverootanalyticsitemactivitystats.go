...
func (c DriveRootAnalyticsItemActivityStatClient) ListDriveRootAnalyticsItemActivityStats(ctx context.Context, id stable.UserIdDriveId, options ListDriveRootAnalyticsItemActivityStatsOperationOptions) (result ListDriveRootAnalyticsItemActivityStatsOperationResponse, err error) {
...
func (c DriveRootAnalyticsItemActivityStatClient) ListDriveRootAnalyticsItemActivityStatsComplete(ctx context.Context, id stable.UserIdDriveId, options ListDriveRootAnalyticsItemActivityStatsOperationOptions) (ListDriveRootAnalyticsItemActivityStatsCompleteResult, error) {
