...
// UpdateDriveRootAnalyticsItemActivityStat - Update the navigation property itemActivityStats in users
func (c DriveRootAnalyticsItemActivityStatClient) UpdateDriveRootAnalyticsItemActivityStat(ctx context.Context, id stable.UserIdDriveIdRootAnalyticsItemActivityStatId, input stable.ItemActivityStat, options UpdateDriveRootAnalyticsItemActivityStatOperationOptions) (result UpdateDriveRootAnalyticsItemActivityStatOperationResponse, err error) {
