...
func (c DriveRootAnalyticsItemActivityStatActivityClient) CreateDriveRootAnalyticsItemActivityStatActivity(ctx context.Context, id stable.UserIdDriveIdRootAnalyticsItemActivityStatId, input stable.ItemActivity, options CreateDriveRootAnalyticsItemActivityStatActivityOperationOptions) (result CreateDriveRootAnalyticsItemActivityStatActivityOperationResponse, err error) {
