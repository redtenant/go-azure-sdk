...
// from users. The content stream, if the item represents a file.
func (c DriveRootAnalyticsItemActivityStatActivityDriveItemContentClient) GetDriveRootAnalyticsItemActivityStatActivityDriveItemContent(ctx context.Context, id stable.UserIdDriveIdRootAnalyticsItemActivityStatIdActivityId, options GetDriveRootAnalyticsItemActivityStatActivityDriveItemContentOperationOptions) (result GetDriveRootAnalyticsItemActivityStatActivityDriveItemContentOperationResponse, err error) {
