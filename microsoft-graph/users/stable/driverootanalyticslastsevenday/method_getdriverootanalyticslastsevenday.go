...
// GetDriveRootAnalyticsLastSevenDay - Get lastSevenDays from users
func (c DriveRootAnalyticsLastSevenDayClient) GetDriveRootAnalyticsLastSevenDay(ctx context.Context, id stable.UserIdDriveId, options GetDriveRootAnalyticsLastSevenDayOperationOptions) (result GetDriveRootAnalyticsLastSevenDayOperationResponse, err error) {
