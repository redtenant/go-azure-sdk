...
// GetDriveRootChild - Get children from users. Collection containing Item objects for the immediate children of Item.
// Only items representing folders have children. Read-only. Nullable.
func (c DriveRootChildClient) GetDriveRootChild(ctx context.Context, id stable.UserIdDriveIdRootChildId, options GetDriveRootChildOperationOptions) (result GetDriveRootChildOperationResponse, err error) {
