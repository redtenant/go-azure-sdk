...
func DefaultGetDriveRootChildrenCountOperationOptions() GetDriveRootChildrenCountOperationOptions {
	return GetDriveRootChildrenCountOperationOptions{}
}
...
func (c DriveRootChildClient) GetDriveRootChildrenCount(ctx context.Context, id stable.UserIdDriveId, options GetDriveRootChildrenCountOperationOptions) (result GetDriveRootChildrenCountOperationResponse, err error) {
	opts := client.RequestOptions{
		...
		Path:          fmt.Sprintf("%s/root/children/$count", id.ID()),
