...
func (c DriveRootChildClient) ListDriveRootChildren(ctx context.Context, id stable.UserIdDriveId, options ListDriveRootChildrenOperationOptions) (result ListDriveRootChildrenOperationResponse, err error) {
...
func (c DriveRootChildClient) ListDriveRootChildrenComplete(ctx context.Context, id stable.UserIdDriveId, options ListDriveRootChildrenOperationOptions) (ListDriveRootChildrenCompleteResult, error) {
...
func (c DriveRootChildClient) ListDriveRootChildrenCompleteMatchingPredicate(ctx context.Context, id stable.UserIdDriveId, options ListDriveRootChildrenOperationOptions, predicate DriveItemOperationPredicate) (result ListDriveRootChildrenCompleteResult, err error) {
