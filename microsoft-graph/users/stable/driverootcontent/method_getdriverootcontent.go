...
// GetDriveRootContent - Get content for the navigation property root from users. The content stream, if the item
// represents a file.
func (c DriveRootContentClient) GetDriveRootContent(ctx context.Context, id stable.UserIdDriveId, options GetDriveRootContentOperationOptions) (result GetDriveRootContentOperationResponse, err error) {
