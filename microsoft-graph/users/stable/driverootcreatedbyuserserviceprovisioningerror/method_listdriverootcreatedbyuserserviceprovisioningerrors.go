...
func (c DriveRootCreatedByUserServiceProvisioningErrorClient) ListDriveRootCreatedByUserServiceProvisioningErrors(ctx context.Context, id stable.UserIdDriveId, options ListDriveRootCreatedByUserServiceProvisioningErrorsOperationOptions) (result ListDriveRootCreatedByUserServiceProvisioningErrorsOperationResponse, err error) {
...
func (c DriveRootCreatedByUserServiceProvisioningErrorClient) ListDriveRootCreatedByUserServiceProvisioningErrorsComplete(ctx context.Context, id stable.UserIdDriveId, options ListDriveRootCreatedByUserServiceProvisioningErrorsOperationOptions) (ListDriveRootCreatedByUserServiceProvisioningErrorsCompleteResult, error) {
...
func (c DriveRootCreatedByUserServiceProvisioningErrorClient) ListDriveRootCreatedByUserServiceProvisioningErrorsCompleteMatchingPredicate(ctx context.Context, id stable.UserIdDriveId, options ListDriveRootCreatedByUserServiceProvisioningErrorsOperationOptions, predicate ServiceProvisioningErrorOperationPredicate) (result ListDriveRootCreatedByUserServiceProvisioningErrorsCompleteResult, err error) {
