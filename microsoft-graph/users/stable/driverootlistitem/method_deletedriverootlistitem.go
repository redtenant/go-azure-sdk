...
func (c DriveRootListItemClient) DeleteDriveRootListItem(ctx context.Context, id stable.UserIdDriveId, options DeleteDriveRootListItemOperationOptions) (result DeleteDriveRootListItemOperationResponse, err error) {
