...
// GetDriveRootListItem - Get listItem from users. For drives in SharePoint, the associated document library list item.
// Read-only. Nullable.
func (c DriveRootListItemClient) GetDriveRootListItem(ctx context.Context, id stable.UserIdDriveId, options GetDriveRootListItemOperationOptions) (result GetDriveRootListItemOperationResponse, err error) {
