...
// GetDriveRootListItemAnalytic - Get analytics from users. Analytics about the view activities that took place on this
// item.
func (c DriveRootListItemAnalyticsClient) GetDriveRootListItemAnalytic(ctx context.Context, id stable.UserIdDriveId, options GetDriveRootListItemAnalyticOperationOptions) (result GetDriveRootListItemAnalyticOperationResponse, err error) {
