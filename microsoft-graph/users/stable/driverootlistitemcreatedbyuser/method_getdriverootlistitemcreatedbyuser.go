...
// GetDriveRootListItemCreatedByUser - Get createdByUser from users. Identity of the user who created the item.
// Read-only.
func (c DriveRootListItemCreatedByUserClient) GetDriveRootListItemCreatedByUser(ctx context.Context, id stable.UserIdDriveId, options GetDriveRootListItemCreatedByUserOperationOptions) (result GetDriveRootListItemCreatedByUserOperationResponse, err error) {
