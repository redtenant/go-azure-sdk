...
type UpdateDriveRootListItemCreatedByUserMailboxSettingOperationResponse struct {
...
func (c DriveRootListItemCreatedByUserMailboxSettingClient) UpdateDriveRootListItemCreatedByUserMailboxSetting(ctx context.Context, id stable.UserIdDriveId, input stable.MailboxSettings, options UpdateDriveRootListItemCreatedByUserMailboxSettingOperationOptions) (result UpdateDriveRootListItemCreatedByUserMailboxSettingOperationResponse, err error) {
