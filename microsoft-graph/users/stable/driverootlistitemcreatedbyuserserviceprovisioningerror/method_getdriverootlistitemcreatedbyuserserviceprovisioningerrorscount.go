...
type GetDriveRootListItemCreatedByUserServiceProvisioningErrorsCountOperationResponse struct {
	HttpResponse *http.Response
	OData        *odata.OData
	Model        *[]byte
}

type GetDriveRootListItemCreatedByUserServiceProvisioningErrorsCountOperationOptions struct {
	Filter    *string
...
func DefaultGetDriveRootListItemCreatedByUserServiceProvisioningErrorsCountOperationOptions() GetDriveRootListItemCreatedByUserServiceProvisioningErrorsCountOperationOptions {
	return GetDriveRootListItemCreatedByUserServiceProvisioningErrorsCountOperationOptions{}
}
...
func (c DriveRootListItemCreatedByUserServiceProvisioningErrorClient) GetDriveRootListItemCreatedByUserServiceProvisioningErrorsCount(ctx context.Context, id stable.UserIdDriveId, options GetDriveRootListItemCreatedByUserServiceProvisioningErrorsCountOperationOptions) (result GetDriveRootListItemCreatedByUserServiceProvisioningErrorsCountOperationResponse, err error) {
	opts := client.RequestOptions{
		...
		Path:          fmt.Sprintf("%s/root/listItem/createdByUser/serviceProvisioningErrors/$count", id.ID()),
