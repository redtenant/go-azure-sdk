...
// GetDriveRootListItemDocumentSetVersion - Get documentSetVersions from users. Version information for a document set
// version created by a user.
func (c DriveRootListItemDocumentSetVersionClient) GetDriveRootListItemDocumentSetVersion(ctx context.Context, id stable.UserIdDriveIdRootListItemDocumentSetVersionId, options GetDriveRootListItemDocumentSetVersionOperationOptions) (result GetDriveRootListItemDocumentSetVersionOperationResponse, err error) {
