...
func (c DriveRootListItemDocumentSetVersionClient) GetDriveRootListItemDocumentSetVersionsCount(ctx context.Context, id stable.UserIdDriveId, options GetDriveRootListItemDocumentSetVersionsCountOperationOptions) (result GetDriveRootListItemDocumentSetVersionsCountOperationResponse, err error) {
