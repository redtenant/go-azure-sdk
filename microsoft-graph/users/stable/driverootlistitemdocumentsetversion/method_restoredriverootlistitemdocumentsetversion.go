...
func (c DriveRootListItemDocumentSetVersionClient) RestoreDriveRootListItemDocumentSetVersion(ctx context.Context, id stable.UserIdDriveIdRootListItemDocumentSetVersionId, options RestoreDriveRootListItemDocumentSetVersionOperationOptions) (result RestoreDriveRootListItemDocumentSetVersionOperationResponse, err error) {
