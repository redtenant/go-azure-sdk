...
func (c DriveRootListItemDocumentSetVersionFieldClient) DeleteDriveRootListItemDocumentSetVersionField(ctx context.Context, id stable.UserIdDriveIdRootListItemDocumentSetVersionId, options DeleteDriveRootListItemDocumentSetVersionFieldOperationOptions) (result DeleteDriveRootListItemDocumentSetVersionFieldOperationResponse, err error) {
