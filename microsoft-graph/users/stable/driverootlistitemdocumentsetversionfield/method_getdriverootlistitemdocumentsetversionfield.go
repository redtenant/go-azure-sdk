...
func (c DriveRootListItemDocumentSetVersionFieldClient) GetDriveRootListItemDocumentSetVersionField(ctx context.Context, id stable.UserIdDriveIdRootListItemDocumentSetVersionId, options GetDriveRootListItemDocumentSetVersionFieldOperationOptions) (result GetDriveRootListItemDocumentSetVersionFieldOperationResponse, err error) {
