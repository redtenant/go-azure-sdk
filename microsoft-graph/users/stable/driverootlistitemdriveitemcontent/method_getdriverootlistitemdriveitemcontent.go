...
func (c DriveRootListItemDriveItemContentClient) GetDriveRootListItemDriveItemContent(ctx context.Context, id stable.UserIdDriveId, options GetDriveRootListItemDriveItemContentOperationOptions) (result GetDriveRootListItemDriveItemContentOperationResponse, err error) {
