...
func (c DriveRootListItemFieldClient) DeleteDriveRootListItemField(ctx context.Context, id stable.UserIdDriveId, options DeleteDriveRootListItemFieldOperationOptions) (result DeleteDriveRootListItemFieldOperationResponse, err error) {
