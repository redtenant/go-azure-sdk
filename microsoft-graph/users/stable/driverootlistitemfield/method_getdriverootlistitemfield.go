...
func (c DriveRootListItemFieldClient) GetDriveRootListItemField(ctx context.Context, id stable.UserIdDriveId, options GetDriveRootListItemFieldOperationOptions) (result GetDriveRootListItemFieldOperationResponse, err error) {
