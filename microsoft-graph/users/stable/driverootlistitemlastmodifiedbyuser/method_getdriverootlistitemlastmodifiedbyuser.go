...
// GetDriveRootListItemLastModifiedByUser - Get lastModifiedByUser from users. Identity of the user who last modified
// the item. Read-only.
func (c DriveRootListItemLastModifiedByUserClient) GetDriveRootListItemLastModifiedByUser(ctx context.Context, id stable.UserIdDriveId, options GetDriveRootListItemLastModifiedByUserOperationOptions) (result GetDriveRootListItemLastModifiedByUserOperationResponse, err error) {
