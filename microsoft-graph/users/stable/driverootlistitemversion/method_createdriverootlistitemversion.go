...
func (c DriveRootListItemVersionClient) CreateDriveRootListItemVersion(ctx context.Context, id stable.UserIdDriveId, input stable.ListItemVersion, options CreateDriveRootListItemVersionOperationOptions) (result CreateDriveRootListItemVersionOperationResponse, err error) {
