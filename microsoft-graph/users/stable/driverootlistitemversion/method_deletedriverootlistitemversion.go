...
func (c DriveRootListItemVersionClient) DeleteDriveRootListItemVersion(ctx context.Context, id stable.UserIdDriveIdRootListItemVersionId, options DeleteDriveRootListItemVersionOperationOptions) (result DeleteDriveRootListItemVersionOperationResponse, err error) {
