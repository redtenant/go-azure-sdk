...
func (c DriveRootListItemVersionClient) GetDriveRootListItemVersion(ctx context.Context, id stable.UserIdDriveIdRootListItemVersionId, options GetDriveRootListItemVersionOperationOptions) (result GetDriveRootListItemVersionOperationResponse, err error) {
