...
func DefaultDeleteDriveRootPermissionOperationOptions() DeleteDriveRootPermissionOperationOptions {
	return DeleteDriveRootPermissionOperationOptions{}
}
...
// DeleteDriveRootPermission - Delete navigation property permissions for users
func (c DriveRootPermissionClient) DeleteDriveRootPermission(ctx context.Context, id stable.UserIdDriveIdRootPermissionId, options DeleteDriveRootPermissionOperationOptions) (result DeleteDriveRootPermissionOperationResponse, err error) {
