...
// GetDriveRootPermission - Get permissions from users. The set of permissions for the item. Read-only. Nullable.
func (c DriveRootPermissionClient) GetDriveRootPermission(ctx context.Context, id stable.UserIdDriveIdRootPermissionId, options GetDriveRootPermissionOperationOptions) (result GetDriveRootPermissionOperationResponse, err error) {
