...
func DefaultGetDriveRootPermissionsCountOperationOptions() GetDriveRootPermissionsCountOperationOptions {
	return GetDriveRootPermissionsCountOperationOptions{}
}
...
func (c DriveRootPermissionClient) GetDriveRootPermissionsCount(ctx context.Context, id stable.UserIdDriveId, options GetDriveRootPermissionsCountOperationOptions) (result GetDriveRootPermissionsCountOperationResponse, err error) {
	opts := client.RequestOptions{
		...
		Path:          fmt.Sprintf("%s/root/permissions/$count", id.ID()),
