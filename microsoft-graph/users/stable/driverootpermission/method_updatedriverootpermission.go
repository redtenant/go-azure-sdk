...
func (c DriveRootPermissionClient) UpdateDriveRootPermission(ctx context.Context, id stable.UserIdDriveIdRootPermissionId, input stable.Permission, options UpdateDriveRootPermissionOperationOptions) (result UpdateDriveRootPermissionOperationResponse, err error) {
