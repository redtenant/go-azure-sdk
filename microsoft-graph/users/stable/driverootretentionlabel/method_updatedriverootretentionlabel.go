...
// UpdateDriveRootRetentionLabel - Update the navigation property retentionLabel in users
func (c DriveRootRetentionLabelClient) UpdateDriveRootRetentionLabel(ctx context.Context, id stable.UserIdDriveId, input stable.ItemRetentionLabel, options UpdateDriveRootRetentionLabelOperationOptions) (result UpdateDriveRootRetentionLabelOperationResponse, err error) {
