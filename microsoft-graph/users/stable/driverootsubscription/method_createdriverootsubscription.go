...
func (c DriveRootSubscriptionClient) CreateDriveRootSubscription(ctx context.Context, id stable.UserIdDriveId, input stable.Subscription, options CreateDriveRootSubscriptionOperationOptions) (result CreateDriveRootSubscriptionOperationResponse, err error) {
