...
func (c DriveRootSubscriptionClient) DeleteDriveRootSubscription(ctx context.Context, id stable.UserIdDriveIdRootSubscriptionId, options DeleteDriveRootSubscriptionOperationOptions) (result DeleteDriveRootSubscriptionOperationResponse, err error) {
