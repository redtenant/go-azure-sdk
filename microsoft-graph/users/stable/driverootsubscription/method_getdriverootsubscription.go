...
// GetDriveRootSubscription - Get subscriptions from users. The set of subscriptions on the item. Only supported on the
// root of a drive.
func (c DriveRootSubscriptionClient) GetDriveRootSubscription(ctx context.Context, id stable.UserIdDriveIdRootSubscriptionId, options GetDriveRootSubscriptionOperationOptions) (result GetDriveRootSubscriptionOperationResponse, err error) {
