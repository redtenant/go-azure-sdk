...
func (c DriveRootSubscriptionClient) GetDriveRootSubscriptionsCount(ctx context.Context, id stable.UserIdDriveId, options GetDriveRootSubscriptionsCountOperationOptions) (result GetDriveRootSubscriptionsCountOperationResponse, err error) {
