...
func (c DriveRootThumbnailClient) CreateDriveRootThumbnail(ctx context.Context, id stable.UserIdDriveId, input stable.ThumbnailSet, options CreateDriveRootThumbnailOperationOptions) (result CreateDriveRootThumbnailOperationResponse, err error) {
