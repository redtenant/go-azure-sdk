...
func (c DriveRootThumbnailClient) DeleteDriveRootThumbnail(ctx context.Context, id stable.UserIdDriveIdRootThumbnailId, options DeleteDriveRootThumbnailOperationOptions) (result DeleteDriveRootThumbnailOperationResponse, err error) {
