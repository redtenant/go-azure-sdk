...
func (c DriveRootThumbnailClient) UpdateDriveRootThumbnail(ctx context.Context, id stable.UserIdDriveIdRootThumbnailId, input stable.ThumbnailSet, options UpdateDriveRootThumbnailOperationOptions) (result UpdateDriveRootThumbnailOperationResponse, err error) {
