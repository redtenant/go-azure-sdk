...
func DefaultCreateDriveRootVersionOperationOptions() CreateDriveRootVersionOperationOptions {
	return CreateDriveRootVersionOperationOptions{}
}
...
// CreateDriveRootVersion - Create new navigation property to versions for users
func (c DriveRootVersionClient) CreateDriveRootVersion(ctx context.Context, id stable.UserIdDriveId, input stable.DriveItemVersion, options CreateDriveRootVersionOperationOptions) (result CreateDriveRootVersionOperationResponse, err error) {
