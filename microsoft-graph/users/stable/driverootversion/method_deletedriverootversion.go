...
func DefaultDeleteDriveRootVersionOperationOptions() DeleteDriveRootVersionOperationOptions {
	return DeleteDriveRootVersionOperationOptions{}
}
...
// DeleteDriveRootVersion - Delete navigation property versions for users
func (c DriveRootVersionClient) DeleteDriveRootVersion(ctx context.Context, id stable.UserIdDriveIdRootVersionId, options DeleteDriveRootVersionOperationOptions) (result DeleteDriveRootVersionOperationResponse, err error) {
