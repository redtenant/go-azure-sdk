...
func (c DriveRootVersionClient) GetDriveRootVersion(ctx context.Context, id stable.UserIdDriveIdRootVersionId, options GetDriveRootVersionOperationOptions) (result GetDriveRootVersionOperationResponse, err error) {
