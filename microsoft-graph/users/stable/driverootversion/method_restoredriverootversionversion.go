...
func (c DriveRootVersionClient) RestoreDriveRootVersionVersion(ctx context.Context, id stable.UserIdDriveIdRootVersionId, options RestoreDriveRootVersionVersionOperationOptions) (result RestoreDriveRootVersionVersionOperationResponse, err error) {
