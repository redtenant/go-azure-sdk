...
// UpdateDriveRootVersion - Update the navigation property versions in users
func (c DriveRootVersionClient) UpdateDriveRootVersion(ctx context.Context, id stable.UserIdDriveIdRootVersionId, input stable.DriveItemVersion, options UpdateDriveRootVersionOperationOptions) (result UpdateDriveRootVersionOperationResponse, err error) {
