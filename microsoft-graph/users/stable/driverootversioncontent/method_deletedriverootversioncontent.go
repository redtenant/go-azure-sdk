...
// DeleteDriveRootVersionContent - Delete content for the navigation property versions in users. The content stream for
// this version of the item.
func (c DriveRootVersionContentClient) DeleteDriveRootVersionContent(ctx context.Context, id stable.UserIdDriveIdRootVersionId, options DeleteDriveRootVersionContentOperationOptions) (result DeleteDriveRootVersionContentOperationResponse, err error) {
