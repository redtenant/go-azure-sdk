...
// GetDriveRootVersionContent - Get content for the navigation property versions from users. The content stream for this
// version of the item.
func (c DriveRootVersionContentClient) GetDriveRootVersionContent(ctx context.Context, id stable.UserIdDriveIdRootVersionId, options GetDriveRootVersionContentOperationOptions) (result GetDriveRootVersionContentOperationResponse, err error) {
