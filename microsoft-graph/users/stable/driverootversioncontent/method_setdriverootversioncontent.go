...
// SetDriveRootVersionContent - Update content for the navigation property versions in users. The content stream for
// this version of the item.
func (c DriveRootVersionContentClient) SetDriveRootVersionContent(ctx context.Context, id stable.UserIdDriveIdRootVersionId, input []byte, options SetDriveRootVersionContentOperationOptions) (result SetDriveRootVersionContentOperationResponse, err error) {
