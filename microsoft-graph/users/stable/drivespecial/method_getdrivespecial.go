...
func (c DriveSpecialClient) GetDriveSpecial(ctx context.Context, id stable.UserIdDriveIdSpecialId, options GetDriveSpecialOperationOptions) (result GetDriveSpecialOperationResponse, err error) {
