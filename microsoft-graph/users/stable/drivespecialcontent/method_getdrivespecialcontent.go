...
// represents a file.
func (c DriveSpecialContentClient) GetDriveSpecialContent(ctx context.Context, id stable.UserIdDriveIdSpecialId, options GetDriveSpecialContentOperationOptions) (result GetDriveSpecialContentOperationResponse, err error) {
