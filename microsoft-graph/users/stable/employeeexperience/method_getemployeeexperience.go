...
// GetEmployeeExperience - Get employeeExperience from users
func (c EmployeeExperienceClient) GetEmployeeExperience(ctx context.Context, id stable.UserId, options GetEmployeeExperienceOperationOptions) (result GetEmployeeExperienceOperationResponse, err error) {
