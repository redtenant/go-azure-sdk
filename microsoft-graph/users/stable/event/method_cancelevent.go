...
func (c EventClient) CancelEvent(ctx context.Context, id stable.UserIdEventId, input CancelEventRequest, options CancelEventOperationOptions) (result CancelEventOperationResponse, err error) {
