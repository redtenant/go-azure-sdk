...
func (c EventClient) CreateEvent(ctx context.Context, id stable.UserId, input stable.Event, options CreateEventOperationOptions) (result CreateEventOperationResponse, err error) {
