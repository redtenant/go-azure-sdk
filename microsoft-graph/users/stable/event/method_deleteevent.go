...
// DeleteEvent - Delete navigation property events for users
func (c EventClient) DeleteEvent(ctx context.Context, id stable.UserIdEventId, options DeleteEventOperationOptions) (result DeleteEventOperationResponse, err error) {
