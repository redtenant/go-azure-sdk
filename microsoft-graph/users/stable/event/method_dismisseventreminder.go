...
// user calendar.
func (c EventClient) DismissEventReminder(ctx context.Context, id stable.UserIdEventId, options DismissEventReminderOperationOptions) (result DismissEventReminderOperationResponse, err error) {
