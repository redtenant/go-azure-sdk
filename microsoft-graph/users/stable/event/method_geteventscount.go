...
func (c EventClient) GetEventsCount(ctx context.Context, id stable.UserId, options GetEventsCountOperationOptions) (result GetEventsCountOperationResponse, err error) {
