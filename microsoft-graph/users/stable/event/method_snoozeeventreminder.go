...
// time.
func (c EventClient) SnoozeEventReminder(ctx context.Context, id stable.UserIdEventId, input SnoozeEventReminderRequest, options SnoozeEventReminderOperationOptions) (result SnoozeEventReminderOperationResponse, err error) {
