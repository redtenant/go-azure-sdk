...
func (c EventClient) TentativelyAcceptEvent(ctx context.Context, id stable.UserIdEventId, input TentativelyAcceptEventRequest, options TentativelyAcceptEventOperationOptions) (result TentativelyAcceptEventOperationResponse, err error) {
