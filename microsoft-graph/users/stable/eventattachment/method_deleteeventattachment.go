...
// DeleteEventAttachment - Delete navigation property attachments for users
func (c EventAttachmentClient) DeleteEventAttachment(ctx context.Context, id stable.UserIdEventIdAttachmentId, options DeleteEventAttachmentOperationOptions) (result DeleteEventAttachmentOperationResponse, err error) {
