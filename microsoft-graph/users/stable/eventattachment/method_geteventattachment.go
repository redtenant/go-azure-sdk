...
// GetEventAttachment - Get attachments from users. The collection of FileAttachment, ItemAttachment, and
// referenceAttachment attachments for the event. Navigation property. Read-only. Nullable.
func (c EventAttachmentClient) GetEventAttachment(ctx context.Context, id stable.UserIdEventIdAttachmentId, options GetEventAttachmentOperationOptions) (result GetEventAttachmentOperationResponse, err error) {
