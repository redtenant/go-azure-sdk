...
// ListEventAttachments - Get attachments from users. The collection of FileAttachment, ItemAttachment, and
// referenceAttachment attachments for the event. Navigation property. Read-only. Nullable.
func (c EventAttachmentClient) ListEventAttachments(ctx context.Context, id stable.UserIdEventId, options ListEventAttachmentsOperationOptions) (result ListEventAttachmentsOperationResponse, err error) {
...
func (c EventAttachmentClient) ListEventAttachmentsComplete(ctx context.Context, id stable.UserIdEventId, options ListEventAttachmentsOperationOptions) (ListEventAttachmentsCompleteResult, error) {
...
func (c EventAttachmentClient) ListEventAttachmentsCompleteMatchingPredicate(ctx context.Context, id stable.UserIdEventId, options ListEventAttachmentsOperationOptions, predicate AttachmentOperationPredicate) (result ListEventAttachmentsCompleteResult, err error) {
