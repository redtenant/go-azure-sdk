...
// GetEventCalendar - Get calendar from users. The calendar that contains the event. Navigation property. Read-only.
func (c EventCalendarClient) GetEventCalendar(ctx context.Context, id stable.UserIdEventId, options GetEventCalendarOperationOptions) (result GetEventCalendarOperationResponse, err error) {
