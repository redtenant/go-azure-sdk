...
// CreateEventExtension - Create new navigation property to extensions for users
func (c EventExtensionClient) CreateEventExtension(ctx context.Context, id stable.UserIdEventId, input stable.Extension, options CreateEventExtensionOperationOptions) (result CreateEventExtensionOperationResponse, err error) {
