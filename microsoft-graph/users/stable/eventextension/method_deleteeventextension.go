...
// DeleteEventExtension - Delete navigation property extensions for users
func (c EventExtensionClient) DeleteEventExtension(ctx context.Context, id stable.UserIdEventIdExtensionId, options DeleteEventExtensionOperationOptions) (result DeleteEventExtensionOperationResponse, err error) {
