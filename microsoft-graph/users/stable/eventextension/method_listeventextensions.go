...
// ListEventExtensions - Get extensions from users. The collection of open extensions defined for the event. Nullable.
func (c EventExtensionClient) ListEventExtensions(ctx context.Context, id stable.UserIdEventId, options ListEventExtensionsOperationOptions) (result ListEventExtensionsOperationResponse, err error) {
...
func (c EventExtensionClient) ListEventExtensionsComplete(ctx context.Context, id stable.UserIdEventId, options ListEventExtensionsOperationOptions) (ListEventExtensionsCompleteResult, error) {
...
func (c EventExtensionClient) ListEventExtensionsCompleteMatchingPredicate(ctx context.Context, id stable.UserIdEventId, options ListEventExtensionsOperationOptions, predicate ExtensionOperationPredicate) (result ListEventExtensionsCompleteResult, err error) {
