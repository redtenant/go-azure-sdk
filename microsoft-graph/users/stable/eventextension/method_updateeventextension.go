...
// UpdateEventExtension - Update the navigation property extensions in users
func (c EventExtensionClient) UpdateEventExtension(ctx context.Context, id stable.UserIdEventIdExtensionId, input stable.Extension, options UpdateEventExtensionOperationOptions) (result UpdateEventExtensionOperationResponse, err error) {
