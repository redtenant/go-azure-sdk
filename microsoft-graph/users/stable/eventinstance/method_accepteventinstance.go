...
func (c EventInstanceClient) AcceptEventInstance(ctx context.Context, id stable.UserIdEventIdInstanceId, input AcceptEventInstanceRequest, options AcceptEventInstanceOperationOptions) (result AcceptEventInstanceOperationResponse, err error) {
