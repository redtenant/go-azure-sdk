...
func (c EventInstanceClient) CancelEventInstance(ctx context.Context, id stable.UserIdEventIdInstanceId, input CancelEventInstanceRequest, options CancelEventInstanceOperationOptions) (result CancelEventInstanceOperationResponse, err error) {
