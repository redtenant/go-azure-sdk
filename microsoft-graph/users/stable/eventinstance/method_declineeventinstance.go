...
func (c EventInstanceClient) DeclineEventInstance(ctx context.Context, id stable.UserIdEventIdInstanceId, input DeclineEventInstanceRequest, options DeclineEventInstanceOperationOptions) (result DeclineEventInstanceOperationResponse, err error) {
