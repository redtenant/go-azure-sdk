...
func (c EventInstanceClient) GetEventInstance(ctx context.Context, id stable.UserIdEventIdInstanceId, options GetEventInstanceOperationOptions) (result GetEventInstanceOperationResponse, err error) {
