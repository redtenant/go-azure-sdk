...
func (c EventInstanceClient) GetEventInstancesCount(ctx context.Context, id stable.UserIdEventId, options GetEventInstancesCountOperationOptions) (result GetEventInstancesCountOperationResponse, err error) {
