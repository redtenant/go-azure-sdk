...
func (c EventInstanceClient) ListEventInstancesComplete(ctx context.Context, id stable.UserIdEventId, options ListEventInstancesOperationOptions) (ListEventInstancesCompleteResult, error) {
...
func (c EventInstanceClient) ListEventInstancesCompleteMatchingPredicate(ctx context.Context, id stable.UserIdEventId, options ListEventInstancesOperationOptions, predicate EventOperationPredicate) (result ListEventInstancesCompleteResult, err error) {
