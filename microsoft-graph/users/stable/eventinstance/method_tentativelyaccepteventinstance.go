...
func (c EventInstanceClient) TentativelyAcceptEventInstance(ctx context.Context, id stable.UserIdEventIdInstanceId, input TentativelyAcceptEventInstanceRequest, options TentativelyAcceptEventInstanceOperationOptions) (result TentativelyAcceptEventInstanceOperationResponse, err error) {
