...
func (c EventInstanceAttachmentClient) CreateEventInstanceAttachmentsUploadSession(ctx context.Context, id stable.UserIdEventIdInstanceId, input CreateEventInstanceAttachmentsUploadSessionRequest, options CreateEventInstanceAttachmentsUploadSessionOperationOptions) (result CreateEventInstanceAttachmentsUploadSessionOperationResponse, err error) {
