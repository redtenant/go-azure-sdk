...
func (c EventInstanceAttachmentClient) GetEventInstanceAttachmentsCount(ctx context.Context, id stable.UserIdEventIdInstanceId, options GetEventInstanceAttachmentsCountOperationOptions) (result GetEventInstanceAttachmentsCountOperationResponse, err error) {
