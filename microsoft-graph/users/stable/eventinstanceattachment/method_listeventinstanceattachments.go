...
// ListEventInstanceAttachments - Get attachments from users. The collection of FileAttachment, ItemAttachment, and
// referenceAttachment attachments for the event. Navigation property. Read-only. Nullable.
func (c EventInstanceAttachmentClient) ListEventInstanceAttachments(ctx context.Context, id stable.UserIdEventIdInstanceId, options ListEventInstanceAttachmentsOperationOptions) (result ListEventInstanceAttachmentsOperationResponse, err error) {
...
func (c EventInstanceAttachmentClient) ListEventInstanceAttachmentsComplete(ctx context.Context, id stable.UserIdEventIdInstanceId, options ListEventInstanceAttachmentsOperationOptions) (ListEventInstanceAttachmentsCompleteResult, error) {
...
func (c EventInstanceAttachmentClient) ListEventInstanceAttachmentsCompleteMatchingPredicate(ctx context.Context, id stable.UserIdEventIdInstanceId, options ListEventInstanceAttachmentsOperationOptions, predicate AttachmentOperationPredicate) (result ListEventInstanceAttachmentsCompleteResult, err error) {
