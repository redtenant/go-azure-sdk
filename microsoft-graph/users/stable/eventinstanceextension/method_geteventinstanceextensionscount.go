...
func (c EventInstanceExtensionClient) GetEventInstanceExtensionsCount(ctx context.Context, id stable.UserIdEventIdInstanceId, options GetEventInstanceExtensionsCountOperationOptions) (result GetEventInstanceExtensionsCountOperationResponse, err error) {
