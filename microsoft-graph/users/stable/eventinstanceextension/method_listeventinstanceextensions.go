...
// ListEventInstanceExtensions - Get extensions from users. The collection of open extensions defined for the event.
// Nullable.
func (c EventInstanceExtensionClient) ListEventInstanceExtensions(ctx context.Context, id stable.UserIdEventIdInstanceId, options ListEventInstanceExtensionsOperationOptions) (result ListEventInstanceExtensionsOperationResponse, err error) {
...
func (c EventInstanceExtensionClient) ListEventInstanceExtensionsComplete(ctx context.Context, id stable.UserIdEventIdInstanceId, options ListEventInstanceExtensionsOperationOptions) (ListEventInstanceExtensionsCompleteResult, error) {
...
func (c EventInstanceExtensionClient) ListEventInstanceExtensionsCompleteMatchingPredicate(ctx context.Context, id stable.UserIdEventIdInstanceId, options ListEventInstanceExtensionsOperationOptions, predicate ExtensionOperationPredicate) (result ListEventInstanceExtensionsCompleteResult, err error) {
