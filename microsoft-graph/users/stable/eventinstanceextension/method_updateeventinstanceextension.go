...
func (c EventInstanceExtensionClient) UpdateEventInstanceExtension(ctx context.Context, id stable.UserIdEventIdInstanceIdExtensionId, input stable.Extension, options UpdateEventInstanceExtensionOperationOptions) (result UpdateEventInstanceExtensionOperationResponse, err error) {
