...
// CreateExtension - Create new navigation property to extensions for users
func (c ExtensionClient) CreateExtension(ctx context.Context, id stable.UserId, input stable.Extension, options CreateExtensionOperationOptions) (result CreateExtensionOperationResponse, err error) {
