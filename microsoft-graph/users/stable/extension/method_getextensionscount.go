...
func (c ExtensionClient) GetExtensionsCount(ctx context.Context, id stable.UserId, options GetExtensionsCountOperationOptions) (result GetExtensionsCountOperationResponse, err error) {
