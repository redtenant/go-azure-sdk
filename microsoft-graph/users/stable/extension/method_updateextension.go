...
// UpdateExtension - Update the navigation property extensions in users
func (c ExtensionClient) UpdateExtension(ctx context.Context, id stable.UserIdExtensionId, input stable.Extension, options UpdateExtensionOperationOptions) (result UpdateExtensionOperationResponse, err error) {
