...
func (c InferenceClassificationClient) GetInferenceClassification(ctx context.Context, id stable.UserId, options GetInferenceClassificationOperationOptions) (result GetInferenceClassificationOperationResponse, err error) {
