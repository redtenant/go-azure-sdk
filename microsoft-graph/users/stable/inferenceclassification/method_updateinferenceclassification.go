...
func (c InferenceClassificationClient) UpdateInferenceClassification(ctx context.Context, id stable.UserId, input stable.InferenceClassification, options UpdateInferenceClassificationOperationOptions) (result UpdateInferenceClassificationOperationResponse, err error) {
