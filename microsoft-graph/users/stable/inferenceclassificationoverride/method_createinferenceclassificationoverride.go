...
func (c InferenceClassificationOverrideClient) CreateInferenceClassificationOverride(ctx context.Context, id stable.UserId, input stable.InferenceClassificationOverride, options CreateInferenceClassificationOverrideOperationOptions) (result CreateInferenceClassificationOverrideOperationResponse, err error) {
