...
type ListInferenceClassificationOverridesCompleteResult struct {
	...
	Items              []stable.InferenceClassificationOverride
}
...
// ListInferenceClassificationOverrides - Get overrides from users. A set of overrides for a user to always classify
// messages from specific senders in certain ways: focused, or other. Read-only. Nullable.
func (c InferenceClassificationOverrideClient) ListInferenceClassificationOverrides(ctx context.Context, id stable.UserId, options ListInferenceClassificationOverridesOperationOptions) (result ListInferenceClassificationOverridesOperationResponse, err error) {
	...
	var values struct {
		Values *[]stable.InferenceClassificationOverride `json:"value"`
	}
...
func (c InferenceClassificationOverrideClient) ListInferenceClassificationOverridesComplete(ctx context.Context, id stable.UserId, options ListInferenceClassificationOverridesOperationOptions) (ListInferenceClassificationOverridesCompleteResult, error) {
	return c.ListInferenceClassificationOverridesCompleteMatchingPredicate(ctx, id, options, InferenceClassificationOverrideOperationPredicate{})
}

// ListInferenceClassificationOverridesCompleteMatchingPredicate retrieves all the results and then applies the predicate
func (c InferenceClassificationOverrideClient) ListInferenceClassificationOverridesCompleteMatchingPredicate(ctx context.Context, id stable.UserId, options ListInferenceClassificationOverridesOperationOptions, predicate InferenceClassificationOverrideOperationPredicate) (result ListInferenceClassificationOverridesCompleteResult, err error) {
	items := make([]stable.InferenceClassificationOverride, 0)

	resp, err := c.ListInferenceClassificationOverrides(ctx, id, options)
	if err != nil {
