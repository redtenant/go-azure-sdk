...
func DefaultDeleteInsightOperationOptions() DeleteInsightOperationOptions {
	return DeleteInsightOperationOptions{}
}
...
// DeleteInsight - Delete navigation property insights for users
func (c InsightClient) DeleteInsight(ctx context.Context, id stable.UserId, options DeleteInsightOperationOptions) (result DeleteInsightOperationResponse, err error) {
