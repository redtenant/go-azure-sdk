...
func DefaultDeleteInsightUsedOperationOptions() DeleteInsightUsedOperationOptions {
	return DeleteInsightUsedOperationOptions{}
}
...
// DeleteInsightUsed - Delete navigation property used for users
func (c InsightUsedClient) DeleteInsightUsed(ctx context.Context, id stable.UserIdInsightUsedId, options DeleteInsightUsedOperationOptions) (result DeleteInsightUsedOperationResponse, err error) {
