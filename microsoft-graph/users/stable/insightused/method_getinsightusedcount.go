...
func (c InsightUsedClient) GetInsightUsedCount(ctx context.Context, id stable.UserId, options GetInsightUsedCountOperationOptions) (result GetInsightUsedCountOperationResponse, err error) {
