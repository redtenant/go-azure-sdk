...
func DefaultGetJoinedTeamAllChannelOperationOptions() GetJoinedTeamAllChannelOperationOptions {
	return GetJoinedTeamAllChannelOperationOptions{}
}
...
// GetJoinedTeamAllChannel - Get allChannels from users. List of channels either hosted in or shared with the team
// (incoming channels).
func (c JoinedTeamAllChannelClient) GetJoinedTeamAllChannel(ctx context.Context, id stable.UserIdJoinedTeamIdAllChannelId, options GetJoinedTeamAllChannelOperationOptions) (result GetJoinedTeamAllChannelOperationResponse, err error) {
