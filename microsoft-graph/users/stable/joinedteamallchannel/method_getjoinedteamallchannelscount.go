...
func DefaultGetJoinedTeamAllChannelsCountOperationOptions() GetJoinedTeamAllChannelsCountOperationOptions {
	return GetJoinedTeamAllChannelsCountOperationOptions{}
}
...
func (c JoinedTeamAllChannelClient) GetJoinedTeamAllChannelsCount(ctx context.Context, id stable.UserIdJoinedTeamId, options GetJoinedTeamAllChannelsCountOperationOptions) (result GetJoinedTeamAllChannelsCountOperationResponse, err error) {
	opts := client.RequestOptions{
		...
		Path:          fmt.Sprintf("%s/allChannels/$count", id.ID()),
