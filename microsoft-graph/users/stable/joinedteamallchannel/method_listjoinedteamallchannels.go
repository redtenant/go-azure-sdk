...
func DefaultListJoinedTeamAllChannelsOperationOptions() ListJoinedTeamAllChannelsOperationOptions {
	return ListJoinedTeamAllChannelsOperationOptions{}
}
...
// ListJoinedTeamAllChannels - Get allChannels from users. List of channels either hosted in or shared with the team
// (incoming channels).
func (c JoinedTeamAllChannelClient) ListJoinedTeamAllChannels(ctx context.Context, id stable.UserIdJoinedTeamId, options ListJoinedTeamAllChannelsOperationOptions) (result ListJoinedTeamAllChannelsOperationResponse, err error) {
...
func (c JoinedTeamAllChannelClient) ListJoinedTeamAllChannelsComplete(ctx context.Context, id stable.UserIdJoinedTeamId, options ListJoinedTeamAllChannelsOperationOptions) (ListJoinedTeamAllChannelsCompleteResult, error) {
	return c.ListJoinedTeamAllChannelsCompleteMatchingPredicate(ctx, id, options, ChannelOperationPredicate{})
}

// ListJoinedTeamAllChannelsCompleteMatchingPredicate retrieves all the results and then applies the predicate
func (c JoinedTeamAllChannelClient) ListJoinedTeamAllChannelsCompleteMatchingPredicate(ctx context.Context, id stable.UserIdJoinedTeamId, options ListJoinedTeamAllChannelsOperationOptions, predicate ChannelOperationPredicate) (result ListJoinedTeamAllChannelsCompleteResult, err error) {
	items := make([]stable.Channel, 0)

	resp, err := c.ListJoinedTeamAllChannels(ctx, id, options)
	if err != nil {
