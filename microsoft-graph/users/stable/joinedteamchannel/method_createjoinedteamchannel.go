...
func (c JoinedTeamChannelClient) CreateJoinedTeamChannel(ctx context.Context, id stable.UserIdJoinedTeamId, input stable.Channel, options CreateJoinedTeamChannelOperationOptions) (result CreateJoinedTeamChannelOperationResponse, err error) {
