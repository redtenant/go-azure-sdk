...
func (c JoinedTeamChannelClient) DeleteJoinedTeamChannel(ctx context.Context, id stable.UserIdJoinedTeamIdChannelId, options DeleteJoinedTeamChannelOperationOptions) (result DeleteJoinedTeamChannelOperationResponse, err error) {
