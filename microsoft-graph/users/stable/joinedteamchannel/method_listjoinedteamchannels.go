...
func (c JoinedTeamChannelClient) ListJoinedTeamChannels(ctx context.Context, id stable.UserIdJoinedTeamId, options ListJoinedTeamChannelsOperationOptions) (result ListJoinedTeamChannelsOperationResponse, err error) {
...
func (c JoinedTeamChannelClient) ListJoinedTeamChannelsComplete(ctx context.Context, id stable.UserIdJoinedTeamId, options ListJoinedTeamChannelsOperationOptions) (ListJoinedTeamChannelsCompleteResult, error) {
