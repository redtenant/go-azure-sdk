...
// GetJoinedTeamChannelFilesFolderContent - Get content for the navigation property filesFolder from users. The content
// stream, if the item represents a file.
func (c JoinedTeamChannelFilesFolderContentClient) GetJoinedTeamChannelFilesFolderContent(ctx context.Context, id stable.UserIdJoinedTeamIdChannelId, options GetJoinedTeamChannelFilesFolderContentOperationOptions) (result GetJoinedTeamChannelFilesFolderContentOperationResponse, err error) {
