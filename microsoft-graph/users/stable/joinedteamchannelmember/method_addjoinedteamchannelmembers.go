...
func (c JoinedTeamChannelMemberClient) AddJoinedTeamChannelMembers(ctx context.Context, id stable.UserIdJoinedTeamIdChannelId, input AddJoinedTeamChannelMembersRequest, options AddJoinedTeamChannelMembersOperationOptions) (result AddJoinedTeamChannelMembersOperationResponse, err error) {
...
func (c JoinedTeamChannelMemberClient) AddJoinedTeamChannelMembersComplete(ctx context.Context, id stable.UserIdJoinedTeamIdChannelId, input AddJoinedTeamChannelMembersRequest, options AddJoinedTeamChannelMembersOperationOptions) (AddJoinedTeamChannelMembersCompleteResult, error) {
