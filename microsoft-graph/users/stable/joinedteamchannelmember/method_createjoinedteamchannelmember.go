...
func (c JoinedTeamChannelMemberClient) CreateJoinedTeamChannelMember(ctx context.Context, id stable.UserIdJoinedTeamIdChannelId, input stable.ConversationMember, options CreateJoinedTeamChannelMemberOperationOptions) (result CreateJoinedTeamChannelMemberOperationResponse, err error) {
