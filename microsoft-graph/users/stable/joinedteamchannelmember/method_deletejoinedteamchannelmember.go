...
func (c JoinedTeamChannelMemberClient) DeleteJoinedTeamChannelMember(ctx context.Context, id stable.UserIdJoinedTeamIdChannelIdMemberId, options DeleteJoinedTeamChannelMemberOperationOptions) (result DeleteJoinedTeamChannelMemberOperationResponse, err error) {
