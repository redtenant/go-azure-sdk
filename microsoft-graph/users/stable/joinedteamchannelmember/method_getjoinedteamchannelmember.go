...
func (c JoinedTeamChannelMemberClient) GetJoinedTeamChannelMember(ctx context.Context, id stable.UserIdJoinedTeamIdChannelIdMemberId, options GetJoinedTeamChannelMemberOperationOptions) (result GetJoinedTeamChannelMemberOperationResponse, err error) {
