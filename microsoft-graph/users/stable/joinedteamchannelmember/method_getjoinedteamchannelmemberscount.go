...
func DefaultGetJoinedTeamChannelMembersCountOperationOptions() GetJoinedTeamChannelMembersCountOperationOptions {
	return GetJoinedTeamChannelMembersCountOperationOptions{}
}
...
func (c JoinedTeamChannelMemberClient) GetJoinedTeamChannelMembersCount(ctx context.Context, id stable.UserIdJoinedTeamIdChannelId, options GetJoinedTeamChannelMembersCountOperationOptions) (result GetJoinedTeamChannelMembersCountOperationResponse, err error) {
