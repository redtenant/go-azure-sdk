...
func DefaultUpdateJoinedTeamChannelMemberOperationOptions() UpdateJoinedTeamChannelMemberOperationOptions {
	return UpdateJoinedTeamChannelMemberOperationOptions{}
}
...
func (c JoinedTeamChannelMemberClient) UpdateJoinedTeamChannelMember(ctx context.Context, id stable.UserIdJoinedTeamIdChannelIdMemberId, input stable.ConversationMember, options UpdateJoinedTeamChannelMemberOperationOptions) (result UpdateJoinedTeamChannelMemberOperationResponse, err error) {
