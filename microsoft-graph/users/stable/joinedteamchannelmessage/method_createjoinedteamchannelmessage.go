...
// CreateJoinedTeamChannelMessage - Create new navigation property to messages for users
func (c JoinedTeamChannelMessageClient) CreateJoinedTeamChannelMessage(ctx context.Context, id stable.UserIdJoinedTeamIdChannelId, input stable.ChatMessage, options CreateJoinedTeamChannelMessageOperationOptions) (result CreateJoinedTeamChannelMessageOperationResponse, err error) {
