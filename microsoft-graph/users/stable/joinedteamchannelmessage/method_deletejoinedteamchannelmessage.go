...
func DefaultDeleteJoinedTeamChannelMessageOperationOptions() DeleteJoinedTeamChannelMessageOperationOptions {
	return DeleteJoinedTeamChannelMessageOperationOptions{}
}
...
// DeleteJoinedTeamChannelMessage - Delete navigation property messages for users
func (c JoinedTeamChannelMessageClient) DeleteJoinedTeamChannelMessage(ctx context.Context, id stable.UserIdJoinedTeamIdChannelIdMessageId, options DeleteJoinedTeamChannelMessageOperationOptions) (result DeleteJoinedTeamChannelMessageOperationResponse, err error) {
