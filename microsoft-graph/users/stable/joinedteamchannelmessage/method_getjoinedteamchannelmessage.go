...
// GetJoinedTeamChannelMessage - Get messages from users. A collection of all the messages in the channel. A navigation
// property. Nullable.
func (c JoinedTeamChannelMessageClient) GetJoinedTeamChannelMessage(ctx context.Context, id stable.UserIdJoinedTeamIdChannelIdMessageId, options GetJoinedTeamChannelMessageOperationOptions) (result GetJoinedTeamChannelMessageOperationResponse, err error) {
