...
// UpdateJoinedTeamChannelMessage - Update the navigation property messages in users
func (c JoinedTeamChannelMessageClient) UpdateJoinedTeamChannelMessage(ctx context.Context, id stable.UserIdJoinedTeamIdChannelIdMessageId, input stable.ChatMessage, options UpdateJoinedTeamChannelMessageOperationOptions) (result UpdateJoinedTeamChannelMessageOperationResponse, err error) {
