...
type UpdateJoinedTeamChannelMessageHostedContentOperationResponse struct {
...
// UpdateJoinedTeamChannelMessageHostedContent - Update the navigation property hostedContents in users
func (c JoinedTeamChannelMessageHostedContentClient) UpdateJoinedTeamChannelMessageHostedContent(ctx context.Context, id stable.UserIdJoinedTeamIdChannelIdMessageIdHostedContentId, input stable.ChatMessageHostedContent, options UpdateJoinedTeamChannelMessageHostedContentOperationOptions) (result UpdateJoinedTeamChannelMessageHostedContentOperationResponse, err error) {
