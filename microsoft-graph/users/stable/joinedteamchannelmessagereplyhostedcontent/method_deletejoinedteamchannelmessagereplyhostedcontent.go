...
// DeleteJoinedTeamChannelMessageReplyHostedContent - Delete navigation property hostedContents for users
func (c JoinedTeamChannelMessageReplyHostedContentClient) DeleteJoinedTeamChannelMessageReplyHostedContent(ctx context.Context, id stable.UserIdJoinedTeamIdChannelIdMessageIdReplyIdHostedContentId, options DeleteJoinedTeamChannelMessageReplyHostedContentOperationOptions) (result DeleteJoinedTeamChannelMessageReplyHostedContentOperationResponse, err error) {
