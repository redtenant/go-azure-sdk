...
// CreateJoinedTeamChannelTab - Create new navigation property to tabs for users
func (c JoinedTeamChannelTabClient) CreateJoinedTeamChannelTab(ctx context.Context, id stable.UserIdJoinedTeamIdChannelId, input stable.TeamsTab, options CreateJoinedTeamChannelTabOperationOptions) (result CreateJoinedTeamChannelTabOperationResponse, err error) {
