...
// ListJoinedTeamChannelTabs - Get tabs from users. A collection of all the tabs in the channel. A navigation property.
func (c JoinedTeamChannelTabClient) ListJoinedTeamChannelTabs(ctx context.Context, id stable.UserIdJoinedTeamIdChannelId, options ListJoinedTeamChannelTabsOperationOptions) (result ListJoinedTeamChannelTabsOperationResponse, err error) {
...
func (c JoinedTeamChannelTabClient) ListJoinedTeamChannelTabsComplete(ctx context.Context, id stable.UserIdJoinedTeamIdChannelId, options ListJoinedTeamChannelTabsOperationOptions) (ListJoinedTeamChannelTabsCompleteResult, error) {
...
func (c JoinedTeamChannelTabClient) ListJoinedTeamChannelTabsCompleteMatchingPredicate(ctx context.Context, id stable.UserIdJoinedTeamIdChannelId, options ListJoinedTeamChannelTabsOperationOptions, predicate TeamsTabOperationPredicate) (result ListJoinedTeamChannelTabsCompleteResult, err error) {
