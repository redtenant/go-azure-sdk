...
func (c JoinedTeamGroupServiceProvisioningErrorClient) GetJoinedTeamGroupServiceProvisioningErrorsCount(ctx context.Context, id stable.UserIdJoinedTeamId, options GetJoinedTeamGroupServiceProvisioningErrorsCountOperationOptions) (result GetJoinedTeamGroupServiceProvisioningErrorsCountOperationResponse, err error) {
