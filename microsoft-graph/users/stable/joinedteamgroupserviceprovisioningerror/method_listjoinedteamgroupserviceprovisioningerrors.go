...
func (c JoinedTeamGroupServiceProvisioningErrorClient) ListJoinedTeamGroupServiceProvisioningErrors(ctx context.Context, id stable.UserIdJoinedTeamId, options ListJoinedTeamGroupServiceProvisioningErrorsOperationOptions) (result ListJoinedTeamGroupServiceProvisioningErrorsOperationResponse, err error) {
...
func (c JoinedTeamGroupServiceProvisioningErrorClient) ListJoinedTeamGroupServiceProvisioningErrorsComplete(ctx context.Context, id stable.UserIdJoinedTeamId, options ListJoinedTeamGroupServiceProvisioningErrorsOperationOptions) (ListJoinedTeamGroupServiceProvisioningErrorsCompleteResult, error) {
...
func (c JoinedTeamGroupServiceProvisioningErrorClient) ListJoinedTeamGroupServiceProvisioningErrorsCompleteMatchingPredicate(ctx context.Context, id stable.UserIdJoinedTeamId, options ListJoinedTeamGroupServiceProvisioningErrorsOperationOptions, predicate ServiceProvisioningErrorOperationPredicate) (result ListJoinedTeamGroupServiceProvisioningErrorsCompleteResult, err error) {
