...
func (c JoinedTeamInstalledAppClient) DeleteJoinedTeamInstalledApp(ctx context.Context, id stable.UserIdJoinedTeamIdInstalledAppId, options DeleteJoinedTeamInstalledAppOperationOptions) (result DeleteJoinedTeamInstalledAppOperationResponse, err error) {
