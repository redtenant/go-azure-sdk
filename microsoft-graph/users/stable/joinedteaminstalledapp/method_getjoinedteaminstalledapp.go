...
func (c JoinedTeamInstalledAppClient) GetJoinedTeamInstalledApp(ctx context.Context, id stable.UserIdJoinedTeamIdInstalledAppId, options GetJoinedTeamInstalledAppOperationOptions) (result GetJoinedTeamInstalledAppOperationResponse, err error) {
