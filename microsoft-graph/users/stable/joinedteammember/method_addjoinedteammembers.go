...
func (c JoinedTeamMemberClient) AddJoinedTeamMembers(ctx context.Context, id stable.UserIdJoinedTeamId, input AddJoinedTeamMembersRequest, options AddJoinedTeamMembersOperationOptions) (result AddJoinedTeamMembersOperationResponse, err error) {
...
func (c JoinedTeamMemberClient) AddJoinedTeamMembersComplete(ctx context.Context, id stable.UserIdJoinedTeamId, input AddJoinedTeamMembersRequest, options AddJoinedTeamMembersOperationOptions) (AddJoinedTeamMembersCompleteResult, error) {
...
func (c JoinedTeamMemberClient) AddJoinedTeamMembersCompleteMatchingPredicate(ctx context.Context, id stable.UserIdJoinedTeamId, input AddJoinedTeamMembersRequest, options AddJoinedTeamMembersOperationOptions, predicate ActionResultPartOperationPredicate) (result AddJoinedTeamMembersCompleteResult, err error) {
