...
// GetJoinedTeamOperation - Get operations from users. The async operations that ran or are running on this team.
func (c JoinedTeamOperationClient) GetJoinedTeamOperation(ctx context.Context, id stable.UserIdJoinedTeamIdOperationId, options GetJoinedTeamOperationOperationOptions) (result GetJoinedTeamOperationOperationResponse, err error) {
