...
// GetJoinedTeamPermissionGrant - Get permissionGrants from users. A collection of permissions granted to apps to access
// the team.
func (c JoinedTeamPermissionGrantClient) GetJoinedTeamPermissionGrant(ctx context.Context, id stable.UserIdJoinedTeamIdPermissionGrantId, options GetJoinedTeamPermissionGrantOperationOptions) (result GetJoinedTeamPermissionGrantOperationResponse, err error) {
