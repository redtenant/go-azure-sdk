...
func (c JoinedTeamPermissionGrantClient) GetJoinedTeamPermissionGrantsCount(ctx context.Context, id stable.UserIdJoinedTeamId, options GetJoinedTeamPermissionGrantsCountOperationOptions) (result GetJoinedTeamPermissionGrantsCountOperationResponse, err error) {
