...
// GetJoinedTeamPhoto - Get photo from users. The profile photo for the team.
func (c JoinedTeamPhotoClient) GetJoinedTeamPhoto(ctx context.Context, id stable.UserIdJoinedTeamId, options GetJoinedTeamPhotoOperationOptions) (result GetJoinedTeamPhotoOperationResponse, err error) {
