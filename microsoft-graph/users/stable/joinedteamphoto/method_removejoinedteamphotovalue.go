...
// RemoveJoinedTeamPhotoValue - Delete media content for the navigation property photo in users. The profile photo for
// the team.
func (c JoinedTeamPhotoClient) RemoveJoinedTeamPhotoValue(ctx context.Context, id stable.UserIdJoinedTeamId, options RemoveJoinedTeamPhotoValueOperationOptions) (result RemoveJoinedTeamPhotoValueOperationResponse, err error) {
