...
// GetJoinedTeamPrimaryChannelFilesFolder - Get filesFolder from users. Metadata for the location where the channel's
// files are stored.
func (c JoinedTeamPrimaryChannelFilesFolderClient) GetJoinedTeamPrimaryChannelFilesFolder(ctx context.Context, id stable.UserIdJoinedTeamId, options GetJoinedTeamPrimaryChannelFilesFolderOperationOptions) (result GetJoinedTeamPrimaryChannelFilesFolderOperationResponse, err error) {
