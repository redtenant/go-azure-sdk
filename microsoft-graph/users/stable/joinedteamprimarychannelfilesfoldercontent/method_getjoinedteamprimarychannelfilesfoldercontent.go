...
// GetJoinedTeamPrimaryChannelFilesFolderContent - Get content for the navigation property filesFolder from users. The
// content stream, if the item represents a file.
func (c JoinedTeamPrimaryChannelFilesFolderContentClient) GetJoinedTeamPrimaryChannelFilesFolderContent(ctx context.Context, id stable.UserIdJoinedTeamId, options GetJoinedTeamPrimaryChannelFilesFolderContentOperationOptions) (result GetJoinedTeamPrimaryChannelFilesFolderContentOperationResponse, err error) {
