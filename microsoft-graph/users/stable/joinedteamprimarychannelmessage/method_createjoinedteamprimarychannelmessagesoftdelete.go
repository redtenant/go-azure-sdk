...
func (c JoinedTeamPrimaryChannelMessageClient) CreateJoinedTeamPrimaryChannelMessageSoftDelete(ctx context.Context, id stable.UserIdJoinedTeamIdPrimaryChannelMessageId, options CreateJoinedTeamPrimaryChannelMessageSoftDeleteOperationOptions) (result CreateJoinedTeamPrimaryChannelMessageSoftDeleteOperationResponse, err error) {
