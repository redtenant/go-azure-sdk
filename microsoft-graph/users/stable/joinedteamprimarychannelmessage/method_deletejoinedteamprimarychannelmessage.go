...
func DefaultDeleteJoinedTeamPrimaryChannelMessageOperationOptions() DeleteJoinedTeamPrimaryChannelMessageOperationOptions {
	return DeleteJoinedTeamPrimaryChannelMessageOperationOptions{}
}
...
// DeleteJoinedTeamPrimaryChannelMessage - Delete navigation property messages for users
func (c JoinedTeamPrimaryChannelMessageClient) DeleteJoinedTeamPrimaryChannelMessage(ctx context.Context, id stable.UserIdJoinedTeamIdPrimaryChannelMessageId, options DeleteJoinedTeamPrimaryChannelMessageOperationOptions) (result DeleteJoinedTeamPrimaryChannelMessageOperationResponse, err error) {
