...
// GetJoinedTeamPrimaryChannelMessage - Get messages from users. A collection of all the messages in the channel. A
// navigation property. Nullable.
func (c JoinedTeamPrimaryChannelMessageClient) GetJoinedTeamPrimaryChannelMessage(ctx context.Context, id stable.UserIdJoinedTeamIdPrimaryChannelMessageId, options GetJoinedTeamPrimaryChannelMessageOperationOptions) (result GetJoinedTeamPrimaryChannelMessageOperationResponse, err error) {
