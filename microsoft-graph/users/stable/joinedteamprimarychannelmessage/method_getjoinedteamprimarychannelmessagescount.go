...
func (c JoinedTeamPrimaryChannelMessageClient) GetJoinedTeamPrimaryChannelMessagesCount(ctx context.Context, id stable.UserIdJoinedTeamId, options GetJoinedTeamPrimaryChannelMessagesCountOperationOptions) (result GetJoinedTeamPrimaryChannelMessagesCountOperationResponse, err error) {
