...
// ListJoinedTeamPrimaryChannelMessages - Get messages from users. A collection of all the messages in the channel. A
// navigation property. Nullable.
func (c JoinedTeamPrimaryChannelMessageClient) ListJoinedTeamPrimaryChannelMessages(ctx context.Context, id stable.UserIdJoinedTeamId, options ListJoinedTeamPrimaryChannelMessagesOperationOptions) (result ListJoinedTeamPrimaryChannelMessagesOperationResponse, err error) {
...
func (c JoinedTeamPrimaryChannelMessageClient) ListJoinedTeamPrimaryChannelMessagesComplete(ctx context.Context, id stable.UserIdJoinedTeamId, options ListJoinedTeamPrimaryChannelMessagesOperationOptions) (ListJoinedTeamPrimaryChannelMessagesCompleteResult, error) {
...
func (c JoinedTeamPrimaryChannelMessageClient) ListJoinedTeamPrimaryChannelMessagesCompleteMatchingPredicate(ctx context.Context, id stable.UserIdJoinedTeamId, options ListJoinedTeamPrimaryChannelMessagesOperationOptions, predicate ChatMessageOperationPredicate) (result ListJoinedTeamPrimaryChannelMessagesCompleteResult, err error) {
