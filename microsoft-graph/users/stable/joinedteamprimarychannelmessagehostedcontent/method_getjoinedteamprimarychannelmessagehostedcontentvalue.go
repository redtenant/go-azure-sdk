...
func (c JoinedTeamPrimaryChannelMessageHostedContentClient) GetJoinedTeamPrimaryChannelMessageHostedContentValue(ctx context.Context, id stable.UserIdJoinedTeamIdPrimaryChannelMessageIdHostedContentId, options GetJoinedTeamPrimaryChannelMessageHostedContentValueOperationOptions) (result GetJoinedTeamPrimaryChannelMessageHostedContentValueOperationResponse, err error) {
