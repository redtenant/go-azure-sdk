...
func (c JoinedTeamPrimaryChannelMessageReplyHostedContentClient) GetJoinedTeamPrimaryChannelMessageReplyHostedContentsCount(ctx context.Context, id stable.UserIdJoinedTeamIdPrimaryChannelMessageIdReplyId, options GetJoinedTeamPrimaryChannelMessageReplyHostedContentsCountOperationOptions) (result GetJoinedTeamPrimaryChannelMessageReplyHostedContentsCountOperationResponse, err error) {
