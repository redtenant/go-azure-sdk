...
// GetJoinedTeamPrimaryChannelSharedWithTeamTeam - Get team from users
func (c JoinedTeamPrimaryChannelSharedWithTeamTeamClient) GetJoinedTeamPrimaryChannelSharedWithTeamTeam(ctx context.Context, id stable.UserIdJoinedTeamIdPrimaryChannelSharedWithTeamId, options GetJoinedTeamPrimaryChannelSharedWithTeamTeamOperationOptions) (result GetJoinedTeamPrimaryChannelSharedWithTeamTeamOperationResponse, err error) {
