...
func DefaultGetJoinedTeamPrimaryChannelTabOperationOptions() GetJoinedTeamPrimaryChannelTabOperationOptions {
	return GetJoinedTeamPrimaryChannelTabOperationOptions{}
}
...
// GetJoinedTeamPrimaryChannelTab - Get tabs from users. A collection of all the tabs in the channel. A navigation
// property.
func (c JoinedTeamPrimaryChannelTabClient) GetJoinedTeamPrimaryChannelTab(ctx context.Context, id stable.UserIdJoinedTeamIdPrimaryChannelTabId, options GetJoinedTeamPrimaryChannelTabOperationOptions) (result GetJoinedTeamPrimaryChannelTabOperationResponse, err error) {
