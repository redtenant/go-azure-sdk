...
// GetJoinedTeamPrimaryChannelTabTeamsApp - Get teamsApp from users. The application that is linked to the tab. This
// can't be changed after tab creation.
func (c JoinedTeamPrimaryChannelTabTeamsAppClient) GetJoinedTeamPrimaryChannelTabTeamsApp(ctx context.Context, id stable.UserIdJoinedTeamIdPrimaryChannelTabId, options GetJoinedTeamPrimaryChannelTabTeamsAppOperationOptions) (result GetJoinedTeamPrimaryChannelTabTeamsAppOperationResponse, err error) {
