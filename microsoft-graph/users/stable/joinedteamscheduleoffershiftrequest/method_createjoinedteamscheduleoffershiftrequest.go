...
// CreateJoinedTeamScheduleOfferShiftRequest - Create new navigation property to offerShiftRequests for users
func (c JoinedTeamScheduleOfferShiftRequestClient) CreateJoinedTeamScheduleOfferShiftRequest(ctx context.Context, id stable.UserIdJoinedTeamId, input stable.OfferShiftRequest, options CreateJoinedTeamScheduleOfferShiftRequestOperationOptions) (result CreateJoinedTeamScheduleOfferShiftRequestOperationResponse, err error) {
