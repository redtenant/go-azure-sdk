...
// GetJoinedTeamScheduleOfferShiftRequest - Get offerShiftRequests from users. The offer requests for shifts in the
// schedule.
func (c JoinedTeamScheduleOfferShiftRequestClient) GetJoinedTeamScheduleOfferShiftRequest(ctx context.Context, id stable.UserIdJoinedTeamIdScheduleOfferShiftRequestId, options GetJoinedTeamScheduleOfferShiftRequestOperationOptions) (result GetJoinedTeamScheduleOfferShiftRequestOperationResponse, err error) {
