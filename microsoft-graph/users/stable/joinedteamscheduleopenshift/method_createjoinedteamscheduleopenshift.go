...
// CreateJoinedTeamScheduleOpenShift - Create new navigation property to openShifts for users
func (c JoinedTeamScheduleOpenShiftClient) CreateJoinedTeamScheduleOpenShift(ctx context.Context, id stable.UserIdJoinedTeamId, input stable.OpenShift, options CreateJoinedTeamScheduleOpenShiftOperationOptions) (result CreateJoinedTeamScheduleOpenShiftOperationResponse, err error) {
