...
// DeleteJoinedTeamScheduleOpenShift - Delete navigation property openShifts for users
func (c JoinedTeamScheduleOpenShiftClient) DeleteJoinedTeamScheduleOpenShift(ctx context.Context, id stable.UserIdJoinedTeamIdScheduleOpenShiftId, options DeleteJoinedTeamScheduleOpenShiftOperationOptions) (result DeleteJoinedTeamScheduleOpenShiftOperationResponse, err error) {
