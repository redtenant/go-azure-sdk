...
func (c JoinedTeamScheduleOpenShiftClient) GetJoinedTeamScheduleOpenShiftsCount(ctx context.Context, id stable.UserIdJoinedTeamId, options GetJoinedTeamScheduleOpenShiftsCountOperationOptions) (result GetJoinedTeamScheduleOpenShiftsCountOperationResponse, err error) {
