...
// ListJoinedTeamScheduleOpenShifts - Get openShifts from users. The set of open shifts in a scheduling group in the
// schedule.
func (c JoinedTeamScheduleOpenShiftClient) ListJoinedTeamScheduleOpenShifts(ctx context.Context, id stable.UserIdJoinedTeamId, options ListJoinedTeamScheduleOpenShiftsOperationOptions) (result ListJoinedTeamScheduleOpenShiftsOperationResponse, err error) {
...
func (c JoinedTeamScheduleOpenShiftClient) ListJoinedTeamScheduleOpenShiftsComplete(ctx context.Context, id stable.UserIdJoinedTeamId, options ListJoinedTeamScheduleOpenShiftsOperationOptions) (ListJoinedTeamScheduleOpenShiftsCompleteResult, error) {
...
func (c JoinedTeamScheduleOpenShiftClient) ListJoinedTeamScheduleOpenShiftsCompleteMatchingPredicate(ctx context.Context, id stable.UserIdJoinedTeamId, options ListJoinedTeamScheduleOpenShiftsOperationOptions, predicate OpenShiftOperationPredicate) (result ListJoinedTeamScheduleOpenShiftsCompleteResult, err error) {
