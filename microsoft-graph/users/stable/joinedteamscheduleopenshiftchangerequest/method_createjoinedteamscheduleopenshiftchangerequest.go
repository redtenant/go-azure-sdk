...
// CreateJoinedTeamScheduleOpenShiftChangeRequest - Create new navigation property to openShiftChangeRequests for users
func (c JoinedTeamScheduleOpenShiftChangeRequestClient) CreateJoinedTeamScheduleOpenShiftChangeRequest(ctx context.Context, id stable.UserIdJoinedTeamId, input stable.OpenShiftChangeRequest, options CreateJoinedTeamScheduleOpenShiftChangeRequestOperationOptions) (result CreateJoinedTeamScheduleOpenShiftChangeRequestOperationResponse, err error) {
