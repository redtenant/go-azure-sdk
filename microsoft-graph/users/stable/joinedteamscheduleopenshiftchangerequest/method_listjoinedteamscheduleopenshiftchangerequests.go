...
// ListJoinedTeamScheduleOpenShiftChangeRequests - Get openShiftChangeRequests from users. The open shift requests in
// the schedule.
func (c JoinedTeamScheduleOpenShiftChangeRequestClient) ListJoinedTeamScheduleOpenShiftChangeRequests(ctx context.Context, id stable.UserIdJoinedTeamId, options ListJoinedTeamScheduleOpenShiftChangeRequestsOperationOptions) (result ListJoinedTeamScheduleOpenShiftChangeRequestsOperationResponse, err error) {
...
func (c JoinedTeamScheduleOpenShiftChangeRequestClient) ListJoinedTeamScheduleOpenShiftChangeRequestsComplete(ctx context.Context, id stable.UserIdJoinedTeamId, options ListJoinedTeamScheduleOpenShiftChangeRequestsOperationOptions) (ListJoinedTeamScheduleOpenShiftChangeRequestsCompleteResult, error) {
...
func (c JoinedTeamScheduleOpenShiftChangeRequestClient) ListJoinedTeamScheduleOpenShiftChangeRequestsCompleteMatchingPredicate(ctx context.Context, id stable.UserIdJoinedTeamId, options ListJoinedTeamScheduleOpenShiftChangeRequestsOperationOptions, predicate OpenShiftChangeRequestOperationPredicate) (result ListJoinedTeamScheduleOpenShiftChangeRequestsCompleteResult, err error) {
