...
// CreateJoinedTeamScheduleSchedulingGroup - Create new navigation property to schedulingGroups for users
func (c JoinedTeamScheduleSchedulingGroupClient) CreateJoinedTeamScheduleSchedulingGroup(ctx context.Context, id stable.UserIdJoinedTeamId, input stable.SchedulingGroup, options CreateJoinedTeamScheduleSchedulingGroupOperationOptions) (result CreateJoinedTeamScheduleSchedulingGroupOperationResponse, err error) {
