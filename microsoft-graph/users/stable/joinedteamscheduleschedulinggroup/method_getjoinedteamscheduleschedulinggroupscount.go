...
func (c JoinedTeamScheduleSchedulingGroupClient) GetJoinedTeamScheduleSchedulingGroupsCount(ctx context.Context, id stable.UserIdJoinedTeamId, options GetJoinedTeamScheduleSchedulingGroupsCountOperationOptions) (result GetJoinedTeamScheduleSchedulingGroupsCountOperationResponse, err error) {
