...
type UpdateJoinedTeamScheduleSchedulingGroupOperationResponse struct {
...
// UpdateJoinedTeamScheduleSchedulingGroup - Update the navigation property schedulingGroups in users
func (c JoinedTeamScheduleSchedulingGroupClient) UpdateJoinedTeamScheduleSchedulingGroup(ctx context.Context, id stable.UserIdJoinedTeamIdScheduleSchedulingGroupId, input stable.SchedulingGroup, options UpdateJoinedTeamScheduleSchedulingGroupOperationOptions) (result UpdateJoinedTeamScheduleSchedulingGroupOperationResponse, err error) {
