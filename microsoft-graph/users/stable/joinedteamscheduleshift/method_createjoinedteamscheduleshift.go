...
// CreateJoinedTeamScheduleShift - Create new navigation property to shifts for users
func (c JoinedTeamScheduleShiftClient) CreateJoinedTeamScheduleShift(ctx context.Context, id stable.UserIdJoinedTeamId, input stable.Shift, options CreateJoinedTeamScheduleShiftOperationOptions) (result CreateJoinedTeamScheduleShiftOperationResponse, err error) {
