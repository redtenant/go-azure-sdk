...
// GetJoinedTeamScheduleShift - Get shifts from users. The shifts in the schedule.
func (c JoinedTeamScheduleShiftClient) GetJoinedTeamScheduleShift(ctx context.Context, id stable.UserIdJoinedTeamIdScheduleShiftId, options GetJoinedTeamScheduleShiftOperationOptions) (result GetJoinedTeamScheduleShiftOperationResponse, err error) {
