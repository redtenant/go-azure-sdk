...
// ListJoinedTeamScheduleShifts - Get shifts from users. The shifts in the schedule.
func (c JoinedTeamScheduleShiftClient) ListJoinedTeamScheduleShifts(ctx context.Context, id stable.UserIdJoinedTeamId, options ListJoinedTeamScheduleShiftsOperationOptions) (result ListJoinedTeamScheduleShiftsOperationResponse, err error) {
...
func (c JoinedTeamScheduleShiftClient) ListJoinedTeamScheduleShiftsComplete(ctx context.Context, id stable.UserIdJoinedTeamId, options ListJoinedTeamScheduleShiftsOperationOptions) (ListJoinedTeamScheduleShiftsCompleteResult, error) {
...
func (c JoinedTeamScheduleShiftClient) ListJoinedTeamScheduleShiftsCompleteMatchingPredicate(ctx context.Context, id stable.UserIdJoinedTeamId, options ListJoinedTeamScheduleShiftsOperationOptions, predicate ShiftOperationPredicate) (result ListJoinedTeamScheduleShiftsCompleteResult, err error) {
