...
// CreateJoinedTeamScheduleSwapShiftsChangeRequest - Create new navigation property to swapShiftsChangeRequests for
// users
func (c JoinedTeamScheduleSwapShiftsChangeRequestClient) CreateJoinedTeamScheduleSwapShiftsChangeRequest(ctx context.Context, id stable.UserIdJoinedTeamId, input stable.SwapShiftsChangeRequest, options CreateJoinedTeamScheduleSwapShiftsChangeRequestOperationOptions) (result CreateJoinedTeamScheduleSwapShiftsChangeRequestOperationResponse, err error) {
