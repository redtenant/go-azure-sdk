...
// DeleteJoinedTeamScheduleSwapShiftsChangeRequest - Delete navigation property swapShiftsChangeRequests for users
func (c JoinedTeamScheduleSwapShiftsChangeRequestClient) DeleteJoinedTeamScheduleSwapShiftsChangeRequest(ctx context.Context, id stable.UserIdJoinedTeamIdScheduleSwapShiftsChangeRequestId, options DeleteJoinedTeamScheduleSwapShiftsChangeRequestOperationOptions) (result DeleteJoinedTeamScheduleSwapShiftsChangeRequestOperationResponse, err error) {
