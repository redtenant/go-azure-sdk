...
// GetJoinedTeamScheduleSwapShiftsChangeRequest - Get swapShiftsChangeRequests from users. The swap requests for shifts
// in the schedule.
func (c JoinedTeamScheduleSwapShiftsChangeRequestClient) GetJoinedTeamScheduleSwapShiftsChangeRequest(ctx context.Context, id stable.UserIdJoinedTeamIdScheduleSwapShiftsChangeRequestId, options GetJoinedTeamScheduleSwapShiftsChangeRequestOperationOptions) (result GetJoinedTeamScheduleSwapShiftsChangeRequestOperationResponse, err error) {
