...
// CreateJoinedTeamScheduleTimeOffRequest - Create new navigation property to timeOffRequests for users
func (c JoinedTeamScheduleTimeOffRequestClient) CreateJoinedTeamScheduleTimeOffRequest(ctx context.Context, id stable.UserIdJoinedTeamId, input stable.TimeOffRequest, options CreateJoinedTeamScheduleTimeOffRequestOperationOptions) (result CreateJoinedTeamScheduleTimeOffRequestOperationResponse, err error) {
