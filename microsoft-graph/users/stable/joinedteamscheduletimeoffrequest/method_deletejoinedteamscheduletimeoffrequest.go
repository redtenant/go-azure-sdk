...
// DeleteJoinedTeamScheduleTimeOffRequest - Delete navigation property timeOffRequests for users
func (c JoinedTeamScheduleTimeOffRequestClient) DeleteJoinedTeamScheduleTimeOffRequest(ctx context.Context, id stable.UserIdJoinedTeamIdScheduleTimeOffRequestId, options DeleteJoinedTeamScheduleTimeOffRequestOperationOptions) (result DeleteJoinedTeamScheduleTimeOffRequestOperationResponse, err error) {
