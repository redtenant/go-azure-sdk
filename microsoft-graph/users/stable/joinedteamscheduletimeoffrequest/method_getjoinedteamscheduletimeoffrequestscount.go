...
func (c JoinedTeamScheduleTimeOffRequestClient) GetJoinedTeamScheduleTimeOffRequestsCount(ctx context.Context, id stable.UserIdJoinedTeamId, options GetJoinedTeamScheduleTimeOffRequestsCountOperationOptions) (result GetJoinedTeamScheduleTimeOffRequestsCountOperationResponse, err error) {
