...
// DeleteJoinedTeamTag - Delete navigation property tags for users
func (c JoinedTeamTagClient) DeleteJoinedTeamTag(ctx context.Context, id stable.UserIdJoinedTeamIdTagId, options DeleteJoinedTeamTagOperationOptions) (result DeleteJoinedTeamTagOperationResponse, err error) {
