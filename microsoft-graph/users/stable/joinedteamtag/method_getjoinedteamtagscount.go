...
func (c JoinedTeamTagClient) GetJoinedTeamTagsCount(ctx context.Context, id stable.UserIdJoinedTeamId, options GetJoinedTeamTagsCountOperationOptions) (result GetJoinedTeamTagsCountOperationResponse, err error) {
