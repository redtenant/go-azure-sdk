...
// ListJoinedTeamTags - Get tags from users. The tags associated with the team.
func (c JoinedTeamTagClient) ListJoinedTeamTags(ctx context.Context, id stable.UserIdJoinedTeamId, options ListJoinedTeamTagsOperationOptions) (result ListJoinedTeamTagsOperationResponse, err error) {
...
func (c JoinedTeamTagClient) ListJoinedTeamTagsComplete(ctx context.Context, id stable.UserIdJoinedTeamId, options ListJoinedTeamTagsOperationOptions) (ListJoinedTeamTagsCompleteResult, error) {
...
func (c JoinedTeamTagClient) ListJoinedTeamTagsCompleteMatchingPredicate(ctx context.Context, id stable.UserIdJoinedTeamId, options ListJoinedTeamTagsOperationOptions, predicate TeamworkTagOperationPredicate) (result ListJoinedTeamTagsCompleteResult, err error) {
