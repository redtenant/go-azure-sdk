...
// DeleteJoinedTeamTagMember - Delete navigation property members for users
func (c JoinedTeamTagMemberClient) DeleteJoinedTeamTagMember(ctx context.Context, id stable.UserIdJoinedTeamIdTagIdMemberId, options DeleteJoinedTeamTagMemberOperationOptions) (result DeleteJoinedTeamTagMemberOperationResponse, err error) {
