...
// ListJoinedTeamTagMembers - Get members from users. Users assigned to the tag.
func (c JoinedTeamTagMemberClient) ListJoinedTeamTagMembers(ctx context.Context, id stable.UserIdJoinedTeamIdTagId, options ListJoinedTeamTagMembersOperationOptions) (result ListJoinedTeamTagMembersOperationResponse, err error) {
...
func (c JoinedTeamTagMemberClient) ListJoinedTeamTagMembersComplete(ctx context.Context, id stable.UserIdJoinedTeamIdTagId, options ListJoinedTeamTagMembersOperationOptions) (ListJoinedTeamTagMembersCompleteResult, error) {
...
func (c JoinedTeamTagMemberClient) ListJoinedTeamTagMembersCompleteMatchingPredicate(ctx context.Context, id stable.UserIdJoinedTeamIdTagId, options ListJoinedTeamTagMembersOperationOptions, predicate TeamworkTagMemberOperationPredicate) (result ListJoinedTeamTagMembersCompleteResult, err error) {
