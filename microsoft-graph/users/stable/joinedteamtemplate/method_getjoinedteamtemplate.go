...
// GetJoinedTeamTemplate - Get template from users. The template this team was created from. See available templates.
func (c JoinedTeamTemplateClient) GetJoinedTeamTemplate(ctx context.Context, id stable.UserIdJoinedTeamId, options GetJoinedTeamTemplateOperationOptions) (result GetJoinedTeamTemplateOperationResponse, err error) {
