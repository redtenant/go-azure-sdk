...
func (c LicenseDetailClient) GetLicenseDetailsCount(ctx context.Context, id stable.UserId, options GetLicenseDetailsCountOperationOptions) (result GetLicenseDetailsCountOperationResponse, err error) {
