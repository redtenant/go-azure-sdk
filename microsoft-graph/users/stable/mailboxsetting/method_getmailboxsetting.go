...
// can get or update settings for sending automatic replies to incoming messages, locale, and time zone. Returned only
// on $select.
func (c MailboxSettingClient) GetMailboxSetting(ctx context.Context, id stable.UserId, options GetMailboxSettingOperationOptions) (result GetMailboxSettingOperationResponse, err error) {
