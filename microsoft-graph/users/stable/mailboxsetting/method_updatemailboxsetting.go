...
func (c MailboxSettingClient) UpdateMailboxSetting(ctx context.Context, id stable.UserId, input stable.MailboxSettings, options UpdateMailboxSettingOperationOptions) (result UpdateMailboxSettingOperationResponse, err error) {
