...
func (c MailFolderClient) CopyMailFolder(ctx context.Context, id stable.UserIdMailFolderId, input CopyMailFolderRequest, options CopyMailFolderOperationOptions) (result CopyMailFolderOperationResponse, err error) {
