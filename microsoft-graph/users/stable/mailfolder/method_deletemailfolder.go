...
func (c MailFolderClient) DeleteMailFolder(ctx context.Context, id stable.UserIdMailFolderId, options DeleteMailFolderOperationOptions) (result DeleteMailFolderOperationResponse, err error) {
