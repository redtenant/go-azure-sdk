...
func (c MailFolderClient) UpdateMailFolder(ctx context.Context, id stable.UserIdMailFolderId, input stable.MailFolder, options UpdateMailFolderOperationOptions) (result UpdateMailFolderOperationResponse, err error) {
