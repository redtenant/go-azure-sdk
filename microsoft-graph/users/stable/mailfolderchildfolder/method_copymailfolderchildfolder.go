...
func DefaultCopyMailFolderChildFolderOperationOptions() CopyMailFolderChildFolderOperationOptions {
	return CopyMailFolderChildFolderOperationOptions{}
}
...
func (c MailFolderChildFolderClient) CopyMailFolderChildFolder(ctx context.Context, id stable.UserIdMailFolderIdChildFolderId, input CopyMailFolderChildFolderRequest, options CopyMailFolderChildFolderOperationOptions) (result CopyMailFolderChildFolderOperationResponse, err error) {
