...
func (c MailFolderChildFolderClient) CreateMailFolderChildFolder(ctx context.Context, id stable.UserIdMailFolderId, input stable.MailFolder, options CreateMailFolderChildFolderOperationOptions) (result CreateMailFolderChildFolderOperationResponse, err error) {
