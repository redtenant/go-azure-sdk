...
func (c MailFolderChildFolderClient) DeleteMailFolderChildFolder(ctx context.Context, id stable.UserIdMailFolderIdChildFolderId, options DeleteMailFolderChildFolderOperationOptions) (result DeleteMailFolderChildFolderOperationResponse, err error) {
