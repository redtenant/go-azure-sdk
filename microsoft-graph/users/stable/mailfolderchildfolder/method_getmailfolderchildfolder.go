...
func (c MailFolderChildFolderClient) GetMailFolderChildFolder(ctx context.Context, id stable.UserIdMailFolderIdChildFolderId, options GetMailFolderChildFolderOperationOptions) (result GetMailFolderChildFolderOperationResponse, err error) {
