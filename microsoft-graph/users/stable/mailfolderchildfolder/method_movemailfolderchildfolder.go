...
func (c MailFolderChildFolderClient) MoveMailFolderChildFolder(ctx context.Context, id stable.UserIdMailFolderIdChildFolderId, input MoveMailFolderChildFolderRequest, options MoveMailFolderChildFolderOperationOptions) (result MoveMailFolderChildFolderOperationResponse, err error) {
