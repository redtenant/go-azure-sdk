...
func DefaultCreateMailFolderChildFolderMessageAttachmentsUploadSessionOperationOptions() CreateMailFolderChildFolderMessageAttachmentsUploadSessionOperationOptions {
	return CreateMailFolderChildFolderMessageAttachmentsUploadSessionOperationOptions{}
}
...
// CreateMailFolderChildFolderMessageAttachmentsUploadSession - Invoke action createUploadSession. Create an upload
// session that allows an app to iteratively upload ranges of a file, so as to attach the file to the specified Outlook
