...
func DefaultGetMailFolderChildFolderMessageAttachmentOperationOptions() GetMailFolderChildFolderMessageAttachmentOperationOptions {
	return GetMailFolderChildFolderMessageAttachmentOperationOptions{}
}
...
// GetMailFolderChildFolderMessageAttachment - Get attachments from users. The fileAttachment and itemAttachment
// attachments for the message.
func (c MailFolderChildFolderMessageAttachmentClient) GetMailFolderChildFolderMessageAttachment(ctx context.Context, id stable.UserIdMailFolderIdChildFolderIdMessageIdAttachmentId, options GetMailFolderChildFolderMessageAttachmentOperationOptions) (result GetMailFolderChildFolderMessageAttachmentOperationResponse, err error) {
