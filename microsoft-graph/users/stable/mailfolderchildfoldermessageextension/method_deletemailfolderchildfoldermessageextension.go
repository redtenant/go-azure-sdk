...
// DeleteMailFolderChildFolderMessageExtension - Delete navigation property extensions for users
func (c MailFolderChildFolderMessageExtensionClient) DeleteMailFolderChildFolderMessageExtension(ctx context.Context, id stable.UserIdMailFolderIdChildFolderIdMessageIdExtensionId, options DeleteMailFolderChildFolderMessageExtensionOperationOptions) (result DeleteMailFolderChildFolderMessageExtensionOperationResponse, err error) {
