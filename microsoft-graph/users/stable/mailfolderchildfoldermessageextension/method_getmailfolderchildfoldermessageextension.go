...
// GetMailFolderChildFolderMessageExtension - Get extensions from users. The collection of open extensions defined for
// the message. Nullable.
func (c MailFolderChildFolderMessageExtensionClient) GetMailFolderChildFolderMessageExtension(ctx context.Context, id stable.UserIdMailFolderIdChildFolderIdMessageIdExtensionId, options GetMailFolderChildFolderMessageExtensionOperationOptions) (result GetMailFolderChildFolderMessageExtensionOperationResponse, err error) {
