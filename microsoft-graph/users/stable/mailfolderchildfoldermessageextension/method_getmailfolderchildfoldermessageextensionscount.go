...
func (c MailFolderChildFolderMessageExtensionClient) GetMailFolderChildFolderMessageExtensionsCount(ctx context.Context, id stable.UserIdMailFolderIdChildFolderIdMessageId, options GetMailFolderChildFolderMessageExtensionsCountOperationOptions) (result GetMailFolderChildFolderMessageExtensionsCountOperationResponse, err error) {
