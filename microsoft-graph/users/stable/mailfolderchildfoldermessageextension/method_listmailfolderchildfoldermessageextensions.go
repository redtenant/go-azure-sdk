...
func (c MailFolderChildFolderMessageExtensionClient) ListMailFolderChildFolderMessageExtensions(ctx context.Context, id stable.UserIdMailFolderIdChildFolderIdMessageId, options ListMailFolderChildFolderMessageExtensionsOperationOptions) (result ListMailFolderChildFolderMessageExtensionsOperationResponse, err error) {
...
func (c MailFolderChildFolderMessageExtensionClient) ListMailFolderChildFolderMessageExtensionsComplete(ctx context.Context, id stable.UserIdMailFolderIdChildFolderIdMessageId, options ListMailFolderChildFolderMessageExtensionsOperationOptions) (ListMailFolderChildFolderMessageExtensionsCompleteResult, error) {
...
func (c MailFolderChildFolderMessageExtensionClient) ListMailFolderChildFolderMessageExtensionsCompleteMatchingPredicate(ctx context.Context, id stable.UserIdMailFolderIdChildFolderIdMessageId, options ListMailFolderChildFolderMessageExtensionsOperationOptions, predicate ExtensionOperationPredicate) (result ListMailFolderChildFolderMessageExtensionsCompleteResult, err error) {
