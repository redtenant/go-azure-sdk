...
func (c MailFolderChildFolderMessageRuleClient) DeleteMailFolderChildFolderMessageRule(ctx context.Context, id stable.UserIdMailFolderIdChildFolderIdMessageRuleId, options DeleteMailFolderChildFolderMessageRuleOperationOptions) (result DeleteMailFolderChildFolderMessageRuleOperationResponse, err error) {
