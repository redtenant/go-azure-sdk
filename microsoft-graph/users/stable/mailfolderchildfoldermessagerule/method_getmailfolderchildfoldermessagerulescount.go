...
func (c MailFolderChildFolderMessageRuleClient) GetMailFolderChildFolderMessageRulesCount(ctx context.Context, id stable.UserIdMailFolderIdChildFolderId, options GetMailFolderChildFolderMessageRulesCountOperationOptions) (result GetMailFolderChildFolderMessageRulesCountOperationResponse, err error) {
