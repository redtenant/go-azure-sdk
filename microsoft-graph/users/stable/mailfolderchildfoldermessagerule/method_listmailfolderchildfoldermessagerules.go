...
// ListMailFolderChildFolderMessageRules - Get messageRules from users. The collection of rules that apply to the user's
// Inbox folder.
func (c MailFolderChildFolderMessageRuleClient) ListMailFolderChildFolderMessageRules(ctx context.Context, id stable.UserIdMailFolderIdChildFolderId, options ListMailFolderChildFolderMessageRulesOperationOptions) (result ListMailFolderChildFolderMessageRulesOperationResponse, err error) {
...
func (c MailFolderChildFolderMessageRuleClient) ListMailFolderChildFolderMessageRulesComplete(ctx context.Context, id stable.UserIdMailFolderIdChildFolderId, options ListMailFolderChildFolderMessageRulesOperationOptions) (ListMailFolderChildFolderMessageRulesCompleteResult, error) {
