...
func (c MailFolderMessageClient) CreateMailFolderMessageForward(ctx context.Context, id stable.UserIdMailFolderIdMessageId, input CreateMailFolderMessageForwardRequest, options CreateMailFolderMessageForwardOperationOptions) (result CreateMailFolderMessageForwardOperationResponse, err error) {
