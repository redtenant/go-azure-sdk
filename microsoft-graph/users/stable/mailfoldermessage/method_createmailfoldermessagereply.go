...
func (c MailFolderMessageClient) CreateMailFolderMessageReply(ctx context.Context, id stable.UserIdMailFolderIdMessageId, input CreateMailFolderMessageReplyRequest, options CreateMailFolderMessageReplyOperationOptions) (result CreateMailFolderMessageReplyOperationResponse, err error) {
