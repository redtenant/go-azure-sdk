...
func DefaultDeleteMailFolderMessageOperationOptions() DeleteMailFolderMessageOperationOptions {
	return DeleteMailFolderMessageOperationOptions{}
}
...
func (c MailFolderMessageClient) DeleteMailFolderMessage(ctx context.Context, id stable.UserIdMailFolderIdMessageId, options DeleteMailFolderMessageOperationOptions) (result DeleteMailFolderMessageOperationResponse, err error) {
