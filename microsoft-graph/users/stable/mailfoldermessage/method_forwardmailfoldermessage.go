...
func (c MailFolderMessageClient) ForwardMailFolderMessage(ctx context.Context, id stable.UserIdMailFolderIdMessageId, input ForwardMailFolderMessageRequest, options ForwardMailFolderMessageOperationOptions) (result ForwardMailFolderMessageOperationResponse, err error) {
