...
func (c MailFolderMessageClient) GetMailFolderMessageValue(ctx context.Context, id stable.UserIdMailFolderIdMessageId, options GetMailFolderMessageValueOperationOptions) (result GetMailFolderMessageValueOperationResponse, err error) {
