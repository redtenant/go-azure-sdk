...
func (c MailFolderMessageClient) ListMailFolderMessages(ctx context.Context, id stable.UserIdMailFolderId, options ListMailFolderMessagesOperationOptions) (result ListMailFolderMessagesOperationResponse, err error) {
...
func (c MailFolderMessageClient) ListMailFolderMessagesComplete(ctx context.Context, id stable.UserIdMailFolderId, options ListMailFolderMessagesOperationOptions) (ListMailFolderMessagesCompleteResult, error) {
...
func (c MailFolderMessageClient) ListMailFolderMessagesCompleteMatchingPredicate(ctx context.Context, id stable.UserIdMailFolderId, options ListMailFolderMessagesOperationOptions, predicate MessageOperationPredicate) (result ListMailFolderMessagesCompleteResult, err error) {
