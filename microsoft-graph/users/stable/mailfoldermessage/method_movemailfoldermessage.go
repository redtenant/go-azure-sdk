...
func (c MailFolderMessageClient) MoveMailFolderMessage(ctx context.Context, id stable.UserIdMailFolderIdMessageId, input MoveMailFolderMessageRequest, options MoveMailFolderMessageOperationOptions) (result MoveMailFolderMessageOperationResponse, err error) {
