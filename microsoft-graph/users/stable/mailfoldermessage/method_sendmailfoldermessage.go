...
func (c MailFolderMessageClient) SendMailFolderMessage(ctx context.Context, id stable.UserIdMailFolderIdMessageId, options SendMailFolderMessageOperationOptions) (result SendMailFolderMessageOperationResponse, err error) {
