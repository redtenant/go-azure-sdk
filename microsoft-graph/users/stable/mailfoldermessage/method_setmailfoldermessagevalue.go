...
// SetMailFolderMessageValue - Update media content for the navigation property messages in users. The unique identifier
// for an entity. Read-only.
func (c MailFolderMessageClient) SetMailFolderMessageValue(ctx context.Context, id stable.UserIdMailFolderIdMessageId, input []byte, options SetMailFolderMessageValueOperationOptions) (result SetMailFolderMessageValueOperationResponse, err error) {
