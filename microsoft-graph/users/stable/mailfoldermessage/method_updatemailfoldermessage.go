...
func (c MailFolderMessageClient) UpdateMailFolderMessage(ctx context.Context, id stable.UserIdMailFolderIdMessageId, input stable.Message, options UpdateMailFolderMessageOperationOptions) (result UpdateMailFolderMessageOperationResponse, err error) {
