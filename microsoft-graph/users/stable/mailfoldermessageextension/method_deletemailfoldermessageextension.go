...
// DeleteMailFolderMessageExtension - Delete navigation property extensions for users
func (c MailFolderMessageExtensionClient) DeleteMailFolderMessageExtension(ctx context.Context, id stable.UserIdMailFolderIdMessageIdExtensionId, options DeleteMailFolderMessageExtensionOperationOptions) (result DeleteMailFolderMessageExtensionOperationResponse, err error) {
