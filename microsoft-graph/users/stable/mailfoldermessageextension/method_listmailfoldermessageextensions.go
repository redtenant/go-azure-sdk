...
// ListMailFolderMessageExtensions - Get extensions from users. The collection of open extensions defined for the
// message. Nullable.
func (c MailFolderMessageExtensionClient) ListMailFolderMessageExtensions(ctx context.Context, id stable.UserIdMailFolderIdMessageId, options ListMailFolderMessageExtensionsOperationOptions) (result ListMailFolderMessageExtensionsOperationResponse, err error) {
...
func (c MailFolderMessageExtensionClient) ListMailFolderMessageExtensionsComplete(ctx context.Context, id stable.UserIdMailFolderIdMessageId, options ListMailFolderMessageExtensionsOperationOptions) (ListMailFolderMessageExtensionsCompleteResult, error) {
...
func (c MailFolderMessageExtensionClient) ListMailFolderMessageExtensionsCompleteMatchingPredicate(ctx context.Context, id stable.UserIdMailFolderIdMessageId, options ListMailFolderMessageExtensionsOperationOptions, predicate ExtensionOperationPredicate) (result ListMailFolderMessageExtensionsCompleteResult, err error) {
