...
func DefaultDeleteMailFolderMessageRuleOperationOptions() DeleteMailFolderMessageRuleOperationOptions {
	return DeleteMailFolderMessageRuleOperationOptions{}
}
...
// DeleteMailFolderMessageRule - Delete navigation property messageRules for users
func (c MailFolderMessageRuleClient) DeleteMailFolderMessageRule(ctx context.Context, id stable.UserIdMailFolderIdMessageRuleId, options DeleteMailFolderMessageRuleOperationOptions) (result DeleteMailFolderMessageRuleOperationResponse, err error) {
