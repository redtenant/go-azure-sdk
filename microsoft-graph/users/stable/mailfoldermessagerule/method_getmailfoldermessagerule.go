...
// GetMailFolderMessageRule - Get messageRules from users. The collection of rules that apply to the user's Inbox
// folder.
func (c MailFolderMessageRuleClient) GetMailFolderMessageRule(ctx context.Context, id stable.UserIdMailFolderIdMessageRuleId, options GetMailFolderMessageRuleOperationOptions) (result GetMailFolderMessageRuleOperationResponse, err error) {
