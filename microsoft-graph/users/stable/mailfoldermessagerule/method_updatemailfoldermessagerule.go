...
// UpdateMailFolderMessageRule - Update the navigation property messageRules in users
func (c MailFolderMessageRuleClient) UpdateMailFolderMessageRule(ctx context.Context, id stable.UserIdMailFolderIdMessageRuleId, input stable.MessageRule, options UpdateMailFolderMessageRuleOperationOptions) (result UpdateMailFolderMessageRuleOperationResponse, err error) {
