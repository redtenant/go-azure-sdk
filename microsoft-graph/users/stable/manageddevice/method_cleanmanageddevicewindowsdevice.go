...
func (c ManagedDeviceClient) CleanManagedDeviceWindowsDevice(ctx context.Context, id stable.UserIdManagedDeviceId, input CleanManagedDeviceWindowsDeviceRequest, options CleanManagedDeviceWindowsDeviceOperationOptions) (result CleanManagedDeviceWindowsDeviceOperationResponse, err error) {
