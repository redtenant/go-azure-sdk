...
func (c ManagedDeviceClient) DeleteManagedDevice(ctx context.Context, id stable.UserIdManagedDeviceId, options DeleteManagedDeviceOperationOptions) (result DeleteManagedDeviceOperationResponse, err error) {
