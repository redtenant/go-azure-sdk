...
func (c ManagedDeviceClient) GetManagedDevice(ctx context.Context, id stable.UserIdManagedDeviceId, options GetManagedDeviceOperationOptions) (result GetManagedDeviceOperationResponse, err error) {
