...
func DefaultGetManagedDevicesCountOperationOptions() GetManagedDevicesCountOperationOptions {
	return GetManagedDevicesCountOperationOptions{}
}
...
func (c ManagedDeviceClient) GetManagedDevicesCount(ctx context.Context, id stable.UserId, options GetManagedDevicesCountOperationOptions) (result GetManagedDevicesCountOperationResponse, err error) {
