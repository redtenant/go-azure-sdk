...
func DefaultListManagedDevicesOperationOptions() ListManagedDevicesOperationOptions {
	return ListManagedDevicesOperationOptions{}
}
...
func (c ManagedDeviceClient) ListManagedDevices(ctx context.Context, id stable.UserId, options ListManagedDevicesOperationOptions) (result ListManagedDevicesOperationResponse, err error) {
	opts := client.RequestOptions{
		...
		Pager:         &ListManagedDevicesCustomPager{},
...
func (c ManagedDeviceClient) ListManagedDevicesComplete(ctx context.Context, id stable.UserId, options ListManagedDevicesOperationOptions) (ListManagedDevicesCompleteResult, error) {
	return c.ListManagedDevicesCompleteMatchingPredicate(ctx, id, options, ManagedDeviceOperationPredicate{})
}

// ListManagedDevicesCompleteMatchingPredicate retrieves all the results and then applies the predicate
func (c ManagedDeviceClient) ListManagedDevicesCompleteMatchingPredicate(ctx context.Context, id stable.UserId, options ListManagedDevicesOperationOptions, predicate ManagedDeviceOperationPredicate) (result ListManagedDevicesCompleteResult, err error) {
	items := make([]stable.ManagedDevice, 0)

	resp, err := c.ListManagedDevices(ctx, id, options)
	if err != nil {
	...
	result = ListManagedDevicesCompleteResult{
