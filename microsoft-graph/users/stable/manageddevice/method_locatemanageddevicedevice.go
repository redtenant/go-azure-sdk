...
func (c ManagedDeviceClient) LocateManagedDeviceDevice(ctx context.Context, id stable.UserIdManagedDeviceId, options LocateManagedDeviceDeviceOperationOptions) (result LocateManagedDeviceDeviceOperationResponse, err error) {
