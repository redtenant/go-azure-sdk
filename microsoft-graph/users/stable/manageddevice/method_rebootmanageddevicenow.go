...
func (c ManagedDeviceClient) RebootManagedDeviceNow(ctx context.Context, id stable.UserIdManagedDeviceId, options RebootManagedDeviceNowOperationOptions) (result RebootManagedDeviceNowOperationResponse, err error) {
