...
func (c ManagedDeviceClient) RecoverManagedDevicePasscode(ctx context.Context, id stable.UserIdManagedDeviceId, options RecoverManagedDevicePasscodeOperationOptions) (result RecoverManagedDevicePasscodeOperationResponse, err error) {
