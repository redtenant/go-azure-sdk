...
func (c ManagedDeviceClient) RemoteLockManagedDevice(ctx context.Context, id stable.UserIdManagedDeviceId, options RemoteLockManagedDeviceOperationOptions) (result RemoteLockManagedDeviceOperationResponse, err error) {
