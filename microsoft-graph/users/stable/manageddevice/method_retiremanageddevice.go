...
func (c ManagedDeviceClient) RetireManagedDevice(ctx context.Context, id stable.UserIdManagedDeviceId, options RetireManagedDeviceOperationOptions) (result RetireManagedDeviceOperationResponse, err error) {
