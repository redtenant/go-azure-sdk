...
func (c ManagedDeviceClient) ShutDownManagedDevice(ctx context.Context, id stable.UserIdManagedDeviceId, options ShutDownManagedDeviceOperationOptions) (result ShutDownManagedDeviceOperationResponse, err error) {
