...
func (c ManagedDeviceClient) SyncManagedDeviceDevice(ctx context.Context, id stable.UserIdManagedDeviceId, options SyncManagedDeviceDeviceOperationOptions) (result SyncManagedDeviceDeviceOperationResponse, err error) {
