...
func (c ManagedDeviceClient) UpdateManagedDevice(ctx context.Context, id stable.UserIdManagedDeviceId, input stable.ManagedDevice, options UpdateManagedDeviceOperationOptions) (result UpdateManagedDeviceOperationResponse, err error) {
