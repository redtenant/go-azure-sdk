...
func (c ManagedDeviceClient) WipeManagedDevice(ctx context.Context, id stable.UserIdManagedDeviceId, input WipeManagedDeviceRequest, options WipeManagedDeviceOperationOptions) (result WipeManagedDeviceOperationResponse, err error) {
