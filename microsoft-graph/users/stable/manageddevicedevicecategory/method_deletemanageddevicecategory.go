...
func (c ManagedDeviceDeviceCategoryClient) DeleteManagedDeviceCategory(ctx context.Context, id stable.UserIdManagedDeviceId, options DeleteManagedDeviceCategoryOperationOptions) (result DeleteManagedDeviceCategoryOperationResponse, err error) {
