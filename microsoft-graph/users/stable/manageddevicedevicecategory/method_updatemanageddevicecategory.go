...
func (c ManagedDeviceDeviceCategoryClient) UpdateManagedDeviceCategory(ctx context.Context, id stable.UserIdManagedDeviceId, input stable.DeviceCategory, options UpdateManagedDeviceCategoryOperationOptions) (result UpdateManagedDeviceCategoryOperationResponse, err error) {
