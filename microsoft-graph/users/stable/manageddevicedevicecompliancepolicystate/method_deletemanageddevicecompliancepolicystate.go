...
// DeleteManagedDeviceCompliancePolicyState - Delete navigation property deviceCompliancePolicyStates for users
func (c ManagedDeviceDeviceCompliancePolicyStateClient) DeleteManagedDeviceCompliancePolicyState(ctx context.Context, id stable.UserIdManagedDeviceIdDeviceCompliancePolicyStateId, options DeleteManagedDeviceCompliancePolicyStateOperationOptions) (result DeleteManagedDeviceCompliancePolicyStateOperationResponse, err error) {
