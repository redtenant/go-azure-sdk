...
// device.
func (c ManagedDeviceDeviceConfigurationStateClient) GetManagedDeviceConfigurationState(ctx context.Context, id stable.UserIdManagedDeviceIdDeviceConfigurationStateId, options GetManagedDeviceConfigurationStateOperationOptions) (result GetManagedDeviceConfigurationStateOperationResponse, err error) {
