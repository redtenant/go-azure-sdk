...
// device.
func (c ManagedDeviceDeviceConfigurationStateClient) ListManagedDeviceConfigurationStates(ctx context.Context, id stable.UserIdManagedDeviceId, options ListManagedDeviceConfigurationStatesOperationOptions) (result ListManagedDeviceConfigurationStatesOperationResponse, err error) {
...
func (c ManagedDeviceDeviceConfigurationStateClient) ListManagedDeviceConfigurationStatesComplete(ctx context.Context, id stable.UserIdManagedDeviceId, options ListManagedDeviceConfigurationStatesOperationOptions) (ListManagedDeviceConfigurationStatesCompleteResult, error) {
...
func (c ManagedDeviceDeviceConfigurationStateClient) ListManagedDeviceConfigurationStatesCompleteMatchingPredicate(ctx context.Context, id stable.UserIdManagedDeviceId, options ListManagedDeviceConfigurationStatesOperationOptions, predicate DeviceConfigurationStateOperationPredicate) (result ListManagedDeviceConfigurationStatesCompleteResult, err error) {
