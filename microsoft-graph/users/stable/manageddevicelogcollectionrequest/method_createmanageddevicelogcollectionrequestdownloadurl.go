...
func (c ManagedDeviceLogCollectionRequestClient) CreateManagedDeviceLogCollectionRequestDownloadUrl(ctx context.Context, id stable.UserIdManagedDeviceIdLogCollectionRequestId, options CreateManagedDeviceLogCollectionRequestDownloadUrlOperationOptions) (result CreateManagedDeviceLogCollectionRequestDownloadUrlOperationResponse, err error) {
