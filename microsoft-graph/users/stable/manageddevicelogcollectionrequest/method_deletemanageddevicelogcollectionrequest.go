...
func (c ManagedDeviceLogCollectionRequestClient) DeleteManagedDeviceLogCollectionRequest(ctx context.Context, id stable.UserIdManagedDeviceIdLogCollectionRequestId, options DeleteManagedDeviceLogCollectionRequestOperationOptions) (result DeleteManagedDeviceLogCollectionRequestOperationResponse, err error) {
