...
func (c ManagedDeviceLogCollectionRequestClient) GetManagedDeviceLogCollectionRequestsCount(ctx context.Context, id stable.UserIdManagedDeviceId, options GetManagedDeviceLogCollectionRequestsCountOperationOptions) (result GetManagedDeviceLogCollectionRequestsCountOperationResponse, err error) {
