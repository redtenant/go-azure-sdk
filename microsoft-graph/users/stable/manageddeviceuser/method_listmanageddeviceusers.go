...
func (c ManagedDeviceUserClient) ListManagedDeviceUsers(ctx context.Context, id stable.UserIdManagedDeviceId, options ListManagedDeviceUsersOperationOptions) (result ListManagedDeviceUsersOperationResponse, err error) {
...
func (c ManagedDeviceUserClient) ListManagedDeviceUsersComplete(ctx context.Context, id stable.UserIdManagedDeviceId, options ListManagedDeviceUsersOperationOptions) (ListManagedDeviceUsersCompleteResult, error) {
...
func (c ManagedDeviceUserClient) ListManagedDeviceUsersCompleteMatchingPredicate(ctx context.Context, id stable.UserIdManagedDeviceId, options ListManagedDeviceUsersOperationOptions, predicate UserOperationPredicate) (result ListManagedDeviceUsersCompleteResult, err error) {
