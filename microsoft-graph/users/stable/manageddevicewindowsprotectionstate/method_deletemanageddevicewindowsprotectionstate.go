...
// DeleteManagedDeviceWindowsProtectionState - Delete navigation property windowsProtectionState for users
func (c ManagedDeviceWindowsProtectionStateClient) DeleteManagedDeviceWindowsProtectionState(ctx context.Context, id stable.UserIdManagedDeviceId, options DeleteManagedDeviceWindowsProtectionStateOperationOptions) (result DeleteManagedDeviceWindowsProtectionStateOperationResponse, err error) {
