...
func (c MessageClient) CreateMessage(ctx context.Context, id stable.UserId, input stable.Message, options CreateMessageOperationOptions) (result CreateMessageOperationResponse, err error) {
