...
func (c MessageClient) CreateMessageForward(ctx context.Context, id stable.UserIdMessageId, input CreateMessageForwardRequest, options CreateMessageForwardOperationOptions) (result CreateMessageForwardOperationResponse, err error) {
