...
func (c MessageClient) CreateMessageReply(ctx context.Context, id stable.UserIdMessageId, input CreateMessageReplyRequest, options CreateMessageReplyOperationOptions) (result CreateMessageReplyOperationResponse, err error) {
