...
func (c MessageClient) CreateMessageReplyAll(ctx context.Context, id stable.UserIdMessageId, input CreateMessageReplyAllRequest, options CreateMessageReplyAllOperationOptions) (result CreateMessageReplyAllOperationResponse, err error) {
