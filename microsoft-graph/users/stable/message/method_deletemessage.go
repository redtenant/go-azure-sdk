...
func DefaultDeleteMessageOperationOptions() DeleteMessageOperationOptions {
	return DeleteMessageOperationOptions{}
}
...
func (c MessageClient) DeleteMessage(ctx context.Context, id stable.UserIdMessageId, options DeleteMessageOperationOptions) (result DeleteMessageOperationResponse, err error) {
