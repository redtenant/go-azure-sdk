...
func (c MessageClient) ForwardMessage(ctx context.Context, id stable.UserIdMessageId, input ForwardMessageRequest, options ForwardMessageOperationOptions) (result ForwardMessageOperationResponse, err error) {
