...
func (c MessageClient) GetMessage(ctx context.Context, id stable.UserIdMessageId, options GetMessageOperationOptions) (result GetMessageOperationResponse, err error) {
