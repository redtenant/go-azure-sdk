...
func DefaultGetMessagesCountOperationOptions() GetMessagesCountOperationOptions {
	return GetMessagesCountOperationOptions{}
}
...
func (c MessageClient) GetMessagesCount(ctx context.Context, id stable.UserId, options GetMessagesCountOperationOptions) (result GetMessagesCountOperationResponse, err error) {
