...
func (c MessageClient) MoveMessage(ctx context.Context, id stable.UserIdMessageId, input MoveMessageRequest, options MoveMessageOperationOptions) (result MoveMessageOperationResponse, err error) {
