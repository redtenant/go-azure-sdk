...
// entity. Read-only.
func (c MessageClient) RemoveMessageValue(ctx context.Context, id stable.UserIdMessageId, options RemoveMessageValueOperationOptions) (result RemoveMessageValueOperationResponse, err error) {
