...
// entity. Read-only.
func (c MessageClient) SetMessageValue(ctx context.Context, id stable.UserIdMessageId, input []byte, options SetMessageValueOperationOptions) (result SetMessageValueOperationResponse, err error) {
