...
func DefaultCreateMessageAttachmentsUploadSessionOperationOptions() CreateMessageAttachmentsUploadSessionOperationOptions {
	return CreateMessageAttachmentsUploadSessionOperationOptions{}
}
...
// app to iteratively upload ranges of a file, so as to attach the file to the specified Outlook item. The item can be a
...
func (c MessageAttachmentClient) CreateMessageAttachmentsUploadSession(ctx context.Context, id stable.UserIdMessageId, input CreateMessageAttachmentsUploadSessionRequest, options CreateMessageAttachmentsUploadSessionOperationOptions) (result CreateMessageAttachmentsUploadSessionOperationResponse, err error) {
