...
func DefaultDeleteMessageAttachmentOperationOptions() DeleteMessageAttachmentOperationOptions {
	return DeleteMessageAttachmentOperationOptions{}
}
...
func (c MessageAttachmentClient) DeleteMessageAttachment(ctx context.Context, id stable.UserIdMessageIdAttachmentId, options DeleteMessageAttachmentOperationOptions) (result DeleteMessageAttachmentOperationResponse, err error) {
