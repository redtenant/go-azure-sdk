...
func (c MessageAttachmentClient) GetMessageAttachment(ctx context.Context, id stable.UserIdMessageIdAttachmentId, options GetMessageAttachmentOperationOptions) (result GetMessageAttachmentOperationResponse, err error) {
