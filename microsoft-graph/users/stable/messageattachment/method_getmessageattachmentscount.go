...
func DefaultGetMessageAttachmentsCountOperationOptions() GetMessageAttachmentsCountOperationOptions {
	return GetMessageAttachmentsCountOperationOptions{}
}
...
func (c MessageAttachmentClient) GetMessageAttachmentsCount(ctx context.Context, id stable.UserIdMessageId, options GetMessageAttachmentsCountOperationOptions) (result GetMessageAttachmentsCountOperationResponse, err error) {
