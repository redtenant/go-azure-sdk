...
// message.
func (c MessageAttachmentClient) ListMessageAttachments(ctx context.Context, id stable.UserIdMessageId, options ListMessageAttachmentsOperationOptions) (result ListMessageAttachmentsOperationResponse, err error) {
...
func (c MessageAttachmentClient) ListMessageAttachmentsComplete(ctx context.Context, id stable.UserIdMessageId, options ListMessageAttachmentsOperationOptions) (ListMessageAttachmentsCompleteResult, error) {
...
func (c MessageAttachmentClient) ListMessageAttachmentsCompleteMatchingPredicate(ctx context.Context, id stable.UserIdMessageId, options ListMessageAttachmentsOperationOptions, predicate AttachmentOperationPredicate) (result ListMessageAttachmentsCompleteResult, err error) {
