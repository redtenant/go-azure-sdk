...
// DeleteMessageExtension - Delete navigation property extensions for users
func (c MessageExtensionClient) DeleteMessageExtension(ctx context.Context, id stable.UserIdMessageIdExtensionId, options DeleteMessageExtensionOperationOptions) (result DeleteMessageExtensionOperationResponse, err error) {
