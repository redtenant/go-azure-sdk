...
// GetMessageExtension - Get extensions from users. The collection of open extensions defined for the message. Nullable.
func (c MessageExtensionClient) GetMessageExtension(ctx context.Context, id stable.UserIdMessageIdExtensionId, options GetMessageExtensionOperationOptions) (result GetMessageExtensionOperationResponse, err error) {
