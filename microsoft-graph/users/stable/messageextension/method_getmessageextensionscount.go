...
type GetMessageExtensionsCountOperationResponse struct {
	HttpResponse *http.Response
	OData        *odata.OData
	Model        *[]byte
}

type GetMessageExtensionsCountOperationOptions struct {
	Filter    *string
...
func DefaultGetMessageExtensionsCountOperationOptions() GetMessageExtensionsCountOperationOptions {
	return GetMessageExtensionsCountOperationOptions{}
}
...
func (c MessageExtensionClient) GetMessageExtensionsCount(ctx context.Context, id stable.UserIdMessageId, options GetMessageExtensionsCountOperationOptions) (result GetMessageExtensionsCountOperationResponse, err error) {
