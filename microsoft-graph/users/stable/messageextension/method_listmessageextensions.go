...
type ListMessageExtensionsOperationOptions struct {
	Count     *bool
	Expand    *odata.Expand
	Filter    *string
...
func DefaultListMessageExtensionsOperationOptions() ListMessageExtensionsOperationOptions {
	return ListMessageExtensionsOperationOptions{}
}
...
// ListMessageExtensions - Get extensions from users. The collection of open extensions defined for the message.
// Nullable.
func (c MessageExtensionClient) ListMessageExtensions(ctx context.Context, id stable.UserIdMessageId, options ListMessageExtensionsOperationOptions) (result ListMessageExtensionsOperationResponse, err error) {
...
func (c MessageExtensionClient) ListMessageExtensionsComplete(ctx context.Context, id stable.UserIdMessageId, options ListMessageExtensionsOperationOptions) (ListMessageExtensionsCompleteResult, error) {
	return c.ListMessageExtensionsCompleteMatchingPredicate(ctx, id, options, ExtensionOperationPredicate{})
}

// ListMessageExtensionsCompleteMatchingPredicate retrieves all the results and then applies the predicate
func (c MessageExtensionClient) ListMessageExtensionsCompleteMatchingPredicate(ctx context.Context, id stable.UserIdMessageId, options ListMessageExtensionsOperationOptions, predicate ExtensionOperationPredicate) (result ListMessageExtensionsCompleteResult, err error) {
	items := make([]stable.Extension, 0)

	resp, err := c.ListMessageExtensions(ctx, id, options)
	if err != nil {
