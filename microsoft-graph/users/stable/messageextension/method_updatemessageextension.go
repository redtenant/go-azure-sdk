...
// UpdateMessageExtension - Update the navigation property extensions in users
func (c MessageExtensionClient) UpdateMessageExtension(ctx context.Context, id stable.UserIdMessageIdExtensionId, input stable.Extension, options UpdateMessageExtensionOperationOptions) (result UpdateMessageExtensionOperationResponse, err error) {
