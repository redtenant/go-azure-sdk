...
// GetOAuth2PermissionGrant - Get oauth2PermissionGrants from users
func (c OAuth2PermissionGrantClient) GetOAuth2PermissionGrant(ctx context.Context, id stable.UserIdOAuth2PermissionGrantId, options GetOAuth2PermissionGrantOperationOptions) (result GetOAuth2PermissionGrantOperationResponse, err error) {
