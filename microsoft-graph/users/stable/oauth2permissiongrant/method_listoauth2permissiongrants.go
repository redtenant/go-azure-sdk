...
func (c OAuth2PermissionGrantClient) ListOAuth2PermissionGrants(ctx context.Context, id stable.UserId, options ListOAuth2PermissionGrantsOperationOptions) (result ListOAuth2PermissionGrantsOperationResponse, err error) {
...
func (c OAuth2PermissionGrantClient) ListOAuth2PermissionGrantsComplete(ctx context.Context, id stable.UserId, options ListOAuth2PermissionGrantsOperationOptions) (ListOAuth2PermissionGrantsCompleteResult, error) {
...
func (c OAuth2PermissionGrantClient) ListOAuth2PermissionGrantsCompleteMatchingPredicate(ctx context.Context, id stable.UserId, options ListOAuth2PermissionGrantsOperationOptions, predicate OAuth2PermissionGrantOperationPredicate) (result ListOAuth2PermissionGrantsCompleteResult, err error) {
