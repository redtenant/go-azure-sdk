...
// DeleteOnenote - Delete navigation property onenote for users
func (c OnenoteClient) DeleteOnenote(ctx context.Context, id stable.UserId, options DeleteOnenoteOperationOptions) (result DeleteOnenoteOperationResponse, err error) {
