...
func (c OnenoteNotebookClient) CopyOnenoteNotebookNotebook(ctx context.Context, id stable.UserIdOnenoteNotebookId, input CopyOnenoteNotebookNotebookRequest, options CopyOnenoteNotebookNotebookOperationOptions) (result CopyOnenoteNotebookNotebookOperationResponse, err error) {
