...
// CreateOnenoteNotebook - Create new navigation property to notebooks for users
func (c OnenoteNotebookClient) CreateOnenoteNotebook(ctx context.Context, id stable.UserId, input stable.Notebook, options CreateOnenoteNotebookOperationOptions) (result CreateOnenoteNotebookOperationResponse, err error) {
