...
func DefaultDeleteOnenoteNotebookOperationOptions() DeleteOnenoteNotebookOperationOptions {
	return DeleteOnenoteNotebookOperationOptions{}
}
...
// DeleteOnenoteNotebook - Delete navigation property notebooks for users
func (c OnenoteNotebookClient) DeleteOnenoteNotebook(ctx context.Context, id stable.UserIdOnenoteNotebookId, options DeleteOnenoteNotebookOperationOptions) (result DeleteOnenoteNotebookOperationResponse, err error) {
