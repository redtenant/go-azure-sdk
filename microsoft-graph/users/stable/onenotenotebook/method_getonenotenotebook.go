...
// GetOnenoteNotebook - Get notebooks from users. The collection of OneNote notebooks that are owned by the user or
// group. Read-only. Nullable.
func (c OnenoteNotebookClient) GetOnenoteNotebook(ctx context.Context, id stable.UserIdOnenoteNotebookId, options GetOnenoteNotebookOperationOptions) (result GetOnenoteNotebookOperationResponse, err error) {
