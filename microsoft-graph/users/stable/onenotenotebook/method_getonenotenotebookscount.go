...
func (c OnenoteNotebookClient) GetOnenoteNotebooksCount(ctx context.Context, id stable.UserId, options GetOnenoteNotebooksCountOperationOptions) (result GetOnenoteNotebooksCountOperationResponse, err error) {
