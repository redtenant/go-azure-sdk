...
func (c OnenoteNotebookClient) GetOnenoteNotebooksFromWebUrl(ctx context.Context, id stable.UserId, input GetOnenoteNotebooksFromWebUrlRequest, options GetOnenoteNotebooksFromWebUrlOperationOptions) (result GetOnenoteNotebooksFromWebUrlOperationResponse, err error) {
