...
// ListOnenoteNotebooks - Get notebooks from users. The collection of OneNote notebooks that are owned by the user or
// group. Read-only. Nullable.
func (c OnenoteNotebookClient) ListOnenoteNotebooks(ctx context.Context, id stable.UserId, options ListOnenoteNotebooksOperationOptions) (result ListOnenoteNotebooksOperationResponse, err error) {
	...
	var values struct {
		Values *[]stable.Notebook `json:"value"`
	}
...
func (c OnenoteNotebookClient) ListOnenoteNotebooksComplete(ctx context.Context, id stable.UserId, options ListOnenoteNotebooksOperationOptions) (ListOnenoteNotebooksCompleteResult, error) {
...
func (c OnenoteNotebookClient) ListOnenoteNotebooksCompleteMatchingPredicate(ctx context.Context, id stable.UserId, options ListOnenoteNotebooksOperationOptions, predicate NotebookOperationPredicate) (result ListOnenoteNotebooksCompleteResult, err error) {
	items := make([]stable.Notebook, 0)
