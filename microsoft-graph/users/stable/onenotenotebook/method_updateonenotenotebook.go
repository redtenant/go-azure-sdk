...
func DefaultUpdateOnenoteNotebookOperationOptions() UpdateOnenoteNotebookOperationOptions {
	return UpdateOnenoteNotebookOperationOptions{}
}
...
// UpdateOnenoteNotebook - Update the navigation property notebooks in users
func (c OnenoteNotebookClient) UpdateOnenoteNotebook(ctx context.Context, id stable.UserIdOnenoteNotebookId, input stable.Notebook, options UpdateOnenoteNotebookOperationOptions) (result UpdateOnenoteNotebookOperationResponse, err error) {
