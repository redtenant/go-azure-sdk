...
// CopyOnenoteNotebookSectionToSectionGroup - Invoke action copyToSectionGroup. For Copy operations, you follow an
// asynchronous calling pattern: First call the Copy action, and then poll the operation endpoint for the result.
func (c OnenoteNotebookSectionClient) CopyOnenoteNotebookSectionToSectionGroup(ctx context.Context, id stable.UserIdOnenoteNotebookIdSectionId, input CopyOnenoteNotebookSectionToSectionGroupRequest, options CopyOnenoteNotebookSectionToSectionGroupOperationOptions) (result CopyOnenoteNotebookSectionToSectionGroupOperationResponse, err error) {
