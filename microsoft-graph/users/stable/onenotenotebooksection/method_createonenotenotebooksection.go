...
func DefaultCreateOnenoteNotebookSectionOperationOptions() CreateOnenoteNotebookSectionOperationOptions {
	return CreateOnenoteNotebookSectionOperationOptions{}
}
...
// CreateOnenoteNotebookSection - Create new navigation property to sections for users
func (c OnenoteNotebookSectionClient) CreateOnenoteNotebookSection(ctx context.Context, id stable.UserIdOnenoteNotebookId, input stable.OnenoteSection, options CreateOnenoteNotebookSectionOperationOptions) (result CreateOnenoteNotebookSectionOperationResponse, err error) {
