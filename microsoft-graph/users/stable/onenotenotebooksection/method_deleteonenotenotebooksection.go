...
func DefaultDeleteOnenoteNotebookSectionOperationOptions() DeleteOnenoteNotebookSectionOperationOptions {
	return DeleteOnenoteNotebookSectionOperationOptions{}
}
...
// DeleteOnenoteNotebookSection - Delete navigation property sections for users
func (c OnenoteNotebookSectionClient) DeleteOnenoteNotebookSection(ctx context.Context, id stable.UserIdOnenoteNotebookIdSectionId, options DeleteOnenoteNotebookSectionOperationOptions) (result DeleteOnenoteNotebookSectionOperationResponse, err error) {
