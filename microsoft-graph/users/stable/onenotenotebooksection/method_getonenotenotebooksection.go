...
func DefaultGetOnenoteNotebookSectionOperationOptions() GetOnenoteNotebookSectionOperationOptions {
	return GetOnenoteNotebookSectionOperationOptions{}
}
...
// GetOnenoteNotebookSection - Get sections from users. The sections in the notebook. Read-only. Nullable.
func (c OnenoteNotebookSectionClient) GetOnenoteNotebookSection(ctx context.Context, id stable.UserIdOnenoteNotebookIdSectionId, options GetOnenoteNotebookSectionOperationOptions) (result GetOnenoteNotebookSectionOperationResponse, err error) {
