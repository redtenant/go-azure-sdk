...
// ListOnenoteNotebookSections - Get sections from users. The sections in the notebook. Read-only. Nullable.
func (c OnenoteNotebookSectionClient) ListOnenoteNotebookSections(ctx context.Context, id stable.UserIdOnenoteNotebookId, options ListOnenoteNotebookSectionsOperationOptions) (result ListOnenoteNotebookSectionsOperationResponse, err error) {
...
func (c OnenoteNotebookSectionClient) ListOnenoteNotebookSectionsComplete(ctx context.Context, id stable.UserIdOnenoteNotebookId, options ListOnenoteNotebookSectionsOperationOptions) (ListOnenoteNotebookSectionsCompleteResult, error) {
...
func (c OnenoteNotebookSectionClient) ListOnenoteNotebookSectionsCompleteMatchingPredicate(ctx context.Context, id stable.UserIdOnenoteNotebookId, options ListOnenoteNotebookSectionsOperationOptions, predicate OnenoteSectionOperationPredicate) (result ListOnenoteNotebookSectionsCompleteResult, err error) {
