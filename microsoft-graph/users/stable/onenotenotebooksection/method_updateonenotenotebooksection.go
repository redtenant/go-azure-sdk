...
// UpdateOnenoteNotebookSection - Update the navigation property sections in users
func (c OnenoteNotebookSectionClient) UpdateOnenoteNotebookSection(ctx context.Context, id stable.UserIdOnenoteNotebookIdSectionId, input stable.OnenoteSection, options UpdateOnenoteNotebookSectionOperationOptions) (result UpdateOnenoteNotebookSectionOperationResponse, err error) {
