...
func (c OnenoteNotebookSectionGroupClient) CreateOnenoteNotebookSectionGroup(ctx context.Context, id stable.UserIdOnenoteNotebookId, input stable.SectionGroup, options CreateOnenoteNotebookSectionGroupOperationOptions) (result CreateOnenoteNotebookSectionGroupOperationResponse, err error) {
