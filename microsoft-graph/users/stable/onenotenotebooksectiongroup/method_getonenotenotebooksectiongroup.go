...
// Nullable.
func (c OnenoteNotebookSectionGroupClient) GetOnenoteNotebookSectionGroup(ctx context.Context, id stable.UserIdOnenoteNotebookIdSectionGroupId, options GetOnenoteNotebookSectionGroupOperationOptions) (result GetOnenoteNotebookSectionGroupOperationResponse, err error) {
