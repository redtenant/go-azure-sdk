...
// ListOnenoteNotebookSectionGroups - Get sectionGroups from users. The section groups in the notebook. Read-only.
// Nullable.
func (c OnenoteNotebookSectionGroupClient) ListOnenoteNotebookSectionGroups(ctx context.Context, id stable.UserIdOnenoteNotebookId, options ListOnenoteNotebookSectionGroupsOperationOptions) (result ListOnenoteNotebookSectionGroupsOperationResponse, err error) {
...
func (c OnenoteNotebookSectionGroupClient) ListOnenoteNotebookSectionGroupsComplete(ctx context.Context, id stable.UserIdOnenoteNotebookId, options ListOnenoteNotebookSectionGroupsOperationOptions) (ListOnenoteNotebookSectionGroupsCompleteResult, error) {
...
func (c OnenoteNotebookSectionGroupClient) ListOnenoteNotebookSectionGroupsCompleteMatchingPredicate(ctx context.Context, id stable.UserIdOnenoteNotebookId, options ListOnenoteNotebookSectionGroupsOperationOptions, predicate SectionGroupOperationPredicate) (result ListOnenoteNotebookSectionGroupsCompleteResult, err error) {
