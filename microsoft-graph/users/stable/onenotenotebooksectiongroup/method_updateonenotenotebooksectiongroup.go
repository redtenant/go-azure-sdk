...
func (c OnenoteNotebookSectionGroupClient) UpdateOnenoteNotebookSectionGroup(ctx context.Context, id stable.UserIdOnenoteNotebookIdSectionGroupId, input stable.SectionGroup, options UpdateOnenoteNotebookSectionGroupOperationOptions) (result UpdateOnenoteNotebookSectionGroupOperationResponse, err error) {
