...
func (c OnenoteNotebookSectionGroupSectionGroupClient) GetOnenoteNotebookSectionGroupCount(ctx context.Context, id stable.UserIdOnenoteNotebookIdSectionGroupId, options GetOnenoteNotebookSectionGroupCountOperationOptions) (result GetOnenoteNotebookSectionGroupCountOperationResponse, err error) {
