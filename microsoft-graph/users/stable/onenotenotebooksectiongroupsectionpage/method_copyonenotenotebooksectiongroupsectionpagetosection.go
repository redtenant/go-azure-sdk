...
func (c OnenoteNotebookSectionGroupSectionPageClient) CopyOnenoteNotebookSectionGroupSectionPageToSection(ctx context.Context, id stable.UserIdOnenoteNotebookIdSectionGroupIdSectionIdPageId, input CopyOnenoteNotebookSectionGroupSectionPageToSectionRequest, options CopyOnenoteNotebookSectionGroupSectionPageToSectionOperationOptions) (result CopyOnenoteNotebookSectionGroupSectionPageToSectionOperationResponse, err error) {
