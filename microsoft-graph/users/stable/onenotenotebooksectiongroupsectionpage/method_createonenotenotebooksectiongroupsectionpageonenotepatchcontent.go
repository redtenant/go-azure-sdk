...
func (c OnenoteNotebookSectionGroupSectionPageClient) CreateOnenoteNotebookSectionGroupSectionPageOnenotePatchContent(ctx context.Context, id stable.UserIdOnenoteNotebookIdSectionGroupIdSectionIdPageId, input CreateOnenoteNotebookSectionGroupSectionPageOnenotePatchContentRequest, options CreateOnenoteNotebookSectionGroupSectionPageOnenotePatchContentOperationOptions) (result CreateOnenoteNotebookSectionGroupSectionPageOnenotePatchContentOperationResponse, err error) {
