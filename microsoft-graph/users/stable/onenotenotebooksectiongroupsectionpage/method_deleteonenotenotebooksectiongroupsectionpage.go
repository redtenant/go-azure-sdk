...
// DeleteOnenoteNotebookSectionGroupSectionPage - Delete navigation property pages for users
func (c OnenoteNotebookSectionGroupSectionPageClient) DeleteOnenoteNotebookSectionGroupSectionPage(ctx context.Context, id stable.UserIdOnenoteNotebookIdSectionGroupIdSectionIdPageId, options DeleteOnenoteNotebookSectionGroupSectionPageOperationOptions) (result DeleteOnenoteNotebookSectionGroupSectionPageOperationResponse, err error) {
