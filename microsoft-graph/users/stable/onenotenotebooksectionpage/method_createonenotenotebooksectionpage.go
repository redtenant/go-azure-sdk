...
func (c OnenoteNotebookSectionPageClient) CreateOnenoteNotebookSectionPage(ctx context.Context, id stable.UserIdOnenoteNotebookIdSectionId, input stable.OnenotePage, options CreateOnenoteNotebookSectionPageOperationOptions) (result CreateOnenoteNotebookSectionPageOperationResponse, err error) {
