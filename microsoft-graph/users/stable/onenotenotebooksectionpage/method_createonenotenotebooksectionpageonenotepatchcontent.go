...
func (c OnenoteNotebookSectionPageClient) CreateOnenoteNotebookSectionPageOnenotePatchContent(ctx context.Context, id stable.UserIdOnenoteNotebookIdSectionIdPageId, input CreateOnenoteNotebookSectionPageOnenotePatchContentRequest, options CreateOnenoteNotebookSectionPageOnenotePatchContentOperationOptions) (result CreateOnenoteNotebookSectionPageOnenotePatchContentOperationResponse, err error) {
