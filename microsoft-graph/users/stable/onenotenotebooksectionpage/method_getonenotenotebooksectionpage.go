...
func (c OnenoteNotebookSectionPageClient) GetOnenoteNotebookSectionPage(ctx context.Context, id stable.UserIdOnenoteNotebookIdSectionIdPageId, options GetOnenoteNotebookSectionPageOperationOptions) (result GetOnenoteNotebookSectionPageOperationResponse, err error) {
