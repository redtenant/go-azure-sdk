...
func DefaultGetOnenoteNotebookSectionPagesCountOperationOptions() GetOnenoteNotebookSectionPagesCountOperationOptions {
	return GetOnenoteNotebookSectionPagesCountOperationOptions{}
}
...
func (c OnenoteNotebookSectionPageClient) GetOnenoteNotebookSectionPagesCount(ctx context.Context, id stable.UserIdOnenoteNotebookIdSectionId, options GetOnenoteNotebookSectionPagesCountOperationOptions) (result GetOnenoteNotebookSectionPagesCountOperationResponse, err error) {
