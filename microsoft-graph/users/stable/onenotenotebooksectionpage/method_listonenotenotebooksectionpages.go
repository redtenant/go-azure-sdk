...
func (c OnenoteNotebookSectionPageClient) ListOnenoteNotebookSectionPages(ctx context.Context, id stable.UserIdOnenoteNotebookIdSectionId, options ListOnenoteNotebookSectionPagesOperationOptions) (result ListOnenoteNotebookSectionPagesOperationResponse, err error) {
...
func (c OnenoteNotebookSectionPageClient) ListOnenoteNotebookSectionPagesComplete(ctx context.Context, id stable.UserIdOnenoteNotebookIdSectionId, options ListOnenoteNotebookSectionPagesOperationOptions) (ListOnenoteNotebookSectionPagesCompleteResult, error) {
