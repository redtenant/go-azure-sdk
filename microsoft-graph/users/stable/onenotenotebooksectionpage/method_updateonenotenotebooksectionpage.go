...
func (c OnenoteNotebookSectionPageClient) UpdateOnenoteNotebookSectionPage(ctx context.Context, id stable.UserIdOnenoteNotebookIdSectionIdPageId, input stable.OnenotePage, options UpdateOnenoteNotebookSectionPageOperationOptions) (result UpdateOnenoteNotebookSectionPageOperationResponse, err error) {
