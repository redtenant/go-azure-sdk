...
// DeleteOnenoteNotebookSectionPageContent - Delete content for the navigation property pages in users. The page's HTML
// content.
func (c OnenoteNotebookSectionPageContentClient) DeleteOnenoteNotebookSectionPageContent(ctx context.Context, id stable.UserIdOnenoteNotebookIdSectionIdPageId, options DeleteOnenoteNotebookSectionPageContentOperationOptions) (result DeleteOnenoteNotebookSectionPageContentOperationResponse, err error) {
