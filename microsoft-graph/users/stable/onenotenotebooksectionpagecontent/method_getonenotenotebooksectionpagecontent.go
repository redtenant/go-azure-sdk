...
// GetOnenoteNotebookSectionPageContent - Get content for the navigation property pages from users. The page's HTML
// content.
func (c OnenoteNotebookSectionPageContentClient) GetOnenoteNotebookSectionPageContent(ctx context.Context, id stable.UserIdOnenoteNotebookIdSectionIdPageId, options GetOnenoteNotebookSectionPageContentOperationOptions) (result GetOnenoteNotebookSectionPageContentOperationResponse, err error) {
