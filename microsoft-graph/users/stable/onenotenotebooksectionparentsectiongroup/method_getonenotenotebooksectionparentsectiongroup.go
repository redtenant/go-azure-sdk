...
// GetOnenoteNotebookSectionParentSectionGroup - Get parentSectionGroup from users. The section group that contains the
// section. Read-only.
func (c OnenoteNotebookSectionParentSectionGroupClient) GetOnenoteNotebookSectionParentSectionGroup(ctx context.Context, id stable.UserIdOnenoteNotebookIdSectionId, options GetOnenoteNotebookSectionParentSectionGroupOperationOptions) (result GetOnenoteNotebookSectionParentSectionGroupOperationResponse, err error) {
