...
func (c OnenoteOperationClient) CreateOnenoteOperation(ctx context.Context, id stable.UserId, input stable.OnenoteOperation, options CreateOnenoteOperationOperationOptions) (result CreateOnenoteOperationOperationResponse, err error) {
