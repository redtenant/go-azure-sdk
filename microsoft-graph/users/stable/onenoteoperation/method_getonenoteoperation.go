...
func (c OnenoteOperationClient) GetOnenoteOperation(ctx context.Context, id stable.UserIdOnenoteOperationId, options GetOnenoteOperationOperationOptions) (result GetOnenoteOperationOperationResponse, err error) {
