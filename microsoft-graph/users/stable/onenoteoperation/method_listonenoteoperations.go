...
// ListOnenoteOperations - Get operations from users. The status of OneNote operations. Getting an operations collection
...
func (c OnenoteOperationClient) ListOnenoteOperations(ctx context.Context, id stable.UserId, options ListOnenoteOperationsOperationOptions) (result ListOnenoteOperationsOperationResponse, err error) {
...
func (c OnenoteOperationClient) ListOnenoteOperationsComplete(ctx context.Context, id stable.UserId, options ListOnenoteOperationsOperationOptions) (ListOnenoteOperationsCompleteResult, error) {
...
func (c OnenoteOperationClient) ListOnenoteOperationsCompleteMatchingPredicate(ctx context.Context, id stable.UserId, options ListOnenoteOperationsOperationOptions, predicate OnenoteOperationOperationPredicate) (result ListOnenoteOperationsCompleteResult, err error) {
