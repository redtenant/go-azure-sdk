...
// UpdateOnenoteOperation - Update the navigation property operations in users
func (c OnenoteOperationClient) UpdateOnenoteOperation(ctx context.Context, id stable.UserIdOnenoteOperationId, input stable.OnenoteOperation, options UpdateOnenoteOperationOperationOptions) (result UpdateOnenoteOperationOperationResponse, err error) {
