...
// result.
func (c OnenotePageClient) CopyOnenotePageToSection(ctx context.Context, id stable.UserIdOnenotePageId, input CopyOnenotePageToSectionRequest, options CopyOnenotePageToSectionOperationOptions) (result CopyOnenotePageToSectionOperationResponse, err error) {
