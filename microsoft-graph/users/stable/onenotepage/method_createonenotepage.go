...
func (c OnenotePageClient) CreateOnenotePage(ctx context.Context, id stable.UserId, input stable.OnenotePage, options CreateOnenotePageOperationOptions) (result CreateOnenotePageOperationResponse, err error) {
