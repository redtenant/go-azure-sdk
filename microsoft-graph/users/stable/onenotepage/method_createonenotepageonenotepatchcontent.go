...
func (c OnenotePageClient) CreateOnenotePageOnenotePatchContent(ctx context.Context, id stable.UserIdOnenotePageId, input CreateOnenotePageOnenotePatchContentRequest, options CreateOnenotePageOnenotePatchContentOperationOptions) (result CreateOnenotePageOnenotePatchContentOperationResponse, err error) {
