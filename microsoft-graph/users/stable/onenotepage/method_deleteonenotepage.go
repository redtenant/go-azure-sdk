...
func (c OnenotePageClient) DeleteOnenotePage(ctx context.Context, id stable.UserIdOnenotePageId, options DeleteOnenotePageOperationOptions) (result DeleteOnenotePageOperationResponse, err error) {
