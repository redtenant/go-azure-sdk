...
// GetOnenotePage - Get pages from users. The pages in all OneNote notebooks that are owned by the user or group.
// Read-only. Nullable.
func (c OnenotePageClient) GetOnenotePage(ctx context.Context, id stable.UserIdOnenotePageId, options GetOnenotePageOperationOptions) (result GetOnenotePageOperationResponse, err error) {
