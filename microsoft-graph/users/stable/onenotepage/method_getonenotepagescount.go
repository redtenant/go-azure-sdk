...
func (c OnenotePageClient) GetOnenotePagesCount(ctx context.Context, id stable.UserId, options GetOnenotePagesCountOperationOptions) (result GetOnenotePagesCountOperationResponse, err error) {
