...
// ListOnenotePages - Get pages from users. The pages in all OneNote notebooks that are owned by the user or group.
// Read-only. Nullable.
func (c OnenotePageClient) ListOnenotePages(ctx context.Context, id stable.UserId, options ListOnenotePagesOperationOptions) (result ListOnenotePagesOperationResponse, err error) {
...
func (c OnenotePageClient) ListOnenotePagesComplete(ctx context.Context, id stable.UserId, options ListOnenotePagesOperationOptions) (ListOnenotePagesCompleteResult, error) {
...
func (c OnenotePageClient) ListOnenotePagesCompleteMatchingPredicate(ctx context.Context, id stable.UserId, options ListOnenotePagesOperationOptions, predicate OnenotePageOperationPredicate) (result ListOnenotePagesCompleteResult, err error) {
