...
func (c OnenotePageClient) UpdateOnenotePage(ctx context.Context, id stable.UserIdOnenotePageId, input stable.OnenotePage, options UpdateOnenotePageOperationOptions) (result UpdateOnenotePageOperationResponse, err error) {
