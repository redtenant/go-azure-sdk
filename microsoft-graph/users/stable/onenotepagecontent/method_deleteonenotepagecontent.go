...
// DeleteOnenotePageContent - Delete content for the navigation property pages in users. The page's HTML content.
func (c OnenotePageContentClient) DeleteOnenotePageContent(ctx context.Context, id stable.UserIdOnenotePageId, options DeleteOnenotePageContentOperationOptions) (result DeleteOnenotePageContentOperationResponse, err error) {
