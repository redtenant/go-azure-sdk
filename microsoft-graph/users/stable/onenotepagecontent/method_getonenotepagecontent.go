...
// GetOnenotePageContent - Get content for the navigation property pages from users. The page's HTML content.
func (c OnenotePageContentClient) GetOnenotePageContent(ctx context.Context, id stable.UserIdOnenotePageId, options GetOnenotePageContentOperationOptions) (result GetOnenotePageContentOperationResponse, err error) {
