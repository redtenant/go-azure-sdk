...
func (c OnenotePageParentNotebookClient) GetOnenotePageParentNotebook(ctx context.Context, id stable.UserIdOnenotePageId, options GetOnenotePageParentNotebookOperationOptions) (result GetOnenotePageParentNotebookOperationResponse, err error) {
