...
// CreateOnenoteResource - Create new navigation property to resources for users
func (c OnenoteResourceClient) CreateOnenoteResource(ctx context.Context, id stable.UserId, input stable.OnenoteResource, options CreateOnenoteResourceOperationOptions) (result CreateOnenoteResourceOperationResponse, err error) {
