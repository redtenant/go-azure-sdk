...
func (c OnenoteResourceClient) ListOnenoteResources(ctx context.Context, id stable.UserId, options ListOnenoteResourcesOperationOptions) (result ListOnenoteResourcesOperationResponse, err error) {
...
func (c OnenoteResourceClient) ListOnenoteResourcesComplete(ctx context.Context, id stable.UserId, options ListOnenoteResourcesOperationOptions) (ListOnenoteResourcesCompleteResult, error) {
...
func (c OnenoteResourceClient) ListOnenoteResourcesCompleteMatchingPredicate(ctx context.Context, id stable.UserId, options ListOnenoteResourcesOperationOptions, predicate OnenoteResourceOperationPredicate) (result ListOnenoteResourcesCompleteResult, err error) {
