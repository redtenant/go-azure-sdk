...
// UpdateOnenoteResource - Update the navigation property resources in users
func (c OnenoteResourceClient) UpdateOnenoteResource(ctx context.Context, id stable.UserIdOnenoteResourceId, input stable.OnenoteResource, options UpdateOnenoteResourceOperationOptions) (result UpdateOnenoteResourceOperationResponse, err error) {
