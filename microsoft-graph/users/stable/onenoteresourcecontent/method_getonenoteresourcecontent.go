...
// GetOnenoteResourceContent - Get content for the navigation property resources from users. The content stream
func (c OnenoteResourceContentClient) GetOnenoteResourceContent(ctx context.Context, id stable.UserIdOnenoteResourceId, options GetOnenoteResourceContentOperationOptions) (result GetOnenoteResourceContentOperationResponse, err error) {
