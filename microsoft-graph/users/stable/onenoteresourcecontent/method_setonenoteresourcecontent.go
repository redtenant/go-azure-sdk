...
// SetOnenoteResourceContent - Update content for the navigation property resources in users. The content stream
func (c OnenoteResourceContentClient) SetOnenoteResourceContent(ctx context.Context, id stable.UserIdOnenoteResourceId, input []byte, options SetOnenoteResourceContentOperationOptions) (result SetOnenoteResourceContentOperationResponse, err error) {
