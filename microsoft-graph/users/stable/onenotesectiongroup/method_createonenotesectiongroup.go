...
func (c OnenoteSectionGroupClient) CreateOnenoteSectionGroup(ctx context.Context, id stable.UserId, input stable.SectionGroup, options CreateOnenoteSectionGroupOperationOptions) (result CreateOnenoteSectionGroupOperationResponse, err error) {
