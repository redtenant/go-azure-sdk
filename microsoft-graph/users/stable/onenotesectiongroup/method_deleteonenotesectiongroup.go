...
func (c OnenoteSectionGroupClient) DeleteOnenoteSectionGroup(ctx context.Context, id stable.UserIdOnenoteSectionGroupId, options DeleteOnenoteSectionGroupOperationOptions) (result DeleteOnenoteSectionGroupOperationResponse, err error) {
