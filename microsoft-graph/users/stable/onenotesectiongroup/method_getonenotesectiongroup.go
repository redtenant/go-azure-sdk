...
// GetOnenoteSectionGroup - Get sectionGroups from users. The section groups in all OneNote notebooks that are owned by
// the user or group. Read-only. Nullable.
func (c OnenoteSectionGroupClient) GetOnenoteSectionGroup(ctx context.Context, id stable.UserIdOnenoteSectionGroupId, options GetOnenoteSectionGroupOperationOptions) (result GetOnenoteSectionGroupOperationResponse, err error) {
