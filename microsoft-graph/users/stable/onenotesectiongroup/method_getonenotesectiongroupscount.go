...
func (c OnenoteSectionGroupClient) GetOnenoteSectionGroupsCount(ctx context.Context, id stable.UserId, options GetOnenoteSectionGroupsCountOperationOptions) (result GetOnenoteSectionGroupsCountOperationResponse, err error) {
