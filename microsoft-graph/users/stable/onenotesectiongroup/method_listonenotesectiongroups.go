...
// ListOnenoteSectionGroups - Get sectionGroups from users. The section groups in all OneNote notebooks that are owned
// by the user or group. Read-only. Nullable.
func (c OnenoteSectionGroupClient) ListOnenoteSectionGroups(ctx context.Context, id stable.UserId, options ListOnenoteSectionGroupsOperationOptions) (result ListOnenoteSectionGroupsOperationResponse, err error) {
...
func (c OnenoteSectionGroupClient) ListOnenoteSectionGroupsComplete(ctx context.Context, id stable.UserId, options ListOnenoteSectionGroupsOperationOptions) (ListOnenoteSectionGroupsCompleteResult, error) {
...
func (c OnenoteSectionGroupClient) ListOnenoteSectionGroupsCompleteMatchingPredicate(ctx context.Context, id stable.UserId, options ListOnenoteSectionGroupsOperationOptions, predicate SectionGroupOperationPredicate) (result ListOnenoteSectionGroupsCompleteResult, err error) {
