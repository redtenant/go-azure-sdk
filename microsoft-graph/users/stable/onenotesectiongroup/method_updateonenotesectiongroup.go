...
func (c OnenoteSectionGroupClient) UpdateOnenoteSectionGroup(ctx context.Context, id stable.UserIdOnenoteSectionGroupId, input stable.SectionGroup, options UpdateOnenoteSectionGroupOperationOptions) (result UpdateOnenoteSectionGroupOperationResponse, err error) {
