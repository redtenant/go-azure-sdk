...
// GetOnenoteSectionGroupParentNotebook - Get parentNotebook from users. The notebook that contains the section group.
// Read-only.
func (c OnenoteSectionGroupParentNotebookClient) GetOnenoteSectionGroupParentNotebook(ctx context.Context, id stable.UserIdOnenoteSectionGroupId, options GetOnenoteSectionGroupParentNotebookOperationOptions) (result GetOnenoteSectionGroupParentNotebookOperationResponse, err error) {
