...
// GetOnenoteSectionGroupParentSectionGroup - Get parentSectionGroup from users. The section group that contains the
// section group. Read-only.
func (c OnenoteSectionGroupParentSectionGroupClient) GetOnenoteSectionGroupParentSectionGroup(ctx context.Context, id stable.UserIdOnenoteSectionGroupId, options GetOnenoteSectionGroupParentSectionGroupOperationOptions) (result GetOnenoteSectionGroupParentSectionGroupOperationResponse, err error) {
