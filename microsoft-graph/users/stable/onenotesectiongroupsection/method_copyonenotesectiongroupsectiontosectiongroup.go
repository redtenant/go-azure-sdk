...
// CopyOnenoteSectionGroupSectionToSectionGroup - Invoke action copyToSectionGroup. For Copy operations, you follow an
// asynchronous calling pattern: First call the Copy action, and then poll the operation endpoint for the result.
func (c OnenoteSectionGroupSectionClient) CopyOnenoteSectionGroupSectionToSectionGroup(ctx context.Context, id stable.UserIdOnenoteSectionGroupIdSectionId, input CopyOnenoteSectionGroupSectionToSectionGroupRequest, options CopyOnenoteSectionGroupSectionToSectionGroupOperationOptions) (result CopyOnenoteSectionGroupSectionToSectionGroupOperationResponse, err error) {
