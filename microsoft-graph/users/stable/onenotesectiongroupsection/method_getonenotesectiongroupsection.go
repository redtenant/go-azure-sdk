...
func (c OnenoteSectionGroupSectionClient) GetOnenoteSectionGroupSection(ctx context.Context, id stable.UserIdOnenoteSectionGroupIdSectionId, options GetOnenoteSectionGroupSectionOperationOptions) (result GetOnenoteSectionGroupSectionOperationResponse, err error) {
