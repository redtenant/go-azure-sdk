...
func DefaultGetOnenoteSectionGroupSectionsCountOperationOptions() GetOnenoteSectionGroupSectionsCountOperationOptions {
	return GetOnenoteSectionGroupSectionsCountOperationOptions{}
}
...
func (c OnenoteSectionGroupSectionClient) GetOnenoteSectionGroupSectionsCount(ctx context.Context, id stable.UserIdOnenoteSectionGroupId, options GetOnenoteSectionGroupSectionsCountOperationOptions) (result GetOnenoteSectionGroupSectionsCountOperationResponse, err error) {
