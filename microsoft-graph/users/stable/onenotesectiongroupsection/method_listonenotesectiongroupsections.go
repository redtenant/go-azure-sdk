...
func (c OnenoteSectionGroupSectionClient) ListOnenoteSectionGroupSections(ctx context.Context, id stable.UserIdOnenoteSectionGroupId, options ListOnenoteSectionGroupSectionsOperationOptions) (result ListOnenoteSectionGroupSectionsOperationResponse, err error) {
...
func (c OnenoteSectionGroupSectionClient) ListOnenoteSectionGroupSectionsComplete(ctx context.Context, id stable.UserIdOnenoteSectionGroupId, options ListOnenoteSectionGroupSectionsOperationOptions) (ListOnenoteSectionGroupSectionsCompleteResult, error) {
...
func (c OnenoteSectionGroupSectionClient) ListOnenoteSectionGroupSectionsCompleteMatchingPredicate(ctx context.Context, id stable.UserIdOnenoteSectionGroupId, options ListOnenoteSectionGroupSectionsOperationOptions, predicate OnenoteSectionOperationPredicate) (result ListOnenoteSectionGroupSectionsCompleteResult, err error) {
