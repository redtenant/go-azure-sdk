...
func (c OnenoteSectionGroupSectionClient) UpdateOnenoteSectionGroupSection(ctx context.Context, id stable.UserIdOnenoteSectionGroupIdSectionId, input stable.OnenoteSection, options UpdateOnenoteSectionGroupSectionOperationOptions) (result UpdateOnenoteSectionGroupSectionOperationResponse, err error) {
