...
func (c OnenoteSectionGroupSectionGroupClient) GetOnenoteSectionGroupCount(ctx context.Context, id stable.UserIdOnenoteSectionGroupId, options GetOnenoteSectionGroupCountOperationOptions) (result GetOnenoteSectionGroupCountOperationResponse, err error) {
