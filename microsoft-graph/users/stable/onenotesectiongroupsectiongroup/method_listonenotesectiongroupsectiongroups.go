...
// ListOnenoteSectionGroupSectionGroups - Get sectionGroups from users. The section groups in the section. Read-only.
// Nullable.
func (c OnenoteSectionGroupSectionGroupClient) ListOnenoteSectionGroupSectionGroups(ctx context.Context, id stable.UserIdOnenoteSectionGroupId, options ListOnenoteSectionGroupSectionGroupsOperationOptions) (result ListOnenoteSectionGroupSectionGroupsOperationResponse, err error) {
...
func (c OnenoteSectionGroupSectionGroupClient) ListOnenoteSectionGroupSectionGroupsComplete(ctx context.Context, id stable.UserIdOnenoteSectionGroupId, options ListOnenoteSectionGroupSectionGroupsOperationOptions) (ListOnenoteSectionGroupSectionGroupsCompleteResult, error) {
...
func (c OnenoteSectionGroupSectionGroupClient) ListOnenoteSectionGroupSectionGroupsCompleteMatchingPredicate(ctx context.Context, id stable.UserIdOnenoteSectionGroupId, options ListOnenoteSectionGroupSectionGroupsOperationOptions, predicate SectionGroupOperationPredicate) (result ListOnenoteSectionGroupSectionGroupsCompleteResult, err error) {
