...
// GetOnenoteSectionGroupSectionPageParentSection - Get parentSection from users. The section that contains the page.
// Read-only.
func (c OnenoteSectionGroupSectionPageParentSectionClient) GetOnenoteSectionGroupSectionPageParentSection(ctx context.Context, id stable.UserIdOnenoteSectionGroupIdSectionIdPageId, options GetOnenoteSectionGroupSectionPageParentSectionOperationOptions) (result GetOnenoteSectionGroupSectionPageParentSectionOperationResponse, err error) {
