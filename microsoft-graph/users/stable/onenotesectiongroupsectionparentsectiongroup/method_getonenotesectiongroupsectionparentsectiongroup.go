...
// GetOnenoteSectionGroupSectionParentSectionGroup - Get parentSectionGroup from users. The section group that contains
// the section. Read-only.
func (c OnenoteSectionGroupSectionParentSectionGroupClient) GetOnenoteSectionGroupSectionParentSectionGroup(ctx context.Context, id stable.UserIdOnenoteSectionGroupIdSectionId, options GetOnenoteSectionGroupSectionParentSectionGroupOperationOptions) (result GetOnenoteSectionGroupSectionParentSectionGroupOperationResponse, err error) {
