...
func (c OnenoteSectionPageClient) CreateOnenoteSectionPage(ctx context.Context, id stable.UserIdOnenoteSectionId, input stable.OnenotePage, options CreateOnenoteSectionPageOperationOptions) (result CreateOnenoteSectionPageOperationResponse, err error) {
