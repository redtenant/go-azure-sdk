...
func (c OnenoteSectionPageClient) CreateOnenoteSectionPageOnenotePatchContent(ctx context.Context, id stable.UserIdOnenoteSectionIdPageId, input CreateOnenoteSectionPageOnenotePatchContentRequest, options CreateOnenoteSectionPageOnenotePatchContentOperationOptions) (result CreateOnenoteSectionPageOnenotePatchContentOperationResponse, err error) {
