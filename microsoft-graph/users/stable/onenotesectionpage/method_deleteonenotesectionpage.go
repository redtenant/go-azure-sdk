...
func (c OnenoteSectionPageClient) DeleteOnenoteSectionPage(ctx context.Context, id stable.UserIdOnenoteSectionIdPageId, options DeleteOnenoteSectionPageOperationOptions) (result DeleteOnenoteSectionPageOperationResponse, err error) {
