...
func (c OnenoteSectionPageClient) GetOnenoteSectionPage(ctx context.Context, id stable.UserIdOnenoteSectionIdPageId, options GetOnenoteSectionPageOperationOptions) (result GetOnenoteSectionPageOperationResponse, err error) {
