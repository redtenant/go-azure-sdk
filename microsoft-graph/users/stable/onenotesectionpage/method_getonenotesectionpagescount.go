...
func (c OnenoteSectionPageClient) GetOnenoteSectionPagesCount(ctx context.Context, id stable.UserIdOnenoteSectionId, options GetOnenoteSectionPagesCountOperationOptions) (result GetOnenoteSectionPagesCountOperationResponse, err error) {
