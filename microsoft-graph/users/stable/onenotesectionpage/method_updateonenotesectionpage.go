...
func (c OnenoteSectionPageClient) UpdateOnenoteSectionPage(ctx context.Context, id stable.UserIdOnenoteSectionIdPageId, input stable.OnenotePage, options UpdateOnenoteSectionPageOperationOptions) (result UpdateOnenoteSectionPageOperationResponse, err error) {
