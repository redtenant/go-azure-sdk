...
// DeleteOnenoteSectionPageContent - Delete content for the navigation property pages in users. The page's HTML content.
func (c OnenoteSectionPageContentClient) DeleteOnenoteSectionPageContent(ctx context.Context, id stable.UserIdOnenoteSectionIdPageId, options DeleteOnenoteSectionPageContentOperationOptions) (result DeleteOnenoteSectionPageContentOperationResponse, err error) {
