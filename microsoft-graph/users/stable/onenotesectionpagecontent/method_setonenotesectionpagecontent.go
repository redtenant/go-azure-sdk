...
// SetOnenoteSectionPageContent - Update content for the navigation property pages in users. The page's HTML content.
func (c OnenoteSectionPageContentClient) SetOnenoteSectionPageContent(ctx context.Context, id stable.UserIdOnenoteSectionIdPageId, input []byte, options SetOnenoteSectionPageContentOperationOptions) (result SetOnenoteSectionPageContentOperationResponse, err error) {
