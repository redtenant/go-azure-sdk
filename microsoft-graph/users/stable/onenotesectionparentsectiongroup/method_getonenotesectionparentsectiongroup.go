...
// Read-only.
func (c OnenoteSectionParentSectionGroupClient) GetOnenoteSectionParentSectionGroup(ctx context.Context, id stable.UserIdOnenoteSectionId, options GetOnenoteSectionParentSectionGroupOperationOptions) (result GetOnenoteSectionParentSectionGroupOperationResponse, err error) {
