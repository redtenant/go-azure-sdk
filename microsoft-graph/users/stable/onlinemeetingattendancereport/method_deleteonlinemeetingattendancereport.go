...
func (c OnlineMeetingAttendanceReportClient) DeleteOnlineMeetingAttendanceReport(ctx context.Context, id stable.UserIdOnlineMeetingIdAttendanceReportId, options DeleteOnlineMeetingAttendanceReportOperationOptions) (result DeleteOnlineMeetingAttendanceReportOperationResponse, err error) {
