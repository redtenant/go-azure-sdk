...
// Read-only.
func (c OnlineMeetingAttendanceReportClient) ListOnlineMeetingAttendanceReports(ctx context.Context, id stable.UserIdOnlineMeetingId, options ListOnlineMeetingAttendanceReportsOperationOptions) (result ListOnlineMeetingAttendanceReportsOperationResponse, err error) {
...
func (c OnlineMeetingAttendanceReportClient) ListOnlineMeetingAttendanceReportsComplete(ctx context.Context, id stable.UserIdOnlineMeetingId, options ListOnlineMeetingAttendanceReportsOperationOptions) (ListOnlineMeetingAttendanceReportsCompleteResult, error) {
