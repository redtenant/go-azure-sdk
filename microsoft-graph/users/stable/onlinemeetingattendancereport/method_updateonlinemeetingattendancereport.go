...
func (c OnlineMeetingAttendanceReportClient) UpdateOnlineMeetingAttendanceReport(ctx context.Context, id stable.UserIdOnlineMeetingIdAttendanceReportId, input stable.MeetingAttendanceReport, options UpdateOnlineMeetingAttendanceReportOperationOptions) (result UpdateOnlineMeetingAttendanceReportOperationResponse, err error) {
