...
func (c OnlineMeetingAttendanceReportAttendanceRecordClient) DeleteOnlineMeetingAttendanceReportAttendanceRecord(ctx context.Context, id stable.UserIdOnlineMeetingIdAttendanceReportIdAttendanceRecordId, options DeleteOnlineMeetingAttendanceReportAttendanceRecordOperationOptions) (result DeleteOnlineMeetingAttendanceReportAttendanceRecordOperationResponse, err error) {
