...
func (c OnlineMeetingAttendanceReportAttendanceRecordClient) GetOnlineMeetingAttendanceReportAttendanceRecordsCount(ctx context.Context, id stable.UserIdOnlineMeetingIdAttendanceReportId, options GetOnlineMeetingAttendanceReportAttendanceRecordsCountOperationOptions) (result GetOnlineMeetingAttendanceReportAttendanceRecordsCountOperationResponse, err error) {
