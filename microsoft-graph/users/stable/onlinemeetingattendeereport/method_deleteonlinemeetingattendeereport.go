...
// DeleteOnlineMeetingAttendeeReport - Delete attendeeReport for the navigation property onlineMeetings in users. The
// content stream of the attendee report of a Microsoft Teams live event. Read-only.
func (c OnlineMeetingAttendeeReportClient) DeleteOnlineMeetingAttendeeReport(ctx context.Context, id stable.UserIdOnlineMeetingId, options DeleteOnlineMeetingAttendeeReportOperationOptions) (result DeleteOnlineMeetingAttendeeReportOperationResponse, err error) {
