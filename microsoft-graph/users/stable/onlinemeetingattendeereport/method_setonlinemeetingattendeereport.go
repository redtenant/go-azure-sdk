...
// SetOnlineMeetingAttendeeReport - Update attendeeReport for the navigation property onlineMeetings in users. The
// content stream of the attendee report of a Microsoft Teams live event. Read-only.
func (c OnlineMeetingAttendeeReportClient) SetOnlineMeetingAttendeeReport(ctx context.Context, id stable.UserIdOnlineMeetingId, input []byte, options SetOnlineMeetingAttendeeReportOperationOptions) (result SetOnlineMeetingAttendeeReportOperationResponse, err error) {
