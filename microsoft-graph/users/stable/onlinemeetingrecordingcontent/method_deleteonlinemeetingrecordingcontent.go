...
// DeleteOnlineMeetingRecordingContent - Delete content for the navigation property recordings in users. The content of
// the recording. Read-only.
func (c OnlineMeetingRecordingContentClient) DeleteOnlineMeetingRecordingContent(ctx context.Context, id stable.UserIdOnlineMeetingIdRecordingId, options DeleteOnlineMeetingRecordingContentOperationOptions) (result DeleteOnlineMeetingRecordingContentOperationResponse, err error) {
