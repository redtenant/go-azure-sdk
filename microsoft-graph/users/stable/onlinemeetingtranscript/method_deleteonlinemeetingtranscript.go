...
// DeleteOnlineMeetingTranscript - Delete navigation property transcripts for users
func (c OnlineMeetingTranscriptClient) DeleteOnlineMeetingTranscript(ctx context.Context, id stable.UserIdOnlineMeetingIdTranscriptId, options DeleteOnlineMeetingTranscriptOperationOptions) (result DeleteOnlineMeetingTranscriptOperationResponse, err error) {
