...
func (c OnlineMeetingTranscriptMetadataContentClient) DeleteOnlineMeetingTranscriptMetadataContent(ctx context.Context, id stable.UserIdOnlineMeetingIdTranscriptId, options DeleteOnlineMeetingTranscriptMetadataContentOperationOptions) (result DeleteOnlineMeetingTranscriptMetadataContentOperationResponse, err error) {
