...
func DefaultDeleteOutlookMasterCategoryOperationOptions() DeleteOutlookMasterCategoryOperationOptions {
	return DeleteOutlookMasterCategoryOperationOptions{}
}
...
// DeleteOutlookMasterCategory - Delete navigation property masterCategories for users
func (c OutlookMasterCategoryClient) DeleteOutlookMasterCategory(ctx context.Context, id stable.UserIdOutlookMasterCategoryId, options DeleteOutlookMasterCategoryOperationOptions) (result DeleteOutlookMasterCategoryOperationResponse, err error) {
