...
func (c OutlookMasterCategoryClient) UpdateOutlookMasterCategory(ctx context.Context, id stable.UserIdOutlookMasterCategoryId, input stable.OutlookCategory, options UpdateOutlookMasterCategoryOperationOptions) (result UpdateOutlookMasterCategoryOperationResponse, err error) {
