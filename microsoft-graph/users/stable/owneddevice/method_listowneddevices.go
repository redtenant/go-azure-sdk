...
// ListOwnedDevices - Get ownedDevices from users. Devices the user owns. Read-only. Nullable. Supports $expand and
// $filter (/$count eq 0, /$count ne 0, /$count eq 1, /$count ne 1).
func (c OwnedDeviceClient) ListOwnedDevices(ctx context.Context, id stable.UserId, options ListOwnedDevicesOperationOptions) (result ListOwnedDevicesOperationResponse, err error) {
...
func (c OwnedDeviceClient) ListOwnedDevicesComplete(ctx context.Context, id stable.UserId, options ListOwnedDevicesOperationOptions) (ListOwnedDevicesCompleteResult, error) {
