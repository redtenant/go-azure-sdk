...
func (c OwnedObjectClient) GetOwnedObjectsCount(ctx context.Context, id stable.UserId, options GetOwnedObjectsCountOperationOptions) (result GetOwnedObjectsCountOperationResponse, err error) {
