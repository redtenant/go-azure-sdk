...
// ListOwnedObjects - Get ownedObjects from users. Directory objects the user owns. Read-only. Nullable. Supports
// $expand, $select nested in $expand, and $filter (/$count eq 0, /$count ne 0, /$count eq 1, /$count ne 1).
func (c OwnedObjectClient) ListOwnedObjects(ctx context.Context, id stable.UserId, options ListOwnedObjectsOperationOptions) (result ListOwnedObjectsOperationResponse, err error) {
...
func (c OwnedObjectClient) ListOwnedObjectsComplete(ctx context.Context, id stable.UserId, options ListOwnedObjectsOperationOptions) (ListOwnedObjectsCompleteResult, error) {
...
func (c OwnedObjectClient) ListOwnedObjectsCompleteMatchingPredicate(ctx context.Context, id stable.UserId, options ListOwnedObjectsOperationOptions, predicate DirectoryObjectOperationPredicate) (result ListOwnedObjectsCompleteResult, err error) {
