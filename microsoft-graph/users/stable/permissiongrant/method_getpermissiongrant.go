...
// GetPermissionGrant - Get permissionGrants from users. List all resource-specific permission grants of a user.
func (c PermissionGrantClient) GetPermissionGrant(ctx context.Context, id stable.UserIdPermissionGrantId, options GetPermissionGrantOperationOptions) (result GetPermissionGrantOperationResponse, err error) {
