...
func (c PermissionGrantClient) GetPermissionGrantsCount(ctx context.Context, id stable.UserId, options GetPermissionGrantsCountOperationOptions) (result GetPermissionGrantsCountOperationResponse, err error) {
