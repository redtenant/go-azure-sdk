...
// UpdatePermissionGrant - Update the navigation property permissionGrants in users
func (c PermissionGrantClient) UpdatePermissionGrant(ctx context.Context, id stable.UserIdPermissionGrantId, input stable.ResourceSpecificPermissionGrant, options UpdatePermissionGrantOperationOptions) (result UpdatePermissionGrantOperationResponse, err error) {
