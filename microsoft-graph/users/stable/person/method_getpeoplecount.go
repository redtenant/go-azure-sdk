...
func DefaultGetPeopleCountOperationOptions() GetPeopleCountOperationOptions {
	return GetPeopleCountOperationOptions{}
}
...
func (c PersonClient) GetPeopleCount(ctx context.Context, id stable.UserId, options GetPeopleCountOperationOptions) (result GetPeopleCountOperationResponse, err error) {
	opts := client.RequestOptions{
		...
		Path:          fmt.Sprintf("%s/people/$count", id.ID()),
