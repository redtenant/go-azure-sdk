...
func (c PersonClient) GetPerson(ctx context.Context, id stable.UserIdPersonId, options GetPersonOperationOptions) (result GetPersonOperationResponse, err error) {
