...
// Read-only.
func (c PhotoClient) GetPhotoValue(ctx context.Context, id stable.UserIdPhotoId, options GetPhotoValueOperationOptions) (result GetPhotoValueOperationResponse, err error) {
