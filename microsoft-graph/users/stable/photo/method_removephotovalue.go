...
// entity. Read-only.
func (c PhotoClient) RemovePhotoValue(ctx context.Context, id stable.UserIdPhotoId, options RemovePhotoValueOperationOptions) (result RemovePhotoValueOperationResponse, err error) {
