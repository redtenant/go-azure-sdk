...
func DefaultDeletePlannerOperationOptions() DeletePlannerOperationOptions {
	return DeletePlannerOperationOptions{}
}
...
// DeletePlanner - Delete navigation property planner for users
func (c PlannerClient) DeletePlanner(ctx context.Context, id stable.UserId, options DeletePlannerOperationOptions) (result DeletePlannerOperationResponse, err error) {
