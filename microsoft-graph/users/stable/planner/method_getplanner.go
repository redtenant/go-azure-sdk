...
// GetPlanner - Get planner from users. Entry-point to the Planner resource that might exist for a user. Read-only.
func (c PlannerClient) GetPlanner(ctx context.Context, id stable.UserId, options GetPlannerOperationOptions) (result GetPlannerOperationResponse, err error) {
