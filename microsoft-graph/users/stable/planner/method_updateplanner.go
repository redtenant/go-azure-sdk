...
// UpdatePlanner - Update the navigation property planner in users
func (c PlannerClient) UpdatePlanner(ctx context.Context, id stable.UserId, input stable.PlannerUser, options UpdatePlannerOperationOptions) (result UpdatePlannerOperationResponse, err error) {
