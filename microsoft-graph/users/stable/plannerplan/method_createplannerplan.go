...
func (c PlannerPlanClient) CreatePlannerPlan(ctx context.Context, id stable.UserId, input stable.PlannerPlan, options CreatePlannerPlanOperationOptions) (result CreatePlannerPlanOperationResponse, err error) {
