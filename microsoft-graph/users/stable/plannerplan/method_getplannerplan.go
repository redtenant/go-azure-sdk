...
func DefaultGetPlannerPlanOperationOptions() GetPlannerPlanOperationOptions {
	return GetPlannerPlanOperationOptions{}
}
...
// GetPlannerPlan - Get plans from users. Read-only. Nullable. Returns the plannerTasks assigned to the user.
func (c PlannerPlanClient) GetPlannerPlan(ctx context.Context, id stable.UserIdPlannerPlanId, options GetPlannerPlanOperationOptions) (result GetPlannerPlanOperationResponse, err error) {
