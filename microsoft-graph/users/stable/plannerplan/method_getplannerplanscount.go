...
func (c PlannerPlanClient) GetPlannerPlansCount(ctx context.Context, id stable.UserId, options GetPlannerPlansCountOperationOptions) (result GetPlannerPlansCountOperationResponse, err error) {
