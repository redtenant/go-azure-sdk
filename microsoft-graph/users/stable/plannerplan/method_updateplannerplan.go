...
func (c PlannerPlanClient) UpdatePlannerPlan(ctx context.Context, id stable.UserIdPlannerPlanId, input stable.PlannerPlan, options UpdatePlannerPlanOperationOptions) (result UpdatePlannerPlanOperationResponse, err error) {
