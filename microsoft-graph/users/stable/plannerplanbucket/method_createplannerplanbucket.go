...
func (c PlannerPlanBucketClient) CreatePlannerPlanBucket(ctx context.Context, id stable.UserIdPlannerPlanId, input stable.PlannerBucket, options CreatePlannerPlanBucketOperationOptions) (result CreatePlannerPlanBucketOperationResponse, err error) {
