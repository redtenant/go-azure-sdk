...
// ListPlannerPlanBuckets - Get buckets from users. Read-only. Nullable. Collection of buckets in the plan.
func (c PlannerPlanBucketClient) ListPlannerPlanBuckets(ctx context.Context, id stable.UserIdPlannerPlanId, options ListPlannerPlanBucketsOperationOptions) (result ListPlannerPlanBucketsOperationResponse, err error) {
	...
	var values struct {
		Values *[]stable.PlannerBucket `json:"value"`
	}
...
func (c PlannerPlanBucketClient) ListPlannerPlanBucketsComplete(ctx context.Context, id stable.UserIdPlannerPlanId, options ListPlannerPlanBucketsOperationOptions) (ListPlannerPlanBucketsCompleteResult, error) {
...
func (c PlannerPlanBucketClient) ListPlannerPlanBucketsCompleteMatchingPredicate(ctx context.Context, id stable.UserIdPlannerPlanId, options ListPlannerPlanBucketsOperationOptions, predicate PlannerBucketOperationPredicate) (result ListPlannerPlanBucketsCompleteResult, err error) {
	items := make([]stable.PlannerBucket, 0)
