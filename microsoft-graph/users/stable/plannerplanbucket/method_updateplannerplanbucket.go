...
// UpdatePlannerPlanBucket - Update the navigation property buckets in users
func (c PlannerPlanBucketClient) UpdatePlannerPlanBucket(ctx context.Context, id stable.UserIdPlannerPlanIdBucketId, input stable.PlannerBucket, options UpdatePlannerPlanBucketOperationOptions) (result UpdatePlannerPlanBucketOperationResponse, err error) {
