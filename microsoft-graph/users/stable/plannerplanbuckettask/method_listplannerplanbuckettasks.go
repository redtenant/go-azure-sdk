...
// ListPlannerPlanBucketTasks - Get tasks from users. Read-only. Nullable. The collection of tasks in the bucket.
func (c PlannerPlanBucketTaskClient) ListPlannerPlanBucketTasks(ctx context.Context, id stable.UserIdPlannerPlanIdBucketId, options ListPlannerPlanBucketTasksOperationOptions) (result ListPlannerPlanBucketTasksOperationResponse, err error) {
...
func (c PlannerPlanBucketTaskClient) ListPlannerPlanBucketTasksComplete(ctx context.Context, id stable.UserIdPlannerPlanIdBucketId, options ListPlannerPlanBucketTasksOperationOptions) (ListPlannerPlanBucketTasksCompleteResult, error) {
...
func (c PlannerPlanBucketTaskClient) ListPlannerPlanBucketTasksCompleteMatchingPredicate(ctx context.Context, id stable.UserIdPlannerPlanIdBucketId, options ListPlannerPlanBucketTasksOperationOptions, predicate PlannerTaskOperationPredicate) (result ListPlannerPlanBucketTasksCompleteResult, err error) {
