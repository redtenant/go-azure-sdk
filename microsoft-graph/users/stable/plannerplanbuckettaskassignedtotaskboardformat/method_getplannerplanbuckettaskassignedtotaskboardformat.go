...
// GetPlannerPlanBucketTaskAssignedToTaskBoardFormat - Get assignedToTaskBoardFormat from users. Read-only. Nullable.
// Used to render the task correctly in the task board view when grouped by assignedTo.
func (c PlannerPlanBucketTaskAssignedToTaskBoardFormatClient) GetPlannerPlanBucketTaskAssignedToTaskBoardFormat(ctx context.Context, id stable.UserIdPlannerPlanIdBucketIdTaskId, options GetPlannerPlanBucketTaskAssignedToTaskBoardFormatOperationOptions) (result GetPlannerPlanBucketTaskAssignedToTaskBoardFormatOperationResponse, err error) {
