...
// UpdatePlannerPlanBucketTaskDetail - Update the navigation property details in users
func (c PlannerPlanBucketTaskDetailClient) UpdatePlannerPlanBucketTaskDetail(ctx context.Context, id stable.UserIdPlannerPlanIdBucketIdTaskId, input stable.PlannerTaskDetails, options UpdatePlannerPlanBucketTaskDetailOperationOptions) (result UpdatePlannerPlanBucketTaskDetailOperationResponse, err error) {
