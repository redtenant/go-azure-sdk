...
// UpdatePlannerPlanDetail - Update the navigation property details in users
func (c PlannerPlanDetailClient) UpdatePlannerPlanDetail(ctx context.Context, id stable.UserIdPlannerPlanId, input stable.PlannerPlanDetails, options UpdatePlannerPlanDetailOperationOptions) (result UpdatePlannerPlanDetailOperationResponse, err error) {
