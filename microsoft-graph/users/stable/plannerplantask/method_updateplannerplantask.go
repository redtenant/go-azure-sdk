...
func (c PlannerPlanTaskClient) UpdatePlannerPlanTask(ctx context.Context, id stable.UserIdPlannerPlanIdTaskId, input stable.PlannerTask, options UpdatePlannerPlanTaskOperationOptions) (result UpdatePlannerPlanTaskOperationResponse, err error) {
