...
// DeletePlannerPlanTaskDetail - Delete navigation property details for users
func (c PlannerPlanTaskDetailClient) DeletePlannerPlanTaskDetail(ctx context.Context, id stable.UserIdPlannerPlanIdTaskId, options DeletePlannerPlanTaskDetailOperationOptions) (result DeletePlannerPlanTaskDetailOperationResponse, err error) {
