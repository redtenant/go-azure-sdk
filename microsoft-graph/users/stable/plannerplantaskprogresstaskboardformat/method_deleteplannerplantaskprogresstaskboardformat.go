...
func (c PlannerPlanTaskProgressTaskBoardFormatClient) DeletePlannerPlanTaskProgressTaskBoardFormat(ctx context.Context, id stable.UserIdPlannerPlanIdTaskId, options DeletePlannerPlanTaskProgressTaskBoardFormatOperationOptions) (result DeletePlannerPlanTaskProgressTaskBoardFormatOperationResponse, err error) {
