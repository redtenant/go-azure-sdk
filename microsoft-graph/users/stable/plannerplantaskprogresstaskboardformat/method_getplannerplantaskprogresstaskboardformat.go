...
func (c PlannerPlanTaskProgressTaskBoardFormatClient) GetPlannerPlanTaskProgressTaskBoardFormat(ctx context.Context, id stable.UserIdPlannerPlanIdTaskId, options GetPlannerPlanTaskProgressTaskBoardFormatOperationOptions) (result GetPlannerPlanTaskProgressTaskBoardFormatOperationResponse, err error) {
