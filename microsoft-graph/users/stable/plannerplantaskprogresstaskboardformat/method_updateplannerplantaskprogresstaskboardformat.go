...
func (c PlannerPlanTaskProgressTaskBoardFormatClient) UpdatePlannerPlanTaskProgressTaskBoardFormat(ctx context.Context, id stable.UserIdPlannerPlanIdTaskId, input stable.PlannerProgressTaskBoardTaskFormat, options UpdatePlannerPlanTaskProgressTaskBoardFormatOperationOptions) (result UpdatePlannerPlanTaskProgressTaskBoardFormatOperationResponse, err error) {
