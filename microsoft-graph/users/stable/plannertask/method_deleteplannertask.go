...
// DeletePlannerTask - Delete navigation property tasks for users
func (c PlannerTaskClient) DeletePlannerTask(ctx context.Context, id stable.UserIdPlannerTaskId, options DeletePlannerTaskOperationOptions) (result DeletePlannerTaskOperationResponse, err error) {
