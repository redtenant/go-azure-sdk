...
// GetPlannerTask - Get tasks from users. Read-only. Nullable. Returns the plannerPlans shared with the user.
func (c PlannerTaskClient) GetPlannerTask(ctx context.Context, id stable.UserIdPlannerTaskId, options GetPlannerTaskOperationOptions) (result GetPlannerTaskOperationResponse, err error) {
