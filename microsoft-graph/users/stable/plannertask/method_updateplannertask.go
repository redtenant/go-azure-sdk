...
// UpdatePlannerTask - Update the navigation property tasks in users
func (c PlannerTaskClient) UpdatePlannerTask(ctx context.Context, id stable.UserIdPlannerTaskId, input stable.PlannerTask, options UpdatePlannerTaskOperationOptions) (result UpdatePlannerTaskOperationResponse, err error) {
