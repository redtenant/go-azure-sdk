...
// GetPlannerTaskAssignedToTaskBoardFormat - Get assignedToTaskBoardFormat from users. Read-only. Nullable. Used to
// render the task correctly in the task board view when grouped by assignedTo.
func (c PlannerTaskAssignedToTaskBoardFormatClient) GetPlannerTaskAssignedToTaskBoardFormat(ctx context.Context, id stable.UserIdPlannerTaskId, options GetPlannerTaskAssignedToTaskBoardFormatOperationOptions) (result GetPlannerTaskAssignedToTaskBoardFormatOperationResponse, err error) {
