...
// UpdatePlannerTaskAssignedToTaskBoardFormat - Update the navigation property assignedToTaskBoardFormat in users
func (c PlannerTaskAssignedToTaskBoardFormatClient) UpdatePlannerTaskAssignedToTaskBoardFormat(ctx context.Context, id stable.UserIdPlannerTaskId, input stable.PlannerAssignedToTaskBoardTaskFormat, options UpdatePlannerTaskAssignedToTaskBoardFormatOperationOptions) (result UpdatePlannerTaskAssignedToTaskBoardFormatOperationResponse, err error) {
