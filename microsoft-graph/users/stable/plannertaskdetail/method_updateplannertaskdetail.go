...
// UpdatePlannerTaskDetail - Update the navigation property details in users
func (c PlannerTaskDetailClient) UpdatePlannerTaskDetail(ctx context.Context, id stable.UserIdPlannerTaskId, input stable.PlannerTaskDetails, options UpdatePlannerTaskDetailOperationOptions) (result UpdatePlannerTaskDetailOperationResponse, err error) {
