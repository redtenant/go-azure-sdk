...
func (c RegisteredDeviceClient) GetRegisteredDevice(ctx context.Context, id stable.UserIdRegisteredDeviceId, options GetRegisteredDeviceOperationOptions) (result GetRegisteredDeviceOperationResponse, err error) {
