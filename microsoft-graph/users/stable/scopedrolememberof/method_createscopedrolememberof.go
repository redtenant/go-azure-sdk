...
func (c ScopedRoleMemberOfClient) CreateScopedRoleMemberOf(ctx context.Context, id stable.UserId, input stable.ScopedRoleMembership, options CreateScopedRoleMemberOfOperationOptions) (result CreateScopedRoleMemberOfOperationResponse, err error) {
