...
func (c ScopedRoleMemberOfClient) UpdateScopedRoleMemberOf(ctx context.Context, id stable.UserIdScopedRoleMemberOfId, input stable.ScopedRoleMembership, options UpdateScopedRoleMemberOfOperationOptions) (result UpdateScopedRoleMemberOfOperationResponse, err error) {
