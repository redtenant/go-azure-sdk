...
func DefaultDeleteSettingOperationOptions() DeleteSettingOperationOptions {
	return DeleteSettingOperationOptions{}
}
...
// DeleteSetting - Delete navigation property settings for users
func (c SettingClient) DeleteSetting(ctx context.Context, id stable.UserId, options DeleteSettingOperationOptions) (result DeleteSettingOperationResponse, err error) {
