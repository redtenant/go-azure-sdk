...
func (c SettingClient) UpdateSetting(ctx context.Context, id stable.UserId, input stable.UserSettings, options UpdateSettingOperationOptions) (result UpdateSettingOperationResponse, err error) {
