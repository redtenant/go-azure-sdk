...
func (c SettingStorageClient) DeleteSettingStorage(ctx context.Context, id stable.UserId, options DeleteSettingStorageOperationOptions) (result DeleteSettingStorageOperationResponse, err error) {
