...
func (c SettingStorageClient) GetSettingStorage(ctx context.Context, id stable.UserId, options GetSettingStorageOperationOptions) (result GetSettingStorageOperationResponse, err error) {
