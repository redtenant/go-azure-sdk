...
// GetSettingWindow - Get windows from users
func (c SettingWindowClient) GetSettingWindow(ctx context.Context, id stable.UserIdSettingWindowId, options GetSettingWindowOperationOptions) (result GetSettingWindowOperationResponse, err error) {
