...
type UpdateSettingWindowOperationResponse struct {
...
// UpdateSettingWindow - Update the navigation property windows in users
func (c SettingWindowClient) UpdateSettingWindow(ctx context.Context, id stable.UserIdSettingWindowId, input stable.WindowsSetting, options UpdateSettingWindowOperationOptions) (result UpdateSettingWindowOperationResponse, err error) {
