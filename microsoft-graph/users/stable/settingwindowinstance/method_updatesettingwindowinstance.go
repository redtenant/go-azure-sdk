...
// UpdateSettingWindowInstance - Update the navigation property instances in users
func (c SettingWindowInstanceClient) UpdateSettingWindowInstance(ctx context.Context, id stable.UserIdSettingWindowIdInstanceId, input stable.WindowsSettingInstance, options UpdateSettingWindowInstanceOperationOptions) (result UpdateSettingWindowInstanceOperationResponse, err error) {
