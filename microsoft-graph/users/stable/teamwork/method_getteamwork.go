...
// GetTeamwork - Get userTeamwork. Get the userTeamwork settings for a specified user, which includes the Microsoft
// Teams region and the locale chosen by the user.
func (c TeamworkClient) GetTeamwork(ctx context.Context, id stable.UserId, options GetTeamworkOperationOptions) (result GetTeamworkOperationResponse, err error) {
