...
func (c TeamworkAssociatedTeamClient) CreateTeamworkAssociatedTeam(ctx context.Context, id stable.UserId, input stable.AssociatedTeamInfo, options CreateTeamworkAssociatedTeamOperationOptions) (result CreateTeamworkAssociatedTeamOperationResponse, err error) {
