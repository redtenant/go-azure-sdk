...
// GetTeamworkAssociatedTeam - Get associatedTeams from users. The list of associatedTeamInfo objects that a user is
// associated with.
func (c TeamworkAssociatedTeamClient) GetTeamworkAssociatedTeam(ctx context.Context, id stable.UserIdTeamworkAssociatedTeamId, options GetTeamworkAssociatedTeamOperationOptions) (result GetTeamworkAssociatedTeamOperationResponse, err error) {
