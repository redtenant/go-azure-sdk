...
func DefaultGetTeamworkInstalledAppOperationOptions() GetTeamworkInstalledAppOperationOptions {
	return GetTeamworkInstalledAppOperationOptions{}
}
...
// GetTeamworkInstalledApp - Get installed app for user. Retrieve the app installed in the personal scope of the
// specified user.
func (c TeamworkInstalledAppClient) GetTeamworkInstalledApp(ctx context.Context, id stable.UserIdTeamworkInstalledAppId, options GetTeamworkInstalledAppOperationOptions) (result GetTeamworkInstalledAppOperationResponse, err error) {
