...
func DefaultGetTeamworkInstalledAppsCountOperationOptions() GetTeamworkInstalledAppsCountOperationOptions {
	return GetTeamworkInstalledAppsCountOperationOptions{}
}
...
func (c TeamworkInstalledAppClient) GetTeamworkInstalledAppsCount(ctx context.Context, id stable.UserId, options GetTeamworkInstalledAppsCountOperationOptions) (result GetTeamworkInstalledAppsCountOperationResponse, err error) {
	opts := client.RequestOptions{
		...
		Path:          fmt.Sprintf("%s/teamwork/installedApps/$count", id.ID()),
