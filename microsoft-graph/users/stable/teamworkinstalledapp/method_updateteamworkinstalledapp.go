...
func (c TeamworkInstalledAppClient) UpdateTeamworkInstalledApp(ctx context.Context, id stable.UserIdTeamworkInstalledAppId, input stable.UserScopeTeamsAppInstallation, options UpdateTeamworkInstalledAppOperationOptions) (result UpdateTeamworkInstalledAppOperationResponse, err error) {
