...
// GetTeamworkInstalledAppChat - Get chat between user and teamsApp. Retrieve the chat of the specified user and Teams
// app.
func (c TeamworkInstalledAppChatClient) GetTeamworkInstalledAppChat(ctx context.Context, id stable.UserIdTeamworkInstalledAppId, options GetTeamworkInstalledAppChatOperationOptions) (result GetTeamworkInstalledAppChatOperationResponse, err error) {
