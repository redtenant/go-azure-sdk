...
// GetTeamworkInstalledAppTeamsAppDefinition - Get teamsAppDefinition from users. The details of this version of the
// app.
func (c TeamworkInstalledAppTeamsAppDefinitionClient) GetTeamworkInstalledAppTeamsAppDefinition(ctx context.Context, id stable.UserIdTeamworkInstalledAppId, options GetTeamworkInstalledAppTeamsAppDefinitionOperationOptions) (result GetTeamworkInstalledAppTeamsAppDefinitionOperationResponse, err error) {
