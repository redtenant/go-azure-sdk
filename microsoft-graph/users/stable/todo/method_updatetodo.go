...
func (c TodoClient) UpdateTodo(ctx context.Context, id stable.UserId, input stable.Todo, options UpdateTodoOperationOptions) (result UpdateTodoOperationResponse, err error) {
