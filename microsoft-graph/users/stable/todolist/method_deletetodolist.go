...
func DefaultDeleteTodoListOperationOptions() DeleteTodoListOperationOptions {
	return DeleteTodoListOperationOptions{}
}
...
// DeleteTodoList - Delete navigation property lists for users
func (c TodoListClient) DeleteTodoList(ctx context.Context, id stable.UserIdTodoListId, options DeleteTodoListOperationOptions) (result DeleteTodoListOperationResponse, err error) {
