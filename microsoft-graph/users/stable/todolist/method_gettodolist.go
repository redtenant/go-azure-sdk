...
func DefaultGetTodoListOperationOptions() GetTodoListOperationOptions {
	return GetTodoListOperationOptions{}
}
...
// GetTodoList - Get lists from users. The task lists in the users mailbox.
func (c TodoListClient) GetTodoList(ctx context.Context, id stable.UserIdTodoListId, options GetTodoListOperationOptions) (result GetTodoListOperationResponse, err error) {
