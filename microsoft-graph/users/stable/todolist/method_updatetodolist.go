...
func (c TodoListClient) UpdateTodoList(ctx context.Context, id stable.UserIdTodoListId, input stable.TodoTaskList, options UpdateTodoListOperationOptions) (result UpdateTodoListOperationResponse, err error) {
