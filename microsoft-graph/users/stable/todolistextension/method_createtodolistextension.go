...
// CreateTodoListExtension - Create new navigation property to extensions for users
func (c TodoListExtensionClient) CreateTodoListExtension(ctx context.Context, id stable.UserIdTodoListId, input stable.Extension, options CreateTodoListExtensionOperationOptions) (result CreateTodoListExtensionOperationResponse, err error) {
