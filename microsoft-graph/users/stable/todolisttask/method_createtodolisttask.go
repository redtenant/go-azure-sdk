...
func (c TodoListTaskClient) CreateTodoListTask(ctx context.Context, id stable.UserIdTodoListId, input stable.TodoTask, options CreateTodoListTaskOperationOptions) (result CreateTodoListTaskOperationResponse, err error) {
