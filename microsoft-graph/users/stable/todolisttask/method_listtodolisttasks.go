...
// ListTodoListTasks - Get tasks from users. The tasks in this task list. Read-only. Nullable.
func (c TodoListTaskClient) ListTodoListTasks(ctx context.Context, id stable.UserIdTodoListId, options ListTodoListTasksOperationOptions) (result ListTodoListTasksOperationResponse, err error) {
	...
	var values struct {
		Values *[]stable.TodoTask `json:"value"`
	}
...
func (c TodoListTaskClient) ListTodoListTasksComplete(ctx context.Context, id stable.UserIdTodoListId, options ListTodoListTasksOperationOptions) (ListTodoListTasksCompleteResult, error) {
...
func (c TodoListTaskClient) ListTodoListTasksCompleteMatchingPredicate(ctx context.Context, id stable.UserIdTodoListId, options ListTodoListTasksOperationOptions, predicate TodoTaskOperationPredicate) (result ListTodoListTasksCompleteResult, err error) {
	items := make([]stable.TodoTask, 0)
