...
func (c TodoListTaskAttachmentSessionClient) DeleteTodoListTaskAttachmentSession(ctx context.Context, id stable.UserIdTodoListIdTaskIdAttachmentSessionId, options DeleteTodoListTaskAttachmentSessionOperationOptions) (result DeleteTodoListTaskAttachmentSessionOperationResponse, err error) {
