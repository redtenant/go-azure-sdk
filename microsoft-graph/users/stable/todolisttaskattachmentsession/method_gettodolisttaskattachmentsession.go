...
func (c TodoListTaskAttachmentSessionClient) GetTodoListTaskAttachmentSession(ctx context.Context, id stable.UserIdTodoListIdTaskIdAttachmentSessionId, options GetTodoListTaskAttachmentSessionOperationOptions) (result GetTodoListTaskAttachmentSessionOperationResponse, err error) {
