...
func (c TodoListTaskAttachmentSessionClient) ListTodoListTaskAttachmentSessions(ctx context.Context, id stable.UserIdTodoListIdTaskId, options ListTodoListTaskAttachmentSessionsOperationOptions) (result ListTodoListTaskAttachmentSessionsOperationResponse, err error) {
...
func (c TodoListTaskAttachmentSessionClient) ListTodoListTaskAttachmentSessionsComplete(ctx context.Context, id stable.UserIdTodoListIdTaskId, options ListTodoListTaskAttachmentSessionsOperationOptions) (ListTodoListTaskAttachmentSessionsCompleteResult, error) {
...
func (c TodoListTaskAttachmentSessionClient) ListTodoListTaskAttachmentSessionsCompleteMatchingPredicate(ctx context.Context, id stable.UserIdTodoListIdTaskId, options ListTodoListTaskAttachmentSessionsOperationOptions, predicate AttachmentSessionOperationPredicate) (result ListTodoListTaskAttachmentSessionsCompleteResult, err error) {
