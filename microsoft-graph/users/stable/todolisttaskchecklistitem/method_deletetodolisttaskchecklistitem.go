...
// DeleteTodoListTaskChecklistItem - Delete navigation property checklistItems for users
func (c TodoListTaskChecklistItemClient) DeleteTodoListTaskChecklistItem(ctx context.Context, id stable.UserIdTodoListIdTaskIdChecklistItemId, options DeleteTodoListTaskChecklistItemOperationOptions) (result DeleteTodoListTaskChecklistItemOperationResponse, err error) {
