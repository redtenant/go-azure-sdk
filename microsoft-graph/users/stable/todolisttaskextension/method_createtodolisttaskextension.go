...
func (c TodoListTaskExtensionClient) CreateTodoListTaskExtension(ctx context.Context, id stable.UserIdTodoListIdTaskId, input stable.Extension, options CreateTodoListTaskExtensionOperationOptions) (result CreateTodoListTaskExtensionOperationResponse, err error) {
