...
func (c TodoListTaskExtensionClient) DeleteTodoListTaskExtension(ctx context.Context, id stable.UserIdTodoListIdTaskIdExtensionId, options DeleteTodoListTaskExtensionOperationOptions) (result DeleteTodoListTaskExtensionOperationResponse, err error) {
