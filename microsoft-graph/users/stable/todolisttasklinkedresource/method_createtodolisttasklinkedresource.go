...
func (c TodoListTaskLinkedResourceClient) CreateTodoListTaskLinkedResource(ctx context.Context, id stable.UserIdTodoListIdTaskId, input stable.LinkedResource, options CreateTodoListTaskLinkedResourceOperationOptions) (result CreateTodoListTaskLinkedResourceOperationResponse, err error) {
	...
	var model stable.LinkedResource
	result.Model = &model
