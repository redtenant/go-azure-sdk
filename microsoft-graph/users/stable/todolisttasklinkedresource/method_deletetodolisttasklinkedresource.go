...
func (c TodoListTaskLinkedResourceClient) DeleteTodoListTaskLinkedResource(ctx context.Context, id stable.UserIdTodoListIdTaskIdLinkedResourceId, options DeleteTodoListTaskLinkedResourceOperationOptions) (result DeleteTodoListTaskLinkedResourceOperationResponse, err error) {
