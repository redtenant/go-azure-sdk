...
func (c TodoListTaskLinkedResourceClient) GetTodoListTaskLinkedResource(ctx context.Context, id stable.UserIdTodoListIdTaskIdLinkedResourceId, options GetTodoListTaskLinkedResourceOperationOptions) (result GetTodoListTaskLinkedResourceOperationResponse, err error) {
