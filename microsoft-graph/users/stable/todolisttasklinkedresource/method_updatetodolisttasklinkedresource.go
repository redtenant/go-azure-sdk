...
// UpdateTodoListTaskLinkedResource - Update the navigation property linkedResources in users
func (c TodoListTaskLinkedResourceClient) UpdateTodoListTaskLinkedResource(ctx context.Context, id stable.UserIdTodoListIdTaskIdLinkedResourceId, input stable.LinkedResource, options UpdateTodoListTaskLinkedResourceOperationOptions) (result UpdateTodoListTaskLinkedResourceOperationResponse, err error) {
