...
func (c UserClient) CheckMemberObjects(ctx context.Context, id stable.UserId, input CheckMemberObjectsRequest, options CheckMemberObjectsOperationOptions) (result CheckMemberObjectsOperationResponse, err error) {
...
func (c UserClient) CheckMemberObjectsComplete(ctx context.Context, id stable.UserId, input CheckMemberObjectsRequest, options CheckMemberObjectsOperationOptions) (result CheckMemberObjectsCompleteResult, err error) {
	items := make([]string, 0)
