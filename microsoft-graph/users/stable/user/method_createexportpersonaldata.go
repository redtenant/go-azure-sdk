...
func (c UserClient) CreateExportPersonalData(ctx context.Context, id stable.UserId, input CreateExportPersonalDataRequest, options CreateExportPersonalDataOperationOptions) (result CreateExportPersonalDataOperationResponse, err error) {
