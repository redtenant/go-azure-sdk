...
func (c UserClient) GetMailTips(ctx context.Context, id stable.UserId, input GetMailTipsRequest, options GetMailTipsOperationOptions) (result GetMailTipsOperationResponse, err error) {
...
func (c UserClient) GetMailTipsComplete(ctx context.Context, id stable.UserId, input GetMailTipsRequest, options GetMailTipsOperationOptions) (GetMailTipsCompleteResult, error) {
