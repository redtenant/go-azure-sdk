...
func (c UserClient) GetMemberObjects(ctx context.Context, id stable.UserId, input GetMemberObjectsRequest, options GetMemberObjectsOperationOptions) (result GetMemberObjectsOperationResponse, err error) {
...
func (c UserClient) GetMemberObjectsComplete(ctx context.Context, id stable.UserId, input GetMemberObjectsRequest, options GetMemberObjectsOperationOptions) (result GetMemberObjectsCompleteResult, err error) {
	items := make([]string, 0)
