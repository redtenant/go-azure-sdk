...
// this user
func (c UserClient) RemoveAllDevicesFromManagement(ctx context.Context, id stable.UserId, options RemoveAllDevicesFromManagementOperationOptions) (result RemoveAllDevicesFromManagementOperationResponse, err error) {
