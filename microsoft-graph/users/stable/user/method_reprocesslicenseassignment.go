...
func (c UserClient) ReprocessLicenseAssignment(ctx context.Context, id stable.UserId, options ReprocessLicenseAssignmentOperationOptions) (result ReprocessLicenseAssignmentOperationResponse, err error) {
