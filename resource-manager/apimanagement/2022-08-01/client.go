...
import (
	...
	"github.com/redtenant/go-azure-sdk/resource-manager/apimanagement/2022-08-01/api"
	"github.com/redtenant/go-azure-sdk/resource-manager/apimanagement/2022-08-01/apidiagnostic"
	"github.com/redtenant/go-azure-sdk/resource-manager/apimanagement/2022-08-01/apiissue"
	"github.com/redtenant/go-azure-sdk/resource-manager/apimanagement/2022-08-01/apiissueattachment"
	"github.com/redtenant/go-azure-sdk/resource-manager/apimanagement/2022-08-01/apiissuecomment"
	"github.com/redtenant/go-azure-sdk/resource-manager/apimanagement/2022-08-01/apimanagementservice"
	"github.com/redtenant/go-azure-sdk/resource-manager/apimanagement/2022-08-01/apimanagementserviceskus"
	"github.com/redtenant/go-azure-sdk/resource-manager/apimanagement/2022-08-01/apioperation"
	"github.com/redtenant/go-azure-sdk/resource-manager/apimanagement/2022-08-01/apioperationpolicy"
	"github.com/redtenant/go-azure-sdk/resource-manager/apimanagement/2022-08-01/apioperationsbytag"
	"github.com/redtenant/go-azure-sdk/resource-manager/apimanagement/2022-08-01/apioperationtag"
	"github.com/redtenant/go-azure-sdk/resource-manager/apimanagement/2022-08-01/apipolicy"
	"github.com/redtenant/go-azure-sdk/resource-manager/apimanagement/2022-08-01/apiproduct"
	"github.com/redtenant/go-azure-sdk/resource-manager/apimanagement/2022-08-01/apirelease"
	"github.com/redtenant/go-azure-sdk/resource-manager/apimanagement/2022-08-01/apirevision"
	"github.com/redtenant/go-azure-sdk/resource-manager/apimanagement/2022-08-01/apisbytag"
	"github.com/redtenant/go-azure-sdk/resource-manager/apimanagement/2022-08-01/apischema"
	"github.com/redtenant/go-azure-sdk/resource-manager/apimanagement/2022-08-01/apitag"
	"github.com/redtenant/go-azure-sdk/resource-manager/apimanagement/2022-08-01/apitagdescription"
	"github.com/redtenant/go-azure-sdk/resource-manager/apimanagement/2022-08-01/apiversionset"
	"github.com/redtenant/go-azure-sdk/resource-manager/apimanagement/2022-08-01/apiversionsets"
	"github.com/redtenant/go-azure-sdk/resource-manager/apimanagement/2022-08-01/apiwiki"
	"github.com/redtenant/go-azure-sdk/resource-manager/apimanagement/2022-08-01/authorization"
	"github.com/redtenant/go-azure-sdk/resource-manager/apimanagement/2022-08-01/authorizationaccesspolicy"
	"github.com/redtenant/go-azure-sdk/resource-manager/apimanagement/2022-08-01/authorizationconfirmconsentcode"
	"github.com/redtenant/go-azure-sdk/resource-manager/apimanagement/2022-08-01/authorizationloginlinks"
	"github.com/redtenant/go-azure-sdk/resource-manager/apimanagement/2022-08-01/authorizationprovider"
	"github.com/redtenant/go-azure-sdk/resource-manager/apimanagement/2022-08-01/authorizations"
	"github.com/redtenant/go-azure-sdk/resource-manager/apimanagement/2022-08-01/authorizationserver"
	"github.com/redtenant/go-azure-sdk/resource-manager/apimanagement/2022-08-01/backend"
	"github.com/redtenant/go-azure-sdk/resource-manager/apimanagement/2022-08-01/backendreconnect"
	"github.com/redtenant/go-azure-sdk/resource-manager/apimanagement/2022-08-01/cache"
	"github.com/redtenant/go-azure-sdk/resource-manager/apimanagement/2022-08-01/certificate"
	"github.com/redtenant/go-azure-sdk/resource-manager/apimanagement/2022-08-01/contenttype"
	"github.com/redtenant/go-azure-sdk/resource-manager/apimanagement/2022-08-01/contenttypecontentitem"
	"github.com/redtenant/go-azure-sdk/resource-manager/apimanagement/2022-08-01/delegationsettings"
	"github.com/redtenant/go-azure-sdk/resource-manager/apimanagement/2022-08-01/deletedservice"
	"github.com/redtenant/go-azure-sdk/resource-manager/apimanagement/2022-08-01/diagnostic"
	"github.com/redtenant/go-azure-sdk/resource-manager/apimanagement/2022-08-01/documentationresource"
	"github.com/redtenant/go-azure-sdk/resource-manager/apimanagement/2022-08-01/emailtemplate"
	"github.com/redtenant/go-azure-sdk/resource-manager/apimanagement/2022-08-01/emailtemplates"
	"github.com/redtenant/go-azure-sdk/resource-manager/apimanagement/2022-08-01/gateway"
	"github.com/redtenant/go-azure-sdk/resource-manager/apimanagement/2022-08-01/gatewayapi"
	"github.com/redtenant/go-azure-sdk/resource-manager/apimanagement/2022-08-01/gatewaycertificateauthority"
	"github.com/redtenant/go-azure-sdk/resource-manager/apimanagement/2022-08-01/gatewaygeneratetoken"
	"github.com/redtenant/go-azure-sdk/resource-manager/apimanagement/2022-08-01/gatewayhostnameconfiguration"
	"github.com/redtenant/go-azure-sdk/resource-manager/apimanagement/2022-08-01/gatewaylistkeys"
	"github.com/redtenant/go-azure-sdk/resource-manager/apimanagement/2022-08-01/gatewayregeneratekey"
	"github.com/redtenant/go-azure-sdk/resource-manager/apimanagement/2022-08-01/graphqlapiresolver"
	"github.com/redtenant/go-azure-sdk/resource-manager/apimanagement/2022-08-01/graphqlapiresolverpolicy"
	"github.com/redtenant/go-azure-sdk/resource-manager/apimanagement/2022-08-01/group"
	"github.com/redtenant/go-azure-sdk/resource-manager/apimanagement/2022-08-01/groupuser"
	"github.com/redtenant/go-azure-sdk/resource-manager/apimanagement/2022-08-01/identityprovider"
	"github.com/redtenant/go-azure-sdk/resource-manager/apimanagement/2022-08-01/issue"
	"github.com/redtenant/go-azure-sdk/resource-manager/apimanagement/2022-08-01/logger"
	"github.com/redtenant/go-azure-sdk/resource-manager/apimanagement/2022-08-01/namedvalue"
	"github.com/redtenant/go-azure-sdk/resource-manager/apimanagement/2022-08-01/networkstatus"
	"github.com/redtenant/go-azure-sdk/resource-manager/apimanagement/2022-08-01/notification"
	"github.com/redtenant/go-azure-sdk/resource-manager/apimanagement/2022-08-01/notificationrecipientemail"
	"github.com/redtenant/go-azure-sdk/resource-manager/apimanagement/2022-08-01/notificationrecipientuser"
	"github.com/redtenant/go-azure-sdk/resource-manager/apimanagement/2022-08-01/openidconnectprovider"
	"github.com/redtenant/go-azure-sdk/resource-manager/apimanagement/2022-08-01/outboundnetworkdependenciesendpoints"
	"github.com/redtenant/go-azure-sdk/resource-manager/apimanagement/2022-08-01/performconnectivitycheck"
	"github.com/redtenant/go-azure-sdk/resource-manager/apimanagement/2022-08-01/policy"
	"github.com/redtenant/go-azure-sdk/resource-manager/apimanagement/2022-08-01/policydescription"
	"github.com/redtenant/go-azure-sdk/resource-manager/apimanagement/2022-08-01/policyfragment"
	"github.com/redtenant/go-azure-sdk/resource-manager/apimanagement/2022-08-01/portalconfig"
	"github.com/redtenant/go-azure-sdk/resource-manager/apimanagement/2022-08-01/portalrevision"
	"github.com/redtenant/go-azure-sdk/resource-manager/apimanagement/2022-08-01/portalsettings"
	"github.com/redtenant/go-azure-sdk/resource-manager/apimanagement/2022-08-01/privateendpointconnections"
	"github.com/redtenant/go-azure-sdk/resource-manager/apimanagement/2022-08-01/product"
	"github.com/redtenant/go-azure-sdk/resource-manager/apimanagement/2022-08-01/productapi"
	"github.com/redtenant/go-azure-sdk/resource-manager/apimanagement/2022-08-01/productgroup"
	"github.com/redtenant/go-azure-sdk/resource-manager/apimanagement/2022-08-01/productpolicy"
	"github.com/redtenant/go-azure-sdk/resource-manager/apimanagement/2022-08-01/productsbytag"
	"github.com/redtenant/go-azure-sdk/resource-manager/apimanagement/2022-08-01/productsubscription"
	"github.com/redtenant/go-azure-sdk/resource-manager/apimanagement/2022-08-01/producttag"
	"github.com/redtenant/go-azure-sdk/resource-manager/apimanagement/2022-08-01/productwiki"
	"github.com/redtenant/go-azure-sdk/resource-manager/apimanagement/2022-08-01/quotabycounterkeys"
	"github.com/redtenant/go-azure-sdk/resource-manager/apimanagement/2022-08-01/quotabyperiodkeys"
	"github.com/redtenant/go-azure-sdk/resource-manager/apimanagement/2022-08-01/region"
	"github.com/redtenant/go-azure-sdk/resource-manager/apimanagement/2022-08-01/reports"
	"github.com/redtenant/go-azure-sdk/resource-manager/apimanagement/2022-08-01/schema"
	"github.com/redtenant/go-azure-sdk/resource-manager/apimanagement/2022-08-01/signinsettings"
	"github.com/redtenant/go-azure-sdk/resource-manager/apimanagement/2022-08-01/signupsettings"
	"github.com/redtenant/go-azure-sdk/resource-manager/apimanagement/2022-08-01/skus"
	"github.com/redtenant/go-azure-sdk/resource-manager/apimanagement/2022-08-01/subscription"
	"github.com/redtenant/go-azure-sdk/resource-manager/apimanagement/2022-08-01/tag"
	"github.com/redtenant/go-azure-sdk/resource-manager/apimanagement/2022-08-01/tagresource"
	"github.com/redtenant/go-azure-sdk/resource-manager/apimanagement/2022-08-01/tenantaccess"
	"github.com/redtenant/go-azure-sdk/resource-manager/apimanagement/2022-08-01/tenantaccessgit"
	"github.com/redtenant/go-azure-sdk/resource-manager/apimanagement/2022-08-01/tenantconfiguration"
	"github.com/redtenant/go-azure-sdk/resource-manager/apimanagement/2022-08-01/tenantconfigurationsyncstate"
	"github.com/redtenant/go-azure-sdk/resource-manager/apimanagement/2022-08-01/tenantsettings"
	"github.com/redtenant/go-azure-sdk/resource-manager/apimanagement/2022-08-01/user"
	"github.com/redtenant/go-azure-sdk/resource-manager/apimanagement/2022-08-01/userconfirmationpasswordsend"
	"github.com/redtenant/go-azure-sdk/resource-manager/apimanagement/2022-08-01/usergroup"
	"github.com/redtenant/go-azure-sdk/resource-manager/apimanagement/2022-08-01/useridentity"
	"github.com/redtenant/go-azure-sdk/resource-manager/apimanagement/2022-08-01/users"
	"github.com/redtenant/go-azure-sdk/resource-manager/apimanagement/2022-08-01/usersubscription"
	"github.com/redtenant/go-azure-sdk/resource-manager/apimanagement/2022-08-01/usertoken"
