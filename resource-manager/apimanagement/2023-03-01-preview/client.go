...
import (
	...
	"github.com/redtenant/go-azure-sdk/resource-manager/apimanagement/2023-03-01-preview/api"
	"github.com/redtenant/go-azure-sdk/resource-manager/apimanagement/2023-03-01-preview/apidiagnostic"
	"github.com/redtenant/go-azure-sdk/resource-manager/apimanagement/2023-03-01-preview/apiissue"
	"github.com/redtenant/go-azure-sdk/resource-manager/apimanagement/2023-03-01-preview/apiissueattachment"
	"github.com/redtenant/go-azure-sdk/resource-manager/apimanagement/2023-03-01-preview/apiissuecomment"
	"github.com/redtenant/go-azure-sdk/resource-manager/apimanagement/2023-03-01-preview/apimanagementservice"
	"github.com/redtenant/go-azure-sdk/resource-manager/apimanagement/2023-03-01-preview/apimanagementserviceskus"
	"github.com/redtenant/go-azure-sdk/resource-manager/apimanagement/2023-03-01-preview/apioperation"
	"github.com/redtenant/go-azure-sdk/resource-manager/apimanagement/2023-03-01-preview/apioperationpolicy"
	"github.com/redtenant/go-azure-sdk/resource-manager/apimanagement/2023-03-01-preview/apioperationsbytag"
	"github.com/redtenant/go-azure-sdk/resource-manager/apimanagement/2023-03-01-preview/apioperationtag"
	"github.com/redtenant/go-azure-sdk/resource-manager/apimanagement/2023-03-01-preview/apipolicy"
	"github.com/redtenant/go-azure-sdk/resource-manager/apimanagement/2023-03-01-preview/apiproduct"
	"github.com/redtenant/go-azure-sdk/resource-manager/apimanagement/2023-03-01-preview/apirelease"
	"github.com/redtenant/go-azure-sdk/resource-manager/apimanagement/2023-03-01-preview/apirevision"
	"github.com/redtenant/go-azure-sdk/resource-manager/apimanagement/2023-03-01-preview/apisbytag"
	"github.com/redtenant/go-azure-sdk/resource-manager/apimanagement/2023-03-01-preview/apischema"
	"github.com/redtenant/go-azure-sdk/resource-manager/apimanagement/2023-03-01-preview/apitag"
	"github.com/redtenant/go-azure-sdk/resource-manager/apimanagement/2023-03-01-preview/apitagdescription"
	"github.com/redtenant/go-azure-sdk/resource-manager/apimanagement/2023-03-01-preview/apiversionset"
	"github.com/redtenant/go-azure-sdk/resource-manager/apimanagement/2023-03-01-preview/apiversionsets"
	"github.com/redtenant/go-azure-sdk/resource-manager/apimanagement/2023-03-01-preview/apiwiki"
	"github.com/redtenant/go-azure-sdk/resource-manager/apimanagement/2023-03-01-preview/authorization"
	"github.com/redtenant/go-azure-sdk/resource-manager/apimanagement/2023-03-01-preview/authorizationaccesspolicy"
	"github.com/redtenant/go-azure-sdk/resource-manager/apimanagement/2023-03-01-preview/authorizationconfirmconsentcode"
	"github.com/redtenant/go-azure-sdk/resource-manager/apimanagement/2023-03-01-preview/authorizationloginlinks"
	"github.com/redtenant/go-azure-sdk/resource-manager/apimanagement/2023-03-01-preview/authorizationprovider"
	"github.com/redtenant/go-azure-sdk/resource-manager/apimanagement/2023-03-01-preview/authorizations"
	"github.com/redtenant/go-azure-sdk/resource-manager/apimanagement/2023-03-01-preview/authorizationserver"
	"github.com/redtenant/go-azure-sdk/resource-manager/apimanagement/2023-03-01-preview/backend"
	"github.com/redtenant/go-azure-sdk/resource-manager/apimanagement/2023-03-01-preview/backendreconnect"
	"github.com/redtenant/go-azure-sdk/resource-manager/apimanagement/2023-03-01-preview/cache"
	"github.com/redtenant/go-azure-sdk/resource-manager/apimanagement/2023-03-01-preview/certificate"
	"github.com/redtenant/go-azure-sdk/resource-manager/apimanagement/2023-03-01-preview/contenttype"
	"github.com/redtenant/go-azure-sdk/resource-manager/apimanagement/2023-03-01-preview/contenttypecontentitem"
	"github.com/redtenant/go-azure-sdk/resource-manager/apimanagement/2023-03-01-preview/delegationsettings"
	"github.com/redtenant/go-azure-sdk/resource-manager/apimanagement/2023-03-01-preview/deletedservice"
	"github.com/redtenant/go-azure-sdk/resource-manager/apimanagement/2023-03-01-preview/diagnostic"
	"github.com/redtenant/go-azure-sdk/resource-manager/apimanagement/2023-03-01-preview/documentationresource"
	"github.com/redtenant/go-azure-sdk/resource-manager/apimanagement/2023-03-01-preview/emailtemplate"
	"github.com/redtenant/go-azure-sdk/resource-manager/apimanagement/2023-03-01-preview/emailtemplates"
	"github.com/redtenant/go-azure-sdk/resource-manager/apimanagement/2023-03-01-preview/gateway"
	"github.com/redtenant/go-azure-sdk/resource-manager/apimanagement/2023-03-01-preview/gatewayapi"
	"github.com/redtenant/go-azure-sdk/resource-manager/apimanagement/2023-03-01-preview/gatewaycertificateauthority"
	"github.com/redtenant/go-azure-sdk/resource-manager/apimanagement/2023-03-01-preview/gatewaygeneratetoken"
	"github.com/redtenant/go-azure-sdk/resource-manager/apimanagement/2023-03-01-preview/gatewayhostnameconfiguration"
	"github.com/redtenant/go-azure-sdk/resource-manager/apimanagement/2023-03-01-preview/gatewayinvalidatedebugcredentials"
	"github.com/redtenant/go-azure-sdk/resource-manager/apimanagement/2023-03-01-preview/gatewaylistdebugcredentials"
	"github.com/redtenant/go-azure-sdk/resource-manager/apimanagement/2023-03-01-preview/gatewaylistkeys"
	"github.com/redtenant/go-azure-sdk/resource-manager/apimanagement/2023-03-01-preview/gatewaylisttrace"
	"github.com/redtenant/go-azure-sdk/resource-manager/apimanagement/2023-03-01-preview/gatewayregeneratekey"
	"github.com/redtenant/go-azure-sdk/resource-manager/apimanagement/2023-03-01-preview/graphqlapiresolver"
	"github.com/redtenant/go-azure-sdk/resource-manager/apimanagement/2023-03-01-preview/graphqlapiresolverpolicy"
	"github.com/redtenant/go-azure-sdk/resource-manager/apimanagement/2023-03-01-preview/group"
	"github.com/redtenant/go-azure-sdk/resource-manager/apimanagement/2023-03-01-preview/groupuser"
	"github.com/redtenant/go-azure-sdk/resource-manager/apimanagement/2023-03-01-preview/identityprovider"
	"github.com/redtenant/go-azure-sdk/resource-manager/apimanagement/2023-03-01-preview/issue"
	"github.com/redtenant/go-azure-sdk/resource-manager/apimanagement/2023-03-01-preview/logger"
	"github.com/redtenant/go-azure-sdk/resource-manager/apimanagement/2023-03-01-preview/namedvalue"
	"github.com/redtenant/go-azure-sdk/resource-manager/apimanagement/2023-03-01-preview/networkstatus"
	"github.com/redtenant/go-azure-sdk/resource-manager/apimanagement/2023-03-01-preview/notification"
	"github.com/redtenant/go-azure-sdk/resource-manager/apimanagement/2023-03-01-preview/notificationrecipientemail"
	"github.com/redtenant/go-azure-sdk/resource-manager/apimanagement/2023-03-01-preview/notificationrecipientuser"
	"github.com/redtenant/go-azure-sdk/resource-manager/apimanagement/2023-03-01-preview/openidconnectprovider"
	"github.com/redtenant/go-azure-sdk/resource-manager/apimanagement/2023-03-01-preview/outboundnetworkdependenciesendpoints"
	"github.com/redtenant/go-azure-sdk/resource-manager/apimanagement/2023-03-01-preview/performconnectivitycheck"
	"github.com/redtenant/go-azure-sdk/resource-manager/apimanagement/2023-03-01-preview/policy"
	"github.com/redtenant/go-azure-sdk/resource-manager/apimanagement/2023-03-01-preview/policydescription"
	"github.com/redtenant/go-azure-sdk/resource-manager/apimanagement/2023-03-01-preview/policyfragment"
	"github.com/redtenant/go-azure-sdk/resource-manager/apimanagement/2023-03-01-preview/portalconfig"
	"github.com/redtenant/go-azure-sdk/resource-manager/apimanagement/2023-03-01-preview/portalrevision"
	"github.com/redtenant/go-azure-sdk/resource-manager/apimanagement/2023-03-01-preview/portalsettings"
	"github.com/redtenant/go-azure-sdk/resource-manager/apimanagement/2023-03-01-preview/privateendpointconnections"
	"github.com/redtenant/go-azure-sdk/resource-manager/apimanagement/2023-03-01-preview/product"
	"github.com/redtenant/go-azure-sdk/resource-manager/apimanagement/2023-03-01-preview/productapi"
	"github.com/redtenant/go-azure-sdk/resource-manager/apimanagement/2023-03-01-preview/productapilink"
	"github.com/redtenant/go-azure-sdk/resource-manager/apimanagement/2023-03-01-preview/productgroup"
	"github.com/redtenant/go-azure-sdk/resource-manager/apimanagement/2023-03-01-preview/productgrouplink"
	"github.com/redtenant/go-azure-sdk/resource-manager/apimanagement/2023-03-01-preview/productpolicy"
	"github.com/redtenant/go-azure-sdk/resource-manager/apimanagement/2023-03-01-preview/productsbytag"
	"github.com/redtenant/go-azure-sdk/resource-manager/apimanagement/2023-03-01-preview/productsubscription"
	"github.com/redtenant/go-azure-sdk/resource-manager/apimanagement/2023-03-01-preview/producttag"
	"github.com/redtenant/go-azure-sdk/resource-manager/apimanagement/2023-03-01-preview/productwiki"
	"github.com/redtenant/go-azure-sdk/resource-manager/apimanagement/2023-03-01-preview/quotabycounterkeys"
	"github.com/redtenant/go-azure-sdk/resource-manager/apimanagement/2023-03-01-preview/quotabyperiodkeys"
	"github.com/redtenant/go-azure-sdk/resource-manager/apimanagement/2023-03-01-preview/region"
	"github.com/redtenant/go-azure-sdk/resource-manager/apimanagement/2023-03-01-preview/reports"
	"github.com/redtenant/go-azure-sdk/resource-manager/apimanagement/2023-03-01-preview/schema"
	"github.com/redtenant/go-azure-sdk/resource-manager/apimanagement/2023-03-01-preview/signinsettings"
	"github.com/redtenant/go-azure-sdk/resource-manager/apimanagement/2023-03-01-preview/signupsettings"
	"github.com/redtenant/go-azure-sdk/resource-manager/apimanagement/2023-03-01-preview/skus"
	"github.com/redtenant/go-azure-sdk/resource-manager/apimanagement/2023-03-01-preview/subscription"
	"github.com/redtenant/go-azure-sdk/resource-manager/apimanagement/2023-03-01-preview/tag"
	"github.com/redtenant/go-azure-sdk/resource-manager/apimanagement/2023-03-01-preview/tagapilink"
	"github.com/redtenant/go-azure-sdk/resource-manager/apimanagement/2023-03-01-preview/tagoperationlink"
	"github.com/redtenant/go-azure-sdk/resource-manager/apimanagement/2023-03-01-preview/tagproductlink"
	"github.com/redtenant/go-azure-sdk/resource-manager/apimanagement/2023-03-01-preview/tagresource"
	"github.com/redtenant/go-azure-sdk/resource-manager/apimanagement/2023-03-01-preview/tenantaccess"
	"github.com/redtenant/go-azure-sdk/resource-manager/apimanagement/2023-03-01-preview/tenantaccessgit"
	"github.com/redtenant/go-azure-sdk/resource-manager/apimanagement/2023-03-01-preview/tenantconfiguration"
	"github.com/redtenant/go-azure-sdk/resource-manager/apimanagement/2023-03-01-preview/tenantconfigurationsyncstate"
	"github.com/redtenant/go-azure-sdk/resource-manager/apimanagement/2023-03-01-preview/tenantsettings"
	"github.com/redtenant/go-azure-sdk/resource-manager/apimanagement/2023-03-01-preview/user"
	"github.com/redtenant/go-azure-sdk/resource-manager/apimanagement/2023-03-01-preview/userconfirmationpasswordsend"
	"github.com/redtenant/go-azure-sdk/resource-manager/apimanagement/2023-03-01-preview/usergroup"
	"github.com/redtenant/go-azure-sdk/resource-manager/apimanagement/2023-03-01-preview/useridentity"
	"github.com/redtenant/go-azure-sdk/resource-manager/apimanagement/2023-03-01-preview/users"
	"github.com/redtenant/go-azure-sdk/resource-manager/apimanagement/2023-03-01-preview/usersubscription"
	"github.com/redtenant/go-azure-sdk/resource-manager/apimanagement/2023-03-01-preview/usertoken"
	"github.com/redtenant/go-azure-sdk/resource-manager/apimanagement/2023-03-01-preview/workspace"
	"github.com/redtenant/go-azure-sdk/resource-manager/apimanagement/2023-03-01-preview/workspacepolicy"
