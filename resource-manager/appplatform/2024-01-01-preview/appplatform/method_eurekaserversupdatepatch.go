...
func (c AppPlatformClient) EurekaServersUpdatePatch(ctx context.Context, id commonids.SpringCloudServiceId, input EurekaServerResource) (result EurekaServersUpdatePatchOperationResponse, err error) {
