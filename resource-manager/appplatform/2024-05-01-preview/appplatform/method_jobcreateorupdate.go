...
type JobCreateOrUpdateOperationResponse struct {
...
// JobCreateOrUpdate ...
func (c AppPlatformClient) JobCreateOrUpdate(ctx context.Context, id JobId, input JobResource) (result JobCreateOrUpdateOperationResponse, err error) {
...
func (c AppPlatformClient) JobCreateOrUpdateThenPoll(ctx context.Context, id JobId, input JobResource) error {
	...
	if err := result.Poller.PollUntilDone(ctx); err != nil {
		return fmt.Errorf("polling after JobCreateOrUpdate: %+v", err)
	}
