...
type JobExecutionCancelOperationResponse struct {
...
// JobExecutionCancel ...
func (c AppPlatformClient) JobExecutionCancel(ctx context.Context, id ExecutionId) (result JobExecutionCancelOperationResponse, err error) {
...
func (c AppPlatformClient) JobExecutionCancelThenPoll(ctx context.Context, id ExecutionId) error {
	...
	if err := result.Poller.PollUntilDone(ctx); err != nil {
		return fmt.Errorf("polling after JobExecutionCancel: %+v", err)
	}
