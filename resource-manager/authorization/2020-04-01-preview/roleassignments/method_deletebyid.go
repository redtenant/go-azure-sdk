...
// DeleteById ...
func (c RoleAssignmentsClient) DeleteById(ctx context.Context, id RoleIdId, options DeleteByIdOperationOptions) (result DeleteByIdOperationResponse, err error) {
