...
func DefaultDeleteByIdOperationOptions() DeleteByIdOperationOptions {
	return DeleteByIdOperationOptions{}
}
...
func (o DeleteByIdOperationOptions) ToQuery() *client.QueryParams {
...
// DeleteById ...
func (c RoleAssignmentsClient) DeleteById(ctx context.Context, id commonids.ScopeId, options DeleteByIdOperationOptions) (result DeleteByIdOperationResponse, err error) {
