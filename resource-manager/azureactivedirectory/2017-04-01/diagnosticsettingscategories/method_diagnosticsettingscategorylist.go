...
func (c DiagnosticSettingsCategoriesClient) DiagnosticSettingsCategoryList(ctx context.Context) (result DiagnosticSettingsCategoryListOperationResponse, err error) {
