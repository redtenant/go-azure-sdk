...
func (c BillingRoleDefinitionsClient) ListByEnrollmentAccount(ctx context.Context, id EnrollmentAccountId) (result ListByEnrollmentAccountOperationResponse, err error) {
...
func (c BillingRoleDefinitionsClient) ListByEnrollmentAccountComplete(ctx context.Context, id EnrollmentAccountId) (ListByEnrollmentAccountCompleteResult, error) {
	return c.ListByEnrollmentAccountCompleteMatchingPredicate(ctx, id, BillingRoleDefinitionOperationPredicate{})
}
