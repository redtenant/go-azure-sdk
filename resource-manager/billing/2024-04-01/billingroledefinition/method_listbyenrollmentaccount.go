...
func (c BillingRoleDefinitionClient) ListByEnrollmentAccount(ctx context.Context, id EnrollmentAccountId) (result ListByEnrollmentAccountOperationResponse, err error) {
...
func (c BillingRoleDefinitionClient) ListByEnrollmentAccountComplete(ctx context.Context, id EnrollmentAccountId) (ListByEnrollmentAccountCompleteResult, error) {
