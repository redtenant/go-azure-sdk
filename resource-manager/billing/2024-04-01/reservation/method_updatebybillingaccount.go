...
func (c ReservationClient) UpdateByBillingAccount(ctx context.Context, id ReservationId, input Patch) (result UpdateByBillingAccountOperationResponse, err error) {
...
func (c ReservationClient) UpdateByBillingAccountThenPoll(ctx context.Context, id ReservationId, input Patch) error {
	...
	if err := result.Poller.PollUntilDone(ctx); err != nil {
		return fmt.Errorf("polling after UpdateByBillingAccount: %+v", err)
	}
