...
func (c ChannelClient) ListByResourceGroupComplete(ctx context.Context, id commonids.BotServiceId) (ListByResourceGroupCompleteResult, error) {
	return c.ListByResourceGroupCompleteMatchingPredicate(ctx, id, BotChannelOperationPredicate{})
}
