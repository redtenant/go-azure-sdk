...
// List ...
func (c SharedGalleryImagesClient) List(ctx context.Context, id SharedGalleryId, options ListOperationOptions) (result ListOperationResponse, err error) {
	...
	var values struct {
		Values *[]SharedGalleryImage `json:"value"`
	}
...
func (c SharedGalleryImagesClient) ListComplete(ctx context.Context, id SharedGalleryId, options ListOperationOptions) (ListCompleteResult, error) {
	return c.ListCompleteMatchingPredicate(ctx, id, options, SharedGalleryImageOperationPredicate{})
}
...
func (c SharedGalleryImagesClient) ListCompleteMatchingPredicate(ctx context.Context, id SharedGalleryId, options ListOperationOptions, predicate SharedGalleryImageOperationPredicate) (result ListCompleteResult, err error) {
	items := make([]SharedGalleryImage, 0)
