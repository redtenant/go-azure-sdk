...
func (c VirtualMachinesClient) AttachDetachDataDisks(ctx context.Context, id VirtualMachineId, input AttachDetachDataDisksRequest) (result AttachDetachDataDisksOperationResponse, err error) {
