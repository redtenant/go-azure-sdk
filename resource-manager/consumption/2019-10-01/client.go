...
import (
	...
	"github.com/redtenant/go-azure-sdk/resource-manager/consumption/2019-10-01/aggregatedcost"
	"github.com/redtenant/go-azure-sdk/resource-manager/consumption/2019-10-01/balances"
	"github.com/redtenant/go-azure-sdk/resource-manager/consumption/2019-10-01/budgets"
	"github.com/redtenant/go-azure-sdk/resource-manager/consumption/2019-10-01/charges"
	"github.com/redtenant/go-azure-sdk/resource-manager/consumption/2019-10-01/credits"
	"github.com/redtenant/go-azure-sdk/resource-manager/consumption/2019-10-01/events"
	"github.com/redtenant/go-azure-sdk/resource-manager/consumption/2019-10-01/forecasts"
	"github.com/redtenant/go-azure-sdk/resource-manager/consumption/2019-10-01/lots"
	"github.com/redtenant/go-azure-sdk/resource-manager/consumption/2019-10-01/marketplaces"
	"github.com/redtenant/go-azure-sdk/resource-manager/consumption/2019-10-01/pricesheet"
	"github.com/redtenant/go-azure-sdk/resource-manager/consumption/2019-10-01/reservationdetails"
	"github.com/redtenant/go-azure-sdk/resource-manager/consumption/2019-10-01/reservationrecommendationdetails"
	"github.com/redtenant/go-azure-sdk/resource-manager/consumption/2019-10-01/reservationrecommendations"
	"github.com/redtenant/go-azure-sdk/resource-manager/consumption/2019-10-01/reservationsummaries"
	"github.com/redtenant/go-azure-sdk/resource-manager/consumption/2019-10-01/reservationtransactions"
...
func NewClientWithBaseURI(sdkApi sdkEnv.Api, configureFunc func(c *resourcemanager.Client)) (*Client, error) {
	...
	forecastsClient, err := forecasts.NewForecastsClientWithBaseURI(sdkApi)
	if err != nil {
