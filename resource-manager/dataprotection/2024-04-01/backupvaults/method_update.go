...
// Update ...
func (c BackupVaultsClient) Update(ctx context.Context, id BackupVaultId, input PatchResourceRequestInput, options UpdateOperationOptions) (result UpdateOperationResponse, err error) {
...
func (c BackupVaultsClient) UpdateThenPoll(ctx context.Context, id BackupVaultId, input PatchResourceRequestInput, options UpdateOperationOptions) error {
