...
func (c StartMenuItemClient) ListComplete(ctx context.Context, id ApplicationGroupId, options ListOperationOptions) (ListCompleteResult, error) {
	return c.ListCompleteMatchingPredicate(ctx, id, options, StartMenuItemOperationPredicate{})
}

// ListCompleteMatchingPredicate retrieves all the results and then applies the predicate
func (c StartMenuItemClient) ListCompleteMatchingPredicate(ctx context.Context, id ApplicationGroupId, options ListOperationOptions, predicate StartMenuItemOperationPredicate) (result ListCompleteResult, err error) {
