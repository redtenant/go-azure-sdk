...
// ListBySubscription ...
func (c IotDpsResourceClient) ListBySubscription(ctx context.Context, id commonids.SubscriptionId) (result ListBySubscriptionOperationResponse, err error) {
	opts := client.RequestOptions{
		...
		Path:       fmt.Sprintf("%s/providers/Microsoft.Devices/provisioningServices", id.ID()),
	}
...
func (c IotDpsResourceClient) ListBySubscriptionComplete(ctx context.Context, id commonids.SubscriptionId) (ListBySubscriptionCompleteResult, error) {
	return c.ListBySubscriptionCompleteMatchingPredicate(ctx, id, ProvisioningServiceDescriptionOperationPredicate{})
}
