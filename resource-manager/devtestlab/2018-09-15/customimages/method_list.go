...
// List ...
func (c CustomImagesClient) List(ctx context.Context, id LabId, options ListOperationOptions) (result ListOperationResponse, err error) {
	opts := client.RequestOptions{
		...
		Path:          fmt.Sprintf("%s/customImages", id.ID()),
	}
...
func (c CustomImagesClient) ListComplete(ctx context.Context, id LabId, options ListOperationOptions) (ListCompleteResult, error) {
	return c.ListCompleteMatchingPredicate(ctx, id, options, CustomImageOperationPredicate{})
}
