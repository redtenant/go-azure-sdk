...
func (c VirtualNetworksClient) ListComplete(ctx context.Context, id LabId, options ListOperationOptions) (ListCompleteResult, error) {
	return c.ListCompleteMatchingPredicate(ctx, id, options, VirtualNetworkOperationPredicate{})
}
