...
// List ...
func (c GuestConfigurationConnectedVMwarevSphereAssignmentsClient) List(ctx context.Context, id ProviderVirtualMachineId) (result ListOperationResponse, err error) {
