...
func (c CollectionClient) ServicesListByResourceGroupCompleteMatchingPredicate(ctx context.Context, id commonids.ResourceGroupId, predicate ServicesDescriptionOperationPredicate) (result ServicesListByResourceGroupCompleteResult, err error) {
