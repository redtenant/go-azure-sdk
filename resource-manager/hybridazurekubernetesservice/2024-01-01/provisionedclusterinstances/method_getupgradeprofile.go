...
func (c ProvisionedClusterInstancesClient) GetUpgradeProfile(ctx context.Context, id commonids.ScopeId) (result GetUpgradeProfileOperationResponse, err error) {
	opts := client.RequestOptions{
		...
		Path:       fmt.Sprintf("%s/providers/Microsoft.HybridContainerService/provisionedClusterInstances/default/upgradeProfiles/default", id.ID()),
	}
	...
	var model ProvisionedClusterUpgradeProfile
	result.Model = &model
