...
func (o ListOperationOptions) ToQuery() *client.QueryParams {
	...
	if o.Hash != nil {
		out.Append("hash", fmt.Sprintf("%v", *o.Hash))
	}
	if o.HashVersion != nil {
		out.Append("hashVersion", fmt.Sprintf("%v", *o.HashVersion))
	}
	if o.OrderBy != nil {
...
func (c CodeVersionClient) ListComplete(ctx context.Context, id CodeId, options ListOperationOptions) (ListCompleteResult, error) {
	return c.ListCompleteMatchingPredicate(ctx, id, options, CodeVersionResourceOperationPredicate{})
}
