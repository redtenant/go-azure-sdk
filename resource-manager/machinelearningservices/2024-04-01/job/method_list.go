...
func (o ListOperationOptions) ToQuery() *client.QueryParams {
	...
	if o.JobType != nil {
		out.Append("jobType", fmt.Sprintf("%v", *o.JobType))
	}
	...
	if o.Tag != nil {
		out.Append("tag", fmt.Sprintf("%v", *o.Tag))
	}
	return &out
}
...
func (c JobClient) List(ctx context.Context, id WorkspaceId, options ListOperationOptions) (result ListOperationResponse, err error) {
	...
	var values struct {
		Values *[]JobBaseResource `json:"value"`
	}
...
func (c JobClient) ListComplete(ctx context.Context, id WorkspaceId, options ListOperationOptions) (ListCompleteResult, error) {
	return c.ListCompleteMatchingPredicate(ctx, id, options, JobBaseResourceOperationPredicate{})
}
