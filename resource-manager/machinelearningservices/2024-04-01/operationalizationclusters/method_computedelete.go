...
// ComputeDelete ...
func (c OperationalizationClustersClient) ComputeDelete(ctx context.Context, id ComputeId, options ComputeDeleteOperationOptions) (result ComputeDeleteOperationResponse, err error) {
...
func (c OperationalizationClustersClient) ComputeDeleteThenPoll(ctx context.Context, id ComputeId, options ComputeDeleteOperationOptions) error {
