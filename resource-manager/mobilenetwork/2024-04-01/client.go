...
import (
	...
	"github.com/redtenant/go-azure-sdk/resource-manager/mobilenetwork/2024-04-01/attacheddatanetwork"
	"github.com/redtenant/go-azure-sdk/resource-manager/mobilenetwork/2024-04-01/attacheddatanetworks"
	"github.com/redtenant/go-azure-sdk/resource-manager/mobilenetwork/2024-04-01/datanetwork"
	"github.com/redtenant/go-azure-sdk/resource-manager/mobilenetwork/2024-04-01/datanetworks"
	"github.com/redtenant/go-azure-sdk/resource-manager/mobilenetwork/2024-04-01/diagnosticspackages"
	"github.com/redtenant/go-azure-sdk/resource-manager/mobilenetwork/2024-04-01/extendedueinformation"
	"github.com/redtenant/go-azure-sdk/resource-manager/mobilenetwork/2024-04-01/mobilenetwork"
	"github.com/redtenant/go-azure-sdk/resource-manager/mobilenetwork/2024-04-01/mobilenetworks"
	"github.com/redtenant/go-azure-sdk/resource-manager/mobilenetwork/2024-04-01/packetcaptures"
	"github.com/redtenant/go-azure-sdk/resource-manager/mobilenetwork/2024-04-01/packetcorecontrolplane"
	"github.com/redtenant/go-azure-sdk/resource-manager/mobilenetwork/2024-04-01/packetcorecontrolplanecollectdiagnosticspackage"
	"github.com/redtenant/go-azure-sdk/resource-manager/mobilenetwork/2024-04-01/packetcorecontrolplanereinstall"
	"github.com/redtenant/go-azure-sdk/resource-manager/mobilenetwork/2024-04-01/packetcorecontrolplanerollback"
	"github.com/redtenant/go-azure-sdk/resource-manager/mobilenetwork/2024-04-01/packetcorecontrolplanes"
	"github.com/redtenant/go-azure-sdk/resource-manager/mobilenetwork/2024-04-01/packetcorecontrolplaneversion"
	"github.com/redtenant/go-azure-sdk/resource-manager/mobilenetwork/2024-04-01/packetcoredataplane"
	"github.com/redtenant/go-azure-sdk/resource-manager/mobilenetwork/2024-04-01/packetcoredataplanes"
	"github.com/redtenant/go-azure-sdk/resource-manager/mobilenetwork/2024-04-01/routinginfo"
	"github.com/redtenant/go-azure-sdk/resource-manager/mobilenetwork/2024-04-01/service"
	"github.com/redtenant/go-azure-sdk/resource-manager/mobilenetwork/2024-04-01/services"
	"github.com/redtenant/go-azure-sdk/resource-manager/mobilenetwork/2024-04-01/sim"
	"github.com/redtenant/go-azure-sdk/resource-manager/mobilenetwork/2024-04-01/simgroup"
	"github.com/redtenant/go-azure-sdk/resource-manager/mobilenetwork/2024-04-01/simgroups"
	"github.com/redtenant/go-azure-sdk/resource-manager/mobilenetwork/2024-04-01/simpolicies"
	"github.com/redtenant/go-azure-sdk/resource-manager/mobilenetwork/2024-04-01/simpolicy"
	"github.com/redtenant/go-azure-sdk/resource-manager/mobilenetwork/2024-04-01/sims"
	"github.com/redtenant/go-azure-sdk/resource-manager/mobilenetwork/2024-04-01/site"
	"github.com/redtenant/go-azure-sdk/resource-manager/mobilenetwork/2024-04-01/sites"
	"github.com/redtenant/go-azure-sdk/resource-manager/mobilenetwork/2024-04-01/slice"
	"github.com/redtenant/go-azure-sdk/resource-manager/mobilenetwork/2024-04-01/slices"
	"github.com/redtenant/go-azure-sdk/resource-manager/mobilenetwork/2024-04-01/ueinformationlist"
...
type Client struct {
	...
	ExtendedUeInformation                           *extendedueinformation.ExtendedUeInformationClient
	...
	RoutingInfo                                     *routinginfo.RoutingInfoClient
	SIM                                             *sim.SIMClient
	...
	UeInformationList                               *ueinformationlist.UeInformationListClient
}
...
func NewClientWithBaseURI(sdkApi sdkEnv.Api, configureFunc func(c *resourcemanager.Client)) (*Client, error) {
	...
	extendedUeInformationClient, err := extendedueinformation.NewExtendedUeInformationClientWithBaseURI(sdkApi)
	if err != nil {
		return nil, fmt.Errorf("building ExtendedUeInformation client: %+v", err)
	}
	configureFunc(extendedUeInformationClient.Client)
	...
	routingInfoClient, err := routinginfo.NewRoutingInfoClientWithBaseURI(sdkApi)
	if err != nil {
		return nil, fmt.Errorf("building RoutingInfo client: %+v", err)
	}
	configureFunc(routingInfoClient.Client)
	...
	ueInformationListClient, err := ueinformationlist.NewUeInformationListClientWithBaseURI(sdkApi)
	if err != nil {
		return nil, fmt.Errorf("building UeInformationList client: %+v", err)
	}
	configureFunc(ueInformationListClient.Client)
	...
	return &Client{
		...
		ExtendedUeInformation:  extendedUeInformationClient,
		...
		Slice:                                           sliceClient,
		Slices:                                          slicesClient,
		UeInformationList:                               ueInformationListClient,
	}, nil
}
