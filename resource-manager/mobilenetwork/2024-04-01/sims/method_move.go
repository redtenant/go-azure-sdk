...
// Move ...
func (c SIMsClient) Move(ctx context.Context, id SimGroupId, input SimMove) (result MoveOperationResponse, err error) {
...
func (c SIMsClient) MoveThenPoll(ctx context.Context, id SimGroupId, input SimMove) error {
