...
import (
	...
	"github.com/redtenant/go-azure-sdk/resource-manager/network/2024-01-01/adminrulecollections"
	"github.com/redtenant/go-azure-sdk/resource-manager/network/2024-01-01/adminrules"
	"github.com/redtenant/go-azure-sdk/resource-manager/network/2024-01-01/applicationgatewayprivateendpointconnections"
	"github.com/redtenant/go-azure-sdk/resource-manager/network/2024-01-01/applicationgatewayprivatelinkresources"
	"github.com/redtenant/go-azure-sdk/resource-manager/network/2024-01-01/applicationgateways"
	"github.com/redtenant/go-azure-sdk/resource-manager/network/2024-01-01/applicationgatewaywafdynamicmanifests"
	"github.com/redtenant/go-azure-sdk/resource-manager/network/2024-01-01/applicationsecuritygroups"
	"github.com/redtenant/go-azure-sdk/resource-manager/network/2024-01-01/availabledelegations"
	"github.com/redtenant/go-azure-sdk/resource-manager/network/2024-01-01/availableservicealiases"
	"github.com/redtenant/go-azure-sdk/resource-manager/network/2024-01-01/azurefirewalls"
	"github.com/redtenant/go-azure-sdk/resource-manager/network/2024-01-01/bastionhosts"
	"github.com/redtenant/go-azure-sdk/resource-manager/network/2024-01-01/bastionshareablelink"
	"github.com/redtenant/go-azure-sdk/resource-manager/network/2024-01-01/bgpservicecommunities"
	"github.com/redtenant/go-azure-sdk/resource-manager/network/2024-01-01/checkdnsavailabilities"
	"github.com/redtenant/go-azure-sdk/resource-manager/network/2024-01-01/cloudservicepublicipaddresses"
	"github.com/redtenant/go-azure-sdk/resource-manager/network/2024-01-01/connectionmonitors"
	"github.com/redtenant/go-azure-sdk/resource-manager/network/2024-01-01/connectivityconfigurations"
	"github.com/redtenant/go-azure-sdk/resource-manager/network/2024-01-01/customipprefixes"
	"github.com/redtenant/go-azure-sdk/resource-manager/network/2024-01-01/ddoscustompolicies"
	"github.com/redtenant/go-azure-sdk/resource-manager/network/2024-01-01/ddosprotectionplans"
	"github.com/redtenant/go-azure-sdk/resource-manager/network/2024-01-01/dscpconfiguration"
	"github.com/redtenant/go-azure-sdk/resource-manager/network/2024-01-01/dscpconfigurations"
	"github.com/redtenant/go-azure-sdk/resource-manager/network/2024-01-01/endpointservices"
	"github.com/redtenant/go-azure-sdk/resource-manager/network/2024-01-01/expressroutecircuitarptable"
	"github.com/redtenant/go-azure-sdk/resource-manager/network/2024-01-01/expressroutecircuitauthorizations"
	"github.com/redtenant/go-azure-sdk/resource-manager/network/2024-01-01/expressroutecircuitconnections"
	"github.com/redtenant/go-azure-sdk/resource-manager/network/2024-01-01/expressroutecircuitpeerings"
	"github.com/redtenant/go-azure-sdk/resource-manager/network/2024-01-01/expressroutecircuitroutestable"
	"github.com/redtenant/go-azure-sdk/resource-manager/network/2024-01-01/expressroutecircuitroutestablesummary"
	"github.com/redtenant/go-azure-sdk/resource-manager/network/2024-01-01/expressroutecircuits"
	"github.com/redtenant/go-azure-sdk/resource-manager/network/2024-01-01/expressroutecircuitstats"
	"github.com/redtenant/go-azure-sdk/resource-manager/network/2024-01-01/expressrouteconnections"
	"github.com/redtenant/go-azure-sdk/resource-manager/network/2024-01-01/expressroutecrossconnectionarptable"
	"github.com/redtenant/go-azure-sdk/resource-manager/network/2024-01-01/expressroutecrossconnectionpeerings"
	"github.com/redtenant/go-azure-sdk/resource-manager/network/2024-01-01/expressroutecrossconnectionroutetable"
	"github.com/redtenant/go-azure-sdk/resource-manager/network/2024-01-01/expressroutecrossconnectionroutetablesummary"
	"github.com/redtenant/go-azure-sdk/resource-manager/network/2024-01-01/expressroutecrossconnections"
	"github.com/redtenant/go-azure-sdk/resource-manager/network/2024-01-01/expressroutegateways"
	"github.com/redtenant/go-azure-sdk/resource-manager/network/2024-01-01/expressroutelinks"
	"github.com/redtenant/go-azure-sdk/resource-manager/network/2024-01-01/expressrouteportauthorizations"
	"github.com/redtenant/go-azure-sdk/resource-manager/network/2024-01-01/expressrouteports"
	"github.com/redtenant/go-azure-sdk/resource-manager/network/2024-01-01/expressrouteportslocations"
	"github.com/redtenant/go-azure-sdk/resource-manager/network/2024-01-01/expressrouteproviderports"
	"github.com/redtenant/go-azure-sdk/resource-manager/network/2024-01-01/expressrouteserviceproviders"
	"github.com/redtenant/go-azure-sdk/resource-manager/network/2024-01-01/firewallpolicies"
	"github.com/redtenant/go-azure-sdk/resource-manager/network/2024-01-01/firewallpolicyrulecollectiongroups"
	"github.com/redtenant/go-azure-sdk/resource-manager/network/2024-01-01/flowlogs"
	"github.com/redtenant/go-azure-sdk/resource-manager/network/2024-01-01/ipallocations"
	"github.com/redtenant/go-azure-sdk/resource-manager/network/2024-01-01/ipgroups"
	"github.com/redtenant/go-azure-sdk/resource-manager/network/2024-01-01/loadbalancers"
	"github.com/redtenant/go-azure-sdk/resource-manager/network/2024-01-01/localnetworkgateways"
	"github.com/redtenant/go-azure-sdk/resource-manager/network/2024-01-01/natgateways"
	"github.com/redtenant/go-azure-sdk/resource-manager/network/2024-01-01/networkgroups"
	"github.com/redtenant/go-azure-sdk/resource-manager/network/2024-01-01/networkinterfaces"
	"github.com/redtenant/go-azure-sdk/resource-manager/network/2024-01-01/networkmanageractiveconfigurations"
	"github.com/redtenant/go-azure-sdk/resource-manager/network/2024-01-01/networkmanageractiveconnectivityconfigurations"
	"github.com/redtenant/go-azure-sdk/resource-manager/network/2024-01-01/networkmanagerconnections"
	"github.com/redtenant/go-azure-sdk/resource-manager/network/2024-01-01/networkmanagereffectiveconnectivityconfiguration"
	"github.com/redtenant/go-azure-sdk/resource-manager/network/2024-01-01/networkmanagereffectivesecurityadminrules"
	"github.com/redtenant/go-azure-sdk/resource-manager/network/2024-01-01/networkmanagers"
	"github.com/redtenant/go-azure-sdk/resource-manager/network/2024-01-01/networkprofiles"
	"github.com/redtenant/go-azure-sdk/resource-manager/network/2024-01-01/networksecuritygroups"
	"github.com/redtenant/go-azure-sdk/resource-manager/network/2024-01-01/networkvirtualappliances"
	"github.com/redtenant/go-azure-sdk/resource-manager/network/2024-01-01/networkwatchers"
	"github.com/redtenant/go-azure-sdk/resource-manager/network/2024-01-01/p2svpngateways"
	"github.com/redtenant/go-azure-sdk/resource-manager/network/2024-01-01/packetcaptures"
	"github.com/redtenant/go-azure-sdk/resource-manager/network/2024-01-01/peerexpressroutecircuitconnections"
	"github.com/redtenant/go-azure-sdk/resource-manager/network/2024-01-01/privatednszonegroups"
	"github.com/redtenant/go-azure-sdk/resource-manager/network/2024-01-01/privateendpoints"
	"github.com/redtenant/go-azure-sdk/resource-manager/network/2024-01-01/privatelinkservices"
	"github.com/redtenant/go-azure-sdk/resource-manager/network/2024-01-01/publicipaddresses"
	"github.com/redtenant/go-azure-sdk/resource-manager/network/2024-01-01/publicipprefixes"
	"github.com/redtenant/go-azure-sdk/resource-manager/network/2024-01-01/routefilterrules"
	"github.com/redtenant/go-azure-sdk/resource-manager/network/2024-01-01/routefilters"
	"github.com/redtenant/go-azure-sdk/resource-manager/network/2024-01-01/routes"
	"github.com/redtenant/go-azure-sdk/resource-manager/network/2024-01-01/routetables"
	"github.com/redtenant/go-azure-sdk/resource-manager/network/2024-01-01/scopeconnections"
	"github.com/redtenant/go-azure-sdk/resource-manager/network/2024-01-01/securityadminconfigurations"
	"github.com/redtenant/go-azure-sdk/resource-manager/network/2024-01-01/securitypartnerproviders"
	"github.com/redtenant/go-azure-sdk/resource-manager/network/2024-01-01/securityrules"
	"github.com/redtenant/go-azure-sdk/resource-manager/network/2024-01-01/serviceendpointpolicies"
	"github.com/redtenant/go-azure-sdk/resource-manager/network/2024-01-01/serviceendpointpolicydefinitions"
	"github.com/redtenant/go-azure-sdk/resource-manager/network/2024-01-01/servicetags"
	"github.com/redtenant/go-azure-sdk/resource-manager/network/2024-01-01/staticmembers"
	"github.com/redtenant/go-azure-sdk/resource-manager/network/2024-01-01/subnets"
	"github.com/redtenant/go-azure-sdk/resource-manager/network/2024-01-01/trafficanalytics"
	"github.com/redtenant/go-azure-sdk/resource-manager/network/2024-01-01/usages"
	"github.com/redtenant/go-azure-sdk/resource-manager/network/2024-01-01/vipswap"
	"github.com/redtenant/go-azure-sdk/resource-manager/network/2024-01-01/virtualappliancesites"
	"github.com/redtenant/go-azure-sdk/resource-manager/network/2024-01-01/virtualapplianceskus"
	"github.com/redtenant/go-azure-sdk/resource-manager/network/2024-01-01/virtualnetworkgatewayconnections"
	"github.com/redtenant/go-azure-sdk/resource-manager/network/2024-01-01/virtualnetworkgateways"
	"github.com/redtenant/go-azure-sdk/resource-manager/network/2024-01-01/virtualnetworkpeerings"
	"github.com/redtenant/go-azure-sdk/resource-manager/network/2024-01-01/virtualnetworks"
	"github.com/redtenant/go-azure-sdk/resource-manager/network/2024-01-01/virtualnetworktap"
	"github.com/redtenant/go-azure-sdk/resource-manager/network/2024-01-01/virtualnetworktaps"
	"github.com/redtenant/go-azure-sdk/resource-manager/network/2024-01-01/virtualrouterpeerings"
	"github.com/redtenant/go-azure-sdk/resource-manager/network/2024-01-01/virtualrouters"
	"github.com/redtenant/go-azure-sdk/resource-manager/network/2024-01-01/virtualwans"
	"github.com/redtenant/go-azure-sdk/resource-manager/network/2024-01-01/vmsspublicipaddresses"
	"github.com/redtenant/go-azure-sdk/resource-manager/network/2024-01-01/vpngateways"
	"github.com/redtenant/go-azure-sdk/resource-manager/network/2024-01-01/vpnlinkconnections"
	"github.com/redtenant/go-azure-sdk/resource-manager/network/2024-01-01/vpnserverconfigurations"
	"github.com/redtenant/go-azure-sdk/resource-manager/network/2024-01-01/vpnsites"
	"github.com/redtenant/go-azure-sdk/resource-manager/network/2024-01-01/webapplicationfirewallpolicies"
	"github.com/redtenant/go-azure-sdk/resource-manager/network/2024-01-01/webcategories"
