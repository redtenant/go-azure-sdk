...
func (c NetworkcloudsClient) BareMetalMachinesCreateOrUpdate(ctx context.Context, id BareMetalMachineId, input BareMetalMachine) (result BareMetalMachinesCreateOrUpdateOperationResponse, err error) {
...
func (c NetworkcloudsClient) BareMetalMachinesCreateOrUpdateThenPoll(ctx context.Context, id BareMetalMachineId, input BareMetalMachine) error {
	result, err := c.BareMetalMachinesCreateOrUpdate(ctx, id, input)
	if err != nil {
