...
func (c NetworkcloudsClient) BareMetalMachinesRestart(ctx context.Context, id BareMetalMachineId) (result BareMetalMachinesRestartOperationResponse, err error) {
...
func (c NetworkcloudsClient) BareMetalMachinesRestartThenPoll(ctx context.Context, id BareMetalMachineId) error {
	...
	if err := result.Poller.PollUntilDone(ctx); err != nil {
		return fmt.Errorf("polling after BareMetalMachinesRestart: %+v", err)
	}
