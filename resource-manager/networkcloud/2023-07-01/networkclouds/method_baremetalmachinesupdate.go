...
func (c NetworkcloudsClient) BareMetalMachinesUpdate(ctx context.Context, id BareMetalMachineId, input BareMetalMachinePatchParameters) (result BareMetalMachinesUpdateOperationResponse, err error) {
...
func (c NetworkcloudsClient) BareMetalMachinesUpdateThenPoll(ctx context.Context, id BareMetalMachineId, input BareMetalMachinePatchParameters) error {
	result, err := c.BareMetalMachinesUpdate(ctx, id, input)
	if err != nil {
