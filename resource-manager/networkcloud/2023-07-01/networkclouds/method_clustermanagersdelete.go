...
func (c NetworkcloudsClient) ClusterManagersDelete(ctx context.Context, id ClusterManagerId) (result ClusterManagersDeleteOperationResponse, err error) {
...
func (c NetworkcloudsClient) ClusterManagersDeleteThenPoll(ctx context.Context, id ClusterManagerId) error {
	result, err := c.ClusterManagersDelete(ctx, id)
	if err != nil {
