...
// ClustersDeploy ...
func (c NetworkcloudsClient) ClustersDeploy(ctx context.Context, id ClusterId, input ClusterDeployParameters) (result ClustersDeployOperationResponse, err error) {
...
func (c NetworkcloudsClient) ClustersDeployThenPoll(ctx context.Context, id ClusterId, input ClusterDeployParameters) error {
	...
	if err := result.Poller.PollUntilDone(ctx); err != nil {
		return fmt.Errorf("polling after ClustersDeploy: %+v", err)
	}
