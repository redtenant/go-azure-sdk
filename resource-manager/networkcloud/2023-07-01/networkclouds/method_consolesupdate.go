...
// ConsolesUpdate ...
func (c NetworkcloudsClient) ConsolesUpdate(ctx context.Context, id ConsoleId, input ConsolePatchParameters) (result ConsolesUpdateOperationResponse, err error) {
...
func (c NetworkcloudsClient) ConsolesUpdateThenPoll(ctx context.Context, id ConsoleId, input ConsolePatchParameters) error {
	result, err := c.ConsolesUpdate(ctx, id, input)
	if err != nil {
