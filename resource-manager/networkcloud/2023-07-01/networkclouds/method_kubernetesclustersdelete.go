...
func (c NetworkcloudsClient) KubernetesClustersDelete(ctx context.Context, id KubernetesClusterId) (result KubernetesClustersDeleteOperationResponse, err error) {
...
func (c NetworkcloudsClient) KubernetesClustersDeleteThenPoll(ctx context.Context, id KubernetesClusterId) error {
	result, err := c.KubernetesClustersDelete(ctx, id)
	if err != nil {
