...
func (c NetworkcloudsClient) MetricsConfigurationsCreateOrUpdate(ctx context.Context, id MetricsConfigurationId, input ClusterMetricsConfiguration) (result MetricsConfigurationsCreateOrUpdateOperationResponse, err error) {
...
func (c NetworkcloudsClient) MetricsConfigurationsCreateOrUpdateThenPoll(ctx context.Context, id MetricsConfigurationId, input ClusterMetricsConfiguration) error {
	result, err := c.MetricsConfigurationsCreateOrUpdate(ctx, id, input)
	if err != nil {
