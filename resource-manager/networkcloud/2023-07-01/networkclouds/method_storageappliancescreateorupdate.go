...
func (c NetworkcloudsClient) StorageAppliancesCreateOrUpdate(ctx context.Context, id StorageApplianceId, input StorageAppliance) (result StorageAppliancesCreateOrUpdateOperationResponse, err error) {
...
func (c NetworkcloudsClient) StorageAppliancesCreateOrUpdateThenPoll(ctx context.Context, id StorageApplianceId, input StorageAppliance) error {
	result, err := c.StorageAppliancesCreateOrUpdate(ctx, id, input)
	if err != nil {
