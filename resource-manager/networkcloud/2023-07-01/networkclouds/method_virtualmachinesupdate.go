...
func (c NetworkcloudsClient) VirtualMachinesUpdate(ctx context.Context, id VirtualMachineId, input VirtualMachinePatchParameters) (result VirtualMachinesUpdateOperationResponse, err error) {
...
func (c NetworkcloudsClient) VirtualMachinesUpdateThenPoll(ctx context.Context, id VirtualMachineId, input VirtualMachinePatchParameters) error {
	result, err := c.VirtualMachinesUpdate(ctx, id, input)
	if err != nil {
