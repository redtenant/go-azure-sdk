...
// BmcKeySetsUpdate ...
func (c NetworkcloudsClient) BmcKeySetsUpdate(ctx context.Context, id BmcKeySetId, input BmcKeySetPatchParameters) (result BmcKeySetsUpdateOperationResponse, err error) {
...
func (c NetworkcloudsClient) BmcKeySetsUpdateThenPoll(ctx context.Context, id BmcKeySetId, input BmcKeySetPatchParameters) error {
	result, err := c.BmcKeySetsUpdate(ctx, id, input)
	if err != nil {
