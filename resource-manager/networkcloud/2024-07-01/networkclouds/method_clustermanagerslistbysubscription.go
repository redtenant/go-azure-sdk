...
func (c NetworkcloudsClient) ClusterManagersListBySubscriptionComplete(ctx context.Context, id commonids.SubscriptionId) (ClusterManagersListBySubscriptionCompleteResult, error) {
	return c.ClusterManagersListBySubscriptionCompleteMatchingPredicate(ctx, id, ClusterManagerOperationPredicate{})
}
...
func (c NetworkcloudsClient) ClusterManagersListBySubscriptionCompleteMatchingPredicate(ctx context.Context, id commonids.SubscriptionId, predicate ClusterManagerOperationPredicate) (result ClusterManagersListBySubscriptionCompleteResult, err error) {
	...
	resp, err := c.ClusterManagersListBySubscription(ctx, id)
	if err != nil {
