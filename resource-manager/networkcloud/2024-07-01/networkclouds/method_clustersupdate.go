...
// ClustersUpdate ...
func (c NetworkcloudsClient) ClustersUpdate(ctx context.Context, id ClusterId, input ClusterPatchParameters) (result ClustersUpdateOperationResponse, err error) {
