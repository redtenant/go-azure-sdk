...
func (c NetworkcloudsClient) KubernetesClustersRestartNode(ctx context.Context, id KubernetesClusterId, input KubernetesClusterRestartNodeParameters) (result KubernetesClustersRestartNodeOperationResponse, err error) {
...
func (c NetworkcloudsClient) KubernetesClustersRestartNodeThenPoll(ctx context.Context, id KubernetesClusterId, input KubernetesClusterRestartNodeParameters) error {
	...
	if err := result.Poller.PollUntilDone(ctx); err != nil {
		return fmt.Errorf("polling after KubernetesClustersRestartNode: %+v", err)
	}
