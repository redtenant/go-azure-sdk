...
func (c NetworkcloudsClient) MetricsConfigurationsUpdate(ctx context.Context, id MetricsConfigurationId, input ClusterMetricsConfigurationPatchParameters) (result MetricsConfigurationsUpdateOperationResponse, err error) {
...
func (c NetworkcloudsClient) MetricsConfigurationsUpdateThenPoll(ctx context.Context, id MetricsConfigurationId, input ClusterMetricsConfigurationPatchParameters) error {
	result, err := c.MetricsConfigurationsUpdate(ctx, id, input)
	if err != nil {
