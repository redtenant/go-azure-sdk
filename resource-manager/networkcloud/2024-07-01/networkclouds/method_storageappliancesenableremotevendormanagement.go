...
func (c NetworkcloudsClient) StorageAppliancesEnableRemoteVendorManagement(ctx context.Context, id StorageApplianceId, input StorageApplianceEnableRemoteVendorManagementParameters) (result StorageAppliancesEnableRemoteVendorManagementOperationResponse, err error) {
	opts := client.RequestOptions{
		...
		Path:       fmt.Sprintf("%s/enableRemoteVendorManagement", id.ID()),
	}
...
func (c NetworkcloudsClient) StorageAppliancesEnableRemoteVendorManagementThenPoll(ctx context.Context, id StorageApplianceId, input StorageApplianceEnableRemoteVendorManagementParameters) error {
	...
	if err := result.Poller.PollUntilDone(ctx); err != nil {
		return fmt.Errorf("polling after StorageAppliancesEnableRemoteVendorManagement: %+v", err)
	}
