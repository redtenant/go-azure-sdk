...
func (c NetworkcloudsClient) TrunkedNetworksListBySubscriptionComplete(ctx context.Context, id commonids.SubscriptionId) (TrunkedNetworksListBySubscriptionCompleteResult, error) {
	return c.TrunkedNetworksListBySubscriptionCompleteMatchingPredicate(ctx, id, TrunkedNetworkOperationPredicate{})
}
...
func (c NetworkcloudsClient) TrunkedNetworksListBySubscriptionCompleteMatchingPredicate(ctx context.Context, id commonids.SubscriptionId, predicate TrunkedNetworkOperationPredicate) (result TrunkedNetworksListBySubscriptionCompleteResult, err error) {
	...
	resp, err := c.TrunkedNetworksListBySubscription(ctx, id)
	if err != nil {
