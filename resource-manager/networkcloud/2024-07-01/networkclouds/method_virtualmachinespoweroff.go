...
func (c NetworkcloudsClient) VirtualMachinesPowerOff(ctx context.Context, id VirtualMachineId, input VirtualMachinePowerOffParameters) (result VirtualMachinesPowerOffOperationResponse, err error) {
...
func (c NetworkcloudsClient) VirtualMachinesPowerOffThenPoll(ctx context.Context, id VirtualMachineId, input VirtualMachinePowerOffParameters) error {
	...
	if err := result.Poller.PollUntilDone(ctx); err != nil {
		return fmt.Errorf("polling after VirtualMachinesPowerOff: %+v", err)
	}
