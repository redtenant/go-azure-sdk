...
func (c ComponentPolicyStatesClient) ListQueryResultsForPolicyDefinition(ctx context.Context, id PolicyDefinitionId, options ListQueryResultsForPolicyDefinitionOperationOptions) (result ListQueryResultsForPolicyDefinitionOperationResponse, err error) {
