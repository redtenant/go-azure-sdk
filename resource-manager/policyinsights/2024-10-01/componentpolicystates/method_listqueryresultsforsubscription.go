...
func (c ComponentPolicyStatesClient) ListQueryResultsForSubscription(ctx context.Context, id commonids.SubscriptionId, options ListQueryResultsForSubscriptionOperationOptions) (result ListQueryResultsForSubscriptionOperationResponse, err error) {
