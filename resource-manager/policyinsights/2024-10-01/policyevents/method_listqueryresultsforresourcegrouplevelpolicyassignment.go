...
func (c PolicyEventsClient) ListQueryResultsForResourceGroupLevelPolicyAssignmentComplete(ctx context.Context, id AuthorizationNamespacePolicyAssignmentId, options ListQueryResultsForResourceGroupLevelPolicyAssignmentOperationOptions) (ListQueryResultsForResourceGroupLevelPolicyAssignmentCompleteResult, error) {
	return c.ListQueryResultsForResourceGroupLevelPolicyAssignmentCompleteMatchingPredicate(ctx, id, options, PolicyEventOperationPredicate{})
}
