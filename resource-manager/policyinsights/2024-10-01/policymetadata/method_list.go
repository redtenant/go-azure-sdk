...
// List ...
func (c PolicyMetadataClient) List(ctx context.Context, options ListOperationOptions) (result ListOperationResponse, err error) {
...
func (c PolicyMetadataClient) ListComplete(ctx context.Context, options ListOperationOptions) (ListCompleteResult, error) {
	return c.ListCompleteMatchingPredicate(ctx, options, SlimPolicyMetadataOperationPredicate{})
}
