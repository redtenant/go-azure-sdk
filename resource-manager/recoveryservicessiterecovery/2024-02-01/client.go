...
import (
	...
	"github.com/redtenant/go-azure-sdk/resource-manager/recoveryservicessiterecovery/2024-02-01/clusterrecoverypoint"
	"github.com/redtenant/go-azure-sdk/resource-manager/recoveryservicessiterecovery/2024-02-01/clusterrecoverypoints"
	"github.com/redtenant/go-azure-sdk/resource-manager/recoveryservicessiterecovery/2024-02-01/migrationrecoverypoints"
	"github.com/redtenant/go-azure-sdk/resource-manager/recoveryservicessiterecovery/2024-02-01/operations"
	"github.com/redtenant/go-azure-sdk/resource-manager/recoveryservicessiterecovery/2024-02-01/recoverypoints"
	"github.com/redtenant/go-azure-sdk/resource-manager/recoveryservicessiterecovery/2024-02-01/replicationalertsettings"
	"github.com/redtenant/go-azure-sdk/resource-manager/recoveryservicessiterecovery/2024-02-01/replicationappliances"
	"github.com/redtenant/go-azure-sdk/resource-manager/recoveryservicessiterecovery/2024-02-01/replicationeligibilityresults"
	"github.com/redtenant/go-azure-sdk/resource-manager/recoveryservicessiterecovery/2024-02-01/replicationevents"
	"github.com/redtenant/go-azure-sdk/resource-manager/recoveryservicessiterecovery/2024-02-01/replicationfabrics"
	"github.com/redtenant/go-azure-sdk/resource-manager/recoveryservicessiterecovery/2024-02-01/replicationjobs"
	"github.com/redtenant/go-azure-sdk/resource-manager/recoveryservicessiterecovery/2024-02-01/replicationlogicalnetworks"
	"github.com/redtenant/go-azure-sdk/resource-manager/recoveryservicessiterecovery/2024-02-01/replicationmigrationitems"
	"github.com/redtenant/go-azure-sdk/resource-manager/recoveryservicessiterecovery/2024-02-01/replicationnetworkmappings"
	"github.com/redtenant/go-azure-sdk/resource-manager/recoveryservicessiterecovery/2024-02-01/replicationnetworks"
	"github.com/redtenant/go-azure-sdk/resource-manager/recoveryservicessiterecovery/2024-02-01/replicationpolicies"
	"github.com/redtenant/go-azure-sdk/resource-manager/recoveryservicessiterecovery/2024-02-01/replicationprotectableitems"
	"github.com/redtenant/go-azure-sdk/resource-manager/recoveryservicessiterecovery/2024-02-01/replicationprotecteditems"
	"github.com/redtenant/go-azure-sdk/resource-manager/recoveryservicessiterecovery/2024-02-01/replicationprotectionclusters"
	"github.com/redtenant/go-azure-sdk/resource-manager/recoveryservicessiterecovery/2024-02-01/replicationprotectioncontainermappings"
	"github.com/redtenant/go-azure-sdk/resource-manager/recoveryservicessiterecovery/2024-02-01/replicationprotectioncontainers"
	"github.com/redtenant/go-azure-sdk/resource-manager/recoveryservicessiterecovery/2024-02-01/replicationprotectionintents"
	"github.com/redtenant/go-azure-sdk/resource-manager/recoveryservicessiterecovery/2024-02-01/replicationrecoveryplans"
	"github.com/redtenant/go-azure-sdk/resource-manager/recoveryservicessiterecovery/2024-02-01/replicationrecoveryservicesproviders"
	"github.com/redtenant/go-azure-sdk/resource-manager/recoveryservicessiterecovery/2024-02-01/replicationstorageclassificationmappings"
	"github.com/redtenant/go-azure-sdk/resource-manager/recoveryservicessiterecovery/2024-02-01/replicationstorageclassifications"
	"github.com/redtenant/go-azure-sdk/resource-manager/recoveryservicessiterecovery/2024-02-01/replicationvaulthealth"
	"github.com/redtenant/go-azure-sdk/resource-manager/recoveryservicessiterecovery/2024-02-01/replicationvaultsetting"
	"github.com/redtenant/go-azure-sdk/resource-manager/recoveryservicessiterecovery/2024-02-01/replicationvcenters"
	"github.com/redtenant/go-azure-sdk/resource-manager/recoveryservicessiterecovery/2024-02-01/supportedoperatingsystems"
	"github.com/redtenant/go-azure-sdk/resource-manager/recoveryservicessiterecovery/2024-02-01/targetcomputesizes"
	"github.com/redtenant/go-azure-sdk/sdk/client/resourcemanager"
	sdkEnv "github.com/redtenant/go-azure-sdk/sdk/environments"
)

type Client struct {
	ClusterRecoveryPoint                     *clusterrecoverypoint.ClusterRecoveryPointClient
	ClusterRecoveryPoints                    *clusterrecoverypoints.ClusterRecoveryPointsClient
	...
	ReplicationProtectionClusters            *replicationprotectionclusters.ReplicationProtectionClustersClient
...
func NewClientWithBaseURI(sdkApi sdkEnv.Api, configureFunc func(c *resourcemanager.Client)) (*Client, error) {
	clusterRecoveryPointClient, err := clusterrecoverypoint.NewClusterRecoveryPointClientWithBaseURI(sdkApi)
	if err != nil {
		return nil, fmt.Errorf("building ClusterRecoveryPoint client: %+v", err)
	}
	configureFunc(clusterRecoveryPointClient.Client)

	clusterRecoveryPointsClient, err := clusterrecoverypoints.NewClusterRecoveryPointsClientWithBaseURI(sdkApi)
	if err != nil {
		return nil, fmt.Errorf("building ClusterRecoveryPoints client: %+v", err)
	}
	configureFunc(clusterRecoveryPointsClient.Client)
	...
	replicationProtectionClustersClient, err := replicationprotectionclusters.NewReplicationProtectionClustersClientWithBaseURI(sdkApi)
	if err != nil {
		return nil, fmt.Errorf("building ReplicationProtectionClusters client: %+v", err)
	}
	configureFunc(replicationProtectionClustersClient.Client)
	...
	return &Client{
		ClusterRecoveryPoint:                     clusterRecoveryPointClient,
		ClusterRecoveryPoints:                    clusterRecoveryPointsClient,
		...
		ReplicationProtectionClusters:            replicationProtectionClustersClient,
