...
// List ...
func (c ReplicationAlertSettingsClient) List(ctx context.Context, id VaultId) (result ListOperationResponse, err error) {
	opts := client.RequestOptions{
		...
		Path:       fmt.Sprintf("%s/replicationAlertSettings", id.ID()),
	}
...
func (c ReplicationAlertSettingsClient) ListComplete(ctx context.Context, id VaultId) (ListCompleteResult, error) {
	return c.ListCompleteMatchingPredicate(ctx, id, AlertOperationPredicate{})
}
