...
func (c ReplicationAppliancesClient) List(ctx context.Context, id VaultId, options ListOperationOptions) (result ListOperationResponse, err error) {
	...
	var values struct {
		Values *[]ReplicationAppliance `json:"value"`
	}
...
func (c ReplicationAppliancesClient) ListComplete(ctx context.Context, id VaultId, options ListOperationOptions) (ListCompleteResult, error) {
	return c.ListCompleteMatchingPredicate(ctx, id, options, ReplicationApplianceOperationPredicate{})
}
...
func (c ReplicationAppliancesClient) ListCompleteMatchingPredicate(ctx context.Context, id VaultId, options ListOperationOptions, predicate ReplicationApplianceOperationPredicate) (result ListCompleteResult, err error) {
	items := make([]ReplicationAppliance, 0)
