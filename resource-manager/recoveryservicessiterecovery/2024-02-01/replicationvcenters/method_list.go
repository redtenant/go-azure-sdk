...
// List ...
func (c ReplicationvCentersClient) List(ctx context.Context, id VaultId) (result ListOperationResponse, err error) {
...
func (c ReplicationvCentersClient) ListComplete(ctx context.Context, id VaultId) (ListCompleteResult, error) {
	return c.ListCompleteMatchingPredicate(ctx, id, VCenterOperationPredicate{})
}
