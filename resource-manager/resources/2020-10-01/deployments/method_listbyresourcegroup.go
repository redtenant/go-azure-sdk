...
// ListByResourceGroup ...
func (c DeploymentsClient) ListByResourceGroup(ctx context.Context, id commonids.ResourceGroupId, options ListByResourceGroupOperationOptions) (result ListByResourceGroupOperationResponse, err error) {
...
func (c DeploymentsClient) ListByResourceGroupCompleteMatchingPredicate(ctx context.Context, id commonids.ResourceGroupId, options ListByResourceGroupOperationOptions, predicate DeploymentExtendedOperationPredicate) (result ListByResourceGroupCompleteResult, err error) {
