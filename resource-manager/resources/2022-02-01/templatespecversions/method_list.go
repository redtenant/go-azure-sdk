...
func (c TemplateSpecVersionsClient) ListComplete(ctx context.Context, id TemplateSpecId) (ListCompleteResult, error) {
	return c.ListCompleteMatchingPredicate(ctx, id, TemplateSpecVersionOperationPredicate{})
}
