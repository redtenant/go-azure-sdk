...
// List ...
func (c BookmarkRelationsClient) List(ctx context.Context, id BookmarkId, options ListOperationOptions) (result ListOperationResponse, err error) {
...
func (c BookmarkRelationsClient) ListComplete(ctx context.Context, id BookmarkId, options ListOperationOptions) (ListCompleteResult, error) {
	return c.ListCompleteMatchingPredicate(ctx, id, options, RelationOperationPredicate{})
}
