...
// CreateOrUpdate ...
func (c DatabaseExtensionsClient) CreateOrUpdate(ctx context.Context, id ExtensionId, input DatabaseExtensions) (result CreateOrUpdateOperationResponse, err error) {
