...
func (c DatabaseRecommendedActionsClient) ListByDatabaseAdvisor(ctx context.Context, id DatabaseAdvisorId) (result ListByDatabaseAdvisorOperationResponse, err error) {
