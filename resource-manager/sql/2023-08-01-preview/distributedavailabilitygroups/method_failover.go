...
// Failover ...
func (c DistributedAvailabilityGroupsClient) Failover(ctx context.Context, id DistributedAvailabilityGroupId, input DistributedAvailabilityGroupsFailoverRequest) (result FailoverOperationResponse, err error) {
