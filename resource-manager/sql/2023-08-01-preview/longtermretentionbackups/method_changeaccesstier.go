...
type ChangeAccessTierOperationResponse struct {
...
// ChangeAccessTier ...
func (c LongTermRetentionBackupsClient) ChangeAccessTier(ctx context.Context, id LongTermRetentionBackupId, input ChangeLongTermRetentionBackupAccessTierParameters) (result ChangeAccessTierOperationResponse, err error) {
...
func (c LongTermRetentionBackupsClient) ChangeAccessTierThenPoll(ctx context.Context, id LongTermRetentionBackupId, input ChangeLongTermRetentionBackupAccessTierParameters) error {
	...
	if err := result.Poller.PollUntilDone(ctx); err != nil {
		return fmt.Errorf("polling after ChangeAccessTier: %+v", err)
	}
