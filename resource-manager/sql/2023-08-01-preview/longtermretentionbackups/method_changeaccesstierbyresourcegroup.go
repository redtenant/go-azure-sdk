...
type ChangeAccessTierByResourceGroupOperationResponse struct {
...
func (c LongTermRetentionBackupsClient) ChangeAccessTierByResourceGroup(ctx context.Context, id LongTermRetentionDatabaseLongTermRetentionBackupId, input ChangeLongTermRetentionBackupAccessTierParameters) (result ChangeAccessTierByResourceGroupOperationResponse, err error) {
	opts := client.RequestOptions{
		...
		Path:       fmt.Sprintf("%s/changeAccessTier", id.ID()),
	}
...
func (c LongTermRetentionBackupsClient) ChangeAccessTierByResourceGroupThenPoll(ctx context.Context, id LongTermRetentionDatabaseLongTermRetentionBackupId, input ChangeLongTermRetentionBackupAccessTierParameters) error {
	...
	if err := result.Poller.PollUntilDone(ctx); err != nil {
		return fmt.Errorf("polling after ChangeAccessTierByResourceGroup: %+v", err)
	}
