...
func (c ManagedInstancePrivateLinkResourcesClient) ListByManagedInstance(ctx context.Context, id commonids.SqlManagedInstanceId) (result ListByManagedInstanceOperationResponse, err error) {
...
func (c ManagedInstancePrivateLinkResourcesClient) ListByManagedInstanceComplete(ctx context.Context, id commonids.SqlManagedInstanceId) (ListByManagedInstanceCompleteResult, error) {
...
func (c ManagedInstancePrivateLinkResourcesClient) ListByManagedInstanceCompleteMatchingPredicate(ctx context.Context, id commonids.SqlManagedInstanceId, predicate ManagedInstancePrivateLinkOperationPredicate) (result ListByManagedInstanceCompleteResult, err error) {
