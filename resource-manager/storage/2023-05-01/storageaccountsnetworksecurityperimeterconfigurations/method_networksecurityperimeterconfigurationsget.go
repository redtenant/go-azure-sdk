...
func (c StorageAccountsNetworkSecurityPerimeterConfigurationsClient) NetworkSecurityPerimeterConfigurationsGet(ctx context.Context, id NetworkSecurityPerimeterConfigurationId) (result NetworkSecurityPerimeterConfigurationsGetOperationResponse, err error) {
