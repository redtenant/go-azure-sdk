...
func (c StorageAccountsNetworkSecurityPerimeterConfigurationsClient) NetworkSecurityPerimeterConfigurationsReconcile(ctx context.Context, id NetworkSecurityPerimeterConfigurationId) (result NetworkSecurityPerimeterConfigurationsReconcileOperationResponse, err error) {
...
func (c StorageAccountsNetworkSecurityPerimeterConfigurationsClient) NetworkSecurityPerimeterConfigurationsReconcileThenPoll(ctx context.Context, id NetworkSecurityPerimeterConfigurationId) error {
