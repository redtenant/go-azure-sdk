...
func (c CloudEndpointResourceClient) CloudEndpointsAfsShareMetadataCertificatePublicKeys(ctx context.Context, id CloudEndpointId) (result CloudEndpointsAfsShareMetadataCertificatePublicKeysOperationResponse, err error) {
