...
// List ...
func (c VirtualMachinesClient) List(ctx context.Context, id ClusterId) (result ListOperationResponse, err error) {
...
func (c VirtualMachinesClient) ListCompleteMatchingPredicate(ctx context.Context, id ClusterId, predicate VirtualMachineOperationPredicate) (result ListCompleteResult, err error) {
