...
func (c WorkloadNetworkGatewaysClient) WorkloadNetworksGetGateway(ctx context.Context, id GatewayId) (result WorkloadNetworksGetGatewayOperationResponse, err error) {
