...
// Start ...
func (c SAPApplicationServerInstancesClient) Start(ctx context.Context, id ApplicationInstanceId, input StartRequest) (result StartOperationResponse, err error) {
