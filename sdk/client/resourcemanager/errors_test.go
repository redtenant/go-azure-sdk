...
func TestParseErrorFromApiResponse_ResourceManagerType2(t *testing.T) {
	// Resource Manager specific response from https://github.com/redtenant/go-azure-sdk/issues/387
...
func TestParseErrorFromApiResponse_ResourceManagerType3(t *testing.T) {
	// Resource Manager specific response from https://github.com/redtenant/go-azure-sdk/issues/560
